...
In addition to [the responsibility model for Public Cloud Database services](/guides/public-cloud/public-cloud-databases/public-cloud-databases-responsibility-model), this security fact sheets aims at describing security features and functions associated to the service. It describes also best practices that customers can adopt to secure their databases.
...
Once you have followed [these first steps to subscribe your service](/guides/public-cloud/public-cloud-databases/public-cloud-databases-getting-started) and reset the default password communicated to access to the service, you must filter connections by using iptables.<br />
...
Customer data (DB) is backed up, automated and operated following different frequencies. Those backups are encrypted and uploaded to a remote, replicated storage backend, in a different datacenter from the one the database service is hosted on. Details about frequencies, RPO and locations are listed following type of services and ranges at [this link](/guides/public-cloud/public-cloud-databases/public-cloud-databases-backups).<br />
Customer data backup health status is checked daily by OVHcloud.<br />
If you need to restore your data using a backup, you can follow [this guide](/guides/public-cloud/public-cloud-databases/public-cloud-databases-restore-backup) and create a new service for this purpose.
...
You can troubleshoot your IAM policy configuration and analyse actions [by using API calls to get logs](/guides/manage-and-operate/iam/iam-troubleshooting).
...
You can activate the vRack option at the subscription step or afterwards and have your private network for your Database project. The configuration of your private network can be done by following [this link](/guides/public-cloud/public-cloud-databases/public-cloud-databases-configure-vrack).
...
[Public Cloud Databases documentation](/guides/public-cloud/public-cloud-databases/overview)
