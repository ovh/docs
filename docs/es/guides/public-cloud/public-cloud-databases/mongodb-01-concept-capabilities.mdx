...
Logs and metrics are available through the Control Panel, API, and can be forwarded to Logs Data Platform. See the [Public Cloud Databases - How to setup logs forwarding guide](/guides/public-cloud/public-cloud-databases/databases-16-logs-to-customer/) for more information.
