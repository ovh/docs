...
<img className="thumbnail" alt="migration strategy diagram" src="/images/public-cloud/public-cloud-databases/mongodb-19-migrate-to-ovhcloud/diagram_migration_strategy.png" loading="lazy" />
...
- **Create Cluster**: [Set up the new OVHcloud managed MongoDB cluster](/guides/public-cloud/public-cloud-databases/mongodb-13-getting-started/).
