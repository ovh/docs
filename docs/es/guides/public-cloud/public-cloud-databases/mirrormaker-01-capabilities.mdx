...
Logs and metrics are available through the Control Panel, API and can be forwarded to Logs Data Platform. For setup instructions, see the [Analytics - How to setup logs forwarding](/guides/public-cloud/data-analytics/analytics/analytics-logs-to-customer/).
