...
<img className="thumbnail" alt="Add a pool" src="/images/public-cloud/public-cloud-databases/postgresql-08-pool/postgresql_08_pool-20220411131919759.png" loading="lazy" />
...
<img className="thumbnail" alt="Pools" src="/images/public-cloud/public-cloud-databases/postgresql-08-pool/postgresql_08_pool-20220411134051260.png" loading="lazy" />

Click on <code className="action">Information</code>, then collect the required information.

<img className="thumbnail" alt="Pool informations" src="/images/public-cloud/public-cloud-databases/postgresql-08-pool/postgresql_08_pool-2022041113491326.png" loading="lazy" />
