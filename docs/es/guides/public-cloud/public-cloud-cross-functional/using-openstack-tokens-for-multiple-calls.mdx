...
- Para los usuarios de Windows, consulte esta guía para exportar sus variables de entorno: [Cargar las variables de entorno necesarias para OpenStack](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/).
...
<img className="thumbnail" alt="descargar el archivo openRC" src="/images/public-cloud/public-cloud-cross-functional/using-openstack-tokens-for-multiple-calls/openrc.png" loading="lazy" />
