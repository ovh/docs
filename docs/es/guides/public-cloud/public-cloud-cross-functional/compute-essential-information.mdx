...
- [Crear la primera instancia](/guides/public-cloud/compute/compute-getting-started)
- [Gestionar los límites](/guides/public-cloud/public-cloud-cross-functional/increasing-public-cloud-quota)

## Enfoque global <a id="global-approach"></a>
...
## Enfoque práctico <a id="concrete-approach"></a>
...
|[Valor](/guides/public-cloud/compute/key-concepts)|Conceptos y definiciones que necesitará para avanzar.|
...
|Documentación|Detalles|
|---|---|
|[Crear la primera instancia](/guides/public-cloud/compute/compute-getting-started)|Esta es la primera guía práctica para iniciar un servidor cloud desde el área de cliente de OVHcloud.|
...
|[Configuración de la red privada](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack)|En OVHcloud, la tecnología vRack utiliza las redes privadas. Esta guía le ayudará a realizar esta operación.|
...
|[Configurar una Additional IP](/guides/public-cloud/public-cloud-network-services/configure-additional-ip)|Las Additional IP permiten cambiar el tráfico de una instancia a otra. Esta guía explica cómo configurar esta opción.|
...
|[Instalación de la CLI OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment)|OpenStack también puede utilizarse en línea de comandos. Así es como instalar las herramientas.|
