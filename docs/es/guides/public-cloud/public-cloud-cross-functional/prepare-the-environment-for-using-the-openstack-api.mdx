...
<img className="thumbnail" alt="Instalación automática" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/1_preparation_openstack_environment_windows.png" loading="lazy" />
...
<img className="thumbnail" alt="Elección de las variables de entorno" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/2_preparation_openstack_environment_windows.png" loading="lazy" />
...
<img className="thumbnail" alt="Configuración de las variables de entorno" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/3_preparation_openstack_environment_windows.png" loading="lazy" />
...
<img className="thumbnail" alt="Introducción de la ruta de acceso" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/4_edit_system_variables.png" loading="lazy" />
...
<img className="thumbnail" alt="Instalación automática" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/5_preparation_openstack_environment_windows.png" loading="lazy" />
...
<img className="thumbnail" alt="Verificación" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/6_preparation_openstack_environment_windows.png" loading="lazy" />
