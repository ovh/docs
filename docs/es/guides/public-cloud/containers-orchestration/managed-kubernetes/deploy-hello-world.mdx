...
![Select your cluster](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-hello-world/select-cluster.png)

Click on your cluster to access its information.

![OVHcloud Managed Kubernetes cluster view](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-hello-world/cluster-infos.png)
...
![Add a node pool - Set a name](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-hello-world/add-node-pool1.png)
...
![Add a node pool - Choose a flavor](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-hello-world/add-node-pool2.png)

Configure the number of nodes you want to add to your node pool, 3 for example with Autoscaling disabled.

![Add a node pool - Set the number of nodes](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-hello-world/add-node-pool3.png)

Define the billing method: monthly or hourly.

![Add a node pool - Choose a flavor](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-hello-world/add-node-pool4.png)
...
![Verify your node is ready](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-hello-world/node-pool-status.png)

After its creation, click on the node pool in order to list its nodes details.

![Node pool details](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-hello-world/node-pool.png)
