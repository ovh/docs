...
And you also need to follow [Deploying a GPU application on OVHcloud Managed Kubernetes](/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-gpu-application/) tutorial to install NVIDIA GPU operator and configure your cluster correctly with needed components for this guide.
...
As you have already followed the [Deploying a GPU application on OVHcloud Managed Kubernetes](/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-gpu-application/) tutorial, you should already have `dcgm-exporter` running in your cluster.
...
If you followed the [Deploying a GPU application on OVHcloud Managed Kubernetes](/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-gpu-application/) tutorial, you should see metrics like in our example.
