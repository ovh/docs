...
![Configuring default settings for kubectl](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-kubectl-on-an-ovh-managed-kubernetes-cluster/kubernetes-quickstart-01.png)

Then, click on `kubeconfig` to download the `kubectl` configuration file:

![Configuring default settings for kubectl](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-kubectl-on-an-ovh-managed-kubernetes-cluster/kubernetes-quickstart-02.png)
...
![Add environment variables](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-kubectl-on-an-ovh-managed-kubernetes-cluster/configuring_default_settings_for_kubectl-02.png)
