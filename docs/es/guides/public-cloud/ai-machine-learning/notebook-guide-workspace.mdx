...
When you **stop your notebook**, your workspace (`/workspace`) is automatically saved and pushed to your [Object Storage](/guides/public-cloud/ai-machine-learning/gi-02-concepts-data/). This means that all files contained in your `/workspace` directory will be saved for future use.
