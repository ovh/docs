...
- To go further with **Flask**, imagine creating an app to deploy an Object Detection model. Refer to this [tutorial](/guides/public-cloud/ai-machine-learning/deploy-tuto-04-flask-yolov5/).
- **Flask** allows you to do sentiment classification on texts using Hugging Face models. [Here it is](/guides/public-cloud/ai-machine-learning/deploy-tuto-06-flask-hugging-face/).
