...
![app add label](/images/guides/public-cloud/ai-machine-learning/deploy-guide-03-tokens/01-app-add-label.png)

Once created, all the labels of an AI Deploy app are listed on the app details, under **Labels** field:

![app dashboard](/images/guides/public-cloud/ai-machine-learning/deploy-guide-03-tokens/02-app-dashboard.png)
...
![image](/images/guides/public-cloud/ai-machine-learning/deploy-guide-03-tokens/03-app-add-label-existing-app.png)
...
From the **AI Dashboard** page, you can access the tokens management page by clicking on the `Tokens` tab. From there, you can click on the `+ Create a token` button to create a new token:

![token list new](/images/guides/public-cloud/ai-machine-learning/deploy-guide-03-tokens/04-token-list.png)
...
![token generation input read](/images/guides/public-cloud/ai-machine-learning/deploy-guide-03-tokens/05-token-gen-input-read.png)
...
![token generation result](/images/guides/public-cloud/ai-machine-learning/deploy-guide-03-tokens/06-token-gen-result-read.png)
...
![token generation input operator](/images/guides/public-cloud/ai-machine-learning/deploy-guide-03-tokens/07-token-gen-input-op.png)
...
![app access login](/images/guides/public-cloud/ai-machine-learning/deploy-guide-03-tokens/11-app-access-credentials.png)
...
![app response](/images/guides/public-cloud/ai-machine-learning/deploy-guide-03-tokens/12-app-access-result.png)
...
![token regenerate](/images/guides/public-cloud/ai-machine-learning/deploy-guide-03-tokens/08-token-list-regen.png)

Then click on `Confirm`:

![token regenerate confirm](/images/guides/public-cloud/ai-machine-learning/deploy-guide-03-tokens/09-token-regen-confirm.png)
...
![token delete](/images/guides/public-cloud/ai-machine-learning/deploy-guide-03-tokens/10-token-list-delete.png)
