...
Follow the instructions in the [AI Endpoints - Getting Started](/guides/public-cloud/ai-machine-learning/endpoints-guide-01-getting-started/) guide for more information on authentication.
...
| **model**                    | No       | `string`/`null`   | ID of the model to use                                                                | -       | Specifies the model to use for transcription. Useful when using our [unified endpoint](/guides/public-cloud/ai-machine-learning/endpoints-guide-07-virtual-models/).                                                                                                                                                            |
...
<Tabs>
  ...
  <Tab label="cURL">
    ...
    To [**authenticate with your API key**](/guides/public-cloud/ai-machine-learning/endpoints-guide-01-getting-started/), add an Authorization header:
...
- **Authenticated requests** (using an [API key](/guides/public-cloud/ai-machine-learning/endpoints-guide-01-getting-started/)): Up to `2048 MB` or `10 800 seconds` of audio per request.
