...
All steps for starting and working on AI Notebooks are described in the [AI Notebooks - Getting Started](/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/) guide.
...
To follow all the steps in detail, please refer to this [documentation](/guides/public-cloud/ai-machine-learning/gi-01-manage-users/).

As an alternative, you can generate an authorized token directly via our [CLI](/guides/public-cloud/ai-machine-learning/cli-13-howto-app-token-cli/).
...
You only pay for the resources you use and eventually the local storage. Check [this documentation](/guides/public-cloud/ai-machine-learning/notebook-guide-billing-concept/) for detailed examples.
...
Please note that each AI Notebook is limited to a maximum amount of CPUs and GPUs. You can refer to the AI Notebooks [Capabilities and Limitations](/guides/public-cloud/ai-machine-learning/notebook-guide-capabilities/) guide.
...
If you want to build and use a custom Docker image, you can do it with AI Training by following this [tutorial](/guides/public-cloud/ai-machine-learning/training-tuto-02-build-custom-image/).
