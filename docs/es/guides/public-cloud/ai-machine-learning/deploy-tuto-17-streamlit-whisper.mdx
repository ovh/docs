...
- A [user for AI Deploy & Object Storage](/guides/public-cloud/ai-machine-learning/gi-01-manage-users/)
- [The OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/) installed on your local computer
- [Docker](https://www.docker.com/get-started) installed on your local computer, **or** access to a Debian Docker Instance, which is available on the [Public Cloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es)
...
You can create your Object Storage bucket using either the UI (OVHcloud Control Panel) or the `ovhai` CLI, which can be downloaded [here](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/).

<Tabs>
  <Tab label="Using the Control Panel (UI)">
    If you do not feel comfortable with commands, this method may be more intuitive.
    
    First, go to the <code className="action">Public Cloud</code> section of the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es).
...
To do this, you will need [Docker](https://www.docker.com/get-started), either installed directly on your computer, or using a Debian Docker Instance, available on the [Public Cloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es).
...
You could also combine your transcripts with an LLM. Learn how to [Deploy LLaMA 2 on AI Deploy](/guides/public-cloud/ai-machine-learning/deploy-tuto-15-streamlit-chatbot-llama-v2/).
