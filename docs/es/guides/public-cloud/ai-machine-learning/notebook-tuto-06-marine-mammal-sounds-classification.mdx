...
You need to attach a volume if your data is in your OVHcloud Object Storage and you want to use it during your experiment. For more information on data, volumes and permissions, see [our guide on data](/guides/public-cloud/ai-machine-learning/cli-17-how-to-cli-data-notebooks/).
...
If you want to launch it with the CLI, choose the [volume](/guides/public-cloud/ai-machine-learning/cli-17-how-to-cli-data-notebooks/) you want to attach and the number of GPUs (`<nb-gpus>`) to use on your notebook and use the following command:
...
- If you want to train your model, please check out this [AI Training tutorial](/guides/public-cloud/ai-machine-learning/training-tuto-08-train-marine-mammal-sound/).
- If you want to deploy a **Streamlit** app in order to classify marine mammal sounds using your model, please check out this [notebook](/guides/public-cloud/ai-machine-learning/deploy-tuto-03-streamlit-sounds-classification/).
- You can also compare two methods for audio classification task by following this [tutorial](/guides/public-cloud/ai-machine-learning/training-tuto-06-models-comparaison-weights-and-biases/).
