...
- A user account created on this Public Cloud project, with the **AI** and **Object Storage** roles assigned. For more information on how to create such a user, please consult the [Manage AI users and roles](/guides/public-cloud/ai-machine-learning/gi-01-manage-users/) documentation.
- The `ovhai` CLI installed. Please refer to our guide on [how to install ovhai CLI](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/) for assistance.
...
To create your first **S3 compatible Object Storage bucket**, click [this link](https://manager.eu.ovhcloud.com/#/pci/projects) to access your Public Cloud project, then click the <code className="action">Object Storage</code> button in the left-hand side bar, in the <code className="action">Storage</code> section:
...
For more information about editing user rights, you can check the [dedicated documentation](/guides/public-cloud/ai-machine-learning/gi-01-manage-users/).
...
Now that your bucket has been created, and the associated user has the necessary permissions, you can move on to the `ovhai` CLI. If you have not installed it yet, please refer to the [ovhai CLI installation guide](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/).
...
<Tabs>
  <Tab label="AI Notebooks">
    ...
    You can also consult the dedicated [CLI - Launch an AI notebook documentation](/guides/public-cloud/ai-machine-learning/cli-11-howto-run-notebook-cli/) to know more about the possible options, frameworks, and editors available.
  </Tab>
  <Tab label="AI Training">
    ...
    You can also consult the dedicated [CLI - Launch an AI Training job documentation](/guides/public-cloud/ai-machine-learning/cli-12-howto-run-job-cli/) to know more about the possible job commands.
  </Tab>
  <Tab label="AI Deploy">
    ...
    You can also consult the dedicated [CLI - Launch an AI Deploy app documentation](/guides/public-cloud/ai-machine-learning/cli-18-howto-deploy-app/) to know more about the possible job commands.
  </Tab>
</Tabs>
