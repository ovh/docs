...
3. An API key generated from the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), in <code className="action">Public Cloud</code> > `AI Endpoints` > <code className="action">API keys</code>
