...
Para obtener más información, consulte la documentación: [Comparison and resilience of Deployment Modes - Understanding 3-AZ / 1-AZ / Local Zones (EN)](/guides/public-cloud/public-cloud-cross-functional/deployment-modes-comparison-resilience-details/).
