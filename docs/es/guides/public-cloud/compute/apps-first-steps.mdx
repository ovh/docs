...
Utilice el [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es) / API o la API de OpenStack Horizon para instalar la aplicación que haya elegido en su instancia de Public Cloud.
