...
- [Una llave SSH](/guides/public-cloud/compute/compute-creating-ssh-keys/) creada para desplegar una instancia GPU Linux.
...
A continuación, siga los pasos que se describen en [esta guía](/guides/public-cloud/compute/public-cloud-first-steps#create-instance/). Este proceso puede tardar unos minutos.
