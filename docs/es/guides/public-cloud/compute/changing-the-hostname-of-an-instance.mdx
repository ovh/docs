...
- Haber creado una [instancia de Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
- [Conectarse a la instancia por SSH](/guides/public-cloud/compute/public-cloud-first-steps#connect-instance/) (sudo).
