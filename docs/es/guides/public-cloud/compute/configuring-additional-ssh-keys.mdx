...
- [Acceso administrativo a su instancia por SSH](/guides/public-cloud/compute/creating-ssh-keys-pci#login-linux/)
...
Si es necesario, utilice nuestra [guía de claves SSH](/guides/public-cloud/compute/compute-creating-ssh-keys/) para crear un nuevo par de claves SSH.  
También encontrará información sobre [la gestión de varias claves](/guides/public-cloud/compute/creating-ssh-keys-pci#multiplekeys/) en su estación de trabajo local si su instalación lo requiere.

### Paso 2: configurar una nueva cuenta de usuario

[Conéctese a su instancia](/guides/public-cloud/compute/public-cloud-first-steps#connect-instance/) y utilice los siguientes comandos para crear una nueva cuenta de usuario y una carpeta `.ssh`:
...
[Conéctese a su instancia](/guides/public-cloud/compute/public-cloud-first-steps#connect-instance/) y abra, con su editor de texto preferido (`nano` se utiliza en este ejemplo), el archivo `authorized_keys` en la carpeta personal del nuevo usuario:
...
Consulte la [guía sobre las claves SSH](/guides/public-cloud/compute/compute-creating-ssh-keys/) para saber más sobre el uso de las claves SSH con las instancias Public Cloud.

## Más información

[Cómo crear instancias de Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)

[Cómo sustituir un par de claves SSH en una instancia Public Cloud por el modo de rescate](/guides/public-cloud/compute/replacing-lost-ssh-key/)
