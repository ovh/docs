...
:::info
**Buena práctica**: Para cargas de trabajo críticas, elija un [despliegue multi-AZ](/guides/public-cloud/public-cloud-cross-functional/3az-ref-architecture/) para garantizar la resiliencia y la continuidad del servicio.
...
Para instrucciones detalladas sobre la creación y uso de claves SSH, consulte la guía [OVHcloud sobre SSH](/guides/public-cloud/compute/creating-ssh-keys-pci/).
...
:::info
**Buena práctica**: Las copias de seguridad no sustituyen una [arquitectura resistente](/guides/public-cloud/public-cloud-cross-functional/3az-ref-architecture/). Para entornos críticos, combine las copias de seguridad con la replicación multi-AZ para garantizar una protección máxima de los datos y una disponibilidad óptima del servicio.
...
Para más detalles sobre la configuración de redes de Public Cloud, consulte la guía oficial [OVHcloud sobre redes](/guides/public-cloud/public-cloud-network-services/concepts-01-public-cloud-networking-concepts/).
...
Los Savings Plans le ayudan a optimizar su presupuesto manteniendo el rendimiento y la fiabilidad de su entorno en la nube. Para más información, consulte la guía oficial [OVHcloud sobre Savings Plans](/guides/public-cloud/public-cloud-cross-functional/savings-plans/).
...
- [Cómo crear una instancia de Public Cloud y acceder a ella](/guides/public-cloud/compute/public-cloud-first-steps/)
