...
- The [OpenStack CLI](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/) ready to be used on your system.
- An [OpenStack user](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/) has been created with (at least) the _Compute Operator_ and _Backup Operator_ roles.
...
This [documentation](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/) can help you deal with the required environment variables on Windows.
