...
Cree un nuevo par de llaves SSH en su dispositivo local, siguiendo las instrucciones de la primera parte de la [guía de creación de una llave SSH](/guides/public-cloud/compute/compute-creating-ssh-keys/).
...
Reinicie la instancia en modo normal desde su [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es). Consulte las instrucciones de [guide sur le mode rescue](/guides/public-cloud/compute/put-an-instance-in-rescue-mode/) si es necesario.
