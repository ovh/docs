...
- [Preparar el entorno para utilizar la API OpenStack](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/) instalando python-cinderclient y python-novaclient
