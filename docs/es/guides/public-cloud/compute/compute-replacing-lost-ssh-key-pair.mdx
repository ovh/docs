...
Reinicie la instancia en modo normal desde su [área de cliente de OVHcloud](/links/manager). Consulte las instrucciones de [guide sur le mode rescue](/guides/public-cloud/compute/put-an-instance-in-rescue-mode) si es necesario.
