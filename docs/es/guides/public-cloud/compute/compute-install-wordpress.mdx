...
- Tener una [instancia de Public Cloud](/guides/public-cloud/compute/compute-getting-started) con Debian o Ubuntu instalado.
...
### Paso 2: configuración del servidor de bases de datos <a id="sqlconf"></a>
...
>
> Como alternativa, OVHcloud le ofrece la solución [SSL Gateway](/links/web/ssl-gateway). Para más información, consulte [nuestra guía](/guides/web-cloud/ssl-gateway/ssl-gateway-order).
> 
