...
Para más información, consulte nuestra [guía sobre la creación de una instancia de Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
...
:::info
`Ed25519` se considera el más seguro, pero `RSA` es una alternativa válida. Ambos métodos son compatibles con el [área de cliente de OVHcloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
...
Copie esta cadena de clave para [añadirla a una nueva instancia o importarla en su área de cliente](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
...
[Cómo crear una instancia de Public Cloud y conectarse a ella](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)
