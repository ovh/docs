...
- Un [usuario OpenStack](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user) (opcional).
...
### Instalar y configurar Stormshield Network Security en su entorno Public Cloud <a id="step1"></a>
...
Conéctese al [área de cliente de OVHcloud](/links/manager), acceda a la sección `Public Cloud` y seleccione el proyecto de Public Cloud correspondiente. En el menú de la izquierda, haga clic en `Instances` en la pestaña **Compute** y seleccione las dos instancias SNS EVA.
...
#### Caso de uso nº 1: configurar Stormshield Network Security para utilizarlo como puerta de enlace <a id="step2"></a>
...
#### Caso de uso n°2: configurar un NAT (**N**network **A**ddress **T**ranslation) para acceder a un servicio HTTP privado desde el exterior <a id="step3"></a>
...
#### Caso de uso n°3: túnel IPsec (de sitio a sitio) <a id="step4"></a>
...
#### Caso de uso n°4: VPN SSL/TLS (de cliente a sitio) <a id="step5"></a>
