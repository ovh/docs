...
- Tener un [proyecto Public Cloud](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project)
- Estar conectado a su [área de cliente de OVHcloud](/links/manager)
- Tener [creado un usuario OpenStack](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user) (opcional)
...
**A continuación, se muestra un breve descriptivo de las acciones posibles según el método o interfaz elegido:** <a id="horizon"></a>
...
Consulte el guía "[Presentación de Horizon](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon)" para familiarizarse con Horizon.
...
- [Preparar el entorno para utilizar la API OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment)
- [Cargar las variables de entorno necesarias para OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-set-openstack-environment-variables)
...
Para ello, debe elegir el proveedor y el recurso Terraform adecuados. Encuentre más información en nuestro [guía de uso de Terraform](/guides/manage-and-operate/terraform/terraform-at-ovhcloud).

</details>

## Procedimiento

### Paso 1: Activar y gestionar un vRack <a id="activation"></a>
...
>>
>> ![Comprar el vrack](/images/assets/screens/control-panel/product-selection/bare-metal-cloud/network/orderingvrack25.png)
>>
...
>>
>> ![añadir el proyecto](/images/guides/public-cloud/public-cloud-network-services/configuration-06-configure-ip-block-vrack-to-instance/addprojectvrack.png)
>>
...
### Paso 2: Crear una red privada en el vRack <a id="create-pn-in-vrack"></a>
...
![Creación de VLAN](/images/guides/public-cloud/public-cloud-network-services/configuration-06-configure-ip-block-vrack-to-instance/vrack2022-03.png)
...
![seleccionar región](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack5-2024.png)

En la siguiente etapa, se le presentan varias opciones:

![crear red](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack6-2022.png)
...
- **Asignar un servicio Gateway y conectarse a la red privada**: Seleccione esta opción si tiene la intención de crear instancias con una red privada únicamente. Para más información, le invitamos a consultar las siguientes guías: [Crear una red privada con una Gateway](/guides/public-cloud/public-cloud-network-services/create-private-network-gateway) y [Crear una primera instancia Public Cloud y conectarse a ella](/guides/public-cloud/compute/compute-getting-started).
...
Consulte la guía "[Cómo crear una instancia de Public Cloud y conectarse a ella](/guides/public-cloud/compute/compute-getting-started)". Durante la creación de una instancia, puede elegir en el paso 5, un modo de red y luego una red privada en la que integrar su instancia.
...
Inicie sesión en su [área de cliente de OVHcloud](/links/manager), vaya a la sección `Public Cloud` y seleccione el proyecto Public Cloud correspondiente en la esquina superior izquierda.
...
![detalles de la instancia](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/instance_details.png)
...
![adjuntar red](/images/guides/public-cloud/public-cloud-network-services/configuration-06-configure-ip-block-vrack-to-instance/vrack2021-01.png)
...
![adjuntar red](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack9.png)
...
![conexión Horizon](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon1.png)
