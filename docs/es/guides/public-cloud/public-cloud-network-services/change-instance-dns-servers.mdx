...
Conéctese a su instancia por SSH. Para más información, consulte la guía [Conectarse a una instancia de Public Cloud](/guides/public-cloud/compute/compute-getting-started#connect-instance).
...
Conéctese a la instancia a través de una sesión de escritorio remoto o con la consola VNC. Para más información, consulte la guía [Conectarse a una instancia de Public Cloud](/guides/public-cloud/compute/compute-getting-started#connect-instance).

Abra los `Parámetros de red`.

![modificar los servidores dns](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers1.png)

En el panel de configuración, acceda a la configuración IPv4 de su tarjeta de red pública.

![modificar los servidores dns](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers2.png)

Añada los servidores que quiera utilizar en los `parámetros avanzados`.

![modificar los servidores dns](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers3.png)
...
[Crear una primera instancia de Public Cloud y conectarse a ella](/guides/public-cloud/compute/compute-getting-started)
