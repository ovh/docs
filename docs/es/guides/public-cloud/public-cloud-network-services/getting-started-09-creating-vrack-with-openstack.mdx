...
- Tener un [proyecto de Public Cloud.](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project/)
...
- Haber [creado un usuario de OpenStack](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/) (opcional).
...
<img className="thumbnail" alt="agregar proyecto" src="/images/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/addprojectvrack.png" loading="lazy" />

<a name="ovhcloud-api"></a>

#### Desde la APIv6 de OVHcloud

Para activar y gestionar un vRack desde la APIv6 de OVHcloud, haga clic [aquí](/guides/public-cloud/public-cloud-network-services/getting-started-08-creating-vrack-with-api#step-1-activating-and-managing-a-vrack/) (EN), para consultar la guía específica sobre este método.
...
[Configuración del vRack Public Cloud desde las APIv6 de OVHcloud](/guides/public-cloud/public-cloud-network-services/getting-started-08-creating-vrack-with-api/) (EN).
