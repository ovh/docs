...
> [!info]
> 
> Actualmente las opciones Floating IP y Gateway no permiten la IPv6. La IPv6 solo puede utilizarse con las instancias en [modo público](/guides/public-cloud/public-cloud-network-services/concepts#publicmode).
>
...
Conéctese al [área de cliente de OVHcloud](/links/manager), acceda a la sección de `Public Cloud` y seleccione el proyecto de Public Cloud correspondiente. En la columna izquierda, seleccione el menú `Instancias` y haga clic en el botón `...` junto a la instancia correspondiente y haga clic en `Detalles de la instancia`.
...
Puede consultar la información en la columna `Redes`.
...
Acceda a la sección `Conexiones de red` de su Windows.
...
A continuación, haga clic derecho en su tarjeta de red para acceder a `Propiedades`.
...
Haga clic en `Internet Protocol Version 6 (TCP/IPv6)` y seleccione el botón `Propiedades`.
...
Una vez que haya finalizado, marque la casilla `Validar los parámetros a la salida` y haga clic en el botón `OK` para aceptar los cambios.
