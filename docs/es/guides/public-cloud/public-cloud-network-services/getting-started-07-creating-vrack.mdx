...
[El área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es) es una interfaz completamente y exclusivamente visual, lo que la convierte en una interfaz ideal para la gestión de varios VLAN. También tendrá la posibilidad de personalizar el rango de IP privada, que por defecto es 10.1.0.0/16.
...
Será redirigido a otra página para validar el pedido, la operación solo tardará unos minutos.
    ...
    <img className="thumbnail" alt="añadir el proyecto" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/addprojectvrack.png" loading="lazy" />
...
<Tabs>
  <Tab label="Desde el área de cliente de OVHcloud">
    ...
    <img className="thumbnail" alt="Creación de VLAN" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack2022-03.png" loading="lazy" />
...
Haga clic ahora en <code className="action">Crear una red privada</code>. La página siguiente le permitirá personalizar varios parámetros.
    ...
    <img className="thumbnail" alt="seleccionar región" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack5-2024.png" loading="lazy" />

En la siguiente etapa, se le presentan varias opciones:
    
    <img className="thumbnail" alt="crear red" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack6-2022.png" loading="lazy" />
...
En el campo **Nombre de la red privada**, defina un nombre para su red privada.
    ...
    **Opciones de puerta de enlace de red**
    ...
    - **Asignar un servicio Gateway y conectarse a la red privada**: Seleccione esta opción si tiene la intención de crear instancias con una red privada únicamente. Para más información, le invitamos a consultar las siguientes guías: [Crear una red privada con una Gateway](/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/) y [Crear una primera instancia Public Cloud y conectarse a ella](/guides/public-cloud/compute/public-cloud-first-steps/).
...
<Tabs>
  <Tab label="Desde el área de cliente de OVHcloud">
    Consulte la guía "[Cómo crear una instancia de Public Cloud y conectarse a ella](/guides/public-cloud/compute/public-cloud-first-steps/)". Durante la creación de una instancia, puede elegir en el paso 5, un modo de red y luego una red privada en la que integrar su instancia.
...
<Tabs>
  <Tab label="Desde el área de cliente de OVHcloud">
    ...
    <img className="thumbnail" alt="detalles de la instancia" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/instance_details.png" loading="lazy" />
...
Se le mostrará el panel de control de su instancia. Haga clic en el botón <code className="action">⁝</code> a la derecha de "Redes privadas" y luego en <code className="action">Asociar una red</code>.
    ...
    <img className="thumbnail" alt="adjuntar red" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack2021-01.png" loading="lazy" />
...
En la ventana emergente que aparece, seleccione la o las redes privadas que desee adjuntar a su instancia y haga clic en <code className="action">Confirmar</code>.
    ...
    <img className="thumbnail" alt="adjuntar red" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack9.png" loading="lazy" />
  </Tab>
  <Tab label="Desde las APIv6 de OVHcloud">
    La acción consistirá simplemente en añadir una nueva interfaz de red a su servidor, además de la existente.
...
Deberá rellenar al menos los siguientes campos:
  ...
  <Tab label="Desde OpenStack Horizon">
    ...
    <img className="thumbnail" alt="conexión Horizon" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon1.png" loading="lazy" />
