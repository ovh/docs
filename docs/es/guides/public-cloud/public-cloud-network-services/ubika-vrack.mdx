...
### Configure your vRack <a id="step1"></a>
...
### Install and configure Ubika WAAP Gateway on your Public Cloud environment <a id="step2"></a>
...
Go to the `download` section of the [official Ubika website](https://my.ubikasec.com/). Log in to your Ubika account and follow the instructions to download the UWG OpenStack image.
...
### Configure the licences <a id="step3"></a>
...
### Create your web server environment <a id="step4"></a>
