...
If you are unfamiliar with Public Cloud, please refer to our guide on "[Getting started with Public Cloud](/guides/public-cloud/public-cloud-cross-functional/00-essential-info-to-get-started-on-public-cloud/)".

To create and configure a Public Cloud instance, follow the steps in our guide on "[Creating and connecting to a Public Cloud instance](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)".
...
If you use a Web Cloud Databases database, make sure that your server is authorized to connect to it. To do this, add the server's IP address to the list of authorized IP addresses. This configuration secures access to the database and prevents connection problems. Please refer to the "Authorize an IP address" section of our guide "[Getting started with the Web Cloud Databases service](/guides/web-cloud/web-cloud-databases/starting-with-clouddb/)".
...
For a full list of security best practices, please refer to our guides "[Securing a dedicated server](/guides/bare-metal-cloud/dedicated-servers/securing-a-dedicated-server/)" and "[Best practices for securing and structuring OVHcloud Public Cloud projects](/guides/public-cloud/public-cloud-cross-functional/securing-and-structuring-projects/)".
