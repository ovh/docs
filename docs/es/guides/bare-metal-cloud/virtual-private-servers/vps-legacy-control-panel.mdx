...
Conéctese al [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es), abra la pestaña <code className="action">Bare Metal Cloud</code> y seleccione su servidor entre los <code className="action">servidores privados virtuales</code>.
...
- el idioma;
- una [llave SSH](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys-dedicated/) (opcional)
...
Al reinstalar su VPS, le enviaremos por correo electrónico la contraseña root para conectarse a su VPS por [SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction/), a menos que haya seleccionado una [llave SSH](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys-dedicated/) para preinstalar.
...
[Creación y uso de llaves SSH](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys-dedicated/)
