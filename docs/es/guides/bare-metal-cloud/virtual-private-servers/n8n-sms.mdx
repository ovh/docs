...
- Tener una [cuenta SMS de OVHcloud](https://www.ovhcloud.com/es-es/sms/) y un [remitente SMS](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-expediteurs-sms/) válido.
...
- [El remitente debe estar definido en su cuenta de OVHcloud](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-expediteurs-sms/). Para realizar una prueba sin declarar un remitente y utilizar un número corto, reemplace `"sender": "Your_sender"` por `"senderForResponse": true`.
