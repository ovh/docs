...
description: Cómo utilizar el vRack con la solución Managed Bare Metal
...
Para mover el *datacenter* de su Managed Bare Metal a otro vRack, haga clic en el botón <code className="action">Mover</code>
