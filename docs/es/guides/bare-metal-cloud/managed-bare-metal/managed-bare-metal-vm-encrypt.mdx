...
- Tener contratado el servicio [Managed Bare Metal](https://www.ovhcloud.com/es-es/managed-bare-metal/).
...
![huella del certificado](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/certificate_thumbprints_01.png)

![huella del certificado](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/certificate_thumbprints_02.png)
...
![Área de cliente de OVHcloud](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_nupanel_01.png)
...
![importar certificado KMS](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_02.png)

#### Compruebe que el KMS está configurado.

Compruebe que e l« **Connection Status** » correspondiente al KMS está en modo « Normal ».

![verificar estado conexión](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_03.png)
...
![vMotion cifrado](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_06.png)
...
![comprobación de la configuración](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_07.png)

![comprobación de la configuración](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_08.png)

![comprobación de la configuración](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_09.png)
