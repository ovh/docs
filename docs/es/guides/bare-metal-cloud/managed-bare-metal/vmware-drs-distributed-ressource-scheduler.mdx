...
<img className="thumbnail" alt="Principio del DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs0.png" loading="lazy" />
...
<img className="thumbnail" alt="Activación del DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs01.png" loading="lazy" />
...
<img className="thumbnail" alt="Automatización DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs02.png" loading="lazy" />
...
<img className="thumbnail" alt="Opciones adicionales DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs03.png" loading="lazy" />
...
<img className="thumbnail" alt="opciones avanzadas drs" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs05.png" loading="lazy" />

### Reglas DRS

Para gestionar las reglas de MV/host, diríjase a la pestaña `Configurar`.

<img className="thumbnail" alt="reglas drs" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs06.png" loading="lazy" />
...
La cuarta regla, «máquinas virtuales a máquinas virtuales», viene explicada en nuestra guía sobre la [funcionalidad HA](/guides/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/).

<img className="thumbnail" alt="creación reglas drs" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs07.png" loading="lazy" />
