...
- [Veeam Managed Backup activado](/guides/bare-metal-cloud/managed-bare-metal/veeam-backup-as-a-service/) en su Managed Bare Metal
...
<img className="thumbnail" alt="Correo electrónico" src="/images/bare-metal-cloud/managed-bare-metal/veeam-managed-backup-restoration/backup-report-email2.png" loading="lazy" />
