...
<img className="thumbnail" alt="esquema HA" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HA3.png" loading="lazy" />
...
<img className="thumbnail" alt="activación HA" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HA.png" loading="lazy" />
...
<img className="thumbnail" alt="Fallo del host" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam1.PNG" loading="lazy" />
...
<img className="thumbnail" alt="aislamiento del host" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam2.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Almacén de datos con PDL" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam3.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Almacén de datos con APD" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam4.PNG" loading="lazy" />

##### Supervisión de las MV

La supervisión de las máquinas virtuales está disponible después de instalar las [VMware tools](/guides/bare-metal-cloud/managed-bare-metal/vmware-tools-install/).
...
<img className="thumbnail" alt="Supervisión de las MV" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam5.PNG" loading="lazy" />
