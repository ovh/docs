...
En función de su KMS, podrá conectarse al servidor utilizando su navegador. Haga clic a continuación en <code className="action">View Certificate</code>, y en <code className="action">Thumbprint</code>

<img className="thumbnail" alt="huella del certificado" src="/images/bare-metal-cloud/managed-bare-metal/vm-encrypt/certificate_thumbprints_01.png" loading="lazy" />

<img className="thumbnail" alt="huella del certificado" src="/images/bare-metal-cloud/managed-bare-metal/vm-encrypt/certificate_thumbprints_02.png" loading="lazy" />
...
Una vez en la página principal del servicio, haga clic en <code className="action">Seguridad</code>.

<img className="thumbnail" alt="Área de cliente de OVHcloud" src="/images/bare-metal-cloud/managed-bare-metal/vm-encrypt/vm-encrypt_nupanel_01.png" loading="lazy" />

Un poco más abajo de la página verá el apartado « **Virtual Machine Encryption Key Management Servers** ». Haga clic en el botón <code className="action">Añadir un nuevo servidor KMS</code>.
...
Active la casilla para declarar que ha leído la documentación, y haga clic en <code className="action">Siguiente</code>. 
...
Comience el proceso conectándose a su Managed Bare Metal con el cliente web vSphere. Consulte la lista de inventario y seleccione el vCenter correspondiente. Diríjase a «Gestionar», y después a «Key Management Servers». Haga clic en <code className="action">Añadir KMS</code>, complete los datos KMS en el asistente que aparece en pantalla y haga clic en <code className="action">Ok</code>.
Acepte el certificado haciendo clic en <code className="action">Trust</code>.

<img className="thumbnail" alt="procedimiento añadir clave KMS" src="/images/bare-metal-cloud/managed-bare-metal/vm-encrypt/vm-encrypt_01.png" loading="lazy" />
...
Seleccione el servidor KMS en el vCenter en el que se ha añadido el mismo. En «Todas las opciones», haga clic en <code className="action">Establecer un enlace de confianza con KMS</code>.
...
<img className="thumbnail" alt="importar certificado KMS" src="/images/bare-metal-cloud/managed-bare-metal/vm-encrypt/vm-encrypt_02.png" loading="lazy" />

#### Compruebe que el KMS está configurado.

Compruebe que e l« **Connection Status** » correspondiente al KMS está en modo « Normal ».

<img className="thumbnail" alt="verificar estado conexión" src="/images/bare-metal-cloud/managed-bare-metal/vm-encrypt/vm-encrypt_03.png" loading="lazy" />

#### Modifique la política de almacenamiento de « VM Encryption Storage »

Cree una máquina virtual. Una vez creada, haga clic derecho sobre ella. Haga clic en <code className="action">VM Policies</code>, y en <code className="action">Edit VM Storage Policies</code>.
...
Modifique su máquina virtual y haga clic <code className="action">VM Options</code>
...
<img className="thumbnail" alt="vMotion cifrado" src="/images/bare-metal-cloud/managed-bare-metal/vm-encrypt/vm-encrypt_06.png" loading="lazy" />
...
<img className="thumbnail" alt="comprobación de la configuración" src="/images/bare-metal-cloud/managed-bare-metal/vm-encrypt/vm-encrypt_07.png" loading="lazy" />

<img className="thumbnail" alt="comprobación de la configuración" src="/images/bare-metal-cloud/managed-bare-metal/vm-encrypt/vm-encrypt_08.png" loading="lazy" />

<img className="thumbnail" alt="comprobación de la configuración" src="/images/bare-metal-cloud/managed-bare-metal/vm-encrypt/vm-encrypt_09.png" loading="lazy" />
