...
Para mover el *datacenter* de su Managed Bare Metal a otro vRack, haga clic en el botón `Mover`
...
Es posible modificar sus parámetros o volver a crearlos siguiendo la guía de [creación de VLAN](/guides/bare-metal-cloud/managed-bare-metal/vlan-creation).
