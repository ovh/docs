...
Todos los cambios que se describen a continuación se deben realizar desde su Managed Bare Metal en vSphere haciendo clic con el botón derecho del ratón en una máquina virtual y, luego, en `«Modificar los parámetros»`.
