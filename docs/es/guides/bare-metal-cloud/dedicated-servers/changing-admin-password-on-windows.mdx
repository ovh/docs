...
En primer lugar, sustituya el netboot por **Arrancar en el disco duro** en el [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es) (ver [Etapa 1](#1-reiniciar-el-servidor-en-modo-de-rescate)). 
...
En el [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es), acceda a la pestaña <code className="action">IPMI</code> para abrir una sesión de KVM.
...
[Utilizar IPMI en un servidor dedicado](/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/)
