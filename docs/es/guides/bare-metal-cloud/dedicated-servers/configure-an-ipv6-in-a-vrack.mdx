...
- IPv6:
    ...
    - [Configurar IPv6 en una instancia Public Cloud](/guides/public-cloud/public-cloud-network-services/configuration-02-how-to-configure-ipv6/).
...
- **Enlace directo:** [vRack](https://manager.eu.ovhcloud.com/#/dedicated/vrack)
...
<img className="thumbnail" alt="página de configuración" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/500.png" loading="lazy" />
...
<img className="thumbnail" alt="Configurar una IPv6 en un vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/20240418-03.png" loading="lazy" />
...
<img className="thumbnail" alt="gestión del vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/700.png" loading="lazy" />
...
<img className="thumbnail" alt="selección del vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/701.png" loading="lazy" />
...
<img className="thumbnail" alt="activar SLAAC" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/702.png" loading="lazy" />
...
- Conéctese al [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es).
...
<img className="thumbnail" alt="Configurar una IPv6 en un vRack para el modo de enrutamiento" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/routed-mode-20240513.png" loading="lazy" />
...
<img className="thumbnail" alt="selección vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/600.png" loading="lazy" />
...
<img className="thumbnail" alt="continuar" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/800.png" loading="lazy" />

La subred enrutada `2001:41d0:abcd::ef10::/60` es accesible a través del siguiente salto `2001:41d0:abcd::ef00::2`.

<img className="thumbnail" alt="continuar" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/801.png" loading="lazy" />
...
<img className="thumbnail" alt="continuar" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/20240418-02.png" loading="lazy" />
