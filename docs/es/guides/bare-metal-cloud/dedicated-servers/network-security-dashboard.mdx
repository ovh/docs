...
- **Enlace directo:** [Security Dashboard](https://manager.eu.ovhcloud.com/#/dedicated/network-security/scrubbing-center)
...
Conéctese a su [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es), haga clic en <code className="action">Network</code> en el menú situado a la izquierda de la pantalla y seleccione <code className="action">Direcciones IP públicas</code>. Asegúrese de que la opción `Modo avanzado` esté activada para ver el estado de la infraestructura anti-DDoS y la configuración de sus componentes.
