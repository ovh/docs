...
Si confirma con `Entrada` sin escribir un nombre, se utilizará el nombre de archivo estándar (`id_rsa` en este ejemplo).
...
Si confirma con la tecla `Intro` sin introducir un nombre, se utilizará el nombre de archivo estándar (`id_rsa` en este ejemplo).
...
Al trabajar desde una línea de comandos **Windows**, haga clic con el botón secundario del mouse para **pegar** el contenido del Portapapeles en la ventana de la línea de comandos. Para **copiar*** una cadena de la ventana de la línea de comandos, resáltela y pulse `Intro`. También puede encontrar estas funciones haciendo clic derecho en la barra de menús de la ventana de la línea de comandos.
