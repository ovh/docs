...
Para instalar WordPress en un servidor, puede seguir [este tutorial](/guides/public-cloud/compute/install-wordpress-on-an-instance/).
...
[Cómo descargar y recuperar datos en un servidor mediante SFTP](/guides/bare-metal-cloud/dedicated-servers/comment-deposer-ou-recuperer-des-donnees-sur-un-serveur-dedie-via-sftp/)
