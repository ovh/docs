...
Para configurar la ruta del registro DNS inverso en el [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es), consulte [nuestra guía dedicada](/guides/bare-metal-cloud/virtual-private-servers/configuring-reverse-dns/).
