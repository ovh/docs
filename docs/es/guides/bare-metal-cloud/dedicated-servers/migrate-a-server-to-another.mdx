...
description: Cómo migrar los datos de un servidor a otro
...
- La forma más sencilla es utilizar un programa adecuado como [SFTP](/guides/bare-metal-cloud/dedicated-servers/comment-deposer-ou-recuperer-des-donnees-sur-un-serveur-dedie-via-sftp/).
...
Para más información, consulte nuestra documentación sobre los [dominios y DNS](/guides/web-cloud/domains/overview/).
