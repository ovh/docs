...
En el [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es) puede especificar un modo de arranque de una lista predefinida: disco principal o rescue.
