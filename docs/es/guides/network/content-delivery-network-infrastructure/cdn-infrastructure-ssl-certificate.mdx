...
![Creación de un certificado SSL](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/ssl_in_progress.png)
...
![Añadir un certificado SSL](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/add_ssl.png)

- Si ya tiene un certificado Let's Encrypt, utilice la opción `Sustituir por mi certificado`.

![Sustituir un certificado SSL](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/change_ssl.png)
