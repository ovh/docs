...
Para ello, en el [área de cliente de OVH](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es) acceda a la sección <code className="action">Dedicado</code>. En la columna izquierda, haga clic en <code className="action">NAS y CDN</code> y seleccione el servicio CDN correspondiente.
