...
Para ello, en el [área de cliente de OVH](/links/manager) acceda a la sección `Dedicado`. En la columna izquierda, haga clic en `NAS y CDN` y seleccione el servicio CDN correspondiente.

Haga clic en el atajo `Añadir un dominio a la CDN`.
...
![Añadir un subdominio a la CDN](/images/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_1.png)
...
![Añadir un backend](/images/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_2.png)
...
![Registro CNAME](/images/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/cname_field.png)
...
Esta información también puede obtenerse utilizando el navegador. Por ejemplo, en Firefox se encuentra en las herramientas de desarrollo, seleccionando `Red` (atajo de teclado: F12). Al hacer clic en el archivo que quiera comprobar, podrá ver la respuesta HTTP y sus cabeceras.
