...
¿Ha cerrado la página de la orden de pedido? Acceda a la página [Mis pedidos](https://manager.eu.ovhcloud.com/#/billing/orders). A continuación, podrá ver el pedido y abonarlo.

### ¿Cómo consultar el estado de un pago?

Abra la página [Mis facturas](https://manager.eu.ovhcloud.com/#/billing/history). Si una factura está pendiente de pago, se le propondrá abonar el saldo.
...
Para ayudarle a gestionar sus pedidos, ponemos a su disposición una [guía detallada](/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/).
