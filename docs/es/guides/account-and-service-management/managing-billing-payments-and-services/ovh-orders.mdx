...
![Pedido de OVH](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order01.png)
...
Para acceder al panel de gestión de pedidos, conéctese al [área de cliente de OVHcloud](/links/manager). A continuación, haga clic en `Ver mis pedidos`.
...
![Resumen de pedidos](/images/assets/screens/control-panel/product-selection/right-column/initials/order-tab.png)
...
Si desea ver el pedido en formato HTML, haga clic en `...` a la derecha de su pedido y, seguidamente, en `Ver la orden de pedido en formato HTML`.

![Resumen de pedidos](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order04.png)
...
* Conéctese a su [área de cliente de OVHcloud](/links/manager). A continuación, haga clic en `Ver mis pedidos` y seleccione el botón `...` delante del pedido.
* Seleccione `Seguimiento del pedido`. El seguimiento del pedido también puede mostrarse haciendo clic en el estado de un pedido en la columna `Estado`.

![Seguimiento de los pedidos](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order05b.png)

Se abrirá una ventana en la que podrá realizar el seguimiento en cuatro pasos.

![Seguimiento de los pedidos](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order06.png)
...
* Conéctese a su [área de cliente de OVHcloud](/links/manager). A continuación, haga clic en `Ver mis pedidos` y seleccione el botón `...` delante del pedido.
* Seleccione `Cancelar el pedido`.

![Cancelación de un pedido](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/cancelorder1.png)

Por último, marque la casilla `Sí, quiero cancelar el pedido` y confirme.

![Confirmación de la cancelación](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/cancelorder2.png)
