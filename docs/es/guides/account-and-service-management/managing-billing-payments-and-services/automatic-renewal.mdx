...
Haga clic en su nombre en la esquina superior derecha y seleccione `Mis soluciones y servicios`.

![productos y servicios](/images/assets/screens/control-panel/product-selection/right-menu/my-solutions-and-services.png)

### Mostrar el tipo de renovación <a id="renewal-type"></a>

La página **Gestión de mis soluciones y servicios** contiene una tabla de gestión de los servicios de OVHcloud. Puede consultar su nombre, el tipo de servicio, la disponibilidad del servicio (`Activo` por defecto), su estado (tipo de renovación, acción a realizar, etc.), la próxima fecha de aplicación de la renovación o de la baja, así como un botón `...` dedicado a las acciones posibles para cada servicio.

![mis servicios](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/my-services-en.png)
...
A la derecha de un servicio, haga clic en el botón `...` en la columna `Acciones` y seleccione la acción que desee.
...
![configurar la renovación](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/configure-renewal-en.png)

Haga clic en la acción `Configurar la renovación`. Según el servicio elegido, puede configurarlo con renovación manual o elegir la frecuencia de renovación automática. En su caso, podrá elegir el tipo de renovación y la frecuencia de la misma.

![configurar la renovación](/images/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/configure-renew-en.png)
...
![anticipar el pago](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/forward-payment-en.png)
...
>
> Una vez que haya elegido el tipo de pedido, haga clic en `Aceptar`.
>
...
![dar de baja](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/cancel-en.png)
...
![Renovar el servicio](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/renew-service-en.png)
...
![Pagar una factura](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/pay-bill-en.png)
...
Solo tiene que elegir la acción `Abonar mi factura` que le redirigirá a una plataforma de pago en línea.
...
Puede realizar acciones agrupadas seleccionando varios servicios en la tabla y haciendo clic en el botón `Acciones`.

![acciones agrupadas](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/batch-actions-en.png)
