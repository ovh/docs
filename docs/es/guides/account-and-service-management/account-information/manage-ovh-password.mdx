...
- En la página [Seguridad de la cuenta](https://manager.eu.ovhcloud.com/#/account/useraccount/security), haga clic en <code className="action">Editar</code> (a la derecha de "Contraseña").
