...
En la página [Seguridad de la cuenta](https://manager.eu.ovhcloud.com/#/account/useraccount/security), haga clic en <code className="action">Activar la doble autenticación</code>.
...
Conéctese al [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es) e introduzca su identificador (o dirección de correo electrónico principal) y contraseña.
...
Para eliminar un dispositivo, acceda a la página [Seguridad de la cuenta](https://manager.eu.ovhcloud.com/#/account/useraccount/security) y haga clic en los <code className="action">...</code> a la derecha de su dispositivo que quiera eliminar y, por último, en <code className="action">Eliminar</code>.
...
En primer lugar, acceda a [la página de autenticación en el área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es).
