...
En primer lugar, verifique si el correo que ha recibido también es visible en la página [Mis mensajes](https://manager.eu.ovhcloud.com/#/communication) de su área de cliente de OVHcloud. Allí encontrará copias de los correos oficiales enviados por OVHcloud.
...
Abra la página [Seguridad de la cuenta](https://manager.eu.ovhcloud.com/#/account/useraccount/security) y cambie inmediatamente su contraseña.<br/>
