...
| **Fonction** | **Description** | **Formats disponibles** | **Modèle de migration** | **Documentation disponible** |
| --- | --- | --- | --- | --- |
| L'API OVHcloud, CLI et SDK Python| Gestion, automatisation et migration des notebooks via API REST, CLI AI et SDK Python propres à OVHcloud. | JSON, YAML, Python | **Entrante** : outils et interfaces de gestion disponibles par défaut <br/>**Sortante** : les API et CLI dépendront des environnements cibles et peuvent nécessiter une adaptation. | [AI Notebooks - Premiers pas](/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/) |
