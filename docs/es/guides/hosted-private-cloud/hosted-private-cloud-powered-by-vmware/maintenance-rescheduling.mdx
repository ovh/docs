...
- Tienes acceso a tu [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es) o al panel de [administración de sus servicios a través de la API](https://eu.api.ovh.com/).

## Procedimiento

:::tip[Success]
Los mensajes de correo enviados por OVHcloud también pueden accederse desde su [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es).<br/>
...
Conéctese al [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es) con una cuenta de administrador.
...
<img className="thumbnail" alt="modificación de horario" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/maintenance-rescheduling/maintenance-date-edition01.png" loading="lazy" />
...
<img className="thumbnail" alt="modificación de horario" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/maintenance-rescheduling/maintenance-date-edition02.png" loading="lazy" />
