...
Haga clic en el menú `Servicios` y a continuación seleccione `vSphere DRS`.

Haga clic en `Modificar`y active la funcionalidad con el botón `vSphere DRS`.

![Activación del DRS](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs01.png)
...
![Automatización DRS](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs02.png)
...
![Opciones adicionales DRS](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs03.png)
...
![opciones avanzadas drs](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs05.png)

### Reglas DRS

Para gestionar las reglas de MV/host, diríjase a la pestaña `Configurar`.

![reglas drs](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs06.png)
...
![creación reglas drs](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs07.png)
