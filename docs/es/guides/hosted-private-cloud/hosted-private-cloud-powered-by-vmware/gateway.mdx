...
* Having added the private gateway network to [restrictions per source IP](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/manager-ovh-private-cloud).
