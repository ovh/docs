...
description: Cómo protegerse de la vulnerabilidad L1TF
...
Aunque OVHcloud actualiza el vCenter, usted deberá encargarse de actualizar los hosts ESXi. El parche está disponible en el [Update Manager](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-update-manager/).
...
<img className="thumbnail" alt="Mensaje de alerta host" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/check-and-block-l1tf/warningMsg.png" loading="lazy" />
...
<img className="thumbnail" alt="Activar mitigación" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/check-and-block-l1tf/enableMitigation.png" loading="lazy" />
...
<img className="thumbnail" alt="Borrar mensaje de alerta" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/check-and-block-l1tf/deleteWarning.png" loading="lazy" />
