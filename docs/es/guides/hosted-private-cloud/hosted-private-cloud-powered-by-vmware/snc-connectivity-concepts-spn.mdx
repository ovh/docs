...
<img className="thumbnail" alt="SPN subnet rules" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/snc-connectivity-concepts-spn/SNC-SPN-GW-Support.svg" loading="lazy" />

**Behavior using next-hop feature:**

<img className="thumbnail" alt="next-hop feature" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/snc-connectivity-concepts-spn/SNC-SPN-Subnet-NH.svg" loading="lazy" />
...
<img className="thumbnail" alt="Topology BGP" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/snc-connectivity-concepts-spn/SNC-SPN-BGP-v0.svg" loading="lazy" />
