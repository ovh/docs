...
Todos los cambios que se describen a continuación se deben realizar desde su Private Cloud en vSphere haciendo clic con el botón derecho del ratón en una máquina virtual y, luego, en `«Modificar los parámetros»`.

![Édition des ressources](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware01.png)

En este menú, puede aumentar los recursos de su máquina virtual. 

![Édition des ressources](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware02.png)
...
![Ajout de CPU](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware03.png)

También puede reservar una cierta frecuencia (mínima y máxima) y especificar el número de núcleos por ranura.

Si marca la casilla `«Conexión de la unidad central de procesamiento (CPU) en caliente»`, podrá cambiar estos valores cuando se inicie la máquina virtual.
...
![Ajout de mémoire](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware04.png)
...
![Ajout de stockage](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware05.png)
...
![Ajout du réseau](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware06.png)

Esta interfaz es útil en caso de que falle la red. Puede comprobar que el *id. del puerto* se corresponda con el especificado en las pestañas `«Redes»` y `«Puertos»` de la tarjeta en cuestión.

### El lector de CD/DVD

El lector de CD/DVD permite, por ejemplo, montar una imagen ISO en su máquina virtual.

![Ajout d'un lecteur CD / DVD](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware07.png)
...
![Ajout de périphériques](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware08.png)
