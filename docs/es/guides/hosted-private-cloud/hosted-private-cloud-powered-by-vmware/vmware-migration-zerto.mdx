...
> [Move2Cloud - Migrating VMware Workloads to SecNumCloud Hosted Private Cloud with Zerto](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-migration-zerto-secnumcloud)
...
You can find more about network planning in [NSX-T - First steps](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/nsx-01-first-steps).
...
For step-by-step instructions, refer to [Authorise IPs to connect to vCenter](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/autoriser-des-ip-a-se-connecter-au-vcenter).
...
For instructions, refer to the [IAM setup guide](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-iam-getting-started).
...
Refer to [NSX-T – First steps](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/nsx-01-first-steps) for details on creating segments and assigning them to VMs.
...
You can find an overview of how NSX handles these features in [NSX-T – First steps](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/nsx-01-first-steps).
...
Full details can be found in [Zerto Virtual Replication on OVHcloud](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-customer-to-ovh).
...
Details and parameters are available in [Zerto VPN Setup on OVHcloud](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-customer-to-ovh).
...
See [VMware Storage vMotion](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/storage-vmotion) for full details.
