...
Para contratar un bloque de IP adicional en su **Hosted Private Cloud**, acceda al área de cliente de OVHcloud. En el menú `Hosted Private Cloud`, acceda a la sección `IP` en la columna izquierda y haga clic en `Contratar IP adicionales`. Seleccione su solución **Hosted Private Cloud** en el menú desplegable antes de pasar a la siguiente etapa.
...
Podrá seguir la migración del bloque de IP desde su [área de cliente de OVHcloud](/links/manager) en el menú `Hosted Private Cloud` > `Private Cloud`. Haga clic en su servicio Hosted Private Cloud y, a continuación, en la pestaña `Operaciones`.

La referencia de la operación es «removeIpRipeBlock».

![operaciones manager](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ajout-de-bloc-ip/operations.png)

A continuación, la IP aparecerá en el `Aparcamiento de IP`.
