...
- Estar conectado a la [interfaz vSphere](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vsphere-interface-connexion/).
...
<img className="thumbnail" alt="Principio del DRS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs0.png" loading="lazy" />
...
<img className="thumbnail" alt="Activación del DRS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs01.png" loading="lazy" />
...
<img className="thumbnail" alt="Automatización DRS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs02.png" loading="lazy" />
...
<img className="thumbnail" alt="Opciones adicionales DRS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs03.png" loading="lazy" />
...
<img className="thumbnail" alt="opciones avanzadas drs" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs05.png" loading="lazy" />

### Reglas DRS

Para gestionar las reglas de MV/host, diríjase a la pestaña `Configurar`.

<img className="thumbnail" alt="reglas drs" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs06.png" loading="lazy" />
...
La cuarta regla, «máquinas virtuales a máquinas virtuales», viene explicada en nuestra guía sobre la [funcionalidad HA](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/).

<img className="thumbnail" alt="creación reglas drs" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs07.png" loading="lazy" />
