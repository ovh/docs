...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es) and add a Additional IP address to your [vRack](https://www.ovhcloud.com/es-es/network/vrack/).
