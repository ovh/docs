...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es) and open the management section of your [vRack](https://www.ovhcloud.com/es-es/network/vrack/). Verify the Additional IP address used by the Nutanix Cluster.
