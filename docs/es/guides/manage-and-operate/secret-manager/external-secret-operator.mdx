...
- You must have [ordered an OKMS domain](/guides/manage-and-operate/kms/kms-quick-start) or [created a first secret](/guides/manage-and-operate/secret-manager/secret-manager-ui).
