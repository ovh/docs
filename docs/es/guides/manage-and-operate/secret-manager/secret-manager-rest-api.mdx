...
- Have [ordered an OKMS domain](/guides/manage-and-operate/kms/kms-quick-start) or [created a first secret](/guides/manage-and-operate/secret-manager/secret-manager-ui).
...
The REST APIs are one of the two API sets offered by the Secret Manager, along with the [Hashicorp Vault KV2 compliant API](/guides/manage-and-operate/secret-manager/secret-manager-kv2-api).
...
![swagger](/images/guides/manage-and-operate/secret-manager/secret-manager-rest-api/swagger.png)
...
![public-swagger-ui](/images/guides/manage-and-operate/secret-manager/secret-manager-rest-api/public-swagger-ui.png)
...
![firefox-cert-manager](/images/guides/manage-and-operate/secret-manager/secret-manager-rest-api/firefox-cert-manager.png)
...
![chromium-cert-manager](/images/guides/manage-and-operate/secret-manager/secret-manager-rest-api/chromium-cert-manager.png)
...
![certificate-identification](/images/guides/manage-and-operate/secret-manager/secret-manager-rest-api/firefox-identify-with-certificate.png)
