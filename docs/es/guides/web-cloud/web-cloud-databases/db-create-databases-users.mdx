...
Acceda al [área de cliente de OVHcloud](/links/manager). Haga clic en la pestaña `Web Cloud` y seleccione `Web Cloud Databases`. Seleccione el nombre del servidor de bases de datos.

Abra la pestaña `Bases de datos` y haga clic en `Añadir una base de datos.`
...
- **Permisos** (solo si está marcada la casilla `Crear un usuario`): son los permisos que se asociarán al usuario sobre la base de datos. Para un uso convencional, seleccione `Administrador`. Más adelante podrá modificar los permisos.
...
Acceda a la pestaña `Usuarios y permisos` y haga clic en `Añadir un usuario`
...
Para administrar los permisos de cada usuario, acceda al [área de cliente de OVHcloud](/links/manager). Haga clic en la pestaña `Web Cloud` y seleccione `Web Cloud Databases`. Seleccione el nombre del servidor de bases de datos. Haga clic en la pestaña `Usuarios y permisos`.

Haga clic en el botón `...` a la derecha del usuario correspondiente y, seguidamente, en `Gestionar los permisos`.
...
Para eliminar una base de datos en su servidor de bases de datos, abra la pestaña `Bases de datos`, haga clic en el botón `...` situado a la derecha de la base de datos correspondiente y seleccione `Eliminar la base`.
