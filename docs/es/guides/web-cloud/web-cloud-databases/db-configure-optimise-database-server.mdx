...
Desde el [área de cliente de OVHcloud](/links/manager), haga clic en `Web Cloud Databases` y seleccione el servicio de bases de datos correspondiente. Por defecto, se abrirá la pestaña `Información general`.
...
![Información general](/images/assets/screens/control-panel/product-selection/web-cloud/web-cloud-databases/general-information/general-information.png)
...
Desde el [área de cliente de OVHcloud](/links/manager), haga clic en `Web Cloud Databases` y seleccione la instancia Web Cloud Databases correspondiente.

Para ello, abra la pestaña `IP autorizadas` y haga clic en el botón `Añadir una dirección IP/máscara`.
...
### Modificar su solución Web Cloud Databases <a id="modify-ram-web-cloud-db"></a>
...
>
> Para asociar una solución Web Cloud Databases a un alojamiento web **Performance**, consulte nuestra guía "[Desvincular mi solución Web Cloud Databases de un alojamiento web](/guides/web-cloud/web-cloud-databases/db-detach-from-web-hosting)".
>
...
Para cambiar su solución Web Cloud Databases, acceda al [área de cliente de OVHcloud](/links/manager). Haga clic en la pestaña `Web Cloud` y seleccione `Web Cloud Databases`. Seleccione el nombre del servidor de bases de datos.
En la pestaña **"Información general"** que se muestra por defecto, haga clic en `...` a la derecha de la indicación "RAM" y luego en `Cambiar la cantidad de RAM` para acceder al pedido de esta modificación.
...
Elija la cantidad de RAM deseada y haga clic en el botón `Siguiente`. A continuación, elija la duración deseada.
...
Acceda a su área de cliente (sección IP) Haga clic en la pestaña `Web Cloud` y seleccione `Web Cloud Databases`. Seleccione el nombre de su servidor Web Cloud Databases.

#### Instancia MySQL y MariaDB

- Abra la pestaña `Configuración`:

En el cuadro **"Configuración general de MySql"** encontrará la configuración actualmente establecida para su base de datos. Puede modificarla directamente y hacer clic en `Aplicar`.

![Web Cloud Databases](/images/assets/screens/control-panel/product-selection/web-cloud/web-cloud-databases/configuration/general-configuration-of-mysql.png)
...
Realice los cambios necesarios y haga clic en `Confirmar`.
...
En el recuadro **"Configuración General de PostgreSQL"** encontrará la configuración actualmente definida para su base de datos. Puede modificarla directamente y hacer clic en `Aplicar`.

![Web Cloud Databases](/images/assets/screens/control-panel/product-selection/web-cloud/web-cloud-databases/configuration/general-configuration-of-postgresql.png)
...
Además, puede activar extensiones en sus bases de datos. Para ello, abra la pestaña `Bases de datos` y haga clic en el icono de la tabla de la base de datos en la columna **"Extensiones"**
...
Para modificar esta versión, haga clic en `Editar la versión`.
...
Introduzca este comando en phpMyAdmin haciendo clic en la **base de datos**, en la sección **"SQL"**, y haciendo clic en `Ejecutar`:
...
Para ello, introduzca el comando en phpMyAdmin, en la sección **"SQL"** y haga clic en `Ejecutar`.
...
Acceda a su área de cliente (sección IP) Haga clic en la pestaña `Web Cloud` y seleccione `Web Cloud Databases`. Seleccione el nombre del servidor de bases de datos.
