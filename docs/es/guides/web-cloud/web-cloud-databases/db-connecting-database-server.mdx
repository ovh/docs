...
Conéctese a su [área de cliente de OVHcloud](/links/manager) y acceda a la sección `Web Cloud`. En la columna izquierda, haga clic en la pestaña `Web Cloud Databases` y seleccione el nombre del servidor de bases de datos.
...
> [!warning]
>
> Si utiliza una solución Web Cloud Databases/ SQL Privado, no olvide autorizar su IP utilizando la guía sobre la [configuración de su servidor de bases de datos](/guides/web-cloud/web-cloud-databases/db-configure-optimise-database-server).
>
...
![](/images/assets/screens/other/web-tools/squirrel/aliases.png) ejecutar SQuirreL SQL
...
![](/images/assets/screens/other/web-tools/squirrel/add-alias.png) conexión a la base de datos

- Confirme con el botón `Connect.

![](/images/assets/screens/other/web-tools/squirrel/connect-to-mysql.png) confirmación de la conexión

Se establecerá la conexión a la base de datos:

![](/images/assets/screens/other/web-tools/squirrel/general-dashboard.png) conexión a la base de datos
...
> [!info]
>
> Para un servidor SQL privado, esta acción solo es posible por [SSH](/guides/web-cloud/web-hosting/ssh-on-webhosting) desde un alojamiento compartido de OVHcloud.
...
```php
<?php
$db = new PDO('mysql:host=host;port=puerto;dbname=nombre_base_de_datos', 'username', 'password');
?>
```
...
![config connection](/images/assets/screens/other/web-tools/squirrel/add-alias.png) conexión a la base de datos

- Confirme con el botón `Connect.

![valid connection](/images/assets/screens/other/web-tools/squirrel/connect-to-mysql.png) confirmación de la conexión

Se establecerá la conexión a la base de datos:

![config connection](/images/assets/screens/other/web-tools/squirrel/general-dashboard.png) conexión a la base de datos
