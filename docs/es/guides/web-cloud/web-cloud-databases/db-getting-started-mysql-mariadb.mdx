...
- Haber consultado la [guía de inicio de Web Cloud Databases](/guides/web-cloud/web-cloud-databases/db-getting-started).
...
![configuración de la conexión](/images/assets/screens/other/web-tools/squirrel/add-alias.png)

- Confirme con el botón `Connect`.

![confirmación de la conexión](/images/assets/screens/other/web-tools/squirrel/connect-to-mysql.png)

Se establecerá la conexión a la base de datos:

![conexión a la base de datos](/images/assets/screens/other/web-tools/squirrel/general-dashboard.png)
...
> [!info]
>
> En algunos casos, la RAM disponible en la instancia Cloud Databases puede no permitir la exportación o importación deseadas. En ese caso, le recomendamos que utilice la herramienta OVHcloud en el área de cliente. Si lo necesita, consulte la guía ["Primeros pasos con el servicio Cloud Databases"](/guides/web-cloud/web-cloud-databases/db-getting-started).
>
