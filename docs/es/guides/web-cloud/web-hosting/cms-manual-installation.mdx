...
Para obtener la dirección IP de su plan de hosting, conéctese a su [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es) en la sección <code className="action">Web Cloud</code> y seleccione su plan de hosting en la sección <code className="action">Alojamientos</code>.<br/>
...
Si tiene un plan Web Cloud Databases en MySQL o MariaDB y quiere utilizarlo para instalar manualmente su CMS, consulte nuestra documentación sobre la [creación de una base de datos en un servicio Web Cloud Databases](/guides/web-cloud/web-cloud-databases/create-db-and-user-on-db-server/).
...
- Para conectarse a una base de datos en un databases de Web Cloud, consulte [esta guía](/guides/web-cloud/web-cloud-databases/connecting-to-database-on-database-server/).
