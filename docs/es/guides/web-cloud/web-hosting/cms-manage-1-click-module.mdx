...
También puede consultar el mensaje de correo electrónico recibido al crear el módulo desde su [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es): haga clic en su nombre en la esquina superior derecha de la pantalla y, en el menú que aparece, haga clic en <code className="action">Emails de servicio</code>.
...
Para eliminar el módulo en 1 clic, acceda al [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es), haga clic en <code className="action">Web Cloud</code>, <code className="action">Alojamientos</code>, el alojamiento correspondiente y seleccione <code className="action">Módulos en 1 clic</code>.
