...
Para más información, consulte los detalles de nuestros [planes de hosting](https://www.ovhcloud.com/es-es/web-hosting/) y nuestra guía "[Primeros pasos con su solución Web Cloud Databases](/guides/web-cloud/web-cloud-databases/starting-with-clouddb/)".
...
Solo los servidores de bases de datos [Web Cloud Databases](https://www.ovhcloud.com/es-es/web-cloud/databases/) permiten a servidores externos conectarse a ellos. Para ello, debe haber autorizado previamente la dirección IP de su servidor externo en su servidor de bases de datos. Si necesita ayuda, consulte nuestra guía "[Primeros pasos con su solución Web Cloud Databases](/guides/web-cloud/web-cloud-databases/starting-with-clouddb/)".
