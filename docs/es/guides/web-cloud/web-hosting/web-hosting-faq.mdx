...
1. Conéctese a su [área de cliente de OVHcloud](/links/manager) y acceda a la sección `Web Cloud`.
2. Haga clic en el menú `Alojamientos` y seleccione el alojamiento web correspondiente.
...
1. Acceda a la [interfaz de conexión al área de cliente de OVHcloud](/links/manager).
 2. Haga clic en el enlace `¿Ha olvidado el identificador o la contraseña?`, situado bajo la ventana de inicio de sesión.
...
1. Conéctese a su [área de cliente de OVHcloud](/links/manager) y acceda a la sección `Web Cloud`.
2. Haga clic en el menú `Alojamientos` y seleccione el alojamiento web correspondiente.
3. En la nueva página, haga clic en la pestaña `Bases de datos`.
...
1. Conéctese a su [área de cliente de OVHcloud](/links/manager) y acceda a la sección `Web Cloud`.
2. Haga clic en el menú `Correo electrónico` (o en el menú `MX Plan` si utiliza la versión beta del área de cliente de OVHcloud) y seleccione el dominio correspondiente.
3. En la nueva página, haga clic en la pestaña `Correo electrónico`.
4. En la tabla que aparece, haga clic en el botón `...` situado a la derecha de la dirección de correo electrónico correspondiente y seleccione `Cambiar la contraseña`.
...
1. Conéctese a su [área de cliente de OVHcloud](/links/manager) y acceda a la sección `Web Cloud`.
2. Haga clic en el menú `Alojamientos` y seleccione el alojamiento web correspondiente.
3. En la nueva página, haga clic en la pestaña `Multisitio`.
...
1. Conéctese a su [área de cliente de OVHcloud](/links/manager) y acceda a la sección `Web Cloud`.
2. Haga clic en el menú `Alojamientos` y seleccione el alojamiento web correspondiente.
3. En la nueva página, haga clic en la pestaña `Certificados SSL`.
...
1. Conéctese a su [área de cliente de OVHcloud](/links/manager) y acceda a la sección `Web Cloud`.
2. Haga clic en el menú `Alojamientos` y seleccione el alojamiento web correspondiente.
3. En la página que aparece, en el recuadro **Suscripción**, haga clic en el botón `...` a la derecha de la mención `Solución` y luego en `Cambiar de plan`.
4. A continuación, seleccione la nueva suscripción y su duración. Acepte los contratos correspondientes y haga clic en `Enviar`.
...
1. Conéctese a su [área de cliente de OVHcloud](/links/manager) y acceda a la sección `Web Cloud`.
2. Haga clic en el menú `Alojamientos` y seleccione el alojamiento web correspondiente.
3. En la página que se abre, en el recuadro **Configuración**, haga clic en el botón `...` a la derecha de la mención `Direcciones de correo` y seleccione `Desvincular mi opción de correo`.
...
1. Conéctese a su [área de cliente de OVHcloud](/links/manager) y acceda a la sección `Web Cloud`.
2. Haga clic en el menú `Alojamientos` y seleccione el alojamiento web correspondiente.
3. En la página que se abre, en el recuadro **Configuración**, haga clic en el botón `...` a la derecha de la mención `Web Cloud Databases` y seleccione `Desvincular`.
...
1. Conéctese a su [área de cliente de OVHcloud](/links/manager) y acceda a la sección `Web Cloud`.
2. Haga clic en el menú `Web Cloud Databases` y seleccione la solución Web Cloud Databases correspondiente.
3. En la página que se abre, en el recuadro **Información general**, haga clic en el botón `...` a la derecha de la mención `RAM` y luego en `Cambiar la cantidad de RAM`.
4. Siga las instrucciones para contratar la cantidad de RAM deseada y continúe hasta la validación del pedido.

:::tip

Si lo necesita, consulte también la sección "*Modificar su servicio Web Cloud Databases*" de nuestra guía "[Configurar un servicio Web Cloud Databases](/guides/web-cloud/web-cloud-databases/db-configure-optimise-database-server)".
...
1. Conéctese a su [área de cliente de OVHcloud](/links/manager) y acceda a la sección `Web Cloud`.
2. Haga clic en su nombre en la esquina superior derecha y seleccione `Mis soluciones y servicios`.
...
1. Conéctese a su [área de cliente de OVHcloud](/links/manager) y acceda a la sección `Web Cloud`.
2. Haga clic en el menú `Alojamientos` y seleccione el alojamiento web correspondiente.
3. En la nueva página, haga clic en la pestaña `Módulos en un clic`.
4. En la tabla que aparece, haga clic en el botón `...` situado a la derecha en la línea del *módulo en 1 clic* correspondiente y seleccione `Eliminar el módulo`.
...
2. Haga clic en el menú `Alojamientos` y seleccione el alojamiento web correspondiente.
3. En la nueva página, haga clic en la pestaña `Bases de datos`.
4. En la tabla que aparece, haga clic en el botón `...` situado a la derecha de la fila de la base de datos correspondiente y seleccione `Eliminar la base de datos`.
...
2. Haga clic en el menú `Alojamientos` y seleccione el alojamiento web correspondiente.
3. Abra la pestaña `FTP - SSH`.
4. En la nueva página que aparece, haga clic en el botón `Restaurar una copia de seguridad`.
...
2. Haga clic en el menú `Alojamientos` y seleccione el alojamiento web correspondiente.
3. En la nueva página, haga clic en la pestaña `Bases de datos`.
4. En la tabla que aparece, haga clic en el botón `...` situado a la derecha de la fila de la base de datos correspondiente y seleccione `Restaurar una copia de seguridad`.
...
6. Una vez seleccionada la copia de seguridad, haga clic en el botón `...` situado a la derecha de la copia de seguridad que quiera restaurar y seleccione `Restaurar la copia de seguridad`.
...
1. Conéctese a su [área de cliente de OVHcloud](/links/manager) y acceda a la sección `Web Cloud`.
2. Haga clic en el menú `Dominios` y seleccione el dominio correspondiente.
3. En la nueva página, haga clic en la pestaña `Servidores DNS`.
4. Anote los nombres de los servidores DNS indicados y acceda a la pestaña `Zona DNS` (a la derecha de la pestaña `Servidores DNS`).
...
Los `Destinos` (servidores DNS) de las entradas de tipo `NS` declaradas en la zona DNS del nombre de dominio **son idénticas** a las recuperadas en la pestaña `Servidores DNS`.

En este caso, su dominio (o su subdominio en *www*) apunta a la dirección IP de nuestro servidor de redirección (213.186.33.5).

1. Conéctese a su [área de cliente de OVHcloud](/links/manager) y acceda a la sección `Web Cloud`.
2. Haga clic en el menú `Dominios` (o en el menú `Zonas DNS` si utiliza la versión beta del área de cliente de OVHcloud) y seleccione el dominio correspondiente.
3. A continuación, abra la pestaña `Zona DNS`.
...
5. Haga clic en el botón `...` situado a la derecha de la línea y seleccione `Modificar el registro`.
...
Los `Destinos` (servidores DNS) de las entradas de tipo `NS` declaradas en la zona DNS del nombre de dominio **no son idénticas** a las recuperadas en la pestaña `Servidores DNS`. Sin embargo, los `Destinos` (servidores DNS) tienen una de las siguientes formas:
...
Si alguno de sus servidores DNS declarados en la pestaña `Servidores DNS` tiene la forma siguiente: `sdnsX.ovh.net`, `sdnsX.ovh.ca`, `vpsXXXXXX.ovh.net` o `vpsXXXXXX.ovh.ca` (donde cada `X` designa un número comprendido entre **0** y **9**), consulte directamente el **Caso n°3**.
...
En este caso, el dominio no utiliza los servidores DNS adecuados de OVHcloud para aplicar la configuración de la zona DNS que se indica en la pestaña `Zona DNS`.

Para corregirlo, siga estos pasos:

1. Conéctese a su [área de cliente de OVHcloud](/links/manager) y acceda a la sección `Web Cloud`.
2. Haga clic en el menú `Dominios` y seleccione el dominio correspondiente.
3. A continuación, abra la pestaña `Servidores DNS` en la columna izquierda.
4. En la nueva página, haga clic en el botón `Cambiar los servidores DNS`.
5. A continuación, seleccione la opción `Utilizar los DNS por defecto de OVHcloud` y haga clic en el botón `Aplicar la configuración`.
...
2. Haga clic en el menú `Alojamientos` y seleccione el alojamiento web correspondiente.
3. Abra la pestaña `FTP - SSH`.
4. En la nueva página, haga clic en el botón `Restaurar una copia de seguridad`.
5. En la nueva ventana, seleccione la fecha de la copia de seguridad que desea restaurar y continúe hasta que comience la restauración.
