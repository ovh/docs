...
- Según el método utilizado, tener acceso a la gestión del plan de hosting desde el [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es) o disponer de la contraseña FTP necesaria para conectarse al espacio de almacenamiento. 
...
- El estado de mantenimiento aparecerá en el [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es). En la sección <code className="action">Web Cloud</code>, haga clic en su servicio en la sección <code className="action">Alojamientos</code> y seleccione la pestaña <code className="action">Información general</code>.
