...
Si utiliza una base de datos en una solución **Web Cloud Databases**, consulte nuestra guía sobre [la conexión a la base de datos de una solución Web Cloud Databases](/guides/web-cloud/web-cloud-databases/connecting-to-database-on-database-server/).
