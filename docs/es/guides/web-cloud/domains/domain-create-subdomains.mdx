...
Para desbloquear la creación de direcciones de correo Exchange personalizadas con un subdominio, conéctese al [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es) y seleccione <code className="action">Web Cloud</code>. Haga clic en <code className="action">Microsoft</code> en la columna de la izquierda y, a continuación, en <code className="action">Exchange</code>. A continuación, seleccione la plataforma Exchange que quiera utilizar con su subdominio. A continuación, abra la pestaña <code className="action">Dominios asociados</code> y haga clic en el botón <code className="action">Añadir un dominio</code> situado a la derecha.
...
Para desbloquear la creación de direcciones Email Pro personalizadas con un subdominio, conéctese al [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es) y seleccione <code className="action">Web Cloud</code>. Haga clic en <code className="action">Email Pro</code> y seleccione la plataforma Email Pro que quiera utilizar con su subdominio. En la nueva página, abra la pestaña <code className="action">Dominios asociados</code> y haga clic en el botón <code className="action">Añadir un dominio</code> situado a la derecha.
