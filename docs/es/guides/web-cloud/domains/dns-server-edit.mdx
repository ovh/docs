...
- El *registro* que gestiona la extensión de su dominio (por ejemplo, el registro de las extensiones *.fr*) debe ser informado de la modificación DNS realizada en OVHcloud. Siga la progresión de esta operación en la página [Operaciones en curso](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/web/ongoing-operations).
