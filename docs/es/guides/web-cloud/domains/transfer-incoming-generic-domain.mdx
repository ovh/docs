...
El proceso de transferencia puede reanudarse desde la página [Operaciones en curso](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/web/ongoing-operations).
...
Una vez finalizado el procedimiento de transferencia, podrá administrar su nombre de dominio desde la página [Dominios](https://manager.eu.ovhcloud.com/#/web-domains/domain).
