---
title: Transferir un nombre de dominio O2Switch a OVHcloud
description: Descubra diferentes datos relativos a la transferencia de un nombre de dominio O2Switch a OVHcloud
lastUpdated: 2026-02-10
---

## Objetivo

Para transferir un nombre de dominio O2Switch es necesario seguir un procedimiento específico.

**Descubra cómo transferir un nombre de dominio O2Switch a OVHcloud**
...
- El nombre de dominio está registrado en el agente registrador O2Switch.
...
Para desbloquear el nombre de dominio y obtener el código de transferencia, siga los pasos descritos en la [documentación dedicada de O2Switch](https://faq.o2switch.fr/espace-client/recuperer-code-de-transfert).
