...
Posteriormente, podrá administrar su nombre de dominio conectándose a su [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es).
...
<Tabs>
  <Tab label="Paso 1">
    Acceda a la página [Mis soluciones y servicios](https://manager.eu.ovhcloud.com/#/billing/autorenew/services).
  </Tab>
  <Tab label="Paso 2">
...
:::tip[Success]
Consulte todos los detalles en nuestra guía "[Cómo renovar mis servicios de OVHcloud](/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/)".
...
Realice un [procedimiento de recuperación de contactos](https://www.ovh.es/cgi-bin/es/procedure/procedureChangeContacts.cgi) para que su nombre de dominio se gestione íntegramente desde su [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es). Así no necesitará contactar con la persona que gestionaba anteriormente su nombre de dominio.
...
- **Desde su área de cliente de OVHcloud**: Si la zona DNS activa de su nombre de dominio se gestiona en OVHcloud, acceda a la página [Zonas DNS](https://manager.eu.ovhcloud.com/#/web/zone) para visualizar todos los registros DNS declarados para su nombre de dominio.
...
<Tabs>
  <Tab label="Paso 1">
    Acceda a la página [Zonas DNS](https://manager.eu.ovhcloud.com/#/web/zone) y haga clic en el botón <code className="action">Contratar</code> en la parte superior derecha de la tabla que aparece.
  </Tab>
  <Tab label="Paso 2">
...
<Tabs>
  <Tab label="Paso 1">
    Acceda a la página [Zonas DNS](https://manager.eu.ovhcloud.com/#/web/zone) y seleccione el subdominio correspondiente.
...
:::tip[Success]
Si no ha recibido este e-mail, compruebe su correo no deseado o acceda a la página [Mi cuenta](https://manager.eu.ovhcloud.com/#/account/useraccount/dashboard) y haga clic en la pestaña <code className="action">E-mails recibidos</code>.
...
<Tabs>
  <Tab label="Paso 1">
    Acceda a la página [Zonas DNS](https://manager.eu.ovhcloud.com/#/web/zone) y compruebe si el nombre de dominio en cuestión aparece.
...
Si la pestaña no aparece en su [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es), la opción "GLUE" no está disponible para su nombre de dominio.
...
En su [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es), este mensaje indica únicamente que la zona DNS creada para su nombre de dominio no es su zona DNS activa.
...
<Tabs>
  <Tab label="Paso 1">
    Acceda a la página [Dominios](https://manager.eu.ovhcloud.com/#/web-domains/domain) y compruebe si el nombre de dominio en cuestión aparece.
...
[Alojamiento web - FAQ](/guides/web-cloud/web-hosting/faq-web-hosting/)
