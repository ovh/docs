...
Para eliminar la dirección de correo electrónico MX Plan (p. ej.: `contact@mydomain.ovh`), siga nuestra guía "[Eliminar una cuenta de correo electrónico](/guides/web-cloud/email-and-collaborative-solutions/common-email-features/email-reset-account/) ".
