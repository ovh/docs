...
:::info
Si utiliza Outlook para Windows, consulte nuestra guía [Configurar una cuenta Email Pro en Outlook para Windows](/guides/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-outlook-2016/).
...
Haga clic en [este enlace](https://manager.eu.ovhcloud.com/#/web/email_pro) para acceder a la sección <code className="action">Email Pro</code>. El nombre del servidor aparece en el marco **Conexión** de la pestaña <code className="action">Información general</code>.
