...
- **Si ya tiene una cuenta configurada**, haga clic en `Herramientas` en el menú superior y luego en `Cuentas`. A continuación, haga clic en el botón `+` situado en la esquina inferior izquierda y seleccione `Nueva cuenta`.

![Email Pro](/images/guides/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-outlook-2016-mac/configuration-outlook-2016-mac-step1.png)

Introduzca su dirección de correo electrónico y haga clic en `Continuar`. Seleccione el tipo `IMAP` o `POP` e introduzca la información solicitada.
...
Una vez introducidos los datos, haga clic en el botón `Agregar cuenta`. Si son correctos, la aplicación se conectará a la cuenta.

![Email Pro](/images/guides/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-outlook-2016-mac/configuration-outlook-2016-mac-step2.png)
