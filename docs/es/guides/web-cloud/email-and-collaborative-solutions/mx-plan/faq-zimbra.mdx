...
Consulte nuestra página "[Configurar una dirección de correo electrónico de Zimbra en un cliente de correo](/guides/web-cloud/email-and-collaborative-solutions/zimbra/zimbra-mail-apps/)".
...
1. Inicie sesión en su [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es).
