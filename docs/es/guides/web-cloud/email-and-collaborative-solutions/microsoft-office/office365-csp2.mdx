...
Para contratar un servicio Office 365 Reseller, acceda al [área de cliente de OVHcloud](/links/manager). Una vez conectado, seleccione `Sunrise` en la barra superior y haga clic en `Office 365 Reseller`.
...
- Haga clic en `Contratar` para finalizar.
...
![Office 365](/images/guides/web-cloud/email-and-collaborative-solutions/microsoft-office/office-csp2/csp2-01.png)
...
Para ello, acceda al apartado `Sunrise`. En el menú de la izquierda, seleccione `Office 365 Reseller` y seleccione el servicio.
...
![Office 365](/images/guides/web-cloud/email-and-collaborative-solutions/microsoft-office/office-csp2/sunrise_office365_CSP2_services_details.png)
...
![Office 365](/images/guides/web-cloud/email-and-collaborative-solutions/microsoft-office/office-csp2/sunrise_office365_CSP2_Subscribers.png)
