...
- Être connecté à [l'espace client OVHcloud](/links/manager), partie `Télécom` puis `SMS`.
...
Connectez-vous à votre [espace client OVHcloud](/links/manager) puis sélectionnez `Télécom`. Cliquez ensuite sur `SMS` et sur votre compte SMS. Dans l'onglet `Accueil`, cliquez sur le bouton `Commander un numéro Time2Chat`.
