...
- Haber creado un usuario de SMS desde el área de cliente de OVHcloud o a través de la API. Para ello, puede consultar la guía [Usuarios de SMS](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms/).
...
<img className="thumbnail" alt="URL de envío de sms" src="/images/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-url---http2sms/img_4011.jpg" loading="lazy" />
...
<img className="thumbnail" alt="Lista de caracteres de SMS" src="/images/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-url---http2sms/smsauthorizedcharacters.png" loading="lazy" />
