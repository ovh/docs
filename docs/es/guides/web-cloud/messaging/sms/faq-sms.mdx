...
Para más información, consulte la guía "[Gestionar el historial de SMS](/guides/web-cloud/messaging/sms/gerer-l-historique-des-sms/)".
...
Para los **usuarios API**, [acceda a la sección SMS](https://manager.eu.ovhcloud.com/#/telecom/sms), seleccione su cuenta y acceda a <code className="action">Usuarios API</code>. Haga clic en <code className="action">...</code> > <code className="action">Límite</code> para el usuario en cuestión y configure:
...
Para más información, consulte la guía "[Todo sobre los usuarios SMS](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms/)".
...
[Acceda a la sección SMS](https://manager.eu.ovhcloud.com/#/telecom/sms) de su área de cliente de OVHcloud, seleccione su cuenta SMS y haga clic en <code className="action">Enviar un SMS</code>. Complete los siguientes campos:
...
Para más información, consulte la guía "[Enviar SMS desde el área de cliente de OVHcloud](/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-mon-espace-client/)".
...
Para más información, consulte la guía "[Enviar SMS desde una URL - http2sms](/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-url---http2sms/)".
...
Para más información, consulte la guía "[Enviar SMS desde una dirección de correo electrónico](/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-adresse-email/)".
...
[Acceda a la sección SMS](https://manager.eu.ovhcloud.com/#/telecom/sms) de su área de cliente de OVHcloud, seleccione su cuenta SMS y haga clic en <code className="action">Enviar un SMS</code>. Los pasos son:
...
[Acceda a la sección SMS](https://manager.eu.ovhcloud.com/#/telecom/sms) de su área de cliente de OVHcloud, seleccione su cuenta SMS y acceda a <code className="action">Contactos</code> > <code className="action">Crear una lista de contactos</code>. Puede:
...
Las agendas de contactos SMS ofrecen una gestión más completa de los contactos (nombre, apellidos, número). [Acceda a la sección SMS](https://manager.eu.ovhcloud.com/#/telecom/sms), seleccione su cuenta SMS y acceda a <code className="action">Contactos</code> > <code className="action">Agenda de contactos</code>. Puede:
...
Para más información, consulte la guía "[Gestionar mis agendas de contactos SMS](/guides/web-cloud/messaging/sms/gerer-mes-carnets-dadresses-sms/)".
...
Para más información, consulte la guía "[Todo sobre los remitentes SMS](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-expediteurs-sms/)".
...
Para más información, consulte la guía "[Enviar SMS con la API de OVHcloud en PHP](/guides/web-cloud/messaging/sms/envoyer-des-sms-avec-lapi-ovh-en-php/)".
...
Los acuses de recibo (Delivery Reports / DLR) confirman la correcta entrega de un SMS. Para recibirlos automáticamente, configure una URL de callback en su usuario API. [Acceda a la sección SMS](https://manager.eu.ovhcloud.com/#/telecom/sms) y luego a <code className="action">Usuarios API</code>, haga clic en <code className="action">...</code> > <code className="action">Callback</code> para el usuario en cuestión. Introduzca la URL de su endpoint web. Con cada actualización de estado, OVHcloud llamará a esta URL con los siguientes parámetros:
