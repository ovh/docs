...
- Si votre numéro n'est actuellement pas configuré, cliquez sur l'onglet `Configuration`, sélectionnez `File d'appels` puis cliquez sur `Paramétrer`.

- Si votre numéro a déjà une configuration en place, cliquez sur l'onglet `Configuration` puis sur `Changer de configuration`. Sélectionnez ensuite `File d'appels` et cliquez sur `Paramétrer`. Vous devrez alors confirmer la perte de la configuration actuellement en place.

![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-01.png)
...
![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-02.png)

Pour revenir à cette page à tout moment, cliquez sur l'onglet `Mon numéro` puis, dans le cadre « Configuration », cliquez sur `Paramétrer la configuration`.

![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-03.png)
...
#### 2.1 Gérer la file d'appels et ses lignes <a id="manage-lines"></a>

Depuis le menu « Configuration », cliquez sur `Gestion des lignes dans la file`.

##### 1. Ajouter une ligne à la file

Sur la page qui s'affiche, dans la partie « Organisation de vos lignes », cliquez sur le bouton `+ Ajouter une ligne` pour ajouter une nouvelle ligne à votre file d'appels.

![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-04.png)

Complétez ensuite les informations demandées.

![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-05.png)

|Option|Détails|
|---|---|
|Numéro|Il s'agit du ou des numéros de lignes que vous souhaitez ajouter en tant que membres à la file d'appels.<br /><br /> Cliquez sur le bouton `Rechercher` pour afficher la liste des lignes et numéros rattachés à votre compte. Sélectionnez celui que vous souhaitez ajouter, puis cliquez sur `Valider`.<br /> S'il n'apparaît pas dans la liste, entrez manuellement le numéro au format international (par exemple, 0033 pour une ligne en France) dans la zone de texte.<br /><br /> Pour ajouter un ou plusieurs membres supplémentaires, cliquez sur `Ajouter une ligne supplémentaire`.|
...
Une fois ces informations complétées, cliquez sur le bouton `Valider` pour réaliser l'ajout. 
...
![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-06.png)
...
Une fois vos choix effectués, cliquez sur le bouton `Valider`.
...
![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-07.png)

Une fois vos modifications effectuées, cliquez sur le bouton `Valider`.

##### 4. Modifier ou supprimer une ligne 

Depuis le tableau des lignes de votre file d'appels, cliquez sur le bouton `...` à droite de la ligne concernée et sélectionnez `Modifier` ou `Supprimer`.

![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-08.png)

La modification vous permet d'affiner les réglages de sonnerie de chaque ligne mais aussi d'activer/désactiver une ligne au sein de la file d'appels, en passant son `Statut` à `Activé` ou `Désactivé`.

![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-09.png)
...
#### 2.2 Gérer les sons et l'attente <a id="manage-sounds"></a>

Dans le menu « Configuration », cliquez sur `Gestion des sons et de l'attente`. Plusieurs actions sont alors possibles depuis cette page. 
...
Pour ajouter un son, cliquez sur le bouton `Ajouter un son` puis suivez les étapes de téléversement. Cliquez enfin sur le bouton `Valider` en bas de la page pour confirmer les changements.

![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-10.png)
...
- **Renvoyer sur un répondeur** : le ou les appelants concernés par le débordement seront alors renvoyés vers le répondeur de votre choix. Pour le sélectionner, cochez d'abord la case `Renvoyer sur un répondeur`. Cliquez ensuite sur `Ajouter un répondeur` et sélectionnez le répondeur d'une vos ligne SIP.
- **Jouer une annonce de débordement** : le ou les appelants concernés par le débordement entendront alors l'annonce que vous avez définie et l'appel sera ensuite raccroché. Pour téléverser un fichier audio, cochez d'abord la case `Jouer une annonce de débordement`. Cliquez ensuite sur `Ajouter un son`, puis suivez les étapes qui apparaissent jusqu'à finalisation.

Cliquez enfin sur le bouton `Valider` en bas de la page pour confirmer les changements.

![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-11.png)
...
- **Renvoyer sur un répondeur** : le ou les appelants concernés seront alors renvoyés vers le répondeur de votre choix. Pour le sélectionner, cochez d'abord la case `Renvoyer sur un répondeur`. Cliquez ensuite sur `Ajouter un répondeur` et sélectionnez le répondeur d'une vos ligne SIP.
- **Jouer une annonce de fermeture** : le ou les appelants concernés entendront alors l'annonce que vous avez définie. Pour l'envoyer, cochez d'abord la case `Jouer une annonce de fermeture`. Cliquez ensuite sur `Ajouter un son`, puis suivez les étapes qui apparaissent jusqu'à finalisation.

Cliquez enfin sur le bouton `Valider` en bas de la page pour confirmer les changements.

![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-12.png)

#### 2.3 Gérer les plages horaires et les fermetures <a id="manage-agenda"></a>

Depuis le menu « Configuration », cliquez sur `Plages horaires et fermetures`. Plusieurs actions sont alors possibles depuis cette page. 

##### 1. Activer ou désactiver les plages horaires

Utilisez les boutons `Activées` ou `Désactivées` afin de définir si vous souhaitez utiliser ou non les plages horaires mises en place.
...
![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-13.png)
...
Finalisez votre choix en cliquant sur le bouton `Modifier`.

![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-14.png)
...
Utilisez le bouton `Répéter` pour, par exemple, appliquer le même créneau sur plusieurs jours de la semaine.<br />
Définissez ensuite le créneau à appliquer grâce au bouton `Rediriger les appels vers`, puis validez l'ajout de la plage horaire en cliquant sur `Ajouter`.

![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-15.png)
...
Pour **supprimer une plage**, cliquez sur celle-ci, puis sur `Supprimer`.

![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-16.png)

Dès que toutes vos plages horaires sont configurées, cliquez sur le bouton `Valider` pour sauvegarder ces changements. 
...
Celles-ci vous permettront de fermer votre file d'appels sur des plages horaires normalement considérées comme étant ouvertes. Pour cela, toujours dans la partie « Gestion des plages horaires et des fermetures », cliquez sur `Gérer les fermetures exceptionnelles`.

![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-17.png)
...
Une fois les informations complétées, cliquez sur `Créer l'événement`. Répétez cette manipulation afin d'ajouter toutes les fermetures exceptionnelles que vous souhaitez créer. Cliquez finalement sur le bouton `Valider` pour sauvegarder ces changements.

![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-18.png)

#### 2.4 Gérer le filtrage des appels <a id="manage-filters"></a>

Depuis le menu « Configuration », cliquez sur `Filtrages des appels`. Plusieurs actions sont alors possibles depuis cette page. 
...
![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-19.png)

Quatre configurations sont proposées :

|Configuration|Description|
|---|---|
|Rejeter automatiquement les appels anonymes|Permet de rejeter automatiquement les appels entrants provenant d'un correspondant anonyme. Pour gérer son activation, utilisez les boutons `Activé` ou `Désactivé`.|
...
Cliquez sur le bouton `Valider` pour sauvegarder ces changements.
...
![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-20.png)
...
Une fois les listes complétées, appuyez sur `Appliquer`.
...
Pour **supprimer des éléments de vos listes**, sélectionnez-les dans le tableau en cochant la case située à gauche de ces derniers. Cliquez ensuite sur le bouton `Actions` puis sur `Supprimer les éléments sélectionnés`. Confirmez alors la suppression.

![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-20bis.png)

### Gérer les enregistrement d'appels <a id="manage-records"></a>
...
![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-21.png)

Cliquez sur le bouton `Activé` sous « Enregistement des appels » pour activer ceux-ci. Cette activation vaut pour acceptation des [conditions particulières](https://www.ovh.com/fr/support/documents_legaux/conditions_particulieres_du_service_d_enregistrement_des_communications_telephoniques.pdf) d'utilisation du service.

Vous pouvez laisser le choix à vos appelants de ne pas être enregistrés. Pour cela, cliquez sur le bouton `Activée` sous « Demande de non enregistement des appels ». Choisissez alors la touche que vos appelants devront composer pour ne pas être enregistrés.

Validez vos choix en cliquant sur `Appliquer`.

Un tableau vous donnera accès aux enregistrements d'appels, vous permettant de les télécharger ou de les supprimer.

![fileappels](/images/guides/web-cloud/phone-and-fax/voip/les-files-d-appels/2022-VoIP-FA-22.png)
