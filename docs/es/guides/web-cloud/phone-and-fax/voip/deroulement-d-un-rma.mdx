...
| :---: | :---: |
| ![actions-rma](/images/guides/web-cloud/phone-and-fax/voip/deroulement-d-un-rma/rma-schema-retour.png) | ![frise-rma](/images/guides/web-cloud/phone-and-fax/voip/deroulement-d-un-rma/rma-schema-frise.png) |
...
1. Cliquez sur l'onglet `Services` puis sur la ligne SIP concernée (vous pouvez rechercher le numéro dans le champ prévu à cet effet).
1. Cliquez alors sur l'onglet `Assistance` puis sur `Suivi RMA`.
1. Les informations relatives au RMA sont alors visibles, ainsi qu'un bouton pour `Télécharger le bon de retour`.
...
![deroulement-rma](/images/guides/web-cloud/phone-and-fax/voip/deroulement-d-un-rma/rma2020.png)

</Tab>
<Tab label="Bon RMA - xDSL">

![deroulement-rma-xdsl](/images/guides/web-cloud/phone-and-fax/voip/deroulement-d-un-rma/rma-xdsl-2025.png)
...
| :---: | :---: |
| ![deroulement-rma-ftth-modem](/images/guides/web-cloud/phone-and-fax/voip/deroulement-d-un-rma/rma-ftth-2025.png) | ![deroulement-rma-ftth-ont](/images/guides/web-cloud/phone-and-fax/voip/deroulement-d-un-rma/rma-ftth-ont-2025.png) |
...
1. Cliquez sur l'onglet `Facturation` puis sur `Virement vers un compte bancaire`.
1. Dans le tableau, cliquez sur les `...` à droite de la ligne correspondant à la caution restituée, puis sur `Demander un remboursement`.
1. Cliquez sur `Valider la demande`.
