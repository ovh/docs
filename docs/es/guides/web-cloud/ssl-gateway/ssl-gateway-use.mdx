...
- [Haber contratado un servicio SSL Gateway](/guides/web-cloud/ssl-gateway/ssl-gateway-order).
...
Conéctese al [área de cliente](/links/manager) y acceda a la sección `Sunrise`.

![menú sunrise](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/4.PNG)

En la columna izquierda, haga clic en `SSL Gateway`.

![botón ssl gateway](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/5.PNG)

Seleccione el servicio que desee configurar.

![panel central](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/6.PNG)

Se mostrará la pantalla desde la que podrá gestionar el servicio.

![configuración global](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/7.PNG)

#### Informacion

En la página de gestión del servicio, podrá ver la siguiente información:

![apartado información](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/8.PNG)
...
![apartado configuración](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/9.PNG)

|Configuración|Botón que permite modificar la configuración del servicio SSL Gateway|
|HSTS [[1]](#id5)|Obliga al navegador a realizar sus próximas conexiones a su sitio web en HTTPS|
|Registro inverso|Permite asignar un nombre de host a su dirección IP SSL Gateway|
|Redirección HTTPS [[2]](#id6)|Redirige al visitante hacia la versión HTTPS de su sitio web cuando hay acceso en HTTP|
|Servidor HTTPS [[3]](#id7)|Activa el HTTPS entre el servidor de SSL Gateway y el suyo|
|Restricción de IP de origen|Si completa este campo, solo las IP o redes indicadas podrán conectarse al SSL Gateway|
|Configuración de ciphers [[4]](#id8)|Permite elegir un nivel de seguridad para su certificado SSL/TLS|
...
![pestaña dominios](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/10.PNG)

Haga clic en `+ Dominios` para añadir un dominio o subdominio.
...
Elija los dominios opcionales y haga clic en `Añadir`.

![añadir dominio free](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/11.PNG)
...
Elija los dominios y haga clic en `Añadir`.

![añadir dominio advanced](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/12.PNG)
...
Haga clic en `+ Servidor` para añadir la dirección IP y el puerto correspondientes al servidor en el que esté alojado su sitio web.

![pestaña servidores](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/13.PNG)
...
Introduzca las direcciones y puertos correspondientes y haga clic en `Añadir`.

![añadir IP y puerto advanced](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/15.PNG)
...
![pestaña tareas](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/13-bis.PNG)
...
![pestaña gráficas](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/17.PNG)
...
> 
> ![Regenerar SSL](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/16.PNG)
>
...
Para consultar la lista de direcciones IP de origen utilizadas por el SSL Gateway, acceda al área de cliente Sunrise y seleccione `SSL Gateway` en la columna izquierda. En el panel central podrá ver la **IPv4 de salida**.
