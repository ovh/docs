...
Rendez-vous sur la page [https://status.isp.ovh.net/](https://status.isp.ovh.net/) et vérifiez si votre accès est affecté par incident en cours. Dès lors, deux possibilités :
...
![adslsynchronisation](/images/guides/web-cloud/internet/internet-access/reestablish-synchronization/rj11_filtre.png)
