...
Rendez-vous sur la page [https://status.isp.ovh.net/](https://status.isp.ovh.net/) et vérifiez si votre accès Internet fibre est affecté par un incident en cours.
...
|---|---|
|![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-ont-huawei.jpg)|![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-ont-nokia.jpg)|
...
![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-ont-huawei.jpg)
...
![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-ont-nokia.jpg)
...
![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-rad.png)
...
### Étape 3 : vérifier le fonctionnement jusqu'à la box OVHcloud <a id="check-box"></a>
...
![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-box-ovh.png)

#### 3.1 Tests liés au voyant « POWER » <a id="check-box-power"></a>
...
![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-box-ovh-test-power.png)

#### 3.2 Tests liés au voyant « WAN » <a id="check-box-wan"></a>
...
![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-box-ovh-test-wan.png)

#### 3.3 Tests liés au voyant « INTERNET » <a id="check-box-internet"></a>
...
Positionnez-vous ensuite sur le menu `Network Setting`, puis cliquez sur `Broadband`.

![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-box-ovh-test-internet-step1.png)
...
![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-box-ovh-test-internet-step2.png)

En dessous de « PPP Information », renseignez vos identifiants PPP à côté de « PPP User Name » et « PPP Password ».

Cliquez sur `OK`, puis patientez quelques instants le temps que la manipulation soit prise en compte. Si le voyant « **INTERNET** » reste éteint, [prenez contact avec notre équipe support](https://help.ovhcloud.com/csm?id=csm_get_help) afin de poursuivre le diagnostic.

![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-box-ovh-test-internet-step3.png)

### Étape 4 : vérifier le fonctionnement jusqu'à vos équipements personnels <a id="check-personal-equipments"></a>
...
- si vous avez activé le protocole **IPv6** sur votre accès Internet OVHcloud, assurez-vous que le ou les sites qui ne fonctionnent pas sont bien accessibles via ce protocole. Si ce n'est pas le cas, désactiver l'IPv6 pourrait rétablir l'accès à ces pages. Cette gestion s'effectue dans l'espace client, en cliquant sur l'onglet `Mon accès` de l'accès à Internet concerné, puis sur la section « Caractéristiques ».
...
Pour débuter la manipulation, effectuez un clic droit sur l'image en bas à gauche représentant le logo **Windows** et cliquez sur `Connexions réseau`. Dans la fenêtre qui apparaît, assurez-vous d'être bien positionné sur l'onglet `État` dans la barre de menu à gauche, puis cliquez sur `Modifier les options d'adaptateur`.

![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step1.png)
...
![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step2.png)

Vous pouvez remarquer différents états concernant les cartes réseau.

|États|Illustration|Description|
|---|---|---|
|Active et connectée|![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step3.png)|La carte réseau est activée et vous êtes connecté à la box OVHcloud. La connexion depuis cette carte doit donc être fonctionnelle.|
|Active et non connectée|![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step4.png)|La carte réseau est activée, mais vous n'êtes pas connecté à la box OVHcloud. La connexion depuis cette carte n'est donc pas fonctionnelle.|
|Désactivée|![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step5.png)|La carte réseau est désactivée. La connexion depuis cette carte n'est donc pas fonctionnelle.|
...
Pour l'activer, faites un clic droit sur l'image représentant la carte, puis cliquez sur `Activer`. Patientez alors le temps de son activation. Si la manipulation échoue, la carte est peut-être mal installée ou hors service. Dans ce cas, vous devrez vous rapprocher d'un professionnel, comme un technicien informatique. 

![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step6.png)
...
![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step7.png)
...
![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step8.png)
...
![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step9.png)
...
1. Positionnez-vous sur l'onglet `Mon modem` et cliquez sur `Configurer les réseaux Wi-Fi` dans la section `Configuration générale`.

![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/espaceclient2022.png)

Dans la page qui apparaît, cliquez sur le bouton représentant des points de suspension (à droite du réseau Wi-Fi que vous souhaitez configurer), puis sur `Éditer`. La configuration actuelle s'affiche en dessous du tableau. Vous pouvez y modifier le canal et la clé Wi-Fi. 

Validez vos changements grâce au bouton `Valider` et **patientez cinq minutes, le temps que la modification soit prise en compte par votre box OVHcloud.** Si nécessaire, effectuez plusieurs tests concernant le canal Wi-Fi afin de trouver le plus stable et le mieux adapté à votre situation.

![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/wifi-2022.png)

#### 4.5 Vérifier la configuration réseau de votre box OVHcloud <a id="check-box-network"></a>
...
1. Cliquez sur `Offres Internet` puis sur le *Pack* contenant l'accès à Internet concerné.
1. Cliquez sur votre accès à Internet fibre ou xDSL dans le cadre `Accès Internet` à droite.
1. Positionnez-vous sur l'onglet `Mon modem` et descendez dans la page jusqu'à voir la section `Configuration réseau`.

Nous allons nous intéresser spécifiquement aux tableaux « IP LAN » et « DHCP ».

![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step12-2022.png)
...
Pour réinitialiser la configuration de votre box OVHcloud, depuis l'onglet `Mon modem`, descendez dans la page jusqu'à voir la section `Configurations avancées`, puis cliquez sur `Réinitialiser la configuration OVHcloud`. **Patientez cinq minutes le temps que la modification soit prise en compte par votre modem.**

![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step13-2022.png)
...
Pour cela, effectuez un clic droit sur l'image en bas à gauche représentant le logo **Windows** et cliquez sur `Connexions réseau`. Dans la fenêtre qui apparaît, assurez-vous d'être bien positionné sur l'onglet `État` dans la barre de menu à gauche, puis cliquez sur `Modifier les options d'adaptateur`.

![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step1.png)

Dans la nouvelle fenêtre qui apparaît, les différentes cartes réseau (Wi-Fi ou Ethernet) installées sur votre ordinateur s'affichent. Effectuez un clic droit sur la carte (Wi-Fi ou câble) concernée, puis sélectionnez `Propriétés`. Assurez-vous que la case à côté de `Protocole Internet version 4 (TCP/IPv4)` est bien cochée. Ensuite, cliquez sur le nom `Protocole Internet version 4 (TCP/IPv4)` pour qu'il s'affiche en surbrillance, puis cliquez sur le bouton `Propriétés`.

Au sein de cette nouvelle fenêtre, assurez-vous que « Obtenir une adresse IP automatiquement » et « Obtenir les adresses des serveurs DNS automatiquement » sont bien cochés. Cliquez finalement sur les boutons `OK` pour valider vos modifications, le cas échéant. 

![diagnosticfibre](/images/guides/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step14.png)
