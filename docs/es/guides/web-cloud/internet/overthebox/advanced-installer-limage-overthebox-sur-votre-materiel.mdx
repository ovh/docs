...
> [!info]
>
> Cette méthode peut être utilisée pour revenir sur une version antérieure. Il faudra impérativement décocher la case `keep settings`.
>
...
- Cliquez sur le bouton `Flash image...`.

![overthebox](/images/guides/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/step1-luci-flash-1-2024.png)

- Cliquez sur `Browse...`.
- Choisissez le fichier d'image que vous venez de télécharger.
- Puis cliquez sur `Upload`.

![overthebox](/images/guides/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/step1-luci-flash-2-2024.png)

- Si vous souhaitez conserver vos configurations cochez la case `Keep settings`. Il est toutefois recommandé de la laisser décochée pour éviter d'éventuels conflits de configuration entre différentes versions.
- Cliquez sur `Continue`.

![overthebox](/images/guides/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/step1-luci-flash-3-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/usbboot-windows-win32di.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/usbboot-macos-diskutil.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/usbboot-nuc.png)

Dans le cas d'une OverTheBox IT v1, la clé USB doit être branchée sur un des ports USB **noirs** :

![overthebox](/images/guides/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/usbboot-itv1.png)

Dans le cas d'une OverTheBox Plus, la clé USB doit être branchée sur un des ports USB **en façade** :

![overthebox](/images/guides/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/usbboot-v2b.png)

Dans le cas d'une OverTheBox IT v2, la clé USB doit être branchée sur un des ports USB **au dos** :

![overthebox](/images/guides/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/usbboot-v2c.png)
