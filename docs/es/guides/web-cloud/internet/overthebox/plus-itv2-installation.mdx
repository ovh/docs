...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-installation/install-step2-OTBv3-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-installation/install-step2-OTBv2b-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-installation/install-step2-OTBv2c-2024.png)
...
Sur la page d'authentification, cliquez sur `Connexion`. Par défaut, aucun mot de passe n'est configuré.

Cliquez sur le bouton `Enregistrement`.

![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-installation/install-step3-1-start-2024.png)
...
- Sur l'écran d'enregistrement, cliquez sur le bouton `Connexion` pour vous connecter à votre compte OVHcloud.
- Renseignez vos identifiants OVHcloud puis cliquez sur `Continue`, puis autorisez la connexion API.
- La page vous redirigera sur la page d'authentification de l'interface web de l'**OverTheBox**. Cliquez à nouveau sur `Connexion`.
- Puis passez à l'étape enregistrement

![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-installation/install-step3-2-login-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-installation/install-step3-3-register-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-installation/install-step3-4-activate-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-installation/install-step3-5-ready-2024.png)

</Tab>
<Tab label="Votre service est désormais actif.">
...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-installation/install-step4-1-serviceok-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-installation/install-step4-2-perf-2024.png)
...
Les modems sont isolés dans leurs propre VLAN. Le WiFi des modems est donc indisponible depuis le réseau LAN de l'OverTheBox. Il est possible de réutiliser le WiFi d'un modem Zyxel fourni avec l'une de nos offres Internet. Pour plus d'informations, consultez notre guide « [Comment réutiliser le wifi d'un modem Zyxel avec OverTheBox](/guides/web-cloud/internet/internet-access/comment-reutiliser-wifi-zyxel-otb) ».
