...
- [Create a pool](/guides/storage-and-backup/block-storage/cloud-disk-array/ceph-create-a-pool/)
- [Create a user](/guides/storage-and-backup/block-storage/cloud-disk-array/ceph-create-a-user/)
- [Add rights to a user on a pool](/guides/storage-and-backup/block-storage/cloud-disk-array/ceph-change-user-rights/)
- [Add an IP ACL](/guides/storage-and-backup/block-storage/cloud-disk-array/ceph-create-an-ip-acl/) to allow your server to contact the cluster
