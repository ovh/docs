...
Tiene a su disposición un tableau de bord `Facturación` en su [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es) para visualizar su consumo actual y así predecir la factura final al final del mes.
