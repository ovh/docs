...
Para encontrar sus Vaults, haga clic en [este enlace](https://manager.eu.ovhcloud.com/#/bmc-backup-agent-baremetal/service) para acceder a la sección <code className="action">Backup Agent</code> y, a continuación, haga clic en la pestaña <code className="action">Vaults</code>.
