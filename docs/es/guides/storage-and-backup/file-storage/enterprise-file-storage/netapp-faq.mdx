...
Sí, puede acceder directamente a este servicio desde el [área de cliente de OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.es/&ovhSubsidiary=es), en la sección <code className="action">Bare Metal Cloud</code> y, seguidamente, en la sección <code className="action">Almacenamiento y Backup</code>".
