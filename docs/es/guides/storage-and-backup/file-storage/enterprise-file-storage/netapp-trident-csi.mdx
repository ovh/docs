...
- Conocimientos de las [API de OVHcloud](/guides/manage-and-operate/api/first-steps/) y/o la [CLI de OVHcloud](/guides/manage-and-operate/cli/cli-getting-started/)
