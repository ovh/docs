...
- [An environment that is ready to use the OpenStack API with the Swift client](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/)
- [OpenStack environment variables set](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/)
