...
- [Preparar el entorno para utilizar la API OpenStack](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/) instalando python-swiftclient
- [Cargar las variables de entorno OpenStack](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/)
...
La URL se compone de un punto de terminación, disponible a partir de la [interfaz Horizon](/guides/public-cloud/public-cloud-cross-functional/access-and-security-in-horizon/), el nombre del contenedor y el nombre del objeto (incluido el prefijo).
