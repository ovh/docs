...
Puede generar su identificador y contraseña OpenStack a través de esta [guía](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/).
