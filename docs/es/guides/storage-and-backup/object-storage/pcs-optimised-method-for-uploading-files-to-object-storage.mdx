...
- [Preparar el entorno para utilizar la API de OpenStack](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/) con el cliente python-swiftclient
