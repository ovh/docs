...
- Se si desidera preparare l'ambiente per l'utilizzo di [Terraform](/guides/public-cloud/public-cloud-cross-functional/how-to-use-terraform/), è necessario prepararlo.
...
- Prepara l'ambiente per utilizzare [Terraform](/guides/public-cloud/public-cloud-cross-functional/how-to-use-terraform/)
...
Apri una [connessione SSH alla tua istanza](/guides/public-cloud/compute/public-cloud-first-steps#connect-instance/) e utilizza il comando qui sotto per visualizzare i dischi associati.
...
<Tabs>
  <Tab label="Con Linux">
    Apri una [connessione SSH alla tua istanza](/guides/public-cloud/compute/public-cloud-first-steps#step-3-crea-unistanza/) e utilizza il comando qui sotto per visualizzare i dischi associati.
