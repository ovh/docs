...
- [Creare un'istanza dallo Spazio Cliente OVHcloud](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project/).
- [Disporre di un accesso amministratore all'istanza](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
