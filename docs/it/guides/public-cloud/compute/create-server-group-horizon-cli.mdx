...
- [Prepare the environment to use the OpenStack API](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment) by installing python-swiftclient.
