...
Utilizzando lo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it) / API o l'API di OpenStack Horizon, installa l'applicazione scelta sulla tua istanza Public Cloud.
