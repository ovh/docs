...
Riavvia l'istanza in modalità "normale" dallo [Spazio Cliente OVHcloud](/links/manager). Se necessario, consulta le istruzioni nella [guida sulla modalità rescue](/guides/public-cloud/compute/put-an-instance-in-rescue-mode).
