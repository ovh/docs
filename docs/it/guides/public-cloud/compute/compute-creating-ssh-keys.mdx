...
>
> Per maggiori informazioni consulta la nostra [guida sulla creazione di un'istanza Public Cloud](/guides/public-cloud/compute/compute-getting-started).
>
...
> [!info]
>
> `Ed25519` è considerato il più sicuro, ma `RSA` è un'alternativa valida. Entrambi i metodi sono compatibili con lo [Spazio Cliente OVHcloud](/guides/public-cloud/compute/compute-getting-started).
...
Copia questa stringa di chiave per [aggiungerla a una nuova istanza o importarla nello Spazio Cliente](/guides/public-cloud/compute/compute-getting-started).
...
[Come creare un'istanza Public Cloud e connettersi ad essa](/guides/public-cloud/compute/compute-getting-started)
