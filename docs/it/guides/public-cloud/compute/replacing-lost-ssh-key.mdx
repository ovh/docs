...
Crea una nuova coppia di chiavi SSH sul tuo dispositivo locale, seguendo le istruzioni contenute nella prima parte della [guida alla creazione di una chiave SSH](/guides/public-cloud/compute/compute-creating-ssh-keys/).
...
Riavvia l’istanza in modalità "normale" dallo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it). Se necessario, consulta le istruzioni nella [guida sulla modalità rescue](/guides/public-cloud/compute/put-an-instance-in-rescue-mode/).
