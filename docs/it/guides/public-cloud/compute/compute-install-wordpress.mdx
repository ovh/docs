...
- Disporre di un'[istanza Public Cloud](/guides/public-cloud/compute/compute-getting-started) con Debian o Ubuntu installato.
...
### Step 2: configurazione del server del database <a id="sqlconf"></a>
...
![wordpress](/images/guides/public-cloud/compute/install-wordpress-on-an-instance/wp_install1.png)
...
![wordpress](/images/guides/public-cloud/compute/install-wordpress-on-an-instance/wp_install2.png)
...
> 
> In alternativa, OVHcloud propone la soluzione [SSL Gateway](https://www.ovh.it/ssl-gateway/). Per maggiori informazioni, consulta la [nostra guida](/guides/web-cloud/ssl-gateway/ssl-gateway-order).
>
