...
:::info
**Buona pratica**: Per i carichi di lavoro critici, privilegia un [deploy multi-AZ](/guides/public-cloud/public-cloud-cross-functional/3az-ref-architecture/) per garantire resilienza e continuità del servizio.
...
Per istruzioni dettagliate sulla creazione e sull'utilizzo delle chiavi SSH, consulta la guida [OVHcloud su SSH](/guides/public-cloud/compute/compute-creating-ssh-keys/).
...
Per ulteriori dettagli sulla configurazione delle reti Public Cloud, consulta la guida ufficiale [OVHcloud sulle reti](/guides/public-cloud/public-cloud-network-services/concepts-01-public-cloud-networking-concepts/).
...
I Savings Plans ti aiutano ad ottimizzare il tuo budget mantenendo le prestazioni e l'affidabilità del tuo ambiente cloud. Per ulteriori informazioni, consulta la guida ufficiale [OVHcloud sui Savings Plans](/guides/public-cloud/public-cloud-cross-functional/savings-plans/).
...
- [Come creare un'istanza Public Cloud e accedervi](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)
