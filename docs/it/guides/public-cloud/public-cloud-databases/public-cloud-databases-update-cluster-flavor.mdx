...
To adjust the flavor of your cluster, log in to the OVHcloud Control Panel and open your Public Cloud project. Click `Databases` in the left navigation bar, select your engine instance then click the `Configuration` tab.
...
Click `Edit` on the "Flavor" line and adjust the flavor of your cluster.

![Change node template](/images/guides/public-cloud/public-cloud-databases/databases-13-update-your-cluster-flavor/flavor_change_view.png)
