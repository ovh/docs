...
<img className="thumbnail" alt="Debian postgresql-client" src="/images/public-cloud/public-cloud-databases/postgresql-03-connect-cli/debian_postgresql.png" loading="lazy" />
...
[PostgreSQL capabilities](/guides/public-cloud/public-cloud-databases/postgresql-01-capabilities/)
