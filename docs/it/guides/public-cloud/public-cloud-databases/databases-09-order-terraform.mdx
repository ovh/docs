...
description: Find out how to order and manage your Public Cloud managed database service using Terraform
...
To retrieve this information, follow our [First steps with the OVHcloud APIs](/guides/manage-and-operate/api/first-steps/) tutorial.
