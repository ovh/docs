...
Follow the guide [MongoDB - Connect with CLI](/guides/public-cloud/public-cloud-databases/mongodb-03-connect-cli/) in order to ensure you can connect to your database. That step ensures IP filtering is set up properly and that you have a suitable service URI available.
