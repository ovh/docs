...
- **OVHcloud Built-in Monitoring Tools:**
    - [Metrics tab](/guides/public-cloud/public-cloud-databases/mongodb-15-monitoring/): Provides comprehensive monitoring dashboards.

- **OVHcloud MongoDB Prometheus Endpoint:**
    - [Prometheus metrics](/guides/public-cloud/public-cloud-databases/databases-17-metrics-via-prometheus/): Fetch service metrics with Prometheus.
...
- **Third-Party Tools:**
    ...
    - [Hatchet](/guides/public-cloud/public-cloud-databases/mongodb-17-why-mongodb/): Parses the logs to help you identify slow queries.
...
- **OVHcloud Automated Backup Solutions:**
    - [OVHcloud Automated Backup](/guides/public-cloud/public-cloud-databases/databases-05-automated-backups/).
    - [OVHcloud Restore Backup](/guides/public-cloud/public-cloud-databases/databases-06-restore-backup/)
- **Snapshot-based Backups**
    - [mongodump and mongorestore](/guides/public-cloud/public-cloud-databases/mongodb-06-howto-backup-restore/): Regular snapshots of the data.
...
- [Network Security](/guides/public-cloud/public-cloud-databases/mongodb-02-manage-control-panel/):
...
- [**User Management**](/guides/public-cloud/public-cloud-databases/mongodb-02-manage-control-panel/):
...
- [**Use Appropriate Indexes:**](/guides/public-cloud/public-cloud-databases/mongodb-26-developer-best-practices/) Create indexes to support query patterns and Regularly review and optimize indexes.
