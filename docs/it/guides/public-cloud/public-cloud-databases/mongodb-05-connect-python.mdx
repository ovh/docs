...
One of the easiest, yet powerful, is to use a Command Line Interface (CLI), as shown in our guide : [Connect to MongoDB with CLI](/guides/public-cloud/public-cloud-databases/mongodb-03-connect-cli/).
...
Once you know the IP address, follow the steps from this guide : [Configure your MongoDB instance to accept incoming connections](/guides/public-cloud/public-cloud-databases/mongodb-02-manage-control-panel/).
