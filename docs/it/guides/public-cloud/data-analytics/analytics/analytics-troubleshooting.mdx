...
1. **Check the Analytics service instance status:** connect to the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it) and explore your Analytics services. Verify the status. Nominal status is **Running**;
