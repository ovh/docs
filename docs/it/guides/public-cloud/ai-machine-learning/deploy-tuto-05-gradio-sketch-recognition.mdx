...
:::info
Here you will use your trained model, then save it in an Object Storage container. Click [here](/guides/public-cloud/ai-machine-learning/cli-16-commands-reference-data/) to learn more about Object Storage.
...
- You can imagine deploying an AI model with an other tool: **Flask**. Refer to this [tutorial](/guides/public-cloud/ai-machine-learning/deploy-tuto-06-flask-hugging-face/).
- Do you want to use **Streamlit** to create a audio classification app? [Here it is](/guides/public-cloud/ai-machine-learning/deploy-tuto-03-streamlit-sounds-classification/).
