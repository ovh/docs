...
![image](/images/guides/public-cloud/ai-machine-learning/notebook-tuto-07-transfer-learning-resnet50-image-classification/resnet.png)
...
Then, you can launch your notebook from the [OVHcloud Control Panel](/links/manager) or via the ovhai [CLI](/guides/public-cloud/ai-machine-learning/ai-cli-run-notebook).
