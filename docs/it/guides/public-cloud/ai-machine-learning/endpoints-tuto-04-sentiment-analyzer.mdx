...
<img className="thumbnail" alt="image" src="/images/public-cloud/ai-machine-learning/endpoints-tuto-04-sentiment-analyzer/sentiment-analysis.png" loading="lazy" />
