...
This guide shows how to share [**notebooks**](/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/) with other people through the **ovhai** CLI.
