...
- Disporre di un [progetto Public Cloud](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project/)
- Aver [creato un utente OpenStack](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user#crea-un-utente-openstack/) (facoltativo)
...
<img className="thumbnail" alt="aggiungi il progetto" src="/images/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/addprojectvrack.png" loading="lazy" />

<a name="ovhcloud-api"></a>

#### Dalle APIv6 OVHcloud

Per attivare e gestire una vRack, clicca [qui](/guides/public-cloud/public-cloud-network-services/getting-started-08-creating-vrack-with-api#step-1-activating-and-managing-a-vrack/) (EN), per consultare la guida specifica a questo metodo.
...
[Configurazione della vRack Public Cloud da APIv6 OVHcloud](/guides/public-cloud/public-cloud-network-services/getting-started-08-creating-vrack-with-api/) (EN).
