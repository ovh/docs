...
- using the [OpenStack CLI](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment) by doing `openstack floating ip list` and `openstack loadbalancer list`.
