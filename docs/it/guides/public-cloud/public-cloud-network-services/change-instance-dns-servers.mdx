...
Accedi alla tua istanza via SSH Per maggiori informazioni, consulta la guida [Connettersi a un'istanza Public Cloud](/guides/public-cloud/compute/compute-getting-started#connect-instance).
...
Accedi all'istanza tramite una sessione desktop remoto o con la console VNC. Per maggiori informazioni, consulta la guida [Connettersi a un'istanza Public Cloud](/guides/public-cloud/compute/compute-getting-started#connect-instance).

Apri le `Impostazioni di rete`.

![modifica i server DNS](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers1.png)

Accedi alla configurazione IPv4 della tua scheda di rete pubblica tramite il pannello di configurazione.

![modifica i server DNS](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers2.png)

Aggiungi i server che vuoi utilizzare nelle `Impostazioni avanzate`.

![modifica i server DNS](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers3.png)
...
[Creare una prima istanza Public Cloud e connettersi](/guides/public-cloud/compute/compute-getting-started)
