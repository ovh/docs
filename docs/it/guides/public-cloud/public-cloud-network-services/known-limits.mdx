...
- in [Horizon](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon/).
- using the [OpenStack CLI](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/) by doing `openstack floating ip list` and `openstack loadbalancer list`.
