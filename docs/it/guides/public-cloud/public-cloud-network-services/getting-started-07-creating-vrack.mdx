...
- Avere un [progetto Public Cloud](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project/)
- Avere [creato un utente OpenStack](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/) (opzionale)
...
[Lo Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it) è un'interfaccia completamente e unicamente visiva, che lo rende un'interfaccia ideale per la gestione di diversi VLAN. Avrai inoltre la possibilità di personalizzare l'intervallo di IP privati, che di default è 10.1.0.0/16.
...
Consulta la guida "[Introduzione a Horizon](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon/)" per familiarizzare con Horizon.
...
Per farlo, devi scegliere il fornitore e la risorsa Terraform corretti. Trova ulteriori informazioni nella nostra [guida all'utilizzo di Terraform](/guides/manage-and-operate/terraform/terraform-at-ovhcloud/).
...
Verrai reindirizzato su un'altra pagina per confermare l'ordine, l'operazione richiederà alcuni minuti.
    ...
    <img className="thumbnail" alt="aggiungi il progetto" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/addprojectvrack.png" loading="lazy" />
...
<Tabs>
  <Tab label="Dal Spazio Cliente OVHcloud">
    ...
    <img className="thumbnail" alt="Creazione VLAN" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack2022-03.png" loading="lazy" />
...
Clicca ora su <code className="action">Crea una rete privata</code>. La pagina successiva ti permetterà di personalizzare diversi parametri.
    ...
    <img className="thumbnail" alt="Seleziona regione" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack5-2024.png" loading="lazy" />

Nella fase successiva, ti vengono presentate diverse opzioni:
    
    <img className="thumbnail" alt="Creazione rete" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack6-2022.png" loading="lazy" />
...
Nel campo **Nome della rete privata**, definisci un nome per la tua rete privata.
    ...
    **Opzioni gateway di rete**
    ...
    - **Assegna una Gateway e collegati alla rete privata**: Seleziona questa opzione se hai l'intenzione di creare delle istanze con una rete privata esclusivamente. Per ulteriori informazioni, ti invitiamo a consultare le seguenti guide: [Creare una rete privata con una Gateway](/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/) e [Creare una prima istanza Public Cloud e collegarvisi](/guides/public-cloud/compute/public-cloud-first-steps/).
...
<Tabs>
  <Tab label="Dal Spazio Cliente OVHcloud">
    Consulta la guida "[Creare un'istanza dallo spazio cliente](/guides/public-cloud/compute/public-cloud-first-steps/)". Durante la creazione di un'istanza, puoi scegliere all'ultimo passo, un tipo di rete e quindi una rete privata alla quale integrare la tua istanza.
    
    <img className="thumbnail" alt="aggiungi nuova istanza" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/network-selection.png" loading="lazy" />
...
<Tabs>
  <Tab label="Dallo Spazio Cliente OVHcloud">
    ...
    <img className="thumbnail" alt="dettaglio istanza" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/instance_details.png" loading="lazy" />
...
Ti verrà mostrato il pannello del tuo'istanza. Clicca sul pulsante <code className="action">⁝</code> a destra di "Reti private" e poi su <code className="action">Associa una rete</code>.
    ...
    <img className="thumbnail" alt="collega rete" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack2021-01.png" loading="lazy" />
...
Nella finestra che appare, seleziona una o più reti private da collegare alla tua istanza e clicca su <code className="action">Confermare</code>.
    ...
    <img className="thumbnail" alt="collega rete" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack9.png" loading="lazy" />
  </Tab>
  <Tab label="Dalle APIv6 OVHcloud">
    L'azione consiste semplicemente nell'aggiungere una nuova interfaccia di rete al tuo server, oltre a quella esistente.
...
Dovrai compilare almeno i seguenti campi:
  ...
  <Tab label="Da OpenStack Horizon">
    ...
    <img className="thumbnail" alt="connessione Horizon" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon1.png" loading="lazy" />

Vai quindi in `Compute`, quindi in `Instances`:
    
    <img className="thumbnail" alt="Horizon Compute instances" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon2.png" loading="lazy" />
...
**Aggiunta di un'interfaccia di rete privata**
    ...
    <img className="thumbnail" alt="Horizon attach interface" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon3.png" loading="lazy" />

Seleziona la tua interfaccia e conferma:
    
    <img className="thumbnail" alt="Horizon attach interface" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon4.png" loading="lazy" />
...
Questa azione va effettuata solo se desideri isolare il tuo server nel vRack (rete privata) o, al contrario, rimuoverlo da uno o più VLAN.
    ...
    <img className="thumbnail" alt="Horizon detach interface" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon5.png" loading="lazy" />

Seleziona l'interfaccia da eliminare e conferma:
    
    <img className="thumbnail" alt="Horizon detach interface" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon6.png" loading="lazy" />
  </Tab>
  <Tab label="Dalla CLI OpenStack">
    **Recupero delle informazioni necessarie**
