...
:::info
Al momento, le offerte Floating IP e Gateway non supportano l'IPv6. L'IPv6 è utilizzabile solo con le istanze in [modalità pubblica](/guides/public-cloud/public-cloud-network-services/concepts-01-public-cloud-networking-concepts#publicmode/).
