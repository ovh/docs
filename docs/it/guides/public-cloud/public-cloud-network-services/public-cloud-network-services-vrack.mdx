...
**Ecco una descrizione rapida delle azioni possibili in base al metodo/interfaccia scelto:** <a id="horizon"></a>
...
- [Preparare l'ambiente per utilizzare l'API OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment)
- [Impostare le variabili d'ambiente OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-set-openstack-environment-variables)
...
### Passo 1: Attivare e gestire un vRack <a id="activation"></a>
...
>>
>> ![Ordina il vrack](/images/assets/screens/control-panel/product-selection/bare-metal-cloud/network/orderingvrack25.png)
>>
...
>>
>> ![aggiungi il progetto](/images/guides/public-cloud/public-cloud-network-services/configuration-06-configure-ip-block-vrack-to-instance/addprojectvrack.png)
>>
...
### Passo 2: Creare una rete privata nel vRack <a id="create-pn-in-vrack"></a>
...
![Creazione VLAN](/images/guides/public-cloud/public-cloud-network-services/configuration-06-configure-ip-block-vrack-to-instance/vrack2022-03.png)
...
![Seleziona regione](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack5-2024.png)

Nella fase successiva, ti vengono presentate diverse opzioni:

![Creazione rete](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack6-2022.png)
...
- **Assegna una Gateway e collegati alla rete privata**: Seleziona questa opzione se hai l'intenzione di creare delle istanze con una rete privata esclusivamente. Per ulteriori informazioni, ti invitiamo a consultare le seguenti guide: [Creare una rete privata con una Gateway](/guides/public-cloud/public-cloud-network-services/create-private-network-gateway) e [Creare una prima istanza Public Cloud e collegarvisi](/guides/public-cloud/compute/compute-getting-started).
...
Consulta la guida "[Creare un'istanza dallo spazio cliente](/guides/public-cloud/compute/compute-getting-started)". Durante la creazione di un'istanza, puoi scegliere all'ultimo passo, un tipo di rete e quindi una rete privata alla quale integrare la tua istanza.

![aggiungi nuova istanza](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/network-selection.png)
...
Accedi al tuo [Spazio Cliente OVHcloud](/links/manager), vai alla sezione `Public Cloud` e seleziona il progetto Public Cloud desiderato in alto a sinistra.
...
![dettaglio istanza](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/instance_details.png)

Ti verrà mostrato il pannello del tuo'istanza. Clicca sul pulsante `⁝` a destra di "Reti private" e poi su `Associa una rete`.

![collega rete](/images/guides/public-cloud/public-cloud-network-services/configuration-06-configure-ip-block-vrack-to-instance/vrack2021-01.png)

Nella finestra che appare, seleziona una o più reti private da collegare alla tua istanza e clicca su `Confermare`.

![collega rete](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack9.png)
...
![connessione Horizon](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon1.png)
