...
Log in to the [OVHcloud Control Panel](/links/manager) and click on the OVHcloud `Shell button` to launch the terminal.

![Cloudshell button](/images/guides/public-cloud/public-cloud-cross-functional/getting-started-ovhcloudshell/OVHcloud_Shell.png)
