...
<img className="thumbnail" alt="token" src="/images/public-cloud/public-cloud-cross-functional/how-to-use-terraform/first_step.png" loading="lazy" />

<img className="thumbnail" alt="token created" src="/images/public-cloud/public-cloud-cross-functional/how-to-use-terraform/create_token.png" loading="lazy" />
...
You now need to [create a new OpenStack user](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/), then [generate the OpenRC file](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables#step-1-retrieve-the-variables/) containing all of the credentials you want to export as environment variables.
...
<img className="thumbnail" alt="public-cloud" src="/images/public-cloud/public-cloud-cross-functional/how-to-use-terraform/basic_infrastructure_for_a_web_site.png" loading="lazy" />
...
1. [Create a Public Cloud project manually from the OVHcloud Control Panel](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project/)
