...
- Per gli utenti di Windows, consulta questa guida per esportare le tue variabili d'ambiente: [Impostare le variabili d'ambiente OpenStack](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/).
...
<img className="thumbnail" alt="scarica il file openRC" src="/images/public-cloud/public-cloud-cross-functional/using-openstack-tokens-for-multiple-calls/openrc.png" loading="lazy" />
