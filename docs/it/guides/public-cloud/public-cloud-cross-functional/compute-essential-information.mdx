...
- [Crea la tua prima istanza](/guides/public-cloud/compute/compute-getting-started)
- [Gestisci le quote](/guides/public-cloud/public-cloud-cross-functional/increasing-public-cloud-quota)

## Approccio globale <a id="global-approach"></a>
...
## Approccio pratico <a id="concrete-approach"></a>
...
|[Lessico](/guides/public-cloud/compute/key-concepts)|I concetti e le definizioni di cui avete bisogno per progredire.|
...
|Documentazione|Descrizione|
|---|---|
|[Crea la tua prima istanza](/guides/public-cloud/compute/compute-getting-started)|La prima guida pratica per avviare un server Cloud dallo Spazio Cliente OVHcloud.|
...
|[Configura la rete privata](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack)|In OVHcloud le reti private sono basate sulla tecnologia vRack. Questa guida ti mostra come eseguire questa operazione.|
...
|[Configura un Additional IP](/guides/public-cloud/public-cloud-network-services/configure-additional-ip)|Gli Additional IP ti permettono di trasferire il traffico da un'istanza all'altra, questa guida ti mostra come configurarlo.|
...
|[Installazione della CLI OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment)|OpenStack può essere utilizzato anche da riga di comando, come installare gli strumenti.|
