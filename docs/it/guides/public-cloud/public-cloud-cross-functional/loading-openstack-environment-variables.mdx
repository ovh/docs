...
- Aver creato un utente OpenStack. A questo proposito, consulta [l’apposita guida](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/)
- Aver preparato l’ambiente di sviluppo per utilizzare l’API OpenStack. A questo proposito, consulta questa guida: [Preparare l’ambiente per utilizzare l’API OpenStack](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/)
...
Come indicato in [questa guida](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/), la password è visibile una sola volta, cioè al momento della sua creazione.
