...
![Configure OIDC provider menu](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-oidc-provider-config/configure-oidc-menu.png)
