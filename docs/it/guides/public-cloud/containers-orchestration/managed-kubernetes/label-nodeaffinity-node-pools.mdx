...
To deploy your application on your Kubernetes cluster, we invite you to follow our guide to [configuring default settings](/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-kubectl-on-an-ovh-managed-kubernetes-cluster/) for `kubectl`.
