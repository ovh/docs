...
![Clusters](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/add-ip-restrictions/clusters.png)

Click on your Kubernetes cluster.

![Your Kubernetes cluster](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/add-ip-restrictions/cluster.png)

Click the `APIServer access` tab or the *Modify limitations* link.

![APIServer access](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/add-ip-restrictions/apiserver_access.png)
...
![Add IP restriction to a Kubernetes cluster](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/add-ip-restrictions/add-ip-restriction.png)
...
![OVHcloud API rights](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/add-ip-restrictions/api-rights.png)
...
![Copy paste service name](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/add-ip-restrictions/get-service-name.png)
