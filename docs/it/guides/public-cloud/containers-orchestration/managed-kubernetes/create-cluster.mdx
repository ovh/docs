...
<iframe className="video" width="560" height="315" src="https://www.youtube-nocookie.com/embed/ApfujBFT82g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
![CDKTF](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/cdktf.png)
...
![CDKTF](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/cdktf_schema.png)
...
![Pulumi](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/pulumi.jpg)
...
![Create a cluster](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/creating-a-cluster1.png)

Select a location for your new cluster.

![Select a location](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/creating-a-cluster2.png)

Choose the minor version of Kubernetes.

![Choose the minor version of Kubernetes](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/creating-a-cluster3.png)
...
You can now choose to integrate your Kubernetes cluster into a private network using OVHcloud vRack. For more information about this option, please read our guide [Using the vRack](/guides/public-cloud/containers-orchestration/managed-kubernetes/managed-kubernetes-using-vrack).

![Choose a private network for this cluster](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/creating-a-cluster4.png)
...
![Node pool](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/creating-a-cluster5.png)

In the next step, define the size of the default node pool.

![Default node pool](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/creating-a-cluster6.png)
...
![Autoscaling](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/creating-a-cluster7.png)

In the next step, choose the appropriate billing mode (monthly or hourly). You can also enable the anti-affinity mode here. 

![Choose the billing mode](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/creating-a-cluster8.png)
...
![Enter a name for your cluster](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/creating-a-cluster9.png)
...
![Terraform](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/ovh-loves-terraform.png)
...
![Kubernetes cluster and node pool](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/cluster-and-node-pool.png)
...
Now, log in to the [OVHcloud Control Panel](/links/manager), go to the `Public Cloud` section and click on `Managed Kubernetes Service`.  
As you can see, your cluster has been successfuly created:

![Cluster created](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/cluster-created.png)

Now, click on `my_kube_cluster`, then on the `Node pools` tab:

![Node pool created](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/my-pool-node-pool-created.png)
...
Log in to the [OVHcloud Control Panel](/links/manager), go to the `Public Cloud` section and click on `Managed Kubernetes Service`.  
As you can see, your cluster has been successfuly created:
