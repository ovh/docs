...
### How TrilioVault for Kubernetes works <a id="how-triliovault-for-kubernetes-works"></a>
...
### Understanding TrilioVault Application Scope <a id="understanding-triliovault-application-scope"></a>
...
### Backup and Restore Workflow <a id="backup-and-restore-workflow"></a>
...
### Step 1 - Installing TrilioVault for Kubernetes <a id="step-1---installing-triliovault-for-kubernetes"></a>
...
#### Installing TrilioVault Operator and Manager Using Helm <a id="installing-triliovault-operator-and-manager-using-helm"></a>
...
#### TrilioVault Application Licensing <a id="triliovault-application-licensing"></a>
...
#### Installing TVK Application Licensing <a id="installing-tvk-application-licensing"></a>
...
#### Renewing TVK Application License <a id="renewing-tvk-application-license"></a>
...
### Step 2 - Creating a TrilioVault Target to Store Backups <a id="step-2---creating-a-triliovault-target-to-store-backups"></a>
...
<ol start={2}>
  <li>Next, create the Kubernetes secret containing your target Object Storage bucket credentials (please replace the `<>` placeholders accordingly):</li>
</ol>
...
<ol start={4}>
  <li>Now, please replace the `<>` placeholders accordingly to your OVHcloud Object Storage Trilio bucket, like: <code>bucketName</code>, <code>region</code>, <code>url</code> and <code>credentialSecret</code>.</li>
...
### Step 3 - Getting to Know the TVK Web Management Console <a id="step-3---getting-to-know-the-tvk-web-management-console"></a>
...
#### Getting Access to the TVK Web Management Console <a id="getting-access-to-the-tvk-web-management-console"></a>
...
#### Exploring the TVK Web Console User Interface <a id="exploring-the-tvk-web-console-user-interface"></a>

The home page looks similar to:

![TVK Home Cluster Dashboard](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-namespace-and-applications-with-trilio/tvk_cluster_dashboard.png)
...
- `Backup & Recovery`: This is the main dashboard which gives you a general overview for the whole cluster, like: Discovered namespaces, Applications, Backupplans list, Targets, Hooks, Policies etc.
    - `Namespaces`:
  ![TVK Cluster Namespaces](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-namespace-and-applications-with-trilio/tvk_console_home_namespaces.png)
    - `Applications`:
  ![TVK Auto-discovered Applications](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-namespace-and-applications-with-trilio/tvk_auto_discovered_applications.png)
    - `Backupplans`:
  ![TVK Backupplans](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-namespace-and-applications-with-trilio/tvk_backupplans.png)
    - `Targets`:
  ![TVK Target List](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-namespace-and-applications-with-trilio/tvk_target_list.png)
    - `Scheduling Policy`:
  ![TVK Default Scheduling Policy](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-namespace-and-applications-with-trilio/tvk_default_scheduling_policies.png)
    - `Retention Policy`:
  ![TVK Default Retention Policy](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-namespace-and-applications-with-trilio/tvk_default_retention_policies.png)
  ...
  ![TVK TrilioVault Monitoring Backups and Restores](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-namespace-and-applications-with-trilio/tvk_triliovault_monitoring.png)
    - `Velero Monitoring`:
  ![TVK Velero Monitoring](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-namespace-and-applications-with-trilio/tvk_velero_monitoring.png)
- `Disaster Recovery`: Allows you to manage and perform disaster recovery operations.
  ![TVK Disaster Recovery](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-namespace-and-applications-with-trilio/tvk_disaster_recovery.png)
...
![TVK Target Browser](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-namespace-and-applications-with-trilio/tvk_target_browser.png)
...
### Step 4 - Helm Release Backup and Restore Example <a id="step-4---helm-release-backup-and-restore-example"></a>
...
#### Creating mysql-qa Helm Release Backup <a id="creating-mysql-qa-helm-release-backup"></a>
...
#### Deleting mysql-qa Helm Release and Resources <a id="deleting-mysql-qa-helm-release-and-resources"></a>
...
#### Restoring mysql-qa Helm Release Backup <a id="restoring-mysql-qa-helm-release-backup"></a>
...
#### Verifying Applications Integrity after Restoration <a id="verifying-applications-integrity-after-restoration"></a>
...
### Step 5 - Backup and Restore Whole Cluster Example <a id="step-5---backup-and-restore-whole-cluster-example"></a>
...
#### Creating the OVHcloud Managed Kubernetes Cluster Backup using TVK Multi-Namespace backup feature <a id="creating-the-ovh-managed-kubernetes-cluster-backup"></a>
...
#### Re-creating the OVHcloud Managed Kubernetes Cluster and Restoring Applications <a id="re-creating-the-ovh-managed-kubernetes-cluster-and-restoring-applications"></a>
...
![Multi-Namespace Restore Phase 1](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-namespace-and-applications-with-trilio/multi-ns-restore_phase_1.png)

To start the restore process, click on the `Restore` button. A progress window will be displayed similar to below:

![Multi-Namespace Restore Phase 2](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-namespace-and-applications-with-trilio/multi-ns-restore_phase_2.png)

After a while, if the progress window looks like below, then the `multi-namespace` restore operation completed successfully.

![Multi-Namespace Restore Phase 3](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-namespace-and-applications-with-trilio/multi-ns-restore_phase_3.png)

#### Checking OVHcloud Managed Kubernetes Cluster Applications State <a id="checking-ovh-managed-kubernetes-cluster-applications-state"></a>
...
### Step 6 - Scheduled Backups <a id="step-6---scheduled-backups"></a>
...
>
> ![TVK Default Scheduling Policies](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-namespace-and-applications-with-trilio/tvk_default_scheduling_policies.png)
>
...
### Step 7 - Backups Retention Policy <a id="step-7---backups-retention-policy"></a>
...
#### Using Retention Policies <a id="using-retention-policies"></a>
...
#### Using Cleanup Policies <a id="using-cleanup-policies"></a>
