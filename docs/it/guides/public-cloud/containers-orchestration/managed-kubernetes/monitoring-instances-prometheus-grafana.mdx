...
![Prometheus static target](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/monitoring-pci-instances-prometheus/prom_targets_static.png)
...
![Add user description](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/monitoring-pci-instances-prometheus/add_user_1.png)

![Add user role](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/monitoring-pci-instances-prometheus/add_user_2.png)
...
Retrieve your OpenStack user info from the command-line tool (refer to the [Setting OpenStack environment variables](/guides/public-cloud/public-cloud-cross-functional/compute-set-openstack-environment-variables) guide) for the region you want to scrape.

This example uses the GRA11 region.

![Download OpenStack configuration file](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/monitoring-pci-instances-prometheus/download_openrc.png)
...
![Prometheus OpenStack targets](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/monitoring-pci-instances-prometheus/prom_targets_openstack.png)
...
![Create script credentials](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/monitoring-pci-instances-prometheus/ovh_creds.png)
...
![Prometheus OVHcloud targets](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/monitoring-pci-instances-prometheus/prom_targets_ovhcloud.png)
