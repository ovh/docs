...
- A [private network with a Gateway](/guides/public-cloud/public-cloud-network-services/create-private-network-gateway)
...
![OVHcloud Managed Rancher Service UI](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/backup-restore-etcd-s3/rancher-ui.png)

Click on `Cluster Management` in the menu.

Then click on `Cloud Credentials`.

![OVHcloud Managed Rancher Service Credentials UI](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-pci-compute-instances/rancher-creds.png)

If you don't have any **OVHcloud Public Cloud** credentials yet, click the `Create` button.

Click the `OVHcloud Public Cloud` button.

![OVHcloud Managed Rancher Service PCI credentials UI](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-pci-compute-instances/pci-creds.png)

Define a name for the credentials, e.g. `pci`. Then fill in the OpenStack user's username and password.

![OVHcloud Managed Rancher Service Create Credentials](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-pci-compute-instances/rancher-create-pci-creds.png)

Click on `Get projects list`:

![OVHcloud Managed Rancher Service Create Credentials](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-pci-compute-instances/rancher-pci-creds-project.png)

Select your Public Cloud Project in this list then click the `Create` button.

> [!warning]
>
> You don't have to click the `Edit Auth Config` button.
...
![OVHcloud Managed Rancher Service Create Kubernetes PCI](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-pci-compute-instances/rancher-create.png)

In Rancher you can create a Kubernetes cluster with different methods. To create a Kubernetes cluster running in Compute Instances, use the **Provision new nodes and create a cluster using RKE2/K3s** way and click the `OVHcloud Public Cloud` driver.

Select an OVHcloud Public Cloud credential:

![OVHcloud Managed Rancher Service Create Kubernetes PCI](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-pci-compute-instances/rancher-select-creds.png)

Then, define the cluster name.

![OVHcloud Managed Rancher Service Cluster Name](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-pci-compute-instances/rancher-cluster-name.png)
...
- Choose a Key Pair (optional). It's the SSH Key Pair that will be used to access your nodes. Please refer to this guide on [how to create a SSH KeyPair and add it to your Public Cloud project](/guides/public-cloud/compute/compute-getting-started). If you leave this field empty, a new keypair will be generated automatically.
...
![OVHcloud Managed Rancher Service Machine Pool 1](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-pci-compute-instances/rancher-machine-pool-1.png)
...
![OVHcloud Managed Rancher Service Machine Pool 2](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-pci-compute-instances/rancher-machine-pool-2.png)
...
![OVHcloud Managed Rancher Service Cluster Configuration](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-pci-compute-instances/rancher-cluster-config.png)
...
![OVHcloud Managed Rancher Service Cluster Created](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-pci-compute-instances/rancher-cluster-created.png)

### Testing the Kubernetes cluster 

To test your cluster, on the Rancher UI, in the **Cluster** menu, after selecting your cluster, you can simply click on the `Kubectl Shell` icon to open a terminal.
...
![OVHcloud Managed Rancher Service Test Cluster](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-pci-compute-instances/kubectl-get-nodes.png)
...
![OVHcloud Managed Rancher Service Test Cluster](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-pci-compute-instances/kubectl-get-ns.png)
