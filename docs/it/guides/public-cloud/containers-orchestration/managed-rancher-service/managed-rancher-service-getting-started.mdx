...
> [!warning]
>
> Deploying to OVHcloud will incur charges. For more information, refer to the [MKS](https://www.ovhcloud.com/it/public-cloud/prices/#568) and [Compute](/links/public-cloud/prices) pricing pages.
...
![Rancher Homepage](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/rancher-homepage_create.png)

2\. Use the OVHcloud **Hosted Kubernetes provider** by clicking on `OVHcloud MKS`.

![Cluster Creation](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/cluster-creation.png)

3\. Set the parameters of your MKS cluster:

![Cluster Creation](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/mks-cluster-creation-form.png)
...
| Member Roles | Yes, default value is ok | Configure user authorization for the cluster. Click `Add Member` to add users that can access the cluster. Use the Role drop-down menu to set permissions for each user. |
...
![MKS Driver Cluster Configuration](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/mksdriver_cluster_config.png)
...
![MKS Driver Cluster Configuration](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/mksdriver_network_configuration.png)
...
![MKS Driver Cluster Configuration](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/mksdriver_nodepool_configuration.png)
...
![MKS Driver Cluster Configuration](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/mksdriver_provisioning.png)

From the Cluster Management page, wait for your cluster to become `Active`.

![MKS Driver Cluster Configuration](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/mksdriver_cluster_provisioning.png)

![MKS Driver Cluster Configuration](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/mksdriver_cluster_provisioning_available.png)
...
> For more information, refer to the [MKS](https://www.ovhcloud.com/it/public-cloud/prices/#568) and [Compute](/links/public-cloud/prices) pricing pages.
...
![Cluster Creation](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/PublicCloudDriver_creation_auth.png)
...
![Public Cloud Driver - Cloud Credentials](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/PublicCloudDriver_creation_cloud_credential.png)
...
![Cluster Creation](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/PublicCloudDriver_creation_machine_pool.png)
...
- **Key Pair** (optional) - The SSH Key Pair that should be used to access your nodes. Please refer to this guide on [how to create a SSH KeyPair and add it to your Public Cloud project](/guides/public-cloud/compute/compute-getting-started). If you leave this field empty, a new keypair will be generated automatically.
...
Use Member Roles to configure user authorization for the cluster. Click `Add Member` to add users that can access the cluster. Use the `Role` drop-down menu to set permissions for each user.
...
![Rancher Homepage](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/rancher-homepage.png)

2\. Select **Generic**

![Import Cluster](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/import-cluster.png)

3\. Set the Cluster Name (it is not mandatory to match the name of your existing MKS cluster) then click on `Create`

![Import Cluster Form](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/import-cluster-form.png)

4\. Follow the instructions provided on the **Registration** tab.

![Register Cluster Instructions](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/register-cluster-instructions.png)
...
![Cluster Dashboard](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/cluster-dashboard-explore.png)
...
To access the application catalog, explore your federated downstream Kubernetes cluster and click on `Apps/Charts` in the left panel.

![App Catalog](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/getting-started/app-catalog.png)
