...
È possibile recuperare il buono d'ordine in qualsiasi momento dalla pagina [I miei ordini](https://manager.eu.ovhcloud.com/#/billing/orders), come spiegato di seguito.
...
Una volta generato il buono d'ordine, è possibile seguirlo dalla pagina [I miei ordini](https://manager.eu.ovhcloud.com/#/billing/orders):
...
Se i criteri di idoneità al diritto di recesso sono soddisfatti, il diritto di recesso può essere esercitato direttamente dalla pagina [I miei ordini](https://manager.eu.ovhcloud.com/#/billing/orders):
