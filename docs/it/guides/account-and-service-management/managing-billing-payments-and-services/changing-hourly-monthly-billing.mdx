...
:::warning
La procedura seguente non funziona per le istanze di terza generazione (esempio: B3-32). Per essere fatturati mensilmente per questo tipo di istanza, è necessario creare un [Savings Plan](/guides/public-cloud/public-cloud-cross-functional/savings-plans/) per questo modello di istanza.
