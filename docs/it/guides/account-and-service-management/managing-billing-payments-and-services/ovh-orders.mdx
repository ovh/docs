...
![Buono d'ordine OVH](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order01.png)
...
Accedi allo [Spazio Cliente OVHcloud](/links/manager). Nella nuova pagina, clicca su `Visualizza i tuoi ordini`.

![Spazio Cliente](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/huborders.png)

Ecco una sintesi dei diversi ordini effettuati:

![Riepilogo degli ordini](/images/assets/screens/control-panel/product-selection/right-column/initials/order-tab.png)
...
![Riepilogo degli ordini](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order04.png)
...
* Accedi allo [Spazio Cliente OVHcloud](/links/manager). Nella nuova pagina, clicca su `Visualizza i tuoi ordini` e poi sul pulsante `...` davanti al tuo ordine.
...
![Gestione degli ordini](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order05b.png)

Si apre una finestra in cui puoi effettuare il monitoraggio in quattro step.

![Gestione degli ordini](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order06.png)
...
![Annullamento di un ordine](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/cancelorder1.png)

Seleziona la casella `Sì, voglio annullare questo ordine` e infine conferma l'operazione.

![Conferma dell'operazione di annullamento](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/cancelorder2.png)
