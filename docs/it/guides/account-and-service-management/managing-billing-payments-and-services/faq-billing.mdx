...
La lista dei contatti dei tuoi servizi è disponibile dalla pagina [Gestione dei contatti](https://manager.eu.ovhcloud.com/#/account/contacts/services).
...
I dati di fatturazione sono quelli del tuo identificativo cliente. Per le prossime fatture, è sufficiente aggiornare queste informazioni dalla pagina [Il mio profilo](https://manager.eu.ovhcloud.com/#/account/useraccount/infos).
...
Per consultare lo stato dei tuoi servizi, apri la pagina [Le mie offerte e servizi](https://manager.eu.ovhcloud.com/#/billing/autorenew/services).
...
Per maggiori informazioni, consulta la guida [Gestire il rinnovo dei servizi](/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/).

### Come attivare il rinnovo automatico?

Nella pagina [Le mie offerte e servizi](https://manager.eu.ovhcloud.com/#/billing/autorenew/services), clicca sui tre puntini in corrispondenza del servizio interessato e seleziona l’opzione <code className="action">Attiva il pagamento automatico</code>.
...
Nella pagina [I miei metodi di pagamento](https://manager.eu.ovhcloud.com/#/billing/payment/method), clicca su <code className="action">Aggiungi un metodo di pagamento</code>.

### Come aggiornare un metodo di pagamento?

Nella pagina [I miei metodi di pagamento](https://manager.eu.ovhcloud.com/#/billing/payment/method), è possibile aggiungere o eliminare un metodo di pagamento (carta bancaria, Paypal o addebito SEPA).
...
Nella pagina [I miei metodi di pagamento](https://manager.eu.ovhcloud.com/#/billing/payment/method), seleziona il metodo di pagamento da eliminare e clicca sull’icona a forma di cestino.
...
Nella pagina [Le mie offerte e servizi](https://manager.eu.ovhcloud.com/#/billing/autorenew/services), è possibile consultare e modificare la frequenza di rinnovo delle soluzioni.
Per saperne di più, consulta questa guida dettagliata: [Gestire il rinnovo dei miei servizi](/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/).

#### Consigli e suggerimenti

La frequenza di rinnovo delle soluzioni può essere modificata dalla pagina [Le mie offerte e servizi](https://manager.eu.ovhcloud.com/#/billing/autorenew/services).
Per maggiori informazioni, consulta la guida [Gestire il rinnovo dei servizi](/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/).
...
Se la fattura che stai cercando non compare in questa sezione, è possibile che il tuo utente non risulti come contatto di fatturazione del servizio interessato. Per conoscerlo ed eventualmente modificarlo, apri la pagina [Gestione dei contatti](https://manager.eu.ovhcloud.com/#/account/contacts/services).
...
Per maggiori informazioni, consulta la guida [Sistema di fatturazione dei servizi Cloud](/guides/public-cloud/public-cloud-cross-functional/analyze-billing/).
...
Per scaricarlo, apri la pagina [Le mie fatture](https://manager.eu.ovhcloud.com/#/billing/history). Clicca su <code className="action">Azioni</code> > <code className="action">Esporta in CSV</code>.
