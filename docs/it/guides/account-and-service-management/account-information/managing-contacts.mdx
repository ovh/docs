...
- **Link diretto:** [Gestione dei contatti](https://manager.eu.ovhcloud.com/#/account/contacts/services)
...
:::warning
Ti consigliamo di non dare a terzi le credenziali di accesso allo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it).
