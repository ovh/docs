...
Nella pagina [Sicurezza dell'account](https://manager.eu.ovhcloud.com/#/account/useraccount/security), clicca su <code className="action">Attiva l'autenticazione a due fattori</code>.
...
Accedi alla [pagina di accesso allo Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it) e inserisci identificativo (o indirizzo email principale) e password.
...
Per rimuovere un dispositivo, accedi alla pagina [Sicurezza dell'account](https://manager.eu.ovhcloud.com/#/account/useraccount/security) e clicca sui <code className="action">...</code> a destra del dispositivo da rimuovere e poi su <code className="action">Eliminare</code>.
...
Per prima cosa, accedi alla [pagina di autenticazione dello Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it).
