...
Prima di tutto, verifica se l'e-mail che hai ricevuto è visibile anche nella pagina [I miei messaggi](https://manager.eu.ovhcloud.com/#/communication). Troverai le copie delle e-mail ufficiali inviate da OVHcloud.
...
Accedi alla pagina [Sicurezza](https://manager.eu.ovhcloud.com/#/account/useraccount/security) e modifica immediatamente la tua password.<br/>
