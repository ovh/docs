...
- **Link diretto:** [Il mio profilo](https://manager.eu.ovhcloud.com/#/account/useraccount/infos)
...
Per inserire questo indirizzo email di recupero, accedi al tuo [profilo utente](https://manager.eu.ovhcloud.com/#/account/useraccount/infos).
...
È possibile modificare le informazioni del tuo account. Accedi al tuo [profilo utente](https://manager.eu.ovhcloud.com/#/account/useraccount/infos).
