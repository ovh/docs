...
- Nella pagina [Sicurezza dell'account](https://manager.eu.ovhcloud.com/#/account/useraccount/security), clicca sul pulsante <code className="action">Modificare</code> in corrispondenza della voce “Password”.
