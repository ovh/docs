...
description: Shared responsibilities between OVHcloud and the customer for NAS-HA and Enterprise File Storage solutions
...
Visit our dedicated Discord channel: [https://discord.gg/ovhcloud](https://discord.gg/ovhcloud). Ask questions, provide feedback and interact directly with the team that builds our services.
