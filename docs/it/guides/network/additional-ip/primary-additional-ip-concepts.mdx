...
You can find more information about the differences between Floating IP and Additional IP in [this guide](/guides/public-cloud/public-cloud-network-services/additional-ip-vs-floating-ip).
...
- **Configuration**: IPv4 and IPv6 addresses configuration details, such as address, prefix size, or default gateway, can be found within the [OVHcloud Control Panel](/links/manager), usually in the `Network` tab of the given product.
...
> [!tip]
> **Related Guides** :
> - [Configuring an Additional IPv6 block in a vRack](/guides/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack)
