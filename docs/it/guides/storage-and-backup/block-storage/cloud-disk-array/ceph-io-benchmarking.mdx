...
description: Come verificare le reali prestazioni del servizio Cloud Disk Array
...
Visita il nostro canale Discord dedicato: [https://discord.gg/ovhcloud](https://discord.gg/ovhcloud). Poni domande, fornisci feedback e interagisci direttamente con il team che crea i nostri servizi di archiviazione e backup.
