...
Questo URL è composto da un punto terminale, disponibile dall'[interfaccia Horizon](/guides/public-cloud/public-cloud-cross-functional/access-and-security-in-horizon/), dal nome del container e dal nome del tuo oggetto (incluso il prefisso).
