...
Per generare l'identificativo cliente e la password OpenStack, consulta questa [guida](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/).
