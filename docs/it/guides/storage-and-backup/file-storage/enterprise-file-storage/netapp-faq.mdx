...
Sì, il servizio è direttamente accessibile dallo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it), nella sezione <code className="action">Bare Metal Cloud</code>, poi <code className="action">Storage e Backup</code>.
