...
- You already have a [private network](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack) available in your project.
- A [Public Cloud instance](https://www.ovhcloud.com/en-gb/public-cloud/) in your OVHcloud account
- An [OpenStack CLI ready environment](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment)
...
Example output:
    ...
    **2\. Authorize a client VM**
    ...
    Retrieve the VM’s [private IP address](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack).
...
**3\. Mount the share on your client VM**
  ...
  <Tab label="Via Manila CSI in Kubernetes environment">
    ...
    **4\. Installing OpenStack CLI**
    ...
    Prepare your environment to use the OpenStack API by installing python-openstackclient, following [this guide](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment).
