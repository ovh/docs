...
Log in to the [OVHcloud Control Panel](/links/manager) and add an Additional IP address to your [vRack](https://www.ovh.it/soluzioni/vrack/).
...
Connect to Prism Central and go to `Compute & Storage`, then `Images`.

Click on the `Add Image` button.

![clic add image](/images/guides/hosted-private-cloud/nutanix-on-ovhcloud/24-add-public-ip-on-vm/add-image.png)
...
![clic add image](/images/guides/hosted-private-cloud/nutanix-on-ovhcloud/24-add-public-ip-on-vm/add-image2.png)

Select `Place image directly on clusters`, then select your cluster and `Save`.

![clic add image](/images/guides/hosted-private-cloud/nutanix-on-ovhcloud/24-add-public-ip-on-vm/add-image3.png)
