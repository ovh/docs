...
An example of an IPsec interconnection in this guide: [IPsec interconnection between two sites](/guides/hosted-private-cloud/nutanix-on-ovhcloud/44-ipsec-interconnection/)
...
Details of these solutions can be found in our documentation on [asynchronous or NearSync replication through Prism Element](/guides/hosted-private-cloud/nutanix-on-ovhcloud/46-prism-element-replication/)
