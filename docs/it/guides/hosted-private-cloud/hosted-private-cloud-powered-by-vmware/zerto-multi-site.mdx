...
- Log in to the [OVHcloud Control Panel](/links/manager), then go to the `Hosted Private Cloud` section.
...
![zerto manager tab](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-multi-site/zerto_manager_tab.png)
...
![zerto manager add onprem zerto](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-multi-site/zerto_manager_add_onprem_zerto.png)
...
![zerto manager vpn configuration](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-multi-site/zerto_manager_vpn_configuration.png)
...
![zerto manager status finished](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-multi-site/zerto_status_finished.png)
...
- On Managed vSphere Zerto, go to `Sites` tab and get the token:
    ...
    ![zerto get token](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-multi-site/zerto_get_token.png)

- On your on-premises Zerto, choose `Pair to a site` and enter the Managed vSphere Zerto IP and token:

    ![zerto pair site](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-multi-site/zerto_pair_site.png)
...
![network diagram](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-multi-site/network_diagram.png)
