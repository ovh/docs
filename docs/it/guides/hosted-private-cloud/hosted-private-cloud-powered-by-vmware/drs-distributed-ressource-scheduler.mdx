...
![Principio del DRS](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs0.png)
...
Se la funzione DRS non è già attiva nel tuo cluster, selezionalo e poi clicca sulla scheda `Configura`.

Clicca sul menu `Servizi` e poi sul sottomenu `vSphere DRS`.

Clicca su `Modifica` e attiva il cursore `vSphere DRS` per attivare la funzionalità DRS.

![Attivazione di ACE](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs01.png)
...
![automazione DRS](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs02.png)
...
![opzioni aggiuntive DRS](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs03.png)
...
![opzioni avanzate drs](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs05.png)

### Le regole DRS

Per la gestione delle regole VM/host clicca sulla scheda `Configura`.

![regole drs](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs06.png)
...
La quarta regola, "Da macchine virtuali a macchine virtuali" è spiegata nella nostra guida sulla funzione [funzione HA](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability).

![creazione regole drs](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs07.png)
