...
<img className="thumbnail" alt="Typical lifecycle of a VMware on OVHcloud service" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/lifecycle-policy/01_lifecycle_pcc.png" loading="lazy" />
