...
![dashboard Public VCF as-a-Service](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-first-vm-creation/vcd-dashboard-vcd.png)

![dashboard vm](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-first-vm-creation/vcd-vm-dashboad.png)
...
![Menu VM Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-first-vm-creation/vcd-creation-template-vm.png)<br />
...
![Menu VM Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-first-vm-creation/vdc-creation-vm-scratch.png)<br />
...
![Menu Vm Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-first-vm-creation/vcd-vm-clone.png)<br />
  </Tab>
</Tabs>
...
![Creation VM Storage](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-first-vm-creation/vcd-creation-vm-network.png)
...
![Storage Policies](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-first-vm-creation/vcd-create-vm-storage-policies.png)
...
![VM Template Created](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-first-vm-creation/vcd-vm-template-created.png)
...
>
> ![VM Creation Gif](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-first-vm-creation/vcd-create-VM.gif)
