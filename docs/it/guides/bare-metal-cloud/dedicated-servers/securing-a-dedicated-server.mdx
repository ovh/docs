...
description: Come impostare misure di sicurezza di base per proteggere il server dedicato da attacchi e accessi non autorizzati
...
[Configura il firewall su Windows](/guides/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win/)
