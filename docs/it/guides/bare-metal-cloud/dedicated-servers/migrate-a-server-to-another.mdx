...
description: Come migrare i dati da un server dedicato a un altro
...
- Il modo più semplice è utilizzare un software adeguato come [SFTP](/guides/bare-metal-cloud/dedicated-servers/comment-deposer-ou-recuperer-des-donnees-sur-un-serveur-dedie-via-sftp/).
...
Per maggiori informazioni, leggi la nostra documentazione sui [domini e DNS](/guides/web-cloud/domains/overview/).
