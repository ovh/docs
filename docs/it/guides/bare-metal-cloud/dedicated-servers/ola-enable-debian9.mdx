...
<br/>Per attivare il tool accedi allo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it). Nella sezione <code className="action">Bare Metal Cloud</code>, seleziona il tuo server tra <code className="action">Server dedicati</code> e clicca sulla scheda <code className="action">IPMI</code> (1).
