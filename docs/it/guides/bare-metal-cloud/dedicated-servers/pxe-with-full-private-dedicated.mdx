...
The only significant difference is that [private networks](/guides/network/ovhcloud-connect/occ-concepts-overview#private-connection/) do not have access to everything that does not belong to your infrastructure.<br/>
