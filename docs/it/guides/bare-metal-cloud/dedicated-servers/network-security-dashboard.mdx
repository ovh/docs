...
- **Link diretto:** [Security Dashboard](https://manager.eu.ovhcloud.com/#/dedicated/network-security/scrubbing-center)
...
Accedi allo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it), clicca su <code className="action">Network</code> nel menu a sinistra dello schermo e poi su <code className="action">Indirizzi IP Pubblici</code>. Verifica che la `Modalità avanzata` sia abilitata per visualizzare lo stato dell'infrastruttura anti-DDoS e la configurazione dei suoi componenti.
