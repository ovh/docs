...
Per configurare il percorso del reverse DNS nello [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it), consulta la [nostra guida dedicata](/guides/bare-metal-cloud/virtual-private-servers/configuring-reverse-dns/).
