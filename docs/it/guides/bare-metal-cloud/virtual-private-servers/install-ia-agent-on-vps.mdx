...
### Update your VPS and install Python <a id="step1"></a>
...
### Create a virtual environment and install Open Interpreter <a id="step2"></a>
...
### Configure an AI template for the agent (local or remote) <a id="step3"></a>
...
### Test your AI Agent <a id="step4"></a>
...
![AI agent](/images/guides/bare-metal-cloud/virtual-private-servers/install-ia-agent-on-vps/question-version-python.png)
...
![AI agent](/images/guides/bare-metal-cloud/virtual-private-servers/install-ia-agent-on-vps/question-python-script.png)
