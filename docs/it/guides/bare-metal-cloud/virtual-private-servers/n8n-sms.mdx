...
- Disporre di un [account SMS OVHcloud](https://www.ovhcloud.com/it/sms/) e un [mittente SMS](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-expediteurs-sms/) valido.
...
- [Il mittente deve essere definito nel tuo account OVHcloud](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-expediteurs-sms/). Per effettuare un test senza dichiarare un mittente e utilizzare un numero corto, sostituisci `"sender": "Your_sender"` con `"senderForResponse": true`.
