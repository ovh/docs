...
Dallo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it) o tramite le API OVHcloud, puoi installare l'applicazione che preferisci. Consulta la guida Iniziare [a utilizzare un VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps/).
