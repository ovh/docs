...
Le azioni descritte in questa guida devono essere effettuate dal proprio servizio Managed Bare Metal direttamente sul client vSphere, cliccando con il tasto destro sulla VM e selezionando la voce `Edit Settings`.

![Modifica delle risorse](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware01.png)

Questo menu permette di aggiungere o rimuovere le risorse della macchina virtuale. 

![Modifica delle risorse](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware02.png)
...
![Aggiunta di CPU](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware03.png)
...
![Aggiunta di memoria](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware04.png)
...
![Aggiunta di storage](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware05.png)
...
![Aggiunta della rete](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware06.png)
...
![Aggiunta di un lettore CD/DVD](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware07.png)
...
![Aggiunta di componenti](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware08.png)
