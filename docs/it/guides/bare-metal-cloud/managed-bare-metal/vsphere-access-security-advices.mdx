...
<img className="thumbnail" alt="Aggiunta di IP" src="/images/bare-metal-cloud/managed-bare-metal/vsphere-access-security-advices/adding_ip.png" loading="lazy" />
...
<img className="thumbnail" alt="Utenti" src="/images/bare-metal-cloud/managed-bare-metal/vsphere-access-security-advices/users.png" loading="lazy" />
...
<img className="thumbnail" alt="Modifica dei parametri degli utenti" src="/images/bare-metal-cloud/managed-bare-metal/vsphere-access-security-advices/users_edit.png" loading="lazy" />
...
Questa operazione è disponibile nello [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it). Accedi alla sezione Managed Bare Metal, seleziona la scheda <code className="action">Sicurezza</code> e clicca sul pulsante <code className="action">Modifica la durata di una sessione </code> a destra.

<img className="thumbnail" alt="Scadenza della sessione" src="/images/bare-metal-cloud/managed-bare-metal/vsphere-access-security-advices/security-expiration.png" loading="lazy" />

A questo punto, inserisci il numero di minuti di validità di una sessione.

<img className="thumbnail" alt="Scadenza della sessione" src="/images/bare-metal-cloud/managed-bare-metal/vsphere-access-security-advices/expiration.png" loading="lazy" />
