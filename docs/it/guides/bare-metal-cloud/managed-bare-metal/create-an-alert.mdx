...
<img className="thumbnail" alt="Creazione di un alert" src="/images/bare-metal-cloud/managed-bare-metal/create-an-alert/alarms01.png" loading="lazy" />
...
<img className="thumbnail" alt="Nome e destinazione dell'alert" src="/images/bare-metal-cloud/managed-bare-metal/create-an-alert/alarms02.png" loading="lazy" />
...
<img className="thumbnail" alt="Regole dell'alert" src="/images/bare-metal-cloud/managed-bare-metal/create-an-alert/alarms03.png" loading="lazy" />
...
<img className="thumbnail" alt="Sospensione dell'alert" src="/images/bare-metal-cloud/managed-bare-metal/create-an-alert/alarms04.png" loading="lazy" />
...
<img className="thumbnail" alt="Ripeilogo dell'alert" src="/images/bare-metal-cloud/managed-bare-metal/create-an-alert/alarms05.png" loading="lazy" />
