...
Le azioni descritte in questa guida devono essere effettuate dal proprio servizio Managed Bare Metal direttamente sul client vSphere, cliccando con il tasto destro sulla VM e selezionando la voce <code className="action">Edit Settings</code>.

<img className="thumbnail" alt="Modifica delle risorse" src="/images/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware01.png" loading="lazy" />

Questo menu permette di aggiungere o rimuovere le risorse della macchina virtuale. 

<img className="thumbnail" alt="Modifica delle risorse" src="/images/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware02.png" loading="lazy" />
...
<img className="thumbnail" alt="Aggiunta di CPU" src="/images/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware03.png" loading="lazy" />
...
<img className="thumbnail" alt="Aggiunta di memoria" src="/images/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware04.png" loading="lazy" />
...
<img className="thumbnail" alt="Aggiunta di storage" src="/images/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware05.png" loading="lazy" />
...
<img className="thumbnail" alt="Aggiunta della rete" src="/images/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware06.png" loading="lazy" />
...
<img className="thumbnail" alt="Aggiunta di un lettore CD/DVD" src="/images/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware07.png" loading="lazy" />
...
<img className="thumbnail" alt="Aggiunta di componenti" src="/images/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware08.png" loading="lazy" />
