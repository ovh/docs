...
<img className="thumbnail" alt="Deploy di una VM" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm01.png" loading="lazy" />

Per creare una macchina virtuale è possibile scegliere tra diverse opzioni:

- Da un file ISO, disponibile nel datastore.
- Da un template personale o [fornito da OVHcloud](/guides/bare-metal-cloud/managed-bare-metal/ovf-template/).
...
<img className="thumbnail" alt="Scelta della modalità di creazione" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm02.png" loading="lazy" />
...
<img className="thumbnail" alt="Localizzazione della macchina virtuale" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm03.png" loading="lazy" />
...
<img className="thumbnail" alt="Scelta delle risorse" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm04.png" loading="lazy" />
...
<img className="thumbnail" alt="Scelta dello storage" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm05.png" loading="lazy" />
...
<img className="thumbnail" alt="Scelta della compatibilità" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm06.png" loading="lazy" />
...
<img className="thumbnail" alt="Scelta del Guest OS" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm07.png" loading="lazy" />
...
<img className="thumbnail" alt="Scelta della rete" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm08.png" loading="lazy" />
...
<img className="thumbnail" alt="Scelta del file ISO" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm09.png" loading="lazy" />
...
<img className="thumbnail" alt="Connettere ISO" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm10.png" loading="lazy" />
...
<img className="thumbnail" alt="Riepilogo VM" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm11.png" loading="lazy" />
...
<img className="thumbnail" alt="Avvio VM" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm12.png" loading="lazy" />
