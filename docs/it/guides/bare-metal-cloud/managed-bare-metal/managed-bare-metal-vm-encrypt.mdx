...
![Fingerprint del certificato](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/certificate_thumbprints_01.png)

![Fingerprint del certificato](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/certificate_thumbprints_02.png)
...
Accedi allo Spazio Cliente e, nella sezione `Bare Metal Cloud`, clicca su `Managed Bare Metal` nella colonna a sinistra e seleziona il servizio in questione.

Nella pagina principale, clicca sulla scheda `Sicurezza`.

![Spazio Cliente OVHcloud](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_nupanel_01.png)
...
* seleziona la casella in cui dichiari di aver preso visione e compreso la documentazione e le azioni da effettuare. Clicca su `Continua` per confermare l'operazione. 
...
Per prima cosa accedi al Managed Bare Metal con il client Web vSphere, esplora la lista dell'inventario e seleziona il vCenter in questione. Clicca su "Manage" > "Key Management Servers". Clicca su `Add KMS`, inserisci le informazioni nella configurazione guidata e clicca su `OK`.
Clicca su `Trust` per convalidare il certificato.

![Procedura di aggiunta KMS](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_01.png)
...
![Importazione certificato KMS](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_02.png)

#### Verifica la configurazione del KMS

In **Connection Status**, verifica che lo stato del KMS risulti in modalità "Normal".

![Verifica lo stato della connessione](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_03.png)
...
![vMotion cifrato](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_06.png)
...
![Verifica della configurazione](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_07.png)

![Verifica della configurazione](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_08.png)

![Verifica della configurazione](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_09.png)
