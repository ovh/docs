...
In questa guida utilizzeremo una VM installata su Debian 9, creata a partire dai [template disponibili sul servizio Managed Bare Metal](/guides/bare-metal-cloud/managed-bare-metal/ovf-template/).
...
In questo esempio utilizziamo una VM installata su Ubuntu 18.04, creata a partire dai [template disponibili sul servizio Managed Bare Metal](/guides/bare-metal-cloud/managed-bare-metal/ovf-template/).
