...
If you have enabled [IAM on your account](/guides/manage-and-operate/observability/logs-data-platform/overview/) you first need to create a policy and give the creation rights to your preferred user/account. See the [IAM for LDP documentation policy guide](/guides/manage-and-operate/observability/logs-data-platform/overview/).
...
If you don't know how to create a Logstash collector, please refer to the [Logstash guide](/guides/manage-and-operate/observability/logs-data-platform/ingestion-logstash-dedicated-input/). Edit the configuration of Logstash. For this example we will use a SSL TCP input with the GELF codec. Here is the input configuration.
...
- **username**: This is the username to authenticate yourself against the API. Again, we recommend that you use [tokens](/guides/manage-and-operate/observability/logs-data-platform/security-tokens/) for that.
...
- **fields**: This is where the magic happens. The field of the document found will be added to the event. The field of the document is on the left and the new (or updated) field of the event is on the right. Be sure to follow the [field naming conventions](/guides/manage-and-operate/observability/logs-data-platform/getting-started-field-naming-convention/).
