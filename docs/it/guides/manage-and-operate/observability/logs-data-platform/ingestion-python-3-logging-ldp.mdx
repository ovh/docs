...
- a facility to ensure fields suits the [LDP naming conventions](/guides/manage-and-operate/observability/logs-data-platform/getting-started-field-naming-convention/).
...
* Fields are types using the [LDP naming convention](/guides/manage-and-operate/observability/logs-data-platform/getting-started-field-naming-convention/): `manager.age` is renamed `manager_age_int`
