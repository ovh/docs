...
- You must have [ordered an OKMS domain](/guides/manage-and-operate/kms/kms-quick-start).
...
| `--kmip-addr`   | Address of the KMIP server. Available in your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) on your OKMS domain page. (e.g., `eu-west-rbx.okms.ovh.net:5696`). | `""` (required)                  |
