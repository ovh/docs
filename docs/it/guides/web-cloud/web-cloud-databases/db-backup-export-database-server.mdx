...
Clicca sui tre puntini `...` in corrispondenza del database e seleziona `Salva adesso`.
...
Clicca sui tre puntini `...` a destra del database e seleziona `Mostra i backup`
...
Visualizzi la lista dei backup disponibili, clicca sul pulsante `...` a destra del backup scelto e poi su `Scarica il backup` per recuperare questo backup.
...
Per esportare il tuo database direttamente da phpMyAdmin, è necessario effettuare l'accesso. Per effettuare questa operazione, consulta la guida ["Connettersi a un database"](/guides/web-cloud/web-cloud-databases/db-connecting-database-server).

Una volta connesso a phpMyAdmin, clicca sul nome del database da esportare e poi sulla scheda `Esporta` in alto.
...
[Ripristinare e importare un database sul tuo server di database](/guides/web-cloud/web-cloud-databases/db-restore-import-database)
