...
Per ordinare un servizio Office 365 Reseller, accedi al tuo [Spazio Cliente OVHcloud](/links/manager). Seleziona `Sunrise` nel pannello superiore e clicca su `Office 365 Reseller`.
...
- Clicca su `Ordina` per finalizzare
...
Per effettuare questa operazione accedi alla sezione `Sunrise`. Nel menu a sinistra, seleziona `Office 365 Reseller` e poi seleziona il servizio.
