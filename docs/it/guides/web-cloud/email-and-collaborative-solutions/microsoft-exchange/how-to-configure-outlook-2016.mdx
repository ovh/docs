...
Ti consigliamo di verificare la configurazione del nome di dominio configurato sul tuo servizio Exchange nel tuo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it), scheda <code className="action">Domini associati</code>, quindi colonna <code className="action">Diagnostica</code> della tabella.
