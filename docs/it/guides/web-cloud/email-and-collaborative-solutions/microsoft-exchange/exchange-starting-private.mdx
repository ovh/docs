...
Per consultare questa email dal tuo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it), clicca sul tuo profilo in alto a destra e poi su <code className="action">Email de servizio</code> e cerca l’email che ha come oggetto:
