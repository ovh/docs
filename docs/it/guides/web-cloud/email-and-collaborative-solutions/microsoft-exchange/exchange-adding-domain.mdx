...
È possibile acquistare licenze Outlook nello [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it) e licenze Office 365 nella pagina [Microsoft 365](https://www.ovhcloud.com/it/collaborative-tools/microsoft-365/). Per utilizzare un client di posta Outlook o più programmi della suite Office, ti consigliamo una di queste soluzioni.
