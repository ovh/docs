...
<img className="thumbnail" alt="creazione dei token" src="/images/web-cloud/messaging/sms/envoyer-des-sms-avec-lapi-ovh-en-nodejs/img_2462.jpg" loading="lazy" />
...
<img className="thumbnail" alt="recupero dei token" src="/images/web-cloud/messaging/sms/envoyer-des-sms-avec-lapi-ovh-en-nodejs/img_2463.jpg" loading="lazy" />
