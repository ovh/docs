...
Per maggiori informazioni sulla funzione http2sms, consulta la guida [Inviare SMS da un URL](/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-url---http2sms/).
