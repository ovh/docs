...
Puoi consultare la guida che segue per qualsiasi dettaglio sugli utenti SMS: [Tutte le informazioni sugli utenti SMS](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms/)
...
<img className="thumbnail" alt="Lista dei caratteri SMS" src="/images/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-adresse-email/smsauthorizedcharacters.png" loading="lazy" />
