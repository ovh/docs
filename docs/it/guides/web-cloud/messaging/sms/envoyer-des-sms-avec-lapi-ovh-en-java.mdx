...
<img className="thumbnail" alt="creazione di token" src="/images/web-cloud/messaging/sms/envoyer-des-sms-avec-lapi-ovh-en-java/img_2479.jpg" loading="lazy" />
...
<img className="thumbnail" alt="recupero dei token" src="/images/web-cloud/messaging/sms/envoyer-des-sms-avec-lapi-ovh-en-java/img_2480.jpg" loading="lazy" />
