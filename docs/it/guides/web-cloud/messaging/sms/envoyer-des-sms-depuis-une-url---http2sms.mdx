...
- Creare un utente SMS attraverso lo Spazio Cliente OVHcloud o direttamente attraverso le API. A questo proposito, è possibile consultare la guida che segue: [Tutte le informazioni sugli utenti SMS](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms/)
...
<img className="thumbnail" alt="http2sms" src="/images/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-url---http2sms/img_4011.jpg" loading="lazy" />
...
<img className="thumbnail" alt="Lista dei caratteri SMS" src="/images/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-url---http2sms/smsauthorizedcharacters.png" loading="lazy" />
