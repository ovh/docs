...
![changeACS](/images/guides/web-cloud/internet/internet-access/comment-changer-backend-acs/changeACS-step1-2022.png)
...
Une fois le backend choisi, sélectionnez-le dans la liste déroulante et cliquez sur le bouton `Valider`.
...
![changeACS](/images/guides/web-cloud/internet/internet-access/comment-changer-backend-acs/changeACS-step2.png)
