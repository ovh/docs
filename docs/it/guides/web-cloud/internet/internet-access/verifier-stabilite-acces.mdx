...
![serviceName dans espace client](/images/guides/web-cloud/internet/internet-access/verifier-stabilite-acces/servicename-2022.png)
...
Saisissez, dans le champ `serviceName`, la référence de votre accès obtenue à l'étape précédente. Cliquez alors sur `Execute`.

Voici un exemple de retour :

![api_radex](/images/guides/web-cloud/internet/internet-access/verifier-stabilite-acces/api_radex3.png)
