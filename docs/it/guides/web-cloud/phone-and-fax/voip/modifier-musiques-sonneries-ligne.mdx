...
1. Positionnez-vous ensuite sur l'onglet `Gestion des musiques`.

![sonneriesetmusiques](/images/guides/web-cloud/phone-and-fax/voip/modifier-musiques-sonneries-ligne/gestion-musiques.png)
...
Une fois que vous êtes prêt, en dessous de la musique ou de la sonnerie que vous voulez modifier, choisissez `Personnalisée` dans le menu déroulant puis cliquez sur le bouton `Choisir un fichier`. Dans la fenêtre qui s'ouvre, retrouvez le fichier audio que vous souhaitez utiliser. Une fois sélectionné, cliquez sur le bouton `Envoyer le fichier`.

![sonneriesetmusiques](/images/guides/web-cloud/phone-and-fax/voip/modifier-musiques-sonneries-ligne/ajout-musique.png)
