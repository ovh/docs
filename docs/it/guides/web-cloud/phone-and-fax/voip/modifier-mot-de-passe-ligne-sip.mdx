...
1. Positionnez-vous ensuite sur l'onglet `Gestion`, puis cliquez sur le bouton `Mot de passe SIP`.
...
![passwordsip](/images/guides/web-cloud/phone-and-fax/voip/modifier-mot-de-passe-ligne-sip/password-sip-step1.png)

### Étape 2 : modifier le mot de passe de la ligne SIP

Dans la fenêtre qui s'affiche, renseignez le nouveau mot de passe souhaité dans la zone de texte en dessous de « Nouveau mot de passe », puis cliquez sur le bouton `Valider`.
...
![passwordsip](/images/guides/web-cloud/phone-and-fax/voip/modifier-mot-de-passe-ligne-sip/password-sip-step2.png)
