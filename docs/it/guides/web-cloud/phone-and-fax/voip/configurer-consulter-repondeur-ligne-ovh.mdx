...
> Vous devez alors configurer les plages horaires sur ce numéro et non sur votre ligne. Pour en savoir plus, consultez notre [FAQ](/guides/web-cloud/phone-and-fax/voip/faq-voip) et nos [guides de configuration des numéro alias](/guides/web-cloud/phone-and-fax/voip/overview).
>
...
### Consulter son répondeur <a id="consulter"></a>
...
#### Consulter son répondeur via un téléphone <a id="via-telephone"></a>
...
1. Positionnez-vous ensuite sur l'onglet `Répondeur`, cliquez sur `Mot de passe accès répondeur` et suivez les indications.

#### Consulter son répondeur via votre espace client <a id="via-espace-client"></a>

1. Connectez-vous à votre [espace client OVHcloud](/links/manager) et cliquez sur `Télécom`.
1. Cliquez sur `VoIP & Fax` puis sur le groupe de facturation contenant votre ligne SIP.
1. Cliquez sur l'onglet `Services` puis sur la ligne SIP pour laquelle vous souhaitez consulter le répondeur.
1. Positionnez-vous ensuite sur l'onglet `Répondeur` et cliquez sur `Écoute et gestion des messages`.

![repondeur](/images/guides/web-cloud/phone-and-fax/voip/configurer-consulter-repondeur-ligne-ovh/voicemail-step7.png)
...
![repondeur](/images/guides/web-cloud/phone-and-fax/voip/configurer-consulter-repondeur-ligne-ovh/voicemail-step8.png)

#### Consulter son répondeur via les notifications e-mail <a id="via-notifications"></a>
...
### Personnaliser la configuration de son répondeur <a id="personnaliser"></a>

1. Connectez-vous à votre [espace client OVHcloud](/links/manager) et cliquez sur `Télécom`.
1. Cliquez sur `VoIP & Fax` puis sur le groupe de facturation contenant votre ligne SIP.
1. Cliquez sur l'onglet `Services` puis sur la ligne SIP concernée.
1. Positionnez-vous sur l'onglet `Répondeur` puis cliquez sur `Configuration du répondeur`. 

![repondeur](/images/guides/web-cloud/phone-and-fax/voip/configurer-consulter-repondeur-ligne-ovh/voicemail-step3.png)
...
- **Accueil et enregistrement des messages** : faites votre choix parmi les paramètres proposés, puis appuyez sur le bouton `Appliquer les options` pour valider les modifications que vous venez d'effectuer.
...
![repondeur](/images/guides/web-cloud/phone-and-fax/voip/configurer-consulter-repondeur-ligne-ovh/voicemail-step4.png)

- **Options de notification** : faites votre choix parmi les paramètres proposés, puis appuyez sur le bouton `Appliquer les options` pour valider les modifications que vous venez d'effectuer.
...
![repondeur](/images/guides/web-cloud/phone-and-fax/voip/configurer-consulter-repondeur-ligne-ovh/voicemail-step5.png)

- **Adresses e-mail à notifier** : visualisez, grâce au tableau, les adresses qui recevront une notification, supprimez-en grâce à l'icône en forme de poubelle et ajoutez-en des nouvelles en cliquant sur le bouton `Ajouter une adresse e-mail`, puis en remplissant les champs demandés.
...
![repondeur](/images/guides/web-cloud/phone-and-fax/voip/configurer-consulter-repondeur-ligne-ovh/voicemail-step6.png)

### Associer une ligne à un répondeur <a id="associer"></a>
...
1. Cliquez sur `VoIP & Fax` puis sur le groupe de facturation contenant votre ligne SIP.
1. Cliquez sur l'onglet `Services` puis sur la ligne SIP concernée.
1. Positionnez-vous sur l'onglet `Répondeur` puis cliquez sur `Choix de la messagerie par défaut`.

![repondeur](/images/guides/web-cloud/phone-and-fax/voip/configurer-consulter-repondeur-ligne-ovh/voicemail-step1.png)

Sur la page qui s'affiche, sélectionnez dans le menu déroulant le nouveau répondeur que vous souhaitez associer à la ligne concernée. Vous avez la possibilité d'appliquer vos choix de configuration à plusieurs lignes, grâce au bouton `Appliquer à plusieurs lignes`. Cliquez sur le bouton `Valider` pour terminer la première manipulation.

![repondeur](/images/guides/web-cloud/phone-and-fax/voip/configurer-consulter-repondeur-ligne-ovh/voicemail-step2.png)

Retournez vers la gestion du répondeur et positionnez-vous maintenant sur l'onglet `Gestion des appels`. Cliquez alors sur le bouton `Renvoi d'appel`. 

![repondeur](/images/guides/web-cloud/phone-and-fax/voip/configurer-consulter-repondeur-ligne-ovh/voicemail-step9.png)
...
Vous avez la possibilité d'appliquer vos choix de configuration à plusieurs lignes, grâce au bouton `Appliquer à plusieurs lignes`. Cliquez sur le bouton `Valider` pour terminer l'opération.

![repondeur](/images/guides/web-cloud/phone-and-fax/voip/configurer-consulter-repondeur-ligne-ovh/voicemail-step10.png)
