...
### Étape 1 : Retrouver et définir les identifiants de votre ligne SIP <a id="sip-credentials"></a>
...
1. Dans l'onglet `Gestion`, cliquez sur `Informations générales`.

![ligne sip - Login et Domain](/images/guides/web-cloud/phone-and-fax/voip/popc-installation/login-domain1.png)

Vous retrouvez alors, dans le cadre « Informations SIP », votre **login** et votre **domain**.

![ligne sip - Login et Domain](/images/guides/web-cloud/phone-and-fax/voip/popc-installation/login-domain2.png)
...
Pour lancer l'installation du logiciel, sur votre PC, faites un clic droit sur le fichier nommé `VoiceOperatorPanel-OVH-setup.exe` et sélectionnez `Exécuter en tant qu'administrateur`.

Lancez l'installation et acceptez les contrats.

![installation - contrats](/images/guides/web-cloud/phone-and-fax/voip/popc-installation/popc-install-01.png)
...
![installation - dongle](/images/guides/web-cloud/phone-and-fax/voip/popc-installation/popc-install-02.png)
...
![installation - mode](/images/guides/web-cloud/phone-and-fax/voip/popc-installation/popc-install-03.png)
...
Une fois validé, cliquez sur `Next` puis sur `Finish`.
...
![configuration - login domain proxy SIP](/images/guides/web-cloud/phone-and-fax/voip/popc-installation/popc-config-01.png)
...
![configuration - mot de passe SIP](/images/guides/web-cloud/phone-and-fax/voip/popc-installation/popc-config-02.png)
...
![configuration - répondeur](/images/guides/web-cloud/phone-and-fax/voip/popc-installation/popc-config-03.png)
...
![configuration - email](/images/guides/web-cloud/phone-and-fax/voip/popc-installation/popc-config-04.png)
...
![configuration - entrée et sortie audio](/images/guides/web-cloud/phone-and-fax/voip/popc-installation/popc-config-05.png)
...
- Si vous avez commandé l'offre POPC, veillez à ce que le dongle USB soit bien branché sur votre PC et cliquez sur `Saisir une licence`.
- Si vous avez installé le logiciel POPC dans le but de le tester, cliquez sur `Demande d'essai`.

![configuration - essai - licence](/images/guides/web-cloud/phone-and-fax/voip/popc-installation/popc-config-06.png)
...
![configuration - statut du compte](/images/guides/web-cloud/phone-and-fax/voip/popc-installation/popc-config-07.png)
...
Une fois le logiciel ouvert, cliquez sur l'onglet `Paramètres` dans la partie droite de l'interface principale. Ouvrez alors le menu déroulant `Compte` pour retrouver les champs de configuration.
...
![configuration - via interface](/images/guides/web-cloud/phone-and-fax/voip/popc-installation/popc-config-08.png)
...
Une fois que vous avez défini ces informations, cliquez sur `Sauvegarder`. Le logiciel va redémarrer et appliquer la nouvelle configuration SIP que vous avez définie.
