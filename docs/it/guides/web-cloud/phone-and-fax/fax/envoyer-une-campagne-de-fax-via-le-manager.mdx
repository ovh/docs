...
Cliquez sur l'onglet `Fax` puis sur `Campagnes de fax`.

![campagne fax](/images/guides/web-cloud/phone-and-fax/fax/envoyer-une-campagne-de-fax-via-le-manager/01campagne-fax2022.png)

Cliquez sur le bouton `+ Nouvelle campagne` pour configurer votre campagne de fax.

![campagne fax](/images/guides/web-cloud/phone-and-fax/fax/envoyer-une-campagne-de-fax-via-le-manager/02campagne-fax.png)
...
* Document à faxer (format pdf) : cliquez sur le bouton `Fichier` pour sélectionner le document à envoyer, celui-ci doit être au format **PDF**.
...
* Destinataires : vous pouvez choisir de soit `Entrer les destinataires manuellement`, soit téléverser dans l'espace client un `Fichier de destinataires` au format **txt**. Dans ce dernier cas, cliquez sur le nouveau bouton `Fichier` pour ajouter votre liste de destinataires.
...
Une fois tous les champs complétés, cliquez sur `Valider`.
...
Cliquez sur le bouton `...` à droite de la campagne pour avoir accès aux options de suivi :

* `Détails` : permet d'afficher les détails d'une campagne (nom, référence, statu, état, planification, statut des envois).
...
* `Supprimer` : permet de supprimer une campagne de l'historique.

![campagne fax](/images/guides/web-cloud/phone-and-fax/fax/envoyer-une-campagne-de-fax-via-le-manager/03campagne-fax.png)
...
* **Succès partiel** : la campagne s'est déroulée mais certains numéros sont probablement invalides. Vous pouvez avoir le détail de la campagne en cliquant sur le bouton `...` puis sur `Détails`
* **En erreur** : la campagne n'a pas pu être réalisée. Cliquez sur `...` puis sur `Détails` pour obtenir des informations complémentaires.
