...
<Tabs>
  <Tab label="Passaggio 1">
    Accedi alla pagina [Le mie offerte e servizi](https://manager.eu.ovhcloud.com/#/billing/autorenew/services). Nella tabella che appare, identifica il dominio o i domini di cui vuoi cambiare la modalità di rinnovo.
...
<Tabs>
  <Tab label="Passaggio 1">
    Accedi alla pagina [Le mie offerte e servizi](https://manager.eu.ovhcloud.com/#/billing/autorenew/services). Nella tabella, identifica il dominio che vuoi rinnovare.
...
<Tabs>
  <Tab label="Passaggio 1">
    Accedi alla pagina [Le mie offerte e servizi](https://manager.eu.ovhcloud.com/#/billing/autorenew/services). Nella tabella, identifica il dominio che vuoi disattivare.
...
<Tabs>
  <Tab label="Passaggio 1">
    Accedi alla pagina [Le mie offerte e servizi](https://manager.eu.ovhcloud.com/#/billing/autorenew/services). Nella tabella, identifica il dominio per il quale devi saldare una fattura di rinnovo.
