...
Potrai in seguito amministrare il tuo nome di dominio effettuando l'accesso al tuo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it).
...
<Tabs>
  <Tab label="Step 1">
    Accedi alla pagina [Le mie offerte e servizi](https://manager.eu.ovhcloud.com/#/billing/autorenew/services).
  </Tab>
  <Tab label="Step 2">
...
Una volta sottoscritti, gli IDN appaiono nel tuo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it) nel formato **xn--**.

Anche se il tuo nome di dominio viene visualizzato in [notazione internazionalizzata (IDN)](https://it.wikipedia.org/wiki/Nome_di_dominio_internazionalizzato) nel tuo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it), funzionerà e verrà visualizzato normalmente altrove. L'indirizzo del tuo sito web sarà visualizzato così come lo hai richiesto. Anche i tuoi indirizzi e-mail verranno visualizzati come desideri dai tuoi corrispondenti.
...
:::tip[Success]
Consulta tutti i dettagli nella nostra guida "[Come rinnovare i tuoi servizi OVHcloud](/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/)".
...
Effettua una [procedura di recupero dei contatti](https://www.ovh.it/cgi-bin/it/procedure/procedureChangeContacts.cgi) affinché il tuo nome di dominio sia interamente gestito nel tuo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it). In questo modo, non avrai più bisogno di contattare la persona che gestiva in precedenza il tuo nome di dominio.
...
- **Dal tuo Spazio Cliente OVHcloud**: Se la zona DNS attiva del tuo nome di dominio è gestita su OVHcloud, accedi alla pagina [Zone DNS](https://manager.eu.ovhcloud.com/#/web/zone) per visualizzare tutti i record DNS dichiarati per il tuo nome di dominio.
...
<Tabs>
  <Tab label="Step 1">
    Accedi alla pagina [Zone DNS](https://manager.eu.ovhcloud.com/#/web/zone), poi clicca sul pulsante <code className="action">Ordina</code> in alto a destra della tabella visualizzata.
  </Tab>
  <Tab label="Step 2">
...
:::tip[Success]
Se non hai ricevuto questa e-mail, controlla la posta indesiderata oppure accedi alla pagina [Il mio account](https://manager.eu.ovhcloud.com/#/account/useraccount/dashboard), poi clicca sulla scheda <code className="action">E-mail ricevute</code>.
...
<Tabs>
  <Tab label="Step 1">
    Accedi alla pagina [Zone DNS](https://manager.eu.ovhcloud.com/#/web/zone) e verifica se il nome di dominio in questione appare.
...
Se la scheda non appare nel tuo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it), l'opzione "GLUE" non è disponibile per il tuo nome di dominio.
...
Nel tuo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it), questo messaggio indica unicamente che la zona DNS creata per il tuo nome di dominio non è la sua zona DNS attiva.
...
<Tabs>
  <Tab label="Step 1">
    Accedi alla pagina [Domini](https://manager.eu.ovhcloud.com/#/web-domains/domain) e verifica se il nome di dominio in questione appare.
...
[Hosting Web - FAQ](/guides/web-cloud/web-hosting/faq-web-hosting/)
