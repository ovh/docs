...
Il trasferimento può essere riavviato dalla pagina [Operazioni in corso](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/web/ongoing-operations).
...
Una volta completata la procedura, è possibile gestire il nome di dominio dalla pagina [Domini](https://manager.eu.ovhcloud.com/#/web-domains/domain).
