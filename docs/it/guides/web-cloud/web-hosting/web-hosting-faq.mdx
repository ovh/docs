...
1. Accedi allo [Spazio Cliente OVHcloud](/links/manager) e clicca su `Web Cloud`.
2. Clicca sul menu `Hosting` e seleziona l'hosting Web interessato.
...
2. Clicca sul link `Non ricordi identificativo o password?` presente nella finestra di connessione.
...
1. Accedi allo [Spazio Cliente OVHcloud](/links/manager) e clicca su `Web Cloud`.
2. Clicca sul menu `Hosting` e seleziona l'hosting Web interessato.
3. Clicca sulla scheda `Database`.
...
1. Accedi allo [Spazio Cliente OVHcloud](/links/manager) e clicca su `Web Cloud`.
2. Clicca sul menu `Email` (o sul menu `MX Plan` se utilizzi la versione beta dello Spazio Cliente OVHcloud) e seleziona il dominio interessato.
3. Clicca sulla scheda `Email`.
4. Nella tabella che appare, clicca sul pulsante `...` a destra dell'indirizzo email interessato e poi clicca su `Modifica la password`.
...
1. Accedi allo [Spazio Cliente OVHcloud](/links/manager) e clicca su `Web Cloud`.
2. Clicca sul menu `Hosting` e seleziona l'hosting Web interessato.
3. Clicca sulla scheda `Multisito`.
...
1. Accedi allo [Spazio Cliente OVHcloud](/links/manager) e clicca su `Web Cloud`.
2. Clicca sul menu `Hosting` e seleziona l'hosting Web interessato.
3. Clicca sulla scheda `Certificati SSL`.
...
1. Accedi allo [Spazio Cliente OVHcloud](/links/manager) e clicca su `Web Cloud`.
2. Clicca sul menu `Hosting` e seleziona l'hosting Web interessato.
3. Nella nuova pagina e nel riquadro **Abbonamento**, clicca sul pulsante `...` a destra della dicitura `Piano` e poi su `Modificare soluzione`.
4. Seleziona il nuovo abbonamento e la durata. Conferma i contratti corrispondenti e clicca su `Invia`.
...
1. Accedi allo [Spazio Cliente OVHcloud](/links/manager) e clicca su `Web Cloud`.
2. Clicca sul menu `Hosting` e seleziona l'hosting Web interessato.
3. Nella nuova pagina e nel riquadro **Configurazione**, clicca sul pulsante `...` a destra della dicitura `Account email`, poi su `Scollega la tua opzione email`.
...
1. Accedi allo [Spazio Cliente OVHcloud](/links/manager) e clicca su `Web Cloud`.
2. Clicca sul menu `Hosting` e seleziona l'hosting Web interessato.
3. Nella nuova pagina e nel riquadro **Configurazione**, clicca sul pulsante `...` a destra della voce `Web Cloud Databases` e poi su `Scollega`.
...
1. Accedi allo [Spazio Cliente OVHcloud](/links/manager) e clicca su `Web Cloud`.
2. Clicca sul menu `Web Cloud Databases` e seleziona la soluzione Web Cloud Databases interessata.
3. Nella nuova pagina e nel riquadro **Informazioni generali**, clicca sul pulsante `...` a destra della dicitura `RAM`, poi su `Modifica la quantità di RAM`.
4. Segui le istruzioni per ordinare la quantità di RAM desiderata, poi prosegui fino alla convalida dell'ordine.

:::tip

In caso di necessità, consulta la sezione "*Modifica la tua offerta Web Cloud Databases*" della nostra guida "[Configurare un'offerta Web Cloud Databases](/guides/web-cloud/web-cloud-databases/db-configure-optimise-database-server)".
...
1. Accedi allo [Spazio Cliente OVHcloud](/links/manager) e clicca su `Web Cloud`.
2. Nella nuova pagina, clicca sul tuo nome nell'angolo in alto a destra e seleziona `Le mie offerte e servizi`.
...
1. Accedi allo [Spazio Cliente OVHcloud](/links/manager) e clicca su `Web Cloud`.
2. Clicca sul menu `Hosting` e seleziona l'hosting Web interessato.
3. Clicca sulla scheda `CMS in 1 click`.
4. Nella tabella che appare, clicca sul pulsante `...` situato a destra nella riga del *modulo in 1 click* interessato e poi su `Elimina un modulo`.
...
2. Clicca sul menu `Hosting` e seleziona l'hosting Web interessato.
3. Clicca sulla scheda `Database`.
4. Nella tabella che appare, clicca sul pulsante `...` a destra nella riga del database in questione e poi su `Elimina il database`.
...
2. Clicca sul menu `Hosting` e seleziona l'hosting Web interessato.
3. Clicca sulla scheda `FTP - SSH`.
4. Nella nuova pagina clicca sul pulsante `Ripristina un backup`.
...
2. Clicca sul menu `Hosting` e seleziona l'hosting Web interessato.
3. Clicca sulla scheda `Database`.
4. Nella tabella che appare, clicca sul pulsante `...` a destra nella riga del database in questione e poi su `Ripristina un backup`.
...
6. Una volta scelto il backup, clicca sul pulsante `...` a destra del backup da ripristinare e poi su `Ripristina il backup`.
...
1. Accedi allo [Spazio Cliente OVHcloud](/links/manager) e clicca su `Web Cloud`.
2. Clicca sul menu `Domini` e seleziona il dominio interessato.
3. Clicca sulla scheda `Server DNS`.
4. Annota i nomi dei server DNS indicati e clicca sulla scheda `Zona DNS` (a destra della scheda `Server DNS`).
...
I `Destinazioni` (server DNS) dei record di tipo `NS` dichiarati nella zona DNS del nome di dominio **sono identici** a quelli recuperati nella scheda `Server DNS`.
...
1. Accedi allo [Spazio Cliente OVHcloud](/links/manager) e clicca su `Web Cloud`.
2. Clicca sul menu `Domini` (o sul menu `Zone DNS` se utilizzi la versione beta dello Spazio Cliente OVHcloud) e seleziona il dominio interessato.
3. Clicca sulla scheda `Zona DNS`.
...
5. Clicca sul pulsante `...` a destra della riga e poi su `Modifica il record`.
...
I `Destinazioni` (server DNS) dei record di tipo `NS` dichiarati nella zona DNS del nome di dominio **non sono identici** a quelli recuperati nella scheda `Server DNS`. Tuttavia, i `Destinazione` (server DNS) hanno una delle forme seguenti:
...
Se uno dei tuoi server DNS dichiarati nella scheda `Server DNS` ha la forma seguente: `sdnsX.ovh.net`, `sdnsX.ovh.ca`, `vpsXXXX.ovh.net` o `vpsXXXX.ovh.ca` (dove ogni `X` indica una cifra compresa tra **0** e **9**), consulta direttamente il **Caso n°3**.
...
In questo caso, significa che il dominio non utilizza i server DNS corretti di OVHcloud per applicare la configurazione della zona DNS presente nella scheda `Zona DNS`.
...
2. Clicca sul menu `Domini` e seleziona il dominio interessato.
3. Clicca sulla scheda `Server DNS`.
4. Clicca sul pulsante `Modifica i server DNS`.
5. Nella nuova pagina, seleziona l'opzione `Utilizzare i DNS predefiniti di OVHcloud` e clicca sul pulsante `Applicare la configurazione`.
...
I `Target` (server DNS) dei record di tipo `NS` dichiarati nella zona DNS del nome di dominio **non sono identici** a quelli recuperati nella scheda `Server DNS`. Inoltre, i nomi dei server DNS recuperati nella scheda `Server DNS` non hanno nessuna delle forme descritte nel **Caso n°2**, ad eccezione delle forme seguenti: `sdnsX.ovh.net`, `sdnsX.ovh.ca`, `vpsXXXX.ovh.net` o `vpsXXXXXX.ovh.ca` (in cui ogni `X` indica una cifra compresa tra **0** e **9**).
...
![notebook_idn](/images/assets/screens/control-panel/product-selection/web-cloud/domain-dns/general-information/idn-notation.png)
