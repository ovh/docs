...
- dallo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it);
...
Per riassumere, modificare la configurazione dell’hosting Web dallo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it) o modificare i valori presenti nel file ".ovhconfig" equivale a effettuare la stessa operazione.
...
A destra della voce **Versione PHP**, situata quasi al centro della pagina, clicca sul pulsante <code className="action">...</code> e poi su <code className="action">Modifica la configurazione</code>.
    ...
    Se l’opzione **Versione PHP** non compare nel tuo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it), verifica che il file *.ovhconfig* esista effettivamente nella root FTP del tuo hosting condiviso OVHcloud.
...
Crea un file ".ovhconfig" contenente la versione di PHP desiderata per il sito web o i siti web interessati. Segui le operazioni descritte nella sezione "[3.3 - Modifica il contenuto del file ".ovhconfig"](#update-ovhconfig)" di questa guida, se necessario. Quando caricherai il file ".ovhconfig" sul tuo [spazio di storage FTP](/guides/web-cloud/web-hosting/ftp-connection/), fallo nella cartella radice dove si trovano i file che compongono il sito web interessato. Trova la cartella radice del tuo sito web dal tuo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it) nell'onghetta <code className="action">Multisito</code> dell'hosting interessato.
