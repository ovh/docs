...
- Essere connesso al tuo [spazio clienti OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it).
...
1. Accedi al tuo [spazio clienti OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it), vai su <code className="action">Web Cloud</code> e clicca sul tuo hosting web.
