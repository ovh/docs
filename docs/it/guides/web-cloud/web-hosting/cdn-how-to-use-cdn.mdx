...
Questa operazione viene eseguita automaticamente se la zona DNS attiva del dominio è gestita anche dall’[account OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.it/&ovhSubsidiary=it) che contiene l’hosting Web.
