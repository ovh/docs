...
| --- | --- | --- | --- | --- |
| X | X | Choisir de souscrire au service [Serveur Dédié](/guides/account-and-service-management/responsibility-sharing/dedicated-servers/) ou [VMware on OVHcloud](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/responsibility-sharing/) en fonction des besoins et suivre les modèles de responsabilités associés | RA | CI |
