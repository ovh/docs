...
![two_buckets](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-configure-ovhcloud-backint-agent-several-buckets/two_buckets.png)
...
- [Un projet Public Cloud](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project) dans votre compte OVHcloud avec :
...
2. Cliquez sur l'univers `Public Cloud` et sélectionnez votre projet Public Cloud. Puis cliquez sur `Object Storage`.
3. Cliquez sur les buckets Object Storage qui accueilleront les sauvegardes de votre base de données SAP HANA.
4. Vérifiez la valeur du paramètre `Versioning`, ce dernier doit avoir pour valeur `Activé`. Si la valeur de ce paramètre est `Désactivé`, cliquez sur `Activer le versioning`.

| Versioning activé | Versioning désactivé |
| --- | --- |
| ![versioning_enabled](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-configure-ovhcloud-backint-agent-several-buckets/versioning_enabled.png) | ![versioning_disabled](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-configure-ovhcloud-backint-agent-several-buckets/versioning_disabled.png) |
...
![backup_hana_cockpit](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-configure-ovhcloud-backint-agent-several-buckets/backup_hana_cockpit.png)
...
![bucket_data_backup](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-configure-ovhcloud-backint-agent-several-buckets/bucket_data_backup.png)
...
![bucket_log_backup](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-configure-ovhcloud-backint-agent-several-buckets/bucket_log_backup.png)
