...
:::info
Si vous ne savez pas comment vous connecter au portail web de votre organisation, consultez d'abord le guide « [Comment se connecter à Public VCF as-a-Service](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-logging/) ».
...
- Avoir suivi le guide « [Public VCF as-a-Service - Les concepts fondamentaux de Public VCF as-a-Service](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-get-concepts/) ».
...
<img className="thumbnail" alt="Public VCF as-a-ServiceControl Panel Network Overview Gif" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-concepts/vcd_network_overview.gif" loading="lazy" />
...
<img className="thumbnail" alt="Public VCF as-a-Service Network IP Prefixe" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-concepts/vcd_network_ipspace_banner.png" loading="lazy" />

#### Via l'espace client Public VCF as-a-Service**

<img className="thumbnail" alt="Public VCF as-a-Service Network IP Prefixe 02" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-concepts/vcd_network_ipspace.gif" loading="lazy" />
...
<img className="thumbnail" alt="Public VCF as-a-ServiceIP Spaces Prefixe 00" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-concepts/vcd_network_prefixe_ip.png" loading="lazy" />

<img className="thumbnail" alt="Public VCF as-a-ServiceIP Spaces Prefixe 02" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-concepts/vcd_network_prefixe_ip_2.png" loading="lazy" />
...
<img className="thumbnail" alt="Public VCF as-a-Service Network IP Spaces Topology" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-concepts/vcd_network_ip_space_topology.png" loading="lazy" />
...
<img className="thumbnail" alt="Public VCF as-a-Service Network Datacenter Groups Overview Gif" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-concepts/vcd_network_datacenter-groups_overview.gif" loading="lazy" />
...
<img className="thumbnail" alt="Public VCF as-a-Service Network Datacenter Groups Sync" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-concepts/vcd_network_datacenter-groups_sync.png" loading="lazy" />

**Création ou import de réseau dans le groupe de centre de données (optionnel)**

<img className="thumbnail" alt="Public VCF as-a-Service Network Datacenter Groups Network Creation" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-concepts/vcd_network_datacenter-groups_network_creation.png" loading="lazy" />

<img className="thumbnail" alt="Public VCF as-a-Service Network Datacenter Groups Network Import" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-concepts/vcd_network_datacenter-groups_network_import.png" loading="lazy" />
...
![Public VCF as-a-Service Network Edge Overview Gif](/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-concepts/vcd_network_edge_overview.gif)
...
![Public VCF as-a-Service Network DHCP Activation](/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-concepts/vcd_network_dhcp.png)
...
![Public VCF as-a-Service Network vApp Network Gif](/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-concepts/vcd_network_vapp.gif)
...
Vous pouvez maintenant suivre les étapes du guide suivant : [« Guide 2 - Public VCF as-a-Service - Network - Créer des composants réseau via le control panel Public VCF as-a-Service »](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-creation/)

**Networking pour Public VCF as-a-Service - Index des guides** :

- Guide 1 : « Public VCF as-a-Service - Network - Concepts »
- Guide 2 : « [Public VCF as-a-Service - Network - Créer des composants réseau via le control panel Public VCF as-a-Service »](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-creation/)
