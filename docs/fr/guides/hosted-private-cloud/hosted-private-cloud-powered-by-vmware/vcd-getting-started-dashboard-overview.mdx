...
Dans cette section vous retrouvez un bandeau sur votre gauche, le même que quand vous cliquez sur une de vos : `Applications virtuelles | Machines virtuelles | Applications de conteneur ` depuis la section **"Application"** :
...
![Applications Overview animé](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-getting-started/vcd_overview_application.gif)
...
![Réseau Overview](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-getting-started/vcd_overview_networking.gif)
...
- `Bienvenue dans le Hub de contenu`
- `Contenu`
- `Catalogues`
...
![Loupe Overview](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-getting-started/vcd_overview_loupe.gif)
