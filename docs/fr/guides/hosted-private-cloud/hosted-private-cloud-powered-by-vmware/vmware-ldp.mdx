...
- Disposer d'un [compte client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr).
...
- Avoir suivi le guide « [Introduction à Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-introduction-to-ldp/) ».
...
- [Visualiser vos logs dans un tableau de bord Grafana (EN)](/guides/manage-and-operate/observability/logs-data-platform/visualization-grafana/)
- [Utiliser la cli "LDP Tail" pour regarder en live vos logs (EN)](/guides/manage-and-operate/observability/logs-data-platform/cli-ldp-tail/)
- [Pousser les logs depuis Apache vers LDP (EN)](/guides/manage-and-operate/observability/logs-data-platform/ingestion-apache/)
