...
- Être connecté à l'[espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) avec NSX-T activé, ou à votre système Syslog ou plateforme d’agrégation de logs
...
Si vous rencontrez des difficultés avec le réseau au sein de VCD on OVHcloud, consultez le guide « [VMware Cloud Director on OVHcloud - Network Concepts](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-concepts/) ».
