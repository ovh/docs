...
* Avoir ajouté le réseau de la private gateway dans [les autorisations par IP source](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/manager-ovh-private-cloud/).
