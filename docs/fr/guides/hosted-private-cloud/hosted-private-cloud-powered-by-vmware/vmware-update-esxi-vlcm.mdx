...
<img className="thumbnail" alt="Affichage de l'image actuelle dans vLCM" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-update-esxi-vlcm/vlcm_00.png" loading="lazy" />

Cliquez sur <code className="action">Edit</code> pour modifier l’image.

<img className="thumbnail" alt="Bouton Edit pour modifier l'image" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-update-esxi-vlcm/vlcm_01.png" loading="lazy" />
...
<img className="thumbnail" alt="Sélection d'une nouvelle version ESXi" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-update-esxi-vlcm/vlcm_02.png" loading="lazy" />
...
<img className="thumbnail" alt="Lancement avec Remediate All" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-update-esxi-vlcm/vlcm_03.png" loading="lazy" />
...
<img className="thumbnail" alt="Validation finale" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-update-esxi-vlcm/vlcm_05.png" loading="lazy" />
