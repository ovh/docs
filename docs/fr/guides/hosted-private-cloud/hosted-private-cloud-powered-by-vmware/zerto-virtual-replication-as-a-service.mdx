...
Pour les autres cas de figure, consultez notre guide sur comment [utiliser Zerto entre OVHcloud et une plateforme tierce](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-customer-to-ovhcloud/).
