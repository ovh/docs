...
<img className="thumbnail" alt="Cycle de vie typique d'un service VMware on OVHcloud" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/lifecycle-policy/01_lifecycle_pcc.png" loading="lazy" />
