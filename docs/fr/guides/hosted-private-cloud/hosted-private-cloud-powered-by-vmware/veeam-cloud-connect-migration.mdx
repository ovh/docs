...
Utilisez l'option <code className="action">Export Entire Backup Chain</code> dans la console Cloud Connect.
...
Utilisez l'option <code className="action">Add Existing Backup</code> dans la console Veeam Backup & Replication Enterprise Edition.
