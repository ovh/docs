...
- Avoir lu les guides : 
    ...
    - [Premiers pas avec OKMS](/guides/manage-and-operate/kms/kms-quick-start).
...
### Introduction, liste des URL et des appels API OKMS disponibles <a id="introduction"></a>
...
#### Liste des appels API v1 et v2 KMS  <a id="listing-api"></a>
...
### Étape 1 - Commande d'un KMS OVHcloud (obligatoire) <a id="command-okms"></a>
...
![Manager KMS Menu Order Animated Gif](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/okms_order.gif).

#### Via l'espace client OVHcloud

Afin d'accéder au KMS OVHcloud, connectez-vous à votre [espace client OVHcloud](/links/manager), puis rendez-vous dans la partie `Hosted Private Cloud`. Dans la colonne de gauche, cliquez sur `Identité, Sécurité & Opération`, puis sur `Key Management Service`.
...
![Manager KMS Menu OKMS Order Finish](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/okms_order_finish-optimized.png)

Une fois votre commande validée, vous retrouverez avec votre KMS, le **Nom**, l'**ID** et la **Région**.

![Manager KMS Menu KMS All 01](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/manager_okms_all-optimized.png)

Copiez votre "**ID**" OKMS.

![Manager KMS Menu](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/manager_okms_copy_id-optim-resize.png)
...
![Manager KMS Menu](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/manager_okms_id-optimized-optim-resize.png)
...
### Étape 2 - Activation du KMS OVHcloud (obligatoire) <a id="activation-okms"></a>
...
Pour créer ou Importer un service de gestion de clé KMS, connectez-vous à votre [espace client OVHcloud](/links/manager), puis rendez-vous dans la partie `Hosted Private Cloud`. Dans la colonne de gauche, cliquez sur `VMware`, puis sélectionnez votre PCC concerné. Sur la page qui s'affiche, cliquez sur l'onglet `Sécurité`.

![Manager Hpc Security KMS](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/manager_hpc_security-opti.png)
...
![Manager Hpc Security KMS](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/manager_hpc_kms_add-optimized.png)
...
![Manager HPC Security KMS Add 02](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/manager_hpc_kms_add_2-optim-resize.png)
...
![Manager HPC Security KMS Add 02_2](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/manager_hpc_kms_add_2_2.png)
...
![Manager HPC Security KMS Add 02](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/manager_users_edit.png)

Vérifiez que la `gestion du chiffrement` est activée.

![Manager HPC Security KMS Add 02](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/manager_users_edit_encryption.png)
...
![Manager HPC Security KMS Delivered](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/manager_hpc_kms_add_delivered.png)

</details>

### Étape 3 - Création d'une politique IAM <a id="iam-creation"></a>
...
![Manager IAM Policy](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/manager_iam-resize-optim.png)
...
![Manager IAM Policy 02](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/manager_iam_2.png)

Vous devez ensuite ajouter les actions afin de pouvoir générer les clés pour votre politique de chiffrement vSphere.

Cliquez dans le champ « Type de produits », puis ajoutez `Key Management System (KMS)`.

Vous pouvez choisir d'ajouter toutes les actions ou filtrer plus finement selon vos besoins utilisateurs.

![Manager IAM Policy 03](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/manager_iam_3.png)

Pour terminer, cliquez sur `Créer la politique`.

![Manager IAM Policy 04](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/manager_iam_4.png)
...
### Étape 4 - Configuration de OKMS avec VMware vSphere HPC (obligatoire) <a id="add-okms"></a>
...
Pour que vCenter puisse truster votre serveur KMS OVHcloud, connectez-vous à votre [espace client OVHcloud](/links/manager), puis allez dans la partie `Hosted Private Cloud`. Dans la colonne de gauche, cliquez sur `VMware` et sélectionnez le datacentre concerné.

![Manager HPC General Information Web Interface](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/manager_hpc_vsphere.png)
...
![Manager Web Interface](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/manager_web_interface_pcc.png)
...
![KMS Key Provider](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/kms_key_provider.png)
...
![KMS Key Provider](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/okms_vsphere_add_standard_key_provider.png)
...
![TRUST KMS](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/trust_kms.png)

Ensuite, cliquez sur `APPROUVER`

![TRUST KMS](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/okms_vsphere_vcenter_trust_kms-optim-resize.png)

![TRUST KMS](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/trust_kms_3.png)
...
![KMS Key Provider](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/okms_vsphere_upload_kms_cert-ptim-resize.png)

Pour terminer, collez le certificat public KMS récupéré depuis le snippet dans la fenêtre ouverte vSphere.

![KMS Key Provider](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/okms_vsphere_upload_kms_cert_2-optim-resize.png)
...
Pour plus d'informations sur les avantages et inconvénients de l'utilisation d'un CSR, lisez la documentation [KMS](/guides/manage-and-operate/kms/kms-quick-start).
...
![Trust KMS server with CSR](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/kms_trust_vcenter_csr.png)

![Trust KMS server with CSR](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/kms_trust_vcenter_csr_2.png)
...
![Trust KMS server with CSR](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/okms_vsphere_upload_signed_csr-optim-resize.png)

![Trust KMS server with CSR](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/okms_vsphere_upload_signed_csr_2-optim-resize.png)
...
![Trust KMS server with CSR](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/okms_vsphere_okms_validation.png)
...
### Étape 5 - Création d'une stratégie de stockage VM (obligatoire) <a id="storage-policy"></a>
...
![VM Storage Policies Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/vsphere_vm_policie.png)

Cliquez sur `CRÉER` dans **Stratégies de stockage VM**.

![VM Storage Policies Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/vsphere_vm_policie_2.png)
...
![VM Storage Policies Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/vsphere_vm_policie-optim-resize.png)
...
![VM Storage Policies Creation 02](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/vsphere_vm_policie_2-optim-resize.png)
...
![VM Storage Policies Creation 03](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/vsphere_vm_policie_3-optim-resize.png)
...
![VM Storage Policies Creation 04](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/vsphere_vm_policie_4-optim-resize.png)
...
![VM Storage Policies Creation 05](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/vsphere_vm_policie_5_optim-resize.png)

</details>

### Étape 6 - Activation du chiffrement sur une VM (obligatoire) <a id="activation-encryption"></a>
...
![VM Storage Policies Encryption](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/okms_vsphere_vm_policies-optim-resize.png)
...
![VM Storage Policies Encryption 03](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/okms_vsphere_vm_policies_3-optim-resize.png)
...
![VM Storage Policies Encryption](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/okms_vsphere_deploy_vm_policies.png)
...
![VM Storage Policies Encryption Confirmation 04](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-okms-vm-encrypt/okms_vsphere_vm_policies_4-optim-resize.png)

</details>

## Aller plus loin <a id="go-further"></a>

### Informations utiles TLS OKMS <a id="useful-information"></a>
