...
<img className="thumbnail" alt="Règles de sous-réseau SPN" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/snc-connectivity-concepts-spn/SNC-SPN-GW-Support.svg" loading="lazy" />

Voici un comportement utilisant la fonctionnalité next-hop :

<img className="thumbnail" alt="fonctionnalité next-hop" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/snc-connectivity-concepts-spn/SNC-SPN-Subnet-NH.svg" loading="lazy" />
...
<img className="thumbnail" alt="Topologie BGP" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/snc-connectivity-concepts-spn/SNC-SPN-BGP-v0.svg" loading="lazy" />
