...
Connectez-vous à l'interface web vSphere, en vous aidant si besoin du guide « [Se connecter à la console Web vSphere on OVHcloud](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vsphere-interface-connexion/) ».
...
|                                        **Images**                                         | **Étapes**                                                                       |
|:-----------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------|
| <img className="thumbnail" alt="vSphere Datastore Upload 01" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-datastore-upload/datastore_inventory_2.png" loading="lazy" />      | - Cliquez sur <code className="action">Inventaire</code>.                                         |
| <img className="thumbnail" alt="vSphere Datastore Upload 01" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-datastore-upload/datastore.png" loading="lazy" /><br/> <img className="thumbnail" alt="vSphere Datastore Upload 01" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-datastore-upload/datastore_1.png" loading="lazy" />| - Depuis `pcc-XXX-XXX-XXX-XXX.ovh.XX`, cliquez sur <code className="action">Banques de données</code>. |
...
|                                        **Images**                                         | **Étapes**                                                |
|:-----------------------------------------------------------------------------------------:|:----------------------------------------------------------|
| <img className="thumbnail" alt="vSphere Global Inventory" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-datastore-upload/global_inventory.png" loading="lazy" />      | - Cliquez sur <code className="action">Listes d'inventaires globaux</code>. |
| <img className="thumbnail" alt="vSphere Global Inventory Datastore" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-datastore-upload/global_inventory_datastores.png" loading="lazy" /> | - Puis sur <code className="action">Banques de données</code>.                  |
...
|                                       **Images**                                       | **Étapes**                                       |
|:--------------------------------------------------------------------------------------:|:-------------------------------------------------|
|        <img className="thumbnail" alt="vSphere Upload Folder" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-datastore-upload/datastore_folder_upload.png" loading="lazy" />        | - Pour confirmer, cliquez sur <code className="action">Envoyer</code>. |
