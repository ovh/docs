...
[Move2Cloud - Migration de charges de travail VMware vers le Hosted Private Cloud SecNumCloud avec Zerto](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-migration-zerto-secnumcloud/)
...
Retrouvez plus d'informations sur la planification du réseau dans notre guide « [Premiers pas avec NSX](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/nsx-01-first-steps/) ».
...
Pour des instructions détaillées, référez-vous à notre guide « [Autoriser des IP à se connecter au vCenter](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/autoriser-des-ip-a-se-connecter-au-vcenter/) ».
...
Pour des instructions détaillées, référez-vous au [guide de configuration IAM](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-iam-getting-started/).
...
Référez-vous à notre guide « [Premiers pas avec NSX](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/nsx-01-first-steps/) » pour obtenir plus de détails sur la création de segments et leur affectation aux machines virtuelles.
...
Vous retrouverez un aperçu de la façon dont NSX gère ces fonctionnalités dans notre guide « [Premiers pas avec NSX](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/nsx-01-first-steps/) ».
...
Tous les détails sont disponibles dans notre guide « [Utiliser Zerto entre OVHcloud et une plateforme tierce](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-customer-to-ovhcloud/) ».
...
Les détails et les paramètres sont disponibles dans notre guide « [Utiliser Zerto entre OVHcloud et une plateforme tierce](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-customer-to-ovhcloud/) ».
...
Pour plus de détails, consultez notre guide « [VMware Storage vMotion](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-storage-vmotion/) ».
