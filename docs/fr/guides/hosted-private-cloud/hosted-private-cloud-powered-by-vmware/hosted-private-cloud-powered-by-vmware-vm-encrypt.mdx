...
Suivant votre KMS, vous pouvez vous connecter au serveur à l'aide de votre navigateur. Cliquez ensuite sur `View Certificate`, puis sur `Thumbprint`.

![empreinte du certificat](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vm-encrypt/certificate_thumbprints_01.png)

![empreinte du certificat](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vm-encrypt/certificate_thumbprints_02.png)
...
Connectez-vous à votre [espace client](/links/manager) et assurez-vous de vous situer dans la section `Hosted Private Cloud`. 

Cliquez sur `VMware` dans la barre de services à gauche, puis sélectionnez le service VMware concerné.

Depuis la page principale du service, cliquez sur `Sécurité`.

![Manager Add Kms](/images/assets/screens/control-panel/product-selection/hosted-private-cloud/vmware/security/add-kms.png)
...
![server KMS](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vm-encrypt/vm-encrypt_manager_03.png)
...
![server KMS](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vm-encrypt/vm-encrypt_manager_04.png)
...
Cliquez sur `Ajouter > Ajouter un fournisseur de clés standard`.

![Add KMS](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vm-encrypt/add_kms.png)

Puis spécifiez les informations KMS dans l'assistant qui s'affiche :

![Add KMS](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vm-encrypt/vm-encrypt_01.png)

Validez le certificat en cliquant sur `Trust KMS`.
...
![import certificat KMS](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vm-encrypt/vm-encrypt_02.png)

#### Vérifier que le KMS est configuré

Vérifiez que le « **Connection Status** » correspondant au KMS est en mode « Normal ».

![vérifier connection status](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vm-encrypt/vm-encrypt_03.png)

#### Modifier la politique de stockage de « VM Encryption Storage »

Créez une machine virtuelle. Une fois celle-ci créée, effectuez un clic droit sur celle-ci. Cliquez alors sur `VM Policies`, puis sur `Edit VM Storage Policies`.

![VM encryption storage](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vm-encrypt/vm-encrypt_04.png)

Sélectionnez les fichiers de la machine virtuelle et les autres disques durs qui doivent être chiffrés.

![VM encryption storage](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vm-encrypt/vm-encrypt_05.png)
...
![vMotion chiffré](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vm-encrypt/vm-encrypt_06.png)
...
![vérification de la configuration](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vm-encrypt/vm-encrypt_07.png)

![vérification de la configuration](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vm-encrypt/vm-encrypt_09.png)
