...
- [Public VCF as-a-Service - Concepts fondamentaux](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-get-concepts/)
- [Public VCF as-a-Service - Concepts réseau](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-concepts/)
- [Création d'une VM sur Public VCF as-a-Service](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-first-vm-creation/)
- [Création de composants réseau via Public VCF as-a-Service](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-creation/)
...
Avec Public VCF as-a-Service, vous ne pouvez pas utiliser d’outil de backup autre que notre outil managed Veeam for VCD. Référez-vous au guide suivant pour plus d'informations : [Public VCF as-a-Service - Sauvegarde avec Veeam Data Platform](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-backup/).
