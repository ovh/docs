...
<img className="thumbnail" alt="snapshot" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/snapshots-horaires-ovh/snapshot01.png" loading="lazy" />

Créez un dossier dans lequel vous allez plus tard copier les fichiers à restaurer.

<img className="thumbnail" alt="snapshot" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/snapshots-horaires-ovh/snapshot02.png" loading="lazy" />
...
<img className="thumbnail" alt="snapshot" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/snapshots-horaires-ovh/snapshot03.png" loading="lazy" />
...
<img className="thumbnail" alt="snapshot" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/snapshots-horaires-ovh/snapshot04.png" loading="lazy" />
...
Nous vous recommandons l'utilisation d'une solution complète de sauvegarde comme notre service [Veeam Backup](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/veeam-backup-as-a-service/) ou tout autre système réalisant un backup complet de vos machines virtuelles.
