...
Pour les autres cas de figure, consultez notre guide sur comment [utiliser Zerto entre OVHcloud et une plateforme tierce](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-customer-to-ovh).
...
le datacenter voulu -> cliquez sur l'onglet `Disaster Recovery Plan (DRP)`.

![zerto ovh enable](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_enable_01.png)

Sélectionnez **Between two OVH Private Cloud solutions** puis cliquez sur `Activate Zerto DRP`,

![zerto ovh enable](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_enable_02.png)
...
![zerto ovh enable](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_enable_03.png)
...
![zerto ovh enable](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_enable_04.png)
...
![zerto ovh enable](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_enable_05.png)
...
![Zerto Dashboard](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_int_01.png)
...
Depuis le menu `Actions`, sélectionnez `Create VPG`

![Zerto VPG Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_01.png)

![Zerto VPG Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_02.png)
...
![Zerto VPG Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_03.png)
...
![Zerto VPG Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_04.png)

* Cliquez sur la flèche pointant vers la droite pour passer celle-ci dans le VPG

Poursuivez en cliquant sur `NEXT`

![Zerto VPG Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_05.png)
...
![Zerto VPG Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_06.png)
...
![Zerto VPG Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_07.png)
...
![Zerto VPG Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_08.png)
...
![Zerto VPG Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_09.png)
...
![Zerto VPG Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_10.png)

Passez cette étape en cliquant sur `NEXT`

![Zerto VPG Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_11.png)

Sur le dernier écran, on retrouve un récapitulatif de l'ensemble des éléments configurés.

Après vérification, validez la création en cliquant sur `DONE`

![Zerto VPG Creation](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_13.png)
...
![Zerto Test Failover](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_test_00.png)

Pour cela, connectez-vous à l'interface Zerto Replication et cliquez sur `FAILOVER` (le sélecteur à gauche étant par défaut sur **TEST**).
...
![Zerto Test Failover](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_test_01.png)
...
Validez et passez à l'étape suivante en cliquant sur `NEXT`.

![Zerto Test Failover](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_test_02.png)
...
Continuez en cliquant `NEXT`

![Zerto Test Failover](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_test_03.png)

Dernier écran de récapitulatif sur une vue des différents sites avec le nombre de VPG pour le test.

Confirmez le lancement du test avec `START FAILOVER TEST`
...
![Zerto Test Failover](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_test_05.png)
...
![Zerto Test Failover](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_test_06.png)

La nouvelle fenêtre vous indique si le test est un succès et vous pouvez rajouter un commentaire.

Confirmez la fin du test avec `STOP`.
...
![Zerto Live Failover](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_02.png)

Pour cela connectez-vous à l'interface Zerto Replication, basculez le sélecteur en bas à droite de l'interface sur **LIVE** (la couleur du bandeau va changer pour signaler que vous allez faire des actions impactantes) et cliquez sur `FAILOVER`.

![Zerto Live Failover](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_03.png)
...
![Zerto Live Failover](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_04.png)
...
![Zerto Live Failover](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_05.png)
...
![Zerto Live Failover](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_06.png)

Au niveau des options **Auto** la temporisation par défaut est de soixante (60) minutes.

Continuez en cliquant sur `NEXT`

![Zerto Live Failover](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_07.png)
...
Lancez la bascule en cliquant sur `START FAILOVER`.

![Zerto Live Failover](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_08.png)

Si vous avez choisi une **Commit Policy** de type **Auto**, un message d'avertissement vous rappelle l'impact de celui-ci.

Confirmez le lancement en cliquant sur `START FAILOVER`.

La bascule se lance immédiatement avec les actions sur le vCenter du site distant.

Il ne vous reste plus qu'à contrôler si tout fonctionne correctement sur le site distant.

![Zerto Live Failover](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_10.png)
...
![Zerto Live Failover](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_11.png)
...
Validez en cliquant sur `COMMIT`

![Zerto Live Failover](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_13.png)
