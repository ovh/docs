...
<img className="thumbnail" alt="Panneau des règles de la Gateway Firewall" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/nsx-t-get-logs-by-api/01nsx-t_get_logs_by_api.png" loading="lazy" />
...
<img className="thumbnail" alt="Activation des logs pour la règle" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/nsx-t-get-logs-by-api/02nsx-t_get_logs_by_api.png" loading="lazy" />
