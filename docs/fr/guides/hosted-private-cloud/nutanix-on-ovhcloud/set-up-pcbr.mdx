...
Pour créer le conteneur, vous devez dans un premier temps créer un projet Public Cloud. Pour cela, suivez notre guide : [Créer votre premier projet Public Cloud - OVHcloud](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project).
