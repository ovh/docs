...
![cliquez sur ajouter une image](/images/guides/hosted-private-cloud/nutanix-on-ovhcloud/24-add-public-ip-on-vm/add-image.png)
...
![cliquez sur ajouter une image](/images/guides/hosted-private-cloud/nutanix-on-ovhcloud/24-add-public-ip-on-vm/add-image2.png)

Sélectionnez `Place image directly on clusters`, puis sélectionnez votre cluster et cliquez sur `Save`.

![cliquez sur ajouter une image](/images/guides/hosted-private-cloud/nutanix-on-ovhcloud/24-add-public-ip-on-vm/add-image3.png)
