...
Un exemple d'interconnexion IPsec est disponible à cette adresse : [Interconnexion IPsec entre deux sites](/guides/hosted-private-cloud/nutanix-on-ovhcloud/44-ipsec-interconnection/)
...
Retrouvez le détail de ces solutions dans notre documentation sur la [réplication asynchrone ou *NearSync* au travers de Prism Element](/guides/hosted-private-cloud/nutanix-on-ovhcloud/46-prism-element-replication/)
