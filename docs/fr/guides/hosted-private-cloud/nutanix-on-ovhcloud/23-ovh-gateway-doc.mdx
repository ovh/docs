...
Vous pouvez-vous aider de ce guide : [Remplacement de l'OVHgateway](/guides/hosted-private-cloud/nutanix-on-ovhcloud/30-software-gateway-replacement/).
...
Connectez-vous à l'[espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) et accédez à la gestion de votre [vRack](https://www.ovhcloud.com/fr/network/vrack/). Vérifiez l'adresse Additional IP utilisée par le cluster Nutanix.
