...
Cette machine n'a pour but que de vous permettre de télécharger vos premières sources (ISO windows, appliances, etc). Vous devrez remplacer cette machine virtuelle par un autre système d'exploitation. Consultez ce guide pour plus d'informations : [Remplacement de l'OVHgateway](/guides/hosted-private-cloud/nutanix-on-ovhcloud/30-software-gateway-replacement/).
