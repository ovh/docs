...
Cliquez sur votre nom dans le coin supérieur droit puis choisissez `Mes offres & services`.

![produits et services](/images/assets/screens/control-panel/product-selection/right-menu/my-solutions-and-services.png)

### Afficher le type de renouvellement <a id="renewal-type"></a>
...
![mes services](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/my-services-fr.png)
...
>
> ![manageautomaticrenewal](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/filters-fr.png)
...
À droite d'un service, cliquez sur le bouton `...` dans la colonne `Actions` puis sur l'action de votre choix.

![menu actions](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/actions-fr.png)
...
![configurer le renouvellement](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/configure-renewal-fr.png)

Cliquez sur l'action `Configurer le renouvellement`. Selon le service choisi, vous pouvez le paramétrer en renouvellement manuel ou choisir la fréquence de renouvellement automatique. Le cas échéant, vous pourrez donc choisir le type de renouvellement, ainsi que la fréquence de celui-ci.

![configurer le renouvellement](/images/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/configure-renew-fr.png)
...
![anticiper le paiement](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/forward-payment-fr.png)
...
![résilier](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/cancel-fr.png)
...
![Renouveler le service](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/renew-service-fr.png)
...
![Payer une facture](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/pay-bill-fr.png)
...
Il vous suffit alors de choisir l'action `Régler ma facture` qui vous redirigera vers une plateforme de paiement en ligne.
...
Vous avez la possibilité d'effectuer des actions groupées, en sélectionnant plusieurs services dans le tableau puis en cliquant sur le bouton `Actions`.

![actions groupées](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/batch-actions-fr.png)
