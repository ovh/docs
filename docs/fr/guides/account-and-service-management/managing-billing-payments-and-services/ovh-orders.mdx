...
![Bon de commande OVH](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order01.png)
...
Pour accéder au panneau de gestion des commandes, connectez-vous à votre [espace client OVHcloud](/links/manager). Sur la page qui s'affiche, cliquez sur `Voir mes commandes`.

![Espace client](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/huborders.png)

Un récapitulatif des différentes commandes passées apparaît comme ci-dessous :

![Récapitulatif des commandes](/images/assets/screens/control-panel/product-selection/right-column/initials/order-tab.png)
...
![Récapitulatif des commandes](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order04.png)
...
* Connectez-vous à votre [espace client OVHcloud](/links/manager). Sur la page qui s'affiche, cliquez sur `Voir mes commandes`, puis sur le bouton `...` devant votre commande.
...
![Suivi de commande](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order05b.png)

La fenêtre ci-dessous apparaît, vous permettant un suivi en quatre étapes.

![Suivi de commande](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order06.png)
...
![Annulation d'une commande](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/cancelorder1.png)
...
![Validation de l'annulation](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/cancelorder2.png)
