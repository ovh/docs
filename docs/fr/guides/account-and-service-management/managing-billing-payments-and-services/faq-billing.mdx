...
La liste des contacts de vos services est disponible sur la page [Gestion des contacts](https://manager.eu.ovhcloud.com/#/account/contacts/services).
...
Vos coordonnées de facturation sont celles de votre identifiant client. Pour vos prochaines factures, il vous suffit de mettre à jour ces informations sur la page [Mon profil](https://manager.eu.ovhcloud.com/#/account/useraccount/infos).
...
Pour consulter l'état de vos services, ouvrez la page [Mes offres et services](https://manager.eu.ovhcloud.com/#/billing/autorenew/services).
...
Si vous souhaitez en savoir plus, nous vous invitons à consulter ce guide détaillé : [Gérer le renouvellement de mes services](/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/).

### Comment activer le renouvellement automatique ?

Sur la page [Mes offres et services](https://manager.eu.ovhcloud.com/#/billing/autorenew/services), identifiez le service concerné, cliquez sur le bouton <code className="action">...</code>, puis sélectionnez <code className="action">Activer le paiement automatique</code>. Par défaut, le renouvellement automatique est activé sur chaque service lors de sa commande.
...
Sur la page [Moyens de paiement](https://manager.eu.ovhcloud.com/#/billing/payment/method), cliquez sur <code className="action">Ajouter un moyen de paiement</code>.

### Comment mettre à jour mon moyen de paiement ?

Sur la page [Moyens de paiement](https://manager.eu.ovhcloud.com/#/billing/payment/method), vous pourrez ajouter ou supprimer un moyen de paiement (Carte bancaire, Paypal ou prélèvement SEPA).
...
Sur la page [Moyens de paiement](https://manager.eu.ovhcloud.com/#/billing/payment/method), identifiez le moyen de paiement à supprimer, puis cliquez sur l'icône en forme de corbeille.
...
Sur la page [Mes offres et services](https://manager.eu.ovhcloud.com/#/billing/autorenew/services), vous pourrez modifier la fréquence de renouvellement de vos solutions.
Si vous souhaitez en savoir plus, nous vous invitons à consulter ce guide détaillé : [Gérer le renouvellement de mes services](/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/).

### Comment retrouver mes factures ?

Ouvrez la page [Mes factures](https://manager.eu.ovhcloud.com/#/billing/history).

#### Trucs et astuces

Si une facture n'apparaît pas dans votre espace client, il est possible que vous ne soyez pas le contact de facturation du service concerné. Pour le connaître et éventuellement le modifier, ouvrez la page [Gestion des contacts](https://manager.eu.ovhcloud.com/#/account/contacts/services).
...
Sur la page [Moyens de paiement](https://manager.eu.ovhcloud.com/#/billing/payment/method), vous pourrez enregistrer votre moyen de paiement. Vos factures seront ainsi automatiquement régularisées.
...
Pour les solutions telles que les noms de domaine, hébergements web, serveurs dédiés et VPS, rendez-vous sur la page [Mes offres et services](https://manager.eu.ovhcloud.com/#/billing/autorenew/services). Identifiez le service concerné, cliquez sur le bouton <code className="action">...</code>, puis sélectionnez <code className="action">Résilier mon service</code>. À noter que si une demande a déjà été effectuée, il vous sera proposé d'<code className="action">Annuler la résiliation du service</code>.
...
Si vous souhaitez en savoir plus, nous vous invitons à consulter ce guide détaillé : [Information concernant le mode de facturation cloud](/guides/public-cloud/public-cloud-cross-functional/analyze-billing/).
...
Pour le télécharger, ouvrez la page [Mes factures](https://manager.eu.ovhcloud.com/#/billing/history). Cliquez ensuite sur le bouton <code className="action">Actions</code>, puis sélectionnez « Exporter en CSV ».
