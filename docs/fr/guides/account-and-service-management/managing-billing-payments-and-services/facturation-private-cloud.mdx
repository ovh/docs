...
Depuis votre espace client OVHcloud, vous pouvez activer les licences SPLA, afin de [déployer des machines virtuelles Windows avec une licence OVHcloud](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ovf-template/).
