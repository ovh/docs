...
À la fin de votre commande, lors de la validation du moyen de paiement, il vous suffit de choisir `Payer par mandat administratif` :

![Paiement par mandat](/images/guides/account-and-service-management/managing-billing-payments-and-services/mandat-administratif/moyen_paiement.png)
