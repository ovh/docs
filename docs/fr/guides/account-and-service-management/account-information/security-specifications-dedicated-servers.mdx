...
D'autres guides sont disponibles dans [le corpus documentaire sur les Serveurs Dédiés](/guides/bare-metal-cloud/dedicated-servers/overview/) pour assister le client à la prise 
...
Les principe de portabilité d'OVHcloud sont décrits dans sa propre [politique de portabilité](/guides/account-and-service-management/reversibility/00-global-reversibility-policy/) et ceux spécifiques au service Serveurs Dédiés sont indiqués dans sa [politique spécifique](/guides/account-and-service-management/reversibility/01-dedicated-servers-reversibility-policy/).
