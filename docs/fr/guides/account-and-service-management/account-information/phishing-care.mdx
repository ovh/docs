...
En priorité, vérifiez si l'e-mail que vous avez reçu est aussi visible sur la page [Mes communications](https://manager.eu.ovhcloud.com/#/communication). Vous y retrouverez les copies des e-mails officiels envoyés par OVHcloud.
...
Ouvrez la page [Sécurité du compte](https://manager.eu.ovhcloud.com/#/account/useraccount/security) et modifiez immédiatement votre mot de passe.<br/>
