...
description: "Contactez un responsable du Startup Program d'OVHcloud pour obtenir des conseils, une consultation technique ou des informations sur le programme"
...
Si vous êtes déjà en contact ou avez rencontré l'un de nos Startup Program Managers, vous pouvez les joindre directement via LinkedIn. Vous retrouverez la liste complète de nos Startup Program Managers sur [notre site web](https://startup.ovhcloud.com/fr/faq-support/#SPManager).

### Rencontrer nos équipes lors d'événements

Nous organisons ou participons à de nombreux événements où nos Startup Program Managers sont disponibles pour répondre à vos questions et vous faire découvrir le Startup Program d'OVHcloud. Vous pouvez consulter la liste complète de nos événements sur [notre site web](https://events.ovhcloud.com/fr/all-events-startup/).
