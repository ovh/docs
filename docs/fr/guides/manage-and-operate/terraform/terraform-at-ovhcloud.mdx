...
| Control Panel concept | Terraform provider(s) | Resource or Data Source  |
| --- | --- | --- |
| AI Notebooks | not available but [ovhai CLI](/guides/public-cloud/ai-machine-learning/cli-15-commands-reference/) can help for automation||
| AI Training | not available but [ovhai CLI](/guides/public-cloud/ai-machine-learning/cli-15-commands-reference/) can help for automation||
| AI Deploy | not available but [ovhai CLI](/guides/public-cloud/ai-machine-learning/cli-15-commands-reference/) can help for automation||
...
- [Creating a kubernetes cluster on Terraform](/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/)
- [Creating a private registry (Harbor) through Terraform](/guides/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-through-terraform/)
