...
Les API REST sont l'un des deux jeux d'API offerts par le Secret Manager avec les [API compatibles Hashicorp Vault KV2](/guides/manage-and-operate/secret-manager/secret-manager-kv2-api/).
