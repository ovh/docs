...
>
> <pre className="highlight language-console"><code className="language-console">$ debian@server:~$ sudo chmod 644 /usr/share/ca-certificates/ldp.pem</code></pre>
>
> - Import this certificate to your system's trusted CA repository
>
> <pre className="highlight language-console"><code className="language-console">$ debian@server:~$ sudo update-ca-certificates</code></pre>
>
...
- Head to your stream by using the button `Graylog access` located in the **...** menu of your stream, or head directly to the graylog access of your cluster.
...
![Graylog search view](/images/guides/manage-and-operate/observability/logs-data-platform/ingestion-syslog-ng/search.png)
