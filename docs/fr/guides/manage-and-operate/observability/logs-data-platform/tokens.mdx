...
This access token can then be used to interact with Logs Data Platform backend APIs. Don't forget to manage access rights of your service account with the [IAM policies](/guides/manage-and-operate/observability/logs-data-platform/getting-started-roles-permission).
...
![Token Menu](/images/guides/manage-and-operate/observability/logs-data-platform/security-tokens/token_menu.png)

On this page you will have the possibility to create a token and to remove them. Note that you cannot modify a token.

![token generation](/images/guides/manage-and-operate/observability/logs-data-platform/security-tokens/token_generation.png)

Once the token is created, you can use its value or remove it:

![token generated](/images/guides/manage-and-operate/observability/logs-data-platform/security-tokens/token_generated.png)
