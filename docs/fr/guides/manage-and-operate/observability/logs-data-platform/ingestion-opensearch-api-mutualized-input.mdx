...
or with [IAM enabled](/guides/manage-and-operate/observability/logs-data-platform/overview/)
...
Replace the `<user>`, `<password>` and `<ldp-cluster>` with your Logs Data Platform username, password and cluster. You can also use [tokens](/guides/manage-and-operate/observability/logs-data-platform/security-tokens/) in place of your credentials.  Sending this payload will result in this log:
...
Logs Data Platform will also detect any typed field in the original data and convert them accordingly to our [field naming convention](/guides/manage-and-operate/observability/logs-data-platform/getting-started-field-naming-convention/). This last example illustrates it:
...
The OpenSearch input will also flatten any sub-object or array sent through it and also supports ingest pipelines that are used, for example, with [Filebeat integrations](/guides/manage-and-operate/observability/logs-data-platform/ingestion-filebeat/).
...
- Create a [service account](/guides/manage-and-operate/iam/identities-management/) and assign the required IAM policies (see the [IAM access management guide](/guides/manage-and-operate/observability/logs-data-platform/overview/)).
...
- You can create a local user by following the dedicated section on the [Identities management guide](/guides/manage-and-operate/iam/identities-management/).
...
[Vector](https://vector.dev/) is a fast and lightweight log forwarder written in Rust. This software is quite similar to [Logstash](/guides/manage-and-operate/observability/logs-data-platform/ingestion-logstash-dedicated-input/) or [Fluent Bit](/guides/manage-and-operate/observability/logs-data-platform/ingestion-kubernetes-fluent-bit/). It takes logs from a source, transforms them and sends them in a format compatible with the configured output module.
...
- **auth.user** and **auth.password** must be set to the username of the Logs Data Platform account and its associated password. Note that you can use [tokens](/guides/manage-and-operate/observability/logs-data-platform/security-tokens/) in place of your credentials.
