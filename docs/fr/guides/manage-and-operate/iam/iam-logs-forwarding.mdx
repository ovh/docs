...
Pour découvrir Logs Data Platform avant de poursuivre ce guide, référez-vous à [cette documentation](/guides/manage-and-operate/observability/logs-data-platform/getting-started-introduction-to-ldp/).
...
Pour plus de détails sur l'utilisation de vos logs avec Logs Data Platform, reportez-vous à la documentation [Logs Data Platform - Visualisation, interrogation et exploitation de vos logs](/guides/manage-and-operate/observability/logs-data-platform/overview/). Cela comprend :
