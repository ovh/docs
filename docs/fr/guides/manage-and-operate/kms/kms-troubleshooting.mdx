...
Le KMS OVHcloud dispose d'une intégration native avec [Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/overview/) pour la gestion des logs.
