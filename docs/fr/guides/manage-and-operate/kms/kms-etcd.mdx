...
| `--kmip-addr`   | Adresse du serveur KMIP. Disponible dans le [dashboard de votre domaine OKMS](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/dedicated/security/kms). (par exemple : `eu-west-rbx.okms.ovh.net:5696`). | `""` (obligatoire)               |
