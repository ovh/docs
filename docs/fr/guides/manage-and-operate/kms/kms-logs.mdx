...
- Avoir [commandé un KMS OVHcloud et créé un certificat d'accès](/guides/manage-and-operate/kms/kms-quick-start).

## En pratique

### Description

Le KMS OVHcloud dispose d'une intégration native avec [Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/introduction) pour la gestion des logs.

### Accès aux logs en direct

Les logs du KMS sont accessibles depuis l'onglet `Logs` d'un KMS.

![Logs tab](/images/guides/manage-and-operate/kms/kms-troubleshooting/kms-logs-tab.png)
...
![LDP Subscription](/images/guides/manage-and-operate/kms/kms-troubleshooting/kms-ldp-subscription.png)
