...
Vous pouvez commander un KMS depuis [l'espace client OVHcloud](/links/manager) en vous rendant dans le menu `Identité, Sécurité & Opérations` puis `Key Management Service`. Cliquez alors sur le bouton `Commander un KMS`.

![Accès au menu KMS](/images/guides/manage-and-operate/kms/quick-start/access_to_the_KMS_menu_01.png)

Indiquez la région de votre KMS.

![Commander le KMS](/images/guides/manage-and-operate/kms/quick-start/order_kms_01.png)
...
![Commander le KMS](/images/guides/manage-and-operate/kms/quick-start/order_kms_02.png)

Après quelques secondes, le KMS est bien disponible dans votre espace client.

![Commander le KMS](/images/guides/manage-and-operate/kms/quick-start/order_kms_03.png)
...
![Créer une clé](/images/guides/manage-and-operate/kms/quick-start/create_key_01.png)

Un formulaire permet alors de configurer la clé en sélectionnant le type de la clé, sa taille et ses usages.

![Créer une clé](/images/guides/manage-and-operate/kms/quick-start/create_key_02.png)
...
![Créer une clé](/images/guides/manage-and-operate/kms/quick-start/create_key_03.png)
