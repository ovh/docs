...
- **Méthode via l'espace client OVHcloud** : Accédez à la section [Enteprise File Storage](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr)
...
:::warning
Pour commander un produit via Terraform, votre compte doit avoir un moyen de paiement par défaut défini. Cela se fait depuis l'[espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) ou via l'API avec l'endpoint [/me/payment/method](https://api.ovh.com/console/#/me/payment/method~GET).
