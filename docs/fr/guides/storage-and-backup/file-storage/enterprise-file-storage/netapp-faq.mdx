...
Oui, ce service est directement accessible depuis votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), dans la rubrique <code className="action">Bare Metal Cloud</code> puis <code className="action">Storage et Backup</code>.
