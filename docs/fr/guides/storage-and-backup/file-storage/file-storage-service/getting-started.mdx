...
- Vous disposez déjà d’un [réseau privé](/guides/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/) dans votre projet Public Cloud
- Une [instance Public Cloud](https://www.ovhcloud.com/fr/public-cloud/) dans votre compte OVHcloud
- Un [environnement CLI OpenStack prêt à l’emploi](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/)
...
Exemple de résultat :
    ...
    **2\. Autoriser une machine virtuelle cliente**
    ...
    Récupérez l'adresse [IP privée de la machine virtuelle](/guides/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/).
...
**3\. Montez le share sur votre machine virtuelle cliente**
  ...
  <Tab label="Via Manila CSI dans l'environnement K8s">
    ...
    **4\. Installation de la CLI OpenStack**
    ...
    Préparez votre environnement pour utiliser l'API OpenStack en installant python-openstackclient, en suivant [ce guide](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/).
  ...
  <Tab label="Via Terraform">
    **1\. Prérequis additionnels**
    ...
    - Vous disposez déjà d'un environnement [Terraform](/guides/public-cloud/public-cloud-cross-functional/how-to-use-terraform/) fonctionnel.
