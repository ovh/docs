...
Pour retrouver vos Vaults, cliquez sur [ce lien](https://manager.eu.ovhcloud.com/#/bmc-backup-agent-baremetal/service) pour accéder à la section <code className="action">Backup Agent</code>, puis cliquez sur l'onglet <code className="action">Vaults</code>.
