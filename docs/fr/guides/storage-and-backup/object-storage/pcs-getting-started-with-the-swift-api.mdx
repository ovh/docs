...
- [Préparer l'environnement pour utiliser l'API OpenStack](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/) en installant python-swiftclient
...
Cette URL est composée d'un point de terminaison, disponible à partir de l'[interface Horizon](/guides/public-cloud/public-cloud-cross-functional/access-and-security-in-horizon/), du nom de votre conteneur et du nom de votre objet (y compris le préfixe).
