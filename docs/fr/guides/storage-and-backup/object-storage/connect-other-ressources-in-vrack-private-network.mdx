...
- Un [réseau privé vRack](/guides/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/).
- Une [Gateway Public Cloud](/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/).
...
Afin de créer et de configurer à la fois une Gateway Public Cloud et un réseau privé vRack, veuillez suivre le guide « [Créer un réseau privé avec une Gateway](/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/) ». Ce guide explique comment :
