...
Vous pouvez générer votre identifiant et votre mot de passe OpenStack à l'aide de ce [guide](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/).
