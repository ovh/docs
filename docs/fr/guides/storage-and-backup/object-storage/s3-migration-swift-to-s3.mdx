...
- Pour votre conteneur source : nous vous recommandons d'utiliser votre utilisateur OpenStack et le fichier de configuration Rclone associé depuis [l'espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr). Suivez les étapes de [ce guide](/guides/storage-and-backup/object-storage/pcs-sync-rclone-object-storage/) pour accéder au fichier de configuration associé à votre utilisateur OpenStack.
...
Nous vous recommandons de comparer les buckets source et destination après la migration. Vos buckets source et destination OVHcloud peuvent être comparés en ligne de commande ou directement depuis [l'espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr)
