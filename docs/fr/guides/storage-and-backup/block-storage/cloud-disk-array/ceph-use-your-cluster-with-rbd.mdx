...
- [Créer un pool](/guides/storage-and-backup/block-storage/cloud-disk-array/ceph-create-a-pool/)
- [Créer-un-utilisateur](/guides/storage-and-backup/block-storage/cloud-disk-array/ceph-create-a-user/)
- [Ajouter des droits à un utilisateur sur un pool](/guides/storage-and-backup/block-storage/cloud-disk-array/ceph-change-user-rights/)
- [Ajouter un IP ACL](/guides/storage-and-backup/block-storage/cloud-disk-array/ceph-create-an-ip-acl/) pour permettre à votre serveur de contacter le cluster
...
`<mon_X_IP>` doit être remplacé par des moniteurs IP que vous pouvez trouver sur le gestionnaire du [Cloud Disk Array](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr). Sous "Plateformes et services", sélectionnez votre groupe Ceph.
