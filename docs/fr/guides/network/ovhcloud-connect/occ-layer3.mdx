...
description: Détails sur le mode Layer 3 (L3) pour OVHcloud Connect
...
<img className="thumbnail" alt="Implémentation L3" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-implementation.png" loading="lazy" />
...
<img className="thumbnail" alt="L3 Two POP" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-twopop.png" loading="lazy" />

De ce fait, le L3 permet d'être compatibles avec du multi-DC :

<img className="thumbnail" alt="L3 Multi DC" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-multidc.png" loading="lazy" />
...
<img className="thumbnail" alt="Règles L3" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-rules.gif" loading="lazy" />

Le schéma ci-dessous montre la combinaison de L2 et L3. Ils peuvent se terminer dans le même DC OVHcloud ou non.

<img className="thumbnail" alt="L3 Mix L2" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-mixl2.png" loading="lazy" />
...
<img className="thumbnail" alt="Architecture L3" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-architecture.png" loading="lazy" />
...
<img className="thumbnail" alt="Rack BGP L3" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-bgpvrack.png" loading="lazy" />

À un niveau plus global, la topologie BGP ressemblera à ceci :

<img className="thumbnail" alt="Topologie globale BGP L3" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-bgpglobal.png" loading="lazy" />
...
<img className="thumbnail" alt="BGP L3 as-prepend ou med" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-bgpasprepend-med.png" loading="lazy" />
