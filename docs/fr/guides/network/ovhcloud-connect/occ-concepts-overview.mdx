...
description: Présentation des concepts nécessaires à la compréhension de l’offre OVHcloud Connect
...
<img className="thumbnail" alt="OVHcloud Connect" src="/images/network/ovhcloud-connect/occ-concepts-overview/VrackConnectDedicated2025.png" loading="lazy" />
...
La liste disponible sur [ce lien de notre site web](https://www.ovhcloud.com/fr/network/ovhcloud-connect/) présente les PoPs d'OVHcloud accessibles via chacun de nos partenaires fournisseurs de services cloud.
