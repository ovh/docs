...
description: Détails sur le mode Layer 2 (L2) pour OVHcloud Connect
...
<img className="thumbnail" alt="Implémentation L2" src="/images/network/ovhcloud-connect/occ-layer2/occ-l2-implementation.png" loading="lazy" />
...
<img className="thumbnail" alt="Conception L2 prise en charge" src="/images/network/ovhcloud-connect/occ-layer2/occ-l2-supported-unsupported.png" loading="lazy" />
...
<img className="thumbnail" alt="Topologies L2" src="/images/network/ovhcloud-connect/occ-layer2/occ-l2-topologies.png" loading="lazy" />
