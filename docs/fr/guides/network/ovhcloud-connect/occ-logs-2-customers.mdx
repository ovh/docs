...
Pour en savoir plus sur Logs Data Platform avant de lire ce guide, reportez-vous au [Guide d'introduction de Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-introduction-to-ldp/).
...
- Un service [OVHcloud Connect](/guides/network/ovhcloud-connect/occ-concepts-overview/) opérationnel.
