...
Pour cela, rendez-vous dans votre [espace client OVH](/links/manager) dans l'onglet `Dédié`, puis `NAS et CDN`.

Cliquez ensuite sur `Ajouter un domaine au CDN` :

![Espace client CDN](/images/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/cdn_customer_panel.png)

Dans l'étape 1, il vous sera possible de choisir le sous-domaine à ajouter au CDN :

![Ajouter un sous-domaine sur le CDN](/images/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_1.png)
...
![Ajouter un backend](/images/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_2.png)
...
![Nom de photo](/images/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/cname_field.png)
