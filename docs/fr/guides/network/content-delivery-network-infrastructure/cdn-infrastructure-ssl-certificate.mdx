...
![Certificat SSL en cours](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/ssl_in_progress.png)
...
![SSL validé](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/ssl_validated.png)

### Ajouter son propre certificat

- Si vous n'avez pas encore ajouté de nom de domaine ou que vous ne possédez aucun certificat, vous pouvez utiliser l'option `Ajouter mon certificat` depuis l'onglet SSL du votre CDN :

![Ajout d'un certificat SSL](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/add_ssl.png)

- Si vous possédez déjà un certificat Let's Encrypt, vous pouvez simplement utiliser l'option `Remplacer par mon certificat` :

![Changement d'un certificat SSL](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/change_ssl.png)
