...
Pour cela, rendez-vous dans votre [espace client OVH](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) dans l'onglet <code className="action">Dédié</code>, puis <code className="action">NAS et CDN</code>.
