...
Vous trouverez plus d’informations sur les différences entre les Floating IP et les Additional IP dans [ce guide](/guides/public-cloud/public-cloud-network-services/concepts-02-additional-ip-vs-floating-ip/).
...
- **Configuration** : Les détails de configuration des adresses IPv4 et IPv6, tels que l'adresse, la taille du préfixe ou la passerelle par défaut, se trouvent dans [l'espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), généralement dans l'onglet <code className="action">Réseau</code> du produit concerné.
...
:::tip[Success]
**Guides associés** :
- [Configurer un bloc Additional IPv6 dans un vRack](/guides/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/)
