...
![Rancher Cluster Creation](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-custom-nodes/rancher-cluster-creation.jpg)
...
Follow this guide if you want to [create OVHcloud Compute Instances](/guides/public-cloud/compute/compute-getting-started).
...
![OVHcloud Managed Rancher Service Create Kubernetes PCI](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-custom-nodes/rancher-create-custom.png)
...
![Rancher Custom Cluster Creation](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-custom-nodes/rancher-cluster-creation.png)
...
![Rancher cluster roles](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-custom-nodes/rancher-cluster-roles.png)

![Rancher command roles for etcd and control plane](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-custom-nodes/rancher-cluster-roles-command.png)
...
![Rancher cluster roles](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-custom-nodes/rancher-cluster-roles-worker.png)

![Rancher command for workers](/images/guides/public-cloud/containers-orchestration/managed-rancher-service/creating-kubernetes-custom-nodes/rancher-command-worker.png)
