...
It also supposes that you already have followed the [Using vRack](/guides/public-cloud/containers-orchestration/managed-kubernetes/managed-kubernetes-using-vrack) guide to activate the vRack on your Public Cloud project and put your OVHcloud Managed Kubernetes cluster inside the vRack.

## Instructions

### Setting up the vRack

First of all, we will need to set up vRack Private Network for our Public Cloud. To do it, we follow the [Configuring vRack for Public Cloud](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack) guide. Once you have created a vRack and added it into a Private Network, you can continue. 

![Setting-up the vRack](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/vrack-example-between-private-networks/vrack-example-01.png)

> [!warning]
> As explained in the [Known limits](/guides/public-cloud/containers-orchestration/managed-kubernetes/managed-kubernetes-known-limits) guide, the following subnets are not compliant with the `vRack` feature and can generate some incoherent behaviours with our used overlay networks:
>
...
![Choose a private network for this cluster](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/vrack-example-between-private-networks/vrack-example-02.png)
...
![Private network information in Attached network column](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/vrack-example-between-private-networks/vrack-example-03.png)

### Setting up the PCI

Now we can create a new Public Cloud instance inside the vRack, by following the [Integrating an instance into vRack](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack#step-3-integrating-an-instance-into-vrack) guide.

We are going to create an Ubuntu instance:

![Setting-up PCI - Ubuntu instance](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/vrack-example-between-private-networks/vrack-example-04.png)

In the fourth step of creation, we attach it to the private network we created before:

![Setting-up PCI - Attaching to a private network](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/vrack-example-between-private-networks/vrack-example-05.png)
...
![Setting-up PCI - SSH connection information](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/vrack-example-k8s-and-pci/vrack-example-05-bis.png)
...
Now we have set up the database, we can deploy WordPress on the Kubernetes cluster. We are following a similar process as in our [Installing WordPress](/guides/public-cloud/containers-orchestration/managed-kubernetes/managed-kubernetes-install-wordpress) tutorial, but adapting it to use an external database.
...
![Setting-up WordPress](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/vrack-example-between-private-networks/vrack-example-06.png)
