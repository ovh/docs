...
First of all, we will need to set up vRack Private Network for our Public Cloud. To do it, we follow the [Configuring vRack for Public Cloud](/guides/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/) guide. Once you have created a vRack and added it into a Private Network, you can continue. 
...
Now we can create a new Public Cloud instance inside the vRack, by following the [Integrating an instance into vRack](/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack#step-3-integrating-an-instance-into-vrack/) guide.
...
Now we have set up the database, we can deploy WordPress on the Kubernetes cluster. We are following a similar process as in our [Installing WordPress](/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-wordpress/) tutorial, but adapting it to use an external database.
