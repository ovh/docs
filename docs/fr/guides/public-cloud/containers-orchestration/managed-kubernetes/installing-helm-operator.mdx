...
In order to create a private registry, you can follow the [how to create an OVHcloud private registry](/guides/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry/) tutorial.
...
To go deeper on the Kubernetes operators topic, follow the other [Kubernetes tutorials](/guides/public-cloud/containers-orchestration/managed-kubernetes/overview/) in the `Operators` section.
