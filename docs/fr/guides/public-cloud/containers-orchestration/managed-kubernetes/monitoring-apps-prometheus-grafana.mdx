...
![Prometheus Architecture](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/monitoring-apps-grafana-prometheus/prometheus-scraping-schema.png)
...
![Prometheus](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/monitoring-apps-grafana-prometheus/prometheus.png)
...
![Grafana](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/monitoring-apps-grafana-prometheus/grafana.png)

![Grafana Home Page](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/monitoring-apps-grafana-prometheus/grafana-home-page.png)

This time again, thanks to the prometheus operator and without doing anything on your side, several dashboards are available. You can display them by clicking on the `Dashboards` icon, in the Grafana sidebar, then on `browse`:

![Grafana](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/monitoring-apps-grafana-prometheus/grafana-browse.png)
![Grafana](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/monitoring-apps-grafana-prometheus/grafana-dashboards.png)
...
![Grafana](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/monitoring-apps-grafana-prometheus/grafana-metrics.png)
