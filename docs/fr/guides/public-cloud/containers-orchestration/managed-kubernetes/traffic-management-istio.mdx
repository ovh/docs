...
![Bookinfo architecture](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/traffic-management-with-istio/bookinfo-architecture.png)
...
![A/B Testing - At every refresh you will see that stars change alternatively between back (`v2`) and red (`v3`)](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/traffic-management-with-istio/ab-testing-001.png)
...
![Canary Release v1 to v2 progressing release](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/traffic-management-with-istio/canary-schema.png)
...
![Canary Testing - all traffic to v1](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/traffic-management-with-istio/canary-testing-001.png)
...
![Canary Testing - one tenth of times we get v2](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/traffic-management-with-istio/canary-testing-002.png)
...
![Rolling Deployment](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/traffic-management-with-istio/rolling-deployment-001.png)
...
![Rolling deployment - At this moment traffic will be equally split between the two releases of `reviews`](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/traffic-management-with-istio/rolling-deployment-002.png)
...
![Rolling deployment - And now the `v2` of `reviews` receives all the traffic](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/traffic-management-with-istio/rolling-deployment-003.png)
