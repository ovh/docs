...
Pour plus d'informations sur la gestion des Floating IP avec OpenStack, consultez notre guide « [Concepts - Additional IP ou Floating IP](/guides/public-cloud/public-cloud-network-services/concepts-02-additional-ip-vs-floating-ip/) ».
...
- [Concepts - Additional IP ou Floating IP](/guides/public-cloud/public-cloud-network-services/concepts-02-additional-ip-vs-floating-ip/) : Comprendre la différence entre Additional IP et Floating IP.
