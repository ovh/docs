...
![Popeye](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/popeye.png)
...
![Popeye Report](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/popeye-report.png)
...
![OVHcloud Object Storage container name](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/set-container-name.png)
...
Access the administration UI for your OVHcloud Managed Kubernetes clusters by clicking on `Users & Roles` in the left-hand menu and click on `+ Add user`.

![Create OpenStack user](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/create_openstack_user1.png)

Enter a description for the user you want to create, for example `Popeye` and click on `Next`.

![Create OpenStack user](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/create_openstack_user2.png)

Check the `ObjectStore operator` role and click on `Confirm`.

![Create OpenStack user](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/create_openstack_user3.png)

Your user is being created.
Username and password will be automatically generated and displayed in your Control Panel.

![Create OpenStack user](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/create_openstack_user4.png)
...
Click on `Download OpenStack's RC file` to retrieve the OpenStack RC file.

![Download OpenStack RC file](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/download-openrc1.png)

Then select the region of your Object Storage container (`GRA` for this guide) and click on the `Download` button.

![Download OpenStack RC file](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/download-openrc2.png)
...
![Popeye report stored on OVHcloud Object Storage](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/report-saved-on-object-storage.png)
