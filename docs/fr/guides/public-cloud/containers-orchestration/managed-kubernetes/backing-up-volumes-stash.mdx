...
- [Prepare your environement to use the OpenStack API](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment)

- [Get Openstack RC File v3 from Horizon](/guides/public-cloud/public-cloud-cross-functional/compute-horizon-access-security)
...
![Snapshots onb OVHcloud Manager](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backing-up-volumes-using-stash/snapshots-on-manager.png)
