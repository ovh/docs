...
Access the UI for OVHcloud Enterprise File Storage by clicking the `Storage and backups` then `Enterprise File Storage` menu in the [Bare Metal Cloud section of the OVHcloud Control Panel](/links/manager).
