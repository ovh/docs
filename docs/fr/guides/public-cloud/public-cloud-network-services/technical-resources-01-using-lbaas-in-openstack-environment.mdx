...
- Avoir un [réseau privé](/guides/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/) configuré dans votre projet
...
>
> Vous pouvez en savoir plus sur notre page [Concepts](/guides/public-cloud/public-cloud-network-services/concepts-02-additional-ip-vs-floating-ip/).
>
...
<img className="thumbnail" alt="diagram" src="/images/public-cloud/public-cloud-network-services/technical-resources-01-using-lbaas-in-openstack-environment/topology.png" loading="lazy" />
