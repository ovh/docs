...
<img className="thumbnail" alt="simple LB concepts" src="/images/public-cloud/public-cloud-network-services/concepts-03-loadbalancer/LB_concepts_simple.svg" loading="lazy" />

<img className="thumbnail" alt="full LB concepts" src="/images/public-cloud/public-cloud-network-services/concepts-03-loadbalancer/LB_concepts_full.svg" loading="lazy" />
...
<img className="thumbnail" alt="Architecture du Load Balancer privée à privée" src="/images/public-cloud/public-cloud-network-services/concepts-03-loadbalancer/priv-to-priv.png" loading="lazy" />
...
<img className="thumbnail" alt="Architecture du Load Balancer public-privé" src="/images/public-cloud/public-cloud-network-services/concepts-03-loadbalancer/pub-to-priv.png" loading="lazy" />
...
<img className="thumbnail" alt="Public to Public Load Balancer architecture" src="/images/public-cloud/public-cloud-network-services/concepts-03-loadbalancer/pub-to-pub.png" loading="lazy" />
...
|---|---|---|---|---|
|Private to Private | Obligatoire | Non requis | 3 ([src](/guides/public-cloud/public-cloud-network-services/known-limits/)) | Non requis |
|Public to Private | Obligatoire | Obligatoire | 5 ([src](/guides/public-cloud/public-cloud-network-services/known-limits/)) | Obligatoire |
|Public to Public | Obligatoire | Obligatoire | 5 ([src](/guides/public-cloud/public-cloud-network-services/known-limits/)) | Obligatoire |
...
- Configurez votre premier load balancer avec ce [guide](/guides/public-cloud/public-cloud-network-services/getting-started-01-create-lb-service/).
