...
Référez-vous aux guides suivants :
  ...
  - [Attacher une adresse Floating IP à une instance Public Cloud](/guides/public-cloud/public-cloud-network-services/getting-started-03-attach-floating-ip-to-instance/).
  - [Gestion des règles de firewall et port security sur les réseaux utilisant OpenStack CLI](/guides/public-cloud/public-cloud-cross-functional/security-group-private-network/)
