...
- Une [Floating IP des services L3](/guides/public-cloud/public-cloud-network-services/getting-started-03-attach-floating-ip-to-instance/)
...
Ce scénario est couvert par le guide « [Attacher une adresse Floating IP à une instance Public Cloud](/guides/public-cloud/public-cloud-network-services/getting-started-03-attach-floating-ip-to-instance/) ».

#### Architecture de configuration

<img className="thumbnail" alt="schema" src="/images/public-cloud/public-cloud-network-services/configuration-01-snat-configuration/architecture.png" loading="lazy" />
...
Créez une VM avec une Floating IP comme expliqué dans ce [guide](/guides/public-cloud/public-cloud-network-services/getting-started-03-attach-floating-ip-to-instance/).
