...
### vRack OVHcloud - Clustering avec les VLAN <a id="vlancluster"></a>
...
#### Mode Public : une IP publique est attachée directement à l'instance <a id="publicmode"></a>
...
#### Public Cloud Gateway (avec SNAT) <a id="gateway"></a>
...
![PCI Networking](/images/guides/public-cloud/public-cloud-network-services/concepts-01-public-cloud-networking-concepts/netcon3.png)
...
#### Load Balancer dans un réseau privé <a id="loadbalancer"></a>
...
Pour en savoir plus, consultez notre guide [Load Balancer](/guides/public-cloud/public-cloud-network-services/getting-started-load-balancer) .

### Adresses IP publiques

#### OVHcloud Floating IP pour Public Cloud <a id="floatingip"></a>
...
![PCI Networking](/images/guides/public-cloud/public-cloud-network-services/concepts-01-public-cloud-networking-concepts/netcon5.png)
...
Apprenez-en plus sur les Additional IP et Floating IP sur la [page concept dédiée](/guides/public-cloud/public-cloud-network-services/additional-ip-vs-floating-ip).
