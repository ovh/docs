...
Ces opérations peuvent être réalisées depuis l'[espace client OVHcloud](/links/manager), l'[API OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment) ou l'[API OVHcloud](/links/api).
...
- Avoir accès à l'[API OVHcloud](/links/api), à l'[espace client OVHcloud](/links/manager) ou à l'environnement OpenStack ([Tutoriel](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment))
...
Veuillez noter qu'il est nécessaire d'avoir activé le vRack avant de poursuivre. Si vous n'en possédez pas, nous vous invitons à consulter cette [section](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack#activation) du guide correspondant.

Cliquez ensuite sur le bouton `Créer une Gateway`. 

![création de la gateway](/images/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/firstgatewaycreation.png)
...
![sélection de la région](/images/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/select_region.png)
...
![sélection d'une taille de gateway](/images/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/select_size.png)
...
![menu déroulant](/images/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/gatewayandprivatenetwork.png)
...
![créer un réseau privé](/images/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/newprivatenetwork.png)
...
![créer un réseau privé](/images/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/createprivatenetwork.png)
...
![créer une gateway](/images/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/confirmcreation.png)
...
![nouveau réseau privé](/images/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/createdprivatenetwork.png) 

Vous pouvez afficher la Public Gateway dans la section `Gateway`.

![nouveau gateway](/images/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/mynewgateway.png)
...
- [Définir les variables d'environnement OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-set-openstack-environment-variables)
