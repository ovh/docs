...
[L'espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) est une interface entièrement et uniquement visuelle, ce qui en fait une interface idéale à la gestion de plusieurs VLAN. Vous aurez également la possibilité de personnaliser la plage d'IP privée qui, par défaut, est 10.1.0.0/16.
...
Vous serez redirigé vers une autre page pour valider la commande, l'opération prendra quelques minutes.
    ...
    <img className="thumbnail" alt="ajouter le projet" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/addprojectvrack.png" loading="lazy" />
...
Le tableau de bord de votre instance vous est alors présenté. Cliquez sur le bouton <code className="action">⁝</code> à droite de « Réseaux privés » puis sur <code className="action">Attacher un réseau</code>.
    ...
    <img className="thumbnail" alt="attacher réseau" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack2021-01.png" loading="lazy" />
...
Dans la pop-up qui apparaît, sélectionnez le ou les réseaux privés à attacher à votre instance puis cliquez sur <code className="action">Confirmer</code>.
    ...
    <img className="thumbnail" alt="attacher réseau" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack9.png" loading="lazy" />
  </Tab>
  <Tab label="Depuis les APIv6 OVHcloud">
...
Vous devrez renseigner a minima les champs suivants :
  ...
  <Tab label="Depuis OpenStack Horizon">
    ...
    <img className="thumbnail" alt="connexion Horizon" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon1.png" loading="lazy" />
