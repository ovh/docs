...
You must have created a private network and a subnet as explained in [this guide](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack).
...
![network list](/images/guides/public-cloud/public-cloud-network-services/configuration-04-update-subnet/network_list.png)

In that list, click on your network name ("private_network_GRA11" in this example). The network detail page is then displayed.

![network details](/images/guides/public-cloud/public-cloud-network-services/configuration-04-update-subnet/network_details.png)

Click the `Subnets` tab: the subnets from the private network are listed.

![subnets list](/images/guides/public-cloud/public-cloud-network-services/configuration-04-update-subnet/subnets_list.png)
...
![gateway IP](/images/guides/public-cloud/public-cloud-network-services/configuration-04-update-subnet/add_gateway_ip.png)
...
![subnet details](/images/guides/public-cloud/public-cloud-network-services/configuration-04-update-subnet/subnet_details.png)

Click on `Save` and your subnet is updated with a gateway IP !

### Using the OpenStack Command Line Interface

You need to have your [CLI environment set up](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment) and your [variables defined](/guides/public-cloud/public-cloud-cross-functional/compute-set-openstack-environment-variables).
