...
### Configurez votre vRack <a id="step1"></a>
...
![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/ubika-vrack.png)

### Installer et configurer Ubika WAAP Gateway sur votre environnement Public Cloud <a id="step2"></a>
...
Rendez-vous dans la section `download` du [site officiel d'Ubika](https://my.ubikasec.com/). Connectez-vous à votre compte Ubika et suivez les instructions pour télécharger l'image UWG OpenStack.
...
![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/login.png)
...
![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/managed-1.png)

Ajoutez la seconde instance :

![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/managed-2.png)
...
![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/virtual-interface-1.png)

UWG managed-2 :

![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/virtual-interface-2.png)

Supprimez la passerelle par défaut et ajoutez la passerelle vRack pour chaque Ubika managé (`Setup` > `Networking` > `Routes`).

UWG managed-1 :

![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/default-gateway-1.png)

UWG managed-2 :

![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/default-gateway-2.png)

Créez une configuration active/passive haute disponibilité (`Setup` > `High Availability` > `Add`) :

![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ha-1.png)

Ajoutez une addresse IP du bloc d'IP en tant qu'IP Virtuelle :

![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/ha-2-vrack.png)

Ajoutez les deux instances UWG managées en tant que membres VRRP à l'aide des interfaces de charge de travail (eth1) :

![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ha-3.png)

Appliquez la configuration (bouton en haut à droite de l'interface) :

![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ha-4.png)

### Configurer les licences <a id="step3"></a>
...
### Créez votre environnement de serveur web <a id="step4"></a>
...
![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/reverse-proxy.png)

Créez un enregistrement DNS A pour le serveur web pointant vers l'IP virtuelle du déploiement Ubika :

![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/dns-vrack.png)
...
![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/tunnel-1.png)

![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/tunnel-2.png)

Appliquez la configuration :

![Ubika vrack](/images/guides/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/tunnel-3.png)
