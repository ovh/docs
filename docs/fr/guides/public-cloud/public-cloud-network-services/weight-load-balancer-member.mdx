...
- La [CLI OpenStack installée et configurée](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment).
...
- Pour vous connecter avec l'authentification unique OVHcloud (SSO) : utilisez le lien `Horizon` dans le menu de gauche sous « Interfaces de gestion » après avoir ouvert votre projet `Public Cloud` dans l'[espace client OVHcloud](/links/manager).
- Pour vous connecter avec un utilisateur OpenStack spécifique : ouvrez la [page de connexion à Horizon](https://horizon.cloud.ovh.net/auth/login/) et entrez les [identifiants de l'utilisateur OpenStack](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user) précédemment créé, puis cliquez sur `Se connecter`.
...
![Mettre à jour le tableau de bord Openstack membre](/images/guides/public-cloud/public-cloud-network-services/weight-load-balancer/update-member_openstack_dashboard-1.png)
...
![Mettre à jour le poids](/images/guides/public-cloud/public-cloud-network-services/weight-load-balancer/member-status-draining.png)
...
![Mettre à jour le tableau de bord Openstack membre](/images/guides/public-cloud/public-cloud-network-services/weight-load-balancer/pool-tab.png)
