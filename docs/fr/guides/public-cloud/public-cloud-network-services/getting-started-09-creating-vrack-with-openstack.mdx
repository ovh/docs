...
- Consulter le guide [Configurer le vRack sur le Public Cloud](/guides/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/) (pour comprendre les différentes méthodes de gestion du vRack avec le Public Cloud)
...
<img className="thumbnail" alt="ajouter le projet" src="/images/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/addprojectvrack.png" loading="lazy" />

<a name="ovhcloud-api"></a>

#### Depuis les APIv6 OVHcloud

Pour activer et gérer un vRack depuis les APIv6 OVHcloud, cliquez [ici](/guides/public-cloud/public-cloud-network-services/getting-started-08-creating-vrack-with-api#etape-1-activer-et-gerer-un-vrack/) pour consulter le guide spécifique à cette méthode.
...
[Configuration du vRack Public Cloud depuis les APIv6 OVHcloud](/guides/public-cloud/public-cloud-network-services/getting-started-08-creating-vrack-with-api/).
