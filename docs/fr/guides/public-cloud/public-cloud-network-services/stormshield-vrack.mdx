...
### Installer et configurer Stormshield Network Security sur votre environnement Public Cloud <a id="step1"></a>
...
Connectez-vous à l'[espace client OVHcloud](/links/manager), rendez-vous dans la section `Public Cloud`, puis sélectionnez le projet Public Cloud concerné. Dans le menu de gauche, cliquez sur `Instances` sous l'onglet **Compute**, puis retrouvez vos deux instances SNS EVA.
...
#### Cas d'usage n°1 : configurer Stormshield Network Security pour une utilisation en tant que passerelle <a id="step2"></a>
...
#### Cas d'usage n°2 : configurer un NAT (**N**etwork **A**ddress **T**ranslation) pour accéder à un service HTTP privé depuis l'extérieur <a id="step3"></a>
...
#### Cas d'usage n°3 : tunnel IPsec (de site à site) <a id="step4"></a>
...
#### Cas d'usage n°4 : VPN SSL/TLS (de client à site) <a id="step5"></a>
