...
- via le [CLI OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment) en effectuant `openstack floating ip list` et `openstack loadbalancer list` ;
