...
![image problématique](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/problematic_image.png)
...
![image solution](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/solution_image.png)
...
![Ajouter un projet Public Cloud à Vrack](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/add_pcp_to_vrack.png)
...
![Modifier le sous-réseau région 1](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/configure_subnet_region1.png)

![Modifier le sous-réseau région 1 - 2](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/configure_subnet_region1_2.png)

**- Deuxième région :**

![Modifier le sous-réseau région 2](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/configure_subnet_region2.png)

![Modifier le sous-réseau région 2 - 2](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/configure_subnet_region2_2.png)

**3\. Actualisez l'état du réseau**

Retournez dans l'espace client OVHcloud et actualisez la page du réseau.

![Actualiser la page de liste du vrack](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/refresh_vrack_list_page.png)
...
![Ajouter un serveur Bare Metal à Vrack](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/add_baremetal_to_vrack.png)
...
![Créer un réseau privé Public Cloud](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/create_private_network.png)
...
![Obtenir l'adresse MAC](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/obtain_mac_address.png)

**3\. Créez un port virtuel sur le réseau privé Public Cloud en utilisant l'adresse MAC du serveur Bare Metal.**

![Créer un port virtuel](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/create_virtual_port.png)
