...
Retrouvez plus d'informations sur la configuration d'adresses Additional IP dans [ce guide](/guides/public-cloud/public-cloud-network-services/configure-additional-ip).
...
Pour plus d'informations sur la configuration des Floating IP, consultez la page [Concepts - Réseau Public Cloud](/guides/public-cloud/public-cloud-network-services/concepts).

### Comment obtenir des adresses IP publiques dans votre espace client ?

Dans votre [espace client OVHcloud](/links/manager), dans la section `Public Cloud`, allez dans la rubrique **Network** du menu de gauche et sélectionnez `IP Publiques`. Gérez ici les Additional IP et les Floating IP selon vos besoins.

![Concept IP](/images/guides/public-cloud/public-cloud-network-services/concepts-02-additional-ip-vs-floating-ip/concip.png)
