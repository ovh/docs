...
Oui cette [fonctionnalité](https://docs.openstack.org/octavia/latest/user/guides/monitoring.html) est disponible depuis le déploiement de la version Zed en juin 2023. Retrouvez plus d'informations sur [cette page](/guides/public-cloud/public-cloud-network-services/loadbalancer-monitoring-prometheus).
...
Oui, c'est le cas pour une Gateway (routeur L3 avec option SNAT). Actuellement, seules les instances en **mode privé** de réseau et connectées à un réseau privé à région unique sont prises en charge. Pour plus d'informations, consultez notre [guide concept sur le réseau Public Cloud](/guides/public-cloud/public-cloud-network-services/concepts).
