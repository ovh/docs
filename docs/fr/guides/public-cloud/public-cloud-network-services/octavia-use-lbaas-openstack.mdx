...
- Avoir un [réseau privé](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack) configuré dans votre projet
- [Préparer l'environnement pour utiliser l'API OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment) en installant python-swiftclient.
...
>
> Vous pouvez en savoir plus sur notre page [Concepts](/guides/public-cloud/public-cloud-network-services/additional-ip-vs-floating-ip).
>
