...
- Un [utilisateur OpenStack](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/) (facultatif).
...
<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/ubika-vrack.png" loading="lazy" />
...
<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/login.png" loading="lazy" />
...
<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/managed-1.png" loading="lazy" />

Ajoutez la seconde instance :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/managed-2.png" loading="lazy" />
...
<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/virtual-interface-1.png" loading="lazy" />

UWG managed-2 :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/virtual-interface-2.png" loading="lazy" />

Supprimez la passerelle par défaut et ajoutez la passerelle vRack pour chaque Ubika managé (`Setup` > `Networking` > `Routes`).

UWG managed-1 :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/default-gateway-1.png" loading="lazy" />

UWG managed-2 :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/default-gateway-2.png" loading="lazy" />

Créez une configuration active/passive haute disponibilité (`Setup` > `High Availability` > `Add`) :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/ha-1.png" loading="lazy" />

Ajoutez une addresse IP du bloc d'IP en tant qu'IP Virtuelle :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/ha-2-vrack.png" loading="lazy" />

Ajoutez les deux instances UWG managées en tant que membres VRRP à l'aide des interfaces de charge de travail (eth1) :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/ha-3.png" loading="lazy" />

Appliquez la configuration (bouton en haut à droite de l'interface) :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/ha-4.png" loading="lazy" />
...
<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/reverse-proxy.png" loading="lazy" />

Créez un enregistrement DNS A pour le serveur web pointant vers l'IP virtuelle du déploiement Ubika :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/dns-vrack.png" loading="lazy" />
...
<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/tunnel-1.png" loading="lazy" />

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/tunnel-2.png" loading="lazy" />

Appliquez la configuration :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/tunnel-3.png" loading="lazy" />
