...
<img className="thumbnail" alt="PCI Networking" src="/images/public-cloud/public-cloud-network-services/concepts-01-public-cloud-networking-concepts/netcon3.png" loading="lazy" />
...
Pour en savoir plus, consultez notre guide [Load Balancer](/guides/public-cloud/public-cloud-network-services/getting-started-01-create-lb-service/) .
...
<img className="thumbnail" alt="PCI Networking" src="/images/public-cloud/public-cloud-network-services/concepts-01-public-cloud-networking-concepts/netcon5.png" loading="lazy" />
...
Apprenez-en plus sur les Additional IP et Floating IP sur la [page concept dédiée](/guides/public-cloud/public-cloud-network-services/concepts-02-additional-ip-vs-floating-ip/).
