...
<img className="thumbnail" alt="image problématique" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/problematic_image.png" loading="lazy" />
...
<img className="thumbnail" alt="image solution" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/solution_image.png" loading="lazy" />
...
<img className="thumbnail" alt="Ajouter un projet Public Cloud à Vrack" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/add_pcp_to_vrack.png" loading="lazy" />
...
<Tabs>
  <Tab label="Via l'espace client OVHcloud et Horizon">
    ...
    **- Première région :**
    ...
    <img className="thumbnail" alt="Modifier le sous-réseau région 1" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/configure_subnet_region1.png" loading="lazy" />
    
    <img className="thumbnail" alt="Modifier le sous-réseau région 1 - 2" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/configure_subnet_region1_2.png" loading="lazy" />

**- Deuxième région :**
    
    <img className="thumbnail" alt="Modifier le sous-réseau région 2" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/configure_subnet_region2.png" loading="lazy" />
    
    <img className="thumbnail" alt="Modifier le sous-réseau région 2 - 2" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/configure_subnet_region2_2.png" loading="lazy" />

**3\. Actualisez l'état du réseau**
    
    Retournez dans l'espace client OVHcloud et actualisez la page du réseau.
    
    <img className="thumbnail" alt="Actualiser la page de liste du vrack" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/refresh_vrack_list_page.png" loading="lazy" />
...
<img className="thumbnail" alt="Ajouter un serveur Bare Metal à Vrack" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/add_baremetal_to_vrack.png" loading="lazy" />

<Tabs>
  <Tab label="Via l'espace client OVHcloud et Horizon">
    **1\. Créez un réseau privé Public Cloud**
    
    <img className="thumbnail" alt="Créer un réseau privé Public Cloud" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/create_private_network.png" loading="lazy" />
    ...
    **2\. Récupérez l'adresse MAC de l'interface privée du serveur Bare Metal.**
    ...
    <img className="thumbnail" alt="Obtenir l'adresse MAC" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/obtain_mac_address.png" loading="lazy" />

**3\. Créez un port virtuel sur le réseau privé Public Cloud en utilisant l'adresse MAC du serveur Bare Metal.**
    
    <img className="thumbnail" alt="Créer un port virtuel" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/create_virtual_port.png" loading="lazy" />
