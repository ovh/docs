...
![simple LB concepts](/images/guides/public-cloud/public-cloud-network-services/concepts-03-loadbalancer/LB_concepts_simple.svg)

![full LB concepts](/images/guides/public-cloud/public-cloud-network-services/concepts-03-loadbalancer/LB_concepts_full.svg)
...
![Architecture du Load Balancer privée à privée](/images/guides/public-cloud/public-cloud-network-services/concepts-03-loadbalancer/priv-to-priv.png)
...
![Architecture du Load Balancer public-privé](/images/guides/public-cloud/public-cloud-network-services/concepts-03-loadbalancer/pub-to-priv.png)
...
![Public to Public Load Balancer architecture](/images/guides/public-cloud/public-cloud-network-services/concepts-03-loadbalancer/pub-to-pub.png)
...
### Prérequis réseau <a id="network-prerequisites"></a>
...
|---|---|---|---|---|
|Private to Private | Obligatoire | Non requis | 3 ([src](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-known-limits)) | Non requis |
|Public to Private | Obligatoire | Obligatoire | 5 ([src](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-known-limits)) | Obligatoire |
|Public to Public | Obligatoire | Obligatoire | 5 ([src](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-known-limits)) | Obligatoire |
...
## Operating status et Provisioning status<a id="operating-provisioning-status"></a>
...
- Configurez votre premier load balancer avec ce [guide](/guides/public-cloud/public-cloud-network-services/getting-started-load-balancer).
