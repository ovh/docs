...
- Avoir la [OpenStack CLI](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/) prête à être utilisée sur votre système.
- Un [utilisateur OpenStack](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/) a été créé avec (a minima) les rôles _Compute Operator_ et _Backup Operator_.
...
Afin de récupérer le disque d'une instance Public Cloud, le moyen le plus simple est d'utiliser [l'utilitaire en ligne de commande OpenStack](https://docs.openstack.org/newton/user-guide/common/cli-overview.html). Si l'outil n'a pas été installé sur votre système, vous pouvez lire [notre guide](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/) ainsi que [notre guide pour créer un utilisateur OpenStack](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/).
...
Cette [documentation](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/) vous aidera à configurer les bonnes variables d'environnement sous Windows.
