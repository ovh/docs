...
- Avoir créé une [instance Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
- Être [connecté en SSH](/guides/public-cloud/compute/public-cloud-first-steps#connect-instance/) (sudo) à l'instance.
