...
- Si vous souhaitez préparer l'environnement pour utiliser [Terraform](/guides/public-cloud/public-cloud-cross-functional/how-to-use-terraform/), vous devez préparer l'environnement.
...
- Préparer l'environnement si vous souhaitez utiliser [Terraform](/guides/public-cloud/public-cloud-cross-functional/how-to-use-terraform/)
...
Ouvrez une [connexion SSH à votre instance](/guides/public-cloud/compute/public-cloud-first-steps#connect-instance/), puis utilisez la commande ci-dessous pour lister les disques attachés.
...
<Tabs>
  <Tab label="Sous Linux">
    Ouvrez une [connexion SSH à votre instance](/guides/public-cloud/compute/public-cloud-first-steps#create-instance/) puis utilisez la commande ci-dessous pour lister les disques attachés.
