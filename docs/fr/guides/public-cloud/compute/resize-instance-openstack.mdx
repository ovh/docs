...
- Avoir un [environnement OpenStack préparé pour le CLI](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/)
- Avoir défini les [variables d'environnement OpenStack](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/)
