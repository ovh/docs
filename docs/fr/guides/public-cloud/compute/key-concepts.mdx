...
:::info
**Meilleure pratique** : Pour les charges de travail critiques, privilégiez un [déploiement multi-AZ](/guides/public-cloud/public-cloud-cross-functional/3az-ref-architecture/) pour assurer la résilience et la continuité du service.
...
Pour des instructions détaillées sur la création et l'utilisation des clés SSH, consultez le guide [OVHcloud sur le SSH](/guides/public-cloud/compute/compute-creating-ssh-keys/).
...
:::info
**Meilleure pratique** : Les sauvegardes ne remplacent pas une [architecture résiliente](/guides/public-cloud/public-cloud-cross-functional/3az-ref-architecture/). Pour les environnements critiques, combinez les sauvegardes avec la réplication multi-AZ pour assurer une protection maximale des données et une disponibilité optimale du service.
...
Pour plus de détails sur la configuration des réseaux Public Cloud, consultez le guide officiel [OVHcloud sur les réseaux](/guides/public-cloud/public-cloud-network-services/concepts-01-public-cloud-networking-concepts/).
...
Les Savings Plans vous aident à optimiser votre budget tout en maintenant les performances et la fiabilité de votre environnement cloud. Pour plus d'informations, consultez le guide officiel [OVHcloud sur les Savings Plans](/guides/public-cloud/public-cloud-cross-functional/savings-plans/).
...
- [Comment créer une instance Public Cloud et y accéder](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)
