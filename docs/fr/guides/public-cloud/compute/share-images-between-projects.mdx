...
- [Préparer l’environnement à l’utilisation de l’API OpenStack](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/)

Vous aurez également besoin de :

- posséder une [Instance Public Cloud](https://www.ovhcloud.com/fr/public-cloud/) dans votre compte OVHcloud ;
- Un utilisateur [OpenStack](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/) créé dans votre projet ;
