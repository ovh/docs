...
Retrouvez plus d’informations dans notre [guide sur la création d’une instance Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
...
:::info
`Ed25519` est considéré comme le plus sûr mais `RSA` est une alternative valable. Les deux méthodes sont compatibles avec l'[espace client OVHcloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
...
Copiez cette chaîne de clé pour [l'ajouter à une nouvelle instance ou l'importer dans votre espace client](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
...
[Comment créer une instance Public Cloud et s'y connecter](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)
