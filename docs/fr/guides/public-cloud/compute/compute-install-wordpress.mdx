...
- Avoir une [instance Public Cloud](/guides/public-cloud/compute/compute-getting-started) avec Debian ou Ubuntu installé
...
### Étape 2 : configuration du serveur de base de données <a id="sqlconf"></a>
...
> 
> En alternative, OVHcloud vous propose la solution [SSL Gateway](/links/web/ssl-gateway). Référez-vous à [notre documentation](/guides/web-cloud/ssl-gateway/ssl-gateway-order) pour plus d'informations.
>
