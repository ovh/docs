...
[Hatchet](https://github.com/simagix/hatchet) is a powerful and sophisticated logs analyzer and viewer specifically designed for MongoDB JSON logs. It provides advanced features for logs processing, aggregation and storage of the processed data. You need to [setup logs forwarding with OVHcloud](/guides/public-cloud/public-cloud-databases/databases-16-logs-to-customer/) in order to collect logs and analyze them with Hatchet.
