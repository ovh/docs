...
Please refer to this [guide](/guides/public-cloud/public-cloud-databases/databases-03-advanced-configuration#using-the-ovhcloud-control-panel/) to find out how to change your advanced parameters from the OVHcloud Control Panel.
