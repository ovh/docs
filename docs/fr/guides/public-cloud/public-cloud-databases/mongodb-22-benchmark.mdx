...
- [Set up the OVHcloud MongoDB cluster](/guides/public-cloud/public-cloud-databases/mongodb-13-getting-started/). Make sure to select a plan with similar hardware specifications compared to the other databases with which you would like to benchmark.
...
![YCSB Load](/images/public-cloud/public-cloud-databases/mongodb-22-benchmark/YCSBLoad.png)
...
![YCSB run](/images/public-cloud/public-cloud-databases/mongodb-22-benchmark/YCSBrun.png)
...
- Consider future growth and scalability needs. You might want to consider how to [size a MongoDB cluster](/guides/public-cloud/public-cloud-databases/mongodb-18-cluster-sizing/).

### Step 2: Setup OVHcloud Cluster

- [Set up the OVHcloud MongoDB cluster](/guides/public-cloud/public-cloud-databases/databases-01-order-control-panel/).
...
![SimRunner run](/images/public-cloud/public-cloud-databases/mongodb-22-benchmark/simRunnerRun.png)
...
![SimRunner output](/images/public-cloud/public-cloud-databases/mongodb-22-benchmark/simRunnerOutput.png)
