...
- A Public Cloud Databases for Kafka service running and configured. [This guide](/guides/public-cloud/public-cloud-databases/kafka-02-getting-started/) can help you to meet this requirement.
- Following the [Getting Started guide](/guides/public-cloud/public-cloud-databases/kafka-02-getting-started/), save all certificates in a dedicated folder: 
