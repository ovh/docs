...
You can further customise your OpenSearch by using advanced parameters. See the [Advanced parameters references documentation](/guides/public-cloud/public-cloud-databases/opensearch-03-advanced-parameters-references/) for more information on the supported parameters.
