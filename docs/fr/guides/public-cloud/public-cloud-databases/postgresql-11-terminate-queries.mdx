...
<img className="thumbnail" alt="Terminate button" src="/images/public-cloud/public-cloud-databases/postgresql-11-terminate-queries/postgresql-11-terminate.png" loading="lazy" />
...
Please refer to this [guide](/guides/public-cloud/public-cloud-databases/postgresql-03-connect-cli/) to find out how to connect to your database using `psql`.
