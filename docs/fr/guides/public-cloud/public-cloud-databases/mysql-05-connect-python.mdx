...
One of the easiest, yet powerful, is to use a Command Line Interface (CLI), as shown in our guide : [Connect to MySQL with CLI](/guides/public-cloud/public-cloud-databases/mysql-03-connect-cli/).
