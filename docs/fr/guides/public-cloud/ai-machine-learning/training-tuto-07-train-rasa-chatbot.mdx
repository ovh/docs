...
Deployment will be performed in the second part of the tutorial which you can find here: [How to deploy a chatbot](/guides/public-cloud/ai-machine-learning/deploy-tuto-11-rasa-chatbot-flask/).
...
If you want to create a Rasa chatbot with a notebook, please follow this tutorial: [Create and train a Rasa chatbot](/guides/public-cloud/ai-machine-learning/notebook-tuto-10-create-chatbot/).
...
For more explanation about the CLI command for AI Training, please read this guide: [CLI Reference](/guides/public-cloud/ai-machine-learning/cli-15-commands-reference/).
...
More explanations are here: [CLI Reference](/guides/public-cloud/ai-machine-learning/cli-15-commands-reference/).
...
[How to create and train a rasa chatbot](/guides/public-cloud/ai-machine-learning/notebook-tuto-10-create-chatbot/)

If you want to deploy your model created with the chatbot, you can follow this tutorial. 

[How to deploy a chatbot](/guides/public-cloud/ai-machine-learning/deploy-tuto-11-rasa-chatbot-flask/)
