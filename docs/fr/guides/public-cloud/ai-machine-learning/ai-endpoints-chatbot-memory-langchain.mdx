...
![Comparaison between chatbot with and without memory](/images/guides/public-cloud/ai-machine-learning/endpoints-tuto-09-chatbot-memory-langchain/chatbot-with-without-memory-langchain.png)
