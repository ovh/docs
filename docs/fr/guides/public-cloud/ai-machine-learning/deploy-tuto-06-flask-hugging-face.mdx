...
- You can also imagine deploying an Object Detection model with **Flask** in this [tutorial](/guides/public-cloud/ai-machine-learning/deploy-tuto-04-flask-yolov5/).
- Discover an other tool to deploy easily AI models: **Gradio**. Refer to this [documentation](/guides/public-cloud/ai-machine-learning/deploy-tuto-05-gradio-sketch-recognition/).
