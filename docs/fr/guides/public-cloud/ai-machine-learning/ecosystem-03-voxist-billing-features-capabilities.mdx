...
:::info
To know how to use the **WebSocket API**, please follow this [guide](/guides/public-cloud/ai-machine-learning/ecosystem-04-voxist-models/).
...
To launch an AI Deploy app, there are several possibilities. You can do it from the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) or the CLI `ovhai`.
...
:::info
To know how to launch an app from the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), refer to this [guide](/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/).
...
You can also start this app with the `ovhai` [CLI](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/) by running the following command:
...
:::info
Replace `<label=name>` by the variables corresponding to your **token**. To know more about the management of the token, refer to this [documentation](/guides/public-cloud/ai-machine-learning/deploy-guide-03-tokens/).
...
:::info
For more detailed information on Voxist models, please refer to this [documentation](/guides/public-cloud/ai-machine-learning/ecosystem-04-voxist-models/).
...
- transcription configuration - *set up your required configuration, for more information about the features, follow this [documentation](/guides/public-cloud/ai-machine-learning/ecosystem-04-voxist-models/)*
...
To learn more about the basic cost of an app launched with AI Deploy, please refer to this [documentation](/guides/public-cloud/ai-machine-learning/deploy-guide-06-billing-concept/).
...
:::info
To learn more about the basic cost (resource price) of an app launched with AI Deploy, please refer to this [documentation](/guides/public-cloud/ai-machine-learning/deploy-guide-06-billing-concept/).
