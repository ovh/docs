...
Log in to the [OVHcloud Control Panel](/links/manager), navigate to the `Public Cloud` section, select your desired Public Cloud project, then go to the `AI & Machine Learning` category in the left menu and choose `AI Endpoints`.

![AI Endpoints section](/images/guides/public-cloud/ai-machine-learning/endpoints-guide-01-getting-started/api-access-key-creation-1.png)
...
![API access key creation](/images/guides/public-cloud/ai-machine-learning/endpoints-guide-01-getting-started/api-access-key-creation-2.png)
...
![AI Endpoints playground overview](/images/guides/public-cloud/ai-machine-learning/endpoints-guide-01-getting-started/playground_demo.png)
...
![AI Endpoints documentation overview](/images/guides/public-cloud/ai-machine-learning/endpoints-guide-01-getting-started/documentation_demo.png)
...
![AI Endpoints tutorials overview](/images/guides/public-cloud/ai-machine-learning/endpoints-guide-01-getting-started/tutorials_demo.png)
...
![AI Endpoints API overview](/images/guides/public-cloud/ai-machine-learning/endpoints-guide-01-getting-started/api_demo.png)
...
Here you can also find information on how to send a correct request to the model (existing parameters). Examples of usage are provided. You will also find there the output schema example. Click `Try it out` to prepare the request. There, you can modify the input schema if needed to customize the request you are sending. When you are ready, click `Execute` to send your modified request.
...
To revoke one of your API access keys, log in to the [OVHcloud Control Panel](/links/manager), go to the `Public Cloud` section and select the Public Cloud project concerned. Click on `AI Endpoints` underneath **AI & Machine Learning** in the left-hand menu, then on then `API key` management section.
...
![AI Endpoints access key cancellation](/images/guides/public-cloud/ai-machine-learning/endpoints-guide-01-getting-started/api-access-key-revoke.png)
...
For your convenience, you can monitor your estimated consumption and resource usage through the [OVHcloud Control Panel](/links/manager). To do so, navigate to the `AI Endpoints` section of the `AI & Machine Learning` category, in the left-hand vertical menu.
