...
Log in to the [OVHcloud Control Panel](/links/manager), and navigate to the `Public Cloud` section, in the horizontal menu at the top of the website. Select the Public Cloud project you want to use. Then, click on the `AI & Machine Learning` category in the left-hand vertical menu to access the `AI Notebooks` section.

From there, click the `Create a Notebook` button. The authorization process will take place silently in the background.

![Create a Notebook Control Panel manager 01](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/creating-a-notebook-using-UI-01.png)
...
First, navigate to the `Public Cloud` section of the [OVHcloud Control Panel](/links/manager) by clicking on it in the horizontal menu at the top of the website.
...
After that, you have the option to set labels. This allows to specify one of yours AI tokens and apply it to this new AI Notebook. This AI token can then be shared with anyone who should have access to the Notebook, allowing them to access it without requiring your own Public Cloud project credentials. This is useful if you want to provide access to the AI Notebook outside your Public Cloud project. More information [here](/guides/public-cloud/ai-machine-learning/ai-cli-app-token).

Then, click the `Next` button.

![Create a Notebook Control Panel manager 02](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/creating-a-notebook-using-UI-02.png)
...
![Create a Notebook Control Panel manager 03](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/creating-a-notebook-using-UI-03.png)

**3\. Pre-configured Frameworks**

Then, choose the AI framework you want to use, which will be pre-installed and ready to use when your AI Notebook is launched. A wide range of Machine Learning frameworks are available, in different versions. Select the version that suits your needs. Then, click on the `Next` button to continue. This guide will use _PyTorch_ as an example.

![Create a Notebook Control Panel manager 04](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/creating-a-notebook-using-UI-04.png)
...
![Create a Notebook Control Panel manager 05](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/creating-a-notebook-using-UI-05.png)

**5\. Notebook location**

Next, select a location.

![Create a Notebook Control Panel manager 06](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/creating-a-notebook-using-UI-06.png)
...
![Create a Notebook Control Panel manager 07](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/creating-a-notebook-using-UI-07.png)
...
![Create a Notebook Control Panel manager 08](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/creating-a-notebook-using-UI-08.png)

**8\. SSH Keys**

SSH public keys allow you to access your Notebook remotely. This section is optional, click the `Next` button.

![Create a Notebook Control Panel manager 09](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/creating-a-notebook-using-UI-09.png)
...
![Create a Notebook Control Panel manager 10](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/creating-a-notebook-using-UI-10.png)
...
![Create a Notebook Control Panel manager 11](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/creating-a-notebook-using-UI-11.png)
...
![Create a Notebook ovhai CLI](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/creating-a-notebook-using-ovhai-CLI.png)
...
![Create a Notebook API](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/creating-a-notebook-using-API-01.png)
...
![Create a Notebook API token authentication](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/creating-a-notebook-using-API-02.png)
...
![Create a Notebook API creation answer](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/creating-a-notebook-using-API-03.png)
...
![Accessing a Notebook Control Panel manager 1](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/accessing-a-notebook-using-UI-1.png)
...
![Accessing a Notebook Control Panel manager 2](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/accessing-a-notebook-using-UI-2.png)
...
![Access a Notebook ovhai CLI](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/accessing-a-notebook-using-ovhai-CLI.png)
...
![Access a Notebook API](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/accessing-a-notebook-using-API.png)
...
![Notebook Authentication Credentials](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/notebook-authentication-creds.png)
...
![Notebook Authentication Token](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/notebook-authentication-token.png)

</Tab>
</Tabs>


![Accessing a Notebook Control Panel manager 3](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/accessing-a-notebook-using-UI-3.png)
...
![Accessing a Notebook Control Panel manager 4](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/accessing-a-notebook-using-UI-4.png)
...
Go back to the `AI Notebooks` board, from the `Public Cloud` section of the [OVHcloud Control Panel](/links/manager).
...
![Stop a Notebook Control Panel manager](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/stopping-a-notebook-using-UI.png)
...
![Stop a Notebook API](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/stopping-a-notebook-using-API.png)
...
![Restart a Notebook Control Panel manager](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/restarting-a-notebook-using-UI.png)
...
Select the `Start a stopped notebook` endpoint, which is a PUT method. Provide the UUID of the Notebook you wish to restart as an input parameter. Then, click the `Send API request` button to send the request.
...
![Restart a Notebook API](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/restarting-a-notebook-using-API.png)
...
![Delete a Notebook Control Panel manager](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/deleting-a-notebook-using-UI.png)
...
![Delete a Notebook API](/images/guides/public-cloud/ai-machine-learning/notebook-guide-introduction-definition/deleting-a-notebook-using-API.png)
