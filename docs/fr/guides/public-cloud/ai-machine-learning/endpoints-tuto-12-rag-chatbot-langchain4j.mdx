...
Note that the chatbot will use the streaming mode, as explained in the [Memory Chatbot with LangChain4j](/guides/public-cloud/ai-machine-learning/endpoints-tuto-10-memory-chatbot-langchain4j/) tutorial.
