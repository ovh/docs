...
- [Analyse sentiments on Tweets](/guides/public-cloud/ai-machine-learning/notebook-tuto-05-hugging-face-sentiment-analysis/)

- [Create a Spam classifier](/guides/public-cloud/ai-machine-learning/notebook-tuto-09-spam-classifier/)

- [Discover speech to text powers and use them to generate video subtitles, meeting scripts and summaries](/guides/public-cloud/ai-machine-learning/notebook-tuto-08-speech-to-text/)
