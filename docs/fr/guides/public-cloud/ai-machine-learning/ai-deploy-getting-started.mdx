...
Log in to the [OVHcloud Control Panel](/links/manager), navigate to the `Public Cloud` section, select your desired Public Cloud project, then go to the `AI & Machine Learning` category in the left menu and choose `AI Deploy`.
...
![AI Deploy app subscribe](/images/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/ai_app_subscribe.png)
...
![AI Deploy app name](/images/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/step-1-name-app.png)
...
![AI Deploy app location](/images/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/step-2-select-location.png)
...
![AI Deploy app resources](/images/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/step-3-app-resources.png)
...
![AI Deploy app docker image](/images/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/step-4-app-image.png)
...
![AI Deploy app scaling strategies](/images/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/step-5-scaling-strategies.png)
...
![AI Deploy app port](/images/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/step-6-app-port.png)
...
![AI Deploy app confidentiality](/images/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/step-7-app-confidentiality.png)
...
![AI Deploy app volumes](/images/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/step-8-app-volumes.png)
...
![AI Deploy app labels](/images/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/step-8-app-labels.png)
...
![AI Deploy app details](/images/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/ai_app_details.png)
...
![AI Deploy token creation](/images/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/step-10-token-creation.png)
...
Then, select the `AI Deploy` section, which allows you to manage and access all your created apps.

Locate the specific AI Deploy app you want to stop. Click the `...` button and stop your AI Deploy application by selecting `Stop` from the context menu.

![image](/images/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/step-11-stop-app.png)
