...
![LiteLLM Blog Thumbnail](/images/guides/public-cloud/ai-machine-learning/endpoints-tuto-16-litellm-integration/hero.png)
...
3. An API key generated from the [OVHcloud Control Panel](/links/manager), in `Public Cloud` > `AI Endpoints` > `API keys`

![Generate an API key](/images/guides/public-cloud/ai-machine-learning/endpoints-tuto-16-litellm-integration/generate_an_api_key.png)
...
![Output of the code](/images/guides/public-cloud/ai-machine-learning/endpoints-tuto-16-litellm-integration/output_1.png)
...
![Output of the code](/images/guides/public-cloud/ai-machine-learning/endpoints-tuto-16-litellm-integration/output_2.png)
...
![Output of the code](/images/guides/public-cloud/ai-machine-learning/endpoints-tuto-16-litellm-integration/output_3.png)
...
| :--------------- |:---------------|
|  ![Reference Photo](/images/guides/public-cloud/ai-machine-learning/endpoints-tuto-16-litellm-integration/ovhcloud.jpg) |   ![Output of the code](/images/guides/public-cloud/ai-machine-learning/endpoints-tuto-16-litellm-integration/output_4.png)        |
...
![Output of the code](/images/guides/public-cloud/ai-machine-learning/endpoints-tuto-16-litellm-integration/output_5.png)
...
![Output of the code](/images/guides/public-cloud/ai-machine-learning/endpoints-tuto-16-litellm-integration/output_6.png)
...
![Output of the code](/images/guides/public-cloud/ai-machine-learning/endpoints-tuto-16-litellm-integration/output_7.png)
...
![Output of the code](/images/guides/public-cloud/ai-machine-learning/endpoints-tuto-16-litellm-integration/output_8.png)
...
![AI Endpoints Catalog](/images/guides/public-cloud/ai-machine-learning/endpoints-tuto-16-litellm-integration/output_9.png)
