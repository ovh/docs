...
![Overview](/images/guides/public-cloud/ai-machine-learning/deploy-tuto-14-img-segmentation-app/img_seg_app_overview.png)
...
You can upload your data to the cloud either by using the [OVHcloud Control Panel (UI)](/links/manager) or with the [OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client).

#### Upload data via UI (Control Panel)

If you do not feel comfortable with commands, this method will be more intuitive.

First, log in to the [OVHcloud Control Panel](/links/manager) and access the `Public Cloud` section.
