...
If you want to upload it from the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), go to the Object Storage section and [create a new object container](/guides/storage-and-backup/object-storage/pcs-create-container/) by clicking `Object Storage` > `Create an object container`.
...
:::info
Here we will use the [ovhai CLI](/guides/public-cloud/ai-machine-learning/cli-12-howto-run-job-cli/). If you wish to do this from the OVHcloud Control Panel, refer to this [documentation](/guides/public-cloud/ai-machine-learning/training-guide-02-howto-submit-job/).
...
:::info
To find out more about how jobs work and their status, check this [documentation](/guides/public-cloud/ai-machine-learning/training-guide-03-concepts-jobs/).
...
- To build an app to classify audios, refer to this [tutorial](/guides/public-cloud/ai-machine-learning/deploy-tuto-03-streamlit-sounds-classification/).
- Do you want to know how to build and use custom Docker image with AI Training? [Here it is](/guides/public-cloud/ai-machine-learning/training-tuto-02-build-custom-image/).
