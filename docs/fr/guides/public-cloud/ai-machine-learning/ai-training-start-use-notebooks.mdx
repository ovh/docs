...
-   **autogluon** : An OVHcloud preset image containing JupyterLab notebook, Visual Studio Code IDE and `AutoGluon` + `mxnet` libraries
    ![image](/images/guides/public-cloud/ai-machine-learning/training-guide-06-howto-notebooks/01_submit_image.png)
...
![image](/images/guides/public-cloud/ai-machine-learning/training-guide-06-howto-notebooks/02_http_access_url.png)
...
![image](/images/guides/public-cloud/ai-machine-learning/training-guide-06-howto-notebooks/03_login_form.png)
...
![image](/images/guides/public-cloud/ai-machine-learning/training-guide-06-howto-notebooks/04_jupyter_vs_vscode.png)

Just select the one that you want to use, and you will be redirected to the corresponding one.

![image](/images/guides/public-cloud/ai-machine-learning/training-guide-06-howto-notebooks/05_jupyter.png)
...
>
> ![image](/images/guides/public-cloud/ai-machine-learning/training-guide-06-howto-notebooks/09_nvidia_smi.png)
...
![image](/images/guides/public-cloud/ai-machine-learning/training-guide-06-howto-notebooks/06_stop_notebook.png)

Then `confirm` your choice.

![image](/images/guides/public-cloud/ai-machine-learning/training-guide-06-howto-notebooks/07_confirm_stop.png)

After some time your job should go into an `Interrupted` state meaning that the job has been stopped.

![image](/images/guides/public-cloud/ai-machine-learning/training-guide-06-howto-notebooks/08_interrupted.png)
