...
- A [user for AI Notebooks](/guides/public-cloud/ai-machine-learning/gi-01-manage-users/)
...
Here is the reference to install the CLI: [CLI Installation](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/).

The token is now created. Don't forget to save the token to use it later.

Now, if you already have trained some Rasa models with AI Training by following [our tutorial](/guides/public-cloud/ai-machine-learning/training-tuto-07-train-rasa-chatbot/), you already have created a container with your trained models. You can skip the next part and go directly [here](#visualstudiocode).
...
[How to train a chatbot with docker and AI Training](/guides/public-cloud/ai-machine-learning/training-tuto-07-train-rasa-chatbot/)
