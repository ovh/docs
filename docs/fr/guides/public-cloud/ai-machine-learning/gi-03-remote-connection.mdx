...
Here is how to add your SSH key to your AI Solution if you are using the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) or the `ovhai` CLI:
