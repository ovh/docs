...
![image](/images/guides/public-cloud/ai-machine-learning/notebook-tuto-09-spam-classifier/spam-classifier.png)
...
You can launch your notebook from the [OVHcloud Control Panel](/links/manager) or via the ovhai [CLI](/guides/public-cloud/ai-machine-learning/ai-cli-run-notebook).
