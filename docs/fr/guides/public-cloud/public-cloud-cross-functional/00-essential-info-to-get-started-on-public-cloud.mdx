...
- [Créer sa première instance](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)
...
|Documentation|Détails|
|---|---|
|[Créer sa première instance](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)|Premier guide pratique pour démarrer un serveur cloud depuis l'espace client OVHcloud.|
...
|[Configuration du réseau privé](/guides/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/)|Chez OVHcloud, les réseaux privés sont portés par la technologie vRack. Ce guide vous accompagne dans cette mise en place.|
...
|[Créer un cluster Kubernetes](/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/) (EN)|Ce guide vous accompagne pas à pas dans la création de votre premier cluster Kubernetes.|
|[Configurer une Additional IP](/guides/public-cloud/public-cloud-network-services/getting-started-04-configure-additional-ip-to-instance/)|Les Additional IP peuvent vous permettre de basculer le trafic d'une instance à une autre, ce guide vous expliquera comment configurer cela.|
...
|[Installation de la CLI OpenStack](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/)|OpenStack peut également être utilisé en ligne de commande, voici comment installer les outils.|
