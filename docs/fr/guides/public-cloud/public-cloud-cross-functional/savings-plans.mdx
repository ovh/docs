...
<img className="thumbnail" alt="Facturation d'un Savings Plan pour des instances" src="/images/public-cloud/public-cloud-cross-functional/savings-plans/billings_savings_plan_instances_svp.png" loading="lazy" />
...
<img className="thumbnail" alt="Facturation pour des instances à l'heure" src="/images/public-cloud/public-cloud-cross-functional/savings-plans/billings_savings_plan_instances_hours.png" loading="lazy" />
...
<img className="thumbnail" alt="Facturation d'un Savings Plan pour des VCPu" src="/images/public-cloud/public-cloud-cross-functional/savings-plans/billings_savings_plan_rancher_svp.png" loading="lazy" />
...
<img className="thumbnail" alt="Facturation pour des VCPu à l'heure." src="/images/public-cloud/public-cloud-cross-functional/savings-plans/billings_savings_plan_rancher_hours.png" loading="lazy" />
