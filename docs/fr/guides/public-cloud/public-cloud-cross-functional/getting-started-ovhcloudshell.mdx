...
<img className="thumbnail" alt="Bouton Cloudshell" src="/images/public-cloud/public-cloud-cross-functional/getting-started-ovhcloudshell/OVHcloud_Shell.png" loading="lazy" />
