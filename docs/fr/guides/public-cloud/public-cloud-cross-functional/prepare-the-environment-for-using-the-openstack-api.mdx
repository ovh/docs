...
<img className="thumbnail" alt="Installation automatique" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/1_preparation_openstack_environment_windows.png" loading="lazy" />
...
<img className="thumbnail" alt="Paramètres des variables d’environnement " src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/2_preparation_openstack_environment_windows.png" loading="lazy" />
...
<img className="thumbnail" alt="Paramètres de performance" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/3_preparation_openstack_environment_windows.png" loading="lazy" />
...
<img className="thumbnail" alt="Ajout du chemin d'accès" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/4_edit_system_variables.png" loading="lazy" />
...
<img className="thumbnail" alt="Installation automatique" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/5_preparation_openstack_environment_windows.png" loading="lazy" />
...
<img className="thumbnail" alt="Vérification" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/6_preparation_openstack_environment_windows.png" loading="lazy" />
