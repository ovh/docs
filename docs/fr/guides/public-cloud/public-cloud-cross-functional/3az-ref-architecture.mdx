...
<img className="thumbnail" alt="2-az with local storage" src="/images/public-cloud/public-cloud-cross-functional/3az-ref-architecture/2az-with-local-storage.png" loading="lazy" />
