...
- **Comment l'activer** : Connectez-vous à l'[espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), cliquez sur votre nom en haut à droite puis sur vos initiales. Accédez à l'onglet <code className="action">Sécurité</code>, et suivez les étapes pour configurer la 2FA via une application mobile ou une clé de sécurité. Assurez-vous de stocker vos codes de secours en toute sécurité. Pour plus de détails, référez-vous au [guide sur la 2FA](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa/).
...
<img className="thumbnail" alt="Ajouter des groupes d'utilisateurs" src="/images/public-cloud/public-cloud-cross-functional/securing-and-structuring-projects/Add_user_groups.png" loading="lazy" />
...
<img className="thumbnail" alt="Ajouter types de produits & ressources" src="/images/public-cloud/public-cloud-cross-functional/securing-and-structuring-projects/Product_types_resources.png" loading="lazy" />
