...
- [Avoir configuré les variables d'environnement OpenStack](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/).
- Être familier de [Terraform](/guides/public-cloud/public-cloud-cross-functional/how-to-use-terraform/), si vous avez l'intention de l'utiliser.
...
<img className="thumbnail" alt="Landing zone architecture diagram" src="/images/public-cloud/public-cloud-cross-functional/landing-zone-migration/landing_zone_architecture.png" loading="lazy" />
...
Suivez [ce guide](/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/) pour configurer une gateway.
...
Utilisez les adresses Floating IP pour exposer en toute sécurité certaines ressources privées (par exemple, des instances, des services) à l'Internet public. Suivez [ce guide](/guides/public-cloud/public-cloud-network-services/getting-started-03-attach-floating-ip-to-instance/) pour associer une adresse Floating IP.
...
Suivez [ce guide](/guides/public-cloud/public-cloud-network-services/getting-started-01-create-lb-service/) pour configurer et utiliser un Load Balancer.
...
Suivez [ce guide](/guides/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/) pour configurer et utiliser un pare-feu Stormshield.
...
Suivez [ce guide](/guides/public-cloud/public-cloud-network-services/tutorial-ubika-vrack/) pour déployer une protection WAAP avec Ubika.
...
Consultez la [documentation associée](/guides/public-cloud/public-cloud-cross-functional/securing-and-structuring-projects/).
...
Utilisez les tags, les rôles IAM et les alertes pour associer les coûts aux équipes, aux environnements ou aux services. Pour plus d'informations, consultez [cette documentation](/guides/public-cloud/public-cloud-cross-functional/analyze-billing/).
