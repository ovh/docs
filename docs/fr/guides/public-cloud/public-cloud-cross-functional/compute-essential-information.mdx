...
- [Créer sa première instance](/guides/public-cloud/compute/compute-getting-started)
- [Gérer ses quotas](/guides/public-cloud/public-cloud-cross-functional/increasing-public-cloud-quota)

## Approche globale <a id="global-approach"></a>
...
![Public Cloud Ecosystem](/images/guides/public-cloud/public-cloud-cross-functional/00-essential-info-to-get-started-on-public-cloud/ecosystem.png)
...
![Public Cloud geolocation](/images/guides/public-cloud/public-cloud-cross-functional/00-essential-info-to-get-started-on-public-cloud/geolocation.png)
...
## Approche concrète <a id="concrete-approach"></a>
...
Vous devrez ensuite [créer un projet Public Cloud](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project). Un projet est un environnement que vous allez dédier à un contexte.
...
Votre moyen de payement étant enregistré, il servira à débiter le montant calculé pour votre [facturation en fin de mois](/guides/public-cloud/public-cloud-cross-functional/analyze-billing). Ce calcul est fait sur la base du temps d'utilisation de chaque ressource, en fonction du prix des ressources.
...
<br />Ces quotas sont attribués par localisation (région au sens OpenStack). Il se peut donc que vous atteigniez le maximum de ressources possibles sur votre projet et qu'il faille [augmenter ces quotas](/guides/public-cloud/public-cloud-cross-functional/increasing-public-cloud-quota).

![Public Cloud quota](/images/guides/public-cloud/public-cloud-cross-functional/00-essential-info-to-get-started-on-public-cloud/quota.png)
...
- Si vous souhaitez utiliser les APIs OpenStack ou Amazon S3, ou l'interface Horizon, vous aurez à [créer des utilisateurs](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user) pour cela. Les utilisateurs peuvent éventuellement avoir des droits limités afin de sécuriser les périmètres d'action.
- Si vous n'avez pas besoin d'accéder aux APIs ou à Horizon, vous pouvez [associer un autre compte client OVHcloud](/guides/public-cloud/public-cloud-cross-functional/delegate-projects) en complément sur votre projet.
...
|---|---|
|[FAQ](/guides/public-cloud/public-cloud-cross-functional/faq-pci)|Les questions les plus fréquentes au sujet de Public Cloud.|
|[Lexique](/guides/public-cloud/public-cloud-cross-functional/introduction-about-instances)|Les concepts et définitions dont vous aurez besoin pour avancer.|
...
|Documentation|Détails|
|---|---|
|[Créer sa première instance](/guides/public-cloud/compute/compute-getting-started)|Premier guide pratique pour démarrer un serveur cloud depuis l'espace client OVHcloud.|
|[Utilisation d'une clé SSH](/guides/public-cloud/compute/compute-creating-ssh-keys)| Pour vous connecter à une instance Linux, vous aurez besoin de passer par une connexion SSH, ce guide vous en détaille l'utilisation.|
|[Configuration du réseau privé](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack)|Chez OVHcloud, les réseaux privés sont portés par la technologie vRack. Ce guide vous accompagne dans cette mise en place.|
...
|[Accéder à l'interface Horizon](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon)|L'interface Horizon d'OpenStack permet certaines actions avancées, voici comment vous y connecter.|
...
|[Configurer une Additional IP](/guides/public-cloud/public-cloud-network-services/configure-additional-ip)|Les Additional IP peuvent vous permettre de basculer le trafic d'une instance à une autre, ce guide vous expliquera comment configurer cela.|
|[Utilisation de l'interface Horizon](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon)|Horizon est l'interface classique d'OpenStack, ce guide vous expliquera comment y accéder.|
|[Installation de la CLI OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment)|OpenStack peut également être utilisé en ligne de commande, voici comment installer les outils.|
