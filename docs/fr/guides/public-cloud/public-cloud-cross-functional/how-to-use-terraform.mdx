...
* [Configurer un accès utilisateur à Horizon](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon/)
...
Il faut maintenant [créer un nouvel utilisateur OpenStack](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/), puis [générer le fichier OpenRC ](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables#etape-1-recuperer-les-variables/) contenant tous les identifiants que vous souhaitez exporter en tant qu'environnement variables.
...
1. [Créer manuellement un projet Public Cloud depuis l'espace client OVHcloud](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project/).
