...
Quantum Notebooks is compliant with the OVHcloud AI CLI. Discover how to [install the OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/).
...
You are also able to check it from the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) in your notebook's general information by clicking the <code className="action">Go to Graph Dashboard</code> button.
