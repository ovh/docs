...
description: Découvrez les possibilités de votre espace client Managed Bare Metal
...
Une fois dans la partie <code className="action">Bare Metal Cloud</code> puis <code className="action">Managed Bare Metal</code> de votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), vous aurez accès à un aperçu général de votre Managed Bare Metal :

<img className="thumbnail" alt="Informations générales" src="/images/bare-metal-cloud/managed-bare-metal/manager-ovhcloud/controlpanel1-e.png" loading="lazy" />
...
<img className="thumbnail" alt="Informations générales" src="/images/bare-metal-cloud/managed-bare-metal/manager-ovhcloud/controlpanel2-e.png" loading="lazy" />
...
Le prochain renouvellement de votre service Managed Bare Metal y est également mentionné. À droite de cette date, le bouton <code className="action">...</code> vous permet de commander une licence ou de supprimer votre service Managed Bare Metal.
...
Pour plus de détails sur la résiliation d'un service Managed Bare Metal, consultez notre guide [Comment résilier le Managed Bare Metal](/guides/bare-metal-cloud/managed-bare-metal/how-to-cancel/).
...
<img className="thumbnail" alt="Utilisateurs" src="/images/bare-metal-cloud/managed-bare-metal/manager-ovhcloud/controlpanel6-e.png" loading="lazy" />

Vous pouvez créer un utilisateur en cliquant sur le bouton <code className="action">Créer un utilisateur</code> à gauche.
...
En cliquant sur le bouton <code className="action">...</code> à droite du tableau, plusieurs choix se présentent à vous :
...
- <code className="action">Accès vSphere</code> - il s'agit des droits globaux de l'utilisateur sur le vSphere :
...
- <code className="action">Accès au VM Network</code> - il s'agit de la gestion des droits sur la partie réseau public (appelée `VM Network` dans l'interface vSphere) :
...
- <code className="action">Ajout de ressources</code> - ce bouton permet d'accorder ou non le droit d'ajouter des ressources supplémentaires via le plugin OVH dans le vSphere client.
...
Il est possible de modifier ou de supprimer l'IP ou la plage en cliquant sur le bouton <code className="action">...</code> présent sur la droite de ce tableau.
...
Vous pourrez trouver plus de détails sur cette option dans [ce guide](/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/).

#### Opérations

Dans cet onglet, vous trouverez les opérations en cours sur votre infrastructure :

<img className="thumbnail" alt="Opérations" src="/images/bare-metal-cloud/managed-bare-metal/manager-ovhcloud/controlpanel9-e.png" loading="lazy" />

Vous pouvez vérifier si une opération est en erreur, si une maintenance est planifiée...

Vous pouvez modifier la date d'une maintenance en cliquant sur le bouton <code className="action">...</code> présent à droite de ce tableau.
...
L'onglet <code className="action">Licence Windows</code> permet d'activer les licences SPLA Windows sur votre Managed Bare Metal en cliquant sur le bouton situé à droite :
...
Pour plus d'informations sur cette option, vous pouvez consulter ce [guide](/guides/bare-metal-cloud/managed-bare-metal/veeam-backup-as-a-service/).
