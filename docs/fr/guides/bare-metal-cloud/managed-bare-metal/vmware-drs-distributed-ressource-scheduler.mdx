...
description: Maitriser la répartition de charge avec la fonction DRS
...
<img className="thumbnail" alt="Principe du DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs0.png" loading="lazy" />
...
<img className="thumbnail" alt="Activation du DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs01.png" loading="lazy" />
...
<img className="thumbnail" alt="automatisation DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs02.png" loading="lazy" />
...
<img className="thumbnail" alt="options supplémentaires DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs03.png" loading="lazy" />
...
<img className="thumbnail" alt="options avancées drs" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs05.png" loading="lazy" />

### Les règles DRS

Dans l'onglet `Configurer` vous trouverez la gestion des règles de VM/hôte.

<img className="thumbnail" alt="règles drs" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs06.png" loading="lazy" />
...
La quatrième règle, 'Machines virtuelles à machines virtuelles' est expliqué dans notre guide sur la [fonction HA](/guides/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/).

<img className="thumbnail" alt="création règles drs" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs07.png" loading="lazy" />
