...
Toutes les modifications décrites ci-dessous doivent être réalisées depuis votre Managed Bare Metal sur vSphere en effectuant un clic droit sur une machine virtuelle, puis en cliquant sur `Modifier les paramètres`.

![Édition des ressources](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware01.png)

Dans ce menu, vous avez la possibilité d'augmenter les ressources de votre machine virtuelle. 

![Édition des ressources](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware02.png)
...
![Ajout de CPU](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware03.png)
...
Si vous cochez la case `Connexion CPU à chaud`, vous pourrez modifier ces valeurs lorsque la machine virtuelle sera démarrée.
...
![Ajout de mémoire](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware04.png)
...
![Ajout de stockage](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware05.png)
...
![Ajout du réseau](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware06.png)

Cette interface est intéressante en cas de dysfonctionnement réseau. Vous pouvez vous assurer que le *port ID* correspond à celui renseigné dans l'onglet `Networking` et `Ports` dans la carte en question.

### Le lecteur CD/DVD

Le Lecteur CD/DVD permet par exemple le montage d'image ISO sur votre machine virtuelle.

![Ajout d'un lecteur CD / DVD](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware07.png)
...
![Ajout de périphériques](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware08.png)
