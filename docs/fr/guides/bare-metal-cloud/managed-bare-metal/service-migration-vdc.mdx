...
description: "Découvrez comment gérer tous les aspects de la migration d'une infrastructure vers un vDC"
...
Consultez à cet effet nos guides pour [changer les droits d'un utilisateur](/guides/bare-metal-cloud/managed-bare-metal/change-user-rights/), [modifier le mot de passe d'un utilisateur](/guides/bare-metal-cloud/managed-bare-metal/changer-user-password/) et [associer un e-mail à un utilisateur](/guides/bare-metal-cloud/managed-bare-metal/vsphere-edit-user/).
...
Consultez donc notre guide sur l'[activation du chiffrement des machines virtuelles](/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/) afin d'activer le KMS sur le vDC de destination.
...
Vous pouvez, dans le cadre d'une migration, lier vos services Managed Bare Metal au sein du même vRack. Consultez notre guide sur [l'utilisation du Private Cloud au sein d'un vRack](/guides/bare-metal-cloud/managed-bare-metal/using-vrack/).
...
La migration implique de refaire la configuration du VMware High Availability (HA), notamment l'ordre et la priorité de boot. Consultez [notre guide sur sa configuration](/guides/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/).
...
Consultez notre guide pour [activer et utiliser Veeam Backup Managed](/guides/bare-metal-cloud/managed-bare-metal/veeam-backup-as-a-service/).
