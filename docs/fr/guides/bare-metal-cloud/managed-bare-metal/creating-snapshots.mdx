...
Faites un clic droit sur votre VM puis choisissez <code className="action">Snapshots</code> et enfin <code className="action">Prendre un snapshot...</code> :

<img className="thumbnail" alt="creer snapshot" src="/images/bare-metal-cloud/managed-bare-metal/creating-snapshots/snapshot01.png" loading="lazy" />
...
<img className="thumbnail" alt="configurer snapshot" src="/images/bare-metal-cloud/managed-bare-metal/creating-snapshots/snapshot02.png" loading="lazy" />

### Gestion des snapshots

Vous pouvez retrouver l’ensemble des snapshots d’une VM dans le gestionnaire des snapshots. Pour cela, faites un clic droit sur la VM puis choisissez <code className="action">Snapshots</code> et enfin <code className="action">Gérer les snapshots</code> :

<img className="thumbnail" alt="gerer snapshots" src="/images/bare-metal-cloud/managed-bare-metal/creating-snapshots/snapshot03.png" loading="lazy" />

### Supprimer un snapshot

Dans le gestionnaire des snapshots, sélectionnez le snapshot à supprimer et cliquez sur <code className="action">Supprimer</code>.

Il est possible de supprimer tous les snapshots de la VM en une seule opération en cliquant sur <code className="action">Supprimer tout</code>.

### Restaurer un snapshot

Dans le gestionnaire des snapshots, sélectionnez le snapshot à restaurer et cliquez sur <code className="action">Restaurer</code>
...
Pour effectuer une consolidation, faites un clic droit sur la VM puis choisissez <code className="action">Snapshots</code> et enfin <code className="action">Consolider</code>
