...
- [Avoir activé les licences Windows](/guides/bare-metal-cloud/managed-bare-metal/manager-ovhcloud#licence-windows/) depuis votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr)

## En pratique

### Récupérer l'URL du template OVF

Depuis un navigateur internet, rendez-vous sur la page d'accueil de votre Managed Bare Metal puis cliquez sur <code className="action">OVH Template</code>.

<img className="thumbnail" alt="Nom de photo" src="/images/bare-metal-cloud/managed-bare-metal/ovf-template/gatewayssl.png" loading="lazy" />
...
<img className="thumbnail" alt="Nom de photo" src="/images/bare-metal-cloud/managed-bare-metal/ovf-template/copylink.png" loading="lazy" />
...
<img className="thumbnail" alt="Nom de photo" src="/images/bare-metal-cloud/managed-bare-metal/ovf-template/01selectdeploy.png" loading="lazy" />
...
<img className="thumbnail" alt="Nom de photo" src="/images/bare-metal-cloud/managed-bare-metal/ovf-template/02puturl.png" loading="lazy" />

L'étape suivante vous permet de choisir le datacenter :

<img className="thumbnail" alt="Nom de photo" src="/images/bare-metal-cloud/managed-bare-metal/ovf-template/03selectdatacenter.png" loading="lazy" />

Choisissez ensuite le cluster dans lequel la machine virtuelle va être déployée :

<img className="thumbnail" alt="Nom de photo" src="/images/bare-metal-cloud/managed-bare-metal/ovf-template/04selectcluster.png" loading="lazy" />
...
<img className="thumbnail" alt="Nom de photo" src="/images/bare-metal-cloud/managed-bare-metal/ovf-template/05detailstemplate.png" loading="lazy" />

Choisissez le datastore dans lequel la machine virtuelle va être stockée ainsi que le format du disque :

<img className="thumbnail" alt="Nom de photo" src="/images/bare-metal-cloud/managed-bare-metal/ovf-template/06selectdatastore.png" loading="lazy" />

Vous devez maintenant choisir le réseau qui sera utilisé.

<img className="thumbnail" alt="Nom de photo" src="/images/bare-metal-cloud/managed-bare-metal/ovf-template/07selectnetwork.png" loading="lazy" />

La configuration est quasiment terminée, vous avez accès à un résumé de la configuration souhaitée :

<img className="thumbnail" alt="Nom de photo" src="/images/bare-metal-cloud/managed-bare-metal/ovf-template/08resume.png" loading="lazy" />

Après avoir cliqué sur <code className="action">Terminer</code>, une tâche est créée et vous permet de suivre le déploiement :

<img className="thumbnail" alt="Nom de photo" src="/images/bare-metal-cloud/managed-bare-metal/ovf-template/09startdeploy.png" loading="lazy" />
...
<img className="thumbnail" alt="Nom de photo" src="/images/bare-metal-cloud/managed-bare-metal/ovf-template/10inventory.png" loading="lazy" />
...
<img className="thumbnail" alt="Nom de photo" src="/images/bare-metal-cloud/managed-bare-metal/ovf-template/sqlinformations.png" loading="lazy" />
