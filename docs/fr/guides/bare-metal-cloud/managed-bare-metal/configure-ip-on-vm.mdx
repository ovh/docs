...
<Tabs>
  <Tab label="IPv4">
    ...
    <img className="thumbnail" alt="Configuration sur l'OVHcloud Network" src="/images/bare-metal-cloud/managed-bare-metal/configure-ip-on-vm/01config_ip_ovh_network.png" loading="lazy" />
...
Sur chaque bloc livré par OVHcloud, 5 adresses IP sont réservées à la configuration du réseau et ne doivent jamais être utilisées pour vos machines virtuelles. Il s'agit de la première et des quatre dernières IP du bloc.
    ...
    <img className="thumbnail" alt="Configuration avancée sur l'OVH Network" src="/images/bare-metal-cloud/managed-bare-metal/configure-ip-on-vm/02config_ip_ovh_network_advanced.png" loading="lazy" />
  </Tab>
  <Tab label="IPv6">
    :::warning
...
<Tabs>
  <Tab label="IPv4 Linux">
    ...
    <img className="thumbnail" alt="Interface IP" src="/images/bare-metal-cloud/managed-bare-metal/configure-ip-on-vm/config_ip_interfaces.png" loading="lazy" />
...
```sh
  ...
  <Tab label="IPv4 Windows">
    ...
    <img className="thumbnail" alt="Configuration Windows" src="/images/bare-metal-cloud/managed-bare-metal/configure-ip-on-vm/config_ip_windows.png" loading="lazy" />
...
```sh
  ...
  <Tab label="IPv6 Linux">
    ...
    <img className="thumbnail" alt="Interface IPv6" src="/images/bare-metal-cloud/managed-bare-metal/configure-ip-on-vm/config_ip_interfaces_v6.png" loading="lazy" />
...
```sh
  ...
  <Tab label="IPv6 Windows">
    ...
    <img className="thumbnail" alt="Configuration Windows IPv6" src="/images/bare-metal-cloud/managed-bare-metal/configure-ip-on-vm/config_ip_windows_v6.png" loading="lazy" />
...
<img className="thumbnail" alt="VLAN" src="/images/bare-metal-cloud/managed-bare-metal/configure-ip-on-vm/04vlanBis.png" loading="lazy" />

<img className="thumbnail" alt="VLAN" src="/images/bare-metal-cloud/managed-bare-metal/configure-ip-on-vm/05vlan.png" loading="lazy" />

<img className="thumbnail" alt="VxLAN" src="/images/bare-metal-cloud/managed-bare-metal/configure-ip-on-vm/06vxlan.png" loading="lazy" />

#### Linux

Voici un exemple de configuration sur la distribution Debian :

<img className="thumbnail" alt="IP privée sur Linux" src="/images/bare-metal-cloud/managed-bare-metal/configure-ip-on-vm/linux_private.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Configuration Windows IP publique" src="/images/bare-metal-cloud/managed-bare-metal/configure-ip-on-vm/windows_private.PNG" loading="lazy" />
