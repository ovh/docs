...
<img className="thumbnail" alt="schéma HA" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HA3.png" loading="lazy" />
...
<img className="thumbnail" alt="activation HA" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HA.png" loading="lazy" />
...
<img className="thumbnail" alt="panne de l'hôte" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam1.PNG" loading="lazy" />
...
<img className="thumbnail" alt="isolation d'hôte" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam2.PNG" loading="lazy" />
...
<img className="thumbnail" alt="banque de données avec PDL" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam3.PNG" loading="lazy" />
...
<img className="thumbnail" alt="banque de données avec APD" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam4.PNG" loading="lazy" />

##### Surveillance de VM

La surveillance des machines virtuelles est disponible suite à l'installation des [VMware tools](/guides/bare-metal-cloud/managed-bare-metal/vmware-tools-install/). 
...
<img className="thumbnail" alt="Surveillande de VM" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam5.PNG" loading="lazy" />
