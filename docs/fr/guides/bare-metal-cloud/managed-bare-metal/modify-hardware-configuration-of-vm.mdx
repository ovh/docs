...
Toutes les modifications décrites ci-dessous doivent être réalisées depuis votre Managed Bare Metal sur vSphere en effectuant un clic droit sur une machine virtuelle, puis en cliquant sur <code className="action">Modifier les paramètres</code>.
