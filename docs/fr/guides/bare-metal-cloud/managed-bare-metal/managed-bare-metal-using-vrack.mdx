...
![Datacenter](/images/guides/bare-metal-cloud/managed-bare-metal/using-vrack/images/vRackDatacenter.PNG)

Il est possible de déplacer le *datacenter* de votre infrastructure Managed Bare Metal dans un autre vRack en cliquant sur le bouton `Déplacer`
