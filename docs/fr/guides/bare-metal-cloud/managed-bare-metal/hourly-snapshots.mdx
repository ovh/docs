...
Nous vous recommandons l'utilisation d'une solution complète de sauvegarde comme notre service [Veeam Backup](/guides/bare-metal-cloud/managed-bare-metal/veeam-backup-as-a-service/) ou tout autre système réalisant un backup complet de vos machines virtuelles.
