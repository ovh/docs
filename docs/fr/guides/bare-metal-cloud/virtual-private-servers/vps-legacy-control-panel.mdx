...
Connectez-vous à votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), ouvrez l'onglet <code className="action">Bare Metal Cloud</code> et sélectionnez votre serveur parmi les <code className="action">Serveur privés virtuels</code>.
...
- la langue ;
- une [clé SSH](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys-dedicated/) (facultatif)
...
Lors de la réinstallation de votre VPS, un e-mail contenant votre mot de passe root vous sera envoyé pour vous connecter à votre VPS en [SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction/), sauf si vous avez sélectionné une [clé SSH](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys-dedicated/) à préinstaller.
...
[Création et utilisation de clés SSH](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys-dedicated/)
