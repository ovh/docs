...
- Si le nom de domaine est géré par OVHcloud en tant que registrar **et** qu'il utilise les serveurs DNS d'OVHcloud, ajoutez l'enregistrement TXT dans la section <code className="action">Web Cloud</code> de votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr). Suivez alors les instructions décrites dans notre guide « [Editer sa zone DNS](/guides/web-cloud/domains/dns-zone-edit/) » si ce processus ne vous est pas familier.
