...
- Disposer d’une offre [VPS](https://www.ovhcloud.com/fr/vps/) ou d’un [Serveur Dédié](https://www.ovhcloud.com/fr/bare-metal/) dans votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) avec une [configuration recommandée pour ISPmanager](https://www.ispmanager.com/docs/ispmanager/system-requirements).
