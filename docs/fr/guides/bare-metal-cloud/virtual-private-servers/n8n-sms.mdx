...
- Disposer d'un [compte SMS OVHcloud](https://www.ovhcloud.com/fr/sms/) et d'un [expéditeur SMS](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-expediteurs-sms/) valide.
...
- [L'expéditeur doit être défini dans votre compte OVHcloud](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-expediteurs-sms/). Pour réaliser un test sans déclarer d'expéditeur et utiliser un numéro court, remplacez `"sender": "Your_sender"` par `"senderForResponse": true`.
