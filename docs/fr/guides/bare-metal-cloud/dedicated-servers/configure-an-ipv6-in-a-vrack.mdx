...
<img className="thumbnail" alt="page de configuration" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/500.png" loading="lazy" />
...
<img className="thumbnail" alt="Configurer une IPv6 dans un vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/20240418-03.png" loading="lazy" />
...
- Connectez-vous à [l'espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr).
