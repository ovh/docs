...
Pour configurer le chemin du *reverse* DNS dans [l'espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) veuillez vous référer à [notre guide dédié](/guides/bare-metal-cloud/virtual-private-servers/configuring-reverse-dns/).
