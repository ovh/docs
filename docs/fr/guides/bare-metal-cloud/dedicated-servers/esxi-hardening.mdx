...
description: Découvrez les différents moyens vous permettant de sécuriser efficacement votre serveur dédié ESXi
...
<img className="thumbnail" alt="Edge_Network_Firewall" src="/images/bare-metal-cloud/dedicated-servers/esxi-hardening/firewall_network_1.png" loading="lazy" />
...
<img className="thumbnail" alt="Edge_Network_Firewall" src="/images/bare-metal-cloud/dedicated-servers/esxi-hardening/firewall_network_2.png" loading="lazy" />
