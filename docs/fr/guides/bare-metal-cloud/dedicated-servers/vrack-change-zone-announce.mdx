...
Cette API permet de récupérer la liste des services vRack. Si vous n'arrivez pas à identifier le service concerné grâce à ces références, aidez-vous de votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) pour le récupérer. Pour cela, positionnez-vous dans la partie <code className="action">Bare Metal Cloud</code>, puis <code className="action">Network</code> et ensuite « vRack ».
