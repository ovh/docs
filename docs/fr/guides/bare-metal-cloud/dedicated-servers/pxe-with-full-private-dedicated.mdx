...
La seule différence majeure notable est que les [réseaux privés](/guides/network/ovhcloud-connect/occ-concepts-overview#prive/) n'ont donc pas accès à tout ce qui n'appartient pas à votre infrastructure.<br/>
