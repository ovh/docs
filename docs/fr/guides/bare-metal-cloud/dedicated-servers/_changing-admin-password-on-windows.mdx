...
Dans l'[espace client OVHcloud](/links/manager), accédez à l'onglet `IPMI` pour ouvrir une session KVM.
...
[Utilisation de l'IPMI pour les serveurs dédiés](/guides/bare-metal-cloud/dedicated-servers/dedicated-servers-ipmi)
