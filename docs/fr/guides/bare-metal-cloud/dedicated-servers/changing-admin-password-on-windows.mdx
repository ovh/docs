...
Commencez par remplacer le netboot par **Booter sur le disque dur** dans l'[espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) (voir [Etape 1](#etape-1-redemarrer-le-serveur-en-mode-rescue)). 
...
Dans l'[espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), accédez à l'onglet <code className="action">IPMI</code> pour ouvrir une session KVM.
...
[Utilisation de l'IPMI pour les serveurs dédiés](/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/)
