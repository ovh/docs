...
Pour plus d'informations sur l'accès à cet outil, veuillez consulter [ce guide](/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/).  
