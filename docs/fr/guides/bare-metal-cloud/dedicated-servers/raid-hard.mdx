...
description: "Apprenez à vérifier l'état de votre RAID matériel et de vos disques durs"
...
<iframe className="video" width="560" height="315" src="https://www.youtube.com/embed/t_BL_uOXQVA" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen={true}></iframe>
