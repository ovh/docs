...
description: "Découvrez comment migrer les données d'un serveur dédié vers un autre"
...
- La plus simple est d'utiliser un logiciel adapté tel que [SFTP](/guides/bare-metal-cloud/dedicated-servers/comment-deposer-ou-recuperer-des-donnees-sur-un-serveur-dedie-via-sftp/).
...
Pour plus d'informations, consultez notre documentation sur les [domaines et DNS](/guides/web-cloud/domains/overview/).
