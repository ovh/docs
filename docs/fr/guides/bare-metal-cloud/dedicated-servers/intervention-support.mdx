...
- La nouvelle adresse MAC (visible dans l'onglet <code className="action">Interfaces réseau</code> de l'[espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) ou dans le retour de la commande `ip link`).
...
1\. Connectez-vous en tant qu'administrateur à partir de l'interface [IPMI/KVM](/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/).<br/>
