...
Les [serveurs dédiés](https://www.ovhcloud.com/fr/bare-metal/) OVHcloud vous permettent de configurer les disques, le [RAID matériel](/guides/bare-metal-cloud/dedicated-servers/raid-hard/), le [RAID logiciel](/guides/bare-metal-cloud/dedicated-servers/raid-soft/), LVM, ZFS, etc. pendant [la réinstallation](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server/) de votre système d'exploitation depuis l’[API OVHcloud](https://eu.api.ovh.com/) ou depuis votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr). Dans cet article, nous allons nous concentrer sur l'[API OVHcloud](https://eu.api.ovh.com/).<br/>
