...
description: Découvrez comment installer Etherpad sur votre hébergement web POWER
...
[Accédez via SSH](/guides/ovhcloud-labs/power-web-hosting/getting-started#ssh/) à votre hébergement web POWER et récupérez les sources d'Etherpad dans le répertoire `www` :
...
[Redémarrez votre instance](/guides/ovhcloud-labs/power-web-hosting/getting-started#restart/), votre Etherpad sera alors en ligne.
