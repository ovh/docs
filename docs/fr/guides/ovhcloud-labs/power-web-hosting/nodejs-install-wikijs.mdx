...
description: Découvrez comment installer Wiki.JS sur votre hébergement web POWER
...
[Redémarrez votre instance](/guides/ovhcloud-labs/power-web-hosting/getting-started#restart/), votre Wiki.JS sera alors en ligne.
