...
description: Découvrez comment installer Ghost sur votre hébergement web POWER
...
[Redémarrez votre instance](/guides/ovhcloud-labs/power-web-hosting/getting-started#restart/), votre plateforme Ghost sera alors en ligne.

<img className="thumbnail" alt="Ghost" src="/images/ovhcloud-labs/power-web-hosting/nodejs-install-ghost/nodejs-install-ghost-01.png" loading="lazy" />
