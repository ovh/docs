...
description: Découvrez comment installer Slideshow sur votre hébergement web POWER
...
[Accédez via SSH](/guides/ovhcloud-labs/power-web-hosting/getting-started#ssh/) à votre hébergement web POWER. Commencez par recupérer les sources du projet :
...
[Redémarrez votre instance](/guides/ovhcloud-labs/power-web-hosting/getting-started#restart/), votre application de présentation de slides sera alors en ligne.

<img className="thumbnail" alt="Slideshow" src="/images/ovhcloud-labs/power-web-hosting/nodejs-install-slideshow/nodejs-install-slideshow-01.png" loading="lazy" />
