...
description: Découvrez comment installer Camaleon sur votre hébergement web POWER
...
[Redémarrez votre instance](/guides/ovhcloud-labs/power-web-hosting/getting-started#restart/), votre CMS Camaleon sera alors en ligne.
