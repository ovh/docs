...
description: Découvrez comment installer Django sur votre hébergement web POWER
...
[Redémarrez votre instance](/guides/ovhcloud-labs/power-web-hosting/getting-started#restart/), votre Django sera en ligne.

<img className="thumbnail" alt="Django" src="/images/ovhcloud-labs/power-web-hosting/python-install-django/python-install-django-01.png" loading="lazy" />
...
Retrouvez la documentation officielle de Django sur [https://docs.djangoproject.com/fr/3.1/](https://docs.djangoproject.com/fr/3.1/).
