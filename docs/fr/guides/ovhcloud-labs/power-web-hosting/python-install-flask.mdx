...
description: Découvrez comment installer Flask sur votre hébergement web POWER
...
[Accédez via SSH](/guides/ovhcloud-labs/power-web-hosting/getting-started#ssh/) à votre hébergement web POWER et activez `virtualenv` :
...
[Redémarrez votre instance](/guides/ovhcloud-labs/power-web-hosting/getting-started#restart/), votre projet Flask sera en ligne.

<img className="thumbnail" alt="Flask" src="/images/ovhcloud-labs/power-web-hosting/python-install-flask/python-install-flask-01.png" loading="lazy" />
