...
description: Découvrez comment installer Rails sur votre hébergement web POWER
...
[Accédez via SSH](/guides/ovhcloud-labs/power-web-hosting/getting-started#ssh/) à votre hébergement web POWER.
...
[Redémarrez votre instance](/guides/ovhcloud-labs/power-web-hosting/getting-started#restart/), votre Rails sera alors en ligne.

<img className="thumbnail" alt="Rails" src="/images/ovhcloud-labs/power-web-hosting/ruby-install-rails/ruby-install-rails-01.png" loading="lazy" />
...
<img className="thumbnail" alt="Rails" src="/images/ovhcloud-labs/power-web-hosting/ruby-install-rails/ruby-install-rails-02.png" loading="lazy" />
...
Pour plus d'informations sur Rails, n'hésitez pas à consulter la documentation officielle sur [https://guides.rubyonrails.org/](https://guides.rubyonrails.org/).
