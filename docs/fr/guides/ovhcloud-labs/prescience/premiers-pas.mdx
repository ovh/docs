...
description: Découvrez comment prendre en main la plateforme OVH Prescience
...
![login_page](/images/ovhcloud-labs/prescience/premiers-pas/login_page.png)

Cliquez sur <code className="action">Login</code> afin d'accéder à l'application.
...
![landing_page](/images/ovhcloud-labs/prescience/premiers-pas/landing_page.png)
...
Afin de lister toutes les sources déposées sur l'application, cliquez sur l'onglet <code className="action">Sources</code>.

![source_page](/images/ovhcloud-labs/prescience/premiers-pas/source_page.png)
...
Pour déposer une nouvelle source, il vous suffit de cliquer sur le bouton <code className="action">Upload Source</code>, puis de renseigner les champs demandés.
...
Renseignez le formulaire comme suit, puis cliquez sur <code className="action">Upload</code> afin de démarrer le dépôt du fichier.

![upload_source](/images/ovhcloud-labs/prescience/premiers-pas/upload_source.png)
...
![source_beeing_parsed](/images/ovhcloud-labs/prescience/premiers-pas/source_beeing_parsed.png)
...
![source_parsed](/images/ovhcloud-labs/prescience/premiers-pas/source_parsed.png)
...
![source_actions](/images/ovhcloud-labs/prescience/premiers-pas/source_actions.png)
...
Renseignez le formulaire comme suit, puis continuez en cliquant sur <code className="action">Start</code>.

![preprocess_form](/images/ovhcloud-labs/prescience/premiers-pas/preprocess_form.png)
...
![dataset_preprocessed](/images/ovhcloud-labs/prescience/premiers-pas/dataset_preprocessed.png)
...
![dataset_view](/images/ovhcloud-labs/prescience/premiers-pas/dataset_view.png)

Le lancement d'une optimisation se fait ensuite via le bouton <code className="action">Optimize</code>. Cette action vous demandera de renseigner les éléments suivants :
...
![optimisation_form](/images/ovhcloud-labs/prescience/premiers-pas/optimisation_form.png)

Vous pourrez alors suivre la progression de celle-ci dans l'onglet « Optimizations Runs ».

![optimisation_run](/images/ovhcloud-labs/prescience/premiers-pas/optimisation_run.png)
...
![optimization_result](/images/ovhcloud-labs/prescience/premiers-pas/optimization_result.png)

Vous pouvez, à souhait, ajuster les indicateurs à afficher sur la courbe via le menu déroulant « Select a scoring metric ».

L'affichage est également disponible sous la forme de tableau, via le bouton <code className="action">Table</code>.

![optimisation_result_table](/images/ovhcloud-labs/prescience/premiers-pas/optimisation_result_table.png)
...
![run_comparison](/images/ovhcloud-labs/prescience/premiers-pas/run_comparison.png)
...
Renseignez le formulaire avec les informations suivantes, puis cliquez sur <code className="action">Start</code>.

![train_form](/images/ovhcloud-labs/prescience/premiers-pas/train_form.png)
...
![production_query](/images/ovhcloud-labs/prescience/premiers-pas/production_query.png)
...
![model-metric-task](/images/ovhcloud-labs/prescience/premiers-pas/model-metric-task.png)
...
![model_kpi](/images/ovhcloud-labs/prescience/premiers-pas/model_kpi.png)
