...
- Depuis votre [espace client OVHcloud](https://manager.eu.ovhcloud.com/#/telecom/overTheBox), sélectionnez le **service OverTheBox** que vous souhaitez associer à votre boîtier.
