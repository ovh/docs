...
Depuis votre [espace client OVHcloud](https://manager.eu.ovhcloud.com/#/telecom/pack), cliquez sur votre accès à Internet FTTH ou xDSL dans le cadre `Accès Internet` à droite, puis positionnez-vous sur l'onglet <code className="action">Mon modem</code> et cliquez sur <code className="action">Configurer les réseaux Wi-Fi</code> dans la section <code className="action">Configuration générale</code>.
...
Depuis votre [espace client OVHcloud](https://manager.eu.ovhcloud.com/#/telecom/pack), cliquez sur votre accès à Internet FTTH ou xDSL dans le cadre `Accès Internet` à droite, puis positionnez-vous sur l'onglet <code className="action">Mon modem</code> et descendez dans la page jusqu'à voir la section <code className="action">Configuration réseau</code>.
