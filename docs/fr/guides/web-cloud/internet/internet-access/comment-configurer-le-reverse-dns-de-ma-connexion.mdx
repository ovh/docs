...
La configuration du Reverse DNS s'effectue dans votre [espace client OVHcloud](https://manager.eu.ovhcloud.com/#/telecom/pack). Cliquez sur votre accès à Internet FTTH ou xDSL dans le cadre `Accès Internet` à droite.
