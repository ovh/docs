...
:::info
Ce guide ne concerne que les modems de marque Zyxel. Si vous possédez un modem Thomson ou Technicolor, vous pouvez demander un échange de confort facturé 70 € HT (84 € TTC). Pour cela, depuis votre [espace client OVHcloud](https://manager.eu.ovhcloud.com/#/telecom/pack) partie « Télécom », cliquez sur <code className="action">Accès Internet</code>, puis sélectionnez le pack et l’accès à Internet concerné. Assurez-vous d'être positionné sur l'onglet <code className="action">Mon Accès</code>. En bas de la page à gauche, cliquez sur le bouton <code className="action">Échanger mon modem</code>.
