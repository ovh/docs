...
Depuis votre [espace client OVHcloud](https://manager.eu.ovhcloud.com/#/telecom/pack), accédez à l'onglet <code className="action">Télécom</code>.
...
Vérifiez que l'adresse obtenue correspond bien à celle que vous avez notée sur le site de l'ARCEP.
  ...
  <Tab label="Étape 3">
    **Effectuez un déménagement de votre accès à Internet :**
    ...
    Depuis votre [espace client OVHcloud](https://manager.eu.ovhcloud.com/#/telecom/pack), effectuez une demande de déménagement de votre accès en suivant notre guide « [Comment déménager mon accès xDSL/Fibre](/guides/web-cloud/internet/internet-access/comment-demenager-mon-acces-xdsl/) ». Choisissez l'offre Fibre Pro.
