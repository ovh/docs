...
Pour changer d'offre, depuis votre [espace client OVHcloud](https://manager.eu.ovhcloud.com/#/telecom/pack), sélectionnez le *Pack* contenant l'accès à Internet concerné, puis cliquez sur <code className="action">Changer d'offre</code> dans le cadre « Informations Générales ».
