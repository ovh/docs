...
Depuis votre [espace client OVHcloud](https://manager.eu.ovhcloud.com/#/telecom/pack), sélectionnez le *Pack* contenant l'accès à Internet concerné. La référence interne est affichée dans le cadre `Accès Internet` à droite.
...
Si vous n'avez pas accès à l'adresse e-mail de contact du compte OVHcloud, vous pouvez consulter les e-mails de service depuis l'[espace client OVHcloud](https://manager.eu.ovhcloud.com/#/telecom/pack).
