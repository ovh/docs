...
Pour commander un service Office 365 Revendeurs, rendez-vous dans votre [espace client OVHcloud](/links/manager). Une fois connecté, sélectionnez `Sunrise` dans le bandeau supérieur puis cliquez sur `Office 365 Revendeurs`.
...
- Cliquez sur `Commander` pour finaliser.
...
Pour cela, rendez-vous dans la section `Sunrise`. Dans le menu de gauche, choisissez `Office 365 Revendeurs` puis sélectionnez le service.
