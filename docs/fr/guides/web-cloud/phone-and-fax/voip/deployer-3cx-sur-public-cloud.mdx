...
- Un projet [Public Cloud](https://www.ovhcloud.com/fr/public-cloud/) dans votre compte OVHcloud. Retrouvez plus d'informations dans notre guide « [Créer votre premier projet Public Cloud](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project/) ».
...
Accédez à la section [Public Cloud](https://manager.eu.ovhcloud.com/#/pci/projects), puis sélectionnez votre projet.
...
[L'essentiel pour commencer avec Public Cloud](/guides/public-cloud/public-cloud-cross-functional/00-essential-info-to-get-started-on-public-cloud/)
