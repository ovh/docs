...
<Api version="v1" section="/telephony" method="GET" route={"/telephony/\\{billingAccount\\}/eventToken"} />

<Api version="v1" section="/telephony" method="GET" route={"/telephony/\\{billingAccount\\}/service/\\{serviceName\\}/eventToken"} />
...
- [Projet communautaire](/guides/web-cloud/phone-and-fax/voip/projet-communautaire-cti)
- [Intégration CTI de la téléphonie OVH aux CRM et ERP](/guides/web-cloud/phone-and-fax/voip/cti-crm-erp-sugarcrm)
