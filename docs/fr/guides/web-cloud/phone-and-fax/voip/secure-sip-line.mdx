...
Pour cela, activez la restriction et consultez les logs d'authentification depuis votre espace client. Reportez-vous aux instructions décrites dans notre documentation « [Restreindre sa ligne SIP OVHcloud par IP](/guides/web-cloud/phone-and-fax/voip/secure-sip-line-ovh/) » si nécessaire.
