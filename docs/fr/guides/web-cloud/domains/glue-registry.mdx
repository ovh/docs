...
<Tabs>
  <Tab label="Étape 1">
    Accédez à la page [Zones DNS](https://manager.eu.ovhcloud.com/#/web/zone), puis choisissez le nom de domaine que vous avez utilisé pour créer les hôtes lors de la [Partie 3](#step3).
...
<Tabs>
  <Tab label="Étape 1">
    Accédez à la page [Zones DNS](https://manager.eu.ovhcloud.com/#/web/zone), puis choisissez le nom de domaine pour lequel vous avez personnalisé les serveurs DNS.
...
<Tabs>
  <Tab label="Étape 1">
    Accédez à la page [Noms de domaine](https://manager.eu.ovhcloud.com/#/web-domains/domain), puis choisissez *le nom de domaine pour lequel vous souhaitez personnaliser les serveurs DNS*.
