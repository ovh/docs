...
:::info
La création / modification / suppression d'une zone DNS dans votre [espace client OVHcloud](https://manager.eu.ovhcloud.com/#/web/zone) est gratuite.
...
<Tabs>
  <Tab label="Étape 1">
    Accédez à la page [Mes offres et services](https://manager.eu.ovhcloud.com/#/billing/autorenew/services), puis sur le bouton <code className="action">...</code> à droite de la zone DNS à résilier, puis sur <code className="action">Résilier mon service</code>.
