...
Le processus de transfert peut être redémarré depuis la page [Opérations en cours](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/web/ongoing-operations).
...
Une fois la procédure de transfert terminée, vous pouvez gérer votre nom de domaine depuis la page [Noms de domaine](https://manager.eu.ovhcloud.com/#/web-domains/domain).
