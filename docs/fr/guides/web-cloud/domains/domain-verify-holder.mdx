...
Pour certaines extensions ( par exemple : .fr, .it, .es), l'administrateur du domaine peut se rendre directement sur son [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) et modifier l'adresse du contact titulaire en suivant les étapes décrites à l'étape 2 de cette page.
...
<Tabs>
  <Tab label="Étape 1">
    Accédez à la page [Opérations en cours](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/web/ongoing-operations), puis retrouvez le nom de domaine concerné.
