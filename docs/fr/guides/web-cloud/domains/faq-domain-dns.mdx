...
Vous pourrez ensuite administrer votre nom de domaine en vous connectant à votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr).
...
<Tabs>
  <Tab label="Étape 1">
    Accédez à la page [Mes offres & services](https://manager.eu.ovhcloud.com/#/billing/autorenew/services).
  </Tab>
  <Tab label="Étape 2">
...
Effectuez une [procédure de récupération des contacts](https://www.ovh.com/fr/cgi-bin/fr/procedure/procedureChangeContacts.cgi) pour que votre nom de domaine soit entièrement géré dans votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr). Ainsi, vous n'aurez plus besoin de contacter la personne qui gérait auparavant votre nom de domaine.
...
- **Depuis votre espace client OVHcloud** : Si la zone DNS active de votre nom de domaine est gérée chez OVHcloud, accédez à la page [Zones DNS](https://manager.eu.ovhcloud.com/#/web/zone) pour visualiser l'ensemble des enregistrements DNS déclarés pour votre nom de domaine.
...
<Tabs>
  <Tab label="Étape 1">
    Accédez à la page [Zones DNS](https://manager.eu.ovhcloud.com/#/web/zone), puis cliquez sur le bouton <code className="action">Commander</code> en haut à droite du tableau qui s'affiche.
  </Tab>
  <Tab label="Étape 2">
...
:::tip[Success]
Si vous n'avez pas reçu cet e-mail, vérifiez dans vos courriers indésirables ou rendez-vous sur la page [Mon compte](https://manager.eu.ovhcloud.com/#/account/useraccount/dashboard), puis cliquez sur l'onglet <code className="action">Emails reçus</code>.
...
<Tabs>
  <Tab label="Étape 1">
    Accédez à la page [Zones DNS](https://manager.eu.ovhcloud.com/#/web/zone), puis vérifiez si le nom de domaine concerné apparaît.
...
Si l'onglet n'apparaît pas dans votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), c'est que l'option « GLUE » est indisponible pour votre nom de domaine.
...
Dans votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), ce message indique uniquement que la zone DNS créée pour votre nom de domaine n'est pas sa zone DNS active.
...
<Tabs>
  <Tab label="Étape 1">
    Accédez à la page [Noms de domaine](https://manager.eu.ovhcloud.com/#/web-domains/domain), puis vérifiez si le nom de domaine concerné apparaît.
...
[Hébergement Web - FAQ](/guides/web-cloud/web-hosting/faq-web-hosting/)
