...
- Selon la méthode utilisée, disposer d’un accès à la gestion de l’offre d’hébergement web depuis l’[espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) ou du mot de passe de l'utilisateur FTP vous permettant d'accéder à votre espace de stockage. 
...
- Le statut « maintenance » apparaît dans votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr). Dans la partie <code className="action">Web Cloud</code>, cliquez sur votre service dans la section <code className="action">Hébergements</code> puis sur l'onglet <code className="action">Informations générales</code>.
