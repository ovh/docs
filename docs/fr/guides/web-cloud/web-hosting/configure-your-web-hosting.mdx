...
- depuis votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) ;
...
En résumé, modifier la configuration de votre hébergement web depuis l'[espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) ou modifier les valeurs présentes dans le fichier « .ovhconfig » revient à réaliser la même opération.
...
- **Via l'espace client OVHcloud**. Connectez-vous à [l'espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) puis rendez-vous dans la partie <code className="action">Web Cloud</code>. Dans la colonne de gauche, cliquez sur <code className="action">Hébergements</code> puis choisissez l'hébergement web concerné. Dans l'onglet <code className="action">Informations générales</code>, repérez la version en dessous de *Version PHP globale*. 
...
Cliquez sur le bouton <code className="action">...</code> à droite de la mention **Version PHP Globale**, puis sur <code className="action">Modifier la configuration</code>.
    ...
    Si l'option **version PHP globale** n'apparaît pas dans votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), vérifiez que fichier *.ovhconfig* existe bien à la racine FTP de votre hébergement mutualisé OVHcloud.
