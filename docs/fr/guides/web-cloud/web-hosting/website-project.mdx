...
<Tabs>
  <Tab label="Utiliser un CMS">
    ...
    Une fois connecté à votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) et via votre hébergement web, cette option vous permet d'installer rapidement les CMS WordPress, Joomla!, PrestaShop et Drupal.
...
Retrouvez plus de détails sur son utilisation dans notre documentation « [Premiers pas avec le service Web Cloud Databases](/guides/web-cloud/web-cloud-databases/starting-with-clouddb/) ».
