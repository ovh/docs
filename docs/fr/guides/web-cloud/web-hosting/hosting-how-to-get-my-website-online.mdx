...
Si vous souhaitez créer une nouvelle base de données chez OVHcloud, connectez-vous à votre [espace client OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), puis cliquez sur <code className="action">Hébergements</code>. Choisissez le nom de l'hébergement concerné et positionnez-vous enfin sur l'onglet <code className="action">Base de données</code>.
