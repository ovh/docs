...
Dirigez-vous dans l'onglet `Bases de données` et enfin sur `Ajouter une base de données`
...
- **Droits** (seulement si la case `Créer un utilisateur` est cochée) : il s'agit des droits qui seront associés à l'utilisateur sur la base de données. Pour une utilisation classique, sélectionnez `Administrateur`. Les droits peuvent être modifiés par la suite.
...
Dirigez-vous dans l'onglet `Utilisateurs et droits` et cliquez sur `Ajouter un utilisateur`
...
Renseignez un « nom d'utilisateur  » et un « mot de passe » puis cliquez sur `Valider`.
...
Pour gérer les droits de chaque utilisateur, rendez-vous dans votre [espace client OVHcloud](/links/manager). Cliquez sur  l'onglet `Web Cloud`, puis sur `Web Cloud Databases`. Sélectionnez le nom de votre serveur de bases de données. Cliquez sur l'onglet `Utilisateurs et droits`.

Cliquez sur le bouton `...` à droite de l'utilisateur concerné puis sur `Gérer les droits`.
...
Pour supprimer une base de données sur votre serveur de bases de données, dirigez-vous dans l'onglet `Bases de données` puis cliquez sur le bouton `...` à droite de la base de données concernée et enfin cliquez sur `Supprimer la base` .
