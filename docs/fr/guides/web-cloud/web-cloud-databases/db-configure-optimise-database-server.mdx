...
Dans [l'espace client OVHcloud](/links/manager), rendez-vous dans la section `Web Cloud Databases`, puis sur l'instance SQL concernée. Assurez-vous d'être bien positionné sur l'onglet `Informations générales`.
...
Dans votre [espace client OVHcloud](/links/manager), rendez-vous dans la section `Web Cloud Databases`, puis sur l'instance Web Cloud Databases concernée.

Cliquez sur l'onglet `IP autorisées` puis sur le bouton `Ajouter une adresse IP/masque`.
...
### Modifier votre offre Web Cloud Databases <a id="modify-ram-web-cloud-db"></a>
...
>
> Pour délier une offre Web Cloud Databases associée à un hébergement web **Performance**, consultez notre guide « [Délier ma solution Web Cloud Databases d'un hébergement web](/guides/web-cloud/web-cloud-databases/db-detach-from-web-hosting) ».
>
...
Pour modifier votre offre Web Cloud Databases, rendez-vous dans votre [espace client OVHcloud](/links/manager). Cliquez sur l'onglet `Web Cloud`, puis sur `Web Cloud Databases`. Sélectionnez le nom de votre serveur de bases de données.

Dans l'onglet **« Informations générales »** qui est affiché par défaut, cliquez sur `...` à droite de la mention « RAM » puis sur `Changer la quantité de la RAM` afin d'accéder à la commande de ce basculement.
...
Choisissez la quantité de RAM souhaitée puis cliquez sur le bouton `Suivant`. Vous pouvez ensuite choisir la durée souhaitée.
...
Rendez-vous dans votre [espace client OVHcloud](/links/manager). Cliquez sur l'onglet `Web Cloud`, puis sur `Web Cloud Databases`. Sélectionnez le nom de votre serveur Web Cloud Databases.

#### Instance MySQL et MariaDB

- Cliquez sur l'onglet `Configuration`.

Vous trouverez dans le cadre **« Configuration générale de MySql »** la configuration actuellement définie pour votre base de données. Vous pouvez directement modifier celle-ci, puis cliquer sur `Appliquer`.
...
Vous trouverez, dans le cadre **« Configuration générale de PostgreSQL »**, la configuration actuellement définie pour votre base de données. Vous pouvez directement modifier celle-ci, puis cliquer sur `Appliquer`.
...
Pour modifier cette version, cliquez sur `Modifier la version`.
...
Entrez cette commande dans phpPgAdmin en cliquant sur **votre base de données**, rubrique **« SQL »**, puis en cliquant sur `Lancer` :
...
Il faut pour cela entrer cette commande dans phpMyAdmin, rubrique **« SQL »**, puis cliquer sur `Exécuter` :
...
Rendez-vous dans votre [espace client OVHcloud](/links/manager). Cliquez sur l'onglet `Web Cloud`, puis sur `Web Cloud Databases`. Sélectionnez le nom de votre serveur de bases de données.
