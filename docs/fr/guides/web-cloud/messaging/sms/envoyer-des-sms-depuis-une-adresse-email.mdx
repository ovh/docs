...
Vous pouvez consulter le guide suivant pour toute précision sur les utilisateurs SMS : [Tout savoir sur les utilisateurs SMS](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms/)
...
<img className="thumbnail" alt="Liste des caractères SMS" src="/images/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-adresse-email/smsauthorizedcharacters.png" loading="lazy" />
