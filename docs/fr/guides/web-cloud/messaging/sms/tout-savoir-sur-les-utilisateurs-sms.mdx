...
Pour plus d'informations sur la fonction http2sms, consultez le guide [Envoyer des SMS depuis une URL](/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-url---http2sms/).
