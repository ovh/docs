...
[Accédez à la section SMS](https://manager.eu.ovhcloud.com/#/telecom/sms) de votre espace client OVHcloud, sélectionnez votre compte SMS puis l'onglet <code className="action">Message et campagne</code> > <code className="action">Gestion des SMS</code> > <code className="action">Historique des envois</code> ou <code className="action">SMS reçus</code>. Vous pouvez filtrer l'historique par date, expéditeur, destinataire ou message. L'historique est conservé pendant 6 mois. L'historique peut également être exporté au format CSV pour analyse.

Pour plus de détails, consultez le guide « [Gérer l'historique des SMS](/guides/web-cloud/messaging/sms/gerer-l-historique-des-sms/) ».
...
Pour les **utilisateurs API**, [accédez à la section SMS](https://manager.eu.ovhcloud.com/#/telecom/sms), sélectionnez votre compte, puis <code className="action">Utilisateurs API</code>. Cliquez sur <code className="action">...</code> > <code className="action">Limite</code> pour l'utilisateur concerné et configurez :
...
Pour plus de détails, consultez le guide « [Tout savoir sur les utilisateurs SMS](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms/) ».
...
[Accédez à la section SMS](https://manager.eu.ovhcloud.com/#/telecom/sms) de votre espace client OVHcloud, sélectionnez votre compte SMS, puis cliquez sur <code className="action">Envoyer un SMS</code>. Renseignez :
...
Pour plus de détails, consultez le guide « [Envoyer des SMS depuis l'espace client OVHcloud](/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-mon-espace-client/) ».
...
Pour plus de détails, consultez le guide « [Envoyer des SMS depuis une URL - http2sms](/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-url---http2sms/) ».
...
Pour plus de détails, consultez le guide « [Envoyer des SMS depuis une adresse e-mail](/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-adresse-email/) ».
...
[Accédez à la section SMS](https://manager.eu.ovhcloud.com/#/telecom/sms) de votre espace client OVHcloud, sélectionnez votre compte SMS, puis cliquez sur <code className="action">Envoyer un SMS</code>. Les étapes sont :
...
[Accédez à la section SMS](https://manager.eu.ovhcloud.com/#/telecom/sms) de votre espace client OVHcloud, sélectionnez votre compte SMS, puis accédez à <code className="action">Contacts</code> > <code className="action">Créer une liste de contacts</code>. Vous pouvez :
...
Les carnets d'adresses SMS offrent une gestion plus riche des contacts (nom, prénom, numéro). [Accédez à la section SMS](https://manager.eu.ovhcloud.com/#/telecom/sms), sélectionnez votre compte SMS, puis accédez à <code className="action">Contacts</code> > <code className="action">Carnet d'adresses</code>. Vous pouvez :
...
Pour plus de détails, consultez le guide « [Gérer mes carnets d'adresses SMS](/guides/web-cloud/messaging/sms/gerer-mes-carnets-dadresses-sms/) ».
...
Pour plus de détails, consultez le guide « [Tout savoir sur les expéditeurs SMS](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-expediteurs-sms/) ».
...
[Accédez à la section SMS](https://manager.eu.ovhcloud.com/#/telecom/sms) de votre espace client OVHcloud, sélectionnez votre compte SMS, puis cliquez sur l'onglet <code className="action">Expéditeurs</code>. Cliquez sur <code className="action">Actions</code> > <code className="action">Ajouter</code> et choisissez « Ajouter manuellement des expéditeurs ». Renseignez :
...
Pour plus de détails, consultez le guide « [Envoyer des SMS permettant la réponse](/guides/web-cloud/messaging/sms/gerer-les-sms-avec-reponse/) ».
...
Les utilisateurs API SMS permettent de déléguer l'envoi de SMS via l'API ou la fonction http2sms sans exposer vos identifiants client OVHcloud. [Accédez à la section SMS](https://manager.eu.ovhcloud.com/#/telecom/sms) de votre espace client OVHcloud, sélectionnez votre compte SMS, puis cliquez sur <code className="action">Utilisateurs API</code>. Ajoutez un nouvel utilisateur en définissant un identifiant et un mot de passe. Chaque utilisateur peut se voir attribuer :
...
Pour plus de détails, consultez le guide « [Envoyer des SMS avec l'API OVHcloud en PHP](/guides/web-cloud/messaging/sms/envoyer-des-sms-avec-lapi-ovh-en-php/) ».
...
Le protocole SMPP (Short Message Peer-to-Peer) est un protocole industriel pour l'envoi et la réception de SMS en volume. [Accédez à la section SMS](https://manager.eu.ovhcloud.com/#/telecom/sms) de votre espace client OVHcloud, sélectionnez votre compte, puis accédez à <code className="action">Options</code> > <code className="action">Paramètres SMPP</code>. Vous obtiendrez les paramètres de connexion : adresse du serveur SMPP, port, system_id et password. Le protocole SMPP offre une connexion persistante, un débit d'envoi plus élevé, et un support natif des DLR en mode push.
...
Pour plus de détails, consultez le guide « [Tout ce qu'il faut savoir sur le HLR](/guides/web-cloud/messaging/sms/tout-ce-quil-faut-savoir-sur-le-hlr---sms/) ».
