...
<img className="thumbnail" alt="fonctionnement sms avec réponse" src="/images/web-cloud/messaging/sms/gerer-les-sms-avec-reponse/SMSreponse.png" loading="lazy" />
...
<img className="thumbnail" alt="options SMS réponse" src="/images/web-cloud/messaging/sms/gerer-les-sms-avec-reponse/SMSreponse-options.png" loading="lazy" />
...
<img className="thumbnail" alt="envoi SMS" src="/images/web-cloud/messaging/sms/gerer-les-sms-avec-reponse/SMSreponse-envoi.png" loading="lazy" />

Assurez-vous que votre expéditeur est bien le `Numéro permettant la réponse (France uniquement)`.

<img className="thumbnail" alt="envoi SMS" src="/images/web-cloud/messaging/sms/gerer-les-sms-avec-reponse/SMSreponse-expediteur.png" loading="lazy" />

Complétez ensuite les champs dédiés au(x) destinataire(s) et à votre message. Pour plus de détails, consultez [notre guide sur l'envoi de SMS depuis l'espace client](/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-mon-espace-client/).
...
<img className="thumbnail" alt="SMS reçus" src="/images/web-cloud/messaging/sms/gerer-les-sms-avec-reponse/SMSreponse-recus.png" loading="lazy" />
