...
Vous pouvez également acheter un pack de crédits SMS depuis la [section SMS de votre espace client](https://manager.eu.ovhcloud.com/#/telecom/sms). Cliquez sur votre compte SMS puis sur <code className="action">Créditer mon compte</code> depuis l'onglet <code className="action">Accueil</code>.
...
[Gérer l’historique des SMS](/guides/web-cloud/messaging/sms/gerer-l-historique-des-sms/)
