...
- A [Public Cloud Floating IP](/guides/public-cloud/public-cloud-network-services/getting-started-03-attach-floating-ip-to-instance/)
...
This scenario is covered by the guide [Attaching a Floating IP to an instance](/guides/public-cloud/public-cloud-network-services/getting-started-03-attach-floating-ip-to-instance/).

#### Target configuration architecture

<img className="thumbnail" alt="diagram" src="/images/public-cloud/public-cloud-network-services/configuration-01-snat-configuration/architecture.png" loading="lazy" />
...
Create a VM with a Floating IP as explained in [this guide](/guides/public-cloud/public-cloud-network-services/getting-started-03-attach-floating-ip-to-instance/).
