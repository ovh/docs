...
<img className="thumbnail" alt="migracja IP" src="/images/public-cloud/public-cloud-network-services/additional-ip-migrate/migrateip_01.png" loading="lazy" />

Kliknij rozwijane menu, aby wybrać docelową instancję z listy.

<img className="thumbnail" alt="migracja IP" src="/images/public-cloud/public-cloud-network-services/additional-ip-migrate/migrateip_02.png" loading="lazy" />
...
<img className="thumbnail" alt="migracja IP" src="/images/public-cloud/public-cloud-network-services/additional-ip-migrate/migrateip_03.png" loading="lazy" />
...
[Importowanie adresu Additional IP](/guides/public-cloud/public-cloud-network-services/additional-ip-import/)
