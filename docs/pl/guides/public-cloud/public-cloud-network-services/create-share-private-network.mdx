...
- Refer to [Getting started with the OpenStack API](/guides/public-cloud/compute/starting-with-nova).
- Refer to [Attaching a Floating IP to a Public Cloud instance](/guides/public-cloud/public-cloud-network-services/attach-floating-ip-to-instance).
- Refer to [Managing firewall rules and port security on networks using OpenStack CLI ](/guides/public-cloud/public-cloud-cross-functional/security-group-private-network).
