...
- A [Public Cloud Floating IP](/guides/public-cloud/public-cloud-network-services/attach-floating-ip-to-instance)
...
This scenario is covered by the guide [Attaching a Floating IP to an instance](/guides/public-cloud/public-cloud-network-services/attach-floating-ip-to-instance).
...
Create a VM with a Floating IP as explained in [this guide](/guides/public-cloud/public-cloud-network-services/attach-floating-ip-to-instance).
