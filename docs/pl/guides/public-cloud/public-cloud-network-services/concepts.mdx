...
### OVHcloud vRack - Clustering with VLANs <a id="vlancluster"></a>
...
#### Public Mode: A public IP is attached directly to the instance <a id="publicmode"></a>
...
#### Public Cloud Gateway (with SNAT) <a id="gateway"></a>
...
#### Load Balancer inside private networking <a id="loadbalancer"></a>
...
Read more about it on our [Load Balancer guide page](/guides/public-cloud/public-cloud-network-services/getting-started-load-balancer).

### Public IP addresses

#### OVHcloud Floating IP for Public Cloud <a id="floatingip"></a>
...
Find out more about Additional IP and Floating IP on the dedicated [Concepts page](/guides/public-cloud/public-cloud-network-services/additional-ip-vs-floating-ip).
