...
> [!info]
> Ten artykuł dotyczy konfiguracji adresów Additional IPv4 w interfejsie publicznym. Możesz również skonfigurować adresy IPv6 dla instancji Public Cloud, korzystając z [tego przewodnika](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-ipv6-configuration).
>
...
>
> - [Konfiguracja bloku IP w sieci vRack w instancji Public Cloud (EN)](/guides/public-cloud/public-cloud-network-services/configure-ip-block-vrack-instance).
...
![dostęp do zarządzania adresami IP](/images/guides/public-cloud/public-cloud-network-services/getting-started-04-configure-additional-ip-to-instance/pleskip1.png)
...
![dodaj informacje IP](/images/guides/public-cloud/public-cloud-network-services/getting-started-04-configure-additional-ip-to-instance/pleskip2-2.png)

Wprowadź adres Additional IP w formie `xxx.xxx.xxx.xxx/32` w polu "IP address and subnet mask", a następnie kliknij `OK`.

![dodaj informacje IP](/images/guides/public-cloud/public-cloud-network-services/getting-started-04-configure-additional-ip-to-instance/pleskip3-3.png)

**Krok 3: sprawdź aktualną konfigurację IP**

 W sekcji "IP Addresses" sprawdź, czy adres Additional IP został poprawnie dodany.

![aktualna konfiguracja IP](/images/guides/public-cloud/public-cloud-network-services/getting-started-04-configure-additional-ip-to-instance/pleskip4-4.png)
...
W sekcji Public Cloud otwórz `Instances` w menu po lewej stronie i kliknij nazwę instancji. Przejdź do zakładki `Console VNC`.
...
![sprawdź główną konfigurację IP](/images/guides/public-cloud/public-cloud-network-services/getting-started-04-configure-additional-ip-to-instance/image1-1.png)
...
![zmień konfigurację IP](/images/guides/public-cloud/public-cloud-network-services/getting-started-04-configure-additional-ip-to-instance/image2.png)
...
![sekcja konfiguracji zaawansowanej](/images/guides/public-cloud/public-cloud-network-services/getting-started-04-configure-additional-ip-to-instance/image4-4.png)

Potwierdź klikając `Dodaj`.

![Konfiguracja migracji IP](/images/guides/public-cloud/public-cloud-network-services/getting-started-04-configure-additional-ip-to-instance/image5-5.png)
...
![dezaktywacja sieci](/images/guides/public-cloud/public-cloud-network-services/getting-started-04-configure-additional-ip-to-instance/image6.png)

Aby go ponownie uruchomić, kliknij prawym przyciskiem myszy, a następnie wybierz `Aktywuj`.

![aktywacja sieci](/images/guides/public-cloud/public-cloud-network-services/getting-started-04-configure-additional-ip-to-instance/image7.png)
...
![sprawdź aktualną konfigurację sieci](/images/guides/public-cloud/public-cloud-network-services/getting-started-04-configure-additional-ip-to-instance/image8-8.png)
...
[Importuj Additional IP](/guides/public-cloud/public-cloud-network-services/import-additional-ip)

[Przenieś Additional IP](/guides/public-cloud/public-cloud-network-services/migrate-additional-ip)
