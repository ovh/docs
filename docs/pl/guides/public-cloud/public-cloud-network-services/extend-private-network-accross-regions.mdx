...
<img className="thumbnail" alt="problematic image" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/problematic_image.png" loading="lazy" />
...
<img className="thumbnail" alt="solution image" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/solution_image.png" loading="lazy" />
...
<img className="thumbnail" alt="Add Public Cloud project to Vrack" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/add_pcp_to_vrack.png" loading="lazy" />
...
<Tabs>
  <Tab label="Via the OVHcloud Control Panel and Horizon">
    ...
    **- First region:**
    ...
    <img className="thumbnail" alt="Edit subnet region 1" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/configure_subnet_region1.png" loading="lazy" />
    
    <img className="thumbnail" alt="Edit subnet region 1 - 2" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/configure_subnet_region1_2.png" loading="lazy" />

**- Second region:**
    
    <img className="thumbnail" alt="Edit subnet region 2" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/configure_subnet_region2.png" loading="lazy" />
    
    <img className="thumbnail" alt="Edit subnet region 2 - 2" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/configure_subnet_region2_2.png" loading="lazy" />

**3\. Refresh network status**
    
    Go back to the OVHcloud Control Panel and refresh the network page.
    
    <img className="thumbnail" alt="Refresh vrack list page" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/refresh_vrack_list_page.png" loading="lazy" />
...
<img className="thumbnail" alt="Add Bare Metal server to Vrack" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/add_baremetal_to_vrack.png" loading="lazy" />

<Tabs>
  <Tab label="Via the OVHcloud Control Panel and Horizon">
    **1\. Create a Public Cloud private network**
    
    <img className="thumbnail" alt="Create Public Cloud private network" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/create_private_network.png" loading="lazy" />
    ...
    **2\. Obtain the MAC address of the Bare Metal server’s private interface.**
    ...
    <img className="thumbnail" alt="Obtain mac address" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/obtain_mac_address.png" loading="lazy" />

**3\. Create a virtual port on the Public Cloud private network using the MAC address of the Bare Metal server.**
    
    <img className="thumbnail" alt="Create virtual port" src="/images/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/create_virtual_port.png" loading="lazy" />
