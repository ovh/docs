...
- Jeden [projekt Public Cloud](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project) na Twoim koncie OVHcloud.
- Dostęp do [panelu klienta OVHcloud](/links/manager).
- [użytkownik OpenStack](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user) (opcjonalnie).
...
### Instalacja i konfiguracja Stormshield Network Security w Twoim środowisku Public Cloud <a id="step1"></a>
...
Zaloguj się do [Panelu klienta OVHcloud](/links/manager), przejdź do sekcji `Public Cloud` i wybierz odpowiedni projekt Public Cloud. W menu po lewej stronie kliknij `Instancje` w zakładce **Compute**, następnie odnajdź Twoje dwie instancje SNS EVA.
...
#### Przykład zastosowania nr 1: skonfiguruj Stormshield Network Security do użytku jako bramę <a id="step2"></a>
...
#### Przykłady zastosowania nr 2: konfiguruj NAT (**N**etwork **A**ddress **T**ranslation), aby uzyskać dostęp do prywatnej usługi HTTP z zewnątrz <a id="step3"></a>
...
#### Przykłady zastosowania nr 3: tunel IPsec (od strony do strony) <a id="step4"></a>
...
##### Przykłady zastosowania nr 4: VPN SSL/TLS (klient-strona) <a id="step5"></a>
