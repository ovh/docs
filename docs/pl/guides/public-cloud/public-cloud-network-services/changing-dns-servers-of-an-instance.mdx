...
Zaloguj się do instancji przez SSH. Więcej informacji na ten temat znajdziesz w przewodniku "[Logowanie do instancji Public Cloud](/guides/public-cloud/compute/public-cloud-first-steps#connect-instance/)".
...
Zaloguj się do instancji za pomocą sesji zdalnego pulpitu lub konsoli VNC. Więcej informacji na ten temat znajdziesz w przewodniku "[Logowanie do instancji Public Cloud](/guides/public-cloud/compute/public-cloud-first-steps#connect-instance/)".

Otwórz <code className="action">Parametry sieci</code>.

<img className="thumbnail" alt="zmień serwery dns" src="/images/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers1.png" loading="lazy" />

Za pomocą panelu konfiguracyjnego przejdź do konfiguracji IPv4 Twojej publicznej karty sieciowej.

<img className="thumbnail" alt="zmień serwery dns" src="/images/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers2.png" loading="lazy" />

Dodaj serwery, których chcesz użyć w zaawansowanych <code className="action">ustawieniach</code>.

<img className="thumbnail" alt="zmień serwery dns" src="/images/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers3.png" loading="lazy" />
