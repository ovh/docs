...
**Na początek poniżej przedstawiono krótki opis możliwych działań w zależności od wybranej metody/interfejsu.** <a id="horizon"></a>
...
- [Przygotowanie środowiska do korzystania z API OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment)
- [Zmienne środowiskowe OpenStac](/guides/public-cloud/public-cloud-cross-functional/compute-set-openstack-environment-variables)
...
>>
>> ![Zamów vrack](/images/assets/screens/control-panel/product-selection/bare-metal-cloud/network/orderingvrack25.png)
>>
...
>>
>> ![dodaj projekt do vrack](/images/guides/public-cloud/public-cloud-network-services/configuration-06-configure-ip-block-vrack-to-instance/addprojectvrack.png)
>>
...
![Tworzenie VLAN](/images/guides/public-cloud/public-cloud-network-services/configuration-06-configure-ip-block-vrack-to-instance/vrack2022-03.png)
...
![Wybierz region](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack5-2024.png)

W następnym kroku przedstawione są różne Opcje:

![Tworzenie sieci](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack6-2022.png)
...
- **Przypisz Gateway i połącz się z prywatną siecią**: Wybierz tę opcję, jeśli zamierzasz tworzyć instancje z prywatną siecią. Aby uzyskać więcej informacji, zapoznaj się z poniższymi przewodnikami: [Tworzenie prywatnej sieci z bramą](/guides/public-cloud/public-cloud-network-services/create-private-network-gateway) i [Tworzenie i łączenie się ze swoją pierwszą instancją Public Cloud](/guides/public-cloud/compute/compute-getting-started).
...
Jeśli potrzebujesz pomocy, najpierw przejrzyj ten przewodnik: [Tworzenie instancji w Panelu klienta OVHcloud](/guides/public-cloud/compute/compute-getting-started). Przy tworzeniu instancji możesz wybrać, w kroku 5, tryb sieciowy, a następnie prywatną sieć, do której chcesz dołączyć swoją instancję.

![dołączenie nowej instancji](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/network-selection.png)
...
![szczegóły instancji](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/instance_details.png)

Otworzy się pulpit instancji. Kliknij przycisk `⁝` w oknie "Sieć", obok "Sieci prywatne", i wybierz `Przypisz sieć`.

![dołącz sieć](/images/guides/public-cloud/public-cloud-network-services/configuration-06-configure-ip-block-vrack-to-instance/vrack2021-01.png)

W oknie dialogowym, które się pojawi, wybierz prywatną sieć (siec(y)) do dołączenia do swojej instancji i kliknij `Zatwierdź`.

![dołącz sieć](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack9.png)
...
![połączenie Horizon](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon1.png)

Wybierz `Compute` i następnie `Instances` z menu.

![instancje Horizon Compute](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon2.png)
...
![dołącz interfejs Horizon](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon3.png)

Wybierz swój interfejs i potwierdź.

![dołącz interfejs Horizon](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon4.png)
...
![odłącz interfejs Horizon](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon5.png)

Wybierz swój interfejs i potwierdź.

![odłącz interfejs Horizon](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon6.png)
