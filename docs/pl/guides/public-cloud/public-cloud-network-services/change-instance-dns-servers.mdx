...
Zaloguj się do instancji przez SSH. Więcej informacji na ten temat znajdziesz w przewodniku "[Logowanie do instancji Public Cloud](/guides/public-cloud/compute/compute-getting-started#connect-instance)".
...
Zaloguj się do instancji za pomocą sesji zdalnego pulpitu lub konsoli VNC. Więcej informacji na ten temat znajdziesz w przewodniku "[Logowanie do instancji Public Cloud](/guides/public-cloud/compute/compute-getting-started#connect-instance)".

Otwórz `Parametry sieci`.

![zmień serwery dns](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers1.png)

Za pomocą panelu konfiguracyjnego przejdź do konfiguracji IPv4 Twojej publicznej karty sieciowej.

![zmień serwery dns](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers2.png)

Dodaj serwery, których chcesz użyć w zaawansowanych `ustawieniach`.

![zmień serwery dns](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers3.png)
...
[Utwórz pierwszą instancję Public Cloud i połącz się z nią](/guides/public-cloud/compute/compute-getting-started)
