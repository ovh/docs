...
Refer to the following guides:
  ...
  - [Attaching a Floating IP to a Public Cloud instance](/guides/public-cloud/public-cloud-network-services/getting-started-03-attach-floating-ip-to-instance/).
