...
More information about configuring Additional IP addresses is available in [this guide](/guides/public-cloud/public-cloud-network-services/getting-started-04-configure-additional-ip-to-instance/).
...
More information about configuring Floating IP is available on the [Public Cloud Networking Concepts page](/guides/public-cloud/public-cloud-network-services/concepts-01-public-cloud-networking-concepts/).
...
<img className="thumbnail" alt="Concept IP" src="/images/public-cloud/public-cloud-network-services/concepts-02-additional-ip-vs-floating-ip/concip.png" loading="lazy" />
