...
- A Load Balancer created. If this is not the case, please check this [guide](/guides/public-cloud/public-cloud-network-services/getting-started-01-create-lb-service/).
...
<img className="thumbnail" alt="Create listener in OVHcloud Control Panel" src="/images/public-cloud/public-cloud-network-services/technical-resources-02-octavia-monitoring-prometheus/create_listener_manager.png" loading="lazy" />

Click <code className="action">Add</code> to trigger the listener creation. The new listener is added to the listeners list.

<img className="thumbnail" alt="Listener list in OVHcloud Control Panel" src="/images/public-cloud/public-cloud-network-services/technical-resources-02-octavia-monitoring-prometheus/listener_list.png" loading="lazy" />
...
<img className="thumbnail" alt="Load Balancer details in Horizon" src="/images/public-cloud/public-cloud-network-services/technical-resources-02-octavia-monitoring-prometheus/horizon_lb_details.png" loading="lazy" />
...
<img className="thumbnail" alt="Listener creation in listener" src="/images/public-cloud/public-cloud-network-services/technical-resources-02-octavia-monitoring-prometheus/horizon_listener_creation.png" loading="lazy" />
