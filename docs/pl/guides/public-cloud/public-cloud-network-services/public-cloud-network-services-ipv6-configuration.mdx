...
> [!info]
> 
> Aktualnie usługi Floating IP i Gateway nie obsługują IPv6. IPv6 można używać tylko z instancjami w [trybie publicznym](/guides/public-cloud/public-cloud-network-services/concepts#publicmode).
>
...
Zaloguj się do panelu klienta, kliknij menu sekcji `Public Cloud`, wybierz projekt Public Cloud i kliknij pozycję `Instancje` w menu bocznym po lewej stronie. Następnie kliknij na `...` obok odpowiadającej instancji i kliknij na `Szczegóły instancji`.
