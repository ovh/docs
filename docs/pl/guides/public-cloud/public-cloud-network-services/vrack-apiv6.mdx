...
- Consulting the guide [Configuring the vRack on Public Cloud](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack) (to understand the different methods to manage the vRack with the Public Cloud)
