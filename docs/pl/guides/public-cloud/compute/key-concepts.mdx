...
:::info
**Najlepsze praktyki**: Dla krytycznych obciążeń zaleca się wdrożenie [wielostrefowe](/guides/public-cloud/public-cloud-cross-functional/3az-ref-architecture/), aby zapewnić odporność usługi i ciągłość działania.
...
Aby uzyskać szczegółowe instrukcje dotyczące tworzenia i używania kluczy SSH, odwiedź [przewodnik SSH OVHcloud](/guides/public-cloud/compute/compute-creating-ssh-keys/).
...
:::info
**Najlepsze praktyki**: Kopia zapasowa nie zastępuje [odporności architektury](/guides/public-cloud/public-cloud-cross-functional/3az-ref-architecture/). Dla krytycznych środowisk połącz kopie zapasowe z replikacją wielostrefową, aby zapewnić maksymalne ochronę danych i dostępność usługi.
...
Aby uzyskać bardziej szczegółowe wskazówki dotyczące konfigurowania sieci Public Cloud, odwiedź oficjalny [przewodnik OVHcloud dotyczący sieci](/guides/public-cloud/public-cloud-network-services/concepts-01-public-cloud-networking-concepts/).
...
Savings Plans pomagają Ci zoptymalizować budżet, jednocześnie zachowując wydajność i niezawodność Twojego środowiska chmurowego. Aby uzyskać więcej szczegółów, odwiedź oficjalny [przewodnik OVHcloud dotyczący Savings Plans](/guides/public-cloud/public-cloud-cross-functional/savings-plans/).
...
- [Jak utworzyć instancję Public Cloud i połączyć się z nią](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)
