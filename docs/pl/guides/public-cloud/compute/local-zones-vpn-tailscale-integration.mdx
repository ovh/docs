...
- [Two Public Cloud instances](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/) deployed in different [OVHcloud Local Zones](https://www.ovhcloud.com/pl/public-cloud/local-zone-compute/) (we will use Prague and Madrid for this example).
- [SSH access to your OVHcloud Local Zone Public Cloud Instances](/guides/public-cloud/compute/compute-creating-ssh-keys/).
...
- Familiarity with SSH and basic terminal commands. For more information on SSH, read our guide on [how to create and use SSH keys for Public Cloud instances](/guides/public-cloud/compute/compute-creating-ssh-keys/).

## Instructions

### Step 1 - Create two instances in OVHcloud Local Zones

[Create two instances](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/) in different OVHcloud Local Zones, such as Prague and Madrid.
