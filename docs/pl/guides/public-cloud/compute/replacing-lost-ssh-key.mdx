...
Utwórz nową parę kluczy SSH na Twoim lokalnym urządzeniu, postępując zgodnie z instrukcjami z pierwszej części [przewodnika dotyczącego tworzenia klucza SSH](/guides/public-cloud/compute/compute-creating-ssh-keys/).
...
Uruchom ponownie instancję w trybie "normalnym" z poziomu [panelu klienta OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl). W razie potrzeby skorzystaj z instrukcji zawartych w [Przewodniku o trybie ratunkowym](/guides/public-cloud/compute/put-an-instance-in-rescue-mode/).
