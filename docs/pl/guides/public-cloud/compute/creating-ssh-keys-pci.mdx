...
Więcej informacji znajdziesz w naszym [przewodniku dotyczącym tworzenia instancji Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
...
:::info
`Ed25519` jest uważany za najbezpieczniejszy, ale `RSA` jest wartościową alternatywą. Obie metody są kompatybilne z [Panelem klienta OVHcloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
...
Skopiuj ten ciąg klucza, aby [dodać go do nowej instancji lub zaimportować do panelu klienta](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
...
[Jak utworzyć instancję Public Cloud i się z nią połączyć](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)
