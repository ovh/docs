...
Uruchom ponownie instancję w trybie "normalnym" z poziomu [panelu klienta OVHcloud](/links/manager). W razie potrzeby skorzystaj z instrukcji zawartych w [Przewodniku o trybie ratunkowym](/guides/public-cloud/compute/put-an-instance-in-rescue-mode).
