...
- Posiadanie zainstalowanej [instancji Public Cloud](/guides/public-cloud/compute/compute-getting-started) z systemem Debian lub Ubuntu
...
### Etap 2: konfiguracja serwera bazy danych <a id="sqlconf"></a>
...
> 
> OVHcloud oferuje również rozwiązanie [SSL Gateway](/links/web/ssl-gateway). Więcej informacji znajdziesz w [dokumentacji](/guides/web-cloud/ssl-gateway/ssl-gateway-order).
> 
