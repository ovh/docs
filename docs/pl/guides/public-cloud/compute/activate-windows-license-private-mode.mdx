...
- Posiadanie [projektu Public Cloud](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project/)
- [Utworzenie użytkownika OpenStack](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/)

Zalecamy zapoznanie się z przewodnikiem  "[Dostęp do interfejsu Horizon](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon/)" w celu zapoznania się z programem Horizon.
...
Zaloguj się do interfejsu [Horizon](https://horizon.cloud.ovh.net/auth/login/), postępując zgodnie z instrukcjami zawartymi w [pierwszej części tego przewodnika](/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack#interfejs-horizon/).
