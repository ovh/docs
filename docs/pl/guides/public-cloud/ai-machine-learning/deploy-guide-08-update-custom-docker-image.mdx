...
- The [OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/)
...
This stop & restart operation can be performed from the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl) (UI) by clicking the `...` button, next to your app, as shown on the screenshot below:
...
Learn how to use public and private registries when working with OVHcloud AI Tools [here](/guides/public-cloud/ai-machine-learning/gi-07-manage-registry/).

Discover some AI Deploy apps we built with API or Web frontend via our [Apps portfolio](/guides/public-cloud/ai-machine-learning/deploy-guide-05-app-portfolio/).
