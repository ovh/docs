...
:::info
Here you will use your trained model, then save it in an Object Container. Click [here](/guides/public-cloud/ai-machine-learning/cli-16-commands-reference-data/) to learn more about Object Storage.
...
- You can imagine deploying an AI model with an other tool: **Gradio**. Refer to this [tutorial](/guides/public-cloud/ai-machine-learning/deploy-tuto-05-gradio-sketch-recognition/).
- Another way to create an AI Deploy app is to use **Flask**! [Here it is](/guides/public-cloud/ai-machine-learning/deploy-tuto-04-flask-yolov5/).
