...
- The **OVHcloud AI CLI** (`ovhai`) installed. For installation instructions, see [how to install ovhai](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/).
