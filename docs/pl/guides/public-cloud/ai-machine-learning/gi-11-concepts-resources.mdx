...
- Access to the [OVHcloud Control Panel](https://manager.eu.ovhcloud.com/#/pci/projects) or [the OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/) installed on your computer
