...
For more information on how to train DenseNet on a CIFAR-10 dataset, refer to the following [documentation](/guides/public-cloud/ai-machine-learning/notebook-tuto-15-finetune-export-onnx-model/).
...
:::warning
**Warning**
You must have previously created a `densenet-cifar10-onnx-model` Object Storage bucket when training your model via [AI Notebooks](/guides/public-cloud/ai-machine-learning/notebook-tuto-15-finetune-export-onnx-model/).
...
- You can imagine deploying an image segmentation app through this [tutorial](/guides/public-cloud/ai-machine-learning/deploy-tuto-14-img-segmentation-app/).
- Feel free to use **Streamlit** to [deploy a Speech-to-Text app](/guides/public-cloud/ai-machine-learning/deploy-tuto-09-streamlit-speech-to-text-app/).
