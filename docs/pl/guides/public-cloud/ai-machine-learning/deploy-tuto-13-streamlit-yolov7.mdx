...
For more information on how to train YOLOv7 on a custom dataset, refer to the following [documentation](/guides/public-cloud/ai-machine-learning/notebook-tuto-11-yolov7/).
...
:::warning
**Warning**
You must have previously created an `asl-volov7-model` Object Storage container when training your model via [AI Notebooks](/guides/public-cloud/ai-machine-learning/notebook-tuto-11-yolov7/).
...
- You can imagine deploying an app using YOLO models with another Python framework: **Flask**. Refer to this [tutorial](/guides/public-cloud/ai-machine-learning/deploy-tuto-04-flask-yolov5/).
- Feel free to use **Streamlit** for other AI tasks! Deploy a Speech-to-Text app [here](/guides/public-cloud/ai-machine-learning/deploy-tuto-09-streamlit-speech-to-text-app/).
