...
![List Cloud Disk Array cluster](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-multi-attach-persistent-volumes-with-ovh-cloud-disk-array/list-cloud-disk-array.png)
...
![Create File system on Cloud Disk Array](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-multi-attach-persistent-volumes-with-ovh-cloud-disk-array/create-fs.png)
...
![Create user on Cloud Disk Array](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-multi-attach-persistent-volumes-with-ovh-cloud-disk-array/create-ceph-csi-user.png)
...
![Add user permission on Cloud Disk Array](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-multi-attach-persistent-volumes-with-ovh-cloud-disk-array/add-user-permissions.png)
...
![Add ACL on Cloud Disk Array](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-multi-attach-persistent-volumes-with-ovh-cloud-disk-array/add-acl.png)
...
![Get Ceph CSI user key](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-multi-attach-persistent-volumes-with-ovh-cloud-disk-array/get-user-key.png)

- Get the Ceph monitors IP:

<Api version="v1" section="/dedicated/ceph" method="GET" route={"/dedicated/ceph/\\{serviceName\\}"} />

![Get Ceph monitor IPs](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-multi-attach-persistent-volumes-with-ovh-cloud-disk-array/get-ceph-monitor-ip.png)
