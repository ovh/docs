...
- The [OpenStack API CLI](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/) installed.
...
> Important: Assuming that your PCI project is added to your [vRack](/guides/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/).
...
<Tabs>
  ...
  <Tab label="Terraform">
    :::info
    You can create your networks and subnets using Terraform by following [this guide](/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/).
...
To use this kubeconfig file and access to your cluster, you can follow our [configuring kubectl](/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-kubectl-on-an-ovh-managed-kubernetes-cluster/) tutorial, or simply add the `--kubeconfig` flag in your `kubectl` commands.
