...
![Schema vrack gateway](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/vrack-k8s-custom-gateway/schema_mksvrack.png)
...
- The [OpenStack API CLI](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment) installed.
- Being familiar with the [OVHcloud API](/guides/manage-and-operate/api/first-steps).
- Being familiar with [Terraform](/guides/public-cloud/public-cloud-cross-functional/how-to-use-terraform) if you wish to use it.
...
> Important: Assuming that your PCI project is added to your [vRack](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack).
...
![Attach a vRack gateway to an OVHcloud Managed Kubernetes cluster](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/vrack-k8s-custom-gateway/attach-vrack-gateway-to-kubernetes-cluster.png)
...
> [!info]
> 
> You can create your networks and subnets using Terraform by following [this guide](/guides/public-cloud/public-cloud-network-services/create-private-network-gateway).
...
![Create a cluster](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/add-ip-restrictions/clusters.png)
...
![Create a cluster](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/vrack-k8s-custom-gateway/created-cluster.png)
