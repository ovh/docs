...
At any time, the customer can find the currently supported versions on the [dedicated page](/guides/public-cloud/containers-orchestration/managed-kubernetes/software-versions-reserved-resources/)
