...
![OIDC](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-keycloak/oidc.png)
...
![Keycloak](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-keycloak/keycloak.png)
...
![Keycloak interface](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-keycloak/keycloak-interface.png)
...
![Keycloak login](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-keycloak/keycloak-login.png)
...
1. Display the dropdown menu in the top-left corner where it is indicated `Master`, then click on the `Add realm` blue button.
2. Fill in the form with this name: `ovh-lab-k8s-oidc-authentication`, then click on the `Create` blue button.

![Keycloak create realm](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-keycloak/keycloak-realm.png)
...
![Keycloak Clients](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-keycloak/keycloak-clients.png)
...
![Keycloak create client](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-keycloak/keycloak-create-client.png)

<ol start={4}>
  <li>Then click on the <code className="action">Save</code> button.</li>
  <li>In the new created client, Find the <code className="action">Access Type</code> field and set its value to <code className="action">confidential</code> to require a secret to initiate the login protocol. Then click on the <code className="action">Save</code> blue button to save the change.</li>
</ol>

![Keycloak client](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-keycloak/keycloak-client.png)
...
![Keycloak Clients](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-keycloak/clients.png)

![Keycloak Clients Secret](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-keycloak/clients-credentials.png)
