...
- a well configured  `kubectl` (see the [configuring kubectl](/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-kubectl-on-an-ovh-managed-kubernetes-cluster/) guide for details) 
