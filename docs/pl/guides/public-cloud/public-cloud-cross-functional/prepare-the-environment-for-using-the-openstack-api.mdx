...
<img className="thumbnail" alt="Automatyczna instalacja" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/1_preparation_openstack_environment_windows.png" loading="lazy" />
...
<img className="thumbnail" alt="Parametry zmiennych środowiskowych" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/2_preparation_openstack_environment_windows.png" loading="lazy" />
...
<img className="thumbnail" alt="Parametry wydajności" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/3_preparation_openstack_environment_windows.png" loading="lazy" />
...
<img className="thumbnail" alt="Dodanie ścieżki dostępu" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/4_edit_system_variables.png" loading="lazy" />
...
<img className="thumbnail" alt="Automatyczna instalacja" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/5_preparation_openstack_environment_windows.png" loading="lazy" />
...
<img className="thumbnail" alt="Weryfikacja" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/6_preparation_openstack_environment_windows.png" loading="lazy" />
...
[Zmienne środowiskowe OpenStack](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/).
