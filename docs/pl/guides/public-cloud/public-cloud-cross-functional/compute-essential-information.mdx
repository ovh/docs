...
- [Utwórz pierwszą instancję](/guides/public-cloud/compute/compute-getting-started)
- [Zarządzanie limitami](/guides/public-cloud/public-cloud-cross-functional/increasing-public-cloud-quota)

## Podejście globalne <a id="global-approach"></a>
...
![Public Cloud geolokalizacja](/images/guides/public-cloud/public-cloud-cross-functional/00-essential-info-to-get-started-on-public-cloud/geolocation.png)
...
## Konkretne podejście <a id="concrete-approach"></a>
...
|[Słowniczek](/guides/public-cloud/compute/key-concepts)|Koncepcje i definicje, które będą potrzebne, aby iść naprzód.|
...
|Dokumentacja|Szczegóły|
|---|---|
|[Utwórz pierwszą instancję](/guides/public-cloud/compute/compute-getting-started)|Pierwszy przewodnik dotyczący uruchomienia serwera cloud w Panelu klienta OVHcloud.|
...
|[Konfiguracja prywatnej sieci](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack)|W OVHcloud prywatne sieci opierają się na technologii vRack. Niniejszy przewodnik pomaga Ci w uruchomieniu tej usługi.|
...
|[Konfiguracja Additional IP](/guides/public-cloud/public-cloud-network-services/configure-additional-ip)|Adresy Additional IP pozwalają na przełączanie ruchu z jednej instancji na inną. Niniejszy przewodnik wyjaśnia, jak to skonfigurować.|
...
|[Instalacja CLI OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment)|OpenStack może być również używany w wierszu poleceń. Oto jak zainstalować narzędzia.|
