...
- [Utwórz pierwszą instancję](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)
- [Zarządzanie limitami](/guides/public-cloud/public-cloud-cross-functional/increasing-public-cloud-quota/)
...
<img className="thumbnail" alt="Public Cloud geolokalizacja" src="/images/public-cloud/public-cloud-cross-functional/00-essential-info-to-get-started-on-public-cloud/geolocation.png" loading="lazy" />
...
Następnie [utwórz projekt Public Cloud](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project/). Projekt to środowisko, które będziesz musiał określić jako kontekst.
...
Ponieważ Twój sposób płatności jest zarejestrowany, zostanie wykorzystany do pobrania kwoty obliczonej dla Twojego [fakturowania na koniec miesiąca](/guides/public-cloud/public-cloud-cross-functional/analyze-billing/). Obliczenia te dokonuje się na podstawie czasu wykorzystania każdego zasobu, w zależności od ceny zasobów.
...
<br/>Kwoty te są przyznawane według lokalizacji (region w rozumieniu OpenStack). Możliwe jest zatem, że osiągniesz maksymalny poziom zasobów projektu i [zwiększ limity](/guides/public-cloud/public-cloud-cross-functional/increasing-public-cloud-quota/).
...
- Jeśli chcesz korzystać z interfejsu API OpenStack lub Amazon S3 lub interfejsu Horizon, musisz [utworzyć w tym celu użytkowników](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/). Użytkownicy mogą ewentualnie mieć ograniczone prawa, aby zabezpieczyć zakres działania.
- Jeśli nie potrzebujesz dostępu do API lub interfejsu Horizon, możesz [dołączyć do Twojego projektu inne konto klienta OVHcloud](/guides/public-cloud/public-cloud-cross-functional/delegate-projects/).
...
|---|---|
|[FAQ](/guides/public-cloud/public-cloud-cross-functional/faq-pci/)|Najczęstsze pytania dotyczące usługi Public Cloud.|
|[Słowniczek](/guides/public-cloud/public-cloud-cross-functional/introduction-about-instances/)|Koncepcje i definicje, które będą potrzebne, aby iść naprzód.|
...
|Dokumentacja|Szczegóły|
|---|---|
|[Utwórz pierwszą instancję](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)|Pierwszy przewodnik dotyczący uruchomienia serwera cloud w Panelu klienta OVHcloud.|
|[Korzystanie z klucza SSH](/guides/public-cloud/compute/compute-creating-ssh-keys/)| Aby zalogować się do instancji Linux, zapoznaj się z tym przewodnikiem dotyczącym korzystania z tej instancji.|
|[Konfiguracja prywatnej sieci](/guides/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/)|W OVHcloud prywatne sieci opierają się na technologii vRack. Niniejszy przewodnik pomaga Ci w uruchomieniu tej usługi.|
...
|[Dostęp do interfejsu Horizon](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon/)|Interfejs Horizon OpenStack pozwala na wykonywanie niektórych zaawansowanych operacji.|
|[Utwórz klaster Kubernetes](/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/) (EN)|Niniejszy przewodnik ułatwi Ci realizację pierwszego klastra Kubernetes.|
|[Konfiguracja Additional IP](/guides/public-cloud/public-cloud-network-services/getting-started-04-configure-additional-ip-to-instance/)|Adresy Additional IP pozwalają na przełączanie ruchu z jednej instancji na inną. Niniejszy przewodnik wyjaśnia, jak to skonfigurować.|
|[Korzystanie z interfejsu Horizon](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon/)|Horizon to klasyczny interfejs OpenStack, a ten przewodnik wyjaśni, jak uzyskać do niego dostęp.|
|[Instalacja CLI OpenStack](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/)|OpenStack może być również używany w wierszu poleceń. Oto jak zainstalować narzędzia.|
