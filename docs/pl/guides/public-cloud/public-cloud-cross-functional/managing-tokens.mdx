...
Aby zalogować się do interfejsu Horizon i pobrać plik, zapoznaj się [z tym przewodnikiem](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon/).
