...
![Automatyczna instalacja](/images/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/1_preparation_openstack_environment_windows.png)
...
![Parametry zmiennych środowiskowych](/images/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/2_preparation_openstack_environment_windows.png)

#### Etap 2: edycja parametrów systemu

Przejdź do zakładki `Zaawansowane` i kliknij `Zmienne środowiskowe`, aby edytować parametry.

![Parametry wydajności](/images/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/3_preparation_openstack_environment_windows.png)
...
![Dodanie ścieżki dostępu](/images/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/4_edit_system_variables.png)
...
![Automatyczna instalacja](/images/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/5_preparation_openstack_environment_windows.png)
...
![Weryfikacja](/images/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/6_preparation_openstack_environment_windows.png)
...
[Zmienne środowiskowe OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-set-openstack-environment-variables).
