...
- Aby wyeksportować zmienne środowiskowe, zapoznaj się z tym przewodnikiem: [Zmienne środowiskowe OpenStack](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/).
...
<img className="thumbnail" alt="pobierz plik openRC" src="/images/public-cloud/public-cloud-cross-functional/using-openstack-tokens-for-multiple-calls/openrc.png" loading="lazy" />
