...
If you have an existing OVHcloud account and an active Public Cloud project, you can launch the Data Platform service from the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl).
