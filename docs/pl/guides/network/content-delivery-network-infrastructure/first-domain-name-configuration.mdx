...
W tym celu przejdź do [Panelu klienta](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl) > zakładka <code className="action">Serwery dedykowane</code> > <code className="action">NAS i CDN</code>.
