...
- Posiadanie [konta SMS OVHcloud](https://www.ovhcloud.com/pl/sms/) oraz [walidnego nadawcy SMS](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-expediteurs-sms/).
...
- [Nadawca musi być zdefiniowany w Twoim koncie OVHcloud](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-expediteurs-sms/). Aby przeprowadzić test bez deklaracji nadawcy i używania krótkiego numeru, zastąp `"sender": "Your_sender"` przez `"senderForResponse": true`.
