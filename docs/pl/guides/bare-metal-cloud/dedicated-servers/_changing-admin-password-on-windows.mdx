...
W [Panelu klienta OVHcloud](/links/manager) przejdź do zakładki `IPMI`, aby otworzyć sesję KVM.
...
[Korzystanie z IPMI dla serwerów dedykowanych](/guides/bare-metal-cloud/dedicated-servers/dedicated-servers-ipmi)
