...
- **Link bezpośredni:** [Security Dashboard](https://manager.eu.ovhcloud.com/#/dedicated/network-security/scrubbing-center)
...
Zaloguj się do [Panelu klienta OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl), kliknij <code className="action">Network</code> w menu po lewej stronie ekranu, a następnie <code className="action">Publiczne adresy IP</code>. Upewnij się, że `Tryb zaawansowany` jest włączony, aby sprawdzić stan infrastruktury anty-DDoS i konfigurację jej komponentów
