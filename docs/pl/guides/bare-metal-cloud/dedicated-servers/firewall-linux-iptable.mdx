...
Więcej informacji na temat dostępu do tego narzędzia znajdziesz w [tym przewodniku](/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/).  
