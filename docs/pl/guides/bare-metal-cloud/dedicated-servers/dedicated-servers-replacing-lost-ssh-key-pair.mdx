...
Jeśli do [połączenia z serwerem używasz kluczy SSH](/guides/bare-metal-cloud/dedicated-servers/dedicated-servers-creating-ssh-keys), utrata prywatnego klucza SSH może oznaczać całkowitą utratę dostępu do serwera.
...
Utwórz nową parę kluczy SSH na Twoim komputerze, opisaną w pierwszej części przewodnika ["Tworzenie kluczy SSH"](/guides/bare-metal-cloud/dedicated-servers/dedicated-servers-creating-ssh-keys).
