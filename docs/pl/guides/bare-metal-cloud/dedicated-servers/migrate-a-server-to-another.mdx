...
description: Dowiedz się, jak migrować dane z serwera dedykowanego na inny serwer
...
- Najprostszym sposobem jest użycie odpowiedniego oprogramowania, takiego jak [SFTP](/guides/bare-metal-cloud/dedicated-servers/comment-deposer-ou-recuperer-des-donnees-sur-un-serveur-dedie-via-sftp/).
...
Więcej informacji znajdziesz w naszej dokumentacji dotyczącej [domeny i DNS](/guides/web-cloud/domains/overview/).
