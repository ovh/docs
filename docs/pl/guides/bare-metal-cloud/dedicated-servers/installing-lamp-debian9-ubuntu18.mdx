...
Jeśli dystrybucja Debian lub Ubuntu nie jest już zainstalowana na Twoim serwerze, przeprowadź wstępną instalację w [Panelu klienta OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl). Jest to najlepszy sposób na posiadanie własnego systemu dla Twojego serwera www i aplikacji, które go wykonują.
...
Aby zainstalować system WordPress na serwerze, zapoznaj się [z tym tutorialu](/guides/public-cloud/compute/install-wordpress-on-an-instance/).
...
OVHcloud oferuje również rozwiązanie [SSL Gateway](https://www.ovhcloud.com/pl/security/ssl-gateway/). Więcej informacji znajdziesz w [dokumentacji](/guides/web-cloud/ssl-gateway/order-ssl-gateway/).
...
[Jak pobierać i pobierać dane z serwera za pomocą SFTP](/guides/bare-metal-cloud/dedicated-servers/comment-deposer-ou-recuperer-des-donnees-sur-un-serveur-dedie-via-sftp/)
