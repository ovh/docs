...
Aby skonfigurować ścieżkę rewersu DNS w [Panelu klienta OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl), zapoznaj się z [naszym przewodnikiem](/guides/bare-metal-cloud/virtual-private-servers/configuring-reverse-dns/).
