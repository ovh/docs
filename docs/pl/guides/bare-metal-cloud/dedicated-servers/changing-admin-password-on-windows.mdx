...
Zacznij od zastąpienia netbootu **Uruchom z dysku twardego** w Panelu [klienta OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl) (patrz [Etap 1](#etap-1-restart-serwera-w-trybie-rescue)). 
...
W [Panelu klienta OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl) przejdź do zakładki <code className="action">IPMI</code>, aby otworzyć sesję KVM.
...
[Korzystanie z IPMI dla serwerów dedykowanych](/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/)
