...
:::info
Aby uzyskać dostęp do serwera, z którym łączysz się za pomocą klucza SSH, zapoznaj się z naszym przewodnikiem "[Jak zamienić parę kluczy SSH](/guides/bare-metal-cloud/dedicated-servers/replacing-lost-ssh-key/)".
...
Pamiętaj, aby podczas restartu serwera z poziomu [Panelu klienta OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl) użyć trybu uruchamiania **normalnego** Twojego serwera.
