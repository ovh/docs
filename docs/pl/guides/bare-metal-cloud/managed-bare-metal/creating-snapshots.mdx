...
Right-click on your VM then choose `Snapshots` and finally `Take Snapshot...`:

![Take snapshot](/images/guides/bare-metal-cloud/managed-bare-metal/creating-snapshots/snapshot01.png)
...
![Configure snapshot](/images/guides/bare-metal-cloud/managed-bare-metal/creating-snapshots/snapshot02.png)

### Snapshot management

You can find all snapshots of your VM in the snapshot manager. To do this, right-click on the VM, then choose `Snapshots` and finally `Manage Snapshots`:

![Create snapshots](/images/guides/bare-metal-cloud/managed-bare-metal/creating-snapshots/snapshot03.png)

### Deleting a Snapshot

In the snapshot manager, select the snapshot you want to delete and click `Delete`.

All VM snapshots can be removed in one operation by clicking `Delete All`.

### Restoring a snapshot

In the snapshot manager, select the snapshot to restore and click `Restore`.
...
To perform a consolidation, right-click on the VM, then choose `Snapshots` and finally `Consolidate`

![snapshots](/images/guides/bare-metal-cloud/managed-bare-metal/creating-snapshots/consolidate.png)
