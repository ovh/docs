...
description: Odkryj różne sposoby łączenia się z vSphere
...
<img className="thumbnail" alt="Połączenie z klientem desktopowym" src="/images/bare-metal-cloud/managed-bare-metal/vsphere-interface/connexion_client_l.png" loading="lazy" />
...
<img className="thumbnail" alt="Klient vSphere" src="/images/bare-metal-cloud/managed-bare-metal/vsphere-interface/vsphere-client.png" loading="lazy" />

Uzyskasz następnie dostęp do tego interfejsu:

<img className="thumbnail" alt="Logowanie do vSphere" src="/images/bare-metal-cloud/managed-bare-metal/vsphere-interface/connection_interface_w.png" loading="lazy" />

Na stronie <code className="action">Home</code> znajdziesz główne menu swojego vCenter. Z jego poziomu będziesz mógł wykonywać różne czynności:

- uruchamiać wirtualne maszyny w sekcji <code className="action">Hosts and Clusters</code>;
