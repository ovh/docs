...
![Centrum danych](/images/guides/bare-metal-cloud/managed-bare-metal/using-vrack/images/vRackDatacenter.PNG)

Możesz przenieść *centrum danych* usługi Managed Bare Metal do innego rozwiązania vRack klikając na przycisk `Przenieś`
