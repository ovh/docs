...
description: Zarządzanie hostami zapasowymi w usłudze Managed Bare Metal
...
## 
Po przywróceniu prawidłowego działania hosta i zniknięciu alertów, możesz zwrócić host zapasowy. Wystarczy postępować zgodnie z procedurą opisaną w sekcji "usuwanie hosta" w przewodniku [Jak dodać hosta?](/guides/bare-metal-cloud/managed-bare-metal/delete-host/)
