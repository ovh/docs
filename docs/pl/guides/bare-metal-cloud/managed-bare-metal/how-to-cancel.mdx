...
description: Dowiedz się, jak zrezygnować z infrastruktury Managed Bare Metal
...
- Dostęp do [Panelu klienta OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl) i sekcji <code className="action">Bare Metal Cloud</code>, a następnie <code className="action">Managed Bare Metal</code>
...
Zaloguj się do [Panelu klienta OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl), przejdź do sekcji <code className="action">Bare Metal Cloud</code> (1), kliknij <code className="action">Managed Bare Metal</code> (2) i wybierz serwer z listy (3).
...
<img className="thumbnail" alt="zakończenie usługi w Panelu klienta" src="/images/bare-metal-cloud/managed-bare-metal/how-to-cancel/resiliation1.png" loading="lazy" />
...
<img className="thumbnail" alt="zatwierdzenie rezygnacji" src="/images/bare-metal-cloud/managed-bare-metal/how-to-cancel/resiliation2.png" loading="lazy" />
...
<img className="thumbnail" alt="zatwierdzenie rezygnacji" src="/images/bare-metal-cloud/managed-bare-metal/how-to-cancel/resiliation3.png" loading="lazy" />
...
<img className="thumbnail" alt="zatwierdzenie rezygnacji" src="/images/bare-metal-cloud/managed-bare-metal/how-to-cancel/resiliation4.png" loading="lazy" />
