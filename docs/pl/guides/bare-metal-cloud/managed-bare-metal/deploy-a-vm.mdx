...
![Deploy a VM](/images/guides/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm01.png)
...
![Choose a method](/images/guides/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm02.png)
...
![VM location](/images/guides/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm03.png)
...
![Choose resources](/images/guides/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm04.png)
...
![Choose storage](/images/guides/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm05.png)
...
![Choose compatibility](/images/guides/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm06.png)
...
![Choose guest OS](/images/guides/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm07.png)
...
![Choose network](/images/guides/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm08.png)
...
![Choose ISO](/images/guides/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm09.png)

Once the file is selected, it will be displayed as shown below. Do not forget to tick the option `Connect At Power On`.

![Connect ISO](/images/guides/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm10.png)
...
Click on `FINISH` to finalise the deployment.

![Summary VM](/images/guides/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm11.png)
...
![Starting VM](/images/guides/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm12.png)
...
![Console VM](/images/guides/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm13.png)
