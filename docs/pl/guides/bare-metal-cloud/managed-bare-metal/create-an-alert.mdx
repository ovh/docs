...
To create an alert, right-click on the datacentre or any other item you want to monitor, and then click on `Alarms` and `New Alarm Definition`.

![Alert creation](/images/guides/bare-metal-cloud/managed-bare-metal/create-an-alert/alarms01.png)

### Setting name and target

The first step is to name the alert and set its target. You can also add a description.

![Name and target](/images/guides/bare-metal-cloud/managed-bare-metal/create-an-alert/alarms02.png)
...
![Alert rules](/images/guides/bare-metal-cloud/managed-bare-metal/create-an-alert/alarms03.png)
...
![Suspending an alert](/images/guides/bare-metal-cloud/managed-bare-metal/create-an-alert/alarms04.png)
...
![Alert summary](/images/guides/bare-metal-cloud/managed-bare-metal/create-an-alert/alarms05.png)
