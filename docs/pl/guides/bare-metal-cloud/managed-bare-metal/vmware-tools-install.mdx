...
To mount the VMware tools disk from the Vsphere web client, right-click on the VM, then click on `Guest OS` and finally on `Install VMware Tools`. 

![installer VMware Tools](/images/guides/bare-metal-cloud/managed-bare-metal/vmware-tools-install/tools.png)
...
![VMware tools windows](/images/guides/bare-metal-cloud/managed-bare-metal/vmware-tools-install/windows.jpg)
