...
![empreinte du certificat](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/certificate_thumbprints_01.png)

![empreinte du certificat](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/certificate_thumbprints_02.png)
...
W Panelu klienta przejdź do sekcji `Bare Metal Cloud`. Kliknij `Managed Bare Metal` na pasku usług po lewej stronie, po czym wybierz odpowiednią usługę Managed Bare Metal.

Na stronie głównej usługi kliknij opcję `Bezpieczeństwo`.

![espace client OVHcloud](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_nupanel_01.png)
...
Rozpocznij operację, logując się do usługi Managed Bare Metal przy użyciu klienta Web vSphere. Następnie przejrzyj listę zasobów i wybierz vCenter. Kliknij opcję "Zarządzaj", a następnie "Key Management Servers". Kliknij `Dodaj KMS`, a w asystencie, który się pojawi, podaj informacje o KMS i kliknij `OK`.
Kliknij `Trust`, aby zatwierdzić certyfikat.

![procédure ajout clé KMS](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_01.png)
...
![import certificat KMS](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_02.png)

#### Sprawdzanie konfiguracji KMS

Sprawdź, czy **Connection Status** odpowiadający serwerowi KMS jest w trybie "Normal".

![vérifier connection status](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_03.png)
...
![Zaszyfrowany vMotion](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_06.png)
...
![vérification de la configuration](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_07.png)

![vérification de la configuration](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_08.png)

![vérification de la configuration](/images/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/images/vm-encrypt_09.png)
