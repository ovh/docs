...
Aby znaleźć swoje Vault, kliknij [ten link](https://manager.eu.ovhcloud.com/#/bmc-backup-agent-baremetal/service), aby uzyskać dostęp do sekcji <code className="action">Backup Agent</code>, a następnie kliknij kartę <code className="action">Vaults</code>.
