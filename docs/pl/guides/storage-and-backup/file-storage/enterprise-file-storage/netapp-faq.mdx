...
Tak, usługa ta jest dostępna bezpośrednio w [Panelu klienta OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl), w sekcji <code className="action">Bare Metal Cloud</code>, następnie <code className="action">Storage i Backup</code>.
