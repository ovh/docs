...
Podczas gdy standardowe użycie woluminu jest opłacane za GB/miesiąc, [snapshots](/guides/public-cloud/compute/creating-a-volume-snapshot/) przechowywane na **Block Storage** i [kopie zapasowe](/guides/public-cloud/compute/volume-backup/) przechowywane na **Object Storage** mogą generować dodatkowe koszty magazynowania. Zrzuty ekranu pozwalają przechwycić stan woluminu w danym momencie, a kopie zapasowe umożliwiają ochronę danych i ich odzyskanie.
...
Jeśli potrzebujesz szkoleń lub pomocy technicznej w wdrożeniu naszych rozwiązań, skontaktuj się ze swoim przedstawicielem handlowym lub kliknij [ten link](https://www.ovhcloud.com/pl/professional-services/), aby uzyskać wycenę i zażądać indywidualnej analizy Twojego projektu od zespołu Professional Services.
