...
- [Przygotowanie środowiska do korzystania z API OpenStack](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/) za pomoca klienta python-swiftclient
