...
Za pomocą tego [przewodnika](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/) możesz wygenerować identyfikator klienta i hasło OpenStack.
