...
- [Przygotowanie środowiska do korzystania z API OpenStack](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/) poprzez instalację python-swiftclient
- [Pobranie zmiennych środowiskowych OpenStack](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/)
...
Ten adres URL składa się z punktu zakończenia dostępnego w [interfejsie Horizon](/guides/public-cloud/public-cloud-cross-functional/access-and-security-in-horizon/), nazwy kontenera i nazwy obiektu (w tym prefiksu).
