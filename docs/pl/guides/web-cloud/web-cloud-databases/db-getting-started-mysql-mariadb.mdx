...
- Przeglądanie [przewodnik dotyczący uruchomienia usługi Web Cloud Databases](/guides/web-cloud/web-cloud-databases/db-getting-started)
...
> [!info]
>
> W niektórych przypadkach pamięć RAM dostępna w Twojej instancji Web Cloud Databases może nie powodować odpowiedniego eksportu lub importu. W takim przypadku zalecamy użycie narzędzia OVHcloud w Panelu klienta. W razie potrzeby skorzystaj z dokumentacji ["Pierwsze kroki z usługą Web Cloud Databases"](/guides/web-cloud/web-cloud-databases/db-getting-started).
>
