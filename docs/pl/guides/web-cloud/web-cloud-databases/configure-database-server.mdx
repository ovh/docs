...
Aby odłączyć usługę Web Cloud Databases od hostingu **Performance**, zapoznaj się z naszym przewodnikiem "[Odłączenie rozwiązania Web Cloud Databases od hostingu WWW](/guides/web-cloud/web-cloud-databases/detach-from-web-hosting/)".
...
Aby uzyskać dostęp do logów rozwiązania Web Cloud Databases, zapoznaj się z naszym przewodnikiem "[Web Cloud Databases - Jak pobrać logi](/guides/web-cloud/web-cloud-databases/retrieve-logs/)".
