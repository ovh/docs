...
> [!info]
>
> Pour vous accompagner au mieux dans le rétablissement de vos services, vous avez également la possibilité d'utiliser notre assistant de dépannage. Pour y accéder, connectez-vous à votre [espace client OVHcloud](/links/manager) dans la section « Télécom ». Une fois positionné sur l'accès Internet concerné, cliquez sur `Lancer le diagnostic`. 
>
...
### Aucun voyant n'est allumé <a id="aucun-voyant"></a>
...
|---|---|
|Zyxel DX3301-T0|![Zyxel DX3301-T0](/images/guides/web-cloud/internet/internet-access/interruption-de-service/zyxel-dx3301-t0.png)|
|Zyxel VMG8825-T50|![Zyxel VMG8825-T50](/images/guides/web-cloud/internet/internet-access/interruption-de-service/zyxel-vmg8825-t50.png)|
|Zyxel VMG8623-T50B|![Zyxel VMG8623-T50B](/images/guides/web-cloud/internet/internet-access/interruption-de-service/zyxel-vmg8623-t50b.png)|
|Zyxel VMG8924-B10D|![Zyxel VMG8924-B10D](/images/guides/web-cloud/internet/internet-access/interruption-de-service/zyxelb10d_power.jpg)|
|Zyxel VMG8823-B50B|![Zyxel VMG8823-B50B](/images/guides/web-cloud/internet/internet-access/interruption-de-service/zyxelb50b_power.jpg)|
|Technicolor TG789vn|![Technicolor TG789vn](/images/guides/web-cloud/internet/internet-access/interruption-de-service/TG789_power.png)|
|Technicolor TG799vac|![Technicolor TG799vac](/images/guides/web-cloud/internet/internet-access/interruption-de-service/TG799_power.jpg)|
|Technicolor TG788vn|![Technicolor TG788vn](/images/guides/web-cloud/internet/internet-access/interruption-de-service/TG788v1_power.png)|
|Technicolor TG788vn v2|![Technicolor TG788vn v2](/images/guides/web-cloud/internet/internet-access/interruption-de-service/TG788v2_power.png)|
...
### Des voyants sont allumés (clignotants ou fixes) <a id="voyants-allumes"></a>
...
> [!warning]
>
> Avant de poursuivre, vérifiez si votre accès est affecté par un incident en cours en vous rendant sur les liens suivants : [https://status.isp.ovh.net/](https://status.isp.ovh.net/) et [https://web-cloud.status-ovhcloud.com/](https://web-cloud.status-ovhcloud.com/). Si c'est le cas, prenez connaissance des éléments renseignés sur la page, puis patientez le temps de sa résolution.
>
