...
1. Positionnez-vous alors sur l'onglet `Mon modem`.
...
![configureremotelybox](/images/guides/web-cloud/internet/internet-access/configuration-du-modem-a-partir-de-votre-espace-client/configure-remotely-box-step1-2022.png)

<a id="custom-configuration"></a>

### Étape 2 : personnaliser la configuration de votre box

Pour paramétrer votre box depuis l'[espace client OVHcloud](/links/manager), assurez-vous d'être positionné sur l'onglet `Mon modem` de l'accès à Internet concerné. **Pour rappel, il est impératif que la configuration à distance soit activée pour que cette gestion soit possible.**

Depuis l'onglet `Mon modem`, vous retrouvez alors plusieurs sections. Chacune d'elles permet d'interagir avec la configuration de votre box. Poursuivez alors selon la manipulation que vous souhaitez effectuer :
...
Vous avez la possibilité d'actualiser cette liste en cliquant sur le bouton `Rafraîchir`.

![configureremotelybox](/images/guides/web-cloud/internet/internet-access/configuration-du-modem-a-partir-de-votre-espace-client/configure-remotely-box-step2.png)

#### 2.2 Configuration générale

Depuis cette partie, plusieurs possibilités s'offrent à vous.

- **Redémarrer à distance votre box** : pour cela, cliquez sur le bouton `Redémarrer le modem` puis confirmez l'action. Patientez alors le temps que votre box redémarre.
...
- **Paramétrer l'utilisation du réseau Wi-Fi** : cochez la case à côté de `Wi-Fi activé` pour décider d'activer ou de désactiver son utilisation. Pour accéder à la page des paramètres Wi-Fi, cliquez sur `Configurer le Wi-Fi`.

![configureremotelybox](/images/guides/web-cloud/internet/internet-access/configuration-du-modem-a-partir-de-votre-espace-client/configure-remotely-box-step3.png)
...
Une fois le réseau Wi-Fi modifié, cliquez sur le bouton `Valider`.

![configureremotelybox](/images/guides/web-cloud/internet/internet-access/configuration-du-modem-a-partir-de-votre-espace-client/configure-remotely-box-step4.png)
...
![configureremotelybox](/images/guides/web-cloud/internet/internet-access/configuration-du-modem-a-partir-de-votre-espace-client/configure-remotely-box-step5.png)
...
![configureremotelybox](/images/guides/web-cloud/internet/internet-access/configuration-du-modem-a-partir-de-votre-espace-client/configure-remotely-box-step6.png)
...
Pour cela, cliquez sur le bouton `Ajouter un Bail` puis complétez les informations demandées. 
...
![configureremotelybox](/images/guides/web-cloud/internet/internet-access/configuration-du-modem-a-partir-de-votre-espace-client/configure-remotely-box-step7.png)
...
Pour cela, cliquez sur le bouton `Ajouter une Redirection de Ports` puis complétez les informations demandées. 
...
![configureremotelybox](/images/guides/web-cloud/internet/internet-access/configuration-du-modem-a-partir-de-votre-espace-client/configure-remotely-box-step8.png)

#### 2.4 Configurations avancées

Depuis cette partie, plusieurs possibilités s'offrent à vous.

- **Réinitialiser votre box** : permet de réinitialiser les paramètres de votre box, tout en conservant les configurations définies dans votre espace client. Pour cela, cliquez sur le bouton `Réinitialiser le modem` puis confirmez l'action. Patientez alors le temps que la manipulation s'effectue.

- **Réinitialiser la configuration OVHcloud** : permet de réinitialiser les paramètres de votre box sans conserver les configurations définies dans votre espace client. Pour cela, cliquez sur le bouton `Réinitialiser la configuration OVH` puis confirmez l'action. Patientez alors le temps que la manipulation s'effectue.
...
Pour le modifier, sélectionnez la nouvelle valeur dans la liste déroulante puis cliquez sur `Valider`.
...
Pour configurer une DMZ, cliquez sur le bouton `Configurer` en dessous de DMZ. Dans la nouvelle page, sélectionnez le bouton d'action à droite du tableau, éditez l'adresse IP de la DMZ, puis validez la manipulation en cliquant sur le bouton d'action correspondant.
...
Pour cela, choisissez dans la liste le fichier de configuration que vous souhaitez appliquer, puis cliquez sur le bouton `Valider`.

![configureremotelybox](/images/guides/web-cloud/internet/internet-access/configuration-du-modem-a-partir-de-votre-espace-client/configure-remotely-box-step9.png)
...
![configureremotelybox](/images/guides/web-cloud/internet/internet-access/configuration-du-modem-a-partir-de-votre-espace-client/configure-remotely-box-step10.png)
