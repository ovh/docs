...
Connectez-vous à votre [espace client OVHcloud](/links/manager), partie `Telecom`.<br />
Cliquez sur `OverThebox` dans la barre de services à gauche, puis sélectionnez le service OverTheBox auquel vous souhaitez acceder à distance.<br />
...
- Validez la création à l'aide du bouton `Valider`.
...
![overthebox](/images/guides/web-cloud/internet/overthebox/middle-acces-a-distance/step1-create-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/middle-acces-a-distance/step2-connecthttps-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/middle-acces-a-distance/step2-connectssh-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/middle-acces-a-distance/step3-delete-2024.png)
