...
<img className="thumbnail" alt="sms-users" src="/images/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms/smsusers.png" loading="lazy" />
...
<img className="thumbnail" alt="sms-users" src="/images/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms/smsusers01e-2021.png" loading="lazy" />
...
<img className="thumbnail" alt="sms-users" src="/images/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms/smsusers03e-2021.png" loading="lazy" />
...
<img className="thumbnail" alt="sms-users" src="/images/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms/smsusers04-2021.png" loading="lazy" />
...
<img className="thumbnail" alt="sms-users" src="/images/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms/smsusers05-2021.png" loading="lazy" />
...
<img className="thumbnail" alt="sms-users" src="/images/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms/smsusers06-2021.png" loading="lazy" />

Aby uzyskać więcej informacji na temat funkcji http2sms, przeczytaj przewodnik [Wysyłanie wiadomości SMS z adresu URL](/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-url---http2sms/).
...
<img className="thumbnail" alt="sms-users" src="/images/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms/smsusers07-2021.png" loading="lazy" />
