...
- Utworzenie użytkownika SMS w Panelu klienta OVHcloud lub bezpośrednio przez interfejs API. W tym celu zapoznaj się z następującym przewodnikiem: [Informacje o użytkownikach wiadomości SMS](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms/)
...
<img className="thumbnail" alt="Lista znaków SMS" src="/images/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-url---http2sms/smsauthorizedcharacters.png" loading="lazy" />
