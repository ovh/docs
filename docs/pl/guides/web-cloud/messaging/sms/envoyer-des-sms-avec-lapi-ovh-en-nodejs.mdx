...
<img className="thumbnail" alt="tworzenie tokenów" src="/images/web-cloud/messaging/sms/envoyer-des-sms-avec-lapi-ovh-en-nodejs/img_2462.jpg" loading="lazy" />
...
<img className="thumbnail" alt="pozyskiwanie tokenów" src="/images/web-cloud/messaging/sms/envoyer-des-sms-avec-lapi-ovh-en-nodejs/img_2463.jpg" loading="lazy" />
