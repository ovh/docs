...
![delegacja uprawnień exchange](/images/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/feature-delegation/delegation-step1.png)
...
![delegacja uprawnień exchange](/images/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/feature-delegation/delegation-step2.png)

Sprawdź dokładnie podsumowanie zmian. Jeśli są poprawne, kliknij `Zatwierdź`. W ciągu kilku minut uprawnienia zostaną utworzone na serwerach OVHcloud.
...
Kliknij link [Webmail](/links/web/email) i wprowadź dane dostępowe do konta e-mail, dla którego udzielone zastało dane prawo. Po zalogowaniu kliknij prawym przyciskiem myszy nazwę konta w menu po lewej stronie, następnie zaznacz `Dodaj współdzielony katalog`.
...
![delegacja uprawnień exchange](/images/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/feature-delegation/delegation-step3.png)
...
Przejdź do programu Outlook i kliknij `Plik` na pasku menu na górze ekranu, a następnie kliknij `Ustawienia konta`. W rozwijanym menu kliknij ponownie `Parametry konta`. W oknie, które się wyświetla wybierz konto, którego dotyczy przydzielone prawo, a następnie kliknij `Modyfikuj`. 

![delegacja uprawnień exchange](/images/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/feature-delegation/delegation-step4.png)
...
![delegacja uprawnień exchange](/images/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/feature-delegation/delegation-step5.png)

#### 2.2 Korzystanie z "prawa do wysyłki poczty"

- **Przy użyciu webmail Outlook Web App (OWA)**

Kliknij link [Webmail](/links/web/email) i wprowadź dane dostępowe do konta e-mail, dla którego udzielone zastało dane prawo. Po zalogowaniu się kliknij przycisk `Nowa wiadomość` i rozpocznij pisanie e-maila.
...
![delegacja uprawnień exchange](/images/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/feature-delegation/delegation-step6.png)
...
Po otwarciu programu Outlook zacznij pisać nową wiadomość. Upewnij się, czy przycisk `Od` wyświetla się w oknie wiadomości. Jeśli nie wyświetla się, przejdź do zakładki `Opcje`, następnie kliknij `Wyświetl "Od"`.
...
![delegacja uprawnień exchange](/images/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/feature-delegation/delegation-step7.png)
