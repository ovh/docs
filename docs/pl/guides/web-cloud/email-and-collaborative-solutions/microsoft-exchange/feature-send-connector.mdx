...
<Api version="v1" section="/email/exchange" method="GET" route={"email/exchange/\\{organizationName\\}/service/\\{exchangeService\\}/sendConnector"} />Dans la section **PATH PARAMETERS** :
