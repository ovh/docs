...
Aby przeczytać ten e-mail w [Panelu klienta OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl), kliknij swój profil w prawym górnym rogu, a następnie wybierz <code className="action">E-maile od OVHcloud</code> i wyszukaj e-mail z następującym tematem:
