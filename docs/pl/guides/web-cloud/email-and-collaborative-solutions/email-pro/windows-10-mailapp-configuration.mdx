...
### Dodanie konta <a id="add-account"></a>
...
- Otwórz aplikację Outlook. W lewym menu kliknij przycisk `Dodaj konto`, aby rozpocząć konfigurację.
...
- Wprowadź swój adres e-mail, a następnie kliknij przycisk `Dalej`.
- Wprowadź swoje hasło i kliknij przycisk `Pokaż więcej`.
...
- Kliknij przycisk `Dalej`, aby zakończyć konfigurację.
...
### Użycie adresu e-mail <a id="use-account"></a>
...
### Modyfikacja istniejących ustawień <a id="modify-settings"></a>
...
- W sekcji "Twoje konta" kliknij przycisk `Zarządzaj` obok odpowiedniego adresu e-mail.
...
- Kliknij przycisk `Usuń`, aby rozpocząć proces usuwania.
...
### Ogólne ustawienia wysyłania i odbierania <a id="settings-account"></a>

#### Ustawienia IMAP i POP dla odbierania wiadomości <a id="imap-pop"></a>
...
#### Ustawienia SMTP dla wysyłania wiadomości <a id="smtp"></a>
