...
> 1. Kliknij `E-mail Pro`.
> 1. Wybierz odpowiednią platformę.
> 1. Nazwa serwera jest widoczna w sekcji **Logowanie** karty `Informacje ogólne`.
...
Gdy Thunderbird wykryje nazwę domeny OVHcloud, zostanie zaproponowana automatyczna konfiguracja oferty MX Plan. Kliknij `ZMIEN KONFIGURACJĘ`.
...
Wprowadź hasło przypisane do adresu e-mail i kliknij `Dalej`, aby ukończyć konfigurację.
...
- Aby zmienić ustawienia dotyczące **odbioru** wiadomości e-mail, kliknij `Ustawienia serwera` w lewej kolumnie pod swoim adresem e-mail.
...
- Aby zmienić ustawienia dotyczące **wysyłania** wiadomości e-mail, kliknij `Serwer wychodzący (SMTP)` na dole lewej kolumny.
- Kliknij odpowiedni adres e-mail w liście, a następnie kliknij `Edytuj`.
