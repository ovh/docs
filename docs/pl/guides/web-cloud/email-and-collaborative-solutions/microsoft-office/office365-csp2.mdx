...
Aby zamówić usługę Office 365 Reseller, przejdź do [Panelu klienta OVHcloud](/links/manager). Po zalogowaniu wybierz `Sunrise` na górnym pasku, a następnie kliknij `Office 365 Reseller`.
...
- Kliknij na `Zamów`, aby sfinalizować.
...
W tym celu przejdź do sekcji `Sunrise`. W menu po lewej stronie wybierz `Office 365 Reseller` i wybierz usługę.
