...
Aby uzyskać dostęp do frameworków Twojego hostingu Cloud Web, zaloguj się do [panelu klienta OVHcloud](/links/manager). Po zalogowaniu kliknij `Hosting` na pasku usług po lewej stronie, następnie wybierz odpowiedni hosting Cloud Web. Teraz przejdź do karty `Frameworki`.
...
![cloud web hosting ssd](/images/assets/screens/control-panel/product-selection/web-cloud/cloud-web/runtime-software-application/tab-phpfpm7-4.png)

### Etap 2: zarządzanie frameworkami

Istnieje kilka sposobów zarządzania frameworkami hostingu Cloud Web:

- dodanie lub zmiana frameworku (maksymalna liczba frameworków zależy od [wybranej oferty](/links/web/hosting-cloud-web-offer));
...
Aby dodać lub zmienić framework, przejdź do karty`Frameworki` odpowiedniego hostingu Cloud Web. Następnie:
...
Po uzupełnieniu informacji, kliknij przycisk `Zatwierdź`. Upewnij się teraz, czy framework jest używany przez odpowiednie strony podpięte w opcji MultiSite. W tym celu przejdź do etapu 3: [Powiązanie frameworka ze stroną podpiętą w opcji MultiSite](#etap-3-powiazanie-frameworka-ze-strona-podpieta-w-opcji-multisite).
...
![cloud web hosting ssd](/images/assets/screens/control-panel/product-selection/web-cloud/cloud-web/runtime-software-application/modify-a-runtime-software-application-nodejs8.png)
...
![cloud web hosting ssd](/images/assets/screens/control-panel/product-selection/web-cloud/cloud-web/runtime-software-application/modify-a-runtime-software-application-ruby2-6.png)
...
![cloud web hosting ssd](/images/assets/screens/control-panel/product-selection/web-cloud/cloud-web/runtime-software-application/modify-a-runtime-software-application-python3.png)
...
> 
> Równoległe wykorzystanie dwóch frameworków w Twoim hostingu Cloud Web zależy od [wybranej oferty](/links/web/hosting-cloud-web-offer).
> 
...
![cloud web hosting ssd](/images/assets/screens/control-panel/product-selection/web-cloud/cloud-web/runtime-software-application/runtime-software-applications.png)
...
![cloud web hosting ssd](/images/assets/screens/control-panel/product-selection/web-cloud/cloud-web/multisite/modify-a-domain-step-1.png)
