...
Zamówienie możesz również złożyć w [Panelu klienta OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl). Po zalogowaniu wykonaj następujące instrukcje:
...
:::info
OVHcloud oferuje serwery baz danych Web Cloud Databases. Jeśli chcesz korzystać z tej oferty na swojej stronie internetowej, zapoznaj się z naszą dokumentacją dotyczącą tego produktu [na naszej stronie](/guides/web-cloud/web-cloud-databases/overview/).
