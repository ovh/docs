...
Aby wygenerować link do pobrania, zaloguj się do [Panelu klienta OVHcloud](/links/manager), przejdź do sekcji `Web Cloud`, kliknij `Hosting`, a następnie odpowiednią usługę Cloud Web. 

Wybierz kartę `FTP - SSH` i kliknij przycisk `Wygeneruj kopię zapasową` po prawej stronie.

![kopia zapasowa](/images/assets/screens/control-panel/product-selection/web-cloud/cloud-web/ftp-ssh/generate-a-backup.png)

W oknie, które się otworzy wybierz jedną z dostępnych kopii zapasowych, po czym kliknij `Dalej`.

![kopia zapasowa](/images/assets/screens/control-panel/product-selection/web-cloud/cloud-web/ftp-ssh/generate-a-backup-step-1.png)
...
![kopia zapasowa](/images/assets/screens/control-panel/product-selection/web-cloud/cloud-web/ftp-ssh/generate-a-backup-step-2.png)

Kliknij na `Zatwierdź`, aby potwierdzić zlecenie.

Jeśli wygenerowana zostanie kopia zapasowa, w [Panelu klienta OVHcloud](/links/manager) pojawi się następujący komunikat:

![kopia zapasowa](/images/assets/screens/control-panel/product-selection/web-cloud/cloud-web/ftp-ssh/message-backup-progress.png)
...
![kopia zapasowa](/images/assets/screens/email-sending-to-customer/cloud-web/backup-information.png)
