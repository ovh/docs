...
Jeśli chcesz utworzyć nową bazę danych w OVHcloud, zaloguj się do [Panelu klienta](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl) i kliknij <code className="action">Hosting</code>. Zaznacz nazwę odpowiedniego hostingu i przejdź do zakładki <code className="action">Baza danych</code>.
