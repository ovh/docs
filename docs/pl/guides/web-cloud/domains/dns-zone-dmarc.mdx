...
Rekord DMARC możesz dodać do strefy DNS w Panelu klienta OVHcloud. W tym celu zaloguj się do [Panelu klienta OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl) i przejdź do sekcji <code className="action">Web Cloud</code>. W lewej kolumnie wybierz w sekcji <code className="action">Nazwy domen</code> odpowiednią nazwę domeny, następnie kliknij na zakładkę <code className="action">Strefa DNS</code>, aby przejść do strefy DNS.
...
Możesz dodać rekord TXT do strefy DNS w [Panelu klienta OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl) i przejść do sekcji <code className="action">Web Cloud</code>. Kliknij <code className="action">Domeny</code>, następnie nazwę wybranej nazwy domeny. Teraz przejdź do zakładki <code className="action">Strefa DNS</code>.
