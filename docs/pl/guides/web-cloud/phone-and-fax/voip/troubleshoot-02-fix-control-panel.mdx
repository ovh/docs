...
![logigramme de dépannage](/images/guides/web-cloud/phone-and-fax/voip/troubleshoot-02-fix-control-panel/logigramme-voip-v2.png)

### Étape 1 - Etablir un premier diagnostic <a id="step1"></a>
...
### Étape 2 - Réinitialiser le téléphone <a id="step2"></a>
...
1\. Maintenez enfoncée la touche `Redial` 🔄 .<br /><br />![touche redial](/images/guides/web-cloud/phone-and-fax/voip/troubleshoot-02-fix-control-panel/t58wpro-redial.png).<br />2\. Validez la demande de réinitialisation affichée à l'écran du téléphone.
...
### Étape 3 - Dépanner le téléphone depuis l'espace client OVHcloud <a id="step3"></a>
...
1. Rendez-vous dans l'onglet `Assistance` et cliquez sur le bouton `Dépannage Plug & Phone`.

![dépannage-plug-and-phone](/images/guides/web-cloud/phone-and-fax/voip/troubleshoot-02-fix-control-panel/control-panel01.png)
...
![dépannage-plug-and-phone](/images/guides/web-cloud/phone-and-fax/voip/troubleshoot-02-fix-control-panel/control-panel02.png)
...
### Étape 4 - Effectuer des tests complémentaires (facultatif) <a id="step4"></a>
...
#### 4.1 Réinitialiser votre routeur / modem / Box Internet <a id="step4-1"></a>
...
#### 4.2 Effectuer un test croisé <a id="step4-2"></a>
...
### Étape 5 - Contacter l'assistance OVHcloud <a id="step5"></a>
