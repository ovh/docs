...
![local\_logstash\_graylog](/images/guides/manage-and-operate/observability/logs-data-platform/ingestion-logstash-dedicated-input/local_logstash_graylog.png)
...
![logstash_creation](/images/guides/manage-and-operate/observability/logs-data-platform/ingestion-logstash-dedicated-input/logstash_created.png)
...
Click on `Next` button to display the Logstash Configuration Page as follows:

![logstash_creation](/images/guides/manage-and-operate/observability/logs-data-platform/ingestion-logstash-dedicated-input/config_logstash_1.png)
...
![logstash_creation](/images/guides/manage-and-operate/observability/logs-data-platform/ingestion-logstash-dedicated-input/input_section.png)
...
![logstash_creation](/images/guides/manage-and-operate/observability/logs-data-platform/ingestion-logstash-dedicated-input/filter_section.png)
...
To validate the settings, you will have to click on `Test the configuration` button. After some fancy calculations you should see on the screen a green confirmation.

![logstash_testing](/images/guides/manage-and-operate/observability/logs-data-platform/ingestion-logstash-dedicated-input/test_success.png)
...
![input_start](/images/guides/manage-and-operate/observability/logs-data-platform/ingestion-logstash-dedicated-input/input_start.png)
...
![logs_graylog](/images/guides/manage-and-operate/observability/logs-data-platform/ingestion-logstash-dedicated-input/logstash_ssl.png)
...
![input_ca](/images/guides/manage-and-operate/observability/logs-data-platform/ingestion-logstash-dedicated-input/input_ca.png)
...
To do this, please go to the dedicated page by clicking on the `Console output` button.

![input_console](/images/guides/manage-and-operate/observability/logs-data-platform/ingestion-logstash-dedicated-input/input_console.png)
