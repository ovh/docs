...
The best feature is the ability to mix criteria, based on what is important to you. For example, `facility:auth AND level:6`. Why not [create an alert](/guides/manage-and-operate/observability/logs-data-platform/alerting-stream/) on this condition?
