...
![apache Logs](/images/guides/manage-and-operate/observability/logs-data-platform/ingestion-apache/apache-logs.png)
...
To keep things brief, this extract has only the parts relevant to the access log file. [The syslog-ng tutorial](/guides/manage-and-operate/observability/logs-data-platform/how-to-log-your-linux) covers the configuration for any syslog file (like the error log file). This configuration is only valid for syslog-ng 3.8+.
