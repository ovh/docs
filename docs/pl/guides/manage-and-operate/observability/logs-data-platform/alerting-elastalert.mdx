...
If you only have [indices](/guides/manage-and-operate/observability/logs-data-platform/opensearch-index/), you can use them directly in the ElastAlert configuration.
...
- `<password>` is the associated password. You can use [tokens](/guides/manage-and-operate/observability/logs-data-platform/security-tokens/) in place of the username/password couple for your credentials.
...
To test your alert you can use the following curl command sending logs to our [OpenSearch endpoint](/guides/manage-and-operate/observability/logs-data-platform/ingestion-opensearch-api-mutualized-input/):
