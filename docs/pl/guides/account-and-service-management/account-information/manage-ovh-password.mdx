...
- Na stronie [Bezpieczeństwo konta](https://manager.eu.ovhcloud.com/#/account/useraccount/security) kliknij <code className="action">Zmień</code> po prawej stronie "Password".
