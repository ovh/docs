...
- **Link bezpośredni:** [Mój profil](https://manager.eu.ovhcloud.com/#/account/useraccount/infos)
...
Aby wprowadzić ten adres zapasowy, przejdź do swojego [profilu użytkownika](https://manager.eu.ovhcloud.com/#/account/useraccount/infos).
...
Możesz zmienić informacje o swoim koncie. Przejdź do swojego [profilu użytkownika](https://manager.eu.ovhcloud.com/#/account/useraccount/infos).
