...
Najpierw sprawdź, czy otrzymana wiadomość e-mail jest również widoczna na stronie [Moje wiadomości](https://manager.eu.ovhcloud.com/#/communication). Znajdziesz tam kopie wszystkich oficjalnych wiadomości wysłanych przez OVHcloud.
...
Przejdź na stronę [Bezpieczeństwo](https://manager.eu.ovhcloud.com/#/account/useraccount/security) i zmień hasło.
