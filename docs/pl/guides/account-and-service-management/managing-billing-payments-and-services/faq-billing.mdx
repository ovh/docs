...
Lista kontaktów dla Twoich usług jest dostępna bezpośrednio na stronie [Zarządzanie kontaktami](https://manager.eu.ovhcloud.com/#/account/contacts/services).
...
Twoje dane do faktury to dane przypisane do Twojego identyfikatora klienta. Aby zostały one zaktualizowane na kolejnych fakturach, wystarczy, że zmienisz swoje dane na stronie [Mój profil](https://manager.eu.ovhcloud.com/#/account/useraccount/infos).
...
Aby sprawdzić status Twoich usług, otwórz stronę [Moje rozwiązania i usługi](https://manager.eu.ovhcloud.com/#/billing/autorenew/services).
...
Na stronie [Moje sposoby płatności](https://manager.eu.ovhcloud.com/#/billing/payment/method) kliknij <code className="action">Dodaj sposób płatności</code>.

### W jaki sposób zaktualizować sposób płatności?

Na stronie [Moje sposoby płatności](https://manager.eu.ovhcloud.com/#/billing/payment/method) możesz dodać lub usunąć dany sposób płatności (karta płatnicza, PayPal lub przelew SEPA).
...
Na stronie [Moje sposoby płatności](https://manager.eu.ovhcloud.com/#/billing/payment/method) wyszukaj sposób płatności, który chcesz usunąć i kliknij ikonę kosza.
...
Daty odnowienia usług znajdziesz na stronie [Moje rozwiązania i usługi](https://manager.eu.ovhcloud.com/#/billing/autorenew/services).
...
Na stronie [Moje rozwiązania i usługi](https://manager.eu.ovhcloud.com/#/billing/autorenew/services) będziesz mógł zmienić częstotliwość odnawiania Twoich rozwiązań.
Jeśli chcesz dowiedzieć się więcej na ten temat, zapraszamy do zapoznania się z treścią przewodnika: [Zarządzanie odnawianiem usług](/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/).
...
Otwórz stronę [Faktury](https://manager.eu.ovhcloud.com/#/billing/history).

#### Wskazówki i porady

Jeżeli faktura nie widnieje w Panelu klienta, możliwe, że Twoje dane nie pokrywają się z danymi kontaktu księgowego dla powiązanej z fakturą usługi. Aby sprawdzić kontakt księgowy i ewentualnie zmodyfikować jego dane, otwórz stronę [Zarządzanie kontaktami](https://manager.eu.ovhcloud.com/#/account/contacts/services).
...
Na stronie [Moje sposoby płatności](https://manager.eu.ovhcloud.com/#/billing/payment/method) możesz zapisać Twój sposób płatności. Umożliwi Ci to opłacanie faktur w sposób automatyczny.
...
Jeśli chcesz dowiedzieć się więcej na ten temat, zapraszamy do zapoznania się z treścią przewodnika: [Rozliczanie należności za usługę Public Cloud](/guides/public-cloud/public-cloud-cross-functional/analyze-billing/).
...
Aby pobrać fakturę, otwórz stronę [Faktury](https://manager.eu.ovhcloud.com/#/billing/history). Następnie kliknij przycisk <code className="action">Operacje</code> i wybierz <code className="action">Eksport CSV</code>.
