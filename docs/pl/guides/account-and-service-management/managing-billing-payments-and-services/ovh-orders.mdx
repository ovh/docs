...
![Zamówienie OVH](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order01.png)
...
Aby uzyskać dostęp do panelu zarządzania zamówieniami, zaloguj się do [Panelu klienta OVHcloud](/links/manager). Na stronie, która się wyświetli kliknij `Wyświetl moje zamówienia`.

![Panel klienta](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/huborders.png)

Poniżej zamieszczamy podsumowanie różnych wcześniejszych zamówień:

![Podsumowanie zamówień](/images/assets/screens/control-panel/product-selection/right-column/initials/order-tab.png)
...
![Podsumowanie zamówień](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order04.png)
...
* Zaloguj się do [Panelu klienta OVHcloud](/links/manager). Na stronie, która się wyświetli kliknij `Wyświetl moje zamówienia`, następnie przycisk `...` przed Twoim zamówieniem.
...
![Informacje o zamówieniu](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order05b.png)

Pojawi się poniższe okno umożliwiające monitorowanie w czterech krokach.

![Informacje o zamówieniu](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order06.png)
...
![Anulowanie zamówienia](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/cancelorder1.png)

Zaznacz kratkę `Tak, chcę anulować to zamówienie`, po czym zatwierdź tę operację.

![Potwierdzenie anulowania zamówienia](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/cancelorder2.png)
