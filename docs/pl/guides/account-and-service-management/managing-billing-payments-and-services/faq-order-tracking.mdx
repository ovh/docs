...
Zamknąłeś stronę z Twoim zamówieniem? Otwórz stronę [Moje zamówienia](https://manager.eu.ovhcloud.com/#/billing/orders). Następnie będziesz mógł wyświetlić zamówienie i uregulować należność.

### Jak mogę sprawdzić status mojej płatności?

Otwórz stronę [Faktury](https://manager.eu.ovhcloud.com/#/billing/history). Jeśli któraś z faktur oznaczona jest jako oczekująca na płatność, zaproponujemy Ci uregulowanie salda.

#### Wskazówki i porady

Na stronie [Moje sposoby płatności](https://manager.eu.ovhcloud.com/#/billing/payment/method) możesz dodać sposób płatności. Umożliwi Ci to opłacanie faktur w sposób automatyczny.
...
Aby ułatwić Ci zarządzanie zamówieniami, oddajemy w do Twojej dyspozycji [szczegółowy przewodnik](/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/).
