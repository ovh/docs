...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pl/&ovhSubsidiary=pl) and add a Additional IP address to your [vRack](https://www.ovhcloud.com/pl/network/vrack/).
