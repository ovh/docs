...
- You also have the possibility to [trigger SAP HANA backup to several Object Storage buckets](/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-configure-ovhcloud-backint-agent-several-buckets/).
