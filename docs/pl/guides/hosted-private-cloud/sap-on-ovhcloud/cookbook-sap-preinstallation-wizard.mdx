...
To access our SAP pre-installation wizard, go to the `SAP Features Hub` section of the `Hosted Private Cloud` menu, available from the [OVHcloud Control Panel](/links/manager).
