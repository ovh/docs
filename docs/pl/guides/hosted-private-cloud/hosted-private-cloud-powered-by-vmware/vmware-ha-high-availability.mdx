...
<img className="thumbnail" alt="schéma HA" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HA3.png" loading="lazy" />
...
Wyłączenie tej funkcji jest konieczne na przykład do przeprowadzenia aktualizacji przy użyciu narzędzia [Update Manager](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-update-manager/). W tym konkretnym przypadku host jest izolowany.

<img className="thumbnail" alt="activation HA" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HA.png" loading="lazy" />
...
<img className="thumbnail" alt="panne de l'hôte" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam1.PNG" loading="lazy" />
...
<img className="thumbnail" alt="isolation d'hôte" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam2.PNG" loading="lazy" />
...
<img className="thumbnail" alt="banque de données avec PDL" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam3.PNG" loading="lazy" />
...
<img className="thumbnail" alt="banque de données avec APD" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam4.PNG" loading="lazy" />

##### Monitoring maszyn wirtualnych

Monitoring maszyn wirtualnych jest dostępny po zainstalowaniu narzędzia [VMware tools](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-tools-install/).
...
<img className="thumbnail" alt="Surveillande de VM" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam5.PNG" loading="lazy" />
