...
W [interfejsie vSphere](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vsphere-interface-connexion/) umieść widok <code className="action">Storage</code>.

<img className="thumbnail" alt="przestrzeń dyskowa" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-register-vmx/register-vmx-01.png" loading="lazy" />

Wybierz datastore z listy.

<img className="thumbnail" alt="wybierz datastore" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-register-vmx/register-vmx-02.png" loading="lazy" />

W folderach tego datastore wybierz plik `.vmx` i kliknij <code className="action">Register VM</code>.

<img className="thumbnail" alt="enregistrer VM" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-register-vmx/register-vmx-03.png" loading="lazy" />

Uzupełnij wymagane informacje i kliknij <code className="action">Finish</code>.

<img className="thumbnail" alt="enregistrer VM" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-register-vmx/register-vmx-04.png" loading="lazy" />

Te same operacje są powtarzane na każdym datastore i dla każdej VM do ponownego zapisywania.

Sprawdź parametry swoich wirtualnych maszyn (nazwa, [portgroup](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/creation-vlan/), itp..) klikając prawym przyciskiem myszy na każdym z nich, a następnie wybierając <code className="action">Edit Settings</code>.

<img className="thumbnail" alt="zmień ustawienia" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-register-vmx/register-vmx-06.png" loading="lazy" />
...
<img className="thumbnail" alt="enregistrer VM" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-register-vmx/register-vmx-05.png" loading="lazy" />
