...
Tutaj korzystamy z maszyny wirtualnej zainstalowanej w systemie Debian 9 i wdrożonej z [szablonów udostępnionych w Twojej usłudze Private Cloud](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ovf-template/).
...
Tutaj korzystamy z maszyny wirtualnej zainstalowanej w systemie Ubuntu 18.04 i wdrożonej z [szablonów udostępnionych w Twojej usłudze Private Cloud](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ovf-template/).
