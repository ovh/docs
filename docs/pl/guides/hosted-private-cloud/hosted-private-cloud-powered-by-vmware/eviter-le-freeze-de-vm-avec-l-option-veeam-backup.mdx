...
<img className="thumbnail" alt="vSphere" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/eviter-le-freeze-de-vm-avec-l-option-veeam-backup/en01add.png" loading="lazy" />
...
<img className="thumbnail" alt="proxy" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/eviter-le-freeze-de-vm-avec-l-option-veeam-backup/en02proxy.png" loading="lazy" />

Utwórz inną regułę DRS, aby **oddzielić wirtualne maszyny** i utrzymywać serwery proxy wykonujące backupy na różnych hostach:

<img className="thumbnail" alt="proxy" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/eviter-le-freeze-de-vm-avec-l-option-veeam-backup/en03proxy2.png" loading="lazy" />
