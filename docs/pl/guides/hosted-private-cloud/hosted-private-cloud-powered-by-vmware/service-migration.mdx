...
- access to the [OVHcloud Control Panel](/links/manager) (`Private Cloud` in the `Hosted Private Cloud` section)
...
Please refer to our guide on [Enabling Virtual Machine Encryption](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/hosted-private-cloud-powered-by-vmware-vm-encrypt) in order to enable KMS on the destination Hosted Private Cloud.
...
Please consult our guide to [Migrate an IP block between two Hosted Private Cloud services](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/hosted-private-cloud-powered-by-vmware-add-ip-block#migrate-an-ip-block-between-two-hosted-private-cloud-solutions).
