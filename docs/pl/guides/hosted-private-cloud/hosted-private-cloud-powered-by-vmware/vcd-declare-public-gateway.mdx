...
1. Log in to your [OVHcloud Control Panel](/links/manager). Click `Hosted Private Cloud`, then `Public VCF as-a-Service`, and select your organization.

    ![Open organization](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-declare-public-gateway/vcd-declare-public-gateway-01.png)

2. Open the `Virtual Datacenters` tab and select the VDC where you want to use the public IPs.

    ![Select VDC and check vRack](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-declare-public-gateway/vcd-declare-public-gateway-02.png)

    In `General information`, verify that the vRack shown is the one linked to your public IP block.

    ![Select VDC and check vRack](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-declare-public-gateway/vcd-declare-public-gateway-03.png)

3. Select the `vRack` tab.

    ![Select the vRack tab](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-declare-public-gateway/vcd-declare-public-gateway-04.png)

    Locate the vRack segment named `vRack segment - VLAN0` or `vRack segment - PUBLIC`.

    Click the three dot menu `⋮` and `Add a subnet`.

    ![Add a subnet on the vRack segment](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-declare-public-gateway/vcd-declare-public-gateway-05.png)
...
4. In the modal, enter the **gateway in CIDR** form for your public IP block, then confirm. The gateway is the **last usable host** of the block.
    ...
    **Example**: for `203.0.113.0/29`, the last usable host is `203.0.113.6` so enter `203.0.113.6/29`. You can use any standard IP calculator to verify.
    ...
    ![Enter gateway CIDR](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-declare-public-gateway/vcd-declare-public-gateway-06.png)

5. Wait a few seconds and refresh the page. The subnet gateway should now appear on the segment.

    ![Gateway visible after refresh](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-declare-public-gateway/vcd-declare-public-gateway-07.png)
...
![Select Direct network type and gateway](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-declare-public-gateway/vcd-declare-public-gateway-08.png)
