...
For more information, see the page [Public VCF as-a-Service - The fundamentals of Public VCF as-a-Service](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-get-concepts#key-features/).
...
If you choose to migrate to Public VCF as-a-Service, OVHcloud will perform the migration for you, you can follow the following guide [Public VCF as-a-Service - Audit tricky use cases of migration](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-migration-use-cases/) for further information on the full process.
...
For backups, we will offer you **Veeam Managed Backup** with an integrated plugin for VM backups, you can follow the following guide for more information: [Public VCF as-a-Service - Backup with Veeam Data Platform](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-backup/).
