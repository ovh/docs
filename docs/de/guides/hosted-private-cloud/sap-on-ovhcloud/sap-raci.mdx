...
| --- | --- | --- | --- | --- |
| X | X | Choose to subscribe to the [Dedicated Server](/guides/account-and-service-management/responsibility-sharing/dedicated-servers/) service or to the [VMware on OVHcloud](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/responsibility-sharing/) service depending on your needs, and follow the associated responsibility models | RA | CI |
