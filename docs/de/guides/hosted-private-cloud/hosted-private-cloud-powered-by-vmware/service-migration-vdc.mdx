...
- Access to the [OVHcloud Control Panel](/links/manager) (`VMware` in the `Hosted Private Cloud` section)
...
![decision tree](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/service-migration-vdc/tree.png)
...
![add a Virtual Datacenter](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/service-migration-vdc/add-vDC.gif)
...
Next, in the [OVHcloud Control Panel](/links/manager), follow the instructions in our [Move an Additional IP](/guides/bare-metal-cloud/dedicated-servers/move-failover-ip) guide to move the initial NSX-V block to the PCC service you are migrating, but specify the VIP IP of the T0 as the "next hop", as shown in the example below:

![NSX IP Migration](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/service-migration-vdc/MoveIPNextHop.png)
...
The next step depends on the current configuration per [Virtual Protection Group](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-vmware-vsphere-drp):
...
To "move" Private Gateway to destination vDC, you must first disable it by following the steps in [Disable the private gateway](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/gateway#disablegw).
...
Then enable it again by following the steps in [Enable the private gateway](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/gateway#enablegw) and choose the datacentreId of the new vDC.
