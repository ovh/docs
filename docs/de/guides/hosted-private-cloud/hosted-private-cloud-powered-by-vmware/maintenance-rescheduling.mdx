...
- Sie haben Zugriff auf Ihr [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) oder auf die  [OVHcloud API ](https://eu.api.ovh.com/).

## In der praktischen Anwendung

:::tip[Success]
Benachrichtigungen von OVHcloud sind auch in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) verfügbar.<br/>
...
Loggen Sie sich mit dem Administrator-Account in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) ein.
...
<img className="thumbnail" alt="Änderung" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/maintenance-rescheduling/maintenance-date-edition01.png" loading="lazy" />
...
<img className="thumbnail" alt="Änderung" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/maintenance-rescheduling/maintenance-date-edition02.png" loading="lazy" />
