...
Vous devez tout d'abord vous rendre sur l'API [ovh.com](http://ovh.com) : [http://api.ovh.com](http://api.ovh.com/) et vous connecter à l'aide de votre identifiant client ([guide sur l'utilisation de l'API](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/connexion-a-l-api-ovh)
...
![](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/utilisation-du-protocole-sslv3-sur-private-cloud/get_service.png)
...
- [Restreindre l'accès au vCenter aux IPs autorisées](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/manager-ovh-private-cloud#securite)

- [Ajouter explicitement les IPs qui seront autorisées à se connecter](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/manager-ovh-private-cloud#securite)

Vous devez tout d'abord vous rendre sur l'API ovh.com : [http://api.ovh.com](http://api.ovh.com) et vous connecter à l'aide de votre identifiant client ([guide sur l'utilisation de l'API](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/connexion-a-l-api-ovh)
...
![](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/utilisation-du-protocole-sslv3-sur-private-cloud/put_service_name_description.png)
...
![](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/utilisation-du-protocole-sslv3-sur-private-cloud/put_service_name.png)
