...
<img className="thumbnail" alt="Feld nexthop" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ajout-de-bloc-ip/move-api.png" loading="lazy" />

Das Ergebnis wird wie folgt angezeigt:

<img className="thumbnail" alt="Feld nexthop" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ajout-de-bloc-ip/api-result.png" loading="lazy" />
...
Sie können die Migration Ihres IP-Blocks über Ihr [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) im Bereich <code className="action">Hosted Private Cloud</code> unter <code className="action">Private Cloud</code> nachverfolgen. Klicken Sie auf Ihren Hosted Private Cloud Dienst und dann auf den Tab <code className="action">Operationen</code>.

Die Referenz der Operation lautet „removeIpRipeBlock“.

<img className="thumbnail" alt="Operationen Kundencenter" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ajout-de-bloc-ip/operations.png" loading="lazy" />
