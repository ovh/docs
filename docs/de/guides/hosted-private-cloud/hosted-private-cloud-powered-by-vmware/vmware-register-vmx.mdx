...
Gehen Sie im [vSphere Interface](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vsphere-interface-connexion/) in die Ansicht <code className="action">Storage</code>.

<img className="thumbnail" alt="Storage" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-register-vmx/register-vmx-01.png" loading="lazy" />

Wählen Sie einen Datastore in der Liste aus.

<img className="thumbnail" alt="Datastore auswählen" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-register-vmx/register-vmx-02.png" loading="lazy" />

Wählen Sie in den Ordnern dieses Datastores die `.vmx` Datei aus und klicken Sie auf <code className="action">Register VM</code>.

<img className="thumbnail" alt="VM speichern" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-register-vmx/register-vmx-03.png" loading="lazy" />

Füllen Sie die erforderlichen Informationen aus und klicken Sie auf <code className="action">Finish</code>.

<img className="thumbnail" alt="VM speichern" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-register-vmx/register-vmx-04.png" loading="lazy" />

Diese Operationen sind auf jedem Datastore und für jede neu zu registrierende VM zu wiederholen.

Überprüfen Sie die Einstellungen Ihrer VMs (Name, [Portgroup](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/creation-vlan/) etc.), indem Sie mit der rechten Maustaste auf jede Ihrer VMs klicken und dann auf <code className="action">Edit Settings</code>.

<img className="thumbnail" alt="Ändern" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-register-vmx/register-vmx-06.png" loading="lazy" />
...
<img className="thumbnail" alt="VM speichern" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-register-vmx/register-vmx-05.png" loading="lazy" />
