...
- Sie haben [Veeam Managed Backup](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/veeam-backup-as-a-service/) für Ihre Hosted Private Cloud aktiviert.
...
<img className="thumbnail" alt="E-Mail" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/veeam-managed-backup-restoration/backup-report-email2.png" loading="lazy" />
