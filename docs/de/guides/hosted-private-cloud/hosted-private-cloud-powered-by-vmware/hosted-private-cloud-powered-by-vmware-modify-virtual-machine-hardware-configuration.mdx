...
Alle nachstehend beschriebenen Änderungen werden über Ihre Private Cloud in vSphere vorgenommen, indem Sie mit der rechten Maustaste auf eine virtuelle Maschine und dann auf `Einstellungen bearbeiten` klicken.

![Ressourcen bearbeiten](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware01.png)

In diesem Menü können Sie die Ressourcen Ihrer virtuellen Maschine erweitern. 

![Ressourcen bearbeiten](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware02.png)
...
![CPU hinzufügen](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware03.png)

Sie können auch eine bestimmte Frequenz (Minimum und Maximum) festlegen oder die Anzahl der Kerne pro Socket auswählen.

Wenn Sie den Haken bei `CPU-Hotplug` setzen, können Sie diese Werte verändern, während die Maschine läuft.
...
![Arbeitsspeicher hinzufügen](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware04.png)
...
![Speicherplatz hinzufügen](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware05.png)
...
![Netzwerk hinzufügen](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware06.png)

Dieses Interface ist besonders nützlich im Falle eines Netzwerkfehlers. Sie können sicherstellen, dass die *Port ID* mit der ID übereinstimmt, die in den Tabs `Networking` und `Ports` für die betreffende Netzwerkkarte aufgeführt wird.

### CD/DVD-Laufwerk

Mithilfe des CD/DVD-Laufwerks können Sie zum Beispiel ISO-Images auf Ihrer virtuellen Maschine mounten.

![CD/DVD-Laufwerk hinzufügen](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware07.png)
...
![Geräte hinzufügen](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware08.png)
