...
<img className="thumbnail" alt="Datamotive" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/datamotive-intro/datamotive_dashboard.png" loading="lazy" />
