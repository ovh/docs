...
<img className="thumbnail" alt="Erste SMS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/SMS1.png" loading="lazy" />
...
- einen Link zur Bestätigung der Operation (Achtung: Wenn Ihr Telefon nicht mit einem Netzwerk verbunden ist, dessen [IP zugelassen](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/manager-ovh-private-cloud#sicherheit/) ist, wird die Seite nicht angezeigt.)
...
<img className="thumbnail" alt="Operation bestätigen" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/operationValidation.png" loading="lazy" />
...
<img className="thumbnail" alt="Token der Operation" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/operationIdAndToken.png" loading="lazy" />
...
<img className="thumbnail" alt="Zweite SMS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/SMS2.png" loading="lazy" />
...
<img className="thumbnail" alt="Passwort ändern" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/changePassword.png" loading="lazy" />
...
<img className="thumbnail" alt="Passwort festlegen" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/defineNewPassword.png" loading="lazy" />
...
<img className="thumbnail" alt="Passwort verloren" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/passwordLost.png" loading="lazy" />
...
<img className="thumbnail" alt="Benutzerinformationen" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/infoUser.png" loading="lazy" />
...
<img className="thumbnail" alt="Token und Passwort" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/tokenAndPassword.png" loading="lazy" />
