...
- You need to have followed the guide: "[Public VCF as-a-Service - Basic Public VCF as-a-Service concepts](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-get-concepts/)".
...
You can now follow the steps in the following guide: [“Guide 2 - Public VCF as-a-Service - Network - Creating network components via the Public VCF as-a-Service control panel”](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-creation/).

**Networking for Public VCF as-a-Service - Guide index:**

- « Guide 1: Public VCF as-a-Service - Network - Concepts »
- [« Guide 2: Public VCF as-a-Service - Network - Creating network components via the Public VCF as-a-Service control panel »](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-creation/).
