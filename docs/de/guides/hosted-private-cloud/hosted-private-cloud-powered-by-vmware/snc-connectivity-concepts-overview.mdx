...
<img className="thumbnail" alt="SNC Network Global Overview" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/snc-connectivity-concepts-overview/SNC-Global-Network.svg" loading="lazy" />
