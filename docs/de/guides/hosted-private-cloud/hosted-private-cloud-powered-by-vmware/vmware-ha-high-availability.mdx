...
Diese Funktion muss wieder deaktiviert werden, um zum Beispiel Aktualisierungen über den [Update Manager](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-update-manager/) durchzuführen. In diesem Fall wird der Host isoliert.

<img className="thumbnail" alt="Aktivierung von HA" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HA.png" loading="lazy" />
...
<img className="thumbnail" alt="Hostfehler" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam1.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Hostisolierung" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam2.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Datenspeicher mit PDL" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam3.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Datenspeicher mit APD" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam4.PNG" loading="lazy" />

##### VM-Überwachung

Das Monitoring für virtuelle Maschinen ist nach Installation der [VMware Tools](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-tools-install/) verfügbar.
...
<img className="thumbnail" alt="VM-Überwachung" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam5.PNG" loading="lazy" />
