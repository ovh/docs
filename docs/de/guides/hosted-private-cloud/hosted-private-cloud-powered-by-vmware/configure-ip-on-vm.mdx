...
<Tabs>
  <Tab label="IPv4">
    ...
    <img className="thumbnail" alt="Configuration on the OVHcloud Network" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/configure-ip-on-vm/01config_ip_ovh_network.png" loading="lazy" />
...
On each block delivered by OVHcloud, 5 IP addresses are reserved for network configuration and should never be used for your virtual machines. This is the first and the last four IPs in the block.
    ...
    <img className="thumbnail" alt="Advanced configuration on the OVH Network" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/configure-ip-on-vm/02config_ip_ovh_network_advanced.png" loading="lazy" />
  </Tab>
  <Tab label="IPv6">
    :::warning
...
<Tabs>
  <Tab label="Linux IPv4">
    ...
    <img className="thumbnail" alt="IP Interface" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/configure-ip-on-vm/config_ip_interfaces.png" loading="lazy" />
...
```sh
  ...
  <Tab label="Windows IPv4">
    ...
    <img className="thumbnail" alt="Windows Configuration" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/configure-ip-on-vm/config_ip_windows.png" loading="lazy" />
...
```sh
  ...
  <Tab label="Linux IPv6">
    ...
    <img className="thumbnail" alt="IPv6 Interface" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/configure-ip-on-vm/config_ip_interfaces_v6.png" loading="lazy" />
...
```sh
  ...
  <Tab label="Windows IPv6">
    ...
    <img className="thumbnail" alt="Windows IPv6 Configuration" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/configure-ip-on-vm/config_ip_windows_v6.png" loading="lazy" />
...
<img className="thumbnail" alt="VLAN for SDDC" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/configure-ip-on-vm/04vlanBis.png" loading="lazy" />

<img className="thumbnail" alt="VLAN for SDDC" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/configure-ip-on-vm/05vlan.png" loading="lazy" />

<img className="thumbnail" alt="VXLAN on the Private Cloud" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/configure-ip-on-vm/06vxlan.png" loading="lazy" />

#### Linux

Here is a configuration example on a Debian operating system:

<img className="thumbnail" alt="Private IP address on Linux" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/configure-ip-on-vm/linux_private.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Configure a public IP address on Windows" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/configure-ip-on-vm/windows_private.PNG" loading="lazy" />
