...
For instructions for cross platforms set up, please see our guide on [using Zerto between OVHcloud and a third party platform](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-customer-to-ovhcloud/).
...
<img className="thumbnail" alt="zerto ovh enable" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_enable_01.png" loading="lazy" />

Select **Between two OVHcloud Private Cloud solutions** then click <code className="action">Activate Zerto DRP</code>.

<img className="thumbnail" alt="zerto ovh enable" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_enable_02.png" loading="lazy" />
...
<img className="thumbnail" alt="zerto ovh enable" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_enable_03.png" loading="lazy" />
...
<img className="thumbnail" alt="zerto ovh enable" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_enable_04.png" loading="lazy" />
...
<img className="thumbnail" alt="zerto ovh enable" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_enable_05.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto Dashboard" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_int_01.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto VPG Creation" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_01.png" loading="lazy" />

<img className="thumbnail" alt="Zerto VPG Creation" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_02.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto VPG Creation" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_03.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto VPG Creation" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_04.png" loading="lazy" />

- Click on the arrow pointing to the right to place VMs in the VPG

Click <code className="action">NEXT</code>.

<img className="thumbnail" alt="Zerto VPG Creation" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_05.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto VPG Creation" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_06.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto VPG Creation" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_07.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto VPG Creation" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_08.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto VPG Creation" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_09.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto VPG Creation" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_10.png" loading="lazy" />

Long term retention is disabled, click <code className="action">NEXT</code>.

<img className="thumbnail" alt="Zerto VPG Creation" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_11.png" loading="lazy" />

The last screen summarizes the settings for the new VPG. If everything is OK, click <code className="action">DONE</code>.

<img className="thumbnail" alt="Zerto VPG Creation" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_vpg_13.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto Test Failover" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_test_00.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto Test Failover" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_test_01.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto Test Failover" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_test_02.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto Test Failover" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_test_03.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto Test Failover" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_test_05.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto Test Failover" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_test_06.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto Live Failover" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_02.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto Live Failover" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_03.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto Live Failover" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_04.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto Live Failover" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_05.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto Live Failover" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_06.png" loading="lazy" />

For all automatic actions, the default timer is 60 minutes.

Click <code className="action">NEXT</code>.

<img className="thumbnail" alt="Zerto Live Failover" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_07.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto Live Failover" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_08.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto Live Failover" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_10.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto Live Failover" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_11.png" loading="lazy" />
...
<img className="thumbnail" alt="Zerto Live Failover" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-as-a-service/zerto_OvhToOvh_live_13.png" loading="lazy" />
