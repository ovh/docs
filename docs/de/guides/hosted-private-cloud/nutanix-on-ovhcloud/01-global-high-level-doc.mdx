...
This machine is only for you to download your first sources (Windows ISO, appliances, etc.). You will need to replace this virtual machine with another operating system. See this guide for more information: [Replace OVHgateway](/guides/hosted-private-cloud/nutanix-on-ovhcloud/30-software-gateway-replacement/).
