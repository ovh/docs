...
<img className="thumbnail" alt="installer VMware Tools" src="/images/bare-metal-cloud/managed-bare-metal/vmware-tools-install/tools.png" loading="lazy" />
...
<img className="thumbnail" alt="VMware tools windows" src="/images/bare-metal-cloud/managed-bare-metal/vmware-tools-install/windows.jpg" loading="lazy" />
