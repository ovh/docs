...
<img className="thumbnail" alt="Schema HA" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HA3.png" loading="lazy" />
...
<img className="thumbnail" alt="Aktivierung von HA" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HA.png" loading="lazy" />
...
<img className="thumbnail" alt="Hostfehler" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam1.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Hostisolierung" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam2.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Datenspeicher mit PDL" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam3.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Datenspeicher mit APD" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam4.PNG" loading="lazy" />

##### VM-Überwachung

Das Monitoring für virtuelle Maschinen ist nach Installation der [VMware Tools](/guides/bare-metal-cloud/managed-bare-metal/vmware-tools-install/) verfügbar.
...
<img className="thumbnail" alt="VM-Überwachung" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam5.PNG" loading="lazy" />
