...
- Sie sind auf Ihrem [vSphere Interface](/guides/bare-metal-cloud/managed-bare-metal/vsphere-interface/) eingeloggt.
...
<img className="thumbnail" alt="VM deployen" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm01.png" loading="lazy" />

Sie haben mehrere Optionen, um eine virtuelle Maschine zu erstellen:

- Per ISO-Datei, verfügbar in Ihrem Datastore.
- über ein eigenes oder ein [von OVHcloud bereitgestelltes](/guides/bare-metal-cloud/managed-bare-metal/ovf-template/) Template.
...
<img className="thumbnail" alt="Erstellungsoptionen" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm02.png" loading="lazy" />
...
<img className="thumbnail" alt="Speicherort der virtuellen Maschine" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm03.png" loading="lazy" />
...
<img className="thumbnail" alt="Auswahl der Ressourcen" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm04.png" loading="lazy" />
...
<img className="thumbnail" alt="Wahl des Speichers" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm05.png" loading="lazy" />
...
<img className="thumbnail" alt="Auswahl der Kompatibilität" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm06.png" loading="lazy" />
...
<img className="thumbnail" alt="Auswahl des Gast-Betriebssystems" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm07.png" loading="lazy" />
...
<img className="thumbnail" alt="Wahl des Netzwerks" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm08.png" loading="lazy" />
...
<img className="thumbnail" alt="Auswahl der ISO-Datei" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm09.png" loading="lazy" />
...
<img className="thumbnail" alt="ISO verbinden" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm10.png" loading="lazy" />
...
<img className="thumbnail" alt="VM Zusammenfassung" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm11.png" loading="lazy" />
...
<img className="thumbnail" alt="VM starten" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm12.png" loading="lazy" />
...
<img className="thumbnail" alt="VM-Konsole" src="/images/bare-metal-cloud/managed-bare-metal/deploy-a-vm/vm13.png" loading="lazy" />
