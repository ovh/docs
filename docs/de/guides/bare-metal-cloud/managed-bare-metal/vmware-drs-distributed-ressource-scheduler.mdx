...
<img className="thumbnail" alt="Prinzip des DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs0.png" loading="lazy" />
...
<img className="thumbnail" alt="DRS aktivieren" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs01.png" loading="lazy" />
...
<img className="thumbnail" alt="DRS-Automatisierung" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs02.png" loading="lazy" />
...
<img className="thumbnail" alt="Weitere DRS-Optionen" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs03.png" loading="lazy" />
...
<img className="thumbnail" alt="Erweiterte DRS-Optionen" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs05.png" loading="lazy" />

### DRS-Regeln

Im Tab `Konfigurieren` finden Sie die Verwaltung der VM/Host-Regeln.

<img className="thumbnail" alt="DRS-Regeln" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs06.png" loading="lazy" />
...
Die vierte Regel, “Virtuelle Maschinen zu virtuelle Maschinen”, wird in unserer Anleitung zur [HA-Funktion](/guides/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/) erklärt (Englisch).

<img className="thumbnail" alt="DRS-Regeln erstellen" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs07.png" loading="lazy" />
