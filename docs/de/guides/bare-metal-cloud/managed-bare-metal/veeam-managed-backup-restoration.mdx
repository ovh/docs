...
- Sie haben [Veeam Managed Backup](/guides/bare-metal-cloud/managed-bare-metal/veeam-backup-as-a-service/) für Ihre Hosted Private Cloud aktiviert.
...
<img className="thumbnail" alt="E-Mail" src="/images/bare-metal-cloud/managed-bare-metal/veeam-managed-backup-restoration/backup-report-email2.png" loading="lazy" />
