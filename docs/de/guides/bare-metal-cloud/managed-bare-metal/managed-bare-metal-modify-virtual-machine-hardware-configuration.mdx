...
Alle nachstehend beschriebenen Änderungen werden über Ihre Managed Bare Metal in vSphere vorgenommen, indem Sie mit der rechten Maustaste auf eine virtuelle Maschine und dann auf `Einstellungen bearbeiten` klicken.

![Ressourcen bearbeiten](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware01.png)

In diesem Menü können Sie die Ressourcen Ihrer virtuellen Maschine erweitern. 

![Ressourcen bearbeiten](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware02.png)
...
![CPU hinzufügen](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware03.png)
...
![Arbeitsspeicher hinzufügen](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware04.png)
...
![Speicherplatz hinzufügen](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware05.png)
...
![Netzwerk hinzufügen](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware06.png)
...
![CD/DVD-Laufwerk hinzufügen](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware07.png)
...
![Geräte hinzufügen](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware08.png)
