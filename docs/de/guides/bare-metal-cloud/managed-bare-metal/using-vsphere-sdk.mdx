...
Dieses Beispiel verwendet eine auf Debian 9 installierte VM, die mithilfe der [für Ihre Managed Bare Metal bereitgestellten Templates](/guides/bare-metal-cloud/managed-bare-metal/ovf-template/) deployt wurde.
...
Wir verwenden hier eine auf Ubuntu 18.04 installierte VM, die mithilfe der [für Ihre Managed Bare Metal bereitgestellten Templates](/guides/bare-metal-cloud/managed-bare-metal/ovf-template/) deployt wurde.
