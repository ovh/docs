...
![Feld nexthop](/images/guides/bare-metal-cloud/managed-bare-metal/ip-block-addition/images/move-api.png)

Das Ergebnis wird wie folgt angezeigt:

![Feld nexthop](/images/guides/bare-metal-cloud/managed-bare-metal/ip-block-addition/api-result.png)
...
Sie können die Migration Ihres IP-Blocks über Ihr [OVHcloud Kundencenter](/links/manager) im Bereich `Bare Metal Cloud` unter `Managed Bare Metal` nachverfolgen. Klicken Sie auf Ihren Managed Bare Metal Dienst und dann auf den Tab `Operationen`.

Die Referenz der Operation lautet "removeIpRipeBlock".

![Operationen Kundencenter](/images/guides/bare-metal-cloud/managed-bare-metal/ip-block-addition/images/operations.png)
