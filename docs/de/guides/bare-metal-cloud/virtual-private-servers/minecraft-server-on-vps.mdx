...
<br/>Es wird empfohlen, einen neuen VPS zu bestellen oder einen bestehenden Server über Ihr [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) zu [re-installieren](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps#reinstallvps/) und dabei die neueste verfügbare Version von Ubuntu oder Debian zu verwenden.
