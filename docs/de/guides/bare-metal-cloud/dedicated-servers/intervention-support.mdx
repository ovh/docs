...
- The new MAC address (viewable in the tab <code className="action">Network interfaces</code> in the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) or in the return of the command `ip link`).
