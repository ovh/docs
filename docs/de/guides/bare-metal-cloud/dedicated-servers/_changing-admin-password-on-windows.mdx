...
### Schritt 1: Server im Rescue-Modus neu starten <a id="bootinrescue"></a>
...
### Schritt 5: Ein neues Passwort festlegen (IPMI) <a id="passwordreset"></a>

Gehen Sie im [OVHcloud Kundencenter](/links/manager) auf den Tab `IPMI`, um eine KVM-Session zu öffnen.

![IPMI](/images/guides/bare-metal-cloud/dedicated-servers/changing-admin-password-on-windows/adminpw_win_03.png)
...
![pwreset](/images/guides/bare-metal-cloud/dedicated-servers/changing-admin-password-on-windows/adminpw_win_04.png)
...
![Enterpw](/images/guides/bare-metal-cloud/dedicated-servers/changing-admin-password-on-windows/adminpw_win_05.png)

Klicken Sie nun auf `OK` und Sie werden eingeloggt.

![adminlogin](/images/guides/bare-metal-cloud/dedicated-servers/changing-admin-password-on-windows/adminpw_win_06.png)
...
![administratorpw](/images/guides/bare-metal-cloud/dedicated-servers/changing-admin-password-on-windows/adminpw_win_07.png)
...
### Zurücksetzen des Admin-Passworts mit WinRescue <a id="winrescue"></a>

#### Schritt 1: Server im Rescue-Modus neu starten <a id="bootinwinrescue"></a>
...
![ntpwedit](/images/guides/bare-metal-cloud/dedicated-servers/changing-admin-password-on-windows/adminpw_win_09.png)

In diesem Interface können Sie die *SAM*-Datei bearbeiten, um das Passwort des Admin-Benutzers zu löschen. Deren Standardpfad im *WINDOWS*-Systemverzeichnis ist vorausgefüllt. Öffnen Sie die Datei, um die Liste der Benutzer anzuzeigen, indem Sie auf `Open` klicken.

Der relevante Benutzer ist entweder "admin" oder "Administrator", entsprechend der Windows-Version. Sind beide vorhanden, wählen Sie "admin" aus. Klicken Sie anschließend auf `Change password`.

![ntpwedit](/images/guides/bare-metal-cloud/dedicated-servers/changing-admin-password-on-windows/adminpw_win_10.png)

Lassen Sie im nächsten Dialog die Felder leer und klicken Sie auf `OK`. Klicken Sie zum Abschluss auf `Save changes` und dann auf `Exit`.
...
Wechseln Sie wieder zum Fenster der KVM-Sitzung und wählen Sie die Herunterfahren-Option `Neu starten` über den Windows-Button unten links aus.
...
[Verwendung der IPMI-Konsole für Dedicated Server](/guides/bare-metal-cloud/dedicated-servers/dedicated-servers-ipmi)
