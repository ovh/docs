...
description: Erfahren Sie hier, wie Sie Daten zwischen zwei dedizierten Servern migrieren können
...
- Die einfachste Methode ist die Verwendung eines geeigneten Programms wie [SFTP](/guides/bare-metal-cloud/dedicated-servers/comment-deposer-ou-recuperer-des-donnees-sur-un-serveur-dedie-via-sftp/).
...
Weitere Informationen finden Sie in unserer Dokumentation zu [Domains und DNS](/guides/web-cloud/domains/overview/).
