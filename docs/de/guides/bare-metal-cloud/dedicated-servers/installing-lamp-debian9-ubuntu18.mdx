...
Um WordPress auf einem Server zu installieren, können Sie [diesem Tutorial](/guides/public-cloud/compute/install-wordpress-on-an-instance/) folgen.
...
[Daten via SFTP auf einem Server ablegen oder herunterladen](/guides/bare-metal-cloud/dedicated-servers/comment-deposer-ou-recuperer-des-donnees-sur-un-serveur-dedie-via-sftp/)
