...
Loggen Sie sich zunächst in Ihr [OVHcloud Kundencenter ein](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) und gehen Sie zum Bereich <code className="action">Bare Metal Cloud</code>. Wählen Sie den betreffenden Server unter <code className="action">Dedicated Server</code> aus.
