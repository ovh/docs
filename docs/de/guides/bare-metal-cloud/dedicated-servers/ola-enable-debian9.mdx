...
<br/>Loggen Sie sich hierzu in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) ein. Klicken Sie im Bereich <code className="action">Bare Metal Cloud</code> Ihren Server aus <code className="action">Dedicated Server</code>, aus und klicken Sie dann auf den Tab <code className="action">IPMI</code> (1).
