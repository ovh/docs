...
description: Erfahren Sie hier, wie Sie die Disk-Konfiguration Ihres Servers nach einem Austausch wiederherstellen
...
<img className="thumbnail" alt="Software spiegelt Windows" src="/images/bare-metal-cloud/dedicated-servers/raid-soft-windows/raid-soft-windows-01.png" loading="lazy" />

Geben Sie "cmd" ein und klicken Sie auf <code className="action">OK</code>.

<img className="thumbnail" alt="Software spiegelt Windows" src="/images/bare-metal-cloud/dedicated-servers/raid-soft-windows/raid-soft-windows-02.png" loading="lazy" />
