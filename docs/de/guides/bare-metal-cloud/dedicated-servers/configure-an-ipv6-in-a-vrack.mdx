...
- IPv6:
    ...
    - [IPv6 auf einer Public-Cloud-Instanz konfigurieren](/guides/public-cloud/public-cloud-network-services/configuration-02-how-to-configure-ipv6/).
...
<img className="thumbnail" alt="Konfigurationsseite" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/500.png" loading="lazy" />
...
<img className="thumbnail" alt="IPv6 in einem vRack konfigurieren" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/20240418-03.png" loading="lazy" />
...
<img className="thumbnail" alt="vRack-Verwaltung" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/700.png" loading="lazy" />
...
<img className="thumbnail" alt="vRack-Auswahl" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/701.png" loading="lazy" />
...
<img className="thumbnail" alt="SLAAC aktivieren" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/702.png" loading="lazy" />
...
- Melden Sie sich im [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) an.
...
<img className="thumbnail" alt="Einen IPv6 in einem vRack für den gerouteten Modus konfigurieren" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/routed-mode-20240513.png" loading="lazy" />
...
<img className="thumbnail" alt="vRack-Auswahl" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/600.png" loading="lazy" />
...
<img className="thumbnail" alt="weiter" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/800.png" loading="lazy" />

Das erstellte geroutete Subnetz `2001:41d0:abcd::ef10::/60` ist über den Next Hop `2001:41d0:abcd::ef00::2` erreichbar.

<img className="thumbnail" alt="weiter" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/801.png" loading="lazy" />
...
<img className="thumbnail" alt="weiter" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/20240418-02.png" loading="lazy" />
