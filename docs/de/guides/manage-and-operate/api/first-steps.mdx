...
Um Schlüssel aufzulisten und zu widerrufen, können Sie die [API-Konsole](https://eu.api.ovh.com/) oder das [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) verwenden:
...
<Tabs>
  ...
  <Tab label="OVHcloud Kundencenter">
    Gehen Sie zur Seite [API-Schlüssel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/dedicated/account/iam/api-keys).
