...
- [Using Filebeat with Logs Data Platform.](/guides/manage-and-operate/observability/logs-data-platform/ingestion-filebeat/)
...
We cover Filebeat in depth in [another tutorial](/guides/manage-and-operate/observability/logs-data-platform/ingestion-filebeat/). Here is a minimal **filebeat.yml** configuration file.
