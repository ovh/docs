...
![simple\_log](/images/guides/manage-and-operate/observability/logs-data-platform/ingestion-opensearch-api-mutualized-input/one_field.png)
...
![gelf\_log](/images/guides/manage-and-operate/observability/logs-data-platform/ingestion-opensearch-api-mutualized-input/gelf_log.png)
...
![gelf\_convention](/images/guides/manage-and-operate/observability/logs-data-platform/ingestion-opensearch-api-mutualized-input/gelf_convention.png)
...
- Create a [service account](/guides/manage-and-operate/iam/identities-management/) and assign the required IAM policies (see the [IAM access management guide](/guides/manage-and-operate/observability/logs-data-platform/getting-started-roles-permission)).
...
![vector\_logs](/images/guides/manage-and-operate/observability/logs-data-platform/ingestion-opensearch-api-mutualized-input/vector_logs.png)
