...
- [Vorbereitung der Umgebung für die Verwendung der OpenStack API](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/) durch Installation des *python-swiftclient*
...
Diese URL besteht einem API-Zugriffspunkt, den Sie im [Horizon Interface](/guides/public-cloud/public-cloud-cross-functional/access-and-security-in-horizon/) abrufen können, sowie aus dem Namen des Containers und des gewünschten Objekts (einschließlich Präfix).
