...
Mithilfe dieser [Anleitung](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/) können Sie Ihre OpenStack-Kennung und Ihr Passwort erstellen.
