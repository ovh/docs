...
- *Unfreeze* über python-swiftclient:
    - [Umgebung für die Verwendung der OpenStack-API vorbereiten](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/) indem python-swiftclient installiert wird.
