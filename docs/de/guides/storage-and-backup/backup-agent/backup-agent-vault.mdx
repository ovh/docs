...
Um Ihre Vaults zu finden, klicken Sie auf [diesen Link](https://manager.eu.ovhcloud.com/#/bmc-backup-agent-baremetal/service), um auf den Bereich <code className="action">Backup Agent</code> zuzugreifen, und klicken Sie dann auf den Tab <code className="action">Vaults</code>.
