...
- Sie sind vertraut mit der Verwendung der [OVHcloud API](/guides/manage-and-operate/api/first-steps/) oder der [OVHcloud CLI](/guides/manage-and-operate/cli/cli-getting-started/).
