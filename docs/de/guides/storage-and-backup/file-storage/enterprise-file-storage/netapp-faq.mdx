...
Ja, diese Dienstleistung ist direkt über Ihr [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) erreichbar, im Bereich <code className="action">Bare Metal Cloud</code>, dann <code className="action">Storage und Backup</code>.
