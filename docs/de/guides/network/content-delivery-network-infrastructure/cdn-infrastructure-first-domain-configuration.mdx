...
- Sie nutzen das [OVH Content Delivery Network (CDN)](/links/network/cdn-infrastructure).
...
Gehen Sie dazu im [OVHcloud Kundencenter ](/links/manager) in den Bereich `Dedicated` und dann auf `NAS und CDN`.

Klicken Sie auf `Eine Domain zum CDN hinzufügen`:

![CDN Kundencenter](/images/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/cdn_customer_panel.png)

Im ersten Schritt können Sie die Subdomain auswählen, die Sie zum CDN hinzufügen möchten:

![Subdomain zum CDN hinzufügen](/images/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_1.png)
...
![Backend hinzufügen](/images/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_2.png)
...
![CNAME-Eintrag](/images/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/cname_field.png)
