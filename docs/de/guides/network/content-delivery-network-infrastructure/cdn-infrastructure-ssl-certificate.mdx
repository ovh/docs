...
![SSL-Zertifikat wird erstellt](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/ssl_in_progress.png)
...
![SSL aktiviert](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/ssl_validated.png)

### Wie kann ich ein eigenes Zertifikat hinzufügen?

- Wenn Sie bisher keine Domain hinzugefügt haben oder über kein Zertifikat verfügen, können Sie die Option `Mein Zertifikat hinzufügen` im Tab "SSL" Ihres CDN nutzen:

![Ein SSL-Zertifikat hinzufügen](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/add_ssl.png)

- Wenn Sie bereits über ein Let's Encrypt-Zertifikat verfügen, können Sie einfach die Option `Mit meinem Zertifikat ersetzen` nutzen:

![Ein SSL-Zertifikat ersetzen](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/change_ssl.png)
