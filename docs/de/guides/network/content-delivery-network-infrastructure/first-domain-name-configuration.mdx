...
Gehen Sie dazu im [OVHcloud Kundencenter ](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) in den Bereich <code className="action">Dedicated</code> und dann auf <code className="action">NAS und CDN</code>.
