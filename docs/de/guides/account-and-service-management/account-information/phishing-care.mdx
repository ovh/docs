...
Prüfen Sie zunächst, ob die empfangene E-Mail auch auf der Seite [Meine Kommunikation](https://manager.eu.ovhcloud.com/#/communication) in Ihrem OVHcloud Kundencenter sichtbar ist. Dort finden Sie Kopien aller offiziellen E-Mails, die von OVHcloud gesendet wurden.
...
Öffnen Sie die Seite [Kontosicherheit](https://manager.eu.ovhcloud.com/#/account/useraccount/security) und ändern Sie Ihr Passwort.
