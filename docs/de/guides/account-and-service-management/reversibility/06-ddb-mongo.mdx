...
| **Function** | **Description** | **Available formats** | **Migration model** | **Available documentation** |
| --- | --- | --- | --- | --- |
| Private network OVHcloud (vRack) | Connection with other OVHcloud services in private network. | N/A | **Incoming**: Config vRack. <br /> **Outgoing**: Non-transferable functionality. | [vRack](/guides/public-cloud/public-cloud-databases/public-cloud-databases-configure-vrack) |
