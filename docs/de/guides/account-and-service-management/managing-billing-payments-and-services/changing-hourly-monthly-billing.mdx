...
:::warning
Das folgende Verfahren funktioniert nicht bei Instanzen der dritten Generation (Beispiel: B3-32). Um die monatliche Abrechnung für diese Art von Instanz zu erhalten, müssen Sie einen [Savings Plan](/guides/public-cloud/public-cloud-cross-functional/savings-plans/) für diese Instanz erstellen.
