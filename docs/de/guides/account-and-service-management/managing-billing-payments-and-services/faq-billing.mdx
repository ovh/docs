...
Die Liste der Kontakte Ihrer Dienste finden Sie auf der Seite [Kontaktverwaltung](https://manager.eu.ovhcloud.com/#/account/contacts/services).
...
Ihre Abrechnungsdaten sind Ihre Kundenkennung. Für Ihre nächsten Rechnungen genügt es daher, diese Angaben auf der Seite [Mein Profil](https://manager.eu.ovhcloud.com/#/account/useraccount/infos) zu aktualisieren.
...
Um den Status Ihrer Dienste einzusehen, öffnen Sie die Seite [Meine Angebote und Dienste](https://manager.eu.ovhcloud.com/#/billing/autorenew/services).
...
Diese Anleitung beschreibt die Verlängerung ausführlich: [Verlängerung Ihrer OVHcloud Dienste verwalten](/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/)

### Wie kann ich die automatische Verlängerung aktivieren?

Auf der Seite [Meine Angebote und Dienste](https://manager.eu.ovhcloud.com/#/billing/autorenew/services) wählen Sie den betreffenden Dienst aus, klicken Sie auf die drei Punkte und wählen Sie <code className="action">Automatische Zahlung aktivieren</code> aus. Standardmäßig wird die automatische Verlängerung bei der Bestellung des Dienstes aktiviert.
...
Wenn Sie detaillierte Erläuterungen wünschen, empfehlen wir Ihnen dazu die folgende Anleitung: [Verlängerung meiner Dienste verwalten](/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/)
...
Auf der Seite [Zahlungsarten](https://manager.eu.ovhcloud.com/#/billing/payment/method) klicken Sie auf <code className="action">Zahlungsart hinzufügen</code>.

### Wie kann ich mein Zahlungsmittel aktualisieren?

Auf der Seite [Zahlungsarten](https://manager.eu.ovhcloud.com/#/billing/payment/method) können Sie ein Zahlungsmittel hinzufügen oder entfernen (Kreditkarte, PayPal oder SEPA-Lastschrift).
...
Auf der Seite [Zahlungsarten](https://manager.eu.ovhcloud.com/#/billing/payment/method) wählen Sie das Zahlungsmittel aus, das Sie löschen möchten, und klicken Sie auf das Papierkorb-Symbol.
...
Auf der Seite [Meine Angebote und Dienste](https://manager.eu.ovhcloud.com/#/billing/autorenew/services) können Sie die Häufigkeit der Verlängerung Ihrer Lösungen ändern.
Wenn Sie detaillierte Erläuterungen wünschen, empfehlen wir Ihnen dazu die folgende Anleitung: [Verlängerung meiner Dienste verwalten](/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/)
...
Öffnen Sie die Seite [Meine Rechnungen](https://manager.eu.ovhcloud.com/#/billing/history).

#### Tipps und Tricks

Wenn keine Rechnung angezeigt wird, sind Sie möglicherweise nicht der Rechnungskontakt für die betreffende Dienstleistung. Um ihn zu kennen und gegebenenfalls zu ändern, öffnen Sie die Seite [Kontaktverwaltung](https://manager.eu.ovhcloud.com/#/account/contacts/services).
...
Auf der Seite [Zahlungsarten](https://manager.eu.ovhcloud.com/#/billing/payment/method) können Sie Ihre Zahlungsart eintragen. So werden Ihre Rechnungen automatisch beglichen.
...
Lesen Sie dazu die folgende Anleitung: [Informationen zur Cloud-Abrechnung](/guides/public-cloud/public-cloud-cross-functional/analyze-billing/)
...
Um die Datei herunterzuladen, öffnen Sie die Seite [Meine Rechnungen](https://manager.eu.ovhcloud.com/#/billing/history). Klicken Sie auf <code className="action">Aktionen</code> und wählen Sie dann <code className="action">als CSV exportieren</code> aus.
