...
Klicken Sie oben rechts auf Ihren Namen und wählen Sie `Meine Angebote und Dienste`.

![Produkte und Dienstleistungen](/images/assets/screens/control-panel/product-selection/right-menu/my-solutions-and-services.png)

### Verlängerungstyp anzeigen <a id="renewal-type"></a>

Die Seite **Verwaltung meiner Angebote und Dienste** enthält eine Tabelle zur Verwaltung Ihrer OVHcloud Dienstleistungen. Sie finden dort deren Namen, den Typ der Dienstleistung, die Verfügbarkeit der Dienstleistung (z.B. `Aktiv`), deren Status (Art der Verlängerung, durchzuführende Aktion, etc.), das nächste Datum, an dem die Verlängerung oder Kündigung wirksam wird, sowie den Button `...` zum Zugriff die möglichen Aktionen für jeden Dienst.

![Meine Dienstleistungen](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/my-services-en.png)
...
Rechts neben einem Dienst klicken Sie auf den Button `...` in der Spalte `Aktionen` und dann auf die gewünschte Aktion.

![Menü Aktionen](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/actions-en.png)
...
![Verlängerung konfigurieren](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/configure-renewal-en.png)

Klicken Sie auf die Aktion `Verlängerung konfigurieren`. Je nach gewähltem Dienst können Sie die manuelle Verlängerung einstellen oder das Intervall für die automatische Verlängerung auswählen. In diesem Fall können Sie die Verlängerungsart sowie die Häufigkeit der Verlängerung auswählen.

![Verlängerung konfigurieren](/images/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/configure-renew-en.png)
...
![Zahlung vorziehen](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/forward-payment-en.png)
...
>
> Nachdem Sie Ihre Auswahl getroffen haben, klicken Sie auf `Bestätigen`.
>
...
![Kündigen](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/cancel-en.png)
...
![Dienstleistung verlängern](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/renew-service-en.png)
...
![Rechnung bezahlen](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/pay-bill-en.png)
...
Wählen Sie dann einfach die Aktion `Meine Rechnung bezahlen` aus, die Sie zum Zahlungsformular weiterleitet.
...
Sie können gruppierte Aktionen ausführen, indem Sie mehrere Dienste in der Tabelle auswählen und dann auf den Button `Aktionen` klicken.

![Gruppierte Aktionen](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/batch-actions-en.png)
