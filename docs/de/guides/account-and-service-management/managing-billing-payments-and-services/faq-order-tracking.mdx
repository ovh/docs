...
Sie haben die Seite Ihrer Bestellung geschlossen? Öffnen Sie die Seite [Meine Bestellungen](https://manager.eu.ovhcloud.com/#/billing/orders). Dort können Sie Ihre Bestellung einsehen und begleichen.

### Wie kann ich meinen Zahlungsstatus einsehen?

Öffnen Sie die Seite [Meine Rechnungen](https://manager.eu.ovhcloud.com/#/billing/history). Wenn eine ausstehende Rechnung vorhanden ist, können Sie den Restbetrag begleichen.
...
Hilfe zur Verwaltung Ihrer Bestellungen finden Sie in unserer Anleitung: [OVHcloud Bestellungen verwalten](/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/).
