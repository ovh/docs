...
![Select service](/images/guides/public-cloud/public-cloud-databases/databases-06-restore-backup/service-selection-20230331.png)

### Step 2: Go to the backup tab

In the tab list, click on `Backups`.

![Service overview](/images/guides/public-cloud/public-cloud-databases/databases-06-restore-backup/service-overview-20230331.png)
...
![Backup tab](/images/guides/public-cloud/public-cloud-databases/databases-06-restore-backup/backup-tab-20230511.png)
...
![Immutable options](/images/guides/public-cloud/public-cloud-databases/databases-06-restore-backup/immutable-options.png)

#### Region

You can choose a different region for your new service.

![selec tRegion](/images/guides/public-cloud/public-cloud-databases/databases-06-restore-backup/selectRegion.png)
...
![Restore point from backup](/images/guides/public-cloud/public-cloud-databases/databases-06-restore-backup/restore-point-selection-backup.png)

##### **Specific date and latest**

If your service supports point in time recovery (see [Automated Backup guide](/guides/public-cloud/public-cloud-databases/public-cloud-databases-backups) for more details), you will also be offered the option to restore from a specific date and time.

![Restore point from a specific date](/images/guides/public-cloud/public-cloud-databases/databases-06-restore-backup/restore-point-selection-date.png)

You will also be offered the ease to choose the most recent date directly.

![Restore point from latest](/images/guides/public-cloud/public-cloud-databases/databases-06-restore-backup/restore-point-selection-latest.png)

#### Plan

When restoring a backup, you can select another service plan.

![Plan selection](/images/guides/public-cloud/public-cloud-databases/databases-06-restore-backup/plan-selection-20230331.png)

#### Nodes

You can choose to upgrade the node to a bigger flavor.

![Node selection](/images/guides/public-cloud/public-cloud-databases/databases-06-restore-backup/node-selection-20230331.png)
...
![Sizing selection](/images/guides/public-cloud/public-cloud-databases/databases-06-restore-backup/sizing-selection.png)
...
![Options selection](/images/guides/public-cloud/public-cloud-databases/databases-06-restore-backup/option-selection-20230331.png)
...
![Forked service](/images/guides/public-cloud/public-cloud-databases/databases-06-restore-backup/forked-service-20230331.png)
