...
For more information refer to the following [documentation](/guides/public-cloud/public-cloud-databases/mongodb-24-read-preference-and-write-concern/).
...
- **Implement Comprehensive Monitoring**: Utilize MongoDB’s monitoring tools, such as [database commands](https://www.mongodb.com/docs/manual/administration/monitoring/#mongodb-reporting-tools), [OVHcloud Metrics tab](/guides/public-cloud/public-cloud-databases/mongodb-15-monitoring/), or third-party monitoring solutions, to continuously monitor database performance, resource utilization, and operational metrics.
