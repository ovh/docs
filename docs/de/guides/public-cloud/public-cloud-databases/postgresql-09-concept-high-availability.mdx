...
<img className="thumbnail" alt="Public Cloud Databases for PostgreSQL cluster" src="/images/public-cloud/public-cloud-databases/postgresql-09-concept-high-availability/postgresql-cluster.png" loading="lazy" />
