...
Explore step-by-step instructions on how to create a managed Kafka database cluster on OVHcloud Public Cloud via the Control Panel, datacentre selection, plan, instance configuration, storage sizing, and cluster setup options: [Create a Kafka cluster](/guides/public-cloud/data-analytics/overview/)

### Configure cluster for incoming connections

Explore practical guidance on how to configure your OVHcloud Public Cloud Kafka cluster to accept incoming connections covering access setup via the control panel or API and essential network settings: [Configure Kafka cluster connections](/guides/public-cloud/data-analytics/overview/)
