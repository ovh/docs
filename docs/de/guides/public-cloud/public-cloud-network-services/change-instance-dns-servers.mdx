...
Verbinden Sie sich über SSH mit Ihrer Instanz. Weitere Informationen hierzu finden Sie in der Anleitung zum [Einloggen auf einer Instanz](/guides/public-cloud/compute/compute-getting-started#connect-instance).
...
Loggen Sie sich über eine Remote-Verbindung (RDP) oder mit der VNC-Konsole auf der Instanz ein. Weitere Informationen hierzu finden Sie in der Anleitung zum [Einloggen auf einer Instanz](/guides/public-cloud/compute/compute-getting-started#connect-instance).

Öffnen Sie die `Netzwerkeinstellungen`.

![DNS Server ändern](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers1.png)

Gehen Sie über die Systemsteuerung zur IPv4-Konfiguration Ihrer öffentlichen Netzwerkschnittstelle.

![DNS Server ändern](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers2.png)

Fügen Sie die gewünschten Server in den `Erweiterten Einstellungen` hinzu.

![DNS Server ändern](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers3.png)
...
[Eine Public Cloud Instanz erstellen und sich damit verbinden](/guides/public-cloud/compute/compute-getting-started)
