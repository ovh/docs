...
- Understanding of the [Load Balancer concepts](/guides/public-cloud/public-cloud-network-services/concepts-03-loadbalancer/)
- An active [Public Cloud project](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project/)
- A previously configured [Load Balancer](/guides/public-cloud/public-cloud-network-services/getting-started-01-create-lb-service/) within your OVHcloud project space
...
- **OpenStack CLI:** For command line management. More information on preparing your OpenStack API environment is available [here](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/).
...
<img className="thumbnail" alt="Schema 1" src="/images/public-cloud/public-cloud-network-services/technical-resources-04-lbaas-create-L7/Policy9.png" loading="lazy" />
...
<img className="thumbnail" alt="Schema 1" src="/images/public-cloud/public-cloud-network-services/technical-resources-04-lbaas-create-L7/Policy10.png" loading="lazy" />
...
<img className="thumbnail" alt="Schema 1" src="/images/public-cloud/public-cloud-network-services/technical-resources-04-lbaas-create-L7/Policy11.png" loading="lazy" />

After filling in all the necessary fields, click on <code className="action">Add</code> to create your L7 policy.

<img className="thumbnail" alt="Schema 1" src="/images/public-cloud/public-cloud-network-services/technical-resources-04-lbaas-create-L7/Policy4.png" loading="lazy" />
...
<img className="thumbnail" alt="Schema 1" src="/images/public-cloud/public-cloud-network-services/technical-resources-04-lbaas-create-L7/Policy5.png" loading="lazy" />

2\. **Add a New L7 Rule**:

On the L7 rules page, click the <code className="action">Add an L7 rule</code> button.

<img className="thumbnail" alt="Schema 1" src="/images/public-cloud/public-cloud-network-services/technical-resources-04-lbaas-create-L7/Policy6.png" loading="lazy" />
...
<img className="thumbnail" alt="Schema 1" src="/images/public-cloud/public-cloud-network-services/technical-resources-04-lbaas-create-L7/Policy7.png" loading="lazy" />
...
<img className="thumbnail" alt="Schema 1" src="/images/public-cloud/public-cloud-network-services/technical-resources-04-lbaas-create-L7/Policy8.png" loading="lazy" />
