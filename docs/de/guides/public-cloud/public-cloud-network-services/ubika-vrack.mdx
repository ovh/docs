...
Gehen Sie in den Bereich `Download` auf der [offiziellen Website von Ubika](https://my.ubikasec.com/). Loggen Sie sich in Ihren Ubika-Account ein und folgen Sie den Anweisungen zum Herunterladen des UWG OpenStack Images.
