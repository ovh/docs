...
Das [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) ist eine vollständig visuelles Interface, die ideal geeignet ist, um mehrere VLANs zu verwalten. Sie können außerdem den privaten IP-Bereich anpassen, der standardmäßig in 10.1.0.0/16 liegt.
...
Verwenden Sie [diese Anleitung](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon/), um sich mit Horizon vertraut zu machen.
...
Dazu müssen Sie den richtigen Terraform-Provider und -Ressource auswählen. Weitere Informationen finden Sie in unserer Anleitung zu [der Verwendung von Terraform mit OVHcloud](/guides/manage-and-operate/terraform/terraform-at-ovhcloud/).
...
Sie werden auf eine andere Seite weitergeleitet, um die Bestellung zu bestätigen. Es wird einige Minuten dauern, bis das vRack in Ihrem Account eingerichtet ist.
    ...
    <img className="thumbnail" alt="Projekt zum vRack hinzufügen" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/addprojectvrack.png" loading="lazy" />
...
<Tabs>
  <Tab label="Über das OVHcloud Kundencenter">
    ...
    <img className="thumbnail" alt="VLAN-Erstellung" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack2022-03.png" loading="lazy" />
...
Klicken Sie auf die Schaltfläche <code className="action">Privates Netzwerk hinzufügen</code>. Die folgende Seite ermöglicht es Ihnen, mehrere Einstellungen anzupassen.
    ...
    <img className="thumbnail" alt="Region auswählen" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack5-2024.png" loading="lazy" />

Im nächsten Schritt werden Ihnen mehrere Optionen präsentiert:
    
    <img className="thumbnail" alt="Netzwerk erstellen" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack6-2022.png" loading="lazy" />
...
Im Feld **Name des privaten Netzwerks** legen Sie einen Namen für Ihr privates Netzwerk fest.
    ...
    **Netzwerk-Gateway-Optionen**
    ...
    - **Ein Gateway zuweisen und sich mit dem privaten Netzwerk verbinden**: Wählen Sie diese Option, wenn Sie beabsichtigen, Instanzen mit einem privaten Netzwerk zu erstellen. Weitere Informationen finden Sie in den folgenden Anleitungen: [Ein privates Netzwerk mit Gateway erstellen](/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/) und [Erstellen und Verbinden mit Ihrer ersten Public Cloud-Instanz](/guides/public-cloud/compute/public-cloud-first-steps/).
...
<Tabs>
  <Tab label="Über das OVHcloud Kundencenter">
    Wenn Sie Unterstützung benötigen, folgen Sie zunächst dieser Anleitung: [Erstellen einer Instanz im OVHcloud Kundencenter](/guides/public-cloud/compute/public-cloud-first-steps/). Beim Erstellen einer Instanz können Sie in Schritt 5 einen Netzwerkmodus wählen, gefolgt von einem privaten Netzwerk, in das Sie Ihre Instanz integrieren können.
