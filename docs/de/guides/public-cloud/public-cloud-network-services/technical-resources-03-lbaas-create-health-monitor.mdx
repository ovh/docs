...
- An [active OVHcloud account](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de)
...
- A previously configured [Load Balancer](/guides/public-cloud/public-cloud-network-services/getting-started-01-create-lb-service/) within your OVHcloud project
...
<img className="thumbnail" alt="Schema 1" src="/images/public-cloud/public-cloud-network-services/technical-resources-03-lbaas-create-health-monitor/healthM1.png" loading="lazy" />
...
<img className="thumbnail" alt="Schema 1" src="/images/public-cloud/public-cloud-network-services/technical-resources-03-lbaas-create-health-monitor/healthM2.png" loading="lazy" />
...
<img className="thumbnail" alt="Schema 1" src="/images/public-cloud/public-cloud-network-services/technical-resources-03-lbaas-create-health-monitor/healthM3.png" loading="lazy" />
