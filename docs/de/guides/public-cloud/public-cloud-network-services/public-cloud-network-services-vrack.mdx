...
**Zu Beginn finden Sie hier eine kurze Beschreibung der möglichen Aktionen je nach gewählter Methode/Schnittstelle.** <a id="horizon"></a>
...
Beziehen Sie sich auf [dieses Handbuch](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon), um sich mit Horizon vertraut zu machen.
...
Beziehen Sie sich auf [dieses Handbuch](/guides/manage-and-operate/api/first-steps), um mit der OVHcloud APIv6 zu beginnen.
...
- [System für die Verwendung der OpenStack API vorbereiten](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment)
- [OpenStack Umgebungsvariablen einrichten](/guides/public-cloud/public-cloud-cross-functional/compute-set-openstack-environment-variables)
...
Dazu müssen Sie den richtigen Terraform-Provider und -Ressource auswählen. Weitere Informationen finden Sie in unserem Handbuch zu [der Verwendung von Terraform mit OVHcloud](/guides/manage-and-operate/terraform/terraform-at-ovhcloud).

</details>

## In der praktischen Anwendung

### Schritt 1: Aktivieren und Verwalten eines vRacks <a id="activation"></a>
...
>>
>> ![vRack bestellen](/images/assets/screens/control-panel/product-selection/bare-metal-cloud/network/orderingvrack25.png)
>>
...
>>
>> ![Projekt zum vRack hinzufügen](/images/guides/public-cloud/public-cloud-network-services/configuration-06-configure-ip-block-vrack-to-instance/addprojectvrack.png)
>>
...
>>
>> Melden Sie sich über die entsprechende Anleitung an: [Erste Schritte mit der OVHcloud API](/guides/manage-and-operate/api/first-steps).
>>
...
### Schritt 2: Ein privates Netzwerk im vRack erstellen <a id="create-pn-in-vrack"></a>
...
![VLAN-Erstellung](/images/guides/public-cloud/public-cloud-network-services/configuration-06-configure-ip-block-vrack-to-instance/vrack2022-03.png)
...
![Region auswählen](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack5-2024.png)

Im nächsten Schritt werden Ihnen mehrere Optionen präsentiert:

![Netzwerk erstellen](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack6-2022.png)
...
Wenn Sie mit Servern in diesem VLAN kommunizieren möchten, konsultieren Sie bitte die Anleitung: [Mehrere vLANs in einem vRack erstellen](/guides/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack).
...
- **Einen Gateway zuweisen und sich mit dem privaten Netzwerk verbinden**: Wählen Sie diese Option, wenn Sie beabsichtigen, Instanzen mit einem privaten Netzwerk zu erstellen. Weitere Informationen finden Sie in den folgenden Anleitungen: [Ein privates Netzwerk mit Gateway erstellen](/guides/public-cloud/public-cloud-network-services/create-private-network-gateway) und [Erstellen und Verbinden mit Ihrer ersten Public Cloud-Instanz](/guides/public-cloud/compute/compute-getting-started).
...
### Schritt 3: Integrieren einer Instanz in vRack <a id="instance-integration"></a>
...
Wenn Sie Unterstützung benötigen, folgen Sie zunächst diesem Leitfaden: [Erstellen einer Instanz im OVHcloud Kundencenter](/guides/public-cloud/compute/compute-getting-started). Beim Erstellen einer Instanz können Sie in Schritt 5 einen Netzwerkmodus wählen, gefolgt von einem privaten Netzwerk, in das Sie Ihre Instanz integrieren können.
...
Melden Sie sich im [OVHcloud Kundencenter](/links/manager) an, gehen Sie in den Bereich `Public Cloud` und wählen Sie das betreffende Public Cloud-Projekt aus.
...
![attach network](/images/guides/public-cloud/public-cloud-network-services/configuration-06-configure-ip-block-vrack-to-instance/vrack2021-01.png)
...
![attach network](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack9.png)
...
![connection Horizon](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon1.png)
