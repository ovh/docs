...
Loggen Sie sich in Ihr [OVHcloud Kundencenter](/links/manager) ein, gehen Sie in den Bereich `Public Cloud` und wählen Sie das betreffende Public Cloud Projekt aus.  Klicken Sie im linken Menü auf `Instanzen` unter **Compute** und finden Sie Ihre beiden SNS EVA Instanzen.
