...
Verbinden Sie sich über SSH mit Ihrer Instanz. Weitere Informationen hierzu finden Sie in der Anleitung zum [Einloggen auf einer Instanz](/guides/public-cloud/compute/public-cloud-first-steps#connect-instance/).
...
Loggen Sie sich über eine Remote-Verbindung (RDP) oder mit der VNC-Konsole auf der Instanz ein. Weitere Informationen hierzu finden Sie in der Anleitung zum [Einloggen auf einer Instanz](/guides/public-cloud/compute/public-cloud-first-steps#connect-instance/).

Öffnen Sie die <code className="action">Netzwerkeinstellungen</code>.

<img className="thumbnail" alt="DNS Server ändern" src="/images/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers1.png" loading="lazy" />

Gehen Sie über die Systemsteuerung zur IPv4-Konfiguration Ihrer öffentlichen Netzwerkschnittstelle.

<img className="thumbnail" alt="DNS Server ändern" src="/images/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers2.png" loading="lazy" />

Fügen Sie die gewünschten Server in den <code className="action">Erweiterten Einstellungen</code> hinzu.

<img className="thumbnail" alt="DNS Server ändern" src="/images/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers3.png" loading="lazy" />
