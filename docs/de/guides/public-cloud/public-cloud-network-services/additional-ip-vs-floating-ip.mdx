...
More information about configuring Additional IP addresses is available in [this guide](/guides/public-cloud/public-cloud-network-services/configure-additional-ip).
...
More information about configuring Floating IP is available on the [Public Cloud Networking Concepts page](/guides/public-cloud/public-cloud-network-services/concepts).

### How to obtain public IP addresses in the OVHcloud Control Panel

In the [OVHcloud Control Panel](/links/manager), in the `Public Cloud` section, go to the **Network** section of the left-hand menu and select `Public IPs`. Here you can manage Additional IP and Floating IP addresses according to your needs.
