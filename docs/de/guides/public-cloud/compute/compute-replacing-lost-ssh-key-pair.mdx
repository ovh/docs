...
Erstellen Sie ein neues SSH-Schlüsselpaar auf Ihrem lokalen Gerät, wie im [ersten Abschnitt der Dokumentation zu SSH-Schlüsseln](/guides/public-cloud/compute/compute-creating-ssh-keys) beschrieben.
...
Starten Sie die Instanz im "normalen" Modus über Ihr [OVHcloud Kundencenter](/links/manager) neu. Folgen Sie bei Bedarf der [Anleitung zum Rescue-Modus](/guides/public-cloud/compute/put-an-instance-in-rescue-mode).
