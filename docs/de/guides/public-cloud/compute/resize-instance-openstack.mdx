...
- Sie haben [OpenStack CLI auf Ihrem System installiert](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/).
- Sie haben die [OpenStack Umgebungsvariablen konfiguriert](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/).
