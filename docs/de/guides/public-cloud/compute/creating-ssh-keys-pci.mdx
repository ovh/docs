...
Weitere Informationen finden Sie in unserer [Anleitung zur Erstellung einer Public Cloud Instanz](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
...
:::info
`Ed25519` gilt als derzeit sicherste Methode, aber `RSA` ist eine valide Alternative. Beide sind mit dem [OVHcloud Kundencenter](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/) kompatibel.
...
Kopieren Sie diese Schlüsselzeichenfolge, um [sie einer neuen Instanz hinzuzufügen oder in Ihr Kundencenter zu importieren](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
...
[Erstellung einer Public Cloud Instanz](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)
