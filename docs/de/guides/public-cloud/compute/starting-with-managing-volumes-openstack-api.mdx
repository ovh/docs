...
- [Vorbereitung der Umgebung für die Verwendung der OpenStack API](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/) durch Installation des *python-cinderclient* und des *python-novaclient*
- [Laden der OpenStack Umgebungsvariablen](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/)
