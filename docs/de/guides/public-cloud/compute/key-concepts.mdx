...
:::info
**Best Practice:** Für kritische Workloads ist eine [Multi-AZ-Bereitstellung](/guides/public-cloud/public-cloud-cross-functional/3az-ref-architecture/) zu bevorzugen, um Dienstresilienz und -kontinuität zu gewährleisten.
...
Für detaillierte Anweisungen zur Erstellung und Nutzung von SSH-Schlüsseln konsultieren Sie [unsere Anleitung](/guides/public-cloud/compute/compute-creating-ssh-keys/).
...
:::info
**Best Practice:** Backups ersetzen keine [resiliente Architektur](/guides/public-cloud/public-cloud-cross-functional/3az-ref-architecture/). Für kritische Umgebungen kombinieren Sie Backups mit Multi-AZ-Replikation, um maximale Datensicherheit und Dienstverfügbarkeit zu gewährleisten.
...
Für detailliertere Anweisungen zur Konfiguration von Public Cloud Netzwerken konsultieren Sie [unsere Anleitung](/guides/public-cloud/public-cloud-network-services/concepts-01-public-cloud-networking-concepts/).
...
Savings Plans helfen Ihnen, Ihr Budget zu optimieren, ohne die Leistung und Zuverlässigkeit Ihrer Cloud-Umgebung zu beeinträchtigen. Weitere Informationen finden Sie in [unserer Anleitung](/guides/public-cloud/public-cloud-cross-functional/savings-plans/).
...
- [So erstellen Sie eine Public Cloud Instanz und verbinden sich damit](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)
