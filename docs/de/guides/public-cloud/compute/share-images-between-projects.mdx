...
- Sie haben [Ihre Umgebung für die Verwendung der OpenStack API vorbereitet](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/).
