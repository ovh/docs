...
- [Sie haben die Umgebung für die Verwendung der OpenStack-API vorbereitet](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/).
- [Sie haben die OpenStack-Umgebungsvariablen eingerichtet](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/).
