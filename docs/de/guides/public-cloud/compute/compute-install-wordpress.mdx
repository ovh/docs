...
- Sie haben eine [Public Cloud Instanz](/guides/public-cloud/compute/compute-getting-started) mit Debian oder Ubuntu erstellt.
...
### Schritt 2: Konfiguration des Datenbankservers <a id="sqlconf"></a>
...
>
> Alternativ dazu bietet Ihnen OVHcloud die Lösung [SSL Gateway](/links/web/ssl-gateway). Weitere Informationen dazu finden Sie in [unseren Anleitungen](/guides/web-cloud/ssl-gateway/ssl-gateway-order).
> 
