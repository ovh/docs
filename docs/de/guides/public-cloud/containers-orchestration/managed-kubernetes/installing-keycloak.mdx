...
For more information, please refer to the following documentation: [Setting-up a Persistent Volume on OVHcloud Managed Kubernetes](/guides/public-cloud/containers-orchestration/managed-kubernetes/setting-up-a-persistent-volume#persistent-volumes-pv-and-persistent-volume-claims-pvc/)
