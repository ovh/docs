...
Retrieve your OpenStack user info from the command-line tool (refer to the [Setting OpenStack environment variables](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/) guide) for the region you want to scrape.
