...
Please refer to our tutorial on [How to secure a Nginx Ingress with cert-manager on OVHcloud Managed Kubernetes](/guides/public-cloud/containers-orchestration/managed-kubernetes/securing-nginx-ingress-cert-manager/) for ingresses configuration.
