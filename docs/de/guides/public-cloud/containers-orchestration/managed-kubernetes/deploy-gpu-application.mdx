...
![GPU Node Pool](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-gpu-application/gpu-node-pool.png)
...
![Select your cluster](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-gpu-application/create-a-nodepool-1.png)

Click on your cluster, then on the `Node pools` tab.
...
![Name your GPU node pool](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-gpu-application/create-a-nodepool-2.png)

Select a flavor for your new node pool, then click on the `GPU` tab. You can choose "T1-45" for example.

![Select a flavor for your GPU node pool](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-gpu-application/create-a-nodepool-3.png)

In the next step, define the size of your GPU node pool.
You can enable the `Autoscaling` feature.
Define the minimum and maximum pool size in that case, 3 in minimum and 10 in maximum, for example.

![Define a size and autoscaling for your GPU node pool](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-gpu-application/create-a-nodepool-4.png)

Then, choose `Hourly` billing mode for this GPU node pool.

![Billing mode](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-gpu-application/create-a-nodepool-5.png)
...
![GPU nodes](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-gpu-application/create-a-nodepool-6.png)
...
![NVIDIA GPU Kubernetes Operator](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-gpu-application/nvidia-gpu-operator.jpeg)
...
![GPU Nodes NVIDIA labels](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/deploying-gpu-application/gpu-nodes-labels.png)
...
To learn more about using your Kubernetes cluster the practical way, we invite you to look at our [OVHcloud Managed Kubernetes documentation](/guides/public-cloud/containers-orchestration/managed-kubernetes/create-cluster).
