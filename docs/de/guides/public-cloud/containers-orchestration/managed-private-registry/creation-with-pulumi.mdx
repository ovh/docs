...
![Pulumi](/images/guides/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-with-pulumi/pulumi.jpg)
...
![OVHcloud API rights](/images/guides/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-with-pulumi/api-rights.png)
...
![Copy paste service name](/images/guides/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-through-terraform/get-service-name.png)
...
Log in to the [OVHcloud Control Panel](/links/manager), go to the `Public Cloud` section and click on `Managed Private Registry`. <br />
As you can see, your registry has been successfuly created:

![Managed private registry](/images/guides/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-with-pulumi/private-registry.png)
...
![Harbor](/images/guides/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-with-pulumi/harbor.png)

![Harbor home page](/images/guides/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-with-pulumi/harbor-homepage.png)

Then click on the created project:

![Harbor created project](/images/guides/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-with-pulumi/harbor-project.png)
