...
- [Erste Instanz erstellen](/guides/public-cloud/compute/compute-getting-started)
- [Quota verwalten](/guides/public-cloud/public-cloud-cross-functional/increasing-public-cloud-quota)

## Globaler Ansatz <a id="global-approach"></a>
...
## Konkreter Ansatz <a id="concrete-approach"></a>
...
|[Glossar](/guides/public-cloud/compute/key-concepts)|Die Konzepte und Definitionen zur fortgeschrittenen Nutzung.|
...
|Dokumentation|Beschreibung|
|---|---|
|[Erste Instanz erstellen](/guides/public-cloud/compute/compute-getting-started)|Praktische Anleitung zum Starten eines Cloud-Servers über das OVHcloud Kundencenter.|
...
|[Konfiguration des privaten Netzwerks](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack)|Bei OVHcloud werden private Netzwerke mit der vRack Technologie eingesetzt. Diese Anleitung begleitet Sie bei der Umsetzung.|
...
|[Eine Additional IP konfigurieren](/guides/public-cloud/public-cloud-network-services/configure-additional-ip)|Mit Additional IPs können Sie den Traffic von einer Instanz auf eine andere umstellen. In dieser Anleitung erfahren Sie, wie Sie diesen konfigurieren.|
...
|[OpenStack CLI installieren](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment)|OpenStack kann auch über die Kommandozeile verwendet werden. Hier können Sie die Tools installieren.|
