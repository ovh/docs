...
![Landing zone architecture diagram](/images/guides/public-cloud/public-cloud-cross-functional/landing-zone-migration/landing_zone_architecture.png)
...
Follow [this guide](/guides/public-cloud/public-cloud-network-services/create-private-network-gateway) to set up a gateway.
...
Use Floating IPs to expose selected private resources (e.g., instances, services) to the public internet securely. Follow [this guide](/guides/public-cloud/public-cloud-network-services/attach-floating-ip-to-instance) to link a Floating IP.
...
Follow [this guide](/guides/public-cloud/public-cloud-network-services/getting-started-load-balancer) to set up and use a Load Balancer.
...
Follow [this guide](/guides/public-cloud/public-cloud-network-services/stormshield-vrack) to set up and use a Stormshield firewall.
...
Follow [this guide](/guides/public-cloud/public-cloud-network-services/ubika-vrack) to deploy a WAAP protection with Ubika.
...
See the [related documentation](/guides/public-cloud/public-cloud-cross-functional/security-structure-best-practices).
