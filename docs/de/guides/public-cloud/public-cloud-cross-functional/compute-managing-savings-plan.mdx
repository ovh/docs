...
Log in to the [OVHcloud Control Panel](/links/manager) and go to the `Public Cloud` section. Once you have selected your Public Cloud project, click on `Savings Plans` in the left-hand navigation bar under **Einstellungen**.
