...
Um sich mit Horizon zu verbinden und die Datei herunterzuladen, lesen Sie [diese Anleitung](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon/).
