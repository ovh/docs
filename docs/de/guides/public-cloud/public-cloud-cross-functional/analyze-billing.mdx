...
Um die Rechnungen eines Projekts anzuzeigen, loggen Sie sich in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) ein und wählen Sie Ihr <code className="action">Public Cloud</code> Projekt aus. Klicken Sie links auf <code className="action">Abrechnung</code> (im Abschnitt `Einstellungen`) und dann auf den Tab <code className="action">History</code>.
