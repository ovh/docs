...
This guide covers the submission of [**apps**](/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/) through the [**ovhai CLI**](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/).
...
- A working `ovhai` CLI. See [how to install ovhai CLI](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/)
...
:::info
More information about adding and managing public & private registries can be found [here](/guides/public-cloud/ai-machine-learning/gi-07-manage-registry/).
...
For more information about **static and automatic scaling strategies**, please refer to this [documentation](/guides/public-cloud/ai-machine-learning/deploy-guide-04-scaling-strategies/).
...
Using tokens can help you share your app securely. More information about creating, managing and using tokens can be found [here](/guides/public-cloud/ai-machine-learning/deploy-guide-03-tokens/). 
...
To know more about the CLI and available commands to interact with your app check out the [overview of `ovhai`](/guides/public-cloud/ai-machine-learning/cli-15-commands-reference/).
