...
You can launch your notebook from the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) or via the ovhai [CLI](/guides/public-cloud/ai-machine-learning/cli-11-howto-run-notebook-cli/).
...
- With NLP, you can do **sentiment analysis**. For more information, click [here](/guides/public-cloud/ai-machine-learning/notebook-tuto-05-hugging-face-sentiment-analysis/).
