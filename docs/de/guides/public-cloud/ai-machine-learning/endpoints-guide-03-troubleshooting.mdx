...
All steps for starting with AI Endpoints are described in the [AI Endpoints - Getting Started](/guides/public-cloud/ai-machine-learning/endpoints-guide-01-getting-started/) guide.
...
A 401 error code typically indicates that the authorization token specified in the call is either expired or invalid. To resolve this issue, you will need to generate a new authorization token and include it in your request headers. Fore more information on the token creation process, follow the [AI Endpoints - Getting Started](/guides/public-cloud/ai-machine-learning/endpoints-guide-01-getting-started/) guide.
...
If you are now unable to use a model you were previously using, it might have been decommissioned. OVHcloud AI Endpoints follows a [model lifecycle process](/guides/public-cloud/ai-machine-learning/endpoints-guide-04-billing-concept/) to ensure a seamless experience for our customers. As stated in the documentation linked above, we notify you of our decision to retire a model three months in advance, giving you time to prepare for migration.
