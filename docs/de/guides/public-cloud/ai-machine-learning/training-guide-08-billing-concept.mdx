...
Their official pricing is available in the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) or on the [OVHcloud Public Cloud website](https://www.ovhcloud.com/de/public-cloud/prices/).
