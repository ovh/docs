...
AI Training is compliant with the OVHcloud AI CLI. Discover how to [install the OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/).
...
Learn how to build and use your custom Docker image in this [tutorial](/guides/public-cloud/ai-machine-learning/training-tuto-02-build-custom-image/).
