...
![DCGAN training animation](/images/guides/public-cloud/ai-machine-learning/notebook-tuto-14-image-generation-dcgan/dcgan_training_animation.gif)
...
You can launch the notebook from the [OVHcloud Control Panel](/links/manager) or via the ovhai [CLI](/guides/public-cloud/ai-machine-learning/ai-cli-run-notebook).
