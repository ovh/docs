...
Sie können Ihren Domainnamen dann über Ihr [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) verwalten.
...
<Tabs>
  <Tab label="Schritt 1">
    Gehen Sie auf die Seite [Meine Angebote und Dienste](https://manager.eu.ovhcloud.com/#/billing/autorenew/services).
  </Tab>
  <Tab label="Schritt 2">
...
Nach der Bestellung erscheinen IDNs in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) im Format **xn--**.

Auch wenn Ihr Domainname in [internationalisierter Notation (IDN)](https://en.wikipedia.org/wiki/Internationalized_domain_name) in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) angezeigt wird, funktioniert er anderswo normal und wird normal angezeigt. Ihre Website-Adresse wird wie gewünscht angezeigt. Ihre E-Mail-Adressen werden Ihren Kontakten ebenfalls wie gewünscht angezeigt.
...
:::tip[Success]
Alle Details finden Sie in unserer Anleitung "[Verlängerung von OVHcloud Diensten](/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/)".
...
Führen Sie ein [Verfahren zur Kontaktwiederherstellung](https://www.ovh.de/cgi-bin/de/procedure/procedureChangeContacts.cgi) durch, damit Ihr Domainname vollständig in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) verwaltet wird. So müssen Sie die Person, die Ihren Domainnamen zuvor verwaltet hat, nicht mehr kontaktieren.
...
- **Über Ihr OVHcloud Kundencenter**: Wenn die aktive DNS-Zone für Ihren Domainnamen von OVHcloud verwaltet wird, gehen Sie auf die Seite [DNS-Zone](https://manager.eu.ovhcloud.com/#/web/zone), um alle für Ihren Domainnamen deklarierten DNS-Einträge anzuzeigen.
...
<Tabs>
  <Tab label="Schritt 1">
    Gehen Sie auf die Seite [DNS-Zone](https://manager.eu.ovhcloud.com/#/web/zone), und klicken Sie auf die Schaltfläche <code className="action">Bestellen</code> oben rechts in der angezeigten Tabelle.
  </Tab>
  <Tab label="Schritt 2">
...
<Tabs>
  <Tab label="Schritt 1">
    Gehen Sie auf die Seite [DNS-Zone](https://manager.eu.ovhcloud.com/#/web/zone), und wählen Sie die betreffende Subdomain aus.
...
:::tip[Success]
Wenn Sie diese E-Mail nicht erhalten haben, überprüfen Sie Ihren Spam-Ordner oder gehen Sie auf die Seite [Mein Account](https://manager.eu.ovhcloud.com/#/account/useraccount/dashboard), und klicken Sie auf den Tab <code className="action">Empfangene E-Mails</code>.
...
<Tabs>
  <Tab label="Schritt 1">
    Gehen Sie auf die Seite [DNS-Zone](https://manager.eu.ovhcloud.com/#/web/zone), und überprüfen Sie, ob der betreffende Domainname angezeigt wird.
...
Wenn der Tab in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) nicht angezeigt wird, bedeutet dies, dass die Option "GLUE" für Ihren Domainnamen nicht verfügbar ist.
...
In Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) zeigt diese Meldung lediglich an, dass die für Ihren Domainnamen erstellte DNS-Zone nicht dessen aktive DNS-Zone ist.
...
<Tabs>
  <Tab label="Schritt 1">
    Gehen Sie auf die Seite [Domainnamen](https://manager.eu.ovhcloud.com/#/web-domains/domain), und überprüfen Sie, ob der betreffende Domainname angezeigt wird.
  ...
  <Tab label="Schritt 2">
    **Fall 1** – Der Domainname erscheint nicht in der Liste:
    ...
    - Der Domainname ist bei OVHcloud registriert: Sie können ein [Verfahren zur Kontaktwiederherstellung](https://www.ovh.de/cgi-bin/de/procedure/procedureChangeContacts.cgi) durchführen, damit Ihr Domainname in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) verwaltet wird.
    - Der Domainname ist nicht bei OVHcloud registriert: Sie können einen [eingehenden Transfer](/guides/web-cloud/domains/transfer-incoming-generic-domain/) zu OVHcloud durchführen, damit Ihr Domainname in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) verwaltet wird.
    ...
    **Fall 2** – Der Domainname erscheint in der Liste:
    ...
    Sie können dann ein [Verfahren zur Kontaktwiederherstellung](https://www.ovh.de/cgi-bin/de/procedure/procedureChangeContacts.cgi) durchführen, damit Ihr Domainname vollständig in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) verwaltet wird.
  </Tab>
</Tabs>
...
[FAQ zum Webhosting](/guides/web-cloud/web-hosting/faq-web-hosting/)
