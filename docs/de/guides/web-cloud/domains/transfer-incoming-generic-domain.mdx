...
Der Transferprozess kann über die Seite [Laufende Vorgänge](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/web/ongoing-operations) neu gestartet werden.
...
Sobald der Transfer abgeschlossen ist, können Sie Ihren Domainnamen über die Seite [Domainnamen](https://manager.eu.ovhcloud.com/#/web-domains/domain) verwalten.
