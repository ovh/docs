...
Loggen Sie sich in Ihr [OVHcloud Kundencenter](/links/manager) ein und klicken Sie im Bereich `Web Cloud` links auf `Web Cloud Databases`. Wählen Sie den Namen Ihres Datenbankservers aus.
...
> [!warning]
>
> Wenn Sie Web Cloud Databases oder SQL Private für Datenbanken einsetzen, vergessen Sie nicht, Ihrer IP-Adresse mithilfe der Anleitung [Konfiguration Ihres Datenbankservers](/guides/web-cloud/web-cloud-databases/db-configure-optimise-database-server) den Zugriff zu erlauben.
>
...
- Starten Sie SQuirreL und klicken Sie auf `Aliases` und dann auf `+`.

![launch SQuirreL SQL](/images/assets/screens/other/web-tools/squirrel/aliases.png)

- Füllen Sie die folgenden Felder aus und bestätigen Sie mit dem Button `OK`:
...
![config](/images/assets/screens/other/web-tools/squirrel/add-alias.png)

- Bestätigen Sie erneut mit dem Button `Connect`.
...
![config](/images/assets/screens/other/web-tools/squirrel/general-dashboard.png)
