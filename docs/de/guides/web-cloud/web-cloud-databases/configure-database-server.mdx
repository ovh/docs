...
Um einen Web Cloud Databases Dienst vom Webhosting **Performance** abzutrennen, lesen Sie unsere Anleitung "[Web Cloud Databases von einem Webhosting abtrennen](/guides/web-cloud/web-cloud-databases/detach-from-web-hosting/)".
...
Um die Logs Ihrer Web Cloud Databases Lösung einzusehen, lesen Sie unsere Anleitung "[Web Cloud Databases - Logs abrufen](/guides/web-cloud/web-cloud-databases/retrieve-logs/)".
