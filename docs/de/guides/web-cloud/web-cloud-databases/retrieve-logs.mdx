...
Um dies zu überprüfen, ermitteln Sie die öffentliche IP-Adresse Ihres Internetzugangs und lesen Sie den Abschnitt **IP-Adresse autorisieren** in [dieser Anleitung](/guides/web-cloud/web-cloud-databases/starting-with-clouddb/).
...
Weitere Informationen zu Logs Data Platform finden Sie in unserer Anleitung [Einführung in Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-introduction-to-ldp/) (EN).
...
Lesen Sie bei Bedarf unsere Anleitungen "[Einführung in Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-introduction-to-ldp/)" (EN) und "[Schnelleinstieg in Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-quick-start/)" (EN).
  </Tab>
  <Tab label="Schritt 5">
...
[Erste Schritte mit Ihrem Web Cloud Databases](/guides/web-cloud/web-cloud-databases/starting-with-clouddb/)

[Einführung in Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-introduction-to-ldp/) (EN)
