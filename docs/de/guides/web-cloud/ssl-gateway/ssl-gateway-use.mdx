...
> [!info]
>
> - Sie haben bereits ein [SSL Gateway bestellt](/guides/web-cloud/ssl-gateway/ssl-gateway-order).
...
- Loggen Sie sich in [Ihr Kundencenter](/links/manager) ein.
- Klicken Sie dann auf den Bereich `Sunrise`.

![Button Sunrise](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/4.PNG)

- Klicken Sie anschließend auf `SSL Gateway`, um Ihre Dienstleistung einzusehen.

![Button SSL Gateway](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/5.PNG)

- Wählen Sie dann das Angebot, dass Sie konfigurieren möchten.

![Angebotsseite](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/6.PNG)

- So gelangen Sie auf die Verwaltungsseite Ihres Angebots.

![Übersicht Konfiguration](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/7.PNG)

- Beschreibung der Informationen

![Informationen](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/8.PNG)
...
![Konfigurationsteil](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/9.PNG)

|---|---|
|---|---|
|Konfiguration|Button, um die Konfiguration Ihrer SSL Gateway Dienstleistung zu bearbeiten|
|HSTS [[1]](#id5)|Zwingt den Browser dazu, die nächsten Verbindungen mit Ihrer Website über HTTPS durchzuführen|
|Reverse|Erlaubt es, einen Hostnamen über Ihrer SSL Gateway IP anzuzeigen|
|HTTPS [[2]](#id6) Umleitung|Leitet den Besucher Ihrer Website weiter auf die HTTPS Version, wenn er ursprünglich über HTTP darauf zugreift|
|HTTPS [[3]](#id7) Server|Aktiviert HTTPS zwischen dem SSL Gateway Server und Ihrem Server|
...
|Cipher-Konfiguration [[4]](#id8)|Ermöglicht es Ihnen, verschiedene Sicherheitslevel für Ihr SSL/TLS-Zertifikat auszuwählen|
...
![Domains Tab](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/10.PNG)

In dem Tab **"Domains"** können Sie Ihre Domains und Subdomains zu Ihrem SSL Gateway hinzufügen.

- Klicken Sie auf `+ Domain`, um eine Domain oder Subdomain hinzuzufügen.
    - 

:::details Sie haben ein SSL Gateway "Free"
...
>> > 
>> 
>>         - Wählen Sie die Domain und klicken Sie zur Bestätigung auf `Hinzufügen`.

![Free Domain hinzufügen](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/11.PNG)

:::details Sie haben ein SSL Gateway "Advanced"
...
![Advanced Domain hinzufügen](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/12.PNG)
...
- Klicken Sie auf `+ Server`, um eine IP-Adresse und den entsprechenden Port zu dem Server hinzuzufügen, auf dem sich Ihre Website befindet.

![Tab Server](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/13.PNG)
...
![Advanced IP/PORT hinzufügen (intern)](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/15.PNG)
...
![Tab Tasks](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/13-bis.PNG)
...
![Tab Graphen](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/17.PNG)
