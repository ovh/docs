...
Que vous commandiez un nouveau numéro ou souhaitiez valider votre identité pour un numéro déjà en exploitation, cliquez sur l'onglet `Commande de numéros` ou sur `Commander un numéro` dans le menu « Je veux... ».

![commande de numéro](/images/guides/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-commande.png)

Vous accédez alors aux différents types de numéros. Cliquez sur `Vérifier l'identité` en face de « Numéros à valeur ajoutée ».

![vérifier l'identité](/images/guides/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-identite.png)
...
![renseigner coordonnées](/images/guides/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-coordonnees01.png)
![renseigner coordonnées](/images/guides/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-coordonnees02.png)
![renseigner coordonnées](/images/guides/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-coordonnees03.png)

### Ajouter des bénéficiaires

Si vous êtes le seul bénéficiaire, cochez la case « Mon représentant est bénéficiaire ». 

![représentant bénéficiairs](/images/guides/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/beneficiaire.png)

Dans le cas contraire, cliquez sur `+ Ajouter un bénéficiaire` et renseignez les coordonnées du bénéficiaire.

> [!info]
> Vous pouvez ajouter jusqu'à 4 bénéficiaires.

![ajout bénéficiaires](/images/guides/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-beneficiaire1.png)
...
![ajout bénéficiaires](/images/guides/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-beneficiaire2.png)

Cliquez sur `Etape suivante`.

Dans la fenêtre qui s'affiche alors, prenez connaissance des informations puis saisissez `CONFIRMER` dans le champ prévu à cet effet et cliquez sur `Valider mes informations`.

![confirmation](/images/guides/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-confirmer.png)

### Téléverser les documents justificatifs

Une fois vos informations saisies, la liste des documents justificatifs à fournir apparaît. Cliquez sur le bouton `...` puis sur `Télécharger` à droite de chaque document à fournir. 

Cliquez sur `Sélectionner un fichier`, sélectionnez le document correspondant sur votre poste de travail puis cliquez sur `Valider le document`.
...
![ajout des documents](/images/guides/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-documents-v2.png)

Une fois tous vos documents ajoutés, cliquez sur `Retourner au tableau de bord`.
...
#### Entité juridique <a id="entitejuridique"></a>

##### **Société non cotée** <a id="societenoncotee"></a>
...
##### **Société cotée dans un pays de l'UE ou un pays tiers équivalent** <a id="societecotee"></a>
...
##### **Association/Organisme juridique** <a id="association"></a>
...
##### **Administration/Autorité ou Agences publiques et autorités régionales** <a id="administration"></a>
...
##### **Fonds de dotation** <a id="fondsdotation"></a>
...
##### **Exploitation agricole à responsabilité limitée** <a id="exploitationagricole"></a>
...
#### Auto-entrepreneur <a id="autoentrepreneur"></a>
...
#### Fonds d'investissement <a id="fondsinvestissement"></a>

##### **Fonds avec personnalité morale** <a id="fondspersonnalitemorale"></a>
...
##### **Fonds commun de placement (FCP)** <a id="fcp"></a>
...
#### Comité social et économique (CSE) <a id="cse"></a>
...
#### Groupement d'intérêt public, Centre hospitalier universitaire, Établissement public d'intérêt général, Société d'investissement immobilier, Établissements de santé privés d'intérêt collectif <a id="divers"></a>
...
#### Compagnie d'assurance <a id="assurance"></a>
...
#### Paroisse ou église <a id="eglise"></a>
...
Dans votre `Tableau de bord`, cliquez sur `Voir mon profil SVA` dans la partie `Profil SVA`.

Vous aurez alors accès aux coordonnées précédemment renseignées ainsi qu'au tableau récapitulatif de vos documents.

La colonne `Statut` du tableau vous indique le statut de validation du document. Le bouton `...` à droite de chaque document vous permet d'interagir en conséquence.
...
|Non valide|Votre document a été vérifié mais n'est pas conforme|Cliquez sur `...` à droite de ce document pour téléverser un nouveau justificatif|
|Arrivé à expiration le XX/XX/XXXX|La date de fin de validité sera bientôt atteinte|Cliquez sur `...` à droite de ce document pour téléverser un nouveau justificatif à jour|
|Expiré|La date de fin de validité du document est atteinte|Cliquez sur `...` à droite de ce document pour téléverser un nouveau justificatif à jour|
