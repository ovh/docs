...
1. Positionnez-vous sur l'onglet `Gestion des appels`, puis cliquez sur `Double appel et Intercom`.
 
![modeintercom](/images/guides/web-cloud/phone-and-fax/voip/mode-intercom/mode-intercom-step1.png)

### Étape 2 : gérer le mode intercom

Une fois positionné sur la page « Double appel et Intercom », vous avez la possibilité de réaliser deux actions différentes selon l'état d'activation du mode intercom. Cet état est représenté par la case se trouvant à côté de `Activer le mode Intercom avec préfixe 3691`.

Poursuivez la lecture de cette documentation selon la manipulation que vous souhaitez réaliser.

#### Activer le mode intercom

Pour activer le mode intercom, cochez la case `Activer le mode Intercom avec préfixe 3691`, puis cliquez sur le bouton `Valider`.

Si vous souhaitez activer ce mode sur plusieurs lignes, cliquez sur `Appliquer à plusieurs lignes`, choisissez les lignes concernées dans la fenêtre de sélection, puis cliquez sur le bouton `Valider`.

![modeintercom](/images/guides/web-cloud/phone-and-fax/voip/mode-intercom/mode-intercom-step2.png)

#### Désactiver le mode intercom

Pour désactiver le mode intercom, décochez la case `Activer le mode Intercom avec préfixe 3691`, puis cliquez sur le bouton `Valider`.

Si vous souhaitez désactiver ce mode sur plusieurs lignes, cliquez sur `Appliquer à plusieurs lignes`, choisissez les lignes concernées dans la fenêtre de sélection, puis cliquez sur le bouton `Valider`.
