...
![informations générales](/images/guides/web-cloud/phone-and-fax/voip/register-sip-softphone/general-information.png)

Vous retrouvez alors, dans le cadre « Informations SIP », votre **Login**, **Domain** et **Proxy sortant**.

![username - domain](/images/guides/web-cloud/phone-and-fax/voip/register-sip-softphone/username-domain.png)
