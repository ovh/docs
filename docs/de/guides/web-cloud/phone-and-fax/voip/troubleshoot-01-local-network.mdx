...
### Étape 2 - Vérifier la connectivité réseau du téléphone <a id="connectivity"></a>
...
![port sur téléphone](/images/guides/web-cloud/phone-and-fax/voip/troubleshoot-01-local-network/phone-port.png)
...
![port sur routeur](/images/guides/web-cloud/phone-and-fax/voip/troubleshoot-01-local-network/router-port.png)
...
Suivez les instructions de [ce guide](/guides/web-cloud/phone-and-fax/voip/troubleshoot-02-fix-control-panel) pour effectuer ce dépannage.
