...
> Dans ce cadre, consultez [cette procédure](/guides/web-cloud/internet/internet-access/comment-activer-mes-lignes-telephoniques-offre-adsl-vdsl)
>
...
Vous pouvez également retrouver cet e-mail dans votre espace client. Pour cela, connectez-vous à votre [espace client OVHcloud](/links/manager), cliquez sur votre nom en haut à droite puis sur `Mes communications`.

![Mes communications](/images/assets/screens/control-panel/product-selection/telecom/mes-communications.png)

Si vous souhaitez générer la procédure manuellement (dans le cadre d'un changement de NIC Facturation) ou anticiper et valider votre compte OVHcloud pour la téléphonie en vue d'une prochaine commande de services VoIP, connectez-vous à votre [espace client OVHcloud](/links/manager) puis cliquez sur `Télécom`.

Un message d'information vous invitera à cliquer sur le lien du formulaire de validation.

![procédure espace client](/images/guides/web-cloud/phone-and-fax/voip/la-procedure-de-validation-voip/procedure01-2022.png)

Renseignez les champs requis pour préciser les coordonnées du propriétaire du compte bancaire à utiliser, puis cliquez sur `Valider`.

![procédure espace client](/images/guides/web-cloud/phone-and-fax/voip/la-procedure-de-validation-voip/procedure02-2022.png)

Une fois le formulaire validé, son téléchargement au format PDF vous sera proposé.

![procédure espace client](/images/guides/web-cloud/phone-and-fax/voip/la-procedure-de-validation-voip/procedure03-2022.png)
...
Vous pouvez le télécharger **gratuitement** via ce lien : [http://www.adobe.com/fr/products/reader.html](http://www.adobe.com/fr/products/reader.html).
