...
1. Loggen Sie sich in Ihr [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) ein und gehen Sie dann in den Bereich <code className="action">Web Cloud</code>.
...
**SFTP** verwendet wie SSH den Standard-Port 22 anstelle von Port 21. Wenn Sie ein Cloud Web Hosting Angebot verwenden, müssen Sie den Port verwenden, der in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) angezeigt wird. Port 22 ist für Cloud Web Hostings per SSH und SFTP deaktiviert.
...
Gehen Sie hierzu in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) zum Tab <code className="action">FTP - SSH</code> zurück, wie im [ersten Teil](#part-1) dieser Anleitung beschrieben.
...
Überprüfen Sie Ihre Zugangsdaten, um sicherzustellen, dass keine Fehler gemeldet werden. Gegebenenfalls können Sie [Passwort des FTP-Zugangs ändern](/guides/web-cloud/web-hosting/ftp-change-password/) Ihres Webhostings direkt im [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de).
...
Überprüfen Sie diesen anhand des in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) angezeigten Hostnamens.
