...
Loggen Sie sich in Ihr [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) ein und wählen Sie im Bereich <code className="action">Web Cloud</code> links unter <code className="action">Hosting-Pakete</code> das betreffende Hosting aus. Gehen Sie dann auf den Tab <code className="action">Datenbanken</code>.
...
OVHcloud stellt Ihnen ein Online-Tool für das Datenbankmanagement zur Verfügung: phpMyAdmin. Loggen Sie sich in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) ein und gehen Sie in den Bereich <code className="action">Web Cloud</code>. Klicken Sie in der linken Spalte auf <code className="action">Hosting-Pakete</code>, wählen Sie das betreffende Hosting aus, und klicken Sie dann auf den Tab <code className="action">Datenbanken</code>.
...
Um die verfügbaren Snapshots sowie deren Erstellungsdatum und -zeit zu einzusehen, loggen Sie sich in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.de/&ovhSubsidiary=de) ein und gehen Sie dann in den Bereich <code className="action">Web Cloud</code>. Klicken Sie in der linken Spalte auf <code className="action">Hosting-Pakete</code>, wählen Sie das betreffende Hosting aus, und klicken Sie dann auf den Tab <code className="action">Datenbanken</code>.
