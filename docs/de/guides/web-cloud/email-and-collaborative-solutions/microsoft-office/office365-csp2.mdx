...
Um einen Office 365 Reseller Dienst zu bestellen, loggen Sie sich in Ihr [OVHcloud Kundencenter](/links/manager) ein und wählen Sie `Sunrise` im oberen Menu aus. Klicken Sie dann auf `Office 365 Revendeurs`.
...
- Klicken Sie auf `Bestellen`, um den Vorgang abzuschließen.
...
Gehen Sie hierzu in den Bereich `Sunrise`. Im Menü auf der linken Seite wählen Sie `Office 365 Revendeurs`, und dann den Dienst aus.
