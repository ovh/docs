...
### E-Mail-Account hinzufügen <a id="add-account"></a>
...
> 
> Diese Zahl finden Sie in Ihrem [OVHcloud Kundencenter](/links/manager), im Abschnitt `Web Cloud`, dann `Email Pro`. Der Servername ist im Bereich **Verbindung** des Tabs `Allgemeine Informationen` sichtbar.

<Tabs>
<Tab label="Schritt 1">

- Öffnen Sie Outlook. Klicken Sie in der linken Spalte auf `Konto hinzufügen`, um die Konfiguration zu starten.
...
- Geben Sie Ihr Passwort ein und klicken Sie auf den Button `Mehr anzeigen`.
...
### E-Mail-Adresse verwenden <a id="use-account"></a>
...
- Im Abschnitt "Ihre Konten" klicken Sie auf `Verwalten` rechts neben dem relevanten E-Mail-Account.
...
- Klicken Sie auf `Löschen`, um den Löschvorgang zu starten.
...
### Allgemeine Einstellungen zum Senden und Empfangen <a id="settings-account"></a>

#### IMAP und POP Empfangseinstellungen <a id="imap-pop"></a>
...
#### SMTP Sendeeinstellungen <a id="smtp"></a>
...
[Erste Schritte mit der Email Pro Lösung](/guides/web-cloud/email-and-collaborative-solutions/email-pro/first-config)
