...
- **Wenn Sie bereits einen Account eingerichtet haben**, klicken Sie am oberen Rand Ihres Bildschirms auf `Tools` und anschließend auf `Konten`. Klicken Sie im angezeigten Fenster auf `+` und anschließend auf `Neues Konto`.

![E-Mail Pro](/images/guides/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-outlook-2016-mac/configuration-outlook-2016-mac-step1.png)

Klicken Sie nun auf Ihre E-Mail-Adresse und dann auf `Weiter`. Aus den angezeigten Anbietern wählen Sie `IMAP/POP` aus.
...
Nachdem Sie diese Informationen eingegeben haben, klicken Sie auf `Konto hinzufügen`. Sind die Angaben korrekt, wird die Verbindung zu Ihrem Account hergestellt.

Sie können eine Test-E-Mail versenden, um zu überprüfen, ob der Account korrekt eingerichtet ist.

![E-Mail Pro](/images/guides/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-outlook-2016-mac/configuration-outlook-2016-mac-step2.png)
