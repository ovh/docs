...
>
> Sie finden diese Information im [OVHcloud Kundencenter](/links/manager), wenn Sie den betreffenden `E-Mail Pro` Dienst auswählen. Der Servername wird im Kasten **Verbindung** auf der Seite `Allgemeine Informationen` angezeigt.
>
...
- **Wenn ein Account bereits eingerichtet wurde**: Klicken Sie auf `Mail` im Menü oben auf Ihrem Bildschirm und dann auf `Accounts`.

| | |
|---|---|
|![mailmac](/images/guides/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-mail-macos/mail-mac-emailpro01.png)|Wählen `Sie Anderen Mail`-Account aus und klicken Sie auf `Mail-Account`.|
|Geben Sie im Fenster "**Mail Account hinzufügen**"folgende Informationen ein: <br />- **Name** Ihres E-Mail Accounts <br />- Ihre **E-Mail Adresse** <br />- **Passwort** Ihrer E-Mail-Adresse |![mailmac](/images/guides/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-mail-macos/mail-mac-emailpro02.png)|
|![mailmac](/images/guides/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-mail-macos/mail-mac-emailpro03.png)|Geben Sie im folgenden Fenster die Informationen ein: <br />- Lassen Sie Ihre **E-Mail-Adresse** bereits eingeben <br />- Geben Sie Ihre vollständige E-Mail-Adresse unter **Benutzername** ein <br />- Lassen Sie Ihr **Passwort** bereits eingegeben <br />- Wählen Sie `POP` oder `IMAP`(empfohlen) aus in **Account-Typ**<br />- Geben Sie `pro?.mail.ovh.net` in **Empfangsserver** (ersetzen Sie "?" mit der  Nummer Ihres Servers)<br />- Geben Sie auch `pro?.mail.ovh.net` in **Versendungsserver** (ersetzen Sie "?" mit der Nummer Ihres Servers)<br /><br />Um die Konfiguration abzuschließen, klicken Sie auf `Anmelden`|
...
- Klicken Sie auf `Mail` im Menü oben auf Ihrem Bildschirm und dann auf `Einstellungen`.
- Wählen Sie in der linken Spalte den betreffenden Account aus und klicken Sie auf `Server-Einstellungen`.
