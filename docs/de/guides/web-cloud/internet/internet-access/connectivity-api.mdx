...
##### **Getting a list of localities from a zip code** <a id="eligibilitySearchCities"></a>
...
##### Getting the list of streets for a locality <a id="eligibilitySearchStreets"></a>
...
##### **Getting the available street numbers for a given street code** <a id="eligibilitySearchStreetNumbers"></a>
...
##### **Getting all buildings for a specific address** <a id="eligibilitySearchBuildings"></a>
...
##### **Getting the building references from a given line number <a id="eligibilitySearchBuildingsByLine"></a>
...
##### **Doing an eligibility on a line** <a id="eligibilityTestLine"></a>
...
##### **Searching for an active or inactive line for an address** <a id="eligibilitySearchLines"></a>
...
##### **Searching for eligibility for an address <a id="eligibilityTestAddress"></a>
...
##### **Searching eligibility on a building** <a id="eligibilityTestBuilding"></a>
...
##### **Searching eligibility from an OTP identifier** <a id="eligibilityTestOtp"></a>
