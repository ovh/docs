...
![reutiliserWiFiOTB](/images/guides/web-cloud/internet/internet-access/comment-reutiliser-wifi-zyxel-otb/reutiliserWiFiOTB-step1-2022.png)

### Étape 2 : se connecter à l'interface locale du modem <a id="interface-locale"></a>
...
![reutiliserWiFiOTB](/images/guides/web-cloud/internet/internet-access/comment-reutiliser-wifi-zyxel-otb/reutiliserWiFiOTB-step2.png)
...
Une fois connecté à l'interface locale du modem, cliquez sur l'icône de menu en haut à droite, puis sur `Interface Grouping` dans le menu `Network Setting`.

![reutiliserWiFiOTB](/images/guides/web-cloud/internet/internet-access/comment-reutiliser-wifi-zyxel-otb/reutiliserWiFiOTB-step3-1.png)

Sur cette page, cliquez sur le bouton `+ Add New Interface Group`.

![reutiliserWiFiOTB](/images/guides/web-cloud/internet/internet-access/comment-reutiliser-wifi-zyxel-otb/reutiliserWiFiOTB-step3-2.png)
...
Une fois les interfaces souhaitées déplacées dans la section `Selected LAN Interfaces`, cliquez sur `OK` pour valider votre choix. Le modem va alors déplacer les interfaces dans le groupe `OverTheBox`. Un délai peut être nécessaire avant que ne s'affichent les deux groupes d'interfaces `Default` et `OverTheBox`.

![reutiliserWiFiOTB](/images/guides/web-cloud/internet/internet-access/comment-reutiliser-wifi-zyxel-otb/reutiliserWiFiOTB-step3-3-2022.png)

### Étape 4 : modifier la gestion du DHCP pour le groupe OverTheBox

Accédez maintenant à la page `Home Networking` qui se trouve également dans le menu `Network Settings`. Depuis cette page, il vous faut désactiver le DHCP du modem sur le groupe `OverTheBox`, afin que le serveur DHCP utilisé soit celui de l'OverTheBox.

![reutiliserWiFiOTB](/images/guides/web-cloud/internet/internet-access/comment-reutiliser-wifi-zyxel-otb/reutiliserWiFiOTB-step4.png)
...
Une fois les modifications effectuées, cliquez sur le bouton `Apply` pour appliquer votre configuration.
...
![reutiliserWiFiOTB](/images/guides/web-cloud/internet/internet-access/comment-reutiliser-wifi-zyxel-otb/reutiliserWiFiOTB-step6-1.png)
...
![reutiliserWiFiOTB](/images/guides/web-cloud/internet/internet-access/comment-reutiliser-wifi-zyxel-otb/reutiliserWiFiOTB-step6-2.png)
