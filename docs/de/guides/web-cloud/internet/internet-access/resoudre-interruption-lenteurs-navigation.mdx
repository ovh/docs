...
- **aucun incident sur votre ligne n'est en cours** : un incident plus global pourrait perturber votre accès. Rendez-vous donc sur la page [https://status.isp.ovh.net/](https://status.isp.ovh.net/) ou sur notre site [status-ovhcloud.com](https://web-cloud.status-ovhcloud.com/) ;
...
- si vous avez activé le protocole **IPv6** sur votre accès Internet OVHcloud, assurez-vous que le ou les sites qui ne fonctionnent pas sont bien accessibles via ce protocole. Si ce n'est pas le cas, désactiver l'IPv6 pourrait rétablir l'accès à ces pages. Cette gestion s'effectue dans l'espace client depuis l'onglet `Mon accès` de l'accès à Internet concerné, puis la section `Caractéristiques`.
...
Effectuez un clic droit sur l'image en bas à gauche représentant le logo **Windows** et cliquez sur `Connexions réseau`. Dans la fenêtre qui apparaît, assurez-vous d'être bien positionné sur l'onglet `État` dans la barre de menu à gauche, puis cliquez sur `Modifier les options d'adaptateur`.

![browsingoutage](/images/guides/web-cloud/internet/internet-access/resoudre-interruption-lenteurs-navigation/xdsl-browsing-outage-step1.png)
...
![browsingoutage](/images/guides/web-cloud/internet/internet-access/resoudre-interruption-lenteurs-navigation/xdsl-browsing-outage-step2.png)

Vous pouvez remarquer différents états concernant les cartes réseau.

|États|Illustration|Description|
|---|---|---|
|Active et connectée|![browsingoutage](/images/guides/web-cloud/internet/internet-access/resoudre-interruption-lenteurs-navigation/xdsl-windows10-state-ok.png)|La carte réseau est activée et vous êtes connecté au modem. La connexion depuis cette carte doit donc être fonctionnelle.|
|Active et non connectée|![browsingoutage](/images/guides/web-cloud/internet/internet-access/resoudre-interruption-lenteurs-navigation/xdsl-windows10-state-enable.png)|La carte réseau est activée mais vous n'êtes pas connecté au modem. La connexion depuis cette carte n'est donc pas fonctionnelle.|
|Désactivée|![browsingoutage](/images/guides/web-cloud/internet/internet-access/resoudre-interruption-lenteurs-navigation/xdsl-windows10-state-disabled.png)|La carte réseau est désactivée. La connexion depuis cette carte n'est donc pas fonctionnelle.|
...
Pour l'activer, faites un clic droit sur l'image représentant la carte puis cliquez sur `Activer`. Patientez alors le temps de son activation. Si la manipulation échoue, la carte est peut-être mal installée ou hors service. Auquel cas, vous devrez vous rapprocher d'un professionnel, tel qu'un technicien informatique. 

![browsingoutage](/images/guides/web-cloud/internet/internet-access/resoudre-interruption-lenteurs-navigation/xdsl-browsing-outage-step3.png)
...
![browsingoutage](/images/guides/web-cloud/internet/internet-access/resoudre-interruption-lenteurs-navigation/xdsl-browsing-outage-step4.png)
...
![browsingoutage](/images/guides/web-cloud/internet/internet-access/resoudre-interruption-lenteurs-navigation/xdsl-browsing-outage-step5.png)
...
![browsingoutage](/images/guides/web-cloud/internet/internet-access/resoudre-interruption-lenteurs-navigation/xdsl-browsing-outage-step6.png)
...
![browsingoutage](/images/guides/web-cloud/internet/internet-access/resoudre-interruption-lenteurs-navigation/espaceclient2022.png)

Dans la page qui apparaît, cliquez sur le bouton représentant des points de suspension (à droite du réseau Wi-Fi que vous souhaitez configurer), puis sur `Éditer`. La configuration actuelle s'affiche en dessous du tableau. Vous pouvez y modifier le canal Wi-Fi ainsi que la clé Wi-Fi. 

Validez vos changements grâce au bouton `Valider` et **patientez cinq minutes le temps que la modification soit prise en compte par votre modem.** Si nécessaire, effectuez plusieurs tests concernant le canal Wi-Fi afin de trouver celui le plus stable et le mieux adapté à votre situation.

![browsingoutage](/images/guides/web-cloud/internet/internet-access/resoudre-interruption-lenteurs-navigation/wifi-2022.png)
...
![browsingoutage](/images/guides/web-cloud/internet/internet-access/resoudre-interruption-lenteurs-navigation/acces-internet-laptop-test-step12-2022.png)
...
Pour réinitialiser la configuration de votre modem, depuis l'onglet `Mon modem`, descendez dans la page jusqu'à voir la section `Configurations avancées`, puis cliquez sur `Réinitialiser la configuration OVHcloud`. **Patientez cinq minutes le temps que la modification soit prise en compte par votre modem.**

![browsingoutage](/images/guides/web-cloud/internet/internet-access/resoudre-interruption-lenteurs-navigation/acces-internet-laptop-test-step13-2022.png)
...
![browsingoutage](/images/guides/web-cloud/internet/internet-access/resoudre-interruption-lenteurs-navigation/xdsl-browsing-outage-step11.png)
