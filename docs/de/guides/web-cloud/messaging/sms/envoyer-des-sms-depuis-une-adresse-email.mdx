...
> 
>  ![email2sms](/images/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-adresse-email/plaintext01.png)
>
...
![email2sms](/images/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-adresse-email/send-sms-through-email1.png)
...
![email2sms](/images/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-adresse-email/send-sms-through-email3.png)
...
![email2sms](/images/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-adresse-email/send-sms-through-email4.png)

If any sending errors occur, they will be listed in the report, as per the example below:

![email2sms](/images/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-adresse-email/send-sms-through-email5.png)
...
![List of authorised SMS characters](/images/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-adresse-email/smsauthorizedcharacters.png)
