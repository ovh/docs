...
## Requirements
- An SMS user created via the OVHcloud Control Panel, or directly via the APIs. To do this, please refer to the following guide: [Everything you need to know about SMS users](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms)
...
![http2sms](/images/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-url---http2sms/img_4011.jpg)
...
![List of authorised SMS characters](/images/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-url---http2sms/smsauthorizedcharacters.png)
