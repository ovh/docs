...
Log in to the [OVHcloud Control Panel](/links/manager), then select `Telecom`. Next, click `SMS` and your SMS account.

The "Send an SMS" field is the first item available in the list of actions.

![send sms control panel](/images/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-mon-espace-client/sms-send-control-panel01E.png)
...
![send sms control panel](/images/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-mon-espace-client/sms-send-control-panel02E.png)
...
![send sms control panel](/images/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-mon-espace-client/sms-send-control-panel03E.png)
...
![List of authorised SMS characters](/images/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-mon-espace-client/smsauthorizedcharacters.png)

#### Advanced options

![send sms control panel](/images/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-mon-espace-client/sms-send-control-panel-advanced.png)
