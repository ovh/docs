...
![fonctionnement sms avec réponse](/images/guides/web-cloud/messaging/sms/gerer-les-sms-avec-reponse/SMSreponse.png)
...
Connectez-vous à votre [espace client](/links/manager) puis sélectionnez `Télécom`. Cliquez ensuite sur `SMS` et choisissez votre compte SMS.

Dans la barre d'onglets, cliquez sur `Options` puis sur `Options des réponses`.

![options SMS réponse](/images/guides/web-cloud/messaging/sms/gerer-les-sms-avec-reponse/SMSreponse-options.png)
...
![envoi SMS](/images/guides/web-cloud/messaging/sms/gerer-les-sms-avec-reponse/SMSreponse-envoi.png)

Assurez-vous que votre expéditeur est bien le `Numéro permettant la réponse (France uniquement`.

![envoi SMS](/images/guides/web-cloud/messaging/sms/gerer-les-sms-avec-reponse/SMSreponse-expediteur.png)
...
![SMS reçus](/images/guides/web-cloud/messaging/sms/gerer-les-sms-avec-reponse/SMSreponse-recus.png)
