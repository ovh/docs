...
To create an OVHcloud SMS account, go to the [dedicated OVHcloud SMS offers page](https://www.ovhcloud.com/en-gb/sms/) and choose the credit pack that suits your needs. The order will automatically create an SMS account accessible from your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), in the [SMS section](https://manager.eu.ovhcloud.com/#/telecom/sms). Each SMS account is identified by a unique name (e.g. `sms-xx12345-1`). You can have multiple SMS accounts on the same OVHcloud customer ID, allowing you to separate uses (transactional, marketing, internal notifications) and budgets.
...
For **API users**, [go to the SMS section](https://manager.eu.ovhcloud.com/#/telecom/sms), select your account, then <code className="action">API users</code>. Click <code className="action">...</code> > <code className="action">Limit</code> for the relevant user and configure:
...
For more details, see the guide "[Everything you need to know about SMS users](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms/)".
...
[Go to the SMS section](https://manager.eu.ovhcloud.com/#/telecom/sms) of your OVHcloud Control Panel, select your SMS account, then click <code className="action">Send an SMS</code>. Fill in:
...
For more details, see the guide "[Sending SMS from the OVHcloud Control Panel](/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-mon-espace-client/)".
...
For more details, see the guide "[Sending SMS from a URL - http2sms](/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-url---http2sms/)".
...
For more details, see the guide "[Sending SMS from an email address](/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-adresse-email/)".
...
[Go to the SMS section](https://manager.eu.ovhcloud.com/#/telecom/sms) of your OVHcloud Control Panel, select your SMS account, then click <code className="action">Send an SMS</code>. The steps are:
...
[Go to the SMS section](https://manager.eu.ovhcloud.com/#/telecom/sms) of your OVHcloud Control Panel, select your SMS account, then go to <code className="action">Contacts</code> > <code className="action">Create a contact list</code>. You can:
...
SMS address books offer richer contact management (first name, surname, number). [Go to the SMS section](https://manager.eu.ovhcloud.com/#/telecom/sms), select your SMS account, then go to <code className="action">Contacts</code> > <code className="action">Address book</code>. You can:
...
For more details, see the guide "[Managing my SMS address books](/guides/web-cloud/messaging/sms/gerer-mes-carnets-dadresses-sms/)".
...
For more details, see the guide "[Everything you need to know about SMS senders](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-expediteurs-sms/)".
...
[Go to the SMS section](https://manager.eu.ovhcloud.com/#/telecom/sms) of your OVHcloud Control Panel, select your SMS account, then click on the <code className="action">Senders</code> tab. Click <code className="action">Actions</code> > <code className="action">Add</code> and choose "Add senders manually". Fill in:
...
SMS API users allow you to delegate SMS sending via the API or the http2sms function without exposing your OVHcloud customer credentials. [Go to the SMS section](https://manager.eu.ovhcloud.com/#/telecom/sms) of your OVHcloud Control Panel, select your SMS account, then click <code className="action">API users</code>. Add a new user by defining a username and password. Each user can be assigned:
...
1. **Create API keys** from the [OVHcloud API token creation page](https://api.ovh.com/createToken/) by authorising the `/sms/*` endpoints.
...
For more details, see the guide "[Sending SMS with the OVHcloud API in PHP](/guides/web-cloud/messaging/sms/envoyer-des-sms-avec-lapi-ovh-en-php/)".
...
Delivery reports (DLR) confirm the successful delivery of an SMS. To receive them automatically, configure a callback URL on your API user. [Go to the SMS section](https://manager.eu.ovhcloud.com/#/telecom/sms), then <code className="action">API users</code>, click <code className="action">...</code> > <code className="action">Callback</code> for the relevant user. Enter the URL of your web endpoint. With each status update, OVHcloud will call this URL with the following parameters:
