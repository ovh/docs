...
You can refer to the following guide for any specifics about SMS users: [Everything you need to know about SMS users](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-utilisateurs-sms/)
...
<img className="thumbnail" alt="List of authorised SMS characters" src="/images/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-adresse-email/smsauthorizedcharacters.png" loading="lazy" />
