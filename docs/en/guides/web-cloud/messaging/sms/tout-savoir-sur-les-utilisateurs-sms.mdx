...
For further details on the http2sms feature, please refer to our guide on [Sending SMS messages via a URL](/guides/web-cloud/messaging/sms/envoyer-des-sms-depuis-une-url---http2sms/).
