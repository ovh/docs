...
- If you encounter the access error "530 login authentication failed" when connecting to your FTP storage space: Make sure that the access information to your FTP space is correct. To do this, log in to your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) and go to the <code className="action">Web Cloud</code> section. In the left-hand column, click <code className="action">Hosting plans</code>, then select the Web Hosting plan concerned. On the page that opens, click on the <code className="action">FTP - SSH</code> tab.
...
To find out more, read the details of our [Web Hosting plans](https://www.ovhcloud.com/en-gb/web-hosting/) and our guide “[Getting started with your Web Cloud Databases solution](/guides/web-cloud/web-cloud-databases/starting-with-clouddb/)”.
...
Only [Web Cloud Databases](https://www.ovhcloud.com/en-gb/web-cloud/databases/) database servers allow external servers to connect to them. This is because you have previously authorized your external server’s IP address on your database server. If necessary, please refer to our guide on "[Getting started with your Web Cloud Databases solution](/guides/web-cloud/web-cloud-databases/starting-with-clouddb/)".
...
For shared databases (included in your Web Hosting plan) or database servers (Web Cloud Databases) offered in Gravelines (GRA), France and Beauharnois (BHS), Canada, the databases are backed up every day. These backups are accessible via the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) or via the [OVHcloud API](https://eu.api.ovh.com/). Backups are also stored on another infrastructure. This data is replicated in a data centre in Strasbourg (SBG). The backup retention policy is 30 days.
