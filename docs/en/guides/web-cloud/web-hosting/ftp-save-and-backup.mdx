...
- Depending on which method you use, you must be able to manage the Web Hosting plan from the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), or have the FTP user password required to access your storage space. 
...
- The “maintenance” status will appear in your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB). In the <code className="action">Web Cloud</code> section, click on your service in the <code className="action">Hosting plans</code> section, then on the <code className="action">General information</code> tab.
