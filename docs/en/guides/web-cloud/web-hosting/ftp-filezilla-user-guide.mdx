...
The **SFTP** uses, like SSH, port 22 by default instead of port 21. If you are using a Cloud Web hosting plan, you will need to use the port that appears in your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB). Port 22 is disabled in SSH and SFTP for Cloud Web hosting.
...
To do this, go back to the <code className="action">FTP - SSH</code> tab in your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), as detailed in the [first part](#part-1) of this guide.
...
Check your login details to ensure that no errors are entered. If applicable, you can [change the FTP access password](/guides/web-cloud/web-hosting/ftp-change-password/) of your web hosting plan directly in the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB).
...
Check that it is linked to the host name declared in your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB).
