...
In order to create a key pair, please follow our guide on [Creating SSH keys](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys-dedicated#create-ssh-key/).
