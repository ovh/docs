...
To access your Cloud Web hosting plan’s runtime environments, log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB). Click Web hosting in the services bar on the left-hand side, then choose the name of the Cloud Web hosting plan concerned. Next, go to the <code className="action">Runtime software applications</code> tab.
...
Once you have entered this information, click <code className="action">Confirm</code>. If you would like further information on managing runtime environments, please refer to our guide on [Managing Cloud Web runtime software applications](/guides/web-cloud/web-hosting/manage-runtime/).
...
To restart the Node.js daemon, go back to the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB). Go to the <code className="action">Multisite</code> tab, click on <code className="action">...</code> button to the right of the domain name concerned, then click <code className="action">Restart</code>.
