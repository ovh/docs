...
:::tip[Success]
To install your CMS **automatically** from your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), please refer to our documentation on [installing a 1-click module](/guides/web-cloud/web-hosting/cms-install-1-click-modules/).
...
To retrieve the IP address of your Web Hosting plan, log in to your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) in the <code className="action">Web Cloud</code> section, then select your Web Hosting plan in the <code className="action">Hosting</code> section.<br/>
...
If your domain’s active DNS zone is managed in your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), compare your hosting plan’s IP address with the one in your domain’s DNS zone, using our [OVHcloud DNS zones](/guides/web-cloud/domains/dns-zone-edit/) documentation .
...
If you have a Cloud Databases web hosting plan in MySQL or MariaDB and you would like to use it to manually install your CMS, please refer to our guide on [creating a database on a Cloud Databases web service](/guides/web-cloud/web-cloud-databases/create-db-and-user-on-db-server#creating-a-database/).
...
- To connect to a database on a Web Cloud Databases solution, see [this guide](/guides/web-cloud/web-cloud-databases/connecting-to-database-on-database-server/).
