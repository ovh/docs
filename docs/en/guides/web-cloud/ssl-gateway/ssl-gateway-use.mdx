...
Then click on the `Sunrise` section.

![sunrise button](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/4.PNG)

Then click on `SSL Gateway` to view the service.

![ssl gateway button](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/5.PNG)

Select the solution that you wish to configure.

![commercial page](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/6.PNG)

You will then land on the page for managing your solution.

![overall config](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/7.PNG)
...
|HSTS [[1]](#id5)|Requires the browser to make all future connections to your website in HTTPS|
|Reverse|Allows you to put a host name on your SSL Gateway IP address|
|HTTPS Redirection [[2]](#id6)|Redirects the visitor to the HTTPS version of your site when they access it in HTTP|
|HTTPS Server [[3]](#id7)|Enables HTTPS between the SSL Gateway server and your server|
|Source IP restriction|If this field is filled in, only the IPs or networks listed can connect to the SSL Gateway|
|Cipher configuration [[4]](#id8)|Allows you to choose a security level for your SSL/TLS certificate|
...
Click `+ Domain` to add a domain or subdomain.
...
Select your choice, then click `Add` to validate.

![add free domain](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/11.PNG)
...
![add advanced domain](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/12.PNG)
...
Click `+ Server` to add an IP address and a port corresponding to your server hosting your website.

![servers tab](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/13.PNG)
...
![add advanced IP/PORT (internal)](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/15.PNG)
...
![tasks tab](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/13-bis.PNG)
...
![metrics tab](/images/guides/web-cloud/ssl-gateway/use-ssl-gateway/17.PNG)
