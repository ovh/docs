...
![groupes de téléphonie](/images/guides/web-cloud/phone-and-fax/voip/regrouper-services-telephonie/groupes01.png)
...
![renommer groupe](/images/guides/web-cloud/phone-and-fax/voip/regrouper-services-telephonie/groupes02.png)

### Ajouter un groupe de téléphonie

L'ajout d'un groupe de téléphonie est gratuit. Pour créer un nouveau groupe, depuis un groupe existant, cliquez sur l'onglet `Administration` puis sur `Ajouter un groupe`.

![ajouter groupe](/images/guides/web-cloud/phone-and-fax/voip/regrouper-services-telephonie/02-ajouter-01.png)

Prenez connaissance des contrats et conditions, valides-les puis clquez sur `Commander un nouveau groupe de téléphonie (Gratuit)`

![ajouter groupe](/images/guides/web-cloud/phone-and-fax/voip/regrouper-services-telephonie/02-ajouter-02.png)
...
### Regrouper des services dans un groupe de téléphonie <a id="regrouper-lignes"></a>
...
Afin de déplacer une ligne dans un nouveau groupe, sélectionnez celui-ci dans le menu de gauche puis cliquez sur l'onglet `Administration` et enfin sur `Regroupement de lignes`.

![regrouper lignes](/images/guides/web-cloud/phone-and-fax/voip/regrouper-services-telephonie/03-regrouper-01.png)

Sélectionnez d'abord le groupe qui contient actuellement les lignes souhaitées, puis cochez ces dernières. Validez en cliquant sur `Attacher les services sélectionnés`.

![regrouper lignes](/images/guides/web-cloud/phone-and-fax/voip/regrouper-services-telephonie/03-regrouper-02.png)
...
Les accès à Internet OVHcloud comprennent souvent des lignes téléphoniques qu'il faut activer dans l'espace client OVHcloud, dans la partie `Accès Internet`. Ces lignes, une fois activées, génèrent leur propre groupe de téléphonie (un groupe pour chaque accès à Internet).
...
|---|---| 
|![groupe VoIP classique](/images/guides/web-cloud/phone-and-fax/voip/regrouper-services-telephonie/03-regrouper-03.png)|![groupe ovhtel](/images/guides/web-cloud/phone-and-fax/voip/regrouper-services-telephonie/03-regrouper-04.png)|
...
Le menu `Options du groupe`, dans l'onglet `Administration`, vous permet d'activer ou désactiver les options suivantes :
...
![options du groupe](/images/guides/web-cloud/phone-and-fax/voip/regrouper-services-telephonie/options-groupe.png)
...
![supprimer groupe](/images/guides/web-cloud/phone-and-fax/voip/regrouper-services-telephonie/04-supprimer.png)
...
Pour annuler une demande de suppression, cliquez sur `Supprimer le groupe` puis sur `Annuler la suppression`.

![supprimer groupe](/images/guides/web-cloud/phone-and-fax/voip/regrouper-services-telephonie/05-annuler-suppression.png)
