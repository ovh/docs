...
1. Dans l'onglet `Configuration`, cliquez sur `Conférence` puis sur `Paramétrer`.<br />

L'application de la configuration prend quelques secondes.

![conférence](/images/guides/web-cloud/phone-and-fax/voip/conference/conference2022-01.png)
...
Pour retrouver ce menu ultérieurement, cliquez sur l'onglet `Configuration` puis sur `Conférence`.
...
![conference](/images/guides/web-cloud/phone-and-fax/voip/conference/conference2022-02.png)
...
|Annonce personnalisée|Permet de personnaliser l'annonce d'entrée d'un nouveau participant dans la conférence. Pour cela, cliquez sur `Ajouter un son` puis suivez les étapes qui apparaissent.|
...
Cliquez enfin sur le bouton `Valider` en bas de la page afin de confirmer les changements.

#### Administrer la conférence

Dans la partie « Administration », définissez également vos paramètres.

![conference](/images/guides/web-cloud/phone-and-fax/voip/conference/conference2022-03.png)
...
|Suivi et contrôle de la conférence|Permet d'activer des liens pour suivre et contrôler la conférence. Pour les activer, cliquez sur `Générer les URL`. Un bouton à droite de chaque URL vous permet de la copier.<br /><br /> Si des URL sont déjà générées, vous avez la possibilité de :<br /><br /> - **Regénérer les URL** : permet de remplacer les URL existantes par d'autres ;<br /> - **Supprimer les URL** : permet de désactiver le suivi et le contrôle de la conférence.|

Cliquez enfin sur le bouton `Valider` pour confirmer les changements.
