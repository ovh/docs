...
1. Positionnez-vous sur l'onglet `Gestion des appels` puis cliquez sur `Appels simultanés`.

![appels-simultanes](/images/guides/web-cloud/phone-and-fax/voip/gerer-utiliser-appels-simultanes/simultaneous-call-step1.png)
...
![appels-simultanes](/images/guides/web-cloud/phone-and-fax/voip/gerer-utiliser-appels-simultanes/simultaneous-call-step2.png)
