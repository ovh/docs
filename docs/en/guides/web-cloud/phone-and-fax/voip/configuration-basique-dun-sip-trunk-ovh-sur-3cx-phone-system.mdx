...
![3CX Phone Systeme](/images/guides/web-cloud/phone-and-fax/voip/configuration-basique-dun-sip-trunk-ovh-sur-3cx-phone-system/3cx_phone_system-login.png)

</Tab>
<Tab label="Étape 2">

Cliquez sur `Trunks SIP`, puis sur `Ajouter Trunk SIP`.

![3CX Phone Systeme](/images/guides/web-cloud/phone-and-fax/voip/configuration-basique-dun-sip-trunk-ovh-sur-3cx-phone-system/3cx_phone_system-trunk01.png)
...
![3CX Phone Systeme](/images/guides/web-cloud/phone-and-fax/voip/configuration-basique-dun-sip-trunk-ovh-sur-3cx-phone-system/3cx_phone_system-trunk02.png)
...
![3CX Phone Systeme](/images/guides/web-cloud/phone-and-fax/voip/configuration-basique-dun-sip-trunk-ovh-sur-3cx-phone-system/3cx_phone_system-trunk03.png)

> [!info]
> Pour retrouver vos informations de connexion :
>
> 1. Connectez-vous à votre [espace client OVHcloud](/links/manager) et cliquez sur `Telecom`.
> 1. Cliquez sur `VoIP & Fax` puis sur le groupe de facturation contenant votre ligne SIP Trunk.
> 1. Cliquez sur l'onglet `Services` puis sur la ligne SIP Trunk concernée.
...
![3CX Phone Systeme](/images/guides/web-cloud/phone-and-fax/voip/configuration-basique-dun-sip-trunk-ovh-sur-3cx-phone-system/3cx_phone_system-trunk04.png)

</Tab>
<Tab label="Étape 6">

Nous allons associer les DDI au trunk. Cliquez sur l'onglet `SDAs` en haut de la page, puis :

- Cliquez sur le bouton `Ajouter un SDA`.
- Entrez les DDI souhaités.
- Cliquez sur `OK` en haut de la page pour sauvegarder la configuration.

![3CX Phone Systeme](/images/guides/web-cloud/phone-and-fax/voip/configuration-basique-dun-sip-trunk-ovh-sur-3cx-phone-system/3cx_phone_system-trunk07.png)
...
![3CX Phone Systeme](/images/guides/web-cloud/phone-and-fax/voip/configuration-basique-dun-sip-trunk-ovh-sur-3cx-phone-system/3cx_phone_system-trunk05.png)
...
![3CX Phone Systeme](/images/guides/web-cloud/phone-and-fax/voip/configuration-basique-dun-sip-trunk-ovh-sur-3cx-phone-system/3cx_phone_system-trunk06.png)
...
![3CX Phone Systeme](/images/guides/web-cloud/phone-and-fax/voip/configuration-basique-dun-sip-trunk-ovh-sur-3cx-phone-system/3cx_phone_system-trunk08.png)
