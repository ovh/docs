...
1. Cliquez sur l'onglet `Gestion des contacts`.

![gestion des contacts](/images/guides/web-cloud/phone-and-fax/voip/effectuer-un-changement-de-contact-pour-les-services-voip/gestion-contacts01.png)

Vous pourrez alors cliquer sur le bouton d'édition à droite de votre groupe de téléphonie et renseigner le nouveau « NIC » (identifiant client) qui récupérera la gestion de ce groupe. Cliquez sur le bouton `V` de validation pour valider la modification. Ce changement s'appliquera à tous les services du groupe.
...
Pour suivre et gérer les demandes en cours, cliquez d'abord sur le nom rattaché à votre identifiant client dans la barre de menu en haut à droite de l'espace client. Cliquez ensuite sur `Mes contacts` à gauche et enfin sur `Mes demandes`. C'est ici que vous pourrez accepter ou refuser une demande.

![gestion contacts VoIP](/images/guides/web-cloud/phone-and-fax/voip/effectuer-un-changement-de-contact-pour-les-services-voip/managing_contacts_05.png)
...
![gestion contacts VoIP](/images/guides/web-cloud/phone-and-fax/voip/effectuer-un-changement-de-contact-pour-les-services-voip/managing_contacts_06.png)
...
![gestion contacts VoIP](/images/guides/web-cloud/phone-and-fax/voip/effectuer-un-changement-de-contact-pour-les-services-voip/managing_contacts_07.png)
