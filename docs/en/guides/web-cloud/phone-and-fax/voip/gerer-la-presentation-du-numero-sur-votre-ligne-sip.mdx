...
### Configurer la présentation du numéro d'une ligne SIP <a id="sip"></a>
...
1. Positionnez-vous sur l'onglet `Gestion des appels` et cliquez sur `Présentation du numéro`.

![configurer-presentation-numero](/images/guides/web-cloud/phone-and-fax/voip/gerer-la-presentation-du-numero-sur-votre-ligne-sip/display-incoming-call-step1.png)
...
|Présenter un autre numéro|Permet de présenter un numéro différent de celui de la ligne sélectionnée lorsque vous émettez un appel (par exemple, pour masquer le numéro direct d'un de vos collaborateurs en affichant celui de votre standard téléphonique). Pour cela, cliquez sur `Choisir un autre numéro`, puis sélectionnez celui souhaité dans la liste. Seuls les numéros rattachés à vos groupes de facturation apparaissent dans la liste.|

Une fois votre choix fait, cliquez sur le bouton `Appliquer les modifications`. Vous pouvez aussi cliquer sur `Appliquer à plusieurs lignes` pour dupliquer les paramètres sur d'autres lignes OVHcloud.

![configurer-presentation-numero](/images/guides/web-cloud/phone-and-fax/voip/gerer-la-presentation-du-numero-sur-votre-ligne-sip/display-incoming-call-step2.png)

### Configurer la présentation du numéro d'une ligne Trunk <a id="trunk"></a>
...
#### Rester anonyme <a id="rester-anonyme"></a>

1. Connectez-vous à votre [espace client OVHcloud](/links/manager) et cliquez sur `Télécom`.
1. Cliquez sur `VoIP & Fax` puis sur le groupe de facturation contenant votre ligne Trunk.
1. Cliquez sur la ligne Trunk concernée.
1. Positionnez-vous sur l'onglet `Gestion des appels` et cliquez sur `Présentation du numéro`.

![configurer-presentation-numero-trunk](/images/guides/web-cloud/phone-and-fax/voip/gerer-la-presentation-du-numero-sur-votre-ligne-sip/display-incoming-call-trunk-step1.png)

La page qui s'affiche vous indique la configuration actuelle de la présentation du numéro. Par défaut, le numéro de votre ligne est présenté. Pour le masquer, cochez la case `Rester anonyme`, puis cliquez sur le bouton `Appliquer les modifications`. Vous avez aussi la possibilité de cliquer sur `Appliquer à plusieurs lignes` pour dupliquer ce paramètre sur d'autres lignes OVHcloud.

![configurer-presentation-numero-trunk](/images/guides/web-cloud/phone-and-fax/voip/gerer-la-presentation-du-numero-sur-votre-ligne-sip/display-incoming-call-trunk-anonymous-step1.png)

#### Présenter de manière unique un numéro OVHcloud <a id="presenter-numero-unique"></a>
...
La page qui s'affiche vous indique la configuration actuelle de la présentation du numéro. Par défaut, le numéro de votre ligne est présenté. Pour en présenter un autre, cliquez sur `Choisir un autre numéro`, puis sélectionnez celui souhaité dans la liste. Seuls les numéros rattachés à vos groupes de facturation apparaissent ici.

Une fois votre choix fait, cliquez sur le bouton `Appliquer les modifications`. Vous avez aussi la possibilité de cliquer sur `Appliquer à plusieurs lignes` pour dupliquer les paramètres sur d'autres lignes OVHcloud.

![configurer-presentation-numero-trunk](/images/guides/web-cloud/phone-and-fax/voip/gerer-la-presentation-du-numero-sur-votre-ligne-sip/display-incoming-call-trunk-step2.png)

#### Présenter « à la volée » un numéro OVHcloud <a id="presenter-numero-volee"></a>
...
Décochez la case `Rester anonyme`, puis cliquez sur le bouton `Appliquer les modifications`

![désactiver-anonyme](/images/guides/web-cloud/phone-and-fax/voip/gerer-la-presentation-du-numero-sur-votre-ligne-sip/display-incoming-call-trunk-anonymous-step7.png)
...
#### Présenter « à la volée » un numéro externe <a id="presenter-numero-volee-externe"></a>
...
1. Cliquez sur `VoIP & Fax` puis sur le groupe de facturation contenant votre ligne Trunk.
1. Cliquez sur la ligne Trunk concernée.
1. Positionnez-vous sur l'onglet `Gestion des appels` et cliquez sur `Présentation d'un numéro externe`.

![configurer-presentation-numero-trunk](/images/guides/web-cloud/phone-and-fax/voip/gerer-la-presentation-du-numero-sur-votre-ligne-sip/display-incoming-call-trunk-step3.png)
...
![configurer-presentation-numero-trunk](/images/guides/web-cloud/phone-and-fax/voip/gerer-la-presentation-du-numero-sur-votre-ligne-sip/display-incoming-call-trunk-step4.png)

Pour ajouter un nouveau numéro externe, renseignez ce dernier au format international (par exemple, 0033123456789 pour un numéro français) dans la zone de texte à côté de `Numéro externe`, puis cliquez sur `Ajouter`. Un code de validation apparaît alors.
...
![configurer-presentation-numero-trunk](/images/guides/web-cloud/phone-and-fax/voip/gerer-la-presentation-du-numero-sur-votre-ligne-sip/display-incoming-call-trunk-step5.png)
