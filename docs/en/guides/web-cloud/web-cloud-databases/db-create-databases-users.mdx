...
Log in to your [OVHcloud Control Panel](/links/manager) and select `Web Cloud` in the top navigation bar. Click `Web Cloud Databases`, then choose the SQL instance concerned. Click on the `Databases` tab, then on `Add database`.
...
Log in to your [OVHcloud Control Panel](/links/manager) and select `Web Cloud` in the top navigation bar. Click `Web Cloud Databases`, then choose the database name concerned. Next, switch to the `Users and rights` tab and click `Add user`.
...
Log in to your [OVHcloud Control Panel](/links/manager) and select `Web Cloud` in the top navigation bar. Click `Web Cloud Databases`, then choose the database name concerned. Next, switch to the `Users and rights` tab. Click on the  `...` button to the right of the user concerned, then on `Manage rights`.
...
Log in to your [OVHcloud Control Panel](/links/manager) and select `Web Cloud` in the top navigation bar. Click `Web Cloud Databases`, then choose the SQL instance concerned.

To delete a database on your database server, go to the `Databases` tab, then click on the `...` button to the right of the database concerned, then click `Delete the database`.
