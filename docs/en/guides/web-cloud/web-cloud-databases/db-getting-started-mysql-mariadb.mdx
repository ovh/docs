...
- You need to have read the [Web Cloud Databases startup guide](/guides/web-cloud/web-cloud-databases/db-getting-started).
...
Please also read our guide on [getting started with the Web Cloud Databases service](/guides/web-cloud/web-cloud-databases/db-getting-started).
...
> [!info]
>
> In some cases, the RAM available in your Web Cloud Databases instance may not be sufficient to perform the desired export or import. If this is the case, we recommend using the OVHcloud tool in the OVHcloud Control Panel. See the [Getting started with Web Cloud Databases service](/guides/web-cloud/web-cloud-databases/db-getting-started) documentation if necessary.
>
