...
Log in to your [OVHcloud Control Panel](/links/manager) and select `Web Cloud` in the top navigation bar. Click `Web Cloud Databases` in the services bar, then choose the SQL instance concerned. Next, go to the `Databases` tab.
...
The list of available backups will appear. Click on the `...` button to the right of the backup you want to create, then click `Download the backup` to retrieve this backup.
...
To export your database directly from phpMyAdmin, you will need to log in to the interface first. To do this, you can refer to our guide on [connecting to a database](/guides/web-cloud/web-cloud-databases/db-connecting-database-server).
...
[Restoring and importing a database to your database server](/guides/web-cloud/web-cloud-databases/db-restore-import-database)
