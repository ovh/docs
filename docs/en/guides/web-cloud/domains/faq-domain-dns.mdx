...
You can then manage your domain name by logging into your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB).
...
<Tabs>
  <Tab label="Step 1">
    Go to the [My offers and services](https://manager.eu.ovhcloud.com/#/billing/autorenew/services) page.
  </Tab>
  <Tab label="Step 2">
...
Once subscribed, IDNs appear in your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) in the **xn--** format.

Even though your domain name is displayed in [internationalized notation (IDN)](https://en.wikipedia.org/wiki/Internationalized_domain_name) in your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), it will function and display normally elsewhere. Your website address will appear as requested. Your email addresses will also display as intended to your contacts.
...
Perform a [contact recovery procedure](https://www.ovh.co.uk/cgi-bin/en/procedure/procedureChangeContacts.cgi) to have your domain name fully managed in your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB). This way, you will no longer need to contact the person who previously managed your domain name.
...
- **From your OVHcloud Control Panel**: If the active DNS zone for your domain name is managed by OVHcloud, go to the [DNS zones](https://manager.eu.ovhcloud.com/#/web/zone) page to view all the DNS records declared for your domain name.
...
<Tabs>
  <Tab label="Step 1">
    Go to the [DNS zones](https://manager.eu.ovhcloud.com/#/web/zone) page, then click the <code className="action">Order</code> button in the top right corner of the displayed table.
  </Tab>
  <Tab label="Step 2">
...
<Tabs>
  <Tab label="Step 1">
    Go to the [DNS zones](https://manager.eu.ovhcloud.com/#/web/zone) page, then choose the subdomain concerned.
...
:::tip[Success]
If you did not receive this email, check your spam folder or go to the [My account](https://manager.eu.ovhcloud.com/#/account/useraccount/dashboard) page, then click the <code className="action">Emails received</code> tab.
...
<Tabs>
  <Tab label="Step 1">
    Go to the [DNS zones](https://manager.eu.ovhcloud.com/#/web/zone) page, then check if the concerned domain name appears.
...
If the tab does not appear in your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), it means the "GLUE" option is unavailable for your domain name.
...
In your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), this message simply indicates that the DNS zone created for your domain name is not its active DNS zone.
...
<Tabs>
  <Tab label="Step 1">
    Go to the [Domain names](https://manager.eu.ovhcloud.com/#/web-domains/domain) page, then check if the concerned domain name appears.
  ...
  <Tab label="Step 2">
    **Case #1** - The domain name does not appear in the list:
    ...
    - The domain name is registered with OVHcloud: You can perform a [contact recovery procedure](https://www.ovh.co.uk/cgi-bin/en/procedure/procedureChangeContacts.cgi) so that your domain name is managed in your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB).
    - The domain name is not registered with OVHcloud: You can perform an [incoming transfer](/guides/web-cloud/domains/transfer-incoming-generic-domain/) to OVHcloud so that your domain name is managed in your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB).
    ...
    **Case #2** - The domain name appears in the list:
    ...
    You can then perform a [contact recovery procedure](https://www.ovh.co.uk/cgi-bin/en/procedure/procedureChangeContacts.cgi) so that your domain name is fully managed in your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB).
  </Tab>
</Tabs>
...
[Web Hosting FAQ](/guides/web-cloud/web-hosting/faq-web-hosting/)
