...
You can add the TXT record to your DNS zone from the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB). Click the <code className="action">Web Cloud</code> tab, go to <code className="action">Domain names</code>, then choose the domain name concerned. Go to the <code className="action">DNS zones</code> tab.
