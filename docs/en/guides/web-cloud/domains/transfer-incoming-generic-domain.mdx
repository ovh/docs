...
When your order is confirmed, you receive a purchase order. The transfer process does not start until payment has been received. As soon as this step is done, you can track the transfer progress on the [Ongoing operations](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/web/ongoing-operations) page.
...
The transfer process can be restarted from the [Ongoing operations](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/web/ongoing-operations) page.
...
<Tabs>
  <Tab label="Step 1">
    Go to the [Domain names](https://manager.eu.ovhcloud.com/#/web-domains/domain) page, then select the domain name concerned.
