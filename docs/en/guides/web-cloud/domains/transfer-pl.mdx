...
Once the order has been confirmed, you will receive a free purchase order. The transfer process will only start once you have confirmed this free purchase order. Once this is done, you can track the transfer progress via the [Ongoing operations](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/web/ongoing-operations) page.
...
- Once the validation is complete, the domain will be accessible from your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB)  within 24 hours.
...
Once the transfer procedure is complete, you can manage your domain name from the [Domain names](https://manager.eu.ovhcloud.com/#/web-domains/domain) page.
