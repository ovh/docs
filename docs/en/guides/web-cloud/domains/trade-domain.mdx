...
- The domain name status updates. To check this, go to the [Ongoing operations](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/web/ongoing-operations) page.
