...
### Add the account <a id="add-account"></a>
...
> 
> Find this number in your [OVHcloud Control Panel](/links/manager), under the `Web Cloud` section, then `Email Pro`. The server name is visible in the **Connection** section of the `General Information` tab.

<Tabs>
<Tab label="Step 1">

- Open Outlook. In the left column, click on `Add an account` to start the configuration.
...
- Enter your password and click the `Show more` button.
...
- Click `Continue` to finalize the configuration.
...
### Using the email address <a id="use-account"></a>
...
### Modifying existing settings <a id="modify-settings"></a>
...
- In the "Your accounts" section, click on `Manage` to the right of the relevant email account.
...
### General sending and receiving settings <a id="settings-account"></a>

#### IMAP and POP receiving settings <a id="imap-pop"></a>
...
#### SMTP sending settings <a id="smtp"></a>
