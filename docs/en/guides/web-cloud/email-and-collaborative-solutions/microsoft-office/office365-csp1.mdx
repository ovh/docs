...
1. Go to the [Microsoft 365 sales page](/links/web/ms365), or to the [OVHcloud Control Panel](/links/manager):
    - Go to the `Web Cloud` section.
    - In the `MICROSOFT` section, click `Microsoft 365`.
    - Click `Order`.
...
1. In the `MICROSOFT` section, click `Microsoft 365`.
1. Select the Microsoft 365 service concerned.
1. Click the `Licenses` tab.
1. Click the `⁝` button on the license line for the activation, then click `Edit account`.

    ![emails](/images/guides/web-cloud/email-and-collaborative-solutions/microsoft-office/office-csp1/Outlook-cps1-01.png)

1. Enter the license user information, then click `Confirm`.

    ![emails](/images/guides/web-cloud/email-and-collaborative-solutions/microsoft-office/office-csp1/Outlook-cps1-02.png)

### Install the Microsoft 365 suite on your device <a id="install365"></a>

Once the license has been activated, you will receive an email to the contact email address of your OVHcloud account. You can also find this email in your [OVHcloud Control Panel](/links/manager), by clicking on your account name in the top right-hand corner, then `My communications` in the `Emails received` section.
...
1. Select the Microsoft 365 service concerned.
1. Click the `Licenses` tab.
1. Click the `⁝` button to the right of the license concerned, then `Change password`.
...
1. In the `MICROSOFT` section, click `Microsoft 365`.
1. Select the Microsoft 365 service concerned.
1. Click the `Order more licenses` button on the right.
1. Determine the **number** and **license type** you wish to order, then click `Confirm`.

![emails](/images/guides/web-cloud/email-and-collaborative-solutions/microsoft-office/office-csp1/Outlook-cps1-05.png)

### Manage your subscriptions <a id="managesubscriptions"></a>

#### Delete a license in a license group

In the `Licenses` tab of your license group, click the `⁝` button to the right of the license you want to cancel, then click `Delete account`.
...
1. Click `My offers and services`.
1. Identify your license group in the table for your services.
1. Click the `...` button to the right of the license group you want to terminate, then `Terminate`.
1. Specify the reasons for your termination request, then click `Confirm`.
