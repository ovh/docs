...
To order an Office 365 Resellers service, go to your [OVHcloud Control Panel](/links/manager). Once you have logged in, select `Sunrise` in the top menu, then click on `Office 365 Revendeurs`.
...
To do this, go to the `Sunrise` section. In the left-hand menu, choose `Office 365 Revendeurs`, then select the service.
