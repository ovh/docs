...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/v3lte-step1-1-backcover-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/v3lte-step1-2-lteModule-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/v3lte-step1-3-simInsert-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/v3lte-step2-antenna-2024.png)
...
Depuis le menu déroulant, sélectionnez `Network` > `Interfaces`.

![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/v3lte-step3-1-luciltedown-2024.png)

Puis sélectionnez le bouton `Edit` pour l'interface **LTE**.

![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/v3lte-step3-2-lucilteitf-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/v3lte-step3-3-orange-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/v3lte-step3-3-free-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/v3lte-step3-3-bouygues-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/v3lte-step3-3-sfr-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/v3lte-step3-3-airmob-2024.png)

</Tab>
</Tabs>


![overthebox](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/v3lte-step3-4-luciltesaveitf-2024.png)
...
![LTE](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/usblte-e3372-1-2024.png)
...
![LTE](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/usblte-e3372-2-2024.png)
...
![LTE](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/usblte-android-2024.png)
...
![LTE](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/v3lte-check-2024.png)

</Tab>
<Tab label="Autres modèles">

![LTE](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/usblte-check-2024.png)
...
Pour limiter l'utilisation du lien, vous devez activer l'option **Backup** dans le paramètre `Multipath TCP` de l'interface.

Depuis le menu déroulant sélectionnez `Network` > `Interfaces`.<br />
Puis sélectionnez le bouton `Edit` de l'interface en 4G.<br />
Dans l'onglet `Avanced Settings`, modifiez le paramètre `Multipath TCP`.
...
![LTE](/images/guides/web-cloud/internet/overthebox/plus-itv2-lte/lte-mptcp-2024.png)
