...
![nombre de lignes](/images/guides/web-cloud/internet/internet-access/comment-activer-mes-lignes-telephoniques-offre-adsl-vdsl/Activation01-edit-2022.png)
...
1. Connectez-vous à votre [espace client OVHcloud](/links/manager) et cliquez sur `Télécom`.
1. Cliquez sur `Offres Internet` puis sur le *Pack* contenant l'accès à Internet concerné.
1. Cliquez sur `Activer un service` dans le cadre « Téléphonie »

![activer une ligne](/images/guides/web-cloud/internet/internet-access/comment-activer-mes-lignes-telephoniques-offre-adsl-vdsl/Activation02-edit.png)
...
<br />Sélectionnez ensuite la case `Ligne SIP sans téléphone` puis cliquez sur `Valider la commande` en bas de page.

![activation ligne sans téléphone ](/images/guides/web-cloud/internet/internet-access/comment-activer-mes-lignes-telephoniques-offre-adsl-vdsl/Activation03-edit.png)
...
Cliquez sur `Valider la commande` une fois votre choix effectué.

![activation ligne avec téléphone](/images/guides/web-cloud/internet/internet-access/comment-activer-mes-lignes-telephoniques-offre-adsl-vdsl/Activation04-edit.png)
...
Pour activer une ligne Fax, cliquez sur `Activer un service` dans le cadre « EcoFax Pro ». Cliquez alors sur `Activer` pour confirmer votre choix.

![activation ligne fax](/images/guides/web-cloud/internet/internet-access/comment-activer-mes-lignes-telephoniques-offre-adsl-vdsl/Activation05-edit.png)

Cette ligne sera alors disponible dans un délai moyen d'une heure.

Veuillez consulter [nos guides Fax](/guides/web-cloud/phone-and-fax/fax/overview) afin d'avoir plus de détails sur l'utilisation de ce service.
...
![voyants technicolor](/images/guides/web-cloud/internet/internet-access/comment-activer-mes-lignes-telephoniques-offre-adsl-vdsl/2015-03-18-143620_120x314_scrot.png)

![voyants zyxel](/images/guides/web-cloud/internet/internet-access/comment-activer-mes-lignes-telephoniques-offre-adsl-vdsl/Activation06-edit.png)
...
![schéma branchement tg788](/images/guides/web-cloud/internet/internet-access/comment-activer-mes-lignes-telephoniques-offre-adsl-vdsl/untitled.jpg)
