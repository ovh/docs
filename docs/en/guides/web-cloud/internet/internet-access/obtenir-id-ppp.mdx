...
![serviceName dans espace client](/images/guides/web-cloud/internet/internet-access/obtenir-id-ppp/servicename-2022.png)
...
Saisissez, dans le champ `serviceName`, la référence de votre accès obtenue à l'étape précédente. Cliquez alors sur `Execute`. Le message `null` confirmera la bonne prise en compte de votre demande.
...
Une fois connecté, cliquez sur votre nom puis sur `E-mails de service`.

![emails de service](/images/guides/web-cloud/internet/internet-access/obtenir-id-ppp/emails.png)

L'objet de l'e-mail est le suivant :

![email_recus](/images/guides/web-cloud/internet/internet-access/obtenir-id-ppp/mailtype.png)

Voici un exemple d'e-mail contenant les identifiants PPPoE :

![email_recus](/images/guides/web-cloud/internet/internet-access/obtenir-id-ppp/contenumailtyperesetppp-2022.png)
