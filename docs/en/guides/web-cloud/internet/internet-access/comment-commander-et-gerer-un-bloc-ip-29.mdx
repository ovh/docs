...
### Étape 1 : retrouver les IP associées à votre accès <a id="trouver-ip-associees"></a>
...
1. Assurez-vous d'être positionné sur l'onglet `Mon accès`.

![blocip](/images/guides/web-cloud/internet/internet-access/comment-commander-et-gerer-un-bloc-ip-29/blocip-step01-edit-2022.png)
...
Si vous ne possédez pas de bloc IP /29, vous pouvez en commander un en cliquant sur le bouton `Commander` puis en suivant les étapes.

![blocip](/images/guides/web-cloud/internet/internet-access/comment-commander-et-gerer-un-bloc-ip-29/blocip-step2.png)
...
Afin que la configuration du bloc IP puisse s'effectuer en local sur votre box OVHcloud, il est impératif de désactiver la prise en main à distance de celle-ci. Pour cela, toujours depuis votre [espace client OVHcloud](/links/manager) sur l'accès à Internet concerné, positionnez-vous sur l'onglet `Mon modem`.

Sur la page, dans la partie « Configuration générale », assurez-vous de décocher la case à côté de `Configuration à distance activée` et confirmez le changement en cliquant sur `Ok`. Patientez alors le temps de la désactivation. 

![blocip](/images/guides/web-cloud/internet/internet-access/comment-commander-et-gerer-un-bloc-ip-29/blocip-step04-edit-2022.png)
...
#### 3.1 Configuration sur une box Technicolor ou Thomson **excepté pour le modèle Technicolor TG799vac** <a id="conf-tecnhicolor"></a>
...
Pour l'activer sur Windows 10, effectuez un clic droit sur l'image en bas à gauche représentant le logo Windows et cliquez sur `Applications et fonctionnalités`. Descendez en bas de la fenêtre qui apparaît et cliquez sur `Programmes et fonctionnalités`. Sélectionnez ensuite `Activer ou désactiver des fonctionnalités Windows`, puis assurez-vous de cocher la case à côté de `Client Telnet`. Validez en cliquant sur le bouton `OK`.
...
![blocip](/images/guides/web-cloud/internet/internet-access/comment-commander-et-gerer-un-bloc-ip-29/blocip-step5.png)
...
![blocip](/images/guides/web-cloud/internet/internet-access/comment-commander-et-gerer-un-bloc-ip-29/blocip-step6.png)
...
![blocip](/images/guides/web-cloud/internet/internet-access/comment-commander-et-gerer-un-bloc-ip-29/blocip-step7.png)
...
Une fois connecté à l'interface, plusieurs manipulations sont nécessaires. La première consiste à rendre le réseau local public. Pour cela, cliquez sur l'icône menu en haut à droite, puis sur  `Network Settings` puis sur `Home Networking`. Dans la nouvelle fenêtre, positionnez-vous sur l'onglet `Additional Subnet`. Dans la partie « Public LAN », complétez les deux informations ci-dessous :
...
Cliquez ensuite sur le bouton `Apply`.

![blocip](/images/guides/web-cloud/internet/internet-access/comment-commander-et-gerer-un-bloc-ip-29/blocip-step8.png)

Cliquez à nouveau sur l'icône menu en haut à droite, puis sur `Security` et pour finir sur `Firewall`. Modifiez le niveau du pare-feu sur « Low », puis cliquez sur le bouton `Apply`.

![blocip](/images/guides/web-cloud/internet/internet-access/comment-commander-et-gerer-un-bloc-ip-29/blocip-step9.png)

À présent, il est nécessaire de créer une règle afin d'autoriser les équipements connectés en local à accéder à Internet. Pour cela, retournez dans le menu `Network Settings`, puis sur `NAT`. Dans la nouvelle fenêtre, positionnez-vous sur l'onglet `Address Mapping` et cliquez sur le bouton `Add New Rule`.

![blocip](/images/guides/web-cloud/internet/internet-access/comment-commander-et-gerer-un-bloc-ip-29/blocip-step11.png)
...
![blocip](/images/guides/web-cloud/internet/internet-access/comment-commander-et-gerer-un-bloc-ip-29/blocip-step12.png)

Toujours dans le menu `Network Settings`, sélectionnez le menu `Broadband`. Cliquez sur l'icône représentant une feuille et un crayon, à droite du nom de l'interface utilisée par votre modem. L'interface dépend de votre type de connexion :

- **ADSL** : Pour une connexion de type ADSL.
- **VDSL** : Pour une connexion de type VDSL.
- **ETHWAN** : Pour une connexion de type FTTH.

![blocip](/images/guides/web-cloud/internet/internet-access/comment-commander-et-gerer-un-bloc-ip-29/blocip-step13.png)

En cas de doute, le type de votre connexion est disponible sur l'espace client OVHcloud.

![blocip](/images/guides/web-cloud/internet/internet-access/comment-commander-et-gerer-un-bloc-ip-29/blocip-step10-2022.png)

Dans la fenêtre qui apparaît, descendez jusqu'à la partie « Routing feature ». Désactivez le curseur à droite de `NAT`. Cliquez enfin sur le bouton `Apply`.

![blocip](/images/guides/web-cloud/internet/internet-access/comment-commander-et-gerer-un-bloc-ip-29/blocip-step14.png)

### Étape 4 : configurer les adresses IP sur vos équipements <a id="conf-IP-equipements"></a>
...
![blocip](/images/guides/web-cloud/internet/internet-access/comment-commander-et-gerer-un-bloc-ip-29/blocip-step15.png)

### Résiliation du bloc IP /29

Si vous souhaitez résilier votre bloc IP /29, suivez le cheminement décrit dans [l'étape 1](#trouver-ip-associees) puis cliquez sur l'icône `corbeille` à droite de votre bloc IP /29.
