...
:::warning
The following procedure does not work for third-generation instances (example: B3-32). To be billed monthly for this type of instance, you must create a [Savings Plan](/guides/public-cloud/public-cloud-cross-functional/savings-plans/) for this instance model.
