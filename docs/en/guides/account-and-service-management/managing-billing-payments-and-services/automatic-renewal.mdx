...
> [!info]
>
> Depending on your place of residence, local legislation, and the solutions concerned, the details in this guide may vary or not apply to your situation. For further information, please refer to your OVHcloud contracts via the [OVHcloud Control Panel](/links/manager): Click on your name in the top right-hand corner of your screen, then `My offers and services`, then the `Contracts` tab.
>
...
Click your name in the top right-hand corner, then choose `My offers and services`.

![products and services](/images/assets/screens/control-panel/product-selection/right-menu/my-solutions-and-services.png)

### Display renewal type <a id="renewal-type"></a>

The **Manage my solutions and services** page contains a table for managing your OVHcloud services. You can find their names, the type of service, service availability (`Active` by default), its status (renewal type, action to be taken, etc.), the next renewal or cancellation date of effect, and a `...` button dedicated to the possible actions for each service.

![my services](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/my-services-en.png)
...
To the right of a service, click the `...`' button in the `Actions` column, then click on the action you want to perform.

![actions menu](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/actions-en.png)
...
![configure renewal](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/configure-renewal-en.png)

Click the `Configure renewal` action. Depending on the service you have chosen, you can set it to manual renewal, or choose the automatic renewal frequency.

![configure renewal](/images/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/configure-renew-en.png)
...
![anticipate payment](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/forward-payment-en.png)
...
>
> Once you have made your choices, proceed with your order by clicking `Confirm`.
>
...
![cancel](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/cancel-en.png)
...
![Renew service](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/renew-service-en.png)
...
![Pay a bill](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/pay-bill-en.png)
...
Simply click the `Pay my bill` action, which will redirect you to an online payment platform.
...
You can perform group actions by selecting several services in the table, then clicking on the `Actions` button.

![bulk actions](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/batch-actions-en.png)
