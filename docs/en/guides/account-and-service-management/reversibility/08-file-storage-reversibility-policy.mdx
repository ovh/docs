...
|Feature|Description|Available formats|Migration model|Available documentation|
|---|---|---|---|---|
| **vRack**  | The vRack (virtual rack) is a private VLAN technology that allows interconnection between OVHcloud services. | N/A | **Incoming**: Hosted Private Cloud services are included by default in the vRack. <br/> **Outgoing**: Document the network architecture and replicate it using VLANs on the target environment. | [V(x)LAN creation](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/creation-vlan/)<br/>[File Storage vRack](https://labs.ovhcloud.com/en/enterprise-file-storage-vrack/) |
