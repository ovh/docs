...
| Integrated monitoring | Performance dashboards integrated into the OVHcloud interface. | N/A | **Inbound**: Metrics Configuration.<br/> **Outbound**: Configuration to recreate in the target environment. | [Analytics - Kafka](/guides/public-cloud/data-analytics/overview/) |
...
| **Function** | **Description** | **Available formats** | **Migration model** | **Available documentation** |
| --- | --- | --- | --- | --- |
| OVHcloud private network (vRack) | Connect to other OVHcloud services via a private network. | N/A | **Incoming**: vRack configuration. <br/> **Outgoing**: Non-transferable feature. | [vRack](/guides/public-cloud/public-cloud-databases/databases-08-vrack/) |
