...
First, check whether the email you received is also visible on the [My messages](https://manager.eu.ovhcloud.com/#/communication) page. You will find copies of all official emails sent by OVHcloud there.
...
Open the [Account security](https://manager.eu.ovhcloud.com/#/account/useraccount/security) page and change your password.
