...
- On the [Account security](https://manager.eu.ovhcloud.com/#/account/useraccount/security) page, click <code className="action">Edit</code> to the right of “Password”.
