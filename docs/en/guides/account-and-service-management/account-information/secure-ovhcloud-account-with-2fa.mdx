...
On the [Account security](https://manager.eu.ovhcloud.com/#/account/useraccount/security) page, click <code className="action">Enable two-factor authentication</code>.
...
Go to the [login page for the OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) and enter your ID (or primary email address) and password.
...
To remove a device, go to the [Account security](https://manager.eu.ovhcloud.com/#/account/useraccount/security) page and click the <code className="action">...</code> button to the right of the device you want to delete, then click <code className="action">Delete</code>.
...
First, go to [the login page of the OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB).
