...
- **[Enabling Virtual Machine Encryption (VM Encrypt) - OVHcloud](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vm-encrypt/)**: practical guide on enabling VM encryption using KMS capabilities.
- **[Enabling virtual machine encryption with vSphere Native Key Provider - OVHcloud](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vm-encrypt-vnkp/)**: detailed instructions on using KMS in conjunction with the vSphere Native Key Provider for VM encryption.
