...
- Unfreezing via python-swiftclient:
    - [Preparing an environment for using the OpenStack API](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/) by installing python-swiftclient
