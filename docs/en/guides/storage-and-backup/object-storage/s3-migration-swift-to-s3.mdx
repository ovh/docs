...
- For your source container: we recommend using your OpenStack user and associated rclone config file from the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB). Follow the steps in [this guide](/guides/storage-and-backup/object-storage/pcs-sync-rclone-object-storage/) to access the config file associated with your OpenStack user.
...
We recommend comparing the source and destination buckets after migration. Your source and OVHcloud destination buckets can be compared via command line or directly from the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB)
