...
This URL is made up of an endpoint, available from the [Horizon interface](/guides/public-cloud/public-cloud-cross-functional/access-and-security-in-horizon/), the name of your container and the name of your object (including the prefix).
