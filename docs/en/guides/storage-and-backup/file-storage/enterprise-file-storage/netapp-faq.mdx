...
Yes, you can access this service directly from your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) by going to the <code className="action">Bare Metal Cloud</code> section, then <code className="action">Storage and Backup</code>.
