...
- Familiarity with the [OVHcloud APIs](/guides/manage-and-operate/api/first-steps/) and/or the [OVHcloud CLI](/guides/manage-and-operate/cli/cli-getting-started/)
