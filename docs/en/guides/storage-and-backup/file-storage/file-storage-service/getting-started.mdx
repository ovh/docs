...
- You already have a [private network](/guides/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/) available in your project.
- A [Public Cloud instance](https://www.ovhcloud.com/en-gb/public-cloud/) in your OVHcloud account
- An [OpenStack CLI ready environment](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/)
...
Example output:
    ...
    <Api version="v1" section="/cloud" method="POST" route={"/cloud/project/\\{serviceName\\}/region/\\{regionName\\}/share"} />    :::info
...
Example output:
    ...
    **2\. Authorize a client VM**
    ...
    Retrieve the VM’s [private IP address](/guides/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/).
...
**3\. Mount the share on your client VM**
  ...
  <Tab label="Via Manila CSI in Kubernetes environment">
    ...
    **4\. Installing OpenStack CLI**
    ...
    Prepare your environment to use the OpenStack API by installing python-openstackclient, following [this guide](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/).
  ...
  <Tab label="Via Terraform">
    **1\. Additional requirements**
    ...
    - You already have a working [Terraform environment](/guides/public-cloud/public-cloud-cross-functional/how-to-use-terraform/).
