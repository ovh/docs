...
description: Find out how to install Rails on your POWER web hosting plan
...
Then [restart your instance](/guides/ovhcloud-labs/power-web-hosting/getting-started#restart/) and your Rails will be online.
