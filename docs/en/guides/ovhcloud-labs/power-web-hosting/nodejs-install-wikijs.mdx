...
description: Find out how to install WikiJS on your POWER web hosting plan
...
Then [restart your instance](/guides/ovhcloud-labs/power-web-hosting/getting-started#restart/) and your WikiJS will be online.

<img className="thumbnail" alt="WikiJS" src="/images/ovhcloud-labs/power-web-hosting/nodejs-install-wikijs/nodejs-install-wikijs-01.png" loading="lazy" />
