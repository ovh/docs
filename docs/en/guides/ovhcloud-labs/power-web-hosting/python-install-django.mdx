...
description: Find out how to install Django on your POWER web hosting plan
...
[Connect via SSH](/guides/ovhcloud-labs/power-web-hosting/getting-started#ssh/) to your POWER web hosting and activate `virtualenv`:
...
Then [restart your instance](/guides/ovhcloud-labs/power-web-hosting/getting-started#restart/) and your Django will be online.
