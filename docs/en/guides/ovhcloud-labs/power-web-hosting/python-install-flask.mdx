...
description: Find out how to install Flask on your POWER web hosting plan
...
Then [restart your instance](/guides/ovhcloud-labs/power-web-hosting/getting-started#restart/) and your Flask project will be online.
