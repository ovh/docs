...
description: Find out how to install Etherpad  on your POWER web hosting plan
...
[Access via SSH](/guides/ovhcloud-labs/power-web-hosting/getting-started#ssh/) to your POWER web hosting, and retrieve Etherpad sources into the `www` folder:
...
[Restart your instance](/guides/ovhcloud-labs/power-web-hosting/getting-started#restart/) and your Etherpad will be online.

<img className="thumbnail" alt="Etherpad" src="/images/ovhcloud-labs/power-web-hosting/nodejs-install-etherpad/nodejs-install-etherpad-01.png" loading="lazy" />
