...
description: Find out how to install Camaleon on your POWER web hosting plan
...
Then [restart your instance](/guides/ovhcloud-labs/power-web-hosting/getting-started#restart/) and your Camaleon will be online.

<img className="thumbnail" alt="Camaleon" src="/images/ovhcloud-labs/power-web-hosting/ruby-install-cameleon/ruby-install-camaleon-01.png" loading="lazy" />
