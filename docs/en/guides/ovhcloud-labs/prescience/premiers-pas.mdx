...
description: This guide will show how to create an automated learning model in order to perform a classification.
...
Click <code className="action">Login</code> to access the application.
...
To view all of the sources uploaded to the application, click on the <code className="action">Sources</code> tab.
...
To upload a new source, simply click on the <code className="action">Upload Source</code> button, then fill in the fields requested.
...
Fill in the form as follows, then click <code className="action">Upload</code> to start uploading the file.
...
Fill in the form as follows, then continue by clicking <code className="action">Start</code>.
...
You can then launch an optimisation via the <code className="action">Optimize</code> button. This action will prompt you to enter the following information:
...
This display is also available in the form of a table, via the <code className="action">Table</code> button.
...
Fill in the form with the following information, then click <code className="action">Start</code>.
