...
- A [REST API](/guides/manage-and-operate/secret-manager/secret-manager-rest-api/) similar to OVHcloud's standard APIs.
- A [Hashicorp Vault KV2 compliant API](/guides/manage-and-operate/secret-manager/secret-manager-kv2-api/) providing compatibility with applications already compatible with Hashicorp Vault KV2.
