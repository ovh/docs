...
You will also need the `region` and the `okms-id` of the OKMS domain you want to use. This ID and this region can be found in the [OKMS domain dashboard](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/dedicated/security/kms) or via the [OVHcloud CLI](https://github.com/ovh/ovhcloud-cli):
