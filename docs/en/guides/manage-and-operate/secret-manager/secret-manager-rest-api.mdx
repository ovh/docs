...
You can access the OKMS Swagger UI by clicking on the link in your [OKMS domain dashboard](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/dedicated/security/kms).
