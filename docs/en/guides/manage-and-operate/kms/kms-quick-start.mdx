...
You can order a KMS from the [OVHcloud Control Panel](/links/manager) by going to `Identity, Security & Operations` and `Key Management Service`. Then click the `Order a KMS` button.

![Access to the KMS menu](/images/guides/manage-and-operate/kms/quick-start/access_to_the_KMS_menu_01.png)

Enter the region of your KMS.

![Order the KMS](/images/guides/manage-and-operate/kms/quick-start/order_kms_01.png)

You can then finalize the command in another tab. If it has not opened automatically, the command link is displayed:

![Order the KMS](/images/guides/manage-and-operate/kms/quick-start/order_kms_02.png)

After a few seconds, the KMS will be available in your Control Panel.

![Order the KMS](/images/guides/manage-and-operate/kms/quick-start/order_kms_03.png)
...
![Create a key](/images/guides/manage-and-operate/kms/quick-start/create_key_01.png)

A form allows you to configure the key and select its type, size and usage.

![Create a key](/images/guides/manage-and-operate/kms/quick-start/create_key_02.png)
...
![Create a key](/images/guides/manage-and-operate/kms/quick-start/create_key_03.png)
