...
| `--kmip-addr`   | Address of the KMIP server. Available in your [OKMS domain dashboard](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/dedicated/security/kms). (e.g., `eu-west-rbx.okms.ovh.net:5696`). | `""` (required)                  |
