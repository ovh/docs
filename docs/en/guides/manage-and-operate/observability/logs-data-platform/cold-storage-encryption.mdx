...
In the home page of your Logs Data Platform service, in the bottom left you will find a `Configuration` panel. In this panel, in the `PGP encryption keys` line, click the `...` button and then `Edit`:

![Home page](/images/guides/manage-and-operate/observability/logs-data-platform/archive-cold-storage-encryption/home.png)
...
![PGP keys home page](/images/guides/manage-and-operate/observability/logs-data-platform/archive-cold-storage-encryption/pgp_home.png)
...
![Add a new PGP key](/images/guides/manage-and-operate/observability/logs-data-platform/archive-cold-storage-encryption/add_key.png)
...
For this, go to the `Data Stream` tab, pick the stream for which you want cold storage encryption, click the `...` button and then click`Edit`.
...
![Update stream configuration](/images/guides/manage-and-operate/observability/logs-data-platform/archive-cold-storage-encryption/update_stream.png)
...
In the `Data Stream` tab, you can see how many archives exist for each stream. On a stream on which you have some archives, click the`...` button and then click `Archives`.

![List archives](/images/guides/manage-and-operate/observability/logs-data-platform/archive-cold-storage-encryption/archives.png)
