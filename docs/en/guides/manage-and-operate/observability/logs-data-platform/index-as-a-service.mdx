...
To create an OpenSearch index with the Logs Data Platform manager, you need to go to the index page and click on the `Add a new index` on the OpenSearch index section

![add index option](/images/guides/manage-and-operate/observability/logs-data-platform/opensearch-index/add_index.png)
...
If you have enabled [IAM on your account](/guides/manage-and-operate/observability/logs-data-platform/overview) you first need to create a policy and give the creation rights to your preferred user/account. See the [IAM for LDP documentation policy guide](/guides/manage-and-operate/observability/logs-data-platform/getting-started-roles-permission).
...
![Log in the stream](/images/guides/manage-and-operate/observability/logs-data-platform/opensearch-index/stream_1.png)
...
![A song of Ice And Fire](/images/guides/manage-and-operate/observability/logs-data-platform/opensearch-index/dashboard.png)
...
![manager](/images/guides/manage-and-operate/observability/logs-data-platform/opensearch-index/manager.png)
