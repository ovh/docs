...
- [Logstash collector on Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/ingestion-logstash-dedicated-input/).
- [The Filebeat tutorial](/guides/manage-and-operate/observability/logs-data-platform/ingestion-filebeat/).
...
For this tutorial, we will configure the 3 alerts that we can use for a website. These 3 alerts can help you to react immediately in the case of a failure, detect unexpected problems or verify that all your websites are working correctly. But before going into the alerting feature itself, we need to configure our Apache Logging format to include all the information we need. We will also use [Filebeat](/guides/manage-and-operate/observability/logs-data-platform/ingestion-filebeat/) to send our logs to Logs Data Platform.
...
The configuration is inspired by the one you can find in [this tutorial](/guides/manage-and-operate/observability/logs-data-platform/ingestion-apache/).
