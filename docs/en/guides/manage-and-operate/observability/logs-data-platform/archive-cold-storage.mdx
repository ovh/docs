...
- The content of your archives: GELF, one special field [X-OVH-TO-FREEZE](/guides/manage-and-operate/observability/logs-data-platform/getting-started-field-naming-convention/), or both (you will get two separate archives in this case)
