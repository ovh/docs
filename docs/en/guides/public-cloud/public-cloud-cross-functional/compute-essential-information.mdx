...
- [Create your first instance](/guides/public-cloud/compute/compute-getting-started)
- [Manage quotas](/guides/public-cloud/public-cloud-cross-functional/increasing-public-cloud-quota)

## Global approach <a id="global-approach"></a>
...
## Practical approach <a id="concrete-approach"></a>
...
|Documentation|Details|
|---|---|
|[Create your first instance](/guides/public-cloud/compute/compute-getting-started)|First practical guide to starting a cloud server from the OVHcloud Control Panel.|
...
|[Private Network Configuration](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack)|At OVHcloud, private networks are powered by vRack technology. This guide will help you get started.|
...
|[Configuring an Additional IP](/guides/public-cloud/public-cloud-network-services/configure-additional-ip)|Additional IPs can allow you to switch traffic from one instance to another. This guide will explain how to configure this.|
|[Installing the OpenStack CLI](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment)|OpenStack can also be used in the command line. Here is how to install the tools.|
