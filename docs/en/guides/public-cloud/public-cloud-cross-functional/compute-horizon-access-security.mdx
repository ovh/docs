...
- **API Access** (under `Project`)

The API Access table lists the service endpoints of the OpenStack API.

![security Horizon](/images/guides/public-cloud/public-cloud-cross-functional/access-and-security-in-horizon/api_access.png)
...
- **Key Pairs** (under `Project` / `Compute`)
...
![security Horizon](/images/guides/public-cloud/public-cloud-cross-functional/access-and-security-in-horizon/key_pairs.png)
...
- **Security Groups** (under `Project` / `Network`)
...
![security Horizon](/images/guides/public-cloud/public-cloud-cross-functional/access-and-security-in-horizon/security_groups.png)
