...
<img className="thumbnail" alt="Cloudshell button" src="/images/public-cloud/public-cloud-cross-functional/getting-started-ovhcloudshell/OVHcloud_Shell.png" loading="lazy" />
