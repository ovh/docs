...
- [Create your first Public Cloud project](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project/)
...
- [Create your first instance](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)
- [Manage quotas](/guides/public-cloud/public-cloud-cross-functional/increasing-public-cloud-quota/)
...
You will then need to [create a Public Cloud project](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project/). A project is an environment that you will dedicate to a context.
...
Since your payment method has been saved, it will be used to debit the amount calculated for your [billing at the end of the month](/guides/public-cloud/public-cloud-cross-functional/analyze-billing/). This calculation is based on the usage time of each resource, depending on the price of the resources.
...
<br/>These quotas are allocated by region (in the OpenStack sense). As a result, you may reach the maximum possible resources for your project, and you may need to [increase these quotas](/guides/public-cloud/public-cloud-cross-functional/increasing-public-cloud-quota/).
...
- If you would like to use the OpenStack or Amazon S3 APIs, or the Horizon interface, you will need to [create users](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/) to do this. Users may have limited permissions to secure the action perimeters.
- If you do not need access to the APIs or Horizon, you can [link another OVHcloud](/guides/public-cloud/public-cloud-cross-functional/delegate-projects/) customer account as an add-on to your project.
...
|---|---|
|[FAQ](/guides/public-cloud/public-cloud-cross-functional/faq-pci/)|Frequently asked questions about Public Cloud.|
|[Glossary](/guides/public-cloud/public-cloud-cross-functional/introduction-about-instances/)|The concepts and definitions you will need to move forward.|
...
|Documentation|Details|
|---|---|
|[Create your first instance](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)|First practical guide to starting a cloud server from the OVHcloud Control Panel.|
|[Using an SSH key](/guides/public-cloud/compute/compute-creating-ssh-keys/)| To log in to a Linux instance, you will need to log in via an SSH connection. This guide details the procedure.|
|[Private Network Configuration](/guides/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/)|At OVHcloud, private networks are powered by vRack technology. This guide will help you get started.|
...
|[Accessing the Horizon interface](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon/)|The Horizon interface of OpenStack allows some advanced actions, here is how to connect to it.|
|[Creating a Kubernetes cluster](/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/)|This guide will help you step by step in creating your first Kubernetes cluster.|
|[Configuring an Additional IP](/guides/public-cloud/public-cloud-network-services/getting-started-04-configure-additional-ip-to-instance/)|Additional IPs can allow you to switch traffic from one instance to another. This guide will explain how to configure this.|
|[Installing the OpenStack CLI](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/)|OpenStack can also be used in the command line. Here is how to install the tools.|
