...
<img className="thumbnail" alt="Automatic installation" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/1_preparation_openstack_environment_windows.png" loading="lazy" />
...
<img className="thumbnail" alt="Environment variable settings" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/2_preparation_openstack_environment_windows.png" loading="lazy" />
...
<img className="thumbnail" alt="Performance settings" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/3_preparation_openstack_environment_windows.png" loading="lazy" />

#### Step 3: Configure the environment variables.

In the ‘System variables’ section, select ‘New’, attribute the name “PYTHON_HOME”, and add the access path to Python.

<img className="thumbnail" alt="Add the access path" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/4_edit_system_variables.png" loading="lazy" />
...
<img className="thumbnail" alt="Automatic installation" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/5_preparation_openstack_environment_windows.png" loading="lazy" />
...
<img className="thumbnail" alt="Checking" src="/images/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/6_preparation_openstack_environment_windows.png" loading="lazy" />
