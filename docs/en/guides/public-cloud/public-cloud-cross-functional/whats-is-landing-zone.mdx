...
See Public Cloud Landing Zone Reference of architecture in [this guide](/guides/public-cloud/public-cloud-cross-functional/landing-zone-migration/).
...
- **Ingestion:** Ingestion agents, or inputs, receive logs within the Logs Data Platform. They verify the source’s validity and the formatting of logs based on [these rules](/guides/manage-and-operate/observability/logs-data-platform/getting-started-field-naming-convention/), and may add, update or remove fields before forwarding your logs to storage.
...
For guidance on building your Landing Zone to OVHcloud, check our [building documentation](/guides/public-cloud/public-cloud-cross-functional/landing-zone-migration/).
