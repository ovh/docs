...
For more information on Public Cloud billing, see [our dedicated guide](/guides/public-cloud/public-cloud-cross-functional/analyze-billing/).
...
Please read our guide on [Creating and connecting to your first Public Cloud instance](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
...
Please read our guide on [Replacing your lost SSH key pair](/guides/public-cloud/compute/replacing-lost-ssh-key/).
...
- **[Optional since September 2023]** An [OpenStack user](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/) can be created to use the Horizon or OpenStack APIs. This is optional because we have deployed Single Sign-On (SSO) authentication between the OVHcloud Control Panel and Horizon.
...
For more information, please refer to this guide: [Buying an Additional IP](/guides/public-cloud/public-cloud-network-services/additional-ip-buy/).
...
Please read our guide on [Configuring vRack for Public Cloud](/guides/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/).
...
Please refer to our guide on [Managing firewall rules and port security on networks using OpenStack CLI](/guides/public-cloud/public-cloud-cross-functional/security-group-private-network/).
