...
- Understanding of the [Load Balancer concepts](/guides/public-cloud/public-cloud-network-services/load-balancer-concepts)
- An active [Public Cloud project](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project)
- A previously configured [Load Balancer](/guides/public-cloud/public-cloud-network-services/getting-started-load-balancer) within your OVHcloud project space
...
- **OpenStack CLI:** For command line management. More information on preparing your OpenStack API environment is available [here](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment).
- **Horizon Interface:** Offers graphical management via OpenStack for users familiar with this platform. Additional details [here](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon).
...
Click on the `Public Cloud` tab. Select the desired Public Cloud project if you have multiple.

Select `Load Balancer` in the `Network`section or use the quick search function. You will see a list of your Load Balancers. Click on the one you wish to configure.
...
To access the management options for L7 policies of a specific listener, click  the `...` button to the right of the listener you want to configure.

Select the `View L7 policies` option from the dropdown menu.

![Schema 1](/images/guides/public-cloud/public-cloud-network-services/technical-resources-04-lbaas-create-l7/Policy9.png)
...
![Schema 1](/images/guides/public-cloud/public-cloud-network-services/technical-resources-04-lbaas-create-l7/Policy10.png)
...
![Schema 1](/images/guides/public-cloud/public-cloud-network-services/technical-resources-04-lbaas-create-l7/Policy11.png)

After filling in all the necessary fields, click on `Add` to create your L7 policy.

![Schema 1](/images/guides/public-cloud/public-cloud-network-services/technical-resources-04-lbaas-create-l7/Policy4.png)
...
On the L7 policies page of your listener, locate the policy to which you want to add rules. Click the `...` button next to the relevant policy and select `Manage L7 rules`.

![Schema 1](/images/guides/public-cloud/public-cloud-network-services/technical-resources-04-lbaas-create-l7/Policy5.png)

2\. **Add a New L7 Rule**:

On the L7 rules page, click the `Add an L7 rule` button.

![Schema 1](/images/guides/public-cloud/public-cloud-network-services/technical-resources-04-lbaas-create-l7/Policy6.png)
...
![Schema 1](/images/guides/public-cloud/public-cloud-network-services/technical-resources-04-lbaas-create-l7/Policy7.png)

5\. **Saving the Rule**:

Once all fields are filled in according to your criteria, click `Add` to save the rule to your L7 policy.

![Schema 1](/images/guides/public-cloud/public-cloud-network-services/technical-resources-04-lbaas-create-l7/Policy8.png)
...
- To log in with OVHcloud Single Sign-On: Use the `Horizon` link in the left-hand menu under "Management Interfaces" after opening your `Public Cloud` project in the [OVHcloud Control Panel](/links/manager).
...
In the Horizon dashboard, select your `Project`<br />
In the left menu, click on the `Network` tab and select `Load Balancers`.
...
To add a new policy, click the `Create L7 Policy` button.
