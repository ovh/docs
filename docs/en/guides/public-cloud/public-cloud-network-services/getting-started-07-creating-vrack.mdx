...
The [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) is a fully visual interface, ideally suited for managing multiple VLANs. You will also have the possibility to customise the private IP range, which by default is in 10.1.0.0/16.
...
Please refer to [this guide](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon/) to familiarise yourself with Horizon.
...
- [Prepare the environment for using the OpenStack API](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/)
- [Load OpenStack environment variables](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/)
...
For that you need to cherry-pick the correct terraform provider & resource. Find more information in our guide on [using Terraform with OVHcloud](/guides/manage-and-operate/terraform/terraform-at-ovhcloud/).
...
You will be redirected to another page to validate the order, it will take a few minutes for the vRack to be setup in your account.
    ...
    <img className="thumbnail" alt="add project to vrack" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/addprojectvrack.png" loading="lazy" />
...
<Tabs>
  <Tab label="Via the OVHcloud Control Panel">
    ...
    <img className="thumbnail" alt="VLAN creation" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack2022-03.png" loading="lazy" />
...
Click on the button <code className="action">Add Private Network</code>. The following page allows you to customise multiple settings.
    ...
    <img className="thumbnail" alt="select region" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack5-2024.png" loading="lazy" />

In the next step, a number of options are presented to you:
    
    <img className="thumbnail" alt="create network" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack6-2022.png" loading="lazy" />
...
<Tabs>
  <Tab label="Via the OVHcloud Control Panel">
    ...
    <img className="thumbnail" alt="attach new instance" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/network-selection.png" loading="lazy" />
...
<Tabs>
  <Tab label="Via the OVHcloud Control Panel">
    ...
    <img className="thumbnail" alt="detail instance" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/instance_details.png" loading="lazy" />
...
This will open the instance dashboard. Click on the <code className="action">⁝</code> button in the box "Networks", next to "Private networks", and select <code className="action">Attach a network</code>.
    ...
    <img className="thumbnail" alt="attach network" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack2021-01.png" loading="lazy" />
...
In the popup window that appears, select the private network(s) to attach to your instance and click <code className="action">Confirm</code>.
    ...
    <img className="thumbnail" alt="attach network" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack9.png" loading="lazy" />
  </Tab>
  <Tab label="Via the OVHcloud APIv6">
...
You will need to fill in at least the following fields:
  ...
  <Tab label="Via Horizon">
    ...
    <img className="thumbnail" alt="connection Horizon" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon1.png" loading="lazy" />
