...
**To begin with, the following provides a brief description of the possible actions according to the chosen method/interface.** <a id="horizon"></a>
...
- [Prepare the environment for using the OpenStack API](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment)
- [Load OpenStack environment variables](/guides/public-cloud/public-cloud-cross-functional/compute-set-openstack-environment-variables)
...
>>
>> ![Order vrack](/images/assets/screens/control-panel/product-selection/bare-metal-cloud/network/orderingvrack25.png)
>>
...
If you need assistance, follow this guide first: [Creating an instance in the OVHcloud Control Panel](/guides/public-cloud/compute/compute-getting-started). When creating an instance, you can choose, in Step 5, a network mode, followed by a private network to integrate your instance into. 
