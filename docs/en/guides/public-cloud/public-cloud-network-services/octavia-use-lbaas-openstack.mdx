...
- A [private network](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack) configured in your project
...
- [Set OpenStack environment variables](/guides/public-cloud/public-cloud-cross-functional/compute-set-openstack-environment-variables)
...
>
> You can read more about it on our dedicated [Concepts page](/guides/public-cloud/public-cloud-network-services/additional-ip-vs-floating-ip).
...
![diagram](/images/guides/public-cloud/public-cloud-network-services/technical-resources-01-using-lbaas-in-openstack-environment/topology.png)
