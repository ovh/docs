...
- An [OpenStack user](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/) (optional)
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/stormshield-ha-vrack.png" loading="lazy" />
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ha-filter.png" loading="lazy" />
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ha-1.png" loading="lazy" />

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ha-2.png" loading="lazy" />

When the configuration of the HA is finished on the first SNS EVA, join the group of firewalls on the second one:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ha-3.png" loading="lazy" />

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ha-4.png" loading="lazy" />
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ha-5.png" loading="lazy" />
...
<Tabs>
  ...
  <Tab label="Step 2">
    ...
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/configure-management-1.png" loading="lazy" />
  </Tab>
  <Tab label="Step 3">
     Restrict access to the GUI to your public IP and enable SSH:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/configure-management-2.png" loading="lazy" />
  </Tab>
  <Tab label="Step 4">
    Restrict SSH access to your public IP:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/configure-management-3.png" loading="lazy" />
  </Tab>
</Tabs>
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/stormshield-gateway.png" loading="lazy" />
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/gateway-2.png" loading="lazy" />
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/gateway-3.png" loading="lazy" />
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/stormshield-nat-http.png" loading="lazy" />
...
<Tabs>
  ...
  <Tab label="Step 2">
    ...
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/nat-1.png" loading="lazy" />
  </Tab>
  <Tab label="Step 3">
    Create a NAT rule like this one:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/nat-2.png" loading="lazy" />
  </Tab>
  <Tab label="Step 4">
    Create a filter rule like this one:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/nat-3.png" loading="lazy" />
  </Tab>
</Tabs>
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/stormshield-ipsec.png" loading="lazy" />
...
<Tabs>
  <Tab label="Step 1">
    ...
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ipsec-3.png" loading="lazy" />
  </Tab>
  <Tab label="Step 2">
    Create the remote gateway:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ipsec-4.png" loading="lazy" />
  </Tab>
  <Tab label="Step 3">
    Choose a pre-shared key:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ipsec-5.png" loading="lazy" />
  </Tab>
  <Tab label="Step 4">
    Create and activate the tunnel:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ipsec-7.png" loading="lazy" />
  </Tab>
  <Tab label="Step 5">
    Add a filter rule like this one to allow traffic through the tunnel:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ipsec-8.png" loading="lazy" />
  </Tab>
</Tabs>
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/stormshield-ssl-vpn.png" loading="lazy" />
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-1.png" loading="lazy" />

- Create the user directory:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-2.png" loading="lazy" />

- Add a user to our local directory:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-3.png" loading="lazy" />

- Choose a password for the new user:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-4.png" loading="lazy" />
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-5.png" loading="lazy" />

TCP client network:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-6.png" loading="lazy" />

##### **SSL VPN server configuration**

Configure the SSL VPN server:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-7.png" loading="lazy" />
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-8.png" loading="lazy" />

Allow SSL VPN:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-9.png" loading="lazy" />

##### **Configuring filter rules**

Add a filter rule like this one to let VPN client access the VLAN200:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/public-cloud-network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-10.png" loading="lazy" />
