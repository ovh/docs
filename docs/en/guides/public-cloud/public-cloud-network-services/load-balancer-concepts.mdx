...
A specific protocol is `PROMETHEUS`, it enables configuring a prometheus endpoint and does not handle traffic itself. This is used to export metrics to Prometheus for monitoring, but it is not used to route application traffic. Find more information about this configuration on [this page](/guides/public-cloud/public-cloud-network-services/loadbalancer-monitoring-prometheus).
...
![Private to Private Load balancer architecture](/images/guides/public-cloud/public-cloud-network-services/concepts-03-loadbalancer/priv-to-priv.png)
...
![Public to Private Load balancer architecture](/images/guides/public-cloud/public-cloud-network-services/concepts-03-loadbalancer/pub-to-priv.png)
...
|---|---|---|---|---|
|Private to Private | Required | Not required | 3 ([src](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-known-limits)) | Not required |
|Public to Private  | Required | Required | 5 ([src](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-known-limits)) | Required |
|Public to Public  | Required | Required | 5 ([src](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-known-limits)) | Required |
...
## Operating and Provisioning status <a id="operating-provisioning-status"></a>
...
- Configure your first load balancer with this [guide](/guides/public-cloud/public-cloud-network-services/getting-started-load-balancer).
