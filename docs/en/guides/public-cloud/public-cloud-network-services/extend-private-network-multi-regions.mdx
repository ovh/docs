...
![problematic image](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/problematic_image.png)
...
![solution image](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/solution_image.png)
...
![Add Public Cloud project to Vrack](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/add_pcp_to_vrack.png)
...
![Edit subnet region 1](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/configure_subnet_region1.png)

![Edit subnet region 1 - 2](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/configure_subnet_region1_2.png)

**- Second region:**

![Edit subnet region 2](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/configure_subnet_region2.png)

![Edit subnet region 2 - 2](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/configure_subnet_region2_2.png)

**3\. Refresh network status**

Go back to the OVHcloud Control Panel and refresh the network page.

![Refresh vrack list page](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/refresh_vrack_list_page.png)
...
![Add Bare Metal server to Vrack](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/add_baremetal_to_vrack.png)
...
![Create Public Cloud private network](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/create_private_network.png)
...
![Obtain mac address](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/obtain_mac_address.png)

**3\. Create a virtual port on the Public Cloud private network using the MAC address of the Bare Metal server.**

![Create virtual port](/images/guides/public-cloud/public-cloud-network-services/extend-private-network-accross-regions/create_virtual_port.png)
