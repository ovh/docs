...
Log in to your instance via SSH. Refer to our guide on [Connecting to a Public Cloud instance](/guides/public-cloud/compute/public-cloud-first-steps#connect-instance/) if necessary.
...
Connect to the instance via remote desktop session or with the VNC console. Refer to our guide on [Connecting to a Public Cloud instance](/guides/public-cloud/compute/public-cloud-first-steps#connect-instance/) if necessary.

Open the <code className="action">Network settings</code>.

<img className="thumbnail" alt="change-dns-servers" src="/images/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers1.png" loading="lazy" />

Go to your public network adapter’s IPv4 configuration via the control panel.

<img className="thumbnail" alt="change-dns-servers" src="/images/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers2.png" loading="lazy" />

Add the servers you want to use in the <code className="action">Advanced</code> settings.

<img className="thumbnail" alt="change-dns-servers" src="/images/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers3.png" loading="lazy" />
