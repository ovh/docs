...
Log in to your instance via SSH. Refer to our guide on [Connecting to a Public Cloud instance](/guides/public-cloud/compute/compute-getting-started#connect-instance) if necessary.
...
Connect to the instance via remote desktop session or with the VNC console. Refer to our guide on [Connecting to a Public Cloud instance](/guides/public-cloud/compute/compute-getting-started#connect-instance) if necessary.

Open the `Network settings`.

![change-dns-servers](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers1.png)

Go to your public network adapter's IPv4 configuration via the control panel.

![change-dns-servers](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers2.png)

Add the servers you want to use in the `Advanced` settings.

![change-dns-servers](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers3.png)
...
[First steps with Public Cloud instances](/guides/public-cloud/compute/compute-getting-started)
