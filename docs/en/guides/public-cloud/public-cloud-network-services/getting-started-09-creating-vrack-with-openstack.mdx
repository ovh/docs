...
- An [OpenStack user account](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/) (Optional)
...
<img className="thumbnail" alt="add project to vrack" src="/images/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/addprojectvrack.png" loading="lazy" />

<a name="ovhcloud-api"></a>

#### With the OVHcloud APIv6

To activate and manage a vRack using the OVHcloud APIv6, please refer to [this section](/guides/public-cloud/public-cloud-network-services/getting-started-08-creating-vrack-with-api#step-1-activating-and-managing-a-vrack/) of the corresponding guide.
...
[Configuring vRack for Public Cloud using OVHcloud APIv6](/guides/public-cloud/public-cloud-network-services/getting-started-08-creating-vrack-with-api/).
