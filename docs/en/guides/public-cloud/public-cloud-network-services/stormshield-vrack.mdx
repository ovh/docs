...
### Install and configure Stormshield Network Security on your Public Cloud environment <a id="step1"></a>
...
Log into the [OVHcloud Control Panel](/links/manager), go to the `Public Cloud` section, and select the relevant Public Cloud project. In the left menu, click on `Instances` under the **Compute** tab, then find your two SNS EVA instances.
...
#### Use case 1: Configure Stormshield Network Security to be used as a gateway <a id="step2"></a>
...
#### Use case 2: Configure a NAT to access a private HTTP service from the outside <a id="step3"></a>
...
#### Use case 3: IPsec tunnel (site-to-site) <a id="step4"></a>
...
#### Use case 4: SSL/TLS VPN (client-to-site) <a id="step5"></a>
