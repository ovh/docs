...
Read more about it on our [Load Balancer guide page](/guides/public-cloud/public-cloud-network-services/getting-started-01-create-lb-service/).
...
Find out more about Additional IP and Floating IP on the dedicated [Concepts page](/guides/public-cloud/public-cloud-network-services/concepts-02-additional-ip-vs-floating-ip/).
