...
- A [Public Cloud instance](/guides/public-cloud/compute/compute-getting-started) with Debian or Ubuntu installed
...
### Step 2: Configuring the database server <a id="sqlconf"></a>
...
> 
> As an alternative, OVHcloud offers the solution [SSL Gateway](/links/web/ssl-gateway). Refer to the [guide pages](/guides/web-cloud/ssl-gateway/ssl-gateway-order) as well for further information.
>
