...
- [An instance created via the OVHcloud Control Panel](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project/)
- [Administrative access to the instance](/guides/public-cloud/compute/public-cloud-first-steps#connect-instance/)
