...
:::info
**Best Practice:** For critical workloads, prefer a [multi-AZ deployment](/guides/public-cloud/public-cloud-cross-functional/3az-ref-architecture/) to ensure service resilience and continuity.
...
For detailed instructions on creating and using SSH keys, refer to the [OVHcloud SSH guide](/guides/public-cloud/compute/compute-creating-ssh-keys/).
...
:::info
**Best Practice:** Backups are not a substitute for a [resilient architecture](/guides/public-cloud/public-cloud-cross-functional/3az-ref-architecture/). For critical environments, combine backups with multi-AZ replication to ensure maximum data protection and service availability.
...
For more detailed guidance on configuring Public Cloud networks, refer to the official [OVHcloud networking guide](/guides/public-cloud/public-cloud-network-services/concepts-01-public-cloud-networking-concepts/).
...
Saving Plans help you optimize your budget while maintaining the performance and reliability of your cloud environment. For more details, refer to the official [OVHcloud Savings Plans guide](/guides/public-cloud/public-cloud-cross-functional/savings-plans/).
...
- [How to create a Public Cloud instance and connect to it](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)
