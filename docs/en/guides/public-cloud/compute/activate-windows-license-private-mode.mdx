...
We recommend that you read our guide on [Accessing the Horizon](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon/) interface to familiarise yourself with Horizon.
...
Log in to the [Horizon](https://horizon.cloud.ovh.net/auth/login/) interface using the method listed in the [first part of this guide](/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack#horizon/).
