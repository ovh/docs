...
- You want to prepare the environment if you want to use [Terraform](/guides/public-cloud/public-cloud-cross-functional/how-to-use-terraform/).
...
In 3AZ regions, Classic Volumes are regional services that use distributed erasure coding across multiple Availability Zones. This ensures data remains available without impact or downtime in the event of an AZ failure, provided the multi-attached resilient architecture conditions are met. For more information, please refer to our guide "[Proper Usage and Limitations of Classic Multi-Attach Block Storage in 3AZ Regions](/guides/public-cloud/compute/classic-block-multi-az-limitations/)".
...
Establish an [SSH connection to your instance](/guides/public-cloud/compute/public-cloud-first-steps#connect-instance/), then use the command below to list the attached disks.
