...
You can find more information in our [guide on how to create a Public Cloud instance](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
...
:::info
`Ed25519` is considered the most secure but `RSA` is a valid alternative. Both methods are compatible with the [OVHcloud Control Panel](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
...
Copy this key string to [add it to a new instance or to import it into the OVHcloud Control Panel](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
...
[How to create a Public Cloud instance](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)
