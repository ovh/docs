...
To better understand the underlying architecture for multi-zone deployments using regional Block Storage, refer to the following [documentation](/guides/public-cloud/public-cloud-cross-functional/3az-ref-architecture#2az-with-regional-block-storage/).
