...
Restart the instance in "normal" mode from your [OVHcloud Control Panel](/links/manager). Refer to the [rescue mode guide](/guides/public-cloud/compute/put-an-instance-in-rescue-mode) if needed.
