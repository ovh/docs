...
Create a new SSH key pair on your local device, as described in the first part of the [SSH key guide](/guides/public-cloud/compute/compute-creating-ssh-keys/).
...
Restart the instance in "normal" mode from your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB). Refer to the [rescue mode guide](/guides/public-cloud/compute/put-an-instance-in-rescue-mode/) if needed.
