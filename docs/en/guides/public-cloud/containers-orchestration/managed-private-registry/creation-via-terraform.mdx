...
![Terraform](/images/guides/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-through-terraform/ovh-loves-terraform.png)
...
![Terraform registry](/images/guides/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-through-terraform/terraform-registry.png)
...
![OVHcloud Managed Private Registry Harbor](/images/guides/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-through-terraform/ovh-managed-private-registry-harbor.png)
...
Now, log in to the [OVHcloud Control Panel](/links/manager), go to the `Public Cloud` section and click on `Managed Private Registry`. <br />
As you can see, your registry has been successfuly created:

![Private registry created](/images/guides/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-through-terraform/registry-created.png)
