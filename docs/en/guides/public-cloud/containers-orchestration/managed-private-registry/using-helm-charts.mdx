...
To have an overview of OVHcloud Managed Private Registry service, you can go to the [OVHcloud Managed Private Registry site](/guides/public-cloud/containers-orchestration/managed-private-registry/overview/).
