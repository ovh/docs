...
![Operator diagram](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-go-operator/operator.png)
...
### Custom resources definition <a id="customresources"></a>
...
![Hello world from Nginx](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-go-operator/hello-world.png)
...
In order to create a private registry, you can follow the [how to create an OVHcloud private registry](/guides/public-cloud/containers-orchestration/managed-private-registry/managed-private-registry-creation) tutorial.
...
To go deeper on the Kubernetes operators topic, follow the other [Kubernetes tutorials](/guides/public-cloud/containers-orchestration/managed-kubernetes/create-cluster) in the `Operators` section.
