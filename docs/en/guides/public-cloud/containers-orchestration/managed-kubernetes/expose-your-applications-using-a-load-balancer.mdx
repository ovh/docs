...
This guide uses some concepts that are specific to our Public Cloud Load Balancer (listener, pool, health monitor, member, ...) and to the OVHcloud Public Cloud Network (Gateway, Floating IP). You can find more information regarding Public Cloud Network concepts in our official documentation, for example [networking concepts](/guides/public-cloud/public-cloud-network-services/overview/) and [loadbalancer concepts](/guides/public-cloud/public-cloud-network-services/concepts-01-public-cloud-networking-concepts/).
...
The first step is to make sure that you have an existing vRack on your Public Cloud Project. To do so you can follow this guide that explains how to [Configure a vRack for Public Cloud](/guides/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/).
...
- **The subnet does not have an IP reserved for a Gateway**, you will have to provide or create a compatible subnet. Three options are available:
    - Edit an existing subnet to reserve an IP for a Gateway : please refer to the [Update a subnet properties](/guides/public-cloud/public-cloud-network-services/configuration-04-update-subnet/) documentation.
...
1\. Deploy a functional Managed Kubernetes (MKS) cluster using the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), [Terraform, Pulumi](/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/) or the [OVHcloud API](https://api.ovh.com/console-preview/?section=%2Fcloud&branch=v1#post-/cloud/project/-serviceName-/kube).

2\. Retrieve the kubeconfig file needed to use kubectl tool (via the OVHcloud Control Panel, Terraform, Pulumi or API). You can use [this guide](/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-kubectl-on-an-ovh-managed-kubernetes-cluster/).
...
In Public-To-Public mode, the gateway may throttle your LoadBalancers's capacity. To increase the capacity of an OpenStack router, use the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) to modify your gateway with a larger size.
...
See the guide: [How set a GatewayIP on an OpenStack Subnet](/guides/public-cloud/public-cloud-network-services/configuration-04-update-subnet/).
...
- [OVHcloud Load Balancer concepts](/guides/public-cloud/public-cloud-network-services/concepts-03-loadbalancer/)
- [How to monitor your Public Cloud Load Balancer with Prometheus](/guides/public-cloud/public-cloud-network-services/technical-resources-02-octavia-monitoring-prometheus/)
