...
|----------|----------|---------------|
| **File Storage** (Public Cloud) | NFS | [File Storage documentation](/guides/storage-and-backup/file-storage/overview/) |
| **Enterprise File Storage** | NFS | [EFS with MKS](/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-multi-attach-persistent-volumes-with-ovh-efs/) |
| **NAS-HA** | NFS | [NAS-HA with MKS](/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-multi-attach-persistent-volumes-with-ovh-nas-ha/) |
| **Cloud Disk Array** | CephFS | [CDA with MKS](/guides/public-cloud/containers-orchestration/managed-kubernetes/configuring-multi-attach-persistent-volumes-with-ovh-cloud-disk-array/) |
...
For the complete version matrix, see [Kubernetes Plugins & Software versions](/guides/public-cloud/containers-orchestration/managed-kubernetes/software-versions-reserved-resources/).
...
- [Software versions and reserved resources](/guides/public-cloud/containers-orchestration/managed-kubernetes/software-versions-reserved-resources/)
- [Using vRack Private Network](/guides/public-cloud/containers-orchestration/managed-kubernetes/using-vrack/)
- [Persistent Volumes](/guides/public-cloud/containers-orchestration/managed-kubernetes/setting-up-a-persistent-volume/)
- [Expose your applications using Load Balancer](/guides/public-cloud/containers-orchestration/managed-kubernetes/expose-your-applications-using-a-load-balancer/)
