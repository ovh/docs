...
For more information on managing Floating IPs with OpenStack, see the following guide: [Concepts - Additional IP or Floating IP](/guides/public-cloud/public-cloud-network-services/concepts-02-additional-ip-vs-floating-ip/).
...
- [Concepts - Additional IP or Floating IP](/guides/public-cloud/public-cloud-network-services/concepts-02-additional-ip-vs-floating-ip/): Understand the difference between Additional IP and Floating IP.
