...
![Cert Manager](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-cert-manager/cert-manager-logo.png)

It will ensure certificates are valid and up to date periodically, and attempt to renew certificates at an appropriate time before expiry.

![Cert Manager architecture](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-cert-manager/cert-manager-archi.png)
