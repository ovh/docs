...
![Kubernetes Secrets](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/encrypt-secret-with-kubeseal/secrets.jpeg) 
...
![Kubeseal SealedSecret schema](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/encrypt-secret-with-kubeseal/kubeseal-schema.png)
