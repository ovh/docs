...
![Schema](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/setting-up-a-persistent-volume/schema.png)
...
* The [Enterprise Filesystem Service](/guides/public-cloud/containers-orchestration/managed-kubernetes/configure-multi-attach-persistent-volumes-enterprise-file-storage) offers a managed shared filesystem consumed via NFS.
