...
This guide uses some concepts that are specific to our Public Cloud Load Balancer (listener, pool, health monitor, member, ...) and to the OVHcloud Public Cloud Network (Gateway, Floating IP). You can find more information regarding Public Cloud Network concepts in our official documentation, for example [networking concepts](/guides/public-cloud/public-cloud-network-services/concepts) and [loadbalancer concepts](/guides/public-cloud/public-cloud-network-services/concepts).

## Requirements

### Kubernetes version <a id="kube-versions"></a>
...
The first step is to make sure that you have an existing vRack on your Public Cloud Project. To do so you can follow this guide that explains how to [Configure a vRack for Public Cloud](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack).
...
- **The subnet does not have an IP reserved for a Gateway**, you will have to provide or create a compatible subnet. Three options are available:
    - Edit an existing subnet to reserve an IP for a Gateway : please refer to the [Update a subnet properties](/guides/public-cloud/public-cloud-network-services/update-subnet-properties) documentation.
...
<a id="public-to-public-scenario"></a>
...
- `loadbalancer.openstack.org/flavor-id` (MKS Standard only)
  ...
  The UUID of the flavor used to create the loadbalancer. To get the flavors UUIDs, see the following guides:
    - [Prepare the environment to use the OpenStack API](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment);
    - [Load the OpenStack environment variables](/guides/public-cloud/public-cloud-cross-functional/compute-set-openstack-environment-variables).
...
See the guide: [How set a GatewayIP on an OpenStack Subnet](/guides/public-cloud/public-cloud-network-services/update-subnet-properties).
...
- [OVHcloud Load Balancer concepts](/guides/public-cloud/public-cloud-network-services/load-balancer-concepts)
- [How to monitor your Public Cloud Load Balancer with Prometheus](/guides/public-cloud/public-cloud-network-services/loadbalancer-monitoring-prometheus)
