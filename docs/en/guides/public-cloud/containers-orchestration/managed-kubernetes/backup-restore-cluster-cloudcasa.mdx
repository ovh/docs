...
![Dashboard CloudCasa](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-using-cloudcasa/step1.a.Dashboard.png)
...
![Cluster overview](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-using-cloudcasa/step1.b.Cluster.overview.png)

Provide the cluster name and description, then click on the `Save` button.

![Add a cluster](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-using-cloudcasa/step1.c.Add.Cluster.png)

This will display a kubectl command to run to install the CloudCasa agent. 

![Kubectl](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-using-cloudcasa/step1.c.Kubectl.png)
...
![Cluster active](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-using-cloudcasa/step1.d.Cluster.Active.png)
...
![Date from pods](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-using-cloudcasa/step2.c.Date.png)
...
![Add policy](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-using-cloudcasa/step4.a.Add.Policy.png)
...
![Add backup](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-using-cloudcasa/step5.b.Add.Backup.png)
...
![Run now](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-using-cloudcasa/step5.e.Run.Now.png)
...
![Recovery points](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-using-cloudcasa/step6.c.Recovery.Points.png)
...
![Select resources](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-using-cloudcasa/step6.d.Select.png)
...
![Destination cluster](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-using-cloudcasa/step6.i.Select.Destination.png)
...
![Activity Details](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-using-cloudcasa/step6.i.Activity.Details.png)

![Activity Logs](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-using-cloudcasa/step6.i.Activity.Logs.png)

Confirm the application is back up and running.

![Confirm back](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-using-cloudcasa/step6.j.Confirm.Back.png)
...
![Date](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-and-restore-cluster-using-cloudcasa/step6.k.Date.png)
