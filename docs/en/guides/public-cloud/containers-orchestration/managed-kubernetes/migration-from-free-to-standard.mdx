...
For a complete overview, including a detailed comparison table between Free and Standard, please refer to the **Free vs Standard comparison** part of our guide [Choosing the right OVHcloud Managed Kubernetes Plan: Free or Standard](/guides/public-cloud/containers-orchestration/managed-kubernetes/mks-plans) guide. The table in that guide provides a clear side-by-side comparison of key features.
...
- For Velero, follow our guide [here](/guides/public-cloud/containers-orchestration/managed-kubernetes/backing-up-cluster-velero).
- For Trilio, follow our guide [here](/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-restore-cluster-trilio).
- For CloudCasa, follow our guide [here](/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-restore-cluster-cloudcasa).
...
![Create a cluster](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/migration-from-free-to-standard/creating-a-cluster1.png)
...
Install the Velero Helm chart on your newly created OVHcloud Kubernetes cluster by following the **Installing Velero** part of [this guide](/guides/public-cloud/containers-orchestration/managed-kubernetes/backing-up-cluster-velero/).
...
Follow the **Restoring mysql-qa Helm Release Backup** part in step 4 of [our guide](/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-restore-cluster-trilio).

</Tab>
<Tab label="Via CloudCasa">

Follow the **step 6 - Run a restore operation for the dummy application** of [this guide](/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-restore-cluster-cloudcasa).
...
Explore the option of [OVHcloud Saving Plans](/guides/public-cloud/public-cloud-cross-functional/savings-plans) to optimize your cloud costs. Learn more about the available Saving Plans to determine if they align with your financial strategy.
