...
If you run a Managed Kubernetes Service using an older version we strongly encourage you to use the [version upgrade feature](/guides/public-cloud/containers-orchestration/managed-kubernetes/upgrading-kubernetes-version/) to receive official support for your cluster.
