...
![Agones on OVHcloud Managed Kubernetes](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-agones/agones-001-small.jpg)
...
![Online gaming matchmaking and game server assignation](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-agones/agones-002-small.jpg)
...
![Online gaming matchmaking and game server assignation with Agones](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-agones/agones-003-small.jpg)
...
![Xonotic](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-agones/agones-004.png)

Then go to the <em>Multiplayer</em> menu and enter the address and port of our game server:

![Multiplayer menu](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-agones/agones-005.png)

And you are ready to play!

![Let's frag](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-agones/agones-006.png)
