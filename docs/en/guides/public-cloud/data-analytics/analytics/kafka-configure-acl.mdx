...
- A [Kafka cluster running](/guides/public-cloud/public-cloud-databases/kafka-02-getting-started) on OVHcloud Public Cloud [accepting incoming connections](/guides/public-cloud/public-cloud-databases/kafka-01-capabilities) with at least one [topic](/guides/public-cloud/data-analytics/analytics/kafka-create-topics)
