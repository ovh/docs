...
As part of using your Analytics service efficiently, you should keep an eye on the service metrics. You can access those in the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) or using the [API](/guides/manage-and-operate/api/first-steps/). You can also make use of [cross-service integrations](/guides/public-cloud/public-cloud-databases/databases-07-cross-service-integration/) to gather, observe and alert based on services metrics.
