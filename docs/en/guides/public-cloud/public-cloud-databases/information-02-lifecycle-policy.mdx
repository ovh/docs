...
description: Lifecycle policy for Public Cloud Databases engines
...
MongoDB EOL will coincide with the official MongoDB Lifecycle schedule : [https://www.mongodb.com/support-policy/lifecycles](https://www.mongodb.com/support-policy/lifecycles).

### MySQL

MySQL EOL will coincide with the official MySQL Lifecycle schedule for linux : [https://www.mysql.com/fr/support/supportedplatforms/database.html](https://www.mysql.com/fr/support/supportedplatforms/database.html)

### PostgreSQL

PostgreSQL EOL will coincide with the official PostgreSQL versioning policy : [https://www.postgresql.org/support/versioning/](https://www.postgresql.org/support/versioning/)

### Valkey

Valkey EOL will coincide with the official Valkey Community Releases policy : [https://valkey.io/topics/releases](https://valkey.io/topics/releases)
