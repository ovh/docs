...
![vrack schema](/images/guides/public-cloud/public-cloud-databases/databases-08-vrack/redis_tuto_02_vrack-20220829155628651.png)
...
The first step is to create the virtual network that will be used in your vRack. To proceed, consult this [guide](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack).

### Step 2 - Creating a Public Cloud Database connected to the private network

Follow this [guide](/guides/public-cloud/public-cloud-databases/public-cloud-databases-getting-started) to create a new Public Cloud Database.

> [!info]
>
> Choose the plan that best fits your needs. The use of private networking with databases is available with all plans.
>
> ![Choose plan](/images/guides/public-cloud/public-cloud-databases/databases-08-vrack/databases_01_order_control_panel-2022072719143198.png)
>
...
>
> ![Configure options](/images/guides/public-cloud/public-cloud-databases/databases-08-vrack/redis_08_vrack_12.png)
>
...
>
> ![Add virtual network subnet](/images/guides/public-cloud/public-cloud-databases/databases-08-vrack/redis_08_vrack_19.png)
>
...
Follow this [guide](/guides/public-cloud/compute/compute-getting-started) to create a new Public Cloud Instance

> [!info]
>
> At the fourth step, select the desired virtual network **XXXX - my-private-network**.
>
> ![Configure the instance](/images/guides/public-cloud/public-cloud-databases/databases-08-vrack/redis_08_vrack_24.png)
>

> [!info]
>
> If you want to test the access from an existing instance, read this tutorial to connect it to the vRack: [Configuring vRack for Public Cloud](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack#in-case-of-an-existing-instance).
>

### Step 5 - Example of verification with a Public Cloud Databases for Valkey

We assume that you have an already set SSH key on your project. For more details, read the [Creating and connecting to your first Public Cloud instance](/guides/public-cloud/compute/compute-getting-started) page.
