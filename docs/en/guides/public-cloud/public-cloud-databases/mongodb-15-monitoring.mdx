...
- An OVHcloud managed MongoDB service. If you do not have one, please refer to the following guide: [Getting started with Public Cloud Databases](/guides/public-cloud/public-cloud-databases/databases-01-order-control-panel/).
- An account you can use to log in to MongoDB. If you do not have one, please refer to the following guide: [Configure your MongoDB instance to accept incoming connections](/guides/public-cloud/public-cloud-databases/mongodb-02-manage-control-panel/).
...
You can use the main metrics and statistics in the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) to track and manage your database instance.
...
<img className="thumbnail" alt="Monitoring - Conrol Panel" src="/images/public-cloud/public-cloud-databases/mongodb-15-monitoring/monitoring01.png" loading="lazy" />
...
<img className="thumbnail" alt="Monitoring - Compass" src="/images/public-cloud/public-cloud-databases/mongodb-15-monitoring/monitoring02.png" loading="lazy" />
