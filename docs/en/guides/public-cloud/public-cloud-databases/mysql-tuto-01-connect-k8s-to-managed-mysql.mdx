...
You need to have [Helm](https://docs.helm.sh/) installed on your workstation and your cluster. Please refer to the [How to install Helm on OVHcloud Managed Kubernetes Service](/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-helm/) tutorial.

Finally, you need to be able to order a database solution in the OVHcloud Control Panel, as explained in our [Getting started with Public Cloud Databases](/guides/public-cloud/public-cloud-databases/databases-01-order-control-panel/) guide.
...
<img className="thumbnail" alt="Choose MySQL database" src="/images/public-cloud/public-cloud-databases/mysql-tuto-01-connect-k8s-to-managed-mysql/connect-kubernetes-to-managed-mysql01.png" loading="lazy" />

#### Step 2: Select a solution

In this step, choose an appropriate service plan. You will be able to upgrade the plan after creation.

<img className="thumbnail" alt="Choose plan" src="/images/public-cloud/public-cloud-databases/mysql-tuto-01-connect-k8s-to-managed-mysql/connect-kubernetes-to-managed-mysql02.png" loading="lazy" />

Please visit the [capabilities page](/guides/public-cloud/public-cloud-databases/mysql-01-capabilities/) for detailed information on each plan's properties.
...
<img className="thumbnail" alt="Choose region" src="/images/public-cloud/public-cloud-databases/mysql-tuto-01-connect-k8s-to-managed-mysql/connect-kubernetes-to-managed-mysql03.png" loading="lazy" />
...
<img className="thumbnail" alt="Order nodes" src="/images/public-cloud/public-cloud-databases/mysql-tuto-01-connect-k8s-to-managed-mysql/connect-kubernetes-to-managed-mysql04.png" loading="lazy" />

Please visit the [capabilities page](/guides/public-cloud/public-cloud-databases/mysql-01-capabilities/) for detailed information on the hardware resources and other properties of the MySQL database installation.
...
<img className="thumbnail" alt="Configure options" src="/images/public-cloud/public-cloud-databases/mysql-tuto-01-connect-k8s-to-managed-mysql/connect-kubernetes-to-managed-mysql05.png" loading="lazy" />
...
<img className="thumbnail" alt="Confirm order" src="/images/public-cloud/public-cloud-databases/mysql-tuto-01-connect-k8s-to-managed-mysql/connect-kubernetes-to-managed-mysql06.png" loading="lazy" />
...
<img className="thumbnail" alt="Green statuses on Database Control Panel" src="/images/public-cloud/public-cloud-databases/mysql-tuto-01-connect-k8s-to-managed-mysql/connect-kubernetes-to-managed-mysql08.png" loading="lazy" />
...
<img className="thumbnail" alt="Nodes IPs list on Instances Control Panel" src="/images/public-cloud/public-cloud-databases/mysql-tuto-01-connect-k8s-to-managed-mysql/connect-kubernetes-to-managed-mysql09.png" loading="lazy" />

Following the related documentation on how to [authorise the suitable IP addresses](/guides/public-cloud/public-cloud-databases/mongodb-02-manage-control-panel#configuring-authorised-ips/), add your Kubernetes cluster node IPs to the authorised list.

<img className="thumbnail" alt="Green statuses and authorized IPs setted on Database Control Panel" src="/images/public-cloud/public-cloud-databases/mysql-tuto-01-connect-k8s-to-managed-mysql/connect-kubernetes-to-managed-mysql10.png" loading="lazy" />
...
<img className="thumbnail" alt="Password reseted" src="/images/public-cloud/public-cloud-databases/mysql-tuto-01-connect-k8s-to-managed-mysql/connect-kubernetes-to-managed-mysql11.png" loading="lazy" />
...
As described in the [Installing WordPress on OVHcloud Managed Kubernetes](/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-wordpress#installing-the-wordpress-helm-chart/) tutorial, remove the default storage class and install the new one.
...
<img className="thumbnail" alt="WordPress login screen" src="/images/public-cloud/public-cloud-databases/mysql-tuto-01-connect-k8s-to-managed-mysql/connect-kubernetes-to-managed-mysql12.png" loading="lazy" />
...
<img className="thumbnail" alt="WordPress admin dashboard" src="/images/public-cloud/public-cloud-databases/mysql-tuto-01-connect-k8s-to-managed-mysql/connect-kubernetes-to-managed-mysql13.png" loading="lazy" />
