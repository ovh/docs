...
<img className="thumbnail" alt="User ready" src="/images/public-cloud/public-cloud-databases/postgresql-tuto-02-connect-wagtail-to-managed-postgresql/user_enabled.png" loading="lazy" />
...
<img className="thumbnail" alt="Add an IP" src="/images/public-cloud/public-cloud-databases/postgresql-tuto-02-connect-wagtail-to-managed-postgresql/ip_authorize.png" loading="lazy" />
...
The useful parameters, available in the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) are:
...
<img className="thumbnail" alt="Password reseted" src="/images/public-cloud/public-cloud-databases/postgresql-tuto-02-connect-wagtail-to-managed-postgresql/postgresql_tuto_02_connect_wagtail_to_managed_postgresql-2022040814593090.png" loading="lazy" />
...
<img className="thumbnail" alt="Wagtail welcome page" src="/images/public-cloud/public-cloud-databases/postgresql-tuto-02-connect-wagtail-to-managed-postgresql/postgresql_tuto_02_connect_wagtail_to_managed_postgresql-2022021414341293.png" loading="lazy" />

You can now access the administrative area at `http://127.0.0.1:8000/admin`:

![Wagtail admin page](/images/public-cloud/public-cloud-databases/postgresql-tuto-02-connect-wagtail-to-managed-postgresql/postgresql_tuto_02_connect_wagtail_to_managed_postgresql-20220215093836579.png)
...
<img className="thumbnail" alt="delete service menu" src="/images/public-cloud/public-cloud-databases/postgresql-tuto-02-connect-wagtail-to-managed-postgresql/postgresql-tuto-01-connect-strapi-to-managed-postgresql15.png" loading="lazy" />
