...
3. Create a new database instance based on your network requirements. Follow [this guide](/guides/public-cloud/public-cloud-databases/databases-01-order-control-panel/).
