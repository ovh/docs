...
![Overview](/images/guides/public-cloud/ai-machine-learning/deploy-tuto-09-streamlit-speech-to-text-app/speech-to-text.png)
...
![Overview](/images/guides/public-cloud/ai-machine-learning/deploy-tuto-09-streamlit-speech-to-text-app/speech-to-text-app-overview.png)
...
- [The OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client) **and** [Docker](https://www.docker.com/get-started) installed on your local computer, **or** only an access to a Debian Docker Instance on the [Public Cloud](/links/manager).
