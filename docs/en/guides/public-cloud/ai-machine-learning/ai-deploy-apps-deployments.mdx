...
![Set static scaling on AI Deploy via UI](/images/guides/public-cloud/ai-machine-learning/deploy-guide-04-scaling-strategies/set-static-scaling.png)
...
![Set autoscaling on AI Deploy via UI](/images/guides/public-cloud/ai-machine-learning/deploy-guide-04-scaling-strategies/set-autoscaling.png)
...
![Enable custom autoscaling on AI Deploy via UI](/images/guides/public-cloud/ai-machine-learning/deploy-guide-04-scaling-strategies/set-custom-autoscaling.png)
...
![image](/images/guides/public-cloud/ai-machine-learning/deploy-guide-04-scaling-strategies/update-autoscaling-1.png)

In this window, click the `Edit` button to access scaling configuration options. This will open an **Update application scaling** window where you can:
- Switch between auto scaling and static scaling
- Change replica values
- Modify monitored metric and associated values

![Update application scaling step 2](/images/guides/public-cloud/ai-machine-learning/deploy-guide-04-scaling-strategies/update-autoscaling-2.png)
