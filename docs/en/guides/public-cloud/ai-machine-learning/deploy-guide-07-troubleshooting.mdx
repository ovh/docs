...
All steps for starting and working on AI Deploy are described [here](/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/).
...
When you are deploying your own applications and models, some guidelines must be followed. We detail them in the guide [AI Deploy - Build & use custom Docker image](/guides/public-cloud/ai-machine-learning/deploy-tuto-12-build-custom-image/).
...
If you need some official examples, please follow this guide where we share the source code: [AI Deploy - Apps portfolio](/guides/public-cloud/ai-machine-learning/deploy-guide-05-app-portfolio/).
...
- Your Docker image is not following mandatory guidelines, such as OVHcloud user. See [AI Deploy - Build & use custom Docker image](/guides/public-cloud/ai-machine-learning/deploy-tuto-12-build-custom-image/).
...
Find more information on the official documentation about [scaling strategies](/guides/public-cloud/ai-machine-learning/deploy-guide-04-scaling-strategies/).
...
- Refer to the following load-testing tutorial which also provides a dashboard example to follow your scaling: [AI Deploy - How to load test your application with Locust](/guides/public-cloud/ai-machine-learning/deploy-tuto-10-locust/).
...
AI Deploy does not synchronize back your remote data. Please follow [official guidelines to build & use custom Docker image](/guides/public-cloud/ai-machine-learning/deploy-tuto-12-build-custom-image/).

### Is it possible to update the image used by my app?

To make your app use the updated version of a Docker image, follow [this guide](/guides/public-cloud/ai-machine-learning/deploy-guide-08-update-custom-docker-image/).
...
Depending on what you deployed, you then just have a REST endpoint or a Web interface. You can refer to our [Getting Started guide](/guides/public-cloud/ai-machine-learning/deploy-guide-02-getting-started/) for full explanations.
...
If you selected a restricted access, don't forget to [generate an applicative token](/guides/public-cloud/ai-machine-learning/deploy-guide-03-tokens/). 
...
Also, for more detailed information, please refer to our [AI Deploy - Billing and lifecycle](/guides/public-cloud/ai-machine-learning/deploy-guide-06-billing-concept/) page.
