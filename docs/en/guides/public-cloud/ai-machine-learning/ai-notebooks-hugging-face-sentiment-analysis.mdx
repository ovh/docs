...
![Hugging Face](/images/guides/public-cloud/ai-machine-learning/notebook-tuto-05-hugging-face-sentiment-analysis/hugging_face_doc.png)
...
If you want to upload it from the [OVHcloud Control Panel](/links/manager), go to the Object Storage section and create a new object container by clicking `Object Storage` > `Create an object container`.

![image](/images/guides/public-cloud/ai-machine-learning/deploy-tuto-17-streamlit-whisper/new-object-container.png)
...
![camemBERT_results](/images/guides/public-cloud/ai-machine-learning/notebook-tuto-05-hugging-face-sentiment-analysis/results-camembert.png)
...
![BARThez_results](/images/guides/public-cloud/ai-machine-learning/notebook-tuto-05-hugging-face-sentiment-analysis/results-barthez.png)
...
![BERT_results](/images/guides/public-cloud/ai-machine-learning/notebook-tuto-05-hugging-face-sentiment-analysis/results-bert.png)
...
![BARThez_matrix](/images/guides/public-cloud/ai-machine-learning/notebook-tuto-05-hugging-face-sentiment-analysis/confusion-matrix-barthez.png)

Success rate: **87.02 %**

#### Confusion matrix - CamemBERT x reel sentiments

![CamemBERT_matrix](/images/guides/public-cloud/ai-machine-learning/notebook-tuto-05-hugging-face-sentiment-analysis/confusion-matrix-camembert.png)
