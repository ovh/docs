...
This guide explains how to get started with OVHcloud AI Deploy, covering the deployment of your first application using either the Control Panel (UI) or the [ovhai Command-Line Interface](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/).
...
Click [this link](https://manager.eu.ovhcloud.com/#/pci/projects) to access your Public Cloud project, then go to the <code className="action">AI & Machine Learning</code> category in the left menu and choose <code className="action">AI Deploy</code>.
...
:::info
OVHcloud provides multiple datacenters. You can find the capabilities for AI Deploy in the guide [AI Deploy capabilities](/guides/public-cloud/ai-machine-learning/deploy-guide-01-capabilities/).
...
:::info
If you want to deploy your own image, you need to comply with a few rules like adding a specific user. Follow our [Build and use custom images](/guides/public-cloud/ai-machine-learning/training-tuto-02-build-custom-image/) guide. You might also be interested in [Using and managing your public and private registries](/guides/public-cloud/ai-machine-learning/gi-07-manage-registry/).
...
For more detailed information about scaling strategies, please refer to our dedicated guide: [AI Deploy - Scaling strategies](/guides/public-cloud/ai-machine-learning/deploy-guide-04-scaling-strategies/).
...
To learn more about data, volumes and permissions, check out the [data page](/guides/public-cloud/ai-machine-learning/gi-02-concepts-data/).
...
Learn more about this feature in the [dedicated tutorial](/guides/public-cloud/ai-machine-learning/deploy-guide-03-tokens/).
...
You can also generate the equivalent `ovhai` CLI command, which enables you to deploy the same application using the command line interface. This CLI can be downloaded [here](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/). For more information, consult the [CLI - Launch an AI Deploy app](/guides/public-cloud/ai-machine-learning/cli-18-howto-deploy-app/) documentation.
...
<Tabs>
  <Tab label="Using the Control Panel (UI)">
    Click [this link](https://manager.eu.ovhcloud.com/#/pci/projects) to access your Public Cloud project, then select the <code className="action">AI Deploy</code> section. Locate the specific AI Deploy app you want to stop. Click the <code className="action">...</code> button and stop your AI Deploy application by selecting <code className="action">Stop</code> from the context menu.
...
- You can imagine deploying an AI model for sketch recognition thanks to **AI Deploy**. Refer to this [tutorial](/guides/public-cloud/ai-machine-learning/deploy-tuto-05-gradio-sketch-recognition/).
- Do you want to use **Streamlit** in order to create an app? [Here it is](/guides/public-cloud/ai-machine-learning/deploy-tuto-02-flask/).
