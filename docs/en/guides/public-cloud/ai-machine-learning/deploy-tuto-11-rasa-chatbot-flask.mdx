...
In a previous tutorial, we created and trained a Rasa Chatbot with AI Notebooks: [How to create and train a chatbot on OVHcloud](/guides/public-cloud/ai-machine-learning/notebook-tuto-10-create-chatbot/).
