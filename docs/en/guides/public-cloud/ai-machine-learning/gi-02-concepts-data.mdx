...
- You can upload and download data from your local environment using the CLI, see [how to install `ovhai` CLI](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/). Next, find out how to [manage your data with the CLI](/guides/public-cloud/ai-machine-learning/cli-16-commands-reference-data/).
- You can use the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), see [create data container](/guides/storage-and-backup/object-storage/pcs-create-container/).
...
This applies to your internal [/workspace](/guides/public-cloud/ai-machine-learning/notebook-guide-workspace/) and remote object storage volumes.
...
- You can check how to [use your data in an AI Notebook](/guides/public-cloud/ai-machine-learning/cli-17-how-to-cli-data-notebooks/).

- You can check how to [launch an AI Training job with attached volumes](/guides/public-cloud/ai-machine-learning/cli-12-howto-run-job-cli/).
