...
### Create and train a chatbot with a Visual Studio Code notebook <a id="visualstudiocode"></a>
...
![image](/images/guides/public-cloud/ai-machine-learning/notebook-tuto-10-create-chatbot/conversation.png)
