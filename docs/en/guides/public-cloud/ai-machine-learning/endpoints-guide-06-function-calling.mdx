...
:::info
To obtain an API access key for authenticated access, please follow the instructions given in the [AI Endpoints - Getting Started](/guides/public-cloud/ai-machine-learning/endpoints-guide-01-getting-started/) guide. Otherwise, you will be rate limited.
...
:::info
To obtain an API access token for authenticated access, please follow the instructions given in the [AI Endpoints - Getting Started](/guides/public-cloud/ai-machine-learning/endpoints-guide-01-getting-started/) guide.
