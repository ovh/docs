...
- Access to the [OVHcloud Control Panel](/links/manager) or [the OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client) installed on your computer
...
From there, you will access a table listing your instances, where you can find the one you need and its general information. To view your instance details, click either the instance name or the `...` button and then `Manage`.

![image](/images/guides/public-cloud/ai-machine-learning/gi-11-concepts-resources/00_access_tool_details.png)

From there, you can click on the `Grafana Dashboard` button, under `Usage monitoring`, to access your monitoring Grafana UI.

![image](/images/guides/public-cloud/ai-machine-learning/gi-11-concepts-resources/01_access_grafana_ui.png)
...
![image](/images/guides/public-cloud/ai-machine-learning/gi-11-concepts-resources/02_resource_dashboard.png)
