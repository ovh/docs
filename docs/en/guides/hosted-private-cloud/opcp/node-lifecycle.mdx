...
description: Discover the lifecycle of an OPCP node and its different statuses
...
<img className="thumbnail" alt="dashboard" src="/images/hosted-private-cloud/opcp/node-lifecycle/01-log-to-horizon.png" loading="lazy" />
...
<img className="thumbnail" alt="server-status" src="/images/hosted-private-cloud/opcp/node-lifecycle/02-server-status.png" loading="lazy" />
...
<img className="thumbnail" alt="node-lifecyle" src="/images/hosted-private-cloud/opcp/node-lifecycle/03-node-lifecycle.png" loading="lazy" />
...
<img className="thumbnail" alt="server-manageable" src="/images/hosted-private-cloud/opcp/node-lifecycle/03-server-status-to-manageable.png" loading="lazy" />
...
<img className="thumbnail" alt="server-available" src="/images/hosted-private-cloud/opcp/node-lifecycle/03-server-status-to-available.png" loading="lazy" />
...
<img className="thumbnail" alt="Maintenance-on" src="/images/hosted-private-cloud/opcp/node-lifecycle/04-server-to-maintenance-on.png" loading="lazy" />
...
<img className="thumbnail" alt="Maintenance-reason" src="/images/hosted-private-cloud/opcp/node-lifecycle/04-server-to-maintenance-reason.png" loading="lazy" />

Once your maintenance operations are complete, you can disable maintenance:

<img className="thumbnail" alt="Maintenance-off" src="/images/hosted-private-cloud/opcp/node-lifecycle/04-server-to-maintenance-off.png" loading="lazy" />
