...
![schema](/images/guides/hosted-private-cloud/sap-on-ovhcloud/concept-dedicated-server-and-hpc/concept-hybrid.png)
...
Instead of using OVHcloud Connect, a point-to-point VPN can also be deployed with NSX. To learn how to configure an NSX Gateway VPN with OVHcloud, please refer to [our documentation](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/nsx-configurer-un-vpn-via-une-gateway-edge).
...
To know how to enable this feature, please refer to the [OVHcloud documentation](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-vmware-vsphere-drp).
...
- [Setting up Zerto Virtual Replication between two OVHcloud datacenters](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-vmware-vsphere-drp)
