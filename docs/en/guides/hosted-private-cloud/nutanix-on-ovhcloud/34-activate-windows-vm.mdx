...
- A virtual machine running Windows Server. You can use this guide to install a virtual machine on Windows: [Virtual Machine Management](/guides/hosted-private-cloud/nutanix-on-ovhcloud/06-virtual-machine-management/)
