...
description: Presentation of the included licences in the Nutanix on OVHcloud packaged service
...
<img className="thumbnail" alt="Summary licences" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/02-available-services/recap.png" loading="lazy" />
