...
<img className="thumbnail" alt="Function DRS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs0.png" loading="lazy" />
...
<img className="thumbnail" alt="Activation DRS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs01.png" loading="lazy" />
...
<img className="thumbnail" alt="Automation DRS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs02.png" loading="lazy" />
...
<img className="thumbnail" alt="Additional Options" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs03.png" loading="lazy" />
...
<img className="thumbnail" alt="Advanced Options" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs05.png" loading="lazy" />

### DRS rules

In the <code className="action">Configure</code> tab you can find the management of `VM/Host Rules`.

<img className="thumbnail" alt="DRS rules" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs06.png" loading="lazy" />
...
<img className="thumbnail" alt="DRS rules" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs07.png" loading="lazy" />
