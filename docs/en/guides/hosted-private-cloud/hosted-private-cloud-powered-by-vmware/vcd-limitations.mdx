...
- [Public VCF as-a-Service - Fundamental Concepts](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-get-concepts/)
- [Public VCF as-a-Service - Network Concepts](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-concepts/)
- [Creating a VM on Public VCF as-a-Service](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-first-vm-creation/)
- [Creating network components via Public VCF as-a-Service](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-network-creation/)
...
With Public VCF as-a-Service, you cannot use a backup tool other than our managed Veeam for VCD tool. Refer to the following guide for more information: [Public VCF as-a-Service - Backups with Veeam Data Platform](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vcd-backup/).
