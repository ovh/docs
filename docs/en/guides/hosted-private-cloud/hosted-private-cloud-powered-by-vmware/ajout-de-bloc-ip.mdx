...
:::info
Please feel free to refer to our guide on the [OVHcloud Network plugin](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/plugin-ovh-network/) to find out which IPs are reserved for your block, as well as how they are used.
...
<img className="thumbnail" alt="nexthop field" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ajout-de-bloc-ip/move-api.png" loading="lazy" />

The result should look like this:

<img className="thumbnail" alt="nexthop field" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ajout-de-bloc-ip/api-result.png" loading="lazy" />
...
You can track the movement of your IP block via the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) in the <code className="action">Hosted Private Cloud</code> section, then <code className="action">Private Cloud</code>. Click on your Hosted Private Cloud service, then on the <code className="action">Operations</code> tab.
