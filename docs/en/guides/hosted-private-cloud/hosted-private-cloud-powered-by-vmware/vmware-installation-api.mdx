...
This example uses a VM installed with Debian 9, deployed from [templates available for your Hosted Private Cloud infrastructure](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ovf-template/).
...
This example uses a VM installed with Ubuntu 18.04, deployed from [templates available for your Hosted Private Cloud infrastructure](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ovf-template/).
