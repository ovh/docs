...
<img className="thumbnail" alt="installer VMware Tools" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-tools-install/tools.png" loading="lazy" />
