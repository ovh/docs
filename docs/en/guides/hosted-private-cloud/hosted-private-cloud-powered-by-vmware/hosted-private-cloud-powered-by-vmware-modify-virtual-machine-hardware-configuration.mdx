...
All the modifications described below must be made from your Private Cloud on vSphere by right-clicking on a VM, then on `Edit Settings`.

![Editing resources](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware01.png)

In this menu, you can increase your virtual machine's resources.

![Editing resources](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware02.png)
...
![Add a CPU](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware03.png)

You can also set a specific frequency (minimum and maximum) and choose the number of cores per socket.

If you tick the `Enable CPU Hot Add` box, you can modify these values while the virtual machine is running.
...
![Add memory](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware04.png)

### The hard disk

You can increase the hard disk size according to the space left in the datastore used by the virtual machine.

![Add storage](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware05.png)
...
![Add network](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware06.png)
...
![Add a CD/DVD reader](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware07.png)
...
![Add devices](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware08.png)
