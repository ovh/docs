...
:::info
Should you choose to migrate an infrastructure to a new vDC instead, please follow [this dedicated guide](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/service-migration-vdc/).
...
- access to the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) (<code className="action">Private Cloud</code> in the <code className="action">Hosted Private Cloud</code> section)
...
Please refer to our guide on [Enabling Virtual Machine Encryption](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vm-encrypt/) in order to enable KMS on the destination Hosted Private Cloud.
...
These options must therefore be reactivated on the destination Hosted Private Cloud. To do this, please refer to our [guide on activating them](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/activer-l-option-hds-hipaa-ou-pci-dss/).
...
As part of a migration process, you can link your PCC services within the same vRack. Please consult our guide to [Using Private Cloud within a vRack](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/using-private-cloud-in-vrack/).
...
Please consult our guide to [Migrate an IP block between two Hosted Private Cloud services](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ajout-de-bloc-ip#migrate-an-ip-block-between-two-hosted-private-cloud-solutions/).
...
The migration involves reconfiguring VMware High Availability (HA), including boot order and priority. Please consult our guide about [VMware HA configuration](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/).
...
Please refer to our guide on [activating and using Veeam Managed Backup](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/veeam-backup-as-a-service/).
...
- [Authorising the Veeam Backup & Replication virtual machine to connect](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/autoriser-des-ip-a-se-connecter-au-vcenter/) to the source and destination vCenter
