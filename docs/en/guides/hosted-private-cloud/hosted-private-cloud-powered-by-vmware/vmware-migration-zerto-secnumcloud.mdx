...
[Move2Cloud - Migrate VMware workloads to OVHcloud Hosted Private Cloud with Zerto](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-migration-zerto/).
...
1. Open a support ticket from the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB).
2. Select your <code className="action">Hosted Private Cloud</code>.
3. Provide the list of source IPs that require access.

For step-by-step instructions, refer to [Authorize IPs to connect to vCenter](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/autoriser-des-ip-a-se-connecter-au-vcenter/).
...
[Enabling secure access to the vSphere interface](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/)
...
Full details: [Zerto Virtual Replication on OVHcloud](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-customer-to-ovhcloud/)
...
Details and parameters are available in [Zerto VPN Setup on OVHcloud](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/zerto-virtual-replication-customer-to-ovhcloud/).
...
See [VMware Storage vMotion](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-storage-vmotion/) for full details.
