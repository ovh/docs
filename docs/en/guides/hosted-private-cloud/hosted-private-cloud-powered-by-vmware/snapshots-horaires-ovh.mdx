...
<img className="thumbnail" alt="data store" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/snapshots-horaires-ovh/snapshot01.png" loading="lazy" />

Create a folder to which you will later copy the files to restore.

<img className="thumbnail" alt="destination folder" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/snapshots-horaires-ovh/snapshot02.png" loading="lazy" />
...
<img className="thumbnail" alt="copy files" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/snapshots-horaires-ovh/snapshot03.png" loading="lazy" />
...
<img className="thumbnail" alt="register vm" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/snapshots-horaires-ovh/snapshot04.png" loading="lazy" />
...
We recommend using a full backup solution, such as our [Veeam Managed Backup](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/veeam-backup-as-a-service/) service, or any other system that performs a full backup of your virtual machines.
