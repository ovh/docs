...
<img className="thumbnail" alt="First SMS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/SMS1.png" loading="lazy" />
...
- the operation ID
- validation token
- a link to validate the operation (please note, if your phone is not connected to a network whose [IP is authorised](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/manager-ovh-private-cloud#security-tab/), the page will not appear).
...
<img className="thumbnail" alt="Operation Validation" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/operationValidation.png" loading="lazy" />
...
<img className="thumbnail" alt="Operation Token" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/operationIdAndToken.png" loading="lazy" />
...
<img className="thumbnail" alt="Change Password" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/changePassword.png" loading="lazy" />
...
<img className="thumbnail" alt="Define Password" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/defineNewPassword.png" loading="lazy" />
...
<img className="thumbnail" alt="Password Lost" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/passwordLost.png" loading="lazy" />
...
<img className="thumbnail" alt="User Information" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/infoUser.png" loading="lazy" />
...
<img className="thumbnail" alt="Token and Password" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/tokenAndPassword.png" loading="lazy" />
