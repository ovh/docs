...
To order an IP block for your **Hosted Private Cloud**, go to the OVHcloud Control Panel. In the `Hosted Private Cloud` section, click on the `IP` section in the left-hand column, then click `Order additional IP addresses`. Then select your **Hosted Private Cloud** in the dropdown menu before moving on to the next step.
...
![nexthop field](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ajout-de-bloc-ip/move-api.png)

The result should look like this:

![nexthop field](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ajout-de-bloc-ip/api-result.png)
...
You can track the movement of your IP block via the [OVHcloud Control Panel](/links/manager) in the `Hosted Private Cloud` section, then `Private Cloud`. Click on your Hosted Private Cloud service, then on the `Operations` tab.
