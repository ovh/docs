...
<img className="thumbnail" alt="Editing resources" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware01.png" loading="lazy" />

In this menu, you can increase your virtual machine’s resources.

<img className="thumbnail" alt="Editing resources" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware02.png" loading="lazy" />
...
<img className="thumbnail" alt="Add a CPU" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware03.png" loading="lazy" />
...
<img className="thumbnail" alt="Add memory" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware04.png" loading="lazy" />

### The hard disk

You can increase the hard disk size according to the space left in the datastore used by the virtual machine.

<img className="thumbnail" alt="Add storage" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware05.png" loading="lazy" />
...
<img className="thumbnail" alt="Add network" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware06.png" loading="lazy" />
...
<img className="thumbnail" alt="Add a CD/DVD reader" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware07.png" loading="lazy" />
...
<img className="thumbnail" alt="Add devices" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware08.png" loading="lazy" />
