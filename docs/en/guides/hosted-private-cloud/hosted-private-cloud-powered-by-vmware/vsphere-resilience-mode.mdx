...
<img className="thumbnail" alt="vsphere" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vsphere-resilience-mode/resilience_mode.png" loading="lazy" />
