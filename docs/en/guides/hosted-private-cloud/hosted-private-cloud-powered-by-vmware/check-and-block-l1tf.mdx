...
description: Find out how to block the L1TF (L1 Terminal Fault) vulnerability
...
The vCenter update is managed by OVHcloud, however, it is your responsibility to install the patch for ESXi hosts. This is available in the [the Update Manager](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-update-manager/).
