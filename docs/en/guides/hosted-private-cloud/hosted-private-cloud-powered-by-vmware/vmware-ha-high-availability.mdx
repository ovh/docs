...
<img className="thumbnail" alt="" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HA3.png" loading="lazy" />
...
Disabling it is required to perform update operations with [Update Manager](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-update-manager/).

<img className="thumbnail" alt="" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HA.png" loading="lazy" />
...
<img className="thumbnail" alt="" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam1.PNG" loading="lazy" />
...
<img className="thumbnail" alt="" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam2.PNG" loading="lazy" />
...
<img className="thumbnail" alt="" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam3.PNG" loading="lazy" />
...
<img className="thumbnail" alt="" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam4.PNG" loading="lazy" />

##### VM Monitoring

VM monitoring is available after [VMware tools](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-tools-install/) is installed, in case of non-response via the **tools** (heartbeat signals) the virtual machine will be automatically restarted. Advanced configuration is possible for this feature (for example, reboot interval).

<img className="thumbnail" alt="" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam5.PNG" loading="lazy" />
