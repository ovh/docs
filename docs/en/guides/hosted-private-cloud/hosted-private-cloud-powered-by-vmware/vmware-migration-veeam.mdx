...
Move VMs to target storage using [Storage vMotion](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-storage-vmotion/) and configure backup jobs in [OVHcloud Object Storage](https://www.ovhcloud.com/en-gb/public-cloud/object-storage/) to protect your workloads.
