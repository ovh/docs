...
- An a [OVHcloud customer account](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB).
...
- You must have followed the guide [Introduction to Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-introduction-to-ldp/).
...
- [View your logs in a Grafana dashboard](/guides/manage-and-operate/observability/logs-data-platform/visualization-grafana/)
- [Use the "LDP Tail" cli to watch your logs live](/guides/manage-and-operate/observability/logs-data-platform/cli-ldp-tail/)
- [Push logs from Apache to LDP](/guides/manage-and-operate/observability/logs-data-platform/ingestion-apache/)
