...
<img className="thumbnail" alt="Configuration rules for the Gateway Firewall" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/nsx-t-get-logs-by-api/01nsx-t_get_logs_by_api.png" loading="lazy" />

The rule settings are then available. Enable the <code className="action">logging</code> option that should switch to green.

<img className="thumbnail" alt="Activation of logs for the rule" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/nsx-t-get-logs-by-api/02nsx-t_get_logs_by_api.png" loading="lazy" />
...
<img className="thumbnail" alt="infos" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/nsx-t-get-logs-by-api/export-log-bundle.gif" loading="lazy" />
