...
- You must have access to the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) and be technical administrator of the managed VMware vSphere on OVHcloud infrastructure.
