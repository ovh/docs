...
The [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) now includes a new feature, which allows you to:
...
If you bring your own licence (BYOL), you do not need to activate anything in the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB).
...
1. Go to the <code className="action">Hosted Private Cloud</code> section of your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) and click <code className="action">Managed VMware vSphere</code>.
...
:::info
Activating the licence in the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) is only required if you want OVHcloud to provide a Windows SPLA licence for the VM.
...
- **Case 2: You want OVHcloud to licence the VM:**
    - The VM licence must be activated in the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) for it to be billed properly.
