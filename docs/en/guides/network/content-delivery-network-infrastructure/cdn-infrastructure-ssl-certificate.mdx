...
![SSL certificate generation in progress](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/ssl_in_progress.png)
...
![SSL validated](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/ssl_validated.png)

### Add your own certificate.

If you have not added a domain name yet, or if you do not own a certificate, you can use the `Add my certificate` option in your CDN's SSL tab:

![Add an SSL certificate](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/add_ssl.png)

If you already have a Let's Encrypt certificate, then you can use the `Replace with my certificate` option:

![Change an SSL certificate](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/change_ssl.png)
