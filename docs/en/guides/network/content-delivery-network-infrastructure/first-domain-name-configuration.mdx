...
- access to the [OVH Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB)
...
To do this, go to the [OVH Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), click on the <code className="action">Dedicated</code> tab, then go to <code className="action">NAS and CDN</code>.
