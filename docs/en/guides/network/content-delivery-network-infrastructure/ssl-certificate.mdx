...
To ensure that the certificate is generated properly, the subdomain you add will need to point correctly to the CDN. To check that this is the case, please follow the instructions listed in our guide to [Configuring a domain name for the first time](/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/).
...
[Configuring a domain name for the first time](/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/)
