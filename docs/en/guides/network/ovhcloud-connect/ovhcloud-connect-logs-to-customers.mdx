...
- An up-and-running [OVHcloud Connect service](/guides/network/ovhcloud-connect/occ-concepts-overview).
...
Refer to the following documentation: [Logs Data Platform - Visualizing, querying and exploiting your logs](/guides/manage-and-operate/observability/logs-data-platform/overview) for more details about how to use your logs with Logs Data Platform, including how to:
