...
You can find more information about the differences between Floating IP and Additional IP in [this guide](/guides/public-cloud/public-cloud-network-services/concepts-02-additional-ip-vs-floating-ip/).
...
- **Configuration**: IPv4 and IPv6 addresses configuration details, such as address, prefix size, or default gateway, can be found within the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), usually in the <code className="action">Network</code> tab of the given product.
