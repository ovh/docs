...
To enable one of these methods, log in to your [OVHcloud Control Panel](/links/manager). In the `Bare Metal Cloud` section, select your server from `Dedicated Servers` and click on the `IPMI/KVM` tab.

### Open KVM via Java applet <a id="applet-java"></a>
...
In the `Remote KVM` section of the OVHcloud Control Panel, click on `From a Java applet (KVM)`:

![Java KVM Access](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/ipmi-kvm-java-01.png)

Download the file `kvm.jnlp` when you are prompted to do so, and run it:

![Java KVM Opening](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/ipmi-kvm-java-02.png)
...
![Java KVM Overview](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/ipmi-kvm-java-03.png)

You can now manage your server.

### Open KVM via web browser <a id="kvm-browser"></a>

In the `Remote KVM` section of the OVHcloud Control Panel, click on `Via your web browser (KVM)`.

![HTML KVM Access](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/ipmi-kvm-html-01.png)

Activation takes a few seconds. You will receive a message confirming that the IPMI connection is available.

![HTML KVM Opening](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/ipmi-kvm-html-02.png)

Click on `Access the console (KVM)` to open the console in your web browser.

![HTML KVM Overview](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/ipmi-kvm-html-03.png)

### Open SoL via SSH <a id="sol-ssh"></a>

For more details about creating SSH key pairs, see [this page](/guides/bare-metal-cloud/dedicated-servers/dedicated-servers-creating-ssh-keys#create-ssh-key).

In the `Serial over LAN (SoL)` section of the OVHcloud Control Panel, click on `Add SSH key`.

![SSH SoL Access](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/ipmi-sol-sshkey-01.png)
...
![SSH SoL SSH Public Key](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/ipmi-sol-sshkey-02.png)
...
![SSH SoL Opening](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/ipmi-sol-sshkey-03.png)

For more details about using SSH keys to establish an SSH connection, see [this page](/guides/bare-metal-cloud/dedicated-servers/dedicated-servers-creating-ssh-keys#multiplekeys).

### Open SoL via web browser <a id="sol-browser"></a>

Click on `From your browser (SoL)` in the `Serial over LAN (SoL)` section of the OVHcloud Control Panel:

![JavaScript SoL Access](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/ipmi-sol-html-01.png)

> [!info]
>
> If the switch to the popup does not happen automatically, you can still click the `Go to console (SoL)` button.
>

![JavaScript SoL Opening](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/ipmi-sol-html-02.png)

### Test and reboot the IPMI <a id="ipmi-test-reboot"></a>
...
![IPMI Reboot](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/ipmi-reboot.png)
...
To begin, open [IPMI in a Java applet](#applet-java) from the [OVHcloud Control Panel](/links/manager). Then, click `Device` from the menu bar and select `Redirect ISO` from the drop-down menu.
...
To begin, open [IPMI in a Java applet](#applet-java) from the [OVHcloud Control Panel](/links/manager). Then, click `Virtual Media` and select `Virtual Storage`.

![Virtual_Storage](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/virtual_storage.png)
...
![Boot_Menu](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/boot_menu.png)
...
![KVM Install](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/kvm_install01.png)

Click on `Start Media`. This will prepare the ISO for the installation process.

![KVM Install](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/kvm_install02.png)

The file size displayed is not the actual size. This is normal, since the file is not fully uploaded in this step.

![KVM Install](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/kvm_install03.png)

Click on `Power` and select `Reset Server` from the drop-down menu.

![KVM Install](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/kvm_install04.png)

Wait for the boot selection screen to appear and press the appropriate key to enter the boot menu (`F11` in this example).

![KVM Install](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/kvm_install05.png)

In the boot menu, select the optical drive (`UEFI: AMI Virtual CDROM0` in this example) and press `Enter`.

![KVM Install](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/kvm_install06.png)

The ISO file will now be uploaded, then the server will boot from the file.

![KVM Install](/images/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/images/kvm_install07.png)
