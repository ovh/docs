...
With [OVHcloud Dedicated Servers](https://www.ovhcloud.com/en-gb/bare-metal/), you can configure Disks, [hardware RAID](/guides/bare-metal-cloud/dedicated-servers/raid-hard/), Partitions, [software RAID](/guides/bare-metal-cloud/dedicated-servers/raid-soft/), LVM, ZFS, etc. during [OS reinstallation](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server/) from the [OVHcloud API](https://eu.api.ovh.com/) as well as the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB). In this article, we will focus on the [OVHcloud API](https://eu.api.ovh.com/). This will give us more details about the engine that is running in the background in order to create the storage customisation on the dedicated server from the input data passed on to the OVHcloud API.
