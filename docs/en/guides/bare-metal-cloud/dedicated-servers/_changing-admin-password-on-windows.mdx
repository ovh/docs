...
In your [OVHcloud Control Panel](/links/manager), navigate to the `IPMI` tab to open a KVM session.
...
[Using the IPMI with dedicated servers](/guides/bare-metal-cloud/dedicated-servers/dedicated-servers-ipmi)
