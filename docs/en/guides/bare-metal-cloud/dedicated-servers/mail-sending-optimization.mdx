...
To configure the reverse DNS path in the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) please refer to [our dedicated guide](/guides/bare-metal-cloud/virtual-private-servers/configuring-reverse-dns/).
