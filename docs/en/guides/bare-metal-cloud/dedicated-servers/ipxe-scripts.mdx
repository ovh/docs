...
In the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), it is possible to specify a boot mode among a predefined list: primary disk or rescue.<br/>
...
You can now switch back to disk or rescue boot from the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) (see our guide on [Activating and using rescue mode](/guides/bare-metal-cloud/dedicated-servers/rescue-mode/)), or the [OVHcloud API](https://eu.api.ovh.com/).
