...
If you are [using SSH keys](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys-dedicated/) to connect to your server, losing your private SSH key could mean losing access to your server altogether.
...
Create a new SSH key pair on your device, as described in the first part of the [SSH key guide](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys-dedicated/).
...
Switch the boot mode back to "normal" and restart the server in your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB). Refer to the [rescue mode guide](#step2) if necessary.
