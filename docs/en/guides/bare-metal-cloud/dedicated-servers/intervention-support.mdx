...
- The new MAC address (viewable in the tab <code className="action">Network interfaces</code> in the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) or in the return of the command `ip link`).
...
1\. Log in as an administrator from the [IPMI/KVM](/guides/bare-metal-cloud/dedicated-servers/using-ipmi-on-dedicated-servers/) interface.<br/>
