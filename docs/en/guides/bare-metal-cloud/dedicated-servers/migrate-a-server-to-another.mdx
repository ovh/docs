...
description: Find out how to migrate data from one dedicated server to another
...
- The easiest way is to use a suitable software such as [SFTP](/guides/bare-metal-cloud/dedicated-servers/comment-deposer-ou-recuperer-des-donnees-sur-un-serveur-dedie-via-sftp/).
...
For more information, please read our documentation on [domains and DNS](/guides/web-cloud/domains/overview/).
