...
- An OVHcloud AI Endpoints API key. Refer to our guide "[AI Endpoints - Getting started](/guides/public-cloud/ai-machine-learning/endpoints-guide-01-getting-started/)" to generate one.
