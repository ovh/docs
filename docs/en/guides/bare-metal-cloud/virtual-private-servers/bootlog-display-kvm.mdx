...
Once you have done the modifications, reboot your VPS in 'normal' mode in your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB). Boot log information should now appear when using the [KVM console](/guides/bare-metal-cloud/virtual-private-servers/using-kvm-for-vps/).
