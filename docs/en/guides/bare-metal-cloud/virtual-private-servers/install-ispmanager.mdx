...
- A [VPS](https://www.ovhcloud.com/en-gb/vps/) or a [Dedicated Server](https://www.ovhcloud.com/en-gb/bare-metal/) in your [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) with a [recommended configuration for ISPmanager](https://www.ispmanager.com/docs/ispmanager/system-requirements).
