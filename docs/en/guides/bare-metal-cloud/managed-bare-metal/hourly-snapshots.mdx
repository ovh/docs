...
<img className="thumbnail" alt="data store" src="/images/bare-metal-cloud/managed-bare-metal/hourly-snapshots/snapshot01.png" loading="lazy" />

Create a folder to which you will later copy the files to restore.

<img className="thumbnail" alt="destination folder" src="/images/bare-metal-cloud/managed-bare-metal/hourly-snapshots/snapshot02.png" loading="lazy" />
...
<img className="thumbnail" alt="copy files" src="/images/bare-metal-cloud/managed-bare-metal/hourly-snapshots/snapshot03.png" loading="lazy" />
...
<img className="thumbnail" alt="register vm" src="/images/bare-metal-cloud/managed-bare-metal/hourly-snapshots/snapshot04.png" loading="lazy" />
...
We recommend using a full backup solution, such as our [Veeam Managed Backup](/guides/bare-metal-cloud/managed-bare-metal/veeam-backup-as-a-service/) service, or any other system that performs a full backup of your virtual machines.
