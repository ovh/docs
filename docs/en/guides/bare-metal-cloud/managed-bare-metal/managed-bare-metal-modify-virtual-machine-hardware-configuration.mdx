...
All the modifications described below must be made from your Managed Bare Metal on vSphere by right-clicking on a VM, then on `Edit Settings`.

![Editing resources](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware01.png)

In this menu, you can increase your virtual machine's resources.

![Editing resources](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware02.png)
...
![Add a CPU](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware03.png)
...
![Add memory](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware04.png)

### The hard disk

You can increase the hard disk size according to the space left in the datastore used by the virtual machine.

![Add storage](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware05.png)
...
![Add network](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware06.png)
...
![Add a CD/DVD reader](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware07.png)
...
![Add devices](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware08.png)
