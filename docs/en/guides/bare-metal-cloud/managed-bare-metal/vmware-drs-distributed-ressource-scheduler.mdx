...
<img className="thumbnail" alt="Function DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs0.png" loading="lazy" />
...
<img className="thumbnail" alt="Activation DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs01.png" loading="lazy" />
...
<img className="thumbnail" alt="Automation DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs02.png" loading="lazy" />
...
<img className="thumbnail" alt="Additional Options" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs03.png" loading="lazy" />
...
<img className="thumbnail" alt="Advanced Options" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs05.png" loading="lazy" />

### DRS rules

In the <code className="action">Configure</code> tab you can find the management of `VM/Host Rules`.

<img className="thumbnail" alt="DRS rules" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs06.png" loading="lazy" />
...
<img className="thumbnail" alt="DRS rules" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs07.png" loading="lazy" />
