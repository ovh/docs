...
This example uses a VM installed with Debian 9, deployed from [templates available for your Managed Bare Metal infrastructure](/guides/bare-metal-cloud/managed-bare-metal/ovf-template/).
...
This example uses a VM installed with Ubuntu 18.04, deployed from [templates available for your Managed Bare Metal infrastructure](/guides/bare-metal-cloud/managed-bare-metal/ovf-template/).
