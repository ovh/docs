...
description: Find out how to manage all aspects of migrating an infrastructure to Managed Bare Metal
...
:::info
Should you choose to migrate an infrastructure to a new vDC instead, please follow [this dedicated guide](/guides/bare-metal-cloud/managed-bare-metal/service-migration-vdc/).
...
To do this, please refer to our guides on [Changing user rights](/guides/bare-metal-cloud/managed-bare-metal/change-user-rights/), [Changing the User Password](/guides/bare-metal-cloud/managed-bare-metal/changer-user-password/) and [Associating an email with a vSphere user](/guides/bare-metal-cloud/managed-bare-metal/vsphere-edit-user/).
...
Please refer to our guide on [Enabling Virtual Machine Encryption](/guides/bare-metal-cloud/managed-bare-metal/vm-encrypt/) in order to enable KMS on the destination Managed Bare Metal.
...
As part of a migration process, you can link your Managed Mare Metal services within the same vRack. Please consult our guide to [Using Managed Bare Metal within a vRack](/guides/bare-metal-cloud/managed-bare-metal/using-vrack/).
...
Please consult our guide to [Migrate an IP block between two Managed Bare Metal services](/guides/bare-metal-cloud/managed-bare-metal/ip-block-addition#migrate-an-ip-block-between-two-managed-bare-metal-solutions/).
...
The migration involves reconfiguring VMware High Availability (HA), including boot order and priority. Please consult our guide about [VMware HA configuration](/guides/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/).
...
Please refer to our guide on [activating and using Veeam Managed Backup](/guides/bare-metal-cloud/managed-bare-metal/veeam-backup-as-a-service/).
...
- A [Veeam Backup & Replication](/guides/storage-and-backup/backup-and-disaster-recovery-solutions/veeam/veeam-veeam-backup-replication/) virtual machine on the source infrastructure
- [Authorising the Veeam Backup & Replication virtual machine to connect](/guides/bare-metal-cloud/managed-bare-metal/vcenter-authorise-ip-access/) to the source and destination vCenter
