...
- [Veeam Managed Backup enabled](/guides/bare-metal-cloud/managed-bare-metal/veeam-backup-as-a-service/) on your Managed Bare Metal solution
...
<img className="thumbnail" alt="email" src="/images/bare-metal-cloud/managed-bare-metal/veeam-managed-backup-restoration/backup-report-email.png" loading="lazy" />
...
<img className="thumbnail" alt="vSphere" src="/images/bare-metal-cloud/managed-bare-metal/veeam-managed-backup-restoration/vcenter.png" loading="lazy" />
