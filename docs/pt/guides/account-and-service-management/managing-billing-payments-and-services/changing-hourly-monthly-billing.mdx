...
:::warning
O seguinte procedimento não funciona para instâncias de terceira geração (por exemplo: B3-32). Para ser faturado mensalmente para este tipo de instância, deve criar um [Savings Plan](/guides/public-cloud/public-cloud-cross-functional/savings-plans/) para este modelo de instância.
