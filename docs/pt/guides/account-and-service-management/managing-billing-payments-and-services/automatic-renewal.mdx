...
Clique no seu nome no canto superior direito e escolha `As minhas ofertas e serviços`.

![produtos e serviços](/images/assets/screens/control-panel/product-selection/right-menu/my-solutions-and-services.png)

### Apresentar o tipo de renovação <a id="renewal-type"></a>

A página **Gestão das minhas ofertas e serviços** contém uma tabela de gestão dos seus serviços OVHcloud. Nele, pode encontrar os nomes, o tipo de serviço, a disponibilidade do serviço (`Ativo` por defeito), o seu estado (tipo de renovação, ação a realizar, etc.), a próxima data de efeito da renovação ou da rescisão, bem como um botão `...` dedicado às ações possíveis para cada serviço.

![Os meus serviços](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/my-services-en.png)
...
>
> ![manageautomaticréwal](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/filters-en.png)
...
À direita de um serviço, clique no botão `...` na coluna `Açōes` e, a seguir, numa ação à sua escolha.

![menu ações](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/actions-en.png)
...
![configurar a renovação](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/configure-renewal-en.png)

Clique na ação `Configurar a renovação`. Em função do serviço escolhido, pode parametrizá-lo para renovação manual ou escolher a frequência de renovação automática. Se necessário, poderá então escolher o tipo de renovação, bem como a frequência da mesma.

![configurar a renovação](/images/guides/account-and-service-management/managing-billing-payments-and-services/how-to-use-automatic-renewal/configure-renew-en.png)
...
![antecipar o pagamento](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/forward-payment-en.png)
...
>
> Depois de fazer as suas escolhas, prossiga a encomenda clicando em `Validar`.
>
...
![Cancelar](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/cancel-en.png)
...
![Renovar serviço](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/renew-service-en.png)
...
![Pagar uma fatura](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/pay-bill-en.png)
...
Basta então escolher a ação `Pagar a minha fatura` que lhe redirecionará para uma plataforma de pagamento online.
...
Tem a possibilidade de realizar ações agrupadas, selecionando vários serviços no quadro e clicando no botão `Ações`.

![ações agrupadas](/images/assets/screens/control-panel/product-selection/right-column/my-solutions-and-services/batch-actions-en.png)
