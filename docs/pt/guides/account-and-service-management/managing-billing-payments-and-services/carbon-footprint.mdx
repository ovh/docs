...
1. No [Painel de controlo da conta](https://manager.eu.ovhcloud.com/#/account/useraccount/dashboard), na coluna da esquerda, aceda à secção contendo os **Links úteis** e clique no separador <code className="action">A minha pegada ecológica</code>.
...
- Abre-se a interface de ligação ao seu [Área de Cliente OVHcloud](https://manager.eu.ovhcloud.com/#/account/useraccount/dashboard).
