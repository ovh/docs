...
![Nota de encomenda da OVH](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order01.png)
...
Para aceder ao painel de gestão das encomendas, aceda à sua [Área de Cliente OVHcloud](/links/manager). Na página que se abrir, clique em `Ver as minhas encomendas`.

![Área de Cliente](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/huborders.png)

Um resumo das diferentes encomendas efetuadas aparece a seguir:

![Resumo das encomendas](/images/assets/screens/control-panel/product-selection/right-column/initials/order-tab.png)
...
Poderá igualmente visualizar a nota de encomenda em formato HTML, clicando em `...` à direita da sua encomenda e depois em `Ver encomenda em formato HTML`.

![Resumo das encomendas](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order04.png)
...
* Aceda à [Área de Cliente OVHcloud](/links/manager). Na página que se abrir, clique em `Ver as minhas encomendas` e, em seguida, clique no botão `...` junto da sua encomenda.
* Selecione `Seguir encomenda`. O acompanhamento da encomenda pode igualmente ser apresentado clicando no estado de uma encomenda na coluna `Estado`.

![Acompanhamento de encomendas](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order05b.png)

Aparecerá a janela seguinte, que lhe permite um acompanhamento em quatro etapas.

![Acompanhamento de encomendas](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/order06.png)
...
* Aceda à [Área de Cliente OVHcloud](/links/manager). Na página que se abrir, clique em `Ver as minhas encomendas` e, em seguida, clique no botão `...` junto da sua encomenda.
* Selecione `Anular a encomenda`.

![Anular uma encomenda](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/cancelorder1.png)

Por último, selecione a opção `Sim, desejo cancelar esta encomenda` e confirme.

![Confirmação da anulação](/images/guides/account-and-service-management/managing-billing-payments-and-services/managing-ovh-orders/cancelorder2.png)
