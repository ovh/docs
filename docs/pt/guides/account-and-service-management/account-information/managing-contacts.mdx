...
- **Ligação direta:** [Gestão dos contactos](https://manager.eu.ovhcloud.com/#/account/contacts/services)
...
Abra a página [Gestão dos contactos](https://manager.eu.ovhcloud.com/#/account/contacts/services).
...
:::warning
Desaconselhamos que dê a qualquer terceiro as credenciais de acesso à [Área de Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt).
