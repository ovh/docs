...
- Na página [Segurança da conta](https://manager.eu.ovhcloud.com/#/account/useraccount/security), clique em <code className="action">Alterar</code> à direita de "Palavra-passe".
