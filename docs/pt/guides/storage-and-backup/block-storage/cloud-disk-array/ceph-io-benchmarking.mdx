...
description: Como avaliar os desempenhos da solução Cloud Disk Array
...
Visite nosso canal Discord dedicado: [https://discord.gg/ovhcloud](https://discord.gg/ovhcloud). Faça perguntas, forneça feedback e interaja diretamente com a equipe que desenvolve nossos serviços de armazenamento e backup.
