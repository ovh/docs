...
Para encontrar os seus Vaults, clique [neste link](https://manager.eu.ovhcloud.com/#/bmc-backup-agent-baremetal/service) para aceder à secção <code className="action">Backup Agent</code> e, de seguida, clique no separador <code className="action">Vaults</code>.
