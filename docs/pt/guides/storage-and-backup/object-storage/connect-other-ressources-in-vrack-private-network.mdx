...
- A [vRack Private Network service](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack)
- A [Public Cloud Gateway](/guides/public-cloud/public-cloud-network-services/create-private-network-gateway)
...
In order to create and configure both a Public Cloud Gateway and a vRack Private Network, please follow the instructions in our documentation: [Creating a private network with Gateway](/guides/public-cloud/public-cloud-network-services/create-private-network-gateway). This guide explains how to:
