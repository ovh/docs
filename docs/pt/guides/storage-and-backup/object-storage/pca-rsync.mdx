...
Para poder gerar o seu identificador e a sua palavra-passe OpenStack, utilize este [guia](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/).
