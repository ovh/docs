...
description: Volte para um estado anterior das suas VM graças às snapshots
...
Clique com o botão direito do rato na sua VM e escolha a opção <code className="action">Snapshots</code> e <code className="action">Efetuar uma Snapshot</code>:

<img className="thumbnail" alt="criar snapshot" src="/images/bare-metal-cloud/managed-bare-metal/creating-snapshots/snapshot01.png" loading="lazy" />
...
<img className="thumbnail" alt="configurar snapshot" src="/images/bare-metal-cloud/managed-bare-metal/creating-snapshots/snapshot02.png" loading="lazy" />

### Gestão das snapshots

Pode consultar todas as snapshots de uma VM no gestor de snapshots. Para isso, clique com o botão direito do rato na VM e escolha a opção <code className="action">Snapshots</code> e <code className="action">Gerir as snapshots</code>:

<img className="thumbnail" alt="gerir snapshots" src="/images/bare-metal-cloud/managed-bare-metal/creating-snapshots/snapshot03.png" loading="lazy" />

### Eliminar uma snapshot

No gestor de snapshots, selecione a snapshot que pretende eliminar e clique em <code className="action">Eliminar</code>.

É possível eliminar todas as snapshots da VM numa única ação clicando em <code className="action">Eliminar tudo</code>.

### Restaurar uma snapshot

No gestor de snapshots, selecione a snapshot que pretende restaurar e clique em <code className="action">Restaurar</code>.
...
Para efetuar uma consolidação, clique com o botão direito na VM e selecione <code className="action">Snapshots</code> > <code className="action">Consolidar</code>.

<img className="thumbnail" alt="consolidar snapshots" src="/images/bare-metal-cloud/managed-bare-metal/creating-snapshots/consolidate.png" loading="lazy" />
