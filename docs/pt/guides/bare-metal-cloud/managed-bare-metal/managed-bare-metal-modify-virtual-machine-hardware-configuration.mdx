...
Todas as modificações abaixo descritas devem ser realizadas a partir do seu Managed Bare Metal em vSphere, clicando com o botão direito do rato numa máquina virtual e na opção `Modificar os parâmetros`.

![Edição de recursos](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware01.png)

Neste menu, tem a possibilidade de aumentar os recursos da sua máquina virtual. 

![Edição de recursos](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware02.png)
...
![Adicionar uma CPU](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware03.png)
...
![Adição de memória](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware04.png)
...
![Adição de armazenamento](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware05.png)
...
![Adição da rede](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware06.png)
...
![Adição de um leitor CD/DVD](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware07.png)
...
![Adição de periféricos](/images/guides/bare-metal-cloud/managed-bare-metal/modify-hardware-configuration-of-vm/hardware08.png)
