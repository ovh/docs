...
Aqui, iremos utilizar uma VM instalada em Debian 9, implementada através dos [templates disponibilizados no seu Managed Bare Metal](/guides/bare-metal-cloud/managed-bare-metal/ovf-template/).
...
Aqui, iremos utilizar uma VM instalada em Ubuntu 18.04, implementada através dos [templates disponibilizados no seu Managed Bare Metal](/guides/bare-metal-cloud/managed-bare-metal/ovf-template/).
