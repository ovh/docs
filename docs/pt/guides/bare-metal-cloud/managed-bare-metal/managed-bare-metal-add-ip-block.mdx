...
Para encomendar um bloco IP adicional para o seu **Managed Bare Metal**, aceda à sua Área de Cliente OVHcloud. Na secção `Bare Metal Cloud`, clique na opção `IP` no menu à esquerda e, a seguir, clique em `Encomendar IP adicionais`. De seguida, selecione o seu **Managed Bare Metal** no menu pendente antes de passar para o seguinte passo.
...
![campo nexthop](/images/guides/bare-metal-cloud/managed-bare-metal/ip-block-addition/images/move-api.png)

O resultado terá este formato:

![campo nexthop](/images/guides/bare-metal-cloud/managed-bare-metal/ip-block-addition/api-result.png)
...
Poderá acompanhar a transferência do bloco IP na sua [Área de Cliente OVHcloud](/links/manager) na secção `Bare Metal Cloud` > `Managed Bare Metal`. Clique no seu serviço Managed Bare Metal e, depois, no separador `Operações`.
