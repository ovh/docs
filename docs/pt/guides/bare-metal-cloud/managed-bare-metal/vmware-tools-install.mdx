...
<img className="thumbnail" alt="" src="/images/bare-metal-cloud/managed-bare-metal/vmware-tools-install/tools.png" loading="lazy" />
...
<img className="thumbnail" alt="" src="/images/bare-metal-cloud/managed-bare-metal/vmware-tools-install/windows.jpg" loading="lazy" />
