...
<img className="thumbnail" alt="Ativação HA" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HA.png" loading="lazy" />
...
<img className="thumbnail" alt="Falha do host" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam1.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Isolamento do host" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam2.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Datastore com PDL" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam3.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Datastore com APD" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam4.PNG" loading="lazy" />

##### Monitorização das máquinas virtuais

A monitorização das MV passa a estar disponível após a instalação das [VMware Tools](/guides/bare-metal-cloud/managed-bare-metal/vmware-tools-install/).
...
<img className="thumbnail" alt="Monitorização das MV" src="/images/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/HAparam5.PNG" loading="lazy" />
