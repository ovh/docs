...
<img className="thumbnail" alt="snapshot" src="/images/bare-metal-cloud/managed-bare-metal/hourly-snapshots/snapshot01.png" loading="lazy" />

Crie uma pasta na qual irá copiar os ficheiros a restaurar mais tarde.

<img className="thumbnail" alt="snapshot" src="/images/bare-metal-cloud/managed-bare-metal/hourly-snapshots/snapshot02.png" loading="lazy" />
...
<img className="thumbnail" alt="snapshot" src="/images/bare-metal-cloud/managed-bare-metal/hourly-snapshots/snapshot03.png" loading="lazy" />
...
<img className="thumbnail" alt="snapshot" src="/images/bare-metal-cloud/managed-bare-metal/hourly-snapshots/snapshot04.png" loading="lazy" />
...
Recomendamos a utilização de uma solução completa de backup, como o nosso serviço [Veeam Backup](/guides/bare-metal-cloud/managed-bare-metal/veeam-backup-as-a-service/) ou qualquer outro sistema que realize um backup completo das suas máquinas virtuais.
