...
<img className="thumbnail" alt="Princípio do DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs0.png" loading="lazy" />
...
<img className="thumbnail" alt="Ativação do DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs01.png" loading="lazy" />
...
<img className="thumbnail" alt="Automatização DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs02.png" loading="lazy" />
...
<img className="thumbnail" alt="Opções adicionais DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs03.png" loading="lazy" />
...
<img className="thumbnail" alt="Opções avançadas DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs05.png" loading="lazy" />

### Regras DRS

Encontrará no separador `Configurar` a gestão das regras relativas a MV/hosts.

<img className="thumbnail" alt="Regras DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs06.png" loading="lazy" />
...
A quarta regra, «Máquinas virtuais a máquinas virtuais», encontra-se explicada no guia sobre a [função HA](/guides/bare-metal-cloud/managed-bare-metal/vmware-ha-high-availability/).

<img className="thumbnail" alt="Criação de regras DRS" src="/images/bare-metal-cloud/managed-bare-metal/vmware-drs-distributed-ressource-scheduler/drs07.png" loading="lazy" />
