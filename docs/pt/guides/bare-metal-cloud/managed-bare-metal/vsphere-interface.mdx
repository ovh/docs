...
<img className="thumbnail" alt="Ligação à interface vSphere HTML5" src="/images/bare-metal-cloud/managed-bare-metal/vsphere-interface/connection_interface_w_html5.png" loading="lazy" />

A seguir, deverá aceder à seguinte interface:

<img className="thumbnail" alt="Ligação à interface vSphere HTML5" src="/images/bare-metal-cloud/managed-bare-metal/vsphere-interface/vsphere-client-html5.png" loading="lazy" />

A página <code className="action">Home</code> permite consultar os grandes menus do seu vCenter. Poderá efetuar diferentes ações, tais como.

- Implementar uma máquina virtual acedendo à secção <code className="action">Hosts and Clusters</code>;
...
<img className="thumbnail" alt="Ligação à interface vSphere" src="/images/bare-metal-cloud/managed-bare-metal/vsphere-interface/connection_interface_w.png" loading="lazy" />
