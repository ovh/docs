...
- An [OVHcloud SMS account](/links/telecom/sms) and a valid [SMS sender](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-expediteurs-sms).
...
> - [The sender must be defined in your OVHcloud account](/guides/web-cloud/messaging/sms/tout-savoir-sur-les-expediteurs-sms). To perform a test without declaring a sender and using a short number, replace `"sender": "Your_sender"` with `"senderForResponse": true`.
