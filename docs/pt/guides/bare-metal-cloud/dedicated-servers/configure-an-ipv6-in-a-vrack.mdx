...
- IPv6:
    ...
    - [Configurar IPv6 numa instância Public Cloud](/guides/public-cloud/public-cloud-network-services/configuration-02-how-to-configure-ipv6/).
...
- **Ligação direta:** [vRack](https://manager.eu.ovhcloud.com/#/dedicated/vrack)
...
<img className="thumbnail" alt="página de configuração" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/500.png" loading="lazy" />
...
<img className="thumbnail" alt="Configurar um IPv6 num vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/20240418-03.png" loading="lazy" />
...
<img className="thumbnail" alt="gestão do vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/700.png" loading="lazy" />
...
<img className="thumbnail" alt="seleção do vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/701.png" loading="lazy" />
...
<img className="thumbnail" alt="ativar SLAAC" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/702.png" loading="lazy" />
...
- Ligue-se à [área de cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt).
...
<img className="thumbnail" alt="Configurar um IPv6 num vRack para o modo encaminhado" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/routed-mode-20240513.png" loading="lazy" />
...
<img className="thumbnail" alt="seleção vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-an-ipv6-in-a-vrack/600.png" loading="lazy" />
