...
description: Saiba como migrar dados de um servidor dedicado para outro
...
- A forma mais simples é utilizar um software adequado como [SFTP](/guides/bare-metal-cloud/dedicated-servers/comment-deposer-ou-recuperer-des-donnees-sur-un-serveur-dedie-via-sftp/).
...
Para mais informações queira ler a nossa documentação sobre [domínios e DNS](/guides/web-cloud/domains/overview/).
