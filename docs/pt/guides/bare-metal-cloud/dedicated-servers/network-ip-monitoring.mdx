...
Em primeiro lugar, aceda à [Área de Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt) e selecione o separador <code className="action">Bare Metal Cloud</code>. Selecione o servidor em causa no menu pendente dos <code className="action">Servidores Dedicados</code>.
