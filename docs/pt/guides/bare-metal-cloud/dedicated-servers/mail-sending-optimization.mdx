...
Para configurar o caminho da reverse DNS no [Área de Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt) queira consultar [o nosso manual dedicado](/guides/bare-metal-cloud/virtual-private-servers/configuring-reverse-dns/).
