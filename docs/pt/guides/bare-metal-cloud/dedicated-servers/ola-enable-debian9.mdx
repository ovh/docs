...
<br/>Para o fazer, aceda à [Área de Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt). Na secção <code className="action">Bare Metal Cloud</code>, selecione o seu servidor em <code className="action">Servidores dedicados</code> e clique no separador <code className="action">IPMI</code> (1).
