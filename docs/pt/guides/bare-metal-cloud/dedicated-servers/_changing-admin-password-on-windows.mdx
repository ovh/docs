...
Na [Área de Cliente OVHcloud](/links/manager), aceda ao separador `IPMI` para abrir uma sessão KVM.
...
[Como utilizar o IPMI com servidores dedicados](/guides/bare-metal-cloud/dedicated-servers/dedicated-servers-ipmi)
