...
Se [utilizar chaves SSH](/guides/bare-metal-cloud/dedicated-servers/dedicated-servers-creating-ssh-keys) para se ligar ao seu servidor, a perda da sua chave SSH privada poderá implicar a perda total de acesso ao seu servidor.
...
Crie um novo par de chaves SSH no seu ambiente de trabalho, tal como descrito na primeira parte do manual ["Criar chaves SSH"](/guides/bare-metal-cloud/dedicated-servers/dedicated-servers-creating-ssh-keys).
