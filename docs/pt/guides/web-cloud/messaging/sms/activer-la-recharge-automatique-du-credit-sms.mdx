...
To enable automatic re-crediting, log in to the [OVHcloud Control Panel](/links/manager), then go to the `Telecom` tab. Next, click on the `SMS` section in the services bar. Choose the SMS account you would like to enable automatic re-credit for.
