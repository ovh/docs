...
Log in to the [OVHcloud Control Panel](/links/manager), and go to the `Telecom` section. Next, select `SMS`.

Click on the SMS account concerned, and select the `Contacts` tab, then `Address book`.

![phonebook](/images/guides/web-cloud/messaging/sms/gerer-mes-carnets-dadresses-sms/smsphonebook01.png)

Click `Add an address book`, and give it a name.

![phonebook](/images/guides/web-cloud/messaging/sms/gerer-mes-carnets-dadresses-sms/smsphonebook2.png)
...
![phonebook](/images/guides/web-cloud/messaging/sms/gerer-mes-carnets-dadresses-sms/smsphonebook3.png)

You will access a window that enables you to enter the contact details.

![phonebook](/images/guides/web-cloud/messaging/sms/gerer-mes-carnets-dadresses-sms/smsphonebook4.png)
...
![phonebook](/images/guides/web-cloud/messaging/sms/gerer-mes-carnets-dadresses-sms/smsphonebook-spreadsheet1.png)
...
![phonebook](/images/guides/web-cloud/messaging/sms/gerer-mes-carnets-dadresses-sms/smsphonebook-spreadsheet2.png)
...
![phonebook](/images/guides/web-cloud/messaging/sms/gerer-mes-carnets-dadresses-sms/smsphonebook5.png)

A pop-up window will appear. Next, click `Contact file` to select your .csv file, then confirm.

![phonebook](/images/guides/web-cloud/messaging/sms/gerer-mes-carnets-dadresses-sms/smsphonebook6.png)
...
![phonebook](/images/guides/web-cloud/messaging/sms/gerer-mes-carnets-dadresses-sms/smsphonebook7.png)
