...
- Access to the [OVHcloud Control Panel](/links/manager), in the `Telecom` section, then `SMS`.
...
Log in to your [OVHcloud Control Panel](/links/manager) and select `Telecom`.
...
![sms send control panel](/images/guides/web-cloud/messaging/sms/tout-savoir-sur-les-expediteurs-sms/sms-send-control-panel04E.png)

If you want to add an additional SMS sender, click on the `Actions` button in the centre, then on `Add` (2).

![sms send control panel](/images/guides/web-cloud/messaging/sms/tout-savoir-sur-les-expediteurs-sms/sms-send-control-panel05E.png)
