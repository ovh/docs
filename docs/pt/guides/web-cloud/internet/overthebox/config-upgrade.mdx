...
Cliquez sur `OverThebox` dans la barre de services à gauche, puis sélectionnez le service OverTheBox que vous souhaitez mettre à jour.
...
![overthebox](/images/guides/web-cloud/internet/overthebox/config-upgrade/manager-version-2024.png)
...
![overthebox](/images/guides/web-cloud/internet/overthebox/config-upgrade/manager-available-2024.png)

### Mise à jour via l'espace client

> [!warning]
>
> Cette action n'est possible que si votre appareil contacte notre serveur de provisionning. Si ce n'est pas le cas, vous devez effectuer une [installation manuelle](/guides/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel).
>
...
Cliquez ensuite sur le bouton `Mettre à jour`, puis cliquez une seconde fois sur l'encart explicatif, la mise à jour commencera alors.

![overthebox](/images/guides/web-cloud/internet/overthebox/config-upgrade/manager-upgrade-2024.png)
...
Cliquez sur `OverThebox` dans la barre de services à gauche, puis sélectionnez le service OverTheBox que vous souhaitez modifier.

Selectionnez ensuite le canal souhaité à l'aide du menu déroulant `Versions disponibles`.

![overthebox](/images/guides/web-cloud/internet/overthebox/config-upgrade/manager-releaseChannel-2024.png)
...
Activez ou désactivez les mise à jour automatique à l'aide de l'interrupteur `Autoriser les mises à jour automatiques la nuit`.

![overthebox](/images/guides/web-cloud/internet/overthebox/config-upgrade/manager-autoupgrade-2024.png)
