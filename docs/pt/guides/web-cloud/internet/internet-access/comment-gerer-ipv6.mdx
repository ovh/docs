...
![IPv6 status](/images/guides/web-cloud/internet/internet-access/comment-gerer-ipv6/IPv6-status.png)
...
![IPv6 status](/images/guides/web-cloud/internet/internet-access/comment-gerer-ipv6/IPv6-activate.png)
