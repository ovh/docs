...
1. Dans l'onglet `Mon accès`, cliquez sur `Afficher les alertes` dans le cadre `Informations générales`.

![espace client](/images/guides/web-cloud/internet/internet-access/monitoring/espace-client-2022.png)

Vous arrivez alors sur le formulaire de création de notifications.

![afficher alertes](/images/guides/web-cloud/internet/internet-access/monitoring/xdsl-monitoring.png)

### Activer les notifications par e-mail

Pour créer une notification par e-mail, cliquez sur `Ajouter une alerte`. 
...
![notification e-mail](/images/guides/web-cloud/internet/internet-access/monitoring/xdsl-monitoring-alerte.png)

### Activer les notifications par SMS

Pour créer une notification par SMS, cliquez sur `Ajouter une alerte`.
...
![notification SMS](/images/guides/web-cloud/internet/internet-access/monitoring/xdsl-monitoring-alerte.png)
...
![sms d'alerte](/images/guides/web-cloud/internet/internet-access/monitoring/XDSL-monitoring-alertes-sms.png)

### Supprimer une alerte

Pour supprimer une alerte préalablement activée, cliquez sur l'icône prévue à cet effet à droite de l'alerte. Confirmez la suppression en cliquant sur `OK`.
