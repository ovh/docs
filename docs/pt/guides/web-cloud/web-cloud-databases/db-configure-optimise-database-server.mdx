...
Na [Área de Cliente OVHcloud](/links/manager), aceda à secção `Web Cloud Databases` e clique na instância SQL que pretende configurar. Certifique-se de que está no separador `Informações gerais`.
...
![Informações gerais](/images/assets/screens/control-panel/product-selection/web-cloud/web-cloud-databases/general-information/general-information.png)
...
Na [Área de Cliente OVHcloud](/links/manager), aceda à secção `Web Cloud Databases` e clique na Web Cloud Databases SQL em causa. 
...
### Alterar a sua oferta Web Cloud Databases <a id="modify-ram-web-cloud-db"></a>
...
>
> Para desassociar uma oferta Web Cloud Databases associada a um alojamento web **Performance**, consulte o guia "[Desassociar a minha solução Web Cloud Databases de um alojamento web](/guides/web-cloud/web-cloud-databases/db-detach-from-web-hosting)".
>
...
Para alterar a sua oferta Web Cloud Databases, aceda à [Área de Cliente OVHcloud](/links/manager). Clique no separador `Web Cloud` e, a seguir, em `Web Cloud Databases`. Selecione o nome do seu servidor de bases de dados.
...
Aceda à [Área de Cliente OVHcloud](/links/manager). Clique no separador `Web Cloud` e, a seguir, em `Web Cloud Databases`. Selecione o nome do seu servidor Web Cloud Databases. 

#### Instância MySQL e MariaDB

- Aceda ao separador `Configuração`.
...
Para aceder aos logs da sua solução Web Cloud Databases, consulte o guia "[Web Cloud Databases - Como recuperar os logs ?](/guides/web-cloud/web-cloud-databases/db-retrieve-logs)".

#### Acompanhar a RAM consumida

Aceda à [Área de Cliente OVHcloud](/links/manager). Clique no separador `Web Cloud` e, a seguir, em `Web Cloud Databases`. Selecione o nome do seu servidor de bases de dados. 
