...
Para importar a base de dados diretamente a partir do phpMyAdmin, é necessário primeiro conectar-se. Consulte a secção "[Conexão a uma base de dados MySQL ou MariaDB](/guides/web-cloud/web-cloud-databases/connecting-to-database-on-database-server#conexao-a-uma-base-de-dados-mysql-ou-mariadb/)".
