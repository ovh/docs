...
Para mais informações, consulte a [política de fim de vida das bases de dados geridas](/guides/web-cloud/web-cloud-databases/db-managed-db-lifecycle-policy).
