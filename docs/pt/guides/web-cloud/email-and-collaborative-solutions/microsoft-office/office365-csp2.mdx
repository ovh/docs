...
Para encomendar um serviço Office 365 Revendedores, aceda à [Área de Cliente OVHcloud](/links/manager). Depois de conectar, selecione `Sunrise` no painel superior e clique em `Office 365 Revendedores`.
...
- Clique em `Encomendar` para finalizar.
...
![office365](/images/guides/web-cloud/email-and-collaborative-solutions/microsoft-office/office-csp2/csp2-01.png)
...
Para isso, aceda à secção `Sunrise`. No menu à esquerda, escolha o `Office 365 Revendedores` e selecione o serviço.
...
![office365](/images/guides/web-cloud/email-and-collaborative-solutions/microsoft-office/office-csp2/sunrise_office365_CSP2_services_details.png)
...
![office365](/images/guides/web-cloud/email-and-collaborative-solutions/microsoft-office/office-csp2/sunrise_office365_CSP2_Subscribers.png)
