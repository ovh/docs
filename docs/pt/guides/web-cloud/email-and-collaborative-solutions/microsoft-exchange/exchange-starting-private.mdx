...
Para consultar este e-mail a partir da sua [Área de Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt), clique no seu perfil, no topo da página à direita, e depois em <code className="action">E-mails de serviço</code> e pesquise o e-mail com o assunto:
