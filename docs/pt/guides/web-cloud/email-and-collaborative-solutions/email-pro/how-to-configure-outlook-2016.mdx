...
Clique [neste link](https://manager.eu.ovhcloud.com/#/web/email_pro) para aceder à secção <code className="action">E-mail Pro</code>. O nome do servidor está visível no quadro **Ligação** do separador <code className="action">Informações gerais</code>.
