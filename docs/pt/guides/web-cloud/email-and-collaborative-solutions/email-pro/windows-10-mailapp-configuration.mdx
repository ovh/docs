...
- Abra o Outlook. No menu lateral esquerdo, clique em `Adicionar uma conta` para iniciar a configuração.
...
- Digite sua senha e clique no botão `Mostrar mais`.
...
- Clique em `Continuar` para concluir a configuração.
...
### Usar o endereço de e-mail <a id="use-account"></a>
...
### Modificar as configurações existentes <a id="modify-settings"></a>
...
- Na seção "Suas contas", clique em `Gerenciar` à direita do endereço de e-mail em questão.
...
- Clique em `Excluir` para iniciar a exclusão.
...
### Configurações gerais de envio e recebimento <a id="settings-account"></a>

#### Configurações IMAP e POP para recebimento <a id="imap-pop"></a>
...
#### Configurações SMTP para envio <a id="smtp"></a>
