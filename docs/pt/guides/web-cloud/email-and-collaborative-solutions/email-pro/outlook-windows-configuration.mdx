...
- **Se já tem uma conta configurada**, clique em `Ficheiro` e selecione `Adicionar Conta`.

- Introduza o seu endereço de e-mail e clique em `Opções avançadas`. De seguida, selecione a caixa `Permitir configurar manualmente a minha conta` e clique em `Ligar`. 
...
| | |
|---|---|
|![Outlook](/images/guides/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-outlook-2016/config-outlook-emailpro02.png)|Entre os diferentes tipos de conta, selecione IMAP e POP. <br />Recomendamos uma utilização em IMAP.|
|Introduza a password do seu endereço de e-mail e clique em `Seguinte`. |![Outlook](/images/guides/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-outlook-2016/config-outlook-emailpro03.png)|
|![Outlook](/images/guides/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-outlook-2016/config-outlook-emailpro04.png)|Se o Outlook não conseguir configurar automaticamente o seu endereço, esta janela será apresentada. <br />Clique em `Modificar os parâmetros da conta` |
|Introduza no **Correio de entrada**: <br />- o servidor **pro?.mail.ovh.net** (substitua "?" pelo número do seu servidor) <br />- Porta **993**<br />- Método de encriptação **SSL/TLS**<br /><br />Introduza no **Correio de saída**: <br />- o servidor **pro?.mail.ovh.net** (substitua "?" pelo número do seu servidor)<br />- Porta **587**<br />- Método de encriptação **STARTTLS**<br /><br />Clique em `Seguinte` para validar. |![Outlook](/images/guides/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-outlook-2016/config-outlook-emailpro05.png)|
...
- Aceda ao `Ficheiro` a partir da barra de menu na parte superior do ecrã e selecione a conta a alterar no menu pendente **(1)**.
- Clique em `Parâmetros da conta`**(2)**.
- Clique em `Parâmetros do servidor`**(3)** para aceder à janela de configuração.
...
[Configurar um endereço de e-mail no Outlook para Windows](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/how-to-configure-outlook-2016) (versão em inglês).

[Configurar uma conta Exchange no Outlook para Windows](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/how-to-configure-outlook-2016) (versão em inglês).
