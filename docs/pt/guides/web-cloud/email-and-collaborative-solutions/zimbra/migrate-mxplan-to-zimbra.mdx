...
Para realizar uma migração por ficheiro ou múltiplo, consulte as secções " Migração por ficheiro " e " Realizar e seguir uma migração múltipla (modo projeto) " do nosso guia " [Migrar contas de e-mail via OVHcloud Mail Migrator](/guides/web-cloud/email-and-collaborative-solutions/migrating/migration-omm/) ".
...
Para eliminar o endereço de e-mail MX Plan (exemplo: `contact@mydomain.ovh`), siga o nosso guia " [Eliminar uma conta de e-mail](/guides/web-cloud/email-and-collaborative-solutions/common-email-features/email-reset-account/)".
