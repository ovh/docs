...
- [Avoir installé le logiciel POPC](./popc-setting-up) sur votre PC sous Windows.
...
![interface](/images/guides/web-cloud/phone-and-fax/voip/popc-utilisation/00-interface.png)
...
![réinitialiser zones](/images/guides/web-cloud/phone-and-fax/voip/popc-utilisation/00-reinitialiser-zones.png)
...
- faites un clic droit sur l'appel puis cliquer sur `Répondre`.

![appel entrant](/images/guides/web-cloud/phone-and-fax/voip/popc-utilisation/01-appel-entrant.png)
...
![appel sortant](/images/guides/web-cloud/phone-and-fax/voip/popc-utilisation/02-appel-sortant.png)

#### Mettre fin à un appel

Pour mettre fin à un appel entrant ou sortant, faites un clic droit sur l'appel en cours puis cliquez sur `Raccrocher`.

![raccrocher un appel](/images/guides/web-cloud/phone-and-fax/voip/popc-utilisation/03-raccrocher.png)
...
- faites un clic droit sur l'appel puis cliquez sur `Attente`.

![mettre un appel en attente](/images/guides/web-cloud/phone-and-fax/voip/popc-utilisation/04-attente.png)
...
- faites un clic droit sur l'appel en attente puis cliquez sur `Décrocher`.

![reprendre un appel en attente](/images/guides/web-cloud/phone-and-fax/voip/popc-utilisation/04-reprendre.png)
...
- faites un clic-droit sur l'appel à transférer, placez votre curseur sur `Transférer` puis saisissez le numéro de destination.

![mettre en relation deux correspondants](/images/guides/web-cloud/phone-and-fax/voip/popc-utilisation/05-mise-en-relation.png)
...
- cliquez sur le bouton `Messagerie` dans la barre inférieure du logiciel. Cette méthode ne fonctionne que si vous avez correctement renseigné le numéro `123` dans les paramètres du logiciel (plus d'informations sur [ce guide](./popc-setting-up#configuration-dans-le-logiciel)).

![messagerie](/images/guides/web-cloud/phone-and-fax/voip/popc-utilisation/06-messagerie.png)
...
Vous pouvez appeler directement l'un de vos correspondants depuis le journal en faisant un double clic sur l'appel ou un clic droit puis `Appeler`.
<br />Vous pouvez également ajouter l'un des numéros à un annuaire en faisant un clic droit sur l'appel puis en cliquant sur `Ajouter à` et en choisissant l'annuaire.
...
![journal](/images/guides/web-cloud/phone-and-fax/voip/popc-utilisation/07-journal.png)
...
![journal - filtres et légence](/images/guides/web-cloud/phone-and-fax/voip/popc-utilisation/07-journal-filtres-legende.png)
...
Pour activer la supervision, faites un clic droit sur une ligne à superviser, cliquez sur `Contact` puis `Présence` et enfin sur `Activer`.

![supervision - activer](/images/guides/web-cloud/phone-and-fax/voip/popc-utilisation/08-supervision-activer.png)

Des pictogrammes vous permettent de distinguer l'état de la ligne.

![supervision - etats](/images/guides/web-cloud/phone-and-fax/voip/popc-utilisation/08-supervision-etats.png)

##### **Intercepter un appel**

Vous pouvez intercepter un appel en vous rendant dans l'annuaire **local**. Faites un clic droit sur la ligne en train de sonner puis cliquez sur `Intercepter`.

![supervision - intercepter](/images/guides/web-cloud/phone-and-fax/voip/popc-utilisation/08-supervision-intercepter.png)

### Gestion des paramètres

De nombreux paramètres peuvent être modifiés. Si vous rencontrez des difficultés à utiliser le logiciel suite à une personnalisation des paramètres, nous vous conseillons de réinitialiser ces derniers en cliquant sur le bouton `Réinitialiser` situé en bas à droite du volet `Paramètres`.

Vous pourrez alors rétablir les paramètres nécessaires à la configuration de votre ligne SIP OVHcloud en vous aidant de notre guide pour [installer le logiciel POPC](./popc-setting-up#configuration-dans-le-logiciel).
...
Pour cela, cliquez sur `Paramètres` puis sur `Réseau`. Sélectionnez `G.711A` comme codec préféré.

![codecs POPC](/images/guides/web-cloud/phone-and-fax/voip/popc-utilisation/optimisation-codecs.png)

Validez les modifications en cliquant sur `Sauvegarder`. Le logiciel va alors redémarrer pour appliquer cette nouvelle configuration.
