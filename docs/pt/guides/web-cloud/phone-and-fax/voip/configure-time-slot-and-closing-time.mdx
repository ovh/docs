...
- Disposer d'un accès à la gestion de la ligne concernée depuis votre [espace client OVHcloud](/links/manager), partie `Télécom`.
...
### Gérer les plages horaires <a id="plages-horaires"></a>
...
1. Positionnez-vous sur l'onglet `Gestion des appels` et cliquez sur `Gérer les plages horaires`.

![gerer-plages-horaires](/images/guides/web-cloud/phone-and-fax/voip/configure-time-slot-and-closing-time/manage-time-slot-step1.png)
...
![gerer-plages-horaires](/images/guides/web-cloud/phone-and-fax/voip/configure-time-slot-and-closing-time/manage-time-slot-step2.png)
...
Pour modifier un créneau, cliquez sur l'icône en forme de roue dentée à côté de celui-ci. Définissez où seront redirigés les appels, puis cliquez sur le bouton `Modifier`. 
...
![gerer-plages-horaires](/images/guides/web-cloud/phone-and-fax/voip/configure-time-slot-and-closing-time/manage-time-slot-step3.png)
...
![gerer-plages-horaires](/images/guides/web-cloud/phone-and-fax/voip/configure-time-slot-and-closing-time/manage-time-slot-step4.png)

Dès que toutes vos plages horaires sont configurées, cliquez sur le bouton `Valider` pour sauvegarder ces changements. Vous avez aussi la possibilité de cliquer sur `Appliquer à plusieurs numéros` pour dupliquer les paramètres sur d'autres files d'appels.

#### Étape 4 : activer l'utilisation des plages horaires

Il ne reste plus qu'à activer les plages horaires. Dans la partie `Configuration générale` de la page, cliquez sur `Oui` puis sur `Valider`.
...
![gerer-plages-horaires](/images/guides/web-cloud/phone-and-fax/voip/configure-time-slot-and-closing-time/manage-time-slot-step5.png)

### Gérer les fermetures exceptionnelles <a id="fermetures-exceptionnelles"></a>
...
1. Cliquez sur `VoIP & Fax` puis sur le groupe de facturation contenant votre ligne SIP.
1. Cliquez sur l'onglet `Services` puis sur la ligne SIP concernée.
1. Positionnez-vous sur l'onglet `Gestion des appels` et cliquez sur `Gérer les fermetures exceptionnelles`.

![gerer-fermetures-exceptionnelles](/images/guides/web-cloud/phone-and-fax/voip/configure-time-slot-and-closing-time/manage-closing-time-step1.png)
...
Une fois les informations renseignées, cliquez sur `Créer l'événement`. Répétez cette manipulation afin d'ajouter toutes les fermetures exceptionnelles que vous souhaitez créer. Puis cliquez sur le bouton `Valider` pour sauvegarder ces changements.
 
Enfin, dans la partie `Paramètres` de la page, assurez-vous que le « **fuseau horaire** » paramétré est correct et que les plages horaires sont activées. Si vous effectuez un changement, cliquez sur le bouton `Valider` pour le sauvegarder.

![gerer-fermetures-exceptionnelles](/images/guides/web-cloud/phone-and-fax/voip/configure-time-slot-and-closing-time/manage-closing-time-step2.png)
