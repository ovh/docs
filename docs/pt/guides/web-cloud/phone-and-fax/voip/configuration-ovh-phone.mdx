...
1. Cliquez ensuite sur l'onglet `Téléphone` puis sur `Touches programmables`.

![Touches programmables](/images/guides/web-cloud/phone-and-fax/voip/configuration-ovh-phone/touches_programmables.png)

Vous arrivez alors sur l'écran permettant de configurer des touches. Il ne vous reste qu'à cliquer sur `...`, puis sur `Éditer`.

![Édition de la configuration des touches](/images/guides/web-cloud/phone-and-fax/voip/configuration-ovh-phone/gestion_touches.png)
...
Afin de bénéficier de cette option, il faut posséder un module d'extension de touches compatible avec votre poste téléphonique. Pour utiliser ce module, il est nécessaire dans un premier temps de l'activer en vous connectant à votre [espace client OVHcloud](/links/manager). Toujours dans l'onglet `Téléphone`, choisissez cette fois `Paramètres Plug & Phone personnalisés`.

![Paramètres Plug & Phone](/images/guides/web-cloud/phone-and-fax/voip/configuration-ovh-phone/parametre_plug_play.png)

Cliquez ensuite sur `Gérer les paramètres`.

![Gérer les paramètres Plug & Phone](/images/guides/web-cloud/phone-and-fax/voip/configuration-ovh-phone/gestion_parametres_plug_phone.png)

Pour finir, ajoutez dans le champ concerné le nombre de modules d'extension de touches à activer, puis validez en cliquant sur `Modifier les paramètres`.

![Activation des modules d'extension](/images/guides/web-cloud/phone-and-fax/voip/configuration-ovh-phone/module_extension_touches.png)

### Configurer les étiquettes de touches personnalisées

Vous pouvez également attribuer un nom personnalisé à chacune de vos touches programmables. Depuis l'onglet `Téléphone`, choisissez à nouveau `Paramètres Plug & Phone personnalisés`. Cliquez alors sur `Gérer les paramètres` et renseignez les noms souhaités dans les champs `Etiquette de touche`. La numérotation de ces touches correspond à l'ordre des touches de votre téléphone, la touche N°1 étant celle la plus en haut à gauche du poste.
Cliquez enfin sur `Modifier les paramètres` pour valider cette configuration

![etiquttes-touches](/images/guides/web-cloud/phone-and-fax/voip/configuration-ovh-phone/etiquettesb.gif)
