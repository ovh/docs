...
Une fois la ligne SIP sélectionnée, depuis l'onglet `Gestion`, cliquez sur le bouton `Restrictions SIP par IP`.

![securiser-sip](/images/guides/web-cloud/phone-and-fax/voip/secure-sip-line-ovh/restriction01.png)
...
Dans la section `Restrictions SIP de la ligne` de la page, complétez les adresses IP ou les plages d'IP concernées. Cliquez sur le bouton `Ajouter une adresse IP` pour faire apparaître jusqu'à six cases au maximum. 
...
Une fois les adresses ou plages d'IP renseignées, cliquez sur le bouton `Appliquer à plusieurs lignes` si vous souhaitez répliquer la configuration de la ligne sélectionnée à d'autres. Dans ce cas, vous devrez choisir les lignes dans la fenêtre qui apparaît, puis appuyez sur le bouton `Valider`.

Dès que vous êtes prêt à appliquer les modifications, cliquez sur le bouton `Appliquer les modifications`.

![securiser-sip](/images/guides/web-cloud/phone-and-fax/voip/secure-sip-line-ovh/restriction02.png)

- **La configuration souhaitée doit s'appliquer à toutes les lignes SIP associées à votre identifiant client OVHcloud** :

Dans la section `Restrictions SIP associées à votre code client` de la page, complétez les adresses IP ou les plages d'IP concernées. Cliquez sur le bouton `Ajouter une adresse IP` pour faire apparaître jusqu'à six cases au maximum. 
...
![securiser-sip](/images/guides/web-cloud/phone-and-fax/voip/secure-sip-line-ovh/restriction03.png)
...
1. Cliquez sur `VoIP & Fax` puis sur le groupe de facturation contenant votre ligne SIP.
1. Cliquez sur l'onglet `Services` puis sur la ligne SIP concernée.
1. Positionnez-vous ensuite sur l'onglet `Assistance` puis cliquez sur le bouton `Consultation des notifications`.

![securiser-sip](/images/guides/web-cloud/phone-and-fax/voip/secure-sip-line-ovh/restriction04.png)
...
![securiser-sip](/images/guides/web-cloud/phone-and-fax/voip/secure-sip-line-ovh/secure-sip-part5.png)
...
Pour cela, toujours sur la page `Consultation et gestion des notifications`, dans la section `Paramètres de notifications`, cliquez sur le bouton `Modifier les paramètres de notifications`. Complétez ensuite les informations demandées :
...
Une fois les informations complétées, cliquez sur `Valider`. Vous avez la possibilité d'activer ces paramètres de notifications pour d'autres lignes SIP en cliquant sur le bouton `Appliquer à plusieurs lignes`. Vous devrez choisir les lignes dans la fenêtre qui apparaît puis appuyer sur le bouton `Valider`.

![securiser-sip](/images/guides/web-cloud/phone-and-fax/voip/secure-sip-line-ovh/secure-sip-part6.png)
