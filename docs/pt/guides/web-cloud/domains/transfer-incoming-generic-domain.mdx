...
Depois de validar a encomenda, receberá uma nota de encomenda. O processo de transferência só terá início após a receção do pagamento. Depois de realizar esta operação, pode seguir o progresso da transferência na página [Operações em curso](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/web/ongoing-operations).
...
O processo de transferência pode ser reiniciado a partir da página [Operações em curso](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/%23/web/ongoing-operations).
...
Uma vez terminado o processo de transferência, pode gerir o seu nome de domínio a partir da página [Nomes de domínio](https://manager.eu.ovhcloud.com/#/web-domains/domain).
...
<Tabs>
  <Tab label="Etapa 1">
    Aceda à página [Nomes de domínio](https://manager.eu.ovhcloud.com/#/web-domains/domain) e selecione o nome de domínio em causa.
