...
Para desbloquear a criação de endereços de e-mail Exchange personalizados com um subdomínio, aceda à [Área de Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt) e selecione <code className="action">Web Cloud</code>. Clique em <code className="action">Microsoft</code> na coluna da esquerda e, a seguir, em <code className="action">Exchange</code>. De seguida, selecione a plataforma Exchange que deseja utilizar com o seu subdomínio. Na página que se abrir, aceda ao separador <code className="action">Domínios associados</code> e clique no botão <code className="action">Adicionar domínio</code> à direita.
...
Para desbloquear a criação de endereços E-mail Pro personalizados com um subdomínio, aceda à [Área de Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt) e selecione <code className="action">Web Cloud</code>. Clique em <code className="action">E-mails Pro</code> e selecione a plataforma E-mail Pro que pretende utilizar com o seu subdomínio. Na página que se abrir, aceda ao separador <code className="action">Domínios associados</code> e clique no botão <code className="action">Adicionar domínio</code> à direita.
