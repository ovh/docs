...
<Tabs>
  <Tab label="Passo 1">
    Aceda à página [Zonas DNS](https://manager.eu.ovhcloud.com/#/web/zone) e escolha o domínio que utilizou para criar os hosts na [parte 3](#step3).
...
<Tabs>
  <Tab label="Passo 1">
    Aceda à página [Zonas DNS](https://manager.eu.ovhcloud.com/#/web/zone) e escolha o domínio para o qual personalizou os servidores DNS.
...
<Tabs>
  <Tab label="Passo 1">
    Aceda à página [Nomes de domínio](https://manager.eu.ovhcloud.com/#/web-domains/domain) e escolha *o domínio para o qual pretende personalizar os servidores DNS*.
