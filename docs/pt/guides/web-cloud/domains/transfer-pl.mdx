...
Once the order has been confirmed, you will receive a free purchase order. The transfer process will only start once you have confirmed this free purchase order. Once this is done, you can track the transfer progress via the [OVHcloud Control Panel](/links/manager). Once you have logged in, go to the `Web Cloud` section, then click on `Ongoing operations`.
...
Once the transfer procedure is complete, you can manage your domain name from the [OVHcloud Control Panel](/links/manager). To do this, select `Web Cloud`, click `Domain names`, then click on the domain name concerned.
