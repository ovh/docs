...
> [!warning]
>
> Os SSL Gateways são incompatíveis com as ofertas de [alojamentos partilhados OVHcloud](/links/web/hosting). Se pretender beneficiar de um certificado SSL para este tipo de oferta, consulte o nosso guia "[Gerir um certificado SSL num alojamento web](/guides/web-cloud/web-hosting/ssl-on-webhosting)".
>
...
Escolha a sua oferta e depois clique em `Encomendar agora`.

![order ssl gateway](/images/assets/screens/website/order/configure-my-ssl-gateway.png)

Na nova página que se abrir, indique no formulário `Procure o seu nome de domínio` o nome de domínio ou subdomínio em causa e clique no ícone em forma de lupa à direita.
...
:::details Caso 1: a sua zona DNS é gerida pelos servidores DNS partilhados da OVHcloud.
...
:::details Caso 2: a sua zona DNS não é gerida pelos servidores DNS partilhados da OVHcloud.
