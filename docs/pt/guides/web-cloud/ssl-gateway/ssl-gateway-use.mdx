...
> [!info]
>
> - Ter encomendado um serviço [SSL Gateway](/guides/web-cloud/ssl-gateway/ssl-gateway-order).
...
- Clique de seguida na secção `Sunrise`.
...
|HSTS [[1]](#id5)|Obriga o browser a efetuar as suas próximas ligações ao seu website via HTTPS|
|Reverse|Permite atribuir um domínnio/subdomínio ao seu endereço IP IP SSL Gateway|
|Reencaminhamento HTTPS [[2]](#id6)|Reencaminha o visitante para a versão HTTPS do seu website quando ele acede via HTTP|
|Servidor HTTPS [[3]](#id7)|Ativa o HTTPS entre o servidor SSL Gateway e o seu servidor|
...
|Configuração dos ciphers [[4]](#id8)|Permite escolher um nível de segurança para o seu certificado SSL/TLS|
...
<summary>Dispõe de uma oferta **"Free"**</summary>
...
<summary>Dispõe de uma oferta **"Advanced"**</summary>
...
:::details Dispõe de uma oferta "Free"
...
:::details Dispõe de uma oferta "Advanced"
