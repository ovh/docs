...
![alojamento](/images/assets/screens/other/web-tools/terminal/terminal-ls-la-svn.png)
...
Sugerimos que siga o guia [Criar chaves SSH](/guides/bare-metal-cloud/dedicated-servers/dedicated-servers-creating-ssh-keys#create-ssh-key).
...
![alojamento](/images/assets/screens/other/web-tools/terminal/terminal-homez-folder.png)
...
![alojamento](/images/assets/screens/other/web-tools/tortoisesvn/checkout.png)
