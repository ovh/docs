...
Concluída esta etapa, clique no botão <code className="action">Validar</code>. Para mais informações sobre os motores de execução, consulte o nosso manual [Gerir os motores de execução de um alojamento Cloud Web](/guides/web-cloud/web-hosting/manage-runtime/).
...
Para reiniciar o *daemon* Node.js, aceda à sua [Área de Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt). No separador <code className="action">Multi-site</code>, clique no botão <code className="action">...</code> no final da linha correspondente ao domínio à direita, em <code className="action">Reiniciar</code>.
