...
Se utiliza uma base de dados numa oferta **Web Cloud Databases**, consulte o nosso guia sobre [a ligação à sua base de dados presente numa oferta Web Cloud Databases](/guides/web-cloud/web-cloud-databases/connecting-to-database-on-database-server/).
...
:::info
A OVHcloud oferece várias [ofertas CDN](https://www.ovhcloud.com/pt/web-hosting/options/). Se pretender utilizá-los ou ativar um para o seu alojamento web, aceda à [Área de Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt) e consulte o nosso guia sobre [utilização do CDN OVHcloud](/guides/web-cloud/web-hosting/cdn-how-to-use-cdn/).
