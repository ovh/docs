...
Estas são contas de utilizador de uma [federação de identidade](/guides/account-and-service-management/account-information/overview/). Estes utilizadores provêm de um diretório terceiro e não são geridos diretamente pela OVHcloud. Os seus direitos de acesso dependem das políticas [IAM](/guides/account-and-service-management/account-information/iam-policy-ui/) implementadas.
...
A gestão das identidades pode ser automatizada através das API [OVHcloud API](/guides/manage-and-operate/api/first-steps/) ou através do [provider Terraform OVHcloud](/guides/manage-and-operate/terraform/terraform-at-ovhcloud/).
