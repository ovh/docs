...
![Follow](/images/guides/manage-and-operate/observability/logs-data-platform/cli-ldp-tail/follow.png)

You will land on a new page where you will see all your logs in real-time as soon as they arrive. On this page click on the button `Copy WebSocket address` to copy the WebSocket address in your clipboard. Just use the address as in the example and you will see your logs flowing in your terminal right away.

![Websocket](/images/guides/manage-and-operate/observability/logs-data-platform/cli-ldp-tail/websocket.png)
...
![final](/images/guides/manage-and-operate/observability/logs-data-platform/cli-ldp-tail/final.gif)
