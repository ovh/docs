...
- Open the [Logs Data Platform](https://manager.eu.ovhcloud.com/#/dedicated/dbaas/logs) page in the OVHcloud Control Panel and select your platform.
...
3. List your number of PGP encryption keys for [cold storage archive](/guides/manage-and-operate/observability/logs-data-platform/archive-cold-storage/) and edit them. More on that in the [dedicated documentation](/guides/manage-and-operate/observability/logs-data-platform/archive-cold-storage-encryption/).
...
- **Monitor in real-time** allows you to see the logs incoming into your stream in real-time. Note that Graylog also provides this functionality. On this page you can also **Test** different log formats from your computer to your stream. [More about](/guides/manage-and-operate/observability/logs-data-platform/cli-ldp-tail/)
- **Manage alerts** allows you to define your alert conditions on the logs routed to the stream. [More about](/guides/manage-and-operate/observability/logs-data-platform/alerting-stream/)
...
- **Beats**: A secure and reliable protocol used by the beats family in the Elasticsearch ecosystem (Ex: [Filebeat](/guides/manage-and-operate/observability/logs-data-platform/ingestion-filebeat/), [Metricbeat](https://www.elastic.co/beats/metricbeat), [Winlogbeat](https://www.elastic.co/beats/winlogbeat)).
...
- [Send correctly formatted logs](/guides/manage-and-operate/observability/logs-data-platform/getting-started-field-naming-convention/) to use custom types as number, boolean and other stuff.
- [Configure your syslog-ng](/guides/manage-and-operate/observability/logs-data-platform/ingestion-syslog-ng/) to send your Linux logs to Logs Data Platform.
...
- [Using OpenSearch Dashboards and aliases to unleash the power of OpenSearch](/guides/manage-and-operate/observability/logs-data-platform/visualization-opensearch-dashboards/)
