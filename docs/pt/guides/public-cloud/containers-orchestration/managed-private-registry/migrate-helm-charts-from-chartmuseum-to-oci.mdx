...
Follow the guide [Connecting to the UI](/guides/public-cloud/containers-orchestration/managed-private-registry/connecting-to-the-ui/) to connect to your registry.
