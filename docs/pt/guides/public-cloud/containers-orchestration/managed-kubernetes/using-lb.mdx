...
A dedicated documentation for [Public Load Balancer](https://www.ovhcloud.com/pt/public-cloud/load-balancer/) is available, please look at the [Expose your applications using a load balancer](/guides/public-cloud/containers-orchestration/managed-kubernetes/expose-your-applications-using-a-load-balancer/).
