...
![Jenkins login](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-jenkins/installing-jenkins-01.png)

Log in with user `admin` and the password you got before. And here you have your Jenkins:

![Leeeeeeeroy Jenkins!](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/installing-jenkins/installing-jenkins-02.png)
