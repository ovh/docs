...
First of all, you will need to set up vRack private network for your Public Cloud. To do it, please follow the [Configuring vRack for Public Cloud](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack) guide. Once you have created a vRack and added it into a private network, you can continue. 
...
![Choose a private network for this cluster](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/using-vrack/using-vrack-01.png)
...
![Private network information in Attached network column](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/using-vrack/using-vrack-02.png)
...
- As explained in the [Known limits guide](/guides/public-cloud/containers-orchestration/managed-kubernetes/managed-kubernetes-known-limits), the following subnets are not compliant with the `vRack` feature and can generate some incoherent behaviours with our overlay networks:
