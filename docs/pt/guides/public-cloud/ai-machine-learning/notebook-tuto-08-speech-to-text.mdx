...
You can launch your notebook from the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt) or via the ovhai [CLI](/guides/public-cloud/ai-machine-learning/cli-11-howto-run-notebook-cli/).
