...
AI Training accepts images from **public** or **private** repositories. Find more information about using public & private registries [in this documentation](/guides/public-cloud/ai-machine-learning/gi-07-manage-registry/).
...
This is why it can be interesting to add other registries. Learn how to do it by following [this documentation](/guides/public-cloud/ai-machine-learning/gi-07-manage-registry/).
...
- Discover [how to build a custom Docker image to deploy a **Streamlit** app](/guides/public-cloud/ai-machine-learning/deploy-tuto-01-streamlit/).
- You can imagine deploying a Docker image for data processing and training tasks. Refer to this [tutorial](/guides/public-cloud/ai-machine-learning/training-tuto-06-models-comparaison-weights-and-biases/).
