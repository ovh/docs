...
-   **AI Training activated** for your account, see [how to submit a job Step 2](/guides/public-cloud/ai-machine-learning/training-guide-02-howto-submit-job/)
-   a user for AI Tools, see [how to create a user](/guides/public-cloud/ai-machine-learning/gi-01-manage-users/)
...
The documentation of the CLI is available at [CLI documentation](/guides/public-cloud/ai-machine-learning/cli-15-commands-reference/).
