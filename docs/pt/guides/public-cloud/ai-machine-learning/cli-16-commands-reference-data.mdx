...
- a working `ovhai` CLI. See our guide on [how to install ovhai CLI](/guides/public-cloud/ai-machine-learning/cli-10-howto-install-cli/).
...
At this time, __S3* compatible and Git data stores are supported__. To know more about S3 compatible Object Storage, please read [this documentation](/guides/public-cloud/ai-machine-learning/gi-08-s3-compliance/).
