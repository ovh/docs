...
![schema migration](/images/guides/public-cloud/public-cloud-databases/databases-20-move-to-cloud/schema.png)
...
3. Create a new database instance based on your network requirements. Follow [this guide](/guides/public-cloud/public-cloud-databases/public-cloud-databases-getting-started).
