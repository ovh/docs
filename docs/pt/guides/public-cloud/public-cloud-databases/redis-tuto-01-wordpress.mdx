...
<img className="thumbnail" alt="Redis Plugin PHPInfo" src="/images/public-cloud/public-cloud-databases/redis-tuto-01-wordpress/Redis_phpinfo.png" loading="lazy" />
...
<img className="thumbnail" alt="Search Redis Plugin" src="/images/public-cloud/public-cloud-databases/redis-tuto-01-wordpress/Redis_plugin_list.png" loading="lazy" />
...
<img className="thumbnail" alt="Add Authorised IP" src="/images/public-cloud/public-cloud-databases/redis-tuto-01-wordpress/Redis_add_ip_whitelist.png" loading="lazy" />

#### Activate and enable the plugin

Now all installation and configurations are done. So let's activate the plugin.

<img className="thumbnail" alt="Activate Redis Object Cache Plugin" src="/images/public-cloud/public-cloud-databases/redis-tuto-01-wordpress/Redis_Plugin_activate.png" loading="lazy" />

Then enable the object cache functionality.

<img className="thumbnail" alt="Enable Redis Object Cache" src="/images/public-cloud/public-cloud-databases/redis-tuto-01-wordpress/Redis_Plugin_enable.png" loading="lazy" />
...
<img className="thumbnail" alt="Diagnostics Redis Object Cache Plugin" src="/images/public-cloud/public-cloud-databases/redis-tuto-01-wordpress/Redis_Plugin_Diagnostics.png" loading="lazy" />
...
<img className="thumbnail" alt="Performance measure without cache" src="/images/public-cloud/public-cloud-databases/redis-tuto-01-wordpress/Perf_without_cache.png" loading="lazy" />

With the cache, there is a total of 2 database queries taking 0.0043s:

<img className="thumbnail" alt="Performance measure with cache" src="/images/public-cloud/public-cloud-databases/redis-tuto-01-wordpress/Perf_with_cache.png" loading="lazy" />
...
- [Valkey capabilities](/guides/public-cloud/public-cloud-databases/redis-01-capabilities/)
- [How to connect to a Valkey service with CLI](/guides/public-cloud/public-cloud-databases/redis-03-connect-cli/)
- [How to connect to a Valkey service with PHP](/guides/public-cloud/public-cloud-databases/redis-04-connect-php/)
