...
Sugerimos que consulte o guia [Criação e conexão a uma primeira instância Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
...
Pode consultar o guia [Alterar a chave SSH em caso de perda](/guides/public-cloud/compute/replacing-lost-ssh-key/).
...
**[Opcional desde setembro de 2023]** Um utilizador [OpenStack](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/) pode ser criado para utilizar as API Horizon ou OpenStack. Esta é facultativa, pois implementámos uma autenticação única (SSO: *Single Sign-On*) entre a Área de Cliente OVHcloud e Horizon.
...
Para mais informações, consulte o guia [Adicionar um Additional IP](/guides/public-cloud/public-cloud-network-services/additional-ip-buy/).
...
Sugerimos que consulte o guia [Configuração do vRack Public Cloud](/guides/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/).
...
Pode consultar o guia de [gestão das regras de firewall e port security nas redes que utilizam OpenStack CLI](/guides/public-cloud/public-cloud-cross-functional/security-group-private-network/).
