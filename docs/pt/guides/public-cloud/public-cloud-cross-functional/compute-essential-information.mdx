...
- [Criar a primeira instância](/guides/public-cloud/compute/compute-getting-started)
- [Gerir as quotas](/guides/public-cloud/public-cloud-cross-functional/increasing-public-cloud-quota)

## Abordagem global <a id="global-approach"></a>
...
## Abordagem concreta <a id="concrete-approach"></a>
...
|[Léxico](/guides/public-cloud/compute/key-concepts)|Os conceitos e definições de que necessitará para avançar.|
...
|Documentação|Detalhes|
|---|---|
|[Criar a primeira instância](/guides/public-cloud/compute/compute-getting-started)|Primeiro guia prático para iniciar um servidor cloud a partir da Área de Cliente OVHcloud.|
...
|[Configuração da rede privada](/guides/public-cloud/public-cloud-network-services/public-cloud-network-services-vrack)|Na OVHcloud, as redes privadas são suportadas pela tecnologia vRack. Este guia acompanha-o nesta implementação.|
...
|[Configurar um Additional IP](/guides/public-cloud/public-cloud-network-services/configure-additional-ip)|Os endereços Additional IP permitem-lhe transferir o tráfego de uma instância para outra, este guia explica-lhe como configurar isto.|
...
|[Instalação da CLI OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment)|OpenStack pode também ser utilizado em linha de comandos: eis como instalar as ferramentas.|
