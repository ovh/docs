...
- [Criar a primeira instância](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)
- [Gerir as quotas](/guides/public-cloud/public-cloud-cross-functional/increasing-public-cloud-quota/)
...
De seguida, terá de [criar um projeto Public Cloud](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project/). Um projeto é um ambiente que vão dedicar a um contexto.
...
Com o seu método de pagamento registado, este servirá para debitar o montante calculado para a sua [faturação no final do mês](/guides/public-cloud/public-cloud-cross-functional/analyze-billing/). Este cálculo é feito com base no tempo de utilização de cada recurso, em função do preço dos recursos.
...
<br/>Estas quotas são atribuídas por localização (região no sentido OpenStack). Por isso, é possível que atinja o máximo de recursos possíveis no seu projeto e que seja necessário [aumentar estas quotas](/guides/public-cloud/public-cloud-cross-functional/increasing-public-cloud-quota/).
...
- Se deseja utilizar as APIs OpenStack ou Amazon S3, ou a interface Horizon, terá de [criar utilizadores](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/) para isso. Os utilizadores podem ter permissões limitadas para proteger os perímetros de ação.
- Se não tem necessidade de aceder às API ou ao Horizon, pode [associar uma outra conta de cliente OVHcloud](/guides/public-cloud/public-cloud-cross-functional/delegate-projects/) em complemento ao seu projeto.
...
|---|---|
|[FAQ](/guides/public-cloud/public-cloud-cross-functional/faq-pci/)|As questões mais frequentes sobre o Public Cloud.|
|[Léxico](/guides/public-cloud/public-cloud-cross-functional/introduction-about-instances/)|Os conceitos e definições de que necessitará para avançar.|
...
|Documentação|Detalhes|
|---|---|
|[Criar a primeira instância](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)|Primeiro guia prático para iniciar um servidor cloud a partir da Área de Cliente OVHcloud.|
|[Utilização de uma chave SSH](/guides/public-cloud/compute/compute-creating-ssh-keys/)| Para se ligar a uma instância Linux, terá de passar por uma ligação SSH, este manual explica-lhe a utilização.|
|[Configuração da rede privada](/guides/public-cloud/public-cloud-network-services/getting-started-09-creating-vrack-with-openstack/)|Na OVHcloud, as redes privadas são suportadas pela tecnologia vRack. Este guia acompanha-o nesta implementação.|
...
|[Aceder à interface Horizon](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon/)|A interface Horizon da OpenStack permite algumas ações avançadas. Aqui está como conectá-lo.|
|[Criar um cluster Kubernetes](/guides/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/) (EN)|Este guia acompanha-o passo a passo na criação do seu primeiro cluster Kubernetes.|
|[Configurar um Additional IP](/guides/public-cloud/public-cloud-network-services/getting-started-04-configure-additional-ip-to-instance/)|Os endereços Additional IP permitem-lhe transferir o tráfego de uma instância para outra, este guia explica-lhe como configurar isto.|
|[Usando a interface Horizon](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon/)|Horizon é a interface clássica do OpenStack, e este guia explicará como acessá-la.|
|[Instalação da CLI OpenStack](/guides/public-cloud/public-cloud-cross-functional/prepare-the-environment-for-using-the-openstack-api/)|OpenStack pode também ser utilizado em linha de comandos: eis como instalar as ferramentas.|
