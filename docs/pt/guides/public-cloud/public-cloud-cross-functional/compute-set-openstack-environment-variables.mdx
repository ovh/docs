...
- Ter criado um utilizador OpenStack. Consulte [o respetivo guia](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user).
- Ter preparado o ambiente para usar o OpenStack. Para isso, consulte o seguinte guia: [Preparar o ambiente para utilizar a API OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment).
...
Ligue-se à sua [Área de Cliente OVHcloud](/links/manager), aceda à secção `Public Cloud` e selecione o seu projeto Public Cloud no canto superior esquerdo.
<br /> No menu à esquerda, na rubrica **Parâmetros**, clique em `Utilizadores & Funções`. A seguir, clique nas `...` do lado direito do seu utilizador, e selecione `Transferir o ficheiro RC do OpenStack`.
...
Como indicado em [este guia](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user), a palavra-passe só é visível uma vez, no momento da sua criação.
