...
- Para os utilizadores do Windows, consulte este guia para exportar as suas variáveis de ambiente: [Carregar as variáveis de ambiente OpenStack](/guides/public-cloud/public-cloud-cross-functional/loading-openstack-environment-variables/).
...
<img className="thumbnail" alt="descarregar o ficheiro openRC" src="/images/public-cloud/public-cloud-cross-functional/using-openstack-tokens-for-multiple-calls/openrc.png" loading="lazy" />
