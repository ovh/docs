...
Navigate to the `Public Cloud` section of the [OVHcloud Control Panel](/links/manager) and click the `Quantum QPUs` category.
...
- Learn about the technical features, capabilities, and limitations of the Public Cloud Quantum Notebooks offering [here](/guides/public-cloud/quantum-computing/quantum-computing-capabilities).
- Get some hints on how to debug your Notebooks if things go wrong [here](/guides/public-cloud/quantum-computing/quantum-computing-troubleshooting).
