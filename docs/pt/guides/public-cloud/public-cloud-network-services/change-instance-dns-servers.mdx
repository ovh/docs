...
Ligue-se à sua instância em SSH. Para mais informações, consulte o manual "[Aceder a uma instância Public Cloud](/guides/public-cloud/compute/compute-getting-started#connect-instance)".
...
Ligue-se à instância através de uma sessão de ambiente de trabalho remoto ou com a consola VNC. Para mais informações, consulte o guia "[Aceder a uma instância Public Cloud](/guides/public-cloud/compute/compute-getting-started#connect-instance)".

Abra os `Parâmetros de rede`.

![modificar os servidores DNS](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers1.png)

Através do painel de configuração, aceda à configuração IPv4 da sua placa de rede pública.

![modificar os servidores DNS](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers2.png)

Adicione os servidores que deseja utilizar nos `Parâmetros avançados`.

![modificar os servidores DNS](/images/guides/public-cloud/public-cloud-network-services/changing-dns-servers-of-an-instance/changednsservers3.png)
...
[Criar uma primeira instância Public Cloud e ligar-se a ela](/guides/public-cloud/compute/compute-getting-started)
