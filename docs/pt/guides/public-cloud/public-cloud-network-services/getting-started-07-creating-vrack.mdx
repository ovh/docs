...
- Ter um [projeto Public Cloud](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project/)
- Ter [criado um utilizador OpenStack](/guides/public-cloud/public-cloud-cross-functional/create-and-delete-a-user/) (opcional)
...
[O Área de Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt) é uma interface totalmente e exclusivamente visual, o que a torna uma interface ideal para a gestão de vários VLAN. Também terá a possibilidade de personalizar a faixa de IP privado, que por defeito é 10.1.0.0/16.
...
Consulte o guia "[Apresentação de Horizon](/guides/public-cloud/public-cloud-cross-functional/introducing-horizon/)" para se familiarizar com o Horizon.
...
Para isso, terá de escolher o fornecedor e o recurso Terraform adequados. Encontre mais informações no nosso [guia de utilização do Terraform](/guides/manage-and-operate/terraform/terraform-at-ovhcloud/).
...
Será redirecionado para outra página para validar a encomenda, a operação demorará alguns minutos.
    ...
    <img className="thumbnail" alt="adicionar o projeto" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/addprojectvrack.png" loading="lazy" />
...
<Tabs>
  <Tab label="A partir da Área de Cliente OVHcloud">
    ...
    <img className="thumbnail" alt="Criação de VLAN" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack2022-03.png" loading="lazy" />
...
Clique agora em <code className="action">Criar uma rede privada</code>. A página seguinte permitirá personalizar vários parâmetros.
    ...
    <img className="thumbnail" alt="seleccionar região" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack5-2024.png" loading="lazy" />

Na etapa seguinte, são apresentadas-lhe várias opções:
    
    <img className="thumbnail" alt="criar rede" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack6-2022.png" loading="lazy" />
...
No campo **Nome da rede privada**, defina um nome para a sua rede privada.
    ...
    **Opções de gateway de rede**
    ...
    - **Atribuir um Gateway e ligar-se à rede privada**: Selecione esta opção se tiver a intenção de criar instâncias com rede privada apenas. Para mais informações, convidamo-lo a consultar os seguintes guias: [Criar uma rede privada com uma Gateway](/guides/public-cloud/public-cloud-network-services/getting-started-02-create-private-network-gateway/) e [Criar uma primeira instância Public Cloud e ligar-se a ela](/guides/public-cloud/compute/public-cloud-first-steps/).
...
<Tabs>
  <Tab label="A partir da Área de Cliente OVHcloud">
    Consulte o guia "[Criar uma instância a partir do espaço cliente](/guides/public-cloud/compute/public-cloud-first-steps/)". Durante a criação de uma instância, pode escolher na etapa 5, um modo de rede e, em seguida, uma rede privada à qual integrar a sua instância.
    
    <img className="thumbnail" alt="anexar nova instância" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/network-selection.png" loading="lazy" />
...
<Tabs>
  <Tab label="A partir da Área de Cliente OVHcloud">
    Inicie sessão na sua [Área de Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt), aceda à secção <code className="action">Public Cloud</code> e selecione o projeto Public Cloud relevante no canto superior esquerdo.
    ...
    <img className="thumbnail" alt="detalhe instância" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/instance_details.png" loading="lazy" />
...
O painel de gestão da sua instância é então apresentado. Clique no botão <code className="action">⁝</code> à direita de "Redes privadas" e em seguida em <code className="action">Associar uma rede</code>.
    ...
    <img className="thumbnail" alt="ligar rede" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack2021-01.png" loading="lazy" />
...
Na janela pop-up que aparece, selecione a(s) rede(s) privada(s) a ligar à sua instância e clique em <code className="action">Confirmar</code>.
    ...
    <img className="thumbnail" alt="ligar rede" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack9.png" loading="lazy" />
  </Tab>
  <Tab label="A partir das APIv6 OVHcloud">
    A ação consistirá apenas em adicionar uma nova interface de rede ao seu servidor, para além da existente.
...
Terá de preencher, no mínimo, os seguintes campos:
  ...
  <Tab label="A partir do OpenStack Horizon">
    ...
    <img className="thumbnail" alt="ligação Horizon" src="/images/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon1.png" loading="lazy" />
