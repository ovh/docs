...
### Instalar e configurar o Stormshield Network Security no seu ambiente Public Cloud <a id="step1"></a>
...
Aceda à [Área de Cliente OVHcloud](/links/manager), vá à secção `Public Cloud` e selecione o projeto Public Cloud em causa. No menu à esquerda, clique em `Instâncias` no separador **Compute** e encontre as suas duas instâncias SNS EVA.
...
#### Casos de utilização n°1: configurar o Stormshield Network Security para utilizar como gateway <a id="step2"></a>
...
#### Casos de utilização n°2: configurar um NAT (**N**etwork **A**ddress **T**translation) para aceder a um serviço HTTP privado a partir do exterior <a id="step3"></a>
...
#### Casos de utilização n°3: túnel IPsec (de site para site) <a id="step4"></a>
...
#### Casos de utilização n°4: VPN SSL/TLS (de cliente a site) <a id="step5"></a>
