...
- [Preparar o ambiente para utilizar a API OpenStack](/guides/public-cloud/public-cloud-cross-functional/compute-prepare-openstack-api-environment)
...
>>
>> ![Encomendar o vrack](/images/assets/screens/control-panel/product-selection/bare-metal-cloud/network/orderingvrack25.png)
>>
...
>>
>> ![adicionar o projeto](/images/guides/public-cloud/public-cloud-network-services/configuration-06-configure-ip-block-vrack-to-instance/addprojectvrack.png)
>>
...
![Criação de VLAN](/images/guides/public-cloud/public-cloud-network-services/configuration-06-configure-ip-block-vrack-to-instance/vrack2022-03.png)
...
![seleccionar região](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack5-2024.png)

Na etapa seguinte, são apresentadas-lhe várias opções:

![criar rede](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack6-2022.png)
...
- **Atribuir um Gateway e ligar-se à rede privada**: Selecione esta opção se tiver a intenção de criar instâncias com rede privada apenas. Para mais informações, convidamo-lo a consultar os seguintes guias: [Criar uma rede privada com uma Gateway](/guides/public-cloud/public-cloud-network-services/create-private-network-gateway) e [Criar uma primeira instância Public Cloud e ligar-se a ela](/guides/public-cloud/compute/compute-getting-started).
...
Consulte o guia "[Criar uma instância a partir do espaço cliente](/guides/public-cloud/compute/compute-getting-started)". Durante a criação de uma instância, pode escolher na etapa 5, um modo de rede e, em seguida, uma rede privada à qual integrar a sua instância.

![anexar nova instância](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/network-selection.png)
...
Inicie sessão na sua [Área de Cliente OVHcloud](/links/manager), aceda à secção `Public Cloud` e selecione o projeto Public Cloud relevante no canto superior esquerdo.
...
![detalhe instância](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/instance_details.png)
...
![ligar rede](/images/guides/public-cloud/public-cloud-network-services/configuration-06-configure-ip-block-vrack-to-instance/vrack2021-01.png)

Na janela pop-up que aparece, selecione a(s) rede(s) privada(s) a ligar à sua instância e clique em `Confirmar`.

![ligar rede](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/vrack9.png)
...
![ligação Horizon](/images/guides/public-cloud/public-cloud-network-services/getting-started-07-creating-vrack/horizon1.png)
...
Para adicionar uma interface, na coluna `Actions`, clique na seta que permite aceder às ações possíveis sobre a instância. Clique então em `Attach Interface`:
...
Para desligar uma interface de rede privada, na coluna `Actions`, clique na seta que permite aceder às ações possíveis sobre a instância. Clique então em `Detach Interface`:
