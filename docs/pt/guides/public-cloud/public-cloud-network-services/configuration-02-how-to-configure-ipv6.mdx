...
:::info
Atualmente, as ofertas Floating IP e Gateway não tomam a cargo o IPv6. O IPv6 só pode ser utilizado com as instâncias em [modo público](/guides/public-cloud/public-cloud-network-services/concepts-01-public-cloud-networking-concepts#publicmode/).
