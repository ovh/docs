...
- [Acesso administrativo à sua instância via SSH](/guides/public-cloud/compute/creating-ssh-keys-pci#login-linux/)
...
Se necessário, utilize o nosso [guia sobre as chaves SSH](/guides/public-cloud/compute/compute-creating-ssh-keys/) para criar um novo par de chaves SSH.  
Encontrará também informações sobre [a gestão de várias chaves](/guides/public-cloud/compute/creating-ssh-keys-pci#multiplekeys/) na sua estação de trabalho local, se a sua instalação o exigir.

### Etapa 2: configurar uma nova conta de utilizador

[Ligue-se à sua instância](/guides/public-cloud/compute/public-cloud-first-steps#connect-instance/) e utilize os comandos abaixo para criar uma nova conta de utilizador e uma pasta `.ssh`:
...
[Ligue-se à sua instância](/guides/public-cloud/compute/public-cloud-first-steps#connect-instance/) e abra, com o seu editor de texto preferido (`nano` é utilizado neste exemplo), o ficheiro `authorized_keys` na pasta pessoal do novo utilizador:
...
Consulte [manual sobre as chaves SSH](/guides/public-cloud/compute/compute-creating-ssh-keys/) i para saber mais sobre a utilização das chaves SSH com as instâncias Public Cloud.

## Quer saber mais?

[Como criar instâncias Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)

[Como substituir um par de chaves SSH numa instância Public Cloud pelo modo rescue](/guides/public-cloud/compute/replacing-lost-ssh-key/)
