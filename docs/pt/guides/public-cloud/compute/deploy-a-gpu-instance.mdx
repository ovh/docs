...
- [Uma chave SSH](/guides/public-cloud/compute/compute-creating-ssh-keys/) criada para criar uma instância GPU Linux.
...
A seguir, siga os passos restantes, conforme descrito em [este guia](/guides/public-cloud/compute/public-cloud-first-steps#create-instance/). Este processo pode levar alguns minutos.
