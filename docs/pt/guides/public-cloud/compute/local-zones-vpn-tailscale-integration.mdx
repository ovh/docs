...
- [Two Public Cloud instances](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/) deployed in different [OVHcloud Local Zones](https://www.ovhcloud.com/pt/public-cloud/local-zone-compute/) (we will use Prague and Madrid for this example).
