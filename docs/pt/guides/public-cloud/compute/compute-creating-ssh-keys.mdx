...
>
> Encontre mais informações no nosso [guia sobre a criação de uma instância Public Cloud](/guides/public-cloud/compute/compute-getting-started).
>
...
`Ed25519` é considerado o mais seguro mas `RSA` é uma alternativa válida. Ambos os métodos são compatíveis com a [Área de Cliente OVHcloud](/guides/public-cloud/compute/compute-getting-started).
...
Copie esta cadeia de chaves para [adicioná-la a uma nova instância ou importá-la para a sua Área de Cliente](/guides/public-cloud/compute/compute-getting-started).
...
[Como criar e interligar-se a uma instância Public Cloud](/guides/public-cloud/compute/compute-getting-started)
