...
:::info
**Boa prática**: Para cargas de trabalho críticas, prefira uma [implantação multi-AZ](/guides/public-cloud/public-cloud-cross-functional/3az-ref-architecture/) para assegurar a resiliência e a continuidade do serviço.
...
Para instruções detalhadas sobre a criação e utilização de chaves SSH, consulte o guia [OVHcloud sobre SSH](/guides/public-cloud/compute/compute-creating-ssh-keys/).
...
:::info
**Boa prática**: Os backups não substituem uma [arquitetura resiliente](/guides/public-cloud/public-cloud-cross-functional/3az-ref-architecture/). Para ambientes críticos, combine os backups com a replicação multi-AZ para assegurar uma proteção máxima dos dados e uma disponibilidade otimizada do serviço.
...
Para mais detalhes sobre a configuração das redes Public Cloud, consulte o guia oficial [OVHcloud sobre redes](/guides/public-cloud/public-cloud-network-services/concepts-01-public-cloud-networking-concepts/).
...
Os Savings Plans ajudam-no a otimizar o seu orçamento enquanto mantém o desempenho e a fiabilidade do seu ambiente cloud. Para mais informações, consulte o guia oficial [OVHcloud sobre Savings Plans](/guides/public-cloud/public-cloud-cross-functional/savings-plans/).
...
- [Como criar uma instância Public Cloud e aceder a ela](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/)
