...
Aceda à [Área de Cliente OVHcloud](/links/manager), aceda à secção `Public Cloud` e selecione o projeto Public Cloud em questão. A seguir, clique em `Volume Snapshot` na barra de navegação da esquerda, na secção **Backup Storage**.

À direita do backup à sua escolha, clique no botão `...` e em `Criar um volume`.

![criar](/images/guides/public-cloud/compute/create-volume-from-snapshot/volume01.png)

Defina o nome e a capacidade deste novo disco e clique em `Criar o volume`.

![criar](/images/guides/public-cloud/compute/create-volume-from-snapshot/volume02.png)

A criação do disco pode levar alguns minutos, dependendo do seu tamanho.

### Associar o disco a uma instância

Depois de criar o disco, pode decidir associá-lo a uma instância. Para isso, clique em `Block Storage` na barra de navegação à esquerda, abaixo de **Backup Storage**.

À direita do volume à sua escolha, clique no botão `...` e em `Associar a instância`.

![associar volume](/images/guides/public-cloud/compute/create-volume-from-snapshot/volume03.png)

Selecione a instância e clique em `Confirmar` para associar o disco.

![associar volume](/images/guides/public-cloud/compute/create-volume-from-snapshot/volume04.png)

O processo de conexão do disco à sua instância vai então começar e pode levar alguns minutos.

![associar volume](/images/guides/public-cloud/compute/create-volume-from-snapshot/volume05.png)
