...
- [Criar uma instância a partir da Área de Cliente OVHcloud](/guides/public-cloud/public-cloud-cross-functional/create-a-public-cloud-project/).
- [Dispor de um acesso administrador à instância](/guides/public-cloud/compute/first-steps-with-public-cloud-instance/).
