...
Crie um novo par de chaves SSH no seu dispositivo local, seguindo as instruções da primeira parte do [guia de criação de uma chave SSH](/guides/public-cloud/compute/compute-creating-ssh-keys/).
...
Reinicie a instância no modo "normal" a partir da [Área de Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt). Consulte as instruções do [manual sobre o modo rescue](/guides/public-cloud/compute/put-an-instance-in-rescue-mode/), se necessário.
