...
- Ter uma [instância Public Cloud](/guides/public-cloud/compute/compute-getting-started) com Debian ou Ubuntu instalado.
...
### Etapa 2: configuração do servidor de base de dados <a id="sqlconf"></a>
...
> 
> Em alternativa, a OVHcloud oferece-lhe a solução [SSL Gateway](/links/web/ssl-gateway). Para mais informações, consulte o [nosso manual](/guides/web-cloud/ssl-gateway/ssl-gateway-order).
> 
