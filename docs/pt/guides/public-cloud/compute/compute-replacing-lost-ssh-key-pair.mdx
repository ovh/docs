...
Reinicie a instância no modo "normal" a partir da [Área de Cliente OVHcloud](/links/manager). Consulte as instruções do [manual sobre o modo rescue](/guides/public-cloud/compute/put-an-instance-in-rescue-mode), se necessário.
