...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt) and add an Additional IP address to your [vRack](https://www.ovhcloud.com/pt/network/vrack/).
