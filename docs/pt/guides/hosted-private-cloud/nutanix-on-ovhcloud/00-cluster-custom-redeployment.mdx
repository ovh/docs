...
:::warning
If you have signed up to the **Nutanix on OVHcloud BYOL offer** and have activated licences on your cluster, you will need to uninstall your licences before you launch the redeployment. You can use this guide to manage your licences: [Manage licences in your Nutanix on OVHcloud BYOL Offer cluster](/guides/hosted-private-cloud/nutanix-on-ovhcloud/12-activate-licenses-on-byol/).
...
If you have subscribed to the Nutanix BYOL offer, a reminder will tell you not to forget to uninstall your licences. You can use this guide to manage your licences: [Manage licences in your Nutanix on OVHcloud BYOL Offer cluster](/guides/hosted-private-cloud/nutanix-on-ovhcloud/12-activate-licenses-on-byol/). When your licences are uninstalled, click <code className="action">Continue</code>.
...
[Manage licences in your Nutanix on OVHcloud BYOL Offer cluster](/guides/hosted-private-cloud/nutanix-on-ovhcloud/12-activate-licenses-on-byol/)
