...
![Horizon shortcut location](/images/guides/hosted-private-cloud/opcp/opcp-getting-started/dashboard_login_horizon.png)

Once you have logged in, the Horizon OpenStack interface looks like this:

![Horizon OpenStack interface](/images/guides/hosted-private-cloud/opcp/opcp-getting-started/horizon_dashboard.png)
...
![OpenStack Horizon interface menu](/images/guides/hosted-private-cloud/opcp/opcp-getting-started/horizon_menu.png)
...
![Screen capture of the Overview section](/images/guides/hosted-private-cloud/opcp/opcp-getting-started/horizon_project_overview.png)
...
- ***Limit Summary**: The quota limits assigned to the project for each resource type. You can also view resource consumption in relation to available capacity.
    ...
    ![Limit Summary section screenshot](/images/guides/hosted-private-cloud/opcp/opcp-getting-started/horizon_quota_categories.png)
...
- ***Compute** which includes instance limits, vCPUs and RAM.
    ...
    ![Screenshot of the Usage Summary section](/images/guides/hosted-private-cloud/opcp/opcp-getting-started/horizon_quota_historical.png)
...
![Screenshot of the Instances section](/images/guides/hosted-private-cloud/opcp/opcp-getting-started/horizon_instance_list.png)
...
![Screenshot from Images section](/images/guides/hosted-private-cloud/opcp/opcp-getting-started/horizon_image_list.png)
...
![Screenshot of the Key Pairs section](/images/guides/hosted-private-cloud/opcp/opcp-getting-started/horizon_sshkey_list.png)
...
![Network Topology section screenshot](/images/guides/hosted-private-cloud/opcp/opcp-getting-started/horizon_network_topology.png)

##### Networks section

This section contains the list of networks available for dedicated servers on your **OPCP**.

![Screenshot from the Networks section](/images/guides/hosted-private-cloud/opcp/opcp-getting-started/horizon_network_list.png)
