...
<img className="thumbnail" alt="Gateway Hosted Private Cloud" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/utilisation-2FA/gatewayPCC.jpg" loading="lazy" />
...
<img className="thumbnail" alt="Ler o QRcode" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/utilisation-2FA/scanQRcode.png" loading="lazy" />
...
<img className="thumbnail" alt="Ligação 2FA" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/utilisation-2FA/2FAtoken.png" loading="lazy" />
...
Essas aplicações devem ser previamente autorizadas através da política de acesso ao vCenter, que é configurável na [Área de Cliente](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/manager-ovh-private-cloud#securite/).
