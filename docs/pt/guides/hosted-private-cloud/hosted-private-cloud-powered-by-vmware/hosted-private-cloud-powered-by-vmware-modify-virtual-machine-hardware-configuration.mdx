...
Todas as modificações abaixo descritas devem ser realizadas a partir do seu Hosted Private Cloud em vSphere, clicando com o botão direito do rato numa máquina virtual e na opção `Modificar os parâmetros`.

![Edição de recursos](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware01.png)

Neste menu, tem a possibilidade de aumentar os recursos da sua máquina virtual. 

![Edição de recursos](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware02.png)
...
![Adicionar uma CPU](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware03.png)
...
Se selecionar a opção `Enable CPU Hot add`, poderá modificar esses valores quando a máquina virtual for iniciada.
...
![Adição de memória](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware04.png)
...
![Adição de armazenamento](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware05.png)
...
![Adição da rede](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware06.png)

Esta interface é interessante em caso de avaria da rede. Pode assegurar que a *porta ID* corresponde à porta indicada no separador `Networking` e `Ports` na placa em questão.

### Leitor CD/DVD

O leitor CD/DVD permite, por exemplo, a montagem de imagens ISO na sua máquina virtual.

![Adição de um leitor CD/DVD](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware07.png)
...
![Adição de periféricos](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/modify-hardware-configuration-of-vm/hardware08.png)
