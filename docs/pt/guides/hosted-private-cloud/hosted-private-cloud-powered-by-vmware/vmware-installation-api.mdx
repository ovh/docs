...
Aqui, iremos utilizar uma VM instalada em Debian 9, implementada através dos [templates disponibilizados no seu Hosted Private Cloud](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ovf-template/).
...
Aqui, iremos utilizar uma VM instalada em Ubuntu 18.04, implementada através dos [templates disponibilizados no seu Hosted Private Cloud](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ovf-template/).
