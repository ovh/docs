...
<img className="thumbnail" alt="Esquema HA" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HA3.png" loading="lazy" />
...
A desativação é necessária para a realização de operações de atualização com o [Update Manager](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-update-manager/), por exemplo. Neste caso específico, o host é isolado.

<img className="thumbnail" alt="Ativação HA" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HA.png" loading="lazy" />
...
<img className="thumbnail" alt="Falha do host" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam1.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Isolamento do host" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam2.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Datastore com PDL" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam3.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Datastore com APD" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam4.PNG" loading="lazy" />

##### Monitorização das máquinas virtuais

A monitorização das MV passa a estar disponível após a instalação das [VMware Tools](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-tools-install/).
...
<img className="thumbnail" alt="Monitorização das MV" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/HAparam5.PNG" loading="lazy" />
