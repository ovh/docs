...
- Follow the [dedicated guide](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/autoriser-des-ip-a-se-connecter-au-vcenter/) to whitelist the IP addresses of your source infrastructure and Veeam components.
- To enable access without triggering 2FA on Veeam components, refer to the *Application access permission* section of [this guide](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/utilisation-2fa/).
...
To learn how to set up local users and activate two-factor authentication, follow [this documentation](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/).
...
To get started with NSX-T in your HPC, refer to the [NSX first steps guide](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/nsx-01-first-steps/).
...
- [Configure IPsec VPN with NSX](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/nsx-12-configure-ipsec/)
...
:::warning
SNC environments require SPNs (Security Provider Names). Learn more in [this connectivity guide](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/snc-connectivity-concepts-vpn-spn/).
...
Learn more in the [Storage vMotion guide](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-storage-vmotion/).
