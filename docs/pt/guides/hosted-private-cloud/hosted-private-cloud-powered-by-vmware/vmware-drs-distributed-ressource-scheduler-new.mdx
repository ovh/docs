...
<img className="thumbnail" alt="Princípio do DRS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs0.png" loading="lazy" />
...
<img className="thumbnail" alt="Ativação do DRS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs01.png" loading="lazy" />
...
<img className="thumbnail" alt="Automatização DRS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs02.png" loading="lazy" />
...
<img className="thumbnail" alt="Opções adicionais DRS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs03.png" loading="lazy" />
...
<img className="thumbnail" alt="Opções avançadas DRS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs05.png" loading="lazy" />

### Regras DRS

Encontrará no separador `Configurar` a gestão das regras relativas a MV/hosts.

<img className="thumbnail" alt="Regras DRS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs06.png" loading="lazy" />
...
A quarta regra, «Máquinas virtuais a máquinas virtuais», encontra-se explicada no guia sobre a [função HA](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-ha-high-availability/).

<img className="thumbnail" alt="Criação de regras DRS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs07.png" loading="lazy" />
