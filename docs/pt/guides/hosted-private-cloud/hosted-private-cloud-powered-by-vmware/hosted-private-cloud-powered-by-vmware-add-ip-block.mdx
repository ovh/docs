...
Para encomendar um bloco IP adicional para o seu **Hosted Private Cloud**, aceda à sua Área de Cliente OVHcloud. Na secção `Hosted Private Cloud`, clique na opção `IP` no menu à esquerda e, a seguir, clique em `Encomendar IP adicionais`. De seguida, selecione o seu **Hosted Private Cloud** no menu pendente antes de passar para o seguinte passo.
...
![campo nexthop](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ajout-de-bloc-ip/move-api.png)

O resultado terá este formato:

![campo nexthop](/images/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/ajout-de-bloc-ip/api-result.png)
...
Poderá acompanhar a transferência do bloco IP na sua [Área de Cliente OVHcloud](/links/manager) na secção `Hosted Private Cloud` > `Private Cloud`. Clique no seu serviço Hosted Private Cloud e, depois, no separador `Operações`.
...
O IP aparecerá depois no `Endereços IP em Parking`.
