...
- Ter acesso à [Área de Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt) ou à [interface de administração dos seus serviços através da API](https://eu.api.ovh.com/).

## Instruções

:::tip[Success]
Os e-mails enviados pela OVHcloud também estão acessíveis a partir do seu [Área de Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt).<br/>
...
Aceda à [Área de Cliente OVHcloud](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt) com uma conta de administrador.
...
<img className="thumbnail" alt="alteração horária" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/maintenance-rescheduling/maintenance-date-edition01.png" loading="lazy" />
...
<img className="thumbnail" alt="alteração horária" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/maintenance-rescheduling/maintenance-date-edition02.png" loading="lazy" />
