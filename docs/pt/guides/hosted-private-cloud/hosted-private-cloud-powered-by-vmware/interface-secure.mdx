...
Tenha em conta que também é possível atribuir esta autorização a outros utilizadores através da Área de Cliente OVHcloud. Se necessário, consulte a nossa [Apresentação da Área de Cliente Private Cloud OVHcloud](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/manager-ovh-private-cloud/)
...
<img className="thumbnail" alt="Primeira SMS" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/SMS1.png" loading="lazy" />
...
- uma ligação que permite validar a operação (atenção: se o seu telefone não estiver ligado a uma rede cujo [o endereço IP](/guides/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/manager-ovh-private-cloud#seguranca/) não foi autorizado, a página não aparecerá).
...
<img className="thumbnail" alt="Validação da operação" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/operationValidation.png" loading="lazy" />
...
<img className="thumbnail" alt="Token da operação" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/operationIdAndToken.png" loading="lazy" />
...
<img className="thumbnail" alt="Alterar palavra-passe" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/changePassword.png" loading="lazy" />
...
<img className="thumbnail" alt="Definir a palavra-passe" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/defineNewPassword.png" loading="lazy" />
...
<img className="thumbnail" alt="Palavra-passe perdida" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/passwordLost.png" loading="lazy" />
...
<img className="thumbnail" alt="Informações utilizador" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/infoUser.png" loading="lazy" />
...
<img className="thumbnail" alt="Token e palavra-passe" src="/images/hosted-private-cloud/hosted-private-cloud-powered-by-vmware/interface-secure/tokenAndPassword.png" loading="lazy" />
