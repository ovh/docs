---
title: Layer 3 mode
description: Details about using Layer 3 (L3) with OVHcloud Connect
...
<img className="thumbnail" alt="L3 Implementation" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-implementation.png" loading="lazy" />
...
<img className="thumbnail" alt="L3 Rules" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-rules.gif" loading="lazy" />
...
<img className="thumbnail" alt="L3 Architecture" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-architecture.png" loading="lazy" />
...
<img className="thumbnail" alt="L3 BGP vRack" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-bgpvrack.png" loading="lazy" />

At a more global level, BGP topology will look like this:

<img className="thumbnail" alt="L3 BGP Global Topology" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-bgpglobal.png" loading="lazy" />
...
<img className="thumbnail" alt="L3 BGP as-prepend" src="/images/network/ovhcloud-connect/occ-layer3/occ-l3-bgpasprepend-med.png" loading="lazy" />
