...
![Criação de um certificado SSL](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/ssl_in_progress.png)
...
![SSL validado](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/ssl_validated.png)

### Adicionar o seu próprio certificado

- Se ainda não adicionou um domínio ou não possui nenhum certificado, pode utilizar a opção `Adicionar o meu certificado` a partir da janela SSL da sua CDN:

![Adicionar um Certificado SSL](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/add_ssl.png)

- Se já possui um certificado Let's Encrypt, pode simplesmente utilizar a opção `Substituir pelo meu certificado`:

![Substituição de um certificado SSL](/images/guides/network/content-delivery-network-infrastructure/ssl-certificate/change_ssl.png)
