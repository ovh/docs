...
Para isso, aceda à [Área de Cliente OVH](https://www.ovh.com/auth/?onsuccess=https://manager.eu.ovhcloud.com/&from=https://www.ovh.pt/&ovhSubsidiary=pt), na janela <code className="action">Serviços Dedicados</code> selecione a opção <code className="action">NAS e CDN</code>.
