...
Para isso, aceda à [Área de Cliente OVH](/links/manager), na janela `Serviços Dedicados` selecione a opção `NAS e CDN`.

A seguir, clique em `Adicionar domínio à CDN`.

![Área de Cliente CDN](/images/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/cdn_customer_panel.png)

No passo 1, poderá escolher o subdomínio que quer adicionar à CDN.

![Adicionar um subdomínio à CDN](/images/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_1.png)
...
![Adicionar um backend](/images/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_2.png)
...
![Nome da imagem](/images/guides/network/content-delivery-network-infrastructure/first-domain-name-configuration/cname_field.png)
