...
Esta operação, chamada **vMotion**, é descrita [neste manual](vmware_vmotion_new1.).

![escolha vMotion](VmotionStorage2.png){.thumbnail}
...
Assim, poderá aplicar as políticas de armazenamento criadas se dispuser da opção [VMencryption](vm_encrypt2.).

![escolha datastore](VmotionStorage3.png){.thumbnail}
...
![finalizar vMotion](VmotionStorage4.png){.thumbnail}
...
![seguimento vMotion](VmotionStorage5.png){.thumbnail}
