...
![move disk](VmotionStorage1.png){.thumbnail}
...
The option "Change compute resource only" allows to migrate the VM to another host. It is explained in [this guide](vmware_vmotion_new1.).

![choose vMotion](VmotionStorage2.png){.thumbnail}
...
For example, you can apply the storage policies created if you have the [VMencryption](vm_encrypt1.) option.

![choose datastore](VmotionStorage3.png){.thumbnail}
...
![finalise vMotion](VmotionStorage4.png){.thumbnail}
...
![tracking vMotion](VmotionStorage5.png){.thumbnail}
