...
![Festplatte verlagern](VmotionStorage1.png){.thumbnail}
...
Diese Aktion wird **vMotion** genannt und in [dieser Anleitung beschrieben](vmware_vmotion_new1.).

![Auswahl bei vMotion](VmotionStorage2.png){.thumbnail}
...
Sie können die bereits definierten Richtlinien zur Speicherung anwenden, wenn Sie die Option [VMencryption](vm_encrypt1.) nutzen.

![Wahl des Datastores](VmotionStorage3.png){.thumbnail}
...
![vMotion Datastore](VmotionStorage6.png){.thumbnail}

### vMotion abschließen

Klicken Sie auf `Finish`{.action}, um den Migrationsprozess zu starten.

![vMotion abschließen](VmotionStorage4.png){.thumbnail}
...
![Nachverfolgung von vMotion](VmotionStorage5.png){.thumbnail}
