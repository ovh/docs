...
![déplacer disque](VmotionStorage1.png){.thumbnail}
...
Cette opération appelé **vMotion** est décrit dans [ce guide](vmware_vmotion_new1.).

![choix de vMotion](VmotionStorage2.png){.thumbnail}
...
Ainsi, vous pouvez appliquer les politiques de stockage créées si vous disposez d'un de l'option [VMencryption](vm_encrypt1.).

![choix datastore](VmotionStorage3.png){.thumbnail}
...
![finaliser le vMotion](VmotionStorage4.png){.thumbnail}
...
![suivi de vMotion](VmotionStorage5.png){.thumbnail}
