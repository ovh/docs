...
![Migrar disco](VmotionStorage1.png){.thumbnail}
...
Para más información sobre la operación **vMotion**, consulte nuestra [guía](vmware_vmotion_new1.).

![Selección de vMotion](VmotionStorage2.png){.thumbnail}
...
De este modo, si dispone de la opción [VM encryption](vm_encrypt2.), podrá aplicar las políticas de almacenamiento creadas.

![Selección del datastore](VmotionStorage3.png){.thumbnail}
...
![Completar la operación vMotion](VmotionStorage4.png){.thumbnail}
...
![Monitorizar la operación vMotion](VmotionStorage5.png){.thumbnail}
