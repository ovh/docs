...
![SFTP Verbindung](connection_sftp_filezilla_log.png){.thumbnail}

Nach hergestellter Verbindung sehen Sie links Ihren lokalen Terminal und rechts Ihre Datastores:

![Verbindung per SFTP mit FileZilla](connection_sftp_filezilla.png){.thumbnail}
...
![SFTP Verbindung per vSphere](sftpconnection.png){.thumbnail}
