...
![Connexion SFTP](connection_sftp_filezilla_log.png){.thumbnail}

Una vez conectado, su equipo local aparecerá a la izquierda y los datastores a la derecha:

![Conexión por SFTP con FileZilla](connection_sftp_filezilla.png){.thumbnail}
...
![Conexión SFTP a través de vSphere](sftpconnection.png){.thumbnail}
