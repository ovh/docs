...
![Ligação SFTP](connection_sftp_filezilla_log.png){.thumbnail}

Depois de conectado, poderá ver a sua máquina local à esquerda, e os seus datastores à direita:

![Ligação em SFTP com FileZilla](connection_sftp_filezilla.png){.thumbnail}
...
![Ligação SFTP via vSphere](sftpconnection.png){.thumbnail}
