...
![Connessione SFTP](connection_sftp_filezilla_log.png){.thumbnail}

Una volta effettuato l’accesso, le cartelle locali saranno disponibili sulla sinistra e i datastore sulla destra:

![Connessione in SFTP con FileZilla](connection_sftp_filezilla.png){.thumbnail}
...
![Connessione SFTP via vSphere](sftpconnection.png){.thumbnail}
