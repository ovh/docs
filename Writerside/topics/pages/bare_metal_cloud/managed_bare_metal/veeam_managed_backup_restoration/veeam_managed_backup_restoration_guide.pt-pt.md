...
- [Veeam Managed Backup ativado](veeam_backup_as_a_service2.) na sua oferta Hosted Private Cloud

## Instruções

Se não está habituado ao funcionamento das API OVHcloud, consulte o nosso guia [Primeiros passos com as API OVHcloud](first-steps1.).
