...
![Fingerprint del certificato](certificate_thumbprints_01.png){.thumbnail}

![Fingerprint del certificato](certificate_thumbprints_02.png){.thumbnail}
...
![Spazio Cliente OVHcloud](vm-encrypt_nupanel_01.png){.thumbnail}
...
![Server KMS](vm-encrypt_manager_03.png){.thumbnail}
...
![Server KMS](vm-encrypt_manager_04.png){.thumbnail}
...
![Procedura di aggiunta KMS](vm-encrypt_01.png){.thumbnail}
...
![Importazione certificato KMS](vm-encrypt_02.png){.thumbnail}

#### Verifica la configurazione del KMS

In **Connection Status**, verifica che lo stato del KMS risulti in modalità “Normal”.

![Verifica lo stato della connessione](vm-encrypt_03.png){.thumbnail}
...
![VM Encryption Storage](vm-encrypt_04.png){.thumbnail}

Seleziona i file della macchina virtuale e dei dischi da cifrare.

![VM Encryption Storage](vm-encrypt_05.png){.thumbnail}
...
![vMotion cifrato](vm-encrypt_06.png){.thumbnail}
...
![Verifica della configurazione](vm-encrypt_07.png){.thumbnail}

![Verifica della configurazione](vm-encrypt_08.png){.thumbnail}

![Verifica della configurazione](vm-encrypt_09.png){.thumbnail}
