...
- Have a [Managed Bare Metal](https://www.ovhcloud.com/en-gb/managed-bare-metal/){.external} offer.
...
![](certificate_thumbprints_01.png){.thumbnail}

![](certificate_thumbprints_02.png){.thumbnail}
...
![controlpanel](vm-encrypt_manager_04.png){.thumbnail}
...
![](vm-encrypt_07.png){.thumbnail}

![](vm-encrypt_08.png){.thumbnail}

![](vm-encrypt_09.png){.thumbnail}
