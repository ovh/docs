...
![Zertifikat-Thumbprint](certificate_thumbprints_01.png){.thumbnail}

![Zertifikat-Thumbprint](certificate_thumbprints_02.png){.thumbnail}
...
![OVHcloud Kundencenter](vm-encrypt_nupanel_01.png){.thumbnail}
...
![KMS-Server](vm-encrypt_manager_03.png){.thumbnail}
...
![KMS-Server](vm-encrypt_manager_04.png){.thumbnail}
...
![Vorgehensweise KMS hinzufügen](vm-encrypt_01.png){.thumbnail}
...
![KMS-Zertifikat importieren](vm-encrypt_02.png){.thumbnail}
...
![Connection Status überprüfen](vm-encrypt_03.png){.thumbnail}
...
![Verschlüsseltes vMotion](vm-encrypt_06.png){.thumbnail}
...
![Konfiguration überprüfen](vm-encrypt_07.png){.thumbnail}

![Konfiguration überprüfen](vm-encrypt_08.png){.thumbnail}

![Konfiguration überprüfen](vm-encrypt_09.png){.thumbnail}
