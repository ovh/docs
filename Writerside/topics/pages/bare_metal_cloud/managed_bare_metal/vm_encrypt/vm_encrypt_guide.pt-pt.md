...
![Thumbprint do certificado](certificate_thumbprints_01.png){.thumbnail}

![Thumbprint do certificado](certificate_thumbprints_02.png){.thumbnail}
...
![Área de Cliente OVHcloud](vm-encrypt_nupanel_01.png){.thumbnail}
...
![Adicionar KMS](vm-encrypt_01.png){.thumbnail}
...
![Encriptação do vMotion](vm-encrypt_06.png){.thumbnail}
...
![Verificação da configuração ](vm-encrypt_07.png){.thumbnail}

![Verificação da configuração ](vm-encrypt_08.png){.thumbnail}

![Verificação da configuração ](vm-encrypt_09.png){.thumbnail}
