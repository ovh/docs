...
![empreinte du certificat](certificate_thumbprints_01.png){.thumbnail}

![empreinte du certificat](certificate_thumbprints_02.png){.thumbnail}
...
![espace client OVHcloud](vm-encrypt_nupanel_01.png){.thumbnail}
...
![procédure ajout clé KMS](vm-encrypt_01.png){.thumbnail}
...
![Zaszyfrowany vMotion](vm-encrypt_06.png){.thumbnail}
...
![vérification de la configuration](vm-encrypt_07.png){.thumbnail}

![vérification de la configuration](vm-encrypt_08.png){.thumbnail}

![vérification de la configuration](vm-encrypt_09.png){.thumbnail}
