...
![huella del certificado](certificate_thumbprints_01.png){.thumbnail}

![huella del certificado](certificate_thumbprints_02.png){.thumbnail}
...
![Área de cliente de OVHcloud](vm-encrypt_nupanel_01.png){.thumbnail}
...
![procedimiento añadir clave KMS](vm-encrypt_01.png){.thumbnail}
...
![vMotion cifrado](vm-encrypt_06.png){.thumbnail}
...
![comprobación de la configuración](vm-encrypt_07.png){.thumbnail}

![comprobación de la configuración](vm-encrypt_08.png){.thumbnail}

![comprobación de la configuración](vm-encrypt_09.png){.thumbnail}
