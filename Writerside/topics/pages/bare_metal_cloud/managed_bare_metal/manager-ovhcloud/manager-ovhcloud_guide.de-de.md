...
![Allgemeine Informationen](controlpanel1-e.png){.thumbnail}
...
![Allgemeine Informationen](controlpanel2-e.png){.thumbnail}
...
![Optionen](controlpanel3-e.png){.thumbnail}
...
![Optionen](controlpanel4-e.png){.thumbnail}

Weitere Informationen zur Kündigung eines Managed Bare Metal Dienstes finden Sie in unserer Anleitung [Managed Bare Metal kündigen](how-to-cancel1.).
...
![Benutzer](controlpanel6-e.png){.thumbnail}
...
![Benutzerrechte je Datacenter](controlpanel7-e.png){.thumbnail}
...
![Sicherheitseinstellungen](controlpanel8-e.png){.thumbnail}
...
Weitere Informationen zu dieser Option finden Sie in [dieser Anleitung](vm_encrypt1.).

#### Operationen

In diesem Tab finden Sie die aktuell auf Ihrer Infrastruktur ausgeführten Operationen:

![Operationen](controlpanel9-e.png){.thumbnail}
...
![Windows-SPLA-Lizenz](controlpanel10-e.png){.thumbnail}
...
![Datacenter-Ansicht](controlpanel11-e.png){.thumbnail}
...
Weitere Informationen zu dieser Option finden Sie in dieser [Anleitung](veeam_backup_as_a_service2.){.external} (Englisch).
