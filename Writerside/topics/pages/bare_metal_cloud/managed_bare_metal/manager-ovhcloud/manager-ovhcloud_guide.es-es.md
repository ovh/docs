...
![Información general](controlpanel1-e.png){.thumbnail}
...
![Información general](controlpanel2-e.png){.thumbnail}
...
![Opciones](controlpanel3-e.png){.thumbnail}
...
![Opciones](controlpanel4-e.png){.thumbnail}

Si desea más información sobre la cancelación del servicio Managed Bare Metal, consulte nuestra guía [Cómo dar de baja el servicio Managed Bare Metal](how-to-cancel1.).
...
![Usuarios](controlpanel6-e.png){.thumbnail}
...
![Permisos de usuario por datacenter](controlpanel7-e.png){.thumbnail}
...
![Configuración de seguridad](controlpanel8-e.png){.thumbnail}
...
Podrá encontrar más información al respecto en [esta guía](vm_encrypt1.).

#### Operaciones

En esta pestaña, aparecen las operaciones en curso en su infraestructura:

![Operaciones](controlpanel9-e.png){.thumbnail}
...
![Licencia SPLA Windows](controlpanel10-e.png){.thumbnail}
...
![Visualización del Datacenter](controlpanel11-e.png){.thumbnail}
...
Si desea más información sobre esta opción, puede consultar esta [guía](veeam_backup_as_a_service2.){.external}.
