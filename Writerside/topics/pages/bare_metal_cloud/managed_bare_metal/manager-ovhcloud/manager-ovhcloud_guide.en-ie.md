...
![General information](controlpanel1-e.png){.thumbnail}
...
![General information](controlpanel2-e.png){.thumbnail}
...
![Data centre](controlpanel5-e.png){.thumbnail}
...
![Users](controlpanel6-e.png){.thumbnail}
...
![User rights per data centre](controlpanel7-e.png){.thumbnail}
...
![Security settings](controlpanel8-e.png){.thumbnail}
...
You can find more details about this option in [this guide](vm_encrypt1.).

### Operations tab

This tab shows the history of tasks executed on your Managed Bare Metal service.

![Operations](controlpanel9-e.png){.thumbnail}
...
![Windows SPLA Licence](controlpanel10-e.png){.thumbnail}

You can find more information on the [pricing page](https://www.ovhcloud.com/en-ie/managed-bare-metal/options/).
...
![Data centre view ](controlpanel11-e.png){.thumbnail}
...
You can find more details about this option in [this guide](veeam_backup_as_a_service2.).
