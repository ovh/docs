...
![Informações gerais](controlpanel1-e.png){.thumbnail}
...
![Informações gerais](controlpanel2-e.png){.thumbnail}
...
![Opções](controlpanel3-e.png){.thumbnail}
...
![Opções](controlpanel4-e.png){.thumbnail}

Para mais informações sobre o cancelamento de um serviço Managed Bare Metal, consulte [este guia](how-to-cancel1.).
...
![Utilizadores](controlpanel6-e.png){.thumbnail}
...
![Permissões do utilizador por datacenter](controlpanel7-e.png){.thumbnail}
...
![Parâmetros de segurança](controlpanel8-e.png){.thumbnail}
...
Encontrará mais informações sobre essa opção [neste guia](vm_encrypt1.).

#### Operações

Neste separador, encontrará as operações em curso na sua infraestrutura:

![Operações](controlpanel9-e.png){.thumbnail}
...
![Licença SPLA Windows](controlpanel10-e.png){.thumbnail}
...
![Panorama Datacenter](controlpanel11-e.png){.thumbnail}
...
Para mais informações acerca desta opção, consulte [este guia](veeam_backup_as_a_service2.){.external}.
