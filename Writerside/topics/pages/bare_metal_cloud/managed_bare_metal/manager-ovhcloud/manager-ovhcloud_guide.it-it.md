...
![Informazioni generali](controlpanel1-e.png){.thumbnail}
...
![Informazioni generali](controlpanel2-e.png){.thumbnail}
...
![Opzioni](controlpanel3-e.png){.thumbnail}
...
![Opzioni](controlpanel4-e.png){.thumbnail}

Per maggiori dettagli sulla rescissione di un servizio Managed Bare Metal, consulta la nostra guida [Disattivare una soluzione Managed Bare Metal](how-to-cancel1.).
...
![Datacenter](controlpanel5-e.png){.thumbnail}
...
![Utenti](controlpanel6-e.png){.thumbnail}
...
![Permessi utente per datacenter](controlpanel7-e.png){.thumbnail}
...
![Parametri di sicurezza](controlpanel8-e.png){.thumbnail}
...
Per maggiori dettagli su questa opzione consulta [questa guida](vm_encrypt1.).

#### Operazioni

In questa scheda vengono mostrate le operazioni in corso sulla tua infrastruttura:

![Operazioni](controlpanel9-e.png){.thumbnail}
...
![Licenza SPLA Windows](controlpanel10-e.png){.thumbnail}
...
![Informazioni datacenter](controlpanel11-e.png){.thumbnail}
...
![Host](controlpanel12-e.png){.thumbnail}
...
![Datastore](controlpanel13-e.png){.thumbnail}
...
Per maggiori informazioni su questa opzione, consulta [questa guida](veeam_backup_as_a_service2.){.external}.
