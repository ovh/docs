...
![Registro CNAME](gatewayssl.png){.thumbnail}
...
![Registro CNAME](copylink.png){.thumbnail}
...
![Desplegar la plantilla](01selectdeploy.png){.thumbnail}
...
![Seleccionar la plantilla](02puturl.png){.thumbnail}

En la siguiente etapa, elija el datacenter.

![Elección del datacenter](03selectdatacenter.png){.thumbnail}

Seleccione a continuación el cluster en el que quiera desplegar la máquina virtual.

![Elección del cluster](04selectcluster.png){.thumbnail}
...
![Registro CNAME](sqlinformations.png){.thumbnail}
