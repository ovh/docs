...
- [active Windows licences](manager-ovhcloud#windows-licence-tab.) (activate via the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au){.external}, in the `Windows licence`{.action} tab for the datacentre)
