...
> [!primary]
>
> Welche IPs Ihres Blocks reserviert sind und wofür sie verwendet werden, können Sie in unserer Anleitung zum [OVHcloud Network Plugin](plugin_ovh_network1.){.external-link} nachlesen.
>
...
![Feld nexthop](move-api.png){.thumbnail}

Das Ergebnis wird wie folgt angezeigt:

![Feld nexthop](api-result.png){.thumbnail}
...
![Operationen Kundencenter](operations.png){.thumbnail}
