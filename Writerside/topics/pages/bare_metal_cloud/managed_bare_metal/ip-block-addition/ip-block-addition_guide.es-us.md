...
> [!primary]
>
> Para más información sobre las IP reservadas en su bloque y su utilización, consulte la siguiente guía: [Utilizar el plugin OVHcloud Network](plugin_ovh_network1.).
>
...
![campo nexthop](move-api.png){.thumbnail}

Obtendrá el siguiente resultado:

![campo nexthop](api-result.png){.thumbnail}
...
![operaciones manager](operations.png){.thumbnail}
