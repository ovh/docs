...
Se la [politica di accesso al vCenter è configurata come limitata](vcenter-modify-access-policy1.), è necessario aggiungere gli IP che saranno autorizzati a connettersi al servizio.
