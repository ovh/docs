...
Cuando [la política de acceso al vCenter está restringida](vcenter-modify-access-policy1.), es necesario añadir las direcciones IP autorizadas a conectarse al servicio.
