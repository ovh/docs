...
* [Attribuire il permesso "Aggiunta di risorse"](change-user-rights1.) per il datacenter in questione all'utente dallo[Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it){.external}.
...
![Aggiunta di un host](addhost_ess_01.png){.thumbnail}
