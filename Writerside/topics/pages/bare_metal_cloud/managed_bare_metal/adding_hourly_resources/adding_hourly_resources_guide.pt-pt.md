...
* Dar ao utilizador a autorização [“Adição de recursos”](change-user-rights1.){.external} quanto ao datacenter em causa a partir da [Área de Cliente OVH](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pt/&ovhSubsidiary=pt){.external}.
...
![Adicionar host](addhost_ess_01.png){.thumbnail}
