...
With our [Managed Bare Metal solutions](https://www.ovhcloud.com/en-au/managed-bare-metal/){.external}, you can add resources that are billed per hour of usage.
...
- [the "Add resources"](change-user-rights1.){.external} right for the datacentre concerned (this right is granted via the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au){.external})
