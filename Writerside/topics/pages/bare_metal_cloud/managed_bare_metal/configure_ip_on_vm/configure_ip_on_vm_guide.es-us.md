...
![Configuración en la OVHcloud Network](01config_ip_ovh_network.png){.thumbnail}
...
![Configuración avanzada en la OVH Network](02config_ip_ovh_network_advanced.png){.thumbnail}
...
![Configuración Windows](config_ip_windows.jpg){.thumbnail}
...
- una interfaz de VLAN (10 a 20 por defecto y relacionados con el vRack, puede crear más VLAN consultando [esta guía](vlan-creation1.)).
...
![IP privada en Linux](linux_private.PNG){.thumbnail}
...
![Configuración de Windows IP pública](windows_private.PNG){.thumbnail}
