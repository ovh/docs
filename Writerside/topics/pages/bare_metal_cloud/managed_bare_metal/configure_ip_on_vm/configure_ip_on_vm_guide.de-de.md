...
![Konfiguration auf OVHcloud Network](01config_ip_ovh_network.png){.thumbnail}
...
![Erweiterte Konfiguration im OVH Network](02config_ip_ovh_network_advanced.png){.thumbnail}
...
![Windows-Konfiguration](config_ip_windows.jpg){.thumbnail}
...
In den Adapter-Einstellungen können Sie VLAN konfigurieren (standardmäßig 10 bis 20 und mit vRack verbunden. Sie können mehr erstellen, indem Sie dieser [Anleitung](vlan-creation1.) folgen.)
...
![Private IP auf Linux](linux_private.PNG){.thumbnail}
...
![Öffentliche Windows-IP-Konfiguration](windows_private.PNG){.thumbnail}
