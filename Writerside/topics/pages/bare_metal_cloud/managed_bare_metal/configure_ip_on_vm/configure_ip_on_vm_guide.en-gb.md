...
![Configuration on the OVH Network](01config_ip_ovh_network.png){.thumbnail}
...
![Advanced configuration on the OVH Network](02config_ip_ovh_network_advanced.png){.thumbnail}
...
![IP Interface](config_ip_interfaces.jpg){.thumbnail}
...
![Configuration on Windows](config_ip_windows.jpg){.thumbnail}
...
- A VLAN interface (10 to 20 by default and linked to the vRack, you can create more by consulting [this guide](vlan-creation1.)).

In your virtual machine settings, you can use a VLAN :

![VLAN for SDDC](04vlanBis.png){.thumbnail}

![VLAN for SDDC](05vlan.png){.thumbnail}

#### Linux

Here is a configuration example on a Debian operating system:

![Private IP address on Linux](linux_private.PNG){.thumbnail}
...
![Configure a public IP address on Windows](windows_private.PNG){.thumbnail}
