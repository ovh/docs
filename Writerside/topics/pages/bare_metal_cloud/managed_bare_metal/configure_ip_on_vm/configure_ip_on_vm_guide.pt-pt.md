...
![Configuração OVHcloud Network](01config_ip_ovh_network.png){.thumbnail}
...
![Configuração avançada na OVH Network](02config_ip_ovh_network_advanced.png){.thumbnail}
...
![Configuração Windows](config_ip_windows.jpg){.thumbnail}
...
- uma interface VLAN (10 a 20 por predefinição e ligadas ao vRack, pode criar mais através [deste manual](vlan-creation1.)).
...
![IP privado em Linux](linux_private.PNG){.thumbnail}
...
![Configuração Windows IP público](windows_private.PNG){.thumbnail}
