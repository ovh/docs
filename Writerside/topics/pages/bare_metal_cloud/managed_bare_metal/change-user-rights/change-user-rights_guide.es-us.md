...
![Ver y modificar los permisos por DC](user_rights_1.png){.thumbnail}

Desde este menú, podrá modificar los permisos de sus usuarios vSphere por datacenter:

![Modificar los permisos](user_rights_2.png){.thumbnail}
...
![Modificar los permisos](user_rights_3.png){.thumbnail}
