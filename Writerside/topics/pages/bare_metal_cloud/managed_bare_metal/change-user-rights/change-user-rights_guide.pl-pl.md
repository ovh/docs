...
![Sprawdź / Zmień uprawnienia dla poszczególnych centrów danych](user_rights_1.png){.thumbnail}

W menu możesz dokonywać modyfikacji uprawnień użytkowników vSphere dla poszczególnych centrów danych:

![Zmiana uprawnień](user_rights_2.png){.thumbnail}
...
![Zmiana uprawnień](user_rights_3.png){.thumbnail}
