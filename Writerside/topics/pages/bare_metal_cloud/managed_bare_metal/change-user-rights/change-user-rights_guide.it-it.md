...
![Visualizza/Modifica i diritti per DC](user_rights_1.png){.thumbnail}

Dal menu a tendina è possibile modificare i diritti degli utenti vSphere per datacenter:

![Modificare i diritti](user_rights_2.png){.thumbnail}
...
![Modificare i diritti](user_rights_3.png){.thumbnail}
