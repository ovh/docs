...
![Die Rechte für jedes Rechenzentrum anzeigen / ändern](user_rights_1.png){.thumbnail}

In diesem Menü können Sie die Rechte Ihrer vSphere-Nutzer pro Rechenzentrum ändern:

![Die Rechte ändern](user_rights_2.png){.thumbnail}
...
![Die Rechte ändern](user_rights_3.png){.thumbnail}
