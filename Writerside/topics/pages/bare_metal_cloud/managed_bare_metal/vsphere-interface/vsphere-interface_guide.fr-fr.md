...
![Connexion à l'interface vSphere HTML5](connection_interface_w_html5.png){.thumbnail}

Vous accéderez ensuite à cette interface :

![Connexion à l'interface vSphere HTML5](vsphere-client-html5.png){.thumbnail}
...
![Connexion à l'interface vSphere](connection_interface_w.png){.thumbnail}
