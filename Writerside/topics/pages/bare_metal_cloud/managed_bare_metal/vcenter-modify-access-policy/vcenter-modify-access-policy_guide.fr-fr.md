...
> [!primary]
>
> Si vous avez défini la politique d'accès sur « Restreinte », consultez le guide [« Autoriser des IP à se connecter au vCenter »](vcenter-authorise-ip-access1.).
> 

## Aller plus loin

[Autoriser des IP à se connecter au vCenter](vcenter-authorise-ip-access1.)
