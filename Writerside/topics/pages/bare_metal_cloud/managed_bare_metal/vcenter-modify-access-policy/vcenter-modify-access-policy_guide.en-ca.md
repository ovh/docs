...
> [!primary]
>
> If you have set the access policy to "Restricted", follow up by consulting the guide on [Authorising IP addresses for vCenter access](vcenter-authorise-ip-access1.).
> 

## Go further

[Authorising IP addresses for vCenter access](vcenter-authorise-ip-access1.)
