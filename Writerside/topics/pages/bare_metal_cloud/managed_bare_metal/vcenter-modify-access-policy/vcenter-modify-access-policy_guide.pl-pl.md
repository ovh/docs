...
> [!primary]
>
> Jeśli wybierzesz politykę dostępu “Ograniczona", sprawdź przewodnik ["Autoryzacja IP, które mogą łączyć się z vCenter”](vcenter-authorise-ip-access1.).
> 

## Sprawdź również

[Autoryzacja IP, które mogą łączyć się z vCenter](vcenter-authorise-ip-access1.)
