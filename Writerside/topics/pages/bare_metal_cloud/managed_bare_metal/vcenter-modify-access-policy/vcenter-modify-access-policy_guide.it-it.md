...
![Configurazione politica di accesso](modifypolicy-01.png){.thumbnail}
...
![Configurazione politica di accesso](modifypolicy-02.png){.thumbnail}

> [!primary]
>
> Se la politica di accesso al vCenter è configurata come “Limitata”, consulta la guida [Autorizzare IP ad accedere al vCenter](vcenter-authorise-ip-access1.)
> 

## Per saperne di più

[Autorizzare IP ad accedere al vCenter](vcenter-authorise-ip-access1.)
