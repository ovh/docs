...
![Configurar la política de acceso](modifypolicy-01.png){.thumbnail}
...
![Configurar la política de acceso](modifypolicy-02.png){.thumbnail}

> [!primary]
>
> Si ha definido la política de acceso como «Restringida», consulte la guía [«Autorizar direcciones IP a conectarse al vCenter»](vcenter-authorise-ip-access1.).
> 

## Más información

[Autorizar direcciones IP a conectarse al vCenter](vcenter-authorise-ip-access1.)
