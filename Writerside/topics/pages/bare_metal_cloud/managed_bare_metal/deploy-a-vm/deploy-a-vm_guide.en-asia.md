...
- It is possible to create it and select an ISO from your datastore in the process. You can upload ISO files by connecting [via SFTP](sftp-connexion1.).
- You can deploy a VM from your own template, an external template or an [OVHcloud template](ovf_template2.).
...
![Choose a method](vm02.png){.thumbnail}
...
![VM location](vm03.png){.thumbnail}
...
![Choose resources](vm04.png){.thumbnail}
...
![Choose storage](vm05.png){.thumbnail}
...
![Choose compatibility](vm06.png){.thumbnail}
...
![Choose guest OS](vm07.png){.thumbnail}
...
![Choose network](vm08.png){.thumbnail}
...
![Connect ISO](vm10.png){.thumbnail}
...
![Starting VM](vm12.png){.thumbnail}
