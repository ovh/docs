...
![Deploy di una VM](vm01.png){.thumbnail}

Per creare una macchina virtuale è possibile scegliere tra diverse opzioni:

- Da un file ISO, disponibile nel datastore (per importarlo, consulta la [guida di connessione in SFTP](sftp-connexion1.)).
- Da un template personale o [fornito da OVHcloud](ovf_template2.).
...
![Scelta della modalità di creazione](vm02.png){.thumbnail}
...
![Localizzazione della macchina virtuale](vm03.png){.thumbnail}
...
![Scelta delle risorse](vm04.png){.thumbnail}
...
![Scelta dello storage](vm05.png){.thumbnail}
...
![Scelta della compatibilità](vm06.png){.thumbnail}
...
![Scelta del Guest OS](vm07.png){.thumbnail}
...
![Scelta della rete](vm08.png){.thumbnail}
...
![Scelta del file ISO](vm09.png){.thumbnail}
...
![Connettere ISO](vm10.png){.thumbnail}
...
![Riepilogo VM](vm11.png){.thumbnail}
