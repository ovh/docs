...
- A partir de un archivo ISO, disponible en su datastore y que para importarlo debe seguir las instrucciones en la [guía de conexión en SFTP](vsphere-interface1.).
- También puede instrumentar una máquina virtual a partir de una plantilla existente o una [plantilla de OVHcloud](ovf_template2.).
...
![choix de créations](vm02.png){.thumbnail}
...
![emplacement de la machine virtuelle](vm03.png){.thumbnail}
...
![choix des ressources](vm04.png){.thumbnail}
...
![choix du stockage](vm05.png){.thumbnail}
...
![choix compatibilité](vm06.png){.thumbnail}
...
![choix guest OS](vm07.png){.thumbnail}
...
![Choix du réseau](vm08.png){.thumbnail}
...
![Choix du fichier ISO](vm09.png){.thumbnail}
...
![Connecter ISO](vm10.png){.thumbnail}
...
![Récapitulatif VM](vm11.png){.thumbnail}
