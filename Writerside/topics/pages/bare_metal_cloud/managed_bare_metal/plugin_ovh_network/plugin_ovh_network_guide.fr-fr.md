...
![Network summary](ovhcloudplugin_01.png){.thumbnail}
...
![Information about IPs and blocks](ovhcloudplugin_02.png){.thumbnail}
...
![Edit Reverse button](ovhcloudplugin_03.png){.thumbnail}
