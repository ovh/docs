...
![Edição de recursos](hardware01.png){.thumbnail}

Neste menu, tem a possibilidade de aumentar os recursos da sua máquina virtual. 

![Edição de recursos](hardware02.png){.thumbnail}
...
![Adicionar uma CPU](hardware03.png){.thumbnail}
...
![Adição de memória](hardware04.png){.thumbnail}
...
![Adição de armazenamento](hardware05.png){.thumbnail}
...
![Adição da rede](hardware06.png){.thumbnail}
...
![Adição de um leitor CD/DVD](hardware07.png){.thumbnail}
...
![Adição de periféricos](hardware08.png){.thumbnail}
