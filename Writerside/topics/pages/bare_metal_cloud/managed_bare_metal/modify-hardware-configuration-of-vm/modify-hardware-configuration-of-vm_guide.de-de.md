...
![Ressourcen bearbeiten](hardware01.png){.thumbnail}

In diesem Menü können Sie die Ressourcen Ihrer virtuellen Maschine erweitern. 

![Ressourcen bearbeiten](hardware02.png){.thumbnail}
...
![CPU hinzufügen](hardware03.png){.thumbnail}
...
![Arbeitsspeicher hinzufügen](hardware04.png){.thumbnail}
...
![Speicherplatz hinzufügen](hardware05.png){.thumbnail}
...
![Netzwerk hinzufügen](hardware06.png){.thumbnail}
...
![CD/DVD-Laufwerk hinzufügen](hardware07.png){.thumbnail}
...
![Geräte hinzufügen](hardware08.png){.thumbnail}
