...
> [!primary]
>
> Should you choose to migrate an infrastructure to a new vDC instead, please follow [this dedicated guide](service-migration-vdc1.).
>
...
To do this, please refer to our guides on [Changing user rights](change-user-rights1.), [Changing the User Password](changer-user-password1.) and [Associating an email with a vSphere user](vsphere-edit-user1.).
...
Please refer to our guide on [Enabling Virtual Machine Encryption](vm_encrypt1.) in order to enable KMS on the destination Managed Bare Metal.
...
As part of a migration process, you can link your Managed Mare Metal services within the same vRack. Please consult our guide to [Using Managed Bare Metal within a vRack](using-vrack1.).
...
Please consult our guide to [Migrate an IP block between two Managed Bare Metal services](ip-block-addition#migrate-an-ip-block-between-two-managed-bare-metal-solutions.).
...
The migration involves reconfiguring VMware High Availability (HA), including boot order and priority. Please consult our guide about [VMware HA configuration](vmware_ha_high_availability1.).
...
The migration involves reconfiguring the VMware Distributed Resource Scheduler (DRS) feature, in particular the affinity or anti-affinity rules for groups of hosts and VMs. Please consult our guide about [configuring VMware DRS](vmware_drs_distributed_ressource_scheduler1.).
...
Please refer to our guide on [activating and using Veeam Managed Backup](veeam_backup_as_a_service2.).
...
- A [Veeam Backup & Replication](veeam_veeam_backup_replication1.) virtual machine on the source infrastructure
- [Authorising the Veeam Backup & Replication virtual machine to connect](vcenter-authorise-ip-access1.) to the source and destination vCenter
