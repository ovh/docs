...
On this switch, 11 VLANs are created as standard (VLAN10 to VLAN20). By giving the `administrator` right on `Access to the V(x)LAN` in [the users management tab of your Control Panel](manager-ovhcloud#users-tab.), you can create additional VLANs.
...
![nominate portgroup](09network2.png){.thumbnail}
...
![portgroup configuration](10network3.png){.thumbnail}
...
![security settings](11network4.png){.thumbnail}
...
![traffic shaping](12network5.png){.thumbnail}
