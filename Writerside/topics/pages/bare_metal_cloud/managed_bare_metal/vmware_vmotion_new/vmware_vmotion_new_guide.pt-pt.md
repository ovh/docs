...
![mover máquina virtual](Vmotion1.png){.thumbnail}
...
A opção “Change storage only” permite migrar a máquina virtual para outro datastore. Esta operação, chamada **Storage vMotion**, é descrita [neste manual](vmware_storage_vmotion1.).

![escolha do tipo de vMotion](Vmotion2.png){.thumbnail}
...
![escolha do recurso](Vmotion3.png){.thumbnail}
...
![escolha da rede](Vmotion4.png){.thumbnail}
...
![escolha da prioridade](Vmotion5.png){.thumbnail}

### Finalizar o vMotion

Clique em `Finish`{.action} para lançar o procedimento de migração.

![finalizar vMotion](Vmotion6.png){.thumbnail}
...
![seguimento do vMotion](Vmotion7.png){.thumbnail}
