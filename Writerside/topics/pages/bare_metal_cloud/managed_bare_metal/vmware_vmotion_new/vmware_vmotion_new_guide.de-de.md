...
![Eine virtuelle Maschine verlagern](Vmotion1.png){.thumbnail}
...
Mit der Option “Change storage only” können Sie die virtuelle Maschine in einen anderen Datastore verlegen. Diese Aktion wird **Storage vMotion** genannt und in [dieser Anleitung beschrieben](vmware_storage_vmotion1.).

![Wahl des vMotion-Typs](Vmotion2.png){.thumbnail}
...
![Wahl der Ressource](Vmotion3.png){.thumbnail}
...
![Wahl des Netzwerks](Vmotion4.png){.thumbnail}
...
![Wahl der Priorität](Vmotion5.png){.thumbnail}

### vMotion abschließen

Klicken Sie auf `Finish`{.action} , um den Migrationsprozess zu starten.

![vMotion abschließen](Vmotion6.png){.thumbnail}
...
![vMotion nachverfolgen](Vmotion7.png){.thumbnail}
