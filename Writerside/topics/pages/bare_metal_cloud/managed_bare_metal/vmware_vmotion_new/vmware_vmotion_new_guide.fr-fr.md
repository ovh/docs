...
![déplacer machine virtuelle](Vmotion1.png){.thumbnail}
...
L'option « Modifier uniquement le stockage » permet de migrer la machine virtuelle sur une autre banque de données. Cette opération appelé **Storage vMotion** est décrit dans [ce guide](vmware_storage_vmotion1.).

![choix du type de vMotion](Vmotion2.png){.thumbnail}
...
![choix de la ressource](Vmotion3.png){.thumbnail}
...
![choix du réseau](Vmotion4.png){.thumbnail}
...
![suivi du vMotion](Vmotion7.png){.thumbnail}
