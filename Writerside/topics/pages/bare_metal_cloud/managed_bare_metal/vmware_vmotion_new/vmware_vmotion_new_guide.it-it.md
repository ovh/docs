...
![Spostare una macchina virtuale](Vmotion1.png){.thumbnail}
...
L’opzione “Change storage only” permette invece di migrare la VM su un altro datastore. Questa operazione, chiamata **Storage vMotion**, è descritta in [questa guida](vmware_storage_vmotion1.).

![Scelta del tipo di vMotion](Vmotion2.png){.thumbnail}
...
![Scelta della risorsa](Vmotion3.png){.thumbnail}
...
![Monitoraggio del vMotion](Vmotion7.png){.thumbnail}
