...
![Aktivierung von HA](HA.png){.thumbnail}
...
![Hostfehler](HAparam1.PNG){.thumbnail}
...
![Hostisolierung](HAparam2.PNG){.thumbnail}
...
![Datenspeicher mit PDL](HAparam3.PNG){.thumbnail}
...
![Datenspeicher mit APD](HAparam4.PNG){.thumbnail}

##### VM-Überwachung

Das Monitoring für virtuelle Maschinen ist nach Installation der [VMware Tools](vmware_tools_install1.) verfügbar.
...
![VM-Überwachung](HAparam5.PNG){.thumbnail}
