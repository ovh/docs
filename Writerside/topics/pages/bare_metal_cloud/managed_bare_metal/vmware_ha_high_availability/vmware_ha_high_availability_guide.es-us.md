...
![activación HA](HA.png){.thumbnail}
...
![Fallo del host](HAparam1.PNG){.thumbnail}
...
![aislamiento del host](HAparam2.PNG){.thumbnail}
...
![Almacén de datos con PDL](HAparam3.PNG){.thumbnail}
...
![Almacén de datos con APD](HAparam4.PNG){.thumbnail}

##### Supervisión de las MV

La supervisión de las máquinas virtuales está disponible después de instalar las [VMware tools](vmware_tools_install1.).
...
![Supervisión de las MV](HAparam5.PNG){.thumbnail}
