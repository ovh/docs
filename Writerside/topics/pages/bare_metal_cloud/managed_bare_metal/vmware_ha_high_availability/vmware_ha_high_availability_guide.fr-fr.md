...
![activation HA](HA.png){.thumbnail}
...
![panne de l'hôte](HAparam1.PNG){.thumbnail}
...
![isolation d'hôte](HAparam2.PNG){.thumbnail}
...
![banque de données avec PDL](HAparam3.PNG){.thumbnail}
...
![banque de données avec APD](HAparam4.PNG){.thumbnail}

##### Surveillance de VM

La surveillance des machines virtuelles est disponible suite à l'installation des [VMware tools](vmware_tools_install1.). 
...
![Surveillande de VM](HAparam5.PNG){.thumbnail}
