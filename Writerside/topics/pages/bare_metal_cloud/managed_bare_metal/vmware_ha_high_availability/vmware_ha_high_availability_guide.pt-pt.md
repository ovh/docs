...
![Falha do host](HAparam1.PNG){.thumbnail}
...
![Isolamento do host](HAparam2.PNG){.thumbnail}
...
![Datastore com PDL](HAparam3.PNG){.thumbnail}
...
![Datastore com APD](HAparam4.PNG){.thumbnail}

##### Monitorização das máquinas virtuais

A monitorização das MV passa a estar disponível após a instalação das [VMware Tools](vmware_tools_install1.).
...
![Monitorização das MV](HAparam5.PNG){.thumbnail}
