...
- Sie sind in Ihrem [vSphere Interface](vsphere-interface1.) angemeldet.
...
![Alarm erstellen](alarms01.png){.thumbnail}
...
![Name und Bezug der Alarmmeldung](alarms02.png){.thumbnail}
...
![Alarmregeln](alarms03.png){.thumbnail}
...
![Alarm beenden](alarms04.png){.thumbnail}
...
![Übersicht über die Alarmmeldung](alarms05.png){.thumbnail}
