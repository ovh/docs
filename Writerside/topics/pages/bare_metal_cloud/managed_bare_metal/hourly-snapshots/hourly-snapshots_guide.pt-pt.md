...
Recomendamos a utilização de uma solução completa de backup, como o nosso serviço [Veeam Backup](veeam_backup_as_a_service2.) ou qualquer outro sistema que realize um backup completo das suas máquinas virtuais.
