...
Le recomendamos que utilice una solución de backup completa, como nuestro servicio [Veeam Backup](veeam_backup_as_a_service2.) o cualquier otro sistema que realice un backup completo de sus máquinas virtuales.
