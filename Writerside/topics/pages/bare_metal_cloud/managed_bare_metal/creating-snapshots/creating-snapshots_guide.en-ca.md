...
- a user account with access to [vSphere](vsphere-interface1.) (created in the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca))
...
![Take snapshot](snapshot01.png){.thumbnail}
...
![Configure snapshot](snapshot02.png){.thumbnail}
...
![Create snapshots](snapshot03.png){.thumbnail}
...
![snapshots](consolidate.png){.thumbnail}
