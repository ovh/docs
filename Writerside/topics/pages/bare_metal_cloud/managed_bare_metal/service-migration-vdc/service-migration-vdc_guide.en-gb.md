...
Please refer to our guide on [Enabling Virtual Machine Encryption](vm_encrypt1.) in order to enable KMS on the destination vDC.
...
As part of a migration process, you can link your Managed Mare Metal services within the same vRack. Please consult our guide on how to [Using Managed Bare Metal within a vRack](using-vrack1.).
