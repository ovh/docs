...
![IPs hinzufügen](adding_ip.png){.thumbnail}
...
![Nutzereinstellungen](users_edit.png){.thumbnail}
...
![Sitzungstimeout](security-expiration.png){.thumbnail}

Geben Sie ein, nach wie vielen Minuten eine Sitzung beendet werden soll.

![Sitzungstimeout](expiration.png){.thumbnail}
