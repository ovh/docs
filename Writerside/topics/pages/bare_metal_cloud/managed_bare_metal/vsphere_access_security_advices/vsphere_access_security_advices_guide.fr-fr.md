...
![Ajout d'IP](adding_ip.png){.thumbnail}
...
![Utilisateurs](users.png){.thumbnail}
...
![Édition des paramètres des utilisateurs](users_edit.png){.thumbnail}
...
![Expiration de la session](security-expiration.png){.thumbnail}

Renseignez ensuite le nombre de minutes avant qu'une session expire.

![Expiration de la session](expiration.png){.thumbnail}
