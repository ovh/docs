...
![Adicionar IP](adding_ip.png){.thumbnail}
...
![Utilizadores](users.png){.thumbnail}
...
![Edição dos parâmetros dos utilizadores](users_edit.png){.thumbnail}
...
![Expiração da sessão](security-expiration.png){.thumbnail}

Indique o número de minutos antes que uma sessão expire.

![Expiração da sessão](expiration.png){.thumbnail}
