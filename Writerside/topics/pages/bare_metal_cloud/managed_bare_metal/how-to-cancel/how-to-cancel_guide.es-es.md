...
![Baja desde el área de cliente](images_resiliation1.png){.thumbnail}
...
![Confirmar la baja del servicio](images_resiliation2.png){.thumbnail}
...
![Confirmar la baja del servicio](images_resiliation3.png){.thumbnail}
...
![Confirmar la baja del servicio](images_resiliation4.png){.thumbnail}
