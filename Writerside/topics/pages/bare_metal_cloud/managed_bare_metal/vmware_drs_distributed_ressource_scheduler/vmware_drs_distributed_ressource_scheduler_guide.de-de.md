...
![Prinzip des DRS](drs0.png){.thumbnail}
...
![DRS aktivieren](drs01.png){.thumbnail}
...
![DRS-Automatisierung](drs02.png){.thumbnail}
...
![Weitere DRS-Optionen](drs03.png){.thumbnail}
...
![Erweiterte DRS-Optionen](drs05.png){.thumbnail}

### DRS-Regeln

Im Tab `Konfigurieren` finden Sie die Verwaltung der VM/Host-Regeln.

![DRS-Regeln](drs06.png){.thumbnail}
...
Die vierte Regel, “Virtuelle Maschinen zu virtuelle Maschinen”, wird in unserer Anleitung zur [HA-Funktion](vmware_ha_high_availability1.) erklärt (Englisch).

![DRS-Regeln erstellen](drs07.png){.thumbnail}
