...
![Principio del DRS](drs0.png){.thumbnail}
...
![Activación del DRS](drs01.png){.thumbnail}
...
![Automatización DRS](drs02.png){.thumbnail}
...
![Opciones adicionales DRS](drs03.png){.thumbnail}
...
![opciones avanzadas drs](drs05.png){.thumbnail}

### Reglas DRS

Para gestionar las reglas de MV/host, diríjase a la pestaña `Configurar`.

![reglas drs](drs06.png){.thumbnail}
...
La cuarta regla, «máquinas virtuales a máquinas virtuales», viene explicada en nuestra guía sobre la [funcionalidad HA](vmware_ha_high_availability1.).

![creación reglas drs](drs07.png){.thumbnail}
