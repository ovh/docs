...
>
> Jeśli nie posiadasz lokalnego użytkownika, [musisz go utworzyć](changing_root_password_linux_ds1.).
...
* [Wymiana dysku bez wyłączania serwera – Programowa macierz RAID](hotswap_raid_soft1.){.external}
