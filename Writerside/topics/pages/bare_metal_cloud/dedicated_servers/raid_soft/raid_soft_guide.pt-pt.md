...
>
> Se não dispõe de um utilizador local, [deve criar um](changing_root_password_linux_ds1.).
...
[Hot Swap – RAID por hardware (EN)](hotswap_raid_hard1.){.external}

[Substituir um disco a quente num servidor com RAID por software](hotswap_raid_soft1.){.external}
