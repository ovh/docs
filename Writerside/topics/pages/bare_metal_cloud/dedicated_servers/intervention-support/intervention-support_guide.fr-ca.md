...
1\. Redémarrez le serveur en [mode rescue](rescue_mode1.).<br>
...
1\. Redémarrez le serveur en [mode rescue](rescue_mode1.) et repérez la partition `/` :
...
1\. Redémarrez le serveur en [mode rescue](rescue_mode1.).
...
1\. Redémarrez le serveur en [mode rescue](rescue_mode1.) et utilisez la commande `chroot` :
...
1\. Redémarrez le serveur en [mode rescue](rescue_mode1.) afin de monter la partition `/` :
...
1\. Connectez-vous en tant qu'administrateur à partir de l'interface [IPMI/KVM](using_ipmi_on_dedicated_servers1.).<br>
...
1\. Redémarrez le serveur en [mode rescue](rescue_mode1.), montez la partition `/` et utilisez ensuite la commande `chroot` :
