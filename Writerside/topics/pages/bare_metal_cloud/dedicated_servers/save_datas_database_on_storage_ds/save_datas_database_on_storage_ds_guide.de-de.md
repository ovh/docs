...
![Konfiguration der Partitionen anpassen](custompartition.png){.thumbnail}

An dieser Stelle wählen Sie den RAID-Typ von `/home` (1) und Sie können, wenn Sie möchten, die Partition erweitern (2).

![/home bearbeiten](partition_customization_menu.png){.thumbnail}
