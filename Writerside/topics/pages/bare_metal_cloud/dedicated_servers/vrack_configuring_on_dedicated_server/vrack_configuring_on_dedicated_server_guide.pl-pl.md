...
![Zamów vrack](images_orderingvrack.png){.thumbnail}
...
![Sieć i Internet](windows_network_and_internet.png){.thumbnail}
...
![Użyj następującego adresu IP](windows_use_following_ip_address.png){.thumbnail}
...
[Tworzenie kilku sieci VLAN w prywatnej sieci vRack](creating-multiple-vlans-in-a-vrack1.).
