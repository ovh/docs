...
Les [serveurs dédiés](https://www.ovhcloud.com/fr/bare-metal/) OVHcloud vous permettent de configurer des partitions, le [RAID logiciel](raid_soft1.), LVM, ZFS, etc. pendant [l’installation](getting-started-with-dedicated-server1.) de votre système d'exploitation depuis l’[API OVHcloud](https://api.ovh.com/) ou depuis votre [espace client OVHcloud](https://www.ovh.com/manager/#/dedicated/configuration). Dans cet article, nous allons nous concentrer sur l'[API OVHcloud](https://api.ovh.com/).<br>
...
![Tableau représentant les différentes couches du partitionnement](partitioning-layers-table.png){.thumbnail}
...
>
> - lv : cela signifie que des couches LVM seront ajoutées au-dessus du périphérique [RAID logiciel](raid_soft1.) (ou de la partition physique si le niveau du RAID est 0)
...
![Composants du diagramme](Diagram-Components-Simplified.svg){.thumbnail}
