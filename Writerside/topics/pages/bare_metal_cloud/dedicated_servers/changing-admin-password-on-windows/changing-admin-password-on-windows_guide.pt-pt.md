...
Para mais informações sobre o modo rescue, consulte [este guia](rescue_mode1.).

### 2 - Montar a partição do sistema

Ligue-se ao seu servidor através de SSH. Se necessário, consulte o guia de [introdução ao SSH](ssh_introduction1.). Como se trata de um servidor Windows, as partições serão intituladas "Microsoft LDM data".
...
[Como utilizar o IPMI com servidores dedicados](using_ipmi_on_dedicated_servers1.)
