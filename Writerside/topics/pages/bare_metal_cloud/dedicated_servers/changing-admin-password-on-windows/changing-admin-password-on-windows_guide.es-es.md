...
Para más información sobre el modo de rescate, consulte [esta guía](rescue_mode1.).

### 2. montar la partición del sistema

Conéctese al servidor por SSH. Si fuera necesario, consulte la guía [Introducción al SSH](ssh_introduction1.).
...
[Utilizar IPMI en un servidor dedicado](using_ipmi_on_dedicated_servers1.)
