...
Podczas instalacji lub reinstalacji systemu operacyjnego Windows otrzymujesz hasło administratora. Rekomendujemy jego zmianę zgodnie z instrukcją zawartą w przewodniku o bezpieczeństwie [serwera dedykowanego](securing-a-dedicated-server1.). Jeśli utraciłeś hasło administratora, zresetuj je w trybie Rescue.
...
Więcej informacji o trybie Rescue znajdziesz w [tym przewodniku](rescue_mode1.).
...
[Korzystanie z IPMI dla serwerów dedykowanych](using_ipmi_on_dedicated_servers1.)
