...
Genaue Informationen zur Vorgehensweise finden Sie in [der Anleitung zum Rescue-Modus](rescue_mode1.).

### Schritt 2: Systempartition mounten

Verbinden Sie sich via SSH mit Ihrem Server. (Wenn nötig, verwenden Sie die [Anleitung zu SSH](ssh_introduction1.).) Bei Windows-Servern finden Sie Partitionen vom Typ "Microsoft LDM Data" vor:
...
[Verwendung der IPMI-Konsole für Dedicated Server](using_ipmi_on_dedicated_servers1.)
