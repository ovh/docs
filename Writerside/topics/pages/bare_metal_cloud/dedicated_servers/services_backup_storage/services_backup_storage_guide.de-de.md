...
![Backup Storage aktivieren](backup-storage01.png){.thumbnail}

Klicken Sie im angezeigten Kontextmenü auf `Bestätigen`{.action}.

![Backup Storage aktivieren](backup-storage02.png){.thumbnail}
...
![Zugang zum Backup-Speicher hinzufügen](backup-storage03.png){.thumbnail}
...
![Zugang zum Backup-Speicher hinzufügen](backup-storage04.png){.thumbnail}
...
![Zugang zum Backup-Speicher hinzufügen](backup-storage05.png){.thumbnail}
...
Um weitere IP-Adressen verschiedener Dienste hinzuzufügen, können Sie die [OVHcloud API](first-steps1.) verwenden.
...
![Zusätzlichen Backup-Speicherplatz bestellen](backup-storage06.png){.thumbnail}
