...
![Ativar o Backup Storage](backup-storage01.png){.thumbnail}

Clique em `Confirmar`{.action} no menu contextual que aparece.

![Ativar o Backup Storage](backup-storage02.png){.thumbnail}
...
![Adicionar um acesso backup](backup-storage03.png){.thumbnail}
...
![Adicionar um acesso backup](backup-storage04.png){.thumbnail}
...
![Adicionar um acesso backup](backup-storage05.png){.thumbnail}
...
Para poder adicionar outros endereços IP de serviços diferentes, pode utilizar a [API OVHcloud](first-steps1.).
...
![apiamendress](aclapi01.png){.thumbnail}
...
![apiamendress](aclapi02.png){.thumbnail}
...
![Encomendar espaço em disco adicional](backup-storage06.png){.thumbnail}
