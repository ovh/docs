...
![Attiva il tuo Backup Storage](backup-storage01.png){.thumbnail}

Clicca su `Conferma`{.action} nel menu contestuale che appare.

![Attiva il tuo Backup Storage](backup-storage02.png){.thumbnail}
...
![Aggiungere un accesso backup](backup-storage03.png){.thumbnail}
...
![Aggiungere un accesso backup](backup-storage04.png){.thumbnail}
...
![Aggiungere un accesso backup](backup-storage05.png){.thumbnail}
...
Per poter aggiungere altri indirizzi IP di diversi servizi, utilizza [l'API OVHcloud](first-steps1.).
...
![apiacladri](aclapi01.png){.thumbnail}
...
![apiacladri](aclapi02.png){.thumbnail}
...
![Ordina spazio disco aggiuntivo](backup-storage06.png){.thumbnail}
