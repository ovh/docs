...
![Activer votre Backup Storage](backup-storage01.png){.thumbnail}

Cliquez sur `Confirmer`{.action} dans le menu contextuel qui s'affiche.

![Activer votre Backup Storage](backup-storage02.png){.thumbnail}
...
![Ajouter un accès backup](backup-storage03.png){.thumbnail}
...
![Ajouter un accès backup](backup-storage04.png){.thumbnail}
...
![Ajouter un accès backup](backup-storage05.png){.thumbnail}
...
Afin de pouvoir ajouter d'autres adresses IP de services différents, vous pouvez utiliser [l'API OVHcloud](first-steps1.).
...
![Commander de l'espace disque supplémentaire](backup-storage06.png){.thumbnail}
