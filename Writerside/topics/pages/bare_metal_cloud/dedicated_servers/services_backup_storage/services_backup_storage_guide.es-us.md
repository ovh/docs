...
![Activar el Backup Storage](backup-storage01.png){.thumbnail}

Haga clic en `Confirmar`{.action} en el menú contextual que aparece.

![Activar el Backup Storage](backup-storage02.png){.thumbnail}
...
![Añadir la regla de acceso](backup-storage03.png){.thumbnail}
...
![Añadir la regla de acceso](backup-storage04.png){.thumbnail}
...
![Añadir la regla de acceso](backup-storage05.png){.thumbnail}
...
Para poder añadir más direcciones IP de distintos servicios, puede utilizar la [API de OVHcloud](first-steps1.).
...
![Contratar espacio en disco adicional](backup-storage06.png){.thumbnail}
