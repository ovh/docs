...
Die DDoS-Schutz-Infrastruktur von OVHcloud ist ein mehrschichtiges, verteiltes Abwehrsystem gegen Cyber-Angriffe. Es besteht aus mehreren Edge-Standorten und Scrubbing Centern, die schädlichen Traffic analysieren und entfernen können. Zusammen mit der [Edge Network Firewall](firewall_network1.) und dem [GAME DDoS-Schutz](firewall_game_ddos1.) bietet sie qualitativ hochwertige Schutzdienste für verschiedene Fälle.
...
![red-line-attack](forced_blur.png){.thumbnail}{.thumbnail}
...
![red-line-attack](nsd_04_blur.PNG){.thumbnail}{.thumbnail}
...
![red-line-attack](nsd_main_blur.png){.thumbnail}
...
![red-line-attack](nsd_graph_tab_blur.png){.thumbnail}
...
Weitere Informationen zur Konfiguration dieser Regeln finden Sie in der Anleitung zur [Edge Network Firewall](firewall_network1.).
...
Sobald der Befehl ausgeführt wurde, wird die Capture-Datei erstellt. Sie können die erstellte Datei entweder an Ihr Support-Ticket anhängen oder anhand [dieser Anleitung](use-plik1.) unser Tool zum Dateiversand nutzen.
...
[Aktivieren und Konfigurieren der Edge Network Firewall](firewall_network1.)
