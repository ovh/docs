...
- Avoir accès à l'[API OVHcloud](first-steps1.) (pour la méthode de [déploiement via l'API](#viaapi.) de ce guide)
...
> **À propos du RAID :**
>
> - Bring Your Own Image (BYOI) ne prend pas en charge la configuration RAID logicielle au moment de l'installation, mais vous pouvez utiliser le service [Bring Your Own Linux (BYOLinux)](bring-your-own-linux1.) pour le faire. Choisissez le type d'installation personnalisée le plus adapté : [Comparaison entre Bring Your Own Image (BYOI) et Bring Your Own Linux (BYOLinux)](dedicated_servers_bring-your-own-image-versus-bring-your-own-linux.).
>
