...
Für eine detaillierte Übersicht der Befehle sowie die Vorgehensweise beim Testen Ihrer Festplatten lesen Sie folgende [Anleitung (LSI Raid Controller)](raid_hard#using-the-lsi-raid-controller.){.external} (Englisch).
...
Um zu ermitteln, welche Festplatte zu einem bestimmten “sg”-Gerät gehört, folgen Sie dieser [Anleitung](raid_hard1.){.external} (Englisch).
