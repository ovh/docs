...
For an in-depth look of these commands and how to test your hard disks, refer to [this guide (LSI raid controller)](raid_hard1.){.external}.
...
You can refer to [this guide (LSI raid controller)](raid_hard1.){.external} to find which hard drive relates to a designated sg device.
