...
Para informações pormenorizadas sobre estes comandos e a forma de testar os discos rígidos, consulte este [manual](raid_hard1.){.external} (versão em inglês).
...
Pode recorrer a [este manual](raid_hard1.){.external} (versão em inglês) para determinar que disco rígido corresponde a que periférico “sg”.
