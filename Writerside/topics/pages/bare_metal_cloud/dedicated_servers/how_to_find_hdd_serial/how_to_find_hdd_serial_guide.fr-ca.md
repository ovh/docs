...
Pour un aperçu détaillé de ces commandes et de la façon de tester vos disques durs, reportez-vous à [ce guide (contrôleur RAID LSI)](raid_hard1.){.external}.
...
Vous pouvez vous référer à [ce guide (contrôleur RAID LSI)](raid_hard1.){.external} pour déterminer quel disque dur correspond à un périphérique « sg » désigné.
