...
> [!primary]
>
> Si se trata de un disco NVMe, será necesario poner el servidor en [modo de rescate](rescue_mode1.){.external} y utilizar la herramienta **nvme-cli**, instalada por defecto.
> 
...
Para más información sobre estos comandos y sobre cómo probar los discos duros, consulte nuestra guía [RAID por hardware](raid_hard1.){.external}.
...
Para determinar qué periférico sg corresponde a cada disco duro, consulte nuestra guía [RAID por hardware](raid_hard1.){.external}.
