...
> [!primary]
>
> Se il tuo server appartiene alla linea di prodotti **Eco**, consulta [questa guida](getting-started-with-dedicated-server-eco1.).

## Procedura

### Sommario

- [Installazione o reinstallazione di un sistema operativo](getting-started-with-dedicated-server_#install.)
- [Connessione al tuo server](getting-started-with-dedicated-server_#connect.)
- [Riavvio del tuo server dedicato](getting-started-with-dedicated-server_#reboot.)
- [Protezione del tuo server dedicato](getting-started-with-dedicated-server_#secure.)
- [Monitoraggio OVHcloud](getting-started-with-dedicated-server_#monitoring-server.)
- [Configurazione rete](getting-started-with-dedicated-server_#network.)
- [Modalità Rescue](getting-started-with-dedicated-server_#rescue.)
- [Accesso con l'IPMI](getting-started-with-dedicated-server_#console.)
...
![Pulsante Reinstalla](getting-started-with-dedicated-server_images_reinstalling-your-server-01.png){.thumbnail}
...
![Seleziona template](getting-started-with-dedicated-server_images_reinstalling-your-server-02.png){.thumbnail}
...
![Selezione operativa](images_reinstalling-your-server-03.png){.thumbnail}
...
![Personalizzare la configurazione delle partizioni](images_reinstalling-your-server-04.png){.thumbnail}
...
Per maggiori informazioni sulla generazione delle chiavi SSH, consulta la [nostra guida](creating-ssh-keys-dedicated1.). 

![configurazione SSH](images_reinstalling-your-server-05.png){.thumbnail}
...
In modalità di backup, accedi utilizzando la [console IPMI dallo Spazio Cliente OVHcloud](getting-started-with-dedicated-server_#console.).
...
>>
>> Connettiti al server tramite RDP o [IPMI](getting-started-with-dedicated-server_#console.).<br>
>>
> 2. **Apri utilità "Run"**
>>
...
![Riavvia](images_rebooting-your-server.png){.thumbnail}
