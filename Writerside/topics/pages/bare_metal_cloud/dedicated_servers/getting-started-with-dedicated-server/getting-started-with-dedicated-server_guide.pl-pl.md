...
> [!primary]
>
> Jeśli Twój serwer należy do linii produktów **Eco**, przejdź do [tego przewodnika](getting-started-with-dedicated-server-eco1.).

## W praktyce

### Podsumowanie

- [Instalacja lub reinstalacja systemu operacyjnego](getting-started-with-dedicated-server_#install.)
- [Połączenie z serwerem](getting-started-with-dedicated-server_#connect.)
- [Restart serwera dedykowanego](getting-started-with-dedicated-server_#reboot.)
- [Bezpieczeństwo serwera dedykowanego](getting-started-with-dedicated-server_#secure.)
- [Monitoring OVHcloud](getting-started-with-dedicated-server_#monitoring-server.)
- [Konfiguracja sieci](getting-started-with-dedicated-server_#network.)
- [Tryb Rescue](getting-started-with-dedicated-server_#rescue.)
- [Dostęp za pomocą IPMI](getting-started-with-dedicated-server_#console.)
...
![Przycisk Reinstalacja](getting-started-with-dedicated-server_images_reinstalling-your-server-01.png){.thumbnail}
...
![Wybór szablonu](getting-started-with-dedicated-server_images_reinstalling-your-server-02.png){.thumbnail}

Po wybraniu `Instalacji z szablonu OVHcloud`{.action}, możesz wybrać system operacyjny z menu rozwijanego.

![Wybór operacyjny](images_reinstalling-your-server-03.png){.thumbnail}
...
![Spersonalizuj konfigurację partycji](images_reinstalling-your-server-04.png){.thumbnail}
...
![konfiguracja SSH](images_reinstalling-your-server-05.png){.thumbnail}
...
Jako rozwiązanie zapasowe możesz się zalogować za pomocą [konsoli IPMI w Panelu klienta OVHcloud](getting-started-with-dedicated-server_#console.).
...
>>
>> Zaloguj się do serwera przez RDP lub [IPMI](getting-started-with-dedicated-server_#console.).<br>
>>
...
![Restart](images_rebooting-your-server.png){.thumbnail}
