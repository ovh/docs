...
- Être connecté à l'[espace client OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) (pour la méthode de [déploiement via l'espace client](bring-your-own-linux_#viacontrolpanel.) de ce guide)
- Avoir accès à l'[API OVHcloud](first-steps1.) (pour la méthode de [déploiement via l'API](bring-your-own-linux_#viaapi.) de ce guide)
...
- [Déploiement via l'espace client](bring-your-own-linux_#viacontrolpanel.) : vous permet de déployer simplement votre image depuis l'espace client OVHcloud.
- [Déploiement via API](bring-your-own-linux_#viaapi.) : vous pouvez utiliser l’API OVHcloud pour intégrer des images dans vos propres scripts afin d’automatiser les déploiements.
...
![BringYourOwnLinux Control Panel 01](byolinux-controlpanel01.png){.thumbnail}

Dans la fenêtre qui apparaît, sélectionnez `Installer à partir d'un template OVHcloud`{.action} et cliquez sur `Suivant`{.action}.

![BringYourOwnLinux Control Panel 02](byolinux-controlpanel02.png){.thumbnail}
...
![BringYourOwnLinux Control Panel 03](byolinux-controlpanel03.png){.thumbnail}
...
Vous trouverez plus de détails sur les options dans la section « [options de déploiement](bring-your-own-linux_#options.) » ci-dessous.
...
![BringYourOwnLinux Control Panel 04](byolinux-controlpanel04.png){.thumbnail}
...
Voir section [erreurs clients fréquentes](partitioning_ovh#errors.) de la page API OVHcloud & Partitionnement pour les erreurs spécifiques au partitionnement.
...
[Comparaison entre Bring Your Own Image (BYOI) et Bring Your Own Linux (BYOLinux)](bring-your-own-image-versus-bring-your-own-linux1.)
