...
- Access to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl) (for the "[Deployment via Control Panel](bring-your-own-linux_#viacontrolpanel.)" method)
