...
- Access to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=ws) (for the "[Deployment via Control Panel](bring-your-own-linux_#viacontrolpanel.)" method)
