...
- Access to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia) (for the "[Deployment via Control Panel](bring-your-own-linux_#viacontrolpanel.)" method)
- Access to the [OVHcloud API](first-steps1.) (for the "[Deployment via API](bring-your-own-linux_#viaapi.)" section of this guide)
...
- [Deployment via the Control Panel](bring-your-own-linux_#viacontrolpanel.): allows you to simply deploy your image using the OVHcloud Control Panel.
- [Deployment via API](bring-your-own-linux_#viaapi.): you can use the OVHcloud API to integrate images into your own scripts to automate deployments.
...
You can find more details on the options in the [deployment options](bring-your-own-linux_#options.) section below.
...
See OVHcloud API & Partitioning [Common customer errors](partitioning_ovh#errors.) for related partitioning issues.
