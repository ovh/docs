...
- Access to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg) (for the "[Deployment via Control Panel](bring-your-own-linux_#viacontrolpanel.)" method)
