...
- a [dedicated server](https://www.ovhcloud.com/pt/bare-metal/){.external} with a hardware RAID configuration
...
[Configuring MegaRAID for RAID Level 0](megaraid_config1.)
