...
![Activación del firewall de red](firewallcreation2022.png){.thumbnail}
...
| ![Habilitando la configuración](activationconfig.png) |
|:--:|
...
>
> Para más información, consulte las siguientes guías: [Configuración del firewall en Windows](activate-port-firewall-soft-win1.) y [Configuración del firewall en Linux con iptables](firewall-Linux-iptable1.).
>
...
![Ejemplo de configuración](exemple.png){.thumbnail}
...
| ![mitigación-opción](mitigation_menu_step_2.png) |
|:--:|
...
Para obtener información detallada sobre los ataques detectados y los resultados de las actividades del centro de limpieza, le recomendamos que explore nuestro [Network Security Dashboard](network_security_dashboard1.).
...
- [Protección de un servidor de juegos con el firewall de aplicaciones](firewall_game_ddos1.)
