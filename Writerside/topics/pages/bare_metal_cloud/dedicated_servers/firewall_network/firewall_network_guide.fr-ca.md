...
![filtrer les service](selectservice_cut.png){.thumbnail}

Cliquez ensuite sur le bouton `...`{.action} à droite de l'IPv4 concernée et sélectionnez d'abord `Créer un pare-feu`{.action}.

![Activation du Edge Network Firewall](firewallcreation2022.png){.thumbnail}
...
| ![Activation de la configuration](activationconfig.png) |
|:--:|
...
> Pour plus d'informations, reportez-vous aux guides suivants : [Configuration du pare-feu sous Windows](activate-port-firewall-soft-win1.) et [Configuration du pare-feu sous Linux avec iptables](firewall-Linux-iptable1.).
>
...
![Exemple de configuration](exemple.png){.thumbnail}
...
Pour un aperçu détaillé des attaques détectées et des résultats des activités du Scrubbing Center, nous vous encourageons à consulter notre guide sur le [Network Security Dashboard](network_security_dashboard1.).
