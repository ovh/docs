...
Sie können natürlich noch einen Schritt weiter gehen, indem Sie den SPF-Eintrag für einen bestimmten Domainnamen konfigurieren oder die IPv6-Adresse verwenden. Weitere Informationen zum SPF-Eintrag finden Sie in unserer [Anleitung zum Konfigurieren von SPF](dns_zone_spf1.).
...
Weitere Informationen finden Sie in unserer [Anleitung zur Konfiguration von DKIM](dns_zone_dkim1.).
...
Weitere Informationen finden Sie in unserer [Anleitung zum Konfigurieren eines DMARC-Eintrags](dns_zone_dmarc1.).
...
Wenn Ihre DNS-Server von OVHcloud verwaltet werden, Sie dazu unsere [Anleitung zur Bearbeitung der OVHcloud DNS-Zone über Ihr Kundencenter](dns_zone_edit#zugang-zur-verwaltung-einer-ovhcloud-dns-zone.).
...
[DKIM-Eintrag konfigurieren](dns_zone_dkim1.)

[SPF-Eintrag konfigurieren](dns_zone_spf1.)

[DMARC-Eintrag konfigurieren](dns_zone_dmarc1.)
