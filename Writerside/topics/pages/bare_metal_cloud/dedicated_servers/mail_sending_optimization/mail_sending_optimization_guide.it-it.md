...
Puoi spingerti oltre, configurando il record SPF per un dominio specifico o utilizzando l'indirizzo IPv6. Per una corretta comprensione del record SPF, consulta la nostra guida sulla [configurazione di un record SPF](dns_zone_spf1.).
...
Per maggiori informazioni, consulta la nostra guida sulla [configurazione di un record DKIM](dns_zone_dkim1.).
...
Per maggiori informazioni, consulta la nostra guida sulla [configurazione di un record DMARC](dns_zone_dmarc1.).
...
Se i server DNS sono gestiti da OVHcloud, consulta la nostra guida [sulla modifica di una zona DNS OVHcloud dallo Spazio Cliente](dns_zone_edit#accedere-alla-gestione-di-una-zona-dns-ovhcloud.).
...
[Configura un record SPF](dns_zone_spf1.)

[Configura un record DMARC](dns_zone_dmarc1.)
