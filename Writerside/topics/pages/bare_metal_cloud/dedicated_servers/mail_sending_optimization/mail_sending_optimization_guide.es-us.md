...
Por supuesto, puede ir un paso más allá configurando el registro SPF para un dominio específico o utilizando la dirección IPv6. Para más información sobre el registro SPF, consulte nuestra guía sobre la [configuración de un registro SPF](dns_zone_spf1.).
...
Para más información, consulte nuestra guía sobre la [configuración de un registro DKIM](dns_zone_dkim1.).
...
Para más información, consulte nuestra guía sobre la [configuración de un registro DMARC](dns_zone_dmarc1.).
...
Si sus servidores DNS son gestionados por OVHcloud, consulte nuestra guía sobre [la edición de una zona DNS en OVHcloud desde el área de cliente](dns_zone_edit#acceder-a-la-gestion-de-una-zona-dns-de-ovhcloud.).
...
[Configurar un registro SPF](dns_zone_spf1.)

[Configurar un registro DMARC](dns_zone_dmarc1.)
