...
- Aver [configurato un blocco IP nella vRack](configuring-an-ip-block-in-a-vrack1.)
...
[Configurare un blocco di indirizzi IP nella vRack](configuring-an-ip-block-in-a-vrack1.){.external}
