...
En cualquier momento puede volver al disco o al modo de rescate desde el [área de cliente de OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=ws) (consulte nuestra guía "[Activar y utilizar el modo de rescate](rescue_mode1.)") o a través de la [API de OVHcloud](https://ca.api.ovh.com/).
...
[Reinicio del servidor dedicado](getting-started-with-dedicated-server#reboot.)
