...
> 
> As an alternative, OVHcloud offers the solution [SSL Gateway](https://www.ovh.com/world/ssl-gateway/). Refer to the [guide pages](order-ssl-gateway1.) as well for further information.
> 
