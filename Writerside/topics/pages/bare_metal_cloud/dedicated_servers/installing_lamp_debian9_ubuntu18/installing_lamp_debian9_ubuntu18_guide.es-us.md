...
Consulte la guía correspondiente para instalar una distribución en su servicio OVHcloud y conecte a él por [SSH](ssh_introduction1.):

- [Servidor dedicado:](getting-started-with-dedicated-server1.)
- [VPS](starting_with_a_vps1.)
- [Instancia Public Cloud](public-cloud-first-steps1.)
...
> 
> Para instalar WordPress en un servidor, puede seguir [este tutorial](install_wordpress_on_an_instance1.).
...
[La configuración de un cortafuegos](firewall-Linux-iptable1.) (*iptables*) mejorará la seguridad del servidor. Este proceso puede simplificarse utilizando el frontend "Uncomplicated Firewall" (UFW) y su conjunto de perfiles predefinidos. 
...
Para más información, consulte la guía [Editar una zona DNS](dns_zone_edit1.). Si el dominio está en uso, configure los DNS únicamente después de que el sitio web o la aplicación estén listos.
