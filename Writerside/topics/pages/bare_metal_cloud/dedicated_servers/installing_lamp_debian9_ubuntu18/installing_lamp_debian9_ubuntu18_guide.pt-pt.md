...
Siga o guia correspondente para instalar uma distribuição no seu serviço OVHcloud e aceder-lhe através de [SSH](ssh_introduction1.):

- [Servidor dedicado](getting-started-with-dedicated-server1.)
- [VPS](starting_with_a_vps1.)
- [Instância Public Cloud](public-cloud-first-steps1.)
...
> 
> Para instalar o WordPress num servidor, pode seguir [este tutorial](install_wordpress_on_an_instance1.).
...
[A configuração de uma firewall](firewall-Linux-iptable1.) (*iptables*) permitirá melhorar a segurança do seu servidor. Este processo pode ser simplificado utilizando o Frontend "Uncomplated Firewall" (UFW) e o seu conjunto de perfis pré-definidos. 
...
Para saber mais, consulte o guia "[Editar uma zona DNS](dns_zone_edit1.)". Se o domínio estiver a ser utilizado atualmente, só poderá configurar os DNS depois de o website ou a aplicação estarem prontos.
...
> 
> Em alternativa, a OVHcloud oferece-lhe a solução [SSL Gateway](https://www.ovh.pt/ssl-gateway/). Para mais informações, consulte o [nosso manual](order-ssl-gateway1.).
> 
