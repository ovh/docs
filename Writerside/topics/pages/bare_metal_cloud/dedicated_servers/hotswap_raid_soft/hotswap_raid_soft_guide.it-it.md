...
A questo punto il disco malfunzionante è pronto per essere sostituito da un tecnico nel datacenter e, a intervento ultimato, non resta che risincronizzare il RAID. Per effettuare questa operazione, consulta la guida [Configurare un RAID software](raid_soft1.){.external}.
...
[Come configurare il software RAID di un server](raid_soft1.){.external}

[Hot Swap - RAID Hardware](hotswap_raid_hard1.){.external}

[Gestire il RAID Hardware](raid_hard1.){.external} (in inglese)
