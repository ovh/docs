...
Die defekte Festplatte kann jetzt von einem Techniker im Rechenzentrum ausgetauscht werden. Nachdem der Vorgang abgeschlossen ist, muss das RAID nur erneut synchronisiert werden. Verwenden Sie hierzu folgende Dokumentation: [Software-RAID](raid_soft1.){.external}.
...
[Erfahren Sie hier, wie Sie das RAID Array Ihres Servers rekonfigurieren](raid_soft1.)

[OVHcloud API & Partitioning](partitioning_ovh1.) (Englisch)

[Managing hardware RAID](raid_hard1.) (Englisch)

[Hot Swap - Hardware RAID](hotswap_raid_hard1.) (Englisch)
