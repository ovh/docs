...
> [!warning]
>
> Esta etapa pode provocar uma perda de ligação. Se isso acontecer, ligue-se através do [IPMI](using_ipmi_on_dedicated_servers1.) e altere novamente a configuração. Poderá verificar que a gateway predefinida voltou ao estado vazio. Adicione a gateway 100.64.0.1.
>
