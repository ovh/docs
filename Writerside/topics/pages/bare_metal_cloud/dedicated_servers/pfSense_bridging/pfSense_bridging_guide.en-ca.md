...
- At least one [Additional IP](https://www.ovhcloud.com/en-ca/bare-metal/ip/) address attached to the server 
...
In the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca){.external}, go to the `Bare Metal Cloud`{.action} section and click on `Network`{.action}. Next, open the `IP`{.action} menu. 

Click the `Additional IP`{.action} tab.

![Add a virtual MAC (1)](manageIPs.png){.thumbnail} 
...
![Add a virtual MAC (1)](pfSense_bridging_images_addvmac.png){.thumbnail}
...
![Add a virtual MAC (2)](pfSense_bridging_images_addvmac2.png){.thumbnail}
...
![New bridge 1](hypervisor-1_1.png){.thumbnail}

![New bridge 2](hypervisor-1_2.png){.thumbnail}
...
![New vm 3](pfsense-vm-3.png){.thumbnail}
...
![New vm 3](pfsense-vm-4_1.png){.thumbnail}

![New vm 4](pfsense-vm-4_2.png){.thumbnail}
...
![New vm 5](desktop-vm-1.png){.thumbnail}
...
![pfSense setup 2](pfsense-vm-6.png){.thumbnail}
...
![pfSense setup 3](pfsense-vm-7.png){.thumbnail}

![pfSense setup 4](pfsense-vm-8.png){.thumbnail}
...
![desktop net enable 1](desktop-vm-3_1.png){.thumbnail}

Now we enable the network, if it was already enabled simple disable then enable it again.

![desktop net enable 2](desktop-vm-3_2.png){.thumbnail}
...
![desktop pfsense access 1](desktop-vm-4_1.png){.thumbnail}

![desktop pfsense access 1](desktop-vm-4_2.png){.thumbnail}
...
![pfSense setup 3](pfsense-vm-9.png){.thumbnail}
...
![pfSense setup 4](pfsense-vm-10_1.png){.thumbnail}
...
![pfSense setup 5](pfsense-vm-10_2.png){.thumbnail}

![pfSense setup 6](pfsense-vm-10_3.png){.thumbnail}
...
![pfSense setup 7](pfsense-vm-11_1.png){.thumbnail}
...
![pfSense setup 8](pfsense-vm-11_2.png){.thumbnail}

![pfSense setup 9](pfsense-vm-11_3.png){.thumbnail}
...
![pfSense setup 10](pfsense-vm-11_4.png){.thumbnail}

![pfSense setup 11](pfsense-vm-11_5.png){.thumbnail}

![pfSense setup 12](pfsense-vm-11_6.png){.thumbnail}

![pfSense setup 14](pfsense-vm-11_7.png){.thumbnail}
...
![pfSense setup 14](pfsense-vm-10_1.png){.thumbnail}

![pfSense setup 15](pfsense-vm-11_8.png){.thumbnail}
...
![pfSense optimize 1](pfsense-vm-trouble-1_1.png){.thumbnail}
...
![pfSense optimize 2](pfsense-vm-trouble-1_2.png){.thumbnail}

![pfSense optimize 3](pfsense-vm-trouble-1_3.png){.thumbnail}
