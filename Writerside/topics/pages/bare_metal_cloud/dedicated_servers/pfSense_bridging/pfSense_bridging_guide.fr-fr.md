...
![Ajouter une MAC virtuelle (1)](manageIPs.png){.thumbnail} 

Cliquez sur le bouton `...`{.action} à côté de l'Additional IP de votre choix puis sur `Ajouter une MAC virtuelle`{.action}.

![Ajouter une MAC virtuelle (1)](pfSense_bridging_images_addvmac.png){.thumbnail}
...
![Ajouter une MAC virtuelle (2)](pfSense_bridging_images_addvmac2.png){.thumbnail}
...
![Nouveau pont 1](hypervisor-1_1.png){.thumbnail}

![Nouveau pont 2](hypervisor-1_2.png){.thumbnail}
...
![Nouvelle vm 3](pfsense-vm-3.png){.thumbnail}
...
![Nouvelle vm 3](pfsense-vm-4_1.png){.thumbnail}

![Nouvelle vm 4](pfsense-vm-4_2.png){.thumbnail}
...
![Nouvelle vm 5](desktop-vm-1.png){.thumbnail}
...
![Configuration pfSense 2](pfsense-vm-6.png){.thumbnail}
...
![Configuration pfSense 3](pfsense-vm-7.png){.thumbnail}

![Configuration pfSense 4](pfsense-vm-8.png){.thumbnail}
...
![Configuration pfSense 3](pfsense-vm-9.png){.thumbnail}
...
![Configuration pfSense 4](pfsense-vm-10_1.png){.thumbnail}
...
![Configuration de pfSense 5](pfsense-vm-10_2.png){.thumbnail}
...
![Configuration pfSense 9](pfsense-vm-11_3.png){.thumbnail}
...
![Configuration pfSense 10](pfsense-vm-11_4.png){.thumbnail}

![Configuration pfSense 11](pfsense-vm-11_5.png){.thumbnail}

![Configuration de pfSense 12](pfsense-vm-11_6.png){.thumbnail}

![Configuration de pfSense 14](pfsense-vm-11_7.png){.thumbnail}
...
![Configuration de pfSense 14](pfsense-vm-10_1.png){.thumbnail}

![Configuration de pfSense 15](pfsense-vm-11_8.png){.thumbnail}
...
![pfSense optimization 1](pfsense-vm-trouble-1_1.png){.thumbnail}
...
![pfSense optimization 2](pfsense-vm-trouble-1_2.png){.thumbnail}

![pfSense optimization 3](pfsense-vm-trouble-1_3.png){.thumbnail}
