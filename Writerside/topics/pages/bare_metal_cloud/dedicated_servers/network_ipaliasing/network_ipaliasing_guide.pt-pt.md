...
![Adicionar um novo endereço IP](Cpanel-1.png){.thumbnail}
...
![indicar novas informações sobre o novo endereço IP](Cpanel-2024.png){.thumbnail}
...
![check configurgured IP](Cpanel-2024-1.png){.thumbnail}
...
![Internet Protocol Version 4 (TCP/IPv4) Properties](guides-network-ipaliasing-windows-2008-2.png){.thumbnail}

> [!warning]
>
> Atenção: se introduzir informação incorreta, o servidor ficará inacessível. Será obrigado a efetuar as correções em modo [WinRescue](rescue_mode#windows.) ou através do [KVM](using_ipmi_on_dedicated_servers1.).
> 
...
![acesso à gestão dos endereços IP](pleskip1.png){.thumbnail}
...
![adicionar informações IP](Plesk-2024.png){.thumbnail}
...
![adicionar informações IP](Plesk-2024-1.png){.thumbnail}
...
![configuração IP atual](Plesk-2024-2.png){.thumbnail}


### Resolução das deficiências

Se não conseguir estabelecer uma ligação entre a rede pública e o seu alias IP e suspeitar de um problema de rede, reinicie o servidor em [modo rescue](rescue_mode1.) e configure o alias diretamente no servidor.
