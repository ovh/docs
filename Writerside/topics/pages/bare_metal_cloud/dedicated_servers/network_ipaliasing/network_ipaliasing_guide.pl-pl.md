...
![Dodaj nowy adres IP](Cpanel-1.png){.thumbnail}
...
![wprowadź nowe informacje dotyczące nowego adresu IP](Cpanel-2024.png){.thumbnail}
...
> [!warning]
>
> Uwaga! Jeśli wprowadzisz błędne parametry, serwer przestanie być dostępny. Wówczas trzeba będzie dokonać poprawek w trybie [Winrescue](rescue_mode#windows.) lub poprzez [IPMI](using_ipmi_on_dedicated_servers1.).
> 
...
![Advanced TCP/IPv4 Settings](configure-additional-ip.png){.thumbnail}
...
![dostęp do zarządzania adresami IP](pleskip1.png){.thumbnail}
...
![dodaj informacje IP](Plesk-2024.png){.thumbnail}

Wprowadź adres Additional IP w formie `xxx.xxx.xxx.xxx/32` w polu "IP address and subnet mask", a następnie kliknij `OK`{.action}.

![dodaj informacje IP](Plesk-2024-1.png){.thumbnail}

#### Etap 3: sprawdź aktualną konfigurację IP

W sekcji "IP Addresses" sprawdź, czy adres Additional IP został poprawnie dodany.

![aktualna konfiguracja IP](Plesk-2024-2.png){.thumbnail}

#### Rozwiązywanie problemów

Jeśli nie udaje Ci się nawiązać połączenia między siecią publiczną a Twoim aliasem IP i podejrzewasz problem z siecią, zrestartuj serwer w [trybie Rescue](rescue_mode1.) i skonfiguruj alias bezpośrednio na serwerze.
...
[Tryb bridge IP](network_bridging1.)
