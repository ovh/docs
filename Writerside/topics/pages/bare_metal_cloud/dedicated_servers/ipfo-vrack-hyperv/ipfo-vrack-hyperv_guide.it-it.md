...
![creare-vm](create-vm.png){.thumbnail}
...
![creare-vm](create-vm-2.png){.thumbnail}
...
![creare-vm](create-vm-3.png){.thumbnail}
...
![creare-vm](create-vm-4.png){.thumbnail}
...
![configurato](configured.png){.thumbnail}
