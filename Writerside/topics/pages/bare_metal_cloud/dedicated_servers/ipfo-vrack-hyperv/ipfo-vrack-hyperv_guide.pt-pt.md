...
![desable-secure-boot](disable-secure-boot.png){.thumbnail}

Clique em `Security`{.action}, desselecione "Enable Secure Boot" e, a seguir, clique em `Apply`{.action}.

![desable-secure-boot](disable-secure-boot-2.png){.thumbnail}
