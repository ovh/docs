...
>
> If you are configuring your first OVHcloud dedicated server, we recommend to consult our guide on [getting started with a dedicated server](getting-started-with-dedicated-server1.) before continuing.
>
...
You can learn more about iptables in our [Firewall guide](firewall-Linux-iptable1.).
...
For more information on our backup storage solutions, please see our [backup storage guide](services_backup_storage1.).

## Go further

[Configuring the firewall on Windows](activate-port-firewall-soft-win1.)
