...
>
> Se configurar o primeiro servidor dedicado da OVHcloud, recomendamos que consulte primeiro o nosso manual sobre [a implementação de um servidor dedicado](getting-started-with-dedicated-server1.).
>
...
Para mais informações sobre iptables, consulte o nosso [guia dedicado](firewall-Linux-iptable1.).
...
Para saber mais sobre as nossas soluções de armazenamento, consulte o nosso [manual](services_backup_storage1.){.external} sobre armazenamento.

## Quer saber mais?

[Configurar a firewall em Windows](activate-port-firewall-soft-win1.)
