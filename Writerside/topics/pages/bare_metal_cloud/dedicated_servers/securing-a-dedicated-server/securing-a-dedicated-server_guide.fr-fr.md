...
>
> S'il s'agit de votre première configuration d'un serveur dédié OVHcloud, nous vous invitons à consulter en premier lieu notre guide [Premiers pas avec un serveur dédié](getting-started-with-dedicated-server1.).
>
...
Pour plus d'informations sur iptables, consultez notre [guide dédié](firewall-Linux-iptable1.).
...
Pour plus d'informations sur nos solutions de stockage de sauvegarde, consultez notre [guide](services_backup_storage1.){.external} de stockage de sauvegarde.

## Aller plus loin

[Configurer le pare-feu sous Windows](activate-port-firewall-soft-win1.)
