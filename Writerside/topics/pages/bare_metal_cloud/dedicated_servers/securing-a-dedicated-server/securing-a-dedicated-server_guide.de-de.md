...
>
> Wenn Sie Ihren ersten OVHcloud Server konfigurieren, empfehlen wir, zum Einstieg unsere Anleitung zur [Ersteinrichtung eines Dedicated Server](getting-started-with-dedicated-server1.) zu verwenden.
>
...
Weitere Informationen zu Iptables finden Sie in unserer [Anleitung](firewall-Linux-iptable1.).
...
Für weitere Informationen zu unseren Storage-Angeboten lesen Sie [unsere Anleitung](services_backup_storage1.) zum Thema.

## Weiterführende Informationen

[Firewall auf einem Windows Server konfigurieren](activate-port-firewall-soft-win1.)
