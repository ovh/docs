...
>
> Si se trata de su primera configuración de un servidor dedicado de OVHcloud, consulte nuestra guía [Primeros pasos con un servidor dedicado](getting-started-with-dedicated-server1.).
>
...
Para más información sobre iptables, consulte nuestra [guía dedicada](firewall-Linux-iptable1.).
...
Para más información sobre este espacio de backup, consulte nuestra guía [Backup Storage](services_backup_storage1.){.external}.

## Más información

[Configurar el firewall de Windows](activate-port-firewall-soft-win1.)
