...
- Aver completato la [configurazione della vRack](vrack_configuring_on_dedicated_server1.){.external}
...
[Configurare due o più server dedicati nella vRack](vrack_configuring_on_dedicated_server1.){.external}
