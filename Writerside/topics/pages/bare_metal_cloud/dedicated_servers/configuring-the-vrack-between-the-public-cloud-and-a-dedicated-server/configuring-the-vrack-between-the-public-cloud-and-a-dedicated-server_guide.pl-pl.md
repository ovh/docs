...
* Utworzenie [instancji Public Cloud](public-cloud-first-steps1.)
...
Po skonfigurowaniu Twojego [projektu Public Cloud](create_a_public_cloud_project1.) należy dodać go do sieci vRack. Można to zrobić na dwa sposoby:
...
![Zamów usługę vrack](orderingvrack.png){.thumbnail}
...
![dodaj projekt do usługi vrack](addprojectvrack.png){.thumbnail}
...
Jeśli potrzebujesz pomocy, zapoznaj się z przewodnikiem [Tworzenie instancji Public Cloud](public-cloud-first-steps#krok-3-tworzenie-instancji.){.external}. Podczas tworzenia instancji możesz określić prywatną sieć, w której będziesz mógł zintegrować instancję podczas etapu 4. Wybierz wówczas w rozwijanym menu utworzony uprzednio vRack.

#### Przypadek już istniejącej instancji

Możesz przypisać istniejącą instancję do sieci prywatnej. Aby uzyskać więcej informacji, należy zapoznać się z [tą sekcją](getting-started-07-creating-vrack#w-przypadku-istniejacej-instancji.) odpowiedniej instrukcji.
...
Na przykład: jeśli zdefiniowałeś prywatną sieć przypisaną do Twojej instancji za pomocą VLAN 2, prywatny interfejs sieciowy Twojego serwera dedykowanego musi być « oznaczony » za pomocą VLAN 2. Więcej informacji znajdziesz w przewodniku: [Tworzenie kilku sieci VLAN w prywatnej sieci vRack](creating-multiple-vlans-in-a-vrack1.).

### Konfiguracja interfejsów sieciowych

Następnie skonfiguruj interfejsy sieciowe dla nowej instancji Public Cloud i serwera dedykowanego zgodnie z tym przewodnikiem: [Konfiguracja kilku serwerów dedykowanych w sieci vRack](vrack_configuring_on_dedicated_server1.){.external}.
