...
**Ce guide vous montre comment configurer le réseau privé entre une [instance Public Cloud](public-cloud-first-steps#etape-3-creer-une-instance.) et un [Serveur dédié](https://www.ovhcloud.com/fr/bare-metal/).**
