...
* Ter criado uma [instância Public Cloud](public-cloud-first-steps1.)
...
Depois de configurar o seu [projeto Public Cloud](create_a_public_cloud_project1.), deverá adicioná-lo ao vRack. Isto pode ser feito de duas formas:
...
![Encomendar o vrack](orderingvrack.png){.thumbnail}
...
![adicionar um projeto ao vrack](addprojectvrack.png){.thumbnail}
...
Se precisar de ajuda, consulte o guia: [Criar uma instância Public Cloud](public-cloud-first-steps#3o-passo-criacao-de-uma-instancia.){.external}. Ao criar uma instância, poderá especificar, na etapa 4, uma rede privada na qual poderá integrar a sua instância. Escolha, no menu pendente apresentado, o seu vRack criado anteriormente.

#### Caso de uma instância já existente

Pode associar uma instância existente a uma rede privada. Para mais informações, consulte [esta secção](getting-started-07-creating-vrack#caso-de-uma-instancia-existente.) do guia correspondente.
...
Nos servidores dedicados, por predefinição, está na VLAN **0**. Se deseja utilizar este ID, será necessário « etiquetar » a rede privada associada à sua instância com a VLAN **0**. Para o fazer, terá de passar pela [OVHcloud APIv6 (EN)](getting-started-08-creating-vrack-with-api#step-3-creating-a-vlan-in-the-vrack.).
...
Por exemplo: se definiu a rede privada associada à sua instância com VLAN 2, a interface de rede privada do seu servidor dedicado deve ser « etiquetada » com VLAN 2. Para mais informações consulte o seguinte guia: [Criar várias VLAN no vRack](creating-multiple-vlans-in-a-vrack1.).

### Configurar as interfaces de rede

De seguida, configure as interfaces de rede na nova instância Public Cloud e no seu servidor dedicado através deste guia: [Configurar vários servidores dedicados no vRack](vrack_configuring_on_dedicated_server1.){.external}.
