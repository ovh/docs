...
![DNS secondario](cp-03.png){.thumbnail}
...
![DNS secondario](cp-05.png){.thumbnail}
...
- Se il dominio è gestito da OVHcloud come server di registrazione e utilizza server DNS OVHcloud, chiudi la finestra cliccando su `Annulla`{.action}. Segui le istruzioni di [questa guida](dns_zone_edit1.) per aggiungere il record TXT nel tuo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it).

![DNS secondario](cp-04.png){.thumbnail}
...
[Modifica una zona DNS OVHcloud](dns_zone_edit1.){.external}
