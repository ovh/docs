...
> [!warning]
> Ce guide n'est à suivre que si vous avez préalablement suivi les étapes détaillées dans [nos guides pour sauvegarder un serveur bare metal](bare-metal-cloud-dedicated-servers-backup-restore1.).
...
![progression de la restauration](DS_restore_Veeam09.png){.thumbnail}
