...
> Consulta [questa guida](network_support_virtual_mac1.) per determinarlo.
>
...
![Spazio Cliente](moveadditionalIP.png){.thumbnail}
...
![Spazio Cliente](moveadditionalIP2.png){.thumbnail}
