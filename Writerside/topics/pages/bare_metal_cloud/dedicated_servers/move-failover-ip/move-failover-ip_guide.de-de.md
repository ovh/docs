...
> Weitere Informationen finden Sie in [dieser Anleitung](network_support_virtual_mac1.).
>
...
![Kundencenter](moveadditionalIP.png){.thumbnail}
...
![Kundencenter](moveadditionalIP2.png){.thumbnail}
