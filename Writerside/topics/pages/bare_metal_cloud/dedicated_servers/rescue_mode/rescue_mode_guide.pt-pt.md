...
- [Reinicialização da palavra-passe do utilizador](replacing-user-password1.)
...
> [!warning]
> Tenha em conta que se definiu uma chave SSH predefinida no seu espaço para os produtos dedicados, não receberá nenhuma palavra-passe root durante o reboot de um servidor em modo rescue. Neste caso, deve desativar primeiro a chave SSH predefinida antes de reiniciar o servidor em modo rescue. Para isso, consulte a [secção](creating-ssh-keys-dedicated#disablesshkey.) do guia correspondente.
>
...
![Alterar o modo de arranque](rescue-mode-001.png){.thumbnail}
...
![Reiniciar o servidor](rescue-mode-02.png){.thumbnail}
...
De seguida, deverá aceder ao servidor através de uma linha de comandos ou através de uma ferramenta [SSH](ssh_introduction1.), utilizando a palavra-passe root gerada para o modo rescue.
...
![Windows WinRescue](rescue-mode-07.png){.thumbnail}
...
[Alterar a palavra-passe administrador num servidor dedicado Windows](changing-admin-password-on-windows1.)
