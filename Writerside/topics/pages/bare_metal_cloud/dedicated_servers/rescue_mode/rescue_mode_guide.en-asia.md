...
You will then need to access your server via the command line or an [SSH tool](ssh_introduction1.)(/pages/bare_metal_cloud/dedicated_servers/ssh_introduction), using the root password generated for the rescue mode.
