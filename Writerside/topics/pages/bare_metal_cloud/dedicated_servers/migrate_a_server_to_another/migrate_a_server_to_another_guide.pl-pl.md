...
- Najprostszym sposobem jest użycie odpowiedniego oprogramowania, takiego jak [SFTP](comment-deposer-ou-recuperer-des-donnees-sur-un-serveur-dedie-via-sftp1.).
- Inną możliwością jest [synchronizacja obu serwerów ze sobą](how-to-copy-data-from-one-dedicated-server-to-another-using-rsync1.).
...
Aby uzyskać więcej informacji, zapoznaj się z przewodnikiem dotyczącym [Korzystanie z Backup Storage na serwerze dedykowanym](services_backup_storage#korzystanie-z-backup-storage.){.external}.
...
W tym celu zapoznaj się z naszym przewodnikiem: [Przenieś Additional IP](move-failover-ip1.).
...
Więcej informacji znajdziesz w naszej dokumentacji dotyczącej [domeny i DNS](web-cloud-domains-domain-names1.).
