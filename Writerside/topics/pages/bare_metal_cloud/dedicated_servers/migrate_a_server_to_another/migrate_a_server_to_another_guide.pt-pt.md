...
- A forma mais simples é utilizar um software adequado como [SFTP](comment-deposer-ou-recuperer-des-donnees-sur-un-serveur-dedie-via-sftp1.).
- A outra opção consiste em [sincronizar os dois servidores um com o outro](how-to-copy-data-from-one-dedicated-server-to-another-using-rsync1.).
...
Para mais informações, consulte o nosso guia sobre [utilizar o Backup Storage num servidor dedicado](services_backup_storage1.){.external}.
...
Para isso, consulte o nosso guia sobre: [Migrar um Additional IP](move-failover-ip1.).
...
Para mais informações queira ler a nossa documentação sobre [domínios e DNS](web-cloud-domains-domain-names1.).
