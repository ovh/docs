...
- Sie haben einen [Dedicated Server](https://www.ovhcloud.com/de/bare-metal/) in Ihrem Kunden-Account, der [virtuelle MACs unterstützt](network_support_virtual_mac1.).
...
- Ihr Server muss virtuelle MAC-Adressen unterstützen. Ziehen Sie [unsere Anleitung](network_support_virtual_mac1.) zu Rate, um dies zu bestimmen.
...
> [!primary]
> Wenn Sie mit der Verwendung der OVHcloud API nicht vertraut sind, lesen Sie unsere Einführung zur [Verwendung der OVHcloud API](first-steps1.).
...
![Additional IP](images_addvmac2.png){.thumbnail}
