...
- A [dedicated server](https://www.ovhcloud.com/en/bare-metal/) that supports [virtual MACs](network_support_virtual_mac1.).
- An [Additional IP address](https://www.ovhcloud.com/en/bare-metal/ip/){.external} or an Additional IP block (RIPE).
- Access to your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we){.external} or to the [OVHcloud API](https://ca.api.ovh.com/).
- Your server must support virtual MACs. To determine this, consult [this guide](network_support_virtual_mac1.).
...
![IP](network_virtual_mac_images_manageIPs2022.png){.thumbnail}
