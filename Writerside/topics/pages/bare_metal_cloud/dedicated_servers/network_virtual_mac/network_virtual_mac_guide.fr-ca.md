...
- Votre serveur doit supporter les MAC virtuelles. Consultez [ce guide](network_support_virtual_mac1.) afin de le déterminer.
...
> [!primary]
> Si vous n'êtes pas familier avec l'utilisation de l'API OVHcloud, consultez notre guide « [Premiers pas avec les API OVHcloud](first-steps1.) ».
