...
If you are [using SSH keys](creating-ssh-keys-dedicated1.) to connect to your server, losing your private SSH key could mean losing access to your server altogether.
...
Create a new SSH key pair on your device, as described in the first part of the [SSH key guide](creating-ssh-keys-dedicated1.).
...
Switch the boot mode back to "normal" and restart the server in your [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie). Refer to the [rescue mode guide](#step2.) if necessary.
