...
- Tener acceso al [área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es) o a la [API de OVHcloud](https://api.ovh.com/)
...
Conéctese al [área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es), acceda a la sección `Bare Metal Cloud`{.action} y seleccione el servidor al que quiere activar SGX en la sección **Servidores dedicados** del menú de la izquierda.
...
![activación SGX](enable_sgx.png){.thumbnail}

En la siguiente pantalla, haga clic en el botón `Activar`{.action}.

![activación SGX](enable_sgx2.png){.thumbnail}
...
![activación SGX](manage_sgx.png){.thumbnail}
...
![activación SGX](confirmation-popup_sgx.png){.thumbnail}
...
![Desactivación de SGX](disable_sgx.png){.thumbnail}
