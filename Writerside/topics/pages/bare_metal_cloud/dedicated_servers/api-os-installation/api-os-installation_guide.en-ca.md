...
Fully automating OS installation or reinstallation on a [dedicated server](https://www.ovhcloud.com/en-ca/bare-metal/) with the [OVHcloud API](first-steps1.) can be interesting in various situations.
