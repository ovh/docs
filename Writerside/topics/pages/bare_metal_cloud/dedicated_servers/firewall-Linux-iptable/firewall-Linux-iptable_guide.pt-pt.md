...
Para mais informações, consulte o nosso manual sobre a [segurança de um servidor dedicado](securing-a-dedicated-server1.).
...
![versão-iptables](step2-version-iptables.PNG){.thumbnail}
...
>
> Para mais informações sobre o acesso a esta ferramenta, consulte [este guia](using_ipmi_on_dedicated_servers1.).  
> 
