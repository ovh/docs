...
Please refer to our guide on [securing a dedicated server](securing-a-dedicated-server1.) for more information.
...
![iptables-version](step2-version-iptables.PNG){.thumbnail}
...
>
> For more information on accessing this tool, please refer to [this guide](using_ipmi_on_dedicated_servers1.).
> 
