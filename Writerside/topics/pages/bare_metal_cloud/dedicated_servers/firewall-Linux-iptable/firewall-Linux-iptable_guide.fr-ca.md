...
Consultez notre guide sur la [sécurisation d'un serveur dédié](securing-a-dedicated-server1.) pour plus d'informations.
...
>
> Pour plus d'informations sur l'accès à cet outil, veuillez consulter [ce guide](using_ipmi_on_dedicated_servers1.).
> 
