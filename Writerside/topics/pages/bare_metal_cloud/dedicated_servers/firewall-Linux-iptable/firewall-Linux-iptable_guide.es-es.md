...
Para más información, consulte nuestra guía sobre la [seguridad de un servidor dedicado](securing-a-dedicated-server1.).
...
![version-iptables](step2-version-iptables.PNG){.thumbnail}
...
>
> Para más información sobre el acceso a esta herramienta, consulte [esta guía](using_ipmi_on_dedicated_servers1.).
> 
