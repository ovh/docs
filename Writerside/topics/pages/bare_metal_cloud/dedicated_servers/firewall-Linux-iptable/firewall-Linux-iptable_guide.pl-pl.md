...
Więcej informacji znajdziesz w przewodniku dotyczącym [bezpieczeństwa serwera dedykowanego](securing-a-dedicated-server1.).
...
![wersja-iptables](step2-version-iptables.PNG){.thumbnail}
...
>
> Więcej informacji na temat dostępu do tego narzędzia znajdziesz w [tym przewodniku](using_ipmi_on_dedicated_servers1.).  
> 
