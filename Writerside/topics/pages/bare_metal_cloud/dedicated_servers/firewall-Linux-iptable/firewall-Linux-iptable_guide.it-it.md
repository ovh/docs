...
Per maggiori informazioni, consulta la nostra guida sulla [sicurezza di un server dedicato](securing-a-dedicated-server1.).
...
![version-iptable](step2-version-iptables.PNG){.thumbnail}
...
![Check-Current-iptables](Check-Current-iptables.PNG){.thumbnail}
...
>
> Per maggiori informazioni sull'accesso a questo tool, consulta [questa guida](using_ipmi_on_dedicated_servers1.).  
> 
...
![line-numbers](Step7-all-rules.PNG){.thumbnail}
