...
>
> You can find more information on this attack in [an additional FAQ](faq-esxi1.).
>
...
- An offer compatible with our [Network Firewall](firewall_network1.) feature, if you would like to use it for filtering
...
>
> To do this, you will need to [reboot](getting-started-with-dedicated-server#restarting-your-dedicated-server.) your ESXi server via the OVHcloud Control Panel.
> 
...
You can enable and use our [Network Firewall](firewall_network1.) filtering solution.
...
![rules](firewall_web_.png){.thumbnail}
