...
>
> Weitere Informationen zu diesem Angriff finden Sie in dieser [zusätzlichen FAQ (EN)](faq-esxi1.).
>
...
- Sie haben einen separaten Dienst, der mit unserer [Network Firewall](firewall_network1.) kompatibel ist, sofern Sie diese Option zur Filterung verwenden möchten.
...
>
> Dazu muss der ESXi Server über das OVHcloud Kundencenter [neu gestartet werden](getting-started-with-dedicated-server#neustart-ihres-dedicated-servers.).
> 
...
Wir empfehlen, unsere Network Firewall Filterlösung zu [aktivieren und zu verwenden](firewall_network1.).
