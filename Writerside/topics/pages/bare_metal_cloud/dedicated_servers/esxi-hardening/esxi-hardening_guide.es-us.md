...
>
> Más información sobre el ataque en [una FAQ adicional (EN)](faq-esxi1.).
>
...
- Tener contratado un servicio compatible con nuestra funcionalidad de [Network Firewall](firewall_network1.) si quiere utilizarlo para filtrar.
...
>
> Para ello, deberá [reiniciar](getting-started-with-dedicated-server#reinicio-del-servidor-dedicado.) el servidor ESXi desde el área de cliente de OVHcloud.
> 
...
![interfaz](gui_logs_.png){.thumbnail}
...
Le ofrecemos activar y utilizar nuestra solución de filtrado [Network Firewall](firewall_network1.).
...
![rulas](firewall_web_.png){.thumbnail}
