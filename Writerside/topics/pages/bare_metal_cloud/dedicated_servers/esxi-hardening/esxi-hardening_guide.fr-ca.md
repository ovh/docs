...
>
> Vous trouverez plus d'informations sur cette attaque dans [une FAQ complémentaire](faq-esxi1.).
>
...
- Avoir souscrit à une offre compatible avec notre fonctionnalité [Network Firewall](firewall_network1.) si vous souhaitez l'utiliser pour effectuer le filtrage.
...
>
> Pour cela, il vous sera nécessaire de [redémarrer](getting-started-with-dedicated-server#redemarrage-de-votre-serveur-dedie.) votre serveur ESXi à travers l'espace client OVHcloud.
> 
...
Nous vous proposons d'activer et d'utiliser notre solution de filtrage [Network Firewall](firewall_network1.).
