...
- [Haber configurado su ID de cliente para la funcionalidad de OVHcloud Link Aggregation desde el área de cliente de OVHcloud](ola-enable-manager1.).
...
![remote kvm](ola-enable-sles15_images_remote_kvm2022.png){.thumbnail}
...
[Configurar la agregación de enlaces OLA en el área de cliente](ola-enable-manager1.).

[Cómo configurar el ID de cliente para la agrupación de enlaces OVHcloud en Debian 9](ola-enable-debian91.).

[Cómo configurar el ID de cliente para la agrupación de enlaces OVHcloud en CentOS 7](ola-enable-centos71.).

[Cómo configurar el ID de cliente para la agrupación de enlaces OVHcloud en Windows Server 2019](ola-enable-w2k191.).
