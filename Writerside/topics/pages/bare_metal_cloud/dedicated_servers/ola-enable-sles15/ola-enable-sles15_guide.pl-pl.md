...
- [Skonfigurowanie identyfikatora klienta dla funkcji OVHcloud Link Aggregation w Panelu klienta](ola-enable-manager1.)
...
![restart kvm](ola-enable-sles15_images_remote_kvm2022.png){.thumbnail}
...
[Konfiguracja agregacji linków OLA w Panelu klienta](ola-enable-manager1.).

[Jak skonfigurować identyfikator klienta do agregacji linków OVHcloud z systemem Debian 9](ola-enable-debian91.).

[Jak skonfigurować identyfikator klienta do agregacji linków OVHcloud z systemem CentOS 7](ola-enable-centos71.).

[Jak skonfigurować identyfikator klienta do agregacji linków OVHcloud w systemie Windows Server 2019](ola-enable-w2k191.).
