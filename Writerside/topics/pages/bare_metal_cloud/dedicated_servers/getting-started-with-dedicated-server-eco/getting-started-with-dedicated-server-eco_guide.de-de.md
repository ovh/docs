...
![Button Reinstallieren](images_reinstalling-your-server-01.png){.thumbnail}
...
![Template-Auswahl](images_reinstalling-your-server-02.png){.thumbnail}
...
![Operationelle Auswahl](reinstalling-your-server-03.png){.thumbnail}
...
![Konfiguration anpassen](reinstalling-your-server-04.png){.thumbnail}
...
![SSH-Konfiguration](reinstalling-your-server-05.png){.thumbnail}
...
![Neustart](rebooting-your-server.png){.thumbnail}
...
OVHcloud Dedicated Server werden mit einem /64 IPv6 Block geliefert. Um die Adressen dieses Blocks zu verwenden müssen Sie die Konfiguration des Netzwerks anpassen. Lesen Sie dazu unsere Anleitung "[IPv6 auf einem Dedicated Server konfigurieren](network_ipv61.)".
