...
![Reinstalar](images_reinstalling-your-server-01.png){.thumbnail}
...
![Selección de plantilla](images_reinstalling-your-server-02.png){.thumbnail}
...
![Selección operativa](reinstalling-your-server-03.png){.thumbnail}
...
![Personalizar la configuración de las particiones](reinstalling-your-server-04.png){.thumbnail}
...
![configuración SSH](reinstalling-your-server-05.png){.thumbnail}
...
>
> Esta guía explica las tareas más habituales. No obstante, le recomendamos que contacte con un [proveedor de servicios especializado](https://partner.ovhcloud.com/es/directory/) si tiene problemas o dudas sobre la administración, el uso o la implementación de servicios en un servidor.
>
...
![Reinicio](rebooting-your-server.png){.thumbnail}
