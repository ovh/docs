...
- Disposer d'un [serveur dédié](https://www.ovhcloud.com/fr-ca/bare-metal/) des gammes Kimsufi, So You Start ou Rise dans votre espace client OVHcloud.
...
![Bouton Réinstaller](images_reinstalling-your-server-01.png){.thumbnail}
...
![Sélection de template](images_reinstalling-your-server-02.png){.thumbnail}
...
![Sélection opérationnelle](reinstalling-your-server-03.png){.thumbnail}
...
![Personnaliser la configuration des partitions](reinstalling-your-server-04.png){.thumbnail}
...
![configuration SSH](reinstalling-your-server-05.png){.thumbnail}
...
![Redémarrage](rebooting-your-server.png){.thumbnail}
...
![Monitoring](monitoring-your-service.png){.thumbnail}
