...
![Botão Reinstalar](images_reinstalling-your-server-01.png){.thumbnail}
...
![Seleção de templates](images_reinstalling-your-server-02.png){.thumbnail}
...
![Seleção operacional](reinstalling-your-server-03.png){.thumbnail}
...
![Personalizar a configuração das partições](reinstalling-your-server-04.png){.thumbnail}
...
![configuração SSH](reinstalling-your-server-05.png){.thumbnail}
...
![Reiniciar](rebooting-your-server.png){.thumbnail}
