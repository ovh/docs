...
- Sie verfügen über Grundkenntnisse im Umgang mit [SSH](ssh_introduction1.) und in der Netzwerkverwaltung.
...
- [Netzwerkinformationen über das Kundencenter abrufen](network_ipv6_#viacontrolpanel.).
- [Netzwerkinformationen über API abrufen](network_ipv6_#viaapi.).
...
Eine weitere Möglichkeit, die Netzwerkinformationen Ihres Servers abzurufen, ist die Verwendung der [OVHcloud API](first-steps1.).
...
Weitere Informationen finden Sie in [dieser Anleitung](getting-started-with-dedicated-server#auf-dem-server-einloggen.).
...
![Eigenschaften](ipv6_configuration.png){.thumbnail}
...
Versetzen Sie Ihren Server zunächst in den [Rescue-Modus](rescue_mode1.).
