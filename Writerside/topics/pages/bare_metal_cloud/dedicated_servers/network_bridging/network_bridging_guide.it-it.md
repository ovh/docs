...
>
> Accedi alla [pagina di configurazione dedicata](proxmox-network-HG-Scale1.).
...
![Aggiungi un MAC virtuale (1)](addvmac.png){.thumbnail}
...
![Aggiungi un MAC virtuale (2)](addvmac2.png){.thumbnail}
...
È inoltre possibile recuperare l’indirizzo del gateway tramite [il tuo Spazio Cliente OVHcloud](network_bridging_#viacontrolpanel.) o l’[API OVHcloud](network_bridging_#viaapi.).
...
![navigare fino alla periferica di rete](proxmox_01.png){.thumbnail}

In seguito aggiungi l'indirizzo MAC che hai creato precedentemente.

![aprire una periferica di rete](proxmox_02.png){.thumbnail}
...
![Menu contestuale VM](vmware_01.png){.thumbnail}
...
![Modifica le impostazioni](vmware_02.png){.thumbnail}
