...
>
> Przejdź do [dedykowana strona konfiguracji](proxmox-network-HG-Scale1.).
...
Adres bramy możesz również pobrać z poziomu [Panelu klienta](network_bridging_#viacontrolpanel.) lub [API OVHcloud](network_bridging_#viaapi.).
...
![przekierować do urządzenia sieciowego](proxmox_01.png){.thumbnail}

Następnie dodaj adres MAC, który wcześniej utworzyłeś.

![otworzyć urządzenie sieciowe](proxmox_02.png){.thumbnail}
...
![Menu kontekstowe VM](vmware_01.png){.thumbnail}
...
![Zmień parametry](vmware_02.png){.thumbnail}
