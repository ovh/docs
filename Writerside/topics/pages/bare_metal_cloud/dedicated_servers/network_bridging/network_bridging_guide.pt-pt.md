...
>
> Aceda a [página de configuração dedicada](proxmox-network-HG-Scale1.).
...
Também pode obter o gateway através da [sua área de cliente](network_bridging_#viacontrolpanel.) ou da [API OVHcloud](network_bridging_#viaapi.)
...
![navegar até ao periférico de rede](proxmox_01.png){.thumbnail}

A seguir, adicione o endereço MAC que criou anteriormente.

![abrir um periférico de rede](proxmox_02.png){.thumbnail}
...
![Menu contextual VM](vmware_01.png){.thumbnail}
...
![Modificar as configurações](vmware_02.png){.thumbnail}
