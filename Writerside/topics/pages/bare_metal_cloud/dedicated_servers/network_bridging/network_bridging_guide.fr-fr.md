...
>
> Rendez-vous sur la [page de configuration dédiée](proxmox-network-HG-Scale1.).
...
Connectez-vous à votre [espace client OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr){.external}, cliquez sur le menu `Bare Metal Cloud`{.action} puis sur la section `Network`{.action}. Cliquez ensuite sur `IP`{.action}.
...
![Ajouter une MAC virtuelle (1)](addvmac.png){.thumbnail}
...
![Ajouter une MAC virtuelle (2)](addvmac2.png){.thumbnail}
...
Vous pouvez également récupérer la passerelle via [votre espace client](network_bridging_#viacontrolpanel.) ou l’[API OVHcloud](network_bridging_#viaapi.).
...
![naviguer jusqu'au périphérique réseau](proxmox_01.png){.thumbnail}

Ajoutez ensuite l'adresse MAC que vous avez créée précédemment.

![ouvrir un périphérique réseau](proxmox_02.png){.thumbnail}
...
![Menu contextuel VM](vmware_01.png){.thumbnail}
...
![Modifier les paramètres](vmware_02.png){.thumbnail}
