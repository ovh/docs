...
> 
> Please visit the dedicated [configuration page](proxmox-network-HG-Scale1.).
...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), go to the `Bare Metal Cloud`{.action} section and click on `Network`{.action}. Next, open the `IP`{.action} menu.
...
![Add a virtual MAC (1)](addvmac.png){.thumbnail}
...
![Add a virtual MAC (2)](addvmac2.png){.thumbnail}
...
You can also retrieve the gateway via the [OVHcloud Control Panel](network_bridging_#viacontrolpanel.) or the [OVHcloud API](network_bridging_#viaapi.).

#### Via the OVHcloud Control Panel <a name="viacontrolpanel"></a>

Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), go to the `Bare Metal Cloud`{.action} section and select your server from `Dedicated servers`{.action}.
...
![navigate to Network Device](proxmox_01.png){.thumbnail}

Then add the vMAC address created previously.

![open Network Device](proxmox_02.png){.thumbnail}
...
![VM context menu](vmware_01.png){.thumbnail}
...
![Edit settings](vmware_02.png){.thumbnail}
...
- If the IP address is still not working, please create a ticket in your [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/&ovhSubsidiary=GB) to relay your test results to our support teams.
