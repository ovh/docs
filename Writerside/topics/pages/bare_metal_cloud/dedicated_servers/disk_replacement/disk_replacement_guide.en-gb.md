...
If you have a server that uses soft RAID, please refer to the [software RAID](raid_soft1.) guide to find the disks installed on your server.
...
You can check S.M.A.R.T logs in web panel of rescue mode.To check how you can use rescue mode please follow [this guide](rescue_mode1.){.external}
...
If you are hot-swapping a disk on a server with a MegaRAID card you can refer to our [Hot Swap - Hardware RAID](hotswap_raid_hard1.){.external} guide. 

While if you are hot-swapping a disk using software RAID (with a LSI card) please refer to our [Hot Swap - Software RAID](hotswap_raid_soft1.){.external} guide 
