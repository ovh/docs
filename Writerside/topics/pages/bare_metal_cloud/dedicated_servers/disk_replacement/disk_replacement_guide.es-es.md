...
Si tiene un servidor con RAID por software, consulte la guía [RAID por software](raid_soft1.){.external} para identificar los discos instalados en su servidor.
...
Si tiene un servidor con RAID por hardware, consulte la guía [RAID por hardware](raid_hard1.){.external} y siga el procedimiento correspondiente a su tipo de controlador RAID para conocer la ruta de acceso a los discos.
...
Si se trata de un disco NVMe, será necesario poner el servidor en [modo de rescate](rescue_mode1.){.external} e instalar la herramienta `nvme-cli`.
...
Si tiene un servidor con RAID por software, deberá reconstruir el RAID usted mismo. Para ello, no dude en consultar la guía [RAID por software](raid_soft1.){.external}.

## Más información

[RAID por software](raid_soft1.){.external}

[RAID por hardware](raid_hard1.){.external}

[Modo de rescate](rescue_mode1.){.external}
