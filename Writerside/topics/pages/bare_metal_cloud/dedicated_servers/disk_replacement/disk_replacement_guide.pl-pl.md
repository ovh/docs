...
Jeśli posiadasz serwer z programową macierzą RAID, zapoznaj się z przewodnikiem [“Software RAID”](raid_soft1.){.external}, aby odnaleźć dyski zainstalowane na Twoim serwerze.
...
Jeśli posiadasz serwer ze sprzętową macierzą RAID, zapoznaj się z przewodnikiem [“Hardware RAID” - EN](raid_hard1.){.external} i zastosuj procedurę dotyczącą Twojego typu kontrolera RAID, aby odnaleźć ścieżki dostępu do Twoich dysków.
...
W przypadku dysku NVMe konieczne jest uruchomienie serwera w trybie [Rescue](rescue_mode1.) i zainstalować narzędzie `nvme-cli`.
...
Jeśli posiadasz serwer z programową macierzą RAID, uruchom ręcznie ponowną synchronizację dysków. Więcej informacji na ten temat znajdziesz w dokumentacji [“Software RAID”](raid_soft1.){.external}.

## Sprawdź również

[Programowa macierz RAID](raid_soft1.)

[Sprzętowa macierz RAID - EN](raid_hard1.){.external}

[Trybu Rescue](rescue_mode1.)
