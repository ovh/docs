...
Si vous possédez un serveur disposant d'un RAID logiciel, référez-vous au guide [« RAID Logiciel »](raid_soft1.){.external} afin de trouver les disques installés sur votre serveur.
...
Si vous possédez un serveur disposant d'un RAID matériel, référez-vous au guide [« RAID Matériel »](raid_hard1.){.external} et utilisez la procédure concernant votre type de contrôleur RAID pour trouver les chemins d'accès à vos disques.
...
Dans le cas d'un disque NVMe, il sera nécessaire de placer le serveur en [mode rescue](rescue_mode1.){.external} et installer l'outil `nvme-cli`.
...
- **le numéro de série du disque à remplacer ainsi que de tous les autres disques sains**. Pour récupérer le numéro de série du disque à remplacer, consultez [ce guide](how_to_find_hdd_serial1.){.external}. Si, pour une raison ou une autre, il n'est pas possible d'extraire le numéro de série du disque, veuillez le notifier dans le ticket, et nous communiquer le numéro de série du ou des disques à ne pas remplacer. 
...
Si vous possédez un serveur en RAID logiciel, il convient de lancer manuellement la resynchronisation de vos disques. Pour cela, n'hésitez pas à vous reporter à la documentation liée au [« RAID logiciel »](raid_soft1.){.external}.

## Aller plus loin

[RAID logiciel](raid_soft1.){.external}

[RAID matériel](raid_hard1.){.external}

[Mode Rescue](rescue_mode1.){.external}
