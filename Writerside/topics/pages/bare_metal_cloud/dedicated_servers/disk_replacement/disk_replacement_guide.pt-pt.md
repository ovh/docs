...
Se possui um servidor que recorre a RAID por software, consulte o guia [«RAID por software»](raid_soft1.) para encontrar os discos instalados no seu servidor.
...
Se possui um servidor que recorre a RAID por hardware, consulte o guia [«RAID por hardware» - EN](raid_hard1.){.external} e realize o procedimento adequado ao seu tipo de controlador RAID para encontrar os caminhos de acesso aos discos.
...
No caso de um disco NVMe, será preciso pôr o servidor em [modo rescue](rescue_mode1.) e instalar a ferramenta `nvme-cli`.
...
Se possui um servidor em RAID por software, convém que execute manualmente a ressincronização dos discos. Para isso, consulte a documentação associada ao [«RAID por software»](raid_soft1.).

## Quer saber mais?

[RAID por software](raid_soft1.)

[RAID por hardware - EN](raid_hard1.){.external}

[Modo rescue](rescue_mode1.)
