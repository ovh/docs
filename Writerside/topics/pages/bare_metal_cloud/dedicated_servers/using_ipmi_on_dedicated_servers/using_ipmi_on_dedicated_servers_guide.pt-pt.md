...
![IPMI Java iniciado](java_ipmi_initiate_2022.png){.thumbnail}

Faça o download do ficheiro `kvm.jnlp` quando for convidado a fazê-lo, e depois lance-o:

![Abertura IPMI Java](java_ipmi_activation.png){.thumbnail}
...
![Ligação Java IPMI](java_ipmi_login.png){.thumbnail}
...
![Ativação da declaração de integridade IPMI](sol_ipmi_activation_2022.png){.thumbnail}
...
![Teste IPMI](ipmi_test_2022.png){.thumbnail}
...
![Teste IPMI](ipmi_reboot_2022.png){.thumbnail}
...
![Menu_arranque](boot_menu.png){.thumbnail}
...
![Instalação do KVM](kvm_install01.png){.thumbnail}

Clique em `Start Media`{.action}. Isto preparará a ISO para o processo de instalação.

![Instalação do KVM](kvm_install02.png){.thumbnail}
...
Quando o servidor estiver em [modo rescue](rescue_mode1.) e quando estiver ligado, instale-o com o seguinte comando:
