...
![Iniciado IPMI Java](java_ipmi_initiate_2022.png){.thumbnail}
...
![Conexión Java IPMI](java_ipmi_login.png){.thumbnail}
...
![Activación de la declaración de integridad IPMI](sol_ipmi_activation_2022.png){.thumbnail}
...
![Menu_Inicio](boot_menu.png){.thumbnail}
...
![Instalación del KVM](kvm_install01.png){.thumbnail}

Haga clic en `Start Media`{.action}. Esto preparará la ISO para el proceso de instalación.

![Instalación del KVM](kvm_install02.png){.thumbnail}
...
Cuando el servidor esté en [modo rescue](rescue_mode1.) y una vez conectado, instálelo con el siguiente comando:
