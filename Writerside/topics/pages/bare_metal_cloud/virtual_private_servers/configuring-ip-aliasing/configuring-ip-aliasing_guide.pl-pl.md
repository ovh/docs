...
![acces to the ip addresses management](images_pleskip1.png){.thumbnail}
...
![add ip information](Plesk-2024-vps.png){.thumbnail}
...
![add ip information](Plesk-additional-ip.png){.thumbnail}

#### Etap 3: weryfikacja aktualnej konfiguracji IP

W sekcji "IP Addresses" sprawdź, czy adres Additional IP został poprawnie dodany.

![current IP configuration](plesk-final-configuration.png){.thumbnail}
