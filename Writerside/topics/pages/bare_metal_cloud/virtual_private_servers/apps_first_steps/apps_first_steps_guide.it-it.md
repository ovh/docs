...
Dallo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it) o tramite le API OVHcloud è possibile installare l'applicazione che preferisci. Consulta la guida Iniziare [a utilizzare un VPS](starting_with_a_vps1.).
...
>> Si', puoi. Assicurati di creare record GLUE con il tuo Registrar Ad esempio, se vuoi "ns1.mydomain.com" e "ns2.mydomain.com", devi configurare i record "GLUE" perché entrambi puntino sull'indirizzo IP del tuo server. Se il tuo dominio è registrato con OVHcloud, segui [questa guida](glue_registry#step-1-aggiungi-i-record-glue.). Ti ricordiamo che la creazione potrebbe richiedere 24 ore.
...
Se il tuo dominio è registrato in OVHcloud, consulta [questa guida.](dns_zone_edit1.)
