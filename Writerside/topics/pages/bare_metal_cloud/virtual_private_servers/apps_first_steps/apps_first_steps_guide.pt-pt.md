...
A partir da [Área de Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pt/&ovhSubsidiary=pt) ou das API OVHcloud, instale a aplicação que desejar. Também pode consultar o nosso guia [VPS](starting_with_a_vps1.): primeira utilização.
...
Se o seu domínio estiver registado na OVHcloud, pode seguir [este guia](dns_zone_edit1.).
