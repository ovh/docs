...
Connect to your server via SSH. (Consult the [SSH introduction guide](ssh_introduction1.) if necessary.)

Alternatively, you can open a server connection by using [KVM (VPS)](using_kvm_for_vps1.) or the [VNC console (Public Cloud instance)](first_steps_with_public_cloud_instance#accessvnc.).
