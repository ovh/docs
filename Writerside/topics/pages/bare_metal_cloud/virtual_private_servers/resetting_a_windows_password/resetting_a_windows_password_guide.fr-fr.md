...
Connectez-vous à votre serveur via SSH. (Consultez notre [guide d'introduction SSH](ssh_introduction1.) si nécessaire.)

Vous pouvez également ouvrir une connexion au serveur en utilisant [KVM (VPS)](using_kvm_for_vps1.) ou la [console VNC (instance Public Cloud)](first_steps_with_public_cloud_instance#accessvnc.).
