...
>
> Si la función snapshot es demasiado limitada para su proyecto, la opción [Backup automatizado](using-automated-backups-on-a-vps1.) es una alternativa.
>
...
>
> El archivo cargado puede importarse en un proyecto de Public Cloud como imagen (QCOW2) mediante [OpenStack](products_public-cloud-compute-instance-management.). (Consulte un ejemplo de uso en [esta guía](upload_own_image1.).)
>
...
[Usar copias de seguridad automatizadas en un servidor virtual privado (VPS)](using-automated-backups-on-a-vps1.)
