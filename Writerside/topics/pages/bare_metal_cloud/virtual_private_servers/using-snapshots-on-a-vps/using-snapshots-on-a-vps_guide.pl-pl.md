...
>
> Jeśli funkcja snapshot jest zbyt ograniczona dla Twojego projektu, opcja [automatyczne kopie zapasowe](using-automated-backups-on-a-vps1.) jest alternatywna.
>
...
>
> Pobrany plik można zaimportować do projektu Public Cloud (QCOW2) jako obraz za pośrednictwem [OpenStack](products_public-cloud-compute-instance-management.). (Przykład zastosowania znajduje się w [tym przewodniku](upload_own_image1.).)
>
...
[Korzystanie z automatycznych kopii zapasowych na prywatnym serwerze wirtualnym](using-automated-backups-on-a-vps1.)
