...
>
> Se a função snapshot é demasiado limitada para o seu projeto, a opção [Backups automatizados](using-automated-backups-on-a-vps1.) é uma alternativa.
>
...
>
> O ficheiro descarregado pode ser importado para um Projeto Public Cloud enquanto imagem (QCOW2) via [OpenStack](products_public-cloud-compute-instance-management.). (Consulte um exemplo de utilização em [este manual](upload_own_image1.).)
>
...
[Utilizar backups automáticos num alojamento VPS](using-automated-backups-on-a-vps1.)
