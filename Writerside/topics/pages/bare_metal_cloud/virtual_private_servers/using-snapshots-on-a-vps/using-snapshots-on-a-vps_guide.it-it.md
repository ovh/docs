...
>
> Se la funzione Snapshot è troppo limitata per il tuo progetto, l'opzione [Backup automatizzati](using-automated-backups-on-a-vps1.) è un'alternativa.
>
...
>
> Il file scaricato può essere importato in un Progetto Public Cloud come immagine (QCOW2) tramite [OpenStack](products_public-cloud-compute-instance-management.). (Un esempio di utilizzo è disponibile in [questa guida](upload_own_image1.).)
>
...
[Usare backup automatizzati su un VPS](using-automated-backups-on-a-vps1.)
