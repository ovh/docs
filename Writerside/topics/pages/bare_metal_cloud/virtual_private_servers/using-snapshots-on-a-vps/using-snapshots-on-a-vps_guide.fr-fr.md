...
>
> Si la fonction snapshot est trop limitée pour votre projet, l'option [Sauvegardes automatisées](using-automated-backups-on-a-vps1.) est une alternative.
>
...
>
> Le fichier téléchargé peut être importé dans un Projet Public Cloud en tant qu'image (QCOW2) via [OpenStack](products_public-cloud-compute-instance-management.). (Retrouvez un exemple d'utilisation dans [ce guide](upload_own_image1.).)
>
...
Consultez notre guide [Sauvegarde automatique - Kernel panic (cPanel)](cpanel_snapshot1.) pour savoir comment résoudre les problèmes de blocage des serveurs cPanel lors de la sauvegarde automatique OVHcloud.
...
[Utiliser la sauvegarde automatique sur un VPS](using-automated-backups-on-a-vps1.)
