...
Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia) and initiate a server reboot in rescue mode. Follow our [rescue mode guide](rescue1.) if necessary.
