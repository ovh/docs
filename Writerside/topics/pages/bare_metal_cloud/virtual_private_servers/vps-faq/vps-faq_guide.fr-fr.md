...
Tous les détails vous sont présentés dans le guide [« Débuter avec un VPS »](starting_with_a_vps1.).
...
Pour ce faire, n’hésitez pas à consulter le guide [«Sécuriser un VPS»](secure_your_vps1.).
