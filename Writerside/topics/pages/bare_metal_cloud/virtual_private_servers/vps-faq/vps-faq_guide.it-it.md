...
Per maggiori informazioni, consulta la guida Iniziare [a utilizzare un VPS](starting_with_a_vps1.).
...
Per effettuare questa operazione, consulta la guida ["Mettere in sicurezza un VPS"](secure_your_vps1.).
