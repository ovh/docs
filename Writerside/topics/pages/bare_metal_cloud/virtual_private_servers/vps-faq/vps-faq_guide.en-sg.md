...
If you would like to get guaranteed resources but don't know how to manage servers, we would recommend Performance web [hosting plans](https://www.ovhcloud.com/en-sg/web-hosting/performance-offer/).
...
All the details are set out in our guide on [Getting started with a VPS](starting_with_a_vps1.).
...
To do this, please refer to our guide on [Securing a VPS](secure_your_vps1.).
...
![screenshot 1](post-api.png){.thumbnail}
...
![screenshot 1](get-api.png){.thumbnail}
