...
>
>If you encounter any difficulties performing these actions, please contact a [specialist service provider](https://partner.ovhcloud.com/en-sg/directory/) and/or discuss the issue with our community. You can find more information in the [Go further](minecraft_server_on_vps_#gofurther.) section of this guide.
>
...
<br>It is recommended to order a new VPS or reinstall an existing one from your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg), using the latest available release of Ubuntu or Debian. Please refer to our [Getting started guide](starting_with_a_vps#reinstallvps.) if necessary.
