...
<br>Es wird empfohlen, einen neuen VPS zu bestellen oder einen bestehenden Server über Ihr [OVHcloud Kundencenter](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de) zu [re-installieren](starting_with_a_vps#reinstallvps.) und dabei die neueste verfügbare Version von Ubuntu oder Debian zu verwenden.

Wenn das Betriebssystem installiert ist, verbinden Sie sich mit Ihrem VPS per SSH, wie in der Anleitung "[Erste Schritte mit einem VPS](starting_with_a_vps1.)" erklärt.
...
![Download des Servers](download_jar.png){.thumbnail}
...
![Verbindung zum Server](login_minecraft.png){.thumbnail}
...
![Informationen zum Server](minecraft_server_login.png){.thumbnail}
