...
>
>Se tiver dificuldades em aplicar estas instruções, recomendamos que recorra a um fornecedor especializado. Para mais informações, consulte a secção [Quer saber mais](minecraft_server_on_vps_#gofurther.)?
>
...
![Download do servidor](download_jar.png){.thumbnail}
