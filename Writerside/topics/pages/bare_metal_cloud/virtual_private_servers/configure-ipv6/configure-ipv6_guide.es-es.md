...
- [Desde el área de cliente](configure-ipv6_#viacontrolpanel.)
- [A través de la API](configure-ipv6_#viaapi.)
...
En el apartado IP podrá ver la dirección IPv6 y la puerta de enlace IPv6 asignadas al VPS. Anótelas y continúe en el apartado 2 « [Aplicar la configuración IPv6](configure-ipv6_#applyipv6.). »

![Configuración IPv6](vps_ipv6_information.png){.thumbnail}
...
Una vez que haya recuperado las direcciones, vaya al paso 2. [Aplicar la configuración IPv6](configure-ipv6_#applyipv6.).

### 2\. aplicar la configuración IPv6 <a name="applyipv6"></a>

Una vez que disponga de la información necesaria para configurar la IPv6, conéctese al VPS por SSH. Si lo necesita, puede consultar la guía [Introducción al SSH](ssh_introduction1.){.external}.
...
![Configuración IPv6](configure-ipv6-step2.png){.thumbnail}
...
![Configuración IPv6](configure-ipv6-step3.png){.thumbnail}
...
![Configuración IPv6](configure-ipv6-step4.png){.thumbnail}
