...
Esta opção irá abrir uma janela para iniciar o processo de [rescisão do serviço](how_to_cancel_services1.).

### Reiniciar em Modo de Rescue

Clique para reiniciar o VPS em modo rescue. Encontre todos os detalhes no [nosso guia](rescue1.).
...
- A língua;
- uma [chave SSH](creating-ssh-keys-dedicated1.) (facultativo)
...
Aquando da reinstalação do seu VPS, ser-lhe-á enviado um e-mail com a palavra-passe root para se ligar ao seu VPS em [SSH](ssh_introduction1.), exceto se tiver selecionado uma [chave SSH](creating-ssh-keys-dedicated1.) a pré-instalar.
...
É possível desativar as ligações de utilizadores root através do protocolo SSH. Não se esqueça de [criar um utilizador](secure_your_vps#createuser.) diferente antes de continuar os passos indicados abaixo.
...
Utilize esta opção para se ligar ao seu VPS através do KVM. Encontre todos os detalhes no [nosso guia](using_kvm_for_vps1.).
...
[Consulte o manual Introdução ao SSH](ssh_introduction1.)

[Criação e utilização de chaves SSH](creating-ssh-keys-dedicated1.)
