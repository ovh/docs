...
Mit dieser Option wird ein Popup-Fenster geöffnet, um den [Kündigungsvorgang Ihrer Dienstleistung](how_to_cancel_services1.) zu starten.

### Neustart im Rescue-Modus

Klicken Sie hier, um den VPS im Rescue-Modus neu zu starten. Weitere Informationen finden Sie in [unserer Anleitung](rescue1.).
...
- Betriebssystem
- Sprache
- [SSH-Schlüssel](creating-ssh-keys-dedicated1.) (optional)
...
Bei der Reinstallation Ihres VPS erhalten Sie eine E-Mail mit Ihrem Root-Passwort, um sich über [SSH](ssh_introduction1.) mit Ihrem VPS zu verbinden, es sei denn, Sie haben einen [SSH-Schlüssel](creating-ssh-keys-dedicated1.) für die Vorinstallation ausgewählt.
...
Root-Logins über das SSH-Protokoll sollten deaktiviert werden. [Erstellen Sie einen neuen Benutzer](secure_your_vps#createuser.), bevor Sie mit den nachfolgenden Schritten fortfahren.
...
Verwenden Sie diese Option, um sich über KVM mit Ihrem VPS zu verbinden. Weitere Informationen finden Sie in [unserer Anleitung](using_kvm_for_vps1.).
...
[Erstellung und Verwendung von SSH-Schlüsseln](creating-ssh-keys-dedicated1.)

[VPS Sicherheit](secure_your_vps1.)
