...
Esta opción abrirá una ventana emergente para iniciar el proceso de [baja del servicio](how_to_cancel_services1.).

### Reiniciar en modo de rescate

Haga clic en esta opción para reiniciar el VPS en modo de rescate. Para más información, consulte [nuestra guía](rescue1.).
...
- el idioma;
- una [llave SSH](creating-ssh-keys-dedicated1.) (opcional)
...
Al reinstalar su VPS, le enviaremos por correo electrónico la contraseña root para conectarse a su VPS por [SSH](ssh_introduction1.), a menos que haya seleccionado una [llave SSH](creating-ssh-keys-dedicated1.) para preinstalar.
...
Es posible desactivar las conexiones de usuarios root a través del protocolo SSH. No olvide [crear otro usuario](secure_your_vps#createuser.) antes de seguir los pasos que se indican a continuación.
...
Utilice esta opción para conectarse a su VPS a través de KVM. Para más información, consulte [nuestra guía](using_kvm_for_vps1.).
...
[Creación y uso de llaves SSH](creating-ssh-keys-dedicated1.)
