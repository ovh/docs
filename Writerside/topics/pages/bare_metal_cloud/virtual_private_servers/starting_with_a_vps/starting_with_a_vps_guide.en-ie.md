...
You can find all information on the available backup solutions for your service on the [product page](https://www.ovhcloud.com/en-ie/vps/options/) and in the [respective guides](bare-metal-cloud-virtual-private-servers-backups1.).
...
To automate this process, OVHcloud also offers the SSL Gateway solution. Please refer to the [product page](https://www.ovh.ie/ssl-gateway/) or our [documentation](web-cloud-ssl-gateway1.) for further information.
