...
>
> Wenn Sie Ihren ersten OVHcloud VPS konfigurieren, empfehlen wir, zum Einstieg unsere Anleitung zur [Ersteinrichtung eines VPS](starting_with_a_vps1.) zu verwenden.
>
...
Im Allgemeinen sollten Aufgaben, die keine Root-Rechte erfordern, über einen Standardbenutzer ausgeführt werden. Weitere Informationen finden Sie in [dieser Anleitung](changing_root_password_linux_ds1.).
...
Weitere Informationen zu *iptables* finden Sie in unserer [Anleitung](firewall-Linux-iptable2.).
...
Wenn Sie die OVHcloud Network Firewall aktivieren möchten, folgen Sie [dieser Anleitung](firewall_network1.).
...
Alle Informationen zu den für Ihren Dienst verfügbaren Backup-Lösungen finden Sie auf der [Produktseite](https://www.ovhcloud.com/de/vps/options/) und in den [zugehörigen Anleitungen](bare-metal-cloud-virtual-private-servers1.).

## Weiterführende Informationen

[Erste Schritte mit einem VPS](starting_with_a_vps1.) 

[Firewall auf einem Windows Server konfigurieren](activate-port-firewall-soft-win2.)

[Konfiguration der Linux Firewall mit iptables](firewall-Linux-iptable2.)
