...
>
> Per configurare il tuo primo VPS OVHcloud, consulta la nostra guida [sulla messa in servizio di un VPS](starting_with_a_vps1.).
>
...
Per maggiori informazioni su iptables, consulta la nostra [guida dedicata](firewall-Linux-iptable2.).
...
Tutte le informazioni sulle soluzioni di backup disponibili per il tuo servizio sono disponibili sulla [pagina del prodotto](https://www.ovhcloud.com/it/vps/options/) e nelle [rispettive](bare-metal-cloud-virtual-private-servers1.) guide.

## Per saperne di più

[Iniziare a utilizzare un VPS](starting_with_a_vps1.) 

[Configura il firewall su Windows](activate-port-firewall-soft-win2.)

[Configura il firewall su Linux con iptables](firewall-Linux-iptable2.)
