...
>
> If you are configuring your first OVHcloud VPS, we recommend to consult our guide on [getting started with a VPS](starting_with_a_vps1.) before continuing.
>
...
In general, tasks that do not require root privileges should be performed via a standard user. Please refer to the information in [this guide](changing_root_password_linux_ds1.) for details.
...
You can learn more about iptables in our [Firewall guide](firewall-Linux-iptable2.).
...
Please refer to the [Network Firewall guide](firewall_network1.) if you would like to activate it.
...
You can find all information on the available backup solutions for your service on the [product page](https://www.ovhcloud.com/en-ca/vps/options/) and in the [respective guides](bare-metal-cloud-virtual-private-servers1.).

## Go further

[Getting started with a VPS](starting_with_a_vps1.)

[Configuring the firewall on Windows](activate-port-firewall-soft-win2.)

[Configuring the firewall on Linux with iptables](firewall-Linux-iptable2.)

[Network Firewall guide](firewall_network1.)
