...
>
> S'il s'agit de votre première configuration d'un VPS OVHcloud, nous vous invitons à consulter en premier lieu notre guide [Débuter avec un VPS](starting_with_a_vps1.).
>
...
En général, les tâches qui ne requièrent pas de privilèges root doivent être effectuées via un utilisateur standard. Pour plus d'informations, consultez [ce guide](changing_root_password_linux_ds1.).
...
Pour plus d'informations sur iptables, consultez notre [guide dédié](firewall-Linux-iptable2.).
...
Consultez le guide « [Configurer le Network Firewall](firewall_network1.) » si vous souhaitez l'activer.
...
Vous trouverez toutes les informations sur les solutions de sauvegarde disponibles pour votre service sur la [page produit](https://www.ovhcloud.com/fr-ca/vps/options/) et dans les [guides respectifs](bare-metal-cloud-virtual-private-servers1.).

## Aller plus loin

[Débuter avec un VPS](starting_with_a_vps1.)

[Configurer le pare-feu sous Windows](activate-port-firewall-soft-win2.)

[Configurer le pare-feu sous Linux avec Iptables](firewall-Linux-iptable2.)
