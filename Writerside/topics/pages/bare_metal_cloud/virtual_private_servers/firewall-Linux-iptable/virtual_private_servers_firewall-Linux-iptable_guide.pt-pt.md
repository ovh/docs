...
Para mais informações, consulte o nosso manual sobre a [segurança de um VPS](secure_your_vps1.).
...
![versão-iptables](images_step2-version-iptables.PNG){.thumbnail}
...
>
> Para mais informações sobre o acesso a esta ferramenta, consulte [este guia](using_kvm_for_vps1.).  
> 
...
> [!warning]
> 
>Atenção, se introduzir este comando antes de efetuar [o passo 5](firewall-Linux-iptable_#step5.), bloqueará todos os acessos, incluindo o que está em curso, e o acesso SSH. Isto é particularmente problemático numa máquina na qual se pode aceder remotamente. 
>
