...
Weitere Informationen finden Sie in unserer [Anleitung zur Sicherung eines VPS](secure_your_vps1.).
...
![iptables-version](images_step2-version-iptables.PNG){.thumbnail}
...
>
> Weitere Informationen zum Zugriff auf dieses Tool finden Sie in [dieser Anleitung](using_kvm_for_vps1.).
> 
...
> [!warning]
> 
>Wenn Sie diesen Befehl eingeben, bevor Sie [Schritt 5](firewall-Linux-iptable_#step5.) ausführen, blockieren Sie alle Zugänge und damit auch die laufende SSH-Verbindung. Dies ist besonders relevant bei einem Server, auf den Sie *remote* zugreifen. 
>
