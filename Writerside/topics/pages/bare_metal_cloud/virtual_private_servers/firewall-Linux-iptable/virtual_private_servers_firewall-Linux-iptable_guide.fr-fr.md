...
Consultez notre guide sur la [sécurisation d'un VPS](secure_your_vps1.) pour plus d'informations.
...
![version-iptables](images_step2-version-iptables.PNG){.thumbnail}
...
![Check-Current-iptables](images_Check-Current-iptables.PNG){.thumbnail}
...
>
> Pour plus d'informations sur l'accès à cet outil, veuillez consulter [ce guide](using_kvm_for_vps1.).  
> 
...
> [!warning]
> 
>Attention, si vous tapez cette commande avant d'effectuer [l'étape 5](firewall-Linux-iptable_#step5.), vous bloquerez tous les accès y compris celui en cours, l'accès SSH. Ceci est particulièrement problématique sur une machine sur laquelle vous accédez à distance. 
>
...
![line-numbers](images_Step7-all-rules.PNG){.thumbnail}
