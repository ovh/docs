...
Więcej informacji znajdziesz w przewodniku dotyczącym [bezpieczeństwa serwera VPS](secure_your_vps1.).
...
![wersja-iptables](images_step2-version-iptables.PNG){.thumbnail}
...
>
> Więcej informacji na temat dostępu do tego narzędzia znajdziesz w [tym przewodniku](using_kvm_for_vps1.).  
> 
...
> [!warning]
> 
>Uwaga, jeśli wpiszesz to polecenie przed wykonaniem [etapu piątego](firewall-Linux-iptable_#step5.), zablokujesz dostęp do wszystkich usług, w tym do bieżącego dostępu, do SSH. Jest to szczególnie problematyczne w maszynie do zdalnego dostępu. 
>
