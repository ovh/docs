...
Please refer to our guide on [securing a VPS](secure_your_vps1.) for more information.
...
>
> For more information on accessing this tool, please refer to [this guide](using_kvm_for_vps1.).  
> 
...
> [!warning]
> 
> If you type this command before performing [step 5](firewall-Linux-iptable_#step5.), you will block all access including the current one, SSH access. This is particularly problematic on a machine you access remotely. 
>
