...
Para más información, consulte nuestra guía sobre la [seguridad de un VPS](secure_your_vps1.).
...
>
> Para más información sobre el acceso a esta herramienta, consulte [esta guía](using_kvm_for_vps1.).
> 
...
> [!warning]
> 
>Atención: Si introduce este comando antes de realizar [el paso 5](firewall-Linux-iptable_#step5.), bloqueará todos los accesos, incluido el actual, el acceso SSH. Esto es especialmente problemático en una máquina a la que se accede a distancia. 
>
