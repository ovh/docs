...
> [!primary]
>
Si la modificación no funciona como se esperaba, compruebe que el registro `A` esté bien configurado en la zona DNS del dominio. Atención: La modificación de la [zona DNS](setup_instance_reverse1.) puede tardar hasta 24 horas si solo ha cambiado recientemente el registro `A`.
>
