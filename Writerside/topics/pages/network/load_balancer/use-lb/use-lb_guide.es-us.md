...
![Añadir un frontend](images_iplb-add-front-end.png){.thumbnail}
...
![Parámetros avanzados](advanced_frontend.png){.thumbnail}
...
![Añadir una granja de servidores](iplb-cluster-adv.png){.thumbnail}
...
![Añadir servidor](iplb-cluster-add-server.png){.thumbnail}
![Añadir servidor](iplb-cluster-add-server-1.png){.thumbnail}
![Añadir servidor](iplb-cluster-add-server-2.png){.thumbnail}
...
![Contratar un certificado SSL](images_iplb-order-ssl.png){.thumbnail}
...
![Añadir un certificado SSL](iplb-add-ssl.png){.thumbnail}
