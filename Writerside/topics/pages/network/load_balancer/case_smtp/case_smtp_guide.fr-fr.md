...
![Service OVHcloud Load Balancer](iplb_service.png){.thumbnail}
...
Pour plus d'informations sur les fonctionnalités de l'API, consultez la page « [Détails des fonctions API](use_api_details1.) ».
...
![Ajout d'une ferme de serveurs via le Manager](add_farm_Probe.png){.thumbnail}
...
![Ajour d'un serveur dans une Ferme.](add_server_advance.png){.thumbnail}
