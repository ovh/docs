...
Avant de vous lancer, si vous ne l’avez pas encore lue, nous vous conseillons de consulter la [présentation générale du service Load Balancer](use_presentation1.).
...
Pour rappel, un guide de configuration du Load Balancer est disponible : [Configurer un service OVHcloud Load Balancer HTTP/HTTPS](create_http_https1.).
