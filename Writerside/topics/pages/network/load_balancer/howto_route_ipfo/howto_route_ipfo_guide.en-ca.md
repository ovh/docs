...
For more information on the OVH Load Balancer solution, you can read our [Introduction to the OVH Load Balancer](use_presentation1.){.external}.
...
![Configure the front-end by associating an Additional IP](iplb_frontend.png){.thumbnail}
...
![Apply a Load Balancer configuration](howto_route_ipfo_images_apply_configuration.png){.thumbnail}
