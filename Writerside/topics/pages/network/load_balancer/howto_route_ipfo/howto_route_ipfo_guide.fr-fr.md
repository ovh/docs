...
Pour plus d'informations sur le service OVHcloud Load Balancer, nous vous conseillons de consulter la [présentation générale de l'offre](use_presentation1.).
...
![Configurer le frontend en associant une IP Fail-Over](iplb_frontend.png){.thumbnail}
...
![Application d'une Configuration d'un Load Balancer](howto_route_ipfo_images_apply_configuration.png){.thumbnail}
