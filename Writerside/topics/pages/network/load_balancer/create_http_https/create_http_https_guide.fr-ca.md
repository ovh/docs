...
Avant de vous lancer, si vous ne l'avez pas encore lue, nous vous conseillons de consulter présentation générale du service OVHcloud Load Balancer: [Présentation de l’OVHcloud Load Balancer](use_presentation1.){.ref}
...
Pour plus d'informations sur les fonctionnalités du Manager, consulter la page [](use-lb1.){.ref}
...
> 
Pour plus d'informations sur les fonctionnalités de l'API, consulter la page [Référence Rapide API Load Balancer](use_api_reference1.){.ref}
