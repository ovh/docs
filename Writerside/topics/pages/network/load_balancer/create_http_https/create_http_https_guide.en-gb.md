...
If you have not done so already, we recommend reading a general introduction to the OVHcloud Load Balancer service before you get started: [Introduction to the OVHcloud Load Balancer](use_presentation1.)
...
![OVHcloud Load Balancer service](create_http_https_images_iplb_service.png){.thumbnail}
...
For more information on the API’s features, you can consult [the following guide in French](use_api_reference1.).
...
![Add an existing SSL certificate](add_certificat_custom.png){.thumbnail}
