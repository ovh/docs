...
Pour connaître les différentes parties élémentaires du service OVH Load Balancer, voir [Présentation Load Balancer](use_presentation1.){.external}.
...
![Appliquer la configuration](apply_config.png){.thumbnail}
