...
![Ajout d'une nouvelle ferme HTTP dédié à l'infrastructure A](ferme1.png){.thumbnail}
...
![Ajout d'un nouveau serveur à la ferme HTTP A](serveur1.png){.thumbnail}

![Renseigner la configuration du serveur HTTP A](server1.png){.thumbnail}
...
![Ajout d'une nouvelle ferme HTTP dédié à l'infrastructure B](ferme2.png){.thumbnail}

![Création d'une seconde ferme dédiée à l'infrastructure B](backend2.png){.thumbnail}
...
![Ajout d'une nouveau serveur à la ferme HTTP B](serveur2.png){.thumbnail}

![Renseigner la configuration du serveur HTTP B](server2.png){.thumbnail}
...
![Configuration des fermes](farms.png){.thumbnail}
...
![Ajout du frontend dédié à la production, Blue Frontend](frontend1.png){.thumbnail}

![Renseigner la configuration du frontend Blue](fblue.png){.thumbnail}
...
![Ajout du frontend dédié au développement, Green Frontend](frontend2.png){.thumbnail}

![Renseigner la configuration du frontend Green](fgreen.png){.thumbnail}
...
![Appliquer vos changements sur la zone](deploy.png){.thumbnail}
...
![Résultat après la mise à jour des frontends](switch.png){.thumbnail}
