...
![Modify a farm](farm_edit.png){.thumbnail}

In the `Advanced settings`, you will be able to access the `Track session` section:

![Modifying connection tracking](tracking_session.png){.thumbnail}
...
![Apply a Load Balancer configuration](images_apply_configuration.png){.thumbnail}
