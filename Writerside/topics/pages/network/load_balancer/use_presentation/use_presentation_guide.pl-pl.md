...
![Diagram - Load Balancer](diag_gen.png){.thumbnail}
...
![Równoważenie obciążenia](distribute_load.png){.thumbnail}
...
![Eliminacja przerw w ciągłości usługi](eliminate_downtimes.png){.thumbnail}
...
![Skalowalność Twojej infrastruktury](facilitate_maintenance.png){.thumbnail}
...
![Ułatwiona konserwacja infrastruktury](scale_easily.png){.thumbnail}
...
![Łączenie usług](mix_and_match.png){.thumbnail}
...
![Bazy danych](database.png){.thumbnail}
