...
![Advanced settings for a farm](farm_advanced_settings.png){.thumbnail}

This is how you access the probe type’s configuration.

![Probe settings](farm_advanced_settings_unfolded.png){.thumbnail}
...
![Advanced settings for a probe](probe_settings.png){.thumbnail}

A new configuration window will appear, with the probe’s settings.

![Advanced settings for a probe](probe_settings_dialog.png){.thumbnail}
