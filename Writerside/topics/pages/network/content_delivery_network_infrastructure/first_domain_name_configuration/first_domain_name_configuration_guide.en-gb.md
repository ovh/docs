...
![CDN Control Panel](cdn_customer_panel.png){.thumbnail}

In the first step, you can choose the subdomain you want to add to the CDN.

![Add a subdomain name on the CDN](add_cdn_domain_step_1.png){.thumbnail}
...
![Add a backend](add_cdn_domain_step_2.png){.thumbnail}
...
![Name of photo](cname_field.png){.thumbnail}
