...
![CDN Kundencenter](cdn_customer_panel.png){.thumbnail}

Im ersten Schritt können Sie die Subdomain auswählen, die Sie zum CDN hinzufügen möchten:

![Subdomain zum CDN hinzufügen](add_cdn_domain_step_1.png){.thumbnail}
...
![Backend hinzufügen](add_cdn_domain_step_2.png){.thumbnail}
...
![CNAME-Eintrag](cname_field.png){.thumbnail}
