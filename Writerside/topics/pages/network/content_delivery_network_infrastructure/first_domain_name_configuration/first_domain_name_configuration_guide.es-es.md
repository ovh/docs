...
![Añadir un subdominio a la CDN](add_cdn_domain_step_1.png){.thumbnail}
...
![Añadir un backend](add_cdn_domain_step_2.png){.thumbnail}
...
![Registro CNAME](cname_field.png){.thumbnail}
