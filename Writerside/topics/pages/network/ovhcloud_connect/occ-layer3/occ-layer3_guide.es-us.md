...
![L3 Implementation](occ-l3-implementation.png){.thumbnail}
...
![L3 Rules](occ-l3-rules.gif){.thumbnail}
...
![L3 Architecture](occ-l3-architecture.png){.thumbnail}
...
![L3 BGP vRack](occ-l3-bgpvrack.png){.thumbnail}

At a more global level, BGP topology will look like this:

![L3 BGP Global Topology](occ-l3-bgpglobal.png){.thumbnail}
...
![L3 BGP as-prepend](occ-l3-bgpasprepend-med.png){.thumbnail}
