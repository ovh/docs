...
![associate vRack](images_vrack01.png){.thumbnail}

Un message vous confirmera l'association du vRack.

![associate vRack](images_vrack2.png){.thumbnail}
...
![ajout Pop](images_pop1.png){.thumbnail}
...
![ajout Pop](images_l3pop1-1.png){.thumbnail}

Le menu `Configuration PoP` apparaîtra alors.

![ajout Pop](images_l3pop2.png){.thumbnail}
...
![ajout datacentre](images_l3dc0.png){.thumbnail}
...
![ajout datacentre](images_l3dc1.png){.thumbnail}
...
![ajout datacentre](images_l3dc1-1.png){.thumbnail}
...
![ajout datacentre](images_l3dc2.png){.thumbnail}

Choisissez alors le type de routage entre « Static » et « BGP ».

![ajout datacentre](images_l3dc3.png){.thumbnail}
...
![ajout datacentre](images_l3dc5.png){.thumbnail}
...
![ajout datacentre](images_l3dc4.png){.thumbnail}
...
![ajout datacentre](images_l3dc6.png){.thumbnail}
...
![suppression configuration routage](images_deleterouting.png){.thumbnail}
...
![suppression configuration DC](images_deletedc.png){.thumbnail}
...
![suppression configuration PoP](deletepopl3.png){.thumbnail}
