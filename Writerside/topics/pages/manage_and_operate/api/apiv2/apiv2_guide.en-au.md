...
> [!primary]
>
> The event and task examples shown above may vary by API section. Please refer to the [console](console-preview1.) to view the exact definition for each section.
>
...
[Exploring OVHcloud APIs](console-preview1.)

[Using Terraform with OVHcloud](terraform-at-ovhcloud1.) 
