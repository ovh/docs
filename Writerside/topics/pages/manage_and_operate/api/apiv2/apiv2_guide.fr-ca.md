...
![API](console-schemas-version.png){.thumbnail}
...
> [!primary]
>
> Les exemples d'évènement et de tâche présentés ci-dessus peuvent varier selon la section d'API. Veuillez vous référer à la [console](console-preview1.) pour visualiser la définition exacte relative à chaque section.
>
...
[Exploration des API OVHcloud](console-preview1.)

[Using Terraform with OVHcloud](terraform-at-ovhcloud1.) (guide en anglais)
