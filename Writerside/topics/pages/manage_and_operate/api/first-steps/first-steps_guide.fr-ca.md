...
![API keys](api-keys-ca.png){.thumbnail} 
...
Le token **CK** peut être utilisé pour de la délégation de droits. Consultez le guide suivant pour en savoir plus : [Comment gérer le compte d'un client OVHcloud via les API](api_right_delegation1.) (guide en anglais).
