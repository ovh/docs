...
> [!primary]
>
> Se il tuo account OVHcloud è protetto da una [doppia autenticazione](secure-ovhcloud-account-with-2fa1.), inserisci anche il codice generato tramite SMS o applicazione OTP o chiave U2F.
>
...
Il token **CK** può essere utilizzato per la delega dei diritti. Per saperne di più, consulta questa guida: [Come gestire l'account di un cliente OVHcloud tramite le API](api_right_delegation1.) (guida in inglese).
...
[Gestire un dominio tramite le API OVHcloud](api_domain_intro1.) (guida in inglese)

[Come gestire l'account di un cliente OVHcloud tramite le API](api_right_delegation1.) (guida in inglese)
