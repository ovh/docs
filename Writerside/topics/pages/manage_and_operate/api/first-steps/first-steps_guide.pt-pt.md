...
> 
> Este manual fornece as instruções necessárias para realizar as operações mais habituais. No entanto, se encontrar dificuldades, recomendamos que recorra a um [prestador de serviços especializado](https://partner.ovhcloud.com/pt/directory/) e/ou que contacte o editor do serviço. Não poderemos proporcionar-lhe assistência técnica. Para mais informações, aceda à secção «[Quer saber mais?](first-steps_#gofurther.)» deste guia.
> 
...
> [!primary]
>
> Se a sua conta OVHcloud estiver protegida por uma [dupla autenticação](secure-ovhcloud-account-with-2fa1.), deverá também introduzir o código gerado por SMS ou aplicação OTP ou chave U2F.
>
...
O token **CK** pode ser utilizado para a delegação de direitos. Para saber mais, consulte o seguinte guia: [Como gerir a conta de um cliente OVHcloud através das API](api_right_delegation1.) (guia em inglês).
...
[Gerir um domínio através das API OVHcloud](api_domain_intro1.) (guia em inglês)

[Como gerir a conta de um cliente OVHcloud através das API](api_right_delegation1.) (guia em inglês)
