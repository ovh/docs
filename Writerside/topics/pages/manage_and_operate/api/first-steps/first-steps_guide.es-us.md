...
> 
> Esta guía le ayudará a realizar las operaciones más habituales. No obstante, si tiene alguna duda le recomendamos que contacte con un proveedor de servicios especializado o con el editor del servicio. Nosotros no podremos asistirle. Para más información, consulte el apartado [«Más información»](first-steps_#gofurther.) de esta guía.
>
...
![API](images_login.png){.thumbnail} 

> [!primary]
>
> Si su cuenta de OVHcloud está protegida por una [doble autenticación](secure-ovhcloud-account-with-2fa1.), también deberá introducir el código generado por SMS o aplicación OTP o llave U2F.
>
...
![API](api-displayed.png){.thumbnail} 
...
![API keys](api-keys.png){.thumbnail} 
...
El token **CK** puede utilizarse para delegar permisos. Para más información, consulte la siguiente guía: [Cómo gestionar la cuenta de un cliente de OVHcloud a través de las API](api_right_delegation1.) (guía en inglés).
...
[Gestionar los dominios a través de la API](api_domain_intro1.) (documentación en inglés)

[Cómo gestionar la cuenta de un cliente de OVHcloud a través de las API](api_right_delegation1.) (guía en inglés)
