...
- Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl), and navigate to the Bare Metal Cloud section located at the top left in the header.
