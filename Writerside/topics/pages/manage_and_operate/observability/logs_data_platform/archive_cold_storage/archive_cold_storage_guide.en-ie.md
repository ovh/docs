...
As implied in the title, you will need a stream. If you don't know what a stream is or if you don't have any, you can follow this [quick start tutorial](getting_started_quick_start1.). You must edit the stream configuration to activate the cold storage. Click on the Edit button in the menu to go to the stream configuration page.

![Streams menu](streams-menu-1.png){.thumbnail}
...
- The content of your archives : GELF, one special field [X-OVH-TO-FREEZE](getting_started_field_naming_convention1.), or both (you will get two separate archive in this case)
...
![Edit menu](edit-1.png){.thumbnail}
...
![Archive page](archive-1.png){.thumbnail}
