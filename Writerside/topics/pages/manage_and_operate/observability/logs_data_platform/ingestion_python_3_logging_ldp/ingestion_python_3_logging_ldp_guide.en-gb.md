...
- a formatter to convert logging record into [GELF(1.1)](gelf.html?tocpath=Getting%20in%20Log%20Data%7CLog%20Sources%7CGELF%7C_____0#GELFPayloadSpecification#gelf-payload-specification){.external}.
- a facility to ensure fields suits the [LDP naming conventions](getting_started_field_naming_convention1.).
...
* Fields are types using the [LDP naming convention](getting_started_field_naming_convention1.): `manager.age` is renamed `manager_age_int`
