...
- You are already sending logs on a stream you own: [see the quick start tutorial](getting_started_quick_start1.)
- There is nothing else

After some training you will be able to do this kind of Dashboard:

![OpenSearch Dashboards](osd.png)
...
![Alias creation](visualization_opensearch_dashboards_images_alias.png){.thumbnail}
...
![osd setup](osd_setup.png){.thumbnail}

You can also explore any [OpenSearch index](opensearch_index1.) you created on the platform. One OpenSearch Dashboards instance allows you to explore all the data you delivered on Logs Data Platform.
