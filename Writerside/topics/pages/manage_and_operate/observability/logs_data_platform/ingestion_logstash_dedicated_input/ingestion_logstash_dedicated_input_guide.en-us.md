...
If you are new to Logs Data Platform, completion of the [Quick Start Tutorial](getting_started_quick_start1.) is highly recommended.
...
![local\_logstash\_graylog](local_logstash_graylog.png){.thumbnail}
...
- Finally, select the number of instances you would need to handle your load. We recommend to have at least two instances to ensure the high availabilty of your Logstash. However some uses cases need you to limit the number of instance at 1 (like the [Twitter use case](usecase_twitter1.)).
...
![logstash_creation](logstash_created.png){.thumbnail}
...
![logstash_creation](config_logstash_1.png){.thumbnail}
...
![logstash_creation](input_section.png){.thumbnail}
...
![logstash_creation](filter_section.png){.thumbnail}
...
![logstash_testing](test_success.png){.thumbnail}
...
![input_start](input_start.png){.thumbnail}
...
![logs_graylog](logstash_ssl.png){.thumbnail}
...
![input_ca](input_ca.png){.thumbnail}
...
![input_console](input_console.png){.thumbnail}
...
- [Logstash + Groks + Filebeat = Awesome](ingestion_filebeat1.)
