...
- [Starting with Logs Data Platform.](getting_started_quick_start1.)
- [How to setup a Logstash input?](ingestion_logstash_dedicated_input1.)
- [Using Filebeat with Logs Data Platform.](ingestion_filebeat1.)
...
We cover Filebeat in depth in [another tutorial](ingestion_filebeat1.){.external}. Here is a minimal **filebeat.yml** configuration file.
...
![slow_graylog](mysql_slow_graylog.png){.thumbnail}
