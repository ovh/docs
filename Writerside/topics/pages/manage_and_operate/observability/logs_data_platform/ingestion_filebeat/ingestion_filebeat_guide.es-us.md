...
This configuration deactivates the template configuration (unneeded for our endpoint). You need to provide your credentials **<username>** and **<password>** of your account. Like all Logs Data Platform APIs you can also use [tokens](security_tokens1.). Don't change **ldp-logs** since it is our special destination index.
...
![beat_graylog](beats_graylog.png){.thumbnail}
...
- Learn how to configure Filebeat and Logstash to add your own extra filters: [Dedicated input - Logstash](ingestion_logstash_dedicated_input1.)
