...
![Alias creation](alias.png){.thumbnail}

If you only have [indices](opensearch_index1.), you can use them directly in the ElastAlert configuration.
...
- `<password>` is the associated password. You can use [tokens](security_tokens1.) in place of the username/password couple for your credentials.
...
To test your alert you can use the following curl command sending logs to our [OpenSearch endpoint](ingestion_opensearch_api_mutualized_input1.):
