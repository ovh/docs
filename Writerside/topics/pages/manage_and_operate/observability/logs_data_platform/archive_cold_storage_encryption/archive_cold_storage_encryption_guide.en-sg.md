...
With the [Cold Storage feature](archive_cold_storage1.) you can generate daily archives for your log streams.
...
- A stream with cold storage enabled. You can follow this [Cold Storage tutorial](archive_cold_storage1.) to set it up.
...
![PGP keys home page](pgp_home.png){.thumbnail}
...
![Add a new PGP key](add_key.png){.thumbnail}
...
- Ensure the `Enable long-term storage` option is checked. You can refer to the [Cold Storage feature](archive_cold_storage1.) documentation to know about each of its fields.
...
![Update stream configuration](update_stream.png){.thumbnail}
...
![List archives](archives.png){.thumbnail}
...
Once your encrypted archives are available, you can retrieve them [following this tutorial](archive_cold_storage#retrieving-the-archives.).
