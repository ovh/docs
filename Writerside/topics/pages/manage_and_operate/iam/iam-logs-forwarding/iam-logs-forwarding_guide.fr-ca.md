...
Pour découvrir Logs Data Platform avant de poursuivre ce guide, référez-vous à [cette documentation](getting_started_introduction_to_LDP1.).

## Prérequis

- Disposer d'un [compte client OVHcloud](ovhcloud-account-creation1.).
- Disposer d'un compte Logs Data Platform (LDP) au sein de votre compte OVHcloud avec au moins un flux actif configuré. [Ce guide](getting_started_quick_start1.) vous guidera dans toutes les étapes nécessaires.
...
>   
> ![Find stream ID](retrieve_streamId_1.png){.thumbnail}
> 
> - Copiez la page `streamId` de votre compte Logs Data Platform.
>   
> ![Find stream ID](retrieve_streamId_2.png){.thumbnail}
...
![Access Graylog](access_graylog.png){.thumbnail}
...
![Access Graylog](access_graylog_2.png){.thumbnail}
...
![Access Graylog](access_graylog_3.png){.thumbnail}

Pour plus de détails sur l'utilisation de vos logs avec Logs Data Platform, reportez-vous à la documentation [Logs Data Platform - Visualisation, interrogation et exploitation de vos logs](observability-logs-data-platform-visualizing-querying-exploiting1.). Cela comprend :
...
![Audit log](Audit_log_login.png){.thumbnail}
...
![Audit log](Audit_log_password_change.png){.thumbnail}
...
![Journal d'activité](Activity_logs.png){.thumbnail}
...
![Journal d'activité](Access_Policies_logs.png){.thumbnail}
