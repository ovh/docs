...
- Savoir configurer des [politiques d'accès via API](iam-policies-api1.).
- Vous savez [utiliser l'API OpenStack](starting_with_nova1.).
- Avoir créé un [compte de service via API](manage-service-account1.).
