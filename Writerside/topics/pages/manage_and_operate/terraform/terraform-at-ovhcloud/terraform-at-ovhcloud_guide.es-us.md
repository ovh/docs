...
- [OVH provider](https://registry.terraform.io/providers/ovh/ovh/latest) that interacts with [OVHcloud API portal](https://api.ovh.com/). You can refer to [this guide](first-steps1.) to learn more on how to use the API portal. Furthermore, the OVH provider evolves as fast as the OVHcloud offering, be sure to follow the [releases](https://github.com/ovh/terraform-provider-ovh/releases).
...
|Kubernetes Load Balancer|Hashicorp kubernetes|[kubernetes_service](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/service) as described in this [tutorial](using-lb1.)|
...
| Control Panel concept | Terraform provider(s) | Resource or Data Source  |
| --- | --- | --- |
| AI Notebooks | not available but [ovhai CLI](cli_15_commands_reference1.) can help for automation||
| AI Training | not available but [ovhai CLI](cli_15_commands_reference1.) can help for automation||
| AI Deploy | not available but [ovhai CLI](cli_15_commands_reference1.) can help for automation||
...
- [Creating a kubernetes cluster on Terraform](creating-a-cluster-through-terraform1.)
- [Creating a private registry (Harbor) through Terraform](creating-a-private-registry-through-terraform1.)
- [Using OVHcloud High Performance (S3) Object Storage as Terraform Backend to store your Terraform state](use_object_storage_terraform_backend_state1.)
