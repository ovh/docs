...
- a [Veeam Enterprise solution](https://www.ovhcloud.com/en-ie/storage-solutions/veeam-enterprise/){.external}
...
![terms conditions](veeamBandR_inst_02.png){.thumbnail}

Click `Next`{.action} to skip the step of opening a licence file.

![licence](veeamBandR_inst_03.png){.thumbnail}
...
![installation path](veeamBandR_inst_04.png){.thumbnail}
...
![veeam console](veeamBandR_use_12.png){.thumbnail}

Check that it is in **Community Edition** mode, in the bottom right-hand corner.

![free edition](Veeamcommunity.png){.thumbnail}
...
![security](veeamBandR_conf_3.png){.thumbnail}
...
![control panel register](veeam001.png){.thumbnail}
...
![licence activated](veeam02.png){.thumbnail}
...
![open menu](veeamBandR_lic_1.png){.thumbnail}
