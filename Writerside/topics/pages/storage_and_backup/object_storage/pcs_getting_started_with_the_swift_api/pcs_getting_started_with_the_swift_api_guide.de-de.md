...
- [Vorbereitung der Umgebung für die Verwendung der OpenStack API](prepare_the_environment_for_using_the_openstack_api1.) durch Installation des *python-swiftclient*
...
Diese URL besteht einem API-Zugriffspunkt, den Sie im [Horizon Interface](access_and_security_in_horizon1.) abrufen können, sowie aus dem Namen des Containers und des gewünschten Objekts (einschließlich Präfix).
