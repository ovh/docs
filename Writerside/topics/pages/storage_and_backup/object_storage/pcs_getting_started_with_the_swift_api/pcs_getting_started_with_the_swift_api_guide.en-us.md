...
This URL is made up of an endpoint, available from the [Horizon interface](access_and_security_in_horizon1.), the name of your container and the name of your object (including the prefix).
