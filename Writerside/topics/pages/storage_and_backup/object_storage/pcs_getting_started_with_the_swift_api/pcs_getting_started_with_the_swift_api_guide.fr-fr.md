...
Cette URL est composée d'un point de terminaison, disponible à partir de l'[interface Horizon](access_and_security_in_horizon1.), du nom de votre conteneur et du nom de votre objet (y compris le préfixe).
