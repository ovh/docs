...
- Access to your [OVHcloud Control Panel](www.ovh.co.uk_\&ovhSubsidiary=GB.)

## Instructions

Log in to [the OVHcloud Control Panel](www.ovh.co.uk_\&ovhSubsidiary=GB.), go to the `Public Cloud`{.action} section, and select the Public Cloud project concerned. Then click on `Object Storage`{.action} in the left-hand menu.
