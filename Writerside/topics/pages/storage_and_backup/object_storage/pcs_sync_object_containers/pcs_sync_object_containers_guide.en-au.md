...
- [An environment that is ready to use the OpenStack API with the Swift client](prepare_the_environment_for_using_the_openstack_api1.)
- [OpenStack environment variables set](loading_openstack_environment_variables1.)
