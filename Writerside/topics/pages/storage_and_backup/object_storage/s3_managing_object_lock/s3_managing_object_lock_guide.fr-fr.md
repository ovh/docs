...
>
> Pour en savoir plus sur aws cli, suivez ce [guide](s3_getting_started_with_object_storage1.).
>
...
*Lisez ce [guide](s3_identity_and_access_management1.) pour en savoir plus sur la gestion des identités et des accès.*
