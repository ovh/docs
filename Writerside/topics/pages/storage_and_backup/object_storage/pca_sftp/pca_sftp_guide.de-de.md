...
Sie können OpenStack Login und Passwort anhand [dieser Anleitung](create_and_delete_a_user1.) generieren.
...
![cPanel](images_image1.png){.thumbnail}
...
![Verbindung](images_image2.png){.thumbnail}
...
![Verbindung](image3.png){.thumbnail}
...
![Verbindung](conf1.png){.thumbnail}
