...
- [Crea un container Object Storage](pcs_create_container1.)
- [Creare un utente per accedere a Horizon](create_and_delete_a_user#crea-un-utente-openstack.)
...
- [Impostare le variabili d'ambiente OpenStack](loading_openstack_environment_variables#step-1-recupera-le-variabili.){.ref}
