...
- [Crear un contenedor Object Storage](pcs_create_container1.)
- [Crear un acceso a Horizon](create_and_delete_a_user#requisitos.)
...
- [Cargar las variables de entorno OpenStack](loading_openstack_environment_variables#paso-1-obtener-las-variables.){.ref}
