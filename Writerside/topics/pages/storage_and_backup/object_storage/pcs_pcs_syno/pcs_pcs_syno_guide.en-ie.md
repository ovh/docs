...
- [Create an Object Storage container](pcs_create_container1.)
- [Configure an Openstack user](create_and_delete_a_user#creating-an-openstack-user.)
...
[Setting OpenStack environment variables](loading_openstack_environment_variables#step-1-retrieve-the-variables.)
