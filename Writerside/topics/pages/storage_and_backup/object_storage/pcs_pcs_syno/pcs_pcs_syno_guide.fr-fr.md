...
- [Créer un conteneur de stockage](pcs_create_container1.)
- [Créer un utlisateur OpenStack](create_and_delete_a_user#creation-dun-utilisateur-openstack.)
...
- [Charger les variables d'environnement OpenStack](loading_openstack_environment_variables#recuperation-des-variables.){.ref}
