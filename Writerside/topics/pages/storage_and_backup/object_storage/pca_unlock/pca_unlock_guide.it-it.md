...
![disgelo](unfreeze.png){.thumbnail}

Una volta avviato il processo, la data e l'ora di disponibilità dell'archivio sono mostrate nella colonna `Disponibilità`.

![tempo prima del ritiro](unfreeze_result.png){.thumbnail}

Il tuo file sarà disponibile al download al termine di questo periodo. Il download può essere avviato direttamente dal browser o tramite [un client Swift/SFTP/SCP](pca_sftp1.).
