...
S3 object storage classes offer a wide range of S3 API support. All compatible APIs are described in our [S3 compatibility guide](s3_s3_compliancy1.).
...
Yes, S3 Object Storage is largely compatible with S3 APIs and can be integrated with market tools such as [Veeam](s3_veeam1.), [Owncloud](s3_owncloud1.), [Nextcloud](s3_nextcloud1.).
...
The list of endpoints is available in the following guide: [Object Storage endpoints and geo-availability](s3_location1.).
...
You can manage multiple user profiles with S3 Policies. Read our [Identity and Access Management](s3_identity_and_access_management1.) guide.

### How do I configure access rights by object or bucket?

Access rights can be configured per user profile and per object. Read our [Identity and Access Management](s3_identity_and_access_management1.) guide.
...
You can find more information in the following guide: [Encrypt your server-side objects with SSE-C](s3_encrypt_your_objects_with_sse_c1.).
...
You can find more information in our [Object Lock Immutability Management (WORM)](s3_managing_object_lock1.) guide.
...
- [Use S3 Object Storage with rClone](s3_rclone1.)
- [Use Swift Object Storage with rclone](pcs_sync_rclone_object_storage1.)
