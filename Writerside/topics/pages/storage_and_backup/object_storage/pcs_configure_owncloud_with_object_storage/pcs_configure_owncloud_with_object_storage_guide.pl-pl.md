...
- The OpenRC file, obtained from the [OVHcloud Control Panel](create_and_delete_a_user1.) or [Horizon](introducing_horizon1.)
- [Storage space](pcs_create_container1.) dedicated to ownCloud
...
![ownCloud](img_3325.jpg){.thumbnail}
...
![ownCloud](img_3330.jpg){.thumbnail}
