...
- Le fichier OpenRC, obtenu depuis l'[espace client OVHcloud](create_and_delete_a_user1.) ou [Horizon](introducing_horizon1.)
- [Espace de stockage](pcs_create_container1.) dédié à ownCloud
