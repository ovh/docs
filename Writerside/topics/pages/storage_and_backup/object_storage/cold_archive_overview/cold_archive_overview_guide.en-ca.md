...
[OVHcloud Cold Archive](https://www.ovhcloud.com/en-ca/public-cloud/cold-archive/) is  a class of storage designed for a long-term strage of non-actively used data.
...
![Cold Archive concept](cold_archive_overview-20230117154349550.png){.thumbnail}
...
Cold Archive is a service based on Object Storage - S3 API. Performance and limitations (number of buckets, account, maximum bandwidth per connection, number of request per second on bucket, maximum size per object / mpu / part, etc) are available [here](s3_limitations1.).
...
<!--
Our price are described [here](https://www.ovhcloud.com/en-ca/public-cloud/prices/).
-->
...
Operate your lifecycle and learn how to create buckets, archive, retrieve data, list metadata, reading [this guide](cold_archive_getting_started1.).

[All the Object Storage documentation](storage-object-storage1.).
