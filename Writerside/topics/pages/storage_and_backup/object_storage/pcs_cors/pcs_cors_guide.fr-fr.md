...
- [Préparer l’environnement pour utiliser l’API OpenStack](prepare_the_environment_for_using_the_openstack_api1.){.external} en installant python-swiftclient
- [Charger les variables d’environnement OpenStack](loading_openstack_environment_variables1.){.external}
