...
- [OpenStack users](create_and_delete_a_user1.)
- [Preparing the environment to use the OpenStack API](prepare_the_environment_for_using_the_openstack_api1.) by installing python-swiftclient
- [Loading the OpenStack environment variables](loading_openstack_environment_variables1.)
...
![Creating new users](images_create-users.png)
...
![Other user](images_other-user.png)
...
Accept-Ranges: bytes
X-Storage-Policy: PCS
Last-Modified: Wed, 04 May 2022 18:00:00 GM
TX-Timestamp: 1629925988.34920
Content-Type: text/plain; charset=utf-8
Vary: Accept
