...
- You need to have created an *Object Storage* container (you can create one from the Control Panel or from [Horizon](pcs_create_container1.){.external})
...
![Télécharger un fichier de configuration Rclone](pcs_sync_rclone_pcs-20211008090532581.png)
