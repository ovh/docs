...
- Aver creato un container *Object Storage* (dallo Spazio Cliente OVH o dall’interfaccia [Horizon](pcs_create_container1.){.external})
- Aver creato un [utente OpenStack](create_and_delete_a_user1.){.external}
...
![Scarica un file di configurazione rClone](download_file.png){.thumbnail}
