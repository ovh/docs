...
- Utworzony kontener *Object Storage* (z poziomu Panelu klienta lub z poziomu [Horizon](pcs_create_container1.){.external}).
- Utworzony [użytkownik OpenStack](create_and_delete_a_user1.){.external}.
...
Po utworzeniu [użytkownika OpenStack](create_and_delete_a_user1.){.external} w Panelu klienta możesz uzyskać plik konfiguracyjny rClone.
...
![Pobierz plik konfiguracyjny rClone](download_file.png){.thumbnail}
