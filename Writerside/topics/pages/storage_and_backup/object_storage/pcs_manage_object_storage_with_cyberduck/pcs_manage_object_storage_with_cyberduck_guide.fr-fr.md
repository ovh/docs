...
- Disposer de vos identifiants utilisateur (*OS_USERNAME*) et de projet (*OS_PROJECT_NAME* ou *OS_TENANT_NAME*), que vous pouvez obtenir en téléchargeant le fichier « OpenRC » dans le menu [Users and Roles](loading_openstack_environment_variables#etape-1-recuperer-les-variables.) de votre [espace client Public Cloud OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr).
- Disposer de votre mot de passe d'utilisateur OpenStack.

Si vous ne connaissez plus votre mot de passe d'utilisateur OpenStack, vous pouvez le modifier en suivant [ce guide](change_openstack_user_password_in_horizon1.).
...
![objectstorage-cyberduck](pcs_manage_object_storage_with_cyberduck_images_login.png){.thumbnail}
...
![objectstorage-cyberduck](images_successful-login.png){.thumbnail}
...
[Débuter avec l'API Swift](pcs_getting_started_with_the_swift_api1.)
