...
Konto OVHcloud jest domyślnie kontaktem administracyjnym, technicznym i księgowym dla usługi. Więcej informacji znajdziesz w naszym przewodniku ["Zarządzanie kontaktami swoich usług"](managing_contacts1.).
...
Więcej informacji znajdziesz w przewodniku ["Zarządzanie wolumenami"](netapp_volumes1.).
...
Więcej informacji znajdziesz w przewodniku ["Zarządzanie ACL wolumenu"](netapp_volume_acl1.).
...
Więcej informacji znajdziesz w przewodniku ["Zarządzanie snapshotami wolumenu"](netapp_volume_snapshots1.).
