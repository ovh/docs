...
La cuenta de OVHcloud es por defecto el contacto administrador, técnico y de facturación del servicio. Para más información, consulte nuestra guía ["Gestionar los contactos de los servicios"](managing_contacts1.).
...
Para más información, consulte la guía ["Gestionar los volúmenes"](netapp_volumes1.).
...
Para más información, consulte la guía ["Gestionar las ACL de un volumen"](netapp_volume_acl1.).
...
Para más información, consulte la guía ["Gestionar los snapshots de un volumen"](netapp_volume_snapshots1.).
