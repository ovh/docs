...
Le compte OVHcloud est par défaut le contact administrateur, technique et facturation du service. Retrouvez plus d’informations sur notre guide « [Gérer les contacts de ses services»](managing_contacts1.) ».
...
Retrouvez plus d'informations sur le guide [« Gérer vos volumes »](netapp_volumes1.).
...
Retrouvez plus d'informations sur le guide [« Gérer les ACL d'un volume »](netapp_volume_acl1.).
...
Retrouvez plus d'informations sur le guide [« Gérer les snapshots d'un volume »](netapp_volume_snapshots1.).
