...
Enterprise File Storage Dienste können über die [OVHcloud API](netapp_quick_start1.) oder in Ihrem OVHcloud Kundencenter verwaltet werden.
...
![Allgemeine Informationen](manage_enterprise01.png){.thumbnail}
...
> [!primary]
> Detaillierte Informationen zu den technischen Eigenschaften der Enterprise File Storage Lösung finden Sie auf der Seite [Enterprise File Storage - Konzepte](netapp_concepts1.).
>
...
![Volume](manage_enterprise03.png){.thumbnail}
...
![Verwaltung der Volumes](manage_enterprise04.png){.thumbnail}
...
Um Ihre [Snapshot-Regeln](#snapshot_policy.) zu konfigurieren, gehen Sie zurück zum [Volume-Verwaltungsbereich](netapp_control_panel_#instructions.) des Dienstes und öffnen Sie den Tab `Regeln für Snapshots`{.action}.
...
- [Sich mit der Nutzung von Enterprise File Storage über die API vertraut machen](netapp_control_panel_#gofurther.) (optional)

## Weiterführende Informationen <a name="gofurther"></a>

[Enterprise File Storage - Quickstart API](netapp_quick_start1.)

[Enterprise File Storage - Verwaltung der Volumes](netapp_volumes1.)

[Enterprise File Storage - Verwaltung der Volume ACL](netapp_volume_acl1.)

[Enterprise File Storage - Verwaltung der Volume Snapshots](netapp_volume_snapshots1.)
