...
Los servicios Enterprise File Storage pueden administrarse [a través de la API de OVHcloud](netapp_quick_start1.) o desde el área de cliente de OVHcloud.
...
![Información general](manage_enterprise01.png){.thumbnail}
...
> [!primary]
> Para más información sobre las propiedades técnicas de la solución Enterprise File Storage, consulte la página [Concepts](netapp_concepts1.).
>
...
![Volúmenes](manage_enterprise02.png){.thumbnail}
...
![Volumen de creación](manage_enterprise03.png){.thumbnail}
...
![Gestión de volúmenes](manage_enterprise04.png){.thumbnail}
...
![Snapshots](manage_enterprise05.png){.thumbnail}
...
![Snapshots](manage_enterprise06.png){.thumbnail}
...
Para configurar sus [políticas de snapshot](#snapshot_policy.), acceda a la sección [Gestión de volúmenes](netapp_control_panel_#instructions.) del servicio y abra la pestaña `Snapshot policiales`{.action}.
...
![ACL](manage_enterprise07.png){.thumbnail}
...
![Snapshots](manage_enterprise08.png){.thumbnail}
...
![Snapshots](manage_enterprise09.png){.thumbnail}
...
- [Cómo utilizar Enterprise File Storage a través de la API con nuestras guías](netapp_control_panel_#gofurther.) (opcionales)

## Más información <a name="gofurther"></a>

[Enterprise File Storage - API Quickstart](netapp_quick_start1.)

[Enterprise File Storage - Gestión de volúmenes](netapp_volumes1.)

[Enterprise File Storage - Gestión de ACL de volumen](netapp_volume_acl1.)

[Enterprise File Storage - Gestión de snapshots de volúmenes](netapp_volume_snapshots1.)
