...
I servizi Enterprise File Storage possono essere gestiti [tramite le API OVHcloud](netapp_quick_start1.) o dallo Spazio Cliente OVHcloud.
...
![Informazioni generali](manage_enterprise01.png){.thumbnail}
...
> [!primary]
> Consulta la pagina [Concetti](netapp_concepts1.) per ottenere informazioni dettagliate sulle proprietà tecniche della soluzione Enterprise File Storage.
>
...
![Volumi](manage_enterprise02.png){.thumbnail}
...
![Volume di creazione](manage_enterprise03.png){.thumbnail}
...
![Gestione dei volumi](manage_enterprise04.png){.thumbnail}
...
![Snapshot](manage_enterprise05.png){.thumbnail}
...
![Snapshot](manage_enterprise06.png){.thumbnail}
...
Per configurare le tue [politiche di Snapshot](#snapshot_policy.), torna alla sezione [Gestione dei volumi](netapp_control_panel_#instructions.) del tuo servizio e apri la scheda `Snapshot poliziesche`{.action}.
...
![Snapshot](manage_enterprise08.png){.thumbnail}
...
![Snapshot](manage_enterprise09.png){.thumbnail}
...
- [Scopri come utilizzare Enterprise File Storage via API consultando le nostre guide](netapp_control_panel_#gofurther.) (in opzione)

## Per saperne di più <a name="gofurther"></a>

[Enterprise File Storage - API Quickstart](netapp_quick_start1.)

[Enterprise File Storage - Gestione dei volumi](netapp_volumes1.)

[Enterprise File Storage - Gestione delle ACL di volume](netapp_volume_acl1.)

[Enterprise File Storage - Gestione degli Snapshot dei volumi](netapp_volume_snapshots1.)
