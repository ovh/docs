...
Os serviços Enterprise File Storage podem ser geridos [através das API OVHcloud](netapp_quick_start1.) ou a partir da Área de Cliente OVHcloud.
...
![Informações gerais](manage_enterprise01.png){.thumbnail}
...
> [!primary]
> Consulte a página [Conceitos](netapp_concepts1.) para obter informações detalhadas sobre as propriedades técnicas da solução Enterprise File Storage.
>
...
![Volume de criação](manage_enterprise03.png){.thumbnail}
...
![Gestão dos volumes](manage_enterprise04.png){.thumbnail}
...
Para configurar as suas [políticas de snapshot](#snapshot_policy.), volte à secção [Gestão dos volumes](netapp_control_panel_#instructions.) do seu serviço e abra o separador `Snapshot policiais`{.action}.
...
- [Saiba como utilizar o Enterprise File Storage através da API ao consultar os nossos guias](netapp_control_panel_#gofurther.) (como opção)

## Quer saber mais? <a name="gofurther"></a>

[Enterprise File Storage - API Quickstart](netapp_quick_start1.)

[Enterprise File Storage - Gestão de volumes](netapp_volumes1.)

[Enterprise File Storage - Gestão dos ACL de volume](netapp_volume_acl1.)

[Enterprise File Storage - Gestão das snapshots de volumes](netapp_volume_snapshots1.)
