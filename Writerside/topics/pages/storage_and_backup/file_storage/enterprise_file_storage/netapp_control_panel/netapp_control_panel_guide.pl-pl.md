...
Usługi Enterprise File Storage mogą być zarządzane [za pośrednictwem API OVHcloud](netapp_quick_start1.) lub w Panelu klienta OVHcloud.
...
![Informacje ogólne](manage_enterprise01.png){.thumbnail}
...
> [!primary]
> Zapoznaj się ze stroną [Concepts](netapp_concepts1.), aby uzyskać szczegółowe informacje na temat właściwości technicznych rozwiązania Enterprise File Storage.
>
...
![Wolumeny](manage_enterprise02.png){.thumbnail}
...
![Wolumen tworzenia](manage_enterprise03.png){.thumbnail}
...
![Zarządzanie wolumenami](manage_enterprise04.png){.thumbnail}
...
![Snapshoty](manage_enterprise05.png){.thumbnail}
...
![Snapshoty](manage_enterprise06.png){.thumbnail}
...
Aby skonfigurować [politykę snapshotów](#snapshot_policy.), wróć do sekcji [Zarządzanie wolumenami](netapp_control_panel_#instructions.) usługi i otwórz zakładkę `Snapshot policies`{.action}.
...
![Snapshoty](manage_enterprise08.png){.thumbnail}
...
![Snapshoty](manage_enterprise09.png){.thumbnail}
...
- [Dowiedz się, jak korzystać z Enterprise File Storage poprzez API, sprawdź nasze przewodniki](netapp_control_panel_#gofurther.) (opcjonalnie)

## Sprawdź również <a name="gofurther"></a>

[Enterprise File Storage - API Quickstart](netapp_quick_start1.)

[Enterprise File Storage - Zarządzanie wolumenami](netapp_volumes1.)

[Enterprise File Storage - Zarządzanie ACL wolumenu](netapp_volume_acl1.)

[Enterprise File Storage - Zarządzanie snapshotami wolumenów](netapp_volume_snapshots1.)
