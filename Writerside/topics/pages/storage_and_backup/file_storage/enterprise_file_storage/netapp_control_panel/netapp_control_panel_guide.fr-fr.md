...
![Informations générales](manage_enterprise01.png){.thumbnail}
...
> [!primary]
> Consultez la page [Concepts](netapp_concepts1.) pour obtenir des informations détaillées sur les propriétés techniques de la solution Enterprise File Storage.
>
...
![Volume de création](manage_enterprise03.png){.thumbnail}
...
![Gestion des volumes](manage_enterprise04.png){.thumbnail}
...
Afin de configurer vos [politiques de snapshot](#snapshot_policy.), revenez à la section [Gestion des volumes](netapp_control_panel_#instructions.) de votre service et ouvrez l'onglet `Snapshot policies`{.action}.
...
- [Apprenez à utiliser Enterprise File Storage via API en consultant nos guides](netapp_control_panel_#gofurther.) (en option)
