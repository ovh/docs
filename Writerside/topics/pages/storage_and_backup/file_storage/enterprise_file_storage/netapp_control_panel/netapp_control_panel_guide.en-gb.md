...
Enterprise File Storage services can be managed [via the OVHcloud API](netapp_quick_start1.) or in the OVHcloud Control Panel.
...
![General information](manage_enterprise01.png){.thumbnail}
...
> [!primary]
> Please visit the [concepts page](netapp_concepts1.) for detailed information on the technical properties of Enterprise File Storage.
>
...
![Volumes](manage_enterprise02.png){.thumbnail}
...
![Creation volume](manage_enterprise03.png){.thumbnail}
...
![Volume management](manage_enterprise04.png){.thumbnail}
...
In order to configure your [snapshot policies](#snapshot_policy.), navigate back to the [volume management section](netapp_control_panel_#instructions.) of your service and open the tab `Snapshot policies`{.action}.
...
- [Learn how to use Enterprise File Storage via API by consulting our guides](netapp_control_panel_#gofurther.) (optional)

## Go further <a name="gofurther"></a>

[API Quickstart](netapp_quick_start1.)

[Managing volumes via API](netapp_volumes1.)

[Managing volume ACLs via API](netapp_volume_acl1.)

[Managing volume snapshots via API](netapp_volume_snapshots1.)
