...
Enterprise File Storage services can be managed via [OVHcloud API](netapp_quick_start1.) or from your OVHcloud Control Panel.

This guide explains how to connect your Enterprise File Storage service to a [vRack private network](https://www.ovhcloud.com/en-sg/network/vrack/) using vRack Services and vRack Service Endpoint technology.

> [!primary]
>
> For more information on vRack Services, please refer to [this page](global1.).
>

## Requirements

- An [Enterprise File Storage](https://www.ovhcloud.com/en-sg/storage-solutions/enterprise-file-storage/) service in your OVHcloud account
- Access to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg)

## Overview

![global schema](images_global_schema_20240410.png){.thumbnail}
...
Log in to your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg) and select `Bare Metal Cloud`{.action} from the top navigation bar. Go to `Storage and Backup`{.action} then `Enterprise File Storage`{.action} and select your service from the list.

![without network configuration](01-EFS.png){.thumbnail}
...
![without network configuration](04-EFS.png){.thumbnail}
...
[Managing Enterprise File Storage from the OVHcloud Control Panel](netapp_control_panel1.)

[Enterprise File Storage - API Quickstart](netapp_quick_start1.)

[Enterprise File Storage - Managing volumes](netapp_volumes1.)

[Enterprise File Storage - Managing volume ACLs](netapp_volume_acl1.)

[Enterprise File Storage - Managing volume snapshots](netapp_volume_snapshots1.)
