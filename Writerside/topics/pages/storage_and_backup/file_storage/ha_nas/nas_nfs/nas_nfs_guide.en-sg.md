...
- [A partition created on the service with the NFS protcol enabled](nas_get_started#partition.)
- [An ACL entry for the server's IP address](nas_get_started#addaccess.)
