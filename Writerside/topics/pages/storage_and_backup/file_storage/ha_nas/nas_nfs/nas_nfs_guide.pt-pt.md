...
- [Ter criado uma partição no seu serviço com o protocolo NFS ativado](nas_get_started#partition.)
- [Ter uma entrada ACL para o endereço IP do servidor](nas_get_started#addaccess.)
