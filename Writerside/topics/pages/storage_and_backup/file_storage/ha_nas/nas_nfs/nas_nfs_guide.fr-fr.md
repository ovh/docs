...
- Avoir [créé une partition sur votre service avec le protocole NFS activé](nas_get_started#partition.)
- Avoir [une entrée ACL pour l'adresse IP du serveur](nas_get_started#addaccess.)
