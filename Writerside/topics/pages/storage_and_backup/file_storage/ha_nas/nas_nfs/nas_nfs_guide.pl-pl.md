...
- [Utworzenie partycji dla Twojej usługi przy użyciu protokołu NFS](nas_get_started#partition.)
- [Posiadanie wpisu ACL dla adresu IP serwera](nas_get_started#addaccess.)
