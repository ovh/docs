...
- Sie haben sich anhand der [Anleitung zu den ersten Schritten mit der OVHcloud API](first-steps1.) mit der Verwendung der OVHcloud APIv6 vertraut gemacht.

## In der praktischen Anwendung

> [!primary]
> Detaillierte technische Informationen zur Snapshot-Funktion finden Sie auf der [HA-NAS FAQ-Seite](nas_faq1.).
>
...
Zusätzliche Hilfe finden Sie unter "[Weiterführende Informationen](nas_snapshots_api_#gofurther.)".

## Weiterführende Informationen

[NAS via NFS-Freigabe mounten](nas_nfs1.)

[NAS auf Windows Server über CIFS mounten](nas_cifs1.)
