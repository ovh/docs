...
> [!primary]
> N’hésitez pas à vous rendre sur [la page FAQ NAS-HA](nas_faq1.) pour retrouver toutes les informations détaillées concernant la fonction snapshot.
>
...
Plus d’informations dans la section [Aller plus loin](nas_snapshots_api_#gofurther.) de ce guide.
