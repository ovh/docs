...
- Consulte o nosso guia dos [primeiros passos com a API OVHcloud](first-steps1.) para se familiarizar com a APIv6 OVHcloud

## Instruções

> [!primary]
> Não hesite em aceder [à página FAQ NAS-HA](nas_faq1.) para encontrar todas as informações relativas à função snapshot.
>
...
Para mais informações, aceda à secção [Quer saber mais](nas_snapshots_api_#gofurther.).

## Quer saber mais?

[Montar um NAS através de NFS](nas_nfs1.)

[Configure o seu NAS no Windows Server através do CIFS](nas_cifs1.)
