...
2. Przeniesienie danych z naszego przewodnika "[Migracja danych z jednej usługi NAS-HA do innej za pośrednictwem NFS](nas_migration1.)".
...
> [!primary]
> Zapoznaj się z naszym przewodnikiem "[Pierwsze kroki z API OVHcloud](first-steps1.)", aby zapoznać się z korzystaniem z API OVHcloud.
>
...
Proponowane okresy to 1, 12, 24 i 36 miesięcy. Pod koniec okresu abonamentu zostanie automatycznie odnowiony, jeśli nie zostanie złożony [wniosek o rezygnację](how_to_cancel_services1.). Operacja ta może zostać przeprowadzona przez cały okres abonamentu w Panelu klienta.
