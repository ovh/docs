...
2. Migrar sus datos consultando nuestra guía "[Migración de datos de un NAS-HA a otro a través de NFS](nas_migration1.)".
...
> [!primary]
> Consulte nuestra guía [Primeros pasos con las API de OVHcloud](first-steps1.) para familiarizarse con el uso de las API de OVHcloud.
>
...
Los períodos ofrecidos son de 1, 3, 6 y 12 meses. Al finalizar el período contratado, la suscripción se renueva tácitamente si no se ha solicitado ninguna [rescisión](how_to_cancel_services1.). Puede contratarla desde el área de cliente de OVHcloud durante toda su vigencia.
