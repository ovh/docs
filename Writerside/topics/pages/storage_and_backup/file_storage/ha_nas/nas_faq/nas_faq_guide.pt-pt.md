...
2. Migrar dados consultando o nosso guia "[Migração de dados de um NAS-HA para outro através de NFS](nas_migration1.)".
...
> [!primary]
> Consulte o nosso guia "[Primeiros passos com as API OVHcloud](first-steps1.)" para se familiarizar com a utilização das API OVHcloud.
>
