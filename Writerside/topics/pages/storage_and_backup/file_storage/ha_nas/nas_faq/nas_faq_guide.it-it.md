...
2. Migrare i dati consultando la nostra guida "[Migrazione dei dati da un NAS-HA a un altro via NFS](nas_migration1.)".
...
> [!primary]
> Consulta la nostra guida Iniziare a [utilizzare le API OVHcloud](first-steps1.) per familiarizzare con l'utilizzo delle API OVHcloud.
>
