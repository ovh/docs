...
2. Migrieren Sie Ihre Daten mithilfe unserer Anleitung: "[Migration von Daten von einem HA-NAS auf einen anderen per NFS](nas_migration1.)".
...
> [!primary]
> Lesen Sie unsere Anleitung zu den [ersten Schritten mit der OVHcloud API](first-steps1.), um sich mit der Verwendung der OVHcloud API vertraut zu machen.
>
...
Die angebotenen Nutzungsperioden sind 1, 12, 24 und 36 Monate. Am Ende Ihrer Vertragslaufzeit wird Ihr Abonnement automatisch verlängert, wenn keine [Kündigungsanfrage gestellt wurde](how_to_cancel_services1.). Sie können das Abonnement jederzeit über Ihr OVHcloud Kundencenter kündigen.
