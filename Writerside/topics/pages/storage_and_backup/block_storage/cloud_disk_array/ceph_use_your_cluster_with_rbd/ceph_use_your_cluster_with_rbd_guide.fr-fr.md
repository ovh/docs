...
- [Créer un pool](ceph_create_a_pool1.)
- [Créer-un-utilisateur](ceph_create_a_user1.)
- [Ajouter des droits à un utilisateur sur un pool](ceph_change_user_rights1.)
- [Ajouter un IP ACL](ceph_create_an_ip_acl1.) pour permettre à votre serveur de contacter le cluster
