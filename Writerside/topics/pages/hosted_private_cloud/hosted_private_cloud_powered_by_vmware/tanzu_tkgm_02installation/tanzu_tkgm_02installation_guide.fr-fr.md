...
Notez **l'adresse IP publique** que vous utilisez sur cette machine virtuelle et aidez-vous du guide « [Autoriser des adresses IP à se connecter au vCenter](autoriser_des_ip_a_se_connecter_au_vcenter1.) » pour donner accès au cluster vSphere depuis la nouvelle machine virtuelle.
...
[Administrer un cluster TKG](tanzu_tkgm_03manage1.)
