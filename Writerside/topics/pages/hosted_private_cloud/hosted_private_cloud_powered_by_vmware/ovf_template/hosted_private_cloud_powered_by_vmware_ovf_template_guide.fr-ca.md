...
- [Avoir activé les licences Windows](manager_ovh_private_cloud#licence-windows.){.external} depuis votre [espace client OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc){.external}
...
![Nom de photo](images_gatewayssl.png){.thumbnail}
...
![Nom de photo](images_copylink.png){.thumbnail}
...
![Nom de photo](images_01selectdeploy.png){.thumbnail}
...
![Nom de photo](images_02puturl.png){.thumbnail}

L'étape suivante vous permet de choisir le datacenter :

![Nom de photo](images_03selectdatacenter.png){.thumbnail}

Choisissez ensuite le cluster dans lequel la machine virtuelle va être déployée :

![Nom de photo](images_04selectcluster.png){.thumbnail}
...
![Nom de photo](images_10inventory.png){.thumbnail}
...
![Nom de photo](images_sqlinformations.png){.thumbnail}
