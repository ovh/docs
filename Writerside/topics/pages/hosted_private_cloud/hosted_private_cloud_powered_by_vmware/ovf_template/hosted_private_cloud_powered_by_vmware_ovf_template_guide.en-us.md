...
- [active Windows licences](manager_ovh_private_cloud#windows-licence.){.external} (activate via the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we){.external}, in the `Windows licence`{.action} tab for the datacentre)
