...
![Menu](nsx_configurer_le_edge_firewall_images_en01dash.png){.thumbnail}

On the left side, navigate to the `NSX Edges`{.action} section then click on the appliance you're setting up.

![NSX](images_en02nsx.png){.thumbnail}
...
![Source](en04sourceobjects.png){.thumbnail}

![Source](en05sourceIP.png){.thumbnail}
...
![Destination](en07destobjects.png){.thumbnail}

![Destination](en07destIP.png){.thumbnail}
...
![Service](en08servsg.png){.thumbnail}

![Service](en09servdetail.png){.thumbnail}

![Service](en10servport.png){.thumbnail}
...
![Action](en11action.png){.thumbnail}
...
![Advanced](en12adv.png){.thumbnail}
