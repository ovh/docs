...
- Être connecté aux [API OVHCloud](https://api.ovh.com/){.external}. Au besoin, consultez le guide « [Premiers pas avec les API OVHcloud](first-steps1.) ».
...
Connectez-vous aux APIv6 OVHcloud en suivant le guide « [Premiers pas avec les API OVHcloud](first-steps1.) ».
...
Commencez par ajouter de nouveaux datastores en suivant le guide « [Ajouter des espaces de stockage](how_to_add_storage1.) ».
...
Enfin, supprimez vos anciens datastores en suivant le guide « [Supprimer un datastore](delete_datastore1.) ».
...
Pour réaliser votre migration, vous pouvez suivre ce guide : [Migrer vers une nouvelle infrastructure](service-migration-vdc2.).
...
![espace client - récupération de la version de vsphere](manager-version-vsphere.png){.thumbnail}
...
![vSphere - récupération des données](vsphere-version-nsx-v.png){.thumbnail}
