...
As does the [NSX Edge Firewall](nsx_configurer_le_edge_firewall1.), the distibuted firewall restricts or allows network traffic based on rules applied to network nodes or groups.
