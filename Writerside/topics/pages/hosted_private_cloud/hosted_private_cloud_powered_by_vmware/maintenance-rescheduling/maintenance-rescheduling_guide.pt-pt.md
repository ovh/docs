...
![alteração horária](maintenance-date-edition01.png){.thumbnail}
...
![alteração horária](maintenance-date-edition02.png){.thumbnail}

### A partir da API OVHcloud

Ligue-se à [interface de administração dos seus serviços através da API](https://eu.api.ovh.com/). Pode consultar o nosso manual "[Primeiros passos com as API OVHcloud](first-steps1.)".
