...
- You are the administrative or technical contact for the [VMware on OVHcloud solution](https://www.ovhcloud.com/asia/enterprise/products/hosted-private-cloud/) infrastructure.
...
![change maintenance time](maintenance-date-edition01.png){.thumbnail}
...
![change maintenance time](maintenance-date-edition02.png){.thumbnail}

### Using the OVHcloud API

Log in to the [API service administration console](https://ca.api.ovh.com/). You can refer to our guide on [Getting started with the OVHcloud API](first-steps1.).
