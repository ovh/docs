...
- Having **NSX** deployed with two segments configured in your NSX configuration, you can use this guide [Segment management in NSX](nsx-02-segment-management1.).
...
[Implementing NAT for port redirections in NSX](nsx-07-configure-nat-redirection1.)
