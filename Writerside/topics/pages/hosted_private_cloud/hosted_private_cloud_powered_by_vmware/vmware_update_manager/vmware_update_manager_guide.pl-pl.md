...
![Konserwacja](en01menu.png){.thumbnail}
...
![Konserwacja](en04warning.png){.thumbnail}

Twój host znajduje się wówczas w trybie konserwacji.

![Konserwacja](en05maintenanced.png){.thumbnail}
