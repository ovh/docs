...
> [!primary]
>
> Should you choose to migrate an infrastructure to a new vDC instead, please follow [this dedicated guide](service-migration-vdc2.).
>
...
Please refer to our guide on [Enabling Virtual Machine Encryption](vm_encrypt2.) in order to enable KMS on the destination Hosted Private Cloud.
...
These options must therefore be reactivated on the destination Hosted Private Cloud. To do this, please refer to our [guide on activating them](activer_l_option_hds_hipaa_ou_pci_dss1.).
...
As part of a migration process, you can link your PCC services within the same vRack. Please consult our guide to [Using Private Cloud within a vRack](using_private_cloud_in_vrack1.).
...
Please consult our guide to [Migrate an IP block between two Hosted Private Cloud services](ajout_de_bloc_ip#migrate-an-ip-block-between-two-hosted-private-cloud-solutions.).
...
The migration involves reconfiguring VMware High Availability (HA), including boot order and priority. Please consult our guide about [VMware HA configuration](vmware_ha_high_availability2.).
...
The migration involves reconfiguring the VMware Distributed Resource Scheduler (DRS) feature, in particular the affinity or anti-affinity rules for groups of hosts and VMs. Please consult our guide about [configuring VMware DRS](vmware_drs_distributed_ressource_scheduler_new1.).
...
Please refer to our guide on [activating and using Veeam Managed Backup](veeam_backup_as_a_service1.).
...
- A [Veeam Backup & Replication](veeam_veeam_backup_replication1.) virtual machine on the source PCC
- [Authorising the Veeam Backup & Replication virtual machine to connect](autoriser_des_ip_a_se_connecter_au_vcenter1.) to the source and destination vCenter

Please refer to our guide on setting up [Veeam Backup & Replication](veeam_veeam_backup_replication1.).
