...
![Usuario vSphere](images_addMailOnUser01.png){.thumbnail}
...
![Usuario vSphere](images_addMailOnUser02.png){.thumbnail}

Será redirigido a la siguiente ventana:

![Usuario vSphere](images_addMailOnUser03.png){.thumbnail}
