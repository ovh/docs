...
![Settings](fr05settings.png){.thumbnail}
...
![Deployment](fr06deploy.png){.thumbnail}
...
![Interfaces](fr08inter.png){.thumbnail}
...
![Firewall](fr14fw.png){.thumbnail}

### Révision

Vérifiez la configuration puis cliquez sur `Terminer`{.action}.

![Review](fr15review.png){.thumbnail}
