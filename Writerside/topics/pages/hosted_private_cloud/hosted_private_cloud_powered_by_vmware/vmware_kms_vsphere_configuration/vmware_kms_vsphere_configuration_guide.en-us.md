...
To do this, log in to your [OVHcloud Control Panel](manager.). Go to `Hosted Private Cloud` > `VMware` > `Your Dedicated Cloud` > `Security`.
...
>>
>> ![Navigator Padlock](padlock_website.png){.thumbnail}
>>
>> ![Sha Thumbprint Browser](fingerprint_sha.png){.thumbnail}
>>
> **Linux/MacOS**
>>
