...
![Configuration sur l'OVHcloud Network](images_01config_ip_ovh_network.png){.thumbnail}
...
![Configuration avancée sur l'OVH Network](images_02config_ip_ovh_network_advanced.png){.thumbnail}
...
![Configuration Windows](images_config_ip_windows.jpg){.thumbnail}
...
- une interface de VLAN (10 à 20 par défaut et liés au vRack, vous pouvez en créer davantage en consultant [ce guide](creation_vlan1.));
...
![IP privée sur Linux](images_linux_private.PNG){.thumbnail}
...
![Configuration Windows IP publique](images_windows_private.PNG){.thumbnail}
