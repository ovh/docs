...
![Configurazione su OVHcloud Network](images_01config_ip_ovh_network.png){.thumbnail}
...
![Configurazione avanzata sull'OVH Network](images_02config_ip_ovh_network_advanced.png){.thumbnail}
...
![Interfaccia IP](images_config_ip_interfaces.jpg){.thumbnail}
...
![Configurazione Windows](images_config_ip_windows.jpg){.thumbnail}
...
- un'interfaccia VLAN (da 10 a 20 di default e legate alla vRack, potete crearne di più consultando [questa guida](creation_vlan1.));
...
![IP privato su Linux](images_linux_private.PNG){.thumbnail}
...
![Configurazione di Windows IP pubblico](images_windows_private.PNG){.thumbnail}
