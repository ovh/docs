...
![Configuração OVHcloud Network](images_01config_ip_ovh_network.png){.thumbnail}
...
![Configuração avançada na OVH Network](images_02config_ip_ovh_network_advanced.png){.thumbnail}
...
![Configuração Windows](images_config_ip_windows.jpg){.thumbnail}
...
- uma interface VLAN (10 a 20 por predefinição e ligadas ao vRack, pode criar mais através [deste manual](creation_vlan1.));
...
![IP privado em Linux](images_linux_private.PNG){.thumbnail}
...
![Configuração Windows IP público](images_windows_private.PNG){.thumbnail}
