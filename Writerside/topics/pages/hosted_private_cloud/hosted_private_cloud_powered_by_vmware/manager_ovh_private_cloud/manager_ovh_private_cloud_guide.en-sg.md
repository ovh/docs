...
![GENERAL](en03general.png){.thumbnail}
...
![RIGHTS](en07editrights.png){.thumbnail}
...
Check out [Enabling Virtual Machine Encryption](vm_encrypt2.) for more details.
...
Check out the [Activating and using Veeam Managed Backup](veeam_backup_as_a_service1.) guide for more details.
...
![BACKUP](en17backupreport.png){.thumbnail}

#### Disaster Recovery Plan (DRP)

The Disaster Recovery Plan tab allows you to build a DRP plan with Zerto.<br>
Check out [Setting up Zerto Virtual Replication for your DRP](zerto_virtual_replication_as_a_service1.) for more details.
