...
![Informacje ogólne](controlpanel1.png){.thumbnail}
...
![Informacje ogólne](controlpanel2.png){.thumbnail}
...
![Opcje](controlpanel3.png){.thumbnail}
...
![Opcje](controlpanel4.png){.thumbnail}
...
![Użytkownicy](controlpanel6.png){.thumbnail}
...
![Paramètres de sécurité](controlpanel8.png){.thumbnail}
...
Więcej szczegółów na temat tej opcji znajdziesz w [tym przewodniku](vm_encrypt2.).

#### Operacje

W tej karcie znajdziesz operacje trwające w Twojej infrastrukturze:

![Operacje](controlpanel9.png){.thumbnail}
...
![Magazyny danych](controlpanel13.png){.thumbnail}
...
Więcej informacji na temat tego rozwiązania znajdziesz w tym [przewodniku](veeam_backup_as_a_service1.).
