...
![Allgemeine Informationen](controlpanel1.png){.thumbnail}
...
![Allgemeine Informationen](controlpanel2.png){.thumbnail}
...
![Optionen](controlpanel3.png){.thumbnail}
...
![Optionen](controlpanel4.png){.thumbnail}

Weitere Informationen zur Kündigung eines Hosted Private Cloud Dienstes finden Sie in unserer Anleitung [Hosted Private Cloud kündigen](comment_resilier_le_private_cloud1.).
...
![Benutzer](controlpanel6.png){.thumbnail}
...
![Benutzerrechte je Datacenter](controlpanel7.png){.thumbnail}
...
![Sicherheitseinstellungen](controlpanel8.png){.thumbnail}
...
Weitere Informationen zu dieser Option finden Sie in [dieser Anleitung](vm_encrypt2.).

#### Operationen

In diesem Tab finden Sie die aktuell auf Ihrer Infrastruktur ausgeführten Operationen:

![Operationen](controlpanel9.png){.thumbnail}
...
![Windows-SPLA-Lizenz](controlpanel10.png){.thumbnail}
...
![Datacenter-Ansicht](controlpanel11.png){.thumbnail}
...
Weitere Informationen zu dieser Option finden Sie in [dieser Anleitung](veeam_backup_as_a_service1.) (Englisch).
