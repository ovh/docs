...
- Disposer d'un compte utilisateur créé depuis l'espace client OVHcloud. Pour plus d'informations, consultez [ce guide](manager_ovh_private_cloud#utilisateurs.).
...
[Présentation de l’espace client Private Cloud OVHcloud](manager_ovh_private_cloud1.)

[Changer les droits d'un utilisateur](change_users_rights1.)
