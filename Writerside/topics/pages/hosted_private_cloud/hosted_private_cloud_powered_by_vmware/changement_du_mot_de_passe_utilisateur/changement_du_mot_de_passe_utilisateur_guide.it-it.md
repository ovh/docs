...
- Disporre di un account utente creato dallo Spazio Cliente OVHcloud. Per maggiori informazioni, consulta [questa guida](manager_ovh_private_cloud#utenti.)
...
[Modificare i diritti di un utente](change_users_rights1.)
