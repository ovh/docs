...
- Dispor de uma conta de utilizador criada a partir da Área de Cliente OVHcloud. Para mais informações, [consulte este manual](manager_ovh_private_cloud#utilizadores.)
...
![alterar palavra-passe](userpassword2b.png){.thumbnail}

Indique uma palavra-passe nova e confirme-a.

![alterar palavra-passe](userpassword3b.png){.thumbnail}
...
[Apresentação da Área de Cliente Private Cloud OVHcloud](manager_ovh_private_cloud1.)

[Definir e gerir a palavra-passe da sua conta OVHcloud](manage-ovh-password1.)
