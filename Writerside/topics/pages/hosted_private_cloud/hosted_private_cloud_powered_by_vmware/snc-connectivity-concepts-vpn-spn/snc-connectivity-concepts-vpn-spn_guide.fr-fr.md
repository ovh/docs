...
> [!primary]
> Une version en langue anglaise de cette page est disponible [ici](snc-connectivity-concepts-vpn-spn1.).
>
...
![Règles VPN-SPN](SNC-Elligibility-Rules-2.svg){.thumbnail}

* VPN-SPN peut être attaché à 1 ou plusieurs vRack.
* Nx VPN-SPN peuvent être attachés à Nx vRack.

![VPN-SPN sur le même vRack](SNC-Elligibility-Rules-1.svg){.thumbnail}
...
![VPN-SPN and SPN Connector](spn-connector-rules-vpn.svg){.thumbnail}
...
![VPN overview](SNC-SPN-VPN-vrack-v0.svg){.thumbnail}
...
![Exemple de configuration OCC IP](SNC-SPN-VPN-Routing-v0.svg){.thumbnail}
...
![VPN-SPN BGP view](SNC-SPN-VPN-BGP-v0.svg){.thumbnail}
