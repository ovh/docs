...
![VPN-SPN rules](SNC-Elligibility-Rules-2.svg){.thumbnail}

* VPN-SPN can be attached to 1 or several vRack.
* Nx VPN-SPN can be attached to Nx vRack.

![VPN-SPN on same vRack](SNC-Elligibility-Rules-1.svg){.thumbnail}
...
![Example IP configuration OCC](SNC-SPN-VPN-Routing-v0.svg){.thumbnail}
