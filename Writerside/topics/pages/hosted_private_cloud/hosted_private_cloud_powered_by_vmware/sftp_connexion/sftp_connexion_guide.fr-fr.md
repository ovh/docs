...
![Connexion SFTP](images_connection_sftp_filezilla_log.png){.thumbnail}

Une fois connecté, vous retrouverez votre poste local sur la gauche et vos datastores sur la droite :

![Connexion en SFTP avec FileZilla](images_connection_sftp_filezilla.png){.thumbnail}
...
![Connexion SFTP via vSphere](images_sftpconnection.png){.thumbnail}
