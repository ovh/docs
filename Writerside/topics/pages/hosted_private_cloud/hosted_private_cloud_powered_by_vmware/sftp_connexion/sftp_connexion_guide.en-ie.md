...
![SFTP login](images_connection_sftp_filezilla_log.png){.thumbnail}

Once you are logged in, you will find your local machine on the left, and your datastores on the right:

![Login via SFTP with FileZilla](images_connection_sftp_filezilla.png){.thumbnail}
...
![SFTP connection via vSphere](images_sftpconnection.png){.thumbnail}
