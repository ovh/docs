...
Nous vous recommandons l'utilisation d'une solution complète de sauvegarde comme notre service [Veeam Backup](veeam_backup_as_a_service1.) ou tout autre système réalisant un backup complet de vos machines virtuelles.
