...
Zalecamy użycie pełnego rozwiązania do tworzenia kopii zapasowych, takiego jak usługa [Veeam Backup](veeam_backup_as_a_service1.){.external-link} lub inny system realizujący kopię zapasową wirtualnych maszyn.
