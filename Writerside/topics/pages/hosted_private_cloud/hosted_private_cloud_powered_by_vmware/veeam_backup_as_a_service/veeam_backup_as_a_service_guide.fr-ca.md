...
* [Donner le droit « Ajout de ressources »](change_users_rights1.) pour le datacenter concerné à l'utilisateur depuis l'[espace client OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc).
* Être connecté au client vSphere.
* Avoir activé la [haute disponibilité (HA)](vmware_ha_high_availability2.).
* Avoir activé le [Distributed Ressource Scheduler (DRS)](vmware_drs_distributed_ressource_scheduler_new1.) sur le ou les clusters.
