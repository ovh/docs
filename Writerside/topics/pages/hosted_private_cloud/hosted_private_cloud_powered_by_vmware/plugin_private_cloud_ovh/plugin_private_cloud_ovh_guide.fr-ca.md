...
![OVHcloud Plugin - ajouter des hôtes](Plugin01.jpg){.thumbnail}

La commande de datastores supplémentaires s'effectue, elle, dans le menu `Add Storage`{.action}.

![OVHcloud Plugin - ajouter des datastores](Plugin02.jpg){.thumbnail}
...
![Option OVH Hosted Private Cloud](Plugin03.jpg){.thumbnail}
