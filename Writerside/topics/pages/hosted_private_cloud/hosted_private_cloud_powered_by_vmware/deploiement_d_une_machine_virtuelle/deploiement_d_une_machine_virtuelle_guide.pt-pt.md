...
- A criação a partir de um ISO, que estará no seu datastore e que poderá ter importado seguindo [o manual de ligação em SFTP](sftp_connexion1.)
- Também é possível implementar uma máquina virtual a partir de um template seu ou de um [template OVHcloud](ovf_template1.)
...
![escolha de criações](images_vm02.png){.thumbnail}
...
![localização da máquina virtual](images_vm03.png){.thumbnail}
...
![escolha de recursos](images_vm04.png){.thumbnail}
...
![escolha de armazenamento](images_vm05.png){.thumbnail}
...
![escolha da compatibilidade](images_vm06.png){.thumbnail}
...
![escolha de guest OS](images_vm07.png){.thumbnail}
...
![escolha da rede](images_vm08.png){.thumbnail}
...
![escolha do ficheiro ISO](images_vm09.png){.thumbnail}
...
![Ligar ISO](images_vm10.png){.thumbnail}
...
![Resumo VM](images_vm11.png){.thumbnail}
