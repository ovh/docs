...
- Avere accesso all’[interfaccia vSphere](vsphere_interface_connexion1.)
...
![Deploy di una VM](images_vm01.png){.thumbnail}

Per creare una macchina virtuale è possibile scegliere tra diverse opzioni:

- da un file ISO, disponibile nel datastore (per importarlo, consulta la [guida di connessione in SFTP](sftp_connexion1.))
- da un template personale o [fornito da OVHcloud](ovf_template1.)
...
![Scelta della modalità di creazione](images_vm02.png){.thumbnail}
...
![Localizzazione della macchina virtuale](images_vm03.png){.thumbnail}
...
![Scelta delle risorse](images_vm04.png){.thumbnail}
...
![Scelta dello storage](images_vm05.png){.thumbnail}
...
![Scelta della compatibilità](images_vm06.png){.thumbnail}
...
![Scelta del Guest OS](images_vm07.png){.thumbnail}
...
![Scelta della rete](images_vm08.png){.thumbnail}
...
![Scelta del file ISO](images_vm09.png){.thumbnail}
...
![Connettere ISO](images_vm10.png){.thumbnail}
...
![Riepilogo VM](images_vm11.png){.thumbnail}
...
![Avvio VM](images_vm12.png){.thumbnail}
