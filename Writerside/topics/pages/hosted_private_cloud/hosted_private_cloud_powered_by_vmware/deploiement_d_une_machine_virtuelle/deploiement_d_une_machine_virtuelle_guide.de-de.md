...
![VM deployen](images_vm01.png){.thumbnail}

Sie haben mehrere Optionen, um eine virtuelle Maschine zu erstellen:

- per ISO-Datei, verfügbar in Ihrem Datastore (um die Datei zu importieren, befolgen Sie die [Anleitung zur Verbindung via SFTP](sftp_connexion1.)
- über ein eigenes oder ein [von OVHcloud bereitgestelltes](ovf_template1.) Template
...
![Erstellungsoptionen](images_vm02.png){.thumbnail}
...
![Speicherort der virtuellen Maschine](images_vm03.png){.thumbnail}
...
![Auswahl der Ressourcen](images_vm04.png){.thumbnail}
...
![Wahl des Speichers](images_vm05.png){.thumbnail}
...
![Auswahl der Kompatibilität](images_vm06.png){.thumbnail}
...
![Auswahl des Gast-Betriebssystems](images_vm07.png){.thumbnail}
...
![Wahl des Netzwerks](images_vm08.png){.thumbnail}
...
![Auswahl der ISO-Datei](images_vm09.png){.thumbnail}
...
![ISO verbinden](images_vm10.png){.thumbnail}
...
![VM Zusammenfassung](images_vm11.png){.thumbnail}
...
![VM starten](images_vm12.png){.thumbnail}
...
![VM-Konsole](images_vm13.png){.thumbnail}
