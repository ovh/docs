...
![01 Create Segment 01](01-create-segment01.png){.thumbnail}

Cliquez à gauche sur `Segments`{.action}.

![01 Create Segment 02](01-create-segment02.png){.thumbnail}

Cliquez à droite sur `ADD SEGMENT`{.action}.

![01 Create Segment 03](01-create-segment03.png){.thumbnail}
...
![01 Create Segment 04](01-create-segment04.png){.thumbnail}

Cliquez sur `NO`{.action} à l'étape suivante.

![01 Create Segment 05](01-create-segment05.png){.thumbnail}

Le nouveau segment apparait dans la liste.

![01 Create Segment 06](01-create-segment06.png){.thumbnail}
...
![02 Display Network Topology 01](02-display-network-topology-with-onesegment01.png){.thumbnail}
...
![03 Connect Network Card to Segment 01](03-connect-network-card-vm-to-segment01.png){.thumbnail}

Allez dans la barre de défilement à droite de votre adaptateur réseau et choisissez `Parcourir`{.action}.

![03 Connect Network Card to Segment 02](03-connect-network-card-vm-to-segment02.png){.thumbnail}

Sélectionnez le `réseau`{.action} qui porte le nom de votre segment. et cliquez sur `OK`{.action}.

![03 Connect Network Card to Segment 03](03-connect-network-card-vm-to-segment03.png){.thumbnail}

Cliquez sur `OK`{.action}.

![03 Connect Network Card to Segment 04](03-connect-network-card-vm-to-segment04.png){.thumbnail}
...
![04 display network topology with one segment and one vm 01](04-display-network-topology-with-onesegment-and-one-vm01.png){.thumbnail}
...
![05 display four VM on two segment01](05-display-four-vm-on-two-segment01.png){.thumbnail}
...
![05 display four VM on two segment02](05-display-four-vm-on-two-segment02.png){.thumbnail}
...
![06 Add vlan segment 01](06-add-vlan-segment01.png){.thumbnail}
...
![06 Add vlan segment 02](06-add-vlan-segment02.png){.thumbnail}

Cliquez sur `NO`{.action} à l'étape suivante.

![06 Add vlan segment 03](06-add-vlan-segment03.png){.thumbnail}
...
![07 add interfaces to ovh-T1-gw with vlan 01](07-add-interface-on-ovh-t1-gw01.png){.thumbnail}
...
![07 add interfaces to ovh-T1-gw with vlan 02](07-add-interface-on-ovh-t1-gw02.png){.thumbnail}

Cliquez sur `ADD INTERFACE`{.action}.

![07 add interfaces to ovh-T1-gw with vlan 03](07-add-interface-on-ovh-t1-gw03.png){.thumbnail}
...
![07 add interfaces to ovh-T1-gw with vlan 04](07-add-interface-on-ovh-t1-gw04.png){.thumbnail}

Cliquez sur `CLOSE`{.action}

![07 add interfaces to ovh-T1-gw with vlan 05](07-add-interface-on-ovh-t1-gw05.png){.thumbnail}
...
![07 add interfaces to ovh-T1-gw with vlan 05](07-add-interface-on-ovh-t1-gw06.png){.thumbnail}
...
![08 connect VM to VLAN segment 01](08-connect-vm-to-vlan-segment01.png){.thumbnail}

Positionnez-vous sur votre adapteur réseau et cliquez sur `Parcourir`{.action}.

![08 connect VM to VLAN segment 02](08-connect-vm-to-vlan-segment02.png){.thumbnail}

Cliquez sur le `segment`{.action} associé à votre VLAN et cliquez sur `OK`{.action}.

![08 connect VM to VLAN segment 03](08-connect-vm-to-vlan-segment03.png){.thumbnail}

Cliquez sur `OK`{.action} pour valider les changements.

![08 connect VM to VLAN segment 04](08-connect-vm-to-vlan-segment04.png){.thumbnail}
...
![09 display network topology vlan overlay01](09-display-network-topology-vlan-overlay01.png){.thumbnail}
