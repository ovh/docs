...
![01 Create Segment 01](01-create-segment01.png)

Click on `Segments`{.action} on the left.

![01 Create Segment 02](01-create-segment02.png)

Click on `ADD SEGMENT`{.action} on the right.

![01 Create Segment 03](01-create-segment03.png)
...
![01 Create Segment 04](01-create-segment04.png)

Click `NO`{.action} when prompted.

![01 Create Segment 05](01-create-segment05.png)

The new segment appears in the list.

![01 Create Segment 06](01-create-segment06.png)
...
![02 Display Network Topology 01](02-display-network-topology-with-onesegment01.png)
...
![03 Connect Network Card to Segment 01](03-connect-network-card-vm-to-segment01.png)

Scroll to the right of your network adapter and choose `Browse`{.action}.

![03 Connect Network Card to Segment 02](03-connect-network-card-vm-to-segment02.png)

Select the `network`{.action} that is named after your segment and click `OK`{.action}.

![03 Connect Network Card to Segment 03](03-connect-network-card-vm-to-segment03.png)

Click `OK`{.action}.

![03 Connect Network Card to Segment 04](03-connect-network-card-vm-to-segment04.png)
...
![04 display network topology with one segment and one vm 01](04-display-network-topology-with-onesegment-and-one-vm01.png)
...
![05 display four VM on two segment01](05-display-four-vm-on-two-segment01.png)
...
![05 display four VM on two segment02](05-display-four-vm-on-two-segment02.png)
