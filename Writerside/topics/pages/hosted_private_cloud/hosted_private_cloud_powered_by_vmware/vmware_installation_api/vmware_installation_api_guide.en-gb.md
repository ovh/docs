...
This example uses a VM installed with Debian 9, deployed from [templates available for your Hosted Private Cloud infrastructure](ovf_template1.).
...
This example uses a VM installed with Ubuntu 18.04, deployed from [templates available for your Hosted Private Cloud infrastructure](ovf_template1.).
