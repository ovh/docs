...
![Creazione di un alert](images_alarms01.png){.thumbnail}
...
![Nome e destinazione dell'alert](images_alarms02.png){.thumbnail}
...
![Regole dell'alert](images_alarms03.png){.thumbnail}
...
![Sospensione dell'alert](images_alarms04.png){.thumbnail}
...
![Ripeilogo dell'alert](images_alarms05.png){.thumbnail}
