...
- Sie sind in Ihrem [vSphere Interface](vsphere_interface_connexion1.) angemeldet.
...
![Alarm erstellen](images_alarms01.png){.thumbnail}
...
![Name und Bezug der Alarmmeldung](images_alarms02.png){.thumbnail}
...
![Alarmregeln](images_alarms03.png){.thumbnail}
...
![Alarm beenden](images_alarms04.png){.thumbnail}
...
![Übersicht über die Alarmmeldung](images_alarms05.png){.thumbnail}
