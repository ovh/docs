---
title: Evitar a usurpação de endereços IP com o serviço SpoofGuard (EN)
...
- an enabled [Distributed Firewall](nsx_configurer_le_firewall_distribue1.)

## Instructions

In the vSphere interface menu, go to the `Networking and Security`{.action} dashboard.

![Menu](nsx_spoofguard_images_en01dash.png){.thumbnail}
