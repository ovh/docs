...
![esquema HA](images_HA3.png){.thumbnail}
...
![activación HA](images_HA.png){.thumbnail}
...
![Fallo del host](images_HAparam1.PNG){.thumbnail}
...
![aislamiento del host](images_HAparam2.PNG){.thumbnail}
...
![Almacén de datos con PDL](images_HAparam3.PNG){.thumbnail}
...
![Almacén de datos con APD](images_HAparam4.PNG){.thumbnail}

##### Supervisión de las MV

La supervisión de las máquinas virtuales está disponible después de instalar las [VMware tools](vmware_tools_install2.).
...
![Supervisión de las MV](images_HAparam5.PNG){.thumbnail}
