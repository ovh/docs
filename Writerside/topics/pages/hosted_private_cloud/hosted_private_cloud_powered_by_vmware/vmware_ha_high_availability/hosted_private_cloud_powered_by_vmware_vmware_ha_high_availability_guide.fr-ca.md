...
La désactivation est nécessaire pour réaliser des opérations de mise à jour avec [l'update manager](vmware_update_manager1.) par exemple. Dans ce cas précis, l'hôte est isolé.
...
La surveillance des machines virtuelles est disponible suite à l'installation des [VMware tools](vmware_tools_install2.). 
