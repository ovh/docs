...
![nommer portgroup](images_09network2.png){.thumbnail}
...
![configuration portgroup](images_10network3.png){.thumbnail}
...
![paramètres sécurité](images_11network4.png){.thumbnail}
...
![lissage de traffic](images_12network5.png){.thumbnail}
