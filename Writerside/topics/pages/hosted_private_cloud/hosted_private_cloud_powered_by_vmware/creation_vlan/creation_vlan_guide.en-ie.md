...
- A user account with access to vSphere as well as the specific rights for Networking (created in the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie))
...
![New Distributed Port Group](images_08network1.png){.thumbnail}

The next step is to name your **Port Group**:

![nominate portgroup](images_09network2.png){.thumbnail}
...
![portgroup configuration](images_10network3.png){.thumbnail}
...
![security settings](images_11network4.png){.thumbnail}
...
![traffic shaping](images_12network5.png){.thumbnail}
