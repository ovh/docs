...
Aunque OVHcloud actualiza el vCenter, usted deberá encargarse de actualizar los hosts ESXi. El parche está disponible en el [Update Manager](vmware_update_manager1.){.external-link}.
...
![Mensaje de alerta host](warningMsg.png){.thumbnail}
...
![Activar mitigación](enableMitigation.png){.thumbnail}
...
> 
> ![Borrar mensaje de alerta](deleteWarning.png){.thumbnail}
