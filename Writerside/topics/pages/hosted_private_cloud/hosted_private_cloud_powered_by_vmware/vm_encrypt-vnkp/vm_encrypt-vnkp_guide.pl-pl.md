...
- a [VMware on OVHcloud solution](https://www.ovhcloud.com/pl/enterprise/products/hosted-private-cloud/)
...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl), click on `Hosted Private Cloud`{.action} and choose your cluster. Go to `Users`{.action} and click the `...`{.action}
