...
Certains stockages ne seront plus disponibles à la fin Mars 2023 car ils ne seront plus maintenus, comme indiqué dans notre guide sur le [cycle de vie du Hosted Private Cloud powered by VMware](lifecycle_policy#datastores-stockage.).
...
Si vous n'avez pas encore souscrit à une offre plus récente, Utilisez [ce guide](how_to_add_storage1.) pour ajouter un stockage plus important.
...
Faites un clic-droit sur chacune des machines virtuelles qui se trouvent sur ce datastore, choisissez `Migrer`{.action} et aidez-vous du guide « [VMware Storage vMotion](vmware_storage_vmotion#finaliser-le-vmotion.) » pour effectuer la migration vers un datastore plus récent.
...
Aidez-vous du guide « [Supprimer un datastore](delete_datastore1.) » pour supprimer votre stockage obsolète.
