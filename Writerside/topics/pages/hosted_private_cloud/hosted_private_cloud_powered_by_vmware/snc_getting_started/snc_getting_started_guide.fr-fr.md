...
- [Autoriser des IP à se connecter au vCenter](autoriser_des_ip_a_se_connecter_au_vcenter1.)
...
N'hésitez pas à consulter notre guide [Présentation de l’espace client Hosted Private Cloud OVHcloud](manager_ovh_private_cloud1.).
...
![Mot de passe perdu](vsphere_secnumcloud_0.png){.thumbnail}
...
![Lancement du processus](vsphere_secnumcloud_1.png){.thumbnail}
...
![Informations utilisateur](vsphere_secnumcloud_2.png){.thumbnail}
...
![Informations utilisateur](vsphere_secnumcloud_3.png){.thumbnail}
...
- [Mise en place d'un tunnel IPsec avec NSX](nsx-12-configure-ipsec1.)
...
- [Activer la Private Gateway](private_gateway1.)
...
- [Activation du chiffrement des machines virtuelles (VM Encryption)](vm_encrypt2.)
...
[Nos guides SecNumCloud Connectivity](network.)
