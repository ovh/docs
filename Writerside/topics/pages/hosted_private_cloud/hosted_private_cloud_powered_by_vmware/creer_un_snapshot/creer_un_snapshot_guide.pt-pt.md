...
![DELETE](en06delete.png){.thumbnail}

Confirm by clicking `OK`{.action}.

![CONFIRM](en07confirm.png){.thumbnail}
...
![CONSOLIDATE](en08consolidate.png){.thumbnail}

Confirm by clicking `YES`{.action}.

![CONFIRM](en09confirm.png){.thumbnail}
