...
![przeniesienie wirtualnej maszyny](images_Vmotion1.png){.thumbnail}
...
Opcja „Zmień  tylko zasób obliczeniowy” pozwala przenieść wirtualną maszynę do innej bazy danych. Operacja ta, o nazwie**Storage vMotion**, opisana jest w [tym przewodniku](vmware_storage_vmotion2.).

![wybór rodzaju vMotion](images_Vmotion2.png){.thumbnail}
...
![wybór zasobu](images_Vmotion3.png){.thumbnail}
...
![wybór sieci](images_Vmotion4.png){.thumbnail}
...
![wybór priorytetu](images_Vmotion5.png){.thumbnail}

### Zakończenie operacji vMotion

Kliknij `Zakończ`{.action}, aby uruchomić proces migracji.

![zakończenie operacji vMotion](images_Vmotion6.png){.thumbnail}
...
![śledzenie postępu vMotion](images_Vmotion7.png){.thumbnail}
