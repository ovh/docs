...
> [!primary]
> Une version en langue anglaise de cette page est disponible [ici](snc-connectivity-concepts-overview1.).
>
...
![SNC Network Global Overview](SNC-Global-Network.svg){.thumbnail}
