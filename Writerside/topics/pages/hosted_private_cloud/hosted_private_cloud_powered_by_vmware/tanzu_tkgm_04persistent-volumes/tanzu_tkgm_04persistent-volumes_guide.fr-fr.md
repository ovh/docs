...
- Avoir déployé le cluster de **Workload** **TKG** à l'aide du guide « [administrer Tanzu Management Cluster Grid](tanzu_tkgm_03manage1.) ».
...
![01 Affichage dossier FCD](01-display-fcd-folder01.png){.thumbnail}

Il est possible de créer d'autres Storage Classes pour chaque cluster de *WorkLoad*.

## En pratique

Nous allons nous connecter sur un cluster de *WorkLoad* à partir de la console de la machine virtuelle **Bootstrap**. Vous pouvez vous aider du guide « [Administrer Tanzu Management Cluster Grid](tanzu_tkgm_03manage1.) » pour créer un cluster de workload et l'administrer.
...
![02 Select URL01](02-display-datastore-url01.png)
...
![03 Display PV in vCenter 01](03-display-pv-vmware01.png){.thumbnail}

Cliquez sur l'icône en forme de bloc-notes à gauche du volume pour afficher les détails.

![03 Display PV in vCenter 02](03-display-pv-vmware02.png){.thumbnail}
...
![03 Display PV in vCenter 03](03-display-pv-vmware03.png){.thumbnail}
...
![03 Display PV in vCenter 04](03-display-pv-vmware04.png){.thumbnail}
...
![04 Display PV2 in vCenter 01](04-display-pv2-vmware01.png){.thumbnail}
...
![04 Display PV2 in vCenter 02](04-display-pv2-vmware02.png){.thumbnail}
...
![04 Display PV2 in vCenter 03](04-display-pv2-vmware03.png){.thumbnail}

## Aller plus loin <a name="gofurther"></a>

[Présentation de Tanzu Kubernetes Grid au sein d'OVHcloud](tanzu_tkgm_02installation1.)

[Installer Tanzu Kubernetes Grid](tanzu_tkgm_02installation1.)

[Administrer Tanzu Management Cluster Grid](tanzu_tkgm_03manage1.)
