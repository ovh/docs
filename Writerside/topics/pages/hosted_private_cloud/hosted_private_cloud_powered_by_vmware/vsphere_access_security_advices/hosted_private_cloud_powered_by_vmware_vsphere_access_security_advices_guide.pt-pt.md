...
![Adicionar IP](images_adding_ip.png){.thumbnail}
...
![Utilizadores](images_users.png){.thumbnail}
...
![Edição dos parâmetros dos utilizadores](images_users_edit.png){.thumbnail}
...
![Expiração da sessão](images_security-expiration.png){.thumbnail}

Indique o número de minutos antes que uma sessão expire.

![Expiração da sessão](images_expiration.png){.thumbnail}
