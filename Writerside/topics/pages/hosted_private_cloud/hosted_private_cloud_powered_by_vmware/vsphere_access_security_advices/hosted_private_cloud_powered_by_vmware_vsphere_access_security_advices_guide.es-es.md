...
![Añadir IP](images_adding_ip.png){.thumbnail}
...
![Usuarios](images_users.png){.thumbnail}
...
![Configuración de los parámetros de los usuarios](images_users_edit.png){.thumbnail}
...
![Expiración de la sesión](images_security-expiration.png){.thumbnail}

Se abrirá una ventana en la que podrá elegir el tiempo (en minutos) que debe transcurrir antes de que expire una sesión.

![Expiración de la sesión](images_expiration.png){.thumbnail}
