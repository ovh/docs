...
![Ajout d'IP](images_adding_ip.png){.thumbnail}
...
![Utilisateurs](images_users.png){.thumbnail}
...
![Édition des paramètres des utilisateurs](images_users_edit.png){.thumbnail}
...
![Expiration de la session](images_security-expiration.png){.thumbnail}

Renseignez ensuite le nombre de minutes avant qu'une session expire.

![Expiration de la session](images_expiration.png){.thumbnail}
