...
![Dodanie adresów IP](images_adding_ip.png){.thumbnail}
...
![Użytkownicy](images_users.png){.thumbnail}
...
![Edycja parametrów użytkowników](images_users_edit.png){.thumbnail}
...
![Wygaśnięcie sesji](images_security-expiration.png){.thumbnail}

Wprowadź liczbę minut, zanim sesja wygaśnie.

![Wygaśnięcie sesji](images_expiration.png){.thumbnail}
