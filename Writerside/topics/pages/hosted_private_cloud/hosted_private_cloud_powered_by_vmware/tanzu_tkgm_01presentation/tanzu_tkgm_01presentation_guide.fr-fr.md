...
Consultez la documentation « [Installer Tanzu Kubernetes Grid](tanzu_tkgm_02installation1.) » pour effectuer l'installation.
...
![01 admin cluster diagram](01-admin-cluster-diagram01.png){.thumbnail}
...
Consultez le guide « [Administrer Tanzu Kubernete Grid](tanzu_tkgm_02installation1.) » pour déployer un cluster de *Workload* et une application. 
...
![02 admin and workload cluster diagram](02-tkc-mc-wc01.png){.thumbnail}
...
![03 apps and load balancing](03-internetworkcommunication01.png){.thumbnail}
...
Utilisez le guide « [Gestion des volumes permanents dans Tanzu Kubernetes Grid](tanzu_tkgm_04persistent-volumes1.) » pour ajouter une application qui utilise un volume permanent externe.
...
[Installation d'un cluster Tanzu Kubernetes GRID](tanzu_tkgm_02installation1.)

[Administrer un cluster Tanzu Kubernetes GRID](tanzu_tkgm_03manage1.)

[Gestion des volumes sur un cluster Tanzu Kubernetes GRID](tanzu_tkgm_04persistent-volumes1.)
