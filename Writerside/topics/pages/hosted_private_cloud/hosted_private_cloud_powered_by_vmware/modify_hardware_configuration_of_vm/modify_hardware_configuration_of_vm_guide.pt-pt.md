...
![Edição de recursos](images_hardware01.png){.thumbnail}

Neste menu, tem a possibilidade de aumentar os recursos da sua máquina virtual. 

![Edição de recursos](images_hardware02.png){.thumbnail}
...
![Adicionar uma CPU](images_hardware03.png){.thumbnail}
...
![Adição de memória](images_hardware04.png){.thumbnail}
...
![Adição de armazenamento](images_hardware05.png){.thumbnail}
...
![Adição da rede](images_hardware06.png){.thumbnail}
...
![Adição de um leitor CD/DVD](images_hardware07.png){.thumbnail}
...
![Adição de periféricos](images_hardware08.png){.thumbnail}
