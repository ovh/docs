...
Visit our page on [VMware on OVHcloud lifecycle policy](lifecycle_policy1.).
...
- Reconfiguring your network in order to replace VXLAN with [VLAN](creation_vlan1.).
...
> [!primary]
>
>  Find more information on the OVHcloud API in our guide on [Getting started with the OVHcloud API](first-steps1.).
...
To create your VLAN networks, you can follow this documentation: [VLAN Creation](creation_vlan1.)
...
The documentation to migrate to NSX is available here: [vDC Migration](service-migration-vdc2.)

Our support teams and [Professional Services experts](https://www.ovhcloud.com/en-sg/professional-services/) can provide you with assistance.
