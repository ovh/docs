...
- Having **NSX** deployed with two overlay and VLAN segments configured in your NSX configuration. Use our guide on [segment management in NSX](nsx-02-segment-management1.) for more information.
...
If you do not have a VLAN type segment, use the [Segment Management in NSX](nsx-02-segment-management1.) guide to create it with these settings :
