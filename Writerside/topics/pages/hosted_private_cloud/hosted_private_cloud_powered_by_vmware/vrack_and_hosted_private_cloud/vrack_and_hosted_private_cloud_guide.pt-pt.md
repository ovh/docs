...
![VM Network - VM Network diferente zona e diferente PCC ](vmnetwork-vmnetwork-diff-geo-diff-pcc.png){.thumbnail}

**Associar 1 vRack VM Network e 1 vRack vDC, em zonas geográficas diferentes, em diferentes Hosted Private Cloud.**

![VM Network - vDC diferente zona e diferente PCC ](vmnetwork-vdc-diff-geo-diff-pcc.png){.thumbnail}
