...
For more information on NSX at OVHcloud, please refer to our [Getting started with NSX](nsx-01-first-steps1.) guide.
...
![Add tier1-gw 01](01-add-tier1-gw01.png){.thumbnail}
...
![Add tier1-gw 02](01-add-tier1-gw02.png){.thumbnail}
...
![Add tier1-gw 03](01-add-tier1-gw03.png){.thumbnail}

Click `NO`{.action}.

![Add tier1-gw 04](01-add-tier1-gw04.png){.thumbnail}

Your new gateway is displayed and we can see it connected to your north-south gateway (ovh-T0-gw).

![Add tier1-gw 05](01-add-tier1-gw05.png){.thumbnail}
...
![Add tier1-gw 06](01-add-tier1-gw06.png){.thumbnail}

### Adding a segment on your new gateway

Go to `Segments`{.action} on the left and click `ADD SEGMENT`{.action}.

![02 Add Segment on new gateway 01](02-add-segment-on-new-gw01.png){.thumbnail}
...
![02 Add Segment on new gateway 02](02-add-segment-on-new-gw02.png){.thumbnail}

Click `NO`{.action}.

![02 Add Segment on new gateway 03](02-add-segment-on-new-gw03.png){.thumbnail}
...
Use our guide on [segment management in NSX](nsx-02-segment-management1.) to add a new virtual machine to your new segment.

Then click `Network Topology`{.action}.

![03 Display VM on segment in new gw 03](03-display-vm-on-segment-in-new-gw01.png){.thumbnail}
