...
Pour plus d'informations sur NSX chez OVHcloud, consultez le guide « [Premiers pas avec NSX](nsx-01-first-steps1.) ».
...
Aidez-vous du guide sur la [gestion des segments dans NSX](nsx-02-segment-management1.) pour ajouter une nouvelle machine virtuelle à votre nouveau segment. 
