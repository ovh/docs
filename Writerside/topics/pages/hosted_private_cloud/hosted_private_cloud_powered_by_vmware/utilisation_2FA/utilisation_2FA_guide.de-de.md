...
![Private Cloud Gateway](gatewayPCC.jpg){.thumbnail}
...
![QR-Code scannen](scanQRcode.png){.thumbnail}
...
![2FA Login](2FAtoken.png){.thumbnail}
...
Diese Anwendungen müssen zuerst über die vCenter-Zugangseinstellungen, die Sie über Ihr [Kundencenter](manager_ovh_private_cloud#sicherheit.) festlegen, autorisiert werden.
