...
![Gateway Hosted Private Cloud](gatewayPCC.jpg){.thumbnail}
...
![Ler o QRcode](scanQRcode.png){.thumbnail}
...
![Ligação 2FA](2FAtoken.png){.thumbnail}
...
Essas aplicações devem ser previamente autorizadas através da política de acesso ao vCenter, que é configurável na [Área de Cliente](manager_ovh_private_cloud#securite.).
