...
![Die Rechte für jedes Rechenzentrum anzeigen / ändern](images_user_rights_1.png){.thumbnail}

In diesem Menü können Sie die Rechte Ihrer vSphere-Nutzer pro Rechenzentrum ändern:

![Die Rechte ändern](images_user_rights_2.png){.thumbnail}
...
![Die Rechte ändern](images_user_rights_3.png){.thumbnail}
