...
Esta operação, chamada **vMotion**, é descrita [neste manual](vmware_vmotion_new2.).

![escolha vMotion](images_VmotionStorage2.png){.thumbnail}
...
Assim, poderá aplicar as políticas de armazenamento criadas se dispuser de um [armazenamento vSAN](vmware_vsan1.) ou da opção [VMencryption](vm_encrypt2.).

![escolha datastore](images_VmotionStorage3.png){.thumbnail}
...
![finalizar vMotion](images_VmotionStorage4.png){.thumbnail}
...
![seguimento vMotion](images_VmotionStorage5.png){.thumbnail}
