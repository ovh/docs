...
![Migrar disco](images_VmotionStorage1.png){.thumbnail}
...
Para más información sobre la operación **vMotion**, consulte nuestra [guía](vmware_vmotion_new2.).

![Selección de vMotion](images_VmotionStorage2.png){.thumbnail}
...
De este modo, si dispone de un [almacenamiento vSAN](vmware_vsan1.) o de la opción [VM encryption](vm_encrypt2.), podrá aplicar las políticas de almacenamiento creadas.

![Selección del datastore](images_VmotionStorage3.png){.thumbnail}
...
![Completar la operación vMotion](images_VmotionStorage4.png){.thumbnail}
...
![Monitorizar la operación vMotion](images_VmotionStorage5.png){.thumbnail}
