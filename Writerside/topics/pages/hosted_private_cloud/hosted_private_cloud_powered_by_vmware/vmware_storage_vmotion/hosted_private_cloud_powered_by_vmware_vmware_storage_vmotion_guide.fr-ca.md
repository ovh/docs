...
![déplacer disque](images_VmotionStorage1.png){.thumbnail}
...
Cette opération appelé **vMotion** est décrit dans [ce guide](vmware_vmotion_new2.).

![choix de vMotion](images_VmotionStorage2.png){.thumbnail}
...
Ainsi, vous pouvez appliquer les politiques de stockage créées si vous disposez d'un [stockage vSAN](vmware_vsan1.) ou de l'option [VMencryption](vm_encrypt2.).

![choix datastore](images_VmotionStorage3.png){.thumbnail}
...
![finaliser le vMotion](images_VmotionStorage4.png){.thumbnail}
...
![suivi de vMotion](images_VmotionStorage5.png){.thumbnail}
