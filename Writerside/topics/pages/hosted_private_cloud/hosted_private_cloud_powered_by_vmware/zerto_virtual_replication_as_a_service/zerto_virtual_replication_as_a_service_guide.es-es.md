...
Para otros casos, consulte nuestra guía sobre cómo [utilizar Zerto entre OVHcloud y una plataforma tercera](zerto-virtual-replication-customer-to-ovhcloud1.).
...
![zerto ovhcloud enable](zerto_OvhToOvh_enable_01.png){.thumbnail}

Seleccione **Between two OVHcloud Private Cloud solutions** y haga clic en `Activate Zerto DRP`{.action},

![zerto ovhcloud enable](zerto_OvhToOvh_enable_02.png){.thumbnail}
...
![zerto ovhcloud enable](zerto_OvhToOvh_enable_03.png){.thumbnail}
...
![zerto ovhcloud enable](zerto_OvhToOvh_enable_04.png){.thumbnail}
...
![zerto ovhcloud enable](zerto_OvhToOvh_enable_05.png){.thumbnail}
