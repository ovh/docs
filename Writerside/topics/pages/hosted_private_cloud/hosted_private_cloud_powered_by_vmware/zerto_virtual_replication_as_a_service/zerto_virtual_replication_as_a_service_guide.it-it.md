...
Per maggiori informazioni, consulta la guida su come [utilizza Zerto tra OVHcloud e una piattaforma terza](zerto-virtual-replication-customer-to-ovhcloud1.).
...
![Attivare Zerto OVH](zerto_OvhToOvh_enable_01.png){.thumbnail}

Seleziona **Tra due Private Cloud OVH** e clicca su `Attiva Zerto DRP`{.action}.

![Attivare Zerto OVH](zerto_OvhToOvh_enable_02.png){.thumbnail}
...
![Attivare Zerto OVH](zerto_OvhToOvh_enable_03.png){.thumbnail}
...
![Attivare Zerto OVH](zerto_OvhToOvh_enable_04.png){.thumbnail}
...
![Attivare Zerto OVH](zerto_OvhToOvh_enable_05.png){.thumbnail}
