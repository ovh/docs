...
Dans votre [interface vSphere](vsphere_interface_connexion1.), placez-vous dans la vue `Stockage`{.action}.

![vue stockage](register-vmx-01.png){.thumbnail}

Sélectionnez un datastore dans la liste.

![sélectionner datastore](register-vmx-02.png){.thumbnail}
...
Vérifiez les paramètres de vos VM (nom, [portgroup](creation_vlan1.), etc...) en faisant un clic droit sur chacune d'elles puis en sélectionnant `Edit Settings`{.action}.

![modifier paramètres](register-vmx-06.png){.thumbnail}
