...
W [interfejsie vSphere](vsphere_interface_connexion1.) umieść widok `Storage`{.action}.

![przestrzeń dyskowa](register-vmx-01.png){.thumbnail}

Wybierz datastore z listy.

![wybierz datastore](register-vmx-02.png){.thumbnail}
...
Sprawdź parametry swoich wirtualnych maszyn (nazwa, [portgroup](creation_vlan1.), itp..) klikając prawym przyciskiem myszy na każdym z nich, a następnie wybierając `Edit Settings`{.action}.

![zmień ustawienia](register-vmx-06.png){.thumbnail}
