...
![Attivazione di ACE](images_drs01.png){.thumbnail}
...
![automazione DRS](images_drs02.png){.thumbnail}
...
![opzioni aggiuntive DRS](images_drs03.png){.thumbnail}
...
![opzioni avanzate drs](images_drs05.png){.thumbnail}

### Le regole DRS

Per la gestione delle regole VM/host clicca sulla scheda `Configura`.

![regole drs](images_drs06.png){.thumbnail}
...
La quarta regola, “Da macchine virtuali a macchine virtuali” è spiegata nella nostra guida sulla funzione [funzione HA](vmware_ha_high_availability2.).

![creazione regole drs](images_drs07.png){.thumbnail}
