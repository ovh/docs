...
![Prinzip des DRS](images_drs0.png){.thumbnail}
...
![DRS aktivieren](images_drs01.png){.thumbnail}
...
![DRS-Automatisierung](images_drs02.png){.thumbnail}
...
![Weitere DRS-Optionen](images_drs03.png){.thumbnail}
...
![Erweiterte DRS-Optionen](images_drs05.png){.thumbnail}

### DRS-Regeln

Im Tab `Konfigurieren` finden Sie die Verwaltung der VM/Host-Regeln.

![DRS-Regeln](images_drs06.png){.thumbnail}
...
Die vierte Regel, „Virtuelle Maschinen zu virtuelle Maschinen“, wird in unserer Anleitung zur [HA-Funktion](vmware_ha_high_availability2.) erklärt (Englisch).

![DRS-Regeln erstellen](images_drs07.png){.thumbnail}
