...
![Function DRS](images_drs0.png){.thumbnail}
...
![Activation DRS](images_drs01.png){.thumbnail}
...
![Automation DRS](images_drs02.png){.thumbnail}
...
![Additional Options](images_drs03.png){.thumbnail}
...
![Advanced Options](images_drs05.png){.thumbnail}

### DRS rules

In the `Configure`{.action} tab you can find the management of `VM/Host Rules`.

![DRS rules](images_drs06.png){.thumbnail}
...
The fourth rule, **Virtual Machines to Virtual Machines** is explained in our guide on [VMware HA](vmware_ha_high_availability2.).

![DRS rules](images_drs07.png){.thumbnail}
