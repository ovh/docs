...
- Tener contratado el servicio [Hosted Private Cloud](https://www.ovhcloud.com/es-es/enterprise/products/hosted-private-cloud/){.external}.
...
![huella del certificado](images_certificate_thumbprints_01.png){.thumbnail}

![huella del certificado](images_certificate_thumbprints_02.png){.thumbnail}
...
![Área de cliente de OVHcloud](images_vm-encrypt_nupanel_01.png){.thumbnail}
...
![server KMS](images_vm-encrypt_manager_03.png){.thumbnail}
...
![server KMS](images_vm-encrypt_manager_04.png){.thumbnail}
...
![procedimiento añadir clave KMS](images_vm-encrypt_01.png){.thumbnail}
...
![importar certificado KMS](images_vm-encrypt_02.png){.thumbnail}

#### Compruebe que el KMS está configurado.

Compruebe que e l« **Connection Status** » correspondiente al KMS está en modo « Normal ».

![verificar estado conexión](images_vm-encrypt_03.png){.thumbnail}
...
![VM encryption storage](images_vm-encrypt_04.png){.thumbnail}

Seleccione los archivos de la máquina virtual y los demás discos duros que desea cifrar.

![VM encryption storage](images_vm-encrypt_05.png){.thumbnail}
...
![vMotion cifrado](images_vm-encrypt_06.png){.thumbnail}
...
![comprobación de la configuración](images_vm-encrypt_07.png){.thumbnail}

![comprobación de la configuración](images_vm-encrypt_08.png){.thumbnail}

![comprobación de la configuración](images_vm-encrypt_09.png){.thumbnail}
