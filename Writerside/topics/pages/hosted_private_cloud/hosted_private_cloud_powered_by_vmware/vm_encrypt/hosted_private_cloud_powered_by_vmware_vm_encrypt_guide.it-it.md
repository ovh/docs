...
![Fingerprint del certificato](images_certificate_thumbprints_01.png){.thumbnail}

![Fingerprint del certificato](images_certificate_thumbprints_02.png){.thumbnail}
...
![Spazio Cliente OVHcloud](images_vm-encrypt_nupanel_01.png){.thumbnail}
...
![Procedura di aggiunta KMS](images_vm-encrypt_01.png){.thumbnail}
...
![Importazione certificato KMS](images_vm-encrypt_02.png){.thumbnail}

#### Verifica la configurazione del KMS

In **Connection Status**, verifica che lo stato del KMS risulti in modalità “Normal”.

![Verifica lo stato della connessione](images_vm-encrypt_03.png){.thumbnail}
...
![vMotion cifrato](images_vm-encrypt_06.png){.thumbnail}
...
![Verifica della configurazione](images_vm-encrypt_07.png){.thumbnail}

![Verifica della configurazione](images_vm-encrypt_08.png){.thumbnail}

![Verifica della configurazione](images_vm-encrypt_09.png){.thumbnail}
