...
> [!primary]
>
> Please consult our guide ["Using the OVHcloud Network plugin"](plugin_ovh_network2.) to find out which IP addresses are reserved in a block as well as their use.
>
...
![nexthop field](images_move-api.png){.thumbnail}

The result will be in this form:

![nexthop field](images_api-result.png){.thumbnail}
