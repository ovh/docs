...
> [!primary]
>
> Welche IPs Ihres Blocks reserviert sind und wofür sie verwendet werden, können Sie in unserer Anleitung zum [OVHcloud Network Plugin](plugin_ovh_network2.) nachlesen.
>
...
![Feld nexthop](images_move-api.png){.thumbnail}

Das Ergebnis wird wie folgt angezeigt:

![Feld nexthop](images_api-result.png){.thumbnail}
...
![Operationen Kundencenter](images_operations.png){.thumbnail}
