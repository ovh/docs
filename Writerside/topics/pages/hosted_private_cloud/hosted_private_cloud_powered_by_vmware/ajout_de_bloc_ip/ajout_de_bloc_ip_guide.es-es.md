...
> [!primary]
>
> Para más información sobre las IP reservadas en su bloque y su utilización, consulte la siguiente guía: [Utilizar el plugin OVHcloud Network](plugin_ovh_network2.).
>
...
![campo nexthop](images_move-api.png){.thumbnail}

Obtendrá el siguiente resultado:

![campo nexthop](images_api-result.png){.thumbnail}
...
![operaciones manager](images_operations.png){.thumbnail}
