...
> [!primary]
>
> Não hesite em consultar o nosso manual sobre o [plugin OVHcloud Network](plugin_ovh_network2.){.external-link} para saber quais são os IP reservados do seu bloco, assim como a sua utilização.
>
