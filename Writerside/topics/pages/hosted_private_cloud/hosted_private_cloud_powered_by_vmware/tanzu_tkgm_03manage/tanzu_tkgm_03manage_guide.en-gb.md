...
- You need to have the **Tanzu Kubernetes GRID** administration cluster installed, using the [Install Tanzu Kubernetes Grid](tanzu_tkgm_02installation1.) guide.
...
![00 Cluster administration & workload Diagram01](00-tkc-mc-wc01.png){.thumbnail}
...
![01 vm created 01](01-vm-created-after-cwl-deployment01.png){.thumbnail}
...
![02 Verify Application 01](02-verify-application-01.png){.thumbnail}

In the **Bootstrap** console, use the web browser to connect to the URL `http://192.168.0.223`.

![02 Verify Application 02](02-verify-application-02.png){.thumbnail}
...
![03 apps and load balancing](images_03-internetworkcommunication01.png){.thumbnail}
