...
Hinweis: Über Ihr OVHcloud Kundencenter können Sie diese Berechtigung auch anderen Benutzern erteilen. Wenn Sie hierbei Hilfe benötigen, lesen Sie die Anleitung [Einführung in das Kundencenter der OVHcloud Private Cloud](manager_ovh_private_cloud1.).
...
- einen Link zur Bestätigung der Operation (Achtung: Wenn Ihr Telefon nicht mit einem Netzwerk verbunden ist, dessen [IP zugelassen](manager_ovh_private_cloud#sicherheit.) ist, wird die Seite nicht angezeigt.)
...
![Operation bestätigen](operationValidation.png){.thumbnail}
...
![Token der Operation](operationIdAndToken.png){.thumbnail}
...
![Passwort ändern](changePassword.png){.thumbnail}
...
![Passwort festlegen](defineNewPassword.png){.thumbnail}
...
![Passwort verloren](passwordLost.png){.thumbnail}
...
![Benutzerinformationen](infoUser.png){.thumbnail}
...
![Token und Passwort](tokenAndPassword.png){.thumbnail}
