...
- the operation ID
- validation token
- a link to validate the operation (please note, if your phone is not connected to a network whose [IP is authorised](manager_ovh_private_cloud#security-tab.), the page will not appear).
