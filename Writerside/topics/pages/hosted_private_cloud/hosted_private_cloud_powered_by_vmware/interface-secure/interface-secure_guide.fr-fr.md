...
Notez qu'il est également possible d'accorder cette autorisation à d'autres utilisateurs via l'espace client OVHcloud. Reportez-vous si nécessaire à notre [Présentation de l’espace client Private Cloud OVHcloud](manager_ovh_private_cloud1.).
...
- un lien permettant de valider l'opération (notez que si votre téléphone n'est pas connecté à un réseau dont [l'adresse IP est autorisée](manager_ovh_private_cloud#securite.), la page n'apparaîtra pas).
...
![Validation de l'opération](operationValidation.png){.thumbnail}
...
![Jeton d'opération](operationIdAndToken.png){.thumbnail}
...
![Modifier le mot de passe](changePassword.png){.thumbnail}
...
![Définir le mot de passe](defineNewPassword.png){.thumbnail}
...
![Mot de passe perdu](passwordLost.png){.thumbnail}
...
![Informations utilisateur](infoUser.png){.thumbnail}
...
![Jeton et mot de passe](tokenAndPassword.png){.thumbnail}
