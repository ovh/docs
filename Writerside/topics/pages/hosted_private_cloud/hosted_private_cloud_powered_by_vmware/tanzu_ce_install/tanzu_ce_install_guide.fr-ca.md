...
- Configurer le service [DHCP](nsx_configurer_le_dhcp_sur_une_edge_gateway1.) sur la NSX Gateway
...
Consultez notre documentation pour [ajouter un bloc d'IP](ajout_de_bloc_ip1.) si vous n'avez plus d'IP publique utilisable.

![réseau](en00ipblocks.png){.thumbnail}
...
![règle SNAT](en03nsxsnat.png){.thumbnail}
...
![adresses](en00ipsec.png){.thumbnail}
...
Vous pouvez déployer une VM [depuis un ISO](deploiement_d_une_machine_virtuelle1.) ou [depuis un modèle OVF](ovf_template1.).<br>
...
![option vSphere](images_en06deploy.png){.thumbnail}
...
![type d'instance](en10type.png){.thumbnail}
...
![Ressources](en13resources.png){.thumbnail}
...
![modèle de noeuds](en16os.png){.thumbnail}
...
![Déploiement](en18deploy.png){.thumbnail}

Une fois l'opération terminée, vérifiez que vous voyez le message de création et que les nœuds sont visibles dans vSphere.

![message de création](en20created.png){.thumbnail}

![noeuds visibles](en21vsphere.png){.thumbnail}
...
![nom du fichier yaml](en26copyconf.png){.thumbnail}
...
![message de création](en27created.png){.thumbnail}

![noeuds visibles](en28vsphere.png){.thumbnail}
