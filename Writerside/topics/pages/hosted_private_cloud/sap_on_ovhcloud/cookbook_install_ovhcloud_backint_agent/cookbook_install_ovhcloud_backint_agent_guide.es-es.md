...
- [A Public Cloud project](create_a_public_cloud_project1.) in your OVHcloud account with:
    - An [S3 Object Storage bucket](s3_create_bucket1.) and an [S3 user](s3_identity_and_access_management#creating-a-user.) with the read and write rights
...
![recover_tenant_13](recover_tenant_13.png){.thumbnail}

## Go further

- To improve the security of your backups, we advise you to set the [object immutability](s3_managing_object_lock1.).
- You also have the possibility to [trigger SAP HANA backup to several S3 Object Storage buckets](cookbook_configure_ovhcloud_backint_agent_several_buckets1.).
