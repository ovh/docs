...
[Veeam Enterprise Plus with OVHcloud](https://www.ovhcloud.com/en-au/storage-solutions/veeam-enterprise/) allows you to use Veeam Backup and Replication within your OVHcloud infrastructure and benefiting from a Veeam Enterprise Plus licence.

## Requirements

- An SAP HANA database installed.
- A Windows server which will host the [Veeam Backup and Replication](https://www.ovhcloud.com/en-au/storage-solutions/veeam-enterprise/) solution.
- A space on a shared storage for a non-SecNumCloud need or a virtual machine on a [SecNumCloud-qualified VMware on OVHcloud solution](https://www.ovhcloud.com/en-au/enterprise/products/secnumcloud/) acting as an NFS or SMB server for SNC need.

## Instructions

### Veeam Backup and Replication installation

If you want to be helped during the installation of Veeam Backup and Replication on your Windows server, we recommend you [our guide](veeam_veeam_backup_replication1.).
...
To discover a S3 Object Storage creation steps, we recommend our [our guide](s3_create_bucket1.).
...
>>
>> Add your credentials which have the Administrator role on this S3 Object Storage bucket. It's the user's access key and the user's secret key linked to the S3 Object Storage bucket. Find more information about that in [our guide](s3_identity_and_access_management1.).
>>
...
To meet this need, we propose to create a virtual machine on a [SecNumCloud-qualified VMware on OVHcloud solution](https://www.ovhcloud.com/en-au/enterprise/products/secnumcloud/) acting as a NFS or SMB server.
