...
You can set a hostname which will be displayed with the command `hostname`. You have also the possibility to [add your SSH key](getting-started-with-dedicated-server#adicionar-uma-chave-ssh-facultativo.).
...
Once the SLES 15 for SAP installation is done, you can [connect to your dedicated server](getting-started-with-dedicated-server#ligacao-ao-seu-servidor.).
