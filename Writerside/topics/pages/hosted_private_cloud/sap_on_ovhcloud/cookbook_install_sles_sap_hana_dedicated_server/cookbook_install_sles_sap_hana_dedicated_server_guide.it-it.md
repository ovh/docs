...
You can set a hostname which will be displayed with the command `hostname`. You have also the possibility to [add your SSH key](getting-started-with-dedicated-server#aggiunta-di-una-chiave-ssh-facoltativo.).
...
Once the SLES 15 for SAP installation is done, you can [connect to your dedicated server](getting-started-with-dedicated-server#connessione-al-tuo-server.).
