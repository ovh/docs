...
- **Veeam Backup & Replication** installé sur une machine virtuelle de votre cluster Nutanix via cette procédure : [Installer Veeam Backup & Replication](veeam_veeam_backup_replication1.).
...
![Create User VEEAM PE 01](01-create-pe-veeamuser01.png){.thumbnail}
...
![Addon Installation 01](02-install-addon-nutanix-veeam01.png){.thumbnail}
...
![Restore VM 15](07-restorevm15.png){.thumbnail}
...
[Les solutions de stockage OVHcloud](storage-backup.)
