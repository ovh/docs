...
Pour plus de détails sur **AHV**, reportez-vous à la section « [Aller plus loin](06-virtual-machine-management_#gofurther.) » de ce guide.
...
![Tableau de Bord Prism Central - Menu VMs](PrismCentralDashBooardWithVMMenu.PNG){.thumbnail}

Cliquez sur le bouton `Create VM`{.action}.

![Tableau de Bord Prism Central - Gestion des VMs ](PrismCentralDashVmDashBoard.PNG){.thumbnail}

Saisissez un nom dans `Name`{.action}, choisissez les options dans `VM Properties`{.action} et cliquez sur `Next`{.action}

![Création d'une machine virtuelle - Etape 1](CreateVM01.PNG){.thumbnail}

##### **Ajout d'un disque système**

Cliquez sur le bouton`Attach Disk`{.action}.

![Création d'une machine virtuelle - Etape 2](CreateVM02.PNG){.thumbnail}

Saisissez **60** dans le champ `capacity` et cliquez sur `Save`{.action} pour créer un disque de 60 Go.

![Création d'une machine virtuelle - Etape 3](CreateVM03.PNG){.thumbnail}
...
Pour plus de détails sur l'importation d'images, reportez-vous à la section « [Aller plus loin](06-virtual-machine-management_#gofurther.) » de ce guide.

Cliquez sur `Attach Disk`{.action}.

![Création d'une machine virtuelle - Etape 4](CreateVM04.PNG){.thumbnail}

Modifiez les paramètres `Type`{.action} en **CD-ROM**, `Operation`{.action} en **Clone from Image** , `Image`{.action} en **WS2022EN.ISO**.

Cliquez sur `Save`{.action}.

![Création d'une machine virtuelle - Etape 5](CreateVM05.PNG){.thumbnail}
...
![Création d'une machine virtuelle - Etape 6](CreateVM06.PNG){.thumbnail}
...
![Création d'une machine virtuelle - Etape 7](CreateVM07.PNG){.thumbnail}

##### **Configuration du réseau**

Cliquez sur `Attach Subnet`{.action}.

![Création d'une machine virtuelle - Etape 8](CreateVM08.PNG){.thumbnail}

Laissez les champs par défaut et cliquez sur `Save`{.action}.

![Création d'une machine virtuelle - Etape 9](CreateVM09.PNG){.thumbnail}

Cliquez sur `Next`{.action}.

![Création d'une machine virtuelle - Etape 10](CreateVM10.PNG){.thumbnail}

Choisissez le fuseau horaire de votre pays dans le champ `Timezone`{.action} et cliquez sur `Next`{.action}.

![Création d'une machine virtuelle - Etape 11](CreateVM11.PNG){.thumbnail}

Cliquez sur `Create VM`{.action}.

![Création d'une machine virtuelle - Etape 12](CreateVM12.PNG){.thumbnail}

La machine virtuelle nouvellement créée apparaît alors dans le tableau de bord.

![Tableau de bord VMs - VM Créé](CreateVM13.PNG){.thumbnail}.
...
![Installation - WS2022 - Lancement](InstallWS2022-01.PNG){.thumbnail}

##### **Démarrer la machine virtuelle**

Cliquez sur le menu `Actions`{.action} puis sur `Power ON`{.action}.

![Installation - WS2022 - Démarrage ](InstallWS2022-02.PNG){.thumbnail}

##### **Lancer la console**

Cliquez sur le menu `Actions`{.action} puis sur `Launch Console`{.action}.

![Installation - WS2022 - Connexion à l'interface ](InstallWS2022-03.PNG){.thumbnail}
...
![Installation - WS2022 - Etape2](InstallWS2022-05.PNG){.thumbnail}
...
![Installation - WS2022- Etape4](InstallWS2022-09.PNG){.thumbnail}

Cliquez sur `Browse`{.action}.

![Installation - WS2022- Etape5](InstallWS2022-10.PNG){.thumbnail}

Sélectionnez le bon dossier `e:\Windows Server 2022\amd64` et cliquez sur `OK`{.action}.

![Installation - WS2022- Etape5](InstallWS2022-11.PNG){.thumbnail}
...
[Importation d'images dans Nutanix](05-image-import1.)
