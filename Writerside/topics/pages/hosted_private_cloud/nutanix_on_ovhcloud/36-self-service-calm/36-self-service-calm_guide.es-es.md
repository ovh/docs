...
>
> If you encounter any difficulties performing these actions, please contact a [specialist service provider](https://partner.ovhcloud.com/es-es/directory/) and/or discuss the issue with our community. You can find more information in the [Go further](36-self-service-calm_#gofurther.) section of this tutorial.
>
...
![01 create Project 01](01-create-project-01.png){.thumbnail}

Click the `Projects`{.action} icon in the vertical menu bar.

![01 create Project 02](01-create-project-02.png){.thumbnail}

Click the `+ Create Project`{.action} button.

![01 create Project 03](01-create-project-03.png){.thumbnail}

Type the `project name`{.action} in **Project Name** field and click `Create`{.action}

![01 create Project 04](01-create-project-04.png){.thumbnail}

click `+ Add infrastructure`{.action}.

![01 create Project 05](01-create-project-05.png){.thumbnail}

Click `Add infrastructure`{.action}.

![01 create Project 06](01-create-project-06.png){.thumbnail}

Select `NTNX_LOCAL_AZ`{.action} from accounts.

![01 create Project 07](01-create-project-07.png){.thumbnail}

Click `Configure Resources`{.action}.

![01 create Project 08](01-create-project-08.png){.thumbnail}

Select your `Cluster`{.action} from **Select clusters to be added to this project** and click `+ Select VLANs`{.action}.

![01 create Project 09](01-create-project-09.png){.thumbnail}

Check the `production`{.action} VLAN box and click `Confirm and Select Default`{.action}.

![01 create Project 10](01-create-project-10.png){.thumbnail}

Click `Confirm`{.action}.

![01 create Project 11](01-create-project-11.png){.thumbnail}

Click `Save`{.action}.

![01 create Project 12](01-create-project-12.png){.thumbnail}

In the tab bar go to `Environments`{.action} and click `Create Environment`{.action}.

![01 create Project 13](01-create-project-13.png){.thumbnail}

Type a `Name`{.action} in the **Name** field and click `Next`{.action}.

![01 create Project 14](01-create-project-14.png){.thumbnail}

Click `Select Infrastructure`{.action}.

![01 create Project 15](01-create-project-15.png){.thumbnail}

Click `NTNX_LOCAL_AZ`{.action}.

![01 create Project 16](01-create-project-16.png){.thumbnail}

Click `Required for lauching blueprints from marketplace`{.action} to the right of **VM Configuration**

![01 create Project 17](01-create-project-17.png){.thumbnail}
...
![01 create Project 18](01-create-project-18.png){.thumbnail}

Click the `+`{.action} button to the right of **NETWORK ADAPTERS (NICs)**.

![01 create Project 19](01-create-project-19.png){.thumbnail}
...
![01 create Project 20](01-create-project-20.png){.thumbnail}
...
![01 create Project 21](01-create-project-21.png){.thumbnail}

Click the `+`{.action} button to the right of **NETWORK ADAPTERS (NICs)**.

![01 create Project 22](01-create-project-22.png){.thumbnail}
...
![01 create Project 23](01-create-project-23.png){.thumbnail}

Click `+ Add Credential`{.action}.

![01 create Project 24](01-create-project-24.png){.thumbnail}

Click `+ Add Credential`{.action}.

![01 create Project 25](01-create-project-25.png){.thumbnail}
...
![01 create Project 26](01-create-project-26.png){.thumbnail}
...
![01 create Project 27](01-create-project-27.png){.thumbnail}

Click `Marketplace Usage`{.action}.

![02 add credential to environment 01](02-add-credential-to-environment01.png){.thumbnail}

Click `Update`{.action}.

![02 add credential to environment 02](02-add-credential-to-environment02.png){.thumbnail}

Click `Next`{.action}.

![02 add credential to environment 03](02-add-credential-to-environment03.png){.thumbnail}

Click `Not ready for marketplace usage`{.action} to the right of VM Configuration.

![02 add credential to environment 04](02-add-credential-to-environment04.png){.thumbnail}

Scroll down the window.

![02 add credential to environment 05](02-add-credential-to-environment05.png){.thumbnail}

Choose `WindowsAccount`{.action} from **Credential** and scroll up the window.

![02 add credential to environment 06](02-add-credential-to-environment06.png){.thumbnail}

Click the `Linux`{.action} tab in **Credential** and scroll down the window.

![02 add credential to environment 07](02-add-credential-to-environment07.png){.thumbnail}

Choose `LinuxAccount`{.action} from **Credential** and click `Next`{.action}.

![02 add credential to environment 08](02-add-credential-to-environment08.png){.thumbnail}

Click `Save Environment`{.action}.

![02 add credential to environment 09](02-add-credential-to-environment09.png){.thumbnail}

Your environment is ready for application creation and distribution.

![02 add credential to environment 10](02-add-credential-to-environment10.png){.thumbnail}
...
![03 Create Windows Blueprint 01](03-create-windows-blueprint01.png){.thumbnail}

Choose the `name`{.action} of your blueprint from **Name** and click on `Proceed`{.action}.

![03 Create Windows Blueprint 02](03-create-windows-blueprint02.png){.thumbnail}

Type the `name`{.action} in **Application Profile Name** and click on `Credentials`{.action} at the top.

![03 Create Windows Blueprint 03](03-create-windows-blueprint03.png){.thumbnail}
...
![03 Create Windows Blueprint 04](03-create-windows-blueprint04.png){.thumbnail}
...
![03 Create Windows Blueprint 05](03-create-windows-blueprint05.png){.thumbnail}

Click `Back`{.action}.

![03 Create Windows Blueprint 06](03-create-windows-blueprint06.png){.thumbnail}

Click the `+`{.action} button in the left window next to **Service**.

![03 Create Windows Blueprint 07](03-create-windows-blueprint07.png){.thumbnail}
...
![03 Create Windows Blueprint 08](03-create-windows-blueprint08.png){.thumbnail}
...
![03 Create Windows Blueprint 09](03-create-windows-blueprint09.png){.thumbnail}
...
![03 Create Windows Blueprint 10](03-create-windows-blueprint10.png){.thumbnail}
...
![03 Create Windows Blueprint 11](03-create-windows-blueprint11.png){.thumbnail}
...
![03 Create Windows Blueprint 12](03-create-windows-blueprint12.png){.thumbnail}
...
![03 Create Windows Blueprint 13](03-create-windows-blueprint13.png){.thumbnail}
...
![03 Create Windows Blueprint 14](03-create-windows-blueprint14.png){.thumbnail}

The application is created, click `Launch`{.action} to test your application.

![03 Create Windows Blueprint 15](03-create-windows-blueprint15.png){.thumbnail}

Type a `Name`{.action} in **Application Name** and click `Deploy`{.action}.

![03 Create Windows Blueprint 16](03-create-windows-blueprint16.png){.thumbnail}
...
![03 Create Windows Blueprint 17](03-create-windows-blueprint17.png){.thumbnail}

In our case, the IIS server is active and displays a message on the IP address of the virtual machine in HTTP.

![03 Create Windows Blueprint 18](03-create-windows-blueprint18.png){.thumbnail}
...
![04 create Linux blueprint 01](04-create-linux-blueprint01.png){.thumbnail}

Type the `Name`{.action} in **Name** and click `Proceed`{.action}.

![04 create Linux blueprint 02](04-create-linux-blueprint02.png){.thumbnail}

Click `Credentials`{.action}.

![04 create Linux blueprint 03](04-create-linux-blueprint03.png){.thumbnail}

Click `Credentials +`{.action}.

![04 create Linux blueprint 04](04-create-linux-blueprint04.png){.thumbnail}
...
![04 create Linux blueprint 05](04-create-linux-blueprint05.png){.thumbnail}

Click on `Credentials +`{.action}.

![04 create Linux blueprint 06](04-create-linux-blueprint06.png){.thumbnail}
...
![04 create Linux blueprint 07](04-create-linux-blueprint07.png){.thumbnail}

Click `Back`{.action}.

![04 create Linux blueprint 08](04-create-linux-blueprint08.png){.thumbnail}

Type `Linux Application`{.action} in **Application Profile Name** and click `+`{.action} in the left-to-right window of **Service**.

![04 create Linux blueprint 09](04-create-linux-blueprint09.png){.thumbnail}
...
![04 create Linux blueprint 10](04-create-linux-blueprint10.png){.thumbnail}
...
![04 create Linux blueprint 11](04-create-linux-blueprint11.png){.thumbnail}

Choose `LinuxAccount`{.action} from **Check log-in upon create**.

![04 create Linux blueprint 12](04-create-linux-blueprint12.png){.thumbnail}

In the left window, go to `Install`{.action} below **Package** and click on `+ Task`{.action}.

![04 create Linux blueprint 13](04-create-linux-blueprint13.png){.thumbnail}
...
![04 create Linux blueprint 14](04-create-linux-blueprint14.png){.thumbnail}
...
![04 create Linux blueprint 15](04-create-linux-blueprint15.png){.thumbnail}
...
![04 create Linux blueprint 16](04-create-linux-blueprint16.png){.thumbnail}
...
![04 create Linux blueprint 17](04-create-linux-blueprint17.png){.thumbnail}
...
![04 create Linux blueprint 18](04-create-linux-blueprint18.png){.thumbnail}

Click `Launch`{.action} to test your blueprint.

![04 create Linux blueprint 19](04-create-linux-blueprint19.png){.thumbnail}

Type the `name`{.action} of your test deployment in **Application Name** and click `Deploy`{.action}.

![04 create Linux blueprint 20](04-create-linux-blueprint20.png){.thumbnail}

Deployment begins.

![04 create Linux blueprint 21](04-create-linux-blueprint21.png){.thumbnail}

Click `Audit`{.action} to view your deployment progress.

![04 create Linux blueprint 22](04-create-linux-blueprint22.png){.thumbnail}

Once the deployment is complete, you can access the IP address of your NGINX VM via HTTP to view the welcome message.

![04 create Linux blueprint 23](04-create-linux-blueprint23.png){.thumbnail}

#### Publishing applications

Go to the `Blueprints`{.action} icon in the CALM vertical bar on the left and click on the `WS 2022 IIS`{.action} map.

![05 publish Windows Application 01](05-publish-windows-application01.png){.thumbnail}

Click `Publish`{.action}.

![05 publish Windows Application 02](05-publish-windows-application02.png){.thumbnail}
...
![05 publish Windows Application 03](05-publish-windows-application03.png){.thumbnail}

Click `Upload from computer`{.action}.

![05 publish Windows Application 04](05-publish-windows-application04.png){.thumbnail}

Choose the `image`{.action} on your computer and click `Open`{.action}.

![05 publish Windows Application 05](05-publish-windows-application05.png){.thumbnail}

Name your Icon `IIS`{.action} and click on the `blue validation`{.action} button.

![05 publish Windows Application 06](05-publish-windows-application06.png){.thumbnail}

Click `Select & continue`{.action}.

![05 publish Windows Application 07](05-publish-windows-application07.png){.thumbnail}

Click `Submit for approval`{.action}.

![05 publish Windows Application 08](05-publish-windows-application08.png){.thumbnail}

The Windows application is in the marketplace awaiting approval.

Click the `UBUNTU 22 NGINX`{.action} blueprint.

![06 publish Windows Application 01](06-publish-linux-application01.png){.thumbnail}

Click `Publish`{.action}.

![06 publish Windows Application 02](06-publish-linux-application02.png){.thumbnail}
...
![06 publish Windows Application 03](06-publish-linux-application03.png){.thumbnail}

Click `Upload from computer`{.action}.

![06 publish Windows Application 04](06-publish-linux-application04.png){.thumbnail}

Choose the `image`{.action} on your computer and click `Open`{.action}.

![06 publish Windows Application 05](06-publish-linux-application05.png){.thumbnail}

Name your icon `NGINX`{.action} and click the `blue validation button`{.action}.

![06 publish Windows Application 06](06-publish-linux-application06.png){.thumbnail}

Select your icon and click `Select & continue`{.action}.

![06 publish Windows Application 07](06-publish-linux-application07.png){.thumbnail}

Click `Submit for approval`{.action}.

![06 publish Windows Application 08](06-publish-linux-application08.png){.thumbnail}
...
![07 approve Application 02](07-approve-application01.png){.thumbnail}

Check the `WS 2022 IIS`{.action} application and click the validation icon on the right.

![07 approve Application 02](07-approve-application02.png){.thumbnail}
...
![08 ADD to market place 01](08-add-to-marketplace01.png){.thumbnail}

Click `Publish`{.action}.

![08 ADD to market place 02](08-add-to-marketplace02.png){.thumbnail}

The Windows application is published.

![08 ADD to market place 03](08-add-to-marketplace03.png){.thumbnail}

Check `Ubuntu 22 NGINX`{.action}, select `NCM Self Service Project 01`{.action} on the right and click `Apply`{.action}.

![08 ADD to market place 04](08-add-to-marketplace04.png){.thumbnail}

Click `Publish`{.action}.

![08 ADD to market place 05](08-add-to-marketplace05.png){.thumbnail}

The Ubuntu application is published.

![08 ADD to market place 06](08-add-to-marketplace06.png){.thumbnail}
...
![08 ADD to market place 07](08-add-to-marketplace07.png){.thumbnail}

Click `Launch`{.action}.

![08 ADD to market place 08](08-add-to-marketplace08.png){.thumbnail}

Type a `Name`{.action} in **Application Name** and click `Deploy`{.action} to deploy an application.

![08 ADD to market place 09](08-add-to-marketplace09.png){.thumbnail}
...
![09 delete deployed APP 01](09-delete-deployed-app01.png){.thumbnail}

From the **Action** menu, click `Delete`{.action}.

![09 delete deployed APP 02](09-delete-deployed-app02.png){.thumbnail}

Click `Confirm`{.action}.

![09 delete deployed APP 03](09-delete-deployed-app03.png){.thumbnail}

You can view the progress of a deletion as you would for a deployment.

![09 delete deployed APP 04](09-delete-deployed-app04.png){.thumbnail}

The application is completely deleted.

![09 delete deployed APP 05](09-delete-deployed-app05.png){.thumbnail}
