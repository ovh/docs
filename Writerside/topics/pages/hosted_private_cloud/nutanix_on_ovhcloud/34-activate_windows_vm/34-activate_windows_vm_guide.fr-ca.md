...
>
> Si vous éprouvez des difficultés à appliquer ces instructions, nous vous recommandons de faire appel à un [prestataire spécialisé](https://partner.ovhcloud.com/fr-ca/directory/). Pour plus d'informations, consultez la section [Aller plus loin](34-activate_windows_vm_#gofurther.) de ce tutoriel.
>
...
- Une machine virtuelle sous Windows Server. Vous pouvez vous aider de ce guide pour installer une machine virtuelle sous Windows : [Gestion des machines virtuelles](06-virtual-machine-management1.).
...
![Activation de l'utilitaire Exécuter](01-run01.png){.thumbnail}

![Exécuter](01-run02.png){.thumbnail}
