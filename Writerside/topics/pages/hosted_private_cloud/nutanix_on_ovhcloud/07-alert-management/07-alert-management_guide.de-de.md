...
![Configure Prism Central SMTP Server 01](ConfigurePrismCentralSmtp01.PNG){.thumbnail}

In the right-hand menu, click `SMTP Server`{.action}.

Enter the SMTP server sending settings and click `Save`{.action}.

![Configure Prism Central SMTP Server 02](ConfigurePrismCentralSmtp02.PNG){.thumbnail}
...
![Create Alert 01](CreateAlert01.PNG){.thumbnail}
...
![Create Alert 02](CreateAlert02.PNG){.thumbnail}

The alert you have created will then appear in the list.

![Create Alert 03](CreateAlert03.PNG){.thumbnail}
...
![Show triggered alarm 01](ShowTriggeredAlarm01.PNG){.thumbnail}

The raised alarm appears.

![Show triggered alarm 02](ShowTriggeredAlarm02.PNG){.thumbnail}

Select the alarm and click `Resolve`{.action}.

![Resolv Alarm 01](ResolvAlarm01.PNG){.thumbnail}

The alarm is then resolved and no longer appears in the **Prism Central dashboard**.

![Resolv Alarm 02](ResolvAlarm02.PNG){.thumbnail}
...
![Display Events 01](DisplayEvents01.PNG){.thumbnail}

The list of events is displayed.

![Display Events 02](DisplayEvents02.PNG){.thumbnail}
...
![Display Task 02](DisplayTasks01.PNG){.thumbnail}

The task list appears.

![Display Tasks 02](DisplayTasks02.PNG){.thumbnail}
