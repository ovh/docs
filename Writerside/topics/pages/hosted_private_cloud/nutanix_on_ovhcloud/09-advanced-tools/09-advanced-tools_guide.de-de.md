...
For more information on these commands, see the [Go further](09-advanced-tools_#gofurther.) section of this guide.
...
You can install Linux from pre-installed images, and you can customise the configuration with cloud-init, which uses the yaml file format. To import images into a Nutanix cluster, you can refer to our guide on [importing ISO images](05-image-import1.).
