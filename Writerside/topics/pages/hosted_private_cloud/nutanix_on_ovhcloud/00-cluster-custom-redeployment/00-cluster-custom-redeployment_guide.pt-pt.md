...
> [!warning]
> If you have signed up to the **Nutanix on OVHcloud BYOL offer** and have activated licences on your cluster, you will need to uninstall your licences before you launch the redeployment. You can use this guide to manage your licences: [Manage licences in your Nutanix on OVHcloud BYOL Offer cluster](12-activate-licenses-on-byol1.).
>
...
![00 Redeploy cluster from OVHcloud control panel 01](00-cluster-redeployment-through-manager01.png)

If you have subscribed to the Nutanix BYOL offer, a reminder will tell you not to forget to uninstall your licences. You can use this guide to manage your licences: [Manage licences in your Nutanix on OVHcloud BYOL Offer cluster](12-activate-licenses-on-byol1.). When your licences are uninstalled, click `Continue`{.action}.

![00 Redeploy cluster from OVHcloud control panel 02](00-cluster-redeployment-through-manager02.png)

Click `Customise the Configuration`{.action} and click `Next`{.action}

![00 Redeploy cluster from OVHcloud control panel 03](00-cluster-redeployment-through-manager03.png)
...
![00 Redeploy cluster from OVHcloud control panel 04](00-cluster-redeployment-through-manager04.png)
...
![00 Redeploy cluster from OVHcloud control panel 05](00-cluster-redeployment-through-manager05.png)

Enter `REDEPLOY` and click `Confirm`{.action}.

![00 Redeploy cluster from OVHcloud control panel 06](00-cluster-redeployment-through-manager06.png)
...
![00 Redeploy cluster from OVHcloud control panel 07](00-cluster-redeployment-through-manager07.png)

### Redeploy the cluster through the OVHcloud API

Log in to the [OVHcloud API](https://api.ovh.com). For more details on how the OVHcloud API works, please refer to our guide on [Getting started with the OVHcloud APIs](first-steps1.)

> [!warning]
> If you use the OVHcloud API to repackage your cluster with a Nutanix BYOL offer, you will not receive a message to notify you to uninstall your licences. Don't forget to do so. You can use this guide to manage your licences: [Manage licences in your Nutanix on OVHcloud BYOL Offer cluster](12-activate-licenses-on-byol1.). After uninstalling your licences, you can redeploy your cluster with the OVHcloud API.
>
...
![Cluster Redeployment 03](01-cluster-redeployment03.png)
...
![Cluster Redeployment 04](01-cluster-redeployment04.png)
...
![Cluster Redeployment 04](01-cluster-redeployment05.png)
...
![Cluster Redeployment 05](01-cluster-redeployment06.png)
...
[Using the OVHcloud API](manage-operate-api-apiv61.)

[Manage licences in your Nutanix on OVHcloud BYOL Offer cluster](12-activate-licenses-on-byol1.)
