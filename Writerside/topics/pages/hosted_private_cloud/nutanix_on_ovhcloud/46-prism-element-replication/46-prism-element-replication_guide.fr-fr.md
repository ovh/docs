...
Si vous souhaitez de l'aide concernant la mise en place d'un VPN IPsec, consulter notre guide sur l'[interconnexion de deux clusters Nutanix au travers d'un VPN IPsec](44-ipsec-interconnection1.).

Connectez-vous via **Prism Element** au cluster en France à partir de **Prism Central**, comme indiqué dans cette documentation : [Hyper-convergence Nutanix](03-nutanix-hci1.).

Cliquez sur `Data Protection`{.action} depuis le menu `Home`{.action}.

![01 Create Remote Site From France01](01-create-remote-site-from-france01.png){.thumbnail} 

Cliquez sur `Remote Site`{.action} à gauche de l'écran.

![01 Create Remote Site From France02](01-create-remote-site-from-france02.png){.thumbnail}

Cliquez sur `+ Remote Site`{.action} à droite de l'écran et choisissez `Physical Cluster`{.action} pour rajouter un site distant.

![01 Create Remote Site From France04](01-create-remote-site-from-france04.png){.thumbnail}
...
![01 Create Remote Site From France05](01-create-remote-site-from-france05.png){.thumbnail}

Faites défiler la fenêtre à l'aide de La `barre de défilement`{.action}.

![01 Create Remote Site From France06](01-create-remote-site-from-france06.png){.thumbnail}
...
![01 Create Remote Site From France07](01-create-remote-site-from-france07.png){.thumbnail}
...
![01 Create Remote Site From France08](01-create-remote-site-from-france08.png){.thumbnail}
...
![01 Create Remote Site From France09](01-create-remote-site-from-france09.png){.thumbnail}

Cliquez sur `Save`{.action}.

![01 Create Remote Site From France10](01-create-remote-site-from-france10.png){.thumbnail}

Le site distant apparait alors dans la liste.

![01 Create Remote Site From France11](01-create-remote-site-from-france11.png){.thumbnail}
...
![02 Create Remote Site From Canada01](02-create-remote-site-from-canada01.png){.thumbnail} 

Cliquez sur `Remote Site`{.action} à gauche de l'écran.

![02 Create Remote Site From Canada02](02-create-remote-site-from-canada02.png){.thumbnail}

Cliquez sur `+ Remote Site`{.action} à droite de l'écran et choisissez `Physical Cluster`{.action} pour rajouter un site distant.

![02 Create Remote Site From Canada04](02-create-remote-site-from-canada04.png){.thumbnail}
...
![02 Create Remote Site From Canada05](02-create-remote-site-from-canada05.png){.thumbnail}

Faites défiler la fenêtre à l'aide de La `barre de défilement`{.action}.

![02 Create Remote Site From Canada06](02-create-remote-site-from-canada06.png){.thumbnail}
...
![02 Create Remote Site From Canada07](02-create-remote-site-from-canada07.png){.thumbnail}
...
![02 Create Remote Site From Canada08](02-create-remote-site-from-canada08.png){.thumbnail}
...
![02 Create Remote Site From Canada09](02-create-remote-site-from-canada09.png){.thumbnail}

Cliquez sur `Save`{.action}.

![02 Create Remote Site From Canada10](02-create-remote-site-from-canada10.png){.thumbnail}

Le site distant apparait alors dans la liste. 

![02 Create Remote Site From Canada11](02-create-remote-site-from-canada11.png){.thumbnail}
...
![03 Create dataprotection 01](03-create-dataprotection01.png){.thumbnail}

Depuis le tableau de bord **Data Protection**, cliquez en haut à droite sur `+ Protection Domain`{.action} puis sur `Async DR`{.action}.

![03 Create dataprotection 03](03-create-dataprotection03.png){.thumbnail}

Nommez le domaine de protection et cliquez sur `Create`{.action}.

![03 Create dataprotection 04](03-create-dataprotection04.png){.thumbnail}

Sélectionnez trois machines virtuelles et cliquez sur `Protect Selected Entities`{.action}.

![03 Create dataprotection 05](03-create-dataprotection05.png){.thumbnail}

Cliquez sur `Next`{.action}.

![03 Create dataprotection 06](03-create-dataprotection06.png){.thumbnail}

Cliquez sur `New Schedule`{.action} pour configurer la planification.

![03 Create dataprotection 07](03-create-dataprotection07.png){.thumbnail}
...
![03 Create dataprotection 08](03-create-dataprotection08.png){.thumbnail}
...
![03 Create dataprotection 09](03-create-dataprotection09.png){.thumbnail}

Le domaine de protection est créé et apparait dans la liste.

![03 Create dataprotection 10](03-create-dataprotection10.png){.thumbnail}
...
![04 Migrate VM to Canada 01](04-migrate-to-canada01.png){.thumbnail}

Sélectionnez le site distant, saisissez `MIGRATE` et cliquez sur `Migrate`{.action}.

![04 Migrate VM to Canada 02](04-migrate-to-canada02.png){.thumbnail}
...
![04 Migrate VM to Canada 03](04-migrate-to-canada03.png){.thumbnail}
...
![05 Active VM on remote site 01](05-activate-protection-domain01.png){.thumbnail}

Cliquez sur `Yes`{.action}. 

![05 Active VM on remote site 02](05-activate-protection-domain02.png){.thumbnail}
...
[Plan de reprise d'activité sur Nutanix](43-disaster-recovery-plan-overview1.)

[Connexion IPsec](44-ipsec-interconnection1.)
