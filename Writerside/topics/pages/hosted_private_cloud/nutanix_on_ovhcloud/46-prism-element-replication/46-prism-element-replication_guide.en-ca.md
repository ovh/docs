...
If you need help setting up an IPsec VPN, please refer to our guide on [interconnecting two Nutanix clusters through an IPsec VPN](44-ipsec-interconnection1.).

Connect via **Prism Element** to the cluster in France from **Prism Central**, as shown in this documentation: [Nutanix Hyperconvergence](03-nutanix-hci1.).
...
![03 Create data protection 03](03-create-dataprotection03.png){.thumbnail}
...
![03 Create data protection 10](03-create-dataprotection10.png){.thumbnail}
...
[Disaster Recovery Plan in Nutanix](43-disaster-recovery-plan-overview1.)

[IPsec interconnection between two sites](44-ipsec-interconnection1.)
