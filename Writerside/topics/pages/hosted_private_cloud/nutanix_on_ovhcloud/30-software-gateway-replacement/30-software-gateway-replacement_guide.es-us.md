...
![OVHGateway 01](01-stop-ovhgateway01.png){.thumbnail}

Click `VMs`{.action}.

![OVHGateway 02 stop](01-stop-ovhgateway02.png){.thumbnail}

Click on the `OVHgateway`{.action} virtual machine.

![OVHGateway 03](01-stop-ovhgateway03.png){.thumbnail}

From the `More`{.action} menu at the top, click `Soft Shutdown`{.action}.

![OVHGateway 04](01-stop-ovhgateway04.png){.thumbnail}
...
![pfsense Installation 03](03-install-pfsense03.png){.thumbnail}
...
![Configure pfsense 16](04-configureip-pfsense16.png){.thumbnail}
...
![Change Password 03](06-change-password04.png){.thumbnail}.
...
Use the [Isolating management machines from production](27-isolate-management-vm1.) guide to create a new VLAN on your Nutanix cluster with these settings:
...
![11 assign ip to new interface 01](11-assign-ip-to-new-interface01.png){.thumbnail}
