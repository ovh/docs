...
![AOS - Hypervisor](hypervisor01.png){.thumbnail}
...
![AOS - Hypervisor](hypervisor02.png){.thumbnail}
...
![Node Serial Number](serial02.png){.thumbnail}
...
![Nutanix Cluster Check](ncc01.png){.thumbnail}
...
![Nutanix Cluster Check](ncc04.png){.thumbnail}
...
> [!primary]
> Utilisez l'outil [Plik](https://plik.ovhcloud.com/#/) pour téléverser votre rapport et nous le transmettre sous la forme d'un lien de téléchargement. Retrouvez plus d'informations sur l'utilisation de l'outil Plik sur [ce guide](use-plik1.).
>
...
![Nutanix Cluster Check - SMTP](SMTP.png){.thumbnail}
...
![Nutanix Cluster Check - email](email.png){.thumbnail}
...
> [!primary]
>
> Pour plus de détails sur **Logbay** et **Putty**, reportez-vous à la section « [Aller plus loin](50-cluster-information_#gofurther.) » de ce guide.
...
> [!primary]
> Utilisez l'outil [Plik](https://plik.ovhcloud.com/#/) pour téléverser vos fichiers .zip et nous les transmettre sous la forme de liens de téléchargement. Retrouvez plus d'informations sur l'utilisation de l'outil Plik sur [ce guide](use-plik1.).
>
