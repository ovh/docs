...
![Add ssh PE on Load Balancer 01](01-add-pe-ssh-on-loadbalancer01.png){.thumbnail}
...
![Add ssh PE on Load Balancer 02](01-add-pe-ssh-on-loadbalancer02.png){.thumbnail}
...
![Add ssh PE on Load Balancer 03](01-add-pe-ssh-on-loadbalancer03.png){.thumbnail}

A l'intérieur de la ferme de serveurs, cliquez sur `Ajouter un serveur`{.action}.

![Add ssh PE on Load Balancer 04](01-add-pe-ssh-on-loadbalancer04.png){.thumbnail}
