...
![Prism element - Run NCC checks](nutanix-cluster-fw-update-03.png){.thumbnail}

Select `All checks`{.action} and click `Run`{.action}.

![Prism element - run checks](nutanix-cluster-fw-update-03b.png){.thumbnail}
...
![CVM connection](nutanix-cluster-fw-update-04.png){.thumbnail}
...
![Checking nodes state](nutanix-cluster-fw-update-06.png){.thumbnail}
...
![maintenance mode](nutanix-cluster-fw-update-07.png){.thumbnail}
...
![OVHcloud Control Panel - cluster access](nutanix-cluster-fw-update-11.png){.thumbnail}
...
![OVHcloud Control Panel - Boot](nutanix-cluster-fw-update-13.png){.thumbnail}
...
![OVHcloud Control Panel - Boot](nutanix-cluster-fw-update-14.png){.thumbnail}

Confirm your choice.

![OVHcloud Control Panel - Boot](nutanix-cluster-fw-update-15.png){.thumbnail}
...
![maintenance mode exit](nutanix-cluster-fw-update-07.png){.thumbnail}
...
![maintenance mode exit](nutanix-cluster-fw-update-16.png){.thumbnail}
