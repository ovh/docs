...
![image du diagramme](infra1.png){.thumbnail}
...
Cette machine n'a pour but que de vous permettre de télécharger vos premières sources (ISO windows, appliances, etc). Vous devrez remplacer cette machine virtuelle par un autre système d'exploitation. Consultez ce guide pour plus d'informations : [Remplacement de l'OVHgateway](30-software-gateway-replacement1.).
