...
- Connecting all sites via the same [vRack](https://www.ovh.com/ca/en/solutions/vrack/).

![Interconnection with vRack diagram](vrackinterconnection.png){.thumbnail}

- Setting up an IPsec VPN between the two Nutanix clusters.

![Interconnection with IPsec diagram](ipsecinterconnection.png){.thumbnail}

An example of an IPsec interconnection in this guide: [IPsec interconnection between two sites](44-ipsec-interconnection1.)
...
Details of these solutions can be found in our documentation on [asynchronous or NearSync replication through Prism Element](46-prism-element-replication1.)
