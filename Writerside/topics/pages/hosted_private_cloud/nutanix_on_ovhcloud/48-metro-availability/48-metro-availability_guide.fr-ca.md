...
- [hyperconvergence Nutanix](03-nutanix-hci1.) ;
- [outils avancés](09-advanced-tools1.).
...
Aidez-vous de ce guide pour interconnecter vos clusters : [Interconnexion de clusters au travers du vRack](45-vrack-interconnection1.). Pour connecter les trois clusters, utilisez les instructions fournies sur le guide dans ce sens :
...
Aidez-vous de ce guide pour créer des VLAN sur vos clusters Nutanix : [isoler les machines de gestion de la production](27-isolate-management-vm1.).
...
![15 - livemigration Roubaix to Gravelines 00](15-livemigration-roubaix-to-gravelines00.png){.thumbnail}

Revenez sur votre plan de reprise et cliquez sur `Failover`{.action} dans le menu `More`{.action}.

![15 - livemigration Roubaix to Gravelines 01](15-livemigration-roubaix-to-gravelines01.png){.thumbnail}
...
![15 - livemigration Roubaix to Gravelines 02](15-livemigration-roubaix-to-gravelines02.png){.thumbnail}

Saisissez `Failover` et cliquez sur `Failover`{.action}.

![15 - livemigration Roubaix to Gravelines 03](15-livemigration-roubaix-to-gravelines03.png){.thumbnail}

La migration à chaud est en cours.

![15 - livemigration Roubaix to Gravelines 04](15-livemigration-roubaix-to-gravelines04.png){.thumbnail}

La migration s'est terminée avec succès sans coupure de service.

![15 - livemigration Roubaix to Gravelines 05](15-livemigration-roubaix-to-gravelines05.png){.thumbnail}
...
![15 - livemigration Roubaix to Gravelines 06](15-livemigration-roubaix-to-gravelines06.png){.thumbnail}
...
[Interconnexion de clusters au travers du vRack](45-vrack-interconnection1.)
