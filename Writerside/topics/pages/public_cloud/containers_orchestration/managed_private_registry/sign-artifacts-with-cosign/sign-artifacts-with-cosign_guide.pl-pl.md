...
![Docker image in OVHcloud Managed Private Registry](image-stored.png)
...
![Docker image signed in OVHcloud Managed Private Registry](image-signed.png)

Clicking in the `>`{.action} icon displays the associated cosign signature information:

![Docker image cosign signature in OVHcloud Managed Private Registry](image-cosign-signature.png)
