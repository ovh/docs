...
![Clusters](images_clusters.png){.thumbnail}

Click on your Kubernetes cluster.

![Your Kubernetes cluster](images_cluster.png){.thumbnail}

Click on the `...` button in the `OIDC provider` section.

![Configure OIDC provider menu](configure-oidc-menu.png){.thumbnail}
...
![Log in to the API Explorer](images_kubernetes-quickstart-api-ovh-com-001.png){.thumbnail}
...
![Kubernetes section of the API Explorer](images_kubernetes-quickstart-api-ovh-com-002.png){.thumbnail}
...
![OVHcloud API rights](configuring-oidc-provider-config_images_api-rights.png){.thumbnail}
...
![Copy paste service name](configuring-oidc-provider-config_images_get-service-name.png){.thumbnail}
