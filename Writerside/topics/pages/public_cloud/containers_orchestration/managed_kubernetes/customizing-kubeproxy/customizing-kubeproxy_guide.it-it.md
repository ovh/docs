...
![Log in to the API Explorer](customizing-kubeproxy_images_kubernetes-quickstart-api-ovh-com-001.png){.thumbnail}
...
![Kubernetes section of the API Explorer](customizing-kubeproxy_images_kubernetes-quickstart-api-ovh-com-002.png){.thumbnail}
...
![OVHcloud API rights](customizing-kubeproxy_images_api-rights.png){.thumbnail}
...
![Copy paste service name](customizing-kubeproxy_images_get-service-name.png){.thumbnail}
