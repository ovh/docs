...
![Installing WordPress](installing-wordpress-01.png){.thumbnail}
...
![Installing WordPress](installing-wordpress-02.png){.thumbnail}

![Installing WordPress](installing-wordpress-03.png){.thumbnail}
...
Don't hesitate to go to our [Managed Kubernetes guides and tutorials](public-cloud-containers-orchestration-managed-kubernetes-k8s1.).
