...
In order to test your `nginx-ingress`, you can for example [install a WordPress](installing-wordpress1.) on your cluster, and then create a YAML file for the Ingress that uses the controller:
...
![WordPress using Ingress](installing-ingress-01.png){.thumbnail}
