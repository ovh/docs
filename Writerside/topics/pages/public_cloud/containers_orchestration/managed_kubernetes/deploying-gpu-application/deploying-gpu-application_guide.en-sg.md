...
![GPU Node Pool](gpu-node-pool.png){.thumbnail}
...
![Select your cluster](create-a-nodepool-1.png){.thumbnail}
...
![Name your GPU node pool](create-a-nodepool-2.png){.thumbnail}

Select a flavor for your new node pool, then click on the `GPU`{.action} tab. You can choose "T1-45" for example.

![Select a flavor for your GPU node pool](create-a-nodepool-3.png){.thumbnail}
...
![Define a size and autoscaling for your GPU node pool](create-a-nodepool-4.png){.thumbnail}

Then, choose `Hourly` billing mode for this GPU node pool.

![Billing mode](create-a-nodepool-5.png){.thumbnail}
...
![GPU nodes](create-a-nodepool-6.png){.thumbnail}
...
![NVIDIA GPU Kubernetes Operator](nvidia-gpu-operator.jpeg)
...
![GPU Nodes NVIDIA labels](gpu-nodes-labels.png)
