...
> [!warning]
>
> Usage of the [Public Cloud Load Balancer](https://www.ovhcloud.com/en-ca/public-cloud/load-balancer/) with Managed Kubernetes Service (MKS) is currently in Beta phase.
...
If you plan to expose your Load Balancer publicly, in order to attach a [FloatingIP](https://www.ovhcloud.com/en-ca/public-cloud/floating-ip/) to your Load Balancer, it is mandatory to have an [OVHcloud Gateway](https://www.ovhcloud.com/en-ca/public-cloud/gateway/) (an OpenStack router) deployed on the subnet hosting your Load Balancer.
...
Your existing LoadBalancer Service using [Loadbalancer for Kubernetes](https://www.ovhcloud.com/en-ca/public-cloud/load-balancer-kubernetes/) should have the following annotation:
