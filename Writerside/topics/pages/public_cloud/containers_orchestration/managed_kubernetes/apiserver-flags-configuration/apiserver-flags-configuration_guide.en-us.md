...
![Log in to the API Explorer](kubernetes-quickstart-api-ovh-com-001.png){.thumbnail}
...
![Kubernetes section of the API Explorer](kubernetes-quickstart-api-ovh-com-002.png){.thumbnail}
...
![OVHcloud API rights](apiserver-flags-configuration_images_api-rights.png){.thumbnail}
...
![Copy paste service name](apiserver-flags-configuration_images_get-service-name.png){.thumbnail}
