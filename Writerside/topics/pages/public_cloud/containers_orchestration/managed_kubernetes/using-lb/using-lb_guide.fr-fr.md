...
>
> A dedicated documentation for [Public Load Balancer](https://www.ovhcloud.com/fr/public-cloud/load-balancer/) will be published with the release of the Beta phase.
