...
![Hello world from Nginx](hello-world.png)
...
To go deeper on Kubernetes operators topic, follow others [Kubernetes tutorials](public-cloud-containers-orchestration-managed-kubernetes-k8s1.) in the `Operators` section.
