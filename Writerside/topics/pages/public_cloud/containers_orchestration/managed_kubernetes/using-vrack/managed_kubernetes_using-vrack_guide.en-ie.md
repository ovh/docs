...
First of all, you will need to set up vRack private network for your Public Cloud. To do it, please follow the [Configuring vRack for Public Cloud](getting-started-07-creating-vrack1.) guide. Once you have created a vRack and added it into a private network, you can continue. 
...
![Choose a private network for this cluster](using-vrack-01.png){.thumbnail}
...
![Private network information in Attached network column](using-vrack-02.png){.thumbnail}
...
- As explained in the [Known limits guide](known-limits2.), the following subnets are not compliant with the `vRack` feature and can generate some incoherent behaviours with our overlay networks:
