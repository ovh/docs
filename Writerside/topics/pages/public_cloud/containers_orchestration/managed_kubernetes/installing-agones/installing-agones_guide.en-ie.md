...
![Agones on OVHcloud Managed Kubernetes](agones-001-small.jpg){.thumbnail}
...
![Online gaming matchmaking and game server assignation](agones-002-small.jpg){.thumbnail}
...
![Online gaming matchmaking and game server assignation with Agones](agones-003-small.jpg){.thumbnail}
...
![Xonotic](agones-004.png){.thumbnail}

Then go to the <em>Multiplayer</em> menu and enter the address and port of our game server:

![Multiplayer menu](agones-005.png){.thumbnail}

And you are ready to play!

![Let's frag](agones-006.png){.thumnbnail}
