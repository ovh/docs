...
![Schema vrack gateway](schema_mksvrack.png)
...
- The [OpenStack API CLI](prepare_the_environment_for_using_the_openstack_api1.) installed.
- Be familiar with the [OVHcloud API](first-steps1.).
...
> Important: Assuming that your PCI project is added to your [vRack](getting-started-07-creating-vrack1.).
...
>> 
>> ![Attach a Vrack gateway to an OVHcloud Managed Kubernetes cluster](attach-vrack-gateway-to-kubernetes-cluster.png)
...
![Create a cluster](vrack-k8s-custom-gateway_images_clusters.png){.thumbnail}
...
![Create a cluster](created-cluster.png){.thumbnail}
...
To use this kubeconfig file and access to your cluster, you can follow our [configuring kubectl](configuring-kubectl-on-an-ovh-managed-kubernetes-cluster1.) tutorial, or simply add the `--kubeconfig` flag in your `kubectl` commands.
