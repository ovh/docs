...
![Knative components](knative-inside.png)
...
For more information about DNS on OVHcloud, please read our guide on [how to configure a DNS zone](dns_zone_edit1.).
...
![Knative Serving components](knative-serving.png)
