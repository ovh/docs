...
![OpenFaas logo](openfaas-logo.png){.thumbnail}
...
![OpenFaas architecture](openfaas-architecture.png){.thumbnail}
...
If you need a private registry, you can use our [OVHcloud Managed Private Registry](public-cloud-containers-orchestration-managed-private-registry1.). For this tutorial we are choosing to deploy our image on the official Docker registry.
...
![UI Portal](ui-portal-01.jpg){.thumbnail}
...
![UI Portal](ui-portal-02.jpg){.thumbnail}

![UI Portal](ui-portal-03.jpg){.thumbnail}
