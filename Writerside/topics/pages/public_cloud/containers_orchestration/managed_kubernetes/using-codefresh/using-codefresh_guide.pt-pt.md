...
![Codefresh](using-codefresh-01.jpg){.thumbnail}

This tutorial also presupposes that you already have a working OVHcloud Managed Kubernetes cluster, and some basic knowledge of how to operate it. If you want to know more on those topics, please look at the [OVHcloud Managed Kubernetes Service Quickstart](deploying-hello-world1.).
...
![Connect an OVH Kubernetes cluster to Codefresh dashboard](using-codefresh-02.jpg){.thumbnail}

![Connect an OVH Kubernetes cluster to Codefresh dashboard](using-codefresh-03.jpg){.thumbnail}
...
![Connect an OVH Kubernetes cluster to Codefresh dashboard](using-codefresh-04.jpg){.thumbnail}

![Connect an OVH Kubernetes cluster to Codefresh dashboard](using-codefresh-05.jpg){.thumbnail}
...
![Connect an OVH Kubernetes cluster to Codefresh dashboard](using-codefresh-07.jpg){.thumbnail}
...
![Connect an OVH Kubernetes cluster to Codefresh dashboard](using-codefresh-08.jpg){.thumbnail}
