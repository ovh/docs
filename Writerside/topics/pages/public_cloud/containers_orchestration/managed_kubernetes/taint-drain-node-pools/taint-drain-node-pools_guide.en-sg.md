...
![Select your cluster](taint-drain-node-pools_images_create-a-nodepool-1.png){.thumbnail}
...
![Name your second node pool](taint-drain-node-pools_images_create-a-nodepool-2.png){.thumbnail}

Select a flavor for your new node pool, we can choose "D2-8", a different flavor than our other node pool.

![Select a flavor for your second node pool](taint-drain-node-pools_images_create-a-nodepool-3.png){.thumbnail}
...
![Define a size and autoscaling for your second node pool](taint-drain-node-pools_images_create-a-nodepool-4.png){.thumbnail}

Choose `Hourly` billing mode for this second node pool.

![Billing mode](taint-drain-node-pools_images_create-a-nodepool-5.png){.thumbnail}
...
![Status Installing](taint-drain-node-pools_images_create-a-nodepool-6.png){.thumbnail}

![Status OK](images_create-a-nodepool-7.png){.thumbnail}
