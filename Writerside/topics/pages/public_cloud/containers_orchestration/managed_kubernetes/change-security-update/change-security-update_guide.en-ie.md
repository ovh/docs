...
![Access to the administration UI](upgrading-kubernetes-version-000.png){.thumbnail}

Click on the `...`{.action} button to the right of your Kubernetes cluster and choose `Manage cluster`{.action}.

![Click on the right end button and choose Manage cluster](upgrading-kubernetes-version-001.png){.thumbnail}

On the *Management* section, click on `Change security policy`{.action}.

![Click on Change the security policy](change-security-update-002.png){.thumbnail}
...
![Click on Confirm](change-security-update-004.png){.thumbnail}
...
![OVHcloud API rights](change-security-update_images_api-rights.png){.thumbnail}
...
![Copy paste service name](change-security-update_images_get-service-name.png){.thumbnail}
