...
![Cert Manager](cert-manager-logo.png)

It will ensure certificates are valid and up to date periodically, and attempt to renew certificates at an appropriate time before expiry.

![Cert Manager architecture](cert-manager-archi.png)
...
Please refer to our tutorial on [How to secure a Nginx Ingress with cert-manager on OVHcloud Managed Kubernetes](securing-nginx-ingress-cert-manager1.) for ingresses configuration.
