...
> [!warning]
> You can now [create and use a custom gateway on an OVHcloud Managed Kubernetes cluster](vrack-k8s-custom-gateway1.) but if you don't want to, the content of this guide is still relevant.

In this document we suppose that you have some understanding of how to use OVHcloud Managed Kubernetes in the vRack. To get more information on this topic you can look at the [Using vRack Private Network](using-vrack2.) guide and [Working with vRack example - Managed Kubernetes and Public Cloud instances](vrack-example-k8s-and-pci1.) tutorial.
...
![OVHcloud Managed Kubernetes without vRack](using-vrack-01.jpg){.thumbnail}
...
![OVHcloud Managed Kubernetes without vRack](using-vrack-02.jpg){.thumbnail}
...
![OVHcloud Managed Kubernetes inside vRack](using-vrack-03.jpg){.thumbnail}
...
![OVHcloud Managed Kubernetes inside vRack](using-vrack-04.jpg){.thumbnail}

For this use case, no additional configuration is needed, you simply have to choose the private network at the creation of your Managed Kubernetes cluster, as explained in the [Using vRack Private Network](using-vrack2.) guide and [Working with vRack example - Managed Kubernetes and Public Cloud instances](vrack-example-k8s-and-pci1.) tutorial.
...
![Communication between different private networks](using-vrack-05.jpg){.thumbnail}
...
![Communication between different private networks](using-vrack-06.jpg){.thumbnail}
...
![Communication between different private networks](using-vrack-07.jpg){.thumbnail}
...
![Communication between different private networks](using-vrack-08.jpg){.thumbnail}
