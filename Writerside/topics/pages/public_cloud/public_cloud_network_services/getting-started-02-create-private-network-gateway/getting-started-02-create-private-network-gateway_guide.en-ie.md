...
This can be created via the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie), the [OpenStack API](prepare_the_environment_for_using_the_openstack_api1.) or the [OVHcloud API](https://eu.api.ovh.com/).
