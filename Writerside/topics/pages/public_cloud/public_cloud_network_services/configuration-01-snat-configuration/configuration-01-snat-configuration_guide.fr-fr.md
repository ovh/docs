...
- Une [Floating IP des services L3](getting-started-03-attach-floating-ip-to-instance1.)
...
Ce scénario est couvert par le guide « [Attacher une adresse Floating IP à une instance Public Cloud](getting-started-03-attach-floating-ip-to-instance1.) ».

#### Architecture de configuration

![schema](architecture.png){.thumbnail}
...
Créez une VM avec une Floating IP comme expliqué dans ce [guide](getting-started-03-attach-floating-ip-to-instance1.).
