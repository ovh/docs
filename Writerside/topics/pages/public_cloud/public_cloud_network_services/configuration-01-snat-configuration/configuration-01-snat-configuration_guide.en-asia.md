...
- A [Public Cloud Floating IP](getting-started-03-attach-floating-ip-to-instance1.)
...
This scenario is covered by the guide [Attaching a Floating IP to an instance](getting-started-03-attach-floating-ip-to-instance1.).

#### Target configuration architecture

![diagram](architecture.png){.thumbnail}
...
Create a VM with a Floating IP as explained in [this guide](getting-started-03-attach-floating-ip-to-instance1.).
