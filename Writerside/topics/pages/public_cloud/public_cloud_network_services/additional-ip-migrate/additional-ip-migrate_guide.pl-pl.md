...
![migracja IP](migrateip_01.png){.thumbnail}

Kliknij rozwijane menu, aby wybrać docelową instancję z listy.

![migracja IP](migrateip_02.png){.thumbnail}
...
![migracja IP](migrateip_03.png){.thumbnail}
...
[Importowanie adresu Additional IP](additional-ip-import1.)
