...
Accedi alla tua istanza via SSH Per maggiori informazioni, consulta la guida [Connettersi a un'istanza Public Cloud](public-cloud-first-steps#connect-to-instance.).

Passare all'utente root. Se hai bisogno di aiuto, consulta la guida per [passare da root e impostare una password](become_root_and_change_password1.).
...
Accedi all'istanza tramite una sessione desktop remoto o con la console VNC. Per maggiori informazioni, consulta la guida [Connettersi a un'istanza Public Cloud](public-cloud-first-steps#connect-to-instance.).

Apri le `Impostazioni di rete`{.action}.

![modifica i server DNS](changednsservers1.png){.thumbnail}

Accedi alla configurazione IPv4 della tua scheda di rete pubblica tramite il pannello di configurazione.

![modifica i server DNS](changednsservers2.png){.thumbnail}

Aggiungi i server che vuoi utilizzare nelle `Impostazioni avanzate`{.action}.

![modifica i server DNS](changednsservers3.png){.thumbnail}
...
[Creare una prima istanza Public Cloud e connettersi](public-cloud-first-steps1.)

[Accedere come utente root e impostare una password](become_root_and_change_password1.)

[Modificare l’hostname di un’istanza Public Cloud](changing_the_hostname_of_an_instance1.)
