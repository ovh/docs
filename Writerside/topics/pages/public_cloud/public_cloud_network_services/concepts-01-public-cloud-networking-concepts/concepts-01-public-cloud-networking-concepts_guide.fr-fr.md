...
Pour en savoir plus, consultez notre guide [Load Balancer](getting-started-01-create-lb-service1.) .
...
Apprenez-en plus sur les Additional IP et Floating IP sur la [page concept dédiée](concepts-02-additional-ip-vs-floating-ip1.).
