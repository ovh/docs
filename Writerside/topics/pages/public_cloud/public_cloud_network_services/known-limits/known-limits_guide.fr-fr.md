...
- dans [Horizon](introducing_horizon1.) ;
- via le [CLI OpenStack](prepare_the_environment_for_using_the_openstack_api1.)) en effectuant `openstack floating ip list` et `openstack loadbalancer list` ;
