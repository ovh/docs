...
- Sie haben mindestens eine [Public Cloud Instanz](public-cloud-first-steps1.) in Ihrem Kunden-Account.
...
![IP hinzufügen](buyaddIP_04.png){.thumbnail}

Der Bestellschein wird automatisch geöffnet, damit Sie Ihre Bestellung abschließen können.

Weitere Informationen finden Sie in unserer [Anleitung zur Verwaltung von Bestellungen](managing_ovh_orders1.).
