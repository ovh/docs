...
- A [Public Cloud instance](public-cloud-first-steps1.) in your Public Cloud project
...
![Adding IP](buyaddIP_04.png){.thumbnail}

The purchase order will open automatically for you to complete your purchase.

See our guide on [managing OVHcloud orders](managing_ovh_orders1.) for more details.
...
The next step will be the IP configuration in your OS; please refer to our [guide](getting-started-04-configure-additional-ip-to-instance1.).
