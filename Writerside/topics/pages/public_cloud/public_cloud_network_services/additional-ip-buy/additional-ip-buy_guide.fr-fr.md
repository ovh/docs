...
- Disposer d'au moins une instance. Consultez à cet effet [le guide pour créer une instance depuis l'espace client](public-cloud-first-steps1.).
...
![Ajout IP](buyaddIP_04.png){.thumbnail}

Le bon de commande s'ouvrira automatiquement afin de finaliser votre achat.

Consultez notre guide sur la [gestion des commandes OVHcloud](managing_ovh_orders1.) pour plus de détails.
...
La prochaine étape consiste à configurer l’IP dans votre système d'exploitation. Consultez [notre guide dédié à cette configuration](getting-started-04-configure-additional-ip-to-instance1.).

## Aller plus loin

[Configurer une Additional IP](getting-started-04-configure-additional-ip-to-instance1.)
