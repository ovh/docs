...
- Utiliser l'environnement de commande d'Openstack ([Tutoriel](prepare_the_environment_for_using_the_openstack_api1.))
...
Si vous n'êtes pas encore familier avec la création du Load Balancer, veuillez consulter notre guide « [Premiers pas avec le service Load Balancer Public Cloud](getting-started-01-create-lb-service1.) » avant de poursuivre la lecture de ce guide.

## En pratique

### Créer une instance pour Let's Encrypt

Vous pouvez créer une instance dans votre projet dans la région où votre Load Balancer se situe. Pour plus de détails à ce sujet, consultez notre [guide](public-cloud-first-steps1.). Nous vous recommandons d'utiliser Ubuntu comme système d'exploitation. Le format d2-2 sera suffisant pour cette opération.
...
Si vos serveurs DNS sont gérés par OVHcloud, consultez [ce guide](dns_zone_edit1.).
...
[Premiers pas avec le service Load Balancer pour Public Cloud](getting-started-01-create-lb-service1.)
