...
- Posséder un [projet Public Cloud](create_a_public_cloud_project1.)
- Être connecté à votre [espace client OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr){.external}
- Avoir [créé un utilisateur OpenStack](create_and_delete_a_user1.) (facultatif)
...
Consultez le guide [Accéder à l'interface Horizon](introducing_horizon1.) pour vous familiariser à Horizon.
...
Pour cela, vous devez choisir le bon fournisseur et la bonne ressource Terraform. Retrouvez plus d’informations dans notre [guide d’utilisation de Terraform](terraform-at-ovhcloud1.).
...
![sélection project](vrack2021-05.png){.thumbnail}
...
Pour activer et gérer un vRack depuis les APIv6 OVHcloud, cliquez [ici](getting-started-08-creating-vrack-with-api#etape-1-activer-et-gerer-un-vrack.) pour consulter le guide spécifique à cette méthode.
...
>
> Pour plus d'informations sur la gestion des VLAN du vRack des serveurs dédiés, vous pouvez consulter ce guide : [Créer plusieurs VLAN dans le vRack](creating-multiple-vlans-in-a-vrack1.).
...
Sélectionnez cette option si vous avez l'intention de créer des instances avec un réseau privé uniquement. Pour plus d’informations, nous vous invitons à consulter les guides suivants : [Créer un réseau privé avec une Gateway](getting-started-02-create-private-network-gateway1.) et [Créer une première instance Public Cloud et s’y connecter](public-cloud-first-steps#etape-3-creer-une-instance.).
...
Dans le cas où vous devez faire communiquer des serveurs dédiés OVHcloud avec du VLAN taggué, consultez le guide suivant : [Créer plusieurs VLAN dans le vRack](creating-multiple-vlans-in-a-vrack1.).
...
Pour créer un réseau privé depuis les APIv6 OVHcloud, cliquez [ici](getting-started-08-creating-vrack-with-api#etape-3-creer-un-vlan-dans-le-vrack.) pour consulter le guide spécifique à cette méthode.
...
Consultez le guide [Créer une instance depuis l’espace client](public-cloud-first-steps#create-instance.). Lors de la création d'une instance, vous pouvez choisir, à l'étape 5, un mode réseau, puis un réseau privé dans lequel intégrer votre instance.
...
Cliquez [ici](getting-started-08-creating-vrack-with-api#etape-4-integrer-une-instance-dans-le-vrack.) pour consulter le guide spécifique à cette méthode.
...
Pensez également à noter les informations suivantes, comme indiqueé dans le [guide d'utilisation de l'API Nova](starting_with_nova1.) :
...
![attacher réseau](vrack2021-01.png){.thumbnail}
...
![attacher réseau](vrack9.png){.thumbnail}

##### **Gestion des interfaces réseaux depuis les APIv6 OVHcloud**

Cliquez [ici](getting-started-08-creating-vrack-with-api#cas-dune-instance-deja-existante.) pour consulter le guide spécifique à cette méthode.
...
[Configuration du vRack Public Cloud depuis les APIv6 OVHcloud](getting-started-08-creating-vrack-with-api1.)

[Serveurs Dédiés - Créer plusieurs VLAN dans le vRack](creating-multiple-vlans-in-a-vrack1.)
