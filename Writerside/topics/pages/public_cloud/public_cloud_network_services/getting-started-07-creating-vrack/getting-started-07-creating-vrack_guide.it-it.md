...
La [vRack](https://www.ovh.it/soluzioni/vrack/) è una rete privata che permette di configurare l'indirizzamento tra diversi server dedicati OVHcloud. Permette anche di aggiungere [istanze Public Cloud](public-cloud-first-steps1.) alla tua rete privata per creare un'infrastruttura di risorse fisiche e virtuali.

**Questa guida ti mostra come configurare le istanze Public Cloud all'interno della tua vRack.**

## Prerequisiti

- Disporre di un [progetto Public Cloud](create_a_public_cloud_project1.)
- Avere accesso allo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it)
- Aver [creato un utente OpenStack](create_and_delete_a_user#crea-un-utente-openstack.) (facoltativo)
...
Consulta la guida [Creare un utente per accedere a Horizon](introducing_horizon1.) per familiarizzare con Horizon.
...
Consulta la guida [Primi passi con le API OVHcloud](first-steps1.), per familiarizzare con l'utilizzo delle APIv6 OVHcloud.
...
Per farlo, devi scegliere il provider giusto e la risorsa Terraform giusta. Per maggiori informazioni, consulta la nostra [guida all'utilizzo di Terraform (EN)](terraform-at-ovhcloud1.).
...
![selezione project](vrack2021-05.png){.thumbnail}
...
![vRack creation](vrack3.png){.thumbnail}
...
Per attivare e gestire una vRack, clicca [qui](getting-started-08-creating-vrack-with-api#step-1-activating-and-managing-a-vrack.) (EN), per consultare la guida specifica a questo metodo.
...
>
> Per maggiori informazioni sulla gestione delle VLAN della vRack dei server dedicati, consulta questa guida: [Creare due o più VLAN nella vRack](creating-multiple-vlans-in-a-vrack1.).
...
![VLAN creation](vrack2022-03.png){.thumbnail}
...
Seleziona questa opzione se intendi creare istanze esclusivamente con rete privata. Per maggiori informazioni, consulta queste guide: [Creating a private network with Gateway (EN)](getting-started-02-create-private-network-gateway1.) e [Creare e connettersi a un’istanza Public Cloud](public-cloud-first-steps#step-3-crea-unistanza.).
...
Se hai bisogno di far comunicare i server dedicati OVHcloud con VLAN tag, consulta questa guida: [Creare due o più VLAN nella vRack](creating-multiple-vlans-in-a-vrack1.).
...
Per creare una VLAN dalle APIv6 OVHcloud, clicca [qui](getting-started-08-creating-vrack-with-api#step-3-creating-a-vlan-in-the-vrack.) (EN), per consultare la guida specifica a questo metodo.
...
Consulta la guida [Creare un'istanza dallo Spazio Cliente](public-cloud-first-steps#create-instance.). Durante la creazione di un'istanza, potrai specificare, nello step 5 puoi scegliere una modalità di rete e una rete privata nella quale integrare la tua istanza.
...
Clicca [qui](getting-started-08-creating-vrack-with-api#step-4-integrating-an-instance-into-the-vrack.) (EN), per consultare la guida specifica a questo metodo.
...
Ricorda anche queste informazioni, come indicato nella [guida all'utilizzo dell'API Nova](starting_with_nova1.):
...
![connessione Horizon](images_horizon1.png){.thumbnail}

Clicca su `Compute` e poi su `Instances`:

![Horizon compute istanze](images_horizon2.png){.thumbnail}
...
![Horizon attach interfaccia](images_horizon3.png){.thumbnail}

Seleziona la tua interfaccia e conferma:

![Horizon attach interfaccia](horizon4.png){.thumbnail}
...
![Horizon detach interface](horizon6.png){.thumbnail}
...
[Configurazione della vRack Public Cloud da APIv6 OVHcloud](getting-started-08-creating-vrack-with-api1.) (EN)

[Server dedicati - Creare due o più VLAN nella vRack](creating-multiple-vlans-in-a-vrack1.)
