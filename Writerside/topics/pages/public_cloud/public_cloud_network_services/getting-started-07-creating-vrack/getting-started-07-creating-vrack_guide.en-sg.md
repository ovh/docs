...
The [vRack](https://www.ovh.com/sg/solutions/vrack/) is a private network solution that enables our customers to route traffic between OVHcloud dedicated servers as well as other OVHcloud services. At the same time, it allows you to add [Public Cloud instances](https://www.ovhcloud.com/en-sg/public-cloud/) to your private network to create an infrastructure of physical and virtual resources.
...
- An [OpenStack user](create_and_delete_a_user1.) (optional)
...
The [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg) is a fully visual interface, ideally suited for managing only one VLAN. You will not be able to customise the private IP range, which will be in 10.x.x.x/16.
...
Please refer to [this guide](introducing_horizon1.) to familiarise yourself with Horizon.
...
Please refer to [this guide](first-steps1.) to get started with the OVHcloud APIv6.
...
For that you need to cherry-pick the correct terraform provider & resource. Find more information in our guide on [using Terraform with OVHcloud](terraform-at-ovhcloud1.).
...
To activate and manage a vRack using the OVHcloud APIv6, please refer to [this section](getting-started-08-creating-vrack-with-api#step-1-activating-and-managing-a-vrack.) of the corresponding guide.
...
>
> To learn more about this topic, please refer to the guide [Creating multiple vLANs in a vRack](creating-multiple-vlans-in-a-vrack1.)
...
Select this option if you intend to create instances with a private network only. For more information, please consult the following guides: [Creating a private network with Gateway](getting-started-02-create-private-network-gateway1.) and [Creating and connecting to your first Public Cloud instance](public-cloud-first-steps#step-3-creating-an-instance.).

> [!warning]
> If the option is greyed out, it means the region selected does not support it. For more information, please refer to our [regions availability](https://www.ovhcloud.com/en-sg/public-cloud/regions-availability/) page. 
> 
...
In case you need to be able to communicate with dedicated servers in this VLAN, please consult the guide [Creating multiple vLANs in a vRack](creating-multiple-vlans-in-a-vrack1.).
...
To create a private network using the OVHcloud APIv6, please refer to [this section](getting-started-08-creating-vrack-with-api#step-3-creating-a-vlan-in-the-vrack.) of the corresponding guide.
...
Please refer to [this section](getting-started-08-creating-vrack-with-api#step-4-integrating-an-instance-into-the-vrack.) of the corresponding guide.
...
Also, note the information explicated in [this guide](starting_with_nova1.):
...
![attach network](vrack2021-01.png){.thumbnail}

In the popup window that appears, select the private network(s) to attach to your instance and click `Attach`{.action}.

![attach network](vrack9.png){.thumbnail}

##### **Managing network interfaces with the OVHcloud APIv6**

Please refer to [this section](getting-started-08-creating-vrack-with-api#in-case-of-an-existing-instance.) of the corresponding guide.
...
![Horizon compute instances](images_horizon2.png){.thumbnail}
...
[Configuring vRack for Public Cloud using OVHcloud APIv6](getting-started-08-creating-vrack-with-api1.)

[Creating multiple vLANs in a vRack](creating-multiple-vlans-in-a-vrack1.)
