...
Consulte la guía [Conectarse a Horizon](introducing_horizon1.) para familiarizarse con Horizon.
...
Consulte la guía [Primeros pasos con las API de OVHcloud](first-steps1.), para familiarizarse con el uso de las APIv6 de OVHcloud.
...
Para ello, elija el proveedor y el recurso de Terraform adecuados. Para más información, consulte nuestra [guía de uso de Terraform (EN)](terraform-at-ovhcloud1.).
...
![selección del proyecto](vrack2021-05.png){.thumbnail}
...
Para activar y gestionar un vRack desde la APIv6 de OVHcloud, haga clic [aquí](getting-started-08-creating-vrack-with-api#step-1-activating-and-managing-a-vrack.) (EN), para consultar la guía específica sobre este método.
...
>
> Para más información sobre la gestión de las VLAN del vRack de los servidores dedicados, consulte la siguiente guía: [Crear varias VLAN en el vRack](creating-multiple-vlans-in-a-vrack1.).
...
![Creación de la VLAN](vrack2022-03.png){.thumbnail}
...
Seleccione esta opción si quiere crear instancias únicamente con una red privada. Para más información, consulte las siguientes guías: [Creating a private network with Gateway (EN)](getting-started-02-create-private-network-gateway1.) y [Crear y conectarse a una instancia de Public Cloud](public-cloud-first-steps#3-crear-una-instancia.).
...
Si desea que los servidores dedicados de OVHcloud se comuniquen con una VLAN « etiquetada », consulte la siguiente guía: [Crear varias VLAN en el vRack](creating-multiple-vlans-in-a-vrack1.).
...
Para crear una red privada desde las APIv6 de OVHcloud, haga clic [aquí](getting-started-08-creating-vrack-with-api#step-3-creating-a-vlan-in-the-vrack.) (EN), para consultar la guía específica.
...
Consulte la guía [Crear una instancia desde el área de cliente](public-cloud-first-steps#create-instance.). Al crear una instancia, podrá especificar, en el paso 5, un modo de red y, a continuación, una red privada en la que integrar su instancia.
...
Haga clic [aquí](getting-started-08-creating-vrack-with-api#step-4-integrating-an-instance-into-the-vrack.) (EN), para consultar la guía específica sobre este método.
...
Recuerde también lo siguiente, tal y como se indica en la [guía de uso de la API Nova](starting_with_nova1.) (EN):
...
![conexión de red](vrack2021-01.png){.thumbnail}

En la nueva ventana, seleccione la red o redes privadas que quiera asociar a la instancia y haga clic en `Asociar`{.action}.

![conexión de red](vrack9.png){.thumbnail}

##### **Gestión de las interfaces de red desde las APIv6 de OVHcloud**

Haga clic [aquí](getting-started-08-creating-vrack-with-api#in-case-of-an-existing-instance.) (EN), para consultar la guía específica sobre este método.
...
![connexion Horizon](images_horizon1.png){.thumbnail}
...
[Configuración del vRack Public Cloud desde las APIv6 de OVHcloud](getting-started-08-creating-vrack-with-api1.) (EN)

[Servidores dedicados - Crear varias VLAN en el vRack](creating-multiple-vlans-in-a-vrack1.)
