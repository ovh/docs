...
- Consulting the guide [Configuring the vRack on Public Cloud](getting-started-07-creating-vrack1.) (to understand the different methods to manage the vRack with the Public Cloud)
...
Log in to the OVHcloud APIv6 interface according to the relevant guide ([First steps with the OVHcloud API](first-steps1.)) and follow these steps:
