...
- [Avoir créer un utilisateur OpenStack](introducing_horizon#creer-un-compte-utilisateur-openstack.).
- [Avoir créer un utilisateur OpenStack](create_and_delete_a_user1.).
- Connaissances réseaux élémentaires.
- Consulter le guide [Configuration du vRack Public Cloud](getting-started-07-creating-vrack1.) pour connaître les différentes méthodes proposées pour gérer le vRack Public Cloud OVHcloud.
...
[Configuration du vRack Public Cloud](getting-started-07-creating-vrack1.)
