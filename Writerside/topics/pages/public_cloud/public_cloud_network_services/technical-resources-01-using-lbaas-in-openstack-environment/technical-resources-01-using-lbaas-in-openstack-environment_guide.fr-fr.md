...
- Avoir un [réseau privé](getting-started-07-creating-vrack1.) configuré dans votre projet
- [Préparer l’environnement pour utiliser l’API OpenStack](prepare_the_environment_for_using_the_openstack_api1.) en installant python-swiftclient.
...
Vous pouvez en savoir plus sur notre page [Concepts](concepts-02-additional-ip-vs-floating-ip1.).
...
![diagram](topology.png){.thumbnail}
