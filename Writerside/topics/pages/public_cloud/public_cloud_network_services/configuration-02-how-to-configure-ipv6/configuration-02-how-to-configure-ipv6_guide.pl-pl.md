...
> [!primary]
> 
> Aktualnie usługi Floating IP i Gateway nie obsługują IPv6. IPv6 można używać tylko z instancjami w [trybie publicznym](concepts-01-public-cloud-networking-concepts#publicmode1.).
>
...
Najpierw należy [przełączyć instancję na tryb awaryjny rescue-pro](put_an_instance_in_rescue_mode1.).
