...
> [!primary]
> 
> Actuellement, les offres Floating IP et Gateway ne prennent pas en charge l'IPv6. L'IPv6 n'est utilisable qu'avec les instances en [mode public](concepts-01-public-cloud-networking-concepts#publicmode1.).
>
...
Dans un premier temps, [passez votre instance dans le mode de secours rescue-pro](put_an_instance_in_rescue_mode1.).
