...
> [!primary]
> 
> Floating IP and Gateway currently do not support IPv6. You can only use IPv6 with instances in [Public Mode](concepts-01-public-cloud-networking-concepts#publicmode1.).
>
...
Firstly, [put your instance into rescue-pro mode](put_an_instance_in_rescue_mode1.).
