...
> [!primary]
> 
> Al momento, le offerte Floating IP e Gateway non supportano l'IPv6. L'IPv6 è utilizzabile solo con le istanze in [modalità pubblica](concepts-01-public-cloud-networking-concepts#publicmode1.).
>
...
In un primo momento [riavvia la tua istanza in modalità di ripristino Rescue-pro](put_an_instance_in_rescue_mode1.).
