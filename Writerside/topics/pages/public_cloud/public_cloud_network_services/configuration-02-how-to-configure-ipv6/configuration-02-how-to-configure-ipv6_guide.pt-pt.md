...
> [!primary]
> 
> Atualmente, as ofertas Floating IP e Gateway não tomam a cargo o IPv6. O IPv6 só pode ser utilizado com as instâncias em [modo público](concepts-01-public-cloud-networking-concepts#publicmode1.).
>
...
Primeiro, [passe a sua instância para o modo Rescue](put_an_instance_in_rescue_mode1.).
