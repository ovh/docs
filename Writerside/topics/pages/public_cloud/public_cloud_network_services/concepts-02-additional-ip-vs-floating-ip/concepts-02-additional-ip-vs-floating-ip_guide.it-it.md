...
More information about configuring Additional IP addresses is available in [this guide](getting-started-04-configure-additional-ip-to-instance1.).
...
More information about configuring Floating IP is available on the [Public Cloud Networking Concepts page](concepts-01-public-cloud-networking-concepts1.).
