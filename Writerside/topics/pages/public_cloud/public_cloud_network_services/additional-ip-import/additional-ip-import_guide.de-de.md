...
![Import Additional IP](import22_01.png){.thumbnail}
...
![Import Additional IP](import22_03.png){.thumbnail}
...
Im nächsten Schritt muss die IP-Adresse in Ihrem Betriebssystem konfiguriert werden. Lesen Sie dazu unsere [Anleitung zur IP-Konfiguration](getting-started-04-configure-additional-ip-to-instance1.).
