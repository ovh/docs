...
- An [Additional IP address](https://www.ovhcloud.com/en-au/bare-metal/ip/){.external}
...
![IP Section](import22_01.png){.thumbnail}
...
![Import Additional IP](import22_02.png){.thumbnail}

Confirm by clicking on `Import`{.action}.

![Import confirm](import22_03.png){.thumbnail}
