...
![Sezione IP](import22_01.png){.thumbnail}
...
![Importazione Additional IP](import22_02.png){.thumbnail}

Clicca su `Importa`{.action}.

![Importazione conferm](import22_03.png){.thumbnail}
...
![Importazione Additional IP](import22_04.png){.thumbnail}

Per scegliere l'istanza a cui associare il tuo indirizzo IP, visualizzi una finestra contestuale.

![Importazione Additional IP](import22_05.png){.thumbnail}
