...
![sprawdź główną konfigurację IP](image1-1.png){.thumbnail}
...
![zmień konfigurację IP](image2.png){.thumbnail}
...
![sekcja konfiguracji zaawansowanej](image4-4.png){.thumbnail}

Potwierdź klikając `Dodaj`{.action}.

![Konfiguracja migracji IP](image5-5.png){.thumbnail}
...
![sprawdź aktualną konfigurację sieci](image8-8.png){.thumbnail}
...
![dostęp do zarządzania adresami IP](getting-started-04-configure-additional-ip-to-instance_images_pleskip1.png){.thumbnail}
...
[Importuj Additional IP](additional-ip-import1.)

[Przenieś Additional IP](additional-ip-migrate1.)
