...
![verificar a configuração IP principal](image1-1.png){.thumbnail}
...
![alterar a configuração IP](image2.png){.thumbnail}
...
![secção de configuração avançada](image4-4.png){.thumbnail}

Confirme ao clicar em `Adicionar`{.action}.

![Configuração da migração IP](image5-5.png){.thumbnail}
...
![desativação da rede](image6.png){.thumbnail}

Para a reiniciar, clique com o botão direito e selecione a opção `Ativar`{.action}.

![ativação da rede](image7.png){.thumbnail}
...
![verificar a configuração de rede atual](image8-8.png){.thumbnail}
...
![acesso à gestão dos endereços IP](getting-started-04-configure-additional-ip-to-instance_images_pleskip1.png){.thumbnail}
...
![adicionar informações IP](pleskip2-2.png){.thumbnail}
...
![adicionar informações IP](pleskip3-3.png){.thumbnail}
...
[Migrar um Additional IP](additional-ip-migrate1.)
