...
![IP-Konfiguration überprüfen](image1-1.png){.thumbnail}
...
![IP-Konfiguration ändern](image2.png){.thumbnail}
...
![Konfiguration](image4-4.png){.thumbnail}

Bestätigen Sie, indem Sie auf `Hinzufügen`{.action} klicken.

![Konfiguration Additional IP](image5-5.png){.thumbnail}
...
![Aktuelle Netzwerkkonfiguration überprüfen](image8-8.png){.thumbnail}
...
![Zugang zur Verwaltung der IP-Adressen](getting-started-04-configure-additional-ip-to-instance_images_pleskip1.png){.thumbnail}
...
![IP-Informationen hinzufügen](pleskip2-2.png){.thumbnail}
...
![IP-Informationen hinzufügen](pleskip3-3.png){.thumbnail}
...
![aktuelle IP-Konfiguration](pleskip4-4.png){.thumbnail}

### Diagnose

Starten Sie zunächst Ihre Instanz neu, über das Betriebssystem oder im [OVHcloud Kundencenter](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de). Wenn Sie dann immer noch keine Verbindung zwischen dem öffentlichen Netzwerk und Ihrer Additional IP-Adresse herstellen können und ein Netzwerkproblem vermuten, ist es notwendig, die Instanz im [Rescue-Modus neu zu starten](put_an_instance_in_rescue_mode1.). Anschließend können Sie die Additional IP direkt auf der Instanz konfigurieren.
...
[Umzug einer Additional IP](additional-ip-migrate1.)
