...
- First configuration for Prefect and OVHcloud. See our [Getting started guide](prefect_guide_01_getting_started1.) for more information
- An email address
...
![image](email_block.png){.thumbnail}
...
The first step to complete is the trigger. In this example, we will send an email when the flow previously created in our [Getting Started guide](prefect_guide_01_getting_started1.) is completed. You can fill in the page as follows:

![image](trigger.png){.thumbnail}
...
![image](result_email.png){.thumbnail}
...
- Run your first job with Prefect and the OVHcloud API: [Create your first AI pipeline with prefect](prefect_tuto_03_ai_pipeline1.)
