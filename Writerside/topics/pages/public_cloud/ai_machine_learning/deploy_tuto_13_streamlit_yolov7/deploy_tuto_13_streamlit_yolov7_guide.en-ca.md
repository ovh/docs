...
For more information on how to train YOLOv7 on a custom dataset, refer to the following [documentation](notebook_tuto_11_yolov71.).

Here is an overview of the Sign Language recognition app:

![Overview](overview-streamlit-yolov7-asl.png){.thumbnail}
...
> [!warning]
> **Warning**
> You must have previously created an `asl-volov7-model` Object Storage container when training your model via [AI Notebooks](notebook_tuto_11_yolov71.).
>
...
- You can imagine deploying an app using YOLO models with another Python framework: **Flask**. Refer to this [tutorial](deploy_tuto_04_flask_yolov51.).
- Feel free to use **Streamlit** for other AI tasks! Deploy a Speech-to-Text app [here](deploy_tuto_09_streamlit_speech_to_text_app1.).
