...
![image](images_overview-notebook.png){.thumbnail}
...
![image](notebook_tuto_11_yolov7_images_new-object-container.png){.thumbnail}
...
If you want to launch it from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc), just follow this [guide](notebook_guide_introduction_definition1.).
...
- Do you want to use your YOLOv7 model in an app? [Here it is](deploy_tuto_13_streamlit_yolov71.).
