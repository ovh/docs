...
![image](ai_deploy_concept.png){.thumbnail}
...
You can find a basic example in the section below, and more advanced tutorials in our [AI Deploy documentation](public-cloud-ai-and-machine-learning1.).
...
![image](shared_registry_details.png){.thumbnail}
