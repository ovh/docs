...
![image](overview_interface_tensorboard.png){.thumbnail}
...
If you want to launch it with the [CLI](cli_11_howto_run_notebook_cli1.), just choose the name of your notebook (`<notebook-name>`) and the number of GPUs (`<nb-gpus>`) your want and use the following command:
...
![image](image_overview_jupyter_notebook_tensorboard.png){.thumbnail}
...
- Another way to track your training with an AI notebook is to use **Weights & Biases**. Follow this [tutorial](notebook_tuto_03_weight_biases1.).
- If you want to launch **TensorBoard** in a job, please refer to this [documentation](training_tuto_05_tensorboard1.).
