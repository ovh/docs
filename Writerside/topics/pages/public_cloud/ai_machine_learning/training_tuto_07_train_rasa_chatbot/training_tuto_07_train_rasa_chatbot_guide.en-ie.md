...
Deployment will be performed in the second part of the tutorial which you can find here: [How to deploy a chatbot](deploy_tuto_11_rasa_chatbot_flask1.).
If you want to access the code, you can find it [here](https://github.com/ovh/ai-training-examples/jobs/rasa-chatbot).
If you want to create a Rasa chatbot with a notebook, please follow this tutorial: [Create and train a Rasa chatbot](notebook_tuto_10_create_chatbot1.).
...
For more explanation about the CLI command for AI Training, please read this guide: [CLI Reference](cli_15_commands_reference1.).
...
![image](discussion.png){.thumbnail}
...
More explanations are here: [CLI Reference](cli_15_commands_reference1.).
...
[How to deploy a chatbot](deploy_tuto_11_rasa_chatbot_flask1.)
