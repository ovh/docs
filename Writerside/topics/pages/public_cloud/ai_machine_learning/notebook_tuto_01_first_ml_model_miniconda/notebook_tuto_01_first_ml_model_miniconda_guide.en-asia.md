...
You can launch your notebook from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia) or via the ovhai [CLI](cli_11_howto_run_notebook_cli1.).
...
- If you want to learn more about the field of **Computer vision** and **Image Classification**, check out this [notebook](notebook_tuto_07_transfer_learning_resnet50_image_classification1.).
