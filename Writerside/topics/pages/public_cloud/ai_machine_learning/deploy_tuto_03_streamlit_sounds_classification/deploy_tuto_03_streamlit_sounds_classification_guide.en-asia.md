...
![Overview](overview-streamlit-sounds.png){.thumbnail}
...
> [!primary]
>
> Here you will use your trained model, then save it in an Object Container. Click [here](cli_16_commands_reference_data1.) to learn more about Object Storage.
>
...
- You can imagine deploying an AI model with an other tool: **Gradio**. Refer to this [tutorial](deploy_tuto_05_gradio_sketch_recognition1.).
- Another way to create an AI Deploy app is to use **Flask**! [Here it is](deploy_tuto_04_flask_yolov51.).
