...
**AI Training** includes the OVHcloud Object Storage as a persistent storage solution for your [data](gi_02_concepts_data1.). To use these features the user needs to be granted the **Objectstore Operator** role since it implies read/write access to the Object Storage.
...
![image](03_users_menu.png){.thumbnail}
...
![image](04_users_roles.png){.thumbnail}
