...
You can launch the notebook from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=ws) or via the ovhai [CLI](cli_11_howto_run_notebook_cli1.).
...
- [Analyse sentiments on Tweets](notebook_tuto_05_hugging_face_sentiment_analysis1.)

- [Create a Spam classifier](notebook_tuto_09_spam_classifier1.)

- [Discover speech to text powers and use them to generate video subtitles, meeting scripts and summaries](notebook_tuto_08_speech_to_text1.)
