...
![image](update_docker_img_deploy.svg){.thumbnail}
...
- The [OVHcloud AI CLI](cli_10_howto_install_cli1.)
...
![image](stop_start_app_control-panel.png){.thumbnail}
...
Learn how to use public and private registries when working with OVHcloud AI Tools [here](gi_07_manage_registry1.).

Discover some AI Deploy apps we built with API or Web frontend via our [Apps portfolio](deploy_guide_05_app_portfolio1.).
