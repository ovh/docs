...
This guide covers the submission of [**apps**](deploy_guide_02_getting_started1.) through the [**ovhai CLI**](cli_10_howto_install_cli1.).
...
- A working `ovhai` CLI. See [how to install ovhai CLI](cli_10_howto_install_cli1.)
...
> [!primary]
>
> More information about adding and managing public & private registries can be found [here](gi_07_manage_registry1.).
>
...
For more information about **static and automatic scaling strategies**, please refer to this [documentation](deploy_guide_04_scaling_strategies1.).
...
Using tokens can help you share your app securely. More information about creating, managing and using tokens can be found [here](deploy_guide_03_tokens1.). 
