...
- A [user for AI Notebooks](gi_01_manage_users1.)
...
Here is the reference to install the CLI: [CLI Installation](cli_10_howto_install_cli1.).

The token is now created. Don't forget to save the token to use it later.

Now, if you already have trained some Rasa models with AI Training by following [our tutorial](training_tuto_07_train_rasa_chatbot1.), you already have created a container with your trained models. You can skip the next part and go directly [here](#visualstudiocode.).
...
![image](conversation.png){.thumbnail}
