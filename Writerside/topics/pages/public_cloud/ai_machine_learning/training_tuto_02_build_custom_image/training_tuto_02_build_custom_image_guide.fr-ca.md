...
AI Training accept images from **public** or **private** repositories. Find more information about using public & private registries [in this documentation](gi_07_manage_registry1.).
...
> This is why it can be interesting to add other registries. Learn how to do it by following [this documentation](gi_07_manage_registry1.).
>
...
![image](images_shared_registry_details.png){.thumbnail}
...
- Discover [how to build a custom Docker image to deploy a **Streamlit** app](deploy_tuto_01_streamlit1.).
- You can imagine deploying a Docker image for data processing and training tasks. Refer to this [tutorial](training_tuto_06_models_comparaison_weights_and_biases1.).
