...
To launch an AI Deploy app, there are several possibilities. You can do it from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au) or the CLI `ovhai`.
...
> [!primary]
>
> To know how to launch an app from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au), refer to this [guide](deploy_guide_02_getting_started1.).
>
...
>
> Please refer to the [OVHcloud Public Cloud website](https://www.ovhcloud.com/en-au/public-cloud/prices/) for all information about resources and partners models prices.
>
