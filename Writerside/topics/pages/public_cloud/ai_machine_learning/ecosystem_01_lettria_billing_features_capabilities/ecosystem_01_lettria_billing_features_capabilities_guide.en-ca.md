...
![LettriaSentimentExample](lettria-sentiments-example.png){.thumbnail}
...
![LettriaEmotionExample](lettria-emotions-example.png){.thumbnail}
...
![LettriaNERExample](lettria-ner-example.png){.thumbnail}
...
To launch an AI Deploy app, there are several possibilities. You can do it from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca) or the CLI `ovhai`.
...
![LettriaDeployment](lettria-emotions-image.png){.thumbnail}
...
> [!primary]
>
> To know how to launch an app from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca), refer to this [guide](deploy_guide_02_getting_started1.).
>
...
![LettriaApi](lettria-api-doc.png){.thumbnail}
...
> For more detailed information on Lettria models, please refer to this [documentation](ecosystem_02_lettria_models1.).
>
...
![LettriaBilling](lettria-ai-deploy-billing.png){.thumbnail}
...
>
> Please refer to the [OVHcloud Public Cloud website](https://www.ovhcloud.com/en-ca/public-cloud/prices/) for all information about resources and partners models prices.
>
