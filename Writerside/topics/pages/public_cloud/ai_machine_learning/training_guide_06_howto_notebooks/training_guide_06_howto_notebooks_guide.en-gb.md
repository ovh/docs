...
Follow the same steps as a classic job submission described [here](training_guide_02_howto_submit_job1.) until you reach the [Step 5 - Providing a Docker image](training_guide_02_howto_submit_job#step-5-providing-a-docker-image.).
...
-   **autogluon** : An OVHcloud preset image containing JupyterLab notebook, Visual Studio Code IDE and `AutoGluon` + `mxnet` libraries
    ![image](01_submit_image.png){.thumbnail}

Once your image is chosen, click `Next`{.action}.

### Step 3 - Continue as a classic job submission

Continue to follow the same steps as a classic job submission described [here](training_guide_02_howto_submit_job1.) until you reach the [Step 10 - Consulting your job](training_guide_02_howto_submit_job#step-10-consulting-your-job.).
...
![image](02_http_access_url.png){.thumbnail}
...
> [!primary]
> If you have never created a user for AI Training yet you can follow the instruction [here](gi_01_manage_users1.)

Fill the field and click `Login`{.action}.

![image](03_login_form.png){.thumbnail}
...
>
> For installing specific libraries that require priviledge access you will have to build your own notebook image and use it as **custom image** at [step 2](#step-2-select-the-notebook-corresponding-to-your-needs.) instead of **preset image**. More information about creating your own docker image can be found [here](training_tuto_02_build_custom_image1.)
...
>
> ![image](09_nvidia_smi.png){.thumbnail}
