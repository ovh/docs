...
![Hugging Face Overview](flask-hugging-face-overview.png){.thumbnail}
...
![Flask tree structure](tree-flask-app.png){.thumbnail}
...
- You can also imagine deploying an Object Detection model with **Flask** in this [tutorial](deploy_tuto_04_flask_yolov51.).
- Discover an other tool to deploy easily AI models: **Gradio**. Refer to this [documentation](deploy_tuto_05_gradio_sketch_recognition1.).
