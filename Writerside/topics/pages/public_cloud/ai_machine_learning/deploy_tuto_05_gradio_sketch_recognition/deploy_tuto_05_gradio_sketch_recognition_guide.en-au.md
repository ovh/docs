...
![Overview](overview-gradio-app.png){.thumbnail}
...
> [!primary]
>
> Here you will use your trained model, then save it in an Object Storage container. Click [here](cli_16_commands_reference_data1.) to learn more about Object Storage.
>
...
- You can imagine deploying an AI model with an other tool: **Flask**. Refer to this [tutorial](deploy_tuto_06_flask_hugging_face1.).
- Do you want to use **Streamlit** to create a audio classification app? [Here it is](deploy_tuto_03_streamlit_sounds_classification1.).
