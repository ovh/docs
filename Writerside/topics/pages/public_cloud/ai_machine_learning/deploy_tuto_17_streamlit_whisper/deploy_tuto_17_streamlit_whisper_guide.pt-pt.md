...
![Overview](images_speech-to-text.png){.thumbnail}
...
- A [user for AI Deploy & Object Storage](gi_01_manage_users1.)
...
You can create your Object Storage bucket using either the UI (OVHcloud Control Panel) or the `ovhai` CLI, which can be downloaded [here](cli_10_howto_install_cli1.).
...
>>
>> ![image](new-object-container.png){.thumbnail}
>>
...
>>
>> For your information, the previous command is applicable to both Swift and S3 buckets. However, it's important to note that for S3 usage, a proper configuration is necessary. If S3 is not configured yet and you wish to use it, please read the [S3 compliance guide](gi_08_s3_compliance1.).
...
![Overview](whisper-app-overview.png){.thumbnail}
...
You could also combine your transcripts with an LLM. Learn how to [Deploy LLaMA 2 on AI Deploy](deploy_tuto_15_streamlit_chatbot_llama_v21.).
