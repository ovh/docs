...
![Dashboard menu](dashboard-01.jpg){.thumbnail}

The following chapters will help you to discover each section of the `AI Dashboard`.

### Dashboard tab

![Dashboard tab](dashboard-02.png){.thumbnail}

In this section, you will find information related to your use of the AI Tools with easy access to [AI Notebooks](notebook_guide_introduction_definition1.), [AI Training](training_guide_02_howto_submit_job1.) and [AI Deploy](deploy_guide_02_getting_started1.).  
Listed instances are the ones that are in `RUNNING` and `STOPPED` status.

You can also easily access to your [Object Storage](storage-object-storage1.).
...
![Users & tokens tab](dashboard-03.png){.thumbnail}
...
To know how to manage your users and token, please read the following guide: [Manage AI users and roles](gi_01_manage_users1.).

### Command Line Interface 

![Command Line Interface](dashboard-04.png){.thumbnail}
...
![Documentation ](dashboard-05.png){.thumbnail}
