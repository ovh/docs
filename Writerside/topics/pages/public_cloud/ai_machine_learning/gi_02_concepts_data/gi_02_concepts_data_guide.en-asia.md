...
- You can upload and download data from your local environment using the CLI, see [how to install `ovhai` CLI](cli_10_howto_install_cli1.). Next, find out how to [manage your data with the CLI](cli_16_commands_reference_data1.).
- You can use the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia), see [create data container](pcs_create_container1.).
...
![image](data_phases_job.svg){.thumbnail}
...
![image](data_phases_notebook.svg){.thumbnail}
...
- You can check how to [use your data in an AI Notebook](cli_17_how_to_cli_data_notebooks1.).

- You can check how to [launch an AI Training job with attached volumes](cli_12_howto_run_job_cli1.).
