...
![AI Deploy app subscribe](ai_app_subscribe.png){.thumbnail}
...
> [!primary]
>
> OVHcloud provides multiple datacenters. You can find the capabilities for AI Deploy in the guide [AI Deploy capabilities](deploy_guide_01_capabilities1.).
>
...
![AI Deploy app subscribe](ai_app_image.png){.thumbnail}
...
> [!primary]
>
> If you want to deploy your own container, you need to comply with a few rules like adding a specific user. Follow our [Build and use custom images](training_tuto_02_build_custom_image1.) guide.
>
...
![AI Deploy app label](ai_app_labels.png){.thumbnail}
...
![AI Deploy app details](ai_app_details.png){.thumbnail}
...
![AI Deploy app details](ai_app_token.png){.thumbnail}
...
![AI Deploy app details](ai_app_stop.png){.thumbnail}
...
- You can imagine deploying an AI model for sketch recognition thanks to **AI Deploy**. Refer to this [tutorial](deploy_tuto_05_gradio_sketch_recognition1.).
- Do you want to use **Streamlit** in order to create an app? [Here it is](deploy_tuto_02_flask1.).
