...
This guide shows how to access Object Storage data from your [**notebooks**](notebook_guide_introduction_definition1.).
...
You can read the [Getting started](cli_11_howto_run_notebook_cli1.) page to know how to find this URL.

You should get a page like this, showing your dataset in the file explorer:

![image](jupyterlab_with_dataset.png){.thumbnail}
