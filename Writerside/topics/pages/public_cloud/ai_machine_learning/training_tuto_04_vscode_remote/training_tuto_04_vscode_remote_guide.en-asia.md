...
-   installing the [OVHcloud AI CLI](cli_10_howto_install_cli1.)
...
![image](vscode-1.png){.thumbnail}

Then click on the `+` button to add a SSH server.

![image](vscode-2.png){.thumbnail}

Then click on the window icon near your server in the list.

![image](vscode-3.png){.thumbnail}

Enjoy.

![image](vscode-4.png){.thumbnail}
