...
-   **AI Training activated** for your account, see [how to submit a job Step 2](training_guide_02_howto_submit_job1.)
-   a user for AI Tools, see [how to create a user](gi_01_manage_users1.)
...
![image](00_oauth2_login.png){.thumbnail}
...
The documentation of the CLI is available at [CLI documentation](cli_15_commands_reference1.).
