...
This guide shows how to share [**notebooks**](notebook_guide_introduction_definition1.) with other people through the **ovhai** CLI.
...
![image](ovh_login_page.png){.thumbnail}
...
![image](ovh_login_token_page.png){.thumbnail}
