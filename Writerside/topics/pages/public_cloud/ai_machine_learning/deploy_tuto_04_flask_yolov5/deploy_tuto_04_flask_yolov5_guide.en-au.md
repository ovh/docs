...
For more information on how to train YOLOv5 on a custom dataset, refer to the following [documentation](notebook_tuto_04_yolov51.).
...
![image](tree_yolov5_web_service.png){.thumbnail}
...
- You can imagine deploying a **Flask** app in order to classify the feelings in a text. Refer to this [tutorial](deploy_tuto_06_flask_hugging_face1.).
- Another way to create an AI Deploy app is to use **Streamlit**! [Here it is](deploy_tuto_01_streamlit1.).
