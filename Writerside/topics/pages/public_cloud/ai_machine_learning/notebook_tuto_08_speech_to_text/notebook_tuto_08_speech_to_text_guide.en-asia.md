...
![image](speech-to-text.jpeg){.thumbnail}
...
- With NLP, you can do **sentiment analysis**. For more information, click [here](notebook_tuto_05_hugging_face_sentiment_analysis1.).
