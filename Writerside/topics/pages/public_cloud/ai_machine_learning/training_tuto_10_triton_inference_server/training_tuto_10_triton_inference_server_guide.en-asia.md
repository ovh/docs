...
![Overview](ovh-ai-training-triton-inference-server.png){.thumbnail}

## Requirements

- Access to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia)
- [ovhai CLI](cli_10_howto_install_cli1.) installed
...
To upload the models to an OVHcloud Object Storage container, you can use the `ovhai` [CLI](cli_17_how_to_cli_data_notebooks1.).
...
> [!primary]
>
> For more information on how to build Docker images compatible with OVHcloud AI solutions, please refer to this [documentation](training_tuto_02_build_custom_image1.).
>
...
> [!warning]
>
> The shared registry of AI Training should only be used for testing purposes. Please consider attaching your own registry. More information about this can be found [here](gi_07_manage_registry1.). The images pushed to this registry are for AI Tools workloads only, and will not be accessible for external uses.
>
