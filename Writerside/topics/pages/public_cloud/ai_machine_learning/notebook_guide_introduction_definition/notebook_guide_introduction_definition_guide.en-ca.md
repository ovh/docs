...
- a Public Cloud user with `administrator` or `AI Training admin` role, see [here](gi_01_manage_users1.) for more information
...
You can create notebooks with the OVHcloud Control Panel (see below in this tutorial) or use the [ovhai CLI](cli_11_howto_run_notebook_cli1.).

AI Notebooks also provide an easy way to access data from your Object Storage, you can read more about it [here](notebook_guide_data_ui1.).
...
>
> Discover how to [install the OVHcloud AI CLI](cli_10_howto_install_cli1.).
>
...
If you have not already created a Public Cloud user account, follow this [guide](gi_01_manage_users1.) and then log in with your Public Cloud user account.
...
![Create a Notebook 15](creating-a-notebook15.png){.thumbnail}
