...
> [!primary]
>
> To know how to use the **WebSocket API**, please follow this [guide](ecosystem_04_voxist_models1.).
>

### Launch a Voxist app

To launch an AI Deploy app, there are several possibilities. You can do it from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=ws) or the CLI `ovhai`.
...
![VoxistDeployment](voxist-rest-image-ui.png){.thumbnail}
...
> [!primary]
>
> To know how to launch an app from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=ws), refer to this [guide](deploy_guide_02_getting_started1.).
>

#### Launch an app with ovhai CLI

You can also start this app with the `ovhai` [CLI](cli_10_howto_install_cli1.) by running the following command:
...
> [!primary]
>
> Replace `<label=name>` by the variables corresponding to your **token**. To know more about the management of the token, refer to this [documentation](deploy_guide_03_tokens1.).
>
...
![VoxistApi](voxist-api-doc.png){.thumbnail}
...
> [!primary]
>
> For more detailed information on Voxist models, please refer to this [documentation](ecosystem_04_voxist_models1.).
>
...
- transcription configuration - *set up your required configuration, for more information about the features, follow this [documentation](ecosystem_04_voxist_models1.)*
...
The pricing of Voxist differs slightly from the usual AI Deploy offer. In order for you to better understand your invoice, please find more details below about the [price calculation](https://www.ovhcloud.com/es/public-cloud/prices/).
...
To learn more about the basic cost of an app launched with AI Deploy, please refer to this [documentation](deploy_guide_06_billing_concept1.).
...
> [!primary]
>
> To learn more about the basic cost (resource price) of an app launched with AI Deploy, please refer to this [documentation](deploy_guide_06_billing_concept1.).
>
> Please refer to the [OVHcloud Public Cloud website](https://www.ovhcloud.com/es/public-cloud/prices/) for all information about resources and partners models prices.
>
