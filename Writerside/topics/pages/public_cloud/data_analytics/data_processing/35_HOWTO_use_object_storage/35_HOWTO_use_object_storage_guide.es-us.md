...
Otherwise, this [How to](34_HOWTO_handle-python-environment1.) explains how to generate an environment file.
...
The wordcount.txt file should be uploaded in the container you're using when submitting a job. Please refer to this documentation that explains how to create a Swift container [Getting started with the Swift API](pcs_getting_started_with_the_swift_api1.).
...
(See [How to create EC2 credentials](pcs_getting_started_with_the_swift_s3_api1.){.external} for more details)
...
Concerning the 'WordCount' use case, here is a link to the tutorial with a more advanced [Wordcount](41_TUTORIAL_wordcount1.){.external}.
