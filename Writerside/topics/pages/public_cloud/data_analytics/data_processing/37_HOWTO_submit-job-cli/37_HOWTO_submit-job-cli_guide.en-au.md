...
## Requirements
- An OVHcloud account
- An activated cloud project in your OVHcloud account (see [How to create a cloud project](create_a_public_cloud_project1.){.external} and [How to activate the Data Processing service for your cloud project](30_HOWTO_activate_project1.){.external} for details)
...
![Creating API Keys for your script](keys.png){.thumbnail}
...
Please see [Creating Storage Containers in Customer Panel](pcs_create_container1.){.external} or [Create an object container in Horizon](pcs_create_container1.){.external} for more details.

You can also manage your Object storage through command line with the [Openstack Swift API](pcs_getting_started_with_the_swift_api1.){.external} 
...
If you want to submit a python job, do not forget to upload your environment.yml file (see [How to generate environment file for Python jobs](34_HOWTO_handle-python-environment1.){.external})
...
If you don't know how to set these parameters values, please refer to the page [How to fill the job submit form in the Data Processing page from the OVHcloud Manager](32_HOWTO_fill-job-submit-form1.){.external})
...
If you want to check your results after the job is finished, you can download its logs from your Object Storage (see [Checking a job's logs in the Data Processing manager's page](21_GETTINGSTARTED_check-job-logs1.)).
