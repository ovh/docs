...
- An OVHcloud account
- A cloud project in your OVHcloud account (see [How to create a cloud project](create_a_public_cloud_project1.) for details.)
- Data Processing activated (see [How to activate the Data Processing](30_HOWTO_activate_project1.){.external} for details.)
...
![Logs](wordspersong.png){.thumbnail}
...
> [!primary]
>
> You can download Python and Environment files generated here on [official OVHcloud Github repository](https://github.com/ovh/data-processing-samples){.external} [[1]](41_TUTORIAL_wordcount_#notes.)
...
You can find how to generate them here: [How to submit a Python job on the Data Processing platform using the OVHcloud manager](32_HOWTO_fill-job-submit-form1.){.external}
...
A detailed version about how to deploy a job in Python is explained on the guide [How to submit a job in Python](31_HOWTO_submit-python-ui1.){.external}.
...
![Logs](images_logs.png){.thumbnail}
