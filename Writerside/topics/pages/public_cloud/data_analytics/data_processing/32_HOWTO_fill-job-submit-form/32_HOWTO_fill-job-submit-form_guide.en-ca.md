...
In this guide, we are assuming that you're using the [OVHcloud Manager](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca){.external} to use the Data Processing platform. 
...
- Access to the [OVHcloud Manager](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca){.external}
- An OVHcloud account 
...
![Data Processing Engine](engine.png){.thumbnail}
...
![Data Processing Engine](images_region.png){.thumbnail}
...
![Data Processing Engine](cpuram.png){.thumbnail}
...
![Data Processing Engine](advanced.png){.thumbnail}
...
![Data Processing Engine](configure.png){.thumbnail}
