...
![Monte Carlo Graph](monte_carlo_graph.png){.thumbnail}
...
Save it in a file called 'pi-spark.py' or download it from this repository: [Data Processing Samples - Calculate Pi](https://github.com/ovh/data-processing-samples/tree/master/python_calculatePi) [[1]](40_TUTORIAL_calculate_pi_#notes.).
...
![Monte Carlo comparison](comparison_chart.png){.thumbnail}
