...
In this guide, we are assuming that you're using the [OVHcloud Manager](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we){.external} to use the Data Processing platform and you have already submitted a job. 
...
- Access to the [OVHcloud Manager](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we){.external}
...
![Data Processing Job dashboard](jobuserinterface.png){.thumbnail}
...
![Warming up](warmup.png){.thumbnail}

The Apache Spark dashboard for your job will then start automatically. 

![Apache Spark dashboard](sparkdashboard.png){.thumbnail}
...
![Metrics token](token.png){.thumbnail}
...
![grafana charts](grafanadashboard.png){.thumbnail}
