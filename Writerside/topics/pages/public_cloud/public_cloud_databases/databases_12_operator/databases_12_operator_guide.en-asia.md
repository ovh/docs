...
- Access to the [OVHcloud API](https://ca.api.ovh.com/). Create your credentials using our [First Steps with the OVHcloud API](first-steps1.) guide.
...
In order to generate your OVHcloud API, please follow our [First steps with the OVHcloud APIs](first-steps1.) tutorial.
