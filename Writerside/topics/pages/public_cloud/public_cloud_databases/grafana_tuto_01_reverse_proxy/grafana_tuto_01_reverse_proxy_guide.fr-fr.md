...
![Schema concept](pcdb-expose-grafana-to-internet-20230208211544858.png){.thumbnail}
...
- A Grafana database running on your OVHcloud Public Cloud project. ([This guide](databases_01_order_control_panel1.) can help you to create a managed Grafana. If you need more details on the private network configuration use [this guide](databases_08_vrack1.))
...
> [!primary]
>
> [This guide](databases_01_order_control_panel1.) can help you to create a new instance in your vRack.
...
![Grafana dashboard](pcdb-expose-grafana-to-internet-20230208190332776.png)
