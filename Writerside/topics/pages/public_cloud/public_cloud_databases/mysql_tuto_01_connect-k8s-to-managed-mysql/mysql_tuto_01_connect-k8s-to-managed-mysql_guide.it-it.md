...
You need to have [Helm](https://docs.helm.sh/){.external} installed on your workstation and your cluster. Please refer to the [How to install Helm on OVHcloud Managed Kubernetes Service](installing-helm1.) tutorial.

Finally, you need to be able to order a database solution in the OVHcloud Control Panel, as explained in our [Getting started with Public Cloud Databases](databases_01_order_control_panel1.) guide.
...
![Choose MySQL database](connect-kubernetes-to-managed-mysql01.png){.thumbnail}

#### Step 2: Select a solution

In this step, choose an appropriate service plan. You will be able to upgrade the plan after creation.

![Choose plan](connect-kubernetes-to-managed-mysql02.png){.thumbnail}

Please visit the [capabilities page](mysql_01_capabilities1.) for detailed information on each plan's properties.
...
![Choose region](connect-kubernetes-to-managed-mysql03.png){.thumbnail}
...
![Order nodes](connect-kubernetes-to-managed-mysql04.png){.thumbnail}

Please visit the [capabilities page](mysql_01_capabilities1.) for detailed information on the hardware resources and other properties of the MySQL database installation.
...
![Configure options](connect-kubernetes-to-managed-mysql05.png){.thumbnail}
...
![Confirm order](connect-kubernetes-to-managed-mysql06.png){.thumbnail}
...
![Green statuses on Database Control Panel](connect-kubernetes-to-managed-mysql08.png){.thumbnail}
...
![Nodes IPs list on Instances Control Panel](connect-kubernetes-to-managed-mysql09.png){.thumbnail}

Following the related documentation on how to [authorise the suitable IP addresses](mongodb_02_manage_control_panel#configuring-authorised-ips.), add your Kubernetes cluster node IPs to the authorised list.

![Green statuses and authorized IPs setted on Database Control Panel](connect-kubernetes-to-managed-mysql10.png){.thumbnail}
...
![Password reseted](connect-kubernetes-to-managed-mysql11.png){.thumbnail}
...
As described in the [Installing WordPress on OVHcloud Managed Kubernetes](installing-wordpress#installing-the-wordpress-helm-chart.) tutorial, remove the default storage class and install the new one.
...
![WordPress login screen](connect-kubernetes-to-managed-mysql12.png){.thumbnail}
...
![WordPress admin dashboard](connect-kubernetes-to-managed-mysql13.png){.thumbnail}
