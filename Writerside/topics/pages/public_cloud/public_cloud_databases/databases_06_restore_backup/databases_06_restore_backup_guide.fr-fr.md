...
You can learn more about how backups works on the [Automated backups guide](databases_05_automated_backups1.).
...
![Select service](service-selection-20230331.png){.thumbnail}

### Step 2: Go to the backup tab

In the tab list click on `Backups`{.action}.

![Service overview](service-overview-20230331.png){.thumbnail}
...
![Backup tab](backup-tab-20230511.png){.thumbnail}
...
![Immutable options](immutable-options.png){.thumbnail}
...
![Restore point from backup](restore-point-selection-backup.png){.thumbnail}

##### Specific date and latest

If your service supports point in time recovery (see [Automated Backup guide](databases_05_automated_backups1.) for more details), you will also be offered the option to restore from a specific date and time.

![Restore point from a specific date](restore-point-selection-date.png){.thumbnail}

You will also be offered the ease to choose the most recent date directly.

![Restore point from latest](restore-point-selection-latest.png){.thumbnail}

#### Plan

When restoring a backup you can select another service plan.

![Plan selection](plan-selection-20230331.png){.thumbnail}

#### Nodes

You can choose to upgrade the node to a bigger flavor.

![Node selection](node-selection-20230331.png){.thumbnail}
...
![Sizing selection](sizing-selection.png){.thumbnail}
...
![Options selection](option-selection-20230331.png){.thumbnail}
...
![Forked service](forked-service-20230331.png){.thumbnail}
