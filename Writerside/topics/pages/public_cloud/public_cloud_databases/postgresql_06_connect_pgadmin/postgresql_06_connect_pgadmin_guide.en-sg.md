...
One of the easiest, yet powerful, is to use a Command Line Interface (CLI), as shown in our guide: [Connect to PostgreSQL with CLI](postgresql_03_connect_cli1.) or by using programming languages, such as [PHP](postgresql_04_connect_php1.) or [Python](postgresql_05_connect_python1.).
...
![pgAdmin Dashboard view](postgresql_06_connect_pgadmin-2022020413471615.png)

In the **Create - Server** dialog of the `General`{.action} tab, fill in the Name field.

![Create - Server General tab](postgresql_06_connect_pgadmin-20220204140701739.png)
...
![Create - Server Connection tab](postgresql_06_connect_pgadmin-20220204140939712.png)

Finally, select the `SSL`{.action} tab and set the **SSL Mode** to **Require**.

![Create - Server SSL tab](postgresql_06_connect_pgadmin-20220204141355524.png)
...
![Connection Dashboard view](postgresql_06_connect_pgadmin-20220204142252902.png)
