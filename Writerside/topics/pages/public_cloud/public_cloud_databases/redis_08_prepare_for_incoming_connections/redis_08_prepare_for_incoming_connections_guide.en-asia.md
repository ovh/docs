...
Log in to your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia) and open your `Public Cloud`{.action} project. Click on `Databases`{.action} in the left-hand navigation bar and select your Redis instance.
...
![User creation](redis_08_prepare_for_incoming_connections-2022032912263856.png){.thumbnail}

Once created or updated, the user has to be ready and with the "Enabled" status in the Control Panel.

![User ready](redis_08_prepare_for_incoming_connections-20220329122758377.png){.thumbnail}

> [!primary]
>
> Follow the [Commands Official Documentation](https://redis.io/commands/) to learn more.
>
> Follow this [guide](redis_01_capabilities#users-and-roles.) to learn more about users and roles capabilities and limitations.
>
...
![Add an IP](redis_08_prepare_for_incoming_connections_images_ip_authorize.png){.thumbnail}
...
![Login informations](redis_08_prepare_for_incoming_connections-20220329100705698.png)
