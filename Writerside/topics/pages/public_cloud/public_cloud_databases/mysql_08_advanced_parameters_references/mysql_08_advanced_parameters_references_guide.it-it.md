...
Please refer to this [guide](databases_03_advanced_configuration#using-the-ovhcloud-control-panel.) to find out how to change your advanced parameters from the OVHcloud Control Panel.
