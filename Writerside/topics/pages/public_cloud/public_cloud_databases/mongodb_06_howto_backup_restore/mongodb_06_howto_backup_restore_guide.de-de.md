...
Follow the guide [MongoDB - Connect with CLI](mongodb_03_connect_cli1.) in order to ensure you can connect to your database. That step ensures IP filtering is set up properly and that you have a suitable service URI available.
