...
![Choose region](kafka_region.png){.thumbnail}
...
![Order nodes](kafka_features.png){.thumbnail}

Please visit the [capabilities page](public-cloud-databases1.) of your selected database type for detailed information on hardware resources and other properties of the database installation.
...
![Configure options](kafka_options.png){.thumbnail}
...
![Confirm order](kafka_configuration.png){.thumbnail}
...
![Users](kafka_concept.png){.thumbnail}

The `General information`{.action} tab should inform you to create users and authorized IPs.

![Kafka General information](kafka_cluster_ready_to_configure.png){.thumbnail}
...
![Users](kafka_add_user.png){.thumbnail}
...
![Password reset](kafka_user_password_reset1.png){.thumbnail}
...
![Authorised IP](kafka_authorized_ip.png){.thumbnail}
...
![Add IP](kafka_add_ip.png){.thumbnail}
...
![Add a topic](kafka_topics.png){.thumbnail}
...
![Create a topic](kafka_create_topic.png){.thumbnail}
...
![Enable ACLs](kafka_acl.png){.thumbnail}
...
![Define ACLs](kafka_add_entry1.png){.thumbnail}
...
![Kafka server certificate](kafka_get_sercer_certificate.png){.thumbnail}

##### **2 - User certificate**

The user certificate can be downloaded from the **Users** tab:

![User informations](kafka_user_access_key.png){.thumbnail}
![User certificate](kafka_download_user_certificate.png){.thumbnail}

##### **3 - User access key**

Also download the user access key.

![User access key](kafka_dowload_access_key.png){.thumbnail}
...
[Kafka capabilities](kafka_01_capabilities1.)
