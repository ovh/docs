...
To create a new connection pool, log in to your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia) and open your `Public Cloud`{.action} project.
...
![Add a pool](postgresql_08_pool-20220411131919759.png){.thumbnail}
...
![Pools](postgresql_08_pool-20220411134051260.png){.thumbnail}

Click on `Information`{.action}, then collect the required information.

![Pool informations](postgresql_08_pool-2022041113491326.png){.thumbnail}
