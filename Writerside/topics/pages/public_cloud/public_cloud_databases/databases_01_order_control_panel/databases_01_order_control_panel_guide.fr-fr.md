...
![Choose database](databases_01_order_control_panel-20231208145850.png){.thumbnail}
...
![Choose plan](databases_01_order_control_panel-20231208150215.png){.thumbnail}

### Step 3: Select a location

Choose the geographical region of the data centre in which your database will be hosted.

![Choose region](databases_01_order_control_panel-20231208150326.png){.thumbnail}

### Step 4: Configure database nodes

You can choose the node template in this step.

![Order nodes](databases_01_order_control_panel-20231208150805.png){.thumbnail}
...
![Sizing](databases_01_order_control_panel-20230414151211.png){.thumbnail}

### Step 6: Configure your options

Define your network configuration:

![Configure options](databases_01_order_control_panel-20230414151536.png){.thumbnail}

#### Connecting a private network (optional)

![Attach network](databases_01_order_control_panel-20230414152851.png){.thumbnail}
...
Please follow [this guide](getting-started-07-creating-vrack1.) for detailed instructions.
...
![Confirm order](databases_01_order_control_panel-20231208153010.png){.thumbnail}
...
Continue with the *Configure your instance to accept incoming connections* guide of your selected database type available [here](public-cloud-databases1.) to configure your service after installation.
