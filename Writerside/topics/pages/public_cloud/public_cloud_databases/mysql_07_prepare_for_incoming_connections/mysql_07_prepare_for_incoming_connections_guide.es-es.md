...
![User table](mysql_07_prepare_for_incoming_connections-20220308112922280.png){.thumbnail}

You can add more users by clicking on the button `Add user`{.action}.

![Add user](mysql_07_prepare_for_incoming_connections-20220308111540905.png){.thumbnail}
...
![Add an IP](mysql_07_prepare_for_incoming_connections_images_ip_authorize.png){.thumbnail}
...
![Login information tab](mysql_04_connect_php-20220124153927876.png){.thumbnail}

Select the `Databases`{.action} tab to get the database name.

![Databases tab](mysql_04_connect_php-20220124154604558.png){.thumbnail}
