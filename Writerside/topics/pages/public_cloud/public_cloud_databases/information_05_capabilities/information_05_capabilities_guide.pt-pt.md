...
See our [MySQL Capabilities and limitations](mysql_01_capabilities1.) guide.
...
See our [PostgreSQL Capabilities and limitations](postgresql_01_capabilities1.) guide.
...
See our [MongoDB Capabilities and limitations](mongodb_01_concept_capabilities1.) guide.
...
See our [Redis Capabilities and limitations](redis_01_capabilities1.) guide.
...
See our [M3db Capabilities and limitations](m3db_01_capabilities1.) guide.
...
See our [OpenSearch Capabilities and limitations](opensearch_01_capabilities1.) guide.
...
See our [Cassandra Capabilities and limitations](cassandra_01_capabilities1.) guide.

## Feature Availability

| Feature                                                                                                      | MySQL | PostgreSQL | MongoDB          | Redis | M3db | Opensearch | Cassandra |
|--------------------------------------------------------------------------------------------------------------|-------|------------|------------------|-------|------|------------|-----------|
| End-to-end security ([more information](information_01_security_overview1.))         | ✓     | ✓          | ✓                | ✓     | ✓    | ✓          | ✓         |
...
You can now adjust the storage space of your cluster according to your needs. To resize your cluster, see our [guide](databases_11_resize_your_cluster_storage1.).

### 15 March 2023

Remote backup is now available for all services. See [Automated backups](databases_05_automated_backups1.).

### 27 January 2023

PostgreSQL 15 is now available in the OVHcloud Control Panel and via the API. Please refer to the [DBMS lifecycle policy](information_02_lifecycle_policy1.).

### 8 November 2022

MongoDB 6.0 is now available in the OVHcloud Control Panel and via the API. Please refer to the [DBMS lifecycle policy](information_02_lifecycle_policy1.).
