...
![Redis Plugin PHPInfo](Redis_phpinfo.png){.thumbnail}
...
![Search Redis Plugin](Redis_plugin_list.png){.thumbnail}
...
![Activate Redis Object Cache Plugin](Redis_add_ip_whitelist.png){.thumbnail}

#### Activate and enable the plugin

Now all installation and configurations are done. So let's activate the plugin.

![Activate Redis Object Cache Plugin](Redis_Plugin_activate.png){.thumbnail}

Then enable the object cache functionality.

![Enable Redis Object Cache](Redis_Plugin_enable.png){.thumbnail}
...
![Diagnostics Redis Object Cache Plugin](Redis_Plugin_Diagnostics.png){.thumbnail}
...
![Performance measure without cache](Perf_without_cache.png){.thumbnail}

With the Redis cache, there is a total of 2 database queries taking 0.0043s:

![Performance measure with cache](Perf_with_cache.png){.thumbnail}
...
[Redis capabilities](redis_01_capabilities1.)

[How to connect to Redis with CLI](redis_03_connect_cli1.)

[How to connect to Redis with PHP](redis_04_connect_php1.)
