...
![Terminate button](postgresql-11-terminate.png){.thumbnail}
...
Please refer to this [guide](postgresql_03_connect_cli1.) to find out how to connect to your database using `psql`.
