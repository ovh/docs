...
One of the easiest, yet powerful, is to use a Command Line Interface (CLI), as shown in our guide : [Connect to MongoDB with CLI](mongodb_03_connect_cli1.).
...
Once you know the IP address, follow the steps from this guide : [Configure your MongoDB instance to accept incoming connections](mongodb_02_manage_control_panel1.).
