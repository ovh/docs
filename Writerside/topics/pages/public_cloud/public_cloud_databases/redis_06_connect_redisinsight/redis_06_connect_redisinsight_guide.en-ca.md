...
- A Redis database running on your OVHcloud Public Cloud Databases ([this guide](databases_01_order_control_panel1.) can help you to meet this requirement)
- [Configure your Redis instance](redis_08_prepare_for_incoming_connections1.) to accept incoming connections
...
One of the easiest, yet powerful, is to use a Command Line Interface (CLI), as shown in our guide: [Redis - Connect with CLI](redis_03_connect_cli1.) or by using programming languages, such as [PHP](redis_04_connect_php1.).
...
![Login information tab](redis_06_connect_redisinsight-20220209095337130.png){.thumbnail}

#### Configuration

Once connected to the RedisInsight interface, click on the `I already have a database`{.action} link:

![Redis first screen](redis_06_connect_redisinsight-20220207114821477.png){.thumbnail}

Then on Connect to a Redis database`{.action} :

![Configure your Redis database](redis_06_connect_redisinsight-2022020711515517.png){.thumbnail}
...
![Add Redis database](redis_06_connect_redisinsight-20220207120005204.png){.thumbnail}

Finally, select your Redis database:

![Dashboard](redis_06_connect_redisinsight-20220209095424435.png){.thumbnail}

Congratulations! You are now connected to your Redis instance!

![Result](redis_06_connect_redisinsight-20220209095533690.png){.thumbnail}
