...
- A Cassandra database running on your OVHcloud Public Cloud Databases ([this guide](databases_01_order_control_panel1.) can help you to meet this requirement)
...
![User table](cassandra_02_prepare_for_incoming_connections-20220530081746230.png){.thumbnail}

You can add more users by clicking on the button `Add user`{.action}.

![Add user](cassandra_02_prepare_for_incoming_connections-20220530081855845.png){.thumbnail}
...
![Add an IP](ip_authorize.png){.thumbnail}
...
![Login information tab](cassandra_02_prepare_for_incoming_connections-20220530082044838.png){.thumbnail}
