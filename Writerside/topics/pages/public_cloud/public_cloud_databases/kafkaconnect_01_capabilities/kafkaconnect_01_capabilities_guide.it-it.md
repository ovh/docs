...
You can further customise your Kafka Connect by using advanced parameters. See the [Advanced parameters references documentation](kafkaconnect_02_advanced_parameters_references1.) for more information on the supported parameters.
