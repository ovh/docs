...
In this tutorial, we are going to show you how to build a [Strapi](https://strapi.io/){.external} application using the OVHcloud managed [PostgreSQL](https://www.postgresql.org/){.external} database [service](https://www.ovhcloud.com/pt/public-cloud/postgresql/).
...
You need to be able to order a database solution in the OVHcloud Control Panel, as explained in our [Getting started with Public Cloud Databases](databases_01_order_control_panel1.) guide.
...
![Choose PostgreSQL database](postgresql-tuto-01-connect-strapi-to-managed-postgresql01.png){.thumbnail}
...
![Choose plan](postgresql-tuto-01-connect-strapi-to-managed-postgresql02.png){.thumbnail}

Please visit the [capabilities page](postgresql_01_capabilities1.) for detailed information on each plan's properties.
...
![Choose region](postgresql-tuto-01-connect-strapi-to-managed-postgresql03.png){.thumbnail}
...
![Order nodes](postgresql-tuto-01-connect-strapi-to-managed-postgresql04.png){.thumbnail}

Please visit the [capabilities page](postgresql_01_capabilities1.) for detailed information on the hardware resources and other properties of the MySQL database installation.
...
![Configure options](postgresql-tuto-01-connect-strapi-to-managed-postgresql05.png){.thumbnail}

Click `Next`{.action} to continue.

#### Step 6: Summary and confirmation

The last section will show a summary of your order as well as the API equivalent of creating this database instance with the [OVHcloud API](first-steps1.).

![Confirm order](postgresql-tuto-01-connect-strapi-to-managed-postgresql06.png){.thumbnail}
...
![Green statuses on Database Control Panel](postgresql-tuto-01-connect-strapi-to-managed-postgresql08.png){.thumbnail}
...
Following the related documentation on how to [authorize the suitable IP addresses](mongodb_02_manage_control_panel#configuring-authorized-ips.), add your IPs to the authorized list.

![Green statuses and authorized IPs setted on Database Control Panel](postgresql-tuto-01-connect-strapi-to-managed-postgresql10.png){.thumbnail}
...
![Password reseted](postgresql-tuto-01-connect-strapi-to-managed-postgresql11.png){.thumbnail}
...
![Download certificate](postgresql-tuto-01-connect-strapi-to-managed-postgresql16.png){.thumbnail}
...
![Strapi admin login creation page](postgresql-tuto-01-connect-strapi-to-managed-postgresql12.png){.thumbnail}

Fill the form fields as requested, and press the `Let's start`{.action} button.

![Strapi dashboard page](postgresql-tuto-01-connect-strapi-to-managed-postgresql13.png){.thumbnail}
...
![Strapi create user page](postgresql-tuto-01-connect-strapi-to-managed-postgresql14.png){.thumbnail}
...
![delete service menu](postgresql-tuto-01-connect-strapi-to-managed-postgresql15.png){.thumbnail}
