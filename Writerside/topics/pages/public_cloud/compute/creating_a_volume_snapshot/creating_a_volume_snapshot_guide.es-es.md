...
- Un volumen de [Block Storage](create_and_configure_an_additional_disk_on_an_instance1.) creado en su proyecto de [Public Cloud](https://www.ovhcloud.com/es-es/public-cloud/).
...
Haga clic en el botón `...`{.action} para eliminar o `Crear un volumen`{.action} a partir del snapshot correspondiente. Para más información, consulte [esta guía](create-volume-from-snapshot1.).
