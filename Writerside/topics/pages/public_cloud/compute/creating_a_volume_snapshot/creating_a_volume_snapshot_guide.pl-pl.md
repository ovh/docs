...
Tworzenie kopii zapasowej wolumenu wymaga odłączenia wolumenu od instancji. Więcej informacji na temat tej opcji można znaleźć w tym [przewodniku](volume-backup1.).
...
![Snapshoty wolumenów](volume_snapshot01.png){.thumbnail}

Po prawej stronie wybranego wolumenu kliknij `...`{.action} a następnie `Utwórz snapshot`{.action} (nie ma potrzeby odłączania wolumenu od instancji.) Jeśli jednak chcesz odłączyć wolumen, zapoznaj się z [tą sekcją](create_and_configure_an_additional_disk_on_an_instance#linux_1.) odpowiedniego przewodnika dla systemu Linux i [tą sekcją](create_and_configure_an_additional_disk_on_an_instance#windows_1.) dla systemu Windows.

![Snapshoty wolumenów](volume_snapshot02.png){.thumbnail}
...
![Snapshoty wolumenów](volume_snapshot03.png){.thumbnail}
...
Kliknij przycisk `...`{.action}, aby usunąć snapshot lub Utwórz wolumen z odpowiedniego snapshota. Więcej informacji znajdziesz w [tym przewodniku](create-volume-from-snapshot1.).

## Sprawdź również

[Tworzenie kopii zapasowej wolumenu](volume-backup1.)
...
[Zwiększenie rozmiaru dodatkowego dysku](increase_the_size_of_an_additional_disk1.)
