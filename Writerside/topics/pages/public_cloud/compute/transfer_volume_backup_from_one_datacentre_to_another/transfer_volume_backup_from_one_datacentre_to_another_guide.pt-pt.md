...
- CLI OpenStack. Consulte o nosso guia « [Como preparar o ambiente para utilizar a API OpenStack](prepare_the_environment_for_using_the_openstack_api1.) ».
...
[Transferir a cópia de segurança de uma instância de uma região OpenStack para outra](transfer_instance_backup_from_one_datacentre_to_another1.){.external}.
