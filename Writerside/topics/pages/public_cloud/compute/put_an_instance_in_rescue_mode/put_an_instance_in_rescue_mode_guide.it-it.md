...
> [!alert]
>
> Ad oggi, la modalità Rescue per le istanze Metal non è disponibile nello Spazio Cliente OVHcloud. Per maggiori informazioni, consulta la guida dedicata al [Rescue mode per le istanze Metal](rescue_mode_metal_instance1.).
...
![Spazio Cliente](rescue2022.png){.thumbnail}
...
![Spazio Cliente](rescue2.png){.thumbnail}
...
![Spazio Cliente](rescuedata.png){.thumbnail}
...
![Spazio Cliente](rescueexit2022.png){.thumbnail}
