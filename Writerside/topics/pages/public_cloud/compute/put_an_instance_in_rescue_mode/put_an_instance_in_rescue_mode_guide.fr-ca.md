...
> [!alert]
>
> A ce jour, le mode rescue pour les instances Metal n'est pas accessible via l'espace client OVHcloud. Pour plus d'informations, consultez notre guide dédié au [mode rescue pour les instances Metal](rescue_mode_metal_instance1.).
...
![tableau de bord](rescue2022.png){.thumbnail}
...
![tableau de bord](rescue2.png){.thumbnail}
...
![tableau de bord](rescuedata.png){.thumbnail}
...
![tableau de bord](rescueexit2022.png){.thumbnail}
