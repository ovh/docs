...
> [!alert]
>
> Atualmente, o modo rescue para as instâncias Metal não está acessível através da Área de Cliente OVHcloud. Para mais informações, consulte o nosso guia dedicado ao [modo rescue para as instâncias Metal](rescue_mode_metal_instance1.).
...
![área de cliente](rescue2022.png){.thumbnail}
...
![área de cliente](rescue2.png){.thumbnail}
...
![área de cliente](rescuedata.png){.thumbnail}
...
![área de cliente](rescueexit2022.png){.thumbnail}
