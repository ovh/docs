...
Dans le guide [créer un accès à Horizon](introducing_horizon1.){.external}, il vous a été expliqué comment créer et supprimer un utilisateur OpenStack et générer un mot de passe d’accès.
...
![Connexion à Horizon](1_H_login_window.png){.thumbnail}
...
![Changement de mot de passe](2_H_pass_change_option.png){.thumbnail}
...
![Paramétrage du mot de passe](3_H_set_new_passord.png){.thumbnail}
