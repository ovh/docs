...
No guia [Criar um acesso à interface Horizon](introducing_horizon1.){.external}, explica-se como criar e eliminar um utilizador OpenStack e gerir uma palavra-passe de acesso.
...
![Conexão ao Horizon](1_H_login_window.png){.thumbnail}
...
![Alteração da palavra-passe](2_H_pass_change_option.png){.thumbnail}
...
![Parametrização da palavra-passe](3_H_set_new_passord.png){.thumbnail}
