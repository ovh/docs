...
In our guide to [Configuring user access to Horizon](introducing_horizon1.){.external}, we explained how to create and delete OpenStack users, as well as how to generate an access password.
...
![Horizon login](1_H_login_window.png){.thumbnail}
...
![Change password](2_H_pass_change_option.png){.thumbnail}
...
![Set password](3_H_set_new_passord.png){.thumbnail}
