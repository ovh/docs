...
W przewodniku [Dostęp do panelu Horizon](introducing_horizon1.){.external} pokazano, jak stworzyć i usunąć użytkownika OpenStack oraz wygenerować hasło dostępowe.
...
![Logowanie do Horizon](1_H_login_window.png){.thumbnail}
...
![Zmiana hasla](2_H_pass_change_option.png){.thumbnail}
...
![Ustawienie hasla](3_H_set_new_passord.png){.thumbnail}
