...
Zapraszamy do zapoznania się z przewodnikiem [Tworzenie pierwszej instancji Public Cloud i łączenie się z nią](public-cloud-first-steps1.).
...
Zapoznaj się z przewodnikiem [Zmiana klucza SSH w przypadku utraty](replacing_lost_ssh_key1.).
...
Zapoznaj się z przewodnikiem dotyczącym [Tworzenia kopii zapasowej instancji](save_an_instance1.).
...
Zapoznaj się z przewodnikiem [Tworzenie i usuwanie użytkownika OpenStack](create_and_delete_a_user1.).
...
Aby zmienić model rozliczenia na inny, zapoznaj się z naszym przewodnikiem [Zmiana typu rozliczenia z godzinowego na miesięczne dla instancji Public Cloud](changing_hourly_monthly_billing1.).
...
Zapraszamy do zapoznania się z przewodnikiem [Konfiguracja grupy zabezpieczeń](setup_security_group1.).
...
Zapraszamy do zapoznania się z przewodnikiem [Konfiguracja usługi vRack Public Cloud](getting-started-07-creating-vrack1.).
...
Zapraszamy do zapoznania się z przewodnikiem [zarządzanie regułami firewalla i portu security w sieciach wykorzystujących OpenStack CLI](security_group_private_network1.).
...
Zapraszamy do zapoznania się z przewodnikiem [Wykupienie adresu Additional IP](additional-ip-buy1.).
...
Możesz jednak filtrować lukę bezpośrednio do Twojej instancji, wykonując reboot hard Twojej instancji albo [w Panelu klienta OVHcloud](first_steps_with_public_cloud_instance1.) albo za pomocą polecenia takiego jak to:
