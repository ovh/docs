...
Sugerimos que consulte o guia [Criação e conexão a uma primeira instância Public Cloud](public-cloud-first-steps1.).
...
Pode consultar o guia [Alterar a chave SSH em caso de perda](replacing_lost_ssh_key1.).
...
Pode consultar o guia [Criar uma cópia de segurança de uma instância](save_an_instance1.).
...
Sugerimos que consulte o guia [Criar e eliminar um utilizador OpenStack](create_and_delete_a_user1.).
...
Para passar de um modo de faturação para outro, consulte o nosso manual [Passar de uma faturação à hora para uma faturação ao mês](changing_hourly_monthly_billing1.).
...
Pode consultar o guia [Configurar um grupo de segurança](setup_security_group1.).
...
Sugerimos que consulte o guia [Configuração do vRack Public Cloud](getting-started-07-creating-vrack1.).
...
Pode consultar o guia de [gestão das regras de firewall e port security nas redes que utilizam OpenStack CLI](security_group_private_network1.).
...
Para mais informações, consulte o guia [Adicionar um Additional IP](additional-ip-buy1.).
...
No entanto, é possível mitigar esta falha diretamente na sua instância fazendo um "hard" reboot da sua instância, quer [através da Área de Cliente OVHcloud](first_steps_with_public_cloud_instance1.), quer com um comando como este:
