...
Para más información, consulte la guía [Crear y conectarse a una primera instancia de Public Cloud](public-cloud-first-steps1.).
...
Por favor, consulte la guía [Modificar su llave SSH en caso de pérdida](replacing_lost_ssh_key1.).
...
Para más información, consulte la guía [Guardar una copia de seguridad de una instancia](save_an_instance1.).
...
Para más información, consulte la guía [Crear y eliminar un usuario de OpenStack](create_and_delete_a_user1.).
...
Para pasar de un modo de facturación a otro, consulte nuestra guía [Cambiar de facturación por horas a mensual](changing_hourly_monthly_billing1.).
...
Le invitamos a consultar la guía [Configurar un grupo de seguridad](setup_security_group1.).
...
Para más información, consulte la guía [Configuración del vRack Public Cloud](getting-started-07-creating-vrack1.).
...
Para más información, consulte la guía [gestión de las reglas de firewall y port security en las redes que utilizan OpenStack CLI](security_group_private_network1.).
...
Para más información, consulte la guía [Comprar una Additional IP](additional-ip-buy1.).
...
No obstante, es posible mitigar este fallo directamente en su instancia realizando un "hard reboot" de su instancia, bien [a través del área de cliente de OVHcloud](first_steps_with_public_cloud_instance1.), o bien con un comando como este:
