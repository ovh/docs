...
- [Ter criado uma instância a partir da Área de Cliente OVHcloud](public-cloud-first-steps#3o-passo-criacao-de-uma-instancia.).
- [Tornar-se o utilizador root e selecionar uma palavra-passe](become_root_and_change_password1.).
