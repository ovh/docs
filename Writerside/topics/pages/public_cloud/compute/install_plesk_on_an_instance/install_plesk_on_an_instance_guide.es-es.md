...
- [Crear una instancia desde el área de cliente de OVHcloud](public-cloud-first-steps#3-crear-una-instancia.).
- [Conectarse como usuario root y establecer una contraseña](become_root_and_change_password1.).
