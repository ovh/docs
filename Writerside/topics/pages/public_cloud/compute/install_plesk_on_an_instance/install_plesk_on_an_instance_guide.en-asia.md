...
- [An instance created via the OVHcloud Control Panel](public-cloud-first-steps#step-3-creating-an-instance.)
- [Root access to the instance](become_root_and_change_password1.)
