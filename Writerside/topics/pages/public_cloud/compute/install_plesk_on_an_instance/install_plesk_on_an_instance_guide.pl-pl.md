...
- [Utworzenie instancji w Panelu klienta OVHcloud](public-cloud-first-steps#krok-3-tworzenie-instancji.)
- [Dostęp root i zdefiniowanie hasła](become_root_and_change_password1.)
