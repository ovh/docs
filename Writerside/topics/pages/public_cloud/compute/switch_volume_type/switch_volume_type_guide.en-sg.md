...
- A [Block Storage volume](create_and_configure_an_additional_disk_on_an_instance1.) created in your [Public Cloud project](https://www.ovhcloud.com/en-sg/public-cloud/)
