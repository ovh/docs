...
- [Accéder à l'interface Horizon](introducing_horizon1.)
...
![Sélection de région](switch_volume_type_images_region2021.png){.thumbnail}
...
![Choix de l'option](selectoption.png){.thumbnail}
...
![Choix de l'option](changevolume.png){.thumbnail}
