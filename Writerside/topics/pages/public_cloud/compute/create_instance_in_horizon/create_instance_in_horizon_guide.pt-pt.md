...
- [Ter acesso à interface Horizon](introducing_horizon1.){.external}. 

## Instruções

Para começar a criar uma instância, aceda à interface Horizon. Se precisar de ajuda para realizar esta operação, consulte o [nosso manual](introducing_horizon1.).
