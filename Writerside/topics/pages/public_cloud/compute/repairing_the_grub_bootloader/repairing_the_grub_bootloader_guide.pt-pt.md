...
- A instância deve estar em modo rescue (Consulte o guia [Passar uma instância em modo rescue](put_an_instance_in_rescue_mode1.))
...
Agora pode retirar a instância do modo rescue. (Ver o guia [Passar uma instância em modo rescue](put_an_instance_in_rescue_mode1.))
