...
![Instalación automática](1_preparation_openstack_environment_windows.png){.thumbnail}
...
![Elección de las variables de entorno](2_preparation_openstack_environment_windows.png){.thumbnail}
...
![Configuración de las variables de entorno](3_preparation_openstack_environment_windows.png){.thumbnail}
...
![Introducción de la ruta de acceso](4_edit_system_variables.png){.thumbnail}
...
![Instalación automática](5_preparation_openstack_environment_windows.png){.thumbnail}
...
![Verificación](6_preparation_openstack_environment_windows.png){.thumbnail}
