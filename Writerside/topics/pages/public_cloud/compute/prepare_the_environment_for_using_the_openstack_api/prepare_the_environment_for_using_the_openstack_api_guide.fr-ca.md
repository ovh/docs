...
![Installation automatique](1_preparation_openstack_environment_windows.png){.thumbnail}
...
![Paramètres des variables d’environnement ](2_preparation_openstack_environment_windows.png){.thumbnail}
...
![Paramètres de performance](3_preparation_openstack_environment_windows.png){.thumbnail}
...
![Ajout du chemin d'accès](4_edit_system_variables.png){.thumbnail}
...
![Installation automatique](5_preparation_openstack_environment_windows.png){.thumbnail}
...
![Vérification](6_preparation_openstack_environment_windows.png){.thumbnail}
