...
![orizzonte - accesso API](api_access.png){.thumbnail}
...
![orizzonte - chiavi SSH](key_pairs.png){.thumbnail}
...
Questa sezione di interfaccia contiene le istruzioni di base. Per maggiori informazioni sulle chiavi SSH, consulta [questa guida](public-cloud-first-steps#step-1-crea-chiavi-ssh.).
...
![orizzonte - gruppi di sicurezza](security_groups.png){.thumbnail}
