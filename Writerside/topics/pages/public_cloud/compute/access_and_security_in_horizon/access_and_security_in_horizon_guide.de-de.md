...
- [Zugang zum Horizon-Interface](introducing_horizon1.)
...
![Sicherheit Horizon](api_access.png){.thumbnail}
...
![Sicherheit Horizon](key_pairs.png){.thumbnail}
...
Dieser Teil der Benutzeroberfläche enthält einige grundlegende Anweisungen; ausführlichere Informationen zu SSH-Schlüsseln finden Sie in [dieser Anleitung](public-cloud-first-steps#schritt-1-ssh-schlussel-erstellen.).
...
![Sicherheit Horizon](security_groups.png){.thumbnail}
