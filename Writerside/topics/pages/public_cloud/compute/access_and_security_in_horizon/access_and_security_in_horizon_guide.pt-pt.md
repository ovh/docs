...
![horizon - acesso API](api_access.png){.thumbnail}
...
![horizonte - chaves SSH](key_pairs.png){.thumbnail}
...
Esta secção da interface contém instruções básicas. Para mais informações sobre as chaves SSH, consulte [este guia](public-cloud-first-steps#1o-passo-criacao-de-chaves-ssh.).
...
![horizon - grupos de segurança](security_groups.png){.thumbnail}
