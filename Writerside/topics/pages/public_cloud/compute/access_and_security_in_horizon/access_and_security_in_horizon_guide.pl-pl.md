...
![horizon - dostęp API](api_access.png){.thumbnail}
...
![horizon - klucze SSH](key_pairs.png){.thumbnail}
...
Ta część interfejsu zawiera podstawowe instrukcje. Więcej informacji na temat kluczy SSH znajdziesz w [tym przewodniku](public-cloud-first-steps#krok-1-utworzenie-kluczy-ssh.).
...
![horyzont - grupy bezpieczeństwa](security_groups.png){.thumbnail}
