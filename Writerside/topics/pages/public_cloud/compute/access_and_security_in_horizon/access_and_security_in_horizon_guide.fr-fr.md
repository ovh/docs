...
![horizon - accès API](api_access.png){.thumbnail}
...
![horizon - clés SSH](key_pairs.png){.thumbnail}
...
Cette section d'interface contient des instructions de base. Pour plus d'informations sur les clés SSH, consultez [ce guide](public-cloud-first-steps#etape-1-creer-des-cles-ssh.).
...
![horizon - groupes de sécurité](security_groups.png){.thumbnail}
