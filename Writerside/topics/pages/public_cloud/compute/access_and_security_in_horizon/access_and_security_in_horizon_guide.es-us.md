...
![horizon - acceso a la API](api_access.png){.thumbnail}
...
![horizon - llaves SSH](key_pairs.png){.thumbnail}
...
Esta sección de la interfaz contiene instrucciones básicas. Para más información sobre las llaves SSH, consulte [esta guía](public-cloud-first-steps#1-crear-claves-ssh.).
...
![horizon - grupos de seguridad](security_groups.png){.thumbnail}
