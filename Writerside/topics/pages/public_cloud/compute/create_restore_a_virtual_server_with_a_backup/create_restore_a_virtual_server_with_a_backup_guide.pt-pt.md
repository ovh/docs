...
A Área de Cliente OVHcloud permite-lhe criar [backups das suas instâncias](save_an_instance1.) em apenas alguns cliques e automatizar este processo.
...
- Ter um backup de uma instância Public Cloud. Para isso, consulte [o guia relativo à criação de um backup](save_an_instance1.).
...
Para mais informações sobre a criação de uma instância, consulte [este guia](public-cloud-first-steps#3o-passo-criacao-de-uma-instancia.).

> [!primary]
>
> Para criar uma instância num datacenter diferente do do backup, será necessário transferir o backup para a zona correspondente. Consulte então o [guia relativo ao backup de uma instância de um datacenter para outro](transfer_instance_backup_from_one_datacentre_to_another1.).
>
...
[Criação e ligação a uma primeira instância Public Cloud](first_steps_with_public_cloud_instance1.)

[Efetuar um backup de uma instância](first_steps_with_public_cloud_instance1.)
