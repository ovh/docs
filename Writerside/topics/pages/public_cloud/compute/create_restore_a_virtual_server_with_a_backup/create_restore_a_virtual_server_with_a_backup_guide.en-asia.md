...
The OVHcloud Control Panel enables you to [create backups of your instances](save_an_instance1.) within a few clicks, as well as automating this process.
...
Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia) and open your `Public Cloud`{.action} project. Then Click `Instance backup`{.action} under the `Storage` section.
...
For further information on creating an instance, please refer to [this guide](public-cloud-first-steps1.).

> [!primary]
>
>In order to create the instance in a different data centre, you will first need to transfer the backup to the appropriate region. Please refer to our guide to [transferring an instance backup](transfer_instance_backup_from_one_datacentre_to_another1.).
>

### Restoring an instance from a backup

Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia) and switch to the `Public Cloud`{.action} section. Click on `Instances`{.action} in the left-hand sidebar.
...
[First steps](public-cloud-first-steps1.)

[Creating instance backups](save_an_instance1.)
