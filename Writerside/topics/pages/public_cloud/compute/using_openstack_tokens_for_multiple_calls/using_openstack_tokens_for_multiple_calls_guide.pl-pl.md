...
- Aby wyeksportować zmienne środowiskowe, zapoznaj się z tym przewodnikiem: [Zmienne środowiskowe OpenStack](loading_openstack_environment_variables1.).
...
![pobierz plik openRC](openrc.png){.thumbnail}
