...
- Para os utilizadores do Windows, consulte este guia para exportar as suas variáveis de ambiente: [Carregar as variáveis de ambiente OpenStack](loading_openstack_environment_variables1.).
...
![descarregar o ficheiro openRC](openrc.png){.thumbnail}
