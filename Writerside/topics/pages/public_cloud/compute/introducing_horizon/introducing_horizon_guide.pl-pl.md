...
- Utworzenie [Projekt Public Cloud](create_a_public_cloud_project1.) na Twoim koncie OVHcloud.
- **[Opcjonalnie od września 2023]** Użytkownik [OpenStack](create_and_delete_a_user1.) utworzony w Twoim projekcie. Etap ten jest opcjonalny, ponieważ wdrożyliśmy logowanie jednokrotne (SSO: *Single Sign-On*) między Panelem klienta OVHcloud a Horizon.
...
* Aby zalogować się za pomocą określonego użytkownika OpenStack: otwórz stronę logowania w witrynie [Horizon](https://horizon.cloud.ovh.net/auth/login/) i wprowadź wcześniej utworzone [identyfikatory OpenStack](create_and_delete_a_user1.), a następnie kliknij przycisk `Connect`{.action}.
...
![objętość](volumes2021.png){.thumbnail}
...
![orkiestracja](orchestration2021.png){.thumbnail}
