...
- Disporre di un [progetto Public Cloud](create_a_public_cloud_project1.) nel tuo account OVHcloud.
- **[Facoltativo da settembre 2023]** Un utente [OpenStack](create_and_delete_a_user1.) creato nel tuo progetto. Questo step è facoltativo in quanto abbiamo eseguito un’autenticazione unica (SSO: *Single Sign-On*) tra lo Spazio Cliente OVHcloud e Horizon.
...
* Per accedere con un utente OpenStack specifico: apri la pagina di accesso a [Horizon](https://horizon.cloud.ovh.net/auth/login/) e inserisci le [credenziali OpenStack](create_and_delete_a_user1.) precedentemente create, poi clicca su `Connect`{.action}.
...
![orchestrazione](orchestration2021.png){.thumbnail}
