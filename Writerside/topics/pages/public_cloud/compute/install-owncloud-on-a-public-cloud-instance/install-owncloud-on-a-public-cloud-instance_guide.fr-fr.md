...
* [Guide pour la création d'une Instance de Public Cloud](public-cloud-first-steps1.)
* [Guide de création du stockage d'objets sur la plate-forme de Public Cloud](pcs_create_container1.)
* [Guide de création et de configuration d'un disque supplémentaire sur une Instance de Public Cloud ](create_and_configure_an_additional_disk_on_an_instance1.)
...
![Écran de configuration](owncloud-setup-screen.png){.thumbnail}
...
Lire le guide d'utilisation de l’Object Storage pour ownCloud : [Object Storage pour ownCloud](pcs_configure_owncloud_with_object_storage1.){.external}.
...
Pour ce faire, il vous suffit de suivre les étapes de ce guide : [Créez un disque supplémentaire sur Public Cloud](create_and_configure_an_additional_disk_on_an_instance1.){.external}.

#### Étape 2: Configurer le disque supplémentaire
Pour ce faire, il vous suffit de suivre les étapes de ce guide : [Configurez un disque supplémentaire sur Public Cloud](create_and_configure_an_additional_disk_on_an_instance#depuis-une-instance-sous-linux.){.external}.
...
[Sauvegarde d'une instance](save_an_instance1.){.external}
