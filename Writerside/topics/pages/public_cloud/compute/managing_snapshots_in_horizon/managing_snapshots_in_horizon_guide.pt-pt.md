...
- Ter [criado uma instância Public Cloud](public-cloud-first-steps#3o-passo-criacao-de-uma-instancia.) na sua conta OVHcloud
- [Ter acesso à interface Horizon](introducing_horizon1.)
...
![Seleção da região](managing_snapshots_in_horizon_images_region2021.png){.thumbnail}
...
![Snapshot](createsnapshot.png){.thumbnail}
...
![Snapshot](createsnapshot2.png){.thumbnail}
