...
- Avoir [créé une instance Public Cloud](public-cloud-first-steps#etape-3-creer-une-instance.) dans votre compte OVHcloud
...
![Sélection de région](managing_snapshots_in_horizon_images_region2021.png){.thumbnail}
...
![Create snapshot](createsnapshot.png){.thumbnail}
...
![Create snapshot](createsnapshot2.png){.thumbnail}
