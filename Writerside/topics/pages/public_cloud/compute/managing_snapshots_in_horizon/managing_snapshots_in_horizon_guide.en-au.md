...
- An [OVHcloud Public Cloud instance](public-cloud-first-steps#create-instance.) 
...
![Region selection](managing_snapshots_in_horizon_images_region2021.png){.thumbnail}
