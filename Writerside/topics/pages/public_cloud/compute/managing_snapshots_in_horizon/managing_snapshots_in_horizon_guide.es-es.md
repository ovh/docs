...
- Haber [creado una instancia de Public Cloud](public-cloud-first-steps#3-crear-una-instancia.) en su cuenta de OVHcloud
...
![Selección de región](managing_snapshots_in_horizon_images_region2021.png){.thumbnail}
