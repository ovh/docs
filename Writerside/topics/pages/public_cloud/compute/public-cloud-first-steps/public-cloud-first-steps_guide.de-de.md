...
> [!primary]
>
> Gespeicherte SSH-Schlüssel ermöglichen es Ihnen, Ihre Instanzen schneller zu erstellen. Zur Änderung von Schlüsselpaaren oder zum späteren Hinzufügen von Benutzern folgen Sie der Anleitung “[Zusätzliche SSH-Schlüssel konfigurieren](configuring_additional_ssh_keys1.)”.
>
...
![Schlüssel hinzufügen](puttygen-04.png){.thumbnail}
...
> [!success]
>
Als beste Vorgehensweise erstellen Sie ein privates Netzwerk vor der Instanzerstellung. Weitere Informationen zum Erstellen eines privaten Netzwerks finden Sie in der Anleitung [vRack für Public Cloud konfigurieren](getting-started-07-creating-vrack1.).
>
...
![Instanz auswählen](instance-creation-2024.png){.thumbnail}
...
Weitere Informationen zu Local Zones finden Sie unter den folgenden Links: [Local Zone Compute](https://www.ovhcloud.com/de/public-cloud/local-zone-compute/) und [Local Zone Compute - Funktionen, Kapazitäten und Grenzen](local-zones-capabilities-limitations1.).
...
![Image auswählen](instance-creation-02-2023.png){.thumbnail}
...
![Schlüssel auswählen](instance-creation-03-2022.png){.thumbnail}

Im vierten Schritt können zusätzliche Optionen konfiguriert werden.

![Optionen auswählen](instance-creation-04-2022.png){.thumbnail}
...
Der Private Modus bietet Ihnen die Möglichkeit, Ihre Instanzen ausschließlich einem privaten Netzwerk zuzuweisen. Die Instanzen dieses Modus können dem öffentlichen Netzwerk nur mit einem Gateway oder Loadbalancer mit Floating IPs ausgesetzt werden. Weitere Informationen finden Sie in unserer Dokumentation zu den [Netzwerklösungen für die OVHcloud Public Cloud](public-cloud-network1.).
...
![Abrechnungsmethode auswählen](instance-creation-05-2022.png){.thumbnail}
...
![Instanzen-Seite](instance-connect-01.png){.thumbnail}
...
> [!primary]
>
Sollten Verbindungsprobleme auftreten, d. h. kommt es zu Fehlern mit Ihren SSH-Schlüsseln, lesen Sie bitte die Anleitung “[Änderung des SSH-Schlüssels bei Verlust](replacing_lost_ssh_key1.)”.
>

> [!primary]
>
Wenn Sie über die OVHcloud API oder das Interface von OpenStack Horizon eine Instanz ohne SSH-Schlüssel erstellt haben, können Sie Ihrer Instanz nur über den [Rescue-Modus](put_an_instance_in_rescue_mode1.) einen SSH-Schlüssel hinzufügen. Beachten Sie hierzu die Anweisungen in [diesem Abschnitt der entsprechenden Anleitung](replacing_lost_ssh_key#in-der-praktischen-anwendung.).
>
...
![Instanzen-Seite](instance-connect-02.png){.thumbnail}
...
![PuTTY verwenden](puttyconnect-01.png){.thumbnail}
...
[Public Cloud Quota erhöhen](increasing_public_cloud_quota1.)

[Von der stündlichen auf monatliche Abrechnung umstellen](changing_hourly_monthly_billing1.)
