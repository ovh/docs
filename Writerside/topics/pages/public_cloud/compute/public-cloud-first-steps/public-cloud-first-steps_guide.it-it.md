...
> [!primary]
>
Le chiavi SSH salvate ti consentono di creare più rapidamente le tue istanze. Per cambiare le coppie di chiavi e aggiungere utenti in un secondo momento, consulta la guida [Configura chiavi SSH aggiuntive](configuring_additional_ssh_keys1.).
>
...
> [!success]
>
> È preferibile creare una rete privata prima di procedere alla creazione di un’istanza. Per maggiori informazioni sulla creazione di una rete privata, consulta la guida [Configurazione della vRack sul Public Cloud](getting-started-07-creating-vrack1.).
>
...
> [!primary]
>
In caso di problemi di connessione, ad esempio errori relativi alle chiavi SSH, consulta la guida[Sostituisci la tua chiave SSH in caso di perdita](replacing_lost_ssh_key1.).
>

> [!primary]
>
Se hai creato un'istanza senza chiave SSH tramite l'API OVHcloud o l'interfaccia Openstack Horizon, puoi aggiungere una chiave SSH alla tua istanza solo attraverso [modalità rescue](put_an_instance_in_rescue_mode1.), seguendo le istruzioni descritte in [questa sezione della guida appropriata](replacing_lost_ssh_key#procedura.).
>
...
[Effettuare lo Snapshot di un’istanza](save_an_instance1.)

[Aumenta la quota del tuo Public Cloud](increasing_public_cloud_quota1.)

[Passare dalla fatturazione oraria a quella mensile](changing_hourly_monthly_billing1.)

[Configurare chiavi SSH aggiuntive](configuring_additional_ssh_keys1.)
