...
<br>Anschließend finden Sie Links zu [weiterführenden Wissensressourcen](00-essential-info-to-get-started-on-public-cloud_#gofurther.).
...
- [OVHcloud Kunden-Account erstellen](ovhcloud-account-creation1.)
- [Ihr erstes Public Cloud Projekt erstellen](create_a_public_cloud_project1.)
- [Einführung in das Public Cloud Interface](03-public-cloud-interface-walk-me1.)
- [Erste Instanz erstellen](public-cloud-first-steps1.)
- [Quota verwalten](increasing_public_cloud_quota1.)
...
![Public Cloud Ecosystem](ecosystem.png){.thumbnail}
...
![Public Cloud Geolocation](geolocation.png){.thumbnail}
...
Um zu starten benötigen Sie zunächst einen OVHcloud [Kunden-Account](ovhcloud-account-creation1.).

Erstellen Sie anschließend ein [Public Cloud Projekt](create_a_public_cloud_project1.). Ein Projekt ist eine Umgebung, die einem Kontext zugeordnet wird.
...
Da Ihr Zahlungsmittel hinterlegt ist, wird der berechnete Betrag [am Ende des Monats abgebucht](analyze_billing1.). Diese Berechnung erfolgt auf der Grundlage der Nutzungszeit der einzelnen Ressourcen und des Preises der Ressourcen.
...
<br>Diese Quotas werden nach Region zugeteilt (im Sinne von OpenStack). Es kann daher sein, dass Sie das Maximum an Ressourcen für Ihr Projekt erreichen und [diese Quotas erhöhen müssen](increasing_public_cloud_quota1.).

![Public Cloud quota](quota.png){.thumbnail}
...
- Wenn Sie die OpenStack- oder S3-APIs oder das Horizon-Interface verwenden möchten, müssen dafür [Benutzer erstellt werden](create_and_delete_a_user1.). Die Benutzer können gegebenenfalls eingeschränkte Rechte haben, um die Verwaltungsbereiche abzusichern.
- Wenn der Zugriff nicht die APIs oder Horizon beinhalten muss, können Sie dem Projekt auch [einen weiteren OVHcloud Kunden-Account hinzufügen](delegate_projects1.).
...
|---|---|
|[FAQ](faq_pci1.)|Die häufigsten Fragen zur Public Cloud.|
|[Glossar](introduction_about_instances1.)|Die Konzepte und Definitionen zur fortgeschrittenen Nutzung.|
...
|[Changelog](image_changelog1.)|Änderungslogs von öffentlich verfügbaren System-Images.|

Verwenden Sie folgende Anleitungen, um Informationen zum praktischen Vorgehen zu erhalten:

|Dokumentation|Beschreibung|
|---|---|
|[Erste Instanz erstellen](public-cloud-first-steps1.)|Praktische Anleitung zum Starten eines Cloud-Servers über das OVHcloud Kundencenter.|
|[Verwendung von SSH-Schlüsseln](public-cloud-first-steps#schritt-2-offentliche-schlussel-im-ovhcloud-kundencenter-speichern_1.)| Um sich mit einer Linux-Instanz zu verbinden, benötigen Sie eine SSH-Verbindung. In dieser Anleitung erfahren Sie, wie diese verwendet wird.|
|[Konfiguration des privaten Netzwerks](getting-started-07-creating-vrack1.)|Bei OVHcloud werden private Netzwerke mit der vRack Technologie eingesetzt. Diese Anleitung begleitet Sie bei der Umsetzung.|
|[Eine zusätzliche Disk mit einer Instanz verbinden](create_and_configure_an_additional_disk_on_an_instance1.)|In dieser Anleitung erfahren Sie, wie Sie zusätzlichen Storage zu Ihrer Instanz hinzufügen.|
|[Auf das Horizon-Interface zugreifen](introducing_horizon1.)|Das OpenStack Horizon Interface erlaubt einige erweiterte Einstellungen. Der Zugriff wird hier erklärt.|
|[Kubernetes-Cluster erstellen](creating-a-cluster1.) (EN) |Diese Anleitung begleitet Sie bei der Erstellung Ihres ersten Kubernetes-Clusters.|
|[Eine Additional IP konfigurieren](getting-started-04-configure-additional-ip-to-instance1.)|Mit Additional IPs können Sie den Traffic von einer Instanz auf eine andere umstellen. In dieser Anleitung erfahren Sie, wie Sie diesen konfigurieren.|
|[Verwendung von Horizon](introducing_horizon1.)|Horizon ist das klassische Interface von OpenStack. Diese Anleitung erklärt, wie Sie darauf zugreifen können.|
|[OpenStack CLI installieren](prepare_the_environment_for_using_the_openstack_api1.)|OpenStack kann auch über die Kommandozeile verwendet werden. Hier können Sie die Tools installieren.|
