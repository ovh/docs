...
|[Uso de una llave SSH](public-cloud-first-steps#2-guardar-las-claves-publicas-en-el-area-de-cliente-de-ovhcloud_1.)| Para conectarse a una instancia Linux, necesitará utilizar una conexión SSH en esta guía.|
