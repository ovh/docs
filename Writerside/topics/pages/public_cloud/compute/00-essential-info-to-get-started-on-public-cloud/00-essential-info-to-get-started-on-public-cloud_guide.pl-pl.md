...
<br>Wreszcie, proponujemy zasoby, aby [przejść dalej](00-essential-info-to-get-started-on-public-cloud_#gofurther.).
...
- [Otwórz konto OVHcloud](ovhcloud-account-creation1.)
- [Utwórz Twój pierwszy projekt Public Cloud](create_a_public_cloud_project1.)
- [Poznaj interfejs Public Cloud](03-public-cloud-interface-walk-me1.)
- [Utwórz pierwszą instancję](public-cloud-first-steps1.)
- [Zarządzanie limitami](increasing_public_cloud_quota1.)
...
![Public Cloud geolokalizacja](geolocation.png){.thumbnail}
...
Aby rozpocząć korzystanie z usługi, najpierw musisz mieć [konto klienta OVHcloud](ovhcloud-account-creation1.).

Następnie [utwórz projekt Public Cloud](create_a_public_cloud_project1.). Projekt to środowisko, które będziesz musiał określić jako kontekst.
...
Ponieważ Twój sposób płatności jest zarejestrowany, zostanie wykorzystany do pobrania kwoty obliczonej dla Twojego [fakturowania na koniec miesiąca](analyze_billing1.). Obliczenia te dokonuje się na podstawie czasu wykorzystania każdego zasobu, w zależności od ceny zasobów.
...
<br>Kwoty te są przyznawane według lokalizacji (region w rozumieniu OpenStack). Możliwe jest zatem, że osiągniesz maksymalny poziom zasobów projektu i [zwiększ limity](increasing_public_cloud_quota1.).
...
- Jeśli chcesz korzystać z interfejsu API OpenStack lub S3 lub interfejsu Horizon, musisz [utworzyć w tym celu użytkowników](create_and_delete_a_user1.). Użytkownicy mogą ewentualnie mieć ograniczone prawa, aby zabezpieczyć zakres działania.
- Jeśli nie potrzebujesz dostępu do API lub interfejsu Horizon, możesz [dołączyć do Twojego projektu inne konto klienta OVHcloud](delegate_projects1.).
...
|---|---|
|[FAQ](faq_pci1.)|Najczęstsze pytania dotyczące usługi Public Cloud.|
|[Słowniczek](introduction_about_instances1.)|Koncepcje i definicje, które będą potrzebne, aby iść naprzód.|
...
|[Zmiany obrazu](image_changelog1.)|Zmiany wprowadzone do obrazów systemowych dostępnych publicznie.|

W praktyce znajdziesz tutaj również przewodniki, które pomogą Ci zacząć:

|Dokumentacja|Szczegóły|
|---|---|
|[Utwórz pierwszą instancję](public-cloud-first-steps1.)|Pierwszy przewodnik dotyczący uruchomienia serwera cloud w Panelu klienta OVHcloud.|
|[Korzystanie z klucza SSH](public-cloud-first-steps#krok-2-przechowywanie-kluczy-publicznych-w-panelu-klienta-ovhcloud_1.)| Aby zalogować się do instancji Linux, zapoznaj się z tym przewodnikiem dotyczącym korzystania z tej instancji.|
|[Konfiguracja prywatnej sieci](getting-started-07-creating-vrack1.)|W OVHcloud prywatne sieci opierają się na technologii vRack. Niniejszy przewodnik pomaga Ci w uruchomieniu tej usługi.|
|[Przypisz dodatkowy dysk do instancji](create_and_configure_an_additional_disk_on_an_instance1.)|Niniejszy przewodnik wyjaśnia, jak dodać przestrzeń dyskową do Twojej pierwszej instancji.|
|[Dostęp do interfejsu Horizon](introducing_horizon1.)|Interfejs Horizon OpenStack pozwala na wykonywanie niektórych zaawansowanych operacji.|
|[Utwórz klaster Kubernetes](creating-a-cluster1.) (EN)|Niniejszy przewodnik ułatwi Ci realizację pierwszego klastra Kubernetes.|
|[Konfiguracja Additional IP](getting-started-04-configure-additional-ip-to-instance1.)|Adresy Additional IP pozwalają na przełączanie ruchu z jednej instancji na inną. Niniejszy przewodnik wyjaśnia, jak to skonfigurować.|
|[Korzystanie z interfejsu Horizon](introducing_horizon1.)|Horizon to klasyczny interfejs OpenStack, a ten przewodnik wyjaśni, jak uzyskać do niego dostęp.|
|[Instalacja CLI OpenStack](prepare_the_environment_for_using_the_openstack_api1.)|OpenStack może być również używany w wierszu poleceń. Oto jak zainstalować narzędzia.|
