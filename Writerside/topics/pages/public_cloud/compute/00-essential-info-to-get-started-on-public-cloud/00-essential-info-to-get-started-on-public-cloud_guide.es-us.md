...
<br>Por último, le proponemos recursos para [ir más lejos](00-essential-info-to-get-started-on-public-cloud_#gofurther.).
...
- [Abrir una cuenta de OVHcloud](ovhcloud-account-creation1.)
- [Cree su primer proyecto de Public Cloud](create_a_public_cloud_project1.)
- [Conocer la interfaz de Public Cloud](03-public-cloud-interface-walk-me1.)
- [Crear la primera instancia](public-cloud-first-steps1.)
- [Gestionar los límites](increasing_public_cloud_quota1.)
...
Para empezar, necesitará una [cuenta de cliente de OVHcloud](ovhcloud-account-creation1.).

A continuación, deberá [crear un proyecto de Public Cloud](create_a_public_cloud_project1.). Un proyecto es un entorno que va a dedicar a un contexto.
...
Al haber registrado su forma de pago, esta se utilizará para cargar el importe calculado para su [facturación a fin de mes](analyze_billing1.). Este cálculo se realiza en función del tiempo de uso de cada recurso, en función del precio de los recursos.
...
<br>Estas cuotas se asignan por localización (región en el sentido de OpenStack). Así pues, puede que consiga el máximo de recursos posible en su proyecto y que sea necesario [aumentar los límites](increasing_public_cloud_quota1.).
...
- Si quiere utilizar las API de OpenStack o S3, o la interfaz Horizon, deberá [crear usuarios](create_and_delete_a_user1.) para ello. Los usuarios pueden tener derechos limitados para proteger los perímetros de acción.
- Si no necesita acceder a las API o a Horizon, puede [asociar otra cuenta de cliente de OVHcloud](delegate_projects1.) a su proyecto.
...
|---|---|
|[FAQ](faq_pci1.)|Preguntas más frecuentes sobre Public Cloud.|
|[Valor](introduction_about_instances1.)|Conceptos y definiciones que necesitará para avanzar.|
...
|[Changelog des images](image_changelog1.)|Los cambios en las imágenes de sistema disponibles públicamente.|

En la práctica, a continuación le ofrecemos algunas guías que le ayudarán en el inicio:

|Documentación|Detalles|
|---|---|
|[Crear la primera instancia](public-cloud-first-steps1.)|Esta es la primera guía práctica para iniciar un servidor cloud desde el área de cliente de OVHcloud.|
|[Uso de una llave SSH](introducing_horizon1.)| Para conectarse a una instancia Linux, necesitará utilizar una conexión SSH en esta guía.|
|[Configuración de la red privada](getting-started-07-creating-vrack1.)|En OVHcloud, la tecnología vRack utiliza las redes privadas. Esta guía le ayudará a realizar esta operación.|
|[Asociar un disco adicional a una instancia](create_and_configure_an_additional_disk_on_an_instance1.)|Esta guía explica cómo añadir almacenamiento adicional a la primera instancia de OVH.|
|[Conectarse a Horizon](introducing_horizon1.)|La interfaz Horizon de OpenStack permite realizar determinadas acciones avanzadas. Así es como conectarse a ella.|
|[Crear un cluster Kubernetes](creating-a-cluster1.) (EN)|Esta guía le ayudará paso a paso a la creación de su primer cluster Kubernetes.|
|[Configurar una Additional IP](getting-started-04-configure-additional-ip-to-instance1.)|Las Additional IP permiten cambiar el tráfico de una instancia a otra. Esta guía explica cómo configurar esta opción.|
|[Uso de la interfaz Horizon](introducing_horizon1.)|Horizon es la interfaz clásica de OpenStack, y esta guía explicará cómo acceder a ella.|
|[Instalación de la CLI OpenStack](prepare_the_environment_for_using_the_openstack_api1.)|OpenStack también puede utilizarse en línea de comandos. Así es como instalar las herramientas.|
