...
![seleziona il progetto](avolume01.png){.thumbnail}
...
![configura disk](avolume03.png){.thumbnail}
...
Apri una [connessione SSH alla tua istanza](public-cloud-first-steps#connect-to-instance.) e utilizza il comando qui sotto per visualizzare i dischi associati.
...
![volume sconosciuto](disk-management-01.png){.thumbnail}

Se il disco è indicato come offline, deve prima essere avviato. Per farlo, puoi utilizzare l'[interfaccia utente Windows](create_and_configure_an_additional_disk_on_an_instance_#initDiskManagement.) o l'[utility DISKPART](create_and_configure_an_additional_disk_on_an_instance_#initDiskpart.). Altrimenti, esegui la [formattazione del disco nella gestione dei dischi](create_and_configure_an_additional_disk_on_an_instance_#formatDiskManagement.).
...
![run promo](run-prompt.png){.thumbnail}
...
Apri una [connessione SSH alla tua istanza](public-cloud-first-steps#step-3-crea-unistanza.) e utilizza il comando qui sotto per visualizzare i dischi associati.
...
![gestione dei dischi](start-menu.png){.thumbnail}
...
[Aumenta la dimensione di un disco aggiuntivo](increase_the_size_of_an_additional_disk1.)
