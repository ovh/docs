...
![selecione o projeto](avolume01.png){.thumbnail}
...
![creme disk](avolume02.png){.thumbnail}

O novo disco aparecerá na Área de Cliente.

![configurar disk](avolume03.png){.thumbnail}
...
Abra uma [ligação SSH à sua instância](public-cloud-first-steps#connect-to-instance.) e utilize o comando abaixo para listar os discos ligados.
...
![volume desconhecido](disk-management-01.png){.thumbnail}

Se o disco for indicado como estando fora de linha, deve ser iniciado. Para isso, pode utilizar a [interface de utilizador Windows](create_and_configure_an_additional_disk_on_an_instance_#initDiskManagement.) ou o [utilitário DISKPART](create_and_configure_an_additional_disk_on_an_instance_#initDiskpart.). Caso contrário, faça a [formatação do disco na Gestão dos discos](create_and_configure_an_additional_disk_on_an_instance_#formatDiskManagement.).
...
Abra uma [ligação SSH à sua instância](public-cloud-first-steps#etapa-3-criacao-de-uma-instancia.) e utilize o comando abaixo para listar os discos ligados.
...
![disk](detachinstance.png){.thumbnail}

Clique em `Confirmar`{.action} na nova janela para lançar o processo.

![confirma disk detach](confirminstancedetach.png){.thumbnail}
...
![gestão dos discos](start-menu.png){.thumbnail}
...
![confirma remove disk](confirmunmounting.png){.thumbnail}
...
[Aumentar o tamanho de um disco adicional](increase_the_size_of_an_additional_disk1.)
