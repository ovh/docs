...
![sélectionner le projet](avolume01.png){.thumbnail}
...
Ouvrez une [connexion SSH à votre instance](public-cloud-first-steps#etape-4-connexion-a-votre-instance.), puis utilisez la commande ci-dessous pour lister les disques attachés.
...
![volume inconnu](disk-management-01.png){.thumbnail}

Si le disque est indiqué ici comme étant hors-ligne, il doit d'abord être initialisé. Pour ce faire, vous pouvez utiliser l'[interface utilisateur Windows](create_and_configure_an_additional_disk_on_an_instance_#initDiskManagement.) ou l'[utilitaire DISKPART](create_and_configure_an_additional_disk_on_an_instance_#initDiskpart.). Sinon, procédez au [formatage du disque dans Gestion des disques](create_and_configure_an_additional_disk_on_an_instance_#formatDiskManagement.).
...
![Alt text](initialize_disk.png){.thumbnail}
...
Ouvrez une [connexion SSH à votre instance](public-cloud-first-steps#etape-3-creer-une-instance.) puis utilisez la commande ci-dessous pour lister les disques attachés.
...
![gestion des disques](start-menu.png){.thumbnail}
