...
![Projekt auswählen](avolume01.png){.thumbnail}
...
Stellen Sie eine [SSH-Verbindung](public-cloud-first-steps#connect-to-instance.) zur Instanz her und verwenden Sie den folgenden Befehl, um die eingehängten Disks aufzulisten.
...
![Volume](disk-management-01.png){.thumbnail}

Wird die Disk als `Offline` angezeigt, muss sie zuerst initialisiert werden. Sie können hierzu das [Windows GUI](create_and_configure_an_additional_disk_on_an_instance_#initDiskManagement.) oder das [DISKPART Tool](create_and_configure_an_additional_disk_on_an_instance_#initDiskpart.) verwenden. Falls nicht, [formatieren Sie nun die Disk in der Datenträgerverwaltung](create_and_configure_an_additional_disk_on_an_instance_#formatDiskManagement.).
...
![Disk-Initialisierung](initialize_disk.png){.thumbnail}
...
![Disk Format](format-disk-01.png){.thumbnail}
...
![Disk Detach](confirminstancedetach.png){.thumbnail}
...
![Datenträgerverwaltung](start-menu.png){.thumbnail}
...
![remove disk](confirmunmounting.png){.thumbnail}
