...
- You need to have created a Public Cloud instance in your [OVHcloud Control Panel](public-cloud-first-steps1.) or through the [Horizon interface](create_instance_in_horizon1.)
- [An SSH key](public-cloud-first-steps#step-1-creating-ssh-keys.)
...
This option allows you to create an instance. Please refer to [this guide](create_instance_in_horizon1.) for more information.
...
**Create snapshot**: This option allows you to create a snapshot of your instance. Consult [this guide](managing_snapshots_in_horizon1.) for more information.
...
- Attach Interface: This option allows you to add one or more private interfaces to your instance via the VLAN. For more information, refer to [this section](getting-started-07-creating-vrack#adding-a-private-interface.) of the corresponding guide.
- Detach Interface: This option allows you to delete an interface linked to an instance. For more information, refer to [this section](getting-started-07-creating-vrack#removing-a-private-interface.) of the corresponding guide.
- Edit Instance: This option allows you to change the instance name and [security groups](setup_security_group1.).
...
To find out how to shelve or pause an instance, please refer to [this guide](suspend_or_pause_an_instance1.).
...
> Consult [this guide](become_root_and_change_password1.) for more information.
