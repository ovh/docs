...
- Ter criado uma instância Public Cloud a partir da [Área de Cliente OVHcloud](public-cloud-first-steps1.) ou através da [interface Horizon](create_instance_in_horizon1.).
- [Ter criado uma chave SSH](public-cloud-first-steps#1o-passo-criacao-de-chaves-ssh.).
...
Esta opção permite-lhe criar uma instância. Para mais informações, consulte [este guia](create_instance_in_horizon1.).
...
**Create Snapshot**: Esta opção permite criar uma snapshot (instantânea) da sua instância. Para mais informações, consulte [este guia](managing_snapshots_in_horizon1.).
...
- Attach Interface: esta opção permite adicionar uma ou várias interfaces privadas à sua instância através da VLAN. Para mais informações, consulte [esta parte](getting-started-07-creating-vrack#adicao-de-uma-interface-privada.) do guia correspondente.
- Detach Interface: esta opção permite eliminar uma interface associada a uma instância. Para mais informações, consulte [esta parte](getting-started-07-creating-vrack#eliminacao-de-uma-interface-privada.) do guia correspondente.
- Edit Instance: esta opção permite alterar o nome da instância e os [grupos de segurança](setup_security_group1.).
...
Para saber como suspender ou colocar em pausa uma instância, clique [aqui](suspend_or_pause_an_instance1.) para consultar o guia específico deste método.
...
> Para mais informações, consulte [este guia](become_root_and_change_password1.).
