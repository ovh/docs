...
- Haber creado una instancia de Public Cloud desde el [área de cliente de OVHcloud](public-cloud-first-steps1.) o a través de la [interfaz de Horizon](create_instance_in_horizon1.).
- [Haber creado una llave SSH](public-cloud-first-steps#1-crear-claves-ssh.).
...
Esta opción le permite crear una instancia. Para más información, consulte [esta guía](create_instance_in_horizon1.).
...
**Create Snapshot** : Esta opción permite crear un snapshot (instantáneo) de la instancia. Para más información, consulte [esta guía](managing_snapshots_in_horizon1.).
...
- Attach Interface: esta opción permite añadir una o más interfaces privadas a su instancia a través de la VLAN. Para más información, consulte [esta parte](getting-started-07-creating-vrack#anadir-una-interfaz-privada.) de la guía correspondiente.
- Detach Interface: esta opción permite eliminar una interfaz vinculada a una instancia. Para más información, consulte [esta parte](getting-started-07-creating-vrack#eliminacion-de-una-interfaz-privada.) de la guía correspondiente.
- Edit Instance : esta opción permite cambiar el nombre de la instancia y los [grupos de seguridad](setup_security_group1.).
...
Para saber cómo suspender o poner en pausa una instancia, haga clic [aquí](suspend_or_pause_an_instance1.) para consultar la guía específica sobre este método.
...
> Para más información, consulte [esta guía](become_root_and_change_password1.).
