...
- Avoir créé une instance Public Cloud depuis votre [espace client OVHcloud](public-cloud-first-steps1.) ou à travers l'[interface Horizon](create_instance_in_horizon1.).
- [Avoir créé une clé SSH](public-cloud-first-steps#etape-1-creer-des-cles-ssh.).
...
![public-cloud](options2022.png){.thumbnail}

**Launch Instance** 

Cette option vous permet de créer une instance. Consultez [ce guide](create_instance_in_horizon1.) pour plus d'informations.
...
**Create Snapshot** : Cette option permet de créé un snapshot (instantané) de votre instance. Consultez [ce guide](managing_snapshots_in_horizon#creation-du-snapshot.) pour plus d'informations.
...
- Attach Interface : cette option permet d'ajouter une ou plusieurs interfaces privées à votre instance via le VLAN. Pour plus d'informations, consultez [cette partie](getting-started-07-creating-vrack#ajout-dune-interface-privee.) du guide correspondant.
- Detach Interface : cette option permet de supprimer une interface liée à une instance. Pour plus d'informations, consultez [cette partie](getting-started-07-creating-vrack#suppression-dune-interface-privee.) du guide correspondant.
- Edit Instance : cette option permet de changer le nom de l'instance et les [groupes de sécurité](setup_security_group1.).
...
Pour savoir comment suspendre ou mettre en pause une instance, cliquez [ici](suspend_or_pause_an_instance1.) pour consulter le guide spécifique à cette méthode.
...
> Consultez [ce guide](become_root_and_change_password1.) pour plus d'informations.
