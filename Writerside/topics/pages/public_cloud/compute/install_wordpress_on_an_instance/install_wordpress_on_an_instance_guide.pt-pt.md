...
- Ter uma [instância Public Cloud](public-cloud-first-steps1.) com Debian ou Ubuntu instalado.
...
Para mais informações, consulte o guia [Editar a sua zona DNS](dns_zone_edit1.). Se o domínio estiver a ser utilizado atualmente, só pode configurar os DNS após a instalação do novo WordPress e o arranque do seu website.
...
Abra um navegador Web e ligue-se ao site WordPress introduzindo o endereço IP da sua instância (ou o nome de domínio se já tiver [ligado um à instância](dns_zone_edit1.)). Escolha uma língua na primeira página.
