...
- Avoir une [instance Public Cloud](public-cloud-first-steps1.) avec Debian ou Ubuntu installé
...
Consultez le guide [Éditer sa zone DNS](dns_zone_edit1.) pour en savoir plus. Si le nom de domaine est actuellement utilisé, ne configurez les DNS qu'après l'installation du nouveau WordPress et le démarrage de votre site web.
...
Ouvrez un navigateur Web et connectez-vous au site WordPress en saisissant l'adresse IP de votre instance (ou le nom de domaine si vous en avez déjà [relié un à l'instance](dns_zone_edit1.)). Choisissez une langue sur la première page.
