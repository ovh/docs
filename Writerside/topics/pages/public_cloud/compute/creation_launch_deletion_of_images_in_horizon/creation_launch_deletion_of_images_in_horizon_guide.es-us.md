...
![](horizon_create_image.png){.thumbnail}
...
![](horizon_image_saving.png){.thumbnail}

Haciendo clic en el nombre de la imagen, se muestra el detalle.

![](horizon_image_details.png){.thumbnail}
...
![](horizon_launch_image.png){.thumbnail}
...
![](horizon_delete_image.png){.thumbnail}
