...
- An [OpenStack CLI ready environment](prepare_the_environment_for_using_the_openstack_api1.) (if using CLI)

## Instructions

### Before starting

It is advisable to either use cloud-ready images already provided by the distribution vendor or build your own image using solutions such as [Packer OpenStack builder](create_image_from_existing_image_with_packer1.).
