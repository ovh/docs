...
- eine [Public Cloud](public-cloud-first-steps#schritt-3-instanz-erstellen.) Instanz in Ihrem OVHcloud Kundencenter
- Ihr eigenes RAW/QCOW2 Image (empfohlene Formate) 
- einem OpenStack-[Benutzer](create_and_delete_a_user1.) 
- einer OpenStack [CLI ready Umgebung](prepare_the_environment_for_using_the_openstack_api1.) (wenn Sie CLI verwenden)

## In der praktischen Anwendung

### Vorbereitung

Es wird empfohlen, *cloud-ready* Images der Anbieter zu verwenden oder Ihr eigenes Image mit Lösungen wie [OpenStack Builder zu erstellen](create_image_from_existing_image_with_packer1.).
