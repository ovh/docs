...
La liste des produits OVHcloud certifiés est disponible sur la page « [OVHcloud products HDS certification](hds_certification1.) ».
...
![activer HDS nouveau projet](hds-new-project.png){.thumbnail}
...
![activer HDS projet existant](hds-current-project.png){.thumbnail}

## Aller plus loin

[Documentation Public Cloud](public-cloud-compute1.)
