...
- [Preparar el entorno para utilizar la API OpenStack](prepare_the_environment_for_using_the_openstack_api1.) instalando python-cinderclient y python-novaclient
