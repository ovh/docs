...
- [Przygotowanie środowiska do korzystania z API OpenStack](prepare_the_environment_for_using_the_openstack_api1.) poprzez instalację Python-cinderclient oraz python-novaclient
