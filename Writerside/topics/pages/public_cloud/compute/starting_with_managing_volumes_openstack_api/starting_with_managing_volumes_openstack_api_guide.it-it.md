...
- [Preparare l'ambiente per utilizzare l'API OpenStack](prepare_the_environment_for_using_the_openstack_api1.) installando python-cinderclient e python-novaclient
