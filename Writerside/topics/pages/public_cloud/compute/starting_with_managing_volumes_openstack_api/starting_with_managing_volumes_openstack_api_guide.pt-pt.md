...
- [Preparar o ambiente para utilizar a API OpenStack](prepare_the_environment_for_using_the_openstack_api1.) instalando pithon-cinderclient e python-novaclient
