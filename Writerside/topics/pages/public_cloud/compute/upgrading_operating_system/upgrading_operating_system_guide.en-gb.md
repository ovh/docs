...
> Therefore, OVHcloud strongly recommends to [backup your instance](save_an_instance1.) and conduct extensive testing on your applications to make sure they work on the new operating system version prior to following this tutorial.
>
...
- [Root access](become_root_and_change_password1.) to the server
- [Backup](save_an_instance1.) must be taken before starting
...
Now verify if your applications are working as expected. In case there are issues, we recommend [restoring your backup](create_restore_a_virtual_server_with_a_backup1.) that was taken prior to the upgrade.
...
Verify if your applications are working as expected. In case there are issues, we recommend [restoring your backup](create_restore_a_virtual_server_with_a_backup1.) that was taken prior to the upgrade.
