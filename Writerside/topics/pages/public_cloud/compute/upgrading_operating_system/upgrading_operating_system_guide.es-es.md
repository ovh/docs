...
> Por lo tanto, antes de seguir este tutorial, OVHcloud le recomienda encarecidamente que [guarde su instancia](save_an_instance1.) y realice pruebas en profundidad de sus aplicaciones para asegurarse de que funcionan en la nueva versión del sistema operativo.
>
...
- Tener un [acceso root al servidor.](become_root_and_change_password1.)
- Haber realizado [una copia de seguridad de la instancia.](save_an_instance1.)
...
Compruebe que sus aplicaciones funcionen según lo previsto. Si necesita ayuda, le recomendamos que [restaure la copia de seguridad](create_restore_a_virtual_server_with_a_backup1.) realizada antes de la actualización.
...
Compruebe que sus aplicaciones funcionan según lo previsto. Si necesita ayuda, le recomendamos que [restaure la copia de seguridad](create_restore_a_virtual_server_with_a_backup1.) realizada antes de la actualización.
