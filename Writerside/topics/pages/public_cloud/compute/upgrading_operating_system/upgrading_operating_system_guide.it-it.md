...
> Pertanto, prima di seguire questo tutorial, OVHcloud raccomanda vivamente di [salvare l'istanza](save_an_instance1.) e di effettuare test approfonditi sulle applicazioni, per assicurarti che funzionino sulla nuova versione del sistema operativo.
>
...
- Avere un [accesso root al server](become_root_and_change_password1.)
- Aver effettuato [un backup della tua istanza](save_an_instance1.)
...
Verifica che le tue applicazioni funzionino come previsto. In caso di problemi, ti consigliamo di [ripristinare il backup](create_restore_a_virtual_server_with_a_backup1.) prima dell'aggiornamento.
