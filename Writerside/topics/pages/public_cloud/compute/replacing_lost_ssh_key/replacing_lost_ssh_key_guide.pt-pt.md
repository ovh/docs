...
Para recuperar o acesso, disponibilizámos-lhe um [modo de rescue](put_an_instance_in_rescue_mode1.) que lhe permite ligar-se através de uma palavra-passe e depois modificar os seus ficheiros.
...
- Ter acesso à sua instância via SSH em [modo rescue](put_an_instance_in_rescue_mode1.)
- Criar uma chave SSH
...
Depois de montar o disco da sua instância em [modo rescue](put_an_instance_in_rescue_mode#aceder-a-sua-informacao.), poderá aceder ao conjunto dos seus ficheiros.
