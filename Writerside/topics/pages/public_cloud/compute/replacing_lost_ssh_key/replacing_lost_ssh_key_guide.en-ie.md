...
To regain access, we have provided you with a [rescue mode](put_an_instance_in_rescue_mode1.), which allows you to log in with a password and then change your files.
...
[Become root and select a password](first_steps_with_public_cloud_instance1.)
