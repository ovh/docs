...
After mounting your instance's disk in [rescue mode](put_an_instance_in_rescue_mode1.), you will be able to access all your files. The file containing your SSH keys is shown below:
...
[Become root and select a password](become_root_and_change_password1.)
