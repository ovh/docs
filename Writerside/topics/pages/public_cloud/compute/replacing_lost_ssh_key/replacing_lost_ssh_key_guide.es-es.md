...
Para recuperar el acceso, hemos puesto a su disposición un [modo de rescate](put_an_instance_in_rescue_mode1.) que le permite conectarse con una contraseña y modificar sus archivos.
...
- Tener acceso a su instancia a través de SSH en [modo de rescate](put_an_instance_in_rescue_mode1.)
- Crear una llave SSH
...
Una vez que haya montado el disco de su instancia en [modo de rescate](put_an_instance_in_rescue_mode#acceso-a-sus-datos.), podrá acceder a todos sus archivos.
...
[Convertirse en el usuario root y establecer una contraseña](become_root_and_change_password1.)
