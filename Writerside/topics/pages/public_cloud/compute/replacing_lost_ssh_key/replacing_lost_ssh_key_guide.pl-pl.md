...
Aby odzyskać dostęp, udostępniliśmy [tryb Rescue](put_an_instance_in_rescue_mode1.), który pozwala na zalogowanie się przy użyciu hasła i na zmianę plików.
...
- Dostęp do Twojej instancji przez SSH w [tryb Rescue](put_an_instance_in_rescue_mode1.)
- Utwórz klucz SSH
...
Po zamontowaniu dysku Twojej instancji w [trybie Rescue](put_an_instance_in_rescue_mode#dostep-do-danych.), będziesz mógł uzyskać dostęp do wszystkich Twoich plików.
...
[Zostań użytkownikiem root i wybierz hasło](become_root_and_change_password1.)
