...
Découvrez comment utiliser les sauvegardes pour cloner ou restaurer des instances dans [ce guide](create_restore_a_virtual_server_with_a_backup1.).

## Aller plus loin

[Créer / restaurer un serveur virtuel a partir d’une sauvegarde](create_restore_a_virtual_server_with_a_backup1.)
