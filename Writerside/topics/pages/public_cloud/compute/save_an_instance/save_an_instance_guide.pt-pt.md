...
Saiba como utilizar os backups para clonar ou restaurar instâncias neste [guia](create_restore_a_virtual_server_with_a_backup1.).

## Quer saber mais?

[Criar/restaurar um servidor virtual a partir de um backup](create_restore_a_virtual_server_with_a_backup1.)
