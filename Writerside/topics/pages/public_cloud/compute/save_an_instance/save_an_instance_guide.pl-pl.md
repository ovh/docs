...
Dowiedz się, jak w [tym przewodniku](create_restore_a_virtual_server_with_a_backup1.) wykorzystać kopie zapasowe do klonowania lub przywracania instancji.

## Sprawdź również

[Tworzenie/ przywracanie serwera wirtualnego na podstawie kopii zapasowej](create_restore_a_virtual_server_with_a_backup1.)
