...
Find out how to use backups to clone or restore instances in [this guide](create_restore_a_virtual_server_with_a_backup1.).

## Go further

[Using instance backups to create or restore an instance](create_restore_a_virtual_server_with_a_backup1.)
