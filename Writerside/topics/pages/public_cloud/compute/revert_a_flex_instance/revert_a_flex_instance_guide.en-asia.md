...
- An [OVHcloud Public Cloud instance](public-cloud-first-steps#step-3-creating-an-instance.) with the flex option
...
![New flavor applied](newflavor.png){.thumbnail}
...
Alternatively, you can [edit the configuration of the instance](first_steps_with_public_cloud_instance#edit-the-configuration-of-an-instance.) in the OVHcloud Control Panel.
