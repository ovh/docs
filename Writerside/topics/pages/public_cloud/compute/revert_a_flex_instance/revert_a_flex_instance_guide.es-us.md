...
- Tener una [instancia de Public Cloud de OVHcloud](public-cloud-first-steps#3-crear-una-instancia.) de tipo *flex*.
- [Crear un acceso a Horizon](introducing_horizon1.).
...
![Selección de región](revert_a_flex_instance_images_region2021.png){.thumbnail}
...
![Redimensionar instancia](images_resizeinstance2021.png){.thumbnail}
...
![Elegir un nuevo flavor](confirmflavor.png){.thumbnail}
...
![Nuevo flavor aplicado](newflavor.png){.thumbnail}
...
También puede [editar la configuración de una instancia](first_steps_with_public_cloud_instance#editar-la-configuracion-de-una-instancia.) desde el área de cliente.
