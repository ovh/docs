...
- Posiadanie [instancji Public Cloud](public-cloud-first-steps#krok-3-tworzenie-instancji.) typu *flex*
- [Utworzenie dostępu do interfejsu Horizon](introducing_horizon1.)
...
![Wybór regionu](revert_a_flex_instance_images_region2021.png){.thumbnail}
...
![Zmień rozmiar instancji](images_resizeinstance2021.png){.thumbnail}
...
![Wybierz nową](confirmflavor.png){.thumbnail}
...
![Nowa aplikacja](newflavor.png){.thumbnail}
...
Możesz również [edycja-konfiguracji-instancji](first_steps_with_public_cloud_instance#edycja-konfiguracji-instancji.) w Panelu klienta.
