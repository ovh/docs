...
- Posséder une [instance Public Cloud OVHcloud](public-cloud-first-steps#etape-3-creer-une-instance.) de type *flex*.
- [Créer un accès à l'interface Horizon](introducing_horizon1.)
...
![Sélection de région](revert_a_flex_instance_images_region2021.png){.thumbnail}
...
![Redimensionner instance](images_resizeinstance2021.png){.thumbnail}
...
![Choisir une nouvelle flavor](confirmflavor.png){.thumbnail}
...
![Nouvelle flavor appliquée](newflavor.png){.thumbnail}
...
Vous pouvez également [modifier la configuration de l'instance](first_steps_with_public_cloud_instance#modifier-la-configuration-dune-instance.) depuis votre espace client.
