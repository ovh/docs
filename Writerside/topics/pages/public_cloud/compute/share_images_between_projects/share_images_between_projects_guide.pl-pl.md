...
Czasami może być konieczne współdzielenie obrazu [Instance Backup](save_an_instance1.) lub obrazu [Volume Backup](volume-backup1.) między kilkoma projektami Public Cloud.
...
[Przeniesienie kopii zapasowej instancji do innego centrum danych](transfer_instance_backup_from_one_datacentre_to_another1.).
