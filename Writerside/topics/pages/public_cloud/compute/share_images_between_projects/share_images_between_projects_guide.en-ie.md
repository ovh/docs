...
A situation may arise where you need to share an [Instance backup](save_an_instance1.) image or a [Volume backup](volume-backup1.) image between several Public Cloud projects.
...
- an [OpenStack user](create_and_delete_a_user1.)
...
[Transfer an instance backup from one datacentre to another](transfer_instance_backup_from_one_datacentre_to_another1.).
