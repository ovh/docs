...
Il peut arriver que vous deviez partager une image [Instance backup](save_an_instance1.) ou une image [Volume backup](volume-backup1.) entre  plusieurs projets Public Cloud.
...
- [Préparer l’environnement à l’utilisation de l’API OpenStack](prepare_the_environment_for_using_the_openstack_api1.)

Vous aurez également besoin de :

- posséder une [Instance Public Cloud](https://www.ovhcloud.com/fr/public-cloud/) dans votre compte OVHcloud ;
- Un utilisateur [OpenStack](create_and_delete_a_user1.) créé dans votre projet ;
...
[Transférer la sauvegarde d'une instance d'un datacenter à un autre](transfer_instance_backup_from_one_datacentre_to_another1.).
