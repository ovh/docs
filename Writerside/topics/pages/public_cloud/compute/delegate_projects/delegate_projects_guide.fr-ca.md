...
Vous pouvez cliquer sur les boutons `Modifier`{.action} pour changer les contacts actuels. Suivez les instructions décrites dans notre guide « [Changer les contacts d’un projet](change_project_contacts1.) » afin de finaliser cette manipulation.
...
[Démarrer avec une instance Public Cloud](public-cloud-first-steps1.)

[Informations concernant le mode de facturation Public Cloud](analyze_billing1.)

[Paramètres d’accès et de sécurité dans Horizon](access_and_security_in_horizon1.)
