...
Pode clicar nos botões `Alterar`{.action} para alterar os contactos atuais. Para finalizar esta operação, siga as instruções descritas no nosso manual "[Alterar os contactos de um projeto](change_project_contacts1.)".
...
[Iniciar com uma instância Public Cloud](public-cloud-first-steps1.)

[Informações sobre o método de faturação Public Cloud](analyze_billing1.)

[Parâmetros de acesso e de segurança no Horizon](access_and_security_in_horizon1.)
