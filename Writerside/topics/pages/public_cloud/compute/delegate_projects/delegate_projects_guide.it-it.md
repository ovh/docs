...
Clicca sui pulsanti `Modifica`{.action} per modificare i contatti correnti. Per completare l'operazione, segui la procedura descritta nella guida [Modificare i contatti di un progetto](change_project_contacts1.).
...
[Iniziare a utilizzare un'istanza Public Cloud](public-cloud-first-steps1.)

[Informazioni sulle modalità di fatturazione Public Cloud](analyze_billing1.)

[Impostazioni di accesso e sicurezza in Horizon](access_and_security_in_horizon1.)
