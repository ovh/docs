...
- Uma [instância Public Cloud ](public-cloud-first-steps#3o-passo-criacao-de-uma-instancia.) na sua conta OVHcloud
...
Em primeiro lugar, estabelecer uma [ligação SSH](public-cloud-first-steps#4o-passo-conexao-a-instancia.) ao seu servidor com o seu utilizador predefinido.
