...
* [Avoir créé une instance Public Cloud dans votre compte](public-cloud-first-steps#etape-3-creer-une-instance.)
...
Pour commencer, établissez une [connexion SSH](public-cloud-first-steps#etape-4-connexion-a-votre-instance.) à votre serveur avec votre utilisateur par défaut.
...
![Supprimer la clé privée](pageantkeylist.png){.thumbnail}
