...
- Instancja [Public Cloud](public-cloud-first-steps#krok-3-tworzenie-instancji.) na Twoim koncie OVHcloud.
...
2. Następnie użyj [tego połączenia API](applicationAccess#POST.)
...
Jeśli Twoja domena jest zarejestrowana w OVHcloud, możesz postępować zgodnie z [tym przewodnikiem](dns_zone_edit1.).
