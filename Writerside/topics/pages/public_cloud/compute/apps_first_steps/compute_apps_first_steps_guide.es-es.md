...
- Una [instancia de Public Cloud](public-cloud-first-steps#3-crear-una-instancia.) en su cuenta de OVHcloud.
...
2. Utilice a continuación [esta llamada a la API](applicationAccess#POST.).
...
Si su dominio está registrado en OVHcloud, puede seguir [esta guía](dns_zone_edit1.).
