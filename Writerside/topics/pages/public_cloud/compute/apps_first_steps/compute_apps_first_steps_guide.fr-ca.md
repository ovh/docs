...
- Une [instance Public Cloud](public-cloud-first-steps#etape-3-creer-une-instance.) dans votre compte OVHcloud.
...
2. Utilisez ensuite [cet appel API](%7BinstanceId%7D_applicationAccess#POST.)
