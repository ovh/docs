...
2. Verwenden Sie anschließend [diesen API Call](applicationAccess#POST.).
...
![cPanel](apps_first_steps_images_change_root.png){.thumbnail}
...
>> Ja, das können Sie. Stellen Sie sicher, dass Sie bei Ihrem Registrar für Ihre Domain “GLUE” Einträge erstellen. Wenn Sie zum Beispiel “ns1.mydomain.com” und “ns2.mydomain.com” wünschen, müssen Sie “GLUE” Einträge konfigurieren, damit beide auf die IP-Adresse Ihres Servers zeigen. Wenn Ihre Domain bei OVHcloud registriert ist, folgen Sie [dieser Anleitung](glue_registry#schritt-1-glue-eintrage-hinzufugen.). Bitte beachten Sie, dass die Erstellung 24 Stunden dauern kann.
