...
> [!primary]
>
> Ce guide s'applique uniquement aux instances Metal. Pour accéder au mode rescue pour tous les autres types d'instances, suivez [ce guide principal](put_an_instance_in_rescue_mode1.).

## Prérequis

- Un [projet Public Cloud](https://www.ovhcloud.com/fr/public-cloud/) dans votre compte OVHcloud.
- Une [instance Metal Public Cloud](public-cloud-first-steps1.) dans votre projet.
