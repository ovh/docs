...
- Uma [instância Public Cloud](public-cloud-first-steps1.) no seu projeto
...
A nova página que aparece apresenta uma versão modificada das opções [de criação de instância](public-cloud-first-steps1.), na qual pode modificar os seguintes elementos:
...
- **Modificar o modelo**: pode alterar o modelo de instância. Para mais informações sobre as opções, consulte [este manual](public-cloud-first-steps#3o-passo-criacao-de-uma-instancia.).
- **Alterar o período de faturação**: pode alterar o período de faturação da instância de uma faturação à hora para uma faturação mensal. Para mais informações, consulte [este guia](changing_hourly_monthly_billing1.).

#### Criar um backup de uma instância

Clique em `Criar um backup`{.action}.

Para mais informações, consulte o manual "[Guardar uma instância](save_an_instance1.)". 

#### Criar um backup automático de uma instância

Clique em `Criar um backup automatizado`{.action}.

Para mais informações, consulte o manual "[Guardar uma instância](save_an_instance#criar-um-backup-automatizado-de-uma-instancia.)".

#### Parar uma Instância

Clique em `Parar`{.action}.

Isto colocará a instância no estado `Apagada`, mas continuará a ser-lhe cobrado o mesmo preço pela sua instância. Para mais informações, consulte o nosso manual "[Suspender ou colocar em pausa uma instância](suspend_or_pause_an_instance#parar-suspend-uma-instancia.)".
...
Isto irá ativar o modo de rescue da instância. Consulte o nosso manual [Passar uma instância em modo de rescue](put_an_instance_in_rescue_mode1.) para obter informações detalhadas.
...
Isto colocará a instância no estado "*shelved*", apresentado aqui como `Suspensa`. Consulte o nosso manual "[Suspender ou colocar em pausa uma instância](suspend_or_pause_an_instance#suspender-shelve-uma-instancia.)" para obter mais informações sobre os diferentes estados de suspensão de uma instância.
...
Para mais informações, consulte o nosso manual "[Criação e conexão a uma primeira instância Public Cloud](public-cloud-first-steps#connect-to-instance.)".

## Quer saber mais?

[Criação e conexão a uma primeira instância Public Cloud](public-cloud-first-steps1.)

[Apresentação do Horizon](introducing_horizon1.)
