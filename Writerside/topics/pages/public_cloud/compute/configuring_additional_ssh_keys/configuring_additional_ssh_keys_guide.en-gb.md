...
To create a new SSH key, consult the [Public Cloud first steps guide](public-cloud-first-steps1.).
...
[Public Cloud first steps](public-cloud-first-steps1.)

[Replacing your lost SSH key pair](replacing_lost_ssh_key1.)
