...
Para crear una nueva llave SSH, consulte la [guía de las primeras etapas con Public Cloud](public-cloud-first-steps1.).

### Configuración del nuevo usuario

[Conéctese a su instancia por SSH](public-cloud-first-steps#connect-to-instance.) y cree un nuevo usuario con los siguientes comandos:
...
[Cambiar la llave SSH en caso de pérdida](replacing_lost_ssh_key1.)
