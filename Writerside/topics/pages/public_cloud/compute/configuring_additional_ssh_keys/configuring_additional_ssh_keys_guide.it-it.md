...
Per creare una nuova chiave SSH, consulta la [guida sui primi step con il Public Cloud](public-cloud-first-steps1.).

### Configurazione del nuovo utente

[Accedi alla tua istanza in SSH](public-cloud-first-steps#connect-to-instance.) e crea un nuovo utente utilizzando questi comandi:
...
[Modifica la chiave SSH in caso di perdita](replacing_lost_ssh_key1.)
