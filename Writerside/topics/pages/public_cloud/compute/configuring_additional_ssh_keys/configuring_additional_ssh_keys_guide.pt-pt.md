...
Para criar uma nova chave SSH, consulte o [guia dos primeiros passos com o Public Cloud](public-cloud-first-steps1.).

### Configuração do novo utilizador

[Ligue-se à sua instância em SSH](public-cloud-first-steps#connect-to-instance.) e crie um novo utilizador através dos comandos abaixo:
...
[Alterar a chave SSH em caso de perda](replacing_lost_ssh_key1.)
