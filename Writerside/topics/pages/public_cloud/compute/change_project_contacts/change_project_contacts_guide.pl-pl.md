...
![wymiana-kontaktów](contact1.png){.thumbnail}
...
![wymiana-kontaktów](contactchange.png){.thumbnail}
...
![wymiana-kontaktów](contactchange1.png){.thumbnail}
...
Aby uzyskać szczegółowe informacje na temat tej procedury, zapoznaj się z naszym przewodnikiem "[Zarządzanie kontaktami swoich usług](managing_contacts1.)".

## Sprawdź również

[Rozliczanie należności za usługę Public Cloud](analyze_billing1.)

[Zarządzanie kontaktami swoich usług](managing_contacts1.)
