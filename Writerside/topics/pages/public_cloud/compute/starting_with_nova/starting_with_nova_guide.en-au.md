...
- [Preparing an environment for using the OpenStack API](prepare_the_environment_for_using_the_openstack_api1.){.external}
- [Setting OpenStack environment variables](loading_openstack_environment_variables1.){.external}
