...
Po prawej stronie wybranego wolumenu kliknij przycisk `...`{.action} a następnie `Utwórz kopię zapasową`{.action}. Nie ma potrzeby odłączania najpierw wolumenu od instancji. Jeśli jednak chcesz odłączyć wolumen od instancji, sprawdź tę [sekcję](create_and_configure_an_additional_disk_on_an_instance#linux.) odpowiedniego przewodnika dla systemu Linux i tę [sekcję](create_and_configure_an_additional_disk_on_an_instance#windows.) dla systemu Windows.

![Backup - tworzenie](volumebackup01.png){.thumbnail}
...
![Backup lub Snapshot - tworzenie](volumebackup02.png){.thumbnail}
...
![Snapshot - lista](volumebackup03.png){.thumbnail}
...
![Kopia zapasowa - lista](volumebackup04.png){.thumbnail}
...
Więcej informacji na ten temat znajdziesz w [naszym przewodniku dotyczącym tworzenia wolumenu z kopii zapasowej](create-volume-from-snapshot1.).

![Tworzenie wolumenu z kopii zapasowej](volumebackup05.png){.thumbnail}

## Sprawdź również

[Tworzenie wolumenu z kopii zapasowej](create-volume-from-snapshot1.)

[Tworzenie i konfigurowanie dodatkowego dysku dla instancji](create_and_configure_an_additional_disk_on_an_instance1.)

[Zwiększ rozmiar dodatkowego dysku](create_and_configure_an_additional_disk_on_an_instance1.)
