...
À direita do volume em questão, clique no botão `...`{.action} e em `Criar uma cópia de segurança`{.action}. Não é necessário desassociar primeiro o volume da sua instância. No entanto, se pretender desassociar o seu volume da sua instância, consulte esta [secção](create_and_configure_an_additional_disk_on_an_instance#em-linux.) do guia correspondente para Linux e esta [secção](create_and_configure_an_additional_disk_on_an_instance#em-windows.) para Windows.

![Volume Backup - criação](volumebackup01.png){.thumbnail}
...
![Volume Backup ou Snapshot - criação](volumebackup02.png){.thumbnail}
...
![Volume Snapshot - lista](volumebackup03.png){.thumbnail}
...
![Volume Backup - lista](volumebackup04.png){.thumbnail}
...
Para mais informações, consulte o [nosso manual sobre a criação de um volume a partir de um backup](create-volume-from-snapshot1.).

![Criar um volume a partir de um backup](volumebackup05.png){.thumbnail}

## Saiba mais

[Criar um volume a partir de um backup](create-volume-from-snapshot1.)

[Criar e configurar um disco adicional numa instância](create_and_configure_an_additional_disk_on_an_instance1.)
