...
- A [Block Storage volume](create_and_configure_an_additional_disk_on_an_instance1.) created in your [Public Cloud project](https://www.ovhcloud.com/en-gb/public-cloud/)
...
It is not required to detach the volume from its instance first. However, if you wish to do so, please consult this [section](create_and_configure_an_additional_disk_on_an_instance#on-linux.) of the corresponding guide for Linux and this [section](create_and_configure_an_additional_disk_on_an_instance#on-windows.) for Windows.

![Volume Backup creation](volumebackup01.png){.thumbnail}
...
![Volume Backup or Snapshot creation](volumebackup02.png){.thumbnail}
...
![Volume Snapshot list](volumebackup03.png){.thumbnail}
...
![Volume Backup list](volumebackup04.png){.thumbnail}
...
You can find further information in [this guide](create-volume-from-snapshot1.).

![Create volume from backup](volumebackup05.png){.thumbnail}
