...
A destra del volume, clicca sul pulsante `...`{.action} poi su `Crea un backup`{.action}. Non è necessario scollegare il volume dell'istanza Se vuoi scollegare il tuo volume dall'istanza, consulta questa [sezione](create_and_configure_an_additional_disk_on_an_instance#con-linux.) della guida corrispondente per Linux e questa [sezione](create_and_configure_an_additional_disk_on_an_instance#con-windows.) per Windows.

![Volume Backup - creazione](volumebackup01.png){.thumbnail}
...
![Volume Backup o Snapshot - creazione](volumebackup02.png){.thumbnail}
...
Per maggiori informazioni, consulta la [nostra guida sulla creazione di un volume](create-volume-from-snapshot1.).

![Crea un volume da un backup](volumebackup05.png){.thumbnail}

## Per saperne di più

[Creare un volume a partire da un backup](create-volume-from-snapshot1.)

[Creare e configurare un disco aggiuntivo su un'istanza](create_and_configure_an_additional_disk_on_an_instance1.)
