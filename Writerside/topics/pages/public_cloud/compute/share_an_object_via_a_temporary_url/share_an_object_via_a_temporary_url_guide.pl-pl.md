...
- [Przygotowanie środowiska do korzystania z API OpenStack](prepare_the_environment_for_using_the_openstack_api1.){.ref}
- [Pobranie zmiennych środowiskowych OpenStack](loading_openstack_environment_variables1.){.ref}
