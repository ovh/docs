...
- [Ter preparado o ambiente para usar a API OpenStack](prepare_the_environment_for_using_the_openstack_api1.){.ref}.
- [Carregar as variáveis do ambiente OpenStack](loading_openstack_environment_variables1.){.ref} (versão em francês).
