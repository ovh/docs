...
- Access to the [Horizon interface](create_and_delete_a_user1.)

## Instructions

### Step 1: creating a security group

Access the [Horizon interface](create_and_delete_a_user1.). Then choose the region in which you want to create a security group, via the button in the top left-hand corner.

![define region](security-group0.png){.thumbnail}
...
![access security groups](security-group1.png){.thumbnail}
...
![create security group](security-group2.png){.thumbnail}
...
![manage rules](security-group3.png){.thumbnail}
...
![add a rule](security-group4.png){.thumbnail}
...
![assign security group](security-group5.png){.thumbnail}
...
![edit security group](security-group6.png){.thumbnail}
...
![delete security group](security-group7.png){.thumbnail}
