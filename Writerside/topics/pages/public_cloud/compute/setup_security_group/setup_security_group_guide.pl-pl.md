...
- [Dostęp do interfejsu Horizon](create_and_delete_a_user1.)

## W praktyce

### Etap 1: utworzyć grupę zabezpieczeń

Dostęp do interfejsu [Horizon](create_and_delete_a_user1.). Wybierz region, w którym chcesz utworzyć grupę zabezpieczeń, klikając przycisk w lewym górnym rogu.

![określenie regionu](security-group0.png){.thumbnail}
...
![dostęp do grup zabezpieczeń](security-group1.png){.thumbnail}
...
![utworzyć grupę zabezpieczeń](security-group2.png){.thumbnail}
...
![zarządzanie regułami](security-group3.png){.thumbnail}
...
![dodaj regułę](security-group4.png){.thumbnail}
...
![przypisz grupę zabezpieczeń](security-group5.png){.thumbnail}
...
![zmiana grupy zabezpieczeń](security-group6.png){.thumbnail}
...
![usuń grupę zabezpieczeń](security-group7.png){.thumbnail}
