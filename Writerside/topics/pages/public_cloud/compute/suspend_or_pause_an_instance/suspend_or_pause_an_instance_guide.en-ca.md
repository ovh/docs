...
- An [OVHcloud Public Cloud instance](public-cloud-first-steps#step-3-creating-an-instance.) on **hourly** billing
- Access to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca){.external} or [Horizon interface](introducing_horizon1.)
- Knowledge of [Openstack API](prepare_the_environment_for_using_the_openstack_api1.) and [Openstack variables](loading_openstack_environment_variables1.)
...
To proceed, you need to [configure user access to Horizon](introducing_horizon1.) and [log in to the Horizon interface](https://horizon.cloud.ovh.net/auth/login/).
...
- [Prepare the environment to use the OpenStack API](prepare_the_environment_for_using_the_openstack_api1.)
