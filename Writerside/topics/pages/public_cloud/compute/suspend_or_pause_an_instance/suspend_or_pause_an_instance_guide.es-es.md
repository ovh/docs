...
- Tener acceso al [área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es){.external} o al [interfaz de Horizon](introducing_horizon1.)
...
![horizon](firstaccesshorizon.png){.thumbnail}
