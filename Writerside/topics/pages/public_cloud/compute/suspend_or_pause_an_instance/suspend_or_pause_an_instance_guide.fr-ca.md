...
- Avoir créé une [instance Public Cloud OVHcloud](public-cloud-first-steps1.) au forfait **horaire**.
- Être connecté à l’[espace client OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc){.external} ou à l’interface [Horizon.](introducing_horizon1.)
- Avoir des connaissances de l’[API Openstack](prepare_the_environment_for_using_the_openstack_api1.) et des [variables Openstack](loading_openstack_environment_variables1.)
...
![onglet snapshot](shelved_backup.png){.thumbnail}

#### Depuis l’interface Horizon

Pour utiliser cette méthode, il vous faut [créer un utilisateur OpenStack](introducing_horizon1.) et vous [connecter à l’interface Horizon](https://horizon.cloud.ovh.net/auth/login/).
...
![instance shelve](shelveinstancehorizon.png){.thumbnail}

Une fois la procédure terminée, votre instance aura le statut *Shelved Offloaded*.

![instance réservée](newinstancestatushorizon.png){.thumbnail}
...
![réactiver instance](reactivate_instancePanel.png){.thumbnail}
...
![suspension instance Horizon](suspendinstancehorizon.png){.thumbnail}
...
![Suspendre instance](pauseinstancehorizon.png){.thumbnail}
