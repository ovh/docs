...
- un'[istanza Public Cloud](public-cloud-first-steps1.) con la fatturazione **oraria**
- Avere accesso allo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it){.external} o all'[interfaccia Horizon](introducing_horizon1.)
- Conoscenza dell'[API OpenStack](prepare_the_environment_for_using_the_openstack_api1.) e delle [variabili d’ambiente OpenStack](loading_openstack_environment_variables1.)
...
![sospeso](instance_suspended.png){.thumbnail}
...
Per continuare, devi [creare un utente per accedere a horizon](introducing_horizon1.) e [connetterti all'interfaccia Horizon](https://horizon.cloud.ovh.net/auth/login/).
...
![istanza riservata](newinstancestatushorizon.png){.thumbnail}
