...
- Tener [una instancia de Public Cloud](public-cloud-first-steps1.) sobre la facturación por **horas**
- Tener acceso al [área de cliente de OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=ws){.external} o al [interfaz de Horizon](introducing_horizon1.)
- Conocimiento de la [API de OpenStack](prepare_the_environment_for_using_the_openstack_api1.) y de las [variables OpenStack](loading_openstack_environment_variables1.)
...
Para continuar, debe [crear un acceso a Horizon](introducing_horizon1.) y [conectarse al panel Horizon](https://horizon.cloud.ovh.net/auth/login/).
...
![first access horizon](firstaccesshorizon.png){.thumbnail}
