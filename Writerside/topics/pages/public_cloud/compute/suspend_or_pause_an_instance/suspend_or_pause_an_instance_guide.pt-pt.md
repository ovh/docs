...
- uma [instância Public Cloud](public-cloud-first-steps#3o-passo-criacao-de-uma-instancia.) sobre faturação à **hora**
- acesso à [Área de Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pt/&ovhSubsidiary=pt){.external} o à [interface Horizon](introducing_horizon1.)
- Conhecimento da [API OpenStack](prepare_the_environment_for_using_the_openstack_api1.) e das [variáveis OpenStack](loading_openstack_environment_variables1.)
...
Para continuar, deve [criar um acesso à interface Horizon](introducing_horizon1.) e se [ligar à interface Horizon](https://horizon.cloud.ovh.net/auth/login/).
...
![instance suspension horizon](suspendinstancehorizon.png){.thumbnail}
