...
- Utworzenie [instancji Public Cloud OVHcloud](public-cloud-first-steps1.) w abonamencie **godzina**
- Dostęp do [Panelu klienta OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl){.external} lub [interfejsu Horizon](introducing_horizon1.)
- Znajomość [API OpenStack](prepare_the_environment_for_using_the_openstack_api1.) i [Zmienne OpenStack](loading_openstack_environment_variables1.)
...
Aby kontynuować, należy [tworzenie dostepu do interfejsu Horizon](introducing_horizon1.) i [zalogować się do interfejsu Horizon](https://horizon.cloud.ovh.net/auth/login/).
