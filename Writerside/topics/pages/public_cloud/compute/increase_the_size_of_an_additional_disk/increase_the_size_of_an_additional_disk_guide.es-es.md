...
- Tener un [disco adicional](create_and_configure_an_additional_disk_on_an_instance1.) creado en su proyecto.
- Tienes acceso a tu [Panel de configuración de OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es).
- Tener acceso administrativo (sudo) a su instancia a través de SSH (Linux) o RDP (Windows).

## Procedimiento

Los siguientes pasos suponen que ya ha configurado un disco adicional según las instrucciones de [nuestra guía](create_and_configure_an_additional_disk_on_an_instance1.).
