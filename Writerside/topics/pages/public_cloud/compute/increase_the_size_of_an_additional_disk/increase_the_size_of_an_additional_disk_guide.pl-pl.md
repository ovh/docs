...
- [Dodatkowy dysk](create_and_configure_an_additional_disk_on_an_instance1.) utworzony w Twoim projekcie
- Dostęp do [Panelu client OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl)
- Dostęp administracyjny (sudo) do Twojej instancji przez SSH (Linux) lub RDP (Windows)

## W praktyce

Kolejne etapy zakładają, że skonfigurowałeś już dodatkowy dysk zgodnie z instrukcjami zawartymi w [naszym przewodniku](create_and_configure_an_additional_disk_on_an_instance1.).
...
[Zarządzanie wolumenem instancji Public Cloud](create_and_configure_an_additional_disk_on_an_instance1.)
