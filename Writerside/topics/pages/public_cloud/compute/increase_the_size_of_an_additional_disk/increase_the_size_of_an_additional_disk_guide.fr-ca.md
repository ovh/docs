...
- Un [disque supplémentaire](create_and_configure_an_additional_disk_on_an_instance1.) créé dans votre projet.
- Être connecté à votre [espace client OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc).
- Avoir un accès administratif (sudo) à votre instance via SSH (Linux) ou RDP (Windows).

## En pratique

Les étapes suivantes supposent que vous avez déjà configuré un disque supplémentaire selon les intrusctions de [notre guide](create_and_configure_an_additional_disk_on_an_instance1.).
...
[Créer et configurer un disque additionnel sur une instance](create_and_configure_an_additional_disk_on_an_instance1.)
