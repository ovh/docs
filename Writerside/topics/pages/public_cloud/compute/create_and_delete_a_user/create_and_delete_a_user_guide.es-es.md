...
![Permisos](permissions.png){.thumbnail}
...
Una vez que haya creado el usuario de OpenStack, podrá utilizar sus claves de acceso a [la interfaz Horizon](introducing_horizon1.) haciendo clic en `Horizon`{.action} en el menú de la izquierda.
...
[Presentación de Horizon](introducing_horizon1.)
