...
![Permissões](permissions.png){.thumbnail}
...
Depois de criar o utilizador OpenStack, poderá utilizar as suas credenciais para se ligar [à interface Horizon](introducing_horizon1.) clicando na ligação `Horizon`{.action} no menu à esquerda.
