...
- Dispor de um [projeto Public Cloud](create_a_public_cloud_project1.)
- Ter acesso à [Área de Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pt/&ovhSubsidiary=pt)
- [Ter criado um utilizador OpenStack](create_and_delete_a_user1.)

Recomendamos que consulte o guia "[Aceder à interface Horizon](introducing_horizon1.)" para se familiarizar com o Horizon.
...
Ligue-se à interface [Horizon](https://horizon.cloud.ovh.net/auth/login/) de acordo com o método indicado na [primeira parte deste guia](getting-started-07-creating-vrack#interface-horizon.).

Ligue-se bem à sua zona de trabalho:

![região](horizon1.png){.thumbnail}

Selecione `Compute`{.action} e, a seguir, `Instances`{.action}:

![computação e instância](horizon2.png){.thumbnail}
...
![adicionar interface](horizon3.png){.thumbnail}
...
![ativação da chave windows](windowsactivation1.png){.thumbnail}
...
![ativação da chave windows](windowsactivation2.png){.thumbnail}

## Quer saber mais?

[Saiba como alterar a chave de produto do Windows Server](windows_key1.).
