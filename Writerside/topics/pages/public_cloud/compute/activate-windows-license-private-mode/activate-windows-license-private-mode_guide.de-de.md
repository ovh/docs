...
Wir empfehlen, die [Einführung in das Horizon Interface](introducing_horizon1.) zu lesen, um sich mit Horizon vertraut zu machen.
...
Loggen Sie sich in [Horizon-interface](https://horizon.cloud.ovh.net/auth/login/) mit der im [ersten Teil dieser Anleitung](getting-started-07-creating-vrack#horizon.) beschriebenen Methode ein. 
...
![Instanz](horizon2.png){.thumbnail}
...
![select interface](attachinterfacehorizon.png){.thumbnail}
...
![Windows Key aktivieren](windowsactivation1.png){.thumbnail}
...
![Windows Key aktivieren](windowsactivation2.png){.thumbnail}

## Weiterführende Informationen

[Den Aktivierungsschlüssel Ihres Windows Servers korrigieren](windows_key1.).
