...
We recommend that you read our guide on [Accessing the Horizon interface](introducing_horizon1.) to familiarise yourself with Horizon.
...
Log in to the [Horizon](https://horizon.cloud.ovh.net/auth/login/) interface using the method listed in the [first part of this guide](getting-started-07-creating-vrack#horizon.).
...
![compute and instance](horizon2.png){.thumbnail}
...
![windows key](windowsactivation1.png){.thumbnail}
...
![windows key](windowsactivation2.png){.thumbnail}

## Go further

[Find out how to change the activation key of your Windows Server](windows_key1.).
