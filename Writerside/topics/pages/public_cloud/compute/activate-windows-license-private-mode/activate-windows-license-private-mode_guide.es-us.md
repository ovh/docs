...
Le recomendamos que consulte la guía "[Acceder a Horizon](introducing_horizon1.)" para familiarizarse con Horizon.
...
Conéctese a la interfaz [Horizon](https://horizon.cloud.ovh.net/auth/login/) utilizando el método que se indica en la [primera parte de esta guía](getting-started-07-creating-vrack#interfaz-horizon.).
...
![procesamiento y instancia](horizon2.png){.thumbnail}
...
![interfaz select](attachinterfacehorizon.png){.thumbnail}
...
![activación de llave windows](windowsactivation1.png){.thumbnail}
...
![activación de llave windows](windowsactivation2.png){.thumbnail}

## Más información

[Averigua cómo cambiar la clave de activación de Windows Server](windows_key1.).
