...
- Disporre di un [progetto Public Cloud OVHcloud](create_a_public_cloud_project1.)
- Avere accesso allo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it)
- [Aver creato un utente OpenStack](create_and_delete_a_user1.)

Per familiarizzare con Horizon, consulta la guida [Accedere all'interfaccia Horizon](introducing_horizon1.).
...
Accedi all'interfaccia [Horizon](https://horizon.cloud.ovh.net/auth/login/) utilizzando il metodo indicato nella [prima parte di questa guida](getting-started-07-creating-vrack#interfaccia-horizon.).
...
![host e istanza](horizon2.png){.thumbnail}
...
![interfaccia select](attachinterfacehorizon.png){.thumbnail}
...
![attivazione chiave windows](windowsactivation1.png){.thumbnail}
...
![attivazione chiave windows](windowsactivation2.png){.thumbnail}

## Per saperne di più

[Scoprite come correggere la Product Key di Windows Server](windows_key1.).
