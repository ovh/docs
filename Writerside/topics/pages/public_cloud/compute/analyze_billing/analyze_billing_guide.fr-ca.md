...
* Une [instance Public Cloud](public-cloud-first-steps1.){.external}
...
Pour plus d'informations sur la façon de procéder, consultez ce [guide](suspend_or_pause_an_instance1.).
