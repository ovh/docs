...
* [Disporre di un’istanza Public Cloud](public-cloud-first-steps#step-3-crea-unistanza.)
...
Per maggiori informazioni sulla procedura da seguire, consulta questa [guida](suspend_or_pause_an_instance1.).
