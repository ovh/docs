...
* Una [instancia Public Cloud](public-cloud-first-steps1.){.external}.
...
Para más información sobre cómo proceder, consulte esta [guía](suspend_or_pause_an_instance1.).
