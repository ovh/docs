...
![suivi commande](order_final-min.gif){.thumbnail}

#### Trucs et astuces

Afin de vous aider à gérer vos commandes, nous mettons à votre disposition [un guide détaillé](managing_ovh_orders1.).
...
![livraison de service](billing_final_0.gif){.thumbnail}
