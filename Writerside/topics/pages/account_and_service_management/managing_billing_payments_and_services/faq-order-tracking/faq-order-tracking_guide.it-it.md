...
![stato di un ordine](order_final-min.gif){.thumbnail}

#### Consigli e suggerimenti

Per maggiori informazioni sulla gestione degli ordini, consulta [questa guida](managing_ovh_orders1.).
...
![ordine non è stato consegnato](billing_final_0.gif){.thumbnail}
