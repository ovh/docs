...
![Bon de commande OVH](order01.png){.thumbnail}
...
|3|Moyens de paiement enregistrés sur votre compte client. Pour plus d'informations, consultez le guide [Gérer mes moyens de paiement](manage-payment-methods1.).|
...
![Espace client](huborders.png){.thumbnail}

Un récapitulatif des différentes commandes passées apparaît comme ci-dessous :

![Récapitulatif des commandes](order03.png){.thumbnail}
...
![Récapitulatif des commandes](order04.png){.thumbnail}
...
![Suivi de commande](order05b.png){.thumbnail}

La fenêtre ci-dessous apparaît, vous permettant un suivi en quatre étapes.

![Suivi de commande](order06.png){.thumbnail}
...
> - si votre compte client OVHcloud est d'un [autre type que Particulier](all_about_username#modifier-le-type-de-compte.).
>
...
![Annulation d'une commande](cancelorder1.png){.thumbnail}
...
![Validation de l'annulation](cancelorder2.png){.thumbnail}
