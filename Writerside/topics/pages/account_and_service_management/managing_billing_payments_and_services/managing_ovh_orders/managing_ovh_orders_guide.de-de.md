...
![OVH-Bestellschein](order01.png){.thumbnail}
...
|3|In Ihrem Kundenkonto gespeicherte Zahlungsmethoden. Weitere Informationen finden Sie in der Anleitung [Meine Zahlungsarten verwalten](manage-payment-methods1.).|
...
![Kundencenter](huborders.png){.thumbnail}
...
![Bestellübersicht](order03.png){.thumbnail}
...
![Bestellübersicht](order04.png){.thumbnail}
...
> - Ihre OVHcloud Kundenkennung ist nicht vom Typ [Privatperson](all_about_username#account-typ-andern.)
>
...
![Stornierung einer Bestellung](cancelorder1.png){.thumbnail}
...
![Stornierung bestätigen](cancelorder2.png){.thumbnail}
