...
>
> - renovaciones;
> - si su cuenta de cliente de OVHcloud es de un [tipo diferente a Particular](all_about_username#cambiar-el-tipo-de-cuenta.).
>
...
![Cancelación de un pedido](cancelorder1.png){.thumbnail}

Por último, marque la casilla `Sí, quiero cancelar el pedido`{.action} y confirme.

![Confirmación de la cancelación](cancelorder2.png){.thumbnail}
