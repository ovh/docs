...
![Nota de encomenda da OVH](order01.png){.thumbnail}
...
|3|Métodos de pagamento registados na sua conta de cliente. Para mais informações, consulte o guia [Gerir os meus métodos de pagamento](manage-payment-methods1.).|
...
![Resumo das encomendas](order03.png){.thumbnail}
...
![Resumo das encomendas](order04.png){.thumbnail}
...
![Acompanhamento de encomendas](order05b.png){.thumbnail}

Aparecerá a janela seguinte, que lhe permite um acompanhamento em quatro etapas.

![Acompanhamento de encomendas](order06.png){.thumbnail}
...
>
> - renovações;
> - se a sua conta de cliente OVHcloud é de [outro tipo que não Particer](all_about_username#modificar-o-tipo-de-conta.).
>
...
![Anular uma encomenda](cancelorder1.png){.thumbnail}

Por último, selecione a opção `Sim, desejo cancelar esta encomenda`{.action} e confirme.

![Confirmação da anulação](cancelorder2.png){.thumbnail}
