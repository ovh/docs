...
![Zamówienie OVH](order01.png){.thumbnail}
...
|3|Sposoby płatności zapisane na Twoim koncie klienta Aby uzyskać więcej informacji, zapoznaj się z przewodnikiem [Zarządzanie sposobami płatności](manage-payment-methods1.).|
...
![Panel klienta](huborders.png){.thumbnail}

Poniżej zamieszczamy podsumowanie różnych wcześniejszych zamówień:

![Podsumowanie zamówień](order03.png){.thumbnail}
...
![Podsumowanie zamówień](order04.png){.thumbnail}
...
![Informacje o zamówieniu](order05b.png){.thumbnail}

Pojawi się poniższe okno umożliwiające monitorowanie w czterech krokach.

![Informacje o zamówieniu](order06.png){.thumbnail}
...
> - jeśli Twoje konto klienta OVHcloud jest [innego typu niż](all_about_username#zmien-typ-konta.) OVHcloud.
>
...
![Anulowanie zamówienia](cancelorder1.png){.thumbnail}

Zaznacz kratkę `Tak, chcę anulować to zamówienie`{.action}, po czym zatwierdź tę operację.

![Potwierdzenie anulowania zamówienia](cancelorder2.png){.thumbnail}
