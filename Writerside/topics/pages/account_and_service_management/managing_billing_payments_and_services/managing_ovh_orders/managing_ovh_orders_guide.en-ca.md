...
![OVH purchase order](order01.png){.thumbnail}
...
|3|Payment methods saved to your customer account. For more information, please refer to our guide [Managing payment methods](manage-payment-methods1.).|
...
![Control Panel](huborders.png){.thumbnail}

A summary of the various orders placed appears as below:

![Order summary](order03.png){.thumbnail}
...
![Order summary](order04.png){.thumbnail}
...
![Order tracking](order05b.png){.thumbnail}

The window below will appear, allowing you to follow it in four steps.

![Order tracking](order06.png){.thumbnail}
