...
- Disposer d'un [mode de paiement](manage-payment-methods1.) valide et enregistré dans votre compte OVHcloud
- Être familiarisé avec le [fonctionnement de l'APIv6 OVHcloud](first-steps1.).
