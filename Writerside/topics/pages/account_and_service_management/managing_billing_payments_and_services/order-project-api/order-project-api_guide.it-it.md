...
- Disporre di una [modalità di pagamento](manage-payment-methods1.) valida e registrata sul tuo account OVHcloud
- Familiarizzare con il [funzionamento dell'APIv6 OVHcloud](first-steps1.)
