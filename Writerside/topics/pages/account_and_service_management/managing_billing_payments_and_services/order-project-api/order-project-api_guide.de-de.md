...
- Sie haben einen [gültigen](manage-payment-methods1.) und in Ihrem OVHcloud Account gespeicherten Zahlungsmodus
- Sie müssen mit der [Funktionsweise der OVHcloud APIv6 vertraut sein](first-steps1.).
