...
- Dispor de um [método de pagamento](manage-payment-methods1.) válido e registado na sua conta OVHcloud
- Estar familiarizado com o [funcionamento da APIv6 OVHcloud](first-steps1.)
