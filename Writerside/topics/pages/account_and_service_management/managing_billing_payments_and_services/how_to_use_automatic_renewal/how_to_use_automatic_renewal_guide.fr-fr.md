...
- Être [contact de facturation](managing_contacts#definition.) de vos services OVHcloud
- Disposer d'un moyen de paiement valide dans votre compte OVHcloud. Consultez notre guide « [Gérer vos moyens de paiement](manage-payment-methods1.) ».
...
>> Si vous n'avez enregistré aucun [moyen de paiement](manage-payment-methods1.), une facture vous sera adressée par e-mail. Il vous suffira alors de la régler en ligne.
>>
...
>>Si vous ne souhaitez pas prolonger l'un de ces services, il vous suffit alors [de le résilier dans votre espace client](how_to_cancel_services1.).
>>
>> **Attention**, l'absence d'un moyen de paiement dans votre compte ne déclenche pas une résiliation automatique de vos services. Pour résilier des services, consultez notre guide « [Comment résilier vos services OVHcloud ](how_to_cancel_services1.) ».
>>
...
![produits et services](images_products-services-fr.png){.thumbnail}
...
![mes services](my-services-fr.png){.thumbnail}
...
>
> ![manageautomaticrenewal](filters-fr.png){.thumbnail}
...
![menu actions](actions-fr.png){.thumbnail}
...
>>
>> ![configurer le renouvellement](configure-renewal-fr.png){.thumbnail}
>>
...
>>
>> ![configurer le renouvellement](configure-renew-fr.png){.thumbnail}
>>
...
>>
>> ![anticiper le paiement](forward-payment-fr.png){.thumbnail}
>>
...
> **Résilier**
>>
>> ![résilier](images_cancel-fr.png){.thumbnail}
>>
...
>>
>> Pour plus d'informations sur la résiliation des services OVHcloud, suivez les instructions du guide « **[Comment résilier vos services OVHcloud ](how_to_cancel_services1.)** ».
>>
> **Renouveler le service**
>>
>> ![Renouveler le service](renew-service-fr.png){.thumbnail}
>>
...
> **Régler ma facture**
>>
>> ![Payer une facture](pay-bill-fr.png){.thumbnail}
>>
...
![actions groupées](batch-actions-fr.png){.thumbnail}
...
>> Le NIC (ou NIC-handle) désigne votre identifiant client OVHcloud qui se présente sous la forme **xx11111-ovh**. Le mot de passe demandé est le mot de passe d'accès à votre compte OVHcloud. Si vous ne le connaissez plus, modifiez-le en suivant [ces instructions](manage-ovh-password1.).
...
>> Consultez la partie « [Que faire si je ne parviens pas à me connecter ?](ovhcloud-account-login#que-faire-si-je-ne-parviens-pas-a-me-connecter.) » de notre guide « [Se connecter à l'espace client OVHcloud](ovhcloud-account-login1.) ».
> Je veux activer le renouvellement automatique mais j'obtiens un message d'erreur. Que dois-je faire ?
>> Pour que le renouvellement automatique puisse être activé sur vos services, vous devez avoir ajouté un moyen de paiement valide dans votre compte OVHcloud. Si ce n'est pas le cas ou si le moyen de paiement est expiré, un message d'erreur appparaîtra dans l'espace client lors de vos tentatives d'activation du renouvellement automatique. Consultez notre guide « [Gérer vos moyens de paiement](manage-payment-methods1.) » pour vérifier ou ajouter un moyen de paiement.
> Mon moyen de paiement n'est plus valide. Comment ajouter un nouveau moyen de paiement ?
>> Consultez notre guide « [Gérer mes moyens de paiement](manage-payment-methods1.) ». Avant de pouvoir supprimer un moyen de paiement obsolète, vous devez ajouter un nouveau moyen de paiement valide dans votre compte OVHcloud.
...
>> Suivez les instructions de notre guide « [Transférer un nom de domaine vers un autre bureau d'enregistrement](transfer_outgoing_domain1.) ».
...
>> Afin de vous prémunir d'une indisponibilité d'accès pour tous vos services critiques, nous vous préconisons de privilégier le renouvellement automatique et de [vérifier régulièrement que vos moyens de paiement sont à jour](manage-payment-methods1.).
...
Ce guide n'a pas répondu à votre question ? Consultez notre [FAQ sur la facturation et le paiement](faq-billing1.)

[Gérer vos moyens de paiement](manage-payment-methods1.)

[Comment résilier des services OVHcloud](how_to_cancel_services1.)

[Informations concernant le mode de facturation Public Cloud](analyze_billing1.)
