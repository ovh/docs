...
- Ser [contacto de facturación](managing_contacts#definicion.) de sus servicios de OVHcloud.
- Tener una forma de pago válida en su cuenta de OVHcloud. Consulte nuestra guía "[Gestionar las formas de pago](manage-payment-methods1.)".
...
>> Si no ha registrado ninguna [forma de pago](manage-payment-methods1.), se le enviará una factura por correo electrónico. En ese caso, solo tendrá que abonarla online.
>>
...
>>Si no desea prolongar alguno de estos servicios, solo tiene que [darlo de baja en su área de cliente](managing_billing_payments_and_services_how_to_cancel_services.).
>>
>> **Atención**: la ausencia de una forma de pago en su cuenta no activa la baja automática de sus servicios. Para dar de baja servicios, consulte nuestra guía "[Cómo dar de baja los servicios de OVHcloud ](how_to_cancel_services1.)".
>>
> **Renovación manual**
>>
...
![productos y servicios](products-services-en.png){.thumbnail}
...
![mis servicios](my-services-en.png){.thumbnail}
...
>>
>> ![configurar la renovación](configure-renewal-en.png){.thumbnail}
>>
...
>>
>> ![configurar la renovación](configure-renew-en.png){.thumbnail}
>>
...
> **Adelantar el pago**
>>
>> ![anticipar el pago](forward-payment-en.png){.thumbnail}
>>
...
>>
>> ![dar de baja](images_cancel-en.png){.thumbnail}
>>
...
>>
>> Para más información sobre la baja de los servicios de OVHcloud, siga las instrucciones de la guía "**[Cómo dar de baja los servicios de OVHcloud ](how_to_cancel_services1.)**".
>>
> **Renovar el servicio**
>>
>> ![Renovar el servicio](renew-service-en.png){.thumbnail}
>>
...
> **Abonar mi factura**
>>
>> ![Pagar una factura](pay-bill-en.png){.thumbnail}
>>
...
![acciones agrupadas](batch-actions-en.png){.thumbnail}
...
>> Consulte la sección "[Qué hago si no puedo conectarme?](ovhcloud-account-login#login-failure.)" de nuestra guía "[Conectarse al área de cliente de OVHcloud](ovhcloud-account-login1.)".
> Quiero activar la renovación automática, pero recibo un mensaje de error. ¿Qué debo hacer?
>> Para poder activar la renovación automática en sus servicios, debe haber añadido una forma de pago válida a su cuenta de OVHcloud. En caso contrario, o si la forma de pago ha expirado, aparecerá un mensaje de error en el área de cliente al intentar activar la renovación automática. Para consultar o añadir una forma de pago, consulte nuestra guía "[Gestionar las formas de pago](manage-payment-methods1.)".
> Mi forma de pago ya no es válida. ¿Cómo añadir una nueva forma de pago?
>> Consulte nuestra guía "[Gestionar mis formas de pago](manage-payment-methods1.)". Para poder eliminar una forma de pago obsoleta, debe añadir una nueva forma de pago válida a su cuenta de OVHcloud.
...
>> Siga las instrucciones de nuestra guía "[Transferir un dominio a otro agente registrador](transfer_outgoing_domain1.)".
...
>> Para protegerse de la no disponibilidad de acceso a todos sus servicios críticos, le recomendamos que dé prioridad a la renovación automática y que [compruebe periódicamente que sus formas de pago están actualizadas](manage-payment-methods1.).
...
¿Esta guía no ha respondido a su pregunta? Consulte nuestras [FAQ sobre facturación y pago](faq-billing1.)

[Gestionar las formas de pago](manage-payment-methods1.)

[Cómo dar de baja servicios de OVHcloud](how_to_cancel_services1.)

[Información sobre el tipo de facturación cloud](analyze_billing1.)

[Gestionar la facturación de sus cuentas Exchange](manage_billing_exchange1.)
