...
- [Cree una contraseña segura](manage-ovh-password#generar-una-contrasena-adecuada.) para garantizar la confidencialidad de su cuenta.

- [Active la doble autenticación](secure-ovhcloud-account-with-2fa1.) para evitar todo acceso fraudulento al área de cliente.
...
Para más información, consulte la guía [Proteger mi cuenta de OVHcloud y gestionar mis datos personales](all_about_username#editar-mis-datos-personales.).
...
> [!primary]
>
> Para evitar interrupciones del servicio y garantizar el buen funcionamiento de la renovación automática, [guarde una forma de pago](manage-payment-methods1.) en su [área de cliente de OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=ws).
>
...
- [Gestionar la renovación de los servicioss](how_to_use_automatic_renewal1.);
...
¿Sabía que podía [seguir sus pedidos](managing_ovh_orders1.) en su [área de cliente de OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=ws)?<br>
...
Para más información sobre la baja de sus servicios, consulte la guía [Cómo dar de baja sus servicios de OVHcloud](how_to_cancel_services1.).
...
[Protéjase contra el fraude: cómo detectar los mensajes de correo fraudulento y el phishing](phishing_care1.)

[Gestionar las facturas de OVHcloud](invoice_management1.)
