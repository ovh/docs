...
- [Utwórz silne](manage-ovh-password#generowanie-hasla.) hasło, które zapewni poufność Twojego konta.

- [Włącz weryfikację](secure-ovhcloud-account-with-2fa1.) dwuetapową, aby uniknąć ryzyka nielegalnego dostępu do panelu klienta.
...
![miprofile](myprofile.png){.thumbnail}

Aby uzyskać więcej informacji, zapoznaj się z przewodnikiem [Zabezpieczenie konta OVHcloud i zarządzanie danymi osobowymi](all_about_username#jak-zarzadzac-danymi-osobowymi.).
...
![service_email](service_emails.png){.thumbnail}

### Włącz automatyczne odnowienie

> [!primary]
>
> Aby uniknąć przerw w świadczeniu usług oraz zapewnić prawidłowe funkcjonowanie automatycznego odnowienia, [Zarządzanie sposobami płatności](manage-payment-methods1.) w Twoim [Panelu klienta OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl).
>
...
Czy wiesz, że możesz [śledzić zamówienia](managing_ovh_orders1.) w [Panelu klienta OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl)?<br>
Wystarczy przejść do zakładki `Dashboard`{.action} w górnym menu ekranu, a następnie kliknąć `Wyswietl moje zamówienia`{.action}.

![starsi](viewmyorders.png){.thumbnail}
...
[Rozpoznawanie e-maili typu phishing](phishing_care1.)

[Zarządzanie fakturami OVHcloud](invoice_management1.)
