...
![modalità di pagamento SEPA](sepa.png){.thumbnail}
...
![credit-card-no-sepa](credit-card.png){.thumbnail}
...
![paypal_no_sepa](paypal.png){.thumbnail}
...
Per eliminare tutti i metodi di pagamento, tutti i servizi devono essere in [rinnovo manuale](how_to_use_automatic_renewal#il-rinnovo-manuale.).
...
> [!primary]
>
> Per maggiori informazioni, consulta la guida [Iniziare a utilizzare le API OVHcloud](first-steps1.).
>
...
Ricaricando regolarmente il tuo account, assicurati che il [rinnovo automatico](how_to_use_automatic_renewal#il-rinnovo-automatico.) dei tuoi servizi non venga mai interrotto per mancato pagamento.
...
![credito-prepaid-account](credit-prepaid-account.png){.thumbnail}
