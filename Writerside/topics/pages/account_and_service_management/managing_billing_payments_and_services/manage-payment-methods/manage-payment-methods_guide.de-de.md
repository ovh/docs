...
![Lastschrift SEPA](sepa.png){.thumbnail}
...
![card-credit](credit-card.png){.thumbnail}
...
Wenn Sie alle Ihre Zahlungsarten löschen möchten, müssen alle Ihre Dienstleistungen [auf manuelle Verlängerung](how_to_use_automatic_renewal1.) umgestellt werden.
...
> [!primary]
>
> Mehr Informationen finden Sie in der Einführung zur [Verwendung der OVHcloud API](first-steps1.).
>
...
Wenn Sie Ihren Account regelmäßig aufladen, stellen Sie damit sicher, dass die [automatische Verlängerung](how_to_use_automatic_renewal1.) Ihrer Dienstleistungen nie wegen Zahlungsausfalls unterbrochen wird.
