...
![hubpayment](hubpayment.png){.thumbnail}
...
![manage-payment-methods](managepaymentmethods2.png){.thumbnail}

Wybierz metodę płatności, której chcesz użyć:

![choose-payment-method-no-sepa](choose-payment-method-no-sepa.png){.thumbnail}
...
![credit-card-no-sepa](credit-card-no-sepa.png){.thumbnail}
...
![paypal_no_sepa](paypal_no_sepa.png){.thumbnail}
...
![manage-payment-methods](managepaymentmethods3.png){.thumbnail}
...
![manage-payment-methods](managepaymentmethods4.png){.thumbnail}

Jeśli chcesz usunąć wszystkie Twoje sposoby płatności, wszystkie Twoje usługi muszą być [odnawiane ręcznie](how_to_use_automatic_renewal#odnowienie-reczne.).
...
> [!primary]
>
> Aby uzyskać więcej informacji, zapoznaj się z przewodnikiem Pierwsze kroki z [API OVHcloud](first-steps1.).
>
...
Tworząc regularnie konto, będziesz mógł sprawdzić, czy [automatyczne odnawianie](how_to_use_automatic_renewal#odnowienie-automatyczne.) usług nie zostanie przerwane z powodu braku płatności.
...
![prepaid-account](prepaid-account.png){.thumbnail}
...
![warning_prepaid_account](warning_prepaid_account.png){.thumbnail}
...
![prepaid-account](credit-prepaid-account.png){.thumbnail}

W oknie, które się wyświetli wskaż kwotę do zasilenia, kliknij `Dalej`{.action}, a następnie `Zamów`{.action}.

![order-prepaid-account](order-prepaid-account.png){.thumbnail}
