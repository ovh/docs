...
![SEPA payment method](sepa.png){.thumbnail}
...
If you would like to delete all of your payment methods, all of your services must be set to [manual renewal](how_to_use_automatic_renewal#manual-renewal.).
...
> [!primary]
>
> For more information, please refer to our guide [Getting started with the OVHcloud API](first-steps1.).
>
...
By crediting your account regularly, you will ensure that your services will never be interrupted for default on their [automatic renewal](how_to_use_automatic_renewal#automatic-renewal.).
