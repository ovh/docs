...
Si quiere eliminar todas sus formas de pago, todos sus servicios deben estar [renovados manualmente](how_to_use_automatic_renewal#renovacion-manual.).
...
> [!primary]
>
> Para más información, consulte la guía [Primeros pasos con la API OVHcloud](first-steps1.).
>
...
Recargando su cuenta con regularidad, se asegurará de que la [renovación automática](how_to_use_automatic_renewal1.) de sus servicios no se interrumpa nunca por defecto de pago.
