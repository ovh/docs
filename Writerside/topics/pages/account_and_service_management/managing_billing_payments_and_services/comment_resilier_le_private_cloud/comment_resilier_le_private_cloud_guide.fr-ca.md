...
![resiliation depuis l'espace client](resiliation1.png){.thumbnail}
...
![validation resiliation](resiliation2.png){.thumbnail}
...
![validation resiliation](resiliation3.png){.thumbnail}
...
![validation resiliation](resiliation4.png){.thumbnail}
