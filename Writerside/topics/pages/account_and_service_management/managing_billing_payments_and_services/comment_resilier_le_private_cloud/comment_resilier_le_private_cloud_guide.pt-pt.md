...
![rescisão a partir da Área de Cliente](resiliation1.png){.thumbnail}
...
![validação rescisão](resiliation2.png){.thumbnail}
...
![validação rescisão](resiliation3.png){.thumbnail}
...
![validação rescisão](resiliation4.png){.thumbnail}
