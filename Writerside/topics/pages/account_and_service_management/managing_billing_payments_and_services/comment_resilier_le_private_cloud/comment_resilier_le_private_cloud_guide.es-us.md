...
![Baja desde el área de cliente](resiliation1.png){.thumbnail}
...
![Confirmar la baja del servicio](resiliation2.png){.thumbnail}
...
![Confirmar la baja del servicio](resiliation3.png){.thumbnail}
...
![Confirmar la baja del servicio](resiliation4.png){.thumbnail}
