...
![Change billing calculation](switch_to_monthly_updated.png){.thumbnail}

Sie müssen dann bestätigen, dass Sie die Abrechnungsart ändern möchten:

![Confirm billing calculation change](confirm_to_monthly_updated.png){.thumbnail}
...
Loggen Sie sich gemäß der [entsprechenden Anleitung](first-steps1.) in das [OVHcloud API Interface](https://eu.api.ovh.com/) ein und folgen Sie den nachstehenden Schritten.
