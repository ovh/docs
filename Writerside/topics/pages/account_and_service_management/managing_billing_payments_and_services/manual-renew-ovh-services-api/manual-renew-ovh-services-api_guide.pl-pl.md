...
- Utworzenie [danych identyfikacyjnych dla API OVH](first-steps1.)

## W praktyce

Aby użyć [API do odnowienia usługi](renew#GET.){.external}, będziesz potrzebował `serviceId`. Informacja ta jest dostępna poprzez API, za pomocą `serviceInfos`:
