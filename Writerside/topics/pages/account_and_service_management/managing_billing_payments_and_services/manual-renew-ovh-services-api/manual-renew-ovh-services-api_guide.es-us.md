...
- Disponer de las [claves para conectarse a la API de OVHcloud -EN](first-steps1.){.external}.

## Procedimiento

Para utilizar la [función de renovación de la API]({serviceId}_renew#GET.){.external}, necesitará el **serviceId**. Puede obtener este dato con la función **serviceInfos**, como en el siguiente ejemplo:
