...
- Sie haben Ihre [Zugangsdaten für die OVHcloud API eingerichtet - EN](first-steps1.).

## In der praktischen Anwendung

Um die [Verlängerungs-API](renew#GET.){.external} zu verwenden, benötigen Sie die `serviceId`. Diese Information finden Sie in der API `serviceInfos`, zum Beispiel:
