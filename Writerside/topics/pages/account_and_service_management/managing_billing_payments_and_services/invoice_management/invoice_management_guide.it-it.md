...
- Avere accesso allo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it) come [contatto di fatturazione](managing_contacts1.) del servizio
...
![Dettaglio di una fattura](invoice_ovh.png){.thumbnail}
...
![Fatturazione](hubinvoices.png){.thumbnail}

Visualizzi una tabella con tutte le fatture associate al tuo identificativo:

![Riepilogo delle fatture](billing_section.png){.thumbnail}
...
![Azioni sulle fatture](actions_choices.png){.thumbnail}
...
![Filtri](sort_filters.png){.thumbnail}
...
![Pagamento dell’importo dovuto](pay_debt.png){.thumbnail}

Verrà creato un [buono d'ordine](managing_ovh_orders#il-buono-dordine.). Una volta effettuato il pagamento, la situazione risulterà regolarizzata.

#### Richiedi l'annullamento di una fattura

> [!primary]
>
> Per richiedere la disattivazione del tuo servizio alla data di scadenza, segui le indicazioni di questa [guida](how_to_cancel_services1.).
>

Se hai ricevuto una fattura che non consideri legittima e vuoi richiederne il rimborso o far valere il tuo [diritto di recesso](managing_ovh_orders#esercita-il-diritto-di-recesso.), puoi inviare un reclamo tramite il tuo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it), con riserva dell'applicazione delle nostre [Condizioni Generali di Servizio](https://www.ovh.it/supporto//documenti_legali/condizioni_generali_servizio.pdf).
...
![Verifica dei pagamenti](payment_tracking.png){.thumbnail}
