...
- Estar conectado al [área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es) como [contacto de facturación](managing_contacts1.) del servicio.
...
![Detalles de una factura](invoice_ovh.png){.thumbnail}
...
![Facturación](hubinvoices.png){.thumbnail}

Será redirigido a una página en la que podrá consultar todas sus facturas.

![Mis facturas](billing_section.png){.thumbnail}
...
![Opciones](actions_choices.png){.thumbnail}
...
![Filtros](sort_filters.png){.thumbnail}
...
![Seguimiento de los pagos](payment_tracking.png){.thumbnail}
