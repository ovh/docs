...
- Access to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca) as the [Billing contact](managing_contacts1.) of your service
...
![Bill detail](invoice_ovh.png){.thumbnail}
...
![Billing](hubinvoices.png){.thumbnail}

You will then land on a page summarising your bills:

![Bill summary](billing_section.png){.thumbnail}
...
![Actions for bills](actions_choices.png){.thumbnail}
...
![Sort filters](sort_filters.png){.thumbnail}
...
![Pay a due amount](pay_debt.png){.thumbnail}

A [settlement purchase order](managing_ovh_orders#purchase-order.) will then be created. Once the payment has been made, your account will be balanced again.

#### Request invoice cancellation

> [!primary]
>
> To request that your service be cancelled on the expiry date, follow the instructions in [this guide](how_to_cancel_services1.).
>
...
![Track payments](payment_tracking.png){.thumbnail}
...
[Managing renewal for your services](how_to_use_automatic_renewal1.)
