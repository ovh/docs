...
- Ter acesso à [Área de Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pt/&ovhSubsidiary=pt) enquanto [contacto de faturação](managing_contacts1.) do serviço.
...
![Detalhes de uma fatura](invoice_ovh.png){.thumbnail}
...
![Faturação](hubinvoices.png){.thumbnail}

Aparecerá uma página onde poderá consultar todas as suas faturas.

![Recapitulativo das faturas](billing_section.png){.thumbnail}
...
![Ações nas faturas](actions_choices.png){.thumbnail}
...
![Filtros de tri](sort_filters.png){.thumbnail}
...
![Pagamento da dívida](pay_debt.png){.thumbnail}

Será criada uma [nota de encomenda de regularização](managing_ovh_orders#a-nota-de-encomenda.). Uma vez realizado o pagamento, a situação ficará regularizada.

#### Pedir a anulação de uma fatura

> [!primary]
>
> Para solicitar a rescisão do serviço na data de expiração, siga as instruções deste [guia](how_to_cancel_services1.).
>

Se recebeu uma fatura que não considera legítima e deseja pedir o seu reembolso, ou fazer valer o seu [direito de retratação](managing_ovh_orders#direito-de-retratacao.), pode efetuar uma reclamação através do seu [Área de Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pt/&ovhSubsidiary=pt), sob reserva da aplicação das nossas [Condições Gerais de Serviço](https://www.ovh.pt/suporte/documentos_legais/OVH_COND_GERAIS.pdf).
...
![Pagamentos](payment_tracking.png){.thumbnail}
