...
![prodotti e servizi](products-services.png){.thumbnail}
...
![disattiva](cancel-en.png){.thumbnail}
...
![richiesta di disattivazione](cancellation-request.png){.thumbnail}

### Casi particolari <a name="specific-cases"></a>

#### MX Plan <a name="mxplan"></a>

La maggior parte dei servizi MX Plan sono associati a un hosting. Se è il caso, e vuoi eliminare questa opzione email, segui [le istruzioni contenute in questa guida](activate-email-hosting#elimina-il-servizio-email-associato-allhosting-web.). **Attenzione**, la cancellazione di un MX Plan comporta la cancellazione definitiva di tutti i dati ad esso associati e non dà diritto ad alcun rimborso.
...
Per disattivare la tua offerta [Email Pro](https://www.ovhcloud.com/it/emails/email-pro/), segui le indicazioni di questa [guida](manage_billing_emailpro#elimina-account.).

#### Hosted Exchange <a name="hosted"></a>

Per disattivare la soluzione [Hosted Exchange](https://www.ovhcloud.com/it/emails/hosted-exchange/), segui le indicazioni di questa [guida](manage_billing_exchange#elimina-account.).

#### Private Exchange <a name="private"></a>

Per disattivare la tua offerta [Private Exchange](https://www.ovhcloud.com/it/emails/private-exchange/), segui le indicazioni di questa [guida](manage_billing_exchange#elimina-account_1.).

#### Office 365 csp 1 <a name="office-csp1"></a>

Per disattivare la tua offerta [Office 365 csp 1](https://www.ovhcloud.com/it/collaborative-tools/microsoft-365/), segui questa [guida](office_csp1#gestisci-i-tuoi-abbonamenti.).

#### Office 365 csp 2 <a name="office-csp2"></a>

Per disattivare la tua offerta [Office 365 csp 2](https://www.ovhcloud.com/it/collaborative-tools/microsoft-365/reseller/), segui questa [guida](office_csp2#gestisci-i-tuoi-abbonamenti.).
...
Per disattivare la soluzione [Managed bare metal](https://www.ovhcloud.com/it/managed-bare-metal/), segui le indicazioni di questa [guida](how-to-cancel1.).

#### VMware on OVHcloud <a name="hostedprivatecloud-vmware"></a>

Per disattivare la soluzione [VMware on OVHcloud](https://www.ovhcloud.com/it/enterprise/products/hosted-private-cloud/), segui le istruzioni di questa [guida](comment_resilier_le_private_cloud1.).
...
Il Public Cloud OVHcloud si basa sul principio del *Pay as you go* (per maggiori informazioni, consulta la pagina [relativa alla fatturazione Public Cloud](analyze_billing1.)). Alla fine del mese viene fatturato solo il tempo di utilizzo effettivo delle risorse.

Accedi allo Spazio Cliente OVHcloud per [consultare i tuoi consumi correnti](analyze_billing#consulta-lo-stato-dei-tuoi-consumi.) e vieni avvisato via email quando la proiezione dei tuoi consumi supera una determinata soglia.
...
![cancel_termination](cancel_termination-en.png){.thumbnail}
...
>>
>> - È necessario essere il contatto amministratore del servizio. Per ulteriori informazioni, vedere [questa guida](managing_contacts#definition.).
>> - Il servizio è in **rinnovo automatico**. Se il tuo servizio è in [rinnovo manuale](how_to_use_automatic_renewal#auto-vs-manual.), verrà sospeso alla data di scadenza e poi eliminato dopo alcuni giorni.
>> - Il servizio non è sospeso, in particolare a causa di un mancato pagamento di una fattura. Verificare di essere aggiornati in [pagamenti](invoice_management#pay-bills.) e [rinnovi](how_to_use_automatic_renewal#renewal-management.) dei servizi.
>>
...
[Gestire il rinnovo dei servizi OVHcloud](how_to_use_automatic_renewal1.)
