...
>
Weitere Informationen finden Sie in den [FAQ](how_to_use_automatic_renewal#faq.) am Ende unserer Anleitung zur [Verlängerung von OVHcloud Diensten](how_to_use_automatic_renewal1.).
>

## Voraussetzungen

- Sie sind der "Administrator-Kontakt" des Dienstes, den Sie kündigen möchten (weitere Informationen finden Sie in [dieser Anleitung](managing_contacts#definition.)).
...
![Produkte und Dienstleistungen](products-services.png){.thumbnail}
...
![Kündigen](cancel-en.png){.thumbnail}
...
Um [E-Mail Pro](https://www.ovhcloud.com/de/emails/email-pro/) zu kündigen, folgen Sie den Anweisungen in [dieser Anleitung](manage_billing_emailpro#konten-entfernen.).

#### Hosted Exchange <a name="hosted"></a>

Um [Hosted Exchange](https://www.ovhcloud.com/de/emails/hosted-exchange/) zu kündigen, folgen Sie den Anweisungen in [dieser Anleitung](manage_billing_exchange#accounts-entfernen.).

#### Private Exchange <a name="private"></a>

Um [Private Exchange](https://www.ovhcloud.com/de/emails/private-exchange/) zu kündigen, folgen Sie den Anweisungen in [dieser Anleitung](manage_billing_exchange#accounts-entfernen_1.).

#### Office 365 CSP1 <a name="office-csp1"></a>

Um [Office 365 CSP1](https://www.ovhcloud.com/de/collaborative-tools/microsoft-365/) zu kündigen, folgen Sie den Anweisungen in [dieser Anleitung](office_csp1#ihre-abonnements-verwalten.).

#### Office 365 CSP2 <a name="office-csp2"></a>

Um [Office 365 CSP2](https://www.ovhcloud.com/de/collaborative-tools/microsoft-365/) zu kündigen, folgen Sie den Anweisungen in [dieser Anleitung](office_csp2#ihre-abos-verwalten.).
...
Um Ihren [Managed Bare Metal](https://www.ovhcloud.com/de/managed-bare-metal/) Dienst zu kündigen, folgen Sie den Anweisungen in [dieser Anleitung](how-to-cancel1.).

#### VMware on OVHcloud <a name="hostedprivatecloud-vmware"></a>

Um Ihre [VMware on OVHcloud](https://www.ovhcloud.com/de/hosted-private-cloud/) zu kündigen, folgen Sie den Anweisungen in [dieser Anleitung](comment_resilier_le_private_cloud1.).
...
![public cloud instance deletion](pci-deletion.png){.thumbnail}

Die OVHcloud Public Cloud basiert auf dem Prinzip *Pay as you go* (weitere Details finden Sie auf unserer Seite zum [Abrechnungsmodus Public Cloud](analyze_billing1.)). Sie zahlen am Monatsende nur für die Zeit, in der die Ressourcen tatsächlich genutzt wurden.

Sie können Ihren [aktuellen Verbrauch](analyze_billing#aktuelle-ressourcennutzung-anzeigen.) auch über das OVHcloud Kundencenter einsehen und per E-Mail benachrichtigt werden, wenn die Projektion Ihres Nutzungsvolumens einen bestimmten Grenzwert überschreitet.
...
>>
>> - Sie müssen der "Administrator-Kontakt" des Dienstes sein. Weitere Informationen finden Sie in [dieser Anleitung](managing_contacts#definition.).
>> - Der Dienst wird **automatisch** verlängert. Wenn Ihr Dienst die [manuelle Verlängerung](how_to_use_automatic_renewal#auto-vs-manual.) nutzt, wird er erst am Ablaufdatum gesperrt und nach einigen Tagen gelöscht.
>> - Der Dienst wurde nicht suspendiert, insbesondere aufgrund einer nicht beglichenen Rechnung. Stellen Sie sicher, dass die [Zahlungen](invoice_management#pay-bills.) und [Verlängerungen](how_to_use_automatic_renewal#renewal-management.) Ihrer Dienste auf dem neuesten Stand sind.
>>
...
[Verlängerung Ihrer OVHcloud Dienste verwalten](how_to_use_automatic_renewal1.)
