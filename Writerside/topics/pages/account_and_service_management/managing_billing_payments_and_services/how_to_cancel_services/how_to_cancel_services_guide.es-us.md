...
Para dar de baja su servicio [Managed bare metal](https://www.ovhcloud.com/es/managed-bare-metal/), siga las indicaciones de esta [guía](how-to-cancel1.).

#### VMware on OVHcloud <a name="hostedprivatecloud-vmware"></a>

Para dar de baja su servicio [VMware on OVHcloud](https://www.ovhcloud.com/es/enterprise/products/hosted-private-cloud/), siga las indicaciones de esta [guía](comment_resilier_le_private_cloud1.).
