...
- Les [fonctionnalités principales](05-snc-vmware-reversibility-policy_#fonctionnalites-principales.) pour lesquelles nous garantissons la capacité de migrer.
- L'[implémentation OVHcloud](05-snc-vmware-reversibility-policy_#ovhcloud-implementation.), dont la migration nécessitera des adaptations à un nouvel environnement.
- Les [fonctionnalités spécifiques](05-snc-vmware-reversibility-policy_#fonctionnalites-specifiques.), dont la migration en tant que telle est impossible à garantir car elle est liée à l'environnement OVHcloud ou à des développements spécifiques.
...
[Convertir une machine physique/virtuelle en une infrastructure Cloud](vmware_vcenter_converter1.).
