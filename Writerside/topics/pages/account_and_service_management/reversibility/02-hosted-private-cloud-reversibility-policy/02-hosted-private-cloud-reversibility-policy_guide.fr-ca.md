...
- Les [fonctionnalités principales](02-hosted-private-cloud-reversibility-policy_#fonctionnalites-principales.) pour lesquelles nous garantissons la capacité de migrer.
- L'[implémentation OVHcloud](02-hosted-private-cloud-reversibility-policy_#ovhcloud-implementation.), dont la migration nécessitera des adaptations à un nouvel environnement.
- Les [fonctionnalités spécifiques](02-hosted-private-cloud-reversibility-policy_#fonctionnalites-specifiques.), dont la migration en tant que telle est impossible à garantir car elle est liée à l'environnement OVHcloud ou à des développements spécifiques.
...
[Importer/exporter des machnes virtuelles](ovf_tool1.).
