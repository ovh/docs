...
This document is the reversibility policy for the **Web Hosting** product for the [domain name](https://www.ovhcloud.com/pl/domains/) activity.
...
|----|-----|---|-----|-----|
|Register and manage Domain names|Reservation and registration of domain names with domain name registrars.<br><br>DNS setting of domain names.|N/A|**Inbound migration**: Transfer request to original registrar and then manage via [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl)<br><br>**Outbound migration**: Fully managed transfer request in [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl).|**Inbound migration**: [Transferring a domain name to OVHcloud](transfer_incoming_generic_domain1.)<br><br>[Transferring a .co.uk domain name to OVHcloud](transfer_incoming_couk1.)<br><br>**Outbound migration**: [Transferring a domain name to another registrar](transfer_outgoing_domain1.)<br><br>[Transferring a .co.uk domain name to another registrar](transfer_outgoing_couk1.)|
...
|Load Balancing|Load Balancers are network devices that distribute requests across services and datacenters to ensure that there is no overload.|N/A|**Inbound migration**: Purchase and activation through the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl).<br><br>**Outbound migration**: Order and set up a load balancer with the new provider|**Inbound migration**: [OVHcloud Load Balancers](https://www.ovh.co.uk/solutions/load-balancer/)<br><br>**Outbound migration**: N/A|

### Architecture listing

All components of an OVHcloud Web product are accessible through the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl). This allows to visualize and manage the front-end web servers, file servers, databases, domain names, email, ... as well as the features that are attached to these components.
