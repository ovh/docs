...
- Ter criado a [sua conta OVHcloud](ovhcloud-account-creation1.)
- Estar ligado à [Área de Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pt/&ovhSubsidiary=pt).

> [!primary]
> Em caso de dificuldades de ligação à sua conta, consulte a secção "[Não consigo conectar](ovhcloud-account-login#login-failure.)-me" do nosso manual "[Aceder à Área de Cliente OVHcloud](ovhcloud-account-login1.)".
>
...
Encontre todas as nossas recomendações sobre as palavras-passe no nosso manual "[Alterar a palavra-passe da sua conta](manage-ovh-password1.)".

#### Guardar a sua password

Se ainda não o fez, guarde a sua palavra-passe num [gestor de palavras-passe](manage-ovh-password#utilizar-um-gestor-de-palavras-passe.).
...
![endereço de e-mail de recurso](edit-profile.png){.thumbnail}
...
Encontrará todos os detalhes para o ativar no nosso manual "[Proteger a sua conta OVHcloud com a dupla autenticação](secure-ovhcloud-account-with-2fa1.)".
...
![identificador de cliente](edit-profile.png){.thumbnail}
...
![identificador de cliente](nichandle07.png){.thumbnail}

Introduza o código no campo `Código de validação` e valide.

![identificador de cliente](nichandle08.png){.thumbnail}
...
![identificador de cliente](nichandle09.png){.thumbnail}
...
Para saber mais, consulte o [guia sobre a gestão dos utilizadores](ovhcloud-users-management1.).

#### Gerir contactos

É possível delegar noutro identificador de cliente a gestão administrativa **ou** técnica **ou** de faturação de um ou vários serviços associados à sua conta. Para saber mais, consulte o [guia sobre gestão de contactos](managing_contacts1.).

### O que fazer em caso de suspeição de usurpação de identidade?

Se receber um e-mail a dar-lhe conta de um acesso incomum à sua Área de Cliente, deve [alterar imediatamente a palavra-passe da sua conta](manage-ovh-password#alterar-a-sua-palavra-passe.) e [protegê-la por meio de uma dupla autenticação](secure-ovhcloud-account-with-2fa1.).
...
[Em caso de falha de ligação à Área de Cliente](ovhcloud-account-login#login-failure.)
