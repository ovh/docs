...
- Sie haben [Ihren OVHcloud Kunden-Account erstellt](ovhcloud-account-creation1.)
- Sie sind in Ihrem [OVHcloud Kundencenter](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de) angemeldet.

> [!primary]
> Bei Verbindungsschwierigkeiten zu Ihrem Account lesen Sie den [entsprechenden Abschnitt in unserer Anleitung "In das OVHcloud Kundencenter einloggen"](ovhcloud-account-login#login-failure.).
>
...
Alle Empfehlungen zu Passwörtern finden Sie in unserer [Anleitung zur Passwortänderung](manage-ovh-password1.).

#### Passwort speichern

Wenn Sie das noch nicht getan haben, speichern Sie Ihr Passwort in einem [Passwort-Manager](manage-ovh-password#einen-passwort-manager-verwenden.).
...
![Alternative E-Mail-Adresse](edit-profile.png){.thumbnail}
...
Weitere Informationen zur Aktivierung finden Sie in unserer Anleitung "[Den OVHcloud Kunden-Account mit der Zwei-Faktor-Authentifizierung absichern](secure-ovhcloud-account-with-2fa1.)" sichern.
...
![Kundenkennung](edit-profile.png){.thumbnail}
...
![Kundenkennung](nichandle07.png){.thumbnail}

Geben Sie den Code im Feld `Validierungscode` ein und bestätigen Sie.

![Kundenkennung](nichandle08.png){.thumbnail}
...
![Kundenkennung](nichandle09.png){.thumbnail}
...
Weitere Informationen finden Sie in der [Anleitung zur Benutzerverwaltung](ovhcloud-users-management1.).

#### Kontakte verwalten

Sie können die administrative **oder** technische Verwaltung **oder** die Rechnungsverwaltung eines oder mehrerer Dienste Ihres Accounts an eine andere Kundenkennung übertragen. Um mehr zu erfahren, lesen Sie die [Anleitung zur Verwaltung der Kontakte](managing_contacts1.).

### Was sollte ich bei Verdacht auf Identitätsbetrug tun?

Wenn Sie per E-Mail über eine unbekannte Verbindung mit Ihrem Kundencenter informiert werden, empfehlen wir Ihnen, sofort [Ihr Passwort zu ändern](manage-ovh-password#passwort-andern.) und Ihren Account zusätzlich [mit Zwei-Faktor-Authentifizierung zu schützen](secure-ovhcloud-account-with-2fa1.).
...
[Bei fehlschlagendem Login ins Kundencenter](ovhcloud-account-login#login-failure.)
