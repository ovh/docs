...
> [!primary]
> Si necesita ayuda para conectarse a su cuenta, consulte la sección "[No consigo conectarme](ovhcloud-account-login#login-failure.)" de nuestra guía "[Conectarse al área de cliente de OVHcloud](ovhcloud-account-login1.)".
>
...
Consulte todas nuestras recomendaciones sobre las contraseñas en nuestra guía [Cambiar la contraseña de su cuenta](manage-ovh-password1.).

#### Guardar la contraseña

Si todavía no lo ha hecho, guarde su contraseña en un [gestor de contraseñas](manage-ovh-password#utilizar-un-gestor-de-contrasenas.).
...
![dirección de correo electrónico alternativa](edit-profile.png){.thumbnail}
...
Para más información, consulte nuestra guía [Proteger su cuenta de OVHcloud con la doble autenticación](secure-ovhcloud-account-with-2fa1.).
...
![ID cliente](edit-profile.png){.thumbnail}
...
![ID cliente](nichandle07.png){.thumbnail}

Introduzca el código en el campo `Código de validación` y acepte.

![ID cliente](nichandle08.png){.thumbnail}
...
![ID cliente](nichandle09.png){.thumbnail}
...
Para más información, consulte la [guía sobre la gestión de usuarios](ovhcloud-users-management1.).

#### Gestionar los contactos

Puede delegar la gestión administrativa, técnica **o****** de facturación de uno o varios servicios de su cuenta a otro identificador de cliente. Consulte la guía sobre [la gestión de los contactos](managing_contacts1.) para obtener más información.

### ¿Qué hacer si sospecha de una usurpación de identidad?

Si recibe un mensaje de correo electrónico en el que se le informa de un inicio de sesión desconocido en su área de cliente, le recomendamos [cambiar inmediatamente la contraseña de su cuenta](manage-ovh-password#modificar-la-contrasena.) y [protegerla con la doble autenticación](secure-ovhcloud-account-with-2fa1.).
...
[En caso de fallo de la conexión al área de cliente](ovhcloud-account-login#login-failure.)
