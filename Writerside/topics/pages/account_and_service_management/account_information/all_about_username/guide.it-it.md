...
- Aver creato [il tuo account OVHcloud](ovhcloud-account-creation1.)
- Avere accesso allo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it)

> [!primary]
> In caso di difficoltà di connessione al tuo account, consulta la sezione "[Non riesco a connettermi](all_about_username#login-failure.)" della nostra guida [Accedere allo Spazio Cliente OVHcloud](ovhcloud-account-login1.).
>
...
Per maggiori informazioni sulle password, consulta la guida [Modificare la password del tuo account](manage-ovh-password1.).

#### Salva la password

Se non l'hai ancora fatto, salva la password in un [gestore di password](manage-ovh-password#utilizza-un-software-per-la-gestione-di-password.).
...
![indirizzo email di recupero](edit-profile.png){.thumbnail}
...
Per maggiori informazioni, consulta la nostra guida [Proteggere un account OVHcloud con la doppia autenticazione](secure-ovhcloud-account-with-2fa1.).
...
![identificativo cliente](edit-profile.png){.thumbnail}
...
![identificativo cliente](nichandle07.png){.thumbnail}

Inserisci il codice nel campo `Codice di conferma` e conferma l'operazione.

![identificativo cliente](nichandle08.png){.thumbnail}
...
![identificativo cliente](nichandle09.png){.thumbnail}
...
Per maggiori informazioni, consulta la [guida sulla gestione degli utenti](ovhcloud-users-management1.).

#### Gestisci i contatti

È possibile delegare la gestione amministrativa **o** tecnica **o** di fatturazione di uno o più servizi del tuo account a un altro identificativo cliente. Per saperne di più, consulta [la guida sulla gestione dei contatti](managing_contacts1.).

### Che fare in caso di sospetta usurpazione d’identità?

Se ricevi una email che indica un accesso sconosciuto al tuo Spazio Cliente, ti consigliamo di [modificare immediatamente la password del tuo account](manage-ovh-password#modifica-la-password.) e di [proteggerlo tramite l’attivazione della doppia autenticazione](secure-ovhcloud-account-with-2fa1.).
...
[Modifica la password del tuo account](manage-ovh-password1.)
...
[Se la connessione allo Spazio Cliente OVH non funziona](ovhcloud-account-login#login-failure.)
