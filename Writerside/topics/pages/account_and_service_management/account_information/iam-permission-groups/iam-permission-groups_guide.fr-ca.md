...
- Savoir [mettre en place des politiques IAM via l'espace client](iam-policy-ui1.)
- Savoir [mettre en place des politiques IAM via l'API](iam-policies-api1.)
...
![Permissions groups UI](permissions_groups_ui.png){.thumbnail}
