...
Sur [la page d'identification OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), renseignez votre [identifiant](ovhcloud-account-creation#quel-est-mon-identifiant-client.) suivi de **/idp** sans mot de passe et cliquez sur le bouton `Login`{.action} .
