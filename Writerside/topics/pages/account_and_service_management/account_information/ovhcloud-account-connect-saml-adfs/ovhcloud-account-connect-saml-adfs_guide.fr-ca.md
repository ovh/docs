...
![Menu Outils Windows Server](windows_server_tools_menu.png){.thumbnail}
...
![Menu d'approbations AD FS](adfs_relying_party_trusts_menu.png){.thumbnail}

Sélectionnez `Claims aware`{.action} et validez avec le bouton `Start`{.action}.

![AD FS ajouter une approbation - étape 1](adfs_add_relying_party_trust_1.png){.thumbnail}
...
![AD FS - ajouter une approbation - étape 2](adfs_add_relying_party_trust_2.png){.thumbnail}

Entrez un nom d'affichage pour l'organisme tiers de confiance et cliquez sur le bouton `Next`{.action}.

![AD FS - ajouter une approbation - étape 3](adfs_add_relying_party_trust_3.png){.thumbnail}

Cliquez sur `Next`{.action} dans la fenêtre du contrôle d'accès.

![AD FS - ajouter une approbation - étape 4](adfs_add_relying_party_trust_4.png){.thumbnail}

Cliquez de nouveau sur `Next`{.action} pour continuer.

![AD FS - ajouter une approbation - étape 5](adfs_add_relying_party_trust_5.png){.thumbnail}
...
![Approbations AD FS](adfs_relying_party_trusts.png){.thumbnail}
...
![Mappage d'approbation AD FS étape 1](adfs_relying_party_trusts_mapping_1.png){.thumbnail}

Cliquez ensuite sur `Edit Claim Issuance Policy...`{.action}.

![Mappage d'approbation AD FS étape 2](adfs_relying_party_trusts_mapping_2.png){.thumbnail}

Cliquez sur le bouton `Add Rule...`{.action}.

![Mappage d'approbation AD FS étape 3](adfs_relying_party_trusts_mapping_3.png){.thumbnail}
...
![Mappage d'approbation AD FS étape 4](adfs_relying_party_trusts_mapping_4.png){.thumbnail}

![Mappage d'approbation AD FS étape 5](adfs_relying_party_trusts_mapping_5.png){.thumbnail}

Cliquez sur le bouton `Apply`{.action} et validez avec `OK`{.action}.

![Mappage d'approbation étape 6](adfs_relying_party_trusts_mapping_6.png){.thumbnail}
...
![Informations utilisateur OVHcloud](ovhcloud_user_infos.png){.thumbnail}
...
![OVHcloud connexion SSO étape 1](ovhcloud_user_management_connect_sso_1.png){.thumbnail}
...
![OVHcloud connexion SSO étape 2](ovhcloud_user_management_connect_sso_2.png){.thumbnail}

Vous devez maintenant retrouver votre AD FS en tant que fournisseur d'identité, ainsi que les groupes par défaut.

![OVHcloud connexion SSO étape 3](ovhcloud_user_management_connect_sso_3.png){.thumbnail}

Pour plus d'informations, cliquez sur le lien situé sous l'`URL du service SSO`.

![OVHcloud connexion SSO étape 4](ovhcloud_user_management_connect_sso_4.png){.thumbnail}

![OVHcloud connexion SSO étape 5](ovhcloud_user_management_connect_sso_5.png){.thumbnail}

Le bouton `...`{.action} permet de mettre à jour ou de supprimer le SSO, et d’en consulter les détails.

![OVHcloud connexion SSO étape 6](ovhcloud_user_management_connect_sso_6.png){.thumbnail}
...
![Utilisateur AD FS](adfs_user.png){.thumbnail}

Vérifiez le tableau de correspondances dans AD FS :

![Mappage d'approbation de partie de confiance AD FS](adfs_relying_party_trusts_mapping_4.png){.thumbnail}
...
![Groupes de gestion des utilisateurs AD FS](ovhcloud_user_management_groups_1.png){.thumbnail}

![Groupes de gestion des utilisateurs AD FS](ovhcloud_user_management_groups_2.png){.thumbnail}

Vous pourrez ensuite vérifier que le groupe est ajouté à votre compte OVHcloud dans la section `Groupes` :

![Groupes de gestion des utilisateurs AD FS](ovhcloud_user_management_groups_3.png){.thumbnail}
...
![Connexion à la fédération OVHcloud](ovhcloud_federation_login_1.png){.thumbnail}
...
![OVHcloud Federation login Redirection AD FS](ovhcloud_federation_login_2.png){.thumbnail}
...
![Fédération des infos utilisateurs OVHcloud](ovhcloud_user_infos_federation.png){.thumbnail}
