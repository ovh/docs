...
![Menú Herramientas Windows Server](windows_server_tools_menu.png){.thumbnail}
...
![Menú de aprobación AD FS](adfs_relying_party_trusts_menu.png){.thumbnail}

Seleccione `Claims aware`{.action} y acepte con el botón `Start`{.action}.

![AD FS añadir aprobación - etapa 1](adfs_add_relying_party_trust_1.png){.thumbnail}
...
![AD FS - Añadir una aprobación - etapa 2](adfs_add_relying_party_trust_2.png){.thumbnail}

Escriba un nombre para mostrar el organismo tercero de confianza y haga clic en el botón `Next`{.action}.

![AD FS - Añadir una aprobación - etapa 3](adfs_add_relying_party_trust_3.png){.thumbnail}

Haga clic en `Next`{.action} en la ventana de control de acceso.

![AD FS - Añadir una aprobación - etapa 4](adfs_add_relying_party_trust_4.png){.thumbnail}

Haga clic de nuevo en `Next`{.action} para continuar.

![AD FS - Añadir una aprobación - etapa 5](adfs_add_relying_party_trust_5.png){.thumbnail}
...
![Aprobación AD FS](adfs_relying_party_trusts.png){.thumbnail}
...
![Mapeo de aprobación AD FS etapa 1](adfs_relying_party_trusts_mapping_1.png){.thumbnail}

Haga clic en `Edit Claim Issuance Policy...`{.action}.

![Mapeo de aprobación AD FS etapa 2](adfs_relying_party_trusts_mapping_2.png){.thumbnail}

Haga clic en el botón `Add Rule...`{.action}.

![Mapeo de aprobación AD FS etapa 3](adfs_relying_party_trusts_mapping_3.png){.thumbnail}
...
![Mapeo de aprobación AD FS etapa 4](adfs_relying_party_trusts_mapping_4.png){.thumbnail}

![Mapeo de aprobación AD FS etapa 5](adfs_relying_party_trusts_mapping_5.png){.thumbnail}

Haga clic en el botón `Apply`{.action} y acepte con `OK`{.action}.

![Mapeo de aprobación paso 6](adfs_relying_party_trusts_mapping_6.png){.thumbnail}
...
![Información de usuario de OVHcloud](ovhcloud_user_infos.png){.thumbnail}

Abra la pestaña `Gestión de usuarios`{.action}.

![Perfil del menú OVHcloud](ovhcloud_profile_menu.png){.thumbnail}

Haga clic en el botón `SSO connection`{.action}.

![OVHcloud conexión SSO etapa 1](ovhcloud_user_management_connect_sso_1.png){.thumbnail}
...
![OVHcloud conexión SSO etapa 2](ovhcloud_user_management_connect_sso_2.png){.thumbnail}

Ahora debe encontrar el AD FS como proveedor de identidad, así como los grupos por defecto.

![OVHcloud conexión SSO etapa 3](ovhcloud_user_management_connect_sso_3.png){.thumbnail}

Para más información, haga clic en el enlace situado bajo la `URL del servicio SSO`.

![OVHcloud conexión SSO etapa 4](ovhcloud_user_management_connect_sso_4.png){.thumbnail}

![OVHcloud conexión SSO etapa 5](ovhcloud_user_management_connect_sso_5.png){.thumbnail}

El botón `...`{.action} permite actualizar o eliminar el SSO y consultar los detalles.

![OVHcloud conexión SSO etapa 6](ovhcloud_user_management_connect_sso_6.png){.thumbnail}
...
![Usuario AD FS](adfs_user.png){.thumbnail}

Compruebe la tabla de correspondencias en AD FS :

![Mapeo de aprobación de parte de confianza AD FS](adfs_relying_party_trusts_mapping_4.png){.thumbnail}
...
![Grupos de gestión de usuarios AD FS](ovhcloud_user_management_groups_1.png){.thumbnail}

![Grupos de gestión de usuarios AD FS](ovhcloud_user_management_groups_2.png){.thumbnail}

A continuación, compruebe que el grupo se ha añadido a su cuenta de OVHcloud en la sección `Grupos`:

![Grupos de gestión de usuarios AD FS](ovhcloud_user_management_groups_3.png){.thumbnail}
...
![Conexión a la federación OVHcloud](ovhcloud_federation_login_1.png){.thumbnail}
...
![Federación de la información de los usuarios de OVHcloud](ovhcloud_user_infos_federation.png){.thumbnail}
