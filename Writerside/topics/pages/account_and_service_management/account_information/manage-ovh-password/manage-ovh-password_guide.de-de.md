...
![ovh-passwort-verwalten](account-password-modif-manager-step4.png){.thumbnail}
...
![ovh-passwort-verwalten](account-password-modif-forgotten-step1.png){.thumbnail}
...
![ovh-passwort-verwalten](account-password-modif-forgotten-step2.png){.thumbnail}

- Eine Meldung erscheint, die den Versand der Informationen bestätigt.

![ovh-passwort-verwalten](account-password-modif-forgotten-step3.png){.thumbnail}
