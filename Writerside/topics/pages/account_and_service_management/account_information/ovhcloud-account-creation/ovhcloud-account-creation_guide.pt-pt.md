...
![formulário criação conta](account-creation.png){.thumbnail}
...
|Palavra-passe|A sua palavra-passe deve ser única (criada e utilizada apenas para a sua conta OVHcloud) e suficientemente complexa.<br><br>Para criar uma palavra-passe eficaz, consulte os conselhos do [nosso guia sobre a gestão da palavra-passe](manage-ovh-password#instrucoes.).|
...
![código de utilização única](code.png){.thumbnail}
...
![formulário criação conta](account-type.png){.thumbnail}
...
![identificador de cliente](nic-handle.png){.thumbnail}
...
Agora que a sua conta OVHcloud foi criada, recomendamos que siga as nossas [recomendações sobre a segurança da sua conta e a gestão dos seus dados pessoais](all_about_username1.).

Consulte também os nossos guias para:

[Aceder à Área de Cliente OVHcloud](ovhcloud-account-login1.)

[Alterar a palavra-passe da sua conta OVHcloud](manage-ovh-password1.)
