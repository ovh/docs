...
![formulario creación cuenta](account-creation.png){.thumbnail}
...
|Contraseña|Su contraseña debe ser única (creada y utilizada únicamente por su cuenta de OVHcloud) y ser suficientemente compleja.<br><br>Consulte los consejos de [nuestra guía sobre la gestión de la contraseña](manage-ovh-password#generar-una-contrasena-adecuada.) para crear una contraseña eficaz.|
...
![código de uso único](code.png){.thumbnail}
...
![formulario creación cuenta](account-type.png){.thumbnail}
...
![ID cliente](nic-handle.png){.thumbnail}
...
Una vez que haya creado su cuenta de OVHcloud, le recomendamos que siga nuestras [recomendaciones sobre la seguridad de su cuenta y la gestión de sus datos personales](all_about_username1.).

Consulte también nuestras guías para:

[Conectarse al área de cliente de OVHcloud](ovhcloud-account-login1.)

[Cambiar la contraseña de su cuenta de OVHcloud](manage-ovh-password1.)
