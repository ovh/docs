...
![Ajouter une application SAML, étape 1](OKTA_add_application_step1.png){.thumbnail}

Cliquez sur `Create App Integration`{.action} et sélectionnez `SAML 2.0`{.action}.

![Ajouter une application SAML, étape 2](OKTA_add_application_step2.png){.thumbnail}
...
![Ajouter une application SAML, étape 3](OKTA_add_application_step3.png){.thumbnail}
...
![Ajouter une application SAML, étape 4](OKTA_add_application_step4.png){.thumbnail}
...
![Ajouter une application SAML, étape 5](OKTA_add_application_step5.png){.thumbnail}
...
![Affecter des utilisateurs](OKTA_add_user.png){.thumbnail}
...
![Récupérer les métadonnées](OKTA_retrieve_metadata.png){.thumbnail}
...
![Connexion SSO OVHcloud étape 1](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_connect_sso_1.png){.thumbnail}
...
![Connexion SSO OVHcloud étape 2](ovhcloud_add_federation.png){.thumbnail}

Vous devez maintenant retrouver votre Okta en tant que fournisseur d'identité, ainsi que les groupes par défaut.

![Connexion SSO OVHcloud étape 3](ovhcloud_add_federation_success.png){.thumbnail}

Pour plus d'informations, cliquez sur le lien sous « URL du service SSO ».

![Connexion SSO OVHcloud étape 4](ovhcloud_idp_details.png){.thumbnail}

Le bouton `...`{.action} permet de mettre à jour ou de supprimer le SSO, et d'en consulter les détails.

![Connexion SSO OVHcloud étape 5](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_connect_sso_5.png){.thumbnail}
...
![Groupes de gestion des utilisateurs Okta](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_groups_1.png){.thumbnail}

![Groupes de gestion des utilisateurs Okta](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_groups_2.png){.thumbnail}

Vous pourrez ensuite vérifier que le groupe est ajouté à votre compte OVHcloud dans la section « Groupes » :

![Groupes de gestion des utilisateurs Okta](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_groups_3.png){.thumbnail}
...
Sur [la page d'identification OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc), renseignez votre [identifiant](ovhcloud-account-creation#quel-est-mon-identifiant-client.) suivi de **/idp** sans mot de passe et cliquez sur le bouton `Connexion`{.action}.

![Connexion à la fédération OVHcloud](ovhcloud-account-connect-saml-okta_images_ovhcloud_federation_login_1.png){.thumbnail}
...
[Création d'un compte OVHcloud](ovhcloud-account-creation1.)

[Sécuriser mon compte OVHcloud et gérer mes informations personnelles](all_about_username1.)

[Configuration et gestion du mot de passe de votre compte](manage-ovh-password1.)
