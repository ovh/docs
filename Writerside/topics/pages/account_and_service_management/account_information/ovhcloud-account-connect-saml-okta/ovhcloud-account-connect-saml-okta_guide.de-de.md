...
![Eine SAML Anwendung hinzufügen, Schritt 1](OKTA_add_application_step1.png){.thumbnail}

Klicken Sie auf `Create App Integration`{.action} und wählen Sie `SAML 2.0`{.action}.

![Eine SAML Anwendung hinzufügen, Schritt 2](OKTA_add_application_step2.png){.thumbnail}
...
![Eine SAML Anwendung hinzufügen, Schritt 3](OKTA_add_application_step3.png){.thumbnail}
...
![Eine SAML Anwendung hinzufügen, Schritt 4](OKTA_add_application_step4.png){.thumbnail}
...
![Eine SAML Anwendung hinzufügen, Schritt 5](OKTA_add_application_step5.png){.thumbnail}
...
![Benutzer zuweisen](OKTA_add_user.png){.thumbnail}
...
![Die Metadaten abrufen](OKTA_retrieve_metadata.png){.thumbnail}
...
![OVHcloud Top Menü](ovhcloud-account-connect-saml-okta_images_ovhcloud_top_menu.png){.thumbnail}
...
![OVHcloud Menü Profil](ovhcloud-account-connect-saml-okta_images_ovhcloud_profile_menu.png){.thumbnail}

Klicken Sie auf den Button `SSO-Verbindung`{.action}.

![OVHcloud SSO-Verbindung Schritt 1](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_connect_sso_1.png){.thumbnail}
...
![OVHcloud SSO-Verbindung Schritt 2](ovhcloud_add_federation.png){.thumbnail}

Sie sollten nun Ihren Okta Dienst als Identity Provider sowie die Standardgruppen sehen können.

![OVHcloud SSO-Verbindung Schritt 3](ovhcloud_add_federation_success.png){.thumbnail}

Für weitere Informationen klicken Sie auf den Link unter der `URL des SSO Dienstes`.

![OVHcloud SSO-Verbindung Schritt 4](ovhcloud_idp_details.png){.thumbnail}

Mit dem Button `...`{.action} können Sie den SSO aktualisieren oder löschen und die Details einsehen.

![OVHcloud SSO-Verbindung Schritt 5](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_connect_sso_5.png){.thumbnail}
...
![Okta Benutzer-Verwaltungsgruppen](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_groups_1.png){.thumbnail}

![Okta Benutzer-Verwaltungsgruppen](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_groups_2.png){.thumbnail}

Anschließend können Sie überprüfen, ob die Gruppe zu Ihrem OVHcloud Account im Bereich `Gruppen` hinzugefügt wurde:

![Okta Benutzer-Verwaltungsgruppen](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_groups_3.png){.thumbnail}
...
![Verbindung zum Verband OVHcloud](ovhcloud-account-connect-saml-okta_images_ovhcloud_federation_login_1.png){.thumbnail}
