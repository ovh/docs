...
![Aggiungi un'applicazione SAML, Step 1](OKTA_add_application_step1.png){.thumbnail}

Clicca su `Create App Integration`{.action} e seleziona `SAML 2.0`{.action}.

![Aggiungi un'applicazione SAML, Step 2](OKTA_add_application_step2.png){.thumbnail}
...
![Aggiungi un'applicazione SAML, Step 3](OKTA_add_application_step3.png){.thumbnail}
...
![Aggiungi un'applicazione SAML, Step 4](OKTA_add_application_step4.png){.thumbnail}
...
![Aggiungi un'applicazione SAML, Step 5](OKTA_add_application_step5.png){.thumbnail}
...
![Incidere sugli utenti](OKTA_add_user.png){.thumbnail}
...
![Recupera i metadati](OKTA_retrieve_metadata.png){.thumbnail}
...
![Top menu OVHcloud](ovhcloud-account-connect-saml-okta_images_ovhcloud_top_menu.png){.thumbnail}

Clicca sul tuo nome per accedere alla pagina di gestione del tuo profilo.

![User Information OVHcloud](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_infos.png){.thumbnail}

Apri la scheda `Gestione utenti`{.action}.

![OVHcloud menu progetta](ovhcloud-account-connect-saml-okta_images_ovhcloud_profile_menu.png){.thumbnail}

Clicca sul pulsante `Connessione SSO`{.action}.

![Connessione SSO OVHcloud step 1](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_connect_sso_1.png){.thumbnail}
...
![Connessione SSO OVHcloud step 2](ovhcloud_add_federation.png){.thumbnail}

A questo punto è necessario trovare Okta come provider di identità e i gruppi predefiniti.

![Connessione SSO OVHcloud step 3](ovhcloud_add_federation_success.png){.thumbnail}

Per maggiori informazioni, clicca sul link sotto "URL del servizio SSO".

![Connessione SSO OVHcloud step 4](ovhcloud_idp_details.png){.thumbnail}

Il pulsante `...`{.action} permette di aggiornare o rimuovere l'SO e consulta i dettagli.

![Connessione SSO OVHcloud step 5](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_connect_sso_5.png){.thumbnail}
...
![Gruppi di gestione degli utenti Okta](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_groups_1.png){.thumbnail}

![Gruppi di gestione degli utenti Okta](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_groups_2.png){.thumbnail}

Verifica che il gruppo sia aggiunto al tuo account OVHcloud nella sezione "Gruppi":

![Gruppi di gestione degli utenti Okta](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_groups_3.png){.thumbnail}
...
Nella [pagina di identificazione OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it), inserisci il tuo [identificativo](ovhcloud-account-creation#qual-e-il-mio-identificativo-cliente.) seguito da **/idp** senza password e clicca sul pulsante `Connessione`{.action}.

![Connessione alla federazione OVHcloud](ovhcloud-account-connect-saml-okta_images_ovhcloud_federation_login_1.png){.thumbnail}
...
![OVHcloud Federation login Reindirizzamento Okta](OKTA_login.png){.thumbnail}

Adesso sei connesso con lo stesso identificativo cliente, ma tramite l'utente Okta.

![OVHcloud User Info Federation](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_infos_federation.png){.thumbnail}
...
[Configurazione e gestione della password del tuo account](manage-ovh-password1.)
