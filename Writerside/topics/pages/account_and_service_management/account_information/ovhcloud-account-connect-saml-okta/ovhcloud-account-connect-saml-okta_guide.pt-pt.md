...
![Adicionar uma aplicação SAML, etapa 1](OKTA_add_application_step1.png){.thumbnail}

Clique em `Create App Integration`{.action} e selecione `SAML 2.0`{.action}.

![Adicionar uma aplicação SAML, etapa 2](OKTA_add_application_step2.png){.thumbnail}
...
![Adicionar uma aplicação SAML, etapa 3](OKTA_add_application_step3.png){.thumbnail}
...
![Adicionar uma aplicação SAML, etapa 4](OKTA_add_application_step4.png){.thumbnail}
...
![Adicionar uma aplicação SAML, etapa 5](OKTA_add_application_step5.png){.thumbnail}
...
![Afetar utilizadores](OKTA_add_user.png){.thumbnail}
...
![Obter os metadados](OKTA_retrieve_metadata.png){.thumbnail}
...
![User Informação OVHcloud](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_infos.png){.thumbnail}

Abra o separador `Gestão dos utilizadores`{.action}.

![OVHcloud menu perfil](ovhcloud-account-connect-saml-okta_images_ovhcloud_profile_menu.png){.thumbnail}

Clique no botão `Ligação SSO`{.action}.

![Ligação SSO OVHcloud etapa 1](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_connect_sso_1.png){.thumbnail}
...
![Ligação SSO OVHcloud etapa 2](ovhcloud_add_federation.png){.thumbnail}

Agora tem de encontrar o seu Okta como fornecedor de identidade, assim como os grupos predefinidos.

![Ligação SSO OVHcloud etapa 3](ovhcloud_add_federation_success.png){.thumbnail}

Para mais informações, clique no link em "URL do serviço SSO".

![Ligação SSO OVHcloud etapa 4](ovhcloud_idp_details.png){.thumbnail}

O botão `...`{.action} permite atualizar ou eliminar o SO, e consultar os respetivos detalhes.

![Ligação SSO OVHcloud etapa 5](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_connect_sso_5.png){.thumbnail}
...
![Grupos de gestão dos utilizadores Okta](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_groups_1.png){.thumbnail}

![Grupos de gestão dos utilizadores Okta](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_groups_2.png){.thumbnail}

De seguida, poderá verificar que o grupo é adicionado à sua conta OVHcloud na secção "Grupos":

![Grupos de gestão dos utilizadores Okta](ovhcloud-account-connect-saml-okta_images_ovhcloud_user_management_groups_3.png){.thumbnail}
...
Na [página de identificação da OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pt/&ovhSubsidiary=pt), introduza o seu [identificador](ovhcloud-account-creation#qual-e-o-meu-identificador-de-cliente.) seguido de **/idp** sem password e clique no botão `Ligação`{.action}.

![Ligação à Federação OVHcloud](ovhcloud-account-connect-saml-okta_images_ovhcloud_federation_login_1.png){.thumbnail}
...
![OVHcloud Federation login Reencaminhamento Okta](OKTA_login.png){.thumbnail}
...
[Criação de uma conta OVHcloud](ovhcloud-account-creation1.)

[Proteger a minha conta OVHcloud e gerir as minhas informações pessoais](all_about_username1.)

[Configuração e gestão da palavra-passe da sua conta](manage-ovh-password1.)
