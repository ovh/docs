...
En [la página de identificación de OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es), introduzca su [identificador](ovhcloud-account-creation#cual-es-mi-id-de-cliente.) seguido de **/idp** sin contraseña y haga clic en el botón `Conexión`{.action}.
