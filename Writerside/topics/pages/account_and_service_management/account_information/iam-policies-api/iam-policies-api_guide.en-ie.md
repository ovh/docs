...
- One or more **identities** targeted by this policy.
    - It can be account IDs, users or user groups (like the ones used in [Federation](account-and-service-management-account-information-users1.)).
...
For more information, refer to the [documentation for user management](ovhcloud-users-management1.).

#### With SSO connection enabled

If the federation is enabled through the [SSO connection](account-and-service-management-account-information-users1.), policies only apply to user groups as described in the previous section.
...
A full description of the permission groups can be found in our [dedicated documentation](iam-permission-groups1.).
