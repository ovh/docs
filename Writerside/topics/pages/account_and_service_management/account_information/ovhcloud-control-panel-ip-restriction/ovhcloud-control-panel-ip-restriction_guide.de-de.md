...
Die Einrichtung dieser Option, kombiniert mit der [Zwei-Faktor-Authentifizierung](secure-ovhcloud-account-with-2fa1.), ermöglicht die optimale Absicherung Ihres OVHcloud Kundencenters gegen unbefugte Zugriffe.
...
- Sie haben die [Empfehlungen zur Verwaltung des Account-Passworts](manage-ovh-password1.) zur Kenntnis genommen.
...
[Zwei-Faktor-Authentifizierung in Ihrem OVHcloud Kundencenter einrichten](secure-ovhcloud-account-with-2fa1.)
 
