...
- Une ou plusieurs **identités** visées par cette politique.
    - Il peut s'agir d'identifiants de comptes, d'utilisateurs ou de groupes d'utilisateurs (comme ceux utilisés dans [Federation](ovhcloud-account-connect-saml-adfs1.) - d'autres guides SSO sont disponibles).
...
![politiques IAM](images_iam_policies.png){.thumbnail}
...
![Accès au menu IAM](access_to_the_IAM_menu_01.png){.thumbnail}

Vous pouvez accéder au menu IAM via l’entrée dédiée dans votre espace client.

![Accès au menu IAM](access_to_the_IAM_menu_02.png){.thumbnail}

Le menu affiche la liste de toutes les politiques en cours créées sur votre compte.

![Accès au menu IAM](access_to_the_IAM_menu_03.png){.thumbnail}
...
![Créer une politique](create_a_policy_01.png){.thumbnail}
...
![Créer une politique](create_a_policy_02.png){.thumbnail}
...
![Créer une politique](create_a_policy_05.png){.thumbnail}

Le détail du contenu des groupes de permissions managées est disponible dans la [documentation associée](iam-permission-groups1.).
...
![Créer une politique](create_a_policy_03.png){.thumbnail}
...
![Créer une politique](create_a_policy_04.png){.thumbnail}
...
![Modifier une politique](editing_a_policy.png){.thumbnail}
...
![Lier une identité](link_identity_to_policy.png){.thumbnail}
...
Retrouvez les détails de la gestion des utilisateurs dans la [documentation dédiée](ovhcloud-users-management1.).
