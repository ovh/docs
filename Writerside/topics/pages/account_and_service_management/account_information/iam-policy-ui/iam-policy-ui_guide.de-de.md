...
- Eine oder mehrere **Identitäten**, auf die sich diese Richtlinie bezieht.
    - Es kann sich um Account-IDs, Benutzer oder Benutzergruppen handeln (wie sie auch für den Zugang über [Federation](ovhcloud-account-connect-saml-adfs1.) verwendet werden - weitere SSO-Hilfen stehen zur Verfügung).
...
![IAM-Richtlinien](images_iam_policies.png){.thumbnail}

## Voraussetzungen

- Sie haben einen [OVHcloud Kunden-Account](ovhcloud-account-creation1.).
- Sie kennen die [Benutzerverwaltung für OVHcloud Kunden-Accounts](ovhcloud-users-management1.).
...
![Richtlinie erstellen](create_a_policy_01.png){.thumbnail}
...
![Richtlinie erstellen](create_a_policy_02.png){.thumbnail}
...
![Richtlinie erstellen](create_a_policy_05.png){.thumbnail}

Details zum Inhalt verwalteter Berechtigungsgruppen finden Sie in der zugehörigen [Dokumentation](iam-permission-groups1.).
...
![Richtlinie erstellen](create_a_policy_03.png){.thumbnail}
...
![Richtlinie erstellen](create_a_policy_04.png){.thumbnail}
...
![Richtlinie bearbeiten](editing_a_policy.png){.thumbnail}
...
![Identität verknüpfen](link_identity_to_policy.png){.thumbnail}
...
Details zur Benutzerverwaltung finden Sie in [unserer Dokumentation](ovhcloud-users-management1.).
