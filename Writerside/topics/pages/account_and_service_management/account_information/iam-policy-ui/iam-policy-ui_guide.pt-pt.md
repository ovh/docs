...
- Uma ou mais **identidades** visadas por esta política. 
    - Podem ser identificadores de contas, utilizadores ou grupos de utilizadores (por exemplo, os utilizados em [Federation](ovhcloud-account-connect-saml-adfs1.) - ou outros guias SSO disponíveis). 
...
- Dispor de uma [conta OVHcloud](ovhcloud-account-creation1.)
- Saber [gerir os utilizadores da conta](ovhcloud-users-management1.)
...
![Acesso ao menu IAM](access_to_the_IAM_menu_01.png){.thumbnail}

Pode aceder ao menu IAM através da entrada dedicada no seu Espaço Cliente.

![Acesso ao menu IAM](access_to_the_IAM_menu_02.png){.thumbnail}

O menu apresenta a lista de todas as políticas em curso criadas na sua conta.

![Acesso ao menu IAM](access_to_the_IAM_menu_03.png){.thumbnail}
...
![Criar uma política](create_a_policy_01.png){.thumbnail}
...
![Criar uma política](create_a_policy_02.png){.thumbnail}
...
![Criar uma política](create_a_policy_05.png){.thumbnail}

Os detalhes do conteúdo dos grupos de permissão administrados estão disponíveis na [documentação associada](iam-permission-groups1.).
...
![Criar uma política](create_a_policy_03.png){.thumbnail}
...
![Criar uma política](create_a_policy_04.png){.thumbnail}
...
![Modificar uma política](editing_a_policy.png){.thumbnail}
...
![Associar uma identidade](link_identity_to_policy.png){.thumbnail}
...
Encontre os detalhes da gestão dos utilizadores na [documentação dedicada](ovhcloud-users-management1.).
