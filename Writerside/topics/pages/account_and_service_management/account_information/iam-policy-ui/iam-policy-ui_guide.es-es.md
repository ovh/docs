...
- Una o varias **identidades** incluidas en esta política. 
    - Pueden ser identificadores de cuenta, de usuario o de grupo de usuarios (como los utilizados en [Federation](ovhcloud-account-connect-saml-adfs1.) - hay disponibles otras guías SSO). 
...
![políticas IAM](images_iam_policies.png){.thumbnail}

## Requisitos

- Tener una [cuenta de OVHcloud](ovhcloud-account-creation1.)
- Saber [gestionar los usuarios de la cuenta](ovhcloud-users-management1.)
...
![Acceso al menú IAM](access_to_the_IAM_menu_01.png){.thumbnail}

Puede acceder al menú IAM desde la entrada dedicada del área de cliente.

![Acceso al menú IAM](access_to_the_IAM_menu_02.png){.thumbnail}

El menú muestra una lista de todas las directivas actuales creadas en su cuenta.

![Acceso al menú IAM](access_to_the_IAM_menu_03.png){.thumbnail}
...
![Crear una política](create_a_policy_01.png){.thumbnail}
...
![Crear una política](create_a_policy_02.png){.thumbnail}
...
![Crear una política](create_a_policy_05.png){.thumbnail}

Los detalles del contenido de los grupos de permisos administrados están disponibles en la [documentación asociada](iam-permission-groups1.).
...
![Crear una política](create_a_policy_03.png){.thumbnail}
...
![Crear una política](create_a_policy_04.png){.thumbnail}
...
![Editar una política](editing_a_policy.png){.thumbnail}
...
![Vincular identidad](link_identity_to_policy.png){.thumbnail}
...
Para más información sobre la gestión de usuarios, consulte la [documentación dedicada](ovhcloud-users-management1.).
