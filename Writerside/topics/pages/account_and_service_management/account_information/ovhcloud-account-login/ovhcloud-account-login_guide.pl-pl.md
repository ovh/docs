...
- Informacje o [dobrych praktykach w zakresie zabezpieczenia konta OVHcloud](all_about_username1.)
...
![identyfikator klienta](log-in.png){.thumbnail}

Jeśli aktywowałeś weryfikację [dwuetapową](secure-ovhcloud-account-with-2fa1.), wpisz unikalny kod logowania wygenerowany przez Twoje urządzenie (telefon, tablet lub klucz U2F).
...
![identyfikator klienta](customer-id-bill-en.png){.thumbnail}
...
![identyfikator klienta](images_nic-handle.png){.thumbnail}

### Zgubiłem hasło

Jeśli utracisz hasło lub je zapomnisz, zapoznaj się z [przewodnikiem dotyczącym sposobu zmiany hasła](manage-ovh-password#jesli-nie-znasz-swojego-aktualnego-hasla.).
...
Po przeprowadzeniu tego kroku należy [wpisać do Twojego konta **nowy** adres zapasowy](all_about_username#backup-email.).
...
Zapoznaj się z przewodnikiem dotyczącym [Zabezpieczenia konta OVHcloud za pomocą weryfikacji dwuetapowej](secure-ovhcloud-account-with-2fa#co-moge-zrobic-jesli-zgubie-jedno-z-moich-urzadzen-lub-tez-przestanie-ono-dzialac.).
