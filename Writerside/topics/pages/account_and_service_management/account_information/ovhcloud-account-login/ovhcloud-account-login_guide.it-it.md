...
- Aver consultato le [best practice di protezione del tuo account OVHcloud](all_about_username1.)
...
![identificativo cliente](log-in.png){.thumbnail}

Se hai attivato la [doppia autenticazione](secure-ovhcloud-account-with-2fa1.), inserisci il codice unico di connessione generato dalla tua periferica (telefono, tablet o chiave U2F).
...
![identificativo cliente](customer-id-bill-en.png){.thumbnail}
...
![identificativo cliente](images_nic-handle.png){.thumbnail}

### Ho perso la password

Se hai dimenticato o perso la password, [questa guida ti spiega la procedura da seguire per modificarla](manage-ovh-password#se-non-ricordi-piu-la-password.).
...
Una volta completata l'operazione, è fondamentale [inserire un **nuovo** indirizzo email di recupero](all_about_username#backup-email.) nel tuo account.
...
Consulta la nostra guida [Proteggere un account OVHcloud con la doppia autenticazione](secure-ovhcloud-account-with-2fa#che-fare-se-uno-dei-miei-dispositivi-e-stato-smarrito-o-ha-smesso-di-funzionare.).
...
[Crea il tuo account OVHcloud](ovhcloud-account-creation1.)
