...
- Ter consultado as [boas práticas de segurança da sua conta OVHcloud](all_about_username1.)
...
![identificador de cliente](log-in.png){.thumbnail}

Se ativou a [dupla autenticação](secure-ovhcloud-account-with-2fa1.), deverá introduzir o código único de ligação gerado pelo seu periférico (telefone, tablet ou chave U2F).
...
![identificador de cliente](customer-id-bill-en.png){.thumbnail}
...
![identificador de cliente](images_nic-handle.png){.thumbnail}

### Perdi a minha palavra-passe

Em caso de perda da palavra-passe, consulte [este guia](manage-ovh-password#se-nao-se-lembrar-da-sua-palavra-passe-atual.), que explica o que deverá fazer para a alterar.
...
Uma vez efetuada esta ação, é essencial [introduzir um **novo** endereço de e-mail de SOS](all_about_username#backup-email.) na sua conta.
...
Consulte o manual "[Proteger a sua conta OVHcloud com a dupla autenticação](secure-ovhcloud-account-with-2fa#o-que-devo-fazer-se-um-dos-meus-perifericos-estiver-perdido-ou-parar-de-funcionar.)" para obter mais informações.
...
[Criar a sua conta OVHcloud](ovhcloud-account-creation1.)
