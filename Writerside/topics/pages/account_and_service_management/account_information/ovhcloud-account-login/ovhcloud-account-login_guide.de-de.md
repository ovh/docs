...
- Sie haben [Ihren OVHcloud Account erstellt](ovhcloud-account-creation1.)
- Sie haben die [Best Practices zur Sicherung Ihres OVHcloud Accounts](all_about_username1.) zur Kenntnis genommen
...
![Kundenkennung](log-in.png){.thumbnail}

Wenn Sie die [Zwei-Faktor-Authentifizierung](secure-ovhcloud-account-with-2fa1.) aktiviert haben, bestätigen Sie den Login mit der gewählten Methode (SMS, Mobile App, U2F-Schlüssel).
...
![Kundenkennung](customer-id-bill-en.png){.thumbnail}
...
![Kundenkennung](images_nic-handle.png){.thumbnail}

### Ich habe mein Passwort verloren

Wenn Sie das Passwort nicht zur Hand haben, folgen Sie der [Anleitung zur Passwortänderung](manage-ovh-password#wenn-sie-ihr-aktuelles-passwort-nicht-kennen.).
...
Nachdem diese Umstellung erfolgt ist, [richten Sie **erneut** eine Backup-Adresse](all_about_username#backup-email.) ein.
...
Die entsprechenden Schritte finden Sie in unserer Anleitung "[Den OVHcloud Kunden-Account mit der Zwei-Faktor-Authentifizierung absichern](secure-ovhcloud-account-with-2fa#was-soll-ich-tun-wenn-eines-meiner-peripheriegerate-verloren-geht-oder-nicht-mehr-funktioniert.)".
