...
La création d'un compte est gratuite. Cet espace facilite l'accès à vos informations et permet de gérer vos services. Consultez notre guide [Créer un compte OVHcloud](account_information_ovhcloud-account-creation.).

#### Trucs et astuces

Une fois votre compte créé, pensez à le sécuriser en configurant une double authentification. Retrouvez plus d'informations dans notre guide [Sécuriser son compte OVHcloud avec la double authentification](secure-ovhcloud-account-with-2fa1.).
...
Pour tous ces cas de figure, consultez [cette documentation](ovhcloud-account-login#login-failure.) qui vous permettra de connaître les démarches appropriées.
...
Retrouvez plus d'informations dans notre guide [Modifier le mot de passe de votre compte](manage-ovh-password1.).
...
Un guide complet sur la gestion des contacts est disponible [ici](managing_contacts1.).
...
Si vous souhaitez en savoir plus sur la gestion des contacts, nous vous invitons à consulter ce guide détaillé : [« Gérer les contacts de ses services »](managing_contacts1.).

### Comment sécuriser mon compte ?

Plusieurs solutions s'offrent à vous pour sécuriser votre compte telles que :

- le choix d'un [mot de passe complexe et son renouvellement régulier](manage-ovh-password1.) ;
- l'ajout d'une [double authentification](secure-ovhcloud-account-with-2fa1.) ;
- la configuration d'une [restriction par IP](ovhcloud-control-panel-ip-restriction1.).
...
Vous pouvez activer une ou plusieurs méthodes de double authentification afin de sécuriser et de contrôler l'accès à votre espace client. Retrouvez tous les détails dans notre guide [Sécuriser son compte OVHcloud avec la double authentification](secure-ovhcloud-account-with-2fa1.).
...
- utiliser [les code de secours](secure-ovhcloud-account-with-2fa#codes.) actifs que vous avez sauvegardés ;
- utiliser un autre périphérique de double authentification à votre disposition, si vous en avez activé plusieurs ;
- [désactiver la double authentification](secure-ovhcloud-account-with-2fa#desactivation.).

Consultez la partie [« Que faire si l'un de mes périphériques est perdu/volé ou cesse de fonctionner ? »](secure-ovhcloud-account-with-2fa#lost-device.) ou la partie [« Désactiver complètement la double authentification »](secure-ovhcloud-account-with-2fa#desactivation.) de notre guide sur la double authentification.
...
Pour identifier et signaler un e-mail ou un SMS de phishing, consultez notre [guide dédié](phishing_care1.).
...
- [Comment sécuriser votre site Web ?](secure_your_website1.)
