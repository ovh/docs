...
> [!primary]
>
> Si ha activado la [doble autenticación](secure-ovhcloud-account-with-2fa1.) en su cuenta, deberá introducir el código proporcionado por el método de autenticación que haya establecido en su cuenta. 
...
![Add files - opciones](plik-add-files-options.png)
