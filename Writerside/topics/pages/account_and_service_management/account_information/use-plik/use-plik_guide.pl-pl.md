...
> [!primary]
>
> Jeśli aktywowałeś [weryfikację dwuetapową](secure-ovhcloud-account-with-2fa1.) na Twoim koncie, wpisz kod dostarczony w metodzie uwierzytelniania, którą określiłeś na Twoim koncie. 
...
![Add files - opcje](plik-add-files-options.png)
