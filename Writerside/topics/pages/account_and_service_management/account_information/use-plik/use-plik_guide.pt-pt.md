...
> [!primary]
>
> Se ativou a [dupla autenticação](secure-ovhcloud-account-with-2fa1.) na sua conta, deverá introduzir o código fornecido pelo método de autenticação que definiu na sua conta. 
...
![Add files - opções](plik-add-files-options.png)
