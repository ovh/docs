...
> [!primary]
>
> Si vous avez activé la [double authentification](secure-ovhcloud-account-with-2fa1.) sur votre compte, vous devrez alors saisir le code fourni par la méthode d'authentification que vous avez définie sur votre compte. 
