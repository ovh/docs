...
![Painel de controlo Entra ID](azure_ad_dashboard.png){.thumbnail}

A seguir, clique em `Users`{.action} no menu à esquerda.

![Utilizador do menu Entra ID](azure_ad_menu_user.png){.thumbnail}
...
![Utilizador Entra ID](azure_ad_user.png){.thumbnail}
...
![Grupos de menus Entra ID](azure_ad_menu_groups.png){.thumbnail}
...
![Entra ID Group User Assignment Passo 1](azure_ad_group_user_assignment_1.png){.thumbnail}

Selecione o utilizador a adicionar neste grupo e clique no botão `Select`{.action}.

![Entra ID Group User Assignment Passo 2](azure_ad_group_user_assignment_2.png){.thumbnail}
...
![Aplicações de menu Entra ID](azure_ad_menu_applications.png){.thumbnail}

Clique em `New application`{.action} no menu superior.

![Aplicações Entra ID etapa 1](azure_ad_applications_1.png){.thumbnail}

Clique em `Create your own application`{.action} no menu superior.

![Aplicações Entra ID etapa 2](azure_ad_applications_2.png){.thumbnail}

Selecione `Non-Gallery`{.action} no menu à esquerda e clique no botão `Create`{.action}.

![Aplicações Entra ID etapa 3](azure_ad_applications_3.png){.thumbnail}

Os detalhes da aplicação serão apresentados.

![Aplicações Entra ID etapa 4](azure_ad_applications_4.png){.thumbnail}
...
![Entra ID Application User Assignment Passo 1](azure_ad_application_user_assignment_1.png){.thumbnail}

![Entra ID Application User Assignment Passo 2](azure_ad_application_user_assignment_2.png){.thumbnail}
...
![Entra ID SSO etapa 1](azure_ad_sso_1.png){.thumbnail}

Clique na secção `SAML`{.action}.

![Entra ID SSO etapa 2](azure_ad_sso_2.png){.thumbnail}

Clique em `Upload metadata file`{.action} no menu superior.

![Entra ID SSO etapa 3](azure_ad_sso_3.png){.thumbnail}
...
![Entra ID SSO etapa 5](azure_ad_sso_5.png){.thumbnail}

Aparecerá a configuração SAML.

![Entra ID SSO etapa 6](azure_ad_sso_6.png){.thumbnail}

Na secção `Attributes & Claims`{.action}, clique no botão `Edit`{.action}.

![Entra ID SSO etapa 9](azure_ad_sso_9.png){.thumbnail}
...
![Entra ID SSO entrado UPN](azure_ad_sso_9bis.png){.thumbnail}
...
![Entra ID SSO etapa 8](azure_ad_sso_8.png){.thumbnail}
...
![Informações do utilizador OVHcloud](images_ovhcloud_user_infos.png){.thumbnail}

Abra o separador `Gestão dos utilizadores`{.action}.

![Perfil menu da OVHcloud](images_ovhcloud_profile_menu.png){.thumbnail}
...
![Grupos de gestão de utilizadores Ovhcloud etapa 1](ovhcloud_sso_menu_1.png){.thumbnail}

Preencha os campos e clique no botão `Validar`{.action}.

![Grupos de gestão de utilizadores Ovhcloud etapa 2](ovhcloud_sso_menu_2.png){.thumbnail}

O grupo criado deve constar da lista.

![Grupos de gestão de utilizadores Ovhcloud etapa 3](ovhcloud_sso_menu_3.png){.thumbnail}
