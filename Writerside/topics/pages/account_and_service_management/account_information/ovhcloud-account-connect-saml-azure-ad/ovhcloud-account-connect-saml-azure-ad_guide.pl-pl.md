...
![Użytkownik menu Entra ID](azure_ad_menu_user.png){.thumbnail}
...
![Użytkownik Entra ID](azure_ad_user.png){.thumbnail}
...
![Grupy menu Azure](azure_ad_menu_groups.png){.thumbnail}
...
![Etap 1 Entra ID Group](azure_ad_group_1.png){.thumbnail}

Kliknij przycisk `Create`{.action}, aby wyświetlić wszystkie informacje o tej grupie.

![Etap 2 Entra ID Group](azure_ad_group_2.png){.thumbnail}
...
![Entra ID Group User Asignment Etap 1](azure_ad_group_user_assignment_1.png){.thumbnail}

Wybierz użytkownika, który chcesz dodać do tej grupy, następnie kliknij przycisk `Select`{.action}.

![Entra ID Group User Asignment Etap 2](azure_ad_group_user_assignment_2.png){.thumbnail}
...
![Aplikacje menu Entra ID](azure_ad_menu_applications.png){.thumbnail}

Kliknij `New application`{.action} w menu na górze.

![Aplikacje Entra ID etap 1](azure_ad_applications_1.png){.thumbnail}

Kliknij `Create your own application`{.action} w menu na górze.

![Aplikacje Entra ID etap 2](azure_ad_applications_2.png){.thumbnail}

Wybierz `Non-gallery`{.action} z menu po lewej stronie i kliknij przycisk `Create`{.action}.

![Aplikacje Entra ID etap 3](azure_ad_applications_3.png){.thumbnail}

Wyświetlą się wówczas szczegółowe informacje dotyczące aplikacji.

![Aplikacje Entra ID etap 4](azure_ad_applications_4.png){.thumbnail}
...
![Entra ID Application User Dołącz do etapu 1](azure_ad_application_user_assignment_1.png){.thumbnail}

![Entra ID Application User Dołącz do etapu 2](azure_ad_application_user_assignment_2.png){.thumbnail}
...
![Etap 1 Entra ID SSO](azure_ad_sso_1.png){.thumbnail}

Kliknij `SAML`{.action}.

![Etap 2 Entra ID SSO](azure_ad_sso_2.png){.thumbnail}

Kliknij `Upload metadata file`{.action} w menu na górze.

![Etap 3 Entra ID SSO](azure_ad_sso_3.png){.thumbnail}
...
![Etap 5 Entra ID SSO](azure_ad_sso_5.png){.thumbnail}

Wyświetli się konfiguracja SAML.

![Etap 6 Entra ID SSO](azure_ad_sso_6.png){.thumbnail}

W sekcji `Attributes & Claims`{.action} kliknij przycisk `Edit`{.action}.

![Etap 9 Entra ID SSO](azure_ad_sso_9.png){.thumbnail}
...
![Entra ID SSO — wprowadzanie UPN](azure_ad_sso_9bis.png){.thumbnail}
...
![Etap 12 Entra ID SSO](azure_ad_sso_12.png){.thumbnail}
...
![Etap 8 Entra ID SSO](azure_ad_sso_8.png){.thumbnail}
...
![Informacje o użytkowniku OVHcloud](images_ovhcloud_user_infos.png){.thumbnail}
...
![Grupy zarządzania użytkownikami Ovhcloud etap 1](ovhcloud_sso_menu_1.png){.thumbnail}

Uzupełnij pola, następnie kliknij przycisk `Zatwierdź`{.action}.

![Grupy zarządzania użytkownikami Ovhcloud etap 2](ovhcloud_sso_menu_2.png){.thumbnail}

Utworzona grupa musi pojawić się na liście.

![Grupy zarządzania użytkownikami Ovhcloud etap 3](ovhcloud_sso_menu_3.png){.thumbnail}
