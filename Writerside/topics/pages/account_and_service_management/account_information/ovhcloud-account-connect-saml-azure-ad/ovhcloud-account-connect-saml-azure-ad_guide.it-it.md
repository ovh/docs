...
![Dashboard Entra ID](azure_ad_dashboard.png){.thumbnail}

Clicca su `Users`{.action} nel menu a sinistra.

![Utenti del menu Entra ID](azure_ad_menu_user.png){.thumbnail}
...
![Utenti Entra ID](azure_ad_user.png){.thumbnail}
...
![Gruppi di menu Entra ID](azure_ad_menu_groups.png){.thumbnail}
...
![Entra ID Group Step 1](azure_ad_group_1.png){.thumbnail}

Clicca sul pulsante `Create`{.action} per visualizzare tutte le informazioni su questo gruppo.

![Entra ID Group Step 2](azure_ad_group_2.png){.thumbnail}
...
![Entra ID Group User Assignment Step 1](azure_ad_group_user_assignment_1.png){.thumbnail}

Seleziona l'utente da aggiungere a questo gruppo e clicca sul pulsante `Select`{.action}.

![Entra ID Group User Assignment Step 2](azure_ad_group_user_assignment_2.png){.thumbnail}
...
![Applicazioni del menu Entra ID](azure_ad_menu_applications.png){.thumbnail}

Clicca su `New application`{.action} nel menu in alto.

![Applicazioni Entra ID step 1](azure_ad_applications_1.png){.thumbnail}

Clicca su `Create your own application`{.action} nel menu in alto.

![Applicazioni Entra ID step 2](azure_ad_applications_2.png){.thumbnail}

Seleziona `Non-gallery`{.action} nel menu a sinistra e clicca sul pulsante `Create`{.action}.

![Applicazioni Entra ID step 3](azure_ad_applications_3.png){.thumbnail}

I dettagli dell'applicazione verranno mostrati

![Applicazioni Entra ID step 4](azure_ad_applications_4.png){.thumbnail}
...
![Entra ID Application User Assignment Step 1](azure_ad_application_user_assignment_1.png){.thumbnail}

![Entra ID Application User Assignment Step 2](azure_ad_application_user_assignment_2.png){.thumbnail}
...
![Entra ID SSO Step 1](azure_ad_sso_1.png){.thumbnail}

Clicca sulla sezione `SAML`{.action}.

![Entra ID SSO Step 2](azure_ad_sso_2.png){.thumbnail}

Clicca su `Upload metadata`{.action} nel menu in alto.

![Entra ID SSO Step 3](azure_ad_sso_3.png){.thumbnail}
...
![Entra ID SSO Step 5](azure_ad_sso_5.png){.thumbnail}

Si apre la configurazione SAML.

![Entra ID SSO Step 6](azure_ad_sso_6.png){.thumbnail}

Nella sezione `Attributes & Claims`{.action}, clicca sul pulsante `Edit`{.action}.

![Entra ID SSO Step 9](azure_ad_sso_9.png){.thumbnail}
...
![Entra ID SSO immissione UPN](azure_ad_sso_9bis.png){.thumbnail}
...
![Entra ID SSO Step 12](azure_ad_sso_12.png){.thumbnail}
...
![Entra ID SSO Step 8](azure_ad_sso_8.png){.thumbnail}
...
![Informazioni utente OVHcloud](images_ovhcloud_user_infos.png){.thumbnail}

Apri la scheda `Gestione utenti`{.action}.

![Profilo menu OVHcloud](images_ovhcloud_profile_menu.png){.thumbnail}
...
![Gruppi di gestione utenti Ovhcloud step 1](ovhcloud_sso_menu_1.png){.thumbnail}

Completa i campi e clicca su `Conferma`{.action}.

![Gruppi di gestione utenti Ovhcloud Step 2](ovhcloud_sso_menu_2.png){.thumbnail}

Il gruppo creato deve figurare sull'elenco.

![Gruppi di gestione utenti Ovhcloud step 3](ovhcloud_sso_menu_3.png){.thumbnail}
