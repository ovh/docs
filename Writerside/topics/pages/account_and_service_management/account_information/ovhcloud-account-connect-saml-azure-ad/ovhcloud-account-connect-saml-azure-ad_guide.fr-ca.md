...
![Applications Entra ID étape 1](azure_ad_applications_1.png){.thumbnail}
...
Sur [la page de connexion OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc), renseignez votre [identifiant](ovhcloud-account-creation#quel-est-mon-identifiant-client.) client suivi de **/idp** sans mot de passe puis cliquez sur le bouton `Login`{.action} .
