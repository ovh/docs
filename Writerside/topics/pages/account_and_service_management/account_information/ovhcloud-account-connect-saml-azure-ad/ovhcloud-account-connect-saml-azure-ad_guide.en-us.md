...
![Entra ID Doshboard](azure_ad_dashboard.png){.thumbnail}

Then click on `Users`{.action} from the left-hand menu.

![Entra ID Menu User](azure_ad_menu_user.png){.thumbnail}
...
![Entra ID User](azure_ad_user.png){.thumbnail}
...
![Entra ID Menu Groups](azure_ad_menu_groups.png){.thumbnail}
...
![Entra ID Menu Applications](azure_ad_menu_applications.png){.thumbnail}

Click on `New application`{.action} in the top menu.

![Entra ID Applications step 1](azure_ad_applications_1.png){.thumbnail}

Click on `Create your own application`{.action} in the top menu.

![Entra ID Applications step 2](azure_ad_applications_2.png){.thumbnail}

Select the `Non-gallery`{.action} from the left-hand menu, and click on the `Create`{.action} button.

![Entra ID Applications step 3](azure_ad_applications_3.png){.thumbnail}

The details of the application will then be displayed.

![Entra ID Applications step 4](azure_ad_applications_4.png){.thumbnail}
...
![OVHcloud top menu](images_ovhcloud_top_menu.png){.thumbnail}

Click on your name to access your profile management page.

![OVHcloud user infos](images_ovhcloud_user_infos.png){.thumbnail}

Open the `User management`{.action} tab.

![OVHcloud profile menu](images_ovhcloud_profile_menu.png){.thumbnail}
...
![Ovhcloud user management groups step 1](ovhcloud_sso_menu_1.png){.thumbnail}

Fill in the fields, then click on the `Confirm`{.action} button.

![Ovhcloud user management groups step 2](ovhcloud_sso_menu_2.png){.thumbnail}

The created group should appear on the list.

![Ovhcloud user management groups step 3](ovhcloud_sso_menu_3.png){.thumbnail}
...
On the [OVHcloud login page](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we), enter your [NIC handle](ovhcloud-account-creation#what-is-my-nic-handle.) followed by **/idp** without entering a password, and click the `Login`{.action} button.
...
![Entra ID Login step 1](azure_ad_login_1.png){.thumbnail}

Enter the Entra ID application user email and click on the `Next`{.action} button.

![Entra ID Login step 2](azure_ad_login_2.png){.thumbnail}
...
You are now logged in with the same [NIC handle](ovhcloud-account-creation#what-is-my-nic-handle.), but via your Active Directory user and using your Entra ID application SSO.
