...
![Ajouter une application Web ou mobile](google_workspace_web_mobile_add_saml_app.png){.thumbnail}
...
![Ajouter une application SAML, étape 1](google_workspace_web_mobile_add_saml_app_step1.png){.thumbnail}
...
![Ajouter une application SAML, étape 2](google_workspace_web_mobile_add_saml_app_step2.png){.thumbnail}
...
![Ajouter une application SAML, étape 3](google_workspace_web_mobile_add_saml_app_step3.png){.thumbnail}
...
![Ajouter une application SAML, étape 4](google_workspace_web_mobile_add_saml_app_step4.png){.thumbnail}
...
![Activer l'application pour tous les utilisateurs](google_workspace_web_mobile_enable_app1.png){.thumbnail}

![Activer l'application pour tous les utilisateurs](google_workspace_web_mobile_enable_app2.png){.thumbnail}
...
![Informations utilisateur OVHcloud](ovhcloud-account-connect-saml-google-workspace_images_ovhcloud_user_infos.png){.thumbnail}

Ouvrez l'onglet `Gestion des utilisateurs`{.action}.

![Profil menu OVHcloud](ovhcloud-account-connect-saml-google-workspace_images_ovhcloud_profile_menu.png){.thumbnail}

Cliquez sur le bouton `Connexion SSO`{.action}.

![OVHcloud connexion SSO étape 1](ovhcloud-account-connect-saml-google-workspace_images_ovhcloud_user_management_connect_sso_1.png){.thumbnail}
...
![OVHcloud connexion SSO étape 2](images_ovhcloud_user_management_connect_sso_2.png){.thumbnail}
...
![OVHcloud connexion SSO étape 3](images_ovhcloud_user_management_connect_sso_3.png){.thumbnail}

Pour plus d'informations, cliquez sur le lien situé sous « URL du service SSO ».

![OVHcloud connexion SSO étape 4](images_ovhcloud_user_management_connect_sso_4.png){.thumbnail}

Le bouton `...`{.action} permet de mettre à jour ou de supprimer le SSO, et d’en consulter les détails.

![OVHcloud connexion SSO étape 5](images_ovhcloud_user_management_connect_sso_5.png){.thumbnail}
...
![Gérer les applications web et mobile](google_workspace_web_mobile_add_saml_app.png){.thumbnail}

Cliquez sur la ligne de l'application que vous avez ajoutée précédemment.

![Liste des applications web et mobile](google_workspace_web_mobile_list_app.png){.thumbnail}
...
![Détail de l'application SAML](google_workspace_web_mobile_show_app.png){.thumbnail}
...
![Configuration des groupes d'utilisateur](google_workspace_web_mobile_setup_groups.png){.thumbnail}
...
![Groupes de gestion des utilisateurs Google Workspace](images_ovhcloud_user_management_groups_1.png){.thumbnail}

![Groupes de gestion des utilisateurs Google Workspace](images_ovhcloud_user_management_groups_2.png){.thumbnail}

Vous pourrez ensuite vérifier que le groupe est ajouté à votre compte OVHcloud dans la section « Groupes » :

![Groupes de gestion des utilisateurs Google Workspace](images_ovhcloud_user_management_groups_3.png){.thumbnail}
...
Sur [la page d'identification OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc), renseignez votre [identifiant](ovhcloud-account-creation#quel-est-mon-identifiant-client.) suivi de **/idp** sans mot de passe et cliquez sur le bouton `Login`{.action} .

![Connexion à la fédération OVHcloud](images_ovhcloud_federation_login_1.png){.thumbnail}
...
![OVHcloud Federation login Redirection Google Workspace](images_ovhcloud_federation_login_2.png){.thumbnail}

Vous êtes maintenant connecté avec le même identifiant client, mais via votre utilisateur Google Workspace.

![Fédération des infos utilisateurs OVHcloud](images_ovhcloud_user_infos_federation.png){.thumbnail}

## Aller plus loin

[Créer un compte OVHcloud](ovhcloud-account-creation1.)

[Sécuriser mon compte OVHcloud et gérer mes informations personnelles](all_about_username1.)

[Définition et gestion du mot de passe de votre compte](manage-ovh-password1.)
