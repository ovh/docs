...
![Gerir as aplicações web e móvel](google_workspace_web_mobile_add_saml_app.png){.thumbnail}
...
![OVHcloud Federation login Reencaminhamento Google Workspace](images_ovhcloud_federation_login_2.png){.thumbnail}
