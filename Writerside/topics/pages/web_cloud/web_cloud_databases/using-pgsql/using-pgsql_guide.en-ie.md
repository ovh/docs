...
- To have viewed [the Web Cloud Databases guide](starting_with_clouddb1.)
...
There is also a guide here: [Getting started with the Web Cloud Databases service](starting_with_clouddb1.){.ref}
