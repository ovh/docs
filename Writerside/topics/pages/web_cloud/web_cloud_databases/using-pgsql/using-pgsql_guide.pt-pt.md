...
- Ter consultado [o guia Web Cloud Databases](starting_with_clouddb1.)
...
Está igualmente disponível um guia : [Web Cloud Databases - primeira utilização](starting_with_clouddb1.){.ref}
