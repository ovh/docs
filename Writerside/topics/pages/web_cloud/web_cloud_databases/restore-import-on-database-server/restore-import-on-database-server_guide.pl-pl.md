...
- Posiadanie [instancji Web Cloud Databases](databases.) (zawartej w ofercie[hostingu www Performance](hosting.).
...
Przejdź do Panelu [klienta OVHcloud](manager.). Kliknij kartę `Web Cloud`, a następnie `Web Cloud Databases`{.action}. Wybierz nazwę serwera baz danych. Przejdź do karty `Bazy danych`.
...
![Web Cloud Databases](restore-the-backup.png){.thumbnail}
...
![Web Cloud Databases](import-file.png){.thumbnail}
...
![Web Cloud Databases](database-import-new-file-step-2.png){.thumbnail}
...
![Web Cloud Databases](database-import-existing-file-step-2.png){.thumbnail}
...
Aby zaimportować bazę danych bezpośrednio z phpMyAdmin, należy najpierw się do niej zalogować. Aby to zrobić, możesz zapoznać się z tym [przewodnikiem](connecting-to-database-on-database-server#logowanie-do-bazy-danych-mysql-lub-mariadb.).
...
![Web Cloud Databases](pma-upload-backup-web-cloud-db.png){.thumbnail}

#### Importuj bazę MySQL lub MariaDB za pomocą wiersza poleceń

Operacja ta jest możliwa tylko przez [SSH](ssh_on_webhosting1.) z poziomu hostingu OVHcloud.
...
> [!warning]
>
> - Aby uniknąć sytuacji, w której ktoś miałby dostęp do tego pliku zawierającego wrażliwe dane, zapoznaj się z przewodnikiem dotyczącym bezpieczeństwa dostępu do tego pliku: ["Używanie .htaccess do ochrony hasła katalogu w serwisie WWW"](htaccess_protect_directory_by_password1.)
...
Operacja ta jest możliwa wyłącznie przez [SSH](ssh_on_webhosting1.) z poziomu hostingu OVHcloud w wersji stabilnej lub wyższej.
...
> [!warning]
>
> - Aby uniknąć sytuacji, w której ktoś miałby dostęp do tego pliku zawierającego wrażliwe dane, sprawdź, czy zabezpieczysz dostęp do tego pliku za pomocą przewodnika ["Używanie .htaccess do ochrony hasła katalogu w serwisie WWW"](htaccess_protect_directory_by_password1.)
> - Operacja ta jest możliwa tylko z poziomu hostingu OVHcloud.
>
