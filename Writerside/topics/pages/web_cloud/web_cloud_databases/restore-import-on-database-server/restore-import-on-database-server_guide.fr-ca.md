...
Rendez-vous dans votre [espace client OVHcloud](manager.). Cliquez sur l'onglet `Web Cloud`, puis sur `Web Cloud Databases`{.action}. Sélectionnez le nom de votre serveur de bases de données. Dirigez-vous-vous dans l'onglet `Bases de données`.
...
Cette action est uniquement possible en [SSH](ssh_on_webhosting1.) depuis un hébergement mutualisé OVHcloud.
...
> [!warning]
>
> - Afin d'éviter que quelqu'un accède à ce fichier comportant des données sensibles, pensez à sécuriser l'accès à celui-ci en vous aidant du guide : [Comment protéger l’accès a un répertoire par une authentification ?](htaccess_protect_directory_by_password1.)
...
Cette action est uniquement possible en [SSH](ssh_on_webhosting1.) depuis un hébergement mutualisé OVHcloud en version stable ou supérieure.
...
> [!warning]
>
> - Afin d'éviter que quelqu'un accède à ce fichier comportant des données sensibles, pensez à sécuriser l'accès à celui-ci en vous aidant du guide [Comment protéger l’accès a un répertoire par une authentification ?](ssh_on_webhosting1.)
> - Cette action est possible uniquement depuis un hébergement OVHcloud mutualisé.
>
