...
- Uno dei database inclusi con un [Hosting Web](hosting.).
- Una [istanza Web Cloud Databases](https://www.ovh.it/cloud/cloud-databases/){.external} (inclusa in un'offerta di [Hosting Performance](hosting.).
- Pack di database [Start SQL](hosting-options-startsql.).
...
- I servizi Web Cloud Databases Web Hosting (noti anche come servizi SQLPPrivati), istanze SGBD dedicate raggiungibili tramite la rete Web Hosting ([vedi gli annunci](clouddb-eos-eol1.)).
- I servizi SharedSQL Web Hosting, database MySQL raggiungibili tramite la rete Web Hosting ([vedi gli annunci](sql_eos_eol1.)).
