...
- Jedna z baz danych zawartych w ofercie [Hosting WWW](hosting.).
- Jedna [instancja Web Cloud Databases](https://www.ovh.pl/cloud/cloud-databases/){.external} (zawarta w usłudze [Hosting www Performance](hosting.).
- Pakiet bazy danych [Start SQL](hosting-options-startsql.).
...
- Usługi Web Cloud Databases Web Hosting (znane również jako usługi SQLPrive), dedykowane instancje SGBD dostępne poprzez sieć Web Hosting ([patrz ogłoszenia](clouddb-eos-eol1.)).

- Usługi SharedSQL Web Hosting, bazy danych MySQL dostępne za pośrednictwem sieci Web Hosting ([patrz ogłoszenia](sql_eos_eol1.)).

### Definicje i wytyczne polityki wycofania z eksploatacji

![tymelina](ovhcloud-eol-policy-for-managed-databases-timeline.png)
