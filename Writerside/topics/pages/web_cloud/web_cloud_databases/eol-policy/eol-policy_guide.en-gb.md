...
- One of the included databases with a [Web Hosting plan](hosting.).
- A [Web Cloud Databases instance](https://www.ovh.co.uk/cloud/cloud-databases/){.external} (included in a [Performance Web Hosting](hosting.) offer).
- A [Start SQL](hosting-options-startsql.) database pack.
...
- Web Cloud Databases Web Hosting services (also known as Private SQL services), dedicated DBMS instances that can be reached via the Web Hosting network ([see announcements](clouddb-eos-eol1.)).
- SharedSQL Web Hosting services, MySQL databases that can be reached through the Web Hosting network ([see announcements](sql_eos_eol1.)).
