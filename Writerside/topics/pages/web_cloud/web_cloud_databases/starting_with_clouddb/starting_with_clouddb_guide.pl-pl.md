...
- Posiadanie [instancji Cloud Databases](https://www.ovh.pl/cloud/cloud-databases/){.external} (zawartego w ofercie [pakiecie hostingowym performance](hosting.))
...
Jeśli Twój hosting zawiera opcję prywatnego Web Cloud Databases, przejdź do [Panelu klienta OVHcloud](manager.){.external}. W sekcji `Web Cloud`{.action} kliknij `Hosting`{.action} w kolumnie z lewej strony.
...
![Informacje ogólne](web-cloud-databases-enable.png){.thumbnail}
...
W menu usług po lewej stronie [Panelu klienta](manager.){.external}, przejdź do sekcji `Web Cloud Databases`, a następnie kliknij nazwę instancji. Następnie przejdź do sekcji `Informacje ogólne`{.action}.
...
![cloud databases - bazy danych na instancji](starting_with_clouddb_images_general-information.png){.thumbnail}
...
![cloud databases - bazy danych na instancji](images_add-database.png){.thumbnail}
...
![cloud databases - bazy danych na instancji](add-database-create-user-confirmation.png){.thumbnail}
...
![cloud databases - bazy danych na instancji](images_add-user.png){.thumbnail}
...
![cloud databases - bazy danych na instancji](add-user-confirmation.png){.thumbnail}
...
![cloud databases - bazy danych na instancji](images_manage-rights.png){.thumbnail}
...
![cloud databases - bazy danych na instancji](images_import-file.png){.thumbnail}
...
![cloud databases - bazy danych na instancji](images_database-import-new-file-step-2.png){.thumbnail}
...
![cloud databases - bazy danych na instancji](database-import-new-file-step-3-send-email.png){.thumbnail} 
...
![cloud databases - bazy danych na instancji](images_add-an-ip-address-mask.png){.thumbnail}
...
![cloud databases - bazy danych na instancji](images_add-an-ip-address-mask-confirmation.png){.thumbnail}
...
![cloud databases - bazy danych na instancji](login-information.png){.thumbnail}
