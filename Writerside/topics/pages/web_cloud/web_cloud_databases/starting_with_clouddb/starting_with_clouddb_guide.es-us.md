...
- Tener una instancia [Cloud Databases](https://www.ovh.es/cloud/cloud-databases/) (incluido en un [plan de hosting performance](hosting.)).
...
Si el plan de hosting incluye la opción Web Cloud Databases, acceda al [área de cliente de OVHcloud](manager.){.external}. En la sección `Web Cloud`{.action}, haga clic en `Alojamientos`{.action} en la columna izquierda.
...
![Información general](web-cloud-databases-enable.png){.thumbnail}
...
En la columna izquierda de la sección Web del [área de cliente de OVHcloud](manager.){.external}, haga clic en `Web Cloud Databases`{.action} y seleccione el servicio Cloud Databases correspondiente. Por defecto, se abrirá la pestaña `Información general`{.action}.
...
![Cloud Databases](starting_with_clouddb_images_general-information.png){.thumbnail}
...
![Cloud Databases](images_add-database.png){.thumbnail}
...
![Cloud Databases](add-database-create-user-confirmation.png){.thumbnail}
...
![Cloud Databases](images_add-user.png){.thumbnail}
...
![Cloud Databases](add-user-confirmation.png){.thumbnail}
...
![Cloud Databases](images_manage-rights.png){.thumbnail}
...
![Cloud Databases](images_import-file.png){.thumbnail}
...
![Cloud Databases](images_database-import-new-file-step-2.png){.thumbnail}
...
![Cloud Databases](database-import-new-file-step-3-send-email.png){.thumbnail} 
...
![Cloud Databases](images_add-an-ip-address-mask.png){.thumbnail}
...
![Cloud Databases](images_add-an-ip-address-mask-confirmation.png){.thumbnail}
...
![Cloud Databases](login-information.png){.thumbnail}
