...
- Dispor de uma [instância Web Cloud Databases](https://www.ovh.pt/cloud/cloud-databases/) (associada a um [alojamento web](hosting.)).
- Aceder à [Área de Cliente OVHcloud](manager.){.external}.

## Instruções

### Ativação do seu servidor Web Cloud Databases incluído com o seu plano de alojamento web

Se a sua oferta de alojamento inclui a opção Web Cloud Databases, aceda à [Área de Cliente OVHcloud](manager.){.external}. Na secção `Web Cloud`{.action}, clique em `Alojamentos`{.action} na coluna da esquerda.
...
![Informações gerais](web-cloud-databases-enable.png){.thumbnail}
...
Na[Área de Cliente OVHcloud](manager.){.external}, no menu à esquerda, aceda à secção `Web Cloud Databases`{.action} e clique na instância em causa. Certifique-se que está no separador `Informações gerais`{.action}.
...
![Web Cloud Databases](starting_with_clouddb_images_general-information.png){.thumbnail}
...
![Web Cloud Databases](images_add-database.png){.thumbnail}
...
![Web Cloud Databases](add-database-create-user-confirmation.png){.thumbnail}
...
![Web Cloud Databases](images_add-user.png){.thumbnail}
...
![Web Cloud Databases](add-user-confirmation.png){.thumbnail}
...
![Web Cloud Databases](images_manage-rights.png){.thumbnail}
...
![Web Cloud Databases](images_import-file.png){.thumbnail}
...
![Web Cloud Databases](images_database-import-new-file-step-2.png){.thumbnail}
...
![Web Cloud Databases](database-import-new-file-step-3-send-email.png){.thumbnail} 
...
![Web Cloud Databases](images_add-an-ip-address-mask.png){.thumbnail}
...
![Web Cloud Databases](images_add-an-ip-address-mask-confirmation.png){.thumbnail}
...
![Web Cloud Databases](access-to-ovhcloud-web-hosting.png){.thumbnail}
...
![Web Cloud Databases](login-information.png){.thumbnail}

#### Obter os logs do seu servidor Web Cloud Databases

Para aceder aos logs da sua solução Web Cloud Databases, consulte o guia "[Web Cloud Databases - Como recuperar os logs ?](retrieve-logs1.)".
