...
- You need to have read the [Web Cloud Databases startup guide](starting_with_clouddb1.).
...
All this information is available in the [OVHcloud Control Panel](manager.).

Please also read our guide on [getting started with the Web Cloud Databases service](starting_with_clouddb1.).
...
> [!primary]
>
> In some cases, the RAM available in your Web Cloud Databases instance may not be sufficient to perform the desired export or import. If this is the case, we recommend using the OVHcloud tool in the OVHcloud Control Panel. See the [Getting started with Web Cloud Databases service](starting_with_clouddb1.) documentation if necessary.
>
