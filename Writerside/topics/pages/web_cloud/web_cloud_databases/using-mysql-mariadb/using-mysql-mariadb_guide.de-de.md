...
- Sie verfügen über eine [Web Cloud Databases Instanz](https://www.ovh.de/cloud/cloud-databases/){.external} (auch enthalten in einem [Performance Webhosting](hosting.)).
- Sie haben Zugriff auf Ihr [OVHcloud Kundencenter](manager.).
- Sie haben die [Anleitung zum Start mit Web Cloud Databases](starting_with_clouddb1.) befolgt.
...
Diese Informationen sind über Ihr [Kundencenter](manager.) einsehbar.

Die Anleitung finden Sie unter: [Erste Schritte mit Web Cloud Databases](starting_with_clouddb1.).
