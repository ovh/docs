...
- Disposer d'une [instance Web Cloud Databases](databases.){.external} (incluse dans une offre d'[hébergement web Performance](hosting.)).
...
Rendez-vous dans votre [espace client OVHcloud](manager.){.external}. Cliquez sur  l'onglet `Web Cloud`, puis sur `Web Cloud Databases`{.action}. Sélectionnez le nom de votre serveur de bases de données.
...
Pour gérer les droits de chaque utilisateur, rendez-vous dans votre [espace client OVHcloud](manager.){.external}. Cliquez sur  l'onglet `Web Cloud`, puis sur `Web Cloud Databases`{.action}. Sélectionnez le nom de votre serveur de bases de données. Cliquez sur l'onglet `Utilisateurs et droits`.
