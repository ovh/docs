...
With the [Web Cloud Databases](databases.) solution, you can host multiple databases. In some situations, you may need to view or retrieve the logs of:
...
- A [Web Cloud Databases](databases.) solution (included in a [Performance web hosting](hosting.) solution or standalone)
...
>
> This guide is designed to help you with common tasks. Nevertheless, we recommend contacting a [specialist service provider](partner.) if you encounter any difficulties. We will not be able to provide you with interpretation assistance for the logs available with your Web Cloud Databases solution. You can find more information in the [Go further](retrieve-logs_#go-further.) section of this guide.
>
...
![Web Cloud Databases](tab-with-logs.png){.thumbnail}
...
>
> To check this, retrieve the public IP address of your internet access point and refer to the **Authorize an IP address** section of [this guide](starting_with_clouddb1.).
>
...
![Web Cloud Databases](sftp-login.png){.thumbnail}
...
![Web Cloud Databases](site-manager.png){.thumbnail}
...
[Getting started with your Web Cloud Databases](starting_with_clouddb1.)
