...
Rozwiązanie [Web Cloud Databases](databases.) umożliwia hostowanie kilku baz danych. W niektórych sytuacjach możesz sprawdzić/pobrać logi:
...
- Posiadanie rozwiązania [Web Cloud Databases](databases.) (zawartego lub nie w ofercie [hostingu performance](hosting.)).
...
> 
> Oddajemy w Twoje ręce tutorial, którego celem jest pomoc w jak najbardziej optymalnym wykonywaniu bieżących zadań. Jeśli jednak napotkasz trudności, zalecamy skontaktowanie się z [wyspecjalizowanym dostawcą](partner.). Niestety OVH nie jest w stanie udzielić Ci wsparcia w interpretacji logów dostępnych w ramach Twojego rozwiązania Web Cloud Databases. Więcej informacji znajduje się w sekcji "[Sprawdź również](retrieve-logs_#go-further.)" tego tutoriala.
>
...
>
> Aby to sprawdzić, pobierz publiczny adres IP punktu dostępu do Internetu i sprawdź sekcję **Autoryzuj adres IP** w [tym przewodniku](starting_with_clouddb1.).
>
...
[Pierwsze kroki z Web Cloud Databases](starting_with_clouddb1.)
