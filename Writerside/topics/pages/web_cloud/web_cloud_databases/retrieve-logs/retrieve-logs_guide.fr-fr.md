...
La solution [Web Cloud Databases](databases.) permet d'héberger plusieurs bases de données. Dans certaines situations, vous pouvez être amené à consulter / récupérer les logs  :
...
- Disposer d'une solution [Web Cloud Databases](databases.) (incluse ou non dans une offre d'[hébergement web performance](hosting.)).
...
> 
> Nous mettons à votre disposition ce tutoriel afin de vous accompagner au mieux sur des tâches courantes. Néanmoins, nous vous recommandons de faire appel à un [prestataire spécialisé](partner.) si vous éprouvez des difficultés. En effet, nous ne serons pas en mesure de vous fournir une assistance sur l'interprétation des logs disponibles avec votre solution Web Cloud Databases. Plus d'informations dans la section « [Aller plus loin](retrieve-logs_#go-further.) » de ce tutoriel.
>
...
>
> Pour vérifier cela, récupérez l'adresse IP publique de votre point d'accès à Internet puis consultez la section **Autoriser une adresse IP** de [ce guide](starting_with_clouddb1.).
>
...
[Premiers pas avec votre Web Cloud Databases](starting_with_clouddb1.)
