...
A solução [Web Cloud Databases](databases.) permite alojar várias bases de dados. Em certas situações, poderá ter de consultar / recuperar os logs:
...
- Ter uma solução [Web Cloud Databases](databases.) (incluída ou não numa oferta de [alojamento web performance](hosting.)).
...
> 
> Nós disponibilizamos-lhe este tutorial a fim de o acompanhar nas tarefas mais comuns. No entanto, se encontrar dificuldades, recomendamos que recorra a um [fornecedor especializado](partner.). Não poderemos proporcionar-lhe assistência na interpretação dos logs disponíveis com a sua solução Web Cloud Databases. Mais informações na secção "[Vá mais longe](retrieve-logs_#go-further.)" deste tutorial.
>
...
>
> Para verificar esta informação, obtenha o endereço IP público do seu ponto de acesso à Internet e consulte **Permitir um endereço IP** de [este manual](starting_with_clouddb1.).
>
...
[Primeiros passos com o seu Web Cloud Databases](starting_with_clouddb1.)
