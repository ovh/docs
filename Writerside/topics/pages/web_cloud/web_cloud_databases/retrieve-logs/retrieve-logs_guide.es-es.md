...
La solución [Web Cloud Databases](databases.) permite alojar varias bases de datos. En determinadas situaciones, es posible que necesite consultar o recuperar los logs:
...
- Disponer de una solución [Web Cloud Databases](databases.) (incluida o no en un [plan de hosting Performance](hosting.)).
...
> 
> Este tutorial le ayudará a realizar las tareas más habituales. No obstante, si necesita ayuda, le recomendamos que contacte con un [proveedor especializado](partner.). OVHcloud no podrá ayudarle a interpretar los logs disponibles con su solución Web Cloud Databases. Para más información, consulte el apartado "[Más información](retrieve-logs_#go-further.)" de este tutorial.
>
...
>
> Para comprobarlo, consulte el apartado **Autorizar una dirección IP** de [esta guía](starting_with_clouddb1.).
>
...
[Primeros pasos con su Web Cloud Databases](starting_with_clouddb1.)
