...
- Dispor de uma [instância Web Cloud Databases](https://www.ovh.pt/cloud/cloud-databases/)  (incluída numa oferta de [alojamento web Performance](hosting.).
...
Na [Área de Cliente OVHcloud](manager.), aceda à secção `Web Cloud Databases`{.action} e clique na instância SQL que pretende configurar. Certifique-se de que está no separador `Informações gerais`{.action}.
...
![Informações gerais](images_general-information.png){.thumbnail}
...
Na [Área de Cliente OVHcloud](manager.), aceda à secção `Web Cloud Databases`{.action} e clique na Web Cloud Databases SQL em causa. 
...
>
> Para desassociar uma oferta Web Cloud Databases associada a um alojamento web **Performance**, aceda à [Área de Cliente OVHcloud](manager.). Clique no separador `Web Cloud`{.action} e, a seguir, no separador `Alojamentos`{.action}, que aparece na coluna da esquerda. 
>
...
Para alterar a sua oferta Web Cloud Databases, aceda à [Área de Cliente OVHcloud](manager.). Clique no separador `Web Cloud` e, a seguir, em `Web Cloud Databases`{.action}. Selecione o nome do seu servidor de bases de dados.
...
Aceda à [Área de Cliente OVHcloud](manager.). Clique no separador `Web Cloud` e, a seguir, em `Web Cloud Databases`{.action}. Selecione o nome do seu servidor Web Cloud Databases. 
...
Aceda à [Área de Cliente OVHcloud](manager.). Clique no separador `Web Cloud` e, a seguir, em `Web Cloud Databases`{.action}. Selecione o nome do seu servidor de bases de dados. 
