...
- A [Web Cloud Databases instance](https://www.ovh.co.uk/cloud/cloud-databases/) (included in a [Performance web hosting plan](hosting.)).
...
In your [OVHcloud Control Panel](manager.), go to the `Web Cloud Databases`{.action} section, then select the SQL instance concerned. Click on the `General information`{.action} tab.
...
![General information](images_general-information.png){.thumbnail}
...
In your [OVHcloud Control Panel](manager.), go to the `Web Cloud Databases`{.action} section, then select the Web Cloud Databases instance concerned. Click on the `General information`{.action} tab.
...
>
> To detach a Cloud Databases web hosting plan from a **Performance** web hosting plan, go to your [OVHcloud Control Panel](manager.). Click on the `Web Cloud`{.action} tab then on the relevant hosting plan in the `Hosting plans`{.action} section in the left-hand column. 
>
...
To modify the solution for your Web Cloud Databases instance, go to your [OVHcloud Control Panel](manager.). Click the `Web Cloud` tab, and then click `Web Cloud Databases`{.action}. Select the name of your database server.
...
In your [OVHcloud Control Panel](manager.), go to the `Web Cloud` section, and then click `Web Cloud Databases`{.action}. Select the name of your Web Cloud Databases server.
...
[IP address list for Web Hosting clusters](clusters_and_shared_hosting_IP1.)
