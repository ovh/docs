...
## Zamowienie
- Aby zamówić ofertę SSL Gateway, [kliknij tutaj](hosting-options-ssl.){.external}.
- Wybierz ofertę i kliknij na `Włącz teraz`{.action} lub `Zamów`{.action}.

![page commerciale](1-en.png){.thumbnail}

- Wpisz swoją domenę lub subdomenę i kliknij na `Dalej`{.action}.

![commande free](2-en.png){.thumbnail}
...
![commande free](3-en.png){.thumbnail}
