...
> [!primary]
>
> - Aver ordinato un [SSL Gateway](order-ssl-gateway1.).
...
![riquadro configurazione](9.PNG){.thumbnail}
...
![scheda Domini](10.PNG){.thumbnail}
...
>> 
>> ![aggiunta dominio free](11.PNG){.thumbnail}
>>
>
...
>> Indica la tua scelta e clicca su `Aggiungi`{.action} per confermare.
>>
>> ![aggiunta dominio advanced](12.PNG){.thumbnail}
>>
>
...
![scheda server](13.PNG){.thumbnail}
...
>> Indica la tua scelta e clicca su `Aggiungi`{.action} per confermare.
>> 
>> ![aggiunta IP/PORTA advanced (interna)](15.PNG){.thumbnail}
>>
>
...
![scheda operazioni](13-bis.PNG){.thumbnail}
...
![schede metriche](17.PNG){.thumbnail}
