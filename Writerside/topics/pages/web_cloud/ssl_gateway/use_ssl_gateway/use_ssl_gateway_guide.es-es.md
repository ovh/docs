...
### Requisitos
- [Haber contratado un servicio SSL Gateway](order-ssl-gateway1.).
...
Conéctese al [área de cliente](manager.){.external} y acceda a la sección `Sunrise`{.action}.

![menú sunrise](4.PNG){.thumbnail}

En la columna izquierda, haga clic en `SSL Gateway`{.action}.

![botón ssl gateway](5.PNG){.thumbnail}

Seleccione el servicio que desee configurar.

![panel central](6.PNG){.thumbnail}

Se mostrará la pantalla desde la que podrá gestionar el servicio.

![configuración global](7.PNG){.thumbnail}

#### Informacion
En la página de gestión del servicio, podrá ver la siguiente información:

![apartado información](8.PNG){.thumbnail}
...
![apartado configuración](9.PNG){.thumbnail}
...
![pestaña dominios](10.PNG){.thumbnail}
...
![añadir dominio free](11.PNG){.thumbnail}
...
![añadir dominio advanced](12.PNG){.thumbnail}
...
![pestaña servidores](13.PNG){.thumbnail}
...
![añadir IP y puerto advanced](15.PNG){.thumbnail}
...
![pestaña tareas](13-bis.PNG){.thumbnail}
...
![pestaña gráficas](17.PNG){.thumbnail}
...
> 
> ![Regenerar SSL](16.PNG){.thumbnail}
>
