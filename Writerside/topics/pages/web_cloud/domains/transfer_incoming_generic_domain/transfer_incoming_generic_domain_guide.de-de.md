...
> [!success]
>
> Um die Transferkosten anzuzeigen, geben Sie den Domainnamen, den Sie transferieren möchten, auf unserer Webseite ein: [www.ovhcloud.com/de/domains/tld/](domains-tld.). Folgen Sie dann den Schritten dieser Anleitung.
>
...
|---|---|---|---|---|
|[1](transfer_incoming_generic_domain_#step1.)|[Domaininformationen überprüfen](transfer_incoming_generic_domain_#step1.)|Administrator des Domainnamens|Beim aktuellen Registrar|Entsprechend Ihrem Vorgehen|
|[2](transfer_incoming_generic_domain_#step2.)|[Domainname entsperren und Transfer-Code beantragen](transfer_incoming_generic_domain_#step2.)|Der Administrator des Domainnamens mit Genehmigung des Inhabers|Beim aktuellen Registrar|Entsprechend Ihrem Vorgehen|
...
|[4](transfer_incoming_generic_domain_#step4.)|[Transfer bestätigen](transfer_incoming_generic_domain_#step4.)|Ihr aktueller Registrar|Via Anfrage der Organisation, die Ihre Domainendung verwaltet|Maximal fünf Tage|
...
**Bevor Sie den Transfer beantragen, ist es wichtig zu überprüfen, dass die Angaben zu Ihrem Domainnamen aktuell sind.** Seit Inkrafttreten der DSGVO sind die im [Whois-Eintrag](domains-whois.) sichtbaren Daten sehr begrenzt. Daher empfehlen wir Ihnen, die Informationen Ihres Domainnamens über Ihren aktuellen Registrar zu überprüfen.
...
> [!primary]
>
> Wenn Sie nicht wissen, welcher Registrar für Ihren Domainnamen verantwortlich ist, können Sie über die "Registrar"-Zeilen, die im Suchergebnis des [Whois](domains-whois.){.external}-Tools erscheinen, Informationen zu dessen Identität erhalten.
>
...
Sobald Ihr Domainname freigegeben und der Code verfügbar ist, können Sie den Transfer zu OVHcloud beantragen. Dazu führen Sie einfach eine [Bestellung über unsere Website aus](domains.){.external}. Geben Sie dort Ihren Domainnamen ein und folgen Sie den Bestellschritten.
...
Sie können Ihre Bestellung auch mit einem [Webhosting](hosting.){.external} kombinieren. Unsere Anleitung "[Migration Ihrer Website zu OVHcloud](hosting_migrating_to_ovh1.){.external}" beschreibt den optimalen Weg zum Migrieren Ihrer Dienste.
...
- Wenn Sie fortfahren, ohne diese Operation durchzuführen, wird der Domainname mit einer neuen DNS-Zone auf den OVHcloud DNS-Servern konfiguriert. In diesem Fall kann eine [manuelle Bearbeitung der DNS-Zone](dns_zone_edit1.) erforderlich werden.
...
Der Transferprozess kann über das [OVHcloud Kundencenter](manager.) neu gestartet werden. Wählen Sie `Web Cloud`{.action} aus und gehen Sie in den Bereich `Domainnamen`{.action}. Klicken Sie dann auf `Laufende Operationen`{.action}.
...
Sobald der Transfer abgeschlossen ist, können Sie Ihren Domainnamen über das [OVHcloud Kundencenter](manager.) verwalten. Gehen Sie im Bereich `Web Cloud`{.action} zu `Domainnamen`{.action} und wählen Sie den Domainnamen aus.
...
>
> Loggen Sie sich hierzu in Ihr [OVHcloud Kundencenter](manager.) ein und gehen Sie in den Bereich `Web Cloud`{.action}. Klicken Sie in der linken Spalte auf `Domainnamen`{.action} und wählen Sie den Domainnamen aus. **Monat** und **Jahr** der nächsten Verlängerung werden oben auf der Seite unter dem Domainnamen angezeigt.
>
