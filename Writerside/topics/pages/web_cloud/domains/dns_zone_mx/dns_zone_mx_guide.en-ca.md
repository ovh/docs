...
- You have an MX Plan solution (included in the [web hosting plan](hosting.)), an [Exchange](emails.) offer , or an external email service.
...
Below, you will find the OVHcloud MX configuration to use for our MX Plan solutions (MX Plan standalone or included in an [OVHcloud web hosting](hosting.) plan) and [Exchange](emails.). Our email servers have antispam and antivirus integrated.
