...
- You have an MX Plan solution (included in the [web hosting plan](hosting.)), [Exchange](emails.), or an external email service.
...
Below, you will find the OVHcloud MX configuration to use for our MX Plan solutions (included in an [OVHcloud web hosting](hosting.) plan) and [Exchange](emails.). Our email servers have antispam and antivirus integrated.
