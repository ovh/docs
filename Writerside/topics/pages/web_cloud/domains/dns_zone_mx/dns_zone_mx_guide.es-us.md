...
- Tener una solución MX Plan (incluida en el plan de [alojamiento web](hosting.)), [Exchange](emails.), o un servicio de correo externo.
...
![Correo electrónico](mx-dns-resolution-apac-ca.png){.thumbnail}
...
A continuación ofrecemos la configuración MX de OVHcloud que deberá utilizar para nuestros MX Plan (incluido en un plan de [hosting de OVHcloud](hosting.)) y [Exchange](emails.). Nuestros servidores de correo disponen de antispam y antivirus integrado.
