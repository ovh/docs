...
> - la [lista dei TLD disponibili in OVHcloud](domains-tld.);
...
![protezione attivata](protection-against-domain-name-transfert-enabled.png){.thumbnail}
...
>
> Inoltre, se visualizzi il messaggio: "**AUTH/INFO code : Authcode is not managed by OVHcloud, contact the registry to claim it**", significa che il codice di trasferimento del tuo dominio non può essere recuperato dal tuo [Spazio Cliente OVHcloud](manager.).  
> 
> In entrambi i casi, verifica di essere il contatto **amministratore** del dominio utilizzando la nostra guida sulla [gestione dei contatti](managing_contacts1.) e verifica che l'estensione del tuo dominio permetta lo sblocco dallo [Spazio Cliente OVHcloud](manager.).
> 
...
![disattivazione protezione](protection-against-domain-name-transfert-deactivating.png){.thumbnail}
...
[Trasferimento di dominio.co.uk in uscita](transfer_outgoing_couk1.)
