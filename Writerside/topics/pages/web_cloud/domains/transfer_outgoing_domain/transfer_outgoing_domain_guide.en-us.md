...
- Access to the [OVHcloud Control Panel](manager.) with the necessary permissions to manage the domain name (domain administrator)
...
> [!primary]
>
> If you are the domain name's **owner** but you are currently not able to manage it in the OVHcloud Control Panel, neither by using your own access nor via your domain name's administrative contact, please consult [this guide](managing_contacts#special-case-of-a-domain-owner.) first before proceeding.
>
...
> - The [list of TLDs available at OVHcloud](domains-tld.)
...
Log in to your [OVHcloud Control Panel](manager.) and select `Web Cloud`{.action}. Click `Domain names`{.action}, then choose the domain name concerned.
...
![outgoingtransfer](protection-against-domain-name-transfert-enabled.png){.thumbnail}
...
>
> If you encounter the message "**AUTH/INFO code: Authcode is not managed by OVHcloud, contact the registry to claim it**", this means that the transfer code for your domain name cannot be retrieved via your [OVHcloud Control Panel](manager.).
> 
> In both cases, check that your account is the **administrator** contact of the domain name using our guide on [contact management](managing_contacts1.) then check that the domain name extension can be unlocked from the [OVHcloud Control Panel](manager.).
> 
...
![outgoingtransfer](protection-against-domain-name-transfert-deactivating.png){.thumbnail}
...
[Transferring a .uk domain name to another registrar](transfer_outgoing_couk1.)
