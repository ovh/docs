...
- Tener un [dominio](domains.) registrado con OVHcloud.
...
> [!primary]
>
> Si usted es el **propietario** del dominio pero su gestión en el área de cliente de OVHcloud no está disponible, ya sea a través de su propio acceso o a través del contacto administrativo del dominio, consulte [esta guía](managing_contacts#caso-particular-de-un-propietario-de-dominio.) antes de continuar.
>
...
Conéctese al [Panel de configuración de OVHcloud](manager.) y seleccione `Web Cloud`{.action}. Haga clic en `Dominios`{.action} y seleccione el dominio correspondiente.
...
![protección activada](protection-against-domain-name-transfert-enabled.png){.thumbnail}
...
>
> Además, si encuentra el mensaje: "**AUTH/INFO code : Authcode is not managed by OVHcloud, contact the registry to claim it**", que significa que el código de transferencia de su dominio no es recuperable a través de su [área de cliente de OVHcloud](manager.).  
> 
> En ambos casos, compruebe que es el contacto **administrador** del dominio con ayuda de nuestra guía sobre la [gestión de contactos](managing_contacts1.) y compruebe que la extensión de su dominio permite un desbloqueo desde el [área de cliente de OVHcloud](manager.).
> 
...
![desactivación de la protección](protection-against-domain-name-transfert-deactivating.png){.thumbnail}
...
![Transferencia saliente](protection-against-domain-name-transfert-disabled.png){.thumbnail}
...
[Transferencia del dominio .co.uk saliente](transfer_outgoing_couk1.)
