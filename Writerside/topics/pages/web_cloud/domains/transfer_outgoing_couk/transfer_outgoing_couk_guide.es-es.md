...
- Tener un [dominio .uk](domains.) registrado con OVHcloud.
- Tienes acceso a tu [Panel de configuración de OVHcloud](manager.) y tener los permisos necesarios para gestionar el dominio (ser administrador del dominio).
...
![transferencia saliente](outgoing-transfer-tag.jpg){.thumbnail}

Se abrirá una ventana en la que deberá introducir el TAG del nuevo agente registrador y hacer clic en `Confirmar`{.action}.

![transferencia saliente](outgoing-transfer-tag-confirmation.jpg){.thumbnail}
