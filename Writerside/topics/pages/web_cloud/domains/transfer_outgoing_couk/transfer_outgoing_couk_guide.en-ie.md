...
The process of changing the registrar for Top Level Domains (TLD) of the **UK** country code (**.uk**) differs from the one explained in our [guide regarding generic TLDs](transfer_outgoing_domain1.). The instructions below concern the following extensions:
...
- A [.uk domain name](domains.) registered with OVHcloud
...
>
> If you are the domain's **owner** but you are currently not able to manage it in the OVHcloud Control Panel, neither by using your own access nor via your domain's administrative contact, please consult [this guide](managing_contacts#special-case-of-a-domain-owner.) first before proceeding.
>
...
![outgoingtransfer](outgoing-transfer-tag.jpg){.thumbnail}

In the popup window, enter the TAG of your future registrar, then click on `Confirm`{.action}.

![outgoingtransfer](outgoing-transfer-tag-confirmation.jpg){.thumbnail}
...
[Transferring a domain name to another registrar](transfer_outgoing_domain1.)
