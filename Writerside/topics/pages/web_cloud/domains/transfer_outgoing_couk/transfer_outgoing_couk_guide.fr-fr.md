...
- Disposer d'un [nom de domaine .uk](domains.) enregistré chez OVHcloud
- Être connecté à votre [espace client OVHcloud](manager.) et disposer des droits nécessaires pour gérer le nom de domaine (être administrateur du domaine)
...
![transfert sortant](outgoing-transfer-tag.jpg){.thumbnail}
...
![transfert sortant](outgoing-transfer-tag-confirmation.jpg){.thumbnail}
