...
> 
> - Si votre nom de domaine est enregistré chez OVHcloud, vous pouvez vérifier si ce dernier utilise notre configuration. Pour cela, rendez-vous dans votre [espace client](manager.){.external}, dans l'onglet `Serveurs DNS`{.action} du nom de domaine concerné.
> 
