...
- Haber contratado una de nuestras soluciones [Exchange](emails.), [Email Pro](email-pro.) o una solución de correo electrónico fuera de OVHcloud que disponga del DKIM.
...
La configuración automática del DKIM está disponible para los servicios de correo [Exchange](emails.) y [E-mail Pro](email-pro.).
...
> **Email Pro**
>>
>> Desde su [área de cliente de OVHcloud](manager.), en la pestaña `Web Cloud`{.action}, haga clic en `Emails Pro`{.action} y seleccione el servicio Email Pro correspondiente. Por último, abra la pestaña `Dominios asociados`{.action}.
>>
>> A la derecha del dominio en cuestión, puede observar que la etiqueta `DKIM` es gris.
>>
>>![email](dkim-auto01.png){.thumbnail}
...
> **Email Pro**
>>
>> En el [área de cliente de OVHcloud](manager.), en la pestaña `Web Cloud`{.action}, haga clic en `Emails Pro`{.action} y seleccione el servicio Email Pro correspondiente. Por defecto, el nombre de su plataforma corresponde a su referencia, o ésta será visible con el nombre que le haya asignado (ver la imagen inferior).
>>
>> ![Correo electrónico](dns-dkim-platform-emailpro.png){.thumbnail}
...
> **Email Pro**
>>
>> Desde su [área de cliente de OVHcloud](manager.), en la pestaña `Web Cloud`{.action}, haga clic en `E-mails Pro`{.action} y seleccione el servicio E-mail Pro correspondiente.<br><br> En la sección `Dominios asociados`{.action}, compruebe el color del icono `DKIM` a la derecha del dominio en cuestión (ver la imagen siguiente).
>>
>> ![email](red-dkim.png){.thumbnail}
