...
> [!primary]
>
> To follow this guide, make sure you are connected to OVHcloud API. You may find more information on the [API introduction](api_domain_intro1.) page if needed.
...
- [Order a Domain Name](api_domain_order1.)
- [Tasks Management](api_domain_tasks1.)
- [Manage Contacts of a Domain Name](api_domain_contacts1.)
- [Managing Eligibility Rules](api_domain_rules1.)
- [Configure the Display of Contact Data in the Whois](api_domain_whois1.)
- **Configure the DNS of your Domain Name**
- [Transfer a Domain Name](api_domain_transfer1.)
<!-- End TOC -->
...
This route will add the new name servers on the domain name and trigger a `DomainDnsUpdate` synchronisation task on the registry side. You will be able to track this task via the [dedicated APIs](api_domain_tasks#view-pending-tasks.).
...
You will be able to track this task via the [dedicated APIs](api_domain_tasks#view-pending-tasks.).
...
You will be able to track this task via the [dedicated APIs](api_domain_tasks#view-pending-tasks.), and you will not have to re-declare the name server on the domain name.
