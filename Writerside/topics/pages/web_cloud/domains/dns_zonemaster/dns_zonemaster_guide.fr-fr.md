...
>
> Nous vous recommandons de faire appel à un [prestataire spécialisé](partner.) si vous éprouvez des difficultés. En effet, nous ne serons pas en mesure de vous fournir une assistance. Plus d'informations dans la section [« Aller plus loin »](dns_zonemaster_#go-further.) de ce tutoriel.
>
...
> [!primary]
>
> Pour mieux comprendre la notion de DNS, consultez l'introduction de notre guide sur la [configuration d'une zone DNS](dns_zone_edit1.).
...
![Capture d'écran du formulaire de Zonemaster. Le domaine « domain.tld » a été saisi et est prêt à être testé.](run-domain-test.png){.thumbnail}
...
> ![Capture d'écran des options avancées du formulaire de Zonemaster. Les deux serveurs de noms « dns1.test.tld » et « dns2.test.tld » ont été saisis dans la section « Serveurs de noms » du formulaire.](run-domain-test-nameservers-option.png){.thumbnail}
...
>
> ![Capture d'écran de la page de résultats de Zonemaster pour le domaine « domain.tld ». La section « Adresses » est développée.](fetch-ns-from-parent-zone.png){.thumbnail}
...
![domains](domain-analysis.png){.thumbnail}
...
[Généralités sur les serveurs DNS](dns_server_general_information1.){.external}.

[Modification d'une zone DNS OVHcloud](dns_zone_edit1.){.external}.

[Protégez votre domaine contre le Cache Poisoning avec le DNSSEC](domains-dnssec.){.external}.
