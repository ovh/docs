...
>
> - [Criar uma zona DNS na OVHcloud](domains_dns_zone_create.)
...
> [!warning]
>
> A maioria das extensões propõe uma função de bloqueio contra a transferência, identificável por um estado especial no [Whois](domains-whois.), chamado "transferProhibited".
>
