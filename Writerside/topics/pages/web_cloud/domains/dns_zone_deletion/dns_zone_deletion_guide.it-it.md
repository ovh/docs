...
> [!primary]
>
> La creazione / modifica / eliminazione di una zona DNS dallo [Spazio Cliente OVHcloud](manager.) è totalmente gratuita.
>
...
- Disporre di diritti sufficienti sulla zona DNS da eliminare. Per maggiori informazioni consulta la nostra guida "[Gestire i contatti dei propri servizi](managing_contacts1.)".
...
>
> Effettua un [WHOIS](domains-whois.) del dominio per sapere se la zona DNS attiva del dominio è quella presente in OVHcloud o meno.
>
> Se la zona DNS attiva per il tuo nome di dominio è quella presente in OVHcloud e vuoi sostituirla con una zona DNS ospitata altrove, consulta la nostra guida "[Modificare i server DNS di un nome di dominio OVHcloud](dns_server_general_information1.)" prima di effettuare qualsiasi eliminazione di zona DNS.
>
...
1. Accedi allo [Spazio Cliente OVHcloud](manager.).
...
Al termine dello step precedente, all’indirizzo email del contatto "[Administrator](managing_contacts1.)" della zona DNS OVHcloud viene inviata un’email per confermare l’eliminazione della zona DNS.
...
> [!primary]
>
> Se il reindirizzamento dei collegamenti non funziona, fare un **copia/incolla** del collegamento nella barra degli URL del browser Internet. Se necessario, accedi nuovamente allo [Spazio Cliente OVHcloud](manager.).
>
...
Verrà inviata un’ultima email di conferma all’indirizzo email del contatto "[Amministratore](managing_contacts1.)" della zona DNS OVHcloud, per confermare l’eliminazione.

## Per saperne di più

[Gestire i contatti dei propri servizi](managing_contacts1.)
