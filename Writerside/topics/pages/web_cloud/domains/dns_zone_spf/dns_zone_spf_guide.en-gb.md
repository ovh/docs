...
- [Add an OVHcloud SPF record](#spfrecordovhcloud.) **and use the OVHcloud configuration**: For users who only have OVHcloud email offers on their domain name (excluding [Private Exchange](emails-private-exchange.){.external}).
