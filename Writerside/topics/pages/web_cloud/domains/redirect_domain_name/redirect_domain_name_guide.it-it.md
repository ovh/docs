...
- **Dallo [Spazio Cliente OVHcloud](manager.)**, dove l'assistente di configurazione permette di impostare il reindirizzamento.
...
>
> Attenzione: un reindirizzamento creato dallo [Spazio Cliente OVHcloud](manager.) non permette di reindirizzare una URL in `https://` verso un altro dominio o URL. 
...
Accedi alla sezione `Web Cloud`{.action} dello [Spazio Cliente OVHcloud](manager.), seleziona il dominio da reindirizzare nella sezione `Domini`{.action} e clicca sulla scheda `Reindirizzamento`{.action}.
...
![Presentazione del menu reindirizzamento](add-a-redirection.png){.thumbnail}

Sono disponibili tre opzioni di reindirizzamento dallo[Spazio Cliente OVHcloud](manager.), ognuna delle quali è composta da **5 step** successivi. 
...
>
> Per maggiori informazioni sui record DNS, consulta la nostra documentazione sui [record DNS](dns_zone_edit1.).
>
...
>>
>> ![Step 1](add-a-redirection-step-1.png){.thumbnail}
>>
...
>>
>> ![Step 2](add-a-redirection-step-2-to-a-web-adress.png){.thumbnail}
>>
...
>>
>> ![Step 3](add-a-redirection-step-3-a-visible-redirection.png){.thumbnail}
>>
...
>>
>> ![Step 4](add-a-redirection-step-4-permanent.png){.thumbnail}
>>
...
>>
>> ![Step 5](add-a-redirection-step-5-permanent.png){.thumbnail}
>>
...
>>
>> ![Step 4](add-a-redirection-step-4-temporary.png){.thumbnail}
>>
>> Clicca su `Avanti`{.action} per passare allo Step 5.
>>
> **Step 5**
...
>> In quest'ultimo step, assicurati che le informazioni visualizzate siano corrette.
>>
>> ![Step 5](add-a-redirection-step-5-temporary.png){.thumbnail}
>>
>> Clicca su `Conferma`{.action} per confermare la tua configurazione.
>> 
>> > [!primary]
...
>>
>> ![Step 3](add-a-redirection-step-3-with-an-invisible-redirection.png){.thumbnail}
>>
>> Clicca su `Avanti`{.action} per passare allo Step 4.
>>
> **Step 4**
...
>>
>> ![Step 4](add-a-redirection-step-4-iframe.png){.thumbnail}
>>
...
>> In quest'ultimo step, assicurati che le informazioni visualizzate siano corrette.
>>
>> ![Step 5](add-a-redirection-step-5-iframe.png){.thumbnail}
>>
>> Clicca su `Conferma`{.action} per confermare la tua configurazione.
>> 
>> > [!primary]
...
> 
> Questa guida ti aiuta a eseguire le operazioni necessarie. Tuttavia, in caso di difficoltà o dubbi, ti consigliamo di rivolgerti a uno [specialista del settore](partner.). OVHcloud non sarà infatti in grado di fornirti assistenza sugli step documentati qui sotto. Per maggiori informazioni, consulta la sezione ["Per saperne di più"](redirect_domain_name_#go-further.) di questa guida.
>
...
Gestire un file ".htaccess" può rendere il tuo sito inaccessibile. In caso di dubbio, contatta uno dei [fornitori specializzati](partner.).

Per maggiori informazioni, consulta la nostra guida sul .htaccess nella sezione ["Per saperne di più"](redirect_domain_name_#go-further.) di questa guida.
...
[Bloccare l'accesso al mio sito per alcuni indirizzi IP tramite un file ".htaccess" ](htaccess_how_to_block_a_specific_ip_address_from_accessing_your_website1.).

[Proteggi l'interfaccia di gestione del tuo sito tramite il ".htaccess" ](htaccess_protect_directory_by_password1.).

[Effettuare altre operazioni con il file ".htaccess" ](htaccess_what_else_can_you_do1.).

[Come modificare la mia zona DNS?](dns_zone_edit1.)
