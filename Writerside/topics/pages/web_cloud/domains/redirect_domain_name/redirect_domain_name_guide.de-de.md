...
- **Über das [OVHcloud Kundencenter](manager.)**, in dem ein Konfigurationsassistent Ihre Weiterleitung einrichten kann.
...
> Achten Sie auf die Änderungen, die Sie vornehmen, oder kontaktieren Sie bei Bedarf einen [spezialisierten Dienstleister](partner.) für SEO.
>
> Achtung: Eine über das [OVHcloud Kundencenter](manager.) erstellte Weiterleitung erlaubt nicht die Weiterleitung einer URL als `https://` auf eine andere Domain oder URL. 
...
Loggen Sie sich in das [OVHcloud Kundencenter](manager.){.external} ein, gehen Sie in den Bereich `Web Cloud`{.action}, wählen Sie die umzuleitende Domain unter `Domainnamen`{.action} aus, und klicken Sie dann auf den Tab `Weiterleitung`{.action}.
...
![Vorstellung des Menüs zur Weiterleitung](add-a-redirection.png){.thumbnail}

Über das [OVHcloud Kundencenter](manager.) sind drei Weiterleitungsoptionen verfügbar, von denen jede aus **fünf aufeinander folgenden Schritten** besteht. 
...
>
> Mehr Informationen zu DNS-Einträgen finden Sie in unserer Dokumentation zum [Bearbeiten der OVHcloud DNS-Zone](dns_zone_edit1.).
>
...
>>
>> ![Schritt 1](add-a-redirection-step-1.png){.thumbnail}
>>
...
>>
>> ![Schritt 2](add-a-redirection-step-2-to-a-web-adress.png){.thumbnail}
>>
...
>>
>> ![Schritt 3](add-a-redirection-step-3-a-visible-redirection.png){.thumbnail}
>>
...
>>
>> ![Schritt 4](add-a-redirection-step-4-permanent.png){.thumbnail}
>>
...
>>
>> ![Schritt 5](add-a-redirection-step-5-permanent.png){.thumbnail}
>>
...
>>
>> ![Schritt 4](add-a-redirection-step-4-temporary.png){.thumbnail}
>>
>> Klicken Sie auf `Weiter`{.action}, um zu Schritt 5 überzugehen.
>>
> **Schritt 5**
...
>> Überprüfen Sie im letzten Schritt, ob die angezeigten Informationen korrekt sind.
>>
>> ![Schritt 5](add-a-redirection-step-5-temporary.png){.thumbnail}
>>
>> Klicken Sie auf `Bestätigen`{.action}, um Ihre Konfiguration zu validieren.
>>
>> > [!primary]
...
>>
>> ![Schritt 3](add-a-redirection-step-3-with-an-invisible-redirection.png){.thumbnail}
>>
>> Klicken Sie auf `Weiter`{.action}, um zu Schritt 4 überzugehen.
>>
> **Schritt 4**
...
>> Wählen Sie `Temporär (302)`{.action} aus den beiden Auswahlmöglichkeiten und geben Sie die Zieldomain oder -URL Ihrer Weiterleitung im Feld `Web-Adresse`{.action} ein.
>>
>> ![Schritt 4](add-a-redirection-step-4-iframe.png){.thumbnail}
>>
...
>> Überprüfen Sie im letzten Schritt, ob die angezeigten Informationen korrekt sind.
>>
>> ![Schritt 5](add-a-redirection-step-5-iframe.png){.thumbnail}
>>
>> Klicken Sie auf `Bestätigen`{.action}, um Ihre Konfiguration zu validieren.
>>
>> > [!primary]
...
> 
> Diese Anleitung soll Sie bei allgemeinen Aufgaben bestmöglich unterstützen. Dennoch empfehlen wir Ihnen, falls Sie Hilfe brauchen, einen [spezialisierten Dienstleister](partner.) zu kontaktieren oder Ihre Fragen in der OVHcloud Community zu stellen. Leider können wir Ihnen für administrative Aufgaben keine weitergehende technische Unterstützung anbieten. Weitere Informationen finden Sie am [Ende dieser Anleitung](redirect_domain_name_#go-further.).
>
...
Eine fehlerhafte ".htaccess" Datei kann Ihre Website unerreichbar machen. Kontaktieren Sie im Zweifelsfall einen [spezialisierten Dienstleister](partner.) .

Unsere Dokumentation zum Thema ".htaccess" finden Sie im Abschnitt ["Weiterführende Informationen"](redirect_domain_name_#go-further.) dieser Anleitung.
