...
- **Depuis l'[espace client OVHcloud](manager.)** où un assistant de configuration permet de paramétrer votre redirection.
...
> Soyez vigilant quant aux manipulations que vous allez entreprendre ou contactez un [prestataire spécialisé](partner.) dans le référencement si nécessaire.
>
> Attention : une redirection créée depuis l'[espace client OVHcloud](manager.) ne permet pas de rediriger une URL en `https://` vers un autre domaine ou une autre URL. 
> Pour créer ce type de redirection, vous devrez obligatoirement passer par [une réécriture d'URL](htaccess_url_rewriting_using_mod_rewrite1.) via un fichier « .htaccess » par exemple.
>

### Rediriger un nom de domaine depuis l'espace client

Connectez-vous à l'[espace client OVHcloud](manager.){.external}, rendez-vous dans la partie `Web Cloud`{.action}, sélectionnez le domaine à rediriger dans la section `Noms de domaine`{.action} puis cliquez sur l'onglet `Redirection`{.action}.
...
![Présentation du menu redirection](add-a-redirection.png){.thumbnail}

Trois options de redirections sont disponibles depuis l'[espace client OVHcloud](manager.) et chacune d'entre elles se compose de **5 étapes** successives. 
...
>
> Pour plus d'informations sur les entrées DNS, consultez notre documentation sur les [enregistrements DNS](dns_zone_edit#les-enregistrements-dns.).
>
...
>>
>> ![Étape 1](add-a-redirection-step-1.png){.thumbnail}
>>
...
>>
>> ![Étape 2](add-a-redirection-step-2-to-a-web-adress.png){.thumbnail}
>>
...
>>
>> ![Étape 3](add-a-redirection-step-3-a-visible-redirection.png){.thumbnail}
>>
...
>>
>> ![Étape 4](add-a-redirection-step-4-permanent.png){.thumbnail}
>>
...
>>
>> ![Étape 5](add-a-redirection-step-5-permanent.png){.thumbnail}
>>
...
>>
>> ![Étape 4](add-a-redirection-step-4-temporary.png){.thumbnail}
>>
>> Cliquez sur `Suivant`{.action} pour passer à l'étape 5.
>>
> **Etape 5**
...
>> Dans cette dernière étape, assurez-vous que les informations affichées sont bien correctes.
>>
>> ![Étape 5](add-a-redirection-step-5-temporary.png){.thumbnail}
>>
>> Cliquez sur `Confirmer`{.action} pour valider votre configuration.
>> 
>> > [!primary]
...
>>
>> ![Étape 3](add-a-redirection-step-3-with-an-invisible-redirection.png){.thumbnail}
>>
>> Cliquez sur `Suivant`{.action} pour passer à l'étape 4.
>>
> **Etape 4**
...
>>
>> ![Étape 4](add-a-redirection-step-4-iframe.png){.thumbnail}
>>
...
>> Dans cette dernière étape, assurez-vous que les informations affichées sont bien correctes.
>>
>> ![Étape 5](add-a-redirection-step-5-iframe.png){.thumbnail}
>>
>> Cliquez sur `Confirmer`{.action} pour valider votre configuration.
>> 
>> > [!primary]
...
> 
> Nous mettons à votre disposition cette partie du guide afin de vous accompagner au mieux sur des tâches courantes. Néanmoins, nous vous recommandons de faire appel à un [prestataire spécialisé](partner.) si vous éprouvez des difficultés. En effet, nous ne serons pas en mesure de vous fournir une assistance sur les étapes documentées ci-dessous. Retrouvez plus d'informations dans la section [« Aller plus loin »](redirect_domain_name_#go-further.) de ce guide.
>
...
Manipuler un fichier « .htaccess »  peut rendre votre site inaccessible. En cas de doute, contactez un [prestataire spécialisé](partner.) .

Retrouvez l'ensemble de notre documentation sur le « .htaccess »  dans la section [« Aller plus loin »](redirect_domain_name_#go-further.) de ce guide.
...
[Bloquer l’accès à mon site pour certaines adresses IP via un fichier « .htaccess » ](htaccess_how_to_block_a_specific_ip_address_from_accessing_your_website1.).

[Protéger l'interface d'administration de votre site via le « .htaccess » ](htaccess_protect_directory_by_password1.).

[Réécrire vos URLs grâce au « mod_rewrite »](htaccess_url_rewriting_using_mod_rewrite1.).

[Effectuer d'autres opérations avec le fichier « .htaccess » ](htaccess_what_else_can_you_do1.).

[Comment éditer ma zone DNS ?](dns_zone_edit1.)
