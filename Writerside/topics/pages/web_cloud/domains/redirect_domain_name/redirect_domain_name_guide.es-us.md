...
- **Desde el [área de cliente de OVHcloud](manager.)**) donde hay un asistente de configuración que le permite configurar su redirección.
...
> Esté atento a las operaciones que vaya a realizar o contacte con un [proveedor especializado](partner.) en el posicionamiento, si es necesario.
>
> Atención: una redirección creada desde el [área de cliente de OVHcloud](manager.) no permite redirigir una URL en `https://` a otro dominio o URL. 
> Para crear este tipo de redirección, debe pasar obligatoriamente por [una reescritura de URL](htaccess_url_rewriting_using_mod_rewrite1.) a través de un fichero ".htaccess", por ejemplo.
>

### Redirigir un dominio desde el área de cliente

Conéctese al [área de cliente de OVHcloud](manager.){.external}, acceda al apartado `Web Cloud`{.action}, seleccione el dominio que quiere redirigir en la sección `Dominios`{.action} y haga clic en la pestaña `Redirección`{.action}.
...
![Presentación del menú redirección](add-a-redirection.png){.thumbnail}

Hay tres opciones de redirección disponibles en el [área de cliente de OVHcloud](manager.), cada una de las cuales se compone de **5 etapas** sucesivas. 
...
>
> Para más información sobre los registros DNS, consulte nuestra documentación sobre los [registros DNS](dns_zone_edit1.).
>
...
![Gif1](visible-redirection.gif){.thumbnail}
...
>>
>> ![Etapa 1](add-a-redirection-step-1.png){.thumbnail}
>>
...
>>
>> ![Etapa 2](add-a-redirection-step-2-to-a-web-adress.png){.thumbnail}
>>
...
>>
>> ![Etapa 3](add-a-redirection-step-3-a-visible-redirection.png){.thumbnail}
>>
...
>>
>> ![Etapa 4](add-a-redirection-step-4-permanent.png){.thumbnail}
>>
...
>>
>> ![Etapa 5](add-a-redirection-step-5-permanent.png){.thumbnail}
>>
...
>>
>> ![Etapa 4](add-a-redirection-step-4-temporary.png){.thumbnail}
>>
>> Haga clic en `Siguiente`{.action} para pasar a la etapa 5.
>>
> **Etapa 5**
...
>> En esta última etapa, asegúrese de que la información mostrada es correcta.
>>
>> ![Etapa 5](add-a-redirection-step-5-temporary.png){.thumbnail}
>>
>> Haga clic en `Confirmar`{.action} para validar su configuración.
>> 
>> > [!primary]
...
![Gif2](invisible-redirection.gif){.thumbnail}
...
>> Seleccione `Hacia una dirección Web`{.action}.
>>
>> ![2](add-a-redirection-step-2-to-a-web-adress.png){.thumbnail}
>>
>> Haga clic en `Siguiente`{.action} para ir al etapa 3.
>>
> **Etapa 3**
...
>>
>> ![Etapa 3](add-a-redirection-step-3-with-an-invisible-redirection.png){.thumbnail}
>>
>> Haga clic en `Siguiente`{.action} para ir al etapa 4.
>>
> **Etapa 4**
...
>>
>> ![Etapa 4](add-a-redirection-step-4-iframe.png){.thumbnail}
>>
...
>> En esta última etapa, asegúrese de que la información mostrada es correcta.
>>
>> ![Etapa 5](add-a-redirection-step-5-iframe.png){.thumbnail}
>>
>> Haga clic en `Confirmar`{.action} para validar su configuración.
>> 
>> > [!primary]
...
> 
> Ponemos a su disposición esta parte de la guía para acompañarle lo mejor posible en tareas habituales. No obstante, si tiene alguna duda, le recomendamos que contacte con un [proveedor especializado](partner.). No podremos asistirle en las siguientes etapas. Más información en la sección ["Más información"](redirect_domain_name_#go-further.) de esta guía.
>
...
Manipular un archivo ".htaccess" puede inhabilitar el acceso al sitio web. En caso de duda, contacte con un [proveedor especializado](partner.) .

Para más información, consulte nuestra guía ".htaccess" en la sección ["Más información"](redirect_domain_name_#go-further.) de esta guía.
...
[Bloquear el acceso a mi sitio web para algunas direcciones IP a través de un archivo ".htaccess"](htaccess_how_to_block_a_specific_ip_address_from_accessing_your_website1.).

[Proteger el panel de administración de su sitio web a través de ".htaccess"](htaccess_protect_directory_by_password1.).

[Reescribir las URLs utilizando el "mod_rewrite"](htaccess_url_rewriting_using_mod_rewrite1.).

[Realizar otras operaciones con el archivo ".htaccess"](htaccess_what_else_can_you_do1.).

[Cómo editar mi zona DNS ?](dns_zone_edit1.)
