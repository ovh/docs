...
Avec cette règle, lors de la commande, le domaine doit obligatoirement avoir une [configuration](api_domain_order#configurations-management.) ayant pour label `ACCEPT_CONDITIONS` avec une valeur booléenne à `true`, `1` ou `"1"`.
...
> [!primary]
>
> Pour plus d'informations sur les différents types de contact, veuillez consulter la [documentation associée](api_domain_contacts1.).
