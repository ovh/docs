...
- [Configure the DNS of your Domain Name](api_domain_dns1.)
...
With this rule, when ordering, the domain must have a [configuration](api_domain_order#configurations-management.) labelled `ACCEPT_CONDITIONS` with a boolean value of `true`, `1` or `"1"`.
...
> [!primary]
>
> For more information on the contact types, please consult the [relevant documentation](api_domain_contacts1.)
