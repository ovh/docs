...
>
> This tutorial is designed to help you with common tasks. Nevertheless, we recommend contacting a [specialist provider](partner.) or the publisher of the CMS you have chosen to install if you encounter any difficulties. We will not be able to assist you. You can find more information in the [Go further](cms_manual_installation_#go-further.) section of this tutorial.
>
...
> [!success]
>
> To install your CMS **automatically** from your [OVHcloud Control Panel](manager.), please refer to our documentation on [installing a 1-click module](cms_install_1_click_modules1.).
>
...
You can find more information on our [WordPress module page](hosting-wordpress.). 
...
You can find more information on our [Joomla! module page](hosting-joomla.). 
...
You can find more information on our [Drupal module page](hosting-drupal.). 
...
You can find more information on our [PrestaShop module page](hosting-prestashop.).
...
To install a CMS on your [web hosting plan](hosting.), you will need to make some preparations.
...
Please refer to our documentation, which describes [how to add a multisite on your web hosting plan](multisites_configure_multisite1.), in order to define the root directory to use with your CMS.
...
- Make sure that the domain name you will use to access your CMS, along with its subdomain “www”, is mapped to the IP address of your [web hosting plan](hosting.).

To retrieve the IP address of your Web Hosting plan, log in to your [OVHcloud Control Panel](manager.) in the `Web Cloud`{.action} section, then select your Web Hosting plan in the `Hosting`{.action} section.<br>
...
If your domain’s active DNS zone is managed in your [OVHcloud Control Panel](manager.), compare your hosting plan’s IP address with the one in your domain’s DNS zone, using our [OVHcloud DNS zones](dns_zone_edit1.) documentation .

> [!warning]
>
> If you have activated the `CDN`{.action} or `Country IP`{.action} options with your domain, use the appropriate IP address by referring to our documentation listing [all shared hosting IP addresses](clusters_and_shared_hosting_IP1.).
>
...
- Get [the information you need to log in to your Web Hosting plan’s FTP space](ftp_connection#step-1-retrieve-your-login-information.).
- Retrieve access to your Web Hosting plan’s database if it already exists, or create one using our [documentation](sql_create_database1.).

#### 1.3 Install the free FTP client FileZilla

If you are not already using an FTP client, you can use Filezilla. You can find the free download link and a tutorial on how to use it in our documentation on [using FileZilla with your OVHcloud hosting plan](ftp_filezilla_user_guide1.).

> [!primary]
>
> There are other FTP clients that you can use, such as Cyberduck. You can find more information in our documentation on [using Cyberduck with your OVHcloud hosting plan](ftp_cyberduck_user_guide_on_mac1.).
>
...
Most CMSs require a database to work. Our [web hosting offers](hosting.) include them, with the exception of [100M free hosting](domains-free-hosting.).

Use our documentation to [create a database from your web hosting plan](sql_create_database1.).

If you have a Cloud Databases web hosting plan in MySQL or MariaDB and you would like to use it to manually install your CMS, please refer to our guide on [creating a database on a Cloud Databases web service](create-db-and-user-on-db-server#creating-a-database.).

Once you have created the database, retrieve the connection settings (server, database name, user name, and password) and save them for [step 3](cms_manual_installation_#step3.) in this guide.
...
>
> If this is also the same CMS you need to install, you can use [this guide](sql_change_password#step-3-change-the-password-for-your-websites-database-in-its-configuration-file.) to identify the configuration files in your [FTP storage space](ftp_connection1.).
>
...
>
> - To connect to your database linked to your Web Hosting plan, see [this guide](sql_create_database#accessing-the-phpmyadmin-interface.).
> - To connect to a database on a Web Cloud Databases solution, see [this guide](connecting-to-database-on-database-server1.).
>
...
>
> Then configure the PHP version on your web hosting plan by referring to our guide on [Changing a Web Hosting plan’s PHP version](configure_your_web_hosting1.).
>
...
Once you have unpacked the files in your **CMS** folder, [log in to your storage space via FTP](ftp_connection1.) using [FTP FileZilla client](ftp_filezilla_user_guide1.) and copy the files from the **CMS** folder to the root folder you defined on your hosting in [step 1](cms_manual_installation_#step1.) of this guide.
...
>[!primary]
>
> If the root folder you defined was not created automatically during the actions described in [step 1](cms_manual_installation_#step1.), you can create it via FileZilla.
>
...
To log in to your hosting plan via SSH, please refer to our guide on [Accessing a web hosting plan via SSH](ssh_on_webhosting1.).
...
- [Finalise a WordPress installation](cms_manual_installation_wordpress1.)
- [Finalise a Joomla! installation](cms_manual_installation_joomla1.)
- [Finalise a Drupal installation](cms_manual_installation_drupal1.)
- [Finalise a PrestaShop installation](cms_manual_installation_prestashop1.)
- [Finalise a Pico installation](cms_manual_installation_pico1.)
- [Finalise a Grav installation](cms_manual_installation_grav1.)
- [Finalise a Typo3 installation](cms_manual_installation_typo31.)
- [Finalise a SPIP installation](cms_manual_installation_spip1.)

## Go further <a name="go-further"></a>

[Migrating your website and emails to OVHcloud](hosting_migrating_to_ovh1.)

[Publishing a website on your Web Hosting space](hosting_how_to_get_my_website_online1.)
