...
> 
> Dieses Tutorial soll Sie bei allgemeinen Aufgaben bestmöglich unterstützen. Dennoch empfehlen wir Ihnen, falls Sie Hilfe brauchen, einen [spezialisierten Dienstleister](partner.) oder den Herausgeber des CMS zu kontaktieren. Leider können wir Ihnen für administrative Aufgaben keine weitergehende technische Unterstützung anbieten. Weitere Informationen finden Sie am [Ende dieser Anleitung](cms_manual_installation_#go-further.).
>
...
> [!success]
>
> Um Ihr CMS **automatisch** in Ihrem [OVHcloud Kundencenter](manager.) zu installieren, lesen Sie unsere Anleitung zur [Installation Ihrer Website mit 1-Klick-Modulen](cms_install_1_click_modules1.).
>
...
- Sie haben ein [OVHcloud Webhosting](hosting.), das mindestens eine Datenbank enthält.
...
Weitere Informationen finden Sie auf unserer Seite zum [WordPress Modul](hosting-wordpress.).
...
Weitere Informationen finden Sie auf unserer Seite zum [Joomla! Modul](hosting-joomla.).
...
Weitere Informationen finden Sie auf unserer Seite zum [Drupal Modul](hosting-drupal.).
...
Weitere Informationen finden Sie auf unserer Seite zum [PrestaShop Modul](hosting-prestashop.).
...
Um ein CMS auf Ihrem [Webhosting](hosting.) Angebot zu installieren sind einige Vorbereitungen erforderlich.
...
In unserer Anleitung "[Mehrere Websites auf einem Webhosting einrichten](multisites_configure_multisite1.)" erfahren Sie, wie Sie die Verzeichnisse für Ihre Websites bzw. CMS verwalten.
...
- Vergewissern Sie sich, dass der Domainname, den Sie für den Zugriff auf Ihr CMS verwenden, sowie dessen "www"-Subdomain auf die IP-Adresse Ihres [OVHcloud Webhostings](hosting.) verweisen.

Um die IP-Adresse Ihres Webhostings zu erfahren, loggen Sie sich in Ihr [OVHcloud Kundencenter](manager.) ein und wählen Sie Ihr Webhosting im Bereich `Web Cloud`{.action} unter `Hosting-Pakete`{.action} aus.<br>
Im Kasten `Allgemeine Informationen`{.action} finden Sie die IP-Adresse Ihres Webhostings im Eintrag `IPv4`{.action}.

Wenn die aktive DNS-Zone Ihres Domainnamens in Ihrem [OVHcloud Kundencenter](manager.) verwaltet wird, vergleichen Sie die IP-Adresse Ihres Hostings mit der in der DNS-Zone Ihres Domainnamens eingetragenen. Verwenden Sie dazu unsere Dokumentation zur [Verwaltung von OVHcloud DNS-Zonen](dns_zone_edit1.).

> [!warning]
>
> Wenn Sie eine der Optionen `CDN`{.action} oder `IP des Landes`{.action} für Ihren Domainnamen aktiviert haben, verwenden Sie die stattdessen die IP-Adresse, die Sie in unserer [Dokumentation zu IP-Adressen der Webhosting-Cluster](clusters_and_shared_hosting_IP1.) finden können.
>
...
- Rufen Sie die für die [Verbindung mit dem FTP-Bereich Ihres Webhostings](ftp_connection#schritt-1-erforderliche-verbindungsinformationen-abrufen.) notwendigen Informationen ab.
- Beziehen Sie die Datenbank-Verbindungsinformationen Ihres Webhostings, oder erstellen Sie eine neue Datenbank mithilfe unserer [Dokumentation](sql_create_database1.).

#### 1.3 Den kostenlosen FTP-Client FileZilla installieren

Wenn Sie noch keinen FTP-Client verwenden, können Sie FileZilla installieren. Der Download-Link sowie eine Anleitung zur Verwendung dieser kostenfreien Software finden Sie in unserem Tutorial zur [Verwendung von FileZilla mit Ihrem OVHcloud Webhosting](ftp_filezilla_user_guide1.).

> [!primary]
>
> Es gibt weitere FTP-Clients, die Sie verwenden können, z.B. Cyberduck. Weitere Informationen finden Sie in unserer Dokumentation zur [Verwendung von Cyberduck mit Ihrem OVHcloud Webhosting](ftp_cyberduck_user_guide_on_mac1.).
>
...
Die meisten CMS benötigen eine Datenbank, um zu funktionieren. Unsere [Webhosting Angebote](hosting.) enthalten diese mit Ausnahme des [100M kostenlosen Hostings](domains-free-hosting.).

Verwenden Sie unsere Anleitung zur [Erstellung einer Datenbank über Ihr Webhosting](sql_create_database1.).

Wenn Sie das Angebot Web Cloud Databases mit MySQL oder MariaDB nutzen und dieses für die manuelle Installation Ihres CMS verwenden möchten, lesen Sie unsere Anleitung zur [Erstellung einer Datenbank mit Web Cloud Databases](create-db-and-user-on-db-server#datenbank-erstellen.).

Sobald die Datenbank erstellt wurde, rufen Sie die Verbindungseinstellungen (Server, Name der Datenbank, Benutzername und Passwort) ab und speichern Sie diese für [Schritt 3](cms_manual_installation_#step3.) dieser Anleitung.
...
>
> Wenn es sich dabei um das gleiche CMS handelt, können Sie die Konfigurationsdateien über Ihren [FTP-Speicherplatz](ftp_connection1.) anhand [dieser Anleitung](sql_change_password#schritt-3-passwort-der-datenbank-ihrer-website-in-ihrer-konfigurationsdatei-andern.) identifizieren.
>
...
>
> - Um sich mit Ihrer Webhosting-Datenbank zu verbinden, folgen Sie [dieser Anleitung](sql_create_database#auf-das-phpmyadmin-interface-zugreifen.).
> - Um sich mit einer Datenbank von Web Cloud Databases zu verbinden, folgen Sie [dieser Anleitung](connecting-to-database-on-database-server1.).
>
...
>
> Konfigurieren Sie anschließend die PHP-Version mithilfe unserer Anleitung zur [Änderung der PHP-Version eines Webhostings](configure_your_web_hosting1.).
>
...
Nachdem Sie die Dateien in Ihrem Ordner "**CMS**" dekomprimiert haben, stellen Sie eine [FTP-Verbindung mit Ihrem Webhosting her](ftp_connection1.), etwa mithilfe des [Clients FileZilla](ftp_filezilla_user_guide1.). Kopieren Sie die Dateien aus dem Ordner "**CMS**" zum Wurzelverzeichnis für Ihr CMS, das Sie in [Schritt 1](cms_manual_installation_#step1.) dieser Anleitung erstellt haben.
...
>[!primary]
>
> Wenn das von Ihnen definierte Wurzelverzeichnis nicht automatisch mit den in [Schritt 1](cms_manual_installation_#step1.) beschriebenen Aktionen erstellt wurde , können Sie es über FileZilla erstellen.
>
...
Um sich via SSH mit Ihrem Hosting zu verbinden, lesen Sie unsere Anleitung zur [SSH-Verbindung zu einem OVHcloud Webhosting](ssh_on_webhosting1.).
...
- [Installation von WordPress abschließen](cms_manual_installation_wordpress1.)
- [Installation von Joomla! abschließen](cms_manual_installation_joomla1.)
- [Installation von Drupal abschließen](cms_manual_installation_drupal1.)
- [Installation von PrestaShop abschließen](cms_manual_installation_prestashop1.)
- [Installation von Pico abschließen](cms_manual_installation_pico1.)
- [Installation von Grav abschließen](cms_manual_installation_grav1.)
- [Installation von Typo3 abschließen](cms_manual_installation_typo31.)
- [Installation von SPIP abschließen](cms_manual_installation_spip1.)

## Weiterführende Informationen <a name="go-further"></a>

[Migration Ihrer Website und E-Mails zu OVHcloud](hosting_migrating_to_ovh1.)

[Eine Website auf einem Webhosting online stellen](hosting_how_to_get_my_website_online1.)
