...
Con el [Alojamiento gratuito 100M](domains-free-hosting.){.external}, OVHcloud le ofrece un alojamiento web de 100 MB y una cuenta de correo con 5 GB de almacenamiento. Esta guía explica cómo activar el alojamiento gratuito 100M en su [nombre de dominio](domains.){.external}.
...
> Si quiere crear un sitio web que tenga varias páginas y que requiera una base de datos, como un CMS (WordPress, Joomla, PrestaShop, Drupal, etc.), puede contratar uno de [nuestros planes de hosting](hosting.) directamente desde nuestro sitio web o desde su [área de cliente de OVHcloud](manager.){.external}.
>
...
- Disponer de un [dominio](domains.){.external} en su [área de cliente de OVHcloud](manager.){.external}, no asociado a ningún alojamiento web y sin ningún [MX Plan](email_generalities1.) asociado.
- Estar conectado a su [área de cliente de OVHcloud](manager.){.external}.

## Procedimiento

Conéctese al [área de cliente de OVHcloud](manager.){.external}, haga clic en `Dominios`{.action}  en la columna izquierda y seleccione el dominio correspondiente.
...
>
Si su zona DNS no está gestionada en su [área de cliente de OVHcloud](manager.){.external}, deberá realizar los cambios manualmente en su zona DNS externa.
>
> Para más información, consulte nuestra guía sobre [la edición de una zona DNS de OVHcloud](dns_zone_edit1.).
>
...
> [!primary]
>
Si su proyecto evoluciona rápidamente hacia un alojamiento que dispone de una base de datos, un espacio de almacenamiento más grande o más direcciones de correo, podrá migrar directamente y únicamente del Alojamiento gratuito 100M a un plan de hosting **Personal** desde su [área de cliente OVHcloud](manager.){.external}.
>
...
>
> Para más información, consulte nuestras [ofertas de alojamiento](hosting.).
>
...
Una vez validado el pedido, le enviaremos por correo electrónico la información de [conexión FTP](ftp_connection1.){.external} a su alojamiento gratuito 100M.

Consulte la guía [creación de una cuenta MX Plan](email_creation1.){.external} para disfrutar de la dirección de correo electrónico incluida con su alojamiento gratuito 100M.

## Más información

[Conectarse al espacio de almacenamiento de su alojamiento web](ftp_connection1.){.external}

[Crear una dirección de correo electrónico con su solución MX Plan](email_creation1.){.external}
