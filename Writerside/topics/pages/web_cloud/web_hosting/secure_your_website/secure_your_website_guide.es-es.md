...
>
> Le ofrecemos esta guía para ayudarle a completar mejor las tareas más comunes. Sin embargo, le recomendamos que, si necesita ayuda, contacte con un proveedor de servicios especializado o con el editor del programa o la interfaz. Nosotros no podremos asistirle. Para más información, consulte la sección [Más información](secure_your_website_#go-further.) de esta guía.
>

## Requisitos

- un [plan OVHcloud Web Hosting](hosting.)
- tener los detalles de [inicio de sesión](ftp_connection#1-obtener-los-datos-de-conexion.) para acceder al espacio de almacenamiento de su plan de alojamiento
- acceso al [panel de control de OVHcloud](manager.)
...
- cambie regularmente la contraseña de administrador de su puesto (para más información sobre la elección de las contraseñas, siga las instrucciones de esta [guía](all_about_username#crear-una-contrasena-solida-y-unica.).

### Etapa 2 - Proteger el área de cliente de OVHcloud

Para proteger su cuenta de cliente, [active la doble autenticación](secure-ovhcloud-account-with-2fa1.) y siga las instrucciones de este [guía](all_about_username1.).

Actualice la [información de su cuenta de cliente](all_about_username#editar-mis-datos-personales.) y añada un **email de seguridad**.<br>
...
En primer lugar, haga una copia de seguridad de los datos que componen su sitio web conectándose a su [espacio FTP](ftp_connection1.) y a su [servidor de bases de datos](sql_database_export1.). Importe estos en su equipo o en un soporte externo, de tipo servidor NAS o llave USB.
...
Los mensajes de phishing constituyen también una amenaza para la seguridad de su sitio web, ya que pueden contener o conducir a la instalación de programas maliciosos. Para saber cómo reconocerlas y protegerlas, consulte esta [guía](phishing_care1.).
...
Si su sitio web tiene un lugar preponderante en su actividad profesional, [active la renovación automática](how_to_use_automatic_renewal#acceder-a-la-configuracion-de-los-servicios.) en el conjunto de sus servicios OVHcloud.<br>
...
Compruebe regularmente las actualizaciones de su sitio web siguiendo las instrucciones de esta [guía](diagnostic_403_forbidden#22-actualizar-el-sitio-web.).

No olvide utilizar una versión reciente del [lenguaje PHP](configure_your_web_hosting1.) en su alojamiento.

### Etapa 7 - Activar el HTTPS

Establezca la conexión encriptada a su sitio web a través del protocolo **HTTPS** siguiendo este [guía](ssl-activate-https-website1.). La activación de este protocolo permitirá cifrar toda la información que transita por su sitio web (especialmente las entradas efectuadas por los usuarios en sus formularios).
...
Para ello, debe conectarse al [espacio FTP](ftp_connection1.). y requiere conocimientos técnicos para reconocer los posibles archivos maliciosos del alojamiento. Si necesita ayuda para realizar esta comprobación, no dude en ponerse en contacto con nuestros [partners](partner.).

Si tiene dudas sobre este asunto, no olvide realizar las comprobaciones que se describen en [el etapa 1 de esta guía](#local.) y [cambiar la contraseña](ftp_change_password1.) de su espacio FTP.

### Etapa 11 - Probar las copias de seguridad de su sitio web

Es necesario realizar regularmente [copias de seguridad de los datos](secure_your_website_#backup.) del sitio web (archivos FTP y base de datos).
...
- [bloquear el acceso a su sitio web para determinadas direcciones IP](htaccess_how_to_block_a_specific_ip_address_from_accessing_your_website1.);
- [proteger un directorio o la interfaz de administración de su sitio web asociándolo con un archivo ".htpasswd"](htaccess_protect_directory_by_password1.);
- [proteger su CMS WordPress](htaccess_how_to_protect_wordpress1.).

## Más información <a name="go-further"></a>

[Consejos sobre la piratería de su sitio WordPress](cms_what_to_do_if_your_site_is_hacked1.)

[Reaccionar en caso de desactivación por seguridad de un alojamiento](diagnostic_403_forbidden1.)
