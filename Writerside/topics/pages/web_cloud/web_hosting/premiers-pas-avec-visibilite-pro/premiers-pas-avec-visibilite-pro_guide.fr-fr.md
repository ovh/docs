...
Pour débuter la manipulation, connectez-vous à votre [espace client OVHcloud](manager.){.external} et assurez-vous de vous situer dans la section « Web ». Cliquez sur `Hébergements`{.action}, puis sélectionnez l'hébergement auquel la solution Visibilité Pro a été liée. 

Positionnez-vous ensuite sur l'onglet `Visibilité Pro`{.action}.

![visibilitypro](premiers-pas-avec-visibilite-pro_images_tab.png){.thumbnail}
...
![visibilitypro](acces-to-the-interface.png){.thumbnail}
...
![visibilitypro](establishment-infos.png){.thumbnail}
...
![visibilitypro](establishment-infos-2.png){.thumbnail}
...
![visibilitypro](google-facebook-connection.png){.thumbnail}
...
![visibilitypro](congratulations.png){.thumbnail}
...
![visibilitypro](profil-page.png){.thumbnail}
...
![visibilitypro](autosync-enable.png){.thumbnail}
...
![visibilitypro](to-publish.png){.thumbnail}
...
![visibilitypro](create-new-publication.png){.thumbnail}
...
![visibilitypro](customers-advisors.png){.thumbnail}
...
![visibilitypro](images_dashboard.png){.thumbnail}
