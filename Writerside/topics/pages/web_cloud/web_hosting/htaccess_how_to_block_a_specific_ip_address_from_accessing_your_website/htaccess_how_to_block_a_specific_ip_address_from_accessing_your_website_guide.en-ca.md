...
You can create multiple ".htaccess" files in [the FTP space](ftp_connection1.) of your hosting but **only one** per directory or subdirectory to avoid conflicts between different .htaccess files.
...
>
> This guide is designed to help you with common tasks. Nevertheless, we recommend contacting a [specialist provider](partner.) if you encounter any difficulties. We will not be able to assist you. You can find more information in the [Go further](htaccess_how_to_block_a_specific_ip_address_from_accessing_your_website_#go-further.) section of this guide.
>
...
>
> To edit (or create) these directories, log in to your hosting plan’s FTP space. If you need help with this, please refer to our guide on [Logging in to your Web Hosting plan’s storage space](ftp_connection1.).
>
...
In the event of an error, you can always log in to [the FTP space](ftp_connection1.) of your hosting to correct mistakes.
...
- [Protect your website’s administration interface via ".htaccess"](htaccess_protect_directory_by_password1.).
- [Rewrite your URLs using mod_rewrite](htaccess_url_rewriting_using_mod_rewrite1.)
- [Perform other operations with the ".htaccess" file](htaccess_what_else_can_you_do1.)
