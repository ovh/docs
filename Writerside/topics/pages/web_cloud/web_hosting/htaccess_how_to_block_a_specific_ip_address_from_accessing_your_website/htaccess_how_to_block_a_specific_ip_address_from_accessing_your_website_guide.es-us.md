...
Puede crear varios archivos ".htaccess" en [el espacio FTP](ftp_connection1.) de su alojamiento, pero **un solo** por directorio o subdirectorio para evitar conflictos entre diferentes ficheros ".htaccess".
...
En caso de error, puede conectarse a [el espacio FTP](ftp_connection1.) de su alojamiento para corregir la situación. 
...
- [Proteger la interfaz de administración de su sitio web a través del ".htaccess"](htaccess_protect_directory_by_password1.).
- [Reescribir sus URLs gracias al "mod_rewrite"](htaccess_url_rewriting_using_mod_rewrite1.).
