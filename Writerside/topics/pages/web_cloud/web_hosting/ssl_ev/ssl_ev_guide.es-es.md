...
OVHcloud ofrece varios tipos de certificados SSL en nuestros [planes de hosting de OVHcloud](hosting.). Estos datos se presentan en la guía [Gestionar un certificado SSL en un alojamiento web](ssl_on_webhosting1.). Los certificados SSL son imprescindibles para la seguridad de su sitio web.
...
> [!warning]
>
> Los certificados SSL EV no están disponibles para todo el mundo. Compruebe si puede optar a la suscripción **antes** de contratar este último, utilizando los elementos indicados en los [requisitos](ssl_ev_#requirements.) de esta guía.
>
...
- Contratar o disponer de un [hosting OVHcloud](hosting.) en el que no haya ningún certificado SSL instalado.
- Contratar o disponer de un [nombre de dominio](domains.) y disponer de los derechos exclusivos sobre su uso. El nombre de dominio no debe estar ya asociado a un certificado SSL.
...
> 
> Ponemos a su disposición esta guía para ayudarle a realizar las tareas más habituales. No obstante, si tiene alguna duda, le recomendamos que contacte con un [proveedor especializado](partner.). En efecto, no podremos asistirle en **todas las etapas de verificación directamente efectuada con la autoridad de certificación Sectigo**. Más información en la sección [Más información](ssl_ev_#go-further.) de esta guía.
>
...
Consulte nuestra guía sobre cómo [gestionar un certificado SSL en su alojamiento web](ssl_on_webhosting1.) y seleccione el **Certificado SSL EV** una vez haya llegado al túnel de pedido.
...
Si todavía no ha contratado su dominio y el alojamiento asociado, acceda a nuestra [página de inicio de OVHcloud](website.), introduzca un dominio en el **formulario de búsqueda previsto a tal efecto** y haga clic en `Buscar`{.action} para iniciar el pedido.
...
Para asegurarse de que la comunicación con Sectigo se realiza correctamente, compruebe también la validez de la dirección de correo electrónico que se indica en el formulario al contratar el SSL EV y la dirección de correo electrónico de contacto asociada a su [área de cliente de OVHcloud](manager.).
...
>
> También le recomendamos que **no** active o deje activo el[firewall de aplicación](multisites_activating_application_firewall1.), disponible con nuestros alojamientos web durante toda la instalación de su certificado SSL EV.
>
...
Solo tendrá que [pasar su sitio web en HTTPS](ssl-activate-https-website1.) para utilizar plenamente su certificado SSL EV.
...
[Habilitar HTTPS en el sitio web](ssl-activate-https-website1.)
