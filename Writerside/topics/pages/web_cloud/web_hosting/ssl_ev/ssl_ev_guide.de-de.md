...
OVHcloud bietet verschiedene Arten von SSL-Zertifikaten für die [Webhostings](hosting.) an, wie in unserer Anleitung "[SSL-Zertifikat auf einem Webhosting verwalten](ssl_on_webhosting1.)" beschrieben. SSL-Zertifikate sind für die Sicherheit Ihrer Website unentbehrlich.
...
> [!warning]
>
> EV SSL Zertifikate sind nicht für jedermann verfügbar. Überprüfen Sie deshalb **vor einer Bestellung**, ob Sie für die Zertifizierung des Domainnamens in Frage kommen. Verwenden Sie hierzu die unter [Voraussetzungen](ssl_ev_#requirements.) aufgeführten Punkte.
>
...
- Sie bestellen oder verfügen über ein [OVHcloud Webhosting](hosting.), auf dem noch kein SSL Zertifikat installiert ist.
- Sie bestellen oder verfügen über einen [Domainnamen](domains.) und dessen exklusive Nutzungsrechte. Der Domainname darf nicht bereits mit einem SSL-Zertifikat verbunden sein.
...
> 
> Diese Anleitung soll Sie bei allgemeinen Aufgaben bestmöglich unterstützen. Dennoch empfehlen wir Ihnen, falls Sie Hilfe brauchen, einen [spezialisierten Dienstleister](partner.) zu kontaktieren oder Ihre Fragen in der OVHcloud Community zu stellen. Leider können wir Ihnen keine Unterstützung **für jegliche von der Zertifizierungsstelle Sectigo durchgeführten Verifizierungen** anbieten. Weitere Informationen finden Sie am [Ende dieser Anleitung](ssl_ev_#go-further.).
>
...
Lesen Sie unsere Anleitung "[SSL-Zertifikat auf Ihrem Webhosting verwalten](ssl_on_webhosting1.)" und wählen Sie im Bestellvorgang das **EV SSL-Zertifikat** aus.
...
Wenn Sie Ihren Domainnamen und das dazugehörige Hosting noch nicht bestellt haben, gehen Sie auf die [Startseite von OVHcloud](website.), geben Sie einen Domainnamen in das dafür vorgesehene **Suchformular** ein und klicken Sie anschließend auf `Suchen`{.action}, um Ihre Bestellung zu starten.
...
Um sicherzustellen, dass der E-Mail-Verkehr mit Sectigo korrekt abläuft, überprüfen Sie auch die Gültigkeit der im Formular angegebenen E-Mail-Adresse bei der Bestellung des EV SSL und der Kontakt-E-Mail-Adresse in Ihrem [OVHcloud Kundencenter](manager.).
...
>
> Wir empfehlen auch, die [Application Firewall](multisites_activating_application_firewall1.), die bei unseren Webhostings inkludiert ist, während der gesamten Dauer der Installation Ihres EV SSL-Zertifikats zu deaktivieren.
>
...
Sie müssen nur noch [Ihre Website auf HTTPS umstellen](ssl-activate-https-website1.), um Ihr EV SSL-Zertifikat vollständig zu nutzen.
...
[SSL-Zertifikate auf Webhostings verwalten](ssl_on_webhosting1.)

[Ihre Website auf HTTPS umstellen](ssl-activate-https-website1.)
