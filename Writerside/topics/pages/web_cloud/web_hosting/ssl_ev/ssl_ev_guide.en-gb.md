...
OVHcloud offers several types of SSL certificates for [OVHcloud web hosting solutions](hosting.). They are set out in our guide on [Managing an SSL certificate on a web hosting plan](ssl_on_webhosting1.). SSL certificates are essential for the security of your website.
...
> [!warning]
>
> EV SSL certificates are not available for everyone. To check if you are eligible to sign up for a subscription, please use the information listed in the [requirements](ssl_ev_#requirements.) section of this guide **before** ordering it.
>
...
- You plan to order an SSL secured [OVHcloud web hosting plan](hosting.) or you have a web hosting plan in your customer account without an SSL certificate installed.
- You manage a [domain name](domains.) for which you have exclusive rights. The domain name must not already be linked to an SSL certificate.
...
> 
> This guide is designed to help you with common tasks. Nevertheless, we recommend contacting a [specialist provider](partner.) if you encounter any difficulties. We will not be able to provide you with assistance **for all verification steps directly performed with the Sectigo certification authority**. You can find more information in the [Go further](ssl_ev_#go-further.) section of this guide.
>
...
Read our guide on how to [manage an SSL certificate on your web hosting plan](ssl_on_webhosting1.) and select the **EV SSL Certificate** once you have reached the order process.
...
If you have not yet ordered your domain name and associated hosting package, go to our [OVHcloud homepage](website.), enter a domain name in the **search form** and click `Search`{.action} to start the order process.
...
To ensure that email exchanges with Sectigo are going well, also check the validity of the email address entered in the form when you ordered the EV SSL, as well as the contact email address associated with your [OVHcloud Control Panel](manager.).
...
>
> We also recommend that you **do not** enable or leave the [application firewall](multisites_activating_application_firewall1.), available with our web hosting plans, active for the duration of your EV SSL certificate installation.
>
...
You will only need to [activate HTTPS on your website](ssl-activate-https-website1.) to fully use your EV SSL certificate.
...
[Activating HTTPS on your website](ssl-activate-https-website1.)
