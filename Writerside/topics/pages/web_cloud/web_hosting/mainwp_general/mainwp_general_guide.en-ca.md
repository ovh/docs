...
- [manage your customer information](mainwp-client-management1.)
...
- Access to the [OVHcloud Control Panel](manager.), in the `Web Cloud`{.action} section.
...
> 
> This tutorial is designed to help you with common tasks. However, we recommend contacting a [specialist provider](partner.) or [the publisher of the MainWP plugin](https://mainwp.com/support/){.external} if you experience any difficulties. We will not be able to assist you. More information in the ["Go further"](mainwp_general_#go-further.) section of this tutorial.
>
...
![mainWP](connect_WP_admin.png){.thumbnail}
...
![mainWP](add_new_plugin.png){.thumbnail}
...
![mainWP](plugins_mainwp_result.png){.thumbnail}
...
![mainWP](warning_message_child.png){.thumbnail}
...
![mainWP](add_new_site.png){.thumbnail}
...
![mainWP](add_site_success_message.png){.thumbnail}
...
![mainWP](sites_dashboard.png){.thumbnail}
...
![mainWP](grid_all_sites.png){.thumbnail}
...
![mainWP](updates_screen.png){.thumbnail}
...
![mainWP](update_themes.png){.thumbnail}
...
![mainWP](update_confirmation_message.png){.thumbnail}
...
MainWP offers native features, such as software update management or [customer information management](mainwp-client-management1.). However, MainWP becomes even more powerful thanks to its many extensions, offering a wide range of features.
...
![mainWP](updraftPlus_card.png){.thumbnail}
...
![mainWP](API_key_mainwp.png){.thumbnail}
...
![mainWP](install_activate_extensions.png){.thumbnail}
...
![mainWP](API_key_valid.png){.thumbnail}
