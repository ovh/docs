...
- Posiadanie [hostingu OVHcloud](hosting.) z dostępem SSH Dostęp ten pozwala na zainstalowanie w wierszu poleceń jednego lub kilku rozwiązań alternatywnych wobec tych oferowanych domyślnie w naszych pakietach hostingowych.
- Zapoznanie się z wprowadzaniem wiersza poleceń.
- Możliwość przesyłania plików przez FTP z klientem, takim jak [FileZilla](ftp_filezilla_user_guide1.).
- Ustawienie strefy DNS w celu przekierowania domeny (lub subdomeny) na hosting. Jest to przydatne, jeśli chcesz hostować kilka stron WWW na [MultiSite](multisites_configure_multisite1.) na Twoim hostingu.
...
[hosting współdzielony](hosting.) pozwala na zgłaszanie domen lub subdomen w opcji MultiSite. Do wdrożenia Twojej strony WWW z systemem **Cecil** konieczna jest domena lub subdomena.

Aby pomóc Ci w zadeklarowaniu domeny lub subdomeny w opcji MultiSite na Twoim hostingu, wejdź na naszą stronę "[Udostępnienie hostingu między kilkoma stronami](multisites_configure_multisite1.)".
...
![Instalacja Cecil](static_website_installation_cecil01.png){.thumbnail}
...
![Instalacja Cecil](static_website_installation_cecil02.png){.thumbnail}

Teraz możesz zobaczyć wynik wyświetlając nazwę Twojej domeny:

![Instalacja Cecil](static_website_installation_cecil03.png){.thumbnail}
...
Jeśli Twoja domena lub subdomena jest zainstalowana w OVHcloud, zapoznaj się z naszymi przewodnikami dotyczącymi [konfiguracji DNS](dns_zone_edit1.) i uruchomienia [MultiSite na Twoim hostingu](multisites_configure_multisite1.).
...
![Plik konfiguracji YAML](static_website_installation_cecil04.png){.thumbnail}
...
![Instalacja Cecil](static_website_installation_cecil05.png){.thumbnail}
...
![Instalacja Cecil](static_website_installation_cecil06.png){.thumbnail}

Możesz wyświetlić go na Twoim serwerze, wpisując adres URL strony, a następnie `/mypage/`:

![Wynik przeglądarki](static_website_installation_cecil07.png){.thumbnail}

### Personalizacja plików strony

#### Zmiana dla serwera

Edycja plików _Markdown_ może odbywać się bezpośrednio na serwerze hostingowym. W ofercie [hosting Performance](hosting-performance-offer.) dostęp SSH pozwala na korzystanie z protokołu [GNU nano](https://nano-editor.org/){.external}, [vi](https://ex-vi.sourceforge.net/){.external} lub [vim](https://www.vim.org/){.external}.
...
![Edycja pliku w GNU nano](static_website_installation_cecil08.png){.thumbnail}

Dodaj kilka linii zgodnie z składnią _Markdown_:

![Dodaj zawartość do pliku](static_website_installation_cecil09.png){.thumbnail}
...
![Strona zaktualizowana](static_website_installation_cecil10.png){.thumbnail}
...
![Do pobrania z FileZilla](cecil-folder.png){.thumbnail}

Teraz możesz edytować pliki I.D.E. w swoim repozytorium:

![Wyświetlanie w Visual Studio Code](static_website_installation_cecil12.png){.thumbnail}
...
[Dodaj dynamiczne treści do statycznej strony internetowej generowanej przez Cecil](static_website_installation_cecil_api_call1.)
...
Nasz [Przewodnik dotyczący korzystania z FileZilla](ftp_filezilla_user_guide1.)
