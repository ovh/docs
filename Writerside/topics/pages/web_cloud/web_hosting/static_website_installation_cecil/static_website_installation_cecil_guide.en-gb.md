...
> 
> If you experience any difficulties following the steps in this tutorial, we recommend contacting a [specialist provider](partner.) or reach out to the OVHcloud community. We will not be able to assist you. You can find more information in the [Go further](static_website_installation_cecil_#go-further.) section of this guide.
>

## Requirements

- Have an [OVHcloud web hosting plan](hosting.) that includes SSH access. With this access, you can install one or more alternative solutions online, to those offered by default in our web hosting plans.
- Be familiar with command line input.
- Be able to transfer files via FTP with a client like [FileZilla](ftp_filezilla_user_guide1.).
- Configure your DNS zone to point your domain name (or subdomain) to your web hosting plan. This is particularly useful if you would like to host several websites in [multisites](multisites_configure_multisite1.) on your shared web hosting plan.
...
You can use [shared web hosting](hosting.) to declare domains or subdomains on multiple websites. You need a domain or subdomain to deploy your website created with **Cecil**.

To help you declare a domain or subdomain on multiple websites on your hosting plan, go to our page “[Hosting multiple websites on your hosting plan](multisites_configure_multisite1.)”.
...
![Cecil Installation](static_website_installation_cecil01.png){.thumbnail}
...
![Cecil Installation](static_website_installation_cecil02.png){.thumbnail}

You can now see the result by going to your domain name:

![Cecil Installation](static_website_installation_cecil03.png){.thumbnail}
...
If your domain name or subdomain is hosted at OVHcloud, please refer to our guides for [DNS configuration](dns_zone_edit1.) and setting up [multisites on your web hosting plan](multisites_configure_multisite1.).
...
![YAML configuration file](static_website_installation_cecil04.png){.thumbnail}
...
![Cecil Installation](static_website_installation_cecil05.png){.thumbnail}
...
![Cecil Installation](static_website_installation_cecil06.png){.thumbnail}

You can view it on your server by typing your website URL, followed by `/mypage/`:

![Browser Result](static_website_installation_cecil07.png){.thumbnail}

### Customise your website files

#### Change on server

You can edit Markdown files directly on the Web Hosting server. With your [Performance Hosting](hosting-performance-offer.) SSH access, you can use [GNU nano](https://nano-editor.org/){.external}, [vi](https://ex-vi.sourceforge.net/){.external} or [vim](https://www.vim.org/){.external}.
...
![Editing file in GNU nano](static_website_installation_cecil08.png){.thumbnail}

Add a few lines using the Markdown syntax:

![Adding content to file](static_website_installation_cecil09.png){.thumbnail}
...
![Page updated](static_website_installation_cecil10.png){.thumbnail}
...
![FileZilla Download](cecil-folder.png){.thumbnail}

You can now edit the files in your I.D.E.:

![View in Visual Studio Code](static_website_installation_cecil12.png){.thumbnail}
...
[Add dynamic content to a static web page generated with Cecil](static_website_installation_cecil_api_call1.)

[Cecil application official website](https://cecil.app/){.external}

[A Markdown format guide](https://www.markdownguide.org/){.external}

[Our FileZilla user guide](ftp_filezilla_user_guide1.)
