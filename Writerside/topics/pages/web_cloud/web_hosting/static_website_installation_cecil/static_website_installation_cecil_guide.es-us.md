...
- Disponer de un [plan de hosting de OVHcloud](hosting.) con acceso SSH. Este acceso permite instalar en línea de comandos una o más soluciones alternativas a las que ofrecen nuestros planes de hosting por defecto.
- Estar familiarizado con la entrada en línea de comandos.
- Poder transferir archivos por FTP con un cliente como [FileZilla](ftp_filezilla_user_guide1.).
- Configurar la zona DNS para que su dominio (o subdominio) apunte hacia su alojamiento web compartido. Esto resulta especialmente útil si desea alojar varios sitios web en [multisitios](multisites_configure_multisite1.) en su alojamiento compartido.
...
Los [alojamientos web compartidos](hosting.) permiten declarar dominios o subdominios en multisitios. Un dominio o subdominio es necesario para desplegar su sitio web con **Cecil**.

Si necesita ayuda para declarar un dominio o subdominio multisitio en su alojamiento, consulte nuestra página "[Alojar varios sitios web en un mismo hosting](multisites_configure_multisite1.)".
...
![Instalación Cecil](static_website_installation_cecil01.png){.thumbnail}
...
![Instalación Cecil](static_website_installation_cecil02.png){.thumbnail}

Ahora puede ver el resultado accediendo a su dominio :

![Instalación Cecil](static_website_installation_cecil03.png){.thumbnail}
...
Si tiene su dominio o subdominio alojado en OVHcloud, consulte nuestras guías relativas a la [configuración DNS](dns_zone_edit1.) y la instalación de un [multisitio en su alojamiento web](multisites_configure_multisite1.).
...
![Archivo de configuración YAML](static_website_installation_cecil04.png){.thumbnail}
...
![Instalación Cecil](static_website_installation_cecil05.png){.thumbnail}
...
![Instalación Cecil](static_website_installation_cecil06.png){.thumbnail}

Puede visualizarlo en su servidor escribiendo la URL de su sitio web, seguido de `/mypage/`:

![Resultado del navegador](static_website_installation_cecil07.png){.thumbnail}

### Personalizar los archivos de su sitio web

#### Modificación del servidor

La edición de los archivos _Markdown_ puede realizarse directamente en el servidor de alojamiento web. En su [plan de hosting Performance](hosting-performance-offer.), su acceso SSH permite utilizar indistintamente [GNU nano](https://nano-editor.org/){.external}, [vi](https://ex-vi.sourceforge.net/){.external} o [vim](https://www.vim.org/){.external}.
...
![Edición del archivo en GNU nano](static_website_installation_cecil08.png){.thumbnail}

Añada algunas líneas en la sintaxis _Markdown_:

![Añadir contenido al archivo](static_website_installation_cecil09.png){.thumbnail}
...
![Página actualizada](static_website_installation_cecil10.png){.thumbnail}
...
![Descargando con FileZilla](cecil-folder.png){.thumbnail}

Ahora puede editar los archivos de su I.D.E.:

![Ver en Visual Studio Code](static_website_installation_cecil12.png){.thumbnail}
...
[Añadir contenido dinámico a una página web estática generada con Cecil](static_website_installation_cecil_api_call1.)
...
Nuestra [guía sobre el uso de FileZilla](ftp_filezilla_user_guide1.)
