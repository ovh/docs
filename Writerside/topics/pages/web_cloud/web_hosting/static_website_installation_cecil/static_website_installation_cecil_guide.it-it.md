...
- Disporre di una [offerta di hosting Web OVHcloud](hosting.) con accesso SSH Questo accesso permette di installare online una o più soluzioni alternative a quelle proposte di default nelle nostre soluzioni di hosting Web.
- Aver familiarità con l'inserimento da riga di comando
- Essere in grado di trasferire file in FTP con un cliente come [FileZilla](ftp_filezilla_user_guide1.)
- Impostare la tua zona DNS per far puntare il tuo dominio (o sottodominio) verso il tuo hosting Web condiviso. Questa operazione è utile se vuoi ospitare più siti in [multisiti](multisites_configure_multisite1.) sul tuo hosting web condiviso.
...
I [hosting web condivisi](hosting.) permettono di dichiarare domini o sottodomini in multisiti. Per implementare il tuo sito Web con **Cecil** è necessario un dominio o un sottodominio.

Per aiutarti a dichiarare un dominio o un sottodominio su un multisito sul tuo hosting, consulta la nostra pagina "[Condivisione dell'hosting tra più siti](multisites_configure_multisite1.)".
...
![Installazione Cecil](static_website_installation_cecil01.png){.thumbnail}
...
![Installazione Cecil](static_website_installation_cecil02.png){.thumbnail}

Puoi visualizzare il risultato accedendo al tuo dominio:

![Installazione Cecil](static_website_installation_cecil03.png){.thumbnail}
...
Se il tuo dominio o sottodominio è ospitato in OVHcloud, consulta le nostre guide relative alla [configurazione DNS](dns_zone_edit1.) e all'installazione di un [multisito sul tuo hosting web](multisites_configure_multisite1.).
...
![File di configurazione YAML](static_website_installation_cecil04.png){.thumbnail}
...
![Installazione Cecil](static_website_installation_cecil05.png){.thumbnail}
...
![Installazione Cecil](static_website_installation_cecil06.png){.thumbnail}

Lo si può visualizzare sul server digitando l'URL del sito, seguito da `/mypage/`:

![Risultato browser](static_website_installation_cecil07.png){.thumbnail}

### Personalizza i file del tuo sito

#### Modifica sul server

Per modificare i file _Markdown_ è possibile accedere direttamente al server di hosting Web. Sulla tua offerta di [hosting Performance](hosting-performance-offer.), il tuo accesso SSH permette di utilizzare indifferentemente [GNU nano](https://nano-editor.org/){.external}, [vi](https://ex-vi.sourceforge.net/){.external} o [vim](https://www.vim.org/){.external}.
...
![Modifica del file in GNU nano](static_website_installation_cecil08.png){.thumbnail}

Aggiungi alcune linee rispettando la sintassi _Markdown_:

![Aggiunta di contenuto nel file](static_website_installation_cecil09.png){.thumbnail}
...
![Pagina aggiornata](static_website_installation_cecil10.png){.thumbnail}
...
![Scarica con FileZilla](cecil-folder.png){.thumbnail}

Ora puoi modificare i file nel tuo I.D.E.:

![Visualizzazione in Visual Studio Code](static_website_installation_cecil12.png){.thumbnail}
...
[Aggiungere contenuto dinamico in una pagina Web statica generata con Cecil](static_website_installation_cecil_api_call1.)
...
[Consulta la guida sull'utilizzo di FileZilla](ftp_filezilla_user_guide1.)
