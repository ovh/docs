...
- Disponer de un [plan de hosting de OVHcloud](hosting.) con una base de datos en alojamiento compartido de OVHcloud asociada.
...
> 
> Ponemos a su disposición este tutorial para ayudarle lo mejor posible en tareas habituales. No obstante, si tiene alguna duda, le recomendamos que contacte con un [proveedor especializado](partner.). Nosotros no podremos asistirle. Más información en la sección ["Más información"](sql_overquota_database_#go-further.) de esta guía.
>

Cuando su base de datos en alojamiento compartido OVHcloud se satura (**overquota**), nuestros robots le advierten por correo electrónico en la dirección de correo electrónico del [contacto "Administrador"](managing_contacts1.) de la base de datos. 
...
Recupere la información de acceso a su base de datos directamente en el archivo de configuración de su sitio web. Realice esta acción utilizando el **paso 1** de nuestra guía sobre [el cambio de la contraseña de una base de datos](sql_change_password1.).

Conéctese a su [área de cliente de OVHcloud](manager.) y seleccione `Web Cloud`{.action} en la barra de navegación superior. Haga clic en `Alojamientos`{.action} y seleccione el alojamiento web asociado a su base de datos compartida de OVHcloud. A continuación, abra la pestaña `Bases de datos`{.action}.
...
>
> Asegúrese de realizar las operaciones que desee. Si necesita ayuda, le recomendamos que contacte con un [proveedor especializado](partner.). OVHcloud no podrá ayudarle con el contenido de su base de datos.
>
...
![phpMyAdmin Tablas](pma-check-size.png){.thumbnail}
...
Consulte nuestra oferta de bases de datos [Web Cloud Databasess](databases.) para elegir su nuevo servicio de bases de datos. 

Es recomendable para bases de datos de gran tamaño.

Es posible duplicar el contenido de una base de datos de OVHcloud directamente en otra de sus bases de datos de OVHcloud gracias a la funcionalidad que ofrece su [área de cliente de OVHcloud](manager.). Para ello, consulte nuestra guía "[Duplicar el contenido de una base de datos en otra](copy_database1.)".

En caso de migrar a una base de datos externa a los planes de hosting [Start SQL](hosting-options-startsql.) y [Web Cloud Databases](databases.), puede mover manualmente el contenido de su antigua base de datos hacia una nueva mediante nuestras guías:

- [Exportar la base de datos existente](sql_database_export1.)
- [Primeros pasos con Web Cloud Databasess](starting_with_clouddb1.)
- [Importar su antigua base de datos a su solución Web Cloud Databasess](restore-import-on-database-server1.)
...
> [!alert]
>
> Esta guía explica cómo eliminar datos de la base de datos. En caso de duda, asegúrese de lo que está haciendo o contacte con un [proveedor especializado](partner.).
>
...
[Duplicar el contenido de una base de datos en otra](copy_database1.)
