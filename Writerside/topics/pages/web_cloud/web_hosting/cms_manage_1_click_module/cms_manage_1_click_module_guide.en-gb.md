...
- An [OVHcloud Web Hosting plan](hosting.) that allows you to install a 1-click module (only the free [100M free hosting](activate_start10m1.) does not provide this feature)
...
To access the admin section of your 1-click module, go to your [OVHcloud Control Panel](manager.), click on `Web Cloud`{.action}, `Hosting plans`{.action}, on the relevant hosting plan then on the `1-click modules`{.action} tab.
