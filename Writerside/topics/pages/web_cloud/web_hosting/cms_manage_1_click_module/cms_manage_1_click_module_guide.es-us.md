...
>
> Esta guía le ayudará a realizar las operaciones más habituales. No obstante, si tiene alguna duda le recomendamos que contacte con un proveedor de servicios especializado o con el editor del servicio. Nosotros no podremos asistirle al respecto. Para más información, consulte el apartado [Más información](cms_manage_1_click_module_#go-further.) de esta guía.
>

## Requisitos

- Tener contratado un plan de [hosting Cloud](hosting.) que permita instalar un módulo en 1 clic (solo la oferta gratuita [Start10M](activate_start10m1.) no está incluida).
- Haber creado un módulo en 1 clic en su alojamiento (si todavía no ha realizado la instalación, siga las indicaciones de esta [guía](cms_install_1_click_modules1.)).
...
Para acceder a la parte pública de su sitio web tras la instalación de un módulo en 1 clic, acceda al [área de cliente de OVHcloud](manager.), haga clic en `Web Cloud`{.action}, `Alojamientos`{.action}, el alojamiento correspondiente y, seguidamente, en la pestaña `Módulos en 1 clic`{.action}.
...
> [!primary]
>
> Si su sitio web no aparece correctamente debido a esta operación, consulte las guías de OVHcloud relativas a los alojamientos compartidos en la sección [Diagnóstico](web-cloud-hosting1.).
>

### Acceder al panel de administración

Para acceder a la parte del sitio web reservada a los administradores, acceda al [área de cliente de OVHcloud](manager.), haga clic en `Web Cloud`{.action}, `Alojamientos`{.action}, el alojamiento correspondiente y, seguidamente, en la pestaña `Módulos en 1 clic`{.action}.
...
También puede consultar el mensaje de correo electrónico recibido al crear el módulo desde su [área de cliente de OVHcloud](manager.): haga clic en su nombre en la esquina superior derecha de la pantalla y, en el menú que aparece, haga clic en `Emails de servicio`{.action}.

### Cambiar la contraseña del módulo <a name="password-change"></a>

Puede cambiar la contraseña de su módulo desde el [área de cliente de OVHcloud](manager.) o directamente desde la página de conexión al área de administrador de su sitio web.
...
>
> También puede consultar todos los mensajes enviados por nuestros servicios desde el [área de cliente de OVHcloud](manager.): haga clic en su nombre en la esquina superior derecha de su pantalla y, en el menú contextual situado a la derecha de la pantalla, haga clic en `Emails de servicio`{.action}.
>
...
Para cambiar la contraseña de acceso al panel de administración de su sitio web **desde el área de cliente de OVHcloud**, acceda al [área de cliente de OVHcloud](manager.), haga clic en `Web Cloud`{.action}, `Alojamientos`{.action}, el alojamiento correspondiente y abra la pestaña `Módulos en 1 clic`{.action}.
...
No obstante, si necesita ayuda, le recomendamos encarecidamente que utilice la documentación que le ofrezca el editor del CMS o que contacte con un [proveedor especializado](partner.). Nosotros no podremos asistirle. Más información en la sección (#go-further) de esta guía.

### Eliminar el módulo

> [!warning]
>
> La copia de seguridad de sus datos es una de las operaciones básicas para [proteger sus sitios web](secure_your_website1.). Le recomendamos que, siguiendo las instrucciones de esta **guía**, importe regularmente y [antes de eliminar](exporter-son-site-web1.) la copia de seguridad de sus datos en un soporte local, como un USB o un disco duro externo.
>

#### Etapa 1: identificar la base de datos asociada a su módulo <a name="step1"></a>

Para eliminar el módulo en 1 clic, es necesario empezar identificando su base de datos de forma **segura**. Para ello, acceda al [área de cliente de OVHcloud](manager.). Haga clic en `Web Cloud`{.action}, `Alojamientos`{.action} y seleccione el alojamiento correspondiente. A continuación, abra la pestaña `Bases de datos`{.action}.
...
Conéctese al [espacio FTP del alojamiento](ftp_connection1.). Abra la `Carpeta raíz` encontrada anteriormente en la pestaña `Multisitio`{.action} y busque el archivo de configuración de su módulo:
...
Para hacer copias de seguridad de su sitio web, siga las instrucciones de esta [guía](exporter-son-site-web1.) y recupere los archivos en el espacio FTP de su alojamiento y su base de datos.
...
Para eliminar el módulo en 1 clic, acceda al [área de cliente de OVHcloud](manager.), haga clic en `Web Cloud`{.action}, `Alojamientos`{.action}, el alojamiento correspondiente y seleccione `Módulos en 1 clic`{.action}.
...
> [!warning]
>
> Si elimina el módulo 1 clic **no se eliminará automáticamente la base de datos**. Si inicia la instalación de un nuevo CMS sin haber eliminado previamente la base de datos del anterior (y su alojamiento no permite la creación automática de una nueva base de datos), el mensaje "[Se ha producido un error al cargar la información. (You need at least one free database)](diagnostic_errors_module1clic#se-ha-producido-un-error-al-cargar-la-informacion-you-need-at-least-one-free-database.)" se mostrará en su área de cliente.
>
> Si tiene contratado [Hosting Personal](hosting-personal-offer.), o si ya ha creado cuatro bases de datos en su alojamiento [Hosting Pro](hosting-professional-offer.) o [Hosting Performance](hosting-performance-offer.), deberá eliminar la base de datos indicada en el [paso 1](cms_manage_1_click_module_#step1.) **ANTES** de poder crear un nuevo módulo en 1 clic.
>

Para terminar de eliminar el módulo, acceda a la pestaña `Bases de datos`{.action}, en la sección `Web cloud`{.action}, `Alojamientos`{.action}" y en el alojamiento correspondiente de su [área de cliente de OVHcloud](manager.) y haga clic en `...`{.action} a la derecha de la línea que designa la base de datos y haga clic en el botón `Eliminar la base de datos`{.action}.
...
Proteja su sitio web siguiendo las instrucciones de esta [guía](secure_your_website1.).
