...
> 
> Diese Anleitung soll Sie bei allgemeinen Aufgaben bestmöglich unterstützen. Dennoch empfehlen wir Ihnen, falls Sie Hilfe brauchen, einen [spezialisierten Dienstleister](partner.) zu kontaktieren und/oder Ihre Fragen in der OVHcloud Community zu stellen. Leider können wir Ihnen für administrative Aufgaben keine weitergehende technische Unterstützung anbieten. Weitere Informationen finden Sie am [Ende dieser Anleitung](cms_manage_1_click_module_#go-further.).
>

## Voraussetzungen

- Sie verfügen über ein [OVHcloud Webhosting](hosting.), auf dem Sie 1-Klick-Module installieren können (ausgenommen  [Kostenloses Hosting 100M](activate_start10m1.)).
- Sie haben ein 1-Klick-Modul auf Ihrem Hosting erstellt (Wenn Sie diese Installation noch nicht durchgeführt haben, folgen Sie den Anweisungen in dieser [Anleitung](cms_install_1_click_modules1.)).
...
Um nach der Installation eines 1-Klick-Moduls auf den öffentlichen Teil Ihrer Website zuzugreifen, gehen Sie in Ihrem [OVHcloud Kundencenter](manager.) auf `Web Cloud`{.action}, `Hosting-Pakete`{.action}, das betreffende Hosting und dann auf den Tab `1-Klick-Module`{.action}.

Klicken Sie dann auf den Button `...`{.action} rechts in der Zeile für Ihr Modul und dann auf `Zugang zum Modul`{.action}.

> [!primary]
>
> Sollte Ihre Website nach diesem Vorgang nicht korrekt angezeigt werden, lesen Sie die zu den Webhosting-Paketen gehörigen OVHcloud Anleitungen unter [Diagnose](web-cloud-hosting1.).
>

### Administrator-Interface

Um auf den Administratorbereich Ihrer Website zuzugreifen, gehen Sie im [OVHcloud Kundencenter](manager.) zu `Web Cloud`{.action}. Klicken Sie auf `Hosting-Pakete`{.action} und auf das betreffende Hosting und dann auf den Tab `1-Klick-Module`{.action}.
...
Klicken Sie im Bereich `Hosting-Pakete`{.action} in Ihrem [OVHcloud Kundencenter](manager.) auf den Tab `1-Klick-Module`{.action}. Die Administrator-ID Ihres Moduls wird in der Spalte `Login` angezeigt.

Sie können auch die bei der Erstellung Ihres Moduls erhaltene E-Mail über Ihr [OVHcloud Kundencenter](manager.) abrufen: Klicken Sie oben rechts auf Ihren Namen und dann im Kontextmenü auf `E-Mails vom Support`{.action}.

### Passwort Ihres Moduls ändern <a name="password-change"></a>

Sie können das Passwort Ihres Moduls über Ihr [OVHcloud Kundencenter](manager.) ändern oder direkt auf die Login-Seite Ihrer Website zum Administrator-Bereich gehen.
...
>
> Sie finden auch alle von unseren Diensten versendeten E-Mails über Ihr [OVHcloud Kundencenter](manager.): Klicken Sie oben rechts auf Ihren Namen und dann im Kontextmenü auf `E-Mails vom Support`{.action}.
>
> **Laufzeit der Links:**
>
...
Um das Passwort für den Zugang zum Verwaltungsinterface Ihrer Website zu ändern, gehen Sie im [OVHcloud Kundencenter](manager.) zu `Web Cloud`{.action}. Klicken Sie auf `Hosting-Pakete`{.action} und auf das betreffende Hosting und dann auf den Tab `1-Klick-Module`{.action}.
...
> Wir empfehlen Ihnen jedoch dringend, die Operation mithilfe der vom Herausgeber Ihres CMS zur Verfügung gestellten Dokumentation durchzuführen oder bei Problemen einen [spezialisierten Dienstleister](partner.) zu kontaktieren. Wir werden Ihnen leider keine Unterstützung anbieten können. Weitere Informationen finden Sie im Abschnitt [Weiterführende Informationen](cms_manage_1_click_module_#go-further.) dieser Anleitung.
>
...
> [!warning]
>
> Daten-Backups sind ein Bestandteil der Operationen, die für die [Absicherung Ihrer Webseiten](secure_your_website1.) notwendig sind. Wir empfehlen Ihnen, Backups Ihrer Daten regelmäßig auf einen lokalen Datenträger wie einen USB-Stick oder eine externe Festplatte zu [importieren](exporter-son-site-web1.).
>

#### Schritt 1: Die zu Ihrem Modul gehörige Datenbank identifizieren <a name="step1"></a>

Um Ihr 1-Klick-Modul zu löschen, müssen Sie zuerst sein Datenbank mit Sicherheit **identifizieren**. Gehen Sie dazu im [OVHcloud Kundencenter](manager.) zu `Web Cloud`{.action}. Klicken Sie auf `Hosting-Pakete`{.action} und auf das betreffende Hosting und dann auf den Tab `Datenbanken`{.action}.
...
Loggen Sie sich anschließend in den [FTP-Bereich](ftp_connection1.) Ihres Hostings ein. Öffnen Sie das entsprechende `Wurzelverzeichnis` aus dem Tab `Multisite`{.action} und suchen Sie die Konfigurationsdatei Ihres Moduls:
...
Folgen Sie den Anweisungen in [dieser Anleitung](exporter-son-site-web1.), um Dateien vom FTP-Bereich Ihres Hostings als auch Datenbanken zu exportieren und zu sichern.
...
Um Ihr 1-Klick-Modul zu löschen, gehen Sie in Ihr [OVHcloud Kundencenter](manager.), klicken Sie auf `Web Cloud`{.action}, `Hosting-Pakete`{.action}, das betreffende Hosting und dann auf `1-Klick-Module`{.action}.
...
> [!warning]
>
> Die Löschung Ihres 1-Klick-Moduls **beinhaltet nicht die Löschung der Datenbank**. Wenn Sie die Installation eines neuen CMS starten, ohne zuvor die bestehende Datenbank gelöscht zu haben (und Ihr Hosting erlaubt nicht die automatische Erstellung einer neuen Datenbank), erscheint die Nachricht “[Beim Laden der Informationen ist ein Fehler aufgetreten (You need at least one free database)](diagnostic_errors_module1clic#beim-laden-der-informationen-ist-ein-fehler-aufgetreten-sie-benotigen-mindestens-eine-freie-datenbank.)“ in Ihrem Kundencenter.
>
> Wenn Sie über ein [Basic Hosting](hosting-personal-offer.) verfügen oder bereits vier Datenbanken auf Ihrem [Pro Hosting](hosting-professional-offer.) oder [Performance Hosting](hosting-performance-offer.) erstellt haben, müssen Sie **ZUERST** die im [ersten Schritt](cms_manage_1_click_module_#step1.) identifizierte Datenbank löschen, um ein neues 1-Klick-Modul erstellen zu können.
>

Um die Löschung Ihres Moduls abzuschließen, gehen Sie in im [OVHcloud Kundencenter](manager.) zu `Web Cloud`{.action}. Klicken Sie auf `Hosting-Pakete`{.action} und auf das betreffende Hosting und dann auf den Tab `Datenbanken`{.action}. Klicken Sie auf `...`{.action} rechts neben der Datenbank und wählen Sie `Die Datenbank löschen`{.action} aus.
...
Sichern Sie Ihre Seite entsprechend den Anweisungen in [dieser Anleitung](secure_your_website1.).
...
Wenn Sie Hilfe bei der Nutzung und Konfiguration Ihrer OVHcloud Lösungen benötigen, können Sie unsere verschiedenen [Support-Angebote](support.) einsehen.
