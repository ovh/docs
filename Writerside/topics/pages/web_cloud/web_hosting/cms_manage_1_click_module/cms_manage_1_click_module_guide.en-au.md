...
To access the public section of your website after installing a 1-click module, go to your [OVHcloud Control Panel](manager.), click on `Web Cloud`{.action}, `Hosting plans`{.action}, on the relevant hosting plan then click on the `1-click modules`{.action} tab.

Next, click on the `...`{.action} button to the right of the line related to your 1-click module, then on `Access module`{.action}.

> [!primary]
>
> If your website does not display properly, please refer to the OVHcloud web hosting guides of the [Troubleshooting](web-cloud-hosting1.) section.
>
...
Click on the `1-click modules`{.action} tab in the `Hosting plans`{.action} section of your [OVHcloud Control Panel](manager.). Your module’s admin ID will appear in the `Login` column.
...
To back up your website, follow the instructions of this [guide](exporter-son-site-web1.) to retrieve its files from the FTP space of your hosting plan and its database.
...
>
> If you have a [Personal Hosting](hosting-personal-offer.) offer or if you already created all four databases of your [Pro](hosting-professional-offer.) or [Performance Hosting](hosting-performance-offer.), you will need to delete the database identified in [step 1](cms_manage_1_click_module_#step1.) **BEFORE** creating a new 1-click module.
>

To complete the removal of your module, in the `Web Cloud`{.action}, `Hosting plans`{.action} sections, within the relevant hosting plan of your [OVHcloud Control Panel](manager.), go to the `Databases`{.action} tab, then click on the `...`{.action} button on the right of the line concerning your database and on `Delete database`{.action}.
