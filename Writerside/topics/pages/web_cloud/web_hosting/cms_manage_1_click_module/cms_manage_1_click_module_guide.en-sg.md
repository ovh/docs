...
>
> This guide is designed to assist you in common tasks as much as possible. Nevertheless, we recommend that you contact a [specialist service provider](partner.) and/or discuss the issue with our community on if you face difficulties or doubts. You can find more information in the [Go further](cms_manage_1_click_module_#go-further.) section of this guide.
>

## Requirements

- An [OVHcloud Web Hosting plan](hosting.) that allows you to install a 1-click module
- A 1-click module on your web hosting plan (If you did not install one yet, follow the instructions in this [guide](cms_install_1_click_modules1.))
...
To access the public section of your website after installing a 1-click module, go to the [OVHcloud Control Panel](manager.), click on `Web Cloud`{.action}, `Hosting plans`{.action}, on the relevant hosting plan then click on the `1-click modules`{.action} tab.

Next, click on the `...`{.action} button to the right of the line related to your 1-click module, then `Access module`{.action}.

> [!primary]
>
> If your website does not display properly after this, please refer to the OVHcloud web hosting guides in the [Troubleshooting](web-cloud-hosting1.) section.
>

### Access the administrator interface

To access the admin section of your 1-click module, go to your [OVHcloud Control Panel](manager.), click on `Web Cloud`{.action}, `Hosting plans`{.action}, on the relevant hosting plan then click on the `1-click modules`{.action} tab.
...
You can also search for the email received after the creation of your module from your [OVHcloud Control Panel](manager.): click on your name in the top right-hand corner of the screen then, in the context menu, click on `Service emails`{.action}.

### Change your module password <a name="password-change"></a>

You can change the administrator password of your module via the [OVHcloud Control Panel](manager.) or by going directly to the login page of your website’s admin interface.
...
>
> You can also view all emails sent by our services from your [OVHcloud Control Panel](manager.): click on your name in the top right-hand corner of the screen then, in the context menu, click on `Service emails`{.action}.
>
...
However, we strongly recommend using the documentation provided by your CMS publisher, or contacting a [specialist provider](partner.) if you encounter any difficulties. We will not be able to assist you. You can find more information in the [Go further](cms_manage_1_click_module_#go-further.) section of this guide.

### Delete your module

> [!warning]
>
> Backing up your data is an essential part of the [securing of your websites](secure_your_website1.). We recommend you to download regularly your data backup on a local device, such as an USB drive or external hard drive, following the instructions in this [guide](exporter-son-site-web1.).
>

#### Step 1: Identify the database linked to your module <a name="step1"></a>

To delete your 1-click module, you must first identify its database with **certainty**. Go to your [OVHcloud Control Panel](manager.) and click on `Web Cloud`{.action}, `Hosting plans`{.action}, on the concerned hosting plan then on the `Databases`{.action} tab.
...
Then log on to the [FTP space](ftp_connection1.) of your hosting plan. Open the `Root folder` found earlier in the `Multisite`{.action} tab and browse to the configuration file for your module:
...
To back up your website, follow the instructions of this [guide](exporter-son-site-web1.) to retrieve its files from both the FTP space on your hosting plan and its database.
...
To delete your 1-click module, go to your [OVHcloud Control Panel](manager.), click on `Web Cloud`{.action}, `Hosting plans`{.action}, on the concerned hosting plan then on `1-click modules`{.action}.

Then click on the `...`{.action} button to the right of the line related to your module then click on `Delete the module`{.action}.

> [!warning]
>
> Deleting your 1-click module **will not automatically delete its database**. If you launch the installation of a new CMS without having previously deleted the database from the previous one and if your hosting plan does not allow the automatic creation of another database, the message "[An error has occurred loading the information (You need at least one free database)](diagnostic_errors_module1clic#an-error-has-occurred-loading-the-information-you-need-at-least-one-free-database.)" will appear in your Control Panel.
>
> If you have a [Personal Hosting](hosting-personal-offer.) subscription or if you have already created all four databases of your [Pro Hosting](hosting-professional-offer.) or [Performance Hosting](hosting-performance-offer.), you will need to delete the database identified in [step 1](cms_manage_1_click_module_#step1.) **BEFORE** creating a new 1-click module.
>

To complete the removal of your module, in the `Web Cloud`{.action}, `Hosting plans`{.action} sections, within the relevant hosting plan of your [OVHcloud Control Panel](manager.), go to the `Databases`{.action} tab. Next, click on the `...`{.action} button to the right of the line concerning your database and on the `Delete database`{.action} button.
...
Secure your website by following the instructions in this [guide](secure_your_website1.).
