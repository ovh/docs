...
- Der Domainname (und gegebenenfalls die Subdomain) den Sie für Ihre Website verwenden möchten, ist auf Ihrem OVHcloud Webhosting als [Multisite](multisites_configure_multisite1.) deklariert.

## In der praktischen Anwendung

> [!primary]
>
> Falls Sie auf Schwierigkeiten beim Ausführen der unten beschriebenen Schritte stoßen, finden Sie Lösungen in unserer [Dokumentation zu den häufigsten Fehlermeldungen bei 1-Klick-Modulen](diagnostic_errors_module1clic1.).
>
...
Wählen Sie aus den oben aufgeführten 4 CMS aus und folgen dann den Schritten in dieser Anleitung. Sie können unsere [Übersichtsseite für CMS](hosting-cms-comparison.) verwenden, um Ihre Auswahl zu erleichtern.

Wenn Sie ein CMS installieren möchten, das nicht als OVHcloud 1-Klick-Modul angeboten wird, können Sie es manuell auf Ihrem Hosting installieren, sofern dieses CMS mit Ihrem [OVHcloud Webhosting](hosting.) kompatibel ist.

![CMS-Logos](cms-logos.png){.thumbnail}

### Schritt 2: Zugang zur Verwaltung der 1-Klick-Module

Loggen Sie sich in Ihr [OVHcloud Kundencenter](manager.) ein und klicken Sie im Bereich `Web Cloud`{.action} auf `Hosting-Pakete`{.action}. Wählen Sie das betreffende Hosting aus und klicken Sie dann auf den Tab `1-Klick-Module`{.action}.

Hier können Sie die bereits installierten 1-Klick-Module verwalten und neue Module installieren.

![Zugang zur Verwaltung der 1-Klick-Module](cms_install_1_click_modules_images_tab.png){.thumbnail}
...
![Modulauswahl](add-a-module-select-module-and-domain.png){.thumbnail}

Wenn der Domainname nicht in der Liste steht, gehen Sie in zum Tab `Multisite`{.action}, um ihn hinzuzufügen. Wenn nötig lesen Sie unsere Anleitung "[Mehrere Websites auf einem Webhosting einrichten](multisites_configure_multisite1.)".
...
>
> Wenn nötig, lesen Sie unsere Anleitung „[Mehrere Websites auf einem Webhosting einrichten](multisites_configure_multisite1.)“, um das Zielverzeichnis des Domainnamnes zu ändern.
>
...
![Einfache Installation eines Moduls](add-a-module-quick-mod-step-1-b.png){.thumbnail}
...
> [!primary]
>
> Die Installation kann bis zu 15 Minuten dauern, nachdem Sie in Ihrem [OVHcloud Kundencenter](manager.) auf `Installieren`{.action} geklickt haben.
>
...
![Erweiterte Installation eines Moduls](add-a-module-advanced-mod-step-1.png){.thumbnail}
...
> 
> Um die Login-Daten zu Ihrer Webhosting-Datenbank zu ermitteln, lesen Sie [diese Anleitung](sql_create_database1.).
>
> Um die Login-Daten zu einer mit Web Cloud Databases erstellten Datenbank herauszufinden, lesen Sie [diese Anleitung](starting_with_clouddb1.).
>

![Datenbank für erweiterte Installation](add-a-module-advanced-mod-step-3.png){.thumbnail}
...
- Die Datenbank ist noch nicht auf Ihrem Webhosting erstellt: [Erstellen Sie Ihre Datenbank auf dem Hosting](sql_create_database1.), w0,ählen Sie Ihre Datenbank unter `Wählen Sie die Datenbank aus`{.action} und geben Sie die erforderlichen Informationen ein.
- Die Datenbank befindet sich auf einer [Instanz von Web Cloud Databases](create-db-and-user-on-db-server1.): Wählen Sie unter `Wählen Sie die Datenbank aus`{.action} die Option `Datenbank außerhalb Ihres Webhostings`{.action} und tragen Sie die Verbindungsdaten Ihrer Datenbank ein. Die Instanz und das Webhosting müssen im gleichen Rechenzentrum gehostet werden.
...
- *Name der Datenbank*: Dieser Name wurde bei der Erstellung der Datenbank im [OVHcloud Kundencenter](manager.) festgelegt.

- *Port*: Geben Sie die Nummer **3306** (Standard-Port) für eine Webhosting-Datenbank ein. Für Datenbanken auf einer Web Cloud Databases Instanz folgen Sie [dieser Anleitung](starting_with_clouddb1.).

- *Benutzername*: Er ist identisch für Datenbanken, die in einem Webhosting inklusive sind. Für Datenbanken, die mit Web Cloud Databases erstellt wurden, folgen Sie [dieser Anleitung](starting_with_clouddb1.).
...
- *Domain:* Domainname, mit dem Sie Ihr CMS installieren möchten. Lesen Sie unsere Anleitung "[Mehrere Websites auf einem Webhosting einrichten](multisites_configure_multisite1.)" um mehr zu erfahren.
...
>
> Wenn nötig, lesen Sie unsere Anleitung „[Mehrere Websites auf einem Webhosting einrichten](multisites_configure_multisite1.)“, um das Zielverzeichnis Ihres Domainnamens zu ändern.
>
...
![Modulkonfiguration für die erweiterte Installation](add-a-module-advanced-mod-step-2.png){.thumbnail}
...
![Bestätigung der Installation im Experten-Modus](add-a-module-advanced-mod-step-4.png){.thumbnail}
...
[Finden Sie das richtige CMS für Ihre Website](hosting-cms-comparison.){.external}.

[Mehrere Websites auf einem Webhosting einrichten](multisites_configure_multisite1.).

[Verwaltung einer Datenbank in Ihrem Webhosting](sql_create_database1.).

Entdecken Sie unsere [Web Cloud Databases](https://www.ovh.de/cloud/cloud-databases/){.external}.

[CMS verwalten](cms_manage_1_click_module1.).

[Ihr CMS deinstallieren](cms_manage_1_click_module#schritt-3-ihr-modul-loschen.).

Wenn Sie die volle Kontrolle über die Installation Ihres CMS behalten möchten, können Sie [ein CMS manuell auf Ihrem OVHcloud Webhosting installieren](cms_manual_installation1.).
