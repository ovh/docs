...
- Posiadanie hostingu [Cloud Web](hosting-cloud-web-offer.)
- Dostęp do [panelu klienta OVHcloud](manager.), sekcja `Web Cloud`{.action}
...
Aby uzyskać dostęp do frameworków Twojego hostingu Cloud Web, zaloguj się do [panelu klienta OVHcloud](manager.){.external}. Po zalogowaniu kliknij `Hosting`{.action} na pasku usług po lewej stronie, następnie wybierz odpowiedni hosting Cloud Web. Teraz przejdź do karty `Frameworki`{.action}.
...
![cloud web hosting ssd](images_tab-phpfpm7-4.png){.thumbnail}

### Etap 2: zarządzanie frameworkami

Istnieje kilka sposobów zarządzania frameworkami hostingu Cloud Web:

- dodanie lub zmiana frameworku (maksymalna liczba frameworków zależy od [wybranej oferty](hosting-cloud-web-offer.){.external});
...
![cloud web hosting ssd](manage-runtime_images_modify-a-runtime-software-application-nodejs8.png){.thumbnail}
...
![cloud web hosting ssd](images_modify-a-runtime-software-application-ruby2-6.png){.thumbnail}
...
![cloud web hosting ssd](images_modify-a-runtime-software-application-python3.png){.thumbnail}
...
> 
> Równoległe wykorzystanie dwóch frameworków w Twoim hostingu Cloud Web zależy od [wybranej oferty](hosting-cloud-web-offer.){.external}.
> 
...
![cloud web hosting ssd](runtime-software-applications.png){.thumbnail}
...
![cloud web hosting ssd](modify-a-domain-step-1.png){.thumbnail}
