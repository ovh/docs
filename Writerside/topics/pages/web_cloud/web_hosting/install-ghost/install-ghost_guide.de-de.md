...
Mit [OVHcloud Cloud Web Hosting](hosting-cloud-web-offer.){.external} können Sie Node.js als Runtime Engine für Ihre Websites verwenden und somit auch Ghost oder jede andere für Node.js entwickelte Anwendung installieren.
...
- ein [OVHcloud Cloud Web Hosting](hosting-cloud-web-offer.){.external}.
...
- Sie sind in Ihrem [OVHcloud Kundencenter](manager.){.external} eingeloggt und befinden sich im Bereich `Web Cloud`{.action}.
...
Um auf die Runtime Engines Ihres Cloud Web Hostings zuzugreifen, loggen Sie sich zunächst in Ihrem [OVHcloud Kundencenter](manager.){.external} ein. Klicken Sie links im Menü auf `Hosting-Pakete`{.action} und wählen Sie das betreffende Cloud Hosting aus. Gehen Sie dann auf den Tab `Runtime Engines`{.action}.
...
![ghost cloud web](images_tab-nodejs8.png){.thumbnail}
...
Nachdem Sie diese Informationen eingegeben haben, klicken Sie auf `Bestätigen`{.action}. Für weitere Informationen zur Verwaltung der Runtime Engines lesen Sie unsere Anleitung „[Cloud Web Runtime Engines verwalten](manage-runtime1.){.external}“.

![ghost cloud web](images_modify-a-runtime-software-application-nodejs8.png){.thumbnail}
...
![ghost cloud web](images_tab-nodejs8-full-disabled.png){.thumbnail}
...
![ghost cloud web](install-ghost_images_tab.png){.thumbnail}
...
![ghost cloud web](create-a-database-step-2.png){.thumbnail}
...
![ghost cloud web](add-an-environment-variable.png){.thumbnail}
...
![ghost cloud web](install-ghost_images_change-password.png){.thumbnail}
...
Um den Node.js-*Daemon* neu zu starten, gehen Sie zunächst in Ihr [Kundencenter](manager.){.external}. Gehen Sie zum Tab `Multisite`{.action} , klicken Sie rechts neben der betreffenden Domain auf den Button `...`{.action} rechts, dann auf `Neu starten`{.action}.
...
[Migration Ihrer Website und E-Mails zu OVHcloud](hosting_migrating_to_ovh1.){.external}

[Meine Seite online stellen](hosting_how_to_get_my_website_online1.){.external}

[Installation Ihrer Website mit 1-Klick-Modulen](cms_install_1_click_modules1.){.external}

[Mehrere Websites auf einem Webhosting einrichten](multisites_configure_multisite1.){.external}
