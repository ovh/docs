...
O [alojamento Cloud Web da OVHcloud](hosting-cloud-web-offer.){.external} permite utilizar Node.js como motor de execução para os seus websites e, assim, instalar e alojar o Ghost ou qualquer outra aplicação concebida para Node.js.
...
- Ter um serviço de [alojamento Cloud Web da OVHcloud](hosting-cloud-web-offer.){.external}.
...
- Ter acesso à [Área de Cliente OVHcloud](manager.){.external}, na secção `Web Cloud`{.action}.
...
Para aceder aos motores de execução do seu alojamento Cloud Web, aceda à [Área de Cliente](manager.){.external}. Clique em `Alojamentos`{.action} na barra à esquerda e, em seguida, selecione o alojamento Cloud Web correspondente. Por fim, clique no separador `Motores de execução`{.action}.
...
![ghostcloudweb](images_tab-nodejs8.png){.thumbnail}
...
Concluída esta etapa, clique no botão `Validar`{.action}. Para mais informações sobre os motores de execução, consulte o nosso manual [Gerir os motores de execução de um alojamento Cloud Web](manage-runtime1.){.external}.

![ghostcloudweb](images_modify-a-runtime-software-application-nodejs8.png){.thumbnail}
...
![ghostcloudweb](images_tab-nodejs8-full-disabled.png){.thumbnail}
...
No que diz respeito às opções adicionais, selecione as que pretende ativar. Uma vez as informações introduzidas, clique em `Seguinte`{.action} e finalize a operação. Esta operação pode demorar até uma hora. No entanto, a alteração da configuração DNS pode demorar até 24 horas antes de ficar totalmente efetiva. Se pretender obter mais informações sobre a gestão dos multisites, consulte o nosso manual “[Partilhar o alojamento entre vários sites](multisites_configure_multisite1.){.external}”.

![ghostcloudweb](add-a-domain-or-sub-domain-step-2-ghost.png){.thumbnail}
...
![ghostcloudweb](install-ghost_images_tab.png){.thumbnail}
...
![ghostcloudweb](create-a-database-step-2.png){.thumbnail}
...
![ghostcloudweb](add-an-environment-variable.png){.thumbnail}
...
![ghostcloudweb](install-ghost_images_change-password.png){.thumbnail}
...
Para reiniciar o *daemon* Node.js, aceda à sua [Área de Cliente OVHcloud](manager.){.external}. No separador `Multi-site`{.action}, clique no botão `...`{.action} no final da linha correspondente ao domínio.{.action} à direita, em `Reiniciar`{.action}.
...
[Transferir o meu site para a OVHcloud](hosting_migrating_to_ovh1.){.external} (Versão PT disponível em breve)

[Colocar o meu site online](hosting_how_to_get_my_website_online1.){.external}

[Instalar um CMS com os Módulos 1 clique](cms_install_1_click_modules1.){.external}

[Partilhar o alojamento entre vários sites](multisites_configure_multisite1.){.external}

[Como criar um endereço de e-mail](email_creation1.){.external}

[Utilização do RoundCube](email_roundcube1.){.external}
