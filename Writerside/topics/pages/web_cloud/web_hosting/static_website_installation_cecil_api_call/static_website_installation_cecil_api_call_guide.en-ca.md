...
> 
> If you experience any difficulties following the steps in this tutorial, we recommend contacting a [specialist provider](partner.) or reach out to the OVHcloud community. We will not be able to assist you. You can find more information in the [Go further](static_website_installation_cecil_api_call_#go-further.) section of this guide.
>
...
- You need to have installed and configured the **Cecil** application on your web hosting plan (see our tutorial on [installing and configuring Cecil](static_website_installation_cecil1.)).
...
Prepare your environment by logging in via SSH to your web hosting plan, and refer to the tutorial “[Installation and configuration of Cecil](static_website_installation_cecil1.)” to install your **Cecil** application in a dedicated directory.
