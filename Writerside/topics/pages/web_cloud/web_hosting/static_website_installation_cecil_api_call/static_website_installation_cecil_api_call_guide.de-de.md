...
> 
> Wenn Sie Schwierigkeiten haben, den Schritten dieses Tutorials zu folgen, empfehlen wir Ihnen, einen [spezialisierten Dienstleister](partner.) zu kontaktieren oder Ihre Fragen in der OVHcloud Community zu stellen. Leider können wir Ihnen für administrative Aufgaben keine weitergehende technische Unterstützung anbieten. Weitere Informationen finden Sie am [Ende dieser Anleitung](static_website_installation_cecil_api_call_#go-further.).
>

## Voraussetzungen

- Sie verfügen über ein [OVHcloud Webhosting](hosting.) mit SSH-Zugang. Über diesen Zugriff können Sie eine oder mehrere Alternativlösungen online installieren, ergänzend zu den Webhosting-Standarddiensten.
- Sie sind mit der Befehlszeileneingabe vertraut.
- Sie haben die Anwendung **Cecil** auf Ihrem Hosting installiert und konfiguriert (gemäß unseres Tutorials zur [Installation und Konfiguration von Cecil](static_website_installation_cecil1.)).
...
Loggen Sie sich zunächst via SSH auf Ihrem Webhosting ein. Folgen Sie der Anleitung "[Installation und Konfiguration von Cecil](static_website_installation_cecil1.)", um Ihre **Cecil** Anwendung in einem dedizierten Verzeichnis zu installieren.
...
![Cecil layouts directory including unkompriessed files](static_website_installation_cecil_api_call05.png){.thumbnail}
...
![Updated](static_website_installation_cecil_api_call08.png){.thumbnail}
