...
- Sie verfügen über einen [Domainnamen](domains.) in Ihrem OVHcloud Kundencenter.
- Sie haben ein [OVHcloud Webhosting](hosting.) in Ihrem Kunden-Account.
- Sie haben Zugriff auf Ihr [OVHcloud Kundencenter](manager.).

> [!warning]
>
> Wenn Sie die Option „E-Mail-Adresse(n) bei Ihrem Webhosting inklusive“ für einen externen (nicht bei OVHcloud registrierten) Domainnamen, **dessen Administrator Sie sind**, aktivieren möchten, müssen Sie (mindestens) eine DNS-Zone bei OVHcloud für Ihren externen Domainnamen erstellen. Lesen Sie bei Bedarf unsere Anleitung „[DNS-Zone bei OVHcloud erstellen](dns_zone_create1.)“. So wird Ihr Domainname bei Aktivierung der Option in der Liste der verfügbaren Domainnamen angezeigt.
>
> Ist Ihr Domainname bereits bei OVHcloud registriert oder existiert bereits eine DNS-Zone in einem anderen [OVHcloud Kunden-Account](manager.), lesen Sie unsere Dokumentation „[Verwaltung der Kontakte](managing_contacts1.)“, um die Verwaltung des Domainnamens sicherzustellen.
>
...
Melden Sie sich in Ihrem [OVHcloud Kundencenter](manager.){.external} an, klicken Sie im Bereich `Web Cloud`{.action} auf `Hosting-Pakete`{.action} und wählen Sie das Webhosting mit den E-Mail-Adressen aus.
...
![Aktivierung der E-Mail-Adressen](enable-email-included-webhosting.png){.thumbnail}
...
![Aktivierung der E-Mail-Adressen](order-activate-email-included-webhosting-step-1.png){.thumbnail}

> [!primary]
> Wenn Sie mehr inklusive E-Mail-Accounts nutzen möchten, können Sie ein leistungsfähigeres [Webhosting-Angebot](hosting.){.external} über unsere Webseite auswählen.
>
...
Melden Sie sich in Ihrem [OVHcloud Kundencenter](manager.){.external} an, klicken Sie im Bereich `Web Cloud`{.action} auf `Hosting-Pakete`{.action} und wählen Sie das Webhosting aus.
...
![Aktivierung der E-Mail-Adressen](detach-email-included-webhosting.png){.thumbnail}
...
Melden Sie sich in Ihrem [OVHcloud Kundencenter](manager.){.external} an, klicken Sie im Bereich `Web Cloud`{.action} auf `Hosting-Pakete`{.action} und wählen Sie das jeweilige Webhosting aus.
...
![Aktivierung der E-Mail-Adressen](cancel-email-included-webhosting.png){.thumbnail}
