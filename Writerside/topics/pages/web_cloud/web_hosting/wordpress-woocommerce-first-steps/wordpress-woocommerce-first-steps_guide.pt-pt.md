...
> 
> Colocamos à sua disposição este tutorial para o acompanhar o melhor possível em tarefas comuns. No entanto, se encontrar dificuldades, recomendamos que recorra a um [fornecedor especializado](partner.), ao [editor do CMS WordPress](https://wordpress.com/support/){.external} ou ao [editor do WooCommerce](https://woocommerce.com/){.external}. Não poderemos proporcionar-lhe assistência técnica. Para mais informações, aceda à secção ["Quer saber mais?"](wordpress-woocommerce-first-steps_#go-further.) deste tutorial.
>
...
- Ter previamente [instalado WordPress](cms_install_1_click_modules1.) no seu alojamento web.

Se ainda não o fez, recomendamos que coloque o seu website em HTTPS antes de prosseguir com este tutorial, utilizando o guia "[Ativar o HTTPS num website com certificado SSL](ssl-activate-https-website1.)".
...
![Ativate WooCommerce](add-plugin-woocommerce-activate.png){.thumbnail}
...
![Setup Wizard - Product Tipes](woocommerce-product-types.png){.thumbnail}
...
![Setup Wizard - Business Details, free feature](woocommerce-business-details-2.png){.thumbnail}
...
![Setup Wizard - Extensão, WooCommerce, Settings](plugins-woocommerce.png){.thumbnail}
