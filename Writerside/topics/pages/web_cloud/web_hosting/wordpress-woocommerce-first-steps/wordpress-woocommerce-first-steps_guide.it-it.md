...
- Aver precedentemente [installato WordPress](cms_install_1_click_modules1.) sul tuo hosting Web

Se non lo hai già fatto, ti consigliamo di utilizzare il protocollo HTTPS prima di continuare con questa guida: "[Attivare HTTPS su un sito Internet tramite il certificato SSL](ssl-activate-https-website1.)".
...
![Attivate WooCommerce](add-plugin-woocommerce-activate.png){.thumbnail}
...
![Setup Wizard - Estensione, WooCommerce, Settings](plugins-woocommerce.png){.thumbnail}
