...
>
> This tutorial is designed to help you with common tasks. Nevertheless, we recommend contacting a [specialist provider](partner.) if you encounter any difficulties. We will not be able to assist you. You can find more information in the [Go further](htaccess_url_rewriting_using_mod_rewrite_#go-further.) section of this guide.
>
>
...
To edit (or create) directories, log in to your hosting plan’s FTP space. If you need help with this, please refer to our guide on [Accessing your Web Hosting plan’s storage space](ftp_connection1.).
...
Please refer to our guide on [Hosting multiple websites on your Web Hosting plan](multisites_configure_multisite1.) if you would like more information on this subject.
...
If you do not have an SSL certificate, please refer to our guide on [Managing an SSL certificate on an OVHcloud shared hosting plan](ssl_on_webhosting1.).
...
[Protect your website's administration interface with a .htaccess file](htaccess_protect_directory_by_password1.)
