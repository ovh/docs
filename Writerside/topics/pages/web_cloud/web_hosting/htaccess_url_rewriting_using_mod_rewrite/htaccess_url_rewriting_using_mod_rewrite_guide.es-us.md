...
- Disponer de un [hosting OVHcloud](hosting.)
  
## Procedimiento
...
Para editar o crear directorios, conéctese al espacio FTP de su alojamiento. Si lo necesita, consulte la guía "[Acceder a mi espacio de almacenamiento](ftp_connection1.)".
...
Si desea más información sobre el asunto, consulte nuestra guía sobre la [configuración de un multisitio en un alojamiento compartido](multisites_configure_multisite1.).
...
Si no tiene certificado SSL, consulte nuestra guía sobre la [gestión de un certificado SSL en un alojamiento compartido de OVHcloud](ssl_on_webhosting1.).
...
[Proteger la interfaz de administración de su sitio web mediante un archivo .htaccess](htaccess_protect_directory_by_password1.)
