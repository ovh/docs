...
OVHcloud bietet mehrere [Webhosting-Angebote](hosting.). Sie sind für verschiedene Einsatzzwecke konzipiert:
...
- Verwaltung von Datenbanken ([bei einigen unserer Webhostings inklusive](hosting.)).
- etc.
...
- Sie haben einen [Domainnamen](domains.).
- Sie haben Zugriff auf Ihr [OVHcloud Kundencenter](manager.).

## In der praktischen Anwendung

Ziel dieser Anleitung ist es, Ihnen die wichtigsten Aktionen aufzuzeigen, die mit unseren [Webhosting](hosting.) Lösungen durchgeführt werden können. 
...
Sie können diese Anleitung also als „Repository“ für die möglichen Aktionen verwenden, sobald Sie Ihr [Webhosting](hosting.) abonniert haben und während Sie es verwenden.
...
Je nach Ihren Antworten überprüfen Sie, ob Ihr [Webhosting](hosting.) Angebot Ihren Anforderungen entspricht, bevor Sie fortfahren.

Ist das nicht der Fall, lesen Sie unsere Anleitung „[Webhosting: Wie kann ich mein Angebot wechseln?](how_to_upgrade_web_hosting_offer1.)“.
...
Wenn Sie eine Website von einem anderen Hosting-Anbieter migrieren möchten, lesen Sie unsere Anleitung „[Migration Ihrer Website und E-Mails zu OVHcloud](hosting_migrating_to_ovh1.)“. Dort finden Sie alle wesentlichen Schritte für eine unterbrechungsfreie Migration aller Ihrer Dienstleistungen (Domainname, Website, E-Mail-Adresse(n) etc.).
...
Folgen Sie in diesem Fall unserer Anleitung „[Eine Website auf Ihrem Webhosting online stellen](hosting_how_to_get_my_website_online1.)“. Sie finden dort alle notwendigen Schritte:
...
Wenn Sie in Ihrem [OVHcloud Kundencenter](manager.) eingeloggt sind, können Sie mit dieser Option schnell die CMS *WordPress*, *Joomla!*, *PrestaShop* und *Drupal* auf dem Hosting installieren.

Um diese Option zu verwenden, lesen Sie unsere Anleitung „[Installation Ihrer Website mit 1-Klick-Modulen (CMS)](cms_install_1_click_modules1.)“.

> [!primary]
>
> Wenn Sie Ihr CMS lieber manuell installieren möchten, ohne die Option „1-Klick-Module“, lesen Sie unsere Dokumentation „[Manuelle Installation eines CMS auf einem Webhosting](cms_manual_installation1.)“.
>

### Schritt 3 - E-Mail-Accounts erstellen (optional) <a name="email-creation"></a>

Ihr [Webhosting](hosting.) enthält eine oder mehrere E-Mail-Accounts, die Sie aktivieren können.

Befolgen Sie zunächst unsere Anleitung „[Die in Ihrem Webhosting inklusiven E-Mail-Accounts aktivieren](activate-email-hosting1.)“.

Wenn die Option aktiviert ist, lesen Sie unsere Anleitung „[E-Mail-Accounts mit MX Plan erstellen](email_creation1.)“, um eine oder mehrere E-Mail-Adressen mit Ihrem Domainnamen zu personalisieren.
...
>
> - Wenn Sie bei der Bestellung Ihres Webhostings keinen Domainnamen hinzugefügt haben und die Option „E-Mail-Adresse(n) bei Ihrem Webhosting inklusive“ nutzen möchten, müssen Sie die Operation manuell über Ihr [OVHcloud Kundencenter](manager.) durchführen.
...
- [Verzeichnis von IP-Adressen für die Webhosting Cluster](clusters_and_shared_hosting_IP1.): Hier finden Sie alle IP-Adressen unserer Webhosting-Infrastruktur. Diese Anleitung hilft Ihnen insbesondere bei Domainnamen, deren aktive DNS-Zone nicht bei OVHcloud verwaltet wird (oder die über ein anderes OVHcloud Account verwaltet werden).
- [Mehrere Websites auf einem Webhosting einrichten](multisites_configure_multisite1.): In dieser Anleitung erfahren Sie, wie Sie mehrere Domainnamen zu einem Webhosting hinzufügen. Es kann Ihnen auch dabei helfen, zu überprüfen, ob die Angabe Ihres Domainnamens im Tab `Multisite`{.action} Ihres Webhostings korrekt ist. Bei Bedarf können Sie diese dann in der aktiven DNS-Zone Ihrer Domain ändern.
- [Bearbeiten der OVHcloud DNS-Zone](dns_zone_edit1.): In dieser Anleitung erfahren Sie, wie Sie eine bei OVHcloud vorhandene DNS-Zone bearbeiten. Sie wird verwendet, wenn die aktive DNS-Zone Ihrer Domain auf einem anderen OVHcloud Account als Ihrem eingerichtet ist. Sie können damit auch auf die OVHcloud DNS-Zone Ihrer Domain zugreifen, um zu überprüfen, dass die für Ihre Domain in der DNS-Zone deklarierte IP-Adresse (Eintrag(e) vom Typ *A* und/oder *AAAA*) mit der IP-Adresse Ihres Webhostings übereinstimmt.

Um die Verbindung zwischen Ihrem Domainnamen und Ihrem OVHcloud E-Mail-Angebot zu überprüfen und/oder zu ändern, lesen Sie die Anleitung „[MX-Eintrag konfigurieren](dns_zone_mx1.)“: Dort finden Sie die Namen der OVHcloud E-Mail-Server sowie die Vorgehensweise, um Ihren Domainnamen auf diese Server verweisen zu lassen.

> [!primary]
>
> Wenn die aktive DNS-Zone für Ihre Domain nicht bei OVHcloud verwaltet wird:
> 
> - **Für die Verbindung zwischen Ihrem Domainnamen und Ihrem Webhosting**: Ziehen Sie die oben aufgeführten Anleitungen „[Verzeichnis von IP-Adressen für die Webhosting Cluster](clusters_and_shared_hosting_IP1.)“ und „[Mehrere Websites auf einem Webhosting einrichten](multisites_configure_multisite1.)“ zu Rate, um die IP-Adresse Ihres Webhostings abzurufen. Deklarieren Sie anschließend Ihren Domainnamen korrekt auf Ihrem Webhosting. Wenden Sie sich anschließend an die Organisation, die die aktive DNS-Zone Ihrer Domain verwaltet, damit diese auf Ihr Webhosting verweist.
>
> - **Für die Verbindung zwischen Ihrem Domainnamen und Ihrem OVHcloud E-Mail-Angebot**: Lesen Sie nur die Anleitung „[MX-Eintrag konfigurieren](dns_zone_mx1.)“, um die Namen der OVHcloud E-Mail-Server abzurufen, die in der aktiven DNS-Zone Ihrer Domain angegeben werden müssen. Wenden Sie sich anschließend an die Organisation, die die aktive DNS-Zone Ihrer Domain verwaltet, damit diese auf die OVHcloud E-Mail-Server verweist.
>

### Schritt 5 - Weitere Optionen für Webhostings <a name="other-options"></a>

Abhängig von Ihrem [Webhosting Angebot](hosting.) sind zusätzliche Optionen / Angebote / Funktionen kostenlos verfügbar.
...
Sie können ein kostenloses SSL-Zertifikat von **Let's Encrypt** für jedes [Webhosting](hosting.) aktivieren.

Weitere Informationen zu den SSL-Zertifikaten (kostenlos oder kostenpflichtig), die auf Webhostings angeboten werden, finden Sie in unserer Anleitung „[SSL-Zertifikate auf Webhostings](ssl_on_webhosting1.)“.
...
Weitere Informationen zu unseren verschiedenen CDN Angeboten finden Sie in unserer Anleitung „[Ihre Webseiten mit CDN beschleunigen](cdn_how_to_use_cdn1.)“.
...
Wenn Sie über ein Webhosting **Performance** verfügen, können Sie kostenlos einen [Web Cloud Databases](databases.) Datenbankserver aktivieren.

Weitere Informationen zur Verwendung finden Sie in unserer Dokumentation „[Erste Schritte mit Web Cloud Databases](starting_with_clouddb1.)“.

#### E-Mails von Ihrer Website aus versenden

Alle unsere [Webhosting](hosting.) ermöglichen den kostenlosen Versand von E-Mails von Ihrer Website oder einem bestimmten Skript aus.

Weitere Informationen zu dieser Funktion finden Sie in unserer Anleitung „[Automatische E-Mails eines Webhostings verwalten](mail_function_script_records1.)“.
...
Wenn Ihr [Webhosting](hosting.) über diese Option verfügt, lesen Sie unsere Anleitung „[Automatische Tasks mit einem Webhosting verwendenn](cron_tasks1.)“ für weitere Informationen.

## Weiterführende Informationen

[Migration Ihrer Website und E-Mails zu OVHcloud](hosting_migrating_to_ovh1.)

[Meine Seite online stellen](hosting_how_to_get_my_website_online1.)

[Installation Ihrer Website mit 1-Klick-Modulen](cms_install_1_click_modules1.)

[Eine E-Mail-Adresse erstellen](email_creation1.)

[SSL-Zertifikate auf Webhostings](ssl_on_webhosting1.)
