...
> [!primary]
>
> Per gestire il sito Web in remoto senza utilizzare Visual Studio Code, installa il client FTP FileZilla. consulta la nostra guida "[Utilizzare FileZilla con un hosting OVHcloud](ftp_filezilla_user_guide1.)". Per accedere al sito Web in SSH, consulta la nostra documentazione "[Utilizzare l’accesso SSH per il proprio hosting Web](ssh_on_webhosting1.)".
>
...
[Accedere allo spazio di storage FTP del proprio hosting Web](ftp_connection1.)

[Utilizzare FileZilla con l’hosting OVHcloud](ftp_filezilla_user_guide1.)

[Utilizzare l’accesso SSH del proprio hosting Web](ssh_on_webhosting1.). Ti ricordiamo che per utilizzare SSH è necessario disporre di una [soluzione di hosting Web Pro o Performance](hosting.).
