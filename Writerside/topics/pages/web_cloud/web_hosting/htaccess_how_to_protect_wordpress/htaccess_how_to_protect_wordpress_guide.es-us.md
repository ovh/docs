...
> 
> Ponemos a su disposición este tutorial para ayudarle lo mejor posible en tareas habituales. No obstante, si tiene alguna duda, le recomendamos que contacte con un [proveedor especializado](partner.) o [el editor del CMS WordPress](https://wordpress.com/es/support/){.external}. Nosotros no podremos asistirle. Más información en la sección ["Más información"](htaccess_how_to_protect_wordpress_#go-further.) de este tutorial.
>
...
- Tener un [plan de hosting](hosting.) y haber instalado WordPress.
- Estar en condiciones de utilizar un cliente FTP como [FileZilla](https://filezilla-project.org/). Puede consultar nuestra guía "[Utilizar FileZilla](ftp_filezilla_user_guide1.)".
...
>
Si no utiliza un CMS, OVHcloud pone a su disposición un tutorial sobre la [protección de un directorio o de la interfaz de administración de su sitio web a través de ficheros .htaccess](htaccess_protect_directory_by_password1.).
>
> Para cualquier duda relativa a la creación, el uso o la programación de su sitio web, contacte con nuestra [comunidad de usuarios](https://community.ovh.com/en/) o nuestros [partners de OVHcloud](partner.). El equipo de soporte de OVHcloud no podrá ayudarle en estos asuntos.
>
...
> [!warning]
>
> Antes de seguir los pasos que se indican a continuación, deberá redirigir el protocolo HTTP a HTTPS. Para ello, siga las indicaciones de nuestra guía ["Habilitar HTTPS en un sitio web con certificado SSL"](ssl-activate-https-website#1-activar-el-certificado-ssl-en-el-alojamiento-web.).
...
En este ejemplo, `203.0.113.0` designa la dirección IP que desea bloquear.

Para más información, consulte nuestra guía sobre la [restricción de acceso por IP a través del archivo .htaccess](htaccess_how_to_block_a_specific_ip_address_from_accessing_your_website1.).
