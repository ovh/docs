...
L'[hébergement Cloud Web OVHcloud](hosting-cloud-web-offer.){.external} vous permet d'utiliser Node.js comme moteur d'exécution pour vos sites web, et donc d'y installer Etherpad ou toute autre application conçue pour Node.js.
...
![etherpadcloudweb](tab-nodejs8.png){.thumbnail}
...
![etherpadcloudweb](modify-a-runtime-software-application-nodejs8.png){.thumbnail}
...
![etherpadcloudweb](tab-nodejs8-full-disabled.png){.thumbnail}
...
![etherpadcloudweb](add-a-domain-or-sub-domain-step-2-nodejs.png){.thumbnail}
...
![etherpadcloudweb](install-etherpad_images_change-password.png){.thumbnail}
...
![etherpadcloudweb](restart-nodejs8.png){.thumbnail}
