...
- Utilizar una [base de datos asociada a su plan de hosting](hosting-options-startsql.).
...
En el archivo de configuración indicado en el [Etapa 1](sql_change_password_#step1.), empiece por anotar el nombre de la base de datos:
...
Así como en el [Etapa 1](sql_change_password_#step1.), vuelva al espacio de almacenamiento de archivos de su alojamiento y abra el archivo de configuración del sitio web editando.
