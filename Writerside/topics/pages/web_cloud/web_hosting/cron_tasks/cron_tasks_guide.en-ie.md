...
>
> This guide is designed to help you with common tasks. Nevertheless, we recommend contacting a [specialist provider](partner.) or reach out to the [OVHcloud community](https://community.ovh.com/en/) if you encounter any difficulties. We will not be able to assist you. You can find more information in the [Go further](cron_tasks_#go-further.) section of this guide.
>
...
Log in to your [OVHcloud Control Panel](manager.) and select `Web Cloud`{.action} in the top navigation bar. Click `Hosting plans`{.action}, then choose the Web Hosting plan concerned. Next, navigate to the `cron`{.action} tab by selecting it in the `More`{.action} submenu.

In this section you will see an overview of your scheduled jobs and their settings.

![cron control panel](schedule-jobs.png){.thumbnail}
...
![adding scheduling](add-scheduling-step-1.png){.thumbnail}
...
|![cron frequency](add-scheduling-basic-mod-step-2.png){.thumbnail}|
...
|![cron frequency](add-scheduling-expert-mod-step-2.png){.thumbnail}|
...
![cron control panel](add-scheduling-basic-mod-step-2.gif){.thumbnail}
...
![cron confirmation](add-scheduling-step-3.png){.thumbnail}
...
In your Web Hosting's logs, accessible from the [OVHcloud Control Panel](manager.), you will see the log category labelled "cron".

Please refer to [this guide](logs_and_statistics1.) for details.
...
[Configuring the .ovhconfig file of your Web Hosting plan](configure_your_web_hosting1.)

[Using SSH on a Web Hosting plan](ssh_on_webhosting1.)
