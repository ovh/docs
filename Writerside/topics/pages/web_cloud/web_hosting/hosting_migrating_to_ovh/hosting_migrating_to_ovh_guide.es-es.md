...
- El alojamiento [Cloud Web](hosting-cloud-web-offer.) con **200 direcciones de correo** "MX Plan". Esta oferta la utilizan los desarrolladores de aplicaciones.
...
> [!primary]
>
Además de la solución MX Plan, OVHcloud ofrece otras soluciones de correo. Por ejemplo, puede combinar con direcciones de correo MX Plan direcciones ["Email-Pro"](email-pro.) y/o cuentas ["Exchange"](emails-hosted-exchange.).
>
...
Todos los parámetros de configuración se encuentran en la guía "[Información general sobre los MX Plan](email_generalities#2-utilizar-el-programa-que-elija.)". También encontrará enlaces a las guías de configuración personalizadas para los principales programas de mensajería.

#### Para las cuentas "Email-Pro":

Consulte todas nuestras guías de configuración en `Configuración en el ordenador` y `Configuración en smartphone` de [nuestra documentación sobre la solución Email-Pro](web-cloud-email-collaborative-solutions-email-pro1.).
