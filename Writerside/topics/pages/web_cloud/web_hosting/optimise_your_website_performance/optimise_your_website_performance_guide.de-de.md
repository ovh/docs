...
- Sie verfügen über einen [Domainnamen](domains.), mit dem Sie auf Ihre Webseite zugreifen können.
...
Wir geben Empfehlungen dazu, welches Webhosting-Angebot für das oben aufgeführte CMS verwendet werden sollte auf [der Produktseite](hosting.).

Weitere Informationen dazu, welches Hostingpaket sich eignet, finden Sie auf [dieser Seite](hosting-best-web.).
...
Informationen zum Aktualisieren von PHP finden Sie in [dieser Anleitung](configure_your_web_hosting1.).

Informationen zur Verwendung von PHP-FPM in der _stabilen_ Version oder Details zu erweiterten Optionen Ihres Webhostings finden Sie in [dieser Anleitung](configure_your_web_hosting1.).
...
Sie können direkt über das [OVHcloud Kundencenter](manager.) auf Ihre Logs, Statistiken und Verlaufsdiagramme zugreifen.
...
Um sicherzustellen, dass Ihr Hosting-Angebot an die Anforderungen Ihres CMS angepasst ist, finden Sie einen Vergleich unserer Dienste auf [der Produktseite](hosting.).
...
**So greifen Sie über phpMyAdmin auf die Datenbank zu:** Um über phpMyAdmin auf Ihre Datenbank zuzugreifen, gehen Sie wie folgt über das [OVHcloud Kundencenter](manager.) vor:
...
[Konfiguration Ihres Webhostings bearbeiten](configure_your_web_hosting1.)

[Verwaltung einer Datenbank in Ihrem Webhosting](sql_create_database1.){.external}

[Erste Schritte mit Web Cloud Databases](starting_with_clouddb1.){.external}
