...
> 
> Ponemos a su disposición este tutorial para ayudarle lo mejor posible en tareas habituales. No obstante, si tiene alguna duda, le recomendamos que contacte con un [proveedor especializado](partner.) o [el editor del CMS Joomla!](https://www.joomla.org/){.external}. Nosotros no podremos asistirle. Más información en la sección ["Más información"](cms_manual_installation_joomla_#go-further.) de este tutorial.
>

> [!success]
>
> Para instalar Joomla! **automáticamente** desde su [área de cliente de OVHcloud](manager.), consulte nuestra documentación sobre la [instalación de un módulo en un clic](cms_install_1_click_modules1.).
>
...
Para instalar el CMS **Joomla!** en su [plan de hosting](hosting.), es necesario realizar algunos preparativos.
...
Para completar los siguientes campos, consulte la información indicada en el **etapa 1.4** del tutorial sobre la [instalación manual de un CMS](cms_manual_installation1.):
...
Para las bases de datos creadas en una Web Cloud Databases, consulte la información indicada en **el etapa 1.4** de la guía sobre la [instalación manual de un CMS](cms_manual_installation1.).
...
-*Enter the database name*: este nombre se ha establecido al crear la base de datos en el [área de cliente de OVHcloud](manager.). Es idéntico al nombre de usuario de la base de datos si utiliza una base de datos incluida con su alojamiento web.

-*Enter a table prefix or use the randomly generated one*: si la instalación se realiza con una nueva base de datos, introduzca el prefijo que prefiera. Si utiliza una base de datos ya utilizada en otro sitio web, puede consultar el **etapa 1.4** de la guía sobre la [instalación manual de un CMS](cms_manual_installation1.) para evitar que se introduzca un "prefijo" de tabla que ya utiliza su base de datos.
...
El archivo que desea eliminar se encuentra en su [espacio de almacenamiento FTP](ftp_connection1.).
