...
> 
> Nous mettons à votre disposition ce tutoriel afin de vous accompagner au mieux sur des tâches courantes. Néanmoins, nous vous recommandons de faire appel à un [prestataire spécialisé](partner.) ou [l'éditeur du CMS Joomla!](https://www.joomla.org/){.external} si vous éprouvez des difficultés. En effet, nous ne serons pas en mesure de vous fournir une assistance. Retrouvez plus d'informations dans la section [« Aller plus loin »](cms_manual_installation_joomla_#go-further.) de ce tutoriel.
>

> [!success]
>
> Pour installer Joomla! **automatiquement** depuis votre [espace client OVHcloud](manager.), consultez notre documentation sur l'[installation d'un module « en un clic »](cms_install_1_click_modules1.).
>
> Pour installer **manuellement un autre CMS** (WordPress, Drupal, PrestaShop), consultez notre documentation sur l'[installation manuelle d'un CMS](cms_manual_installation1.).
>
...
Pour installer le CMS **Joomla!** sur votre offre d'[hébergement web](hosting.), quelques préparatifs sont nécessaires.
...
Référez-vous aux informations indiquées dans **l'étape 1.4** du tutoriel sur l'[installation manuelle d'un CMS](cms_manual_installation1.) pour compléter les champs suivants :
...
Pour les bases de données créées sur un Web Cloud Databases, référez-vous aux informations indiquées dans **l'étape 1.4** du guide sur l'[installation manuelle d'un CMS](cms_manual_installation1.).
...
- *Entrer le nom de la base de données* : ce nom a été défini lors de la création de la base de données dans l'[espace client OVHcloud](manager.). Il est identique au nom d'utilisateur de la base de données si vous utilisez une base de données incluse avec votre hébergement web.

- *Saisissez un préfixe de table ou utilisez celui qui est généré de manière aléatoire* : si l'installation se fait avec une toute nouvelle base de données, renseignez le « préfixe » de votre choix. Si vous utilisez une base de données déjà utilisée par un autre site, référez-vous à **l'étape 1.4** du guide sur l'[installation manuelle d'un CMS](cms_manual_installation1.) pour ne pas renseigner un « préfixe » de table déjà utilisé dans votre base de données.
...
Ce fichier à supprimer se trouve dans votre [espace de stockage FTP](ftp_connection1.).
