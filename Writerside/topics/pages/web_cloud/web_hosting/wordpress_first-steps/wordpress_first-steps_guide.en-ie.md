...
>
> This tutorial is designed to help you with common tasks. Nevertheless, we recommend contacting a [specialist provider](partner.) or the [WordPress support](https://wordpress.com/support/){.external} if you encounter any difficulties. We will not be able to assist you. You can find more information in the [Go further](wordpress_first-steps_#go-further.) section of this guide.
>
...
![WordPress - Sub-category added](categories-4.png){.thumbnail}
...
![WordPress - Categorise a post](posts-lists.png){.thumbnail}
