...
> 
> Colocamos à sua disposição este tutorial para o acompanhar o melhor possível em tarefas comuns. No entanto, se encontrar dificuldades, recomendamos que recorra a um [fornecedor especializado](partner.) ou ao [editor do CMS WordPress](https://wordpress.com/support/){.external}. Não poderemos proporcionar-lhe assistência técnica. Para mais informações, aceda à secção ["Quer saber mais?"](wordpress_first-steps_#go-further.) deste tutorial.
>
...
- Ter [instalado Wordpress](cms_install_1_click_modules1.) no seu alojamento web.
- Ter acesso à [Área de Cliente OVHcloud](manager.){.external}

## Instruções

Se ainda não o fez, e antes de continuar, [adicione um certificado SSL](ssl-activate-https-website#1-ativar-o-certificado-ssl-no-alojamento.) no domínio associado ao seu website.
...
![WordPress - Categorias](categories.png){.thumbnail}
...
![WordPress - Categories filed](categories-2.png){.thumbnail}
