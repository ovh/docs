...
> [!primary]
>
> Ce guide concerne principalement les e-mails envoyés depuis des scripts situés sur votre [hébergement web OVHcloud](hosting.) à l'aide de la fonction « mail() » de PHP.
>
> Si vous souhaitez gérer les adresses e-mail comprises dans votre offre MX Plan ou dans votre offre d'[hébergement web OVHcloud](hosting.){.external}, consultez notre documentation sur les [E-mails mutualisés - MX Plan](web-cloud-email-collaborative-solutions-mx-plan1.).
>
...
- vous avez vous-même désactivé la fonctionnalité depuis votre [espace client OVHcloud](manager.).
...
- Analysez les [logs de votre hébergement](logs_and_statistics1.) pour identifier les failles de sécurité et les fichiers infectés.
...
> [!warning]
> 
> Les e-mails émis avec un script utilisant une configuration SMTP ne pourront pas être gérés et suivis depuis votre [espace client OVHcloud](manager.).
> 
...
[Consulter les logs de votre hébergement](logs_and_statistics1.)

[Corriger la page « 403 Forbidden » qui s'affiche sur votre site](diagnostic_403_forbidden1.)

[Restaurer l'espace de stockage FTP de votre hébergement](ftp_save_and_backup1.)
