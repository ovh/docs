...
> [!primary]
>
> Diese Anleitung betrifft hauptsächlich E-Mails, die über Skripte auf Ihrem [OVHcloud Webhosting](hosting.) mit der "mail()"-Funktion von PHP versendet werden.
>
> Wenn Sie die E-Mail-Accounts Ihres MX Plans oder Ihres [OVHcloud Webhostings](hosting.){.external} verwalten möchten, lesen Sie unsere Dokumentation zu [Hosted E-Mail - MX Plan](web-cloud-email-collaborative-solutions-mx-plan1.).
>
...
- Sie haben die Funktion selbst über Ihr [OVHcloud Kundencenter](manager.) deaktiviert.
...
- Analysieren Sie die [Logs Ihres Hostings](logs_and_statistics1.), um Sicherheitslücken und infizierte Dateien zu identifizieren.
...
> 
> Bei Schwierigkeiten kontaktieren Sie bitte einen [spezialisierten Dienstleister](partner.) oder stellen Ihre Fragen in der OVHcloud Community. Leider können wir Ihnen für administrative Aufgaben keine weitergehende technische Unterstützung anbieten. Weitere Informationen finden Sie am [Ende dieser Anleitung](mail_function_script_records_#go-further.).
>
...
> [!warning]
> 
> E-Mails, die über ein Skript mit SMTP-Konfiguration versendet werden, können nicht über Ihr [OVHcloud Kundencenter](manager.) verwaltet und verfolgt werden.
> 
...
[Die Logs Ihres Hostings einsehen](logs_and_statistics1.)

[Fehler "403 Forbidden" einer Webseite korrigieren](diagnostic_403_forbidden1.)

[FTP-Speicherplatz Ihres Hostings wiederherstellen](ftp_save_and_backup1.)
