...
> 
> Esta guía le ayudará a realizar las tareas más habituales. No obstante, si necesita ayuda, le recomendamos que contacte con un [proveedor especializado](partner.). Nosotros no podremos asistirle. Para más información, consulte la sección ["Más información"](ssl_avoid_common_pitfalls_of_making_website_secure_#go-further.) de esta guía.
>
...
- Tener un [alojamiento web de OVHcloud](hosting.){.external}.
- Haber registrado al menos un [dominio](domains.){.external}.
- Tener acceso al [área de cliente de OVHcloud](manager.){.external}, parte "Web cloud".
...
> [!primary]
>
> Algunos sitios web utilizan [Content Delivery Network (CDN)](cdn_how_to_use_cdn1.) para alojar, por ejemplo, librerías *Javascript* (como *JQuery*). 
...
A continuación ofrecemos un ejemplo de redirección que puede añadir a un archivo "[.htaccess](htaccess_url_rewriting_using_mod_rewrite1.)", en la raíz de su sitio web (sustituyendo la URL *https://www.yourdomain.tld* por la suya):
