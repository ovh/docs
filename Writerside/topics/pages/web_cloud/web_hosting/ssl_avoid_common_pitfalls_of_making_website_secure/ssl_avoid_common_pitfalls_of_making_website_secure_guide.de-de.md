...
>
> Wenn Sie Schwierigkeiten haben, die Schritte in diesem Tutorial durchzuführen, empfehlen wir, einen [spezialisierten Dienstleister](partner.) zu kontaktieren oder Ihre Fragen in der OVHcloud Community zu stellen. Leider können wir Ihnen für administrative Aufgaben keine weitergehende technische Unterstützung anbieten. Weitere Informationen finden Sie am [Ende dieser Anleitung](ssl_avoid_common_pitfalls_of_making_website_secure_#go-further.).
>
...
- Sie haben mindestens einen [Domainnamen](domains.){.external} registriert.
- Sie haben Zugriff auf Ihr [OVHcloud Kundencenter](manager.) im Bereich "Web Cloud".
...
> [!primary]
>
> Einige Websites verwenden ein [Content Delivery Network (CDN)](cdn_how_to_use_cdn1.), um beispielsweise *JavaScript*-Bibliotheken (wie *JQuery*) zu hosten. 
...
Hier ein Beispiel für eine Weiterleitung, die Sie in die Datei „[.htaccess](htaccess_url_rewriting_using_mod_rewrite1.)“ im Wurzelverzeichnis Ihrer Website einfügen können (ersetzen Sie die URL *https://www.yourdomain.tld* durch Ihre eigene):
