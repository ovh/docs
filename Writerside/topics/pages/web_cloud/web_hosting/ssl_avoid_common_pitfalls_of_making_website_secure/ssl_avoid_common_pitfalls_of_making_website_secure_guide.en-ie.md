...
>
> This guide is designed to help you with common tasks. Nevertheless, we recommend contacting a [specialist service provider](partner.) or reaching out to the OVHcloud community if you encounter any difficulties. We will not be able to assist you. You can find more information in the [Go further](ssl_avoid_common_pitfalls_of_making_website_secure_#go-further.) section of this guide.
>
...
- At least one [domain name](domains.)
- Access to the [OVHcloud Control Panel](manager.) in the "Web Cloud" section
...
> [!primary]
>
> Some websites use a [Content Delivery Network (CDN)](cdn_how_to_use_cdn1.) to host, for example, *Javascript* libraries (such as *JQuery*). 
...
Here is an example of a redirection that you can add to the file "[.htaccess](htaccess_url_rewriting_using_mod_rewrite1.)", at the root of your website (by replacing the URL *https://www.yourdomain.tld* with your own):
