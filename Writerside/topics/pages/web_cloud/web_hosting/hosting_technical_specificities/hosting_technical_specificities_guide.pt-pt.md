...
> 
> Este manual fornece as instruções necessárias para realizar as operações mais habituais. No entanto, se encontrar dificuldades, recomendamos que recorra a um [prestador de serviços especializado](partner.) e/ou que contacte o editor do serviço. Não poderemos proporcionar-lhe assistência técnica. Para mais informações, aceda à secção "[Quer saber mais?](hosting_technical_specificities_#go-further.)" deste guia.
> 
...
- Se encontrar o erro de acesso "falha de autenticação de ligação 530" ao aceder ao espaço de armazenamento FTP: Certifique-se de que as informações de acesso ao seu espaço FTP estão corretas. Para isso, aceda à [Área de Cliente OVHcloud](manager.) e aceda à secção `Web Cloud`{.action}. Na coluna da esquerda, clique em `Alojamentos`{.action} e selecione o alojamento web em causa. Na página que vai aparecer, clique no separador `FTP - SSH`{.action}.
...
Encontre mais informações sobre este assumpto no nosso guia "[Ligar-se ao espaço de armazenamento FTP do alojamento web](ftp_connection1.)".
...
- [Seguir e gerir os e-mails automatizados do alojamento web](mail_function_script_records1.);
- [Casos práticos - Dicas sobre como hackear o seu website](cms_what_to_do_if_your_site_is_hacked1.).

### Base de dados / SQL

#### Ligações simultâneas à base de dados

Nas ofertas de alojamento web (bases de dados partilhadas), existe um limite de 30 ligações simultâneas por base de dados (este limite passa para 200 se utilizar uma oferta [Web Cloud Databases](databases.). Consultar [detalhes das nossas ofertas de alojamento web](hosting.) para conhecer as opções disponíveis em cada oferta de alojamento web.

Pode igualmente encomendar ofertas [Web Cloud Databases](databases.) suplementares, estas dispõem de opções de personalização:
...
Para saber mais, consulte os detalhes dos nossos [planos de alojamento web](hosting.) e o nosso guia "[Primeiros passos com a sua oferta Web Cloud Databases](starting_with_clouddb1.)".
...
Apenas os servidores de bases de dados [Web Cloud Databases](databases.) permitem a servidores externos a ligação. Isto tendo previamente autorizado o endereço IP do seu servidor externo no servidor de bases de dados. Se necessário, consulte o guia "[Primeiros passos com a oferta Web Cloud Databases](starting_with_clouddb1.)".
...
Para mais informações sobre a gestão das bases de dados e sobre a ligação à interface *phpMyAdmin*, consulte o guia "[Criar uma base de dados num alojamento web](sql_create_database1.)".

### PHP

Recomendamos que consulte as nossas [ofertas de alojamento web](hosting-programming-language.) para se certificar de que a oferta de alojamento web que deseja encomendar se adapta às suas necessidades.
...
>
> Encontre mais pormenores sobre este assumpto no nosso guia "[Alojamento Web: ambiente, versão PHP, ".ovhconfig"](configure_your_web_hosting1.)"
>
...
Descubra como [aceder ao espaço de armazenamento FTP do seu alojamento web](ftp_connection1.) ou [restaurar o espaço de armazenamento FTP do alojamento web](ftp_save_and_backup1.) nas nossas documentações.
...
Saiba como é que [Obter a cópia de segurança da base de dados de um alojamento web](sql_database_export1.) no manual.
...
[Passar o seu website em HTTPS graças ao SSL](ssl-activate-https-website1.)

[Otimização das performances do seu site](optimise_your_website_performance1.)

[Restaurar o espaço de armazenamento FTP do alojamento web](ftp_save_and_backup1.)
