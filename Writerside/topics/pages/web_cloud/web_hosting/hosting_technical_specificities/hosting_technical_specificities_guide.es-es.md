...
- Tener contratado un [plan de hosting](hosting.){.external} compatible.
...
Para más información, consulte nuestra guía "[Conectarse al espacio de almacenamiento FTP de un alojamiento web](ftp_connection1.)".
...
- [Seguimiento y gestión de los mensajes de correo automatizados de su alojamiento web](mail_function_script_records1.);
- [Casos prácticos - Consejos sobre la piratería de su sitio Web](cms_what_to_do_if_your_site_is_hacked1.).

### Base de datos / SQL

#### Conexiones simultáneas a la base de datos

En los planes de hosting (bases de datos compartidas), existe un límite de 30 conexiones simultáneas por base de datos (este límite aumenta a 200 si utiliza un plan [Web Cloud Databases](databases.)). Consultar el [detalle de nuestros planes de hosting](hosting.) para conocer las opciones disponibles en cada plan de hosting.

También puede contratar productos adicionales [Web Cloud Databases](databases.), que disponen de opciones de personalización:
...
Para más información, consulte los detalles de nuestros [planes de hosting](hosting.) y nuestra guía "[Primeros pasos con su solución Web Cloud Databases](starting_with_clouddb1.)".
...
Solo los servidores de bases de datos [Web Cloud Databases](databases.) permiten a servidores externos conectarse a ellos. Para ello, debe haber autorizado previamente la dirección IP de su servidor externo en su servidor de bases de datos. Si necesita ayuda, consulte nuestra guía "[Primeros pasos con su solución Web Cloud Databases](starting_with_clouddb1.)".
...
Para más información sobre la gestión de las bases de datos y la conexión a la interfaz *phpMyAdmin*, consulte la guía "[Crear una base de datos en un alojamiento web](sql_create_database1.)".

### PHP

Le recomendamos que consulte nuestros [planes de hosting](hosting-programming-language.) para asegurarse de que el plan de hosting que desea contratar se ajusta a sus necesidades.
...
>
> Para más información, consulte nuestra guía "[Alojamiento web: entorno, versión PHP, ".ovhconfig"](configure_your_web_hosting1.)"
>
...
Una vez conectado al alojamiento web por SSH, el tráfico saliente se bloqueará por motivos de seguridad. Por lo tanto, le recomendamos que utilice scripts PHP. Para más información, consulte nuestra [guía SSH](ssh_on_webhosting1.). Puede consultar el apartado "[PHP manual](https://www.php.net/manual/es/function.system.php)" relativo a la ejecución de comandos.
...
Cómo [conectarse al espacio de almacenamiento FTP de un alojamiento web](ftp_connection1.) o [restaurar el espacio de almacenamiento FTP de un alojamiento web](ftp_save_and_backup1.) en nuestra documentación.
...
[Habilitar HTTPS en un sitio web con SSL](ssl-activate-https-website1.)

[Optimización del rendimiento de su sitio web](optimise_your_website_performance1.)

[Restaurar el espacio de almacenamiento FTP de un alojamiento web](ftp_save_and_backup1.)

[Recuperar la copia de seguridad de la base de datos de un alojamiento web](sql_database_export1.)
