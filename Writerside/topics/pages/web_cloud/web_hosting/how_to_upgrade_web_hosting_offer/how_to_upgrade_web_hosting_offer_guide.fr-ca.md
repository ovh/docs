...
- de fonctionnalités supplémentaires comme les [mailing-lists](feature_mailing_list1.) (à partir de [l'offre Pro](hosting-professional-offer.)) ou le [service Web Cloud Databases](hosting-professional-offer.){.external} (compris dans [les offres Performance](hosting-performance-offer.)).
...
>
> Si vous souhaitez modifier votre abonnement pour passer à une offre inférieure, veuillez suivre les étapes de notre guide « [Migrer son site et ses e-mails vers OVHcloud](hosting_migrating_to_ovh1.) ».
> 
