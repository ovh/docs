...
- Ter um serviço de [alojamento web](hosting.) com acesso em SSH
- Ter acesso à sua [Área de Cliente OVHcloud](manager.){.external}
...
Para encontrar os acessos SSH do seu alojamento web, consulte o guia "[Utilizar o acesso SSH do alojamento web](ssh_on_webhosting1.)".
...
- `ssh.cluster0XX.hosting.ovh.net`: substitua os `XX` pelo número do cluster onde se encontra o seu alojamento web. Se necessário, consulte o guia "[Utilizar o acesso SSH do alojamento web](ssh_on_webhosting1.)" para encontrar esta informação.
- `/homez.XXX/FTP-main-login/` : altere os `XXX` pelo número do *filer* e o `FTP-main-login` pelos parâmetros recuperados durante a [etapa 2](using-scp-command_#step2.) deste guia.
...
Para verificar se algum conteúdo presente localmente no seu computador foi copiado para o alojamento web, pode [aceder ao espaço de armazenamento FTP do alojamento web](ftp_connection1.) e, de seguida, dirigir-se ao diretório de destino onde o conteúdo é suposto ser copiado.
...
[Utilizar o acesso SSH do alojamento web](ssh_on_webhosting1.)

[Ligar-se ao espaço de armazenamento FTP do seu alojamento web](ftp_connection1.)
