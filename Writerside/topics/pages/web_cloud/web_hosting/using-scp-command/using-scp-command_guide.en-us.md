...
>
> This guide is designed to help you with common tasks. Nevertheless, we recommend contacting a [specialist service provider](partner.) if you encounter any difficulties. We will not be able to assist you. You can find more information in the [Go further](using-scp-command_#go-further.) section of this guide.
>
...
- A [web hosting plan](hosting.) with SSH access
- Access to your [OVHcloud Control Panel](manager.){.external}
...
To find the SSH access for your web hosting plan, please read our guide on [Using SSH access for your web hosting plan](ssh_on_webhosting1.).
...
- `ssh.cluster0XX.hosting.ovh.net`: Replace `XX` with the cluster number where your web hosting plan is located. If you need any further information, please refer to our guide on [Using SSH access on your web hosting plan](ssh_on_webhosting1.).
- `/homez.XXX/FTP-main-login/`: Replace `XXX` with the number of the *filer* and the `FTP-main-login` by the parameters retrieved in [step 2](using-scp-command_#step2.) of this guide.
...
To check that content on your computer has been copied to your web hosting plan, you can [log in to your web hosting plan’s FTP storage space](ftp_connection1.), then go to the target directory where the content is supposed to be.
...
[Logging in to your web hosting plan’s FTP storage space](ftp_connection1.)
