...
- a database created as part of an [OVHcloud Web Hosting plan](hosting.)
- access to the backup that you want to import into your database, or the ability to retrieve it
- Depending on which import method you use, you must be able to administer the Web Hosting plan from the [OVHcloud Control Panel](manager.){.external}, or have the information you need in order to connect to the database.
...
- **Restore an earlier version of your database in just a few clicks**: this method can be used to restore the contents of your databases, thanks to the backups present in the OVHcloud backup tool. This method does not require any particular technical knowledge, and can be carried out from your [OVHcloud Control Panel](manager.).

- **Import your own backup file in just a few clicks**: this method lets you import the data from your own backup file, already in your possession, into one of your databases. This method can be carried out from your [OVHcloud Control Panel](manager.).
...
- **Carry out the import from an SSH command line**: this method involves using the SSH protocol to log in to your storage space, then using commands to interact with the storage space. More advanced knowledge and a specific [OVHcloud Hosting Plan](hosting.) are required to use this type of access.
...
First of all, log in to your [OVHcloud Control Panel](manager.){.external}, click `Hosting plans`{.action}, then select the plan concerned. Next, go to the `Databases`{.action} tab.
...
![databaseimport](sql_importing_mysql_database_images_restore-backup.png){.thumbnail}
...
![databaseimport](images_restore-the-backup.png){.thumbnail}
...
![databaseimport](sql_importing_mysql_database_images_import-file.png){.thumbnail}
...
![databaseimport](database-import-step-1-new-file.png){.thumbnail}
...
![databaseimport](database-import-step-2-new-file.png){.thumbnail}
...
![databaseimport](database-import-step-3.png){.thumbnail}

### Carry out the import from the phpMyAdmin web interface.

To carry out this procedure, you will need to log in to phpMyAdmin. To get the access link for this interface, log in to your [OVHcloud Control Panel](manager.){.external}, click `Hosting plans`{.action}, then select the plan concerned. Next, go to the `Databases`{.action} tab.
...
![databaseimport](images_go-to-phpmyadmin.png){.thumbnail}
...
Once the import script has been written, you will need to upload it, along with the backup file you want to import to the storage space of your Web Hosting plan. To do this, you will need to log in to your storage space. If you do not know how to do this, please refer to the instructions in step 2 of our guide on getting your website online, “[Log in to your storage space](hosting_how_to_get_my_website_online#2-log-in-to-your-storage-space.)”.
