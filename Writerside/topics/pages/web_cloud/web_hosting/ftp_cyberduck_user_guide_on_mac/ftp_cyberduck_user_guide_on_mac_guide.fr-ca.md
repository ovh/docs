...
>
> Nous mettons à votre disposition ce guide afin de vous accompagner au mieux sur des tâches courantes. Néanmoins, nous vous recommandons de faire appel à un [prestataire spécialisé](partner.) et/ou de contacter l'éditeur du service si vous rencontrez des difficultés. En effet, nous ne serons pas en mesure de vous fournir une assistance. Consultez la section [Aller plus loin](ftp_cyberduck_user_guide_on_mac_#go-further.) de ce guide pour plus d'informations.
>

## Prérequis

- Disposer d'une offre d'[hébergement web](hosting.){.external}.
...
> - Si vous ne connaissez pas toutes vos informations FTP (serveur, identifiants etc.), reportez-vous au guide « [Se connecter à l’espace de stockage FTP de son hébergement web](ftp_connection1.) ».
> 
...
> - Si besoin, reportez-vous au guide « [Se connecter à l’espace de stockage FTP de son hébergement web](ftp_connection1.) ».
>
...
[Tutoriel - Utiliser FileZilla avec votre hébergement OVHcloud](ftp_filezilla_user_guide1.)
