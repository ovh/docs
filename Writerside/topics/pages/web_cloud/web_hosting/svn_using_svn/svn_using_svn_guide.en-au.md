...
>
>This guide is designed to assist you in common tasks as much as possible. Nevertheless, we recommend contacting a specialised provider and/or the software publisher for the service if you encounter any difficulties. We will not be able to assist you ourselves. You can find more information in the “[Go further](svn_using_svn_#go-further.)” section of this guide.
>

## Requirements

- a [Web Hosting plan](hosting.) that allows an SSH connection (**from the Pro plan onwards**)
- access to your Web Hosting plan via SSH (see our guide on [accessing a Web Hosting plan via SSH](ssh_on_webhosting1.))

## Instructions

### Creating the repository

Once you have logged in via [SSH on your hosting](ssh_on_webhosting1.), first create the root directory of your SVN repositories, then the repository.
...
In order to create a key pair, please follow our guide on [Creating SSH keys](public-cloud-first-steps#step-1-creating-ssh-keys.). You can ignore the step regarding the import of your SSH key to the OVHcloud Control Panel.
...
>
> You can also find this information in our guide on [Accessing a Web Hosting plan via SSH](ssh_on_webhosting1.).
> 
