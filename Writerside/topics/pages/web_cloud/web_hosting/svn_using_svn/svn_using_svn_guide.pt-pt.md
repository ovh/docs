...
> 
> Este manual fornece as instruções necessárias para realizar as operações mais habituais. No entanto, se encontrar dificuldades, recomendamos que recorra a um [prestador de serviços especializado](partner.) e/ou que contacte o editor do serviço. Não poderemos proporcionar-lhe assistência técnica. Para mais informações, aceda à secção "[Quer saber mais?](svn_using_svn_#go-further.)" deste guia.
> 

## Pré-requisitos

- Ter um [plano de alojamento web](hosting.) que permite uma ligação SSH (**a partir da oferta Pro**)
- Aceder via SSH ao seu alojamento Web (pode consultar o nosso guia [Utilizar o acesso SSH do alojamento web](ssh_on_webhosting1.))

## Instruções

### Criação do depósito

Depois de aceder ao [SSH no seu alojamento](ssh_on_webhosting1.), crie a pasta raiz dos depósitos SVN e, a seguir, o depósito.
...
![alojamento](terminal-ls-la-svn.png){.thumbnail}
...
Sugerimos que siga o guia [Criar chaves SSH](public-cloud-first-steps#1o-passo-criacao-de-chaves-ssh.). Neste guia, não é necessário seguir o passo [Importar a chave SSH para a Área de Cliente OVHcloud](#como-importar-a-sua-chave-ssh-para-a-area-de-cliente-ovh.).
...
>
> Também poderá consultar estas informações consultando o nosso guia [Utilizar o acesso SSH do seu alojamento web](ssh_on_webhosting1.).
> 

![alojamento](terminal-homez-folder.png){.thumbnail}
...
![alojamento](checkout.png){.thumbnail}
