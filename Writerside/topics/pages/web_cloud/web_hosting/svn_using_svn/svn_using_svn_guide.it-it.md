...
> 
> Questa guida ti aiuta a eseguire le operazioni necessarie alla configurazione del tuo account. Tuttavia, in caso di difficoltà o dubbi, ti consigliamo di contattare un fornitore specializzato o l’amministratore del servizio. OVHcloud non può fornirti alcuna assistenza. Per maggiori informazioni consulta la sezione “[Per saperne di più](svn_using_svn_#go-further.)”.
> 

## Pre-obbligatorio

- Disporre di un'[offerta di hosting Web](hosting.) che permette una connessione SSH (**a partire dall'offerta Pro**)
- Connettersi in SSH al tuo hosting Web (consulta la nostra guida [Utilizzare l'accesso SSH al tuo hosting Web](ssh_on_webhosting1.))

## Procedura

### Creazione del deposito

Una volta connesso in [SSH al tuo hosting](ssh_on_webhosting1.), crea la directory di root dei depositi SVN e poi la deposizione.
...
Segui la guida [Creare chiavi SSH](public-cloud-first-steps#step-1-crea-chiavi-ssh.). Non è necessario seguire lo step [Importa la tua chiave SSH nello Spazio Cliente OVHcloud](#importa-la-chiave-ssh-nello-spazio-cliente.) in questa guida.
...
>
> Per maggiori informazioni, consulta la guida [Utilizzare l'accesso SSH di un hosting Web](ssh_on_webhosting1.).
> 
