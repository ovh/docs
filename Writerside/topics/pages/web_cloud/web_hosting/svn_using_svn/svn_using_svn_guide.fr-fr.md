...
> 
> Nous mettons à votre disposition ce guide afin de vous accompagner au mieux sur des tâches courantes. Néanmoins, nous vous recommandons de faire appel à un [prestataire spécialisé](partner.) et/ou de contacter l'éditeur du service si vous éprouvez des difficultés. En effet, nous ne serons pas en mesure de vous fournir une assistance. Plus d'informations dans la section « [Aller plus loin](svn_using_svn_#go-further.) » de ce guide.
> 

## Pre-requis

- Disposer d'une [offre d'hébergement web](hosting.) permettant une connexion SSH (**à partir de l'offre Pro**)
- Se connecter en SSH à votre hébergement Web (vous pouvez consulter notre guide [Utiliser l’accès SSH de son hébergement web](ssh_on_webhosting1.))

## En pratique

### Création du dépôt

Une fois connecté en [SSH sur votre hébergement](ssh_on_webhosting1.), créez le répertoire racine des dépôts SVN, puis le dépôt.
...
Nous vous invitons à suivre le guide [Créer des clés SSH](public-cloud-first-steps#etape-1-creer-des-cles-ssh.). Il n'est pas nécessaire de suivre l'étape [Importez votre clé SSH dans l’Espace client OVHcloud](#importez-votre-cle-ssh-dans-lespace-client-ovhcloud.) dans ce guide.
...
>
> Vous retrouverez également ces infrormations on consultant notre guide [Utiliser l’accès SSH de son hébergement web](ssh_on_webhosting1.).
> 
