...
The .htaccess file is an Apache configuration file (HTTP) that is run by the web server of your Web Hosting plan. It allows you to define specific rules for a directory and all of its subdirectories. You can create multiple .htaccess files in [the FTP space](ftp_connection1.) of your Web Hosting plan. 
...
> 
> This guide is designed to help you with common tasks. Nevertheless, we recommend contacting a [specialist provider](partner.) and/or the service’s software publisher if you encounter any difficulties. We will not be able to assist you. You can find more information in the ["Go further"](htaccess_what_else_can_you_do_#go-further.) section of this guide.
>
...
For more information, see our tutorial: ["How do I block access to my website for certain IP addresses via a .htaccess file?"](htaccess_how_to_block_a_specific_ip_address_from_accessing_your_website1.).
...
For more information, see our tutorial ["Protect your website’s administration interface with a .htaccess file"](htaccess_protect_directory_by_password1.).
...
You can find more information in our tutorial: ["Rewrite the URL for accessing my website with mod_rewrite via the .htaccess file"](htaccess_url_rewriting_using_mod_rewrite1.).
...
[Protecting your website's administration interface with a .htaccess file](htaccess_protect_directory_by_password1.)

[Tutorial - Rewrite the URL for accessing your website using mod_rewrite via the .htaccess file](htaccess_url_rewriting_using_mod_rewrite1.)
