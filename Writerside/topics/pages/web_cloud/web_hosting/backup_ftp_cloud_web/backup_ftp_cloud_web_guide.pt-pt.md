...
> 
> Quando efetuar uma salvaguarda de segurança para o seu site e utilizar uma base de dados, faça também um backup desta. Não hesite em consultar o nosso guia para [recuperar um backup da sua base de dados](sql_database_export1.).
> 
...
- Ter um [alojamento Cloud Web](hosting-cloud-web-offer.){.external}
...
Contrariamente aos alojamentos partilhados OVHcloud, é impossível efetuar um restauro do espaço FTP com um clique a partir da [Área de Cliente OVHcloud](manager.){.external}.
...
Para gerar o link de recuperação, aceda à [Área de Cliente OVHcloud](manager.){.external}, aceda à secção `Web Cloud`{.action}, clique em `Alojamentos`{.action} e, a seguir, no Cloud Web em causa. 
...
Se a geração do backup está bem lançada, na [Área de Cliente OVHcloud](manager.){.external}, aparecerá a seguinte mensagem:
...
Depois de fazer o download dos seus ficheiros, poderá [ligar-se ao seu espaço FTP](ftp_connection1.) através de um software FTP como o [Filezilla](ftp_filezilla_user_guide1.) e, em seguida, substituir os ficheiros que pretende pelos que recuperou.

> [!primary]
>
> Utilize as portas indicadas na [Área de Cliente OVHcloud](manager.){.external} para as ligações SFTP e SSH, pois a porta 22 não estará funcional para o seu alojamento Cloud Web.
>
...
[Ligar-se através do software Filezilla](ftp_filezilla_user_guide1.)
