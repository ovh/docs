...
> 
> Colocamos à sua disposição este tutorial para o acompanhar o melhor possível em tarefas comuns. No entanto, se encontrar dificuldades, recomendamos que recorra a um [fornecedor especializado](partner.). Não poderemos proporcionar-lhe assistência técnica. Para mais informações, aceda à secção [Quer saber mais?](cms_what_to_do_if_your_site_is_hacked_#go-further.) deste manual.
>

## Requisitos

- Ter [oferta de alojamento Web Cloud](hosting.) com o seu website alojado em cima.
...
- [Alterar a palavra-passe de acesso ao seu identificador de cliente OVHcloud](manage-ovh-password1.).
- [Proteger o acesso à sua Área de Cliente OVHcloud com uma dupla autenticação](secure-ovhcloud-account-with-2fa1.).
- [Alterar a palavra-passe de acesso ao espaço de armazenamento FTP do seu alojamento Web](ftp_change_password1.).
- [Alterar palavra-passe de acesso à base de dados](sql_change_password1.).

Também recomendamos que utilize um [gestor de palavras-passe](manage-ovh-password#utilizar-um-gestor-de-palavras-passe.).
...
> [!warning]
>
> Se encontrar dificuldades para efetuar as ações descritas abaixo, recorra a um prestador de [serviços especializado](partner.) em cibersegurança.
>

Utilize o nosso manual sobre [estatísticas e logs do seu alojamento web](logs_and_statistics1.) para pesquisar os elementos maliciosos injetados no seu website. As informações podem ser encontradas nos logs "web". 
...
>
> Se tem a certeza absoluta de que se trata de um IP malicioso, pode bloquear o acesso ao seu alojamento seguindo a nossa documentação sobre as [restrições de acesso através do ficheiro ".htaccess"](htaccess_how_to_block_a_specific_ip_address_from_accessing_your_website1.).
> 
...
- [Restaurar o espaço de armazenamento FTP do seu alojamento Web](ftp_save_and_backup1.)
- [Recuperar o backup SQL da sua base de dados](sql_database_export1.)
- [Importar o backup SQL para a sua base de dados](sql_importing_mysql_database1.)
...
>
> Se o seu alojamento estiver desativado, os robôs de restauro automático disponíveis a partir do seu [Área de Cliente OVHcloud](manager.) também serão desativados.
...
>
> Para reativar o alojamento Web, siga as instruções indicadas no passo 4 deste [guia](diagnostic_403_forbidden1.).
>
...
Deverá eliminar manualmente os ficheiros e os códigos maliciosos previamente detetados no [Etapa 2](cms_what_to_do_if_your_site_is_hacked_#step2.) deste guia e corrigir as falhas de segurança do seu site.

Para aceder ao espaço de armazenamento do alojamento, consulte o [nosso guia](ftp_connection1.) sobre o assumpto.
...
Encontre mais detalhes sobre as permissões "CHMOD" na secção "Informações úteis" do nosso [tutorial sobre a utilização do cliente FTP Filezilla](ftp_filezilla_user_guide#useful-information.).
...
Proteja os seus formulários de contacto com um sistema do tipo "Captcha", para evitar que robôs maliciosos emitam SPAM desta forma. Se a função "mail()" de PHP tiver sido bloqueada no seu alojamento, consulte o [nosso guia](mail_function_script_records1.) para resolver este bloqueio.

Consulte também o nosso manual sobre [como proteger o seu website](secure_your_website1.) para minimizar o risco de novos ataques.

## Quer saber mais? <a name="go-further"></a>

[Aceder ao espaço de armazenamento do alojamento web](ftp_connection1.)

[Alterar a configuração do alojamento web](configure_your_web_hosting1.)

[Ativar firewall da aplicação](multisites_activating_application_firewall1.)

[Otimizar as performances do seu site](optimise_your_website_performance1.)
