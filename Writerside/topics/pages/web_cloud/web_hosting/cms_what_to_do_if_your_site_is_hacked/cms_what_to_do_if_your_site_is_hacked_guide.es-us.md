...
> 
> Ponemos a su disposición este tutorial para ayudarle lo mejor posible en tareas habituales. No obstante, si tiene alguna duda, le recomendamos que contacte con un [proveedor especializado](partner.). Nosotros no podremos asistirle. Más información en la sección ["Más información"](cms_what_to_do_if_your_site_is_hacked_#go-further.) de esta guía.
>

## Requisitos

- Disponer de un [plan de hosting Cloud](hosting.) con su sitio web alojado en él.
...
- [Cambiar la contraseña de acceso a su ID de cliente de OVHcloud](manage-ovh-password1.).
- [Proteger el acceso a su área de cliente de OVHcloud con doble autenticación](secure-ovhcloud-account-with-2fa1.).
- [Cambiar la contraseña de acceso al espacio de almacenamiento FTP de su alojamiento web](ftp_change_password1.).
- [Cambiar la contraseña de acceso a la base de datos](sql_change_password1.).

También le recomendamos que utilice un [gestor de contraseñas](manage-ovh-password#utilizar-un-gestor-de-contrasenas.).
...
> [!warning]
>
Si tiene dificultades para realizar las acciones que se describen a continuación, contacte con un [proveedor especializado](partner.) en ciberseguridad.
>

Utilice nuestra guía sobre [las estadísticas y logs de su alojamiento web](logs_and_statistics1.) para buscar los elementos maliciosos introducidos en su sitio web. Puede consultar la información en los logs "web". 
...
>
> Si está absolutamente seguro de que se trata de una IP maliciosa, puede bloquearle el acceso a su alojamiento siguiendo nuestra documentación sobre las [restricciones de acceso a través del archivo ".htaccess"](htaccess_how_to_block_a_specific_ip_address_from_accessing_your_website1.).
> 
...
- [Restaurar el espacio de almacenamiento FTP de su alojamiento web](ftp_save_and_backup1.)
- [Descargar la copia de seguridad SQL de su base de datos](sql_database_export1.)
- [Importar la copia de seguridad SQL en la base de datos](sql_importing_mysql_database1.)
...
>
Si el alojamiento está "desactivado", también se desactivarán los robots de restauración automática disponibles desde el [área de cliente de OVHcloud](manager.).
...
>
> Para reactivar el alojamiento web, siga las indicaciones del apartado 4 de esta [guía](diagnostic_403_forbidden1.).
>
...
Deberá eliminar manualmente los archivos y códigos maliciosos detectados anteriormente en [el paso 2](cms_what_to_do_if_your_site_is_hacked_#step2.) de esta guía y corregir los fallos de seguridad de su sitio web.

Para conectarse al espacio de almacenamiento de su alojamiento, consulte [nuestra guía](ftp_connection1.) sobre el asunto.
...
Para más información sobre los permisos CHMOD, consulte la sección "Información útil" de nuestro [tutorial sobre el uso del cliente FTP Filezilla](ftp_filezilla_user_guide#useful-information.).
...
Proteja sus formularios de contacto al menos con un sistema de tipo "Captcha", para evitar que robots maliciosos emitan spam por este medio. Si la función "mail()" de PHP también ha sido bloqueada en su alojamiento, consulte [nuestra guía](mail_function_script_records1.) sobre este asunto para solucionar el bloqueo.
...
[Modificar la configuración de un alojamiento web](configure_your_web_hosting1.)

[Activar el firewall de aplicación](multisites_activating_application_firewall1.)
