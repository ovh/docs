...
>
> This tutorial is designed to help you with common tasks. Nevertheless, we recommend contacting a (/links/partner) or reach out to the OVHcloud community if you encounter any difficulties. We will not be able to assist you. You can find more information in the [Go further](cms_what_to_do_if_your_site_is_hacked_#go-further.) section of this guide.
>

## Requirements

- An [OVHcloud web hosting plan](hosting.) with your website hosted on it.
...
- [Change the password for accessing your OVHcloud NIC handle](manage-ovh-password1.).
- [Secure access to your OVHcloud Control Panel with two-factor authentication](secure-ovhcloud-account-with-2fa1.)
- [Change the password for accessing your Web Hosting plan’s FTP storage space](ftp_change_password1.).
- [Change the password for accessing your database](sql_change_password1.).

We also recommend using a [password manager](manage-ovh-password#use-a-password-manager.).
...
> [!warning]
>
> If you experience any difficulties carrying out the actions described below, contact a [specialist provider](partner.) in cyber security.
>

Use our guide to [your web hosting plan’s statistics and logs](logs_and_statistics1.) to search for malicious elements injected into your website. You can find the information in the web logs. 
...
>
> If you are absolutely sure that this is a malicious IP, you can block access to your hosting by following our documentation on [access restrictions via the .htaccess file](htaccess_how_to_block_a_specific_ip_address_from_accessing_your_website1.).
>
...
- [Restore your Web Hosting plan’s FTP storage space](ftp_save_and_backup1.)
- [Retrieve SQL backup of your database](sql_database_export1.)
- [Import SQL backup into your database](sql_importing_mysql_database1.)
...
>
> If your hosting system is in the "disabled" state, the automatic restoration robots available from your [OVHcloud Control Panel](manager.) will be disabled as well.
...
>
> To reactivate the Web Hosting, follow the instructions in step 4 of [this guide](diagnostic_403_forbidden1.).
>
...
>
> To reactivate Web Hosting, follow the instructions in step 4 of this [guide](diagnostic_403_forbidden1.).
>
...
You will need to manually delete the files and malicious codes previously detected in [step 2](cms_what_to_do_if_your_site_is_hacked_#step2.) of this guide, then fix your website’s security vulnerabilities.

To log in to your hosting plan’s storage space, please refer to [our guide](ftp_connection1.) on this subject.
...
You can find more details on "CHMOD" rights in the "Useful information" section of our [tutorial on using the Filezilla FTP client](ftp_filezilla_user_guide#useful-information.).
...
Secure your contact forms at a minimum by using a "Captcha" type system, to prevent malicious robots from emitting SPAM through it. If PHP’s "mail()" function has also been blocked on your web hosting plan, please refer to [our guide](mail_function_script_records1.) for information on how to resolve this block.

Please also refer to our guide on [how to secure your website](secure_your_website1.), to minimise the risk of a new hack occurring.

## Go further <a name="go-further"></a>

[Logging in to your Web Hosting plan’s storage space](ftp_connection1.)

[Modify your Web Hosting plan’s configuration](configure_your_web_hosting1.)

[Enable Application Firewall](multisites_activating_application_firewall1.)
