...
> 
> Dieses Tutorial soll Sie bei allgemeinen Aufgaben bestmöglich unterstützen. Dennoch empfehlen wir Ihnen, falls Sie Hilfe brauchen, einen [spezialisierten Dienstleister](partner.) zu kontaktieren oder Ihre Fragen in der OVHcloud Community zu stellen. Leider können wir Ihnen für administrative Aufgaben keine weitergehende technische Unterstützung anbieten. Weitere Informationen finden Sie am [Ende dieser Anleitung](cms_what_to_do_if_your_site_is_hacked_#go-further.).
>

## Voraussetzungen

- Ihre Webseite befindet sich auf einem [OVHcloud Webhosting](hosting.).
...
- [Passwort für den Zugang zu Ihrer OVHcloud Kundenkennung ändern](manage-ovh-password1.)
- [Den Zugang zu Ihrem OVHcloud Kundencenter mit Zwei-Faktor-Authentifizierung absichern](secure-ovhcloud-account-with-2fa1.)
- [Passwort für den Zugang zum FTP-Speicherplatz Ihres Webhostings ändern](ftp_change_password1.)
- [Passwort für den Zugriff auf Ihre Datenbank ändern](sql_change_password1.)

Wir empfehlen Ihnen auch die Verwendung eines [Passwort-Managers](manage-ovh-password#einen-passwort-manager-verwenden.).
...
> [!warning]
>
> Wenn Sie Schwierigkeiten haben, die unten beschriebenen Aktionen durchzuführen, wenden Sie sich an einen [spezialisierten Dienstleister](partner.) für Cyber-Sicherheit.
>

Folgen Sie unserer Anleitung zu [Statistiken und Logs Ihres Webhostings](logs_and_statistics1.), um in den "Web"-Logs nach den entsprechenden Einträgen zu suchen, die Schadcode in die Website injizieren.
...
>
> Wenn Sie absolut sicher sind, dass es sich um eine unerwünschte IP-Adresse handelt, können Sie den Zugang zu Ihrem Hosting sperren, indem Sie unsere Dokumentation zu den [Zugriffsbeschränkungen über die Datei ".htaccess"](htaccess_how_to_block_a_specific_ip_address_from_accessing_your_website1.) befolgen.
> 
...
- [FTP-Speicherplatz Ihres Webhostings wiederherstellen](ftp_save_and_backup1.)
- [SQL-Backup Ihrer Datenbank abrufen](sql_database_export1.)
- [SQL-Backup in Ihre Datenbank importieren](sql_importing_mysql_database1.)
...
>
> Wenn sich Ihr Hosting im Zustand "Disabled" befindet, wird auch die über Ihr [OVHcloud Kundencenter](manager.) verfügbare Option zur automatischen Wiederherstellung deaktiviert.
...
>
> Um das Webhosting wiederherzustellen, befolgen Sie die Anweisungen in Schritt 4 [dieser Anleitung](diagnostic_403_forbidden1.).
>
...
In [Schritt 2](cms_what_to_do_if_your_site_is_hacked_#step2.) dieser Anleitung müssen Sie die zuvor erfassten Dateien und Code manuell löschen und die Sicherheitslücken Ihrer Website korrigieren.

Um sich mit dem Speicherplatz Ihres Hostings zu verbinden, lesen Sie [unsere Anleitung](ftp_connection1.).
...
Weitere Informationen zu den "CHMOD"-Rechten finden Sie im Abschnitt "Nützliche Informationen" unseres [Tutorials zur Nutzung des FTP-Clients Filezilla](ftp_filezilla_user_guide#useful-information.).
...
Sichern Sie Ihre Kontaktformulare mindestens mit einem "Captcha"-System ab, um zu vermeiden, dass Bots SPAM über diese Methode versenden. Wenn die "mail()"-Funktion von PHP ebenfalls auf Ihrem Hosting gesperrt wurde, lesen Sie hierzu [unsere Anleitung](mail_function_script_records1.), um die Sperrung zu beheben.

Lesen Sie auch unsere Anleitung zur [Sicherung Ihrer Website](secure_your_website1.), um das Risiko eines erneuten Hacks möglichst gering zu halten.

## Weiterführende Informationen <a name="go-further"></a>

[Mit dem Speicherplatz Ihres Webhostings verbinden](ftp_connection1.)

[Konfiguration Ihres Webhostings ändern](configure_your_web_hosting1.)

[Application Firewall aktivieren](multisites_activating_application_firewall1.)

[Die Performance Ihrer Website optimieren](optimise_your_website_performance1.)
