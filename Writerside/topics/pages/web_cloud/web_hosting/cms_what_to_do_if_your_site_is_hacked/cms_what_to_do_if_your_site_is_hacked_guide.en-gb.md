...
>
> This tutorial is designed to help you with common tasks. Nevertheless, we recommend contacting a [specialist provider](partner.) or reach out to the OVHcloud community if you encounter any difficulties. We will not be able to assist you. You can find more information in the [Go further](cms_what_to_do_if_your_site_is_hacked_#go-further.) section of this guide.
>
...
You will need to manually delete the files and malicious code previously detected in [step 2](cms_what_to_do_if_your_site_is_hacked_#step2.) of this guide, then fix your website’s security vulnerabilities.
