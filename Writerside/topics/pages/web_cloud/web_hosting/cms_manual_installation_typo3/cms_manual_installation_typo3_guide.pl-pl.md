...
Aby zainstalować CMS **Typo3** na Twoim [hostingu](hosting.), należy wykonać kilka czynności przygotowawczych.
...
Wybierz nazwę bazy danych, której chcesz użyć na Twojej stronie WWW lub [utwórz nową](sql_create_database1.), a następnie kliknij przycisk `Continue`{.action}.
...
[Tworzenie bazy danych na hostingu](sql_create_database1.)
