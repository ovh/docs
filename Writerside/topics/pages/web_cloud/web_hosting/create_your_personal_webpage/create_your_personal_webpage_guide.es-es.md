...
> 
> Ponemos a su disposición esta guía para ayudarle a realizar las tareas más habituales. No obstante, si tiene alguna duda, le recomendamos que contacte con un [proveedor especializado](partner.). Nosotros no podremos asistirle. Más información en la sección ["Más información"](create_your_personal_webpage_#go-further.) de esta guía.
>

## Requisitos

- Tener un [dominio](domains.)
- Tener contratado un plan de [hosting de OVHcloud](hosting.) o un [Alojamiento gratuito 100M](domains-free-hosting.)
...
![Árbol de archivos y carpetas](create_your_personal_webpage_1.png){.thumbnail}

Consideremos un archivo en formato *PNG*. Sitúcelo en el directorio "Imágenes":

![Árbol de archivos y carpetas con imágenes](create_your_personal_webpage_2.png){.thumbnail}
...
![Resultado de código HTML en el navegador](create_your_personal_webpage_3_es.png){.thumbnail}
...
![Colocación de archivo CSS](create_your_personal_webpage_4.png){.thumbnail}
...
![Modelo de la caja CSS](create_your_personal_webpage_5.png){.thumbnail}
...
Para que sus páginas, y por tanto su sitio web, sean visibles para todo el mundo, debe guardarlas en su alojamiento (debe activar su alojamiento [como se indica en esta guía](activate_start10m1.)).
...
Para subir los archivos a su alojamiento, consulte la guía [FileZilla](ftp_filezilla_user_guide1.) utilizada.
