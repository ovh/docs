...
> 
> Este manual fornece as instruções necessárias para realizar as operações mais habituais. No entanto, se encontrar dificuldades, recomendamos que recorra a um [fornecedor especializado](partner.). Não poderemos proporcionar-lhe assistência técnica. Para mais informações, aceda à secção [Quer saber mais?](create_your_personal_webpage_#go-further.) deste manual.
>

## Requisitos

- Dispor de um [domínio](domains.)
- Ter um serviço de [alojamento web da OVHcloud](hosting.) ou um [Alojamento gratuito 100M](domains-free-hosting.)
...
![Arborescência de ficheiros e pastas](create_your_personal_webpage_1.png){.thumbnail}

Consideremos o caso de um ficheiro em formato *PNG*. Coloque-o no diretório "imagens":

![Arborescência de ficheiros e pastas com imagem](create_your_personal_webpage_2.png){.thumbnail}
...
![Resultado do código HTML no browser](create_your_personal_webpage_3_pt.png){.thumbnail}
...
![Colocação do ficheiro CSS](create_your_personal_webpage_4.png){.thumbnail}
...
![Modelo de caixa CSS](create_your_personal_webpage_5.png){.thumbnail}
...
Para que as suas páginas e, portanto, o seu site, sejam visíveis para todos, deve colocá-las no seu alojamento (deve ativar o alojamento [como indicado neste guia](activate_start10m1.)).
...
Para transferir os seus ficheiros para o seu alojamento, consulte o manual sobre a [utilização do FileZilla](ftp_filezilla_user_guide1.).
