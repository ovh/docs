...
> 
> Diese Anleitung soll Sie bei allgemeinen Aufgaben bestmöglich unterstützen. Dennoch empfehlen wir Ihnen, falls Sie Hilfe brauchen, einen [spezialisierten Dienstleister](partner.) zu kontaktieren und/oder Ihre Fragen in der OVHcloud Community zu stellen. Leider können wir Ihnen für administrative Aufgaben keine weitergehende technische Unterstützung anbieten. Weitere Informationen finden Sie am [Ende dieser Anleitung](create_your_personal_webpage_#go-further.).
>

## Voraussetzungen

- Sie verfügen über einen [Domainnamen](domains.).
- Sie haben ein [OVHcloud Webhosting](hosting.) oder ein [Kostenloses Hosting 100M](domains-free-hosting.).
...
![Ordner und Ordner](create_your_personal_webpage_1.png){.thumbnail}

Fügen Sie Dateien zum Beispiel in das Verzeichnis "Bilder" ein:

![Ordnerstruktur mit Bildern](create_your_personal_webpage_2.png){.thumbnail}
...
![HTML-Code-Ergebnis im Browser](create_your_personal_webpage_3_de.png){.thumbnail}
...
![CSS Datei platzieren](create_your_personal_webpage_4.png){.thumbnail}
...
![CSS-Modell](create_your_personal_webpage_5.png){.thumbnail}
...
Damit Ihre Seiten im Web sichtbar werden, müssen Sie sie auf Ihrem Hosting ablegen (wie in [dieser Anleitung](activate_start10m1.) beschrieben).
...
Um Ihre Dateien auf Ihrem Hosting zu speichern, lesen Sie die Anleitung zur [Verwendung von FileZilla](ftp_filezilla_user_guide1.).
