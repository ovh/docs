...
![Arborescenza file e cartelle](create_your_personal_webpage_1.png){.thumbnail}

Prendiamo un file in formato *PNG*. Inseriscilo nella directory "images":

![Arborescenza file e cartelle con immagine](create_your_personal_webpage_2.png){.thumbnail}
...
![Risultato del codice HTML sul browser](create_your_personal_webpage_3_it.png){.thumbnail}
...
![Posizionamento file CSS](create_your_personal_webpage_4.png){.thumbnail}
...
![Modello della scatola CSS](create_your_personal_webpage_5.png){.thumbnail}
...
Per rendere visibili le tue pagine e quindi il tuo sito, è necessario depositarle sul tuo hosting (è necessario attivare il tuo hosting [come indicato in questa guida](activate_start10m1.)).
...
Per salvare i tuoi file sul tuo hosting, consulta la guida sull'[utilizzo di FileZilla](ftp_filezilla_user_guide1.).
