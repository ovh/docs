...
Verwenden Sie hierzu zwei Apache-Konfigurationsdateien (HTTP), die im [FTP-Bereich](ftp_connection1.) Ihres Webhostings abzulegen sind: 

- "**.htaccess**": Weitere Informationen zu den Funktionen dieser Datei finden Sie in unserem Tutorial zu den möglichen [Operationen mit einer .htaccess Datei](htaccess_what_else_can_you_do1.).
...
> 
> Diese Anleitung soll Sie bei allgemeinen Aufgaben bestmöglich unterstützen. Dennoch empfehlen wir Ihnen, falls Sie Hilfe brauchen, einen [spezialisierten Dienstleister](partner.) zu kontaktieren und/oder Ihre Fragen in der OVHcloud Community zu stellen. Leider können wir Ihnen für administrative Aufgaben keine weitergehende technische Unterstützung anbieten. Weitere Informationen finden Sie am [Ende dieser Anleitung](htaccess_protect_directory_by_password_#go-further.).
>
...
- Sie verfügen über die Zugangsdaten zum [FTP-Bereich Ihres Hostings](ftp_connection1.).
...
>
> Wenn Sie WordPress verwenden, lesen Sie hierzu das OVHcloud Tutorial zur [Verwendung von .htaccess mit WordPress](htaccess_how_to_protect_wordpress1.).
>
> Bei Fragen zur Erstellung, Nutzung oder Programmierung Ihrer Website kann der OVHcloud Support Sie nicht unterstützen.
>
> Kontaktieren Sie hierzu unsere [User Community](https://community.ovh.com/en/) oder die [OVHcloud Partner](partner.).
>
...
> 
> Um die PHP-Version Ihrer Webseiten auf Ihrem Webhosting zu ändern, lesen Sie unsere Anleitung „[Webhosting: Laufzeitumgebung, PHP-Version, .ovhconfig](configure_your_web_hosting1.)“.
>
...
Loggen Sie sich im [FTP-Bereich](ftp_connection1.) Ihres Webhostings ein. Öffnen Sie das [Wurzelverzeichnis](multisites_configure_multisite1.), mit dem Ihr Domainname verknüpft ist.

Erstellen Sie die Datei "crypt.php" in diesem Wurzelverzeichnis.

![root_folder](root-folder.png){.thumbnail}
...
![admin-folder](admin-folder.png){.thumbnail}
...
Wenn Sie über ein Webhosting [Pro](hosting-professional-offer.) oder Webhosting [Performance](hosting-performance-offer.) verfügen, loggen Sie sich über [SSH](ssh_on_webhosting1.) in Ihr Webhosting ein. Wechseln Sie zum "**Wurzelverzeichnis**", in dem sich Ihr Skript "crypt.php" befindet.
...
> [!warning]
>
> Die Verwendung von SSH wird aus Sicherheitsgründen empfohlen. Wenn es sich bei Ihrem Hosting jedoch um ein **Starter** oder ein [Basic](hosting-personal-offer.) Webhosting handelt, ist SSH nicht verfügbar. Sie können dann die Datei "crypt.php" über Ihren Browser ausführen.
>
...
- `ftp_login`: FTP-Benutzername, den Sie verwenden, um sich mit Ihrem FTP-Speicherplatz zu verbinden. Um Ihren FTP-Login zu ermitteln, lesen Sie unsere Anleitung zum [FTP-Bereich Ihres Hostings](ftp_connection1.).
...
[Tutorial - Operationen mit .htaccess Dateien](htaccess_what_else_can_you_do1.)
...
[Tutorial - Die URL einer Website mit mod_rewrite über die .htaccess Datei umschreiben](htaccess_url_rewriting_using_mod_rewrite1.)
