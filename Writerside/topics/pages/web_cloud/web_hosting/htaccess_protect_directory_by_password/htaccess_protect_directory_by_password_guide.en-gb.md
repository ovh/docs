...
You can do this by using two Apache configuration files (HTTP) to place in [the FTP space](ftp_connection1.) of your web hosting plan: 

- "**.htaccess**": For more information on the functionalities of this file, please read our tutorial on [Operations achievable with a .htaccess file](htaccess_what_else_can_you_do1.).
...
> 
> This guide is designed to help you with common tasks. Nevertheless, we recommend contacting a [specialist provider](partner.) and/or the service’s software publisher if you encounter any difficulties. We will not be able to assist you. You can find more information in the ["Go further"](htaccess_protect_directory_by_password_#go-further.) section of this guide.
>
...
- The login details to access [your web hosting plan’s FTP storage space](ftp_connection1.)
...
>
> If you are using a WordPress CMS, OVHcloud also provides a tutorial on how to [use the .htaccess file with WordPress](htaccess_how_to_protect_wordpress1.).
>
...
>
> To do this, contact our [user community](https://community.ovh.com/en/) or [OVHcloud partners](partner.).
>
...
> 
> To modify the PHP version of your websites on your web hosting plan, please refer to our guide: [Web Hosting: Environment, PHP version, .ovhconfig](configure_your_web_hosting1.).
>
...
Log in to [the FTP storage space](ftp_connection1.) of your web hosting plan. Open the [root folder](multisites_configure_multisite1.) that your domain name points to.
...
If you have a [Pro](hosting-professional-offer.) or [Performance](hosting-performance-offer.) hosting plan, then log in with [SSH](ssh_on_webhosting1.) to your web hosting. Go to the **root folder** where your script “crypt.php” is located.
...
> [!warning]
>
> For security reasons, SSH is recommended. However, if you have a **Starter** solution or a [Personal](hosting-personal-offer.) hosting plan where SSH is unavailable, you can also run the "crypt.php" file via your web browser.
>
...
- `your_ftp_login`: The FTP username used to log in to your FTP storage space. To retrieve your FTP login, please refer to our guide on [logging in to your FTP space](ftp_connection1.).
...
[Logging in to your Web Hosting plan’s FTP space](ftp_connection1.)

[Tutorial - Operations achievable with a .htaccess file](htaccess_what_else_can_you_do1.)

[Tutorial - How do I block access to my website for certain IP addresses via a .htaccess file?](htaccess_how_to_block_a_specific_ip_address_from_accessing_your_website1.)

[Tutorial - Rewrite the URL for accessing your website](htaccess_url_rewriting_using_mod_rewrite1.)
