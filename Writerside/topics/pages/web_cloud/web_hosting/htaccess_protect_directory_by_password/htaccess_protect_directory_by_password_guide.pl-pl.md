...
Używając dwóch plików konfiguracyjnych (HTTP) Apache do umieszczenia w [przestrzeni FTP](ftp_connection1.) Twojego hostingu www: 

- "**.htaccess**": aby uzyskać więcej informacji na temat funkcjonalności tego pliku, zapoznaj się z naszym tutorial ["Operacje możliwe do wykonania za pomocą pliku ".htaccess"](htaccess_what_else_can_you_do1.).
...
> 
> Oddajemy w Twojej ręce niniejszy przewodnik, którego celem jest pomoc w jak najlepszym wykonywaniu bieżących zadań. W przypadku trudności zalecamy skorzystanie z pomocy [wyspecjalizowanego usługodawcy](partner.) i/lub kontakt z producentem oprogramowania. Niestety firma OVHcloud nie będzie mogła udzielić wsparcia w tym zakresie. Więcej informacji znajduje się w sekcji ["Sprawdź również"](htaccess_protect_directory_by_password_#go-further.) niniejszego przewodnika.
>
...
- Posiadanie danych do logowania do [przestrzeni FTP Twojego hostingu](ftp_connection1.)
...
>
> Jeśli korzystasz z CMS WordPress, OVHcloud udostępnia również tutorial, w jaki sposób [używać pliku htaccess przy użyciu WordPress](htaccess_how_to_protect_wordpress1.).
>
...
>
> W tym celu skontaktuj się z naszą [społecznością użytkowników](https://community.ovh.com/en/) lub naszymi [partnerami OVHcloud](partner.).
>
...
> 
> Aby zmienić wersję PHP swoich stron www na Twoim hostingu, zapoznaj się z naszym przewodnikiem "[Hosting WWW : środowisko, wersja PHP, .ovhconfig](configure_your_web_hosting1.)".
>
...
Zaloguj się do [przestrzeni dyskowej FTP](ftp_connection1.) Twojego hostingu. Otwórz ["katalog główny"](multisites_configure_multisite1.), do którego wskazuje Twoja domena.
...
Jeśli dysponujesz hostingiem [Pro](hosting-professional-offer.) lub [Performance](hosting-performance-offer.), zaloguj się do hostingu za pomocą [SSH](ssh_on_webhosting1.). Przejdź do "**katalog główny**", w którym znajduje się Twój skrypt "crypt.php".
...
> [!warning]
>
> Ze względów bezpieczeństwa zaleca się korzystanie z SSH. Jeśli jednak dysponujesz usługą **Starter** lub [Perso](hosting-personal-offer.), dla której SSH jest niedostępny, możesz również uruchomić plik "crypt.php" za pomocą przeglądarki internetowej.
>
...
- `your_ftp_login`: login FTP, którego używasz do logowania się do przestrzeni dyskowej FTP. Aby pobrać login FTP, zapoznaj się z naszym przewodnikiem dotyczącym [logowania do przestrzeni FTP](ftp_connection1.).
...
[Logowanie do przestrzeni FTP hostingu WWW](ftp_connection1.)

[Przewodnik - Operacje możliwe do wykonania za pomocą pliku ".htaccess"](htaccess_what_else_can_you_do1.)

[Zablokuj dostęp do mojej strony dla niektórych adresów IP przez plik .htaccess](htaccess_how_to_block_a_specific_ip_address_from_accessing_your_website1.)

[Prześlij link dostępowy do mojej strony za pomocą mod_rewrite za pomocą pliku .htaccess](htaccess_url_rewriting_using_mod_rewrite1.)
