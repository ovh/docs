...
Utilizando dos archivos de configuración (HTTP) Apache que quiere situar en [el espacio FTP](ftp_connection1.) de su alojamiento web: 

- "**.htaccess**": para más información sobre las funcionalidades de este fichero, consulte nuestro tutorial sobre ["Operaciones realizables con un fichero ".htaccess"](htaccess_what_else_can_you_do1.).
...
- Disponer de las claves de conexión al [espacio FTP de su alojamiento](ftp_connection1.).
...
>
Si utiliza un CMS WordPress, OVHcloud también pone a su disposición un tutorial sobre [cómo utilizar el archivo htaccess con WordPress](htaccess_how_to_protect_wordpress1.).
...
>
> Para ello, contacte con nuestra [comunidad de usuarios](https://community.ovh.com/en/) o nuestros [partners de OVHcloud](partner.).
>
...
> 
> Para modificar la versión de PHP de sus sitios web en su alojamiento web, consulte nuestra guía "[Web hosting : entorno, versión PHP, .ovhconfig](configure_your_web_hosting1.)".
>
...
Conéctese al [espacio de almacenamiento FTP](ftp_connection1.) de su alojamiento web. Abra el ["directorio raíz"](multisites_configure_multisite1.) hacia el que apunte su nombre de dominio.
...
Si dispone de un alojamiento [Pro](hosting-professional-offer.) o [Performance](hosting-performance-offer.), conéctese a su alojamiento web en [SSH](ssh_on_webhosting1.). Vaya a la carpeta "**raíz*" en la que se encuentra su script "crypt.php".
...
> [!warning]
>
> Por motivos de seguridad, se recomienda el uso del SSH. No obstante, si tiene un producto **Starter** o [Perso](hosting-personal-offer.) en el que el SSH no está disponible, puede igualmente ejecutar el fichero "crypt.php" a través de su navegador web.
>
...
- `your_ftp_login` : el login FTP que utiliza para conectarse a su espacio de almacenamiento FTP. Para obtener su login FTP, consulte nuestra guía sobre [conexión a su espacio FTP](ftp_connection1.).
...
[Conectarse al espacio FTP de un alojamiento web](ftp_connection1.)

[Tutorial - Operaciones viables con un fichero ".htaccess"](htaccess_what_else_can_you_do1.)
...
[Reescribir la URL de acceso a mi sitio web gracias al mod_rewrite a través del archivo .htaccess](htaccess_url_rewriting_using_mod_rewrite1.)
