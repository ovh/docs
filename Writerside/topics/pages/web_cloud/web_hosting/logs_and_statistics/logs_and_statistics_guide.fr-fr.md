...
>
> N'hésitez pas à contacter un [prestataire spécialisé](partner.) si vous éprouvez des difficultés.
>
...
- **Logs CRON** : retrouvez ici les résultats de l'exécution de vos tâches planifiées [(CRON)](cron_tasks1.) sur votre hébergement web.
...
> [!warning]
>
> Si vous avez activé les logs séparés sur une [entrée multisite](multisites_configure_multisite1.), les utilisateurs créés ici ne peuvent pas accéder aux statistiques de cette entrée multisite spécifique.
>
