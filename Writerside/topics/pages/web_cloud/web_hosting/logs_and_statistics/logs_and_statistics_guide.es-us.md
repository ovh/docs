...
>
> No dude en contactar con un [proveedor especializado](partner.) si tiene alguna duda.
>
...
- **Logs CRON**: consulte aquí los resultados de la ejecución de sus tareas planificadas [(CRON)](cron_tasks1.) en su alojamiento web.
...
> [!warning]
>
> Si ha activado los logs separados en una [entrada multisitio](multisites_configure_multisite1.), los usuarios creados aquí no podrán acceder a las estadísticas de esa entrada multisitio específica.
>
