...
>
> In caso di difficoltà o dubbi, contatta il tuo [provider specializzato](partner.).
>
...
- **Logs CRON**: visualizza qui i risultati dell’esecuzione delle operazioni pianificate [(CRON)](cron_tasks1.) sul tuo hosting Web.
...
> [!warning]
>
> Se i log separati sono stati abilitati su una [voce multisito](multisites_configure_multisite1.), gli utenti creati qui non potranno accedere alle statistiche relative a tale voce multisito specifica.
>
