...
Este guia mostra-lhe as etapas para exportar todos os elementos do seu website para o formato padrão, a partir de um [alojamento web OVHcloud.](hosting.){.external}.

**Descubra como exportar o seu website OVHcloud.**

## Requisitos

- Ter um [plano de alojamento web OVHcloud](hosting.){.external}.
- Estar ligado à [Área de Cliente OVHcloud](manager.){.external}.
...
Estes elementos foram-lhe enviados no e-mail enviado após a instalação do seu alojamento web. Se não possuir estas informações, aceda à [Área de Cliente OVHcloud](manager.){.external}, na secção “Web”, e clique em `Alojamentos`{.action}. De seguida, selecione o nome do alojamento correspondente e aceda ao separador `FTP - SSH`{.action}. 

![export-website](tab-pro.png){.thumbnail}

Aparecerá a informação relativa ao seu espaço de armazenamento e terá a possibilidade de encontrar os elementos necessários para aceder mesmo. Caso seja necessário, consulte o nosso manual: [“Aceder ao espaço de armazenamento do alojamento web”](ftp_connection1.){.external}. Caso tenha perdido a palavra-passe, consulte o manual ["Modificar a palavra-passe de um utilizador FTP"](ftp_change_password1.){.external}.
...
- **Utilizar um programa compatível com o protocolo FTP ou SFTP**: terá de instalar no seu computador um programa compatível, como o [ FileZilla ](ftp_filezilla_user_guide1.). Sugerimos que contacte o editor do programa instalado caso deseje obter ajuda na sua utilização, OVHcloud não criou esse programa;

- **Utilizar um acesso SSH**: terá de utilizar comandos a partir de um terminal para interagir com o seu espaço de armazenamento. Este tipo de acesso requer conhecimentos mais avançados, bem como um [plano de alojamento web da OVHcloud](hosting.){.external} específica. Para mais informações, pode consultar o nosso guia  ["Utilizar o acesso SSH do seu alojamento web"](ssh_on_webhosting1.){.external}. 
...
["Recuperar o backup da base de dados de um alojamento web"](sql_database_export1.){.external}.

Se utiliza uma base de dados **Web Cloud Databases** para o seu website, consulte a secção dedicada ao backup no nosso guia:
[Backup e exportação de uma base de dados no servidor de bases de dados](save-export-on-database-server1.).
...
[Alterar a palavra-passe de um utilizador FTP](ftp_change_password1.)

[Utilização do programa FileZilla com o seu alojamento](ftp_filezilla_user_guide1.)

[Utilizar o acesso SSH do seu alojamento web](ssh_on_webhosting1.)

[Recuperar o backup da base de dados de um alojamento web](sql_database_export1.)

[Web Cloud Databases - primeira utilização](starting_with_clouddb1.)
