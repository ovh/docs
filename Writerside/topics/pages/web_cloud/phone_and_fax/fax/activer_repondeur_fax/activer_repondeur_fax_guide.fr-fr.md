...
Connectez-vous à votre [espace client OVHcloud](manager-telecom.) puis sélectionnez `Télécom`{.action}. Cliquez sur `Téléphonie`{.action} puis sur le groupe ou se trouve votre ligne Fax. Sélectionnez cette dernière.

![gestion répondeur](gestion-repondeur.png){.thumbnail}
...
![activer répondeur](activer-desactiver-repondeur.jpg){.thumbnail}
...
![mot de passe](mot-de-passe-repondeur.jpg){.thumbnail}
...
![notifications](configuration-repondeur.png){.thumbnail}
...
![ecoute messages](messages.jpg){.thumbnail}
