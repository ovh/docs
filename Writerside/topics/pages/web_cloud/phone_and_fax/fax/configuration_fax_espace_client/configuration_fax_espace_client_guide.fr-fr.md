...
![mot de passe fax](motdepassefax.png){.thumbnail}
...
![menu fax](configuration-fax.png){.thumbnail}
...
![notifications](options_de_notifications.jpg){.thumbnail}
...
![adresses de notification](adresses_notifications.png){.thumbnail}
...
![filtrage fax](filtrage_menu.png){.thumbnail}
...
![filtrage fax](regles_filtrage.png){.thumbnail}
