...
- Disposer d'un accès à la gestion de la ligne SIP concernée depuis votre [espace client OVHcloud](manager.){.external}, partie `Télécom`{.action}.
...
Pour démarrer la manipulation, connectez-vous à votre [espace client OVHcloud](manager.){.external}, partie Télécom. Cliquez sur `Téléphonie`{.action} puis sélectionnez la ligne SIP concernée.

Positionnez-vous sur l'onglet `Gestion des appels`{.action} et cliquez sur `Verrouillage des appels sortants`{.action}.

![gerer-appels-verrouillage](manage-calls-locking-step1.png){.thumbnail}
...
![gerer-appels-verrouillage](manage-calls-locking-step2.png){.thumbnail}
...
> [!primary]
>
> Si vous souhaitez renvoyer les appels **en fonction de plages horaires**, consultez notre guide « [Configurer des plages horaires et des fermetures exceptionnelles sur une ligne](configure-time-slot-and-closing-time1.)».
>
...
![gerer-appels-renvoi](manage-calls-fowarding-step1.png){.thumbnail}
...
![gerer-appels-renvoi](manage-calls-fowarding-step2.png){.thumbnail}
...
![gerer-appels-filtrage](manage-calls-filtering-step1.png){.thumbnail}
...
![gerer-appels-filtrage](manage-calls-filtering-step2.png){.thumbnail}
...
![gerer-appels-filtrage](manage-calls-filtering-step3.png){.thumbnail}
