...
- Disposer d'un [numéro alias](telephonie-numeros.){.external} dans votre compte OVHcloud.
...
> Consultez notre [FAQ](faq-voip1.) pour plus d'informations sur les différences entre un numéro alias et une ligne SIP.
>

## En pratique

Connectez-vous à votre [espace client OVHcloud](manager.){.external}, dans la section `Télécom`{.action}.<br>
...
![fileappels](2022-VoIP-FA-01.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-02.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-03.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-04.png){.thumbnail}

Complétez ensuite les informations demandées.

![fileappels](2022-VoIP-FA-05.png){.thumbnail}
...
> - Les redirections vers un numéro mobile ou une ligne externe à OVHcloud ne sont pas comprises dans les [forfaits VoIP](telephonie-voip-offers.). Elles sont donc facturées à la seconde, sauf dans le cadre des forfaits mobile à l’heure.
>
> Consultez les [tarifs de la téléphonie OVHcloud](telephonie-decouvrez-tarifs-telephonie.) pour plus de détails.
...
![fileappels](2022-VoIP-FA-06.png){.thumbnail}

- **« Numéro à afficher »** : définissez le numéro qui sera visible sur le téléphone de la personne qui reçoit l’appel ;

- **« Stratégie de sonnerie »** : définissez la manière dont les lignes de votre file d'appels sonneront. Selon celle choisie, vous serez peut-être amené à [modifier l'ordre des lignes de la file](les_files_d_appels#3-organiser-les-lignes-de-la-file-dappels.) ;
...
![fileappels](2022-VoIP-FA-07.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-08.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-09.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-10.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-11.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-12.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-13.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-14.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-15.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-16.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-17.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-18.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-19.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-20.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-20bis.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-21.png){.thumbnail}
...
![fileappels](2022-VoIP-FA-22.png){.thumbnail}
