...
- [Disposer des identifiants de votre ligne SIP OVHcloud](register-sip-softphone1.)
...
![proxy zoiper](zoiper03.png){.thumbnail}
...
![protocole zoiper](zoiper04.png){.thumbnail}

Un message de succès de l'enregistrement de la ligne est alors présenté.

![protocole zoiper](zoiper05.png){.thumbnail}

Vous pouvez dès lors être joint et composer des appels depuis votre ligne SIP OVHcloud.

![enregistrement zoiper](zoiper06.png){.thumbnail}

### Dépannage

Si l'enregistrement a échoué, vérifiez que vous avez bien saisi les identifiants SIP OVHcloud, notamment le mot de passe SIP. En cas d'échecs répétés, [modifiez votre mot de passe SIP depuis l'espace client OVHcloud](modifier-mot-de-passe-ligne-sip1.) et refaites un essai d'enregistrement avec un nouveau mot de passe SIP.

Vérifiez également que l'adresse IP depuis laquelle vous utilisez Zoiper fait partie des adresses IP autorisées à utiliser votre ligne SIP. Pour plus de détails, consultez le guide [Restreindre sa ligne SIP OVHcloud par IP](secure-sip-line-ovh1.).

Vous pouvez aussi tester l'enregistrement de votre ligne [sur un autre softphone](register-sip-softphone-linphone1.).

## Aller plus loin

[Utiliser une ligne SIP OVHcloud sur un softphone](register-sip-softphone1.)

[Utiliser une ligne SIP OVHcloud sur Linphone](register-sip-softphone-linphone1.)
