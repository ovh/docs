...
- Être connecté à l'[espace client OVHcloud](manager-telecom.).
- Disposer de [lignes SIP OVHcloud](telephonie-voip.) et/ou de [numéros alias OVHcloud](telephonie-numeros.).

## En pratique

Afin d'accéder à la gestion des groupes de téléphonie, connectez-vous à votre [espace client OVHcloud](manager-telecom.). Dans la partie `Télécom`{.action}, cliquez sur `Téléphonie`{.action}.

Les différents groupes apparaissent alors. Cliquez sur un groupe pour afficher la liste des services qu'il contient.

![groupes de téléphonie](00-groupes.png){.thumbnail}
...
![renommer groupe](01-renommer.png){.thumbnail}
...
![ajouter groupe](02-ajouter-01.png){.thumbnail}
...
![ajouter groupe](02-ajouter-02.png){.thumbnail}
...
![regrouper lignes](03-regrouper-01.png){.thumbnail}
...
![regrouper lignes](03-regrouper-02.png){.thumbnail}
...
|---|---| 
|![groupe VoIP classique](03-regrouper-03.png){.thumbnail}|![groupe ovhtel](03-regrouper-04.png){.thumbnail}|
...
![options du groupe](options-groupe.png){.thumbnail}
...
![supprimer groupe](04-supprimer.png){.thumbnail}
...
![supprimer groupe](05-annuler-suppression.png){.thumbnail}
