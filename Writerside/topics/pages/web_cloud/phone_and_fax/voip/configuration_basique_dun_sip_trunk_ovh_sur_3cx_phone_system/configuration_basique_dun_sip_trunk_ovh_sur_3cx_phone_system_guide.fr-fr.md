...
- Un [SIP Trunk OVHcloud](telephonie-sip-trunk.)
- Deux [alias configurés](redirection_avec_presentation1.) en DDI (Redirection avec présentation du numéro)
- Un [softphone](register-sip-softphone1.) ou un téléphone SIP
...
>
> Nous mettons à votre disposition ce guide afin de vous accompagner au mieux sur des tâches courantes. Néanmoins, nous vous recommandons de faire appel à un [prestataire spécialisé](https://partner.ovhcloud.com/fr/) et/ou de contacter l'éditeur du service si vous éprouvez des difficultés. En effet, nous ne serons pas en mesure de vous fournir une assistance. Plus d'informations dans la section [« Aller plus loin »](configuration_basique_dun_sip_trunk_ovh_sur_3cx_phone_system_#go-further.) de ce guide.
>
...
![3CX Phone Systeme](3cx_phone_system-login.png){.thumbnail}

- Cliquez sur `Trunk SIP`{.action}.

![3CX Phone Systeme](3cx_phone_system-trunk01.png){.thumbnail}

- Cliquez sur `Ajouter un Trunk SIP`{.action}.

![3CX Phone Systeme](3cx_phone_system-trunk02.png){.thumbnail}
...
![3CX Phone Systeme](3cx_phone_system-trunk03.png){.thumbnail}
...
![3CX Phone Systeme](3cx_phone_system-trunk04.png){.thumbnail}
...
![3CX Phone Systeme](3cx_phone_system-trunk07.png){.thumbnail}
...
![3CX Phone Systeme](3cx_phone_system-trunk05.png){.thumbnail}
...
![3CX Phone Systeme](3cx_phone_system-trunk06.png){.thumbnail}
...
![3CX Phone Systeme](3cx_phone_system-trunk08.png){.thumbnail}
