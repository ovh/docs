...
Pour débuter la manipulation, connectez-vous à votre [espace client OVHcloud](manager-telecom.){.external} et assurez-vous de vous situer dans la partie `Télécom`{.action}. Cliquez sur `Téléphonie`{.action}, sélectionnez votre groupe de téléphonie puis le numéro à configurer.
...
![configurationnumeroalias](alias-config1-2022.png){.thumbnail}
...
![configurationnumeroalias](alias-config2.png){.thumbnail}
...
Cette configuration est accessible en mode simple uniquement. Reportez-vous aux instructions décrites dans notre documentation « [Configurer une redirection d’appels](redirection_avec_presentation1.){.external} » si vous désirez en apprendre plus.
...
Cette configuration n'est accessible qu'en mode simple. Reportez-vous aux instructions décrites dans notre documentation « [Configurer une file d’appels](les_files_d_appels1.) » si vous désirez en apprendre plus.
...
Cette configuration n'est accessible qu'en mode simple uniquement. Reportez-vous aux instructions décrites dans notre documentation « [Créer et gérer des conférences téléphoniques](conference1.) » si vous désirez en apprendre plus.
...
Cette configuration n'est accessible qu'en mode simple. Consultez notre guide « [Configurer un serveur vocal interactif (SVI)](svi_serveur_vocal_interactif1.) » si vous en désirez en apprendre plus.
...
Cette configuration n'est accessible qu'en mode expert. Consultez notre guide « [Configurer un Contact Center Solution](contact-center-solution1.) » si vous en désirez en apprendre plus.
