...
![assistant zoiper](linphone01.png){.thumbnail}
...
![connexion zoiper](linphone02.png){.thumbnail}

Si la connexion a réussi, la notification `Connecté` apparaît en haut de l'application. 

![connexion réussie zoiper](linphone03.png){.thumbnail}
...
Vérifiez également que l'adresse IP depuis laquelle vous utilisez Linphone fait partie des adresses IP autorisées à utiliser votre ligne SIP. Pour plus de détails, consultez le guide [Restreindre sa ligne SIP OVHcloud par IP](secure-sip-line-ovh1.).

Vous pouvez aussi tester l'enregistrement de votre ligne [sur un autre softphone](register-sip-softphone-zoiper1.).

## Aller plus loin

[Utiliser une ligne SIP OVHcloud sur un softphone](register-sip-softphone1.)

[Enregistrer une ligne SIP OVHcloud sur Zoiper](register-sip-softphone-zoiper1.)
