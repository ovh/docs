...
- A [Public Cloud project](public-cloud.) in your OVHcloud account. You can find more information in our guide [Creating your first Public Cloud project](create_a_public_cloud_project1.).
...
>
> This tutorial is designed to help you with common tasks. Nevertheless, we recommend contacting a [specialist provider](partner.) and/or the service’s publisher if you encounter any difficulties. We will not be able to assist you. You can find more information in the ["Go further"](deployer_3cx_sur_public_cloud_#go-further.) section of this guide.
>
...
Log in to your [OVHcloud Control Panel](manager.) and click on the `Public Cloud`{.action} menu.
...
![choosing a flavor](flavor.png){.thumbnail}

Then select the operating system. To date, 3CX uses Debian 10.

![OS selection](os.png){.thumbnail}
...
![adding script](scriptPostInstall.png){.thumbnail}
...
[All you need to know to get started with Public Cloud](00-essential-info-to-get-started-on-public-cloud1.)

[Familiarise yourself with the Public Cloud interface](03-public-cloud-interface-walk-me1.)

[Create your first OVHcloud Public Cloud project](create_a_public_cloud_project1.)

[Creating and connecting to your first Public Cloud instance](public-cloud-first-steps1.)

For specialized services (SEO, development, etc.), contact [OVHcloud partners](partner.).

If you would like assistance with using and configuring your OVHcloud solutions, we recommend referring to our range of [support solutions](support.).
