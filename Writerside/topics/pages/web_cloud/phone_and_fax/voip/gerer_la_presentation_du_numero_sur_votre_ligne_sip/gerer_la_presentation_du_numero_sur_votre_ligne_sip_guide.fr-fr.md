...
- Disposer de (au choix) :
    - deux [lignes VoIP OVHcloud](telephonie-voip.){.external};
    - une [ligne VoIP OVHcloud](telephonie-voip.) et un [numéro alias OVHcloud](telephonie-numeros.);
    - une [ligne Trunk](telephonie-sip-trunk.);
...
Pour démarrer la manipulation, connectez-vous à votre [espace client OVHcloud](manager.){.external}, partie `Télécom`. Cliquez sur `Téléphonie`{.action} puis sélectionnez la ligne concernée.

Positionnez-vous sur l'onglet `Gestion des appels`{.action} et cliquez sur `Présentation du numéro`{.action}.

![configurer-presentation-numero](display-incoming-call-step1.png){.thumbnail}
...
![configurer-presentation-numero](display-incoming-call-step2.png){.thumbnail}
...
Connectez-vous à votre [espace client OVHcloud](manager.), partie Télécom. Cliquez sur `Téléphonie`{.action} puis sélectionnez le groupe de téléphonie concerné et enfin la ligne Trunk.

Positionnez-vous sur l'onglet `Gestion des appels`{.action} et cliquez sur `Présentation du numéro`{.action}.

![configurer-presentation-numero-trunk](display-incoming-call-trunk-step1.png){.thumbnail}
...
![configurer-presentation-numero-trunk](display-incoming-call-trunk-anonymous-step1.png){.thumbnail}
...
![configurer-presentation-numero-trunk](display-incoming-call-trunk-step2.png){.thumbnail}
...
> 
> - le numéro pour lequel vous souhaitez modifier la présentation dispose bien d'une redirection avec présentation. Si besoin, reportez-vous aux instructions décrites dans notre documentation [Créer une redirection avec présentation](redirection_avec_presentation1.).
>
...
Depuis votre [espace client OVHcloud](manager.), partie `Télécom`. Cliquez sur `Téléphonie`{.action} puis sélectionnez le groupe de téléphonie concerné et enfin la ligne Trunk..
...
![désactiver-anonyme](display-incoming-call-trunk-anonymous-step7.png){.thumbnail}
...
![configurer-presentation-numero-trunk](display-incoming-call-trunk-step3.png){.thumbnail}
...
![configurer-presentation-numero-trunk](display-incoming-call-trunk-step4.png){.thumbnail}
...
![configurer-presentation-numero-trunk](display-incoming-call-trunk-step5.png){.thumbnail}
