...
- Disposer d’un [numéro alias](telephonie-numeros.){.external} ou d'une [ligne VoIP OVHcloud](telephonie.){.external}.
...
Connectez-vous à votre [espace client OVHcloud](manager.){.external}, partie `Télécom`. Cliquez sur `Téléphonie`{.action} puis sélectionnez la ligne ou le numéro OVHcloud concerné.
...
![telephonedirectory](manage-telephone-directory-step1.png){.thumbnail}
...
![telephonedirectory](manage-telephone-directory-step2.png){.thumbnail}
...
Vous avez la possibilité de suivre la parution de vos informations dans les annuaires en ligne depuis votre [espace client OVHcloud](manager.){.external}, partie `Télécom`. Pour cela, une fois connecté, positionnez-vous sur l'onglet `Coordonnées`{.action} de la ligne ou du numéro OVHcloud concerné.
...
![telephonedirectory](manage-telephone-directory-step3.png){.thumbnail}
