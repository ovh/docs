...
- Disposer d'une [ligne OVHcloud avec un forfait compatible](telephonie-voip.){.external} ou d'une ligne Trunk.
- Disposer d'un accès à la gestion de la ligne concernée depuis votre [espace client OVHcloud](manager.){.external}, partie `Télécom`{.action}.
...
Pour démarrer la manipulation, connectez-vous à votre [espace client OVHcloud](manager.){.external}, partie Télécom. Cliquez sur `Téléphonie`{.action} dans la barre de services à gauche, puis sélectionnez la ligne concernée.

Positionnez-vous sur l'onglet `Gestion des appels`{.action} et cliquez sur `Gérer les plages horaires`{.action}.

![gerer-plages-horaires](manage-time-slot-step1.png){.thumbnail}
...
![gerer-plages-horaires](manage-time-slot-step2.png){.thumbnail}
...
Sachez que les communications vers un numéro non enregistré chez OVHcloud (externe) seront décomptées de votre forfait ou facturées selon le [forfait auquel vous avez souscrit](telephonie-voip.){.external} (voir la note en bas de page) et [les tarifs en vigueur](telephonie-decouvrez-tarifs-telephonie.){.external}.

![gerer-plages-horaires](manage-time-slot-step3.png){.thumbnail}
...
![gerer-plages-horaires](manage-time-slot-step4.png){.thumbnail}
...
![gerer-plages-horaires](manage-time-slot-step5.png){.thumbnail}
...
> [!primary]
>
> Les fermetures exceptionnelles complètent [vos plages horaires paramétrées](configure-time-slot-and-closing-time#gerer-les-plages-horaires.){.external}. Il est donc indispensable que ces dernières soient activées pour que les fermetures exceptionnelles s’appliquent.
>
...
![gerer-fermetures-exceptionnelles](manage-closing-time-step1.png){.thumbnail}
...
![gerer-fermetures-exceptionnelles](manage-closing-time-step2.png){.thumbnail}
