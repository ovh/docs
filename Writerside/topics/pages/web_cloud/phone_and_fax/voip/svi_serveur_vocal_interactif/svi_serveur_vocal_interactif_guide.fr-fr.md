...
|---|---|---|
|![menu numéro](menu-numero-svi.png){.thumbnail}|![menu configuration](menu-configuration-svi.png){.thumbnail}|![menu étape](menu-etape-svi.png){.thumbnail}|
...
![gérer les sons](gerer-sons-svi.png){.thumbnail}
...
![gérer les menus](gerer-menus-svi.png){.thumbnail}

Sur la nouvelle page qui s'affiche, cliquez sur `+ Ajouter un menu interactif`{.action}.

![sviconfiguration](svi-menu-creation.png){.thumbnail}
...
![sviconfiguration](svi-menu-creation-entree.png){.thumbnail}
...
![sviconfiguration](svi-sous-menu.png){.thumbnail}
...
![sviconfiguration](svi-etape2021.png){.thumbnail}
...
![sviconfiguration](svi-action2021.png){.thumbnail}
...
![sviconfiguration](svi-action2021b.png){.thumbnail}
...
![svi conditions](svi-conditions2021.png){.thumbnail}

Le menu qui apparaît vous permet de définir jusqu'à trois types de conditions.

![svi conditions](svi-conditions2021b.png){.thumbnail}
...
![SVI conditions exemple](exemple-svi-plages2021.png){.thumbnail}

Poursuivez la lecture de ce guide selon la condition que vous désirez paramétrer :

- [Condition de « Jours exceptionnels »](svi_serveur_vocal_interactif_#condition-de-jours-exceptionnels.)
- [Condition de « Plages horaires génériques »](svi_serveur_vocal_interactif_#condition-de-plages-horaires-generiques.)
- [Condition de « Filtrages d'appels »](svi_serveur_vocal_interactif_#condition-de-filtrages-dappels.)
...
![SVI - jours exceptionnels](images_creneaux-activation2021.png){.thumbnail}
...
![gérer créneaux exceptionnels](svi-creneaux2021.png){.thumbnail}
...
![gérer fermetures exceptionnels](images_creneaux2021.png){.thumbnail}
...
![SVI plages horaires](plages-svi2021.gif){.thumbnail}
...
![SVI -filtrages](images_filtrages2021.png){.thumbnail}
