...
- Disposer d'une [ligne SIP OVHcloud](telephonie-voip.){.external} (Découverte ou Entreprise).
...
![securiser-sip](restriction01.png){.thumbnail}
...
![securiser-sip](restriction02.png){.thumbnail}
...
![securiser-sip](restriction03.png){.thumbnail}
...
Pour y accéder, connectez-vous à votre [espace client OVHcloud](manager.){.external}, partie Télécom. Cliquez sur `Téléphonie`{.action} puis sélectionnez la ligne SIP pour laquelle vous souhaitez récupérer les logs.

Positionnez-vous ensuite sur l'onglet `Assistance`{.action} puis cliquez sur le bouton `Consultation des notifications`{.action}.

![securiser-sip](restriction04.png){.thumbnail}
...
![securiser-sip](secure-sip-part5.png){.thumbnail}
...
![securiser-sip](secure-sip-part6.png){.thumbnail}
