...
Pour débuter la manipulation, connectez-vous à votre [espace client OVHcloud](manager.){.external} et assurez-vous de vous situer dans la section `Télécom`. Cliquez sur `Téléphonie`{.action} dans la barre de services à gauche, puis sélectionnez la ligne SIP concernée parmi celles qui s'affichent. 
...
![passwordsip](password-sip-step1.png){.thumbnail}
...
![passwordsip](password-sip-step2.png){.thumbnail}
...
[Tutoriel - Utiliser une ligne SIP OVHcloud sur un softphone](register-sip-softphone1.)
