...
Le Contact Center Solution (CCS) est la configuration la plus complète applicable à un numéro alias. Elle permet notamment de combiner les configurations avancées que sont la [file d'appels](les_files_d_appels1.) et le [serveur vocal interactif (SVI)](svi_serveur_vocal_interactif1.).
...
- Disposer d'un [numéro alias](telephonie-numeros.){.external}.
...
|File|Une file est un groupe d'agents, sur le principe de la [file d'appels](les_files_d_appels1.). La file permet de faire sonner ces agents selon une stratégie à définir.|
|Menu interactif|Un menu interactif propose à l'appelant des choix de touches pour faire sonner un agent/une file ou jouer un son, sur le principe du [serveur vocal interactif (SVI)](svi_serveur_vocal_interactif1.).|
...
Connectez-vous à votre [espace client OVHcloud](manager-telecom.){.external}, partie `Télécom`{.action}.<br>
...
![contact-center-solution](ccs-config-2022.png){.thumbnail}
...
![contact-center-solution](ccs-step1-1b.png){.thumbnail}
...
![contact-center-solution](options-affichage.png){.thumbnail}

Le plan de configuration contient différents menus.

|Menu du numéro|Menu de la configuration|Menu d'étape|
|---|---|---|
|![menu numéro](menu-numero2021.png){.thumbnail}|![menu configuration](menu-configuration2021.png){.thumbnail}|![menu étape](menu-etape2021.png){.thumbnail}|
|Permet de gérer les options principales de la configuration.|Permet de gérer les étapes du plan ainsi que les [options des appels](contact-center-solution_#options.).|Permet d'ajouter des actions au sein d'une étape ainsi que des conditions d'exécution de l'étape.|
...
![gérer les sons](gerer-sons2021.png){.thumbnail}
...
![gérer les TTS](gerer-tts2021.png){.thumbnail}
...
![gérer les TTS](gerer-tts2021b.png){.thumbnail}
...
Leur fonctionnement est identique à la configuration [File d'appels](les_files_d_appels1.) applicable directement sur un numéro alias.
...
![contact-center-solution](gerer-agents2021.png){.thumbnail}
...
|-----|---|
|**Ligne SIP interne**<br><br>![ligne SIP interne](agent-interne2021.png){.thumbnail}|Pour ajouter une ligne SIP interne, cliquez sur la loupe à droite du champ « Numéro ».<br><br>Dans le menu qui s'affiche, sélectionnez une ligne puis cliquez sur `Valider`{.action}.<br><br>Confirmez en cliquant sur `Ajouter un agent`{.action}<br><br>Les lignes doivent être ajoutées l'une après l'autre.|
|**Ligne externe**<br><br>![ligne SIP externe](agent-externe2021.png){.thumbnail}|Pour ajouter une ligne téléphonique externe, renseignez son numéro au format international (0033xxxxxxxxx pour la France) directement dans le champ « Numéro ».<br><br>Validez l'ajout de chaque ligne en cliquant sur `Ajouter un agent`{.action}.|

> [!warning]
> L'ajout d'une ligne externe peut occasionner des frais car un appel reçu par celle-ci sera comptabilisé en hors-forfait. Vous pouvez consulter nos tarifs hors-forfait en vigueur sur [cette page](telephonie-decouvrez-tarifs-telephonie.){.external}. Nous vous conseillons donc de privilégier les lignes internes ou de n'utiliser une ligne externe qu'en solution de repli.
>
...
![contact-center-solution](ccs-step3-1-3.png){.thumbnail}
...
![gerer files appels](gerer-files2021.png){.thumbnail}
...
![contact-center-solution](gerer-files2021b.png){.thumbnail}
...
![contact-center-solution](gerer-agents-ordre-2021.png){.thumbnail}
...
À la différence de la configuration d'un numéro alias en [Serveur Vocal Interactif (SVI)](svi_serveur_vocal_interactif1.), le CCS permet d'associer une file d'appels entière (et non plus une simple ligne) à une touche de téléphone composée par un appelant.

Pour plus d'informations sur le fonctionnement d'un SVI, consultez notre guide [Configurer un serveur vocal interfactif](svi_serveur_vocal_interactif1.).
...
![gerer menus interactifs](gerer-svi2021.png){.thumbnail}
...
![contact-center-solution](gerer-svi2021b.png){.thumbnail}
...
![contact-center-solution](ccs-step4-1-3.png){.thumbnail}

Dans le menu supplémentaire qui s'affiche, complétez les informations demandées.

![contact-center-solution](gerer-svi2021c.png){.thumbnail}
...
![contact-center-solution](gerer-svi2021d.png){.thumbnail}
...
![contact-center-solution](gerer-etapes-actions2021.png){.thumbnail}
...
![contact-center-solution](gerer-etapes-actions2021c.png){.thumbnail}
...
![contact-center-solution](gerer-etapes-actions2021b.gif){.thumbnail}
...
![contact-center-solution](gerer-conditions2021.png){.thumbnail}
...
![contact-center-solution](exemples-plages2021.png){.thumbnail}
...
![CCS configuration](creneaux-activation2021.png){.thumbnail}
...
![gérer créneaux exceptionnels](gerer-creneaux2021.png){.thumbnail}
...
![CCS configuration](creneaux2021.png){.thumbnail}
...
![contact-center-solution](plageshoraires2021.gif){.thumbnail}
...
![CCS configuration](filtrages2021.png){.thumbnail}
...
![Optionsccs](modifieroption.png){.thumbnail}
...
![Optionsccs](optionsccs.png){.thumbnail}
...
![Optionsccs](numeropres2.png){.thumbnail}
...
![Tableau de bord](tableau2021.png){.thumbnail}
...
![écouter ou chuchoter](tableau01.png){.thumbnail}
...
![écouter ou chuchoter](tableau02.png){.thumbnail}
...
![transférer l'appel](tableau03.png){.thumbnail}
...
![raccrocher l'appel](tableau04.png){.thumbnail}
...
![consulter enregistrements](records2021.png){.thumbnail}
...
![consulter enregistrements](records2021b.png){.thumbnail}
...
![CCS configuration](ccs-records3.png){.thumbnail}
