...
Connectez-vous à votre [espace client OVHcloud](manager.){.external}, partie `Télécom`. Cliquez sur `Téléphonie`{.action} puis sélectionnez votre groupe de téléphonie.
...
![renseigner coordonnées](sva-coordonnees01.png){.thumbnail}
![renseigner coordonnées](sva-coordonnees02.png){.thumbnail}
![renseigner coordonnées](sva-coordonnees03.png){.thumbnail}

### Ajouter des bénéficiaires

Si vous êtes le seul bénéficiaire, cochez la case « Mon représentant est bénéficiaire ». 

![représentant bénéficiairs](beneficiaire.png){.thumbnail}
...
![ajout bénéficiaires](sva-beneficiaire1.png){.thumbnail}
...
![ajout bénéficiaires](sva-beneficiaire2.png){.thumbnail}
...
![confirmation](sva-confirmer.png){.thumbnail}
...
![ajout des documents](sva-documents-v2.png){.thumbnail}
