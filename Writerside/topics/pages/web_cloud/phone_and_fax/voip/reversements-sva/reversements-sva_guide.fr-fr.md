...
- Posséder au moins [un numéro spécial](telephonie-numeros-speciaux-francais.)telecom/telephonie-numeros-speciaux) dans votre compte OVHcloud.
- Être connecté à l'[espace client OVHcloud](manager.), partie `Télécom` :

![espace client Telecom VoIP](https://raw.githubusercontent.com/ovh/docs/master/templates/control-panel/product-selection/telecom/tpl-telecom-02-fr-voip.png){.thumbnail}

## En pratique

Connectez-vous à votre [espace client OVHcloud](manager.){.external} et assurez-vous de vous situer dans la partie « Télécom ». Cliquez sur `Téléphonie`{.action}, puis sélectionnez votre groupe de téléphonie.<br>
Pour plus d'informations sur les groupes de téléphonie, consultez notre guide « [Gérer vos groupes de téléphonie](regrouper_services_telephonie1.)».

### Consulter et/ou modifier le palier tarifaire de votre numéro spécial

> [!primary]
> Vous pouvez consulter la liste complète des paliers tarifaires OVHcloud applicables aux numéros spéciaux en France sur [cette page](telephonie-numeros-speciaux-francais.)telecom/telephonie-numeros-speciaux-francais).
>
...
![choix palier tarifaire](price01.png){.thumbnail}
...
![choix palier tarifaire](price02.png){.thumbnail}
...
![reversements](reversements01.png){.thumbnail}
...
![reversements](reversements02.png){.thumbnail}
...
![reversements](virement.png){.thumbnail}
...
![reversements](remboursement01.png){.thumbnail}
...
![reversements](remboursement02.png){.thumbnail}
...
![reversements](reversements04.png){.thumbnail}

Le tableau qui vous est alors présenté récapitule tous les appels entrants.

![reversements](reversements03.png){.thumbnail}
...
![historique des reversements](historique-reversements01.png){.thumbnail}

Vous retrouvez sur cette page l'historique des reversements effectués par le passé sur votre groupe de téléphonie.

![historique des reversements](historique-reversements02.png){.thumbnail}
...
![couts SVA](couts01.png){.thumbnail}
...
![historique des couts SVA](historique-couts01.png){.thumbnail}
...
![historique des couts SVA](historique-couts02.png){.thumbnail}
