...
- Disposer au moins d'une [ligne SIP OVHcloud](telephonie-voip.){.external}.
...
Connectez-vous à votre [espace client OVHcloud](manager.){.external} et assurez-vous de vous situer dans la section `Télécom`. Cliquez sur `Téléphonie`{.action} puis sélectionnez la ligne concernée. Positionnez-vous sur l'onglet `Téléphone`{.action} et cliquez sur `Carnets de contacts`{.action}.
 
![carnet de contacts](carnetligne.png){.thumbnail}

- **Pour accéder à la gestion du carnet de contacts d'un groupe de lignes** :

Connectez-vous à votre [espace client OVHcloud](manager.){.external} et assurez-vous de vous situer dans la section `Télécom`. Cliquez sur `Téléphonie`{.action} dans la barre de services à gauche, puis cliquez sur le groupe de lignes concerné. Cliquez enfin sur le bouton `Carnet de contacts`{.action}.
 
![carnet de contacts](carnetgroupe.png){.thumbnail}
...
![carnet de contacts](creercarnet.png){.thumbnail}
...
![carnet de contacts](creercarnetV2.png){.thumbnail}
...
![carnet de contacts](carnet-contacts-step5.png){.thumbnail}
...
![carnetcontacts](carnet-contacts-step6.png){.thumbnail}
...
![carnetcontacts](supprimercontact.png){.thumbnail}
