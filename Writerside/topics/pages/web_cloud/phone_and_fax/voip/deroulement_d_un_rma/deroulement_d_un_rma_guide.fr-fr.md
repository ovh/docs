...
> [!primary]
>
> Pour plus d'informations sur l'échange de téléphones fournis par OVHcloud, consultez notre guide « [Gérer le téléphone Plug & Phone d’une ligne SIP](commander_associer_ou_changer_un_telephone1.) ».
...
![deroulement-rma](rma2020.png){.thumbnail}
...
-   connectez vous à votre [espace client OVHcloud](manager.), partie **Telecom** ;
