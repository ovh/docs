...
![your project with Composer](img_2450.jpg){.thumbnail}
...
![create tokens](img_2451.jpg){.thumbnail}
...
![retrieving tokens](img_2452.jpg){.thumbnail}
...
To send SMS messages, use the POST jobs method: [sms_{serviceName}_jobs#POST1.](https://api.ovh.com/console/#/sms/{serviceName}/jobs#POST)
