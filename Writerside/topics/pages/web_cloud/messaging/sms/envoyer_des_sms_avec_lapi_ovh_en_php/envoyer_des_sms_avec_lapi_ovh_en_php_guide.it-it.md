...
![votre projet avec Composer](img_2450.jpg){.thumbnail}
...
![creazione dei token](img_2451.jpg){.thumbnail}
...
![recupero dei token](img_2452.jpg){.thumbnail}
...
Per inviare degli SMS, utilizza il metodo POST jobs: [sms_{serviceName}_jobs#POST1.](https://api.ovh.com/console/#/sms/{serviceName}/jobs#POST)
