...
![Twój projekt utworzony za pomocą narzędzia Composer](img_2450.jpg){.thumbnail}
...
![tworzenie tokenów](img_2451.jpg){.thumbnail}
...
![pozyskiwanie tokenów](img_2452.jpg){.thumbnail}
...
Aby wysłać wiadomość SMS, wykorzystaj metodę POST jobs: [sms_{serviceName}_jobs#POST1.](https://api.ovh.com/console/#/sms/{serviceName}/jobs#POST)
