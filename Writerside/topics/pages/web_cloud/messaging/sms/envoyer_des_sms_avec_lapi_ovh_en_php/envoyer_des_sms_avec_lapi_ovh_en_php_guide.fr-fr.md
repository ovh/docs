...
![création des tokens](img_2451.jpg){.thumbnail}
...
![récupération des tokens](img_2452.jpg){.thumbnail}
...
Pour envoyer des SMS, utilisez la méthode POST jobs : [sms_{serviceName}_jobs#POST1.](https://api.ovh.com/console/#/sms/{serviceName}/jobs#POST)
