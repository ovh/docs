...
> 
> [Sending SMS messages via the OVHcloud Control Panel](envoyer_des_sms_depuis_mon_espace_client#step-2-compose-your-sms-message.)
>
...
![sms credits transfer](credit-transfer01.png){.thumbnail}
...
![sms credits transfer](credit-transfer02.png){.thumbnail}
