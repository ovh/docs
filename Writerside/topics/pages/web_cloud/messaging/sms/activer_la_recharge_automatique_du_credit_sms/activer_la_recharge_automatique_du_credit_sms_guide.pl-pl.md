...
> 
> [Wysyłanie wiadomości SMS z Panelu klienta OVHcloud](envoyer_des_sms_depuis_mon_espace_client#etap-2-tworzenie-wiadomosci-sms.)
>
...
![zasilenie sms](smscredit01.png){.thumbnail}

W rubryce „Zarządzaj opcjami” kliknij polecenie `Zmień`{.action}.

![zasilenie sms](smscredit02.png){.thumbnail}
...
![zasilenie sms](smscredit03.png){.thumbnail}
...
![transfer zasileń SMS](credit-transfer01.png){.thumbnail}
...
![transfer zasileń SMS](credit-transfer02.png){.thumbnail}
