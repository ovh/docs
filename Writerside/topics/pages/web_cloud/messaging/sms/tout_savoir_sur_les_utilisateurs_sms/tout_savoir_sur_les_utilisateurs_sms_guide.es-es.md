...
![Usuarios de SMS](smsusers.png){.thumbnail}
...
![Usuarios API](smsusers01e-2021.png){.thumbnail}
...
![Añadir una cuota a un usuario API](smsusers03e-2021.png){.thumbnail}
...
![Activar una cuota](smsusers04-2021.png){.thumbnail}
...
![Configuración de un límite](smsusers05-2021.png){.thumbnail}
...
![Restricciones por IP](smsusers06-2021.png){.thumbnail}

Para más información sobre la función http2sms, consulte la guía [Enviar SMS desde una URL](envoyer_des_sms_depuis_une_url_-_http2sms1.).
...
![Indicar URL de callback](smsusers07-2021.png){.thumbnail}
...
Para más información sobre el uso de las API de OVHcloud, consulte nuestra guía [Primeros pasos con la API de OVHcloud](first-steps1.).
