...
Per maggiori informazioni sulla funzione http2sms, consulta la guida [Inviare SMS da un URL](envoyer_des_sms_depuis_une_url_-_http2sms1.).
...
Per maggiori informazioni sull'utilizzo delle API OVHcloud, consulta la nostra guida [Iniziare a utilizzare le API OVHcloud](first-steps1.).
