...
Pour plus d'informations sur la fonction http2sms, consultez le guide [Envoyer des SMS depuis une URL](envoyer_des_sms_depuis_une_url_-_http2sms1.).
...
Pour plus d'informations sur l'utilisation des API OVHcloud, consultez notre guide [Premiers pas avec les API OVHcloud](first-steps1.).
