...
Po zaimportowaniu Twojej listy możesz postępować zgodnie z instrukcjami zawartymi w przewodniku [Wysyłanie wiadomości SMS z Panelu klienta](envoyer_des_sms_depuis_mon_espace_client1.), aby wysłać wiadomość SMS do odbiorców tej listy.

## Sprawdź również

[Wysyłanie wiadomości SMS z Panelu klienta](envoyer_des_sms_depuis_mon_espace_client1.)

[Zarządzanie książkami adresowymi SMS](gerer_mes_carnets_dadresses_sms1.)
