...
Now that your list has been imported, you can follow the instructions in our guide on [Sending SMS messages via the OVHcloud Control Panel](envoyer_des_sms_depuis_mon_espace_client1.) in order to send an SMS to the recipients of this list.

## Go further

[Sending SMS messages via the OVHcloud Control Panel](envoyer_des_sms_depuis_mon_espace_client1.)

[Managing SMS address books](gerer_mes_carnets_dadresses_sms1.)
