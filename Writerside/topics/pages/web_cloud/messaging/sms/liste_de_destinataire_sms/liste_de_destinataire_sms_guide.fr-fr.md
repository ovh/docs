...
Maintenant que votre liste est importée, vous pouvez suivre les instructions de notre guide « [Envoyer des SMS depuis mon espace client](envoyer_des_sms_depuis_mon_espace_client1.) » afin d'envoyer un SMS aux destinataires de cette liste.

## Aller plus loin

[Envoyer des SMS depuis mon espace client](envoyer_des_sms_depuis_mon_espace_client1.)

[Gérer mes carnets d’adresses SMS](gerer_mes_carnets_dadresses_sms1.)
