...
![SMS messages to the USA](smstousa1.png){.thumbnail}

On the next page, click on `Actions`{.action} then on `Add`{.action}.

![SMS messages to the USA](smstousa2.png){.thumbnail}

A pop-up will appear with fields to complete.

![SMS messages to the USA](smstousa3.png){.thumbnail}
...
![SMS messages to the USA](smstousa4.png){.thumbnail}
...
You can view the other possible return codes in [this guide](tout_savoir_sur_les_utilisateurs_sms1.).
