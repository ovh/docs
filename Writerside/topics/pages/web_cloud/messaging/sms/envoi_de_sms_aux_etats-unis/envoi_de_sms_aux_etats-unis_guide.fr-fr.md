...
![SMS aux Etats-Unis](smstousa1.png){.thumbnail}

Sur la page qui s'affiche alors, cliquez sur `Action`{.action} puis sur `Ajouter`{.action}.

![SMS aux Etats-Unis](smstousa2.png){.thumbnail}

Une pop-up apparaît avec les champs à remplir.

![SMS aux Etats-Unis](smstousa3.png){.thumbnail}
...
![SMS aux Etats-Unis](smstousa4.png){.thumbnail}
...
Vous pouvez consulter les autres codes de retour possibles sur [ce guide](tout_savoir_sur_les_utilisateurs_sms1.).
