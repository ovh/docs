...
![SMS negli Stati Uniti](smstousa1.png){.thumbnail}

Nella nuova pagina, clicca su `Azione`{.action} e poi su `Aggiungi`{.action}.

![SMS negli Stati Uniti](smstousa2.png){.thumbnail}

Visualizzi un pop-up con i campi da compilare.

![SMS negli Stati Uniti](smstousa3.png){.thumbnail}
...
![SMS negli Stati Uniti](smstousa4.png){.thumbnail}
...
Per conoscere i codici PTT, consulta [questa guida](tout_savoir_sur_les_utilisateurs_sms#step-5-specifica-un-url-di-callback.).
