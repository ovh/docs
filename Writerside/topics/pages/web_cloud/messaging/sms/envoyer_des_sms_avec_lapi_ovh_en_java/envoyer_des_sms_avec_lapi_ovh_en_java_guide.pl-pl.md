...
- Lista aktywnych usług SMS [https://eu.api.ovh.com/1.0/sms/](#_sms#GET.)
- Wysyłanie wiadomości SMS [https://eu.api.ovh.com/1.0/sms/{ServiceName}/jobs/](sms_{serviceName}_jobs#POST.)
...
![tworzenie tokenów](img_2479.jpg){.thumbnail}
...
![pozyskiwanie tokenów](img_2480.jpg){.thumbnail}
...
Aby wysłać wiadomość SMS, wykorzystaj metodę POST jobs: [sms_{serviceName}_jobs#POST.](https://api.ovh.com/console/#/sms/{serviceName}/jobs#POST)
