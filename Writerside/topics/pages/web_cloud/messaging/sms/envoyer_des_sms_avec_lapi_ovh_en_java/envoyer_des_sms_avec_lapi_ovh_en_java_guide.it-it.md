...
- Elenco dei servizi di SMS attivi [https://eu.api.ovh.com/1.0/sms/](#_sms#GET.)
- Inviare SMS [https://eu.api.ovh.com/1.0/sms/{ServiceName}/jobs/](sms_{serviceName}_jobs#POST.)
...
![creazione di token](img_2479.jpg){.thumbnail}
...
![recupero dei token](img_2480.jpg){.thumbnail}
...
Per inviare degli SMS, utilizza il metodo POST jobs: [sms_{serviceName}_jobs#POST.](https://api.ovh.com/console/#/sms/{serviceName}/jobs#POST)
