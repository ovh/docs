...
![área de cliente Telecom SMS](smshistory1.png){.thumbnail}
...
![área de cliente Telecom SMS](smshistory4.png){.thumbnail}
 
El botón `Filtrar`{.action} permite filtrar la búsqueda por remitente (si hubiera más de uno) o por destinatario.

![área de cliente Telecom SMS](smshistory5.png){.thumbnail}
...
![área de cliente Telecom SMS](smshistory6.png){.thumbnail}
...
![área de cliente Telecom SMS](smshistory7.png){.thumbnail}
...
Para más información sobre los códigos ptt y los diferentes ID del DLR, consulte la última sección de la guía [Usuarios de la API](tout_savoir_sur_les_utilisateurs_sms#5-especificar-una-url-de-callback.).
