...
> [!primary]
>
> Zalecamy zapoznanie się z [specyfikacjami technicznymi oferty SMPP OVHcloud](smpp-specification1.).
...
Zapoznaj się z naszymi przewodnikami na temat [zarządzanie nadawcami](envoyer_des_sms_depuis_mon_espace_client#etap-3-wybor-nadawcy-wiadomosci-sms.) oraz na temat [zarządzanie zasileniami SMS i automatycznym doładowaniem](activer_la_recharge_automatique_du_credit_sms1.).

## Sprawdź również

Sprawdź [przewodnik dotyczący zarządzania historią wiadomości SMS](gerer_l_historique_des_sms1.).

[Specyfikacje techniczne oferty SMPP OVHcloud](smpp-specification1.).
