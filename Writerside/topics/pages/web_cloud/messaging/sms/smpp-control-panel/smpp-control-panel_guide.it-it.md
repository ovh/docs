...
> [!primary]
>
> Ti consigliamo di prendere visione delle [specifiche tecniche dell'offerta SMPP OVHcloud](smpp-specification1.).
...
Consulta le nostre guide sulla [gestione mittenti](envoyer_des_sms_depuis_mon_espace_client#step-3-scegli-il-mittente-del-tuo-sms.) e sulla [gestione dei crediti SMS e ricarica automatica](activer_la_recharge_automatique_du_credit_sms1.).

## Per saperne di più

Consulta la nostra guida dedicata alla [gestione dello storico degli SMS](gerer_l_historique_des_sms1.).

[Specifiche tecniche dell'offerta SMPP OVHcloud](smpp-specification1.).
