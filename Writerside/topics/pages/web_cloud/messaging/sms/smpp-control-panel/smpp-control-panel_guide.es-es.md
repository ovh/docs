...
> [!primary]
>
> Le recomendamos que se familiarice con las [especificaciones técnicas de la solución SMPP de OVHcloud](smpp-specification1.).
...
Consulte nuestras guías sobre [gestión de remitentes](envoyer_des_sms_depuis_mon_espace_client#3-elegir-el-remitente-del-sms.) y [gestión de créditos de SMS y recarga automática](activer_la_recharge_automatique_du_credit_sms1.).

## Más información

Consulte [nuestra guía relativa a la gestión del historial de envíos de SMS](gerer_l_historique_des_sms1.).

[Las especificaciones técnicas del producto SMPP OVHcloud](smpp-specification1.).
