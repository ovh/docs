...
> [!primary]
>
> Nous vous recommandons de prendre connaissance des [spécifications techniques de l'offre SMPP OVHcloud](smpp-specification1.).
...
Consultez nos guides sur la [gestion des expéditeurs](envoyer_des_sms_depuis_mon_espace_client#etape-3-choisir-votre-expediteur-sms.) et sur la [gestion des crédits SMS et la recharge automatique](activer_la_recharge_automatique_du_credit_sms1.).

## Aller plus loin

Consultez [notre guide dédié à la gestion de l'historique des SMS](gerer_l_historique_des_sms1.).

[Les spécifications techniques de l'offre SMPP OVHcloud](smpp-specification1.).
