...
Questa guida ti mostra come [creare una lista di destinatari SMS](liste_de_destinataire_sms1.).
...
Per saperne di più, consulta la guida [Gestire le rubriche SMS](gerer_mes_carnets_dadresses_sms1.).
...
A questo proposito, consulta la sezione dedicata alla scelta del mittente per i tuoi SMS della guida [“Inviare sms dallo Spazio Cliente”](envoyer_des_sms_depuis_mon_espace_client#step-3-scegli-il-mittente-del-tuo-sms.).
...
Per inviare un SMS unitario dal tuo Spazio Cliente, consulta [la guida dedicata a questo metodo](envoyer_des_sms_depuis_mon_espace_client1.).
...
Consulta [la nostra guida dedicata alla gestione dello storico degli SMS](gerer_l_historique_des_sms1.).
