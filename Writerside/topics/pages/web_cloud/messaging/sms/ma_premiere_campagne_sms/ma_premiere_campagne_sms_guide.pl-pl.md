...
Z następującego przewodnika dowiesz się, [jak utworzyć listę odbiorców wiadomości SMS](liste_de_destinataire_sms1.).
...
Zapoznaj się z przewodnikiem [Zarządzanie książkami adresowymi SMS](gerer_mes_carnets_dadresses_sms1.), aby dowiedzieć się więcej.
...
Aby wysłać pojedynczą wiadomość SMS z Panelu klienta, zapoznaj się [z przewodnikiem dotyczącym tej metody](envoyer_des_sms_depuis_mon_espace_client1.).
...
Zapoznaj się z [naszym przewodnikiem dotyczącym zarządzania historią wiadomości SMS](gerer_l_historique_des_sms1.).
