...
![send sms control panel](sms-send-control-panel01E.png){.thumbnail}
...
![send sms control panel](sms-send-control-panel02E.png){.thumbnail}
...
For further information on this, you can refer to our [guide on SMS recipient lists](liste_de_destinataire_sms1.).

- By creating an address book (3). You can do this directly via the OVHcloud Control Panel, or import one as a .csv or .txt file.
Feel free to refer to our [guide on managing SMS address books](gerer_mes_carnets_dadresses_sms1.) for further information.
...
![send sms control panel](sms-send-control-panel03E.png){.thumbnail}
...
![List of authorised SMS characters](smsauthorizedcharacters.png){.thumbnail}

#### Advanced options

![send sms control panel](sms-send-control-panel-advanced.png){.thumbnail}
...
![send sms control panel](sms-send-control-panel04E.png){.thumbnail}

If you would like to add an additional SMS sender, click the `Actions`{.action} button in the middle, then `Add`{.action} (2).

![send sms control panel](sms-send-control-panel05E.png){.thumbnail}
