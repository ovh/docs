...
Pour plus d'informations, vous pouvez consulter notre [guide sur les listes de destinataires SMS](liste_de_destinataire_sms1.).
...
N'hésitez pas à consulter notre [guide sur les carnets d'adresses SMS](gerer_mes_carnets_dadresses_sms1.).
...
![Liste des caractères SMS](smsauthorizedcharacters.png){.thumbnail}
