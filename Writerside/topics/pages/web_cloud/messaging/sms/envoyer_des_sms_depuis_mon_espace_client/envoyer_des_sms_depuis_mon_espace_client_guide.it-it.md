...
![envoi sms manager](sms-send-control-panel01E.png){.thumbnail}
...
![envoi sms manager](sms-send-control-panel02E.png){.thumbnail}
...
Per maggiori informazioni, consulta la nostra [guida sulle liste di destinatari SMS](liste_de_destinataire_sms1.).

- Tramite una rubrica indirizzi (3), che può essere creata dallo Spazio Cliente o importata tramite une file .csv o .txt.
Per maggiori informazioni consulta la [guida sulle rubriche SMS](gerer_mes_carnets_dadresses_sms1.).
...
![envoi sms manager](sms-send-control-panel03E.png){.thumbnail}
...
![Lista dei caratteri SMS](smsauthorizedcharacters.png){.thumbnail}
...
![envoi sms manager](sms-send-control-panel04E.png){.thumbnail}

Per aggiungere un ulteriore mittente SMS, clicca sul pulsante `Azioni`{.action} al centro e seleziona `Aggiungi`{.action} (2).

![envoi sms manager](sms-send-control-panel05E.png){.thumbnail}
