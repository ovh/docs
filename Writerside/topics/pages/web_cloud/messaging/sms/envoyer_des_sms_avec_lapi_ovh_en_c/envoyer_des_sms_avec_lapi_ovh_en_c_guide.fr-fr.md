...
Pour l'implémentation de l'appel au Webservice, nous vous conseillons de lire notre guide sur les [premiers pas avec les API OVHcloud](first-steps1.).
...
![création des tokens](sms-tokens-01.png){.thumbnail}
...
![récupération des tokens](sms-tokens-02.png){.thumbnail}
