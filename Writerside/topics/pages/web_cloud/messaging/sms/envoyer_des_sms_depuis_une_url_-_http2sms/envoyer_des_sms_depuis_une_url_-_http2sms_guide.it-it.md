...
## Prerequisiti
- Creare un utente SMS attraverso lo Spazio Cliente OVHcloud o direttamente attraverso le API. A questo proposito, è possibile consultare la guida che segue: [Tutte le informazioni sugli utenti SMS](tout_savoir_sur_les_utilisateurs_sms1.)
...
>
>Per maggiori informazioni sui caratteri autorizzati in codifica a 7 bit, fai riferimento [all'allegato](envoyer_des_sms_depuis_une_url_-_http2sms_#allegato.) in fondo a questa guida.
>
...
![Lista dei caratteri SMS](envoyer_des_sms_depuis_une_url_-_http2sms_images_smsauthorizedcharacters.png){.thumbnail}
