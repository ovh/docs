...
- Utworzenie użytkownika SMS w Panelu klienta OVHcloud lub bezpośrednio przez interfejs API. W tym celu zapoznaj się z następującym przewodnikiem: [Informacje o użytkownikach wiadomości SMS](tout_savoir_sur_les_utilisateurs_sms1.)
...
>
>Aby uzyskać więcej informacji na temat dozwolonych znaków z kodowaniu 7-bitowym, zapoznaj się z [załącznikiem](envoyer_des_sms_depuis_une_url_-_http2sms_#zalacznik.) na dole tego przewodnika.
>
...
![Lista znaków SMS](envoyer_des_sms_depuis_une_url_-_http2sms_images_smsauthorizedcharacters.png){.thumbnail}
