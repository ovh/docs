...
- Haber creado un usuario de SMS desde el área de cliente de OVHcloud o a través de la API. Para ello, puede consultar la guía [Usuarios de SMS](tout_savoir_sur_les_utilisateurs_sms1.).
...
![URL de envío de sms](img_4011.jpg){.thumbnail}
...
![Lista de caracteres de SMS](envoyer_des_sms_depuis_une_url_-_http2sms_images_smsauthorizedcharacters.png){.thumbnail}
