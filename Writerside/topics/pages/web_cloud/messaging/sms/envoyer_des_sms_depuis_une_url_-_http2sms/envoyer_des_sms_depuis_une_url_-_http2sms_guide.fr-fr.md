...
- Avoir créé un utilisateur SMS via l'espace client OVHcloud ou directement via les API. À cet effet, vous pouvez consulter le guide suivant : [Tout savoir sur les utilisateurs SMS](tout_savoir_sur_les_utilisateurs_sms1.)
- Disposer d'un compte SMS OVHcloud avec des crédits SMS
- Disposer d'un expéditeur SMS actif. Pour en savoir plus à ce sujet, vous pouvez consulter ce [guide](envoyer_des_sms_depuis_mon_espace_client#etape-3-choisir-votre-expediteur-sms.)
...
>
>Pour plus d'informations sur les caractères autorisés en encodage 7bit, reportez-vous à [l'annexe](envoyer_des_sms_depuis_une_url_-_http2sms_#annexe.) en bas de ce guide.
>
...
![Liste des caractères SMS](envoyer_des_sms_depuis_une_url_-_http2sms_images_smsauthorizedcharacters.png){.thumbnail}
