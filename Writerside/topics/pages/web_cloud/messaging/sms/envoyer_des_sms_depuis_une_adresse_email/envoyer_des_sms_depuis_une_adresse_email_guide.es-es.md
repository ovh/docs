...
Para más información sobre los caracteres autorizados con codificación de 7 bits, consulte el [anexo](envoyer_des_sms_depuis_une_adresse_email#anexo.) que encontrará al final de esta guía.
...
Para más información sobre los usuarios de SMS, consulte la siguiente guía: [Usuarios de SMS](tout_savoir_sur_les_utilisateurs_sms1.)
...
![Lista de caracteres de SMS](images_smsauthorizedcharacters.png){.thumbnail}
