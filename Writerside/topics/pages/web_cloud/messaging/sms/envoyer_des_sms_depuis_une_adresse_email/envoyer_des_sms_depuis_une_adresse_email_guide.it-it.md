...
Puoi consultare la guida che segue per qualsiasi dettaglio sugli utenti SMS: [Tutte le informazioni sugli utenti SMS](tout_savoir_sur_les_utilisateurs_sms1.)
...
![Lista dei caratteri SMS](images_smsauthorizedcharacters.png){.thumbnail}
