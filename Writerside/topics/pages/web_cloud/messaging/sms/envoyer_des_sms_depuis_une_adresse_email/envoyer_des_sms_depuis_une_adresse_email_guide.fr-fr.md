...
Vous pouvez consulter le guide suivant pour toute précision sur les utilisateurs SMS : [Tout savoir sur les utilisateurs SMS](tout_savoir_sur_les_utilisateurs_sms1.)
...
![Liste des caractères SMS](images_smsauthorizedcharacters.png){.thumbnail}
