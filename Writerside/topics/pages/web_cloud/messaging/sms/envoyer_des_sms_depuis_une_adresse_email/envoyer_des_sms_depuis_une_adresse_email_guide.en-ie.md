...
You can refer to the following guide for any specifics about SMS users: [Everything you need to know about SMS users](tout_savoir_sur_les_utilisateurs_sms1.)
...
![List of authorised SMS characters](images_smsauthorizedcharacters.png){.thumbnail}
