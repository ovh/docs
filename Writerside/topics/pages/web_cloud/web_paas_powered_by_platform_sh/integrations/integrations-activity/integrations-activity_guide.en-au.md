...
A legacy integration is also available for [HipChat](hipchat1.).
...
To install a new activity script, use the [Web PaaS CLI](development-cli1.).
...
A complete list of possible events is available in the [webhook documentation](reference1.).
...
Activity scripts can be written in ES2021 and do not support installing additional packages. We provide a series of [utility functions you can reuse](utility1.) as well as the following libraries, APIs, and global variables to facilitate building out custom functionality.
