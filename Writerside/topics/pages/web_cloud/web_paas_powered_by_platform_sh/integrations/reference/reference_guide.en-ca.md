...
This large block details all information about all services in the environment.  That includes the resulting configuration objects derived from [`routes.yaml`](configuration-routes1.), [`services.yaml`](configuration-services1.), and [`.platform.app.yaml`](configuration-app1.).
