...
The `timezone` property sets the timezone for which the `spec` property of any [cron tasks](cron1.) defined by the application will be interpreted.
...
* PHP runtime - You can change the timezone by providing a [custom php.ini](ini1.) or by adding the following lines to your `.platform.app.yaml` file:
