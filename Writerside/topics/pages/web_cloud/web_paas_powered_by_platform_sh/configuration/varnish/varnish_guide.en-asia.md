...
- Connect to your cluster [using ssh](development-ssh1.) or through the CLI `webpaas ssh -p <project id>`,

- Display the [relationships array](relationships1.) with `echo $PLATFORM_RELATIONSHIPS | base64 -d | jq '.'`,
