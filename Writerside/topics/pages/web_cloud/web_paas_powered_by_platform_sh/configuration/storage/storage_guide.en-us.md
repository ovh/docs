...
This assumes that a `network-storage` service named `files` has already been defined.  See the [Network Storage](network-storage1.) page for more details and examples.
...
See the [web locations](web1.) documentation for more details.
