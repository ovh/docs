...
![Services](relationships.png "0.50")
...
|----------------------------------|---------------|-------------------------|
| [Headless Chrome](headless-chrome1.) | `chrome-headless` | 73 |
| [InfluxDB](influxdb1.) | `influxdb` | 1.2, 1.3, 1.7, 1.8 |
| [Kafka](kafka1.) | `kafka` | 2.1, 2.2, 2.3, 2.4, 2.5 |
| [MariaDB](mysql1.) | `mariadb` | 10.0, 10.1, 10.2, 10.3, 10.4, 10.5 |
| [Memcached](memcached1.) | `memcached` | 1.4, 1.5, 1.6 |
| [Network Storage](network-storage1.) | `network-storage` | 1.0 |
| [Oracle MySQL](mysql1.) | `oracle-mysql` | 5.7, 8.0 |
| [PostgreSQL](postgresql1.) | `postgresql` | 9.6, 10, 11, 12, 13 |
| [RabbitMQ](rabbitmq1.) | `rabbitmq` | 3.5, 3.6, 3.7, 3.8 |
| [Redis](redis1.) | `redis` | 3.2, 4.0, 5.0, 6.0 |
| [Solr](solr1.) | `solr` | 7.7, 8.0, 8.4, 8.6 |
| [Varnish](varnish1.) | `varnish` | 5.6, 6.0 |
