...
Make sure your site is running and configured as you want it to be, on your master branch.  In particular, see the [Routes documentation](configuration-routes1.). You will need your routes configured appropriately before you begin.  Make sure you have turned off [basic-authentication](configure-environment1.) if it was turned on during development.
...
**Time to [Go Live](domains-quick-start1.).**
