...
That can be done through the [management console](administration-web1.) or via the command line, like so:
...
Typically, a private dependency will be hosted in a private Git repository.  While Web PaaS supports [private repositories](development-private-repository1.) for the site itself, that doesn't help for pulling in third party dependencies from private repositories unless they have the same SSH keys associated with them.
