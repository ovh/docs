...
To customize who can use SSH, [set the access key](access1.) in your `platform.app.yaml` file.
...
you must [trigger a redeploy](development-redeploy1.) to propagate SSH access changes to each environment.
