...
New environments can be created in moments through a Git clone, via the [Web PaaS Command Line Interface](development-cli1.), or via the [Web PaaS web console](administration-web1.), and will be an exact replica of their parent environments. This means new environments will have all of the data, as well as the services (like databases, network storage, queues, routing, etc.) instantly cloned. 
...
![Hierarchy](images_environments.png "0.5")
