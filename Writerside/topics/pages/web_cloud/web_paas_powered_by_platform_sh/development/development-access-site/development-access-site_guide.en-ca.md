...
The web URL(s) for the site are listed in the [management console](administration-web1.) under "Access site".

They can also be found on the command line, using the [Web PaaS CLI](development-cli1.):
...
Most interactions with Web PaaS require SSH key authentication, and you will need to [set up your SSH keys](development-ssh1.) before working on a site.
...
The writable static files in an application - including uploads, temporary and private files - are stored in [mounts](storage1.).
