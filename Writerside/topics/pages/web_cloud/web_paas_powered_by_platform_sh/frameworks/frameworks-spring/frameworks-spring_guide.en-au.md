...
You can use [Spring Data Solr](https://spring.io/projects/spring-data-solr) to use [Solr](solr1.) with your application by first determining the Solr client programmatically.
...
You can use [Spring Data Redis](https://spring.io/projects/spring-data-redis) to use [Redis](redis1.) with your application by first determining the Redis client programmatically.
...
[MySQL](mysql1.) is an open-source relational database technology. Spring has robust integration with this technology: [Spring Data JPA](https://spring.io/projects/spring-data-jpa).
...
[MariaDB](mysql1.) is an open-source relational database technology. Spring has robust integration with this technology: [Spring Data JPA](https://spring.io/projects/spring-data-jpa).
...
[PostgreSQL](postgresql1.) is an open-source relational database technology. Spring has robust integration with this technology: [Spring Data JPA](https://spring.io/projects/spring-data-jpa).
...
You can use [Spring JMS](https://spring.io/guides/gs/messaging-jms/) to use [RabbitMQ](rabbitmq1.) with your application by first determining the [RabbitMQ client](https://mvnrepository.com/artifact/com.rabbitmq.jms/rabbitmq-jms) programmatically.
