...
![Merge your changes.](header.png "0.3")

A dialog box will appear that will provide commands to execute future merges from the command line using the [Web PaaS CLI](development-cli1.).

![Merge confirmation cli](header-merge-box.png "0.4")
