...
Une fois cette action effectuée, redémarrez votre modem. Si besoin, reportez-vous aux instructions décrites dans notre documentation « [Redémarrer ou réinitialiser un modem ADSL OVH](restart_reboot_modem1.){.external} ».
...
![adslsynchronisation](rj11_filtre.png){.thumbnail}
...
Le dernier test possible consiste à réinitialiser votre modem. Si besoin, reportez-vous aux instructions décrites dans notre documentation « [Redémarrer ou réinitialiser un modem ADSL OVH](restart_reboot_modem1.){.external} ».
