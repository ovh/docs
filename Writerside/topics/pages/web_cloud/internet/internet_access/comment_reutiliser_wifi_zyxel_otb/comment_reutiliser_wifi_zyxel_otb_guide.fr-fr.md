...
![reutiliserWiFiOTB](reutiliserWiFiOTB-step1-2022.png){.thumbnail}
...
![reutiliserWiFiOTB](reutiliserWiFiOTB-step2.png){.thumbnail}
...
![reutiliserWiFiOTB](reutiliserWiFiOTB-step3-1.png){.thumbnail}

Sur cette page, cliquez sur le bouton `+ Add New Interface Group`{.action}.

![reutiliserWiFiOTB](reutiliserWiFiOTB-step3-2.png){.thumbnail}
...
![reutiliserWiFiOTB](reutiliserWiFiOTB-step3-3-2022.png){.thumbnail}
...
![reutiliserWiFiOTB](reutiliserWiFiOTB-step4.png){.thumbnail}
...
![reutiliserWiFiOTB](reutiliserWiFiOTB-step6-1.png){.thumbnail}
...
![reutiliserWiFiOTB](reutiliserWiFiOTB-step6-2.png){.thumbnail}
