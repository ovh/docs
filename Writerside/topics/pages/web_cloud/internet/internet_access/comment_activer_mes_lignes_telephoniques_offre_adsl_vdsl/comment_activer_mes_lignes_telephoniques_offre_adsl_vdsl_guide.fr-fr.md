...
![nombre de lignes](Activation01-edit-2022.png){.thumbnail}
...
![activer une ligne](Activation02-edit.png){.thumbnail}
...
![activation ligne sans téléphone ](Activation03-edit.png){.thumbnail}
...
![activation ligne avec téléphone](Activation04-edit.png){.thumbnail}
...
![activation ligne fax](Activation05-edit.png){.thumbnail}

Cette ligne sera alors disponible dans un délai moyen d'une heure.

Veuillez consulter [nos guides Fax](web-cloud-phone-and-fax-fax1.) afin d'avoir plus de détails sur l'utilisation de ce service.
...
![voyants technicolor](2015-03-18-143620_120x314_scrot.png){.thumbnail}

![voyants zyxel](Activation06-edit.png){.thumbnail}
...
![schéma branchement tg788](untitled.jpg){.thumbnail}
...
Si vous souhaitez diminuer le nombre de lignes incluses dans votre offre, nous vous conseillons d'envisager de changer d'offre. Consultez notre guide « [Comment changer mon offre xDSL/FTTH](comment_changer_mon_offre_xdsl1.) ».

## Aller plus loin

Consultez [nos guides dédiés à la configuration de vos lignes](web-cloud-phone-and-fax-voip1.).
