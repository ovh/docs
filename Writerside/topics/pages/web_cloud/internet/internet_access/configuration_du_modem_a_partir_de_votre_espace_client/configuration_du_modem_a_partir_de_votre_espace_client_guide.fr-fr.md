...
![configureremotelybox](configure-remotely-box-step1-2022.png){.thumbnail}
...
![configureremotelybox](configure-remotely-box-step2.png){.thumbnail}
...
![configureremotelybox](configure-remotely-box-step3.png){.thumbnail}
...
![configureremotelybox](configure-remotely-box-step4.png){.thumbnail}
...
![configureremotelybox](configure-remotely-box-step5.png){.thumbnail}
...
![configureremotelybox](configure-remotely-box-step6.png){.thumbnail}
...
![configureremotelybox](configure-remotely-box-step7.png){.thumbnail}
...
![configureremotelybox](configure-remotely-box-step8.png){.thumbnail}
...
Si votre modem est de marque Zyxel, veuillez suivre le guide [Comment activer le bridge sur un modem zyxel](comment_activer_bridge_zyxel1.).
>
...
![configureremotelybox](configure-remotely-box-step9.png){.thumbnail}
...
|---|---|
|Bloc IP|Si vous [disposez d'un bloc IP](comment_commander_et_gerer_un_bloc_ip_291.), vous pouvez activer ou désactiver celui-ci. Toute la configuration de votre box va alors s'adapter automatiquement (par exemple : désactivation pare-feu + NAT).|
...
![configureremotelybox](configure-remotely-box-step10.png){.thumbnail}
