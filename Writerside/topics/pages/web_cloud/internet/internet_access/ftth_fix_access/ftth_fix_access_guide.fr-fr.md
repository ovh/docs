...
|---|---|
|![diagnosticfibre](acces-internet-ont-huawei.jpg)|![diagnosticfibre](acces-internet-ont-nokia.jpg)|
...
- **L'état des voyants indique que tout fonctionne correctement** : cela signifie que l'ONT est allumé et que la connexion avec le signal optique est établie. Dans ce cas, poursuivez vers l'étape 3 « [vérifier le fonctionnement jusqu'à la box OVHcloud](ftth_fix_access#etape-3-verifier-le-fonctionnement-jusqua-la-box-ovh.){.external} ».

![diagnosticfibre](acces-internet-ont-huawei.jpg)
...
![diagnosticfibre](acces-internet-ont-nokia.jpg)
...
- **Aucun voyant n’est allumé sur la box OVHcloud** : poursuivez vers la partie « [3.1 Tests liés au voyant POWER](ftth_fix_access#31-tests-lies-au-voyant-power.){.external} ».

- **Le voyant « WAN » est éteint** : poursuivez vers la partie « [3.2 Tests liés au voyant WAN](ftth_fix_access#32-tests-lies-au-voyant-wan.){.external} ».

- **Le voyant « INTERNET » est éteint et le voyant « WAN » allumé** : poursuivez vers la partie « [3.3 Tests liés au voyant INTERNET](ftth_fix_access#33-tests-lies-au-voyant-internet.){.external} ».

- **L'état des voyants indique que tout fonctionne correctement** : cela signifie que la box OVHcloud est allumée, reliée à l'ONT et connectée à Internet. Poursuivez alors vers l'étape 4 « [vérifier le fonctionnement jusqu'à vos équipements personnels](ftth_fix_access#etape-4-verifier-le-fonctionnement-jusqua-vos-equipements-personnels.){.external} ».

![diagnosticfibre](acces-internet-box-ovh.png){.thumbnail}
...
![diagnosticfibre](acces-internet-box-ovh-test-power.png){.thumbnail}
...
![diagnosticfibre](acces-internet-box-ovh-test-wan.png){.thumbnail}
...
![diagnosticfibre](acces-internet-box-ovh-test-internet-step1.png){.thumbnail}
...
![diagnosticfibre](acces-internet-box-ovh-test-internet-step2.png){.thumbnail}
...
![diagnosticfibre](acces-internet-laptop-test-step1.png){.thumbnail}
...
![diagnosticfibre](acces-internet-laptop-test-step2.png){.thumbnail}

Vous pouvez remarquer différents états concernant les cartes réseau.

|États|Illustration|Description|
|---|---|---|
|Active et connectée|![diagnosticfibre](acces-internet-laptop-test-step3.png){.thumbnail}|La carte réseau est activée et vous êtes connecté à la box OVHcloud. La connexion depuis cette carte doit donc être fonctionnelle.|
|Active et non connectée|![diagnosticfibre](acces-internet-laptop-test-step4.png){.thumbnail}|La carte réseau est activée, mais vous n'êtes pas connecté à la box OVHcloud. La connexion depuis cette carte n'est donc pas fonctionnelle.|
|Désactivée|![diagnosticfibre](acces-internet-laptop-test-step5.png){.thumbnail}|La carte réseau est désactivée. La connexion depuis cette carte n'est donc pas fonctionnelle.|
...
![diagnosticfibre](acces-internet-laptop-test-step6.png){.thumbnail}
...
![diagnosticfibre](acces-internet-laptop-test-step7.png){.thumbnail}
...
![diagnosticfibre](acces-internet-laptop-test-step8.png){.thumbnail}
...
![diagnosticfibre](acces-internet-laptop-test-step9.png){.thumbnail}

#### 4.4 Modifier la configuration Wi-Fi de votre box OVHcloud

> [!primary]
>
> Si vous n'utilisez pas une connexion Wi-Fi, poursuivez dès à présent vers la manipulation suivante : « [4.5 Vérifier la configuration réseau de votre box OVHcloud](ftth_fix_access#45-verifier-la-configuration-reseau-de-votre-box-ovh.){.external} ».
>
...
![diagnosticfibre](espaceclient2022.png){.thumbnail}
...
![diagnosticfibre](wifi-2022.png){.thumbnail}
...
![diagnosticfibre](acces-internet-laptop-test-step12-2022.png){.thumbnail}
...
![diagnosticfibre](acces-internet-laptop-test-step13-2022.png){.thumbnail}
...
![diagnosticfibre](acces-internet-laptop-test-step14.png){.thumbnail}
