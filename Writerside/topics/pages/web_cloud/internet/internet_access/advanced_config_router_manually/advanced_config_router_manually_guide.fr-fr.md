...
Si vous ne les connaissez pas, vous pouvez les récupérer en suivant les étapes de notre guide « [Obtenir les identifiants PPPoE](obtenir_id_ppp1.) ».
...
Si vous utilisez votre propre modem/routeur, vous pouvez utiliser les API OVHcloud afin de [générer l'envoi de nouveaux identifiants PPPoE par e-mail](obtenir_id_ppp1.).
...
![serviceName dans espace client](servicename-2022.png){.thumbnail}
...
![modem profil dans espace client](profil-2023.png){.thumbnail}
