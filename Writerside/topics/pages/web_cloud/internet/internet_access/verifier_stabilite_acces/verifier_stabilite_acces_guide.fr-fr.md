...
* l'envoi manuel de [nouveaux identifiants de connexion](obtenir_id_ppp1.).
...
![serviceName dans espace client](verifier_stabilite_acces_images_servicename-2022.png){.thumbnail}
...
![api_radex](api_radex3.png){.thumbnail}
...
Si vous constatez des reconnexions fréquentes sur l'un de vos accès xDSL ou FTTH, nous vous conseillons de faire le point sur votre [desserte interne](la_desserte_interne1.) et de consulter nos guides de [diagnostic et dépannage](web-cloud-internet-internet-access1.).
