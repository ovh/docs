...
![activerBridge](activerBridge-step1-2022.png){.thumbnail}
...
![activerBridge](activerBridge-step2.png){.thumbnail}
...
![activerBridge](activerBridge-step3-1.png){.thumbnail}
...
![activerBridge](activerBridge-step3-2.png){.thumbnail}

En cas de doute, le type de votre connexion est disponible sur l'espace client OVHcloud.

![activerBridge](activerBridge-step3-3-2022.png){.thumbnail}
...
![activerBridge](activerBridge-step4-1.png){.thumbnail}
...
![activerBridge](activerBridge-step4-2.png){.thumbnail}

### Étape 5 : Revenir en mode routeur

Pour revenir en mode routeur suivez le guide [Redémarrer ou réinitialiser une box OVHcloud](restart_reboot_modem#reinitialiser-votre-box-ovh.) pour réinitialiser votre modem Zyxel et rétablir sa configuration par défaut.
