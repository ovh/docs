...
> [!success]
> Si vous souhaitez changer d'offre, consultez notre guide « [Comment changer mon offre xDSL/FTTH](comment_changer_mon_offre_xdsl1.) ».
...
![Resiliation acces](Resiliation01-edit-2022.png){.thumbnail}
...
![Raison resiliation](Resiliation02-edit-2022.png){.thumbnail}
...
![Conservation service](Resiliation03-edit-2022.png){.thumbnail}
...
![Annulation resiliation](Resiliation05-edit-2022.png){.thumbnail}

<br>Afin de valider cette annulation, cliquez sur le bouton `Annuler la résiliation en cours`{.action}.

![Annulation resiliation](Resiliation06-edit-2022.png){.thumbnail}
