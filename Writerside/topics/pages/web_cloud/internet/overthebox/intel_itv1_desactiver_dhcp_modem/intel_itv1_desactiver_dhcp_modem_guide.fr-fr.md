...
![overthebox](4320.png){.thumbnail}

- Cliquez sur **"Configure"**
- Décochez la case **"Use DHCPv4 Server"**
- Cliquez sur **"Apply"**

![overthebox](4321.png){.thumbnail}
...
![overthebox](4332.png){.thumbnail}

- Configurer l'état du DHCP sur **"INACTIF"**

![overthebox](4333.png){.thumbnail}
...
![overthebox](4334.png){.thumbnail}

- Cliquez sur **"DHCP"**

![overthebox](4335.png){.thumbnail}

- Cochez la case **"Activer le serveur DHCP"**
- Cliquez sur **"OK"**

![overthebox](4336.png){.thumbnail}
...
![overthebox](4339.png){.thumbnail}

- Configurez le DHCP sur **"Non"**
- Cliquez sur **"Appliquer"**

![overthebox](4342.png){.thumbnail}
...
![overthebox](4343.png){.thumbnail}

- Configurez le DHCP sur **"Off"**
- Cliquez sur **"Valider"**

![overthebox](4344.png){.thumbnail}
