...
> Veuillez vous reporter au guide suivant pour les offres OverTheBox actuelles : [Installation OverTheBox Plus ou IT v2](plus_itv2_installation1.)
>
...
- Une **OverTheBox** fournie par OVHcloud ou une installation depuis le projet Open Source ([installer l'image overthebox sur votre materiel](advanced_installer_limage_overthebox_sur_votre_materiel1.))
...
![overthebox](installationV1-step1_OTBv1.jpg){.thumbnail}

Dans le cas d'une OverTheBox IT v1 :
![overthebox](installationV1-step1_OTBv2a.jpg){.thumbnail}
...
Dans ce cas, vous devez modifier l'adresse IP de l'un des deux modems, ce guide détaille la procédure à suivre en fonction de votre fournisseur d'accès : [Désactiver le serveur DHCP de votre modem](intel_itv1_desactiver_dhcp_modem1.)
...
Dans le cas d'une OverTheBox Intel :
![overthebox](installationV1-step2_OTBv1.jpg){.thumbnail}

Dans le cas d'une OverTheBox IT v1 :
![overthebox](installationV1-step2_OTBv2a.jpg){.thumbnail}
...
Dans le cas d'une OverTheBox Intel :
![overthebox](installationV1-step3-1_OTBv1.jpg){.thumbnail}

Dans le cas d'une OverTheBox IT v1 :
![overthebox](installationV1-step3-1_OTBv2a.jpg){.thumbnail}
...
![overthebox](installationV1-step4-1.png){.thumbnail}

Votre **OverTheBox** est maintenant prête à la configuration :

![overthebox](installationV1-step4-2.png){.thumbnail}
...
![overthebox](installationV1-step4-5.png){.thumbnail}
...
Dans le cas d'une OverTheBox Intel :
![overthebox](installationV1-step5-1_OTBv1.jpg){.thumbnail}

Dans le cas d'une OverTheBox IT v1 :
![overthebox](installationV1-step5-1_OTBv2a.jpg){.thumbnail}
...
![overthebox](installationV1-step5-2.png){.thumbnail}
...
![overthebox](installationV1-step5-3.png){.thumbnail}
...
![overthebox](installationV1-step5-4.png){.thumbnail}
...
Si vous devez utiliser la télévision via l'un des modems pris en charge par **OverTheBox**, veuillez suivre la procédure décrite sur le guide suivant : [Intégration d'un Décodeur TV](intel_itv1_integration_decodeur_tv1.){.external}.
