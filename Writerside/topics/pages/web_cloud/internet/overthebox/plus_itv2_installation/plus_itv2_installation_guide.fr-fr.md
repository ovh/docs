...
![overthebox](installationV2-step2_OTBPlus.jpg){.thumbnail}

**Exemple** : Le premier modem possède l'IP 192.168.**0**.1 et le deuxième 192.168.**1**.1

Dans le cas d'une OverTheBox IT v2 :

![overthebox](installationV2-step2_OTBITv2_edit.jpg){.thumbnail}
...
![overthebox](installationV2-step4-1.png){.thumbnail}
...
![overthebox](installationV2-step5.png){.thumbnail}
