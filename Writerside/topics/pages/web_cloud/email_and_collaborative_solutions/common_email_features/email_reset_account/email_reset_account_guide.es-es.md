...
>>![Correo electrónico](email-mxplan-legacy-reset.png){.thumbnail}<br>
>>
...
>> Después de restaurar su cuenta, si desea eliminarla definitivamente, deberá darlo de baja. Para ello, consulte nuestra guía [Gestionar la facturación de sus cuentas Email-Pro](manage_billing_emailpro1.).<br><br>
>>![Correo electrónico](emailpro-reset.png){.thumbnail}<br>
>>
> **Exchange**
>>
...
|---|---|
|![Correo electrónico](mxplan-starter-legacy-step1.png){.thumbnail}<br> El nombre del producto aparece en el recuadro Suscripción, en el epígrafe Producto.|![Correo electrónico](mxplan-starter-new-step1.png){.thumbnail}<br>El nombre del producto aparece en el recuadro Resumen, en el epígrafe Referencia del servidor.|
...
[Gestionar la facturación de las cuentas Email Pro](manage_billing_emailpro1.)
