...
- **Email Pro** e **Hosted Exchange**: estas duas ofertas estão 'à la carte', encomenda uma subscrição individual por conta de e-mail. Se deseja eliminar um endereço de e-mail, trata-se de efetuar uma **reinicialização**. Uma vez a conta de e-mail reinicializada, pode reutilizar esta conta para criar um novo endereço de e-mail. Também pode [cancelar a assinatura](manage_billing_exchange#eliminar-contas.) desta conta se pretender eliminá-la definitivamente.
...
>>![e-mail](email-mxplan-new-reset.png){.thumbnail}<br>
>>
> **Email Pro**
>>
...
>> Após a reinicialização da sua conta, se pretender eliminá-la definitivamente, deverá rescindir a sua conta. Para isso, consulte o nosso guia [Gerir a faturação das contas Email-Pro](manage_billing_emailpro1.).<br><br>
...
>> Após a reinicialização da sua conta, se pretender eliminá-la definitivamente, deverá rescindir a sua conta. Para isso, consulte o nosso guia [Gerir a faturação das contas Exchange](manage_billing_exchange1.).<br><br>
...
|---|---|
|![email](mxplan-starter-legacy-step1.png){.thumbnail}<br> Consulte o tipo de oferta na secção “Subscrição”.|![email](mxplan-starter-new-step1.png){.thumbnail}<br>Consulte a Referência do servidor na secção "Resumo".|
...
[Primeiros passos com a solução MXplan](email_generalities1.)

[Primeiros passos com a solução E-mail Pro](first_config1.)

[Primeiros passos com a solução Hosted Exchange](exchange_starting_hosted1.)

[Gerir a faturação das contas Email Pro](manage_billing_emailpro1.)

[Gerir a faturação das suas contas Exchange](manage_billing_exchange1.)
