...
>>![E-Mail](email-mxplan-legacy-reset.png){.thumbnail}<br>
>>
...
>> Wenn Sie Ihren Account nach dem Zurücksetzen endgültig löschen möchten, müssen Sie ihn kündigen. Lesen Sie hierzu unsere Anleitung zur [Verwaltung der Abrechnung Ihrer E-Mail Pro Accounts](manage_billing_emailpro1.).<br><br>
>>![E-Mail](emailpro-reset.png){.thumbnail}<br>
>>
> **Exchange**
>>
...
>> Wenn Sie Ihren Account nach dem Zurücksetzen endgültig löschen möchten, müssen Sie ihn kündigen. Lesen Sie hierzu unsere Anleitung zur [Verwaltung der Abrechnung Ihrer Exchange Accounts](manage_billing_exchange1.).<br><br>
>>![E-Mail](exchange-reset.png){.thumbnail}<br>
>>
...
|---|---|
|![E-Mail](mxplan-starter-legacy-step1.png){.thumbnail}<br>Die Dienstbezeichnung steht im Rahmen **Abo** rechts. MX Plan Legacy *hat keine* Server-Referenz.|![E-Mail](mxplan-starter-new-step1.png){.thumbnail}<br>Das neue Angebot hat eine **Server-Referenz** im Rahmen **Zusammenfassung** links.|
...
[Verwaltung der Abrechnung Ihrer E-Mail Pro Accounts](manage_billing_emailpro1.)

[Verwaltung der Abrechnung Ihrer Exchange Accounts](manage_billing_exchange1.)
