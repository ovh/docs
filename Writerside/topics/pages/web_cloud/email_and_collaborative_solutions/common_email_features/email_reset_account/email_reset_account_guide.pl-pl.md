...
>> Po zresetowaniu konta, jeśli chcesz go definitywnie usunąć, należy go rozwiązać. W tym celu zapoznaj się z naszym przewodnikiem [Zarządzanie płatnościami za Twoje konta Email-Pro](manage_billing_emailpro1.)<br><br>
...
>> Po zresetowaniu konta, jeśli chcesz go definitywnie usunąć, należy go rozwiązać. W tym celu zapoznaj się z naszym przewodnikiem [Zarządzanie płatnościami za Twoje konta Exchange](manage_billing_exchange1.).<br><br>
...
|---|---|
|![email](mxplan-starter-legacy-step1.png){.thumbnail}<br> Znajdź nazwę oferty w polu „Abonament”.|![email](mxplan-starter-new-step1.png){.thumbnail}<br>Znajdź Oznaczenie serwera w polu "Podsumowanie".|
...
[Pierwsze kroki z usługą MXplan](email_generalities1.)

[Pierwsze kroki z usługą E-mail Pro](first_config1.)

[Pierwsze kroki z usługą Hosted Exchange](exchange_starting_hosted1.)

[Zarządzanie płatnościami za Twoje konta Email Pro](manage_billing_exchange1.)

[Zarządzanie płatnościami za konta Exchange](manage_billing_exchange1.)
