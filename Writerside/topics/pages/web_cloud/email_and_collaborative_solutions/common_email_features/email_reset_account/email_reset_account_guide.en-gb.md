...
>> After resetting your account, if you want to permanently delete it, you must cancel it. To do this, please refer to our guide "[Managing the billing for your Email Pro accounts](manage_billing_emailpro1.)".<br><br>
...
>> After resetting your account, if you want to permanently delete it, you must cancel it. To do this, please refer to our guide "[Managing the billing for your Exchange accounts](manage_billing_exchange1.)".<br><br>
...
|---|---|
|![email](mxplan-starter-legacy-step1.png){.thumbnail}<br> The solution appears in the **Subscription** box on the right. The legacy solution *does not* have a server reference.|![email](mxplan-starter-new-step1.png){.thumbnail}<br>The new solution has a **Server model** in the **Summary** box on the left.|
...
[Getting started with Email Pro](first_config1.)

[Getting started with Hosted Exchange](exchange_starting_hosted1.)

[Managing the billing of your Email Pro accounts](manage_billing_emailpro1.)

[Managing the billing of your Exchange accounts](manage_billing_exchange1.)
