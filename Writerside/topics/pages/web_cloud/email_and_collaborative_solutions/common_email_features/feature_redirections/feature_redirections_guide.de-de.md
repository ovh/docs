...
![E-Mails](schema-redirect.png){.thumbnail}
...
> |---|---|
> |![E-Mail](mxplan-starter-legacy.png){.thumbnail}<br>Die Dienstbezeichnung steht im Rahmen **Abo** rechts. MX Plan Legacy *hat keine* Server-Referenz.|![E-Mail](mxplan-starter-new.png){.thumbnail}<br>Das neue Angebot hat eine **Server-Referenz** im Rahmen **Zusammenfassung** links.|
...
>> ![{.thumbnail}](emails-all-01.png) E-Mails<br>
>>
> **Schritt 2**
>>
...
>> ![E-Mails](emails-all-02.png){.thumbnail}<br><br>
...
>> ![E-Mails](emails-all-03.png){.thumbnail}<br><br>
>>
> **Schritt 4**
>>
...
>>![E-Mails](emails-all-04.png){.thumbnail .w-640}<br><br>
>>
> **Schritt 5**
>>
...
>>![E-Mails](emails-all-05.png){.thumbnail .w-640}<br><br>
>>
> **Schritt 6**
>>
...
>>![E-Mails](emails-all-06.png){.thumbnail .w-640}<br><br>
>>
...
>> ![E-Mails](email-alias03.png){.thumbnail}<br>
...
![E-Mails](email-alias04.png){.thumbnail}
...
>> ![E-Mails](mxplan-legacy-1.png){.thumbnail}<br>
>>
> **Schritt 2**
>>
...
>>
>> ![E-Mails](mxplan-legacy-2.png){.thumbnail}<br>
>>
> **Schritt 3**
>>
...
>> ![E-Mails](mxplan-legacy-3.png){.thumbnail}
