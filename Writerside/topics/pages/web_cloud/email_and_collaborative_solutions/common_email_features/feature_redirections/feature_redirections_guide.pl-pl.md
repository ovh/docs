...
> |---|---|
> |![email](mxplan-starter-legacy.png){.thumbnail}<br> Znajdź nazwę oferty w polu „Abonament”|![email](mxplan-starter-new.png){.thumbnail}<br>Znajdź `Oznaczenie serwera` w polu „Podsumowanie”|
...
>> ![emaile](emails-all-01.png){.thumbnail}<br>
>>
> **Etap 2**
...
> ![emaile](emails-all-07.png){.thumbnail .w-640}
