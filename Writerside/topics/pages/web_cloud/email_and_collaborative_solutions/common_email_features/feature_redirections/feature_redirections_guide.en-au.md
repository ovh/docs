...
Go to the address <https://www.ovhcloud.com/en-au/mail/>. Enter your **email address** and **password** to log in.
...
> **Step 1**
>>
>> Once you have logged in to your email account via [webmail](https://www.ovhcloud.com/en-au/mail/), click on the cogwheel icon in the top right-hand corner, then on `Options`{.action}.<br><br>
