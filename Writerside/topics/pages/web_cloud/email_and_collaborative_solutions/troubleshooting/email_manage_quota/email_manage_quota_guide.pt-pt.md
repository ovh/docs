...
> - No âmbito de um [alojamento web](https://www.ovhcloud.com/pt/web-hosting/), é necessário ativar a oferta MX Plan incluída antes de continuar a ler este manual. Para isso, consulte o nosso manual "[Ativar os endereços de e-mail incluídos no seu alojamento web](activate-email-hosting1.)".
...
>> - [Endereço do Windows 10](how_to_configure_windows_101.) (English) (incluído com Windows)<br>
...
>> - [Mail](how_to_configure_mail_macos1.) (incluído com macOS)<br>
...
>> - [Endereço do Windows 10](how_to_configure_windows_103.) (English) (incluído com Windows)<br>
...
>> - [Mail](how_to_configure_mail_macos3.) (incluído com macOS)<br>
...
>> - [Endereço do Windows 10](how_to_configure_windows_102.) (English) (incluído com Windows)<br>
...
>> - [Mail](how_to_configure_mail_macos2.) (incluído com macOS)<br>
...
> **E-mails (MXplan)**
>>
>> Se a capacidade da sua conta de e-mail já está a um máximo de 5GB, pode optar por uma migração para uma oferta [**Email Pro** de 10GB](https://www.ovhcloud.com/pt/emails/email-pro/) ou [**Hosted Exchange** de 50GB](https://www.ovhcloud.com/pt/emails/hosted-exchange/). Para isso, sugerimos que encomende a oferta mais adequada e siga a documentação "[Migrar um endereço de e-mail MX Plan para uma conta E-mail Pro ou Exchange](migration_control_panel1.)". 
>>
> **Email Pro**
>>
>> A oferta Email Pro dispõe de uma capacidade única de 10GB. Pode optar por uma migração para uma oferta [**Hosted Exchange** de 50GB](https://www.ovhcloud.com/pt/emails/hosted-exchange/). Para isso, sugerimos que encomende a oferta mais adequada e siga o nosso manual "[Migrar os endereços de e-mail de uma plataforma de e-mail da OVHcloud para outra](migration_platform1.)".
>>
> **Exchange**
>>
...
[Migrar um endereço de e-mail MX Plan para uma conta E-mail Pro ou Exchange](migration_control_panel1.)

[Migrar manualmente o seu endereço de e-mail](manual_email_migration1.)

[Migrar os endereços de e-mail de uma plataforma de e-mail OVHcloud para outra](migration_platform1.)
