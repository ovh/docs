...
![email](email-quota-quotacontrolpanel01.png){.thumbnail}
...
- [Mail on Windows 10](how_to_configure_windows_101.) (included with Windows)
- [Outlook for Mxplan](how_to_configure_outlook_20161.)
- [Thunderbird](how_to_configure_thunderbird_windows1.) (free)

Configuring an MXplan account on **macOS**:

- [Mail](how_to_configure_mail_macos1.) (included with macOS)
- [Outlook](how_to_configure_outlook_2016_mac1.)
- [Thunderbird](how_to_configure_thunderbird_mac1.) (free)
