...
![Correo electrónico](email-quota-intro.gif){.thumbnail}
...
>>![Correo electrónico](email-quota-quotacontrolpanel01.png){.thumbnail}<br>
>>
> **Exchange**
>>
...
>>![Correo electrónico](email-quota-quotacontrolpanel03.png){.thumbnail}<br>
>>
...
![Correo electrónico](email-quota-webmail01.png){.thumbnail}
...
![Correo electrónico](email-quota-optimise01.png){.thumbnail}
...
>>![Correo electrónico](email-quota-more02.png){.thumbnail}<br>
>>
...
![Correo electrónico](email-quota-step03-archive.png){.thumbnail}
...
>> - [Correo en Windows 10](how_to_configure_windows_101.) (incluido con Windows)<br>
>> - [Outlook para Mxplan](how_to_configure_outlook_20161.)
>> - [Thunderbird](how_to_configure_thunderbird_windows1.) (gratuito)<br>>
>> Configuración de una cuenta MXplan en **macOS**:<br><br>
>> - [Mail](how_to_configure_mail_macos1.) (incluido con macOS)<br>
>> - [Outlook](how_to_configure_outlook_2016_mac1.)<br>
>> - [Thunderbird](how_to_configure_thunderbird_mac1.) (gratuito)<br>
>>
> **Exchange**
>>
>> Configuración de una cuenta Exchange en **Windows** :<br><br>
>> - [Correo en Windows 10](how_to_configure_windows_102.) (incluido con Windows)<br>
>> - [Outlook](how_to_configure_outlook_20162.)<br>
>> - [Thunderbird](how_to_configure_thunderbird2.) (gratuito)<br>>
>> Configuración de una cuenta Exchange en **macOS**:<br><br>
>> - [Mail](how_to_configure_mail_macos2.) (incluido con macOS)<br>
...
[Migrar una cuenta MX Plan a una cuenta Exchange](migration_control_panel1.)

[Migrar manualmente una dirección de correo electrónico](manual_email_migration1.)

[Migrar sus direcciones de correo de una plataforma de correo de OVHcloud a otra](migration_platform1.)
