...
> - Prima di continuare la lettura di questa guida, è necessario attivare il servizio di [hosting Web](https://www.ovhcloud.com/it/web-hosting/). Per farlo, consulta la guida [Attiva gli indirizzi email inclusi nel tuo hosting Web](activate-email-hosting1.).
...
>>![email](email-quota-quotacontrolpanel02.png){.thumbnail}<br>
>>
> **Exchange**
>>
...
>>![email](email-quota-webmail02.png){.thumbnail}<br>
>>
...
![email](email-quota-optimise01.png){.thumbnail}
...
>> - [Posta su Windows 10](how_to_configure_windows_101.) (incluso con Windows)<br>
>> - [Outlook per Mxplan](how_to_configure_outlook_20161.)
>> - [Thunderbird](how_to_configure_thunderbird_windows1.) (gratuito)<br><br>
>> Configurazione di un account MXplan su **macOS**:<br><br>
>> - [Mail](how_to_configure_mail_macos1.) (incluso con macOS)<br>
>> - [Outlook](how_to_configure_outlook_2016_mac1.)<br>
>> - [Thunderbird](how_to_configure_thunderbird_mac1.) (gratuito)
>>
> **Email Pro**
>>
>> Configurazione di un account Email Pro su **Windows**:<br><br>
>> - [Posta su Windows 10](how_to_configure_windows_103.) (incluso con Windows)<br>
>> - [Outlook](how_to_configure_outlook_20163.)<br>
>> - [Thunderbird](how_to_configure_thunderbird1.) (gratuito)<br><br>
>> Configurazione di un account Email Pro su **macOS**:<br><br>
>> - [Mail](how_to_configure_mail_macos3.) (incluso con macOS)<br>
>> - [Outlook](how_to_configure_outlook_2016_mac3.)<br>
>> - [Thunderbird](how_to_configure_thunderbird_mac2.) (gratuito)<br>
>>
> **Exchange**
>>
>> Configurazione di un account Exchange su **Windows**:<br><br>
>> - [Posta su Windows 10](how_to_configure_windows_102.) (incluso con Windows)<br>
>> - [Outlook](how_to_configure_outlook_20162.)<br>
>> - [Thunderbird](how_to_configure_thunderbird2.) (gratuito)<br><br>
>> Configurazione di un account Exchange su **macOS**:<br><br>
>> - [Mail](how_to_configure_mail_macos2.) (incluso con macOS)<br>
>> - [Outlook](how_to_configure_outlook_2016_mac2.)<br>
>> - [Thunderbird](how_to_configure_thunderbird_mac3.) (gratuito)<br>
>>
...
[Migrare un indirizzo email MX Plan verso un account Email Pro o Exchange](migration_control_panel1.)

[Migra manualmente il tuo indirizzo email](manual_email_migration1.)

[Migrare i tuoi account email da una piattaforma OVHcloud verso un'altra](migration_platform1.)
