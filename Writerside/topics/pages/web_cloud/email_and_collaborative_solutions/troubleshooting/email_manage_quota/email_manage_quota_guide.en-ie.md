...
> - For [web hosting plans](https://www.ovhcloud.com/en-ie/web-hosting/), you will need to activate your MX Plan before continuing with this guide. To do this, please refer to our guide on [Activating the email addresses included in your web hosting plan](activate-email-hosting1.).
...
>> - [Windows 10 Mail](how_to_configure_windows_101.) (included with Windows)<br>
>> - [Outlook for MX Plan](how_to_configure_outlook_20161.)
...
>> - [Windows 10 Mail](how_to_configure_windows_103.) (included with Windows)<br>
>> - [Outlook](how_to_configure_outlook_20163.)<br>
>> - [Thunderbird](how_to_configure_thunderbird1.) (free)<br><br>
>> Configuring an Email Pro account on **macOS**:<br><br>
>> - [Mail](how_to_configure_mail_macos3.) (included with macOS)<br>
>> - [Outlook](how_to_configure_outlook_2016_mac3.)<br>
>> - [Thunderbird](how_to_configure_thunderbird_mac2.) (free)<br>
>>
> **Exchange**
>>
>> Configuring an Exchange account on **Windows**:<br><br>
>> - [Windows 10 Mail](how_to_configure_windows_102.) (included with Windows)<br>
...
[Migrating an MX Plan email account to Email Pro or Exchange](migration_control_panel1.)

[Manually migrate your email account](manual_email_migration1.)

[Migrating your email account from one OVHcloud email platform to another](migration_platform1.)
