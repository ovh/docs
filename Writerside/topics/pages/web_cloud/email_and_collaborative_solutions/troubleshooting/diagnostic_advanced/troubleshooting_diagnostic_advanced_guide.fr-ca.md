...
- Pour une offre **E-mail**, dans la section [E-mails](web-cloud-email-collaborative-solutions-mx-plan1.) de nos guides **Web Cloud**, vérifiez la configuration de votre logiciel de messagerie dans le paragraphe `Configuration sur ordinateur` ou de votre smartphone dans `Configuration sur smartphone`.
...
- Pour une offre **E-mail**, consultez notre guide [Modifier le mot de passe d’une adresse e-mail MX Plan](email_change_password1.)
