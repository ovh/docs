...
> [!primary]
>
> Si vous avez d'autres questions qui ne sont pas traitées par ce guide, n'hésitez pas à consulter notre [FAQ E-mail](faq-emails1.).
...
Commencez par vérifier que vous êtes à jour dans les [paiements](invoice_management#pay-bills.) et [renouvellements](how_to_use_automatic_renewal#renewal-management.) de vos services.
...
- Pour une offre **MXplan**, dans la section [E-mails mutualisés - MX Plan](web-cloud-email-collaborative-solutions-mx-plan1.) de nos guides **Web Cloud**, vérifiez la configuration de votre logiciel de messagerie dans le paragraphe `Configuration sur ordinateur` ou de votre smartphone dans `Configuration sur smartphone`.

- Pour une offre **E-mail Pro**, dans la section [E-mail Pro](web-cloud-email-collaborative-solutions-email-pro1.), de nos guides **Web Cloud**, vérifiez la configuration de votre logiciel de messagerie dans le paragraphe `Configuration sur ordinateur` ou de votre smartphone dans `Configuration sur smartphone`.

- Pour une offre **Exchange**, dans la section [Solutions collaboratives Microsoft](web-cloud-email-collaborative-solutions-microsoft-exchange1.) de nos guides **Web Cloud**, vérifiez la configuration de votre logiciel de messagerie dans le paragraphe `Configuration Exchange sur ordinateur` ou de votre smartphone dans `Configuration Exchange sur smartphone`

### Je ne parviens pas à recevoir d'e-mails car mon adresse e-mail est saturée, je n'ai plus d'espace. Que puis-je faire ?

Si vous avez souscrit à [l'une de nos offres e-mail OVHcloud](https://www.ovhcloud.com/fr/emails/) et que l'un de vos comptes e-mail est saturé, consultez notre guide « [Gérer l'espace de stockage d'un compte e-mail](email_manage_quota1.) ». Ce guide vous aidera à déterminer si vous pouvez optimiser l'espace existant ou s’il est nécessaire de changer d'offre e-mail pour augmenter la capacité de stockage.
...
- Pour une offre **MXplan**, consultez notre guide [Modifier le mot de passe d’une adresse e-mail MX Plan](email_change_password1.)
...
Vérifiez que votre nom de domaine pointe correctement vers les serveurs e-mail OVHcloud. Pour cela, des enregistrements de type MX doivent être configurés dans votre zone DNS. <br>Référez-vous à notre guide [Ajouter un champ MX à la configuration de son nom de domaine](dns_zone_mx1.).

![DNSzone](DNS.png){.thumbnail}
...
|535|Echec lors de l'authentification|Les informations utilisateur/mot de passe sont erronées ou l'envoi est potentiellement bloqué sur votre adresse e-mail. Vérifiez l'état de votre adresse e-mail depuis votre espace client OVHcloud. Un changement de mot de passe peut débloquer l'envoi si le compte à été bloqué pour spam. Consultez notre guide [Que faire en cas de compte bloqué pour spam ?](locked_for_spam1.) pour plus d'informations.|
