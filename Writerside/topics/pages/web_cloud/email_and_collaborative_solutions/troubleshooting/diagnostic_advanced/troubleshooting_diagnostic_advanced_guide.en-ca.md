...
- For an **MXplan** solution, go to the [Hosted email](web-cloud-email-collaborative-solutions-mx-plan1.) section in our **Web Cloud** guides, and check the configuration of your email software in the `Configure on computer` section, or in the `Configure on smartphone` section for your smartphone.
