...
> [!primary]
>
> Se tiver outras questões que não sejam tratadas neste manual, não hesite em consultar a nossa [FAQ de E-mail](faq-emails1.).
...
Comece por verificar que está atualizado nos [pagamentos](invoice_management#pay-bills.) e nas [renovações](how_to_use_automatic_renewal#renewal-management.) dos seus serviços.
...
- Para uma oferta **MXplan**, na secção [Hosted email - MX Plan](web-cloud-email-collaborative-solutions-mx-plan1.) dos nossos guias **Web Cloud**.

- Para uma oferta **E-mail Pro**, na secção [E-mail Pro](web-cloud-email-collaborative-solutions-email-pro1.), dos nossos guias **Web Cloud**.

- Para uma oferta **Exchange**, na secção [Soluções colaborativas Microsoft](web-cloud-email-collaborative-solutions-microsoft-exchange1.) dos nossos guias **Web Cloud**.

### Não consigo receber e-mails porque o meu endereço de e-mail está cheio, não tenho espaço. O que posso fazer?

Se subscreveu [um dos nossos serviços de e-mail OVHcloud](https://www.ovhcloud.com/pt/emails/) e uma das suas contas de e-mail está saturada, consulte o nosso guia "[Gerir o espaço de armazenamento de uma conta de e-mail](email_manage_quota1.)". Este guia ajuda-o a determinar se pode otimizar o espaço existente ou se é necessário mudar de oferta de e-mail para aumentar a capacidade de armazenamento.
...
- Para uma oferta **MXplan**, consulte o nosso guia [Alterar a palavra-passe de um endereço de e-mail MX Plan](email_change_password1.)
...
Verifique que o seu domínio está a apontar corretamente para os servidores de e-mail OVHcloud. Para isso, devem ser configurados registos do tipo MX na sua zona DNS. <br>Consulte o nosso manual [Adicionar um campo MX à configuração do domínio](dns_zone_mx1.).
