...
- Disposer d'une solution e-mail OVHcloud:
    - **MX Plan** ([nouvelle version uniquement](email_generalities#en-pratique.)) proposée parmi nos [offres d’hébergement web](https://www.ovhcloud.com/fr-ca/web-hosting/)
