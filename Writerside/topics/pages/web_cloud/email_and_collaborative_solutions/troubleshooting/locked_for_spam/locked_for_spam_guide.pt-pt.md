...
|---|---|
|![email](locked_for_spam_images_mxplan-starter-legacy-step1.png){.thumbnail}<br> Consulte a oferta na secção "Subscrição"|![email](locked_for_spam_images_mxplan-starter-new-step1.png){.thumbnail}<br>Consulte a "Referência do servidor" na secção "Resumo"|
...
>> Passe para [etapa 3](locked_for_spam_#step3.) do guia.
>>
...
> **MX plan - Histórico**
>>
>> Se o bloqueio disser respeito a um endereço de e-mail [MXplan version historial](locked_for_spam_#instructions.), não há ticket de assistência. Consulte este manual [passo 1](locked_for_spam_#step1.) antes de seguir as instruções abaixo.
>>
...
>>
>> Dirija-se ao separador `Emails`{.action} da sua plataforma. Se a coluna "Bloqueado por SPAM" mencionar "Sim", clique nesta menção e depois em `Alterar a palavra-passe`{.action}. O seu endereço de e-mail foi desbloqueado. Não precisa de seguir o [passo 3](locked_for_spam_#step3.).
>>
