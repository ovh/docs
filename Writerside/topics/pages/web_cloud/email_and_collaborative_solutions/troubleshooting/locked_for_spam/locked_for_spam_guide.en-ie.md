...
|------|------|
|![email](locked_for_spam_images_mxplan-starter-legacy-step1.png){.thumbnail}<br> Locate the solution in the `Subscription` box on the right.|![email](locked_for_spam_images_mxplan-starter-new-step1.png){.thumbnail}<br>Locate the `Server model` in the `Summary` box on the left.|
...
>>
>> Go to [step 3](locked_for_spam_#step3.) of the guide.
>>
...
> **MX Plan - Legacy**
>>
>> If the block is for an email account of [MX Plan Legacy](locked_for_spam_#instructions.), there is no support ticket. Be sure to read [step 1](locked_for_spam_#step1.) of this guide before following the instructions below.
>>
...
>>
>> Go to the `Emails`{.action} tab on your platform. If the “Blocked for SPAM” column shows “Yes”, click on it and then on `Change password`{.action}. Your email account is now unblocked, you do not need to follow [step 3](locked_for_spam_#step3.).
>>
