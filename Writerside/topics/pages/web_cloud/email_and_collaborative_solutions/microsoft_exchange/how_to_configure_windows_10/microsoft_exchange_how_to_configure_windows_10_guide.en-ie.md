...
[Configuring an email address included in an MX Plan or web hosting plan on the Mail application for Windows 10](how_to_configure_windows_101.){.external}

[Configuring your Email Pro account in the Mail app for Windows 10](how_to_configure_windows_103.){.external}
