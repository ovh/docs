...
- [Zugangsrechte nutzen](feature_delegation#21-zugangsrechte-nutzen.){.external}

- [„Senden als“-Berechtigung nutzen](feature_delegation#22-senden-als-berechtigung-nutzen.){.external}

- [„Senden im Auftrag von“-Berechtigung nutzen](feature_delegation#23-senden-im-auftrag-von-berechtigung-nutzen.){.external}
