...
- [Utilizzare il “diritto di accesso”](feature_delegation#utilizzare-il-diritto-di-accesso.){.external}

- [Utilizzare il “diritto di invio”](feature_delegation#utilizzare-il-diritto-di-invio.){.external}

- [Utilizzare il “diritto di invio da parte di”](feature_delegation#utilizzare-il-diritto-invia-da-parte-di.){.external}
...
![Delega](delegation-step3.png){.thumbnail}
...
![Delega](delegation-step4.png){.thumbnail}
...
![Delega](delegation-step5.png){.thumbnail}
...
![Delega](delegation-step6.png){.thumbnail}
...
![Delega](delegation-step7.png){.thumbnail}
