...
![Delegación de permisos](delegation-step1.png){.thumbnail}
...
![Delegación de permisos](delegation-step2.png){.thumbnail}
...
- [Utilizar el permiso de acceso completo](feature_delegation#21-utilizar-el-permiso-de-acceso-completo.){.external}
- [Utilizar el permiso de «enviar como»](feature_delegation#22-utilizar-el-permiso-de-enviar-como.){.external}
- [Utilizar el permiso de «enviar en nombre de»](feature_delegation#23-utilizar-el-permiso-de-enviar-en-nombre-de.){.external}
...
![Delegación de permisos](delegation-step3.png){.thumbnail}
...
![Delegación de permisos](delegation-step4.png){.thumbnail}
...
![Delegación de permisos](delegation-step5.png){.thumbnail}
...
![Delegación de permisos](delegation-step6.png){.thumbnail}
...
![Delegación de permisos](delegation-step7.png){.thumbnail}
