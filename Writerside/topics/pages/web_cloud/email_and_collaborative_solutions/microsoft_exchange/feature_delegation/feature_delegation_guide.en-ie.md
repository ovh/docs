...
To do this, log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie): 
...
![delegation](delegation-step1.png){.thumbnail}
...
![delegation](delegation-step2.png){.thumbnail}
...
Log in via the [OVHcloud webmail](https://www.ovhcloud.com/en-ie/mail/) using the credentials for the email account that has been delegated permissions. Once you are logged in, right-click on the name of the account in the menu on the left-hand side, then select `Add shared folder`{.action}.
...
![delegation](delegation-step3.png){.thumbnail}
...
![delegation](delegation-step4.png){.thumbnail}
...
![delegation](delegation-step5.png){.thumbnail}

#### 2.2 Using the "Send As" permission

- **From the Outlook Web App (OWA)**

Log in via the [OVHcloud webmail](https://www.ovhcloud.com/en-ie/mail/) using the credentials for the email account that has been delegated permissions. Once you have logged in, start editing a new email by clicking `+ New`{.action}.
...
![delegation](delegation-step6.png){.thumbnail}
...
![delegation](delegation-step7.png){.thumbnail}
...
[Using the Outlook Web App with an email account](email_owa1.)
