...
- [Utiliser son « droit d'accès »](feature_delegation#21-utiliser-son-droit-dacces.){.external}

- [Utiliser son « droit d'envoi »](feature_delegation#22-utiliser-son-droit-denvoi.){.external}

- [Utiliser son « droit d'envoyer de la part de »](feature_delegation#23-utiliser-son-droit-denvoyer-de-la-part-de.){.external}
