...
![delegação](delegation-step1.png){.thumbnail}
...
![delegação](delegation-step2.png){.thumbnail}
...
- [Utilizar o seu "direito de acesso"](feature_delegation_#access.)
...
![delegação](delegation-step3.png){.thumbnail}
...
![delegação](delegation-step4.png){.thumbnail}
...
![delegação](delegation-step5.png){.thumbnail}
...
![delegação](delegation-step6.png){.thumbnail}
...
![delegação](delegation-step7.png){.thumbnail}
