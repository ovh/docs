...
![delegacja uprawnień exchange](delegation-step1.png){.thumbnail}
...
![delegacja uprawnień exchange](delegation-step2.png){.thumbnail}
...
- [Korzystanie z „prawa dostępu”](feature_delegation#21-korzystanie-z-prawa-dostepu.){.external}

- [Korzystanie z „prawa do wysyłki poczty”](feature_delegation#22-korzystanie-z-prawa-do-wysylki-poczty.){.external}

- [Korzystanie z „prawa do wysyłki poczty w imieniu”](feature_delegation#23-korzystanie-z-prawa-do-wysylki-poczty-w-imieniu.){.external}
...
![delegacja uprawnień exchange](delegation-step3.png){.thumbnail}
...
![delegacja uprawnień exchange](delegation-step4.png){.thumbnail}
...
![delegacja uprawnień exchange](delegation-step5.png){.thumbnail}
...
![delegacja uprawnień exchange](delegation-step6.png){.thumbnail}
...
![delegacja uprawnień exchange](delegation-step7.png){.thumbnail}
