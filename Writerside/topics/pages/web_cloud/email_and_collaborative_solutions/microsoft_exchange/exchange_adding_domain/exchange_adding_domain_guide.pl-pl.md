...
- Możliwość modyfikacji konfiguracji Twojej domeny [strefy DNS](dns_zone_edit1.)
...
![Domeny](add_domain_exchange_step1.png){.thumbnail}
...
![Domeny](add_domain_exchange_step2.png){.thumbnail}
...
>
>![Dodaj domenę](add_domain_exchange_authoritative.png){.thumbnail}
>
...
![Domeny](add_domain_exchange_step3.png){.thumbnail}
...
![emailpro](add_domain_exchange_step4.png){.thumbnail}
...
Jeśli chcesz skonfigurować Twoje konto e-mail w programie pocztowym lub urządzeniu typu smartfon lub tablet lub uzyskać pomoc w zakresie funkcji usługi e-mail, skorzystaj z naszej dokumentacji dostępnej na stronach [Exchange](web-cloud-email-collaborative-solutions-microsoft-exchange1.) i [E-mail Pro](web-cloud-email-collaborative-solutions-email-pro1.).
...
[Tworzenie pola CNAME po dodaniu przypisanej domeny](exchange_dns_cname1.)
