...
- Sie haben administrativen Zugang zur Verwaltung der Domainkonfiguration (zum [Bearbeiten der DNS Zone](dns_zone_edit1.)).
...
>
>![Domain hinzufügen](add_domain_exchange_authoritative.png){.thumbnail}
>
...
Falls Sie Hilfe bei der Einrichtung Ihres E-Mail-Accounts in einem E-Mail-Client oder auf einem Gerät (Smartphone, Tablet) benötigen oder Fragen zu den Funktionen Ihres E-Mail-Dienstes haben, lesen Sie unsere Anleitungen zu [Exchange](web-cloud-email-collaborative-solutions-microsoft-exchange1.) oder [E-Mail Pro](web-cloud-email-collaborative-solutions-email-pro1.).
...
[CNAME-Eintrag zu einer assoziierten Domain hinzufügen](exchange_dns_cname1.)
