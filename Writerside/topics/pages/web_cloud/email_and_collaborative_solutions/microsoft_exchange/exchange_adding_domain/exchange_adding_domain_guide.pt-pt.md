...
- Ter a possibilidade de alterar a configuração do domínio [zona DNS](dns_zone_edit1.).
...
>
>![Adicionar domínio](add_domain_exchange_authoritative.png){.thumbnail}
>
...
[Criar um registo CNAME para adicionar um domínio associado](exchange_dns_cname1.)
