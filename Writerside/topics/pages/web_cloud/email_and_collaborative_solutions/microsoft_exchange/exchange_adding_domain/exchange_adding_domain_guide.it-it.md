...
- Poter modificare la configurazione del dominio [zona DNS](dns_zone_edit1.)
...
>
>![Aggiungi dominio](add_domain_exchange_authoritative.png){.thumbnail}
>
...
Per configurare un account email su un client di posta o un dispositivo come smartphone o tablet o ottenere assistenza sulle funzionalità del tuo servizio di posta, consulta la documentazione disponibile sulle pagine [Exchange](web-cloud-email-collaborative-solutions-microsoft-exchange1.) ed [Email Pro](web-cloud-email-collaborative-solutions-email-pro1.).
...
[Creare un record CNAME per aggiungere un dominio associato](exchange_dns_cname1.)
