...
![Add Domain](add_domain_exchange_step4.png){.thumbnail}
...
![Add Domain](add_domain_exchange_step5.png){.thumbnail}
...
If you need help with configuring your email account on an email client or a device (e.g. a smartphone or tablet) or have questions about email service features, please refer to our documentation which you can access from the [Exchange](web-cloud-email-collaborative-solutions-microsoft-exchange1.) pages.
...
![Add Domain](add_domain_exchange_step6.png){.thumbnail}
...
- **Delete the accounts on your platform**: go to the `Email accounts`{.action} tab. To the right of the account you want to delete, click the `...`{.action} button, then `Reset this account`{.action} or `Reset`{.action}
    ![Add Domain](add_domain_exchange_step7.png){.thumbnail}
...
![Add Domain](add_domain_exchange_step10.png){.thumbnail}
