...
- Être en mesure de modifier la configuration de votre nom de domaine ([zone DNS](dns_zone_edit1.)).
...
![Add Domain](add_domain_exchange_step1.png){.thumbnail}
...
Si vous souhaitez configurer votre adresse e-mail sur un logiciel de messagerie ou un périphérique comme un smartphone ou une tablette, ou obtenir de l'aide concernant les fonctionnalités de votre service e-mail, consultez nos documentations accessibles depuis les pages [Exchange](web-cloud-email-collaborative-solutions-microsoft-exchange1.) et [E-mail Pro](web-cloud-email-collaborative-solutions-email-pro1.).
