...
| | |
|---|---|
|![mailmac](mail-mac-exchange01.png){.thumbnail}|Wählen Sie `Exchange aus`{.action}|
|Geben Sie den **Namen** Ihres E-Mail-Accounts und Ihrer **E-Mail-Adresse** ein und klicken Sie auf `Anmelden`{.action}|![mailmac](mail-mac-exchange02.png){.thumbnail}|
...
|Neben Ihren E-Mails können Sie auch andere Exchange Funktionen auswählen, die Sie über Ihren Mac verwalten möchten.|![mailmac](mail-mac-exchange04.png){.thumbnail}|
