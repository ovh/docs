...
| | |
|---|---|
|![mailmac](mail-mac-exchange01.png){.thumbnail}|Sélectionnez `Exchange`{.action}|
|Saisissez le **Nom** de votre compte e-mail et votre **Adresse e-mail**, puis cliquez sur `Se connecter`{.action}|![mailmac](mail-mac-exchange02.png){.thumbnail}|
...
|En plus de vos e-mails, vous pouvez sélectionner d'autres fonctionnalités Exchange que vous souhaitez gérer depuis votre Mac.|![mailmac](mail-mac-exchange04.png){.thumbnail}|
