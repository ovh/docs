...
- Dodanie domeny do platformy e-mail. W razie potrzeby skorzystaj z przewodnika "[Dodawanie domeny do platformy e-mail](exchange_adding_domain1.)".
- Możliwość skonfigurowania strefy DNS danej domeny w [Panelu klienta OVHcloud lub z poziomu](dns_zone_edit1.) panelu zarządzania, w którym jest zarejestrowana.
...
Domena **mydomena.ovh** została dodana do platformy e-mail (zapoznaj się z przewodnikiem "[Dodawanie domeny do platformy e-mail](exchange_adding_domain1.)").<br>
...
- **zadeklarowana nazwa domeny nie jest zarządzana z poziomu tego samego konta klienta OVHcloud co Twoja platforma e-mail**: skorzystaj z [etapu 3](exchange_dns_cname_#step3.) niniejszego przewodnika w Panelu klienta konta OVHcloud, które zarządza strefą DNS domeny.
...
>> W nowym oknie pojawi się kilka rekordów DNS. Kliknij `CNAME`{.action} i wypełnij pola na podstawie informacji pobranych w [etapie 2](exchange_dns_cname_#step2.) z tego przewodnika.<br>
...
>>
>> - **Subdomena**: wprowadź wartość w postaci "**xxxx-check**", zastępując "**x**" unikatowym kodem odczytanym w [kroku 2](exchange_dns_cname_#step2.) niniejszego przewodnika.
