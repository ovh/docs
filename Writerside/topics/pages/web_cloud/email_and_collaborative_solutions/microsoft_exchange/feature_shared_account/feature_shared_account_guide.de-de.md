...
![E-Mails](exchange-shared_accounts01.png){.thumbnail}
...
![E-Mails](exchange-shared_accounts02.png){.thumbnail}
...
![E-Mails](exchange-shared_accounts03.png){.thumbnail}
...
![E-Mails](exchange-shared_accounts04.png){.thumbnail}
...
![E-Mails](exchange-shared_accounts05.png){.thumbnail}
...
![E-Mails](exchange-shared_accounts06.png){.thumbnail}

In unserem Beispiel ist das freigegebene Postfach nun über den Account **guide-exchange@** verfügbar.

![E-Mails](exchange-shared_accounts07.png){.thumbnail}
...
![E-Mails](exchange-shared_accounts10.png){.thumbnail}
...
[Automatische Signaturen erstellen](feature_footers1.)
