...
![email](exchange-shared_accounts01.png){.thumbnail}
...
![email](exchange-shared_accounts02.png){.thumbnail}
...
![email](exchange-shared_accounts03.png){.thumbnail}
...
![email](exchange-shared_accounts04.png){.thumbnail}
...
![email](exchange-shared_accounts10.png){.thumbnail}

## Per saperne di più

[Consulta il tuo account Exchange dall'interfaccia OWA](email_owa1.)

[Delegare permessi su un account Exchange](feature_delegation1.)

[Condividi un calendario con la Webmail OWA](owa_calendar_sharing1.)

[Aggiungi un piede di pagina ai tuoi account Exchange](feature_footers1.)
