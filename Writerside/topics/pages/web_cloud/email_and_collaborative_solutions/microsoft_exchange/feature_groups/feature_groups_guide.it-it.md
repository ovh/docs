...
Inoltre, visualizzi la voce del menu `Gestisci le deleghe`{.action}. Questa opzione ti consente di delegare l’accesso proprio come per un account Exchange. Per saperne di più, consulta [questa guida](feature_delegation1.).
...
[Delegare i diritti su un account Exchange](feature_delegation1.)

[Guida all’utilizzo di Outlook Web App](email_owa1.)
