...
> [!primary]
>
> Vous utilisez une version antérieure d'Outlook pour Mac ? Consultez notre documentation : [Configurer son compte Exchange sur Outlook 2011 pour Mac](how_to_configure_outlook_2016_mac2.){.external}.
>
> Vous utilisez Outlook 2016 pour Windows ? Consultez notre documentation : [Configurer son compte Exchange sur Outlook 2016 pour Windows](how_to_configure_outlook_20162.){.external}.
>
...
[Configurer son adresse e-mail comprise dans l’offre MX Plan ou dans une offre d’hébergement web sur Outlook 2016 pour Mac](how_to_configure_outlook_2016_mac1.){.external}

[Configurer son compte E-mail Pro sur Outlook 2016 pour Mac](how_to_configure_outlook_2016_mac3.){.external}
