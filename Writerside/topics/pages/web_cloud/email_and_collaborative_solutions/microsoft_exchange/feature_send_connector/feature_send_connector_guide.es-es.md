...
A continuación, conéctese a la API de OVHcloud con sus claves de acceso. Para más información, consulte nuestra guía [Primeros pasos con la API de OVHcloud ](api_first-steps.).
...
[«Editar una zona DNS de OVH»](dns_zone_edit1.)
