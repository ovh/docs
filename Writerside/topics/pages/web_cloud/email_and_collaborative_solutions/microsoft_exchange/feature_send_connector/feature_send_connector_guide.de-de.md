...
Loggen Sie sich anschließend mit Ihren Zugangsdaten in die OVHcloud API-Konsole ein. Weitere Informationen finden Sie in unserer Anleitung [Erste Schritte mit der OVHcloud API](api_first-steps.).
...
[DNS-Zone bearbeiten](dns_zone_edit1.)

[Domain zu Ihrem Exchange Dienst hinzufügen](exchange_adding_domain1.)
