...
- Le champ SRV d'OVHcloud doit être correctement configuré dans la zone DNS du nom de domaine, n'hésitez pas à consulter notre guide [Ajouter un nom de domaine sur son service Exchange](exchange_adding_domain1.).

> [!primary]
>
> Vous utilisez Outlook 2016 et ultérieur pour Mac ? Consultez notre documentation : [Configurer son compte Exchange sur Outlook 2016 pour Mac](how_to_configure_outlook_2016_mac2.){.external}.
>
...
Votre adresse e-mail Exchange, ainsi que toutes ses fonctions collaboratives, sont également disponibles via l'interface [OWA](https://www.ovh.com/fr/mail/). Pour toute question relative à son utilisation, n'hésitez pas à consulter notre guide [Consulter son compte Exchange depuis l’interface OWA](email_owa1.).
...
[Configurer son adresse e-mail comprise dans l’offre MX Plan ou dans une offre d’hébergement web sur Outlook 2016 pour Windows](how_to_configure_outlook_20161.){.external}

[Configurer son compte E-mail Pro sur Outlook 2016 pour Windows](how_to_configure_outlook_20163.){.external}
