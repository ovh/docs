...
Per maggiori informazioni sulla configurazione della tua zona DNS, consulta la pagina "[Aggiungere un record MX alla configurazione del dominio](dns_zone_mx1.)".
...
Per saperne di più, consulta la guida [Aggiungere un dominio sul servizio Exchange](exchange_adding_domain1.).
...
Per sottoscrivere, consulta la pagina "[Ottieni una licenza Outlook per Exchange](office_outlook_license1.)".
...
Per maggiori informazioni sulle funzionalità, consulta [la nostra documentazione](web-cloud-email-collaborative-solutions-microsoft-exchange1.).

## Per saperne di più

[Crea un gruppo di contatti](feature_groups1.)

[Crea e utilizza un account condiviso](feature_shared_account1.)

[Crea e utilizza account risorsa](feature_resources1.)

[Delega i diritti su un account email](feature_delegation1.)
