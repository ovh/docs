...
![E-Mail](exchange-wizard01.png){.thumbnail}
...
![E-Mail](exchange-wizard02.png){.thumbnail}
...
![E-Mail](exchange-wizard03.png){.thumbnail}
...
![E-Mail](exchange-wizard04.png){.thumbnail}
...
![E-Mail](exchange-wizard05.png){.thumbnail .w-640}<br>
...
![E-Mail](exchange-wizard06.png){.thumbnail .w-640}<br>
...
Details zur Konfiguration Ihrer DNS-Zone für Ihren E-Mail-Dienst finden Sie auf der Seite "[MX-Eintrag zur Konfiguration Ihrer Domain hinzufügen](dns_zone_mx1.)".
...
Für weitere Informationen, lesen Sie bitte die Anleitung [Eine Domain zu Ihrem Exchange Dienst hinzufügen](exchange_adding_domain1.).
...
![Eine Domain hinzufügen](first-steps-hosted-exchange-add-domain.png)
...
Um eine Domain mit dieser Endung bestellen zu können, lesen Sie unsere Anleitung ["Eine Outlook-Lizenz für Exchange beziehen"](office_outlook_license1.). 
...
Weitere Anleitungen zu den Funktionen finden Sie in unserer Dokumentation unter [Exchange](web-cloud-email-collaborative-solutions-microsoft-exchange1.).

## Weiterführende Informationen

[Kontaktgruppen erstellen](feature_groups1.)

[Freigegebenes Postfach erstellen und verwenden](feature_shared_account1.)

[Verwendung von Ressourcen-Accounts](feature_resources1.)

[Berechtigungen für einen E-Mail Account übertragen](feature_delegation1.)
