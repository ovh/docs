...
Szczegóły konfiguracji Twojej strefy DNS dotyczące usługi e-mail znajdują się na stronie "[Dodaj pole MX do konfiguracji domeny](dns_zone_mx1.)".
...
Więcej informacji znajdziesz w dokumentacji [Dodawanie domeny do usługi Exchange](exchange_adding_domain1.).
...
![Dodanie domeny](first-steps-hosted-exchange-add-domain.png)
...
![Dodanie konta](first-steps-hosted-exchange-add-account.png)

### Korzystanie z kont e-mail

Po skonfigurowaniu Twoich kont możesz zacząć ich używać. W tym celu OVHcloud udostępnia webmail **Outlook Web App** (OWA). Znajdziesz go pod linkiem <https://www.ovhcloud.com/pl/mail/>. Aby się zalogować, wpisz dane identyfikacyjne przypisane do Twojego konta e-mail. Jeśli potrzebujesz pomocy w zakresie użytkowania OWA, skorzystaj z [naszej dokumentacji](web-cloud-email-collaborative-solutions-microsoft-exchange1.).

Jeśli chcesz skonfigurować Twoje konto e-mail na smartfonie, tablecie lub programie pocztowym, skorzystaj z [naszej dokumentacji](web-cloud-email-collaborative-solutions-microsoft-exchange1.). Abyś mógł korzystać z konta Exchange w sposób optymalny, upewnij się, czy jest ono kompatybilne z Twoim programem pocztowym.
...
Aby zamówić licencję, wejdź na stronę "[Uzyskaj licencję Outlook dla usługi Exchange](office_outlook_license1.)".
...
Jeśli potrzebujesz pomocy odnośnie którejś z funkcji, skorzystaj z [naszej dokumentacji](web-cloud-email-collaborative-solutions-microsoft-exchange1.).

## Sprawdź również

[Utwórz grupę kontaktów](feature_groups1.)

[Tworzenie i korzystanie z konta współdzielonego](feature_shared_account1.)

[Tworzenie i korzystanie z kont zasobów](feature_resources1.)

[Delegowanie uprawnień do konta e-mail](feature_delegation1.)

[Współdzielenie katalogu w interfejsie OWA](owa_directory_sharing1.)

[Zarządzanie płatnościami za Twoje konta Exchange](manage_billing_exchange1.)
