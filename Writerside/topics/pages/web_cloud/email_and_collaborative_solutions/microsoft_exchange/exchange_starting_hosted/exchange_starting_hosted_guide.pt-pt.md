...
Encontre os detalhes de configuração da sua zona DNS relativos ao seu serviço de e-mail na nossa página "[Adicionar um campo MX à configuração do seu domínio](dns_zone_mx1.)".
...
Para obter mais informações, pode consultar o nosso manual [Adicionar um domínio a um serviço Exchange](exchange_adding_domain1.) (versão em inglês).
...
![Adicionar um domínio](first-steps-hosted-exchange-add-domain.png)
...
![Adicionar uma conta](first-steps-hosted-exchange-add-account.png)

### Utilizar os seus endereços de e-mail

As contas foram configuradas e estão prontas a usar. Para isso, a OVHcloud disponibiliza o webmail **Outlook Web App** (OWA). Pode aceder através do endereço <https://www.ovhcloud.com/pt/mail/>, inserindo as credenciais do seu endereço de e-mail. Para mais informações, [consulte os manuais da OVHcloud](web-cloud-email-collaborative-solutions-microsoft-exchange1.).

Se quiser, também pode configurar o seu endereço de e-mail num software (cliente) de correio eletrónico ou dispositivo externo (smartphone ou tablet), [consulte os manuais da OVHcloud](web-cloud-email-collaborative-solutions-microsoft-exchange1.). Para uma utilização otimizada do seu endereço Exchange num software, certifique-se de que seja compatível com o serviço.
...
Para subscrever, consulte a nossa página "[Obter uma licença Outlook para Exchange](office_outlook_license1.)". 
...
Para obter ajuda numa das funcionalidades, consulte a [nossa documentação](web-cloud-email-collaborative-solutions-microsoft-exchange1.).

## Saiba mais

[Criar um grupo de contactos](feature_groups1.)

[Criar e utilizar uma conta partilhada](feature_shared_account1.)

[Criar e utilizar contas de recurso](feature_resources1.)

[Delegar permissões numa conta de e-mail](feature_delegation1.)
