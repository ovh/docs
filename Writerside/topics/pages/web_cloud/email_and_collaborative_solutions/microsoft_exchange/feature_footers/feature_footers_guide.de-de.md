...
![Exchange Signaturen](exchange-footer-step1.png){.thumbnail}
...
![Exchange Signaturen](exchange-footer-step2.png){.thumbnail}
...
![Exchange Signaturen](exchange-footer-step3aag.gif){.thumbnail}
...
![Exchange Signaturen](exchange-footer-step4.png){.thumbnail}
...
![Exchange Signaturen](exchange-footer-step5.png){.thumbnail}
...
- Im OWA wird nicht angezeigt, ob ein Footer für eine Domain aktiviert wurde, und es gibt **keine Synchronisation**. Wenn Benutzer ihre [eigenen Signaturen](email_owa#eine-signatur-hinzufugen.) hinzufügen, werden E-Mails sowohl den eigenen als auch den für die gesamte Domain erstellten Footer enthalten.
