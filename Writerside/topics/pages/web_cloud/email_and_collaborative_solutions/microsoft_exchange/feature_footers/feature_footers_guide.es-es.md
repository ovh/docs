...
- OWA no indica si una firma está habilitada en este dominio y **no se sincroniza**. Cuando los usuarios agregan sus [propias firmas](email_owa#anadir-una-firma.), los correos electrónicos incluyen tanto el pie del mensaje individual como el de todo el dominio.
...
[Delegar permisos en una cuenta de correo](feature_delegation1.)
