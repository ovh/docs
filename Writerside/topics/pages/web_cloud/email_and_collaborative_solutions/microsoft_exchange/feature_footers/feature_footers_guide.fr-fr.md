...
- Dans OWA, il n'est pas indiqué si un pied de page est activé sur ce domaine et il n'y a **pas de synchronisation**. Si les utilisateurs ajoutent [leurs propres signatures](email_owa#ajouter-une-signature.), les e-mails comprendront à la fois le pied de page individuel et celui de l'ensemble du domaine.
...
[Consulter son compte e-mail depuis l’interface OWA](email_owa1.)

[Déléguer des permissions sur un compte ](feature_delegation1.)
