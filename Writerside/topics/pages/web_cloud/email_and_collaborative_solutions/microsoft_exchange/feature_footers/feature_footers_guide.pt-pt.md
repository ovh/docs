...
![exchangesig](exchange-footer-step1.png){.thumbnail}
...
![exchangesig](exchange-footer-step2.png){.thumbnail}
...
![exchangesig](exchange-footer-step3aag.gif){.thumbnail}
...
![exchangesig](exchange-footer-step4.png){.thumbnail}
...
![exchangesig](exchange-footer-step5.png){.thumbnail}
...
- No OWA não se indica se o domínio tem uma assinatura ativa e **não há sincronização**. Se os utilizadores acrescentarem uma [assinatura própria](email_owa#adicionar-assinatura.), os e-mails vão incluir tanto a assinatura individual quanto a assinatura associada ao domínio.
...
[Guia de utilização do Outlook Web App](email_owa1.)

[Atribuir permissões a uma conta de e-mail](feature_delegation1.)

[Partilha de calendários em OWA](owa_calendar_sharing1.)
