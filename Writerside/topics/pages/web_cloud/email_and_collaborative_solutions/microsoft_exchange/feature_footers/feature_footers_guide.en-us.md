...
- It is not indicated in OWA whether a footer is enabled on this domain and there is **no synchronisation**. If users add their [own signatures](email_owa#adding-a-signature.), emails will include both the individual and the domain-wide footer.
...
[Delegating permissions on an Exchange account](feature_delegation1.)

[How to share calendars via OWA](owa_calendar_sharing1.)
