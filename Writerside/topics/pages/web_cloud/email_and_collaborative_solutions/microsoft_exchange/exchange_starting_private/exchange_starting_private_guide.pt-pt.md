...
Para adicionar o primeiro nome de domínio à sua plataforma e configurar as contas, consulte o nosso guia ["Adicionar um domínio ao serviço Exchange"](exchange_adding_domain1.){.external}

## Quer saber mais?

[Editar uma zona DNS](dns_zone_edit1.){.external}

[Adicionar um nome de domínio ao serviço Exchange](exchange_adding_domain1.){.external}
