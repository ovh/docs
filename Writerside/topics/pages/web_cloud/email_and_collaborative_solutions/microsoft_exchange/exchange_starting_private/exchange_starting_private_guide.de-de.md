...
Die E-Mail enthält die IPv4- und IPv6-Adressen Ihres Private Exchange Servers. Geben Sie diese Adressen in die DNS-Zone der zuvor in [Schritt 2](#schritt-2-ihren-dienst-initialisieren.) erstellten Subdomain jeweils als Eintrag vom Typ „A“ und vom Typ „AAAA“ ein. Bei einem OVHcloud-Domainnamen finden Sie weitere Informationen in unserer [passenden Anleitung](dns_zone_edit1.).
...
Informationen zum Hinzufügen Ihres ersten Domainnamens zu Ihrer Plattform und zum Einrichten der Accounts finden Sie in unserer Anleitung [Eine Domain zu Ihrem Exchange Dienst hinzufügen](exchange_adding_domain1.) 

## Weiterführende Informationen

[Eine DNS-Zone bearbeiten](dns_zone_edit1.)

[Eine Domain zu Ihrem Exchange Dienst hinzufügen](exchange_adding_domain1.) 
