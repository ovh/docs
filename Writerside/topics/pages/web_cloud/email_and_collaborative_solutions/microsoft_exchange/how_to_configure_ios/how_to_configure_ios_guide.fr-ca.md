...
|![exchange](configuration-mailex-ios-step03.png){.thumbnail}|7. Saisissez: <br>- le serveur **ex?.mail.ovh.ca** ( remplacez le **?** par [le numéro de votre serveur Exchange](how_to_configure_ios_#addaccount.)) <br>- votre **adresse e-mail complète** dans nom d'utilisateur <br>- le mot de passe de votre adresse e-mail|
