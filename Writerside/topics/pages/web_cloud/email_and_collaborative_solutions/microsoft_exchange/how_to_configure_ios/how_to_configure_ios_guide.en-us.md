...
|![Exchange](configuration-mailex-ios-step03.png){.thumbnail}|7. Enter: <br>- the server **ex?.mail.ovh.ca** (replace the **?** by [your Exchange server number](how_to_configure_ios_#addaccount.))<br>-your **full email address** as username <br>- your account password|
