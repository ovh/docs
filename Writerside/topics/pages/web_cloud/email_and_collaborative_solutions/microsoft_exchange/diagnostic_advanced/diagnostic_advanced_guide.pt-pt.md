...
- Estar atualizado nos [pagamentos](invoice_management#pay-bills.) deste serviço e do domínio associado.
...
Consulte o nosso guia [O que fazer em caso de conta bloqueada por spam?](locked_for_spam1.) para permitir às nossas equipas de segurança reativar a conta.
...
Para reativar a subscrição, basta reconfigurar a [periodicidade de faturação](manage_billing_exchange#periodicity.) na [Área de Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pt/&ovhSubsidiary=pt).
...
Para mais informações sobre esta funcionalidade, consulte o nosso [guia sobre a política de segurança](security-policy1.).

### A autenticação ao webmail falhou <a name="password"></a>

Isto pode dever-se à introdução de uma palavra-passe de conta incorreta. Verifique primeiro que a palavra-passe está correta, ligando-se ao [webmail](email_owa1.) e reinicie o diagnóstico.
...
Pode verificar estes parâmetros na [zona DNS do seu domínio](dns_zone_edit1.).
