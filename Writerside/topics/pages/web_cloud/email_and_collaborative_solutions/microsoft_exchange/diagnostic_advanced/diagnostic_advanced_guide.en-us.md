...
To reactivate your subscription, simply reconfigure its [billing frequency](manage_billing_exchange#periodicity.) in the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we).
