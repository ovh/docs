...
- Être à jour dans les [paiements](invoice_management#pay-bills.) de ce service et du nom de domaine lié.
...
![Diagnostic Exchange](img_4450.png){.thumbnail}
...
Veuillez consulter notre guide [Que faire en cas de compte bloqué pour spam ?](locked_for_spam1.) pour permettre à nos équipes de sécurité de réactiver le compte.
...
Pour réactiver votre abonnement, il suffit de reconfigurer sa [périodicité de facturation](manage_billing_exchange#periodicity.) dans l'[espace client OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr).
...
Pour plus d'informations sur cette fonctionnalité, consultez notre [guide sur la politique de sécurité](security-policy1.).

### L'authentification au webmail a échoué <a name="password"></a>

Cela peut être dû à la saisie d'un mot de passe de compte incorrect. Vérifiez d'abord que le mot de passe est correct, en vous connectant au [webmail](email_owa1.), puis redémarrez le diagnostic.
...
Vous pouvez vérifier ces paramètres dans la [zone DNS de votre domaine](dns_zone_edit1.).
