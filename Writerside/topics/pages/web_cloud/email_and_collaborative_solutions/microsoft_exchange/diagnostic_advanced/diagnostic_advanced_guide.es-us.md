...
- Estar actualizado en los [pagos](invoice_management#pay-bills.) de este servicio y del dominio asociado.
...
![Diagnóstico Exchange](img_4450.png){.thumbnail}
...
![Diagnóstico Exchange](img_4451.png){.thumbnail}

El diagnóstico tardará entre 3 y 10 minutos. Aquí hay un ejemplo de los resultados:

![Diagnóstico Exchange](img_4471.png){.thumbnail}
...
Consulte nuestra guía ¿[Qué hacer en caso de cuenta bloqueada por spam?](locked_for_spam1.) para que nuestros equipos de seguridad puedan reactivar la cuenta.
...
Para reactivar la suscripción, solo tiene que reconfigurar su [frecuencia de facturación](manage_billing_exchange#periodicity.) en el[área de cliente de OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=ws).
...
Para más información sobre esta funcionalidad, consulte nuestra [guía sobre la política de seguridad](security-policy1.).

### La autenticación en el webmail no ha podido realizarse. <a name="password"></a>

Esto puede deberse a la introducción de una contraseña de cuenta incorrecta. En primer lugar, compruebe que la contraseña es correcta conectándose al [webmail](email_owa1.) y reinicie el diagnóstico.
...
Puede comprobar estos parámetros en la [zona DNS del dominio](dns_zone_edit1.).
