...
Para reactivar la suscripción, solo tiene que reconfigurar su [frecuencia de facturación](manage_billing_exchange#periodicity.) en el[área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es).
