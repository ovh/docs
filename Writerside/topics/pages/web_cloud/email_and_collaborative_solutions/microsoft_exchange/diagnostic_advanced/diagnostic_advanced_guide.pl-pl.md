...
- Aktualizacja w [płatności](invoice_management#pay-bills.) tej usługi i powiązanej domeny
...
![Diagnostyka Exchange](img_4450.png){.thumbnail}
...
![Diagnostyka Exchange](img_4451.png){.thumbnail}

Procedura diagnostyczna zajmie około 3 do 10 minut. Oto przykład:

![Diagnostyka Exchange](img_4471.png){.thumbnail}
...
Zapoznaj się z naszym przewodnikiem [Co zrobić w przypadku blokady konta ze względu na spam?](locked_for_spam1.) aby umożliwić naszym zespołom bezpieczeństwa ponowne uruchomienie konta.
...
Aby ponownie włączyć abonament, wystarczy zmienić jego konfigurację [częstotliwość płatności](manage_billing_exchange#periodicity.) w [Panelu klienta OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl).
...
Aby uzyskać więcej informacji na temat tej funkcji, zapoznaj się z naszym [przewodnikiem dotyczącym polityki bezpieczeństwa](security-policy1.).

### Logowanie do webmaila nie powiodło się. <a name="password"></a>

Może to być spowodowane wpisaniem nieprawidłowego hasła do konta. Sprawdź najpierw, czy hasło jest poprawne. Zaloguj się do interfejsu [Webmail](email_owa1.), następnie zrestartuj diagnostykę.
...
Możesz sprawdzić te parametry w [strefie DNS Twojej domeny](dns_zone_edit1.).
