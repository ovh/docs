...
Pour réactiver votre abonnement, il suffit de reconfigurer sa [périodicité de facturation](manage_billing_exchange#periodicity.) dans l'[espace client OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc).
