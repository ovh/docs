...
![criar](exchange-resources-step1.png){.thumbnail}
...
![criar](exchange-resources-step2.png){.thumbnail}
...
Os seus recursos podem ser geridos a partir da tabela do separador "Recursos". Clique em `...`{.action} para modificar ou eliminar um recurso. A opção `Configurar as delegações`{.action} também será apresentada. Com esta opção, poderá delegar o acesso da mesma forma que para uma conta Exchange. Consulte os detalhes [neste guia](feature_delegation1.).

![utilizar](exchange-resources-step3.png){.thumbnail}

### Adicionar um calendário de recursos à OWA

> [!primary]
>
Consulte também o nosso manual sobre [Partilha de calendários a partir da interface OWA](owa_calendar_sharing1.).
>
...
![planeamento](exchange-resources-step5_1.png){.thumbnail}
...
![mensagem de aceitação](exchange-resources-step7.png){.thumbnail}
...
![mensagem de recusa](exchange-resources-step8.png){.thumbnail}

## Quer saber mais?

[Consultar a sua conta Exchange a partir da interface OWA](email_owa1.)

[Partilhar um calendário a partir da interface OWA](owa_calendar_sharing1.)

[Partilhar uma pasta a partir da interface OWA](owa_directory_sharing1.)
