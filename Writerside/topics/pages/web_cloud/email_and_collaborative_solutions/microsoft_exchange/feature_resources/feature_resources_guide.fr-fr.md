...
![créer ressource](exchange-resources-step1.png){.thumbnail}
...
![créer ressource](exchange-resources-step2.png){.thumbnail}
...
![ajouter calendrier](exchange-calendars-step1.png){.thumbnail}

Dans la barre de navigation supérieure, cliquez sur `Ajouter un calendrier`{.action}, puis sur `À partir de l'annuaire`{.action}.

![sélectionner ressource](exchange-resources-step4.png){.thumbnail}
...
![planification](exchange-resources-step5_1.png){.thumbnail}
...
![message d'acceptation](exchange-resources-step7.png){.thumbnail}
...
![message de refus](exchange-resources-step8.png){.thumbnail}

## Aller plus loin

[Consulter son compte Exchange depuis l’interface OWA](email_owa1.)

[Partager un calendrier depuis l’interface OWA](owa_calendar_sharing1.)
