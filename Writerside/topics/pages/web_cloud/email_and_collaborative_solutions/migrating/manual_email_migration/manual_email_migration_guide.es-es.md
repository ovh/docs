...
[Es posible migrar automáticamente](migration_omm1.){.external} una cuenta de correo a través de nuestra herramienta [OVH Mail Migrator](https://omm.ovh.net/){.external}. También puede migrar su cuenta de correo electrónico manualmente a través de los programas de correo.
...
> [!primary]
> En primer lugar, compruebe si nuestra herramienta [OVH Mail Migrator](https://omm.ovh.net/){.external} permite la migración automática. Para ello, consulte la guía [Migrar cuentas de correo electrónico a través de OVH Mail Migrator](migration_omm1.){.external}.
...
![correo electrónico](manager-export-pst01.png){.thumbnail}
...
![correo electrónico](manager-export-pst02.png){.thumbnail}
...
![correo electrónico](outlook-export-import-win.png){.thumbnail}

- Seleccione `Exportar datos a un archivo` y haga clic en `Siguiente`.

![correo electrónico](outlook-export-win02.png){.thumbnail}

- Seleccione `Archivo de datos Outlook (.pst)` y haga clic en `Siguiente`.

![correo electrónico](outlook-export-win03.png){.thumbnail}
...
![correo electrónico](outlook-export-win04.png){.thumbnail}
...
![correo electrónico](outlook-import-win02.png){.thumbnail}

- Seleccione `Archivo de datos Outlook (.pst)` y haga clic en `Siguiente`.

![correo electrónico](outlook-import-win03.png){.thumbnail}

- Seleccione el archivo de backup haciendo clic en `Navegar`. Seleccione la opción más adecuada y haga clic en `Finalizar`.

![correo electrónico](outlook-import-win04.png){.thumbnail}
...
![correo electrónico](outlook-export-mac01.png){.thumbnail}
...
![correo electrónico](outlook-export-mac02.png){.thumbnail}

A continuación, seleccione la carpeta de destino para la copia de seguridad y haga clic en `Guardar`.

![correo electrónico](outlook-export-mac03.png){.thumbnail}
...
![correo electrónico](outlook-import-mac01.png){.thumbnail}

Seleccione el formato de la copia de seguridad que quiera importar y haga clic en `Continuar`.

![correo electrónico](outlook-import-mac02.png){.thumbnail}

Seleccione el archivo de backup y haga clic en `importar`.

![correo electrónico](outlook-import-mac03.png){.thumbnail}
...
![correo electrónico](mail-export-mac01.png){.thumbnail}

Seleccione la carpeta que desee o cree una nueva, y haga clic en `Elegir`.

![correo electrónico](mail-export-mac02.png){.thumbnail}
...
![correo electrónico](mail-import-mac01.png){.thumbnail}

Seleccione el archivo de backup en formato ".mbox" y haga clic en `Continuar`.

![correo electrónico](mail-import-mac02.png){.thumbnail}
...
![correo electrónico](thunderbird-run-profil.png){.thumbnail}
...
![correo electrónico](thunderbird-terminal-profil.png){.thumbnail}
...
![correo electrónico](thunderbird-profil-create01.png){.thumbnail}
...
![correo electrónico](thunderbird-profil-create02.png){.thumbnail}
...
[Migrar una cuenta de correo con OVH Mail Migrator](migration_omm1.){.external}
