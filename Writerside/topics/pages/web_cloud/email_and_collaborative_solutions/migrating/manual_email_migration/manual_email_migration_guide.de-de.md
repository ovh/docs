...
Die automatische [Migration](migration_omm1.){.external} einer E-Mail-Adresse ist über unseren [OVH Mail Migrator](https://omm.ovh.net/){.external} möglich. Sie können Ihre E-Mail-Adresse auch manuell über einen E-Mail-Client migrieren.
...
> [!primary]
> Überprüfen Sie zunächst, ob die automatische Migration mit unserem [OVH Mail Migrator](https://omm.ovh.net/){.external} möglich ist. Lesen Sie hierzu die Anleitung [E-Mail-Accounts über den OVH Mail Migrator migrieren](migration_omm1.).
...
![E-Mails](manager-export-pst01.png){.thumbnail}
...
![E-Mails](manager-export-pst02.png){.thumbnail}
...
![E-Mails](outlook-export-win04.png){.thumbnail}
...
![E-Mails](outlook-import-win02.png){.thumbnail}

- Wählen Sie `Outlook Datendatei (.pst)` und klicken Sie auf `Weiter`.

![E-Mails](outlook-import-win03.png){.thumbnail}
...
![E-Mails](outlook-import-win04.png){.thumbnail}
...
![E-Mails](outlook-export-mac01.png){.thumbnail}
...
![E-Mails](thunderbird_menu.png){.thumbnail}
...
![E-Mails](thunderbird_open_folder.png){.thumbnail}

Sie werden dann zum Profilordner geleitet. Gehen Sie von einem Ordner in die Baumstruktur.

![E-Mails](thunderbird_profil_folder1.png){.thumbnail}
...
![E-Mails](thunderbird_profil_folder2.png){.thumbnail}
...
![E-Mails](thunderbird-run-profil.png){.thumbnail}
...
![E-Mails](thunderbird-terminal-profil.png){.thumbnail}
...
![E-Mails](thunderbird-profil-create01.png){.thumbnail}
...
![E-Mails](thunderbird-profil-create02.png){.thumbnail}
...
[E-Mail-Accounts mit dem OVH Mail Migrator migrieren](migration_omm1.)
