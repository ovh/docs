...
|---|---|
|![email](images_mxplan-starter-legacy-step1.png){.thumbnail}<br> La tua offerta rientra nella sezione "Abbonamento"|![email](images_mxplan-starter-new-step1.png){.thumbnail}<br>Nel riquadro "Riassunto", ritrovi un `Referenza server` che inizia con "mxplan-"|
...
>
> Per maggiori informazioni sulle modifiche dei contatti, consulta la nostra guida per [gestire i contatti dei servizi](managing_contacts1.).
>
...
>
> Per maggiori dettagli sull'aggiunta di un dominio, segui [la guida Email Pro](first_config#step-2-aggiungi-il-dominio.) o [la guida Exchange](exchange_adding_domain1.).
...
Per maggiori informazioni su OMM, consulta la guida [Migrare account email via OVH Mail Migrator](migration_omm1.).
...
Se hai configurato uno degli account migrati su un client di posta elettronica (come Outlook), è necessario impostarlo nuovamente. Le informazioni di connessione al server OVHcloud sono cambiate in seguito alla migrazione. Per maggiori informazioni sulle operazioni da effettuare, consulta la nostra documentazione nelle sezioni delle guide dedicate a [Email Pro](web-cloud-email-collaborative-solutions-email-pro1.) e [Hosted Exchange](web-cloud-email-collaborative-solutions-mx-plan1.). Se non sei in grado di riconfigurare l'account nell'immediato, l'accesso tramite l'applicazione online è sempre possibile.
...
Inoltre, è possibile migrare manualmente i tuoi indirizzi email verso il nuovo servizio di posta OVHcloud utilizzando esclusivamente il client di posta. Clicca sulla guida [Migrare manualmente il tuo indirizzo email](manual_email_migration1.). Vi consigliamo tuttavia di utilizzare questo metodo solo quando non sono possibili i metodi principali.

## Per saperne di più

[Gestire i contatti dei servizi](managing_contacts1.){.external} .

[Guide Email Pro](web-cloud-email-collaborative-solutions-email-pro1.){.external}.

[Guide Exchange](web-cloud-email-collaborative-solutions-microsoft-exchange1.){.external}.
