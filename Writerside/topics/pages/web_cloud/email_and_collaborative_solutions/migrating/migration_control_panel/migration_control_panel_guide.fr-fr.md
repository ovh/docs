...
> [!warning]
>
> [OVH Mail Migrator](migration_omm1.) permet de migrer vos messages d'un serveur e-mail à un autre.</br>
> Si vos e-mails sont uniquement enregistrés en local (configuration en POP ou archivage en local), vous pouvez effectuer un [export depuis votre logiciel de messagerie](manual_email_migration1.), puis [importer votre fichier PST via OMM](migration_omm#realiser-une-migration-par-fichier.) ou [importer directement depuis votre logiciel de messagerie](manual_email_migration1.).
...
|---|---|
|![email](images_mxplan-starter-legacy-step1.png){.thumbnail}<br> Votre offre se situe dans le cadre « Abonnement »|![email](images_mxplan-starter-new-step1.png){.thumbnail}<br>Vous retrouvez une `Référence serveur` dans le cadre « Résumé » commençant par "mxplan-"|
...
>
> Pour plus d'information sur les changements de contacts, consultez notre guide pour [gérer les contacts de ses services](managing_contacts1.).
>
...
> ![email](mxplan-legacy-redirect.png){.thumbnail}
...
![exchange](access_the_migration_tool.png){.thumbnail}
...
![exchange](account_migration_steps.png){.thumbnail}
...
>
>![exchange](account_migration_adddomain.png){.thumbnail}
>
> Pour plus de détails sur l'ajout d'un nom de domaine, suivez [le guide E-mail Pro](first_config#etape-2-ajouter-votre-nom-de-domaine.) ou [le guide Exchange](exchange_adding_domain1.).

La migration de votre MXPlan se fera en 3 grandes étapes, **Renommer**,**Créer** et **Migrer**.

![exchange](mxplan-migration-configure-account.gif){.thumbnail}
...
![exchange](mxplan-migration-configure-account01.png){.thumbnail}
...
![exchange](mxplan-migration-configure-account02.png){.thumbnail}
...
Pour plus d'informations sur OMM, consultez notre guide [Migrer des comptes e-mail via OVH Mail Migrator](migration_omm1.).

![exchange](mxplan-migration-configure-account03.png){.thumbnail}
...
![exchange](check_the_dns_records_associated_domains.png){.thumbnail}
...
![exchange](owa_migrate_content.png){.thumbnail}
...
Vous pouvez également migrer manuellement vos adresses e-mail vers votre nouvelle offre e-mail OVHcloud en utilisant uniquement votre logiciel de messagerie. Appuyez-vous de notre guide [Migrer manuellement votre adresse e-mail](manual_email_migration1.). Nous vous préconisons toutefois de n'utiliser cette méthode que lorsque les méthodes principales ne sont pas possibles.

## Aller plus loin

[Gérer les contacts de ses services](managing_contacts1.){.external}.

[Guides E-mail Pro](web-cloud-email-collaborative-solutions-email-pro1.){.external}.

[Guides Exchange](web-cloud-email-collaborative-solutions-microsoft-exchange1.){.external}.
