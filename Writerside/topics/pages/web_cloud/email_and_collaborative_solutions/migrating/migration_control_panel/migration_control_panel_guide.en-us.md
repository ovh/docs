...
|---|---|
|![email](images_mxplan-starter-legacy-step1.png){.thumbnail}<br> Your solution is specified the "Plan" box.|![email](images_mxplan-starter-new-step1.png){.thumbnail}<br>You will find a `Server model` in the “Summary” box, starting with “mxplan-”.|
...
>
> For more information on editing contacts, please refer to our guide on [managing contacts for your services](managing_contacts1.).
>
...
>
> To find out more about adding a domain name, follow [the Exchange guide](exchange_adding_domain1.).
...
You can also manually migrate your email addresses to your new OVHcloud email solution using only your email software. Please refer to our guide on [Migrating your email address manually](manual_email_migration1.). However, we recommend that you use this method only when the main methods are not possible.

## Go further

[Exchange guides](web-cloud-email-collaborative-solutions-mx-plan1.){.external}.
