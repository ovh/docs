...
|---|---|
|![email](images_mxplan-starter-legacy-step1.png){.thumbnail}<br> Oferta mieści się w sekcji "Abonament"|![email](images_mxplan-starter-new-step1.png){.thumbnail}<br>Odnajdziesz `Oznaczenie serwera` w polu "Podsumowanie", które rozpoczyna się od "mxplan-"|
...
>
> Aby uzyskać więcej informacji na temat zmian kontaktów, zapoznaj się z naszym przewodnikiem dotyczącym [zarządzania kontaktami swoich usług](managing_contacts1.).
>
...
> ![e-mail](mxplan-legacy-redirect.png){.thumbnail}
...
>
> Aby uzyskać więcej informacji na temat dodania domeny, sprawdź [przewodnik E-mail Pro](first_config#etap-2-dodanie-domeny.) lub [przewodnik Exchange](exchange_adding_domain1.).
...
Aby uzyskać więcej informacji na temat narzędzia OMM, zapoznaj się z naszym przewodnikiem [Migracja kont e-mail przez OVH Mail Migrator](migration_omm1.).
...
Możesz również ręcznie przenieść Twoje konta e-mail do nowej usługi e-mail OVHcloud używając tylko programu pocztowego. Skorzystaj z naszego przewodnika [Ręczna migracja Twojego konta e-mail](manual_email_migration1.). Zalecamy jednak, abyś stosował tę metodę tylko wtedy, gdy podstawowe metody nie są możliwe.

## Sprawdź również

[Zarządzanie kontaktami swoich usług](managing_contacts1.){.external}.

[Przewodniki E-mail Pro](web-cloud-email-collaborative-solutions-email-pro1.){.external}.

[Przewodniki Exchange](web-cloud-email-collaborative-solutions-microsoft-exchange1.){.external}.
