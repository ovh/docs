...
|---|---|
|![E-Mail](images_mxplan-starter-legacy-step1.png){.thumbnail}<br> Ihre Dienstbezeichnung befindet sich im Bereich "Abo".|![E-Mail](images_mxplan-starter-new-step1.png){.thumbnail}<br>Sie finden eine `Server-Referenz` im Rahmen "Zusammenfassung", beginnend mit "mxplan-".|
...
>
> Weitere Informationen zu den Änderungen der Kontakte finden Sie in unserer Anleitung zur [Verwaltung der Kontakte Ihrer Dienstleistungen](managing_contacts1.).
>
...
>
> Weitere Informationen zum Hinzufügen eines Domainnamens finden Sie in den Hilfen zu [E-Mail Pro](first_config#schritt-2-ihre-domain-hinzufugen.) und [Exchange](exchange_adding_domain1.).
...
Weitere Informationen zu OMM finden Sie in unserer Anleitung [E-Mail-Accounts über OVH Mail Migrator migrieren](migration_omm1.).
...
Wenn Sie einen der migrierten Accounts auf einem E-Mail-Client (wie Outlook) eingerichtet haben, müssen Sie diesen erneut konfigurieren. Die Verbindungsdaten zum OVHcloud Server haben sich nach der Migration geändert. Weitere Informationen finden Sie in den jeweiligen Anleitungen zu [E-Mail Pro](web-cloud-email-collaborative-solutions-email-pro1.) und [Hosted Exchange](web-cloud-email-collaborative-solutions-mx-plan1.). Auch wenn Sie den Account nicht sofort neu konfigurieren können, ist der Zugriff über die Online-Anwendung weiterhin möglich.
