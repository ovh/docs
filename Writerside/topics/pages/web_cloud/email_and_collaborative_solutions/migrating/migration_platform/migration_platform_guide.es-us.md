...
![email-migración](migration_platform01.gif){.thumbnail}

> [!primary]
>
> Para migrar una solución MX Plan a una plataforma Exchange, consulte nuestra guía [Migrar una dirección MX Plan a una cuenta Exchange](migration_control_panel1.).
>
...
Antes de realizar la migración, si acaba de contratar la nueva solución de correo, añada el dominio a su plataforma [Exchange](exchange_adding_domain1.). Si migra a una plataforma MX Plan, ya que el dominio es "fijo", puede pasar directamente a [la siguiente etapa](#accountsmigration.) .
...
>
> ![email-migración](migration_platform02.png){.thumbnail}
>
> Para más información sobre la adición de un dominio, consulte [la guía Exchange](exchange_adding_domain1.).
...
![email-migración](migration_platform03.gif){.thumbnail}
...
![email-migración](migration_platform04.png){.thumbnail}
...
![email-migración](migration_platform05.png){.thumbnail}
...
> - [Delegación de derechos](feature_delegation1.)
> - [Grupos](feature_groups1.)
> - Contactos externos
> - [Pie de página](feature_footers1.)
...
> Si debe migrar varias cuentas de correo, le recomendamos que utilice el modo [Proyecto](migration_omm#project.) a través de [OMM](https://omm.ovh.net/Project/Create), para importar una tabla en formato CSV con la información de las cuentas de correo que vaya a migrar.

Para más información sobre OMM, consulte nuestra guía [Migrar cuentas de correo a través de OVH Mail Migrator](migration_omm1.).

![email-migración](migration_platform06.png){.thumbnail}
...
![email-migración](images_check_the_dns_records_associated_domains.png){.thumbnail}
...
<br>Para más información, consulte nuestra guía en las secciones relativas an [Hosted Exchange](web-cloud-email-collaborative-solutions-microsoft-exchange1.){.external}. Si no puede reconfigurar la cuenta de forma inmediata, siempre es posible acceder a través de la aplicación online.
...
[Gestionar los contactos de los servicios](managing_contacts1.){.external}.
