...
![email-migrazione](migration_platform01.gif){.thumbnail}

> [!primary]
>
> Per migrare una soluzione MX Plan verso una piattaforma Exchange o Email Pro, consulta la guida [Migrare un indirizzo email MX Plan verso un account Email Pro o Exchange](migration_control_panel1.).
>
...
Se hai appena ordinato il nuovo servizio di posta, prima aggiungi il dominio alla tua piattaforma [Email Pro](first_config#step-2-aggiungi-il-dominio.) o [Exchange](exchange_adding_domain1.). Se migrate verso una piattaforma MX Plan, con il dominio associato "fisso", potrete passare direttamente allo [step successivo](#accountsmigration.).
...
>
> ![email-migrazione](migration_platform02.png){.thumbnail}
>
> Per maggiori informazioni sull'aggiunta di un dominio, consulta [la guida Email Pro](first_config#step-2-aggiungi-il-dominio.) o [la guida Exchange](exchange_adding_domain1.).
...
![email-migrazione](migration_platform03.gif){.thumbnail}
...
![email-migrazione](migration_platform04.png){.thumbnail}
...
![email-migrazione](migration_platform05.png){.thumbnail}
...
> - [Delega dei diritti](feature_delegation1.)
> - [Gruppi](feature_groups1.)
> - Contatti esterni
> - [Firma](feature_footers1.)
...
> Se vuoi migrare più account email, ti consigliamo di utilizzare la modalità [Project](migration_omm#project.) via [OMM](https://omm.ovh.net/Project/Create), per importare una tabella in formato CSV contenente le informazioni degli account email da migrare.

Per maggiori informazioni su OMM, consulta la guida [Migrare account email via OVH Mail Migrator](migration_omm1.).

![email-migrazione](migration_platform06.png){.thumbnail}
...
![email-migrazione](images_check_the_dns_records_associated_domains.png){.thumbnail}
...
<br>Per maggiori informazioni sulle operazioni da effettuare, consulta la nostra documentazione nelle sezioni delle guide dedicate a [Email Pro](web-cloud-email-collaborative-solutions-email-pro1.){.external} e [Hosted Exchange](web-cloud-email-collaborative-solutions-microsoft-exchange1.){.external}. Se non sei in grado di riconfigurare l'account nell'immediato, l'accesso tramite l'applicazione online è sempre possibile.
