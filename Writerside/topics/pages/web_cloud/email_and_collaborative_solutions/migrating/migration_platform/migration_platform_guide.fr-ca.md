...
> [!primary]
>
> Pour migrer une solution MX Plan vers une plateforme Exchange, nous vous invitons à suivre notre guide [Migrer une adresse e-mail MX Plan vers un compte Exchange](migration_control_panel1.).
>
...
Avant de commencer votre migration, si vous venez de commander votre nouvelle offre e-mail, ajoutez d'abord le nom de domaine à votre plateforme [Exchange](exchange_adding_domain1.). Si vous migrez vers une plateforme MX Plan, le nom de domaine attaché étant « fixe », vous pouvez directement passer à [l'étape suivante](#accountsmigration.).
...
>
> Pour plus de détails sur l'ajout d'un nom de domaine, suivez [le guide Exchange](exchange_adding_domain1.).
...
> Si vous devez migrer plusieurs comptes e-mail, nous vous conseillons d'utiliser le mode [Project](migration_omm#realiser-et-suivre-une-migration-multiple-mode-projet.) via [OMM](https://omm.ovh.net/Project/Create), il vous permettra d'importer un tableau au format CSV contenant les informations des comptes e-mail à migrer.

Pour plus d'information sur OMM, consultez notre guide [Migrer des comptes e-mail via OVH Mail Migrator](migration_omm1.).
