...
> [!primary]
>
> Pour migrer une solution MX Plan vers une plateforme Exchange ou E-mail Pro, nous vous invitons à suivre notre guide [Migrer une adresse e-mail MX Plan vers un compte E-mail Pro ou Exchange](migration_control_panel1.).
>
...
Avant de commencer votre migration, si vous venez de commander votre nouvelle offre e-mail, ajoutez d'abord le nom de domaine à votre plateforme [E-mail Pro](first_config#etape-2-ajouter-votre-nom-de-domaine.) ou [Exchange](exchange_adding_domain1.). Si vous migrez vers une plateforme MX Plan, le nom de domaine attaché étant « fixe », vous pouvez directement passer à [l'étape suivante](#accountsmigration.).
...
> - [Délégations de droits](feature_delegation1.) 
> - [Groupes](feature_groups1.)
> - Contacts externes
> - [Pied de page](feature_footers1.)
...
> Si vous devez migrer plusieurs comptes e-mail, nous vous conseillons d'utiliser le mode [Project](migration_omm#project.) via [OMM](https://omm.ovh.net/Project/Create), il vous permettra d'importer un tableau au format CSV contenant les informations des comptes e-mail à migrer.
