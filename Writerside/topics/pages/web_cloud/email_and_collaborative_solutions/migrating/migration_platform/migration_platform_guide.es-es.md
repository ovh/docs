...
> [!primary]
>
> Para migrar una solución MX Plan a una plataforma Exchange o Email Pro, consulte nuestra guía [Migrar una dirección MX Plan a una cuenta Email Pro o Exchange](migration_control_panel1.).
>
...
Antes de realizar la migración, si acaba de contratar la nueva solución de correo, añada el dominio a su plataforma [Email Pro](first_config#2-anadir-su-nombre-de-dominio.) o [Exchange](exchange_adding_domain1.). Si migra a una plataforma MX Plan, ya que el dominio es "fijo", puede pasar directamente a [la siguiente etapa](#accountsmigration.) .
...
>
> Para más información sobre la adición de un dominio, consulte [la guía Email Pro](first_config#2-anadir-su-nombre-de-dominio.) o [la guía Exchange](exchange_adding_domain1.).
...
<br>Para más información, consulte nuestra guía en las secciones relativas a [Email Pro](web-cloud-email-collaborative-solutions-email-pro1.){.external} y [Hosted Exchange](web-cloud-email-collaborative-solutions-microsoft-exchange1.){.external}. Si no puede reconfigurar la cuenta de forma inmediata, siempre es posible acceder a través de la aplicación online.
...
[Guías Email Pro](web-cloud-email-collaborative-solutions-email-pro1.){.external}.
