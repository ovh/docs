...
![email-migração](migration_platform01.gif){.thumbnail}

> [!primary]
>
> Para migrar uma solução MX Plan para uma plataforma Exchange ou E-mail Pro, sugerimos que siga o nosso guia [Migrar um endereço de e-mail MX Plan para uma conta E-mail Pro ou Exchange](migration_control_panel1.).
>
...
Antes de iniciar a migração, caso tenha encomendado a nova oferta de e-mail, adicione o domínio à plataforma [E-mail Pro](first_config#2-adicionar-o-dominio.) ou [Exchange](exchange_adding_domain1.). Se migrar para uma plataforma MX Plan, o domínio associado é "fixo", pode passar diretamente para [o passo seguinte](#accountsmigration.).
...
>
> ![email-migração](migration_platform02.png){.thumbnail}
>
> Para mais informações sobre a adição de um domínio, siga [o guia E-mail Pro](first_config#2-adicionar-o-dominio.) ou [o guia Exchange](exchange_adding_domain1.).
...
![email-migração](migration_platform03.gif){.thumbnail}
...
![email-migração](migration_platform04.png){.thumbnail}
...
![email-migração](migration_platform05.png){.thumbnail}
...
> - [Delegação de direitos](feature_delegation1.) 
> - [Grupos](feature_groups1.)
> - Contactos externos
> - [Posto de página](feature_footers1.)
...
> Se tiver de migrar várias contas de e-mail, sugerimos que utilize o modo [Project](migration_omm#project.) via [OMM](https://omm.ovh.net/Project/Create), o que lhe permitirá importar uma tabela em formato CSV contendo as informações das contas de e-mail a migrar.

Para mais informações sobre OMM, consulte o nosso guia [Migrar contas de e-mail através do OVH Mail Migrator](migration_omm1.).

![email-migração](migration_platform06.png){.thumbnail}
...
![email-migração](images_check_the_dns_records_associated_domains.png){.thumbnail}
...
<br>Para o ajudar nas suas operações, consulte o nosso manual através das secções dos guias [E-mail Pro](web-cloud-email-collaborative-solutions-email-pro1.){.external} e [Hosted Exchange](web-cloud-email-collaborative-solutions-microsoft-exchange1.){.external}. Se não consegue reconfigurar a conta de forma imediata, o acesso através da aplicação online é sempre possível.
...
[Como gerir os contactos (gestores) dos serviços OVHcloud](managing_contacts1.){.external}.

[Guides E-mail Pro](web-cloud-email-collaborative-solutions-email-pro1.){.external}.

[Guias Exchange](web-cloud-email-collaborative-solutions-microsoft-exchange1.){.external}.
