...
![e-mail-migracja](migration_platform01.gif){.thumbnail}

> [!primary]
>
> Aby przenieść rozwiązanie MX Plan na platformę Exchange lub E-mail Pro, zapoznaj się z naszym przewodnikiem [Migracja konta e-mail MX Plan na konto E-mail Pro lub Exchange](migration_control_panel1.).
>
...
Przed rozpoczęciem migracji, jeśli właśnie zamówiłeś nową ofertę e-mail, dodaj najpierw domenę do platformy [E-mail Pro](first_config#etap-2-dodanie-domeny.) lub [Exchange](exchange_adding_domain1.). Jeśli przejdziesz na platformę MX Plan i przypisana do niej nazwa domeny to "stała", możesz przejść bezpośrednio [do kolejnego](#accountsmigration.) etapu.
...
>
> ![e-mail-migracja](migration_platform02.png){.thumbnail}
>
> Aby uzyskać więcej informacji na temat dodania domeny, zapoznaj się [z przewodnikiem E-mail Pro](first_config#etap-2-dodanie-domeny.) lub [przewodnikiem Exchange](exchange_adding_domain1.).
...
![e-mail-migracja](migration_platform03.gif){.thumbnail}
...
![e-mail-migracja](migration_platform04.png){.thumbnail}
...
![e-mail-migracja](migration_platform05.png){.thumbnail}
...
> - [Uprawnienia](feature_delegation1.) 
> - [Grupy](feature_groups1.)
> - Kontakty zewnętrzne
> - [Stopka strony](feature_footers1.)
...
> Jeśli chcesz migrować kilka kont e-mail, zalecamy użycie trybu [Project](migration_omm#project.) przez [OMM](https://omm.ovh.net/Project/Create), pozwoli Ci zaimportować tabelę w formacie CSV zawierającą informacje o kontach e-mail, które mają zostać migrowane.
...
![e-mail-migracja](migration_platform06.png){.thumbnail}
...
![e-mail-migracja](images_check_the_dns_records_associated_domains.png){.thumbnail}
...
<br>Aby pomóc Ci w przeprowadzeniu operacji, zapoznaj się z naszą dokumentacją w sekcjach przewodników dotyczących [E-mail Pro](web-cloud-email-collaborative-solutions-email-pro1.){.external} i [Hosted Exchange](web-cloud-email-collaborative-solutions-microsoft-exchange1.){.external}. Jeśli nie jesteś w stanie zmienić konfiguracji konta w tej chwili, dostęp przez aplikację online jest zawsze możliwy.
