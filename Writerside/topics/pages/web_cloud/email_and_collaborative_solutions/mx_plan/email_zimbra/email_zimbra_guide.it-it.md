...
>
> Per maggiori informazioni, consulta le nostre [FAQ sulla soluzione Zimbra di OVHcloud](faq-zimbra1.).
...
- Disporre delle credenziali di accesso all’indirizzo email MX Plan da consultare. Per maggiori informazioni, consulta la nostra guida "[Iniziare a utilizzare il servizio MX Plan](email_generalities1.)".
...
- [Interfaccia generale della Webmail Zimbra](email_zimbra_#general-interface.)
...
- [Scrivi un’email](email_zimbra_#email-writing.)
- [Configura le preferenze dell’interfaccia Zimbra](#settings.)
- [Contatti](email_zimbra_#contacts.)
...
![Zimbra - connessione](ovhcloud-login-webmail.png){.thumbnail}

Verrai reindirizzato all'interfaccia Zimbra.

![Zimbra - interfaccia](zimbra-01.png){.thumbnail}
...
>>
>> ![Zimbra - menu superiore](zimbra-02.png){.thumbnail}
>>
> **Colonna sinistra**
>>
...
>>
>> ![Zimbra - struttura](zimbra-03.png){.thumbnail}
>>
> **Finestra centrale**
>>
...
![Zimbra - cartelle](zimbra-05.png){.thumbnail}
...
![Zimbra - azioni](zimbra-07.png){.thumbnail}
...
>>
>> ![Zimbra - ricerca semplice](zimbra-08.png){.thumbnail}
>>
> **Ricerca avanzata**
>>
...
>>
>> ![Zimbra - ricerca avanzata](zimbra-09.png){.thumbnail}
>>
...
![Zimbra - scrivere una e-mail](zimbra-10.png){.thumbnail}
...
>> - **A**:  il/i destinatario/i della tua email. Clicca su `A`{.action} per accedere alla tua [rubrica contatti](email_zimbra_#contacts.) e selezionare i destinatari.<br>
...
>>
>> ![Zimbra - intestazione](zimbra-11.png){.thumbnail}
>>
> **Testo dell’email**
>>
...
>>
>> ![Zimbra - corpo](zimbra-12.png){.thumbnail}
>>
...
![Zimbra - allegato](zimbra-13.png){.thumbnail}
...
>
> ![Zimbra - annullare un invio](zimbra-cancel-email.png){.thumbnail .w-400}
...
![Zimbra - preferenze](zimbra-14.png){.thumbnail}
...
![Zimbra - contatti](zimbra-15.png){.thumbnail}
...
![Zimbra - nuovo contatto](zimbra-16.png){.thumbnail}
...
![Zimbra - cartelle dei contatti](zimbra-17.png){.thumbnail}
...
![Zimbra - elenchi](zimbra-list.png){.thumbnail}
...
>> ![Zimbra - Importa](zimbra-19.png){.thumbnail}
>>
> **Esporta i Contatti**
>>
...
>> ![Zimbra - Esportare](zimbra-20.png){.thumbnail}
>>
...
![Zimbra - filtri](zimbra-filters.png){.thumbnail}
...
![Zimbra - creare un filtro](zimbra-21.png){.thumbnail}
...
> **Modalità semplice**
>>
>> ![Zimbra - filtri - modalità singola](zimbra-22.png){.thumbnail}
>>
> **Modalità avanzata**
>>
>> ![Zimbra - filtri - modalità avanzata](zimbra-23.png){.thumbnail}
>>
...
[Iniziare a utilizzare MX Plan](email_generalities1.)

[Modificare la password di un indirizzo email MX Plan](email_change_password1.)

[Crea filtri per i tuoi indirizzi email](feature_filters1.)

[Utilizza i reindirizzamenti email](feature_redirections1.)
