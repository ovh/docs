...
>
> Aby uzyskać więcej informacji, sprawdź nasz [FAQ dotyczący rozwiązania Zimbra OVHcloud](faq-zimbra1.).
...
- Dane do logowania do konta e-mail MX Plan, które chcesz sprawdzić. Aby uzyskać więcej informacji, zapoznaj się z przewodnikiem "[Pierwsze kroki z ofertą MX Plan](email_generalities1.)".
...
- [Ogólny interfejs webmaila Zimbra](email_zimbra_#general-interface.)
...
- [Napisz wiadomość e-mail](email_zimbra_#email-writing.)
- [Skonfiguruj preferencje interfejsu Zimbra](#settings.)
- [Kontakty](email_zimbra_#contacts.)
...
![Zimbra - logowanie](ovhcloud-login-webmail.png){.thumbnail}

Zostaniesz wówczas przekierowany do interfejsu Zimbra.

![Zimbra - interfejs](zimbra-01.png){.thumbnail}
...
>>
>> ![Zimbra - E-maile](zimbra-04.png){.thumbnail}
>>
...
![Zimbra - dokumentacja](zimbra-05.png){.thumbnail}
...
![Zimbra - działania](zimbra-07.png){.thumbnail}
...
>>
>> ![Zimbra - proste wyszukiwanie](zimbra-08.png){.thumbnail}
>>
...
>>
>> ![Zimbra - zaawansowane wyszukiwanie](zimbra-09.png){.thumbnail}
>>
...
![Zimbra - napisz e-mail](zimbra-10.png){.thumbnail}
...
>> - **Do** : odbiorca(y) Twojej wiadomości e-mail. Kliknij na `Do`{.action}, aby przejść do [książki adresowej](email_zimbra_#contacts.) i wybrać odbiorców.<br>
...
>>
>> ![Zimbra — nagłówek](zimbra-11.png){.thumbnail}
>>
> **Treść e-maila**
>>
...
>>
>> ![Zimbra — ciało](zimbra-12.png){.thumbnail}
>>
...
![Zimbra - załącznik](zimbra-13.png){.thumbnail}
...
>
> ![Zimbra - anulowanie wysyłki](zimbra-cancel-email.png){.thumbnail .w-400}

### Skonfiguruj preferencje interfejsu Zimbra <a name="settings"></a>

Interfejs Zimbra posiada 2 menu konfiguracyjne:

![Zimbra - preferencje](zimbra-14.png){.thumbnail}
...
![Zimbra - kontakty](zimbra-15.png){.thumbnail}
...
![Zimbra - nowy kontakt](zimbra-16.png){.thumbnail}
...
![Zimbra - sprawy z kontaktami](zimbra-17.png){.thumbnail}
...
![Zimbra - listy](zimbra-list.png){.thumbnail}
...
>> ![Zimbra - Eksport](zimbra-20.png){.thumbnail}
>>
...
![Zimbra - filtry](zimbra-filters.png){.thumbnail}
...
![Zimbra - utwórz filtr](zimbra-21.png){.thumbnail}
...
> **Tryb prosty**
>>
>> ![Zimbra - filtry - tryb prosty](zimbra-22.png){.thumbnail}
>>
> **Tryb zaawansowany**
>>
>> ![Zimbra - filtry - tryb zaawansowany](zimbra-23.png){.thumbnail}
>>
...
[Pierwsze kroki z usługą MX Plan](email_generalities1.)

[Zmiana hasła do konta e-mail MX Plan](email_change_password1.)

[Tworzenie filtrów dla kont e-mail](feature_filters1.)

[Korzystanie z przekierowań e-mail](feature_redirections1.)
