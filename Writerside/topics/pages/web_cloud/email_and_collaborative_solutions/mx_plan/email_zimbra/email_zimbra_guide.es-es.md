...
>
> Para más información, consulte nuestras [FAQ sobre la solución Zimbra OVHcloud](faq-zimbra1.).
...
- [Interfaz general del webmail Zimbra](email_zimbra_#general-interface.)
...
- [Redactar un email](email_zimbra_#email-writing.)
...
>>
>> ![Zimbra - menú superior](zimbra-02.png){.thumbnail}
>>
> **Columna izquierda**
>>
...
![Zimbra - acciones](zimbra-07.png){.thumbnail}
...
>>
>> ![Zimbra - Búsqueda avanzada](zimbra-09.png){.thumbnail}
>>
...
![Zimbra - Redactar un email](zimbra-10.png){.thumbnail}
...
>> - **Para**: el/los destinatario/s de su correo electrónico. Haga clic en `Para`{.action} para acceder a su [agenda de contactos](email_zimbra_#contacts.) y seleccionar sus destinatarios.<br>
...
>>
>> ![Zimbra - cuerpo](zimbra-12.png){.thumbnail}
>>
...
![Zimbra - archivo adjunto](zimbra-13.png){.thumbnail}
...
>
> ![Zimbra - cancelar un envío](zimbra-cancel-email.png){.thumbnail .w-400}
...
![Zimbra: preferencias](zimbra-14.png){.thumbnail}
...
![Zimbra: nuevo contacto](zimbra-16.png){.thumbnail}
...
![Zimbra - carpetas de contactos](zimbra-17.png){.thumbnail}
...
![Zimbra - crear filtro](zimbra-21.png){.thumbnail}
...
> **Modo simple**
>>
>> ![Zimbra - filtros - modo simple](zimbra-22.png){.thumbnail}
>>
> **Modo avanzado**
>>
>> ![Zimbra - filtros - modo avanzado](zimbra-23.png){.thumbnail}
>>
...
![Correo electrónico](zimbra-delegation.png){.thumbnail}
