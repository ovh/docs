...
>
> Para mais informações, consulte o [FAQ sobre a solução Zimbra OVHcloud](faq-zimbra1.).
...
- Ter acesso às informações de início de sessão do endereço de e-mail MX Plan que pretende consultar. Para mais informações, consulte o nosso guia "[Primeiros passos com a oferta MX Plan](email_generalities1.)".
...
- [Interface geral do webmail Zimbra](email_zimbra_#general-interface.)
...
- [Redigir um e-mail](email_zimbra_#email-writing.)
- [Configurar as preferências da interface Zimbra](#settings.)
- [Contactos](email_zimbra_#contacts.)
...
![Zimbra - ligação](ovhcloud-login-webmail.png){.thumbnail}
...
>>
>> ![Zimbra - Menu superior](zimbra-02.png){.thumbnail}
>>
> **Coluna da esquerda**
>>
...
>>
>> ![Zimbra - árvore](zimbra-03.png){.thumbnail}
>>
> **Janela central**
>>
...
![Zimbra - ações](zimbra-07.png){.thumbnail}
...
>>
>> ![Zimbra - pesquisa simples](zimbra-08.png){.thumbnail}
>>
> **Pesquisa avançada**
>>
...
>>
>> ![Zimbra - pesquisa avançada](zimbra-09.png){.thumbnail}
>>
...
![Zimbra - escrever um e-mail](zimbra-10.png){.thumbnail}
...
>> - **Para** : o(s) destinatário(s) do seu e-mail. Clique em `Para`{.action} para aceder ao seu [livro de contactos](email_zimbra_#contacts.) e selecionar os seus destinatários.<br>
...
>>
>> ![Zimbra - cabeçalho](zimbra-11.png){.thumbnail}
>>
> **Corpo do e-mail**
>>
...
>>
>> ![Zimbra - corps](zimbra-12.png){.thumbnail}
>>
...
![Zimbra - anexo](zimbra-13.png){.thumbnail}
...
![Zimbra - contactos](zimbra-15.png){.thumbnail}
...
![Zimbra - novo contacto](zimbra-16.png){.thumbnail}
...
![Zimbra - pastas de contactos](zimbra-17.png){.thumbnail}
...
![Zimbra - listas](zimbra-list.png){.thumbnail}
...
>> ![Zimbra - Importar](zimbra-19.png){.thumbnail}
>>
...
>> ![Zimbra - Exportar](zimbra-20.png){.thumbnail}
>>
...
![Zimbra - filtros](zimbra-filters.png){.thumbnail}
...
![Zimbra - criar um filtro](zimbra-21.png){.thumbnail}
...
> **Modo simples**
>>
>> ![Zimbra - filtros - modo simples](zimbra-22.png){.thumbnail}
>>
> **Modo avançado**
>>
>> ![Zimbra - filtros - modo avançado](zimbra-23.png){.thumbnail}
>>
...
[Primeiros passos com a oferta MX Plan](email_generalities1.)

[Alterar a palavra-passe de um endereço de e-mail MX Plan](email_change_password1.)

[Criar filtros para os seus endereços de e-mail](feature_filters1.)

[Utilizar os reencaminhamentos de e-mail](feature_redirections1.)
