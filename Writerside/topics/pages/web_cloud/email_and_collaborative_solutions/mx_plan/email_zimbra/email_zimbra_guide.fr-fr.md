...
>
> Pour plus d'informations, consultez notre [FAQ sur la solution Zimbra OVHcloud](faq-zimbra1.).
...
- Disposer des informations de connexion à l’adresse e-mail MX Plan que vous souhaitez consulter. Pour plus d'informations, consultez notre guide « [Premiers pas avec l'offre MX Plan](email_generalities1.) ».
...
- [Interface générale du webmail Zimbra](email_zimbra_#general-interface.)
...
- [Rédiger un e-mail](email_zimbra_#email-writing.)
...
![Zimbra - connexion](ovhcloud-login-webmail.png){.thumbnail}
...
>>
>> ![Zimbra - menu supérieur](zimbra-02.png){.thumbnail}
>>
> **Colonne de gauche**
>>
...
>>
>> ![Zimbra - arborescence](zimbra-03.png){.thumbnail}
>>
> **Fenêtre centrale**
>>
...
![Zimbra - actions](zimbra-07.png){.thumbnail}
...
>>
>> ![Zimbra - recherche simple](zimbra-08.png){.thumbnail}
>>
> **Recherche avancée**
>>
...
>>
>> ![Zimbra - recherche avancée](zimbra-09.png){.thumbnail}
>>
...
![Zimbra - rédiger un e-mail](zimbra-10.png){.thumbnail}
...
>> - **À** : le(s) destinataire(s) de votre e-mail. Cliquez sur `À`{.action} pour accéder à votre [carnet de contacts](email_zimbra_#contacts.) et sélectionner vos destinataires.<br>
...
>>
>> ![Zimbra - en-tête](zimbra-11.png){.thumbnail}
>>
> **Corps de l'e-mail**
>>
...
![Zimbra - pièce jointe](zimbra-13.png){.thumbnail}
...
>
> ![Zimbra - annuler un envoi](zimbra-cancel-email.png){.thumbnail .w-400}
...
![Zimbra - préférences](zimbra-14.png){.thumbnail}
...
![Zimbra - nouveau contact](zimbra-16.png){.thumbnail}
...
![Zimbra - dossiers de contacts](zimbra-17.png){.thumbnail}
...
![Zimbra - listes](zimbra-list.png){.thumbnail}
...
>> ![Zimbra - Importer](zimbra-19.png){.thumbnail}
>>
...
>> ![Zimbra - Exporter](zimbra-20.png){.thumbnail}
>>
...
![Zimbra - filtres](zimbra-filters.png){.thumbnail}
...
![Zimbra - créer un filtre](zimbra-21.png){.thumbnail}
...
> **Mode simple**
>>
>> ![Zimbra - filtres - mode simple](zimbra-22.png){.thumbnail}
>>
> **Mode avancé**
>>
>> ![Zimbra - filtres - mode avancé](zimbra-23.png){.thumbnail}
>>
...
[Modifier le mot de passe d’une adresse e-mail MX Plan](email_change_password1.)

[Créer des filtres pour vos adresses e-mail](feature_filters1.)

[Utiliser les redirections e-mail](feature_redirections1.)
