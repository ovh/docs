...
> [!primary]
>
> Czy używasz wcześniejszej wersji systemu Windows? Zapoznaj się z naszą dokumentacją: [Konfiguracja konta e-mail w aplikacji Poczta na urządzeniu z systemem Windows 8](how_to_configure_windows_101.){.external}.
>
...
[Konfiguracja konta Exchange w aplikacji Poczta na urządzeniu z systemem Windows](how_to_configure_windows_102.){.external}
