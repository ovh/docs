...
|Then click `Configure manually...`{.action} to enter the **INCOMING** server settings: <br>- Protocol **IMAP** <br>\- Server **ssl0.ovh.net** <br>\- Port **993** <br>\- SSL **SSL/TLS** <br>\- Authentication **Normal password** <br>\- Username **Full email address**|![Thunderbird](thunderbird-win-mxplan02.png){.thumbnail}|
|![Thunderbird](thunderbird-win-mxplan03.png){.thumbnail}|Enter **OUTGOING** server settings: <br>- Protocol **SMTP** <br>\- Server **ssl0.ovh.net** <br>\- Port **465** <br>\- SSL **SSL/TLS** <br>\- Authentication **Normal password** <br>\- Username **Full email address**<br><br>To complete the configuration, click `Done`{.action}|
...
OVHcloud also has a web application you can use to access your email address from your browser. You can access this application at <https://www.ovh.ie/mail/>. You can log in using your email credentials. If you have any questions about how to use this interface, please refer to our guides on [Using the Outlook Web App](email_owa1.) and [Using an email address with RoundCube](email_roundcube#ou-et-comment-se-connecter-au-webmail-roundcube.) respectively.
...
![Thunderbird](thunderbird-win-mxplan05.png){.thumbnail}
...
![Thunderbird](thunderbird-win-mxplan06.png){.thumbnail}
