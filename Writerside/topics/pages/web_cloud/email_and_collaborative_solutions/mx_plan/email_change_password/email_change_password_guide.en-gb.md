...
>>
>> If you do not know which type of MX Plan solution you have, please read the section [Identify your MX Plan solution](email_change_password_#whichmxplan.).<br>
...
> [!warning]
>
> The email solution **MX Plan legacy** uses Roundcube webmail. You can only change your password [via the OVHcloud Control Panel](email_change_password_#controlpanel.).
>
...
|---|---|
|![email](email_change_password_images_mxplan-starter-legacy-step1.png){.thumbnail}<br> The solution appears in the **Subscription** box on the right. The legacy solution *does not* have a server reference.|![email](email_change_password_images_mxplan-starter-new-step1.png){.thumbnail}<br>The new solution has a **Server model** in the **Summary** box on the left.|

## Go further

[Getting started with the MX Plan solution](email_generalities1.)

[Getting started with the Email Pro solution](first_config1.)

[Getting started with the Hosted Exchange solution](exchange_starting_hosted1.)
