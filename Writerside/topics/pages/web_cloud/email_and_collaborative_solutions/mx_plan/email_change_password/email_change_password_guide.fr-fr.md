...
>>
>> Si vous ne connaissez pas le type d'offre MXplan que vous possédez, consultez notre paragraphe [Identifiez votre offre MXplan](email_change_password_#whichmxplan.).<br><br>
...
>> Cliquez sur le bouton `...`{.action} puis sur `Modifier`{.action}.<br><br>
>>![email](email-password-emailpro01.png){.thumbnail}<br>
>>
> **Exchange**
>>
...
>> Cliquez sur le bouton `...`{.action} puis sur `Modifier`{.action}.<br><br>
>>![email](email-password-exchange01.png){.thumbnail}<br>
>>
...
> [!warning]
>
> L'offre **Emails MXplan (version historique)** utilise le webmail Roundcube, le changement de mot de passe se fait uniquement [via l'espace client](email_change_password_#controlpanel.).
>
...
![email](mxplan-password-new-step2.png){.thumbnail}
...
![email](mxplan-password-new-step3.png){.thumbnail}
...
![email](mxplan-password-new-step4.png){.thumbnail}
...
![email](mxplan-password-new-step5.png){.thumbnail}
...
|---|---|
|![email](email_change_password_images_mxplan-starter-legacy-step1.png){.thumbnail}<br> L'offre apparait dans le cadre « **Abonnement** » sur la droite, l'offre historique *ne possède pas* de référence serveur.|![email](email_change_password_images_mxplan-starter-new-step1.png){.thumbnail}<br>La nouvelle offre possède une « **Référence serveur** » dans le cadre « **Résumé** » sur la gauche.|

## Aller plus loin

[Premiers pas avec la solution MXplan](email_generalities1.)

[Premiers pas avec la solution E-mail Pro](first_config1.)

[Premiers pas avec la solution Hosted Exchange](exchange_starting_hosted1.)
