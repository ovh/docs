...
>
> - [MXplan](web-cloud-email-collaborative-solutions-mx-plan1.)
> - [Email Pro](web-cloud-email-collaborative-solutions-email-pro1.)
...
>>
>> Si no conoce el tipo de producto MXplan que posee, consulte el apartado [Identifique su producto MXplan](email_change_password_#whichmxplan.).<br>
...
>>![email](email-password-mxplan-legacy01.png){.thumbnail}<br>
>>
...
>>![email](email-password-mxplan-new01.png){.thumbnail}<br>
>>
> **Email Pro**
>>
...
>> Haga clic en el botón `...`{.action} y seleccione `Editar`{.action}.<br><br>
>>![Correo electrónico](email-password-emailpro01.png){.thumbnail}<br>
>>
> **Exchange**
>>
...
>> Haga clic en el botón `...`{.action} y seleccione `Editar`{.action}.<br><br>
>>![Correo electrónico](email-password-exchange01.png){.thumbnail}<br>
>>
...
> [!warning]
>
> La solución **MXplan (versión histórica)** utiliza el webmail Roundcube. La modificación de la contraseña solo se realiza [desde el área de cliente](email_change_password_#controlpanel.).
>
...
![Correo electrónico](mxplan-password-new-step2.png){.thumbnail}
...
![Correo electrónico](mxplan-password-new-step3.png){.thumbnail}
...
![Correo electrónico](mxplan-password-new-step4.png){.thumbnail}
...
![Correo electrónico](mxplan-password-new-step5.png){.thumbnail}
...
|---|---|
|![Correo electrónico](email_change_password_images_mxplan-starter-legacy-step1.png){.thumbnail}<br> La oferta aparece en el recuadro "**Suscripción**", a la derecha, y el producto histórico *no posee* un servidor de referencia.|![Correo electrónico](email_change_password_images_mxplan-starter-new-step1.png){.thumbnail}<br>El nuevo producto tiene una "**Referencia del servidor**" en el recuadro "**Resumen**" a la izquierda.|

## Más información

[Primeros pasos con la solución MXplan](email_generalities1.)

[Primeros pasos con la solución Email Pro](first_config1.)

[Primeros pasos con la solución Hosted Exchange](exchange_starting_hosted1.)
