...
La primera vez que se conecte al webmail deberá seleccionar el idioma de la interfaz y la zona horaria en la que se encuentra. A continuación se abrirá la bandeja de entrada. Para más información, consulte nuestra guía [Utilizar una dirección de correo desde Outlook en la Web](email_owa1.){.external}.
...
|---|---|---|---|---|
|[Windows 10](how_to_configure_windows_101.){.external}|[Outlook 2016](how_to_configure_outlook_20161.){.external}|[Mail de macOS (última versión)](how_to_configure_mail_macos1.){.external}|[Android (última versión)](how_to_configure_android1.){.external}|[Gmail](how_to_configure_gmail1.){.external}|
...
![Correo electrónico](mxplan-starter-legacy-step2.png){.thumbnail}
