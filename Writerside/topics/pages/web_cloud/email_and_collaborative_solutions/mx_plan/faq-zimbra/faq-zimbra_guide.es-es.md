...
No obstante, podrá seguir disfrutando de la interfaz OWA [migrando sus cuentas de correo a una solución Email Pro o Exchange](migration_control_panel1.)

### ¿Puedo dar de baja mi servicio MX Plan?

Para dar de baja un servicio en la sección « Mis servicios » de su área de OVHcloud, consulte la sección MX Plan de nuestra guía « [Cómo dar de baja un servicio de OVHcloud](how_to_cancel_services#mxplan.) ».
...
[MX Plan - Utilizar el webmail Zimbra](email_zimbra1.)
