...
Zimbra bietet vergleichbare Funktionen und ein ähnliches Nutzererlebnis wie OWA. Eine Anleitung zur Verwendung von Zimbra finden Sie bereits unter [dieser Adresse](email_zimbra1.).
...
Eine Anleitung zur Verwendung von Zimbra finden Sie bereits unter [dieser Adresse](email_zimbra1.).
...
Sie können jederzeit zu einem Angebot migrieren, das OWA-Webmail verwendet, also E-Mail Pro oder Exchange. Folgen Sie hierzu der Anleitung "[E-Mail-Accounts von MX Plan zu E-Mail Pro oder Exchange migrieren](migration_control_panel1.)".
...
Sie können aber weiterhin das OWA Interface nutzen, indem Sie Ihre [E-Mail-Accounts auf eine E-Mail Pro oder Exchange Lösung migrieren](migration_control_panel1.).

### Kann ich mein MX Plan Angebot kündigen?

Um Ihr Angebot unter "Meine Dienste" im OVHCloud Kundencenter zu kündigen, folgen Sie der Anleitung "[OVHcloud Dienste kündigen](how_to_cancel_services#mxplan.)" im Abschnitt zu MX Plan.
...
[MX Plan - Zimbra Webmail verwenden](email_zimbra1.)
