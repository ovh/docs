...
Zimbra offers similar features and a user experience close to OWA. A user guide for Zimbra is now available at [this address](email_zimbra1.).
...
A user guide for Zimbra is now available at [this address](email_zimbra1.).
...
You can migrate your accounts at any time to Email Pro or Exchange in order to keep using the OWA webmail. To do this, please refer to our guide on [Migrating an MX Plan email account to an Email Pro or Exchange account](migration_control_panel1.).
...
However, you can still take advantage of the OWA interface [by migrating your email accounts to an Email Pro or Exchange solution](migration_control_panel1.).

### Can I cancel my MX Plan solution?

To cancel your solution in the "My services" section of the OVHcloud Control Panel, please refer to the MX Plan part of our guide on [Cancelling your OVHcloud services](how_to_cancel_services#mxplan.).
...
[MX Plan - How to use Zimbra webmail](email_zimbra1.)
