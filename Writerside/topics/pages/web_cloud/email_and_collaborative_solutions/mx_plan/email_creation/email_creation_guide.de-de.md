...
> **Sonderfälle**
>
> - Hinweis zu Kostenloses Hosting 100M: Es muss zuerst [aktiviert werden](activate_start10m1.), um einen E-Mail-Account zu erstellen. Sie können diese Operation über Ihr [OVHcloud Kundencenter](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de){.external} durchführen, indem Sie die betreffende Domain auswählen.
> - Bei einem Webhosting muss der [inkludierte MX Plan aktiviert werden](https://www.ovhcloud.com/de/web-hosting/){.external}, bevor Sie die übrigen Schritte dieser Anleitung durchführen. Lesen Sie hierzu unsere Anleitung zur [Aktivierung der im Webhosting enthaltenen E-Mail-Accounts](activate-email-hosting1.).
...
|---|---|
|![E-Mail](mxplan-creation-legacy-step1.png){.thumbnail}<br> Ihr Angebot wird im Abschnitt „Abo“ angezeigt.|![E-Mail](mxplan-creation-new-step1.png){.thumbnail}<br>Die `Server-Referenz` steht in der Box „Zusammenfassung“.|
|Weiter zur [historischen MX Plan Version](email_creation_#mxplanlegacy.)|Weiter zur [neuen MX Plan Version](#newmxplan.)|

### Neue MX Plan Version <a name="newmxplan"></a>

#### Zugang zur Verwaltung des E-Mail-Dienstes

Bei der neuen MX Plan Version sollte die Anzeige der folgenden Abbildung entsprechen. Ist das nicht der Fall, überprüfen Sie [mithilfe der oben stehenden Informationen](email_creation_#instructions.), dass Sie den richtigen Schritten folgen.

![E-Mail](mxplan-creation-new-step1.png){.thumbnail}
...
![E-Mail](mxplan-creation-new-step2.png){.thumbnail}
...
![E-Mail](mxplan-creation-new-step3.png){.thumbnail}
...
Beim ersten Login werden Sie aufgefordert, die Sprache sowie Ihre Zeitzone festzulegen. Daraufhin wird Ihr Postfach angezeigt. Um herauszufinden, wie Sie Ihre E-Mail-Adresse mit Outlook Web App (OWA) nutzen, lesen Sie unsere Anleitung zur [Verwendung von E-Mail-Accounts über Outlook Web App (OWA)](email_owa1.).

![E-Mail](mxplan-creation-new-step5.png){.thumbnail}
...
![E-Mail](mxplan-new-reset.png){.thumbnail}

### Historische MX Plan Version <a name="mxplanlegacy"></a>

#### Zugang zur Verwaltung des E-Mail-Dienstes

Bei der historischen MX Plan Version sollte die Anzeige der folgenden Abbildung entsprechen. Ist das nicht der Fall, überprüfen Sie [mithilfe der oben stehenden Informationen](email_creation_#instructions.), dass Sie den richtigen Schritten folgen.

![E-Mail](mxplan-creation-legacy-step1.png){.thumbnail}
...
![E-Mail](mxplan-creation-legacy-step2.png){.thumbnail}
...
![E-Mail](mxplan-creation-legacy-step3.png){.thumbnail}
...
Daraufhin wird Ihr Postfach angezeigt. Weitere Informationen finden Sie in unserer Anleitung zur [Verwendung Ihres E-Mail-Accounts mit RoundCube Webmail](email_roundcube1.).

![E-Mail](mxplan-creation-legacy-step4.png){.thumbnail}
...
![E-Mail](mxplan-legacy-reset.png){.thumbnail}
...
> **Windows**
>>
>> - [Mail auf Windows 10](how_to_configure_windows_101.)
>> - [Outlook](how_to_configure_outlook_20161.)
>> - [Thunderbird](how_to_configure_thunderbird_windows1.)
>>
> **Apple**
>>
>> - [macOS Mail](how_to_configure_mail_macos1.)
>> - [Mail für iPhone oder iPad](how_to_configure_ios1.)
...
> **Andere**
>>
>> - [Interface Gmail](how_to_configure_gmail1.)
>>
