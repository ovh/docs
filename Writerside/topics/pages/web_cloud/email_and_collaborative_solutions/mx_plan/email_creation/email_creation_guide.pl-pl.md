...
> - Zanim przejdziesz do niniejszego przewodnika, należy aktywować Twój pakiet MX Plan zawarty w [ofercie hostingu](https://www.ovhcloud.com/pl/web-hosting/){.external}. W tym celu zapoznaj się z naszym przewodnikiem "[Aktywuj konta e-mail zawarte w Twoim hostingu](activate-email-hosting1.)".

## W praktyce <a name="instructions"></a>

W zależności od daty aktywacji usługi lub jeśli [usługa została niedawno przeniesiona](manual_email_migration1.){.external}, możliwe, że dysponujesz jej starszą lub nową wersją. Zanim przejdziesz dalej, zidentyfikuj tą opcję.
...
|---|---|
|![email](mxplan-creation-legacy-step1.png){.thumbnail}<br> Znajdź nazwę oferty w polu „Abonament”.|![email](mxplan-creation-new-step1.png){.thumbnail}<br>Znajdź `Oznaczenie serwera` w polu „Informacje ogólne”|
|Przejdź do [Starsza wersja usługi MX Plan](email_creation_#mxplanlegacy.)|Przejdź do [Nowej wersji usługi MX Plan](#newmxplan.)|

### Nowa wersja usługi MX Plan <a name="newmxplan"></a>

#### Dostęp do interfejsu zarządzania usługą e-mail

Posiadasz nową wersję usługi MX Plan. Strona usługi e-mail w Panelu klienta powinna wyglądać jak poniżej. Jeśli tak nie jest, upewnij się, czy wybrałeś właściwą ścieżkę, [sprawdzając powyższe informacje](email_creation_#instructions.).
...
> [!warning]
>
> Przed usunięciem kont e-mail upewnij się, że nie są one używane. Może zaistnieć konieczność zabezpieczenia tych kont. W razie potrzeby zapoznaj się z przewodnikiem [Ręczna migracja Twojego konta e-mail](manual_email_migration1.), który opisze, jak wyeksportować dane z konta z Panelu klienta lub programu pocztowego.
...
Posiadasz starszą wersję usługi MX Plan. Strona usługi e-mail w Panelu klienta powinna wyglądać jak poniżej. Jeśli tak nie jest, upewnij się, czy wybrałeś właściwą ścieżkę, [sprawdzając powyższe informacje](email_creation_#instructions.). 
...
Wyświetli się wówczas Twoja skrzynka odbiorcza. Aby dowiedzieć się, jak korzystać z konta e-mail za pośrednictwem Webmail OWA, zapoznaj się z naszym przewodnikiem [Korzystanie z konta e-mail w interfejsie Webmail RoundCube](email_roundcube1.){.external}.
...
> **Windows**
>>
>> - [Poczta na systemie Windows 10](how_to_configure_windows_101.)
>> - [Outlook](how_to_configure_outlook_20161.)
>> - [Thunderbird](how_to_configure_thunderbird_windows1.)
>>
> **Apple**
>>
>> - [Mail macOS](how_to_configure_mail_macos1.)
>> - [E-mail na iPhone lub iPad](how_to_configure_ios1.)
...
> **Inne**
>>
>> - [Interfejs Gmail](how_to_configure_gmail1.)
>>
