...
> - Si tiene un [alojamiento web](https://www.ovhcloud.com/es-es/web-hosting/){.external}, deberá activar su solución MX Plan incluida antes de continuar la lectura de esta guía. Para ello, consulte nuestra guía [Activar las direcciones de correo incluidas en su alojamiento web](activate-email-hosting1.).
...
|---|---|
|![Correo electrónico](mxplan-creation-legacy-step1.png){.thumbnail}<br> El nombre del producto aparece en el recuadro Suscripción, en el epígrafe Producto.|![Correo electrónico](mxplan-creation-new-step1.png){.thumbnail}<br>El nombre del producto aparece en el recuadro `Resumen`, en el epígrafe `Referencia del servidor`.|
|Siga leyendo esta guía en el apartado [Versión histórica de la solución MX Plan](email_creation_#mxplanlegacy.).|Siga leyendo esta guía en el apartado [Nueva versión de la solución MX Plan](#newmxplan.).|

### Nueva versión de la solución MX Plan <a name="newmxplan"></a>

#### Acceder a la gestión del servicio de correo

Si dispone de la nueva versión de la solución MX Plan, la pestaña Información general del servicio debería tener la distribución que se muestra en la imagen de abajo. De lo contrario, [vuelva al apartado anterior](email_creation_#instructions.) y asegúrese de que esta es su versión de la solución.  

![Correo electrónico](mxplan-creation-new-step1.png){.thumbnail}
...
![Correo electrónico](mxplan-creation-new-step2.png){.thumbnail}
...
![Correo electrónico](mxplan-creation-new-step3.png){.thumbnail}
...
La primera vez que se conecte al webmail, deberá seleccionar el idioma de la interfaz y la zona horaria en la que se encuentra. A continuación se abrirá la bandeja de entrada. Para más información, consulte nuestra guía "[Utilizar una dirección de correo desde Outlook Web App (OWA)"](email_owa1.){.external}.

![Correo electrónico](mxplan-creation-new-step5.png){.thumbnail}
...
![Correo electrónico](mxplan-new-reset.png){.thumbnail}

### Versión histórica de la solución MX Plan <a name="mxplanlegacy"></a>

#### Acceder a la gestión del servicio de correo

Si dispone de la versión histórica de la solución MX Plan, la pestaña Información general del servicio debería tener la distribución que se muestra en la imagen de abajo. De lo contrario, [vuelva al apartado anterior](email_creation_#instructions.) y asegúrese de que esta es su versión de la solución. 

![Correo electrónico](mxplan-creation-legacy-step1.png){.thumbnail}
...
![Correo electrónico](mxplan-creation-legacy-step2.png){.thumbnail}
...
![Correo electrónico](mxplan-creation-legacy-step3.png){.thumbnail}
...
A continuación, podrá consultar su bandeja de entrada. Para más información, consulte nuestra [Guía de uso de Roundcube](email_roundcube1.){.external}.

![Correo electrónico](mxplan-creation-legacy-step4.png){.thumbnail}
...
![Correo electrónico](mxplan-legacy-reset.png){.thumbnail}
...
> **Windows**
>>
>> - [Correo en Windows 10](how_to_configure_windows_101.)
>> - [Outlook](how_to_configure_outlook_20161.)
>> - [Thunderbird](how_to_configure_thunderbird_windows1.)
>>
> **Apple**
>>
>> - [Mail de macOS](how_to_configure_mail_macos1.)
>> - [Correo electrónico para iPhone o iPad](how_to_configure_ios1.)
...
> **Otros**
>>
>> - [Interfaz Gmail](how_to_configure_gmail1.)
>>
