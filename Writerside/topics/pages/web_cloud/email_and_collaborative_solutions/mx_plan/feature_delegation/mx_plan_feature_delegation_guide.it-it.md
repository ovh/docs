...
|---|---|
|![email](feature_delegation_images_mxplan-starter-legacy-step1.png){.thumbnail}<br> Il servizio è indicato nel riquadro “Abbonamento”|![email](feature_delegation_images_mxplan-starter-new-step1.png){.thumbnail}<br>Nel riquadro "Riepilogo", individua il "Referenza server"|
|Prosegui nella lettura di questa guida nella sezione "[Procedura](feature_delegation_#oldmxplan.)"|Consulta la nostra guida "[Consulta il tuo account Exchange dall'interfaccia OWA](email_owa#modificare-la-password.)"|

## Procedura <a name="oldmxplan"></a>

> [!primary]
>
>La creazione di una delega su un account email lo mostra nello [Spazio Cliente](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it) interessato. Tuttavia, in questa situazione saranno possibili solo le modifiche indicate nella sezione [Obiettivo](feature_delegation_#objective.) della guida.
>
...
![Delega](mxplan-delegation-01.png){.thumbnail}
...
![Delega](mxplan-delegation-02.png){.thumbnail}
...
![Delega](mxplan-delegation-03.png){.thumbnail}
