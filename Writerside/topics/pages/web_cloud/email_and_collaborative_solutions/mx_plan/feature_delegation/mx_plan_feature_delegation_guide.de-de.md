...
|---|---|
|![E-Mail](feature_delegation_images_mxplan-starter-legacy-step1.png){.thumbnail}<br> Die Angebotsbezeichnung steht in der Box "Abo".|![E-Mail](feature_delegation_images_mxplan-starter-new-step1.png){.thumbnail}<br>Die `Server-Referenz` befindet sich in der Box "Zusammenfassung".|
|Lesen Sie weiter in dieser [Anleitung](feature_delegation_#oldmxplan.).|Fahren Sie fort mit unserer Anleitung zur [Verwendung der Outlook Web App](email_owa#passwort-andern.).|

## In der praktischen Anwendung <a name="oldmxplan"></a>

> [!primary]
>
>Die Einrichtung einer Delegation für einen E-Mail-Account führt dazu, dass er im betreffenden [Kundencenter](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de) angezeigt wird. Für den delegierten Account sind jedoch nur die im Abschnitt [Ziel](feature_delegation_#objective.) dieser Anleitung aufgeführten Änderungen möglich.
>
