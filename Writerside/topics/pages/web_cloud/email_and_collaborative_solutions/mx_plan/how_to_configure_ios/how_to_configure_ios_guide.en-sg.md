...
OVHcloud also offers a web application you can use to access your email account from your browser, accessible via <https://www.ovh.com/sg/mail/>. You can log in using your email credentials.
