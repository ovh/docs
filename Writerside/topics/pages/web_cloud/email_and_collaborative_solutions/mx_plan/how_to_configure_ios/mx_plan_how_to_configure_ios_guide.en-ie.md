...
| | |
|---|---|
|![Exchange](images_configuration-mail-ios-step01.gif){.thumbnail}|1. In `Settings`, go to `Mail`. <br><br> 2. Tap `Accounts`.<br><br> 3. Tap `Add Account`.<br><br> 4. Choose `Other` at the bottom.|
|5. Tap `Add Mail Account`.<br><br>6. Enter your **name**, **email** address, **password** and account **description**.<br><br>7. Press `Next`.|![Exchange](configuration-mail-ios-step02.png){.thumbnail}|
|![Exchange](configuration-mail-ios-step03.png){.thumbnail}|8. Select `IMAP` (recommended) or `POP`.<br><br>In the `INCOMING MAIL SERVER` and `OUTGOING MAIL SERVER` sections, despite the word "optional", enter: <br>- the hostname **ssl0.ovh.net** <br>- your **full email address** as username <br>- your email password|
...
[Configuring an Exchange account on iPhone and iPad](how_to_configure_ios2.)

[Configuring an Email Pro account on iPhone and iPad](how_to_configure_ios3.)
