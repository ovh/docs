...
- an MX Plan email address included in [OVHcloud Web Hosting plans](https://www.ovhcloud.com/en-ca/web-hosting/){.external}
...
OVHcloud also offers a web application you can use to access your email account from your browser, accessible via <https://www.ovh.com/ca/en/mail/>. You can log in using your email credentials.
