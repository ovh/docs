...
> [!primary]
>
> Se utilizzi Outlook 2016 per Windows, consulta la nostra guida per [Configurare un indirizzo email su Outlook 2016 per Windows](how_to_configure_outlook_20161.){.external}.
>
...
[Configurare un account Email Pro su Outlook 2016 per Mac](how_to_configure_outlook_2016_mac3.){.external}.

[Configurare un account Exchange su Outlook 2016 per Mac](how_to_configure_outlook_2016_mac2.){.external}.
