...
>> | | |
>> |---|---|
>> |![mxplan](mxplan-android-first.png){.thumbnail}|Selecione `Adicionar um endereço de e-mail`{.action}|
>>
> **Configuração existente**
>>
>> | | |
>> |---|---|
>> |![mxplan](mxplan-android-existing.png){.thumbnail}|1. Vá para o menu localizado na parte superior esquerda da tela<br><br>2.Selecione `Definições`{.action}<br><br>3.Selecione `Adicionar uma conta`{.action}|
>>
...
>> | | |
>> |---|---|
>> |![mxplan](mxplan-android-01.png){.thumbnail}|A partir do menu Tipo de conta de correio eletrónico, selecione `Outro`{.action}.|
>>
> **Etapa 2**
>> | | |
>> |---|---|
>> |![mxplan](mxplan-android-02.png){.thumbnail}|Introduza o endereço de correio eletrónico.|
>>
> **Etapa 3**
>> | | |
>> |---|---|
>> |![mxplan](mxplan-android-03.png){.thumbnail}|Selecione o protocolo de receção de correio eletrónico. É aconselhável selecionar `Pessoal (IMAP)`{.action}<br><br>Encontre [mais detalhes sobre os protocolos POP e IMAP](how_to_configure_android_#popimap.) no final deste guia para compreender as suas diferenças.|
>>
> **Etapa 4**
>> | | |
>> |---|---|
>> |![mxplan](mxplan-android-04.png){.thumbnail}|Introduza a palavra-passe do seu endereço de e-mail. |
>>
> **Etapa 5**
>> | | |
>> |---|---|
>> |![mxplan](mxplan-android-05.png){.thumbnail}|Preencha as « **Definições do servidor de entrada**»<br><br>- **Nome de utilizador**: O seu endereço de e-mail completo<br>- **Palavra-passe**: A password do seu endereço de e-mail<br>- **Servidor**: introduza **ssl0.ovh.net** |
>>
> **Etapa 6**
>> | | |
>> |---|---|
>> |![mxplan](mxplan-android-06.png){.thumbnail}|Preencha as « **Definições do servidor de envio**»<br><br>- **Nome de utilizador**: O seu endereço de e-mail completo<br>- **Palavra-passe**: A password do seu endereço de e-mail<br>- **Servidor SMTP**: introduza **ssl0.ovh.net** |
>>
> **Etapa 7**
>> | | |
>> |---|---|
>> |![mxplan](mxplan-android-07.png){.thumbnail}|Escolha a frequência da sincronização dos seus e-mails de acordo com as suas preferências.|
>>
> **Etapa 8**
>> | | |
>> |---|---|
>> |![mxplan](mxplan-android-08.png){.thumbnail}|Defina o nome para apresentar o seu endereço de e-mail na aplicação Gmail e prima `Seguinte`{.action}|
>>
...
Para a receção dos e-mails, ao escolher o tipo de conta, recomendamos uma utilização em **IMAP**. No entanto, pode selecionar **POP**. Para compreender o seu funcionamento respetivo, consulte a nossa secção [« POP ou IMAP, qual é a diferença ? »](how_to_configure_android_#popimap.)
...
[Configurar a sua conta E-mail Pro no Android através da aplicação Gmail](how_to_configure_android3.).

[Configurar a sua conta Exchange no Android através da aplicação Gmail](how_to_configure_android2.).
