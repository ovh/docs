...
>> | | |
>> |---|---|
>> |![MX Plan](mxplan-android-first.png){.thumbnail}|Seleziona `Aggiungi un indirizzo email`{.action}|
>>
> **Configurazione esistente**
>>
>> | | |
>> |---|---|
>> |![MX Plan](mxplan-android-existing.png){.thumbnail}|1. Passare al menu nell'angolo superiore sinistro dello schermo<br><br>2.Selezionare `Impostazioni`{.action}<br><br>3.Selezionare `Aggiungi account`{.action}|
>>
...
>> | | |
>> |---|---|
>> |![MX Plan](mxplan-android-01.png){.thumbnail}|Selezionare `Altro`{.action} dal menu dei tipi di account di posta elettronica.|
>>
> **Step 2**
>> | | |
>> |---|---|
>> |![MX Plan](mxplan-android-02.png){.thumbnail}|Inserisci il tuo indirizzo e-mail.|
>>
> **Step 3**
>> | | |
>> |---|---|
>> |![MX Plan](mxplan-android-03.png){.thumbnail}|Seleziona il protocollo di ricezione delle email. Ti consigliamo di selezionare `Personale (IMAP)`{.action}<br><br>Per [maggiori dettagli sui protocolli POP e IMAP](how_to_configure_android_#popimap.), consulta la fine di questa guida per comprenderne le differenze.|
>>
> **Step 4**
>> | | |
>> |---|---|
>> |![MX Plan](mxplan-android-04.png){.thumbnail}|Inserisci la password del tuo indirizzo email. |
>>
> **Step 5**
>> | | |
>> |---|---|
>> |![MX Plan](mxplan-android-05.png){.thumbnail}|Completa le "**Impostazioni server in entrata**"<br><br>- **Nome utente**: Il tuo indirizzo email completo<br>- **Password**: La password del tuo indirizzo email<br>- **Server**: inserisci **ssl0.ovh.net** |
>>
> **Step 6**
>> | | |
>> |---|---|
>> |![MX Plan](mxplan-android-06.png){.thumbnail}|Completa le "**Impostazioni server in uscita**"<br><br>- **Nome utente**: Il tuo indirizzo email completo<br>- **Password**: La password del tuo indirizzo email<br>- **Server SMTP**: inserisci **ssl0.ovh.net** |
>>
> **Step 7**
>> | | |
>> |---|---|
>> |![MX Plan](mxplan-android-07.png){.thumbnail}|Scegli la frequenza di sincronizzazione delle tue email in base alle tue preferenze.|
>>
> **Step 8**
>> | | |
>> |---|---|
>> |![MX Plan](mxplan-android-08.png){.thumbnail}|Determina il nome visualizzato del tuo indirizzo email nell’applicazione Gmail e clicca su `Avanti`{.action}|
>>
...
Per la ricezione delle email, durante la scelta del tipo di account, ti consigliamo di utilizzare **IMAP**. Tuttavia, è possibile selezionare **POP**. Per maggiori informazioni sul loro funzionamento, consulta la nostra sezione ["POP o IMAP, qual è la differenza?"](how_to_configure_android_#popimap.)
...
[Configurare un account E-mail Pro su Android tramite l’applicazione Gmail](how_to_configure_android3.).

[Configurare un account Exchange su Android tramite l’applicazione Gmail](how_to_configure_android2.).
