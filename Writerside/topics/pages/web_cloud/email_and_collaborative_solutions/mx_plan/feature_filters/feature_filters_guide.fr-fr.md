...
|---|---|
|![email](feature_filters_images_mxplan-starter-legacy-step1.png){.thumbnail}<br> Repérez l'offre dans le cadre « Abonnement »|![email](feature_filters_images_mxplan-starter-new-step1.png){.thumbnail}<br>Repérez la « Référence serveur » dans le cadre « Résumé »|
|Poursuivez la lecture de ce guide à partir de la section « [En pratique](feature_filters_#oldmxplan.) ».|Poursuivez vers notre guide « [Règles de boîte de réception depuis l’interface OWA](creating-inbox-rules-in-owa-mx-plan1.) ».|
...
- **spf :** Indiquez une valeur du [champ SPF](dns_zone_spf1.) à prendre en compte, par exemple : « ... n'a pas de champ SPF ... ».
...
> Il permet de prévenir les potentielles usurpations d'identité venant d'adresses e-mail utilisant votre nom de domaine (spoofing). Pour plus d'infos sur le SPF, reportez-vous au guide « [Configurer un enregistrement SPF sur son nom de domaine](dns_zone_spf1.) ».
...
[Règles de boîte de réception depuis l’interface OWA](creating-inbox-rules-in-owa-mx-plan1.)
