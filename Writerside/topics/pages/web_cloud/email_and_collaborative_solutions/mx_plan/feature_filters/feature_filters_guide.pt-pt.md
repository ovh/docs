...
|---|---|
|![email](feature_filters_images_mxplan-starter-legacy-step1.png){.thumbnail}<br> Consulte o tipo de oferta na secção “Subscrição”.|![email](feature_filters_images_mxplan-starter-new-step1.png){.thumbnail}<br>Consulte a Referência do servidor na secção "Resumo".|
|Consulte este manual a partir da secção "[Na prática](feature_filters_#oldmxplan.)".|Consulte o nosso manual "[Regras da caixa de entrada a partir da interface OWA](creating-inbox-rules-in-owa-mx-plan1.)".|
...
- **spf:** Indique um valor do [registo SPF](dns_zone_spf1.) a ter em conta, por exemplo: ".. sem registo SPF ... "
...
> Ajuda a impedir o furto de identidade dos endereços de e-mail que utilizam o domínio (spoofing). Para mais informações sobre o SPF, consulte o guia "[Configurar um registo SPF no domínio](dns_zone_spf1.)".
...
[Regras da caixa de entrada a partir da interface OWA](creating-inbox-rules-in-owa-mx-plan1.)
