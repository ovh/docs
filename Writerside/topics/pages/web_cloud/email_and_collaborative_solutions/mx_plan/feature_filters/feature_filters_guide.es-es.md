...
|---|---|
|![Correo electrónico](feature_filters_images_mxplan-starter-legacy-step1.png){.thumbnail}<br> El nombre del producto aparece en el recuadro Suscripción, en el epígrafe Producto.|![Correo electrónico](feature_filters_images_mxplan-starter-new-step1.png){.thumbnail}<br>El nombre del producto aparece en el recuadro Resumen, en el epígrafe Referencia del servidor.|
|Continúe leyendo esta guía en el apartado "[En la práctica](feature_filters_#oldmxplan.)".|Para más información, consulte nuestra guía Reglas de la bandeja de entrada desde la [interfaz OWA](creating-inbox-rules-in-owa-mx-plan1.).|
...
![correo electrónico](img_3241.jpg){.thumbnail}
...
- **spf:** Indique el valor del [registro SPF](dns_zone_spf1.) que quiera tener en cuenta, por ejemplo: "... no tiene registro SPF ... ".
...
> Permite evitar posibles usurpaciones de identidad procedentes de direcciones de correo que utilizan su nombre de dominio (spoofing). Para más información sobre el SPF, consulte la guía «[Configurar un registro SPF en un dominio](dns_zone_spf1.) ».
...
![correo electrónico](img_3242.jpg){.thumbnail}

## Más información

[Primeros pasos con la solución MX Plan](email_generalities1.)

[Reglas de la bandeja de entrada desde la interfaz OWA](creating-inbox-rules-in-owa-mx-plan1.)
