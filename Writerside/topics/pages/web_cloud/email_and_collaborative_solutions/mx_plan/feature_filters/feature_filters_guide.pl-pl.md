...
|---|---|
|![email](feature_filters_images_mxplan-starter-legacy-step1.png){.thumbnail}<br> Znajdź nazwę oferty w polu „Abonament”.|![email](feature_filters_images_mxplan-starter-new-step1.png){.thumbnail}<br>Znajdź Oznaczenie serwera w polu "Podsumowanie"|
|Przejdź do sekcji "[W praktyce](feature_filters_#oldmxplan.)" niniejszego przewodnika.|Przejdź do naszego przewodnika "[Reguły skrzynki odbiorczej w interfejsie OWA](creating-inbox-rules-in-owa-mx-plan1.)".|
...
- **spf:** Wskaż wartość [pola SPF](dns_zone_spf1.), które należy uwzględnić, na przykład: "... nie ma pola SPF ... ".
...
> Pomaga zapobiegać przypadkom podszywania się pod adresy e-mail używające Twojej domeny (spoofing). Więcej informacji na temat SPF znajdziesz w przewodniku "[Konfiguracja rekordu SPF w jego domenie](dns_zone_spf1.)".
...
[Reguły skrzynki odbiorczej w interfejsie OWA](creating-inbox-rules-in-owa-mx-plan1.)
