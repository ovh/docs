...
> [!primary]
>
> Vous utilisez Outlook 2016 pour Mac ? Consultez notre documentation : [Configurer son adresse e-mail sur Outlook 2016 pour Mac](how_to_configure_outlook_2016_mac1.){.external}.
>
...
>
> Avant de poursuivre, consultez la section "[POP ou IMAP, quelle est la différence ?](how_to_configure_outlook_2016_#popimap.)" de ce guide.
>
...
>>
>> ![Outlook](config-outlook-mxplan05-ca.png){.thumbnail}
>>
> **Etape 4 - POP**
...
>>
>> ![Outlook](config-outlook-mxplan05-pop-ca.png){.thumbnail}
...
Si vous devez effectuer une manipulation qui risquerait d'entrainer la perte des données de votre compte e-mail, nous vous conseillons d'effectuer une sauvegarde préalable du compte e-mail concerné. Pour ce faire, consulter le paragraphe "**Exporter depuis Windows**" sur notre guide [Migrer manuellement votre adresse e-mail](manual_email_migration#exporter-depuis-windows.).
...
Pour la réception des e-mails, lors du choix du type de compte, nous vous conseillons une utilisation en **IMAP**. Vous pouvez cependant sélectionner **POP**. Pour comprendre leur fonctionnement respectif, consultez la section "[POP ou IMAP, quelle est la différence ?](how_to_configure_outlook_2016_#popimap.)" ci-dessous.
...
![mxplan](mxplan-popimap-01.png){.thumbnail}
...
![mxplan](mxplan-popimap-02.png){.thumbnail}
...
[Configurer son compte E-mail Pro sur Outlook pour Windows](how_to_configure_outlook_20163.){.external}

[Configurer son compte Exchange sur Outlook pour Windows](how_to_configure_outlook_20162.){.external}
