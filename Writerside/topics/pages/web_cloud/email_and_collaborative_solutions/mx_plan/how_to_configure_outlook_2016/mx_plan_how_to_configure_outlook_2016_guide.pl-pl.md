...
> [!primary]
>
> Używasz programu Outlook 2016 na urządzeniu Mac ? Zapoznaj się z naszą dokumentacją: [Konfiguracja konta e-mail w programie Outlook 2016 na urządzeniu Mac](how_to_configure_outlook_2016_mac1.){.external}.
>
...
>
> Zanim przejdziesz dalej, zapoznaj się z sekcją "[POP lub IMAP, jaka jest różnica?](how_to_configure_outlook_2016_#popimap.)" w tym przewodniku.
>
...
Do odbierania wiadomości e-mail, wybierając rodzaj konta, zalecamy użycie protokołu **IMAP**. Możesz również wybrać **POP**. Aby dowiedzieć się, jak to działa, zapoznaj się z sekcją "[POP lub IMAP, jaka jest różnica?](how_to_configure_outlook_2016_#popimap.)" poniżej.
...
[Konfiguracja konta Exchange w programie Outlook 2016 na urządzeniu z systemem Windows](how_to_configure_outlook_20162.){.external}
