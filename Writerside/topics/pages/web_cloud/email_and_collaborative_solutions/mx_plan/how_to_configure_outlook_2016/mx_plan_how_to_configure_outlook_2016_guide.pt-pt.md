...
> [!primary]
>
> Se utilizar o Outlook para Mac, consulte o nosso manual [Configurar um endereço de e-mail no Outlook para Mac](how_to_configure_outlook_2016_mac1.){.external}.
>
...
>
> Antes de prosseguir, consulte a secção « [POP ou IMAP. Qual é a diferença?](how_to_configure_outlook_2016_#popimap.) » deste guia.
>
...
Para a receção dos e-mails, ao escolher o tipo de conta, recomendamos uma utilização em **IMAP**. No entanto, pode selecionar **POP**. Para compreender o funcionamento respetivo, consulte a secção « [POP ou IMAP, qual é a diferença?](how_to_configure_outlook_2016_#popimap.) ».
...
[Configurar uma conta Email Pro no Outlook 2016 para Windows](how_to_configure_outlook_20163.){.external}

[Configurar uma conta Exchange no Outlook 2016 para Windows](how_to_configure_outlook_20162.){.external}
