...
Per seguire la procedura, puoi consultare le nostre guide disponibili [qui](web-cloud-email-collaborative-solutions-mx-plan1.).
...
**Consigli e suggerimenti**: Se configuri il tuo account email su un client di posta, ti consigliamo di configurarlo con il protocollo IMAP. In questo modo, le email rimarranno salvate sul server e potrai consultarle ovunque dalla [Webmail](https://www.ovh.it/mail/){.external}. Per conoscere la procedura, consulta [la nostra documentazione](email_generalities1.).
...
Se hai attivato [una delle nostre soluzioni email OVHcloud](https://www.ovhcloud.com/it/emails/) e uno dei tuoi account è pieno, consulta la nostra guida "[Gestire lo spazio di storage di un account email](email_manage_quota1.)". Questa guida ti mostra come ottimizzare lo spazio disponibile o se è necessario cambiare il tuo servizio di posta per aumentare lo spazio di storage.
...
- [Migrare gli indirizzi email da una piattaforma di posta elettronica OVHcloud a un’altra](migration_control_panel1.)
- [Migrare manualmente l’indirizzo email](manual_email_migration1.)
- [Migrare account email tramite OVH Mail Migrator](migration_omm1.)
- [Migrare un account Gmail verso un account email OVHcloud tramite OVH Mail Migrator](security_gmail1.)
