...
Si no ve esta columna, se pueden crear filtros de correo basura configurando reglas de la bandeja de entrada en el [webmail](https://www.ovh.com/world/es/mail/){.external}. Consulte [esta guía](creating-inbox-rules-in-owa-mx-plan1.) para obtener instrucciones detalladas.
...
- [Migrar una dirección de correo MX Plan a una cuenta Email Pro o Exchange](migration_control_panel1.)
- [Migrar las direcciones de correo electrónico de una plataforma de correo de OVHcloud a otra](migration_control_panel1.)
- [Migrar manualmente una dirección de correo electrónico](manual_email_migration1.)
- [Migrar cuentas de correo electrónico mediante OVH Mail Migrator](migration_omm1.)
- [Migrar una cuenta de Gmail a una cuenta de correo electrónico de OVHcloud mediante OVH Mail Migrator](security_gmail1.)
