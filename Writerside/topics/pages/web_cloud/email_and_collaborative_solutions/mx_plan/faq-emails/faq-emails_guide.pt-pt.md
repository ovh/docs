...
Disponibilizamos guias que o ajudarão nesse processo. Aceda a eles [aqui](web-cloud-email-collaborative-solutions-mx-plan1.).
...
Se não visualiza a coluna `Filtro`{.action}, a criação de filtros deverá ser feita através de regras de gestão da caixa de entrada no [webmail](https://www.ovh.pt/mail/){.external}. Para mais informações, consulte este guia: [Criar regras inbox no OWA](creating-inbox-rules-in-owa-mx-plan1.).
...
- [Migrar um endereço de e-mail MX Plan para uma conta E-mail Pro ou Exchange](migrating_control_panel.)
- [Migrar os seus endereços de e-mail de uma plataforma de e-mail OVHcloud para outra](migrating_control_panel.)
- [Migrar manualmente o seu endereço de e-mail](manual_email_migration2.)
- [Migrar contas de e-mail através do OVH Mail Migrator](migration_omm2.)
- [Migrar uma conta Gmail para uma conta de e-mail OVHcloud através do OVH Mail Migrator](security_gmail2.)
