...
If you don't see this column, spam filters can only be created by setting up inbox rules on your email account via [webmail](https://www.ovh.co.uk/mail/). Please refer to [this guide](creating-inbox-rules-in-owa-mx-plan1.) for detailed instructions.
