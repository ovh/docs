...
If you don't see this column, spam filters can only be created by setting up inbox rules on your email account via [webmail](https://www.ovh.com.au/mail/). Please refer to [this guide](creating-inbox-rules-in-owa-mx-plan1.) for detailed instructions.
