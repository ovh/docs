...
If you don't see this column, spam filters can only be created by setting up inbox rules on your email account via [webmail](creating-inbox-rules-in-owa-mx-plan1.) for detailed instructions.
