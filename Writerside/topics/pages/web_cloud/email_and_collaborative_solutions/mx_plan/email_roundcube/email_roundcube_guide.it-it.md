...
- Disporre delle informazioni di connessione all'indirizzo email MX Plan che vuoi consultare Per maggiori informazioni, consulta la nostra guida Iniziare a [utilizzare la soluzione MX Plan](email_generalities1.).
...
- [Modificare la password del tuo indirizzo email](email_roundcube_#password.)
...
> [!warning]
> 
> Se il server è reindirizzato a un'interfaccia **O**utlook **W**eb **A**pp (OWA), significa che sei sull'ultima versione della soluzione MX Plan. Per maggiori informazioni sulla soluzione MX Plan, consulta la pagina [Iniziare a utilizzare la soluzione MX Plan](email_generalities1.).
>
> Per familiarizzare con l'interfaccia **OWA**, consulta la nostra guida [Consultare il suo account email dall'interfaccia OWA](email_owa1.).
...
[Modifica la password di un indirizzo email MX Plan](email_change_password1.)

[Creare una risposta automatica per il proprio indirizzo email](feature_auto_responses1.)
