...
- Ter acesso às informações de acesso ao endereço de e-mail MX Plan que pretende consultar. Para mais informações, consulte o nosso guia [Primeiros passos com a oferta MX Plan](email_generalities1.).
...
- [Alterar a palavra-passe do seu endereço de e-mail](email_roundcube_#password.)
...
![alojamento](webmail_login.png){.thumbnail}

Será então redirecionado para a interface Roundcube.

![alojamento](roundcube01.png){.thumbnail}
...
> [!warning]
> 
> Se for redirecionado para uma interface **O**utlook **W**eb **A**pp (OWA), isto significa que está na última versão da oferta MX Plan. Para mais informações sobre a sua oferta MX Plan, consulte a nossa página [Primeiros passos com a oferta MX Plan](email_generalities1.).
>
> Para se familiarizar com a interface **OWA**, consulte o nosso guia [Consultar a sua conta de e-mail a partir da interface OWA](email_owa1.).
...
![alojamento](roundcube02.png){.thumbnail}
...
![alojamento](roundcube03.png){.thumbnail}
...
![alojamento](roundcube04.png){.thumbnail}
...
![alojamento](roundcube05.png){.thumbnail}
...
![alojamento](roundcube06.png){.thumbnail}
...
![alojamento](roundcube07.png){.thumbnail}
...
![alojamento](roundcube08.png){.thumbnail}
...
![alojamento](roundcube09.png){.thumbnail}
...
![alojamento](roundcube10.png){.thumbnail}
...
![alojamento](roundcube11.png){.thumbnail}
...
![alojamento](roundcube-import-contact.png){.thumbnail}
...
![alojamento](roundcube-export-contact.png){.thumbnail}
...
![alojamento](roundcube12.png){.thumbnail}
...
![alojamento](roundcube13.png){.thumbnail}
...
[Criar uma resposta automática para o endereço de e-mail](feature_auto_responses1.)
