...
![E-Mail Pro](configuration-mail-windows-step1.png){.thumbnail}
...
![E-Mail Pro](configuration-mail-windows-step2.png){.thumbnail}
...
[Konfiguration Ihrer E-Mail-Adresse aus dem MX Plan Angebot oder einem Webhosting Angebot auf der Windows 10 Mail App](how_to_configure_windows_101.){.external}

[Konfiguration von Exchange auf der Windows 10 Mail App](how_to_configure_windows_102.){.external}
