...
![Email Pro](configuration-mail-windows-step1.png){.thumbnail}
...
![Email Pro](configuration-mail-windows-step2.png){.thumbnail}
...
[Configurar una cuenta de correo electrónico en la aplicación Correo de Windows 10](how_to_configure_windows_101.){.external}

[Configurar una cuenta Exchange en la aplicación Correo de Windows 10](how_to_configure_windows_102.){.external}
