...
[Configurare un account MX Plan sull’applicazione Posta per Windows 10](how_to_configure_windows_101.){.external}

[Configurare un account Exchange sull’applicazione Posta per Windows 10](how_to_configure_windows_102.){.external}
