...
> [!primary]
>
> Si utiliza Outlook 2016 para Windows, consulte nuestra guía [Configurar una cuenta Email Pro en Outlook 2016 para Windows](how_to_configure_outlook_20163.){.external}.
>
...
![Email Pro](configuration-outlook-2016-mac-step1.png){.thumbnail}
...
![Email Pro](configuration-outlook-2016-mac-step2.png){.thumbnail}
