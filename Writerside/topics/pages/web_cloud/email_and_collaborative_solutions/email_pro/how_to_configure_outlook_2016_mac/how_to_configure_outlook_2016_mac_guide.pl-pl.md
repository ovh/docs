...
> [!primary]
>
> Używasz programu Outlook 2016 na urządzeniu z systemem Windows ? Zapoznaj się z naszą dokumentacją: [Konfiguracja konta e-mail w programie Outlook 2016 na urządzeniu z systemem Windows](how_to_configure_outlook_20163.){.external}.
>
...
[Konfiguracja konta e-mail, zawartego w usłudze MX Plan lub usłudze hostingu, w programie Outlook 2016 na urządzeniu Mac](how_to_configure_outlook_2016_mac1.){.external}

[Konfiguracja konta Exchange w aplikacji Outlook 2016 na urządzeniu Mac](how_to_configure_outlook_2016_mac2.){.external}
