...
- **DKIM** : Mise en place d'une signature numérique chiffrée pour sécuriser les échanges e-mails. Consultez notre guide « [Configurer un enregistrement DKIM](dns_zone_dkim1.) » pour plus d'informations.
...
- **Configuration manuelle pour un nom de domaine non géré par OVHcloud** : cliquez sur la pastille rouge afin de découvrir les modifications à réaliser.
    - *Pour un enregistrement CNAME*, aidez-vous de notre guide « [Créer un champ CNAME à l’ajout d’un domaine associé](exchange_dns_cname1.) ».
    - *Pour un enregistrement MX*, aidez-vous de notre guide « [Ajouter un champ MX à la configuration de son nom de domaine](dns_zone_mx1.) ».
    - *Pour un enregistrement SRV*, complétez votre zone DNS à l'aide des informations données lorsque vous cliquez sur la pastille rouge. Vous pouvez vous aider du guide « [Éditer une zone DNS OVHcloud](dns_zone_edit1.) » pour ajouter cet enregistrement.
    - *Pour un enregistrement SPF*, complétez votre zone DNS à l'aide des informations données lorsque vous cliquez sur la pastille. Vous pouvez vous aider du guide « [Configurer un enregistrement SPF](dns_zone_spf1.) » pour ajouter cet enregistrement.
    *Pour un enregistrement DKIM*, complétez votre zone DNS à l'aide des informations données lorsque vous cliquez sur la pastille. Vous pouvez vous aider du guide « [Configurer un enregistrement DKIM](dns_zone_dkim1.) » pour ajouter cet enregistrement.
...
[Consulter son compte depuis l’interface OWA](email_owa1.)

[Règles de boîte de réception depuis l’interface OWA](creating-inbox-rules-in-owa-mx-plan1.)

[Ajouter un alias sur son compte e-mail](feature_redirections1.)

[Ajouter un pied de page pour vos comptes e-mail](feature_footers1.)

[Gérer la facturation de vos comptes E-mail Pro](manage_billing_emailpro1.)

[Gérer la politique de sécurité d’un service e-mail](security-policy1.)
