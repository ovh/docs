...
Per la sezione **Server di posta in entrata IMAP**:
 ...
 - **Nome host IMAP**: specifica il nome del tuo server Email Pro recuperato precedentemente durante lo [step 1](how_to_configure_outlook_android_#step1.): (esempi: *pro1.mail.ovh.net*, *pro2.mail.ovh.net*, ecc.)
...
Per la sezione **Server di posta in uscita SMTP**:
 ...
 - **Nome host SMTP**: specifica il nome del tuo server Email Pro recuperato precedentemente durante lo [step 1](how_to_configure_outlook_android_#step1.): (esempi: *pro1.mail.ovh.net*, *pro2.mail.ovh.net*, ecc.)
...
Per la sezione **Server di posta in entrata POP**:
 ...
 - **Nome host POP**: specifica il nome del tuo server Email Pro recuperato precedentemente durante lo [step 1](how_to_configure_outlook_android_#step1.): (esempi: *pro1.mail.ovh.net*, *pro2.mail.ovh.net*, ecc.)
