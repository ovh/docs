...
![Email Pro](configuration-email-pro-gmail-application-android-step1.png){.thumbnail}
...
![Email Pro](configuration-email-pro-gmail-application-android-step2.png){.thumbnail}
...
![Email Pro](configuration-email-pro-gmail-application-android-step3.png){.thumbnail}
...
[Configurar una cuenta de correo electrónico en Android utilizando la aplicación Gmail](how_to_configure_android1.){.external}

[Configurar una cuenta Exchange en Android utilizando la aplicación Gmail](how_to_configure_android2.){.external}
