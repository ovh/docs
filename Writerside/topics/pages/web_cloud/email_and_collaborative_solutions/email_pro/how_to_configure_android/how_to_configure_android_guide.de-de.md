...
![e-mail pro](configuration-email-pro-gmail-application-android-step1.png){.thumbnail}
...
![e-mail pro](configuration-email-pro-gmail-application-android-step2.png){.thumbnail}
...
![e-mail pro](configuration-email-pro-gmail-application-android-step3.png){.thumbnail}
...
[Konfiguration Ihrer E-Mail-Adresse aus dem MX Plan Angebot oder einem Webhosting Angebot in Android über die Gmail-App](how_to_configure_android1.)
