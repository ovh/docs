...
![Exchange](configuration-email-pro-gmail-application-android-step1.png){.thumbnail}
...
![Exchange](configuration-email-pro-gmail-application-android-step2.png){.thumbnail}
...
![Exchange](configuration-email-pro-gmail-application-android-step3.png){.thumbnail}
...
[Konfiguracja konta e-mail, zawartego w usłudze MX Plan lub usłudze hostingu, na urządzeniu z systemem Android przy użyciu aplikacji Gmail](how_to_configure_android1.){.external}

[Konfiguracja konta Exchange na urządzeniu z systemem Android przy użyciu aplikacji Gmail](how_to_configure_android2.){.external}
