...
[Configurare un indirizzo email su Android tramite l’applicazione Gmail](how_to_configure_android1.){.external}

[Configurare un account Exchange su Android tramite l’applicazione Gmail](how_to_configure_android2.){.external}
