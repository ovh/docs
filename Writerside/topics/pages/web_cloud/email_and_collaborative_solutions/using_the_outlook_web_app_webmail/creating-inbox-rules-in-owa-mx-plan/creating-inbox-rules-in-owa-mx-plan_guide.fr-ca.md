...
- une solution e-mail OVHcloud doit avoir été configurée au préalable (**MX Plan**, proposé parmi nos [offres d’hébergement web](https://www.ovhcloud.com/fr-ca/web-hosting/) ou [**Hosted Exchange**](https://www.ovhcloud.com/fr-ca/emails/hosted-exchange/)
...
![règles boîte de réception](exchange-rules-step1.png){.thumbnail}
...
![règles boîte de réception](exchange-rules-step2.png){.thumbnail}

### Étape 2 : Créer des règles

![règles boîte de réception](exchange-rules-step3.png){.thumbnail}
...
![règles boîte de réception](exchange-rules-step4.png){.thumbnail}
...
![règles boîte de réception](redirection_rulebis.gif){.thumbnail}
...
![règles boîte de réception](exchange-rules-step7.png){.thumbnail}
...
![règles boîte de réception](exchange-rules-step8.png){.thumbnail}
...
![règles boîte de réception](exchange-rules-step9_2.png){.thumbnail}
...
[Création de réponses automatiques depuis OWA](owa_automatic_replies1.)

[Partage de calendriers depuis OWA](owa_calendar_sharing1.)

[Utilisation de Outlook Web App avec un compte de messagerie](email_owa1.)
