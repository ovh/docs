...
- an OVHcloud email solution already set up (**MX Plan**, available as part of our [Web Hosting plans](https://www.ovhcloud.com/asia/web-hosting/).
...
Log in to your Exchange account via the [OVHcloud webmail](https://www.ovh.com/asia/mail/). Click on the gear symbol on the top right to unfold the "Options" menu and select `Options`{.action}.

![inboxrules](exchange-rules-step1.png){.thumbnail}
...
![inboxrules](exchange-rules-step2.png){.thumbnail}

### Step 2: Creating rules

![inboxrules](exchange-rules-step3.png){.thumbnail}
...
![inboxrules](exchange-rules-step4.png){.thumbnail}
...
![inboxrules](redirection_rulebis.gif){.thumbnail}
...
![inboxrules](exchange-rules-step7.png){.thumbnail}
...
![inboxrules](exchange-rules-step8.png){.thumbnail}
...
![inboxrules](exchange-rules-step9_2.png){.thumbnail}
