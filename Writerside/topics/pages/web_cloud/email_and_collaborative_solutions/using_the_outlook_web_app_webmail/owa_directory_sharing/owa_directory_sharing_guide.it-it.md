...
![sharefolder](exchange-folder-step1.png){.thumbnail}
...
![sharefolder](exchange-folder-step2aag.gif){.thumbnail}
...
![sharefolder](exchange-folder-step3.png){.thumbnail}
...
[ Guida all’utilizzo di Outlook Web App con un account Exchange](email_owa1.)

[Delegare i diritti su un account Exchange](feature_delegation1.)

[Condividere calendari in OWA](owa_calendar_sharing1.)
