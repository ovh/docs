...
![Ordner freigeben](exchange-folder-step1.png){.thumbnail}
...
![Ordner freigeben](exchange-folder-step2aag.gif){.thumbnail}
...
![Ordner freigeben](exchange-folder-step3.png){.thumbnail}
...
[Berechtigungen für einen Exchange Account übertragen](feature_delegation1.)
