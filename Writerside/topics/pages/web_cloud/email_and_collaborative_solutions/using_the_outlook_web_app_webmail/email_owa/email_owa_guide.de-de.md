...
> [!warning]
> 
> Wenn Sie zu einem **Roundcube** Interface weitergeleitet werden, bedeutet dies, dass Sie die Legacy-Version der MX Plan Lösung verwenden. Weitere Informationen zu Ihrem MX Plan finden Sie auf unserer Seite "[Erste Schritte mit MX Plan](email_generalities1.)".
>
> Um sich mit dem **Roundcube** Interface vertraut zu machen, lesen Sie unsere Anleitung: [Verwendung Ihres E-Mail-Accounts mit Roundcube Webmail](email_roundcube1.).
...
Ausführlichere Anweisungen zum Erstellen von Posteingangsregeln finden Sie in unserer Anleitung: [Posteingangsregeln in OWA erstellen](creating-inbox-rules-in-owa-mx-plan1.).
...
Ausführlichere Anweisungen hierzu finden Sie in unserer Anleitung: [Einrichten einer automatischen Antwort in OWA](owa_automatic_replies1.)
...
Anweisungen zum Erstellen automatisierter Signaturen mithilfe domainübergreifender Vorlagen finden Sie in unserer Anleitung: [Automatische Signaturen erstellen](feature_footers1.).
