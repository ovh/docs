...
> [!warning]
> 
> Jeśli zostałeś przekierowany do interfejsu **Roundcube**, oznacza to, że korzystasz z poprzedniej wersji usługi MX Plan. Aby uzyskać więcej informacji na temat oferty MX Plan, sprawdź naszą stronę [Pierwsze kroki z ofertą MX Plan](email_generalities1.).
>
> Aby zapoznać się z interfejsem **Roundcube**, zapoznaj się z naszym przewodnikiem [Korzystanie z konta e-mail w interfejsie Webmail Roundcube](email_roundcube1.).
...
Szczegółowe instrukcje tworzenia reguł skrzynki odbiorczej zawiera przewodnik: [Tworzenie reguł skrzynki odbiorczej w aplikacji OWA](creating-inbox-rules-in-owa-mx-plan1.).
...
Szczegółowe instrukcje tworzenia odpowiedzi automatycznych zawiera przewodnik: [Tworzenie odpowiedzi automatycznych w interfejsie OWA](owa_automatic_replies1.).
...
Instrukcje dotyczące tworzenia automatycznych podpisów przy użyciu szablonów dla domeny zawiera przewodnik: [Automatyczny podpis](feature_footers1.).
...
[Tworzenie odpowiedzi automatycznych w interfejsie OWA](owa_automatic_replies1.)
...
[Korzystanie z grup (mailing listy) dostępnych z kontem Exchange](feature_groups1.)
