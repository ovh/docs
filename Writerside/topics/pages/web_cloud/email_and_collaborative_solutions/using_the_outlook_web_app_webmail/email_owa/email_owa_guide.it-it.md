...
> [!warning]
>
> Se vieni reindirizzato su un’interfaccia **Roundcube**, significa che sei sulla versione storica dell’offerta MX Plan. Per maggiori informazioni sulla soluzione MX Plan, consulta la pagina [Iniziare a utilizzare la soluzione MX Plan](email_generalities1.).
>
> Per familiarizzare con l'interfaccia **Roundcube**, consulta la nostra guida [Webmail: guida all’utilizzo di Roundcube](email_roundcube1.).
...
Per istruzioni più dettagliate sulla creazione di regole di posta in arrivo, fai riferimento alla nostra guida: [Creare regole di posta in arrivo in OWA](creating-inbox-rules-in-owa-mx-plan1.).
...
Per istruzioni più dettagliate sull’impostazione di risposte automatiche, fai riferimento alla nostra guida: [Impostare risposte automatiche con OWA](owa_automatic_replies1.).
...
Per scoprire come comporre firme automatiche utilizzando template a livello di dominio, fai riferimento alla nostra guida: [Impostare firme automatiche](feature_footers1.).
...
[Impostare risposte automatiche con OWA](owa_automatic_replies1.)

[Condividere una cartella con la Webmail OWA](owa_directory_sharing1.)

[Condividere un calendario con la Webmail OWA](owa_calendar_sharing1.)

[Creare gruppi di contatti (mailing list)](feature_groups1.)
