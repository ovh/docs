...
[Accédez via SSH](getting-started#ssh.) à votre hébergement web POWER et récupérez les sources d'Etherpad dans le répertoire `www` :
...
[Redémarrez votre instance](getting-started#restart.), votre Etherpad sera alors en ligne.
