...
[Accédez via SSH](getting-started#ssh.) à votre hébergement web POWER. Commencez par recupérer les sources du projet :
...
[Redémarrez votre instance](getting-started#restart.), votre application de présentation de slides sera alors en ligne.

![Slideshow](nodejs-install-slideshow-01.png){.thumbnail}
