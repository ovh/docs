...
[Redémarrez votre instance](getting-started#restart.), votre Rails sera alors en ligne.

![Rails](ruby-install-rails-01.png){.thumbnail}
...
![Rails](ruby-install-rails-02.png){.thumbnail}
