...
[Accédez via SSH](getting-started#ssh.) à votre hébergement web POWER et installez Express avec `npm` :
...
[Redémarrez votre instance](getting-started#restart.), votre application Express sera alors en ligne.

![Express](nodejs-install-express-01.png){.thumbnail}
