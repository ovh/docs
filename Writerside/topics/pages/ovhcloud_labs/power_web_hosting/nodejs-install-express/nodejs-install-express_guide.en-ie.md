...
[Connect via SSH](getting-started#ssh.) to your POWER web hosting, and install Express using `npm`:
...
[Restart your instance](getting-started#restart.) and your Express *Hello World* will be online.

![Express Hello World](nodejs-install-express-01.png){.thumbnail}
