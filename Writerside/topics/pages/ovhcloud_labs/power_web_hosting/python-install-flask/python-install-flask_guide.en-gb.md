...
[Connect via SSH](getting-started#ssh.) to your POWER web hosting and activate `virtualenv`:
...
Then [restart your instance](getting-started#restart.) and your Flask project will be online.

![Flask](python-install-flask-01.png){.thumbnail}
