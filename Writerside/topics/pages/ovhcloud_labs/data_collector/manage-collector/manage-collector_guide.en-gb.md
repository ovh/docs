...
![Create a JWT token](create_jwt_token.png)
...
![List all collectors](list_all_collectors.png)
...
![List available sources](list_available_sources.png)
...
![List available sources](available_sources.png)
...
![Source result](source_result.png)
...
![Resulting source](resulting_source.png)
...
![Available sink](available_sink.png)
