...
update_link_subs(){
  sed -i "s,www.ovhcloud.com/${OVHCLOUD_LANG["${GUIDE_SUB^^}"]},www.ovhcloud.com/${OVHCLOUD_LANG["${LANG^^}"]},g" ${TARGET}
  sed -i "s,docs.ovh.com/${OVHDOCS_LANG["${GUIDE_SUB^^}"]},docs.ovh.com/${OVHDOCS_LANG["${LANG^^}"]},g" ${TARGET}
