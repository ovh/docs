---
title: Rétablir la configuration d'usine OverTheBox IT
...
- Branchez la clef USB flashée sur un des ports USB **noir** de l'**OverTheBox** (Ne pas brancher la clef sur le port USB bleu)
