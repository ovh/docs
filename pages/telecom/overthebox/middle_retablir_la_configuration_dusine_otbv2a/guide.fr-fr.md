...
![overthebox](images/OTBv2a_face2.jpg){.thumbnail}
...
> réinstaller en suivant la procédure du guide : Mes 10 premières minutes avec OverTheBox <docs/telecom/overthebox/mes_10_premieres_minutes_avec_overthebox/otbv2a/>
> 
...
Toute l'opération se fera en lignes de commande, veuillez donc ouvrir le **Terminal**
...
- Branchez la clef USB flashée sur un des ports USB **noirs** de l'**OverTheBox** (Ne pas brancher la clef sur le port USB bleu)


![overthebox](images/OTBv2a_face.jpg){.thumbnail}
