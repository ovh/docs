...
Dans le cas où votre matériel est une **OverTheBox** fournie par OVHcloud, vous pouvez suivre la méthode n°1 à l'aide d'une clé usb bootable. Pour les autres matériels, vous pouvez vous reporter à la méthode n°2

### Méthode n°1 : installation automatique à l'aide d'une clé USB

Il est possible de créer une clé USB bootable contenant l'image OverTheBox afin d'installer complétement le système.
...
### Méthode n°2 : installation manuelle depuis une distribution linux live

Dans le cas d'un autre matériel non fournis par OVH, vous devez installer l'image OverTheBox manuellement en écrivant l'image directement sur le disque dur de votre matérielle.
...
On identifie dans cette exemple que la destination d'installation sera **mmcblk0**
...
#### Installation
Décompresser l'image téléchargée et écriver la sur le disque grace à l'utilitaire **dd**.
...
> [!success]
>
> Votre matériel est maintenant opérationelle, vous pouvez l'installer en suivant la procédure décrite dans les guides suivants :
>
