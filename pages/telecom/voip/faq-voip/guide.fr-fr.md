...
Un [numéro](https://www.ovhtelecom.fr/telephonie/numeros/), souvent appelé « numéro alias », ne peut pas être enregistré sur un téléphone. Suivant votre besoin, il peut rediriger les appels vers **une ou plusieurs** lignes SIP ou peut servir à héberger une [conférence téléphonique OVHcloud](/pages/telecom/voip/conference).
<br>Un numéro alias peut être [acheté chez OVHcloud](https://www.ovhtelecom.fr/telephonie/numeros/) ou « porté », via la [portabilité de numéro](/pages/telecom/voip/demander_la_portabilite_de_mon_numero), depuis un autre opérateur téléphonique.
...
* Un numéro alias peut rediriger les appels vers une seule ligne, via une [redirection d'appels](/pages/telecom/voip/redirection_avec_presentation). Cela peut vous permettre, par exemple, de masquer le numéro direct de la ligne SIP.
* Un numéro alias peut aussi faire sonner **en même temps** plusieurs lignes via une configuration de type « [File d'appels](/pages/telecom/voip/les_files_d_appels) ».
* Vous pouvez également, sur un numéro alias, appliquer une configuration de type « [SVI](/pages/telecom/voip/svi_serveur_vocal_interactif) » afin de proposer à vos appelants des choix de touches pour joindre indépendamment chaque service de votre entreprise.
...
Pour consulter le répondeur d'une ligne téléphonique OVHcloud, le plus simple est de composer le « 123 » depuis cette ligne. Si vous souhaitez des informations complémentaires, nous vous invitons à consulter le guide [Configurer et consulter le répondeur de sa ligne](/pages/telecom/voip/configurer-consulter-repondeur-ligne-ovh).
...
Si vous souhaitez réaliser des renvois d'appels spécifiques, adaptés à vos différents usages, nous vous invitons à consulter notre guide pour [activer ou désactiver des services depuis le téléphone](/pages/telecom/voip/activer_desactiver_fonctions).
...
Il existe plusieurs configurations pouvant être appliquées à vos numéros alias, vous pouvez retrouver celles-ci sur le guide [Choisir et appliquer une configuration pour un numéro](/pages/telecom/voip/quelle_configuration_est_adaptee_a_mes_besoins).
...
Vous pouvez également modifier la configuration du numéro en cliquant sur `Changer de configuration`{.action}. Vous pouvez retrouver de plus amples informations en suivant le guide [Choisir et appliquer une configuration pour un numéro](/pages/telecom/voip/quelle_configuration_est_adaptee_a_mes_besoins).
...
Si vous souhaitez des informations complémentaires, nous vous invitons à consulter le guide suivant : [Configurer un Contact Center Solution](/pages/telecom/voip/contact-center-solution).
...
<br>Vous trouverez plus de détails dans le guide [Dépanner son téléphone Plug and Phone](/pages/telecom/voip/troubleshoot-02-fix-control-panel).
