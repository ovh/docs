...
Now that your list has been imported, you can follow the instructions in our guide on [Sending SMS messages via the OVHcloud Control Panel](https://docs.ovh.com/gb/en/sms/send_sms_messages_via_control_panel/) in order to send an SMS to the recipients of this list.

## Go further

[Sending SMS messages via the OVHcloud Control Panel](https://docs.ovh.com/gb/en/sms/send_sms_messages_via_control_panel/)

[Managing SMS address books](https://docs.ovh.com/gb/en/sms/manage-sms-address-books/)
