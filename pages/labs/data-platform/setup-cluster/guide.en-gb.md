...
The analytics data platform is meant to be deploy in a private network, that means that a vRack
interface is compulsory ([see section about vRack](../vrack/guide.en-gb.md)).
...
![](images/)"ingest_01.png" title="Ambari Files View" >}}
...
![Ambari Views](images/ambari_views_01.pn)
