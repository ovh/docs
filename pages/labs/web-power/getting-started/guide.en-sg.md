...
For default, your POWER web hosting plan is attached to a generated URL. In order to use your own [domain name](https://www.ovh.com/sg/domains/), you can add it in the `Multisite`{.action} tab.
