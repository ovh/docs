...
This guide will explain how to manage your POWER web hosting using the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager) and the [OVHcloud APIs](https://ca.api.ovh.com/console/).
...
For default, your POWER web hosting plan is attached to a generated URL. In order to use your own [domain name](https://www.ovh.com/ca/en/domains/), you can add it in the `Multisite`{.action} tab.
...
This tutorial presupposes that you already have some familiarity with the [OVHcloud APIs](https://ca.api.ovh.com/console/). If you want to know more on this topic, please look at the [First Steps with the OVHcloud APIs](../../api/first-steps-with-ovh-api/) guide.

The [OVHcloud APIs](https://ca.api.ovh.com/console/) currently available for POWER hosting plans are:
