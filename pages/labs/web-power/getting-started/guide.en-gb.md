...
The POWER web hosting management UI is in the `Web Cloud`{.action} section, at the `web hosting plans`{.action} section in the sidebar. 
...
At the activation of your POWER web hosting plan, we have sent you an email with the SSH and FTP credentials. You can also manage them from the `FTP - SSH`{.action}.

![FTP - SSH access](images/getting-started-02.png){.thumbnail}

You will find detailed information of this topic in our [Accessing a web web hosting plan via SSH](../../web_hosting_ssh_on_web_hosting_packages/) guide.


#### Adding a domain name

For default, your POWER web hosting plan is attached to a generated URL. In order to use your own [domain name](https://www.ovh.com/world/domains/), you can add it in the `Multisite` {.action} tab.

![Adding a domain name](images/getting-started-03.png){.thumbnail}

You will find detailed information of this topic in our [Hosting multiple websites on your Web Hosting plan](../../hosting/multisites-configuring-multiple-websites/) guide.
...
You will find detailed information of this topic in our [Creating and managing a database in your Web Hosting plan](../../hosting/creating-database/) guide.
...
You will find detailed information of this topic in our [Accessing a website’s logs and statistics on a Web Hosting](../../hosting/shared_view_my_websites_logs_and_statistics/) guide.
...
Let's suppose you have the default configuration for Pyhton hosting:
...
You can create an `.htacess` file in your POWER web hosting root folder (usually `www`) to set up a redirection from HTTP to HTTPS:
