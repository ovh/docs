...
[https://api.ovh.com/createToken](/links/apicreateToken/index.cgi?GET=/sms/&GET=/sms/*/jobs&POST=/sms/*/jobs) (questo URL permette di avere automaticamente le autorizzazioni per gli step descritti in questa guida).
 ...
 * 
 * Fare riferimento all’indirizzo /links/apicreateToken/index.cgi?GET=/sms/&GET=/sms/*/jobs&POST=/sms/*/jobs
