...
Genere las claves para su script (se crean todas a la vez) desde esta página: [/links/apicreateToken/](/links/apicreateToken/?GET=/sms/&GET=/sms/*/jobs/&POST=/sms/*/jobs/) (si accede desde este enlace, tendrá automáticamente los permisos necesarios para seguir los pasos que se explican en esta guía).
