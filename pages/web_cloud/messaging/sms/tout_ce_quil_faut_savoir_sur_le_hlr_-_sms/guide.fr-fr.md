...
![Sélection du compte SMS dans l'espace client](images/img_4068.jpg){.thumbnail}

## Section HLR

Sélectionnez l'onglet SMS.

![Onglet SMS dans l'espace client](images/img_4791.jpg){.thumbnail}
...
![Importation d'un fichier de contacts](images/img_4795.jpg){.thumbnail}
