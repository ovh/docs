...
![hosting](images/installation-select-language.png){.thumbnail}
...
![hosting](images/installation-start.png){.thumbnail}
...
![hosting](images/installation-config-db.png){.thumbnail}
...
![hosting](images/installation-step-after-db-1.png){.thumbnail}
...
![hosting](images/installation-config-admin-user.png){.thumbnail}
...
![hosting](images/installation-successfull.png){.thumbnail}
...
![hosting](images/admin-interface.png){.thumbnail}
