...
![Drupal instalação step 1](images/install-language-1.png){.thumbnail}
...
![Drupal instalação step 2](images/install-profil-2.png){.thumbnail}
...
![Drupal instalação step 3](images/install-db-config-3.png){.thumbnail}
...
![Drupal instalação step 4](images/install-4.png){.thumbnail}
...
![Drupal instalação step 5-1](images/install-configure-site-5-1.png){.thumbnail}
...
![Drupal instalação step 5-1](images/install-configure-site-5-2.png){.thumbnail}
...
![Drupal instalação step 6](images/install-ending-6.png){.thumbnail}
