...
On Web Hosting plans (shared databases), there is a limit of 30 concurrent connections per database (this limit increases to 200 if you use a [Web Cloud Databases](https://www.ovhcloud.com/en-ie/web-cloud/databases/) offer). See the [details of our web hosting plans](https://www.ovhcloud.com/en-ie/web-hosting/) to find out the options available in each web hosting plan.

You can also order additional [Web Cloud Databases](https://www.ovhcloud.com/en-ie/web-cloud/databases/) solutions, which have customization options:
...
To find out more, read the details of our [web hosting plans](https://www.ovhcloud.com/en-ie/web-hosting/) and our guide “[Getting started with your Web Cloud Databases solution](/pages/web_cloud/web_cloud_databases/starting_with_clouddb)”.
...
Only [Web Cloud Databases](https://www.ovhcloud.com/en-ie/web-cloud/databases/) database servers allow external servers to connect to them. This is because you have previously authorized your external server’s IP address on your database server. If necessary, please refer to our guide on "[Getting started with your Web Cloud Databases solution](/pages/web_cloud/web_cloud_databases/starting_with_clouddb)".
...
We recommend referring to our [web hosting plans](https://www.ovhcloud.com/en-ie/web-hosting/uc-programming-language/) to ensure that the web hosting plan you want to order is right for you.
