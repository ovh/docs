...
- Em caso de abuso ou de risco comprovado, o seu serviço será suspenso e ser-lhe-á enviado um e-mail a informá-lo da suspensão do serviço. O que fazer em caso de conta bloqueada por spam? Consulte [nosso guia](/pages/web_cloud/email_and_collaborative_solutions/troubleshooting/locked_for_spam).
...
Para saber mais, consulte as nossas [ofertas de alojamento](https://www.ovhcloud.com/pt/web-hosting/) e este [guia](/pages/web_cloud/web_cloud_databases/starting_with_clouddb).
...
Para mais informações sobre a gestão das bases de dados, consulte o guia [Criar uma base de dados num alojamento web](/pages/web_cloud/web_hosting/sql_create_database).
...
Quando estiver conectado ao alojamento web via SSH, o tráfego de saída será bloqueado por razões de segurança. Por isso, recomendamos que use scripts PHP. Para mais informações, consulte o [guia SSH](/pages/web_cloud/web_hosting/ssh_on_webhosting). Também pode consultar as orientações oficiais [Manual do PHP](https://www.php.net/manual/pt_BR/function.system.php) acerca da execução dos comandos.
...
Saiba como [ligar-se ao espaço de armazenamento](/pages/web_cloud/web_hosting/ftp_connection) ou [restaurar o espaço de armazenamento do alojamento web](/pages/web_cloud/web_hosting/ftp_save_and_backup) nos nossos documentos.
...
Saiba como [Recuperar o backup da base de dados de um alojamento web](/pages/web_cloud/web_hosting/sql_database_export) no nosso manual.
