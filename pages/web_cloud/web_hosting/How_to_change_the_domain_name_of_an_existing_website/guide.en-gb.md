...
Declare your new domain name using our guide on [adding a multisite on your web hosting](/pages/web_cloud/web_hosting/multisites_configure_multisite). Also declare the subdomain as `www` if, for example, you want to have `www.NewDomain.tld` also display your website in addition to `NewDomain.tld`.
