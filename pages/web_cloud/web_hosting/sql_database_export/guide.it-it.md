...
> [!primary]
>
> Utilizzare uno script di backup e task pianificati (detti CRON) ti permette di automatizzare i backup con la frequenza che preferisci. Per maggiori informazioni sui task pianificati, consulta [questa guida](/pages/web_cloud/web_hosting/cron_tasks){.external}.
>
