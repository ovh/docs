...
> **Étape 3**
>>
>> Cliquez sur le bouton `...`{.action} à droite de la base de données à sauvegarder, puis sur `Créer une sauvegarde`{.action}.
>>
...
> **Étape 3**
>>
>> Cliquez sur le bouton `...`{.action} à droite de la base de données concernée, puis sur `Restaurer une sauvegarde`{.action}.
>>
