...
![Joomla instalando step 1](images/install-select-language-1.png){.thumbnail}
...
![Joomla instalando step 2](images/install-define-admin-2.png){.thumbnail}
...
![Joomla instalando step 3](images/install-db-connect-3.png){.thumbnail}
...
![Joomla instalando step 3-1](images/install-db-connect-3-1.png){.thumbnail}
...
![Joomla instalando step 4](images/install-ending-4.png){.thumbnail}
