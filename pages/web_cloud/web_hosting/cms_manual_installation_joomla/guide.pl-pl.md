...
> [!success]
>
> Do zainstalowania Joomla! **automatycznie** w [Panelu klienta OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl) sprawdź naszą dokumentację dotyczącą [instalacji modułu "jednym kliknięciem"](/pages/web_cloud/web_hosting/cms_install_1_click_modules).
>
...
![Joomla instalacja step 1](images/install-select-language-1.png){.thumbnail}
...
![Joomla instalacja step 2](images/install-define-admin-2.png){.thumbnail}
...
![Joomla instalacja step 3](images/install-db-connect-3.png){.thumbnail}
...
![Joomla instalacja step 3-1](images/install-db-connect-3-1.png){.thumbnail}
...
![Joomla instalacja step 4](images/install-ending-4.png){.thumbnail}
