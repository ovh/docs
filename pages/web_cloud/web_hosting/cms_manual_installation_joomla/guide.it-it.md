...
![Joomla Installstep 1](images/install-select-language-1.png){.thumbnail}
...
![Joomla Installstep 2](images/install-define-admin-2.png){.thumbnail}
...
![Joomla Installstep 3](images/install-db-connect-3.png){.thumbnail}
...
![Joomla Installstep 3-1](images/install-db-connect-3-1.png){.thumbnail}
...
![Joomla Installstep 4](images/install-ending-4.png){.thumbnail}
