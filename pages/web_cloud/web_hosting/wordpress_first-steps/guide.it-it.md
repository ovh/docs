...
![WordPress - Categorie](images/categories.png){.thumbnail}
...
![WordPress - Categorie filled](images/categories-2.png){.thumbnail}

Una volta inserite le informazioni, clicca su `Aggiungi una nuova categoria`{.action}:

![WordPress - Categorie added](images/categories-3.png){.thumbnail}
...
![WordPress - Sub-estina](images/categories-4.png){.thumbnail}
...
![WordPress - Set new categto an an existing post](images/posts.png){.thumbnail}
...
![WordPress - GB to page](images/pages.png){.thumbnail}
...
![WordPress - Pagine, Gutenberg page builder](images/pages-editor.png){.thumbnail}

Crea il contenuto della tua pagina e pubblicalo:

![WordPress - Pagine, content](images/post-editor-4.png){.thumbnail}
