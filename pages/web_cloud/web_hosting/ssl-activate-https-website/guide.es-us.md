...
- Tener un [certificado SSL](https://www.ovhcloud.com/es/web-hosting/options/ssl/){.external} instalado en su [alojamiento web de OVHcloud](/links/web/hosting){.external}.
