...
> [!warning]
>
> Bevor Sie fortfahren, empfehlen wir Ihnen, ein vollständiges Backup Ihrer Website zu erstellen, also inklusive aller Dateien des Speicherplatzes als auch der Datenbanken, sofern verwendet. 
>
> Die nachfolgenden Aktionen werden direkt in den Website-Dateien ausgeführt. Wenn Sie auf Schwierigkeiten stoßen, wenden Sie sich bitte an einen [spezialisierten Dienstleister](https://partner.ovhcloud.com/de/directory/).
>
