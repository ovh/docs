...
- You must have a [SSL certificate](https://www.ovhcloud.com/en-au/web-hosting/options/ssl/){.external} installed on your [OVHcloud web hosting plan](https://www.ovhcloud.com/en-au/web-hosting/){.external}.
- at least one website set up and accessible on your OVHcloud web hosting plan.
- You must be logged in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au){.external}, part `Web Cloud`{.action}.
