...
- an [SSL certificate](https://www.ovh.com.au/ssl/) set up on your [OVHcloud Web Hosting plan](https://www.ovhcloud.com/en-au/web-hosting/)
...
You can activate the SSL certificate on your Web Hosting plan via the  [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au){.external}. To do this, you will need to make two separate changes:
