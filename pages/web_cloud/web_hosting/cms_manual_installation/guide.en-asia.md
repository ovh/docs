...
> [!success]
>
> To install your CMS **automatically** from your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia), please refer to our documentation on [installing a 1-click module](/pages/web_cloud/web_hosting/cms_install_1_click_modules).
>
...
You can find more information on our [WordPress module page](https://www.ovhcloud.com/asia/web-hosting/uc-wordpress-website/). 
...
You can find more information on our [Joomla! module page](https://www.ovhcloud.com/asia/web-hosting/uc-joomla-website/). 
...
You can find more information on our [Drupal module page](https://www.ovhcloud.com/asia/web-hosting/uc-drupal-website/). 
...
You can find more information on our [PrestaShop module page](https://www.ovhcloud.com/asia/web-hosting/uc-prestashop-website/).
...
To install a CMS on your [web hosting plan](https://www.ovhcloud.com/asia/web-hosting/), you will need to make some preparations.
...
- Make sure that the domain name you will use to access your CMS, along with its subdomain “www”, is mapped to the IP address of your [web hosting plan](https://www.ovhcloud.com/asia/web-hosting/).
...
Most CMSs require a database to work. Our [web hosting offers](https://www.ovhcloud.com/asia/web-hosting/) include them.
