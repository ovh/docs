...
> [!success]
>
> To install your CMS **automatically** from your [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie), please refer to our documentation on [installing a 1-click module](/pages/web_cloud/web_hosting/cms_install_1_click_modules).
>
...
Most CMSs require a database to work. Our [web hosting](https://www.ovhcloud.com/en-ie/web-hosting/) offers contain them, with the exception of [100M free hosting](https://www.ovhcloud.com/en-ie/domains/free-web-hosting/).
