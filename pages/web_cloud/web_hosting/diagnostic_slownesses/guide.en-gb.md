...
To compare the available PHP versions depending on the runtime environment you are using, see **Step 2** in the guide on [configuring the PHP version on your web hosting](/pages/web_cloud/web_hosting/php_configure_php_on_your_web_hosting_2014).
