...
>
> If you need a service with a guaranteed availability rate higher than 99%, we recommend that you consider using a [Virtual Private Server (VPS)](https://www.ovhcloud.com/en-sg/vps/) or a [Dedicated Server](/links/bare-metal/bare-metal).
>
...
You might consider a more capable [shared hosting offer](https://www.ovhcloud.com/en-sg/web-hosting/) or a dedicated infrastructure such as a [Virtual Private Server (VPS)](https://www.ovhcloud.com/en-sg/vps/) or [Dedicated Server](/links/bare-metal/bare-metal). 
