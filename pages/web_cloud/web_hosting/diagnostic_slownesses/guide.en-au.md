...
>
> If you need a service with a guaranteed availability rate higher than 99%, we recommend that you consider using a [Virtual Private Server (VPS)](https://www.ovhcloud.com/en-au/vps/) or a [Dedicated Server](/links/bare-metal/bare-metal).
>
...
> [!primary]
>
> OVHcloud offers several [CDN options](https://www.ovhcloud.com/en-au/web-hosting/options/). If you would like to use or activate one for your web hosting plan, log in to your [OVHcloud Control Panel](/links/manager) then read our guide on [Using the OVHcloud CDN](/pages/web_cloud/web_hosting/cdn_how_to_use_cdn).
>
...
You might consider a more capable [shared hosting offer](https://www.ovhcloud.com/en-au/web-hosting/) or a dedicated infrastructure such as a [Virtual Private Server (VPS)](https://www.ovhcloud.com/en-au/vps/) or [Dedicated Server](/links/bare-metal/bare-metal). 
