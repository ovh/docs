...
You might consider a more capable [shared hosting offer](https://www.ovhcloud.com/en-au/web-hosting/) or a dedicated infrastructure such as a [Virtual Private Server (VPS)](/links/bare-metal/vps) or [Dedicated Server](/links/bare-metal/bare-metal). 
