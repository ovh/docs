...
Vous pouvez envisager une [offre d'hébergement mutualisée](https://www.ovhcloud.com/fr-ca/web-hosting/) supérieure ou une infrastructure dédiée telle qu'un [Serveur Privé Virtuel (VPS)](/links/bare-metal/vps) ou un [Serveur Dédié](/links/bare-metal/bare-metal). 
