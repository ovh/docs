...
>
> Si necesita un servicio con una tasa de disponibilidad SLA superior al 99%, le recomendamos que considere la posibilidad de utilizar un [Servidor Privado Virtual (VPS)](https://www.ovhcloud.com/es-es/vps/) o un [Servidor Dedicado](/links/bare-metal/bare-metal).
>
...
Puede considerar un [plan de hosting](https://www.ovhcloud.com/es-es/web-hosting/) superior o una infraestructura dedicada como un [Servidor Privado Virtual (VPS)](https://www.ovhcloud.com/es-es/vps/) o un [Servidor Dedicado](/links/bare-metal/bare-metal). 
