...
> [!success]
>
> To link your new database if you are using a Content Management System (CMS) such as WordPress, Joomla!, Drupal or PrestaShop, you can find information on their configuration files in **part 2** of the guide "[Changing a database password](/pages/web_cloud/web_hosting/sql_change_password)".
>
