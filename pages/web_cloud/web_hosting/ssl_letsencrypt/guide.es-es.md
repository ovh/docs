---
Título: "Web hosting - Activar un certificado SSL gratuito Let's Encrypt"
excerpt: "Cómo activar o regenerar un certificado SSL gratuito Let's Encrypt en un alojamiento web"
updated: 2024-10-21
---
...
OVHcloud ofrece varios tipos de certificados SSL en nuestros planes de [hosting OVHcloud] (/links/web/hosting). Estos se describen en la guía «[Alojamiento web - Gestionar un certificado SSL](/pages/web_cloud/web_hosting/ssl_on_webhosting)». Los certificados SSL son indispensables para la seguridad de su sitio web.
...
Let's Encrypt es una autoridad de certificación gratuita, automatizada, abierta y sin ánimo de lucro. Más información en <https://letsencrypt.org/fr/about/>.
...
- Contratar o disponer de un [dominio] (/links/web/domains) y disponer de derechos exclusivos sobre su uso. El dominio o los subdominios no deben estar ya vinculados a un certificado SSL.
...
5. A continuación, haga clic en la pestaña `Multisitio`{.action}.
...
|Deshabilitado|No hay ningún certificado SSL habilitado para esta entrada multisitio. Para activarlo, siga los pasos que se indican a continuación.|
...
{.action} Para preasignar la opción SSL Let's Encrypt a un dominio o subdominio declarado en multisitio en su alojamiento web, siga estos pasos:
...
4. Se abrirá una nueva ventana en la que podrá consultar un resumen de la configuración del dominio o subdominio. Haga clic en `Validar`{.action} para aplicar el cambio solicitado para esta entrada multisitio.
