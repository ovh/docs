...
Su base de datos es un elemento central en la construcción de su sitio web dinámico. Durante el ciclo de vida de su sitio web, puede que necesite copiar el contenido de su base de datos en otra de sus bases de datos [start SQL](https://www.ovhcloud.com/es/web-hosting/options/start-sql/) o [Web Cloud Databases](/links/web/databases).
...
- Tener contratadas bases de datos [start SQL](https://www.ovhcloud.com/es/web-hosting/options/start-sql/) y/o [Web Cloud Databases](/links/web/databases). Es necesario crear previamente las dos bases de datos para poder utilizar la herramienta de duplicación.
...
Puede elegir entre contratar un servicio "[start SQL](https://www.ovhcloud.com/es/web-hosting/options/start-sql/)" o un servidor de bases de datos "[Web Cloud Databases](/links/web/databases)".
...
- Contratar un servicio "[start SQL](https://www.ovhcloud.com/es/web-hosting/options/start-sql/)" o un servidor de bases de datos "[Web Cloud Databases](/links/web/databases)"
