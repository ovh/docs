...
![Lista degli hosting](images/list-web-hosting.png){.thumbnail}

Clicca sulla scheda `Database`{.action} per visualizzare la lista dei database Start SQL disponibili.

![Lista dei BDD Start SQL](images/list-bdd-startsql.png){.thumbnail}
...
![Lista dei server WCD](images/list-wcd-server.png){.thumbnail}

Clicca sulla scheda `Database`{.action} per visualizzare la lista dei database presenti sul tuo server Web Cloud Databases.

![Lista dei database WCD](images/list-database-wcd.png){.thumbnail}
...
![CTA_copiare_BDD](images/cta-copy-database.png){.thumbnail}

Verrà visualizzata una finestra che consente di identificare il database di destinazione.

![Interfaccia copia BDD](images/interface-copy-database.png){.thumbnail}
...
![Lista dei database WCD](images/link-buy-database.png){.thumbnail}
...
![Messaggio di conferma copia BDD](images/confirmation-copy-database.png){.thumbnail}
...
![Messaggio di riuscita BDD](images/success-copy-database.png){.thumbnail}
...
![Attività in corso](images/ongoing-tasks.png){.thumbnail}
