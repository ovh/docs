...
> [!primary]
>
> La nueva base de datos no está activada de forma predeterminada cuando la adquiere. No olvide activarlo. Para ello, conéctese a su [área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es) y acceda a la sección `Web Cloud`{.action}.
> 
...
- Configure una nueva base de datos en su servidor [Web Cloud Databases](https://www.ovhcloud.com/es-es/web-cloud/databases/);
