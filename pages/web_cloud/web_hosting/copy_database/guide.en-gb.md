...
- You must have [start SQL](https://www.ovhcloud.com/en-gb/web-hosting/options/start-sql/) and/or [Web Cloud Databases](https://www.ovhcloud.com/en-gb/web-cloud/databases/) database solutions. The two databases concerned must be created beforehand in order to use the replication tool.
...
- a database [Start SQL](https://www.ovhcloud.com/en-gb/web-hosting/options/start-sql/) (included in some of our [web hosting](https://www.ovhcloud.com/en-gb/web-hosting/) or [ordered separately](https://www.ovhcloud.com/en-gb/web-hosting/options/start-sql/));
- a database hosted on a [Web Cloud Databases](https://www.ovhcloud.com/en-gb/web-cloud/databases/) server  (included with our [Performance hosting](https://www.ovhcloud.com/en-gb/web-hosting/performance-offer/) or [ordered separately](https://www.ovhcloud.com/en-gb/web-cloud/databases/)). 
...
You can choose between buying a "[start SQL](https://www.ovhcloud.com/en-gb/web-hosting/options/start-sql/)" solution, or a "[Web Cloud Databases](https://www.ovhcloud.com/en-gb/web-cloud/databases/)" database server.

> [!primary]
>
> When you purchase your new database, it is not activated by default. Don't forget to enable it. To do this, log in to your [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), then go to the `Web Cloud`{.action} section.
> 
...
- Configure a new database on your server [Web Cloud Databases](https://www.ovhcloud.com/en-gb/web-cloud/databases/);
- Order a "[start SQL](https://www.ovhcloud.com/en-gb/web-hosting/options/start-sql/)" solution or a database server "[Web Cloud Databases](https://www.ovhcloud.com/en-gb/web-cloud/databases/)"
...
- Order a new database [start SQL](https://www.ovhcloud.com/en-gb/web-hosting/options/start-sql/) with more space.
