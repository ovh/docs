...
However, there are many other API calls available, which you can explore depending on your specific needs. For more options and features, you can refer to the « [/hosting/web](/links/console?section=%2Fhosting%2Fweb&branch=v1#get-/hosting/web) » section of the OVHcloud API.
