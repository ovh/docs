...
- A [domain name](/links/web/domains){.external} registered with OVHcloud or a [DNS zone](/links/websitedomains/dns-subdomain/){.external} of a domain name not registered with OVHcloud 
