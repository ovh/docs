...
> **Passaggio 2**
>>
>> Nella pagina che appare, clicca sulla scheda `Statistiche e log`{.action} e vai alla sezione **Statistiche dell'infrastruttura**.
>>
> **Passaggio 3**
>>
>> Dal menu a comparsa in alto a sinistra è possibile visualizzare diversi tipi di grafici:
>>
>> ![Statistiche dell'infrastruttura dell'hosting web](/pages/assets/screens/control_panel/product-selection/web-cloud/web-hosting/statistics-and-logs/infrastructure-statistics-graph.png){.thumbnail}
>>
...
> **Passaggio 2**
>>
>> Nella pagina che appare, clicca sulla scheda `Statistiche e log`{.action} e vai alla sezione **Gestione degli utenti**.
>>
> **Passaggio 3**
>>
>> Clicca su `Crea un nuovo utente`{.action} e segui le istruzioni per completare la creazione.
>>
>> ![Creazione di un nuovo utente per le statistiche](/pages/assets/screens/control_panel/product-selection/web-cloud/web-hosting/statistics-and-logs/create-a-new-user.png){.thumbnail}
...
> **Passaggio 2**
>>
>> Nella pagina che appare, clicca sulla scheda `Statistiche e log`{.action} e vai alla sezione **Statistiche delle visite**.
>>
> **Passaggio 3**
>>
>> Clicca sul pulsante `Visualizza le statistiche`{.action}.
>>
>> ![Statistiche delle visite del sito web](/pages/assets/screens/control_panel/product-selection/web-cloud/web-hosting/statistics-and-logs/view-statistics.png){.thumbnail}
>>
...
> [!warning]
>
> Se i log separati sono stati abilitati su uno dei tuoi [siti web](/pages/web_cloud/web_hosting/multisites_configure_multisite), gli utenti creati qui non potranno accedere alle statistiche relative a quel sito web specifico.
