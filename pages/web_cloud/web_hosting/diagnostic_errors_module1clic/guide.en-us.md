...
- You must have a compatible [web hosting] plan (https://www.ovhcloud.com/en/web-hosting/).
- You must be logged in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we).
...
> [!primary]
>
> As a reminder, do not hesitate to consult in advance our unitary database offers [start SQL](https://www.ovhcloud.com/en/web-hosting/options/start-sql/), as well as our [Web Cloud Databases](https://www.ovhcloud.com/en/web-cloud/databases/) offer.
>
...
The [Pro](https://www.ovhcloud.com/en/web-hosting/professional-offer/) and [Performance](https://www.ovhcloud.com/en/web-hosting/performance-offer/) offers will allow you to create up to three additional “1-click modules” with an independent database for each of them. With the **Performance** plans, you can also activate a [Web Cloud Databases](https://www.ovhcloud.com/en/web-cloud/databases/) server for free.
