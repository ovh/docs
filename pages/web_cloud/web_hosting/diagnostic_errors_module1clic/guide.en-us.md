...
> [!primary]
>
> As a reminder, do not hesitate to consult in advance our unitary database offers [Start SQL](https://www.ovhcloud.com/en/web-hosting/options/start-sql/) and [Web Cloud Databases](https://www.ovhcloud.com/en/web-cloud/databases/).
>
...
The offers [Pro](https://www.ovhcloud.com/en/web-hosting/professional-offer/) and [Performance](https://www.ovhcloud.com/en/web-hosting/performance-offer/) will allow you to create up to three additional 1-click modules with an independent database for each of them. With the **Performance** plans, you can also activate a [Web Cloud Databases](https://www.ovhcloud.com/en/web-cloud/databases/) server for free.
