...
> [!primary]
>
> Le recordamos que no dude en consultar nuestras ofertas de bases de datos unitarias [start SQL](https://www.ovhcloud.com/es/web-hosting/options/start-sql/), así como nuestra oferta [Web Cloud Databases](/links/web/databases).
>
...
Los planes [Pro](/links/web/hosting-professional-offer) y [Performance](https://www.ovhcloud.com/es/web-hosting/performance-offer/) le permitirán crear hasta tres "módulos en un clic" adicionales con una base de datos independiente para cada uno de ellos. Los planes de hosting **Performance** también le permitirán activar gratuitamente un servidor [Web Cloud Databases](/links/web/databases).
