...
![Arborescence fichiers et dossiers](/pages/assets/screens/other/web-tools/vscode/create_your_personal_webpage_1.png){.thumbnail}

Prenons le cas d'un fichier au format *PNG*. Placez-le dans le répertoire « images » :

![Arborescence fichiers et dossiers avec image](/pages/assets/screens/other/web-tools/vscode/create_your_personal_webpage_2.png){.thumbnail}
...
![Résultat code HTML sur navigateur](/pages/assets/screens/other/browsers/web-pages/create_your_personal_webpage_3.png){.thumbnail}
...
![Placement fichier CSS](/pages/assets/screens/other/web-tools/vscode/create_your_personal_webpage_4.png){.thumbnail}
...
![Modèle de boîte CSS](/pages/assets/schemas/web-hosting/create_your_personal_webpage_5.png){.thumbnail}
