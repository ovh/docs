...
>>
>> All available backups will be displayed. Click on the `...`{.action} button to the right of the backup you want to restore, then on `Restore the backup`{.action}.
>>
> **Step 4**
>>
...
> **Step 3**
>>
>> Click on the `...`{.action} button to the right of the database you want to import data into, then on `Import file`{.action}.
>>
...
> **Step 4**
>>
>> In the window that opens, select `Import a new file`{.action}, then click `Next`{.action}.
>>
