...
> **Passaggio 2**
>>
>> Nella pagina che appare, clicca sulla scheda `Database`{.action}.
>>
> **Passaggio 3**
>>
>> Clicca sui tre puntini in corrispondenza del database da ripristinare e seleziona `Ripristina un backup`{.action}. Ti ricordiamo che scegliendo questa opzione il contenuto del database verrà sostituito con quello del backup.
>>
...
>>
>> Verranno elencati tutti i backup disponibili per il database selezionato. Clicca sui tre puntini in corrispondenza del backup da ripristinare e seleziona `Ripristina il backup`{.action}.
>>
> **Passaggio 4**
>>
...
> **Passaggio 3**
>>
>> Clicca sui tre puntini in corrispondenza del database in cui vuoi importare i dati e seleziona `Importa un file`{.action}.
>>
