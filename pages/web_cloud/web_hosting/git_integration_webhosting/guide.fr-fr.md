...
> [!warning]
>
> Lorsque vous associez un répertoire à Git, tous les domaines présentes sur ce répertoire sont également associés à Git. Par exemple, si le répertoire correspondant au site web que vous associez est `www`{.action}, alors tous les domaines associés au répertoire www seront associés à Git.
>

Connectez-vous à votre espace client OVHcloud et effectuez les actions suivantes :

- Accédez à l'onglet Web Cloud.
- Cliquez sur Multisite.
