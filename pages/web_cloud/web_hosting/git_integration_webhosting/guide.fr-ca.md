...
- L'adresse de votre dépôt GitHub est correcte. Elle doit être de la forme `https://github.com/<username>/<repository_name>`{.action}. N'oubliez pas d'ajouter `.git`{.action} à la fin de l'adresse copiée.
