...
You must have an OVHcloud [web hosting plan](https://www.ovhcloud.com/en-ie/web-hosting/).
...
To install the **Pico** CMS on your [web hosting](https://www.ovhcloud.com/en-ie/web-hosting/), you will need to make some preparations.
