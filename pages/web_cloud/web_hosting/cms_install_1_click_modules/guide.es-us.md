...
![Acceso a la sección Módulos en un clic](images/1-click-modules-section.png){.thumbnail}
...
![Elección del módulo](images/add-a-module-select-module-and-domain.png){.thumbnail}
