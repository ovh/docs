...
/// details | Instalación rápida de un "módulo en 1 clic"
...
> **Etapa 3**
>>
>> En la pestaña `Módulos en 1 clic`{.action} del alojamiento, haga clic en el botón `Añadir un módulo`{.action}.
>>
...
/// details | Instalación avanzada de un "módulo en 1 clic"
...
> **Etapa 4**
>>
>> Asegúrese de que la casilla `Instalación en modo avanzado`{.action} esté marcada y haga clic en `Siguiente`{.action}.
>>
...
>> - La base de datos está [creada en su instancia Web Cloud Databases](/pages/web_cloud/web_cloud_databases/create-db-and-user-on-db-server): en el menú desplegable `Seleccione la base de datos`{.action}, elija la opción `Base de datos externa al alojamiento web`{.action} e introduzca la información solicitada. El datacenter en el que se alojan el servicio y el alojamiento web es el mismo.
>> - La base de datos está creada en otro plan de hosting de OVHcloud: en el menú desplegable `Seleccione la base de datos`{.action}, elija la opción `Base de datos externa al alojamiento web`{.action} e introduzca la información solicitada. La base de datos y el alojamiento web deben estar alojados en el mismo datacenter.
>>
> **Etapa 6**
>>
