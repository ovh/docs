...
- Your OVHcloud web hosting uses a recent PHP version and a compatible runtime environment. Check the status of the different versions available on this [page](https://webhosting-infos.hosting.ovh.net/). If you need assistance with this, please refer to our [guide](/pages/web_cloud/web_hosting/configure_your_web_hosting), to change this configuration quickly.
...
![Database for advanced installation](images/add-a-module-advanced-mod-step-3.png){.thumbnail}
...
![Module configuration for advanced installation](images/add-a-module-advanced-mod-step-2.png){.thumbnail}
