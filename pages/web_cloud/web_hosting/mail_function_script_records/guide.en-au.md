...
>>
>> ![Email scripts page](/pages/assets/screens/control_panel/product-selection/web-cloud/web-hosting/email-scripts/tab.png){.thumbnail}
>>
...
### Managing the "Disabled", "Bounce" and "spam" states <a name="block-state"></a>
