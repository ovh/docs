...
- You must have a [OVHcloud Web Hosting plan](https://www.ovhcloud.com/asia/web-hosting/){.external}.
- at least one [domain name](https://www.ovhcloud.com/asia/domains/){.external}.
- access to your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia){.external}, in the "Web cloud" section.
