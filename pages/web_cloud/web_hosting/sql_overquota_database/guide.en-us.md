...
If you are migrating to a database outside of the [Start SQL](https://www.ovhcloud.com/en/web-hosting/options/start-sql/) and [Web Cloud Databases](/links/web/databases) solutions, you can manually move the content from your old database to a new one using our guides:
