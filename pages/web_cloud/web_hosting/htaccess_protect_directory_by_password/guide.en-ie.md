...
>
> To do this, contact our [user community](https://community.ovh.com/en/) or [OVHcloud partners](https://partner.ovhcloud.com/en-ie/directory/).
>
...
> 
> To modify the PHP version of your websites on your web hosting plan, please refer to our guide on [Web Hosting : environment, PHP version, .ovhconfig](/pages/web_cloud/web_hosting/configure_your_web_hosting).
>
...
If you have a [Pro](https://www.ovhcloud.com/en-ie/web-hosting/professional-offer/) or [Performance](https://www.ovhcloud.com/en-ie/web-hosting/performance-offer/) hosting plan, then log in with [SSH](/pages/web_cloud/web_hosting/ssh_on_webhosting) to your web hosting. Go to the **root folder** where your script “crypt.php” is located.
...
> [!warning]
>
> For security reasons, SSH is recommended. However, if you have a **Starter** solution or a [Personal](https://www.ovhcloud.com/en-ie/web-hosting/personal-offer/) hosting plan where SSH is unavailable, you can also run the "crypt.php" file via your web browser.
>
