...
> [!warning]
>
> For security reasons, SSH is recommended. However, if you have a **Starter** solution or a [Personal](/links/web/hosting-personal-offer) hosting plan where SSH is unavailable, you can also run the "crypt.php" file via your web browser.
>
