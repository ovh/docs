...
- An [OVHcloud web hosting plan](https://www.ovhcloud.com/asia/web-hosting/) that includes at least one database
...
To install the **SPIP** CMS on your [web hosting](https://www.ovhcloud.com/asia/web-hosting/), you will need to make some preparations.
