...
Para mudar para a utilização do PHP-FPM na versão _estável_ ou para obter detalhes sobre opções mais avançadas do seu alojamento web, consulte [este guia](/pages/web_cloud/web_hosting/ovhconfig_modify_system_runtime){.external}.
...
[Alterar a configuração de um plano de alojamento web](/pages/web_cloud/web_hosting/ovhconfig_modify_system_runtime){.external}
