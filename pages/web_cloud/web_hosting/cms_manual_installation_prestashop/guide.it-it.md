...
![PrestaShop Installstep 4](images/install-store-infos-4.png){.thumbnail}
...
![PrestaShop Installstep 5](images/install-store-content-5.png){.thumbnail}

Scegli e clicca su `Next`{.action}.

#### 2.5 - Associa PrestaShop al tuo database OVHcloud

![PrestaShop Installstep 6](images/install-db-config-6.png){.thumbnail}
...
![PrestaShop Installstep 6-1](images/install-db-config-6-1.png){.thumbnail}
...
![PrestaShop Installstep 7](images/install-resume-7.png){.thumbnail}
