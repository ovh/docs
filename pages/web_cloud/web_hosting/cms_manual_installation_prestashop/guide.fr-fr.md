...
> [!success]
>
> Pour installer PrestaShop **automatiquement** depuis votre [espace client OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), consultez notre documentation sur l'[installation d'un module « en un clic »](/pages/web_cloud/web_hosting/cms_install_1_click_modules).
>
...
![PrestaShop installation step 1](images/install-update-version.png){.thumbnail}
...
![PrestaShop installation step 2](images/install-select-language.png){.thumbnail}
...
![PrestaShop installation step 3](images/install-licence-agreement-3.png){.thumbnail}
...
![PrestaShop installation step 4](images/install-store-infos-4.png){.thumbnail}
...
![PrestaShop installation step 5](images/install-store-content-5.png){.thumbnail}

Faites vos choix puis cliquez sur `Suivant`{.action}.

#### 2.5 - Lier votre PrestaShop avec votre base de données OVHcloud

![PrestaShop installation step 6](images/install-db-config-6.png){.thumbnail}
...
![PrestaShop installation step 6-1](images/install-db-config-6-1.png){.thumbnail}
...
![PrestaShop installation step 7](images/install-resume-7.png){.thumbnail}
