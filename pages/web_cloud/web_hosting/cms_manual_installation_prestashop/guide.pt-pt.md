...
![PrestaShop instalação step 4](images/install-store-infos-4.png){.thumbnail}
...
![PrestaShop instalação step 5](images/install-store-content-5.png){.thumbnail}

Faça as suas escolhas e clique em `Next`{.action}.

#### 2.5 - Associar o seu PrestaShop com a sua base de dados OVHcloud

![PrestaShop instalação step 6](images/install-db-config-6.png){.thumbnail}
...
![PrestaShop instalação step 6-1](images/install-db-config-6-1.png){.thumbnail}
...
![PrestaShop instalação step 7](images/install-resume-7.png){.thumbnail}
