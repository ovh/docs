...
> [!success]
>
> Aby zainstalować PrestaShop **automatycznie** z poziomu [Panelu klienta OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl), zapoznaj się z naszą dokumentacją dotyczącą [instalacji modułu "za jednym kliknięciem"](/pages/web_cloud/web_hosting/cms_install_1_click_modules).
>
...
![PrestaShop instalacja step 4](images/install-store-infos-4.png){.thumbnail}
...
![PrestaShop instalacja step 5](images/install-store-content-5.png){.thumbnail}

Dokonaj wyboru i kliknij na `Next`{.action}.

#### 2.5 - Powiązanie PrestaShop z bazą danych OVHcloud

![PrestaShop instalacja step 6](images/install-db-config-6.png){.thumbnail}
...
![PrestaShop instalacja step 6-1](images/install-db-config-6-1.png){.thumbnail}
...
![PrestaShop instalacja step 7](images/install-resume-7.png){.thumbnail}
