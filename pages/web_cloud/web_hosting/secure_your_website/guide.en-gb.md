...
Also remember to use a recent version of the [PHP programming language](/pages/web_cloud/web_hosting/php_configure_php_on_your_web_hosting_2014) on your Web Hosting plan.
