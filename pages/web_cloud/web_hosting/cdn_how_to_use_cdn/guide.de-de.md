...
>> ![Website](/pages/assets/screens/control_panel/product-selection/web-cloud/web-hosting/my-websites/tab.png){.thumbnail}
>>
>> Klicken Sie anschließend auf den Button `⁝`{.action} rechts neben dem gewünschten Domainnamen oder Subdomain und dann auf `CDN bearbeiten`{.action}.
>>
>> ![Associated domains options](/pages/assets/screens/control_panel/product-selection/web-cloud/web-hosting/my-websites/associated-domains-options.png){.thumbnail}
>>
> **Schritt 4**
...
>>
>>    Gehen Sie zum Tab `Meine Seiten`{.action}, klicken Sie auf die Schaltfläche `⁝`{.action} rechts neben dem betreffenden Domain- oder Subdomain-Namen und dann auf `CDN leeren`{.action}. 
>>
