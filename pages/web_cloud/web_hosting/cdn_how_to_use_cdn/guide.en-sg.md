...
> [!warning]
>
> Some options are locked on the Basic solution and require you to sign up to [CDN Security](https://www.ovhcloud.com/en-sg/web-hosting/options/cdn/) or [CDN Advanced](https://www.ovhcloud.com/en-sg/web-hosting/options/cdn/).
...
> [!warning]
>
> To have a higher quota of rules and more settings available than creating cache rules, you can choose the [Advanced CDN option](https://www.ovhcloud.com/en-sg/web-hosting/options/cdn/).
...
> [!primary]
>
> The options explained below require a subscription to [CDN Security](https://www.ovhcloud.com/en-sg/web-hosting/options/cdn/) or [CDN Advanced](https://www.ovhcloud.com/en-sg/web-hosting/options/cdn/).
...
> [!primary]
>
> The options presented below require a subscription to [CDN Advanced](https://www.ovhcloud.com/en-sg/web-hosting/options/cdn/).
...
> This change is done automatically if your domain name’s active DNS zone is also managed from the [OVHcloud account](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg) containing your web hosting plan.
>
