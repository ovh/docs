...
> **Étape 2**
>>
>> Sur la page qui s'affiche, repérez la mention **Option CDN**. Cliquez sur `...`{.action} à droite puis sur `Commander un CDN`{.action}, ou sur `Activer l'option`{.action} si l'option CDN est déjà incluse dans votre hébergement.
>>
>> > [!primary]
>> > 
...
>> ![Website](/pages/assets/screens/control_panel/product-selection/web-cloud/web-hosting/my-websites/tab.png){.thumbnail}
>>
>> Cliquez ensuite sur le bouton `⁝`{.action} situé à droite du nom de domaine ou sous-domaine concerné, puis sur `Purger le CDN`{.action}.
>>
...
>> ![Website](/pages/assets/screens/control_panel/product-selection/web-cloud/web-hosting/my-websites/tab.png){.thumbnail}
>>
>> Cliquez ensuite sur le bouton `⁝`{.action} situé à droite du nom de domaine ou sous-domaine concerné, puis sur `Modifier le CDN`{.action}.
>>
>> ![Associated domains options](/pages/assets/screens/control_panel/product-selection/web-cloud/web-hosting/my-websites/associated-domains-options.png){.thumbnail}
>>
> **Étape 4**
