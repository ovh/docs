...
If you have a [Pro](/links/web/hosting-professional-offer) or [Performance](https://www.ovhcloud.com/en-ca/web-hosting/performance-offer/) Web Hosting plan, click on the `...`{.action} button to the right of the FTP user concerned, then on `Edit`{.action}.
...
If you have a [Pro](/links/web/hosting-professional-offer) or [Performance](https://www.ovhcloud.com/en-ca/web-hosting/performance-offer/) Web Hosting plan, use the [SSH protocol](/pages/web_cloud/web_hosting/ssh_on_webhosting) to import files on to your file storage space.
