...
Aby wyświetlić ewentualne błędy PHP, przejdź do trybu `programowania`, korzystając z tych [wskazówek](/pages/web_cloud/web_hosting/ovhconfig_modify_system_runtime#etap-2-zmiana-konfiguracji-hostingu).
