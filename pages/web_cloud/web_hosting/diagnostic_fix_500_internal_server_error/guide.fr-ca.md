...
Afin de faire apparaître d'éventuelles erreurs PHP, passez ensuite votre hébergement en mode `développement` grâce à ces [indications](/pages/web_cloud/web_hosting/ovhconfig_modify_system_runtime#modifier-la-configuration-de-lhebergement-web-depuis-lespace-client).
