...
To find the IP address of your [OVHcloud hosting plan](https://www.ovhcloud.com/asia/web-hosting/), click on `Web Cloud`{.action} in the top of your [OVHcloud Control Panel](/links/manager), then on `Hosting plans`{.action}.
