...
Il vous faut maintenant vérifier que l'adresse IP indiquée dans la [Zone DNS](/pages/web/domains/dns_zone_edit#comprendre-la-notion-de-dns) correspond bien à celle de votre [hébergement Web Cloud](https://www.ovhcloud.com/fr-ca/web-hosting/).
