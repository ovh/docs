...
- A [database associated with your hosting](https://www.ovhcloud.com/en-ie/web-hosting/options/start-sql/) or a [Web Cloud Databases](https://www.ovh.ie/cloud/cloud-databases/)
...
- If your database is located in the section of the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie) dedicated to your [Web Cloud Databases solutions](https://www.ovh.ie/cloud/cloud-databases/), follow [these instructions](#case2).
