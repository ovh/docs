...
- Configure one or more databases ([included with some of our web hosting plans](https://www.ovhcloud.com/en-au/web-hosting/)).
- etc.
...
Once you have logged in to your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au), this option allows you to quickly install the *WordPress*, *Joomla!*, *PrestaShop* and *Drupal* CMS on your hosting.
...
Your [Web Hosting plan](https://www.ovhcloud.com/en-au/web-hosting/) includes one or more email accounts, which you can choose to enable or disable.
...
No matter which [web hosting](https://www.ovhcloud.com/en-au/web-hosting/) you are using, you can activate an SSL certificate from **Let's encrypt** free of charge.
...
If you have a **Performance** web hosting plan, you can activate a [Web Cloud Databases](https://www.ovhcloud.com/en-au/web-cloud/databases/) for free.
