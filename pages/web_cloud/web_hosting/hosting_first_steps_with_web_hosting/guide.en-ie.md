...
OVHcloud offers [several web hosting plans](https://www.ovhcloud.com/en-ie/web-hosting/). They are designed for different use cases:
...
- You have a [domain name](https://www.ovhcloud.com/en-ie/domains/).
...
The purpose of this guide is to show you the main actions you can take with our [web hosting](https://www.ovhcloud.com/en-ie/web-hosting/) solutions. 
Each of these actions will be accompanied by one or more links to specific guides (relevant to the action).

You can use this guide as a "repository" of possible actions when you subscribe to your [web hosting](https://www.ovhcloud.com/en-ie/web-hosting/) offer and throughout its use.
...
Depending on your answers, please ensure that your [web hosting plan](https://www.ovhcloud.com/en-ie/web-hosting/) meets all of your needs before you proceed.
...
Depending on your [web hosting plan](https://www.ovhcloud.com/en-ie/web-hosting/), additional options/offers/features are available free of charge.
...
All [web hosting](https://www.ovhcloud.com/en-ie/web-hosting/) allow you to send emails free of charge from your website or a specific script.
