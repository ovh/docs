...
- Disposer d'une ou plusieurs bases de données ([incluses avec certaines de nos offres d'hébergement web](https://www.ovhcloud.com/fr/web-hosting/)).
- etc.
...
Une fois connecté à votre [espace client OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) et via votre hébergement web, cette option vous permet d'installer rapidement les CMS *WordPress*, *Joomla!*, *PrestaShop* et *Drupal*.
...
Si votre offre d'[hébergement web](https://www.ovhcloud.com/fr/web-hosting/) dispose de cette option, consultez notre guide « [Créer des tâches automatisées (CRON) sur votre hébergement Web](/pages/web_cloud/web_hosting/cron_tasks) » pour plus de détails.
