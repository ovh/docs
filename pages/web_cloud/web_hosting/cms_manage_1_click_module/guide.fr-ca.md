...
> **Étape 2**
>>
>> Cliquez sur l'onglet `Modules en 1 clic`{.action}. L'identifiant administrateur de votre module apparaît dans la colonne `Login`.
>>
> **Étape 3**
>>
...
Vous pouvez également changer le mot de passe d’accès à l’interface d’administration de votre CMS directement depuis votre base de données.<br>
...
> **Étape 3**
>>
>> Cliquez sur le bouton `...`{.action} à droite de la ligne désignant votre module puis sur la commande `Supprimer le module`{.action}.
>>
>> > [!success]
...
> **Étape 2**
>>
>> Cliquez sur `...`{.action} à droite de la ligne désignant la base de données, puis sur `Supprimer la base de données`{.action}.
>>
> **Étape 3**
>>
