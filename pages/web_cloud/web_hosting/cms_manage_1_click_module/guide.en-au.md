...
>
> If you have a [Personal Hosting](/links/web/hosting-personal-offer) offer or if you already created all four databases of your [Pro](/links/web/hosting-professional-offer) or [Performance Hosting](https://www.ovhcloud.com/en-au/web-hosting/performance-offer/), you will need to delete the database identified in [step 1](#step1) **BEFORE** creating a new 1-click module.
>
