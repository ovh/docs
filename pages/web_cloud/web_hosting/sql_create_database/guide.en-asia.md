...
- A [OVHcloud web hosting plan](https://www.ovhcloud.com/asia/web-hosting/) that includes at least one database.
- You need to have a database available to “create” from the databases included in your Web Hosting plan. If required, you can add [Start SQL](https://www.ovhcloud.com/aisa/web-hosting/options/start-sql/) databases to your web hosting plan.
- Access to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia) with the [necessary permissions](/pages/account_and_service_management/account_information/managing_contacts) to manage your web hosting plan
