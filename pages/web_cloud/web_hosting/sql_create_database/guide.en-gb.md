...
- You need to have a database available to “create” from the databases included in your Web Hosting plan. If required, you can add [Start SQL](https://www.ovhcloud.com/en-gb/web-hosting/options/start-sql/) databases to your web hosting plan.
