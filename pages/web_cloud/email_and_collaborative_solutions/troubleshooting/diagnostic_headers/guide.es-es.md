...
1. Seleccione el correo electrónico de su elección.
2. Haga clic en el botón `... Más`{.action} y luego en `< > Ver código fuente`{.action}.
...
![Ver código fuente en Roundcube](images/roundcube01.png){.thumbnail}

##### **Obtener el archivo .eml**

1. Seleccione el correo electrónico de su elección.
2. Haga clic en el botón `... Más`{.action} y luego en `Descargar (.eml)`{.action}.

![Descargar archivo eml en Roundcube](images/roundcube02.png){.thumbnail}
...
1. Seleccione el correo electrónico de su elección.
2. Haga clic en `Más`{.action} en la barra de acciones y seleccione `Mostrar original`{.action}.
3. Se abrirá una nueva ventana con la cabecera completa y el contenido bruto del correo electrónico.

![Detalles del mensaje en Zimbra](images/zimbra-01.png){.thumbnail}
