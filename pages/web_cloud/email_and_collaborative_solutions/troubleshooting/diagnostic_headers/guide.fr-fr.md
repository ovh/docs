...
L'en-tête est composé de plusieurs éléments indiquant le cheminement de l'e-mail. Il est composé d'éléments hiérarchisés de façon antéchronologique, et d'informations supplémentaires.<br>
...
1. Ouvrez l’e-mail de votre choix dans une fenêtre séparée en double-cliquant sur celui-ci dans la liste.
2. Dans la nouvelle fenêtre, cliquez sur `Fichier`{.action} en haut à gauche.
![Menu Fichier dans Outlook](images/outlook01.png){.thumbnail}
3. Sélectionnez `Informations`{.action} sur la gauche puis cliquez sur `Propriétés`{.action}.
![Informations et Propriétés dans Outlook](images/outlook02.png){.thumbnail}
...
![En-tête complet affiché dans Outlook](images/outlook03.png){.thumbnail}

**Nouvel Outlook :**

1. Ouvrez l’e-mail de votre choix.
2. Cliquez sur `Autres actions`{.action} (⋯) en haut de la fenêtre du message.
...
2. Appuyez simultanément sur les touches `Ctrl` \+ `U`.
![En-tête complet affiché dans Thunderbird](images/thunderbird01.png){.thumbnail}
...
1. Sélectionnez l'e-mail de votre choix.
2. Cliquez sur `Fichier`{.action} dans la barre de menu et sélectionnez `Enregistrer sous`{.action}.
...
1. Sélectionnez l'e-mail de votre choix.
2. Rendez-vous sur `Présentation`{.action} dans la barre de menu supérieure, puis dans `Message`{.action} et cliquez sur `Tous les en-têtes`.
![En-tête complet affiché dans Mail macOS](images/mailmac01.png){.thumbnail}
3. L'en-tête complet de l'e-mail apparaît dans une fenêtre séparée. Sélectionnez l'ensemble du texte et copiez-le dans un fichier.

##### **Récupérer le fichier .eml**

1. Sélectionnez l'e-mail de votre choix.
2. Glissez-le directement sur votre Bureau ou dans un dossier du Finder. Le fichier `.eml` est automatiquement créé.
...
3. Cliquez sur la flèche qui pointe vers le bas à côté de la pièce jointe que vous venez de générer, puis cliquez sur `Télécharger`{.action} pour enregistrer le fichier sur votre machine.
