...
/// details | Sind mein E-Mail Angebot und/oder meine Accounts aktiv?  (**Versand** und **Empfang**)
...
> **Domainname**
>>
>> Gehen Sie in den Bereich `Web Cloud`{.action}, klicken Sie auf `Domainnamen`{.action} und wählen Sie Ihre Domain aus. Wenn Ihre Domain abgelaufen ist, wird dies am oberen Ende der Seite angezeigt.
>>
> **Webhosting**
>>
>> Gehen Sie in den Bereich `Web Cloud`{.action}, klicken Sie auf `Hosting-Pakete`{.action} und wählen Sie Ihr Hosting aus. Das Ablaufdatum oder das Datum der automatischen Verlängerung Ihres Webhostings wird oben angegeben.
>>
> **E-Mail-Account MX Plan**
>>
>> Gehen Sie in den Bereich `Web Cloud`{.action}, klicken Sie auf `E-Mails`{.action} (oder `MX Plan`{.action} je nach Angebot) und wählen Sie die betreffende Domain aus. Klicken Sie auf den Tab `E-Mail-Accounts`{.action}. Überprüfen Sie in der Spalte `Wegen SPAM gesperrt` den Status des betreffenden E-Mail-Accounts.
>>
> **E-Mail Pro**
>>
>> Gehen Sie in den Bereich `Web Cloud`{.action}, klicken Sie auf `E-Mail Pro`{.action} und wählen Sie Ihre Plattform aus. Klicken Sie auf den Tab `E-Mail-Accounts`{.action}. Überprüfen Sie in der Spalte `Status` den Status des betreffenden E-Mail-Accounts.
>>
> **Exchange**
>>
>> Gehen Sie in den Bereich `Web Cloud`{.action}, klicken Sie im Bereich **Microsoft** auf `Exchange`{.action} und wählen Sie Ihren Dienst aus. Klicken Sie auf den Tab `E-Mail-Accounts`{.action}. Überprüfen Sie in der Spalte `Status` den Status des betreffenden E-Mail-Accounts.
>>
> **Zimbra**
>>
>> Gehen Sie in den Bereich `Web Cloud`{.action} und klicken Sie auf `Zimbra Mail`{.action}. Klicken Sie auf den Tab `E-Mail-Account`{.action}. Überprüfen Sie in der Spalte `Status` den Status des betreffenden E-Mail-Accounts.

///

/// details | Ich kann keine E-Mails von meinem E-Mail-Programm aus versenden und/oder empfangen (**Versand** und/oder **Empfang**)
...
/// details | Ich kann keine E-Mails empfangen, da meine E-Mail-Adresse voll ist und ich keinen Speicherplatz mehr habe. Was kann ich tun?
...
/// details | Sind die E-Mails über das Webmail-Interface funktionsfähig? (**Versand** und/oder **Empfang**)
...
/// details | Ich kann mich nicht mit dem Webmail verbinden
...
> **E-Mail Pro**
>>
>> Für ein **E-Mail Pro** Angebot gehen Sie in den Bereich `Web Cloud`{.action}, klicken Sie auf `E-Mail Pro`{.action} und wählen Sie Ihren Dienst aus. Klicken Sie im Tab `E-Mail-Accounts`{.action} auf `...`{.action} und dann auf `Ändern`{.action}, um das Passwort zu ändern.
>>
> **Exchange**
>>
>> Für ein **Exchange** Angebot gehen Sie in den Bereich `Web Cloud`{.action}, klicken Sie im Bereich **Microsoft** auf `Exchange`{.action} und wählen Sie Ihren Dienst aus. Klicken Sie im Tab `E-Mail-Accounts`{.action} auf `...`{.action} und dann auf `Ändern`{.action}, um das Passwort zu ändern. <br> Überprüfen Sie, ob die Zwei-Faktor-Authentifizierung aktiviert ist mithilfe unserer Anleitung zur [Zwei-Faktor-Authentifizierung für Exchange](/pages/web_cloud/email_and_collaborative_solutions/microsoft_exchange/manage_2fa_exchange).
>>
> **Zimbra**
>>
>> Für ein **Zimbra** Angebot gehen Sie in den Bereich `Web Cloud`{.action} und klicken Sie auf `Zimbra Mail`{.action}. Klicken Sie im Tab `E-Mail-Account`{.action} auf `⋮`{.action} und dann auf `Ändern`{.action}, um das Passwort zu ändern.

///

/// details | Ist mein Dienst von einer Störung oder Wartung betroffen? (**Versand** und/oder **Empfang**)
...
/// details | Ist die Domain korrekt mit meinem E-Mail-Dienst verbunden? (**Empfang**)
...
/// details | Nach dem Senden einer E-Mail erhalte ich eine Meldung, dass meine E-Mail nicht gesendet werden konnte, einschließlich eines 3-stelligen Codes (**Versand**)
...
[Speicherplatz eines E-Mail-Accounts verwalten](/pages/web_cloud/email_and_collaborative_solutions/troubleshooting/email_manage_quota)

[Was tun, wenn ein Account aufgrund Spamversands gesperrt wurde?](/pages/web_cloud/email_and_collaborative_solutions/troubleshooting/locked_for_spam)
