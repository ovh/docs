...
> **Alojamiento web**
>>
>> Acceda a la sección `Web Cloud`{.action}, haga clic en `Alojamientos`{.action} y seleccione el alojamiento. La fecha de expiración o de renovación automática del alojamiento se indica en la parte superior de la página.
>>
...
> **Email Pro**
>>
>> Acceda a la sección `Web Cloud`{.action}, haga clic en `Email Pro`{.action} y seleccione su plataforma. Haga clic en la pestaña `Cuentas de correo`{.action}. Compruebe el estado de la cuenta de correo en la columna `Estado`.
>>
> **Exchange**
>>
>> Acceda a la sección `Web Cloud`{.action}, haga clic en `Exchange`{.action} en la sección **Microsoft** y seleccione su plataforma. Haga clic en la pestaña `Cuentas de correo`{.action}. Compruebe el estado de la cuenta de correo en la columna `Estado`.
>>
> **Zimbra**
>>
>> Acceda a la sección `Web Cloud`{.action} y haga clic en `Zimbra Mail`{.action}. Haga clic en la pestaña `Cuenta de correo`{.action}. Compruebe el estado de la cuenta de correo en la columna `Estado`.

///

/// details | No consigo enviar y/o recibir correos desde mi cliente de correo (**envío** y/o **recepción**)
...
1. Desde un navegador de Internet, conéctese al [webmail](/links/web/email) con la dirección de correo electrónico correspondiente.
...
/// details | No puedo recibir correos electrónicos porque mi dirección de correo electrónico está llena, no tengo espacio. ¿Qué puedo hacer?
...
/// details | ¿Los mensajes de correo funcionan desde el webmail? (**envío** y/o **recepción**)
...
/// details | No consigo conectarme al webmail
...
Puede consultar las distintas tareas en curso en <https://web-cloud.status-ovhcloud.com/>.
...
/// details | Tras el envío de un email, recibo un mensaje indicando que no ha podido enviarse mi email, que incluye un código de 3 cifras (**envío**)
...
[Gestionar el espacio de almacenamiento de una cuenta de correo](/pages/web_cloud/email_and_collaborative_solutions/troubleshooting/email_manage_quota)

[¿Qué hacer con una cuenta bloqueada debido a correo no deseado?](/pages/web_cloud/email_and_collaborative_solutions/troubleshooting/locked_for_spam)
