...
> **Email Pro**
>>
>> For an **Email Pro** solution, go to the `Web Cloud`{.action} section, click `Email Pro`{.action}, then select your platform. In the `Email accounts`{.action} tab, click the `...`{.action} button, then click `Modify`{.action} to change the password.
>>
> **Exchange**
>>
...
> **Zimbra**
>>
>> For a **Zimbra** solution, go to the `Web Cloud`{.action} section and click `Zimbra Mail`{.action}. In the `Email account`{.action} tab, click the `⋮`{.action} button, then click `Modify`{.action} to change the password.
