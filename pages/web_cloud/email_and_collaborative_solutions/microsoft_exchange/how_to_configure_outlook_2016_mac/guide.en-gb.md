...
OVHcloud offers a web application that includes various [collaborative features](/links/web/emails), which can be accessed at <https://www.ovhcloud.com/en-gb/mail/>. You can log in using your email credentials.
