...
OVHcloud oferuje aplikację internetową wyposażoną w [funkcje do pracy zespołowej](/links/web/emails). Jest ona dostępna pod adresem <https://www.ovh.pl/mail/>. Możesz się do niej zalogować, używając tych samych danych, których używasz do logowania się do konta e-mail.
