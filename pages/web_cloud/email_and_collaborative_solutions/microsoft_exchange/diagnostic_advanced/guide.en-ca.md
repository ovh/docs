...
> [!warning]
> In our guides, we use as the server name: `ex.mail.ovh.ca` You will need to replace the "?" with the actual number indicating the appropriate server  for your Exchange service.
>
