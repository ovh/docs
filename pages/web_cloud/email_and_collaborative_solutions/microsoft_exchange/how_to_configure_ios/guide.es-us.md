...
OVHcloud también ofrece una aplicación web que tiene las [funciones colaborativas de Exchange](/links/web/emails-hosted-exchange) y está disponible en la dirección <https://www.ovh.com/world/es/mail/>. Puede acceder con el nombre de usuario y la contraseña de su dirección de correo electrónico.
