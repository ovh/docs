...
OVHcloud also offers a web application that includes [Exchange collaborative features](https://www.ovh.com/world/emails/), accessible via <https://www.ovh.com/world/mail/>. You can log in using your email credentials.
