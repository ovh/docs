...
No âmbito das nossas ofertas [**Hosted Exchange**](/links/web/emails-hosted-exchange) e [**E-mail Pro**](/links/web/email-pro), este registo CNAME é utilizado como código de validação (token) que será visível na zona DNS do nome de domínio a validar. O objetivo é verificar se o utilizador da plataforma de e-mail é o gestor do nome de domínio que adiciona.

No diagrama abaixo, a plataforma de e-mail ([Exchange](/links/web/emails-exchange) ou [E-mail Pro](/links/web/email-pro)) é representada pelo quadro verde.<br>
