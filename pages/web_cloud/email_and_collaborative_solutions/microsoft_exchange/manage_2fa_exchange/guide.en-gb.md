...
<!-- CP-STEPS-START:enable-2fa-platform -->
...
Switch to the `Security`{.action} tab.
...
<!-- CP-STEPS-END:enable-2fa-platform -->

#### Step 2: Enable two-factor authentication on an account

<!-- CP-STEPS-START:enable-2fa-account -->
...
<!-- CP-STEPS-END:enable-2fa-account -->

### Disabling two-factor authentication

<!-- CP-STEPS-START:disable-2fa -->
