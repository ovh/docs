...
- An [Exchange](https://www.ovhcloud.com/en-gb/emails/hosted-exchange/){.external} or [Email Pro](/links/web/email-pro){.external} service with at least one unconfigured account (which will appear as “@configureme.me”).
