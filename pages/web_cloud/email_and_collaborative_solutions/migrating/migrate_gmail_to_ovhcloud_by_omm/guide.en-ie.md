...
- an email service with OVHcloud, e.g. [Exchange](https://www.ovhcloud.com/en-ie/emails/){.external}, [Email Pro](/links/web/email-pro){.external} or MX Plan (via the MX Plan standalone tool or included in an [OVHcloud web hosting](https://www.ovhcloud.com/en-ie/web-hosting/){.external} plan)
