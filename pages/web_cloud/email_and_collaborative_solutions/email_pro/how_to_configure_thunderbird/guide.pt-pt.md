...
>
> Clique [neste link](/links/control-panel/web-email-pro) para aceder à secção `E-mail Pro`{.action}. O nome do servidor está visível na seção **Ligação** da aba `Informações gerais`{.action}.
