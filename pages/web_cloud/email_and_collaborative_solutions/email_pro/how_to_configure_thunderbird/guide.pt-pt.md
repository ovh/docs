...
>
> Clique [neste link](/links/control-panel/web-email-pro) para aceder à secção `Email Pro`{.action}. O nome do servidor está visível na seção **Ligação** da aba `Informações gerais`{.action}.
