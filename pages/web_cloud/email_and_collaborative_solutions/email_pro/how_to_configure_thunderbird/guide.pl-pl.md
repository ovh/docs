...
>
> Kliknij [ten link](/links/control-panel/web-email-pro), aby uzyskać dostęp do sekcji `E-mail Pro`{.action}. Nazwa serwera jest widoczna w sekcji **Logowanie** karty `Informacje ogólne`{.action}.
