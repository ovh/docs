...
OVHcloud also offers a web application that includes [collaborative features](/links/web/emails), accessible via <https://www.ovh.ie/mail/>. You can log in using your email credentials.
...
> [!primary]
>
> For more information on configuring an email address from your iOS device, see [Apple's Help page](https://support.apple.com/en-ie/102619).
