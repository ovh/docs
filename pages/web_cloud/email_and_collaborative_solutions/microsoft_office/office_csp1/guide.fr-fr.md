...
Si vous ne parvenez pas à résilier votre groupe de licences, contactez nos équipes du support en ouvrant un ticket depuis le [centre d'aide](https://help.ovhcloud.com/csm?id=csm_cases_requests).
