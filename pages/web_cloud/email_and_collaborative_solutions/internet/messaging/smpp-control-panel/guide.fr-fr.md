...
> [!primary]
>
> Nous vous recommandons de prendre connaissance des [spécifications techniques de l'offre SMPP OVHcloud](/pages/web_cloud/email_and_collaborative_solutions/internet/messaging/smpp-specification).
...
Consultez nos guides sur la [gestion des expéditeurs](/pages/web_cloud/email_and_collaborative_solutions/internet/messaging/envoyer_des_sms_depuis_mon_espace_client#etape-3-choisir-votre-expediteur-sms) et sur la [gestion des crédits SMS et la recharge automatique](/pages/web_cloud/email_and_collaborative_solutions/internet/messaging/activer_la_recharge_automatique_du_credit_sms).
...
[Les spécifications techniques de l'offre SMPP OVHcloud](/pages/web_cloud/email_and_collaborative_solutions/internet/messaging/smpp-specification).
