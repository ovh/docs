...
Puede consultar el resto de códigos PTT en la siguiente [guía](/pages/web_cloud/email_and_collaborative_solutions/internet/messaging/tout_savoir_sur_les_utilisateurs_sms).
