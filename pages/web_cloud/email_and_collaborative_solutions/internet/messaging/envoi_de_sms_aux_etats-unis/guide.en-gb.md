...
You can view the other possible return codes in [this guide](/pages/web_cloud/email_and_collaborative_solutions/internet/messaging/tout_savoir_sur_les_utilisateurs_sms).
