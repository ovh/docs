...
Vous pouvez consulter les autres codes de retour possibles sur [ce guide](/pages/web_cloud/email_and_collaborative_solutions/internet/messaging/tout_savoir_sur_les_utilisateurs_sms).
