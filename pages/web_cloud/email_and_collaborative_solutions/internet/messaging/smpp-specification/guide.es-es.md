...
routes:
    canonical: '/pages/web_cloud/email_and_collaborative_solutions/internet/messaging/smpp-specification'
...
[Managing an SMS SMPP account](/pages/web_cloud/email_and_collaborative_solutions/internet/messaging/smpp-control-panel)
