...
Si votre modem est de marque Zyxel, veuillez suivre le guide [Comment activer le bridge sur un modem zyxel](/pages/web_cloud/email_and_collaborative_solutions/internet/internet_access/comment_activer_bridge_zyxel).
>
...
|---|---|
|Bloc IP|Si vous [disposez d'un bloc IP](/pages/web_cloud/email_and_collaborative_solutions/internet/internet_access/comment_commander_et_gerer_un_bloc_ip_29), vous pouvez activer ou désactiver celui-ci. Toute la configuration de votre box va alors s'adapter automatiquement (par exemple : désactivation pare-feu + NAT).|
