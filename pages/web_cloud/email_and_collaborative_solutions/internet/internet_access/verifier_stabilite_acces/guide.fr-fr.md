...
* l'envoi manuel de [nouveaux identifiants de connexion](/pages/web_cloud/email_and_collaborative_solutions/internet/internet_access/obtenir_id_ppp).
