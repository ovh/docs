...
> [!primary]
>
> Ce guide ne concerne que les modems de marque Zyxel. Pour activer le mode bridge sur un modem Thomson ou Technicolor, l'activation se fait depuis l'espace client OVHcloud. Pour cela, vous pouvez consulter le guide [Configurer sa box à partir de l’espace client OVHcloud](/pages/web_cloud/email_and_collaborative_solutions/internet/internet_access/configuration_du_modem_a_partir_de_votre_espace_client)
>
...
Pour revenir en mode routeur suivez le guide [Redémarrer ou réinitialiser une box OVHcloud](/pages/web_cloud/email_and_collaborative_solutions/internet/internet_access/restart_reboot_modem#reinitialiser-votre-box-ovh) pour réinitialiser votre modem Zyxel et rétablir sa configuration par défaut.
