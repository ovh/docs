...
> Veuillez vous reporter au guide suivant pour les offres OverTheBox actuelles : [Installation OverTheBox Plus ou IT v2](/pages/web_cloud/email_and_collaborative_solutions/internet/overthebox/plus_itv2_installation)
>
...
Dans ce cas, vous devez modifier l'adresse IP de l'un des deux modems, ce guide détaille la procédure à suivre en fonction de votre fournisseur d'accès : [Désactiver le serveur DHCP de votre modem](/pages/web_cloud/email_and_collaborative_solutions/internet/overthebox/intel_itv1_desactiver_dhcp_modem)
...
> Voir le guide [Désactiver le serveur DHCP de votre modem](/pages/web_cloud/email_and_collaborative_solutions/internet/overthebox/intel_itv1_desactiver_dhcp_modem)
>
...
Si vous devez utiliser la télévision via l'un des modems pris en charge par **OverTheBox**, veuillez suivre la procédure décrite sur le guide suivant : [Intégration d'un Décodeur TV](/pages/web_cloud/email_and_collaborative_solutions/internet/overthebox/intel_itv1_integration_decodeur_tv){.external}.
