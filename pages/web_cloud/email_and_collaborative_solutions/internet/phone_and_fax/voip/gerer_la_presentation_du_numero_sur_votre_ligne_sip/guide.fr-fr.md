...
> 
> - le numéro pour lequel vous souhaitez modifier la présentation dispose bien d'une redirection avec présentation. Si besoin, reportez-vous aux instructions décrites dans notre documentation [Créer une redirection avec présentation](/pages/web_cloud/email_and_collaborative_solutions/internet/phone_and_fax/voip/redirection_avec_presentation).
>
