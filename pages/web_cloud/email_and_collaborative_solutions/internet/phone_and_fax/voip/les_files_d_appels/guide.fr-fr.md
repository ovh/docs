...
> Consultez notre [FAQ](/pages/web_cloud/email_and_collaborative_solutions/internet/phone_and_fax/voip/faq-voip) pour plus d'informations sur les différences entre un numéro alias et une ligne SIP.
>
...
- **« Stratégie de sonnerie »** : définissez la manière dont les lignes de votre file d'appels sonneront. Selon celle choisie, vous serez peut-être amené à [modifier l'ordre des lignes de la file](/pages/web_cloud/email_and_collaborative_solutions/internet/phone_and_fax/voip/les_files_d_appels#3-organiser-les-lignes-de-la-file-dappels) ;
