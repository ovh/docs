...
- an MX Plan email address (included in the MX Plan solution, or in an [OVHcloud web hosting plan](https://www.ovhcloud.com/en-ca/web-hosting/)).
...
> [!success]
>
> OVHcloud offers a web application that allows you to access your email address from a web browser, at <https://www.ovhcloud.com/en-ca/mail/>. You can log in using your email credentials.
