...
Pour la réception des e-mails, lors du choix du type de compte, nous vous conseillons une utilisation en **IMAP**. Vous pouvez cependant sélectionner **POP**. pour comprendre leurs fonctionnements, consultez notre section [« POP ou IMAP quel est la différence ? »](#popimap)
...
1. **Votre appareils** : un ordinateur, un smartphone ou une tablette. C'est votre support de consultation.
