...
- You need to have an MX Plan email address (included in the MX Plan solution and in [OVHcloud Web Hosting plans](https://www.ovhcloud.com/en/web-hosting/)).
...
OVHcloud also has a web application you can use to access your email account from your browser, via the following address: <https://www.ovh.com/world/mail/>. You can log in using your email credentials.
