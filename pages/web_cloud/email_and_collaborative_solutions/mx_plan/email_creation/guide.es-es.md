...
- Tener una solución MX Plan (incluida en un [plan de hosting de OVHcloud](/links/web/hosting){.external}, en un [Alojamiento gratuito 100M](https://www.ovhcloud.com/es-es/domains/free-web-hosting/){.external} o contratada por separado).
