...
Go to the [Webmail login](https://www.ovh.com/ca/en/mail/) page, then enter the email address and password. Then click the `Login`{.action} button.
...
Go to the [Webmail login](https://www.ovh.com/ca/en/mail/) page, then enter the email address and password. Then click the `Login`{.action} button. Your inbox will appear.
