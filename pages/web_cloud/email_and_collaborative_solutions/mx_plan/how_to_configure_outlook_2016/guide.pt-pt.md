...
> **Passo 3**
>>
>> Introduza a palavra-passe do seu endereço de e-mail, depois clique em `Conectar-se`{.action}.
>>
...
>>
>> Clique em `Modificar as definições da conta`{.action}.
>>
...
>> - Selecione `Definições do servidor`{.action} **(3)** para abrir a janela de configuração.
>>
...
>>
>> - A janela de definições da conta aparece: selecione a conta de e-mail em questão, depois clique em `Modificar...`{.action}.
>>
