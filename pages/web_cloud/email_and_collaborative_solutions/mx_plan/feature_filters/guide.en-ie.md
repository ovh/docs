...
> [!warning]
>
> The following instructions are only eligible for the legacy MX Plan solution. For our current solution, you can manage filters directly via OWA (**O**utlook **W**eb **A**ccess). You can identify which version you are using with the table below.
>
