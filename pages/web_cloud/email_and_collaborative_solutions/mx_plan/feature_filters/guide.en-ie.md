...
> It helps prevent potential identity theft from email addresses that use your domain name (spoofing). For more information on the SPF record, please refer to our guide on [Improve email security with a SPF record](/pages/web_cloud/domains/dns_zone_spf) .
