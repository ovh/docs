...
/// details | Como alterar a sua oferta Zimbra ?

Os seus requisitos mudam: pretende beneficiar de mais funcionalidades na sua conta Zimbra ou, pelo contrário, já não necessita delas. As ofertas Zimbra são flexíveis, siga as instruções abaixo de acordo com a sua situação:

**Pretende passar para uma oferta superior ?**
...
**Pretende passar para uma oferta inferior ?**

As etapas são as mesmas que para a mudança para uma oferta superior (detalhadas acima).
