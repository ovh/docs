---
title: 'MX Plan - Agregar una cuenta de correo electrónico en el nuevo Outlook para Windows'
...
- Disponer de una solución de correo electrónico OVHcloud **Plan MX** ofrecido con nuestras [ofertas de hosting web](/links/web/hosting).
...
>
> Para configurar su dirección de correo MX plan en Outlook clásico, consulte nuestro guía "[MX Plan - Configurar su dirección de correo en Outlook clásico para Windows](/pages/web_cloud/email_and_collaborative_solutions/mx_plan/how_to_configure_outlook_2016)".
