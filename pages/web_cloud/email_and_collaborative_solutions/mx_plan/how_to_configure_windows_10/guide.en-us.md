...
excerpt: "Find out how to configure your email address from the MX Plan on the New Outlook for Windows"
updated: 2026-01-09
---
...
The email addresses from the **MX Plan** offers can be configured on a compatible email client. This allows you to send and receive messages from your preferred application.
...
- You have an OVHcloud email solution **MX Plan** offered with our [web hosting services](/links/web/hosting).
