...
Dans cette documentation nous utiliserons l'adresse e-mail d'exemple `john.smith@mydomain.ovh` et le dossier de la mallette que nous monterons sera le dossier `Briefcase` qui est présent par défaut.
