...
If you are using an apex domain (`example.com`), see the additional information about [Apex domains and CNAME records](/pages/web_cloud/web_paas_powered_by_platform_sh/domains/domains-steps/dns).

If you are planning to host multiple subdomains on different projects, see the additional information about [Subdomains](/pages/web_cloud/web_paas_powered_by_platform_sh/domains/domains-steps/subdomains) *before* you add your domain to Web PaaS.
