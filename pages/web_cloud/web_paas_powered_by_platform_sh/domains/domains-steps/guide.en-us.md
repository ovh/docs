...
If you are using an apex domain (`example.com`), see the additional information about [Apex domains and CNAME records](/pages/web_cloud/web_paas_powered_by_platform_sh/domains/dns).

If you are planning to host multiple subdomains on different projects, see the additional information about [Subdomains](/pages/web_cloud/web_paas_powered_by_platform_sh/domains/subdomains) *before* you add your domain to Web PaaS.
...
While not required, it's strongly recommended that you set up [health notifications](/pages/web_cloud/web_paas_powered_by_platform_sh/integrations/integrations-notifications) to advise you if your site is experiencing issues such as running low on disk space.  Notifications can be sent via email, Slack, or PagerDuty.
