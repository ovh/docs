...
That can be done through the [management console](/pages/web_cloud/web_paas_powered_by_platform_sh/administration-web) or via the command line, like so:
