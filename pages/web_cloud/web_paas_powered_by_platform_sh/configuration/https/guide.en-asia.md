...
```
Note that DNS changes can take up to 24-48 hours to propagate.  If you have waited the 24-48 hours, properly configured the subdomain, and are still seeing an error of this type, [redeploying](/pages/web_cloud/web_paas_powered_by_platform_sh/development/development-redeploy) the impacted environment will usually solve the issue.
