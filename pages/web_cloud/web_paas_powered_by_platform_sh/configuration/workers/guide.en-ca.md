...
Note that [`deploy` and `post_deploy` hooks](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/build), as well as [`cron` commands](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/cron), will run only on the [`web`](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/web) container, not on workers.

## Inheritance

Any top-level definitions for [`size`](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/size), [`relationships`](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/relationships), [`access`](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/access), [`disk` and `mount`](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/storage), and [`variables`](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/variables) will be inherited by every worker, unless overridden explicitly.
