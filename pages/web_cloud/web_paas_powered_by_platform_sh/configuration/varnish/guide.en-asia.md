...
- Connect to your cluster [using ssh](/pages/web_cloud/web_paas_powered_by_platform_sh/development/development-ssh) or through the CLI `webpaas ssh -p <project id>`,

- Display the [relationships array](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/configuration-app/relationships) with `echo $PLATFORM_RELATIONSHIPS | base64 -d | jq '.'`,
