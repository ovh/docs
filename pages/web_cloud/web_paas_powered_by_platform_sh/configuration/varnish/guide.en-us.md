...
- Display the [relationships array](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/relationships) with `echo $PLATFORM_RELATIONSHIPS | base64 -d | jq '.'`,
