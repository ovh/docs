...
If running the cron task in a specific timezone that is different than UTC is required, you will need to [configure that timezone](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/timezone) explicitly.
