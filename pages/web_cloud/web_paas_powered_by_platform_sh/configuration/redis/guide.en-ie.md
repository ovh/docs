...
If you are using PHP, configure a relationship and enable the [PHP redis extension](/pages/web_cloud/web_paas_powered_by_platform_sh/languages/php/languages-php/extensions) in your `.platform.app.yaml`.
