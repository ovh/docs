...
Web PaaS supports running [multiple applications in the same project](/pages/web_cloud/web_paas_powered_by_platform_sh/best_practices/bestpractices-oneormany)
...
override settings.php [as described here](/pages/web_cloud/web_paas_powered_by_platform_sh/frameworks/frameworks-drupal7/customizing-settings-php) and
