...
To customize who can use SSH, [set the access key](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/configuration-app/access) in your `platform.app.yaml` file.
