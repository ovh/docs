...
The next step is to configure the [`.platform.app.yaml`](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-app) file to set the agent in the JVM parameters:
