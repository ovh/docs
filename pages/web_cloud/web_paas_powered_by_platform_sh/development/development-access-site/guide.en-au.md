...
The writable static files in an application - including uploads, temporary and private files - are stored in [mounts](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/storage).
