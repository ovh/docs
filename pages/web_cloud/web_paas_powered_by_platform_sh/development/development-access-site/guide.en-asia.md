...
The web URL(s) for the site are listed in the [management console](/pages/web_cloud/web_paas_powered_by_platform_sh/administration/administration-web) under "Access site".

They can also be found on the command line, using the [Web PaaS CLI](/pages/web_cloud/web_paas_powered_by_platform_sh/development/development-cli):
...
Most interactions with Web PaaS require SSH key authentication, and you will need to [set up your SSH keys](/pages/web_cloud/web_paas_powered_by_platform_sh/development/development-ssh) before working on a site.
...
The writable static files in an application - including uploads, temporary and private files - are stored in [mounts](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/configuration-app/storage).
