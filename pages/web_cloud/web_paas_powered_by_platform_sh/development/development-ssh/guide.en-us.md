...
To connect using certificate-based authentication, install the [Web PaaS CLI](/pages/web_cloud/web_paas_powered_by_platform_sh/development/development-cli).
