...
All containers on development plans are "small" containers.  See the [sizing configuration page](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-app/size) for more details.
