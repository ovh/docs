...
- If you need to create a new key pair, we recommend to follow the steps in the [SSH guide](/pages/web_cloud/web_paas_powered_by_platform_sh/development-ssh).
...
[Configuring the CLI](/pages/web_cloud/web_paas_powered_by_platform_sh/development-cli)

[Using SSH](/pages/web_cloud/web_paas_powered_by_platform_sh/development-ssh)

[Using YAML](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-yaml)

[Managing Web PaaS from the OVHcloud Control Panel](/pages/web_cloud/web_paas_powered_by_platform_sh/control-panel-managing-the-service)
