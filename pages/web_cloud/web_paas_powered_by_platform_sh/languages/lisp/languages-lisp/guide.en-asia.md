...
Web PaaS exposes relationships and other configuration as [environment variables](/pages/web_cloud/web_paas_powered_by_platform_sh/development/development-variables).
