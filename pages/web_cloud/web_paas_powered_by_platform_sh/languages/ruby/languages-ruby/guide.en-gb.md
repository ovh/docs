...
Assuming you have your dependencies stored in the `Gemfile` at [your app root](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/configuration-app), create a hook like the following:
...
To configure it, [create a service](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/configuration-services) such as the following:
...
Once you have a service, link to it in your [app configuration](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration/configuration-app):
