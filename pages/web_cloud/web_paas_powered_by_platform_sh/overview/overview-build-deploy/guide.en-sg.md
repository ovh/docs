...
[environment](/pages/web_cloud/web_paas_powered_by_platform_sh/administration/environments) for a branch, there are two main processes that happen: **Build** and **Deploy**.
