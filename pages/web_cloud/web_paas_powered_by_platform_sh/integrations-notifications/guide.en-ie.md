...
Health notifications can be set up via the [Web PaaS CLI](/pages/web_cloud/web_paas_powered_by_platform_sh/development-cli), through a number of different channels.
