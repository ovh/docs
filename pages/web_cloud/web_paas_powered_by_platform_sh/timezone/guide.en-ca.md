...
The `timezone` property sets the timezone for which the `spec` property of any [cron tasks](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-app/cron) defined by the application will be interpreted.
