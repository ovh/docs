...
See the [activity script](/pages/web_cloud/web_paas_powered_by_platform_sh/integrations-activity/reference) reference for a description of the webhook payload.
