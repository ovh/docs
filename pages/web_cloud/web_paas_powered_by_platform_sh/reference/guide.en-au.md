...
This large block details all information about all services in the environment.  That includes the resulting configuration objects derived from [`routes.yaml`](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-routes), [`services.yaml`](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-services), and [`.platform.app.yaml`](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-app).
