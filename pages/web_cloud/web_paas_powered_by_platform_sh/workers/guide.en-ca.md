...
Note that [`deploy` and `post_deploy` hooks](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-app/build), as well as [`cron` commands](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-app/cron), will run only on the [`web`](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-app/web) container, not on workers.

## Inheritance

Any top-level definitions for [`size`](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-app/size), [`relationships`](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-app/relationships), [`access`](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-app/access), [`disk` and `mount`](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-app/storage), and [`variables`](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-app/variables) will be inherited by every worker, unless overridden explicitly.
