...
You can check the maximum number of PHP-FPM workers by opening an [SSH session](/pages/web_cloud/web_paas_powered_by_platform_sh/development-ssh) and running following command (example for PHP 7.x):
...
To see how much memory your PHP worker processes are using, you can open an [SSH session](/pages/web_cloud/web_paas_powered_by_platform_sh/development-ssh) and look at the PHP access log:
