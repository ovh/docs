...
|----------------------------------|---------------|-------------------------|
| [Headless Chrome](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-services/headless-chrome) | `chrome-headless` | 73 |
| [InfluxDB](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-services/influxdb) | `influxdb` | 1.2, 1.3, 1.7, 1.8 |
| [Kafka](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-services/kafka) | `kafka` | 2.1, 2.2, 2.3, 2.4, 2.5 |
| [MariaDB](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-services/mysql) | `mariadb` | 10.0, 10.1, 10.2, 10.3, 10.4, 10.5 |
| [Memcached](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-services/memcached) | `memcached` | 1.4, 1.5, 1.6 |
| [Network Storage](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-services/network-storage) | `network-storage` | 1.0 |
| [Oracle MySQL](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-services/mysql) | `oracle-mysql` | 5.7, 8.0 |
| [PostgreSQL](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-services/postgresql) | `postgresql` | 9.6, 10, 11, 12, 13 |
| [RabbitMQ](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-services/rabbitmq) | `rabbitmq` | 3.5, 3.6, 3.7, 3.8 |
| [Redis](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-services/redis) | `redis` | 3.2, 4.0, 5.0, 6.0 |
| [Solr](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-services/solr) | `solr` | 7.7, 8.0, 8.4, 8.6 |
| [Varnish](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-services/varnish) | `varnish` | 5.6, 6.0 |
