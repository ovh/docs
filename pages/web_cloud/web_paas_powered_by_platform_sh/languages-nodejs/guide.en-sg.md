...
You can also develop a microservice architecture mixing JavaScript and other apps with [multi-app projects](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-app).
...
To use a specific version in a container with a different language, [use a version manager](/pages/web_cloud/web_paas_powered_by_platform_sh/languages-nodejs/nvm).
...
and add it to your [app configuration](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-app):
...
If you have a `package.json` file in your code, the default [build flavor is run](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-app/build#build):
...
The following examples show how to use Node.js to access various [services](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-services).
