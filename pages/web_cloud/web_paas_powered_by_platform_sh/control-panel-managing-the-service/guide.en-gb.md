...
- A [Web PaaS solution](https://www.ovhcloud.com/en-gb/web-paas/) in your OVHcloud account (find the details in [this guide](/pages/web_cloud/web_paas_powered_by_platform_sh/control-panel-creating-the-service))
...
Each project equals a service subscription. The button `New project`{.action} starts the process of ordering a [new project](/pages/web_cloud/web_paas_powered_by_platform_sh/control-panel-creating-the-service).
...
Click on `Change solution`{.action} in order to choose a [different subscription](/pages/web_cloud/web_paas_powered_by_platform_sh/control-panel-creating-the-service). The only limitation is that you cannot downgrade to the `Start` plan.
