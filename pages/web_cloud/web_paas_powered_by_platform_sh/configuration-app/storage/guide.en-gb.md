...
This assumes that a `network-storage` service named `files` has already been defined.  See the [Network Storage](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-services/network-storage) page for more details and examples.
...
See the [web locations](/pages/web_cloud/web_paas_powered_by_platform_sh/configuration-app/web) documentation for more details.
