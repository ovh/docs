...
<!-- CP-STEPS-START:add-aaaa-domain -->
...
> **Étape 3**
>>
>> Dans la fenêtre qui s'ouvre, sélectionnez le champ de pointage de type `AAAA`{.action}.
>>
> **Étape 4**
>>
>> Renseignez dans le champ `Cible *` l'adresse IP (par exemple : `2001:db8:1:1b00:203:0:113:0`) du service sur lequel votre site web est situé (hébergement web, serveur dédié, VPS, etc.), puis cliquez sur `Suivant`{.action}.
>>
> **Étape 5**
>>
...
<!-- CP-STEPS-START:add-aaaa-subdomain -->
Cliquez sur les onglets ci-dessous pour afficher successivement chacune des **5** étapes.
