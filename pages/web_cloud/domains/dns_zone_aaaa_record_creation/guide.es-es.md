...
> **Paso 3**
>>
>> En la ventana que se abre, seleccione el tipo de registro `AAAA`{.action}.
>>
> **Paso 4**
>>
>> Introduzca la dirección IP (por ejemplo, `2001:db8:1:1b00:203:0:113:0`) del servicio en el que esté situado su sitio web (alojamiento web, servidor dedicado, VPS, etc.) en el campo `Destino *` y haga clic en `Siguiente`{.action}.
>>
> **Paso 5**
>>
...
> **Paso 4**
>>
>> Introduzca en el campo `Subdominio` el subdominio correspondiente (por ejemplo, `www` para el subdominio `www.domain.tld`) y, en el campo `Destino *`, la dirección IP (por ejemplo, `2001:db8:1:1b00:203:0:113:0`) del servicio en el que esté situado el sitio web (alojamiento web, servidor dedicado, VPS, etc.). Haga clic en `Siguiente`{.action}.
>>
> **Paso 5**
>>
>> Revise el resumen y haga clic en `Aceptar`{.action}. Espere hasta **24** horas para que la propagación de la adición en la red DNS sea plenamente efectiva.
