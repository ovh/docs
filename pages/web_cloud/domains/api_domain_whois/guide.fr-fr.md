...
-   Concernant le contact `owner`. La présence des champs dans le noeud `field` signifie que les informations sont masquées. Le choix des informations divulguées n'est cependant pas personnalisable (c'est tout ou rien).
