...
Cette option permet, après la saisie du nom de domaine redirigé, d'afficher le domaine cible dans la barre d'adresses de votre navigateur internet au lieu du nom de domaine redirigé.
...
Comme pour l'option 1, cette option permet d'afficher, après la saisie du nom de domaine redirigé, le domaine cible dans la barre d'adresses de votre navigateur internet au lieu du nom de domaine redirigé.
...
Cette redirection permet, après la saisie du nom de domaine redirigé, de le laisser affiché dans la barre d'adresses de votre navigateur internet au lieu de le remplacer par le domaine cible.<br>
...
La redirection invisible fonctionne avec une balise HTML *iFrame*. Celle-ci permet à votre nom de domaine redirigé d'intégrer dans sa propre page HTML le contenu de l'autre page correspondant au domaine cible.
