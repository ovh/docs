...
excerpt: Prepara e configura la zona DNS del tuo nome di dominio OVHcloud per connetterla a un hosting Wix
updated: 2026-03-17
---
...
Prepara il tuo hosting Wix seguendo le istruzioni del **passaggio 1** da [**questa pagina della documentazione Wix**](https://support.wix.com/en/article/connecting-a-domain-to-wix-using-pointing-5727882).
...
> - Apri [**questa pagina della documentazione Wix**](https://support.wix.com/en/article/connecting-a-domain-to-wix-using-pointing-5727882).
...
>>
>> **3 - Modifica:** se esiste un record "A" per il nome di dominio, clicca sul pulsante `...`{.action} e poi su `Modifica il record`{.action}. Lascia il campo **Sottodominio** vuoto e sostituisci la destinazione con l'indirizzo IPv4 recuperato dalla tua interfaccia Wix. Clicca su `Avanti`{.action} e conferma.
>>
>> Se non esiste alcun record "A", clicca su `Aggiungi un record`{.action} in alto a destra, seleziona il campo di puntamento `A`{.action}, lascia il campo **Sottodominio** vuoto e inserisci l'indirizzo IPv4 recuperato dalla tua interfaccia Wix nel campo **Destinazione**. Clicca su `Avanti`{.action} e conferma.
>>
...
>>
>> **3 - Modifica:** se esiste un record "CNAME" per il sottodominio "www", clicca sul pulsante `...`{.action} e poi su `Modifica il record`{.action}. Sostituisci unicamente la **Destinazione** con il valore recuperato dalla tua interfaccia Wix. Clicca su `Avanti`{.action} e conferma.
>>
>> Se non esiste alcun record "CNAME" per il sottodominio "www", clicca su `Aggiungi un record`{.action} in alto a destra, seleziona il campo di puntamento `CNAME`{.action}, inserisci `www` nel campo **Sottodominio** e il valore recuperato dalla tua interfaccia Wix nel campo **Destinazione**. Clicca su `Avanti`{.action} e conferma.
