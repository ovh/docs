...
excerpt: "Przygotuj i skonfiguruj strefę DNS Twojej nazwy domeny OVHcloud, aby połączyć ją z hostingiem Wix"
updated: 2026-03-18
---
...
>>
>> **3 - Modyfikacja:** Jeśli istnieje rekord "A" dla samej nazwy domeny, kliknij przycisk `...`{.action}, a następnie kliknij `Zmień wpis`{.action}. Pozostaw pole **Subdomena** puste i zastąp cel adresem IPv4 z interfejsu Wix. Kliknij `Dalej`{.action} i zatwierdź.
>>
>> Jeśli nie istnieje żaden rekord "A", kliknij `Dodaj wpis`{.action} w prawym górnym rogu, wybierz typ rekordu `A`{.action}, pozostaw pole **Subdomena** puste i wprowadź adres IPv4 z interfejsu Wix w polu **Cel**. Kliknij `Dalej`{.action} i zatwierdź.
>>
...
>>
>> **3 - Modyfikacja:** Jeśli istnieje rekord "CNAME" dla subdomeny "www", kliknij przycisk `...`{.action}, a następnie kliknij `Zmień wpis`{.action}. Zastąp jedynie **Cel** wartością z interfejsu Wix. Kliknij `Dalej`{.action} i zatwierdź.
>>
>> Jeśli nie istnieje żaden rekord "CNAME" dla subdomeny "www", kliknij `Dodaj wpis`{.action} w prawym górnym rogu, wybierz typ rekordu `CNAME`{.action}, wprowadź `www` w polu **Subdomena** i wartość z interfejsu Wix w polu **Cel**. Kliknij `Dalej`{.action} i zatwierdź.
