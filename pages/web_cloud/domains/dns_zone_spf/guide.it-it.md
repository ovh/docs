...
>
> Se il tuo dominio è registrato presso OVHcloud, verifica che la configurazione di OVHcloud sia attiva nel tuo [Spazio Cliente](/links/manager) utilizzando la scheda `Server DNS`{.action}.
>
...
Accedendo allo [Spazio Cliente OVHcloud](/links/manager). Nella sezione `Domini`{.action}, seleziona il dominio interessato. Clicca sulla scheda `Zona DNS`{.action}.
...
Per aggiungere un record SPF alla configurazione di OVHcloud del tuo dominio, accedi allo [Spazio Cliente OVHcloud](/links/manager). Clicca su `Domini`{.action} e poi sulla scheda `Zona DNS`{.action}.
...
- [Aggiungere un record SPF OVHcloud](#spfrecordovhcloud)**e utilizzare la configurazione OVHcloud**: per gli utenti che dispongono esclusivamente delle soluzioni email OVHcloud sul loro dominio (esclusi [Private Exchange](/links/web/emails-hosted-exchange)).
...
Per modificare il record SPF nella configurazione di OVHcloud del tuo dominio, accedi allo [Spazio Cliente OVHcloud](/links/manager). Clicca su `Domini`{.action} e poi sulla scheda `Zona DNS`{.action}.
