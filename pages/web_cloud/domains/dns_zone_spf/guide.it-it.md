...
excerpt: "Questa guida ti mostra come configurare un record SPF sul tuo nome di dominio per migliorare la sicurezza delle email"
updated: 2026-02-10
---
...
![nome di dominio](/pages/assets/schemas/emails/spf_records_diagram.png){.thumbnail .w-400}
...
>
> Se il tuo nome di dominio è registrato presso OVHcloud, verifica che la configurazione di OVHcloud sia attiva nel tuo [Spazio Cliente](/links/manager) utilizzando la scheda `Server DNS`{.action}.
>
...
Accedendo allo [Spazio Cliente OVHcloud](/links/manager). Nella sezione `Domini`{.action}, seleziona il nome di dominio interessato. Clicca sulla scheda `Zona DNS`{.action}.
...
> [!primary]
>
> Se il tuo nome di dominio è registrato presso OVHcloud, verifica che utilizzi correttamente i server DNS OVHcloud dalla scheda `Server DNS`{.action}.
>
...
![nome di dominio](/pages/assets/screens/control_panel/product-selection/web-cloud/domain-dns/dns-zone/spf_records_check_OVH_configuration.png){.thumbnail .w-400}
...
Per aggiungere un record SPF alla configurazione di OVHcloud del tuo nome di dominio, accedi allo [Spazio Cliente OVHcloud](/links/manager). Clicca su `Domini`{.action} e poi sulla scheda `Zona DNS`{.action}.

Per aggiungere un record SPF, clicca su `Aggiungi un record`{.action}.

![nome di dominio](/pages/assets/screens/control_panel/product-selection/web-cloud/domain-dns/dns-zone/spf_records_add_entry_step1.png){.thumbnail .w-400}
...
![nome di dominio](/pages/assets/screens/control_panel/product-selection/web-cloud/domain-dns/dns-zone/spf_records_add_entry.png){.thumbnail .w-400}
...
![nome di dominio](/pages/assets/screens/control_panel/product-selection/web-cloud/domain-dns/dns-zone/spf_records_add_entry_step2.png){.thumbnail .w-400}
...
![nome di dominio](/pages/assets/screens/control_panel/product-selection/web-cloud/domain-dns/dns-zone/spf_records_add_entry_personnalize_step1.png){.thumbnail .w-400}
...
/// details | "**Altri server inviano mail dal tuo nome di dominio?**"
...
/// details | "**Le informazioni che hai indicato descrivono tutti gli host che inviano mail dal tuo nome di dominio?**"
...
![nome di dominio](/pages/assets/screens/control_panel/product-selection/web-cloud/domain-dns/dns-zone/spf_records_add_TXT_entry.png){.thumbnail .w-400}

### Modifica un record SPF

Per modificare il record SPF nella configurazione di OVHcloud del tuo nome di dominio, accedi allo [Spazio Cliente OVHcloud](/links/manager). Clicca su `Domini`{.action} e poi sulla scheda `Zona DNS`{.action}.

La tabella mostra la configurazione OVHcloud del tuo nome di dominio. ogni riga corrisponde a un diverso record DNS. Recupera il tuo record TXT o SPF in questa tabella e clicca su `...`{.action} per modificare il record.
...
![nome di dominio](/pages/assets/screens/control_panel/product-selection/web-cloud/microsoft/exchange/general-information/spf_records_ip.png){.thumbnail .w-400}
...
![nome di dominio](/pages/assets/screens/control_panel/product-selection/web-cloud/microsoft/exchange/general-information/spf_records_ip2.png){.thumbnail .w-400}

Accedi alla sezione `Domini`{.action}, seleziona il nome di dominio associato alla piattaforma Private Exchange e clicca sulla scheda `Zona DNS`{.action}. Recupera gli indirizzi IPv4 (record `A`) e IPv6 (record `AAAA`) corrispondenti all’URL della webmail.

![nome di dominio](/pages/assets/screens/control_panel/product-selection/web-cloud/domain-dns/dns-zone/spf_records_ip3.png){.thumbnail .w-400}
