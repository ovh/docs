...
> **Step 1**
>>
>> Click on [this link](/links/control-panel/billing-services), then click on the `...`{.action} button to the right of the DNS zone you want to cancel, then click on `Cancel my subscription`{.action}.
>>
