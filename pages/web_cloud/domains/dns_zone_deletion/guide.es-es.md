...
> **Etapa 1**
>>
>> Haga clic en [este enlace](/links/control-panel/billing-services) y, a continuación, haga clic en el botón `...`{.action} a la derecha de la zona DNS que desea cancelar, y luego en `Dar de baja mi servicio`{.action}.
>>
