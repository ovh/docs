---
title: "Connecter un domaine OVHcloud à GoDaddy"
excerpt: Préparez et configurez la zone DNS de votre nom de domaine OVHcloud pour la connecter à un hébergement GoDaddy
updated: 2026-03-17
---

## Objectif

Vous êtes titulaire d'un nom de domaine chez OVHcloud et vous souhaitez le connecter à un hébergement GoDaddy. Ce guide vous explique comment préparer et configurer votre zone DNS OVHcloud pour votre hébergement GoDaddy.
...
> **Étape 1**
>>
>> Cliquez sur [ce lien](/links/control-panel/web-dns-zone), puis choisissez le nom de domaine concerné.
>>
...
>>
>> **3 - Modification :** si un enregistrement « A » existe pour le domaine seul, cliquez sur le bouton `...`{.action} puis sur `Modifier l'entrée`{.action}. Laissez le champ **Sous-domaine** vide et remplacez la cible par l'adresse IPv4 relevée depuis votre interface GoDaddy. Cliquez sur `Suivant`{.action} et validez.
>>
>> Si aucun enregistrement « A » n'existe, cliquez sur `Ajouter une entrée`{.action} en haut à droite, sélectionnez le champ de pointage `A`{.action}, laissez le champ **Sous-domaine** vide et saisissez l'adresse IPv4 relevée depuis votre interface GoDaddy dans le champ **Cible**. Cliquez sur `Suivant`{.action} et validez.
>>
...
>>
>> **3 - Modification :** si un enregistrement « CNAME » existe pour le sous-domaine « www », cliquez sur le bouton `...`{.action} puis sur `Modifier l'entrée`{.action}. Remplacez uniquement la **Cible** par la valeur relevée depuis votre interface GoDaddy. Cliquez sur `Suivant`{.action} et validez.
>>
>> Si aucun enregistrement « CNAME » n'existe pour le sous-domaine « www », cliquez sur `Ajouter une entrée`{.action} en haut à droite, sélectionnez le champ de pointage `CNAME`{.action}, saisissez `www` dans le champ **Sous-domaine** et la valeur relevée depuis votre interface GoDaddy dans le champ **Cible**. Cliquez sur `Suivant`{.action} et validez.
