...
>>
>> **3 - Modification :** si un enregistrement « A » existe pour le nom de domaine seul, cliquez sur le bouton `...`{.action} puis sur `Modifier l'entrée`{.action}. Laissez le champ **Sous-domaine** vide et remplacez la cible par l'adresse IPv4 relevée depuis votre interface GoDaddy. Cliquez sur `Suivant`{.action} et validez.
>>
