---
title: Comment connecter un nom de domaine OVHcloud à un hébergement GoDaddy
...
Vous possédez un nom de domaine chez OVHcloud et vous souhaitez le connecter à un hébergement GoDaddy. Vous trouverez dans ce guide les étapes de préparation et de configuration de votre zone DNS OVHcloud pour permettre la configuration de votre hébergement GoDaddy.
...
Lorsque vous utilisez un hébergement GoDaddy avec un nom de domaine OVHcloud, vous devez d'abord préparer votre hébergement en suivant les instructions de [**cette page de la documentation GoDaddy**](https://fr.godaddy.com/help/connecter-mon-site-websites-marketing-a-un-domaine-enregistre-ailleurs-40612).
...
> - Ouvrez [**cette page de la documentation GoDaddy**](https://fr.godaddy.com/help/connecter-mon-site-websites-marketing-a-un-domaine-enregistre-ailleurs-40612){.external}.
> - Suivez les instructions jusqu'à l'étape 10 et récupérez les informtions spécifiques à votre site web pour pouvoir modifier par la suite vos enregistrements DNS OVHcloud.<br>
...
>> Laissez le champ **Sous-domaine** vide et saisissez l'adresse IPv4 relevée depuis votre interface GoDaddy dans le champ **Cible**.
...
>> Complétez le champ **Sous-domaine** avec la valeur `www` et saisissez la valeur relevée depuis votre interface GoDaddy dans le champ **Cible**.<br>
>> Cliquez sur `Suivant`{.action} puis validez votre enregistrement « CNAME ».

La zone DNS est maintenant configurée pour faire le lien avec un hébergement GoDaddy.
