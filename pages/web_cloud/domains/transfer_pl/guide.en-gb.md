...
- In some cases, the transfer process may require additional information about the domain name holder. To add this information, click `Manage Contacts/Holder`{.action}.
