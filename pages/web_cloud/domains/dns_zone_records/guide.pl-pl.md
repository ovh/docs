...
>> Powiąż nazwę domeny z serwerem e-mail. Na przykład adres *10 mx1.mail.ovh.net* odpowiada jednemu z serwerów e-mail OVHcloud, gdy korzystasz z usługi e-mail OVHcloud. Istnieje prawdopodobieństwo, że Twój dostawca poczty e-mail dysponuje kilkoma serwerami e-mail: należy utworzyć kilka pól MX. Zapoznaj się z naszą dokumentacją "[Dodaj pole MX do konfiguracji nazwy domeny](/pages/web_cloud/domains/dns_zone_mx)".
>>
>> > [!warning]
>> >
...
>>
>> Aby dowiedzieć się więcej, zapoznaj się z naszą dokumentacją "[Dodaj pole SPF do konfiguracji nazwy domeny](/pages/web_cloud/domains/dns_zone_spf)".
>>
> **DKIM**
...
>>
>> Zapoznaj się z naszą dokumentacją "[Konfiguracja rekordu DMARC w Twojej nazwie domeny](/pages/web_cloud/domains/dns_zone_dmarc)", aby dowiedzieć się więcej.
...
[Dodawanie rekordu SPF podczas konfiguracji nazwy domeny](/pages/web_cloud/domains/dns_zone_spf)
