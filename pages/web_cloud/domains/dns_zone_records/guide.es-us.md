...
>> > No obstante, podrá crear registros CNAME con todos los subdominios (ejemplos: *subdomain.domain.tld* o *www.domain.tld*) del nombre de dominio *domain.tld* en la zona DNS creada para *domain.tld*.
>> >
...
>> > [!warning]
>> > 
>> > En cambio, *domain.tld* como nombre de dominio no mostrará el destino del dominio *ovh.com*, ya que el registro DNAME solo es válido para los subdominios de los nombres de dominio definidos en el registro DNAME.
>> >
