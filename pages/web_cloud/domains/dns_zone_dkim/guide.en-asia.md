...
- An OVHcloud [Exchange](https://www.ovhcloud.com/asia/emails/) or external email solution with DKIM
...
>
> If your domain name is registered with OVHcloud, you can check if it is using the OVHcloud configuration in your [Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia). To do this, go to the `DNS Zone`{.action} tab, and select the domain concerned.
>
...
The automatic configuration of DKIM is accessible for the email [Exchange](https://www.ovhcloud.com/asia/emails/) solutions.
...
From your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia), in the `Web Cloud`{.action} tab, click `Microsoft`{.action}, then `Exchange`{.action}. Click on the name of the Exchange service concerned. Finally, go to the `Associated domains`{.action} tab.
