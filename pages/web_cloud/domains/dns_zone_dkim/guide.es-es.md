...
- Haber contratado una de nuestras soluciones [Exchange](/links/web/emails), [Email Pro](https://www.ovhcloud.com/es-es/emails/email-pro/) o una solución de correo electrónico fuera de OVHcloud que disponga del DKIM.
...
La configuración automática del DKIM está disponible para los servicios de correo [Exchange](/links/web/emails) y [E-mail Pro](https://www.ovhcloud.com/es-es/emails/email-pro/).
