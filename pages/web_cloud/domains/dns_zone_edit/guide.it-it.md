...
> **Step 2**
>>
>> Clicca sul menu `Zone DNS`{.action} e seleziona il nome di dominio interessato.
>>
...
[Aggiungere un record SPF alla configurazione di un nome di dominio](/pages/web_cloud/domains/dns_zone_spf)
