...
Per maggiori spiegazioni, consulta le nostre guide "[Cos'è un server DNS?](/pages/web_cloud/domains/dns_server_general_information)" e "[Cos'è una zona DNS?](/pages/web_cloud/domains/dns_zone_general_information)".
