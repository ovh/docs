...
- at least one [domain name](https://www.ovhcloud.com/en/domains/);
...
[Domain names](https://www.ovhcloud.com/en/domains/) all need a **DNS zone** to work. The DNS zone consists of technical information, called *DNS records*. It's kind of like a referral center.
