...
- You have at least one [domain name](https://www.ovhcloud.com/asia/domains/).
...
A [domain name](https://www.ovhcloud.com/asia/domains/) can be associated with several types of services (email, website, etc.).
...
[Domain names](https://www.ovhcloud.com/asia/domains/) all need a **DNS zone** to work which is a domain name’s configuration file. It consists of DNS **records** that map the domain name to various services and functions.
