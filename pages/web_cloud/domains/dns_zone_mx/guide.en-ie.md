...
- You have an MX Plan solution (included in the [web hosting plan](/links/web/hosting), a [free 100M hosting](https://www.ovhcloud.com/en-ie/domains/free-web-hosting/), or the MX Plan solution ordered separately), one of our [OVHcloud email offers](https://www.ovhcloud.com/en-ie/emails/), or an external email service.
