...
- access to manage the DNS zone for the domain name concerned via the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/&ovhSubsidiary=GB).
- access to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/&ovhSubsidiary=GB)
- The domain name concerned must use OVHcloud configuration (i.e. OVHcloud DNS servers).
- an MX Plan solution (included in the [web hosting plan](https://www.ovhcloud.com/en-gb/web-hosting/) , [free 100M hosting](https://www.ovhcloud.com/en-gb/domains/free-web-hosting/), or the MX Plan solution ordered separately), one of our [OVHcloud email offers](https://www.ovhcloud.com/en-gb/emails/), or an external email service.

> [!primary]
>
> - If your domain name does not use OVHcloud DNS servers, you will need to modify the MX records using the interface given by the service provider that manages your domain name configuration.
>
> - If your domain name is with OVHcloud, you can check if it uses our OVHcloud configuration in the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), in the `DNS Servers`{.action} section. Next, select the domain concerned, and go to the `General information`{.action} tab. If `Active` is listed under “**DNS servers**”, you will be using OVHcloud DNS servers.
>
...
MX (**M**ail **e**Xchange) records are used to link your domain name to the receiving email servers attached to your email service. We will use an example.
...
- **(2)** forward the email to the URL of the **MX** record read.
...
> [!warning]
>
> Generally speaking, **modifying MX records in a domain name’s DNS zone is a tricky** task. If you make any mistakes configuring the records, it may make it impossible for emails to reach your email address. Please take care when you carry out this procedure.
...
Below, you will find the OVHcloud MX configuration to use for our MX Plan solutions (alone or included in an [OVHcloud web hosting](https://www.ovhcloud.com/en-gb/web-hosting/) plan), [Email Pro](https://www.ovhcloud.com/en-gb/emails/email-pro/) and [Exchange](https://www.ovhcloud.com/en-gb/emails/). Our email servers have anti-spam and integrated anti-virus.
...
**If you have an OVHcloud** email solution, please refer to the information provided in the “[Familiarizing yourself with OVHcloud MX configuration ](#mxovhcloud)” step.

![dnsmxrecord](images/mx-records-dns-zone-modif.png){.thumbnail}

Once the information is complete, complete the steps, then click `Confirm`{.action}.
