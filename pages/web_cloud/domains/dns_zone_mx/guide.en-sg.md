...
- You have an MX Plan solution (included in the [web hosting plan](https://www.ovhcloud.com/en-sg/web-hosting/)), or an external email service.
...
Below, you will find the OVHcloud MX configuration to use for our MX Plan solutions ( included in an [OVHcloud web hosting](https://www.ovhcloud.com/en-sg/web-hosting/) plan). Our email servers have antispam and antivirus integrated.
