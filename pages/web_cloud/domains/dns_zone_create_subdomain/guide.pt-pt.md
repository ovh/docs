...
excerpt: "Saiba como criar uma zona DNS na OVHcloud para um subdomínio de um nome de domínio através do seu espaço cliente"
updated: 2026-02-19
---
...
**Saiba como criar uma zona DNS na OVHcloud para um subdomínio de um nome de domínio através do seu espaço cliente OVHcloud.**
...
> **Etapa 2**
>>
>> Clique no menu `Zonas DNS`{.action}, depois no botão `Encomendar`{.action}.
>>
...
Para os encontrar, clique nas guias abaixo para exibir sucessivamente cada um dos **3** etapas.
...
>>
>> Procure as 2 linhas do tipo **NS** e recupere as 2 valores presentes na coluna **Alvo**.
