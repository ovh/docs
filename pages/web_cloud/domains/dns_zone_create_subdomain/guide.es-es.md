...
> **Etapa 2**
>>
>> Pulse en el menú `Zonas DNS`{.action}, y luego en el botón `Contratar`{.action}.
>>
...
Para encontrarlos, haga clic en las fichas siguientes para ver cada una de las **3** etapas.
