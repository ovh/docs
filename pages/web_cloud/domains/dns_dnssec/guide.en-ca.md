...
The **D**omain **N**ame **S**ystem **SEC**urity Extensions (**DNSSEC**) protect your domain name's DNS configuration against *cache poisoning* by verifying and authenticating DNS responses.
