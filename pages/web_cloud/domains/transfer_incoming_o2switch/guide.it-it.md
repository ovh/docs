---
title: 'Trasferire un nome di dominio O2Switch in OVHcloud'
excerpt: 'Questa guida ti mostra tutte le informazioni relative al trasferimento di un nome di dominio O2Switch in OVHcloud'
updated: 2026-02-10
flag: hidden
---
...
Il trasferimento di un nome di dominio O2Switch richiede una procedura specifica.

**Questa guida ti mostra come trasferire un nome di dominio O2Switch in OVHcloud**
...
- Il nome di dominio è registrato presso il Registrar O2Switch.
...
Per sbloccare il nome di dominio e recuperare il codice di trasferimento, segui gli step descritti nella [documentazione dedicata di O2Switch](https://faq.o2switch.fr/espace-client/recuperer-code-de-transfert).
