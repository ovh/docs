...
>>
>> **3 - Modifica:** se esiste un record "CNAME" per il sottodominio "www", clicca sul pulsante `...`{.action} e poi su `Modifica il record`{.action}. Sostituisci unicamente la **Destinazione** con `ext-cust.squarespace.com.`. Clicca su `Avanti`{.action} e conferma.
>>
>> Se non esiste alcun record "CNAME" per il sottodominio "www", clicca su `Aggiungi un record`{.action} in alto a destra, seleziona il campo di puntamento `CNAME`{.action}, inserisci `www` nel campo **Sottodominio** e `ext-cust.squarespace.com.` nel campo **Destinazione**. Clicca su `Avanti`{.action} e conferma.
>>
>> **4 - Aggiunta:** crea un record CNAME di verifica inserendo il `codice univoco recuperato da SquareSpace` nel campo **Sottodominio**, quindi `verify.squarespace.com.` nel campo **Destinazione**. Clicca su `Avanti`{.action} e conferma.
...
Per iniziare, segui i passaggi di connessione descritti nel passaggio 1 di questa [guida SquareSpace](https://support.squarespace.com/hc/it/articles/12880712406797-Connecter-un-domaine-OVHcloud-%C3%A0-votre-site-Squarespace).
...
Prosegui al passaggio 2 di questa [guida SquareSpace](https://support.squarespace.com/hc/it/articles/12880712406797-Connecter-un-domaine-OVHcloud-%C3%A0-votre-site-Squarespace).
