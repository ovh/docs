...
> [!primary]
>
> - Vous pouvez connecter votre domaine à un site SquareSpace d’essai ou payant. Vous ne pouvez pas le connecter à un site expiré.
...
> [!warning]
>
> Si vous recevez le message d’alerte “This domain is already connected to another Squarespace site” (Ce domaine est déjà connecté à un autre site Squarespace), vérifiez vos autres sites Squarespace pour déterminer à quel site le domaine est connecté. Puis, déconnectez-le de ce site. 
