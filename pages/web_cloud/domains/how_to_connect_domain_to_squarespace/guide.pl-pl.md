...
Jesteś abonentem nazwy domeny w OVHcloud i chcesz ją połączyć z hostingiem SquareSpace. W tym przewodniku znajdziesz etapy przygotowania i konfiguracji strefy DNS OVHcloud, aby umożliwić konfigurację hostingu SquareSpace.

**Dowiedz się, jak powiązać nazwę domeny OVHcloud z hostingiem SquareSpace**

> [!warning]
>
> - Pomoc SquareSpace nie ma dostępu do ustawień Twojej nazwy domeny OVHcloud i nie może udzielić Ci porad dotyczących informacji, które należy jej dostarczyć.
>
...
### Połącz swoją nazwę domeny z SquareSpace

Operacje na tym etapie należy wykonać w panelu zarządzania SquareSpace.

> [!primary]
>
> - Możesz połączyć swoją nazwę domeny z testową lub płatną witryną SquareSpace. Nie można połączyć go z wygasłą witryną.
> - Jeśli posiadasz konto e-mail powiązane z Twoją nazwą domeny, możesz z niego nadal korzystać po zalogowaniu nazwy domeny do SquareSpace. Przed połączeniem nazwy domeny zalecamy zapoznanie się z tym [przewodnikiem dotyczącym platformy SquareSpace](https://support.squarespace.com/hc/en-us/articles/217601877-Using-a-custom-domain-email-you-already-own-with-Squarespace).
...
> - Nie można połączyć nazwy domeny niestandardowej z usługą SquareSpace, jeśli nazwa domeny zawiera słowo "squarespace" lub "sqsp".
...
> [!warning]
>
> Jeśli otrzymasz alert "This domain is already connected to another Squarespace site" (Ta nazwa domeny jest już połączona z inną stroną Squarespace), sprawdź na innych stronach WWW Squarespace, czy nazwa domeny jest połączona z inną stroną. Następnie wyloguj go z tej witryny.
