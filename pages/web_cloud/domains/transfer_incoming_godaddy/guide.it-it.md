...
excerpt: 'Questa guida ti mostra tutte le informazioni relative al trasferimento di un nome di dominio GoDaddy in OVHcloud'
updated: 2026-02-10
---
...
OVHcloud chiederà il codice di autorizzazione o "Auth code" prima di avviare la procedura di trasferimento del nome di dominio. Puoi ottenerlo aprendo la pagina del tuo portfolio di `Domini`{.action} in GoDaddy.
