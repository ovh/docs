...
excerpt: Questa guida ti mostra come trasferire un nome di dominio.uk o equiparato a OVHcloud.
updated: 2026-02-10
---
...
>
> Se è necessario modificare l’**intestatario** del nome di dominio, è necessario farlo **prima** di modificare i contatti del nome di dominio. Segui le istruzioni descritte nella nostra guida: [Dominio - Come cambiare l'intestatario?](/pages/web_cloud/domains/trade_domain).
>
...
Il nome di dominio sarà disponibile nello [Spazio Cliente OVHcloud](/links/manager) entro poche ore.
