...
Debe crear los registros *A* y *AAAA* para los nombres de hosts que definió en el paso anterior. Los registros *A* y *AAAA* deben tener como destino la dirección IP de destino que coincida con el nombre de hosts creado anteriormente.
