...
Weitere Informationen zu den DNS-Zonen finden Sie in unserer Anleitung „[OVHcloud DNS-Zone bearbeiten](/pages/web_cloud/domains/dns_zone_edit)“.
...
- Sie verfügen über die [entsprechenden](/pages/account_and_service_management/account_information/managing_contacts) Berechtigungen zur Verwaltung des Domainnamens über Ihr [OVHcloud Kundencenter](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de){.external}.
...
- Wenn Sie nicht die DNS-Server, sondern einen oder mehrere Einträge Ihrer aktuellen DNS-Konfiguration / -Zone ändern möchten, lesen Sie unsere Anleitung: „[OVHcloud DNS-Zone bearbeiten](/pages/web_cloud/domains/dns_zone_edit)“.
...
[Änderung einer OVHcloud DNS-Zone](/pages/web_cloud/domains/dns_zone_edit).
