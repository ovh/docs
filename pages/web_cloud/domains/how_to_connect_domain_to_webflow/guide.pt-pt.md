---
title: Como ligar um nome de domínio OVHcloud a um alojamento Webflow
...
É titular de um nome de domínio na OVHcloud, deseja ligá-lo a um alojamento Webflow. Neste guia, encontrará as etapas de preparação e de configuração da sua zona DNS da OVHcloud para permitir a configuração do seu alojamento Webflow.
