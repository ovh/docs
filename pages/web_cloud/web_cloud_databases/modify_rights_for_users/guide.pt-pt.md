...
> **Etapa 2**
>>
>> Na página que aparece, clique no separador `Utilizadores e permissões`{.action}.
>>
...
> **Etapa 3**
>>
>> Clique no botão `...`{.action} à direita do utilizador em questão e, a seguir, em `Gerir permissões`{.action}.
>>
