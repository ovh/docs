...
Rozwiązania [Web Cloud Databases](/links/web/databases) można włączyć bezpłatnie w naszej [ofercie hostingu Performance](/links/web/hosting). W takim przypadku są one przypisane do hostingu, z którego zostały aktywowane. Może zaistnieć konieczność odłączenia rozwiązania Web Cloud Databases od hostingu Performance, do którego jest ono przypisane.
