...
With the [Web Cloud Databases](https://www.ovhcloud.com/en-au/web-cloud/databases/) solution, you can host multiple databases. In some situations, you may need to view or retrieve the logs of:
...
- A [Web Cloud Databases](https://www.ovhcloud.com/en-au/web-cloud/databases/) solution (included in a [Performance web hosting](https://www.ovhcloud.com/en-au/web-hosting/) solution or standalone)
...
>
> This guide is designed to help you with common tasks. Nevertheless, we recommend contacting a [specialist service provider](https://partner.ovhcloud.com/en-au/directory/) if you encounter any difficulties. We will not be able to provide you with interpretation assistance for the logs available with your Web Cloud Databases solution. You can find more information in the [Go further](#go-further) section of this guide.
>
