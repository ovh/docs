...
![Page Video Center dans l'espace client OVHcloud avec les compteurs vidéos et minutes](images/fr-cp-video-center-detail.png){.thumbnail}
...
![Interface principale du Video Center avec la zone d'import et la liste des vidéos](images/fr-vc-dashboard.png){.thumbnail}
...
![Fenêtre d'intégration iframe affichant le code à copier](images/fr-vc-integrer-iframe.png){.thumbnail}
...
![Fenêtre de partage affichant l'URL de partage de la vidéo](images/fr-vc-partager.png){.thumbnail}
...
![Menu d'actions avec les options Modifier, Télécharger et Supprimer](images/fr-vc-actions-menu.png){.thumbnail}
