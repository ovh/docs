...
![Video Center page in the OVHcloud Control Panel showing video and minute counters](images/en-cp-video-center-detail.png){.thumbnail}
...
![Main Video Center interface showing the import area and video list](images/en-vc-dashboard.png){.thumbnail}
...
![Iframe integration window showing the code to copy](images/en-vc-integrate-iframe.png){.thumbnail}
...
![Sharing window showing the video sharing URL](images/en-vc-share.png){.thumbnail}
...
![Action menu showing the Edit, Download and Delete options](images/en-vc-actions-menu.png){.thumbnail}
