...
![Page Video Center dans l'espace client OVHcloud avec les compteurs vidéos et minutes](images/cp-video-center-detail.png){.thumbnail}
...
![Interface principale du Video Center avec la zone d'import et la liste des vidéos](images/vc-dashboard.png){.thumbnail}
...
![Fenêtre d'intégration iframe affichant le code à copier](images/vc-integrer-iframe.png){.thumbnail}
...
![Fenêtre de partage affichant l'URL de partage de la vidéo](images/vc-partager.png){.thumbnail}
...
![Menu d'actions avec les options Modifier, Télécharger et Supprimer](images/vc-actions-menu.png){.thumbnail}
