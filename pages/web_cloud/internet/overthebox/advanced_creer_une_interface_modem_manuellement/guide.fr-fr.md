...
>>
> 3. Configuration
>> - Dans le paramètre `Modem Device`{.action}, choisissez la device récupérée à l'étape 1. Pour notre exemple, `/sys/devices/pci0000:00/0000:00:14.0/usb2/2-2`.
...
- Pour la création manuelle d'une interface WAN consulter l'étape 3 la section « Configurer une interface en 4G », en particulier les paramètres de la section `Advanced Settings` et `Firewall`.
