...
- OVHcloud API: [How to authenticate on the OVHcloud API with Oauth2](/pages/account/api/authenticate-api-with-service-account).
- OpenStack API: [How to use service accounts to connect to OpenStack](/pages/platform/public-cloud/authenticate-api-openstack-with-service-account).

## Requirements

- An [OVHcloud customer account](/pages/account/customer/ovhcloud-account-creation).
- You know [how to configure IAM access policies via the OVHcloud Control Panel](/pages/account/customer/iam-policy-ui).
- You know [how to use the OVHcloud APIs](/pages/account/api/first-steps).
...
Like all OVHcloud APIs, the management of these credentials is subject to configurable access rights within the access policies. You can find more information in our guide on [Using IAM policies via the OVHcloud Control Panel](/pages/account/customer/iam-policy-ui).
...
To modify access for a service account, you can associate it with an existing access policy or create a new one. To find out more about managing access policies, please read our guide on [Using IAM policies via the OVHcloud API](/pages/account/customer/iam-policies-api) .
...
- [How to authenticate on the OVHcloud API with Oauth2](/pages/account/api/authenticate-api-with-service-account)
- [How to use service accounts to connect to OpenStack](/pages/platform/public-cloud/authenticate-api-openstack-with-service-account)
