...
- [Attiva la doppia autenticazione](/pages/account/customer/secure-ovhcloud-account-with-2fa) per evitare qualsiasi accesso fraudolento al tuo Spazio Cliente.
...
Per maggiori informazioni, consulta la guida [Rendere sicuro il tuo account OVHcloud e gestire i tuoi dati personali](/pages/account/customer/all_about_username#come-gestire-le-tue-informazioni-personali_1).
...
> [!primary]
>
> Per evitare interruzioni di servizio e garantire il corretto funzionamento del rinnovo automatico, [registra una modalità di pagamento](/pages/account/billing/manage-payment-methods) nello [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it)
>
...
Sapevate di poter [seguire i vostri ordini](/pages/account/billing/managing_ovh_orders) nel vostro [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it) ?<br>
...
Per maggiori informazioni sulla disattivazione dei tuoi servizi, consulta la guida [Come disattivare i tuoi servizi OVHcloud](/pages/account/billing/how_to_cancel_services).
...
[Proteggersi dalle truffe: come riconoscere email fraudolente e di phishing](/pages/account/customer/phishing_care)

[Gestire le fatture OVHcloud](/pages/account/billing/invoice_management)
