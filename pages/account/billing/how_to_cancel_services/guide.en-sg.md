...
Each [Public Cloud](https://www.ovhcloud.com/en-sg/public-cloud/) service can be deleted by clicking on the `...`{.action} button to the right of the service concerned, then on `Delete`{.action}, as in the example below for an instance:
...
To delete your [MX Plan solution](https://docs.ovh.com/sg/en/emails/), log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg), click on your name in the top right-hand corner, then on `Service Management`{.action}.
...
[Managing renewal for OVHcloud services](https://docs.ovh.com/sg/en/billing/how-to-use-automatic-renewal-at-ovh/)
