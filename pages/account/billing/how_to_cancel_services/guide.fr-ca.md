...
Pour résilier votre service [Hosted Private Cloud powered by Anthos](https://www.ovhcloud.com/fr-ca/hosted-private-cloud/anthos/), connectez-vous à votre [espace client OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc), cliquez sur votre nom en haut à droite puis sur le bouton `Gestion des services`{.action}.
