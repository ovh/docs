...
section: Gestire il rinnovo dei servizi OVHcloud
order: 03
---
...
Per disattivare la soluzione [Managed bare metal](https://www.ovhcloud.com/it/managed-bare-metal/), segui le indicazioni di questa [guida](https://docs.ovh.com/fr/managed-bare-metal/comment-resilier-le-managed-bare-metal/).
...
Per disattivare la soluzione [Hosted Private Cloud powered by VMware](https://www.ohttps://www.ovhcloud.com/it/hosted-private-cloud/vhcloud.com/en-gb/hosted-private-cloud/), segui le istruzioni di questa [guida](https://docs.ovh.com/it/private-cloud/disattivare-una-soluzione-private-cloud/).

#### Hosted Private Cloud powered by Anthos <a name="hostedprivatecloud-anthos"></a>

Per disattivare il servizio [Hosted Private Cloud powered by Anthos](https://www.ohttps://www.ovhcloud.com/it/hosted-private-cloud/vhcloud.com/en-gb/hosted-private-cloud/anthos/), accedi al tuo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it), clicca sul tuo nome in alto a destra e poi sul pulsante `Gestione dei servizi`{.action}.
...
Ogni servizio Public Cloud può essere eliminato cliccando sul pulsante `...`{.action} a destra del servizio interessato e poi su `Elimina`{.action}, come nell'esempio seguente per un'istanza:

![public cloud instance deletion](images/pci-deletion.png){.thumbnail}

Il Public Cloud OVHcloud si basa sul principio del *Pay as you go* (per maggiori informazioni, consulta la pagina [relativa alla fatturazione Public Cloud](https://docs.ovh.com/fr/public-cloud/information-concernant-le-mode-de-facturation-cloud/)). Alla fine del mese viene fatturato solo il tempo di utilizzo effettivo delle risorse.

Accedi allo Spazio Cliente OVHcloud per [consultare i tuoi consumi correnti](https://docs.ovh.com/fr/public-cloud/information-concernant-le-mode-de-facturation-cloud/#consulter-sa-consommation-actuelle) e vieni avvisato via email quando la proiezione dei tuoi consumi supera una determinata soglia.
...
Per disattivare il tuo [hosting Web](https://www.ovhcloud.com/fr/web-hosting/), accedi allo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it), clicca sul tuo nome in alto a destra e poi sul pulsante `Gestione dei servizi`{.action}.
...
Le offerte [SSL Sectigo](https://www.ovhcloud.com/fr/web-hosting/options/ssl/) non possono essere disattivate prima della scadenza, in quanto non vengono rinnovate automaticamente. Sarà quindi sufficiente non rinnovarli alla prossima scadenza.
...
Per disattivare la tua offerta [CloudDB](https://www.ovh.com/fr/cloud-databases/), accedi al tuo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it), clicca sul tuo nome in alto a destra e poi sul pulsante `Gestione dei servizi`{.action}.
...
Per eliminare la soluzione [MX Plan](https://docs.ovh.com/fr/emails/), accedi al tuo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it), clicca sul tuo nome in alto a destra e poi sul pulsante `Gestione dei servizi`{.action}.

Clicca sui tre puntini `...`{.action} in corrispondenza del servizio da disattivare e seleziona `Elimina immediatamente MX Plan`{.action}.
...
Per disattivare la tua offerta [Email Pro](https://www.ovhcloud.com/fr/emails/email-pro/), segui le indicazioni di questa [guida](https://docs.ovh.com/fr/emails-pro/gestion-facturation-emailpro/#deletion).

#### Hosted Exchange <a name="hosted"></a>

Per disattivare la soluzione [Hosted Exchange](https://www.ovhcloud.com/fr/emails/hosted-exchange/), segui le indicazioni di questa [guida](https://docs.ovh.com/fr/microsoft-collaborative-solutions/gestion-facturation-exchange/#supprimer-des-comptes).

#### Private Exchange <a name="private"></a>

Per disattivare la tua offerta [Private Exchange](https://www.ovhcloud.com/fr/emails/private-exchange/), segui le indicazioni di questa [guida](https://docs.ovh.com/fr/microsoft-collaborative-solutions/gestion-facturation-exchange/#supprimer-des-comptes_1).

#### Office 365 csp 1 <a name="office-csp1"></a>

Per disattivare la tua offerta [Office 365 csp 1](https://www.ovhcloud.com/fr/collaborative-tools/microsoft-365/), segui questa [guida](https://docs.ovh.com/fr/microsoft-collaborative-solutions/commander-et-gerer-un-groupe-de-licences-office-365-ovh/#managesubscriptions).

#### Office 365 csp 2 <a name="office-csp2"></a>

Per disattivare la tua offerta [Office 365 csp 2](https://www.ovhcloud.com/fr/collaborative-tools/microsoft-365/), segui questa [guida](https://docs.ovh.com/fr/microsoft-collaborative-solutions/commander-et-gerer-un-groupe-de-licences-office-365-revendeur-csp2-ovh/#gerer-vos-abonnements).

#### Sharepoint <a name="sharepoint"></a>

Puoi **eliminare** un account individuale dalla tua piattaforma Sharepoint o disattivare l'intera piattaforma Sharepoint.
Per disattivare l'intera piattaforma, ti consigliamo di iniziare con l'eliminazione preventiva di ogni singolo account.

* Per eliminare un account Sharepoint individuale, accedi al tuo >
Nella scheda `Utenti`{.action}, clicca sul pulsante `...`{.action} a destra dell'account da eliminare e poi su `Elimina l'account`{.action}. Leggi le informazioni e clicca su `Conferma`{.action}.

* Per disattivare l'intera piattaforma [Sharepoint](https://www.ovhcloud.com/fr/collaborative-tools/sharepoint/), accedi allo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it), clicca sul tuo nome in alto a destra e poi sul pulsante `Gestione dei servizi`{.action}.
...
Per disattivare la tua offerta [FTTH o xDSL](https://www.ovhtelecom.fr/offre-internet/), segui le indicazioni di questa [guida](https://docs.ovh.com/fr/xdsl/comment-resilier-mon-acces-xdsl/).

> [!warning]
>
> **Caso particolare**
>
> Per disattivare un'offerta [Pack SIP Trunk](https://www.ovhtelecom.fr/telephonie/sip-trunk/), è **necessario** creare una richiesta di assistenza presso i team di Supporto attraverso il tuo Spazio Cliente OVHcloud.
>

#### VoIP <a name="voip"></a>

Per disattivare un'offerta [VoIP](https://www.ovhtelecom.fr/telephonie/voip/), segui le istruzioni di questa guida per [disattivare una linea SIP o Trunk](https://docs.ovh.com/fr/voip/changer-l-offre-et-les-options-d-une-ligne-voip/#resilier-sip-trunk) o per [disattivare un numero alias](https://docs.ovh.com/fr/voip/changer-l-offre-et-les-options-d-une-ligne-voip/#resilier-alias).

#### OverTheBox <a name="otb"></a>

Per disattivare il servizio [OverTheBox](https://www.ovhtelecom.fr/overthebox/), accedi allo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it), clicca sul tuo nome in alto a destra e poi sul pulsante `Gestione dei servizi`{.action}.
...
Nessuna procedura di rescissione per le [offerte SMS](https://www.ovhtelecom.fr/sms/). Un account SMS non genera abbonamenti mensili o fatturazione. I crediti SMS hanno una durata illimitata.

Per eliminare un account SMS, ti invitiamo a creare una richiesta di assistenza attraverso lo Spazio Cliente OVHcloud.

#### FAX <a name="fax"></a>

Per disattivare un'offerta [FAX](https://www.ovhtelecom.fr/fax/), segui le indicazioni di [questa guida](https://docs.ovh.com/fr/voip/changer-l-offre-et-les-options-d-une-ligne-voip/#resilier-fax).

### Soluzioni trasversali <a name="transversal"></a>

#### SSL Gateway <a name="ssl_gateway"></a>

Per disattivare la tua offerta [SSL Gateway](https://www.ovh.com/fr/ssl-gateway/), accedi al tuo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it), clicca sul tuo nome in alto a destra e poi sul pulsante `Gestione dei servizi`{.action}.
...
[FAQ - Il rinnovo automatico in OVH](https://docs.ovh.com/fr/billing/faq-renouvellement-automatique-ovh/)
