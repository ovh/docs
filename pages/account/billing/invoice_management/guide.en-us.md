...
- Access to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we) as the [Billing contact](/pages/account/customer/managing_contacts) of your service
...
A [settlement purchase order](/pages/account/billing/managing_ovh_orders) will then be created. Once the payment has been made, your account will be balanced again.
