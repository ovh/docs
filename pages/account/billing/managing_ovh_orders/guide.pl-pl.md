...
|3|Sposoby płatności zapisane na Twoim koncie klienta Więcej informacji znajdziesz w przewodniku Zarządzanie sposobami płatności (https://docs.ovh.com/fr/billing/manage-payment-methods/).|
...
Możesz w każdym momencie odnaleźć Twoje zamówienie w [Panelu klienta OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) w sposób, w jaki zostało to opisane w dalszej części tej dokumentacji.

### Dostęp do zamówień w Panelu klienta OVHcloud

Aby uzyskać dostęp do panelu zarządzania zamówieniami, zaloguj się do [Panelu klienta OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), a następnie w zakładce `Dashboard`{.action} kliknij `Pokaż moje zamówienia`{.action}.
...
|Status|Wyjaśnienie|
|---|---|
|Brak płatności|Status ten odpowiada zamówieniu, które nie zostało jeszcze opłacone. Jeśli płatność nie zostanie uregulowana, zamówienie wygaśnie i zostanie anulowane w dniu wskazanym w formularzu zamówienia. Jeśli po upływie tego terminu chcesz dokonać zamówienia, po prostu przejdź do zamówienia.|
...
Po wygenerowaniu formularza zamówienia możesz śledzić zamówienie w Panelu [klienta OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr):

* Kliknij Twój `Dashboard`, następnie `Wyświetl moje zamówienia`{.action}, a na koniec wybierz `...`{.action} przed Twoim zamówieniem.
...
Artykuł 5 punkt 8 [Regulaminów OVH](https://www.ovh.com/fr/support/documents_legaux/conditions%20generales%20de%20service.pdf){.action} stanowi, że *Użytkownik, będący konsumentem  może odstąpić od umowy bez podania  przyczyny, składając stosowne oświadczenie na piśmie w ciągu 10 dni od dnia zawarcia umowy świadczenia usługi. Do zachowania tego terminu wystarczy przesłanie oświadczenia w tym terminie.*

Opcję skorzystania z prawa do odstąpienia od umowy znajdziesz w dalszym ciągu tego artykułu.

> [!warning]
>
> Prawo do wycofania dotyczy wyłącznie osób fizycznych i ma zastosowanie jedynie do nowych zamówień. Nie będziesz mógł więc korzystać z niego podczas odnawiania ani jeśli Twoje [konto klienta OVHcloud](https://docs.ovh.com/fr/customer/tout-savoir-sur-identifiant-client/#modifier-le-type-de-compte) ma inny typ niż *OVHcloud*.
>
> Ponadto prawo do odstąpienia od umowy nie ma zastosowania do zamówień, które nie zostały opłacone, ponieważ są one automatycznie anulowane po wygaśnięciu zamówienia
>

Jeśli kryteria kwalifikujące do prawa odstąpienia od umowy są spełnione, możesz skorzystać z prawa odstąpienia od umowy bezpośrednio [w Panelu klienta](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr):
