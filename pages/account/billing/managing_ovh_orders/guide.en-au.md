...
|2|If you are logged into the Control Panel when you place the order, the billing contact will appear here. For further information on the different contact types, please read  [this guide](https://docs.ovh.com/au/en/customer/managing-contacts/){.external}.|
...
Our [General Terms and Conditions of Services](https://www.ovh.com.au/support/termsofservice/General_terms_and_conditions.pdf){.action} detail the conditions required for withdrawal from a contract.
