...
|2|If you are logged into the Control Panel when you place the order, the billing contact will appear here. For further information on the different contact types, please read  [this guide](https://docs.ovh.com/sg/en/customer/managing-contacts/){.external}.|
...
Our [General Terms and Conditions of Services](https://www.ovh.com/sg/support/termsofservice/General%20Terms%20and%20Conditions%20of%20Service%20Singapore.pdf){.action} detail the conditions required for withdrawal from a contract.
