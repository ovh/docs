...
È possibile recuperare il buono d’ordine in qualsiasi momento direttamente nello [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), come spiegato nel paragrafo successivo.

### Visualizza i tuoi ordini nello Spazio Cliente OVHcloud

Accedi allo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) e, nella scheda `Dashboard`{.action}, clicca su `Visualizza i tuoi ordini`{.action}.
...
|Stato|Descrizione|
|---|---|
|Pagamento non ricevuto|Questo stato corrisponde a un buono d'ordine che non ha ancora ricevuto il pagamento. Senza pagamento da parte tua, l'ordine scadrà e sarà annullato alla data indicata sul buono d'ordine. Se entro questo termine desideri effettuare l'acquisto, dovrai semplicemente inoltrare nuovamente l'ordine|
...
Una volta generato il buono d'ordine, è possibile eseguire l'ordine direttamente dallo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr):

* Clicca sulla tua `dashboard`, poi su `Visualizza i tuoi ordini`{.action} e infine su `...`{.action} davanti al tuo ordine.
...
L’articolo 12.1.2 delle nostre [Condizioni Generali di Servizio](https://www.ovh.com/fr/support/documents_legaux/conditions%20generales%20de%20service.pdf){.action} specifica che, *ai sensi dell’articolo introduttivo del Codice del consumo, i clienti in qualità di consumatori usufruiscono di un diritto di recesso di 14 giorni.*

Troverai tutte le modalità di applicazione del diritto di recesso nel prosieguo di tale articolo.

> [!warning]
>
> Il diritto di recesso riguarda soltanto i privati e si applica solo ai nuovi ordini. Non è possibile utilizzarlo per rinnovi o se il tuo [account cliente OVHcloud](https://docs.ovh.com/fr/customer/tout-savoir-sur-identifiant-client/#modifier-le-type-de-compte) è di tipo diverso da quello *Privato*.
>
> Inoltre, il diritto di recesso non si applica agli ordini non pagati, in quanto questi vengono automaticamente annullati quando il buono d'ordine scade
>

Se i criteri di idoneità al diritto di recesso sono soddisfatti, il diritto di recesso può essere esercitato direttamente dallo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr):
