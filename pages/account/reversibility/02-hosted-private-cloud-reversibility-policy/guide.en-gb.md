...
|---|---|---|---|---|
|vRack|vRack, or Virtual rack, is a private VLAN technology that enables connection between OVHcloud services|N/A|**Inbound migration**: Hosted private Cloud is included by default into vRack.<br><br>**Outbound migration**: Record the network architecture and reproduce it with VLAN.|[Using Private Cloud with vRack](/pages/cloud/private-cloud/using_private_cloud_in_vrack)<br><br>[How to create a V(x)LAN](/pages/cloud/private-cloud/creation_vlan-vxlan/)|
