...
- knowing the OVHcloud account security [best practices](https://docs.ovh.com/asia/en/customer/all-about-your-username/)
...
If you have enabled [two-factor authentication](https://docs.ovh.com/asia/en/customer/secure-account-with-2FA/), you will then need to enter the unique connection code generated by your device (phone, tablet or U2F key).
...
If you have lost or forgotten your password, please follow [this guide detailing the steps to take in order to change it](https://docs.ovh.com/asia/en/customer/manage-password/#if-you-have-forgotten-your-current-password).
...
Once this action has been completed, please [enter a **new** backup email address](https://docs.ovh.com/asia/en/customer/all-about-your-username/#backup-email) in your account settings.
...
Please refer to our guide on [Securing your OVHcloud account with two-factor authentication](https://docs.ovh.com/asia/en/customer/secure-account-with-2FA/#what-do-i-do-if-i-lose-one-of-my-devices-or-if-it-stops-working) for the appropriate steps.
