...
- Haber consultado las [buenas prácticas de seguridad de su cuenta de OVHcloud](https://docs.ovh.com/es/customer/todo-sobre-el-id-de-cliente/).
...
Si ha activado la [doble autenticación](https://docs.ovh.com/es/customer/proteger-su-cuenta-con-una-2FA/), deberá introducir el código único de conexión generado por su periférico (teléfono, tableta o llave U2F).
...
Consulte los pasos adecuados en nuestra guía "[Proteger su cuenta de OVHcloud con la doble autenticación](https://docs.ovh.com/es/customer/proteger-su-cuenta-con-una-2FA/#que-se-debe-hacer-en-caso-de-perdida-o-averia-de-uno-de-los-dispositivos)".
