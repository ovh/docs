...
Find all policies, including those pre-generated by OVHcloud, by calling the API: **/iam/policy**
...
These actions are specific to every product, such as rebooting a database, ordering an upgrade, restoring a snapshot, etc.
