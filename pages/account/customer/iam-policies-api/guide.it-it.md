...
- One or more **identities** targeted by this policy. 
    - It can be account IDs, users or user groups (like the ones used in [federation](/pages/account/customer/ovhcloud-account-connect-saml-sso)). 
...
If the federation is enabled through the [SSO connection](/pages/account/customer/ovhcloud-account-connect-saml-sso), policies only apply to user groups as described in the previous section.
