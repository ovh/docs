...
Here, you can either import the OVHcloud SP metadata, or enter data about the relying party manually.
...
You can then check that the group is added to your OVHcloud account:
