...
You are now logged in with the same [NIC handle](https://docs.ovh.com/au/en/customer/create-ovhcloud-account/#what-is-my-nic-handle), but via your Active Directory user and using your Azure AD application SSO.
