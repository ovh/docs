...
- Eine oder mehrere **Identitäten**, auf die sich diese Richtlinie bezieht.
    - Es kann sich um Account-IDs, Benutzer oder Benutzergruppen handeln (wie sie auch für den Zugang über [Federation](/pages/account/customer/ovhcloud-account-connect-saml-adfs) verwendet werden - weitere SSO-Hilfen stehen zur Verfügung).
...
- Sie haben einen [OVHcloud Kunden-Account](/pages/account/customer/ovhcloud-account-creation).
- Sie kennen die [Benutzerverwaltung für OVHcloud Kunden-Accounts](/pages/account/customer/ovhcloud-users-management).
...
Details zur Benutzerverwaltung finden Sie in [unserer Dokumentation](/pages/account/customer/ovhcloud-users-management).
