...
Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we){.external}, click `your name`{.action} (1) in the top right-hand corner, then click `My account`{.action} (2).
