---
title: 'Tutto sull’identificativo cliente OVHcloud'
excerpt: 'Come creare l’identificativo cliente e gestire i tuoi dati personali'
...
Se non disponi ancora di un identificativo cliente, accedi alla pagina [creazione dell’account OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr){.external} 
...
- consultare [la guida su come impostare e gestire la password del tuo account](../gestire-la-password/).
- rendi più sicuro l’accesso al tuo account attivando la doppia autenticazione. Per conoscere la procedura di attivazione, consulta questa guida: [Rendere sicuro il tuo account OVHcloud con la doppia autenticazione](../proteggi_il_tuo_account_con_2FA/).
...
![identificativo cliente](images/newhub1.png){.thumbnail}
...
Se necessario, completa la procedura di [doppia autenticazione](../proteggi_il_tuo_account_con_2FA/), che si aggiunge alle tue credenziali di accesso (nome utente e password) ed è gestita dal tuo dispositivo: telefono, tablet o chiave di sicurezza.
...
Se hai dimenticato o perso la password, [questa guida ti spiega la procedura da seguire per modificarla](../gestire-la-password/#modifica-la-password).

### Se il tuo indirizzo email non risulta più accessibile

Se hai indicato un indirizzo email di recupero, puoi[contattare il supporto OVHcloud](https://www.ovhcloud.com/it/contact/) per chiedere di impostarlo come indirizzo principale. Una volta effettuata questa operazione, è necessario indicare un nuovo indirizzo di recupero.

Se non hai indicato un indirizzo email di recupero o se quest’ultimo è inaccessibile, puoi seguire questa [procedura](http://www.ovh.it/cgi-bin/it/procedure/procedureChangeEmail.cgi){.external} e inviarci il form tramite email. Quando lo riceveremo, procederemo a modificare il tuo indirizzo e-mail di contatto, a patto che tutti i documenti forniti sono validi.
...
![identificativo cliente](images/newhub2.png){.thumbnail}

Clicca sui `...`{.action} nella sezione “Il tuo profilo” e infine su `Modifica il tuo profilo`{.action}.

![identificativo cliente](images/nichandle06.png){.thumbnail}
...
È possibile richiedere la rimozione dell’identificativo cliente e i relativi dati, compilando [il modulo per l’esercizio dei diritti GDPR](https://www.ovh.it/protezione-dati-personali/esercita-i-tuoi-diritti){.external} e selezionando il ”Diritto alla cancellazione”.
...
Un utente ha la possibilità di detenere diritti di lettura o scrittura sul tuo account e su tutti i tuoi servizi. È possibile creare, gestire e rimuovere questi utenti dal tuo Spazio Cliente. Per saperne di più, consulta [la guida sulla gestione degli utenti](../gestisci_gli_utenti/). 

### Gestisci i contatti

È possibile delegare la gestione amministrativa **o** tecnica **o** di fatturazione di uno o più servizi del tuo account a un altro identificativo cliente. Per saperne di più, consulta [la guida sulla gestione dei contatti](../gestisci_i_tuoi_contatti/).
