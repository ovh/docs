...
- an understanding of the [password management recommendations for accessing your account](https://docs.ovh.com/sg/en/customer/manage-password/)
...
- [Enabling two-factor authentication via mobile application](https://docs.ovh.com/sg/en/customer/enable-two-factor-authentication-via-mobile-application/)
- [Enabling two-factor authentication via security key](https://docs.ovh.com/sg/en/customer/enable-two-factor-authentication-via-security-key/)
