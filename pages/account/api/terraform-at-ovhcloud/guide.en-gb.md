...
> - When multiples resources are available for one GUI concept, only the main resource is provided in this list.
...
| Control Panel concept | Terraform provider(s) | Resource or Data Source  |
| --- | --- | --- |
| AI Notebooks | not available but [ovhai CLI](../../../platform/ai/cli_15_commands_reference/guide.en-gb.md) can help for automation||
| AI Training | not available but [ovhai CLI](../../../platform/ai/cli_15_commands_reference/guide.en-gb.md) can help for automation||
| AI Deploy | not available but [ovhai CLI](../../../platform/ai/cli_15_commands_reference/guide.en-gb.md) can help for automation||
...
- [Using OVHcloud High Performance (S3) Object Storage as Terraform Backend to store your Terraform state](https://docs.ovh.com/gb/en/public-cloud/use_high_perf_object_storage_terraform_backend_state/)
