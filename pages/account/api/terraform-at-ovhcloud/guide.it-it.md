...
| Control Panel concept | Terraform provider(s) | Resource or Data Source  |
| --- | --- | --- |
| AI Notebooks | not available but [ovhai CLI](https://docs.ovh.com/it/publiccloud/ai/cli/overview-cli/) can help for automation||
| AI Training | not available but [ovhai CLI](https://docs.ovh.com/it/publiccloud/ai/cli/overview-cli/) can help for automation||
| AI Deploy | not available but [ovhai CLI](https://docs.ovh.com/it/publiccloud/ai/cli/overview-cli/) can help for automation||
