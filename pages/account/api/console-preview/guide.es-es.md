...
> [!primary]
>
> If your OVHcloud account is protected by [two-factor authentication](https://docs.ovh.com/es/customer/proteger-su-cuenta-con-una-2FA/), you will also need to enter the code generated by SMS or OTP mobile application or U2F key.
>
...
[Managing a Domain Name with the OVHcloud API](https://docs.ovh.com/es/domains/api/)
