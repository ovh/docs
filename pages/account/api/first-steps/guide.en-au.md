...
> [!primary]
>
> If your OVHcloud account is protected by [two-factor authentication](https://docs.ovh.com/au/en/customer/secure-account-with-2FA/), you will also need to enter the code generated by SMS or OTP mobile application or U2F key.
>
...
The **CK** token can be used for rights delegation. See the following guide for more information: [How to manage a customer’s account via OVHcloud API](https://docs.ovh.com/au/en/api/api-rights-delegation/)
...
[How to manage a customer’s account via OVHcloud API](https://docs.ovh.com/au/en/api/api-rights-delegation/)
