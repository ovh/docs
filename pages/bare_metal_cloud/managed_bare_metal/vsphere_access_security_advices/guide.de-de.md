...
Diese Einstellungen können Sie im [OVHcloud Kundencenter](/links/manager) vornehmen. Gehen Sie hierzu in Ihrem Managed Bare Metal Bereich auf `Sicherheit`{.action}. Klicken Sie dann rechts auf den Button `Sitzungstimeout ändern`{.action}.
