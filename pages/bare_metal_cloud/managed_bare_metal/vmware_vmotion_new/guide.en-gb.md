...
The option "Change storage only" allows to migrate the VM to another datastore. It is explained in [this guide](/pages/bare_metal_cloud/managed_bare_metal/vmware_storage_vmotion).
