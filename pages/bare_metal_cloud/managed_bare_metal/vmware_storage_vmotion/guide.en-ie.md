...
The option "Change compute resource only" allows to migrate the VM to another host. It is explained in [this guide](/pages/bare_metal_cloud/managed_bare_metal/vmware_vmotion_new).
...
For example, you can apply the storage policies created if you have the [VMencryption](/pages/bare_metal_cloud/managed_bare_metal/vm_encrypt) option.
