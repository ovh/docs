...
La cuarta regla, «máquinas virtuales a máquinas virtuales», viene explicada en nuestra guía sobre la [funcionalidad HA](/pages/bare_metal_cloud/managed_bare_metal/vmware_ha_high_availability).
