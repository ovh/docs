...
Accedi allo [Spazio Cliente OVHcloud](/links/manager) e, nella sezione `Bare Metal Cloud`{.action}  (1), clicca su `Managed Bare Metal`{.action} (2), seleziona il server dalla lista (3) e clicca sulla scheda `Utenti`{.action}(4).
