...
After your [Managed Bare Metal infrastructure](/links/websitemanaged-bare-metal/) is delivered, it will be displayed in the section `vRack` (under "Bare Metal Cloud" in your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca)) and the "datacenter" will be automatically included into a vRack.
