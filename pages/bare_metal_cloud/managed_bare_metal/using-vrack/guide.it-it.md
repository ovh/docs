...
Al momento della consegna del servizio [Managed Bare Metal](/links/websitemanaged-bare-metal/), la sezione *datacenter* è già all'interno di una vRack.
...
È possibile modificare le impostazioni o crearne di nuove seguendo la guida alla [creazione di VLAN](/pages/bare_metal_cloud/managed_bare_metal/vlan-creation).
