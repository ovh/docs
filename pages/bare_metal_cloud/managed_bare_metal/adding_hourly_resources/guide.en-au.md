...
With our [Managed Bare Metal solutions](https://www.ovhcloud.com/en-au/managed-bare-metal/), you can add resources that are billed per hour of usage.

**This guide will show you how to add hourly resources via the Managed Bare Metal vSphere interface.**

## Requirements

- a [Managed Bare Metal](https://www.ovhcloud.com/en-au/managed-bare-metal/) solution
