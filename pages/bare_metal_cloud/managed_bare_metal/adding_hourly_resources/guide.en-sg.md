...
With our [Managed Bare Metal solutions](/links/websitemanaged-bare-metal/){.external}, you can add resources that are billed per hour of usage.

**This guide will show you how to add hourly resources via the Managed Bare Metal vSphere interface.**

## Requirements

- a [Managed Bare Metal](/links/websitemanaged-bare-metal/){.external} solution
