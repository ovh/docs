...
- [active Windows licences](/pages/bare_metal_cloud/managed_bare_metal/manager-ovhcloud#windows-licence-tab) (activate via the [OVHcloud Control Panel](/links/manager), in the `Windows licence`{.action} tab for the datacentre)
