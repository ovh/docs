...
- [Ter ativado as licenças Windows](/pages/bare_metal_cloud/managed_bare_metal/manager-ovhcloud#licence-windows) na [Área de Cliente OVHcloud](/links/manager) (separador `Licença Windows`{.action} do datacenter). 
