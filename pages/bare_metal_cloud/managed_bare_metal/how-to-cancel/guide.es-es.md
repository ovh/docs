...
- Estar conectado al [área de cliente de OVHcloud](/links/manager), en el menú `Servidores`{.action} > `Managed Bare Metal`{.action}.
...
Conéctese al [área de cliente de OVHcloud](/links/manager), acceda al menú `Servidores`{.action} (1), haga clic en la sección `Managed Bare Metal`{.action} (2) y seleccione su servicio en la lista (3).
