...
Log in to your [OVHcloud Control Panel](/links/manager), go to `Bare Metal Cloud`{.action} (1), click on `Managed Bare Metal`{.action} (2) and select your offer from the list (3).
