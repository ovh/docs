...
<div id="main-content" class="wiki-content table-meltown-spectre">
   ...
   <p style="text-align: left;"><em>Please note that you can also see the status of <a class="external-link" href="/pages/bare_metal_cloud/dedicated_servers/meltdown_spectre_fixes" rel="nofollow">each <span class="caps">OVH</span> product in this </a><a class="external-link" href="/pages/bare_metal_cloud/dedicated_servers/meltdown_spectre_fixes" rel="nofollow">page</a>.</em></p>
