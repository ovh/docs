...
- The **GAME firewall** (only available for [OVHcloud **Game** dedicated servers](https://www.ovhcloud.com/en-ie/bare-metal/prices/#filterType=range_element&filterValue=game)) state can be:
