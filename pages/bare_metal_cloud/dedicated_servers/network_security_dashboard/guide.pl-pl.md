...
- Stan **GAME firewall** (dostępny tylko dla [OVHcloud **Game** dedicated servers](/links/websitebare-metal/prices/#filterType=range_element&filterValue=game)) może być następujący:
