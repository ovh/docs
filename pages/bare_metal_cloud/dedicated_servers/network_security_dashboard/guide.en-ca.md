...
> [!primary]
>
> Find more information on how DDoS mitigation is achieved at OVHcloud [here](https://www.ovhcloud.com/en-ca/security/anti-ddos/ddos-attack-mitigation/).
>
...
- The **GAME firewall** (only available for [OVHcloud **Game** dedicated servers](https://www.ovhcloud.com/en-ca/bare-metal/prices/#filterType=range_element&filterValue=game)) state can be:
