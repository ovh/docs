...
Log in to your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg). Switch to the `Bare Metal Cloud`{.action} section and select your server from **Dedicated Servers**. In the `Hardware`{.action} tab, click on `Increase storage`{.action}. If you wish to increase RAM instead, click on `Increase RAM`{.action}.
