...
Afterwards, access the [IPMI console](#procedure) in your [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie). You should see the server's BIOS menu displayed.
