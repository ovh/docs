...
Afterwards, access the [IPMI console](#instructions) in your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we). You should see the server's BIOS menu displayed.
