...
Acceda a la [consola IPMI](#instructions) desde el [área de cliente de OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=ws). Debe aparecer el menú del BIOS del servidor.
