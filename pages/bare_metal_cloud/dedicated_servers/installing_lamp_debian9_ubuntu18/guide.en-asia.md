...
- A [dedicated server](/links/bare-metal/bare-metal), a [VPS](/links/websitevps/) or a [Public Cloud instance](/links/websitepublic-cloud/) in your OVHcloud account (excluding Windows systems)
