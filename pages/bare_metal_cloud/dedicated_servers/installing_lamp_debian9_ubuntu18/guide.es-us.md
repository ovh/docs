...
- Un [servidor dedicado](/links/bare-metal/bare-metal), un [VPS](/links/websitevps/) o una instancia de [Public Cloud](/links/websitepublic-cloud/) en su cuenta de OVHcloud (excepto sistemas Windows)
