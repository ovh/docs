...
Remember to change the boot mode of your server back to the regular mode before you restart it in your [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/&ovhSubsidiary=GB).

Refer to the [rescue mode guide](#step1) if necessary.
