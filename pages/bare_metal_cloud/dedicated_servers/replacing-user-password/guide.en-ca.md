...
- A [dedicated server](https://www.ovhcloud.com/en-ca/bare-metal/) or a [VPS](https://www.ovhcloud.com/en-ca/vps/) with a Linux-based OS in your OVHcloud account
...
Remember to use the regular boot mode of your server when restarting it in your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca).
