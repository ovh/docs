...
As well as private IP addressing, the [vRack](https://www.ovhcloud.com/en-au/network/vrack/){.external} also allows you to route public IP traffic through your server's [vRack](https://www.ovhcloud.com/en-au/network/vrack/){.external} port using a public IP address block.
...
> [!primary]
>
> For example purposes we'll be using an IP block of 46.105.135.96/28 and eth1 for the secondary network interface, which is dedicated to the [vRack](https://www.ovhcloud.com/en-au/network/vrack/){.external}.
> 
