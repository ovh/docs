...
No caso de um disco NVMe, será preciso pôr o servidor em [modo rescue](/pages/bare_metal_cloud/dedicated_servers/rescue_mode) e instalar a ferramenta `nvme-cli`.
