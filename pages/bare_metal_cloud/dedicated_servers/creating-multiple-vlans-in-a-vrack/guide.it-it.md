...
* Accesso amministrativo (sudo) al server via SSH
...
>>
> **Ubuntu 20.04+ e Debian 12+**
>>
>> Ubuntu 20.04 e versioni successive, Debian 12 e versioni successive
>>
...
Poi clicca su `Change adapter settings`{.action}.
