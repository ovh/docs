...
> [!primary]
>
> Since October 6th, 2022 our service "Failover IP" has been named [Additional IP](https://www.ovhcloud.com/en-au/network/additional-ip/). This renaming has no impact on its technical features.
>
...
- You must have [Additional IP addresses](https://www.ovhcloud.com/en-au/bare-metal/ip/)
...
* You must have a [server compatible with vRack](https://www.ovhcloud.com/en-au/bare-metal/).
* Activate a [vRack service](https://www.ovhcloud.com/en-au/network/vrack/).
