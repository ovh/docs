...
- You must have [Additional IP addresses](https://www.ovhcloud.com/en-ie/bare-metal/ip/)
...
* You must have a [server compatible with vRack](https://www.ovhcloud.com/en-ie/bare-metal/).
* Activate a [vRack service](https://www.ovhcloud.com/en-ie/network/vrack/).
