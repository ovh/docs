...
- Tener un servidor dedicado compatible con la opción [SGX](/links/websitebare-metal/intel-software-guard-extensions/){.external}
...
Acceda a </links/apiconsole/> y, a continuación, haga clic en el botón `Login`{.action} situado en la esquina superior derecha de la página.  
