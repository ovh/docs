...
>
> Per configurare il tuo primo server dedicato OVHcloud, consulta la nostra guida [Iniziare a utilizzare un server dedicato](/pages/bare_metal_cloud/dedicated_servers/getting-started-with-dedicated-server).
>
...
Per maggiori informazioni su iptables, consulta la nostra [guida dedicata](/pages/bare_metal_cloud/dedicated_servers/firewall-Linux-iptable).
...
Per ulteriori informazioni sulle nostre soluzioni di backup, consulta la guida [Backup storage](/pages/bare_metal_cloud/dedicated_servers/services_backup_storage).
