...
Après avoir redémarré votre serveur en [mode rescue](/pages/bare_metal_cloud/dedicated_servers/rescue_mode), vous devez identifier la partition système. Pour ce faire, exécutez la commande suivante :
...
[Changer le mot de passe administrateur sur un serveur dédié Windows](/pages/bare_metal_cloud/dedicated_servers/changing-admin-password-on-windows)
