...
- The new MAC address (viewable in the tab `Network interfaces`{.action} in the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es) or in the return of the command `ip link`).
