...
Suite au remplacement de la carte mère, vous ne pouvez pas modifier les nouvelles adresses MAC via le fichier `esxi.conf` via les outils intégrés au mode rescue.
