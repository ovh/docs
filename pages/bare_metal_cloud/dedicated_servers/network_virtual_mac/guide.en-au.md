...
- A [dedicated server](https://www.ovhcloud.com/en-au/bare-metal/) that supports [virtual MACs](/pages/bare_metal_cloud/dedicated_servers/network_support_virtual_mac).
- An [Additional IP address](https://www.ovhcloud.com/en-au/bare-metal/ip/){.external} or an Additional IP block (RIPE).
- Access to your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au){.external} or to the [OVHcloud API](https://ca.api.ovh.com/).
