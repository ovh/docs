...
- A [dedicated server](https://www.ovhcloud.com/en/bare-metal/) that supports [virtual MACs](/pages/bare_metal_cloud/dedicated_servers/network_support_virtual_mac).
