...
Więcej informacji znajdziesz w przewodniku dotyczącym [bezpieczeństwa serwera dedykowanego](/pages/bare_metal_cloud/dedicated_servers/securing-a-dedicated-server).
...
>
> Więcej informacji na temat dostępu do tego narzędzia znajdziesz w [tym przewodniku](/pages/bare_metal_cloud/dedicated_servers/using_ipmi_on_dedicated_servers).  
> 
