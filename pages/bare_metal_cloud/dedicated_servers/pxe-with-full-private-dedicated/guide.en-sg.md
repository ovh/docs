...
Get a private infrastructure without having to change the default configuration for your [OVHcloud dedicated servers](https://www.ovhcloud.com/en-sg/bare-metal/).
...
With [OVHcloud dedicated servers](https://www.ovhcloud.com/en-sg/bare-metal/), you can configure/declare your own networks.<br>
...
We will present the case of [dedicated server(s)](https://www.ovhcloud.com/en-sg/bare-metal/) configured in **OLA** mode, i.e. with **only** private networks.
...
- At least one [dedicated server](https://www.ovhcloud.com/en-sg/bare-metal/) with an operating system **already installed**.
...
>
> To check that your machine is eligible for our procedure, log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg) and click on the `Bare Metal Cloud`{.action} tab.
>
