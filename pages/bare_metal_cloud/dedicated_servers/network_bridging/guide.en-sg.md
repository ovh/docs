...
>
> This guide is not applicable to servers of the ranges [Scale](https://www.ovhcloud.com/en-sg/bare-metal/scale/) and [High Grade](https://www.ovhcloud.com/en-sg/bare-metal/high-grade/). The same goes for the latest Advance server range delivered, based on CPU AMD Epyc 4K and 8K CPUs.
> 
