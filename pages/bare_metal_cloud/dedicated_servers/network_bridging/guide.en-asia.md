...
>
> This guide is not applicable to servers of the ranges [Scale](/links/bare-metal/bare-metal/scale/) and [High Grade](/links/bare-metal/bare-metal/high-grade/). The same goes for the latest Advance server range delivered, based on CPU AMD Epyc 4K and 8K CPUs.
> 
