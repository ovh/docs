...
Mit der Option [Backup Storage](/links/websitebare-metal/backup-storage/) können Sie Daten auf einem externen Dienst speichern, der von Ihrem Server unabhängig ist.
