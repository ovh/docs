...
**Cet article a pour objectif de vous montrer comment choisir un schéma de partitionnement dans l'[espace client OVHcloud](https://ovh.com/manager/manager/#/dedicated/configuration) ou l'[API OVHcloud](https://api.ovh.com/).**
...
>
> Le saviez-vous ?
> La solutions [Hosted Private Cloud d'OVHcloud](https://www.ovhcloud.com/fr/hosted-private-cloud/vmware/) est basée sur des installations ESXi avec le schéma de partitionnement `small`.
>
