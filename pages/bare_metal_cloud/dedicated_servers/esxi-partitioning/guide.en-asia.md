...
> Did you know?
>
> [OVHcloud's Hosted Private Cloud solution](https://www.ovhcloud.com/asia/hosted-private-cloud/vmware/) is based on ESXi with the partitioning layout `small`.
>
...
Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://ovh.com/manager/asia/&ovhSubsidiary=asia). From the `General information`{.action} tab, click the `...`{.action} button next to the operating system and then click `Install`{.action}.
