...
> Did you know?
>
> [VMware on OVHcloud solutions](https://www.ovhcloud.com/pt/hosted-private-cloud/vmware/) is based on ESXi with the partitioning layout `small`.
>
...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pt/&ovhSubsidiary=pt). From the `General information`{.action} tab, click the `...`{.action} button next to the operating system and then click `Install`{.action}.
