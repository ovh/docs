...
OVHcloud oferuje gamę serwerów [dedykowanych Storage](/links/websitebare-metal/storage/){.external} dostosowanych do przechowywania kopii zapasowych i wyposażonych w minimum cztery dyski twarde. Istnieje możliwość wykorzystania tych zasobów do zapisywania kopii zapasowych infrastruktury hostowanej w OVHcloud lub u innego dostawcy za pośrednictwem sieci publicznej.
...
- [Serwer Storage OVHcloud](/links/websitebare-metal/storage/){.external}
- Infrastrukturę produkcyjną ([VPS](/links/websitevps/){.external}, [serwery dedykowane](/links/bare-metal/bare-metal){.external}, [Public Cloud](/links/websitepublic-cloud/){.external}…)
...
OVHcloud oferuje gamę [serwerów dedykowanych](/links/websitebare-metal/storage/){.external}, które posiadają kilka dysków twardych. W poniższym przykładzie prezentujemy RAID programowy (_soft RAID_) z czterema dyskami o pojemności 6 TB każdy. 
