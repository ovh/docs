...
- Un [serveur de stockage OVHcloud](/links/websitebare-metal/storage/){.external}.
- Une infrastructure de production ([VPS](/links/websitevps/){.external}, [serveurs dédiés](/links/bare-metal/bare-metal){.external}, [Public Cloud](/links/websitepublic-cloud/){.external}…).
...
OVHcloud dispose d'une gamme de [serveurs de stockage](/links/websitebare-metal/storage/){.external} dont les configurations matérielles contiennent plusieurs disques durs. Dans notre exemple, nous possédons un RAID logiciel (ou _soft RAID_) de quatre disques d'une capacité de 6 To chacun.
