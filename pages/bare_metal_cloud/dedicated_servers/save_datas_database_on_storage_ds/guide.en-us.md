...
- an [OVHcloud Storage Server](https://www.ovhcloud.com/en/bare-metal/storage/)
...
- a private network between your servers ([OVHcloud vRack](https://www.ovh.com/world/solutions/vrack/)) is recommended
...
OVHcloud offers a range of [Storage Servers](https://www.ovhcloud.com/en/bare-metal/storage/) with hardware configurations that contain several hard disks. In our example, we are using a software RAID (or softRAID) with four disks, which each have 6 TB capacity.
