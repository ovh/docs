...
- einen [OVHcloud Storage Server](/links/bare-metal/bare-metalstorage/){.external}
...
OVHcloud bietet eine [Storage Server](/links/bare-metal/bare-metalstorage/){.external} Reihe, deren Hardwarekonfigurationen mehrere Festplatten enthalten. In unserem Beispiel verwenden wir ein Software-RAID (oder _SoftRAID_) mit vier Festplatten mit einer Speicherkapazität von jeweils 6 TB.
