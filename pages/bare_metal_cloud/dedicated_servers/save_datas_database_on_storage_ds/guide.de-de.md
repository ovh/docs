...
- einen [OVHcloud Storage Server](/links/websitebare-metal/storage/){.external}
- eine Produktionsinfrastruktur ([VPS](/links/websitevps/){.external}, [Dedicated Server](/links/bare-metal/bare-metal){.external}, [Public Cloud](/links/websitepublic-cloud/){.external}, ...)
...
OVHcloud bietet eine [Storage Server](/links/websitebare-metal/storage/){.external} Reihe, deren Hardwarekonfigurationen mehrere Festplatten enthalten. In unserem Beispiel verwenden wir ein Software-RAID (oder _SoftRAID_) mit vier Festplatten mit einer Speicherkapazität von jeweils 6 TB.
