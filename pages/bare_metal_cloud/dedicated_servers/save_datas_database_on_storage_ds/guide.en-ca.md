...
- an [OVHcloud Storage Server](https://www.ovhcloud.com/en-ca/bare-metal/storage/)
...
OVHcloud offers a range of [Storage Servers](https://www.ovhcloud.com/en-ca/bare-metal/storage/) with hardware configurations that contain several hard disks. In our example, we are using a software RAID (or softRAID) with four disks, which each have 6 TB capacity.
