...
Comme mentionné dans la [documentation API OVHcloud](/pages/manage_and_operate/api/first-steps#se-connecter-aux-api-ovhcloud), sur la [page des API OVHcloud](/links/apiconsole/) :
...
Ouvrez la [console API SoYouStart](https://ca.api.soyoustart.com/console/) ou [celle de Kimsufi](https://ca.api.kimsufi.com/console/).
