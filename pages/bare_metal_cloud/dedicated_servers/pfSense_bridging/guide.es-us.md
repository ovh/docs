...
routes:
    canonical: '/pages/bare_metal_cloud/dedicated_servers/pfSense_bridging'
updated: 2022-12-20
---
...
- At least one [Additional IP](https://www.ovhcloud.com/es/bare-metal/ip/) address attached to the server 
...
In the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=ws), go to the `Bare Metal Cloud`{.action} section and open the `IP`{.action} menu. 
