...
- At least one [Additional IP](https://www.ovhcloud.com/pt/bare-metal/ip/) address attached to the server 
...
In the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pt/&ovhSubsidiary=pt), go to the `Bare Metal Cloud`{.action} section and open the `IP`{.action} menu. 
