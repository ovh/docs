...
- A [vRack](https://www.ovhcloud.com/pt/network/vrack/){.external} service activated in your account
- A [vRack compatible server](https://www.ovhcloud.com/pt/network/vrack/){.external} attached to your vRack network
