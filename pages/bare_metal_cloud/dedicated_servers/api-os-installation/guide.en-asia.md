...
Fully automating OS installation or reinstallation on a [dedicated server](https://www.ovhcloud.com/asia/bare-metal/) with the [OVHcloud API](/pages/manage_and_operate/api/first-steps) can be interesting in various situations.
...
You can list all your [dedicated servers](https://www.ovhcloud.com/asia/bare-metal/) with the following API call:
...
Some [dedicated servers](https://www.ovhcloud.com/asia/bare-metal/) have multiple groups of disks. For example, one group with SATA disks and another group with SSD disks. Those servers are sometimes also called **hybrid servers**.
