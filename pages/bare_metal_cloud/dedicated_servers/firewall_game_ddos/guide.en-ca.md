...
- An [OVHcloud **Game** dedicated server](https://www.ovhcloud.com/en-ca/bare-metal/prices/#filterType=range_element&filterValue=game#filterType=range_element&filterValue=game)
