...
Conéctese a la [API de OVHcloud](/links/apiconsole/) con su ID de cliente y contraseña. Utilice las siguientes llamadas a la API para modificar el anuncio del bloque de IP:
