...
Si vous êtes bloqué hors de votre système, vous pouvez utiliser notre [mode rescue](/pages/bare_metal_cloud/virtual_private_servers/rescue/) pour rétablir vos modifications.
