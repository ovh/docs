...
Se você estiver bloqueado fora do seu sistema, pode usar o nosso ambiente [modo rescue](/pages/bare_metal_cloud/virtual_private_servers/rescue/) para restaurar as suas alterações.
