...
- Sie haben einen [VPS](/links/websitevps/) in Ihrem Kunden-Account.
...
Alle Informationen zu den für Ihren Dienst verfügbaren Backup-Lösungen finden Sie auf der [Produktseite](/links/websitevps/options/) und in den [zugehörigen Anleitungen](/products/bare-metal-cloud-virtual-private-servers).
