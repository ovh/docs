...
If you want to go further - notably by adding **automatic HTTPS**, a **reverse-proxy**, or hosting **multiple services** on the same VPS - we recommend you consult the **[guide for advanced users](/pages/bare_metal_cloud/virtual_private_servers/install_nextcloud_on_vps_advanced)**, which presents a more robust architecture based on Docker and a modern reverse-proxy.
