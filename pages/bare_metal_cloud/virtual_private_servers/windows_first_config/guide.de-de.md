...
Um auf die KVM-Konsole Ihres VPS zuzugreifen, folgen Sie [unserer Anleitung](/pages/bare_metal_cloud/virtual_private_servers/using_kvm_for_vps).
...
> [!primary]
> Um Ihr Windows-System mithilfe von Firewall-Regeln abzusichern, verwenden Sie unsere Anleitung "[Firewall auf einem Windows VPS konfigurieren](/pages/bare_metal_cloud/virtual_private_servers/activate-port-firewall-soft-win)".
>

### Windows Bootlogs aktivieren (optional)

Loggen Sie sich via Remote-Desktop-Verbindung oder [KVM](/pages/bare_metal_cloud/virtual_private_servers/using_kvm_for_vps) auf dem Server ein. Öffnen Sie das Windows Startmenü und klicken Sie auf `Run`{.action}.
