...
- VPS musi być w trybie Rescue (aby uzyskać więcej informacji, sprawdź [Aktywacja trybu Rescue na serwerze VPS](/pages/bare_metal_cloud/virtual_private_servers/rescue)).
...
Możesz teraz wyjąć serwer VPS z trybu Rescue. (więcej informacji znajdziesz w przewodniku [Aktywacja trybu Rescue na serwerze VPS](/pages/bare_metal_cloud/virtual_private_servers/rescue))
