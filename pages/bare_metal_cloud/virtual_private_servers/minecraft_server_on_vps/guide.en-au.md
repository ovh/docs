...
<br>It is recommended to order a new VPS or reinstall an existing one from your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au), using the latest available release of Ubuntu or Debian. Please refer to our [Getting started guide](/pages/cloud/vps/starting_with_a_vps#reinstallvps) if necessary.
