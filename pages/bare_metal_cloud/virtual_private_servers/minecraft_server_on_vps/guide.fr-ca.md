...
<br>Sur le [site Web officiel de Minecraft](https://minecraft.net/download/server), faites un clic droit sur le lien de téléchargement et sélectionnez `Copier l'adresse du lien`{.action}.
