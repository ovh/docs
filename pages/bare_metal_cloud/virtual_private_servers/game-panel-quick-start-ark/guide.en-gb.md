...
<!-- DRAFT: To screenshot — Game selection with ARK: Survival Evolved highlighted -->
...
<!-- DRAFT: To screenshot — Installation progress with logs panel -->
...
<!-- DRAFT: To screenshot — Server status showing Running -->
...
<!-- DRAFT: To screenshot — Connection details panel with IP and port -->
