...
- A [VPS](/links/websitevps/) in your OVHcloud account
...
If your VPS is of the [**current ranges**](/links/websitevps/), no automatic mounting will occur and the `MOUNTPOINT` column should be empty. In that case, proceed with [step 4](#step4).
...
If your VPS is of the [**current ranges**](/links/websitevps/), first make sure the mount folder is created:
