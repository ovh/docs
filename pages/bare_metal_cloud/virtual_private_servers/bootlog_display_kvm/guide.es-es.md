...
Reinicie el servidor en modo de rescate desde el área de cliente. Si lo necesita, consulte nuestra [guía sobre el modo de rescate](/pages/bare_metal_cloud/virtual_private_servers/rescue).
