...
- dispor de um [VPS](/links/websitevps/) na sua conta OVHcloud
...
Se o seu VPS pertencer às [**gamas VPS atuais**](/links/websitevps/), não será efetuada nenhuma montagem automática e a coluna "MOUNTPOINT" deverá estar vazia. Nesse caso, passe [ao passo 4](#step4).
...
Se o seu VPS pertence às [**gamas VPS atuais**](/links/websitevps/), verifique primeiro se a pasta de montagem foi criada:
