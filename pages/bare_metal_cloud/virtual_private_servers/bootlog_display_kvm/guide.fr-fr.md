...
Si votre VPS appartient aux [**gammes VPS actuelles**](/links/websitevps/), aucun montage automatique ne sera effectué et la colonne "MOUNTPOINT" devrait être vide. Dans ce cas, passez à [l'étape 4](#step4).
...
Si votre VPS appartient aux [**gammes VPS actuelles**](/links/websitevps/), vérifiez d'abord que le dossier de montage est créé :
