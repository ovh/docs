...
- [Aplicación persistente en Red Hat y derivados (CentOS, Rocky & Alma Linux…)](#persistentredhat)
...
#### Aplicación persistente en Red Hat y sus derivados (CentOS, Rocky & Alma Linux, etc.) <a name="persistentredhat"></a>
