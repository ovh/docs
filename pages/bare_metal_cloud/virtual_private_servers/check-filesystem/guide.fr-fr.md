...
Lancez un redémarrage du serveur en mode rescue depuis l'espace client. Si nécessaire, consultez notre [guide du mode rescue](/pages/bare_metal_cloud/virtual_private_servers/rescue).
