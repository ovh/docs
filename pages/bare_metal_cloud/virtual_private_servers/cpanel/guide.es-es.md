...
- Tener contratado un servicio [VPS reciente](/links/bare-metal/vps){.external} con un [OS compatible con cPanel](/links/websitevps/os/).
- Haber iniciado sesión en el [área de cliente de OVHcloud](/links/manager).

## Procedimiento

Si ya tiene un VPS y desea instalar cPanel, puede reinstalar el VPS desde su [área de cliente de OVHcloud](/links/manager) a través de un [OS compatible con cPanel](/links/websitevps/os/).
