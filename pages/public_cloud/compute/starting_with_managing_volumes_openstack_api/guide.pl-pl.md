...
- [Przygotowanie środowiska do korzystania z API OpenStack](/pages/public_cloud/compute/prepare_the_environment_for_using_the_openstack_api) poprzez instalację Python-cinderclient oraz python-novaclient
