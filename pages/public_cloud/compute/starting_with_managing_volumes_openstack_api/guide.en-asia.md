...
- Preparing the environment to [use the OpenStack API](/pages/public_cloud/public_cloud_cross_functional/prepare_the_environment_for_using_the_openstack_api) by installing *python-cinderclient* and *python-novaclient*
