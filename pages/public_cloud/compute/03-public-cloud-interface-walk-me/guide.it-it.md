...
|**SSH Keys**|Uno strumento che ti permette di [gestire le tue chiavi SSH](/pages/public_cloud/compute/public-cloud-first-steps#step-1-crea-chiavi-ssh) in modo centralizzato.|
...
|**Contacts and Rights**|Oltre a modificare il contatto tecnico o di fatturazione del tuo progetto, puoi [aggiungere altri contatti](/pages/public_cloud/compute/change_project_contacts) (account OVHcloud) per gestire tecnicamente il tuo progetto. È inoltre possibile aggiungere utenti in consultazione solo *read-only*.|
