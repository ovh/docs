...
With the cloud-init module, you can configure your [Public Cloud instance](https://www.ovhcloud.com/en-ie/public-cloud/){.external} when you create it, and each time you reboot it. If you wish to reconfigure your hostname in order to fix an error creating your instance, or reconfigure your email server, you will need to disable the cloud-init module. This will configure the hostname so that it is not re-established.
...
- An [OVHcloud Public Cloud instance](https://www.ovhcloud.com/en-ie/public-cloud/){.external}
- [Root access](/pages/platform/public-cloud/public-cloud-first-steps#step-4-connecting-to-your-instance) (via SSH) to the instance
