...
<!-- CP-STEPS-START:create-instance-backup -->
> [!warning]
...
>>
<!-- CP-STEPS-END:create-instance-backup -->

### Creating an automated backup of an instance

<!-- CP-STEPS-START:automated-backup-and-manage -->
> [!primary]
>
...
<!-- CP-STEPS-END:automated-backup-and-manage -->
