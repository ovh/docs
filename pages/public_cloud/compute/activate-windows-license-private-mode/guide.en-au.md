...
We recommend that you read our guide on [Accessing the Horizon interface](/pages/public_cloud/public_cloud_cross_functional/introducing_horizon) to familiarise yourself with Horizon.
