...
>
> Al momento, la creazione di un backup remoto non è disponibile tramite lo Spazio Cliente OVHcloud. È possibile effettuare questa azione solo tramite l'API OVHcloud o OpenStack.
>
