...
>
> Atualmente, a criação de um backup remoto não está disponível via Área de Cliente OVHcloud. Você só pode realizar esta ação via API OVHcloud ou OpenStack.
>
