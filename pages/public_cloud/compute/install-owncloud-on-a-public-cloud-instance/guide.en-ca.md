...
- Infrastructure used: B2-15 [Public Cloud Instance](/links/websitepublic-cloud/){.external}
...
- A [Public Cloud Instance](/links/websitepublic-cloud/prices/){.external} in the [OVHcloud Control Panel](/links/manager){.external} with Ubuntu 18.04 installed
- Root SSH access on the Instance
- [Object Storage](/links/websitepublic-cloud/object-storage/){.external} in the same datacentre as your Public Cloud Instance (optional)
- [High-performance additional disk](/links/websitepublic-cloud/block-storage/){.external} in the same datacentre as your Public Cloud Instance (optional)
...
Find out more about [OVHcloud Object Storage](/links/websitepublic-cloud/object-storage/){.external}.
...
Find out more about [Public Cloud additional disks](/links/websitepublic-cloud/block-storage/){.external}.
