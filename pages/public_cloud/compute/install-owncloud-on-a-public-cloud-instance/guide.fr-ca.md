...
- Infrastructure utilisée : B2-15 [Instance Public Cloud](/links/websitepublic-cloud/){.external}
...
- Avoir une [instance de Public Cloud](/links/websitepublic-cloud/){.external} dans [l’espace client d’OVH](/links/manager){.external} avec Ubuntu 18.04 installé
- Accès root SSH sur l'Instance
- [ Stockage d'objets](/links/websitepublic-cloud/object-storage/){.external} dans le même datacenter que votre Public Cloud Instance (facultatif)
- [Disque supplémentaire de haute performance](/links/websitepublic-cloud/block-storage/){.external} dans le même datacenter que votre instance de Public Cloud (en option)
...
En savoir plus sur [l’Object Storage d’OVH](/links/websitepublic-cloud/object-storage/){.external}.
...
En savoir plus sur [les disques supplémentaires du Public Cloud](/links/websitepublic-cloud/object-storage/){.external}.
