...
- Tener acceso a la [interfaz Horizon](/pages/public_cloud/public_cloud_cross_functional/introducing_horizon).
...
>>
>> Haga clic en `Block Storage`{.action} en el menú de la izquierda bajo **Storage & Backup**.
>>
