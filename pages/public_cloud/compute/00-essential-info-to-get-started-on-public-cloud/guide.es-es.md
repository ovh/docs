...
|[Uso de una llave SSH](public_cloud/compute/creating-ssh-keys-pci)| Para conectarse a una instancia Linux, necesitará utilizar una conexión SSH en esta guía.|
