...
|[Korzystanie z klucza SSH](public_cloud/compute/creating-ssh-keys-pci)| Aby zalogować się do instancji Linux, zapoznaj się z tym przewodnikiem dotyczącym korzystania z tej instancji.|
