...
* Przeczytanie przewodnika [Przygotowanie środowiska do korzystania z API OpenStack](/pages/public_cloud/compute/prepare_the_environment_for_using_the_openstack_api){.external} (zalecane)
...
[Przeniesienie kopii zapasowej wolumenu do innego centrum danych](/pages/public_cloud/compute/transfer_volume_backup_from_one_datacentre_to_another){.external}
