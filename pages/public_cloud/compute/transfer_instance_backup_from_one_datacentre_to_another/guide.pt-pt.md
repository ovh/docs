...
[Transferir o backup de um volume de um datacenter para outro](/pages/public_cloud/compute/transfer_volume_backup_from_one_datacentre_to_another){.external}.
