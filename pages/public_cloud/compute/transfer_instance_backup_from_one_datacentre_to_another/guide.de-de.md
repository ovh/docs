...
* Sie haben die Anleitung “[Vorbereitung der Umgebung für die Verwendung der OpenStack API](/pages/public_cloud/compute/prepare_the_environment_for_using_the_openstack_api)“ gelesen (empfohlen).
...
[Transfer a volume backup from one datacentre to another](/pages/public_cloud/compute/transfer_volume_backup_from_one_datacentre_to_another)
