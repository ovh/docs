...
You now need to [create a new OpenStack user](/pages/public_cloud/compute/create_and_delete_a_user), then [generate the OpenRC file](/pages/public_cloud/compute/loading_openstack_environment_variables#step-1-recupera-le-variabili) containing all of the credentials you want to export as environment variables.
