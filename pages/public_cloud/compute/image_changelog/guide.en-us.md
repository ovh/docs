...
This documentation will only apply to [VPS](https://www.ovhcloud.com/en/vps/compare/) and [Public Cloud instances](https://www.ovhcloud.com/en/public-cloud/compute/).
