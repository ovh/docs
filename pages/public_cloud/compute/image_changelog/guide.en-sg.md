...
This documentation will only apply to [VPS](https://www.ovhcloud.com/en-sg/vps/compare/) and [Public Cloud instances](https://www.ovhcloud.com/en-sg/public-cloud/compute/).
