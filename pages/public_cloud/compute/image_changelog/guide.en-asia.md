...
This documentation will only apply to [VPS](https://www.ovhcloud.com/asia/vps/compare/) and [Public Cloud instances](https://www.ovhcloud.com/asia/public-cloud/compute/).
