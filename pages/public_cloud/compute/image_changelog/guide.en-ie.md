...
This documentation will only apply to [VPS](https://www.ovhcloud.com/en-ie/vps/compare/) and [Public Cloud instances](https://www.ovhcloud.com/en-ie/public-cloud/compute/).
