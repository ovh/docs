...
Utilice el [área de cliente de OVHcloud](/links/manager) / API o la API de OpenStack Horizon para instalar la aplicación que haya elegido en su instancia de Public Cloud.
