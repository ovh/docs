...
>> Cliquez sur [ce lien](/links/control-panel/publiccloud-projects) pour accéder à la section `Public Cloud`{.action}, puis cliquez sur `Instance backup`{.action} dans la barre de navigation de gauche sous **Compute**.
>>
...
> [!tabs]
> Via l'espace client OVHcloud
>> Cliquez sur [ce lien](/links/control-panel/publiccloud-projects) pour accéder à la section `Public Cloud`{.action}, puis cliquez sur `Instances`{.action} dans la barre de navigation de gauche sous **Compute**.
>>
