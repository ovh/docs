...
Lorsque vous cliquez sur `Activer le projet`{.action} depuis le `Mode découverte` et enregistrez un moyen de paiement, un **crédit d'essai de 270 $** est appliqué si vous êtes éligible.
