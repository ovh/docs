...
- [Ihr erstes Public Cloud Projekt erstellen](/pages/public_cloud/public_cloud_cross_functional/create_a_public_cloud_project)
- [Einführung in das Public Cloud Interface](/pages/public_cloud/public_cloud_cross_functional/03-public-cloud-interface-walk-me)
- [Erste Instanz erstellen](/pages/public_cloud/compute/public-cloud-first-steps)
- [Quota verwalten](/pages/public_cloud/public_cloud_cross_functional/increasing_public_cloud_quota)
...
Erstellen Sie anschließend ein [Public Cloud Projekt](/pages/public_cloud/public_cloud_cross_functional/create_a_public_cloud_project). Ein Projekt ist eine Umgebung, die einem Kontext zugeordnet wird.
...
Da Ihr Zahlungsmittel hinterlegt ist, wird der berechnete Betrag [am Ende des Monats abgebucht](/pages/public_cloud/public_cloud_cross_functional/analyze_billing). Diese Berechnung erfolgt auf der Grundlage der Nutzungszeit der einzelnen Ressourcen und des Preises der Ressourcen.
...
<br>Diese Quotas werden nach Region zugeteilt (im Sinne von OpenStack). Es kann daher sein, dass Sie das Maximum an Ressourcen für Ihr Projekt erreichen und [diese Quotas erhöhen müssen](/pages/public_cloud/public_cloud_cross_functional/increasing_public_cloud_quota).
...
|[Verfügbarkeit der Dienste nach Standort](/links/websitepublic-cloud/regions-availability/)|Verfügbarkeitstabellen der Dienste an den verschiedenen Standorten.|
...
|[Auf das Horizon-Interface zugreifen](/pages/public_cloud/public_cloud_cross_functional/introducing_horizon)|Das OpenStack Horizon Interface erlaubt einige erweiterte Einstellungen. Der Zugriff wird hier erklärt.|
...
|Dokumentation|Beschreibung|
|---|---|
|[OpenStack CLI](https://docs.openstack.org/python-openstackclient/stein/#using-openstackclient) (EN)|Die vollständige Dokumentation des essentiellen OpenStack Clients in der Kommandozeile. Dokumentation für die Version "Stein": Nutzen Sie [die Verfügbarkeitstabelle](/links/websitepublic-cloud/regions-availability/), um zu sehen, welche Dienstleistungen verfügbar sind.|
|[OpenStack API](https://docs.openstack.org/stein/api/) (EN)|Die vollständige Dokumentation zu OpenStack für die "Stein"-Version. Nutzen Sie [die Verfügbarkeitstabelle](/links/websitepublic-cloud/regions-availability/), um zu sehen, welche Dienstleistungen verfügbar sind.|
