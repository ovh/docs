...
- [Se familiariser avec l'interface Public Cloud](/pages/public_cloud/public_cloud_cross_functional/03-public-cloud-interface-walk-me)
- [Créer sa première instance](/pages/public_cloud/compute/public-cloud-first-steps)
- [Gérer ses quotas](/pages/public_cloud/public_cloud_cross_functional/increasing_public_cloud_quota)
...
Vous devrez ensuite [créer un projet Public Cloud](/pages/public_cloud/public_cloud_cross_functional/create_a_public_cloud_project). Un projet est un environnement que vous allez dédier à un contexte.
...
Votre moyen de payement étant enregistré, il servira à débiter le montant calculé pour votre [facturation en fin de mois](/pages/public_cloud/public_cloud_cross_functional/analyze_billing). Ce calcul est fait sur la base du temps d'utilisation de chaque ressource, en fonction du prix des ressources.
...
<br>Ces quotas sont attribués par localisation (région au sens OpenStack). Il se peut donc que vous atteigniez le maximum de ressources possibles sur votre projet et qu'il faille [augmenter ces quotas](/pages/public_cloud/public_cloud_cross_functional/increasing_public_cloud_quota).
...
|[Disponibilité des services par localisation](/links/websitepublic-cloud/regions-availability/)|Les tableaux de disponibilité des services à travers les différentes localisations.|
...
|[Accéder à l'interface Horizon](/pages/public_cloud/public_cloud_cross_functional/introducing_horizon)|L'interface Horizon d'OpenStack permet certaines actions avancées, voici comment vous y connecter.|
...
|Documentation|Détails|
|---|---|
|[OpenStack CLI](https://docs.openstack.org/python-openstackclient/stein/#using-openstackclient) (EN)|La documentation exhaustive de l'incontournable client en ligne de commande 'openstack'. Documentation pour la version Stein, référez-vous au [tableau de disponibilité](/links/websitepublic-cloud/regions-availability/) pour savoir quels sont les services disponibles.|
|[APIs OpenStack](https://docs.openstack.org/stein/api/) (EN)|La documentation exhaustive des APIs d'OpenStack. Documentation pour la version Stein, référez-vous au [tableau de disponibilité](/links/websitepublic-cloud/regions-availability/) pour savoir quels sont les services disponibles.|
