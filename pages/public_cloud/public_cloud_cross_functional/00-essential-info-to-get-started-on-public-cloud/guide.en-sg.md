...
- [Create your first Public Cloud project](/pages/public_cloud/public_cloud_cross_functional/create_a_public_cloud_project)
...
- [Manage quotas](/pages/public_cloud/public_cloud_cross_functional/increasing_public_cloud_quota)
...
You will then need to [create a Public Cloud project](/pages/public_cloud/public_cloud_cross_functional/create_a_public_cloud_project). A project is an environment that you will dedicate to a context.
...
Since your payment method has been saved, it will be used to debit the amount calculated for your [billing at the end of the month](/pages/public_cloud/public_cloud_cross_functional/analyze_billing). This calculation is based on the usage time of each resource, depending on the price of the resources.
