...
Aby zalogować się do interfejsu Horizon i pobrać plik, zapoznaj się [z tym przewodnikiem](/pages/public_cloud/public_cloud_cross_functional/introducing_horizon).
