...
Se non hai più bisogno di un [progetto Public Cloud](/links/websitepublic-cloud/), è possibile eliminarlo direttamente dallo Spazio Cliente [OVHcloud](/links/manager).
...
Clicca su `Parametri del progetto`{.action} nella sezione **Impostazioni** in basso nel menu a sinistra.
