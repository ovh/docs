...
Lorsque vous n’avez plus besoin d'un [projet Public Cloud](/links/websitepublic-cloud/), vous pouvez le supprimer directement depuis votre espace client [OVHcloud](/links/manager).
