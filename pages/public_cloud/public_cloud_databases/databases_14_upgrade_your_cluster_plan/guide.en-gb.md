...
To upgrade the service plan of your cluster, log in to the OVHcloud Control Panel and open your Public Cloud project. Click `Databases`{.action} in the left navigation bar, select your engine instance then you should direclty come across the `General Information`{.action} tab.

![Cluster overview](images/cluster_overview.png)

Click `Upgrade your plan`{.action} and choose the desired new plan of your cluster.
