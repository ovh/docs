...
In this tutorial, we are going to show you how to install [Wagtail](https://wagtail.org/) and how to connect it to the OVHcloud managed [PostgreSQL](https://www.postgresql.org/) [database service](https://www.ovhcloud.com/fr-ca/public-cloud/postgresql/).
