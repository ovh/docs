...
updated: 2023-07-10
routes:
    canonical: '/pages/public_cloud/public_cloud_databases/databases_13_update_your_cluster_flavor'
---
...
This option is available through the OVHcloud [API](https://api.ovh.com/console/) and [Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it).

### Requirements

- Access to your [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it) or to the [API](https://api.ovh.com/console/)
