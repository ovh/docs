...
Open your Public Cloud Databases service and click the `Queries in progress`{.action} tab.
...
Please refer to this [guide](/pages/public_cloud/public_cloud_databases/postgresql_03_connect_cli) to find out how to connect to your database using `psql`.
