...
![Choose database](images/databases_01_order_control_panel-20241208145850.png){.thumbnail}

### Step 2: Select a Plan

In this step, choose an appropriate service plan. You will be able to upgrade the plan after creation.

![Choose plan](images/databases_01_order_control_panel-20241208150215.png){.thumbnail}
...
![Choose region](images/databases_01_order_control_panel-20241208150326.png){.thumbnail}

### Step 4: Configure database nodes

You can choose the node template in this step.

![Order nodes](images/databases_01_order_control_panel-20241208150805.png){.thumbnail}
...
![Confirm order](images/databases_01_order_control_panel-20241208153010.png){.thumbnail}
