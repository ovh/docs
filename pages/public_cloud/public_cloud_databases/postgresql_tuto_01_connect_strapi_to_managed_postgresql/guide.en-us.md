...
In this tutorial, we are going to show you how to build a [Strapi](https://strapi.io/) application using the OVHcloud managed [PostgreSQL](https://www.postgresql.org/) database [service](https://www.ovhcloud.com/en/public-cloud/postgresql/).
