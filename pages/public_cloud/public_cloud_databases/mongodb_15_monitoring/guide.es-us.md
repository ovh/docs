...
You can use the main metrics and statistics in the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=ws) to track and manage your database instance.
...
For more information about Managed Databases for MongoDB, please visit our [product page](https://www.ovhcloud.com/es/public-cloud/mongodb/).
