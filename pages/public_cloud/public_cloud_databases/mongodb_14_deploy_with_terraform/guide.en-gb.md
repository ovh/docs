...
excerpt: Find out how to to set up an OVHcloud managed database service via Terraform within a vRack, as well as how to access it from other parts of your infrastructure.
updated: 2024-01-29
---
...
**This tutorial shows you how to set up an OVHcloud managed database service via Terraform within a vRack, as well as how to access it from other parts of your infrastructure.**

However, if you would like know how to do the same with Terraform, but over public network, you can find the tutorial here:
