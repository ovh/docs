...
routes:
    canonical: '/pages/public_cloud/data_analytics/data_processing/33_HOWTO_cancel-job-ui'
updated: 2020-03-06
---
...
In this guide, we are assuming that you're using the [OVHcloud Manager](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc){.external} to use Data Processing platform and you have already submitted a job.  
