...
routes:
    canonical: '/pages/public_cloud/data_analytics/data_processing/22_GETTINGSTARTED_monitor'
updated: 2020-03-06
---
...
In this guide, we are assuming that you're using the [OVHcloud Manager](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de){.external} to use the Data Processing platform and you have already submitted a job. 
...
- Access to the [OVHcloud Manager](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de){.external}
