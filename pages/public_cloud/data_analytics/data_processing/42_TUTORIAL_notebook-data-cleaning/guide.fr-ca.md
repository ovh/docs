...
Then, from the [OVHcloud Control Panel](/links/manager), go to the Object Storage section, locate your S3 bucket and upload your data by clicking `Add object`{.action}.
