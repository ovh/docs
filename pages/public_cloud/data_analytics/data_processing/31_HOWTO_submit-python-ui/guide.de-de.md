...
Please see [Creating Storage Containers in Customer Panel](/pages/storage_and_backup/object_storage/pcs_create_container){.external} or [Create an object container in Horizon](/pages/cloud/storage/object_storage/pcs_create_container#horizon) for more details.
