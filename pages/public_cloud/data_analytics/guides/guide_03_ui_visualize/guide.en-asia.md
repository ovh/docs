...
Log in to your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia) and switch to the `Public Cloud`{.action} section. After selecting your Public Cloud project, click on `Data Integration`{.action} in the left-hand navigation bar under **Data & Analytics**.
...
For more information please read the [CLI installation guide](/pages/public_cloud/data_analytics/guides/guide_01_cli_installation).
...
Please read the [CLI commands reference guide](/pages/public_cloud/data_analytics/guides/guide_02_cli_commands_reference) to help you create your first workflow:
