...
You can further customise your Kafka Connect by using advanced parameters. See the [Advanced parameters references documentation](/pages/public_cloud/data_analytics/analytics/kafkaconnect_02_advanced_parameters_references) for more information on the supported parameters.
