...
<!-- CP-STEPS-START:downloading-server-and-user-certificates -->
...
<!-- CP-STEPS-END:downloading-server-and-user-certificates -->
...
<!-- CP-STEPS-START:connection-methods -->
> [!primary]
...
<!-- CP-STEPS-END:connection-methods -->
