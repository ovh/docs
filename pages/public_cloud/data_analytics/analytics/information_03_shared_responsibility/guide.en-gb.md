...
OVHcloud Analytics services enable you to focus on building and deploying analytics-driven cloud applications while OVHcloud handles the infrastructure and ensures operational maintenance.

The RACI below details the shared responsibilities between OVHcloud and the customer for Analytics services.
This shared model helps relieve the customer’s operational burden.
...
For your information, a **Service** is considered an Analytics service, such as a Kafka, OpenSearch, Grafana cluster.
...
| Process and pay for alarms from managed devices in the Analytics infrastructure | I | RA |
| Maintain logs generated by Analytics services | RA | RA |
| Keep logs of the Service hosted on Analytics engines | RA |

##### **3.1.4. Storage**

| **Activity** | **Customer** | **OVHcloud** |
| --- | --- | --- |
| Managing content hosted on Analytics services  | RA | I |
...
| Maintain Analytics services and their extensions | C | RA |
...
| **Activity** | **Customer** | **OVHcloud** |
| --- | --- | --- |
| Intervening with Analytics services managed elements |  | RA |
...
| Deploy patches, update software, and information systems hosted in Analytics services | CI | RA |
| Confirm the customer's request to change the hardware or software for the Analytics service | A | R |
| Deploy patches, update, and configure the information system using Analytics services | RA |  |
| Perform preventive interventions on managed elements of the Analytics services | I | AR |
