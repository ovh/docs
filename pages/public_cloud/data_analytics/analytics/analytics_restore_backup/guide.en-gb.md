...
<!-- CP-STEPS-START:block-select-service -->
...
<!-- CP-STEPS-END:block-select-backup -->

### Step 4: Configure the target service

<!-- CP-STEPS-START:block-configure-target-service -->
...
<!-- CP-STEPS-END:block-configure-target-service -->

### Step 5: Wait for service creation

<!-- CP-STEPS-START:block-wait-service-creation -->
...
<!-- CP-STEPS-END:block-wait-service-creation -->
