...
You can further customize your Kafka by using advanced parameters. See the [Advanced parameters references documentation](/pages/public_cloud/data_analytics/analytics/kafka_03_advanced_parameters_references) for more information on the supported parameters.
