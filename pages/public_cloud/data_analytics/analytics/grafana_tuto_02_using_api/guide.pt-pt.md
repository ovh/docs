...
> [!warning]
> 
> Don't forget to set the `Authorised IP addresses` in the Dashboards configuration. See our guide on [Configuring your Grafana instance to accept incoming connections](/pages/public_cloud/data_analytics/analytics/grafana_02_prepare_for_incoming_connections) for more details.
