...
## Requirements
- An OVHcloud account
- An activated cloud project in your OVHcloud account (see [How to create a cloud project](/pages/public_cloud/compute/create_a_public_cloud_project){.external} and [How to activate the Data Processing service for your cloud project](/pages/public_cloud/data_processing/30_HOWTO_activate_project){.external} for details)
...
If you want to submit a python job, do not forget to upload your environment.yml file (see [How to generate environment file for Python jobs](/pages/public_cloud/data_processing/34_HOWTO_handle-python-environment){.external})
...
If you don't know how to set these parameters values, please refer to the page [How to fill the job submit form in the Data Processing page from the OVHcloud Manager](/pages/public_cloud/data_processing/32_HOWTO_fill-job-submit-form){.external})
...
If you want to check your results after the job is finished, you can download its logs from your Object Storage (see [Checking a job's logs in the Data Processing manager's page](/pages/public_cloud/data_processing/21_GETTINGSTARTED_check-job-logs)).
