...
routes:
    canonical: '/pages/public_cloud/data_processing/41_TUTORIAL_wordcount'
updated: 2021-01-20
---
...
- Data Processing activated (see [How to activate the Data Processing](/pages/public_cloud/data_processing/30_HOWTO_activate_project){.external} for details.)
