...
Rendez-vous dans le dossier où vous avez téléchargé votre image SNS Openstack et téléversez l'image (pour ce tutoriel, nous utilisons l'image `utm-SNS-EVA-4.8.3-openstack.qcow2`) :
