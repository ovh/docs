...
This type of public IP address is only available for [Public Cloud services](/links/websitepublic-cloud/), designed for cloud-native use cases and especially automation (e.g. Terraform, Ansible). They serve to expose a private instance or a private network service (Load Balancer for example) to the public network.
