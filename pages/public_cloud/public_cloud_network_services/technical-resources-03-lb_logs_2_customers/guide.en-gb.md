...
The forwarded logs are generated by [HAproxy](https://en.wikipedia.org/wiki/HAProxy) (the opensource component that is used to make the load balancing).
...
### How to use your Public Cloud Load Balancer logs?
