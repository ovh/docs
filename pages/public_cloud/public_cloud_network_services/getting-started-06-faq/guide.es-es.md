...
routes:
    canonical: '/pages/public_cloud/public_cloud_network_services/getting-started-06-faq'
updated: 2022-11-02
---
...
This feature comes from the Octavia Load Balancer component in the Yoga release which is not currently available. We are working on upgrading Octavia and Barbican from Victoria to Yoga. Once this is done, we will share this update on [this page](https://www.ovhcloud.com/es-es/public-cloud/regions-availability/).
