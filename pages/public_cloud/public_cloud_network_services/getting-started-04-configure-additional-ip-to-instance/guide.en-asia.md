...
- A [Public Cloud instance](/links/websitepublic-cloud/) in your OVHcloud account
- An [Additional IP address](/links/websitebare-metal/ip/) or an Additional IP block
