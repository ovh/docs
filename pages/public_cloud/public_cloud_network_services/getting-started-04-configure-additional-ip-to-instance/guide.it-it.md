...
- un'[istanza Public Cloud](/links/websitepublic-cloud/) nel tuo account OVHcloud
- un [indirizzo Additional IP](/links/websitebare-metal/ip/) o un blocco Additional IP
