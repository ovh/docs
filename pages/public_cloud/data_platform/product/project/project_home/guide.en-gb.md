...
![Project home](images/project_home.png){.thumbnail}
...
![card menu](images/card_menu.png){.thumbnail}
...
![move cards](images/move_cards.png){.thumbnail}
...
You can also easily download the service configuration files in the card settings. These files can later be imported into the same service on any Project.
...
![activate service](images/activate_service.png){.thumbnail}
