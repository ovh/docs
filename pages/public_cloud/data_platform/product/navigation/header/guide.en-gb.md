...
- Access your [organisation settings](/pages/public_cloud/data_platform/product/organisations/orga_settings) from any page on the Platform.
- Change language.
- Log-out.
...
This button allows you to open or close the [Sidebar](/pages/public_cloud/data_platform/product/navigation/sidebar) no matter in which page you are.
...
- Access your [Organisation Settings](/pages/public_cloud/data_platform/product/organisations/orga_settings)
- Check general useful information (components' status, roadmap, support, etc)
- Acess your [Profile Settings](/pages/public_cloud/data_platform/product/organisations/profile)
