...
Creating your own user profile is the first necessary step in order to use the platform. You can then create or join an [Organization](/pages/public_cloud/data_platform/product/organisations/00-organisations-index)

An [Organization](/pages/public_cloud/data_platform/product/organisations/00-organisations-index) us a workspace shared with your teammates to work on Projects. Once you are part of an [Organization](/pages/public_cloud/data_platform/product/organisations/00-organisations-index), you can create [Projects](/pages/public_cloud/data_platform/product/project/00-project-index) which are dedicated environments that assemble multiple services together and can answer one or more use cases.
...
[Create your profile!](/pages/public_cloud/data_platform/product/organisations/create-account)
...
[Learn more about organizations!](/pages/public_cloud/data_platform/product/organisations/00-organisations-index)
...
![profile](images/profile.png){.thumbnail}
...
![profile](images/profile-preferences.png){.thumbnail}
...
![profile](images/profile-preferences-contact.png){.thumbnail}
...
![profile](images/profile-preferences-info-preference.png){.thumbnail}
...
![profile](images/profile-preferences-myorga.png){.thumbnail}
...
![profile](images/profile-security-update-password.png){.thumbnail}
...
![profile](images/profile-security-recent-sessions.png){.thumbnail}
...
You can find the complete MFA documentation at the following location: [MFA Setup and Configuration Guide](/pages/public_cloud/data_platform/product/organisations/mfa-setup).
...
![profile](images/profile-organizations.png){.thumbnail}
...
![profile](images/profile-organization-orgatoyou.png){.thumbnail}
