...
![delete-orga](images/delete-orga-2.png){.thumbnail}
...
![delete-orga](images/delete-orga-3.png){.thumbnail}

![delete-orga](images/delete-orga-4.png){.thumbnail}

If the checklist was not followed, you will be shown a **leave organization** button instead of the **delete organization**.

![delete-orga](images/delete-orga-5.png){.thumbnail}
