...
Here, you will continue the development of the application you created in the [first part of the Getting Started Guide](/pages/public_cloud/data_platform/getting-started/app-init/00-app-init-index).
...
![alt text](images/gs-advanced-layout.png){.thumbnail}
...
<div class="Project-step">
   ...
   <a class="landing-link" href="/pages/public_cloud/data_platform/getting-further/app-dev/build">
      <img data-no-zoom src="images/connect.png" alt="Connect" />
      <div class="text">
         <h2>Build</h2>
...
<div class="Project-step">
   ...
   <a class="landing-link" href="/pages/public_cloud/data_platform/getting-further/app-dev/configuration">
      <img data-no-zoom src="images/transfer.png" alt="Transfer"/>
      <div class="text">
         <h2>Configure</h2>
...
<div class="Project-step">
   ...
   <a class="landing-link" href="/pages/public_cloud/data_platform/getting-further/app-dev/component">
      <img data-no-zoom src="images/query.png" alt="Query"/>
      <div class="text">
         <h2>Customize</h2>
...
<div class="Project-step">
   ...
   <a class="landing-link" href="pages/public_cloud/data_platform/getting-further/app-dev/extension">
      <img data-no-zoom src="images/expose.png" alt="Expose"/>
      <div class="text">
         <h2>Extend</h2>
