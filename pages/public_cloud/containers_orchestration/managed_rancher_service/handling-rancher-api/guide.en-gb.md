---
title: Handling Managed Rancher Service with the OVHcloud API
excerpt: 'Find out how to start managing Managed Rancher Service with the API on OVHcloud'
updated: 2024-07-26
---
...
Managed Rancher Service (MRS) by OVHcloud provides a powerful platform for orchestrating Kubernetes clusters seamlessly. In this guide we will explore how to managing MRS with the OVHcloud API.
...
If you go to the [Rancher section](https://eu.api.ovh.com/console/?section=%2FpublicCloud&branch=v2#get-/publicCloud/project/-projectId-/rancher) of the API Explorer, you will see the available endpoints:

![Rancher on OVHcloud API](images/api-endpoints-rancher.png){.thumbnail}




https://eu.api.ovh.com/console/?section=%2FpublicCloud&branch=v2
