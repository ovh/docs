...
Now, log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=es), go to the `Public Cloud`{.action} section and click on `Managed Kubernetes Service`. <br>
