...
> [!primary]
> **Standard Plan Requirement**
>
> Floating IPs per node is an exclusive feature of the **Managed Kubernetes Service Standard plan**. This feature is not available on the Free plan.
>
...
>
> The Standard plan with Floating IPs support is available in the following regions:
> - **1-AZ regions**: EU-WEST-RBX (Roubaix), AP-SOUTH-MUM (Mumbai)
> - **3-AZ regions**: EU-WEST-PAR (Paris), EU-SOUTH-MIL (Milan)
>
> For a complete list of available regions by plan, see the [Regional Availability by MKS Plan](/pages/public_cloud/containers_orchestration/managed_kubernetes/datacenters-nodes-storage-flavors#regional-availability-by-mks-plan) section.

## What are Floating IPs for MKS?

Floating IPs for OVHcloud Managed Kubernetes allow you to automatically assign a public Floating IP address to each worker node in a node pool, including nodes managed by the autoscaler.
...
- [OVHcloud Public Cloud Prices](https://www.ovhcloud.com/en-gb/public-cloud/prices/#compute) (Floating IP section)
...
- [OVHcloud API Console - Create Cluster](https://eu.api.ovh.com/console/?section=%2Fcloud&branch=v1#post-/cloud/project/-serviceName-/kube)
...
For complete API documentation, see:
- [OVHcloud API Console - Create Node Pool](https://eu.api.ovh.com/console/?section=%2Fcloud&branch=v1#post-/cloud/project/-serviceName-/kube/-kubeId-/nodepool)
...
For complete API documentation, see:
- [OVHcloud API Console - Update Node Pool](https://eu.api.ovh.com/console/?section=%2Fcloud&branch=v1#put-/cloud/project/-serviceName-/kube/-kubeId-/nodepool/-nodePoolId-)

### Using OVHcloud CLI

You can also manage Floating IPs using the [OVHcloud CLI](https://github.com/ovh/ovhcloud-cli).

**Example: Create a node pool with Floating IPs enabled**
...
**Example: Create a node pool with Floating IPs using a configuration file**
...
For more information about the OVHcloud CLI, see:
- [OVHcloud CLI - Create Node Pool](https://github.com/ovh/ovhcloud-cli/blob/main/doc/ovhcloud_cloud_kube_nodepool_create.md)
...
For advanced users, you can use OpenStack CLI to list Floating IPs and their associations:

```bash
openstack floating ip list
```

For more information on managing Floating IPs with OpenStack, see:
- [OVHcloud KB: Additional IP vs Floating IP](https://help.ovhcloud.com/csm/fr-public-cloud-network-additional-ip-vs-floating-ip?id=kb_article_view&sysparm_article=KB0050159)
...
- **Instance flavor selection**: Choose instance flavors with adequate bandwidth for your workload (B3, C3, R3 flavors offer 10 Gbps bandwidth)
...
- [Additional IP vs Floating IP (KB)](https://help.ovhcloud.com/csm/fr-public-cloud-network-additional-ip-vs-floating-ip?id=kb_article_view&sysparm_article=KB0050159): Understand the difference between Additional IP and Floating IP
