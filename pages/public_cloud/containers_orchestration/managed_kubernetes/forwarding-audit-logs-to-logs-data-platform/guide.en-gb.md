...
In order to forward your Audit logs to Log Data Platform you will need the following existing ressources :
- A *Log Data Plaform Account*
- A *Data Stream*

To create those ressource you can rely on the [Log Data Platform Quick Start Guide](/pages/manage_and_operate/observability/logs_data_platform/getting_started_quick_start/guide.en-us.md).
...
After accessing your MKS cluster details (by clicking on cluster name for the MKS clusters list) you will see "Audit Logs".

#### Step 2 - Create a Log Data Plaform Subscription
Via the 'audit logs' tab, you can view live audit logs from your cluster.
In order to activate logs forwarding to LDP, simply click on "subscribe" on the right-hand side of your screen.

#### Step 3 - Select your LDP Account and Data stream
From the dropdown list select the LDP Accounts you want, then on the Data Stream list select the one you would like to use and click on "subscribe".
...
To delete your subscription you can use the dedicated section on the OVH Control Panel (go to the "Audit logs" tab of your MKS cluster and clicking on "unsubscribe") or the following API route:
