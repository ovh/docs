...
If you are using the [OVHcloud Domain name product](/links/websitedomains/), you can follow this documentation to configure your DNS record to link it to the public IPv4 address associated to your LoadBalancer: [Editing an OVHcloud DNS zone](/pages/web_cloud/domains/dns_zone_edit).
