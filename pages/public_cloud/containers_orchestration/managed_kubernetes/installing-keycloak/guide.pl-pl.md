...
routes:
    canonical: '/pages/public_cloud/containers_orchestration/managed_kubernetes/installing-keycloak'
updated: 2022-11-24
---
...
If you are using the [OVHcloud Domain name product](https://www.ovhcloud.com/pl/domains/), you can follow this documentation to configure your DNS record to link it to the public IPv4 address associated to your LoadBalancer: [Editing an OVHcloud DNS zone](/pages/web_cloud/domains/dns_zone_edit).
