...
| **chunking_strategy**        | No       | `string`/`server_vad object`/`null`   | -                                                                                     | null    | Controls how long audio is segmented before transcription. You can set it to improve transcript throughput on long files (longer than 10m). More details [here](#chunking-strategy).                                                                                                                                                     |
