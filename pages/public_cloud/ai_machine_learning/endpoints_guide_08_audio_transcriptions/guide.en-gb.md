...
This documentation provides an overview of the Speech to Text endpoints offered on [AI Endpoints](https://www.ovhcloud.com/en/public-cloud/ai-endpoints/). 

Visit our [Catalog](https://www.ovhcloud.com/en/public-cloud/ai-endpoints/catalog) to find out which models are compatible with Audio Analysis.
...
In this guide, we have explained how to use Speech to Text models available on [AI Endpoints](https://www.ovhcloud.com/en/public-cloud/ai-endpoints/) models. We have provided a comprehensive overview of the feature which can help you perfect your integration of model for your own application.
