...
/// details | How to install the ovhai CLI?
...
/// details | When I try to use the ovhai CLI, I get a `AI Training error: not authenticated` error.
...
/// details | I can't login with the `--token` parameter inside ovhai CLI
...
/// details | I would like to perform an action with the ovhai CLI, but I do not know the associated command. What can I do?
...
/// details | When should I use AI Notebooks, AI Training or AI Deploy?
...
/// details | What flavors are available?
...
/// details | How many resources can I use when working with OVHcloud AI Tools?
...
/// details | Do AI Tools provide local storage?
...
/// details | How to attach and use storage?
...
/// details | Is there an expected format for data to upload?

You can upload any file or directory to the OVHcloud Object Storage without any format constraints.

///

/// details | Why can't I see my data volume in the container?
...
/// details | How to fix file access permission errors?
...
/// details | Can I use my own Docker image with AI Training & Deploy? How?
...
/// details | Why is my image not executed with the expected linux user?
...
/// details | Why did my notebook, job or app fail?
...
/// details | Why did my notebook or job stop after 7 consecutive running days?

To keep the platform secure and up‑to‑date, hosts are periodically restarted. Any AI Notebook and AI Training job that runs continuously for more than 7 consecutive days in a RUNNING state is automatically stopped. If you need a longer runtime, you can contact [our support](/links/support-contact) to extend the limit up to **28 days**.

///

/// details | My job or my app is blocked in `QUEUED` or `PENDING` state, what does it mean?
...
/// details | Why can't I access my AI Solution UI?
...
/// details | How can I share my AI Tools publicly, without any authentication?
...
/// details | Do OVHcloud AI Solutions support Public and Private networking?
...
/// details | Do AI solutions allow the use of the gRPC protocol?
...
/// details | Is it possible to utilize TensorBoard within my AI Tool?
...
/// details | Is it possible to utilize Weights & Biases within my AI Tool?
