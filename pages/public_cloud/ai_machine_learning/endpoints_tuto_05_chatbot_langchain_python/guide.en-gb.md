...
In this tutorial, we’ll use LangChain (Python edition) with OVHcloud **[AI Endpoints](https://www.ovhcloud.com/en/public-cloud/ai-endpoints/)** to create a **command-line chatbot**, starting with a simple blocking mode, then enabling **streaming** for real-time feedback.
