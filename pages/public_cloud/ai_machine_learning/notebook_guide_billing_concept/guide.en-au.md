...
Their official pricing is available in the [OVHcloud Control Panel](/links/manager) or on the [OVHcloud Public Cloud website](https://www.ovhcloud.com/en-au/public-cloud/prices/).
