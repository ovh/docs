...
Combined with OVHcloud **[AI Endpoints](https://www.ovhcloud.com/en/public-cloud/ai-endpoints/)** which offers both LLM and embedding models, it becomes easy to create advanced, production-ready assistants.
