---
title: AI Endpoints - API Catalog (EN)
excerpt: Découvrez comment utiliser l'API Catalog pour parcourir le catalogue OVHcloud AI Endpoints et consulter les métadonnées ainsi que les fonctionnalités de chaque modèle
updated: 2026-07-29
---
