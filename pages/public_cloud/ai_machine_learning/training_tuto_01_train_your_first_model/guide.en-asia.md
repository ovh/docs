...
To launch your training job, you can also use the [OVHcloud Control Panel](https://www.ovh.com/manager/#/public-cloud/) or the [ovhai CLI](/pages/public_cloud/ai_machine_learning/cli_10_howto_install_cli).
