...
The objective of this guide is to help developers interested in AI quickly and easily get started with [AI Endpoints](https://www.ovhcloud.com/en/public-cloud/ai-endpoints/).

It explains how to obtain an access key, access AI models, and interact with AI APIs on the [AI Endpoints](https://www.ovhcloud.com/en/public-cloud/ai-endpoints/) platform. By following this guide, you will learn how to integrate AI capabilities into your applications with ease.
...
Getting an API key enables you to use the models available in our [catalog](https://www.ovhcloud.com/en/public-cloud/ai-endpoints/catalog) and test their integration into your solutions. To obtain an API access key, please follow the steps below:
...
Once your API key has been generated, you can navigate to the [Catalog page](https://www.ovhcloud.com/en/public-cloud/ai-endpoints/catalog) to choose the AI model you want to interact with.
