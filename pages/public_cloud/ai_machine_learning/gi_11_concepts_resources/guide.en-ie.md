...
- [The OVHcloud AI CLI](/pages/public_cloud/ai_machine_learning/cli_10_howto_install_cli) installed on your computer (optional)
...
>>
>> Go to the `AI & Machine Learning`{.action} category in the left menu and choose `AI Notebooks`{.action}, `AI Training`{.action} or `AI Deploy`{.action} section depending on the AI Tool you are using.
>>
