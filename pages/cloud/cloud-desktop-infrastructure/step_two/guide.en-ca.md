...
You can now start using your [Cloud Desktop Infrastructure](https://www.ovh.com/ca/en/cloud/cloud-desktop/infrastructure/){.external} solution.
...
Now that you have created the template, find out how to [create a pool](https://docs.ovh.com/ca/en/cloud-desktop-infrastructure/how-to-create-pool/).
