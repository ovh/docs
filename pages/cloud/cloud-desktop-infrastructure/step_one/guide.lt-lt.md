...
In five detailed steps, we will explain how to manage your [Cloud Desktop Infrastructure](https://www.ovh.lt/cloud/cloud-desktop/infrastructure/){.external}.
...
- You need to have received an email containing your [Cloud Desktop Infrastructure](https://www.ovh.com/lt/cloud/cloud-desktop/infrastructure/){.external} credentials.
...
- a [Private Cloud](https://www.ovh.lt/private-cloud/){.external} platform for deploying virtual machines and virtual desktops
...
> 
>  
> https://www.ovh.lt/cloud/cloud-desktop/infrastructure/
>
> 
...
Next, find out how to [create pool templates](https://docs.ovh.com/lt/cloud-desktop-infrastructure/create-pool/){.external}.
