...
If you have followed the previous steps, you will have [created a pool](https://docs.ovh.com/ie/en/cloud-desktop-infrastructure/how-to-create-pool/){.external}, and [provided your users with desktop access](https://docs.ovh.com/ie/en/cloud-desktop-infrastructure/assigning-desktop-access/){.external}. Now, you will need to log in to your virtual desktops.
...
- You need to know your access point's URL, which is available in your [OVH Control Panel](https://ovh.com/auth/?action=gotomanager){.external}.
- [Your user account must be authorised to access the desktop pool](https://docs.ovh.com/ie/en/cloud-desktop-infrastructure/assigning-desktop-access/){.external}.
...
- Enter the login address for your virtual desktop (included in the email you received when your [Virtual Cloud Desktop Infrastructure](https://www.ovh.com/ie/en/cloud/cloud-desktop/infrastructure/){.external} solution was delivered, under *Desktop Access*).
