...
> [!primary]
> Dedicated NetApp storage is only available with the [Stateful Production Pack](https://www.ovhcloud.com/en/hosted-private-cloud/anthos/). It will be possible to upgrade a Hosted Private Cloud powered by Anthos deployment.
>
