...
To understand the basics of the OVH Load Balancer service, please refer to the [Load Balancer Introduction](https://docs.ovh.com/ca/en/load-balancer/loadbalancer-introduction/){.external}.
