...
To understand the basics of the OVH Load Balancer service, please refer to the [Load Balancer Introduction](https://docs.ovh.com/ca/en/iplb/loadbalancer-introduction/){.external}.
