...
For more information on failover IPs, you can consult our [webpage](https://www.ovhcloud.com/en-au/bare-metal/ip/){.external}.
...
For more information on the OVH Load Balancer solution, you can read our [Introduction to the OVH Load Balancer](https://docs.ovh.com/au/en/load-balancer/loadbalancer-introduction/){.external}.
...
- a [failover IP](https://www.ovhcloud.com/en-au/bare-metal/ip/){.external}
...
You can define dedicated FOIPs via the [OVH Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au){.external} by going to the `Cloud`{.action} section, then `Load Balancer`{.action}.
