...
For more information on failover IPs, you can consult our [webpage](https://www.ovh.com/ca/en/dedicated-servers/ip_failover.xml){.external}.
...
- a [failover IP](https://www.ovh.com/ca/en/dedicated-servers/ip_failover.xml){.external}
