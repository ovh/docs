...
For more information on failover IPs, you can consult our [webpage](https://www.ovhcloud.com/asia/bare-metal/ip/){.external}.
...
- a [failover IP](https://www.ovhcloud.com/asia/bare-metal/ip/){.external}
...
You can define dedicated FOIPs via the [OVH Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia){.external} by going to the `Cloud`{.action} section, then `Load Balancer`{.action}.
