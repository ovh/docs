...
Il est possible de définir une redirection personnalisée depuis l'[espace client](https://ca.ovh.com/auth/?action=gotomanager){.external} dans la partie `Cloud`{.action}, section `Load Balancer`{.action}.
