...
If you have not done so already, we recommend reading a general introduction to the OVHcloud Load Balancer service before you get started: [Introduction to the OVHcloud Load Balancer](https://docs.ovh.com/ca/en/load-balancer/loadbalancer-introduction/){.ref}
...
For more information on the Sunrise Control Panel’s features, you can consult the following guide: [Managing the Load Balancer from the customer control panel](https://docs.ovh.com/ca/en/load-balancer/usage-loadbalancer/){.ref}
...
For more information on the API’s features, you can consult the following guide: [Load Balancer API Quick Reference](https://docs.ovh.com/ca/en/load-balancer/iplb-api-reference/){.ref}
