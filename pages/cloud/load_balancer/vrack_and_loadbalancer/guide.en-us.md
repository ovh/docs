...
Before starting, if you haven't read it yet, we advise you to read the general presentation of the [Load Balancer](https://docs.ovh.com/us/en/load-balancer/loadbalancer-introduction/) service.
...
As a reminder, a configuration guide for the Load Balancer is available: [Here](https://docs.ovh.com/us/en/load-balancer/configure-iplb/).
