...
Before starting, if you haven't read it yet, we advise you to read the general presentation of the [Load Balancer](https://docs.ovh.com/au/en/load-balancer/loadbalancer-introduction/) service.
