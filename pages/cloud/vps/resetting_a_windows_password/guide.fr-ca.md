...
Connectez-vous sur le VPS via le VNC de [l'espace client OVHcloud](https://ca.ovh.com/auth/?action=gotomanager) avec les identifiants de connexion que vous avez reçu par e-mail.
