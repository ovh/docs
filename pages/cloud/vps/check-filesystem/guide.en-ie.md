...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie) and initiate a server reboot in rescue mode. Follow our [rescue mode guide](../rescue/) if necessary.
