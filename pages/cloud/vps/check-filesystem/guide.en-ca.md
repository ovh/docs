...
Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca) and initiate a server reboot in rescue mode. Follow our [rescue mode guide](/pages/cloud/vps/rescue) if necessary.
