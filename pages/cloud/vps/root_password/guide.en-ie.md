...
Log in to your [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie) and reboot the VPS in rescue mode. If you need further instructions about using activating mode with a VPS, you may consult the [rescue mode guide](/pages/cloud/vps/rescue).
