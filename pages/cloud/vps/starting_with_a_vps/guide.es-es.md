...
Por motivos de seguridad, la conexión con el usuario root está desactivada por defecto. Si debe autorizar este tipo de conexiones, consulte las instrucciones de [esta guía](https://docs.ovh.com/es/root-password/#activar-la-contrasena-root_1).
...
Para más información, consulte la guía [Proteger un VPS](https://docs.ovh.com/es/consejos-proteccion-vps/).
...
[Proteger un VPS](https://docs.ovh.com/es/consejos-proteccion-vps/)

[Configurar una nueva instalación de Windows Server](https://docs.ovh.com/es/windows-first-config/)
