...
routes:
    canonical: 'https://docs.ovh.com/au/en/public-cloud/configure-reverse-dns-instance/'
...
>
If the domain name is managed by OVHcloud as its registrar and it uses OVHcloud DNS servers, you can refer to [this guide](https://docs.ovh.com/au/en/domains/web_hosting_how_to_edit_my_dns_zone/).
>
