...
routes:
    canonical: 'https://docs.ovh.com/sg/en/public-cloud/configure-reverse-dns-instance/'
...
Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg), switch to the `Bare Metal Cloud`{.action} section and click on `IP`{.action} in the left-hand menu.
...
>
If the domain name is managed by OVHcloud as its registrar and it uses OVHcloud DNS servers, you can refer to [this guide](https://docs.ovh.com/sg/en/domains/web_hosting_how_to_edit_my_dns_zone/).
>
