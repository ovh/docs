...
Para acceder a la consola KVM de su VPS, consulte la [guía KVM VPS](https://docs.ovh.com/us/es/vps/utilizar_el_kvm_para_los_vps/).
...
Conéctese al servidor a través de una sesión de escritorio remoto o de [KVM](https://docs.ovh.com/us/es/vps/utilizar_el_kvm_para_los_vps/). Abra el menú Iniciar Windows y haga clic en `Ejecutar`{.action}.
...
Para acceder al contenido de este archivo en modo de rescate, siga las indicaciones de [la guía del modo de rescate del VPS](https://docs.ovh.com/us/es/vps/rescue/).
