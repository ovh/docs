...
Também recomendamos que consulte o nosso manual para [proteger um VPS](../como-proteger-vps/), que utilize as [nossas soluções de backup](../) e que configure a [Network Firewall](/pages/cloud/dedicated/firewall_network).
