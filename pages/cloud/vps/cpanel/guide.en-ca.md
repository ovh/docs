...
If you already have a VPS and want to have cPanel on it, you can reinstall the VPS from your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca) with the "CentOS 7 - cPanel" template (available only with a compatible VPS solution).
...
Furthermore we recommend setting up the [OVHcloud network firewall](../../dedicated/firewall-network/) and [set up a backup solution](/pages/cloud/vps/secure_your_vps#backing-up-your-system-and-your-data) on your VPS.
