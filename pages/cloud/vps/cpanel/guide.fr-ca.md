...
Si vous disposez déjà d'un VPS et que vous souhaitez y installer cPanel, vous pouvez réinstaller le VPS à partir de votre [espace client OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc) à l'aide du modèle « CentOS 7 - cPanel » (disponible uniquement avec une offre VPS compatible).
...
Nous vous recommandons également de consulter notre guide pour [sécuriser un VPS](/pages/cloud/vps/secure_your_vps), d'utiliser [nos solutions de sauvegarde](https://www.ovhcloud.com/fr-ca/vps/options/) et de configurer le [Network Firewall](/pages/cloud/dedicated/firewall_network).
