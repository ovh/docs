...
Además, le recomendamos configurar el [firewall](/pages/cloud/dedicated/firewall_network) y una [solución de backup](/pages/cloud/vps/secure_your_vps) en su VPS.
