...
>
> If you are configuring your first OVHcloud VPS, we recommend to consult our guide on [getting started with a VPS](https://docs.ovh.com/sg/en/vps/getting-started-vps/) before continuing.
>
...
It is strongly recommended that you modify the password of the root user as to not leave it at default value on a new system. Please refer to the information in [this guide](https://docs.ovh.com/sg/en/vps/root-password/) for details.
...
Please refer to the [Network Firewall guide](https://docs.ovh.com/sg/en/dedicated/firewall-network/) if you would like to activate it.
...
You can find all information on the available backup solutions for your service on the [product page](https://www.ovhcloud.com/en-sg/vps/options/) and in the [respective guides](https://docs.ovh.com/sg/en/vps/).
