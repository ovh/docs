...
> [!primary]
>
> If your server runs Windows, use [this guide](https://docs.ovh.com/asia/en/vps/vps-firewall-windows/) instead.
...
You can learn more about iptables in our [Firewall guide](https://docs.ovh.com/asia/en/vps/firewall-iptables/).
