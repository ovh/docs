...
>
> Si se trata de su primera configuración de un VPS de OVHcloud, consulte nuestra guía [Primeros pasos con un VPS](/pages/cloud/vps/starting_with_a_vps).
>
...
Le recomendamos encarecidamente que cambie la contraseña del usuario root para evitar que se quede en el valor predeterminado de un nuevo sistema. Para más información, consulte [esta guía](/pages/cloud/vps/root_password).
...
Para más información sobre iptables, consulte nuestra [guía dedicada](/pages/cloud/vps/firewall-Linux-iptable).
...
[Configurar el firewall de Windows](/pages/cloud/vps/activate-port-firewall-soft-win)
