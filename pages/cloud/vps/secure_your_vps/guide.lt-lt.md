...
We also have a guide on [configuring this firewall network](https://docs.ovh.com/lt/dedicated/firewall-network/){.external}.
...
You will find all information on our VPS backup solutions here: <https://www.ovh.lt/vps/backup-vps.xml>.

## Go further

[Firewall Network Guide](https://docs.ovh.com/lt/dedicated/firewall-network/)
