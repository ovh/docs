...
>
> S'il s'agit de votre première configuration d'un VPS OVHcloud, nous vous invitons à consulter en premier lieu notre guide [Débuter avec un VPS](https://docs.ovh.com/ca/fr/vps/debuter-avec-vps/).
>
...
Il est fortement recommandé de modifier le mot de passe de l'utilisateur root afin de ne pas le laisser à sa valeur par défaut sur un nouveau système. Pour plus d'informations, consultez [ce guide](https://docs.ovh.com/ca/fr/vps/root-password/).
...
Pour plus d'informations sur iptables, consultez notre [guide dédié](https://docs.ovh.com/ca/fr/vps/vps-firewall-iptables/).
...
Vous trouverez toutes les informations sur les solutions de sauvegarde disponibles pour votre service sur la [page produit](https://www.ovhcloud.com/fr-ca/vps/options/) et dans les [guides respectifs](https://docs.ovh.com/ca/fr/vps/).

## Aller plus loin

[Débuter avec un VPS](https://docs.ovh.com/ca/fr/vps/debuter-avec-vps/)

[Configurer le pare-feu sous Windows](https://docs.ovh.com/ca/fr/vps/vps-firewall-windows/)
