...
> [!primary]
>
> If your server runs Windows, use [this guide](https://docs.ovh.com/ie/en/vps/vps-firewall-windows/) instead.
...
>
> If you are configuring your first OVHcloud VPS, we recommend to consult our guide on [getting started with a VPS](https://docs.ovh.com/ie/en/vps/getting-started-vps/) before continuing.
>
...
It is strongly recommended that you modify the password of the root user as to not leave it at default value on a new system. Please refer to the information in [this guide](https://docs.ovh.com/ie/en/vps/root-password/) for details.
...
You can learn more about iptables in our [Firewall guide](https://docs.ovh.com/ie/en/vps/firewall-iptables/).
...
You can find all information on the available backup solutions for your service on the [product page](https://www.ovhcloud.com/en-ie/vps/options/) and in the [respective guides](https://docs.ovh.com/ie/en/vps/).

## Go further

[Getting started with a VPS](https://docs.ovh.com/ie/en/vps/getting-started-vps/)
