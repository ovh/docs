...
- You must be logged in to your [Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie).


## Instructions

Once you have logged in to your Control Panel, go to the `Cloud`{.action} section, and choose your VPS in the left-hand column:

![VPS area in the Control Panel](images/vps_rescue1.png){.thumbnail}

On the main screen of your VPS, click on the `Perkrauti rescue režimu`{.action} button and confirm that you wish to reboot it:
...
[Introduction to SSH](https://docs.ovh.com/lt/dedicated/ssh-introduction/)
