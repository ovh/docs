...
Once you are logged in to the [OVH Control Panel](https://www.docs.ovh.com/auth){.external}, in your Public Cloud project, click on `Add server`{.action}and choose a GPU instance:
...
Once your GPU instance has started, you will need to install the NVIDIA driver from the [official website](http://www.nvidia.fr/Download/index.aspx){.external}.
