...
When you create a [Public Cloud Instance](https://www.ovh.com/ca/en/public-cloud/instances/){.external}, you won't receive an email with login credentials, because authentication is based on secure SSH keys instead of usernames and passwords.
...
* a [Public Cloud](https://www.ovh.com/ca/en/public-cloud/instances/){.external} project in your OVH account
...
First, highlight and copy the text of your public key, then log into the [OVH Control Panel](https://ca.ovh.com/auth/?action=gotomanager){.external}.
