...
* [Guide for creating a Public Cloud Instance](https://docs.ovh.com/gb/en/public-cloud/start-a-first-cloud-server-within-3-min/)
...
- A [Public Cloud Instance](https://www.ovh.co.uk/public-cloud/instances/prices/){.external} in the [OVH Control Panel](https://www.ovh.com/auth/?action=gotomanager){.external} with Ubuntu 18.04 installed
...
Find out more about [OVH Object Storage](https://www.ovh.co.uk/public-cloud/storage/object-storage/){.external}.
...
To do this, just follow the steps in this guide: [Create an additional disk on Public Cloud](https://docs.ovh.com/gb/en/public-cloud/create-an-additional-volume-and-attach-it-to-an-instance/){.external}.

#### Step 2: Configure the additional disk
To do this, just follow the steps in this guide: [Configure an additional disk on Public Cloud](https://docs.ovh.com/gb/en/public-cloud/configure-an-additional-volume/#from-an-instance-on-linux){.external}.
