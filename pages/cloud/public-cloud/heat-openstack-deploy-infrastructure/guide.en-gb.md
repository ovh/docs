...
- You must be logged in to your [OVH Control Panel](https://www.ovh.com/auth/?action=gotomanager).
- You need to have created a Public Cloud project.
- You need to have an OpenStack user account.
- You need to know how to manipulate YAML files.
- You need to have signed up your Public Cloud project for the beta test.
