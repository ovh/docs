...
- You need to have set up the [OpenStack environment variables](https://docs.ovh.com/gb/en/public-cloud/deploy-infrastructure-with-variables-and-formatted-outputs-openstack-heat/){.external}.
- You need to have generated your [API credentials and your OVH authorisation keys](https://eu.api.ovh.com/g934.first_step_with_api){.external}.
- [You must have an SSH key](https://docs.ovh.com/gb/en/public-cloud/create-ssh-keys/){.external}.
- [You need to have installed the OpenStack client](https://github.com/openstack/python-openstackclient){.external}.
- You need to have registered for [FPGA beta in Public Cloud](https://labs.ovh.com/fpga-accelerators-on-public-cloud){.external}.
- [You need to have obtained Accelize credentials](https://accelstore.accelize.com/user/register){.external}.
