...
Log in to the **vSphere** interface. If you need help with this, please refer to our guide on Accessing the vSphere interface (https://docs.ovh.com/us/es/private-cloud/instalar_el_vsphere_client/).
