...
Log in to the **vSphere** interface. If you need help with this, please refer to our guide on Accessing the vSphere interface (https://docs.ovh.com/de/private-cloud/den_vsphere_client_installieren/).
