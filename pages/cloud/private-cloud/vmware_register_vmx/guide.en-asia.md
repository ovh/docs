...
Check the settings of your VMs (name, [portgroup](/pages/cloud/private-cloud/creation_vlan), etc...) by right-clicking on each one and then selecting `Edit Settings`{.action}.
