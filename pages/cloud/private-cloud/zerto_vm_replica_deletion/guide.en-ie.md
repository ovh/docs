...
- A user account with access to vSphere as well as Zerto (created in the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie))
- A deployed [Zerto Virtual Replication](https://docs.ovh.com/ie/en/private-cloud/zerto-virtual-replication-vmware-vsphere-drp/)
