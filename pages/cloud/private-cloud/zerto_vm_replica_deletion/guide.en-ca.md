...
- A user account with access to vSphere as well as Zerto (created in the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca))
- A deployed [Zerto Virtual Replication](https://docs.ovh.com/ca/en/private-cloud/zerto-virtual-replication-vmware-vsphere-drp/)
