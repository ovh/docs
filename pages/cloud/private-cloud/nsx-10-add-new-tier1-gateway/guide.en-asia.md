...
For more information on NSX at OVHcloud, please refer to our [Getting started with NSX](https://docs.ovh.com/asia/en/private-cloud/nsx-first-steps/) guide.
...
Use our guide on [segment management in NSX](https://docs.ovh.com/asia/en/private-cloud/nsx-segment-management/) to add a new virtual machine to your new segment.
