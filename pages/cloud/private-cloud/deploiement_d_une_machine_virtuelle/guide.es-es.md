...
- A partir de un archivo ISO, disponible en su datastore y que para importarlo debe seguir las instrucciones en la [guía de conexión en SFTP](/pages/cloud/private-cloud/vsphere_interface_connexion)
