...
Pour réaliser votre migration, vous pouvez suivre ce guide : [Migrer vers une nouvelle infrastructure](https://docs.ovh.com/ca/fr/private-cloud/vdc-migration/).
