...
Start by adding new datastores, using our guide on [adding storage](https://docs.ovh.com/de/private-cloud/wie_fuge_ich_ein_storage_hinzu/).
...
Finally, delete your old datastores by following our guide on [deleting a datastore](https://docs.ovh.com/de/private-cloud/datastore-loeschen/).
...
Start by adding new datastores by following the guide on [adding storage](https://docs.ovh.com/de/private-cloud/wie_fuge_ich_ein_storage_hinzu/).
