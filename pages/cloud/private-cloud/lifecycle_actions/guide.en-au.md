...
Start by adding new datastores by following the guide on [adding storage](https://docs.ovh.com/au/en/private-cloud/how_to_add_a_storage/).
...
To complete your migration, you can follow this guide: [Migrate to a new infrastructure](https://docs.ovh.com/au/en/private-cloud/vdc-migration/).
