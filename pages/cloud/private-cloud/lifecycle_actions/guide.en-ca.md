...
- Access to the [OVHcloud API](https://api.ovh.com/){.external}. If required, please refer to our guide on [Getting started with OVHcloud](/pages/account/api/first-steps) APIs.
- You need to have [created your login credentials for the OVHcloud API](/pages/account/api/first-steps){.external}.

## Instructions

### Step 1 - Retrieve your Hosted Private Cloud service information

Log in to the OVHcloud APIv6 using our guide on [Getting started with the OVHcloud API](/pages/account/api/first-steps).
...
Start by adding new datastores, using our guide on [adding storage](/pages/cloud/private-cloud/how_to_add_storage).
...
Finally, delete your old datastores by following our guide on [deleting a datastore](/pages/cloud/private-cloud/delete_datastore).
...
Start by adding new datastores by following the guide on [adding storage](/pages/cloud/private-cloud/how_to_add_storage).
...
To complete your migration, you can follow this guide: [Migrate to a new infrastructure](/pages/cloud/private-cloud/service-migration-vdc).
