---
title: NSX Edge nach einem Update aktivieren oder deaktivieren (EN)
...
You can ensure the username has access to NSX via the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de). This will be the same username and password used for your web-client login.
