---
title: How to enable or disable NSX Edge after an update 
...
You can ensure the username has access to NSX via the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia). This will be the same username and password used for your web-client login.
