...
- You need to have **NSX** deployed with a segment configured in your NSX configuration. Use our guide on [segment management in NSX](https://docs.ovh.com/au/en/private-cloud/nsx-segment-management/) for more information.
...
If you have configured DHCP servers in NSX as described in our [Configuring DHCP](https://docs.ovh.com/au/en/private-cloud/nsx-dhcp-configuration/) guide, you have the option to modify the configuration to use the DNS forwarder in your DHCP configurations.
...
[DHCP Configuration](https://docs.ovh.com/au/en/private-cloud/nsx-dhcp-configuration)
