...
- Haber activado las [licencias de Windows](/pages/cloud/private-cloud/manager_ovh_private_cloud#licencia-windows) desde el [área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es){.external} (en la pestaña `Licencia Widows`{.action} de la plataforma). 
