...
Write down **the public IP address** you use on this virtual machine and use this guide [Authorise IP addresses to connect to vCenter](https://docs.ovh.com/pl/private-cloud/authorise-ip-addresses-vcenter/) to grant access to the vSphere cluster to the new virtual machine.
