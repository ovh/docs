...
Write down **the public IP address** you use on this virtual machine and use this guide [Authorise IP addresses to connect to vCenter](https://docs.ovh.com/pt/private-cloud/autorizar-ip-a-ligar-se-ao-vcenter/) to grant access to the vSphere cluster to the new virtual machine.
...
[Administrating a TKG cluster](https://docs.ovh.com/pt/private-cloud/tanzu-tkgm-management)
