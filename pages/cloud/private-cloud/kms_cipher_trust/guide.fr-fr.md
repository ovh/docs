...
* Définir le label à **user-data**

![efault value](images/kms_cipher_trust_vm_10.png){.thumbails}
...
* Renseigner la clé SSH publique
...
* Depuis la fenêtre, rentrez les mots de passes par défaut :
    * Username : **admin**
    * Password : **admin**
...
Utiliser le nouveau mot de passe pour vous authentifier.

![cipher trust manager](images/kms_cipher_trust_getting_started_05.png){.thumbails}

L'instance de KMS est prête a être utilisé
...
* Transmettre ces informations au support OVHcloud
