...
For instructions for cross platforms set up, please our guide on [using Zerto between OVHcloud and a third party plateform](https://docs.ovh.com/au/en/private-cloud/zerto-virtual-replication-customer-to-ovh/).
