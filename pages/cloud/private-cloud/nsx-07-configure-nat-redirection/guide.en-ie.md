...
- Having **NSX** deployed with two segments configured in your NSX configuration, you can use our guide on [segment management in NSX](https://docs.ovh.com/ie/en/private-cloud/nsx-segment-management/) for more information.
