...
> For creating an ISO library and mounting an ISO to a VM, refer to [How to connect an ISO image to a VM](https://docs.ovh.com/ca/en/private-cloud/connect_iso_to_vm/).
...
Connect the utility ISO to your VM ([How to connect an ISO image to a VM](https://docs.ovh.com/ca/en/private-cloud/connect_iso_to_vm/)).<br> 
