...
Accedi allo Spazio Cliente e, nella sezione `Bare Metal Cloud`, clicca su `Private Cloud`{.action} nella colonna a sinistra e seleziona il servizio in questione.
