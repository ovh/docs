...
En su área de cliente, sitúese en el apartado `Server` En la barra de servicios de la izquierda, haga clic en `Private Cloud` y seleccione el servicio Private Cloud correspondiente.
