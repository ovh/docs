...
Begeben Sie sich in Ihrem Kundencenter in den Bereich `Server`. Klicken Sie im linken Menü auf `Private Cloud`{.action} und wählen Sie den betreffenden Private Cloud Dienst aus.
