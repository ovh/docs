...
- a user account with access to [vSphere](/pages/cloud/private-cloud/vsphere_interface_connexion) (created in the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/&ovhSubsidiary=GB))
