...
- vDS versions are the same between source and destination vDC. You can upgrade the vDS vRACK from the source vDC. For the vDS with VM Network (VXLAN vDS), please contact the support so that the vDS is upgraded.
