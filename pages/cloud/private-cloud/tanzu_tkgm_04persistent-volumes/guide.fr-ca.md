...
- Avoir déployé le cluster de **Workload** **TKG** à l'aide du guide « [administrer Tanzu Management Cluster Grid](https://docs.ovh.com/ca/fr/tanzu-tkgm-management) ».
...
Nous allons nous connecter sur un cluster de *WorkLoad* à partir de la console de la machine virtuelle **Bootstrap**. Vous pouvez vous aider du guide « [Administrer Tanzu Management Cluster Grid](https://docs.ovh.com/ca/fr/tanzu-tkgm-management) » pour créer un cluster de workload et l'administrer.
...
[Présentation de Tanzu Kubernetes Grid au sein d'OVHcloud](https://docs.ovh.com/ca/fr/tanzu-tkgm-installation)

[Installer Tanzu Kubernetes Grid](https://docs.ovh.com/ca/fr/tanzu-tkgm-installation)

[Administrer Tanzu Management Cluster Grid](https://docs.ovh.com/ca/fr/tanzu-tkgm-management)
