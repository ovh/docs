...
Revenez sur l'inventaire dans votre interface **vCenter**, cliquez à gauche sur l'icône `DataCenter`{.action} puis allez dans l'onglet `Surveiller`{.action} à droite et cliquez sur `Colume de conteneur`{.action} pour voir les volumes persistants.
