...
> 
> Encryption is still possible at the VM and its data level, as described in the guide [Enabling VM Encryption with vSphere Native Key Provider](https://docs.ovh.com/sg/en/private-cloud/vm-encrypt-vnkp/).
>
