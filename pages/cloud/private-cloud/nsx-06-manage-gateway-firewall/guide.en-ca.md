...
If you want to create filtering rules between internal segments, you will need to use distributed firewall using our guide on [distributed firewall management](https://docs.ovh.com/ca/en/private-cloud/nsx-manage-distributed-firewall/).
...
[Distributed Firewall management](https://docs.ovh.com/ca/en/private-cloud/nsx-manage-distributed-firewall/).
