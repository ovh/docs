...
Si vous souhaitez créer des règles de filtrage entre des segments internes, il sera nécessaire d'utiliser le pare-feu distribué, en vous aidant de notre guide sur la [gestion du pare-feu distribué](https://docs.ovh.com/ca/fr/private-cloud/nsx-manage-distributed-firewall/).
...
[Gestion des segment dans NSX](https://docs.ovh.com/ca/fr/private-cloud/nsx-segment-management/)

[Gestion du pare-feu distribué](https://docs.ovh.com/ca/fr/private-cloud/nsx-manage-distributed-firewall/).
