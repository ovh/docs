...
As does the [NSX Edge Firewall](https://docs.ovh.com/us/en/private-cloud/nsx-edge-firewall-configuration/), the distibuted firewall restricts or allows network traffic based on rules applied to network nodes or groups.
