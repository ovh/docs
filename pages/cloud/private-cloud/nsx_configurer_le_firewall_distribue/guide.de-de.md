---
title: Konfiguration der NSX Distributed Firewall (EN)
...
As does the [NSX Edge Firewall](https://docs.ovh.com/de/private-cloud/nsx-edge-firewall-configuration/), the distibuted firewall restricts or allows network traffic based on rules applied to network nodes or groups.
