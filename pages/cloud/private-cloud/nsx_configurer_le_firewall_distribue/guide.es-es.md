---
title: Configurar el firewall distribuido NSX-v (EN)
...
As does the [NSX Edge Firewall](https://docs.ovh.com/es/private-cloud/nsx-edge-firewall-configuration/), the distibuted firewall restricts or allows network traffic based on rules applied to network nodes or groups.
