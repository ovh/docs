...
Navigate to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au) and log on with your administrative credentials.
...
Check out [Enabling Virtual Machine Encryption](https://docs.ovh.com/au/en/private-cloud/vm-encrypt/) for more details.
...
Check out the [Activating and using Veeam Managed Backup](https://docs.ovh.com/au/en/private-cloud/veeam-backup-as-a-service/) guide for more details.
...
Check out [Setting up Zerto Virtual Replication for your DRP](https://docs.ovh.com/au/en/private-cloud/zerto-virtual-replication-vmware-vsphere-drp/) for more details.
