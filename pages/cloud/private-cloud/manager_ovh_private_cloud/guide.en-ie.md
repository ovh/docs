...
- You must have a [Private Cloud](https://www.ovh.ie/private-cloud/){.external} product.
...
You can find the pricing page [here](https://www.ovh.ie/private-cloud/options/images-licences.xml){.external}.
