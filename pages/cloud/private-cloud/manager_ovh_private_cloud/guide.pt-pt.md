...
Depois de aceder à secção  `Hosted Private Cloud`{.action} e `Private Cloud`{.action} da [Área de Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager){.external}, visualizará um panorama geral da sua Private Cloud:
