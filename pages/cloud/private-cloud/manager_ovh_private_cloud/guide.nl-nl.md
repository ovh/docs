...
- U moet zijn ingelogd op uw[OVH Control Panel](https://www.ovh.com/auth){.external} in het `Dedicated`{.action}-gedeelte en vervolgens `Private Cloud`{.action}.
...
Nadat u hebt geklikt op `Dedicated`{.action} en u `Private Cloud`{.action} van uw [OVH Control Panel](https://www.ovh.com/auth){.external} geopend hebt, ziet u een algemeen overzicht van uw Private Cloud:
