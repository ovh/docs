...
Check out [Enabling Virtual Machine Encryption](https://docs.ovh.com/ca/en/private-cloud/vm-encrypt/) for more details.
...
Check out the [Activating and using Veeam Managed Backup](https://docs.ovh.com/ca/en/private-cloud/veeam-backup-as-a-service/) guide for more details.
...
Check out [Setting up Zerto Virtual Replication for your DRP](https://docs.ovh.com/ca/en/private-cloud/zerto-virtual-replication-vmware-vsphere-drp/) for more details.
