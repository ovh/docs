...
- Having **NSX** deployed with two overlay and VLAN segments configured in your NSX configuration. Use our guide on [segment management in NSX](https://docs.ovh.com/es/private-cloud/nsx-segment-management) for more information.
...
If you do not have a VLAN type segment, use the [Segment Management in NSX](https://docs.ovh.com/es/private-cloud/nsx-segment-management/) guide to create it with these settings :
