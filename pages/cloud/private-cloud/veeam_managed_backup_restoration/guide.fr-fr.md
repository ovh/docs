...
**Ce guide vous explique comment identifier et restaurer une sauvegarde via les API OVHcloud**
...
L'appel API va restaurer les derniers points de restauration valides de chaque backup présent sur le dossier de stockage.
