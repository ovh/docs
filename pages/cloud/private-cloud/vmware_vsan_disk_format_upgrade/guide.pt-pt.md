...
section: Recursos do VMware vSphere
routes:
...
- A deployed [vSan cluster](https://docs.ovh.com/pt/private-cloud/vmware-vsan/)

## Instructions

Log in to your vSphere interface using [this guide](https://docs.ovh.com/pt/private-cloud/connexion-interface-vsphere/).
