...
- A deployed [vSan cluster](https://docs.ovh.com/asia/en/private-cloud/vmware-vsan/)

## Instructions

Log in to your vSphere interface using [this guide](https://docs.ovh.com/asia/en/private-cloud/connexion-interface-vsphere/).
