...
- Être contact [« Administrateur »](/pages/account/customer/managing_contacts) de l'infrastructure [Hosted Private Cloud](https://www.ovhcloud.com/fr-ca/enterprise/products/hosted-private-cloud/), afin de recevoir les identifiants de connexion.
