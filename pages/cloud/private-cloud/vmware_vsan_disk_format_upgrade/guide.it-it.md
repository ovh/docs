...
section: Funzionalità di VMware vSphere
routes:
...
- A deployed [vSan cluster](https://docs.ovh.com/it/private-cloud/vmware-vsan/)

## Instructions

Log in to your vSphere interface using [this guide](https://docs.ovh.com/it/private-cloud/connexion-interface-vsphere/).
