...
- A deployed [vSan cluster](https://docs.ovh.com/es/private-cloud/vmware-vsan/)

## Instructions

Log in to your vSphere interface using [this guide](https://docs.ovh.com/es/private-cloud/connexion-interface-vsphere/).
