...
- A deployed [vSan cluster](https://docs.ovh.com/de/private-cloud/vmware-vsan/)

## Instructions

Log in to your vSphere interface using [this guide](https://docs.ovh.com/de/private-cloud/den_vsphere_client_installieren/).
