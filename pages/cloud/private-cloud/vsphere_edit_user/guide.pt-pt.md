...
Aceda à [Área de Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager) e selecione a secção `Web`Server. Clique em `Private Cloud` na barra de serviços à esquerda e selecione a infraestrutura correspondente.
