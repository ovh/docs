...
Para mais informações sobre a segunda opção, consulte o nosso guia "[Zerto entre dois datacenters da OVHcloud](/pages/cloud/private-cloud/zerto_virtual_replication_as_a_service)"
