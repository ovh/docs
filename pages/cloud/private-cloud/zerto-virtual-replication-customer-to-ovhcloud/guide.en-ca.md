...
Check out [Zerto between two OVHcloud datacenters](https://docs.ovh.com/ca/en/private-cloud/zerto-virtual-replication-vmware-vsphere-drp/) for the other scenario.
