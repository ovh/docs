...
- A VLAN interface (10 to 20 by default and linked to the vRack, you can create more by consulting [this guide](/pages/cloud/private-cloud/creation_vlan-vxlan/)).
