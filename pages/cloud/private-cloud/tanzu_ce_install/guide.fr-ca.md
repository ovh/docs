...
- Avoir déployé une [NSX Edge Services Gateway](https://docs.ovh.com/ca/fr/comment-deployer-une-nsx-edge-gateway/)
- Configurer le service [DHCP](https://docs.ovh.com/ca/fr/configurer-le-dhcp-sur-une-edge-nsx/) sur la NSX Gateway
...
Consultez notre documentation pour [ajouter un bloc d'IP](https://docs.ovh.com/ca/fr/ajout-de-bloc-ip/) si vous n'avez plus d'IP publique utilisable.
...
Vous pouvez déployer une VM [depuis un ISO](https://docs.ovh.com/ca/fr/deploiement-d-une-machine-virtuelle/) ou [depuis un modèle OVF](https://docs.ovh.com/ca/fr/deploiement-template-ovh/).<br>
