...
Check out our [Adding an IP block](https://docs.ovh.com/it/private-cloud/aggiunger-un-blocco-ip/) documentation if you are out of usable public IPs.
...
You can deploy a VM [from an ISO](https://docs.ovh.com/it/private-cloud/deploy-di-una-macchina-virtuale/) or [from an OVF template](https://docs.ovh.com/it/private-cloud/installazione-template-ovh/).<br>
