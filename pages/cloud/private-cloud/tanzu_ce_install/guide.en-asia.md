...
- [DHCP](https://docs.ovh.com/asia/en/private-cloud/setup-dhcp-nsx-edge/) services activated on the NSX Gateway
...
Check out our [Adding an IP block](https://docs.ovh.com/asia/en/private-cloud/add-ip-block/) documentation if you are out of usable public IPs.
...
You can deploy a VM [from an ISO](https://docs.ovh.com/asia/en/private-cloud/deploying-a-virtual-machine/) or [from an OVF template](https://docs.ovh.com/asia/en/private-cloud/applying-ovh-template/).<br>
