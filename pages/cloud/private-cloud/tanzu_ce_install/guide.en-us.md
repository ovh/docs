...
- [DHCP](https://docs.ovh.com/us/en/private-cloud/setup-dhcp-nsx-edge/) services activated on the NSX Gateway
...
Check out our [Adding an IP block](https://docs.ovh.com/us/en/private-cloud/add-ip-block/) documentation if you are out of usable public IPs.
...
In the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we), go to the `Security`{.action} tab of your Hosted Private Cloud and add the public IPs to the allowed adresses to connect.<br>
...
You can deploy a VM [from an ISO](https://docs.ovh.com/us/en/private-cloud/deploying-a-virtual-machine/) or [from an OVF template](https://docs.ovh.com/us/en/private-cloud/applying-ovh-template/).<br>
