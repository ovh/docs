...
Read the [Managing Persistent Volumes in Tanzu Kubernetes Grid](https://docs.ovh.com/au/en/private-cloud/tanzu-tkgm-permanent-volumes) guide to add an application that uses an external persistent volume.
...
[Managing volumes on a Tanzu Kubernetes GRID cluster](https://docs.ovh.com/au/en/private-cloud/tanzu-tkgm-permanent-volumes)
