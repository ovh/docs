...
Consultez la documentation « [Installer Tanzu Kubernetes Grid](/pages/cloud/private-cloud/tanzu_tkgm_02installation) » pour effectuer l'installation.
...
Consultez le guide « [Administrer Tanzu Kubernete Grid](/pages/cloud/private-cloud/tanzu_tkgm_02installation) » pour déployer un cluster de *Workload* et une application. 
...
Utilisez le guide « [Gestion des volumes permanents dans Tanzu Kubernetes Grid](/pages/cloud/private-cloud/tanzu_tkgm_04persistent-volumes) » pour ajouter une application qui utilise un volume permanent externe.
...
[Installation d'un cluster Tanzu Kubernetes GRID](/pages/cloud/private-cloud/tanzu_tkgm_02installation)

[Administrer un cluster Tanzu Kubernetes GRID](/pages/cloud/private-cloud/tanzu_tkgm_03manage)

[Gestion des volumes sur un cluster Tanzu Kubernetes GRID](/pages/cloud/private-cloud/tanzu_tkgm_04persistent-volumes)
