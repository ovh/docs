...
Durante questa operazione è anche possibile modificare la politica di storage e, ad esempio, applicare le regole esistenti per uno [storage vSAN](../vmware-vsan/) o l’opzione [VMencryption](/pages/cloud/private-cloud/vm_encrypt).
