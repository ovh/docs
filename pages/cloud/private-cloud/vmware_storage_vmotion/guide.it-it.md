...
Questa operazione, chiamata **vMotion**, è descritta in [questa guida](/pages/cloud/private-cloud/vmware_vmotion_new).
...
Durante questa operazione è anche possibile modificare la politica di storage e, ad esempio, applicare le regole esistenti per uno [storage vSAN](/pages/cloud/private-cloud/vmware_vsan) o l’opzione [VMencryption](/pages/cloud/private-cloud/vm_encrypt).
