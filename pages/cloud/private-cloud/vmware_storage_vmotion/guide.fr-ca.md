...
Ainsi, vous pouvez appliquer les politiques de stockage créées si vous disposez d'un [stockage vSAN](/pages/cloud/private-cloud/vmware_vsan) ou de l'option [VMencryption](/pages/cloud/private-cloud/vm_encrypt).
