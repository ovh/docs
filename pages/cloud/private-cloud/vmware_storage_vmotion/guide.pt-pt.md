...
Assim, poderá aplicar as políticas de armazenamento criadas se dispuser de um [armazenamento vSAN](/pages/cloud/private-cloud/vmware_vsan) ou da opção [VMencryption](/pages/cloud/private-cloud/vm_encrypt).
