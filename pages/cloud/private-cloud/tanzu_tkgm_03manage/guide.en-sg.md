...
- You need to have the **Tanzu Kubernetes GRID** administration cluster installed, using the [Install Tanzu Kubernetes Grid](https://docs.ovh.com/sg/en/private-cloud/tanzu-tkgm-installation) guide.
...
[Installing Tanzu Kubernetes Grid](https://docs.ovh.com/sg/en/private-cloud/tanzu-tkgm-installation)
