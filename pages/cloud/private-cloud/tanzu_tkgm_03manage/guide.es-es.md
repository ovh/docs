...
- You need to have the **Tanzu Kubernetes GRID** administration cluster installed, using the [Install Tanzu Kubernetes Grid](https://docs.ovh.com/es/private-cloud/tanzu-tkgm-installation) guide.
