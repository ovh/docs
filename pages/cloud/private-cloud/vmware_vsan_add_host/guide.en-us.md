...
- A deployed [vSan Datastore](https://docs.ovh.com/us/en/private-cloud/vmware-vsan/)

## Instructions

### Order a new vSan host

Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we) with your administrative credentials.
