...
- A deployed [vSan Datastore](https://docs.ovh.com/ca/en/private-cloud/vmware-vsan/)

## Instructions

### Order a new vSan host

Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca) with your administrative credentials.
