...
- Having **NSX** deployed with two segments configured in your NSX configuration, you can use this guide [Segment management in NSX](https://docs.ovh.com/es/private-cloud/nsx-segment-management).
...
[Implementing NAT for port redirections in NSX](https://docs.ovh.com/es/private-cloud/nsx-configure-nat-redirection)
