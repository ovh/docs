...
Le déploiement terminée 7 machines virtuelles seront visibles sur votre cluster VMware, 6 sont utilisées pour le fonctionnement du cluster d'administration **TKG** et un autre pour l'administration.
