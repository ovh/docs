...
> [!warning]
>
> vSAN requires vSAN compatible hosts. Find more details [here](https://docs.ovh.com/es/private-cloud/manager-ovh-private-cloud/) on how to order them if needed.
> 
