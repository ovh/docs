...
- An [Additional IP service](https://www.ovhcloud.com/en-au/network/additional-ip/)
- Access to the [OVHcloud API console](https://ca.api.ovh.com/)
- Consulting the guide [First steps to use the OVHcloud API](https://docs.ovh.com/au/en/api/first-steps-with-ovh-api/) (to familiarise yourself with the OVHcloud API)
