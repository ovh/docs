...
- [Créer un pool](https://docs.ovh.com/ca/fr/storage/block-storage/ceph/create-a-pool/)
- [Créer-un-utilisateur](https://docs.ovh.com/ca/fr/storage/block-storage/ceph/create-a-user/)
- [Ajouter des droits à un utilisateur sur un pool](https://docs.ovh.com/ca/fr/storage/block-storage/ceph/change-user-rights/)
- [Ajouter un IP ACL](https://docs.ovh.com/ca/fr/storage/block-storage/ceph/create-an-ip-acl/) pour permettre à votre serveur de contacter le cluster
