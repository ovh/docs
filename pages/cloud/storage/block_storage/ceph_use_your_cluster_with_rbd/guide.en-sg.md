...
- [Create a pool](https://docs.ovh.com/sg/en/storage/block-storage/ceph/create-a-pool/)
- [Create a user](https://docs.ovh.com/sg/en/storage/block-storage/ceph/create-a-user/)
- [Add rights to a user on a pool](https://docs.ovh.com/sg/en/storage/block-storage/ceph/change-user-rights/)
- [Add an IP ACL](https://docs.ovh.com/sg/en/storage/block-storage/ceph/create-an-ip-acl/) to allow your server to contact the cluster
