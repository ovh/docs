...
- Unfreezing via python-swiftclient:
    - [Preparing an environment for using the OpenStack API](https://docs.ovh.com/asia/en/public-cloud/prepare_the_environment_for_using_the_openstack_api/) by installing python-swiftclient
...
Your file will be ready for download after this time period. You can then start the download directly in your browser or via a [Swift/SFTP/SCP client](https://docs.ovh.com/asia/en/storage/pca/sftp/).
