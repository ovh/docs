...
Po utworzeniu [użytkownika OpenStack](/pages/platform/public-cloud/create_and_delete_a_user){.external} w Panelu klienta możesz uzyskać plik konfiguracyjny rClone.
