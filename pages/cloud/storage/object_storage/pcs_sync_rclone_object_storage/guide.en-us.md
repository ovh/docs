...
- You need to have created an *Object Storage* container (you can create one from the Control Panel or from [Horizon](https://docs.ovh.com/us/en/storage/create_an_object_container/){.external})
