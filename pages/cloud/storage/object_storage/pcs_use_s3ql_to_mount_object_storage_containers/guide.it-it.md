...
- [Configure user](https://docs.ovh.com/it/public-cloud/creation-and-deletion-of-openstack-user/)
- [Add storage space](https://docs.ovh.com/it/storage/object-storage/pcs/create-container/)
...
You can follow this guide below in order to retrieve it: [Access and Security in Horizon](https://docs.ovh.com/it/public-cloud/access_and_security_in_horizon/)
