...
**Last updated 24st October 2022**
...
> See the [Curl command memo](https://docs.ovh.com/us/en/storage/pcs/curl-commands-memo/) documentation for the manifest upload.
>
...
>
> In this example, the LargeObject was uploaded in SLO mode.
> Please refer to the [Curl Command Memo](https://docs.ovh.com/us/en/storage/pcs/curl-commands-memo/) documentation for the manifest upload.
>
...
```
swift upload test2 logo_ovh.png
Object PUT failed: https://storage.gra.cloud.ovh.net/v1/AUTH_<account>/test2/logo_ovh.png 413 Request Entity Too Large b'Upload exceeds quota.' (txn: txee1f2b77c26a424ebbda8-0062a1aa7f)
