...
> See the [Curl command memo](https://docs.ovh.com/asia/en/storage/pcs/curl-commands-memo/) documentation for the manifest upload.
>
...
>
> In this example, the LargeObject was uploaded in SLO mode.
> Please refer to the [Curl Command Memo](https://docs.ovh.com/asia/en/storage/pcs/curl-commands-memo/) documentation for the manifest upload.
>
