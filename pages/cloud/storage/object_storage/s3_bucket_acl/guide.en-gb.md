...
- **log delivery group**: this group contains the applicative users used by OVHcloud services to write server access logs inside buckets (read our [Server Access Logging](https://docs.ovh.com/gb/en/storage/object-storage/s3/server-access-logging/) guide for more information)
