...
- You will need to have set up an account to interact with OVH API : [https://docs.ovh.com/au/en/api/first-steps-with-ovh-api/](https://docs.ovh.com/au/en/api/first-steps-with-ovh-api/). From the application key created in this tutorial, you will need to export the 4 environment variables :
...
- The *variable* block defines the region and s3 endpoint that are used to create the bucket. You can update it according to your needs [https://docs.ovh.com/au/en/storage/object-storage/s3/location/](https://docs.ovh.com/au/en/storage/object-storage/s3/location/)
