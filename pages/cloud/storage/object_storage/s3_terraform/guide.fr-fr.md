...
- Avoir accès aux API v6 (reportez à notre guide de [premiers pas avec les API OVHcloud](https://docs.ovh.com/fr/api/first-steps-with-ovh-api/)). Une fois les accès aux API créés, exportez les 4 IDs dans les variables, tel que décrit ci-dessous :
