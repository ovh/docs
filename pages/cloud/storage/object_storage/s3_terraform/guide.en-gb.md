...
- You will need to have set up an account to interact with the OVHcloud API (see this [tutorial](https://docs.ovh.com/gb/en/api/first-steps-with-ovh-api/)). From the application keys created, you will need to export the 4 environment variables :
