...
- The OpenRC file, obtained from the [OVHcloud Control Panel](https://docs.ovh.com/es/public-cloud/creation-and-deletion-of-openstack-user/) or [Horizon](/pages/platform/public-cloud/introducing_horizon)
