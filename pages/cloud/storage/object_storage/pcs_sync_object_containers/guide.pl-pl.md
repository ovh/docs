...
- [An environment that is ready to use the OpenStack API with the Swift client](https://docs.ovh.com/pl/public-cloud/przygotowanie_srodowiska_dla_api_openstack/)
- [OpenStack environment variables set](https://docs.ovh.com/pl/public-cloud/zmienne-srodowiskowe-openstack/)
