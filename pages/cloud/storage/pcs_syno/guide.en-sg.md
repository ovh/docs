...
### Prerequisites
- [Add storage space](https://docs.ovh.com/sg/en/storage/create_an_object_container/)
- [Configure user](https://docs.ovh.com/sg/en/public-cloud/set-openstack-environment-variables/#instructions)
