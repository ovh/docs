...
Os serviços Enterprise File Storage podem ser geridos [através das API OVHcloud](../netapp-quickstart/) ou a partir da Área de Cliente OVHcloud.
...
Ligue-se à sua [Área de Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pt/&ovhSubsidiary=pt) e selecione `Bare Metal Cloud`{.action}. Abra o `Storage e o Backup`{.action}, depois o `Enterprise File Storage`{.action} e selecione o seu serviço na lista.
...
> [!primary]
> Consulte a página [Conceitos](../netapp-concepts/) para obter informações detalhadas sobre as propriedades técnicas da solução Enterprise File Storage.
>
...
[Enterprise File Storage - Gestão de volumes](../netapp-volumes/)

[Enterprise File Storage - Gestão dos ACL de volume](../netapp-volume-acl/)

[Enterprise File Storage - Gestão das snapshots de volumes](../netapp-volume-snapshots/)
