...
Log in to your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au) and go to the `Bare Metal Cloud`{.action} section. Open `Storage and Backup`{.action} and `Enterprise File Storage`{.action}, then select your service from the list.
