...
Enterprise File Storage Dienste können über die [OVHcloud API](../netapp-quickstart/) oder in Ihrem OVHcloud Kundencenter verwaltet werden.
...
> [!primary]
> Detaillierte Informationen zu den technischen Eigenschaften der Enterprise File Storage Lösung finden Sie auf der Seite [Enterprise File Storage - Konzepte](../netapp-concepts/).
>
...
[Enterprise File Storage - Quickstart API](../netapp-quickstart/)

[Enterprise File Storage - Verwaltung der Volumes](../netapp-volumes/)

[Enterprise File Storage - Verwaltung der Volume ACL](../netapp-volume-acl/)

[Enterprise File Storage - Verwaltung der Volume Snapshots](../netapp-volume-snapshots/)
