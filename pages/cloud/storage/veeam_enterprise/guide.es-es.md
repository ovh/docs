...
El usuario de OVHVeamEnterprise solo está disponible localmente. Para activar la conexión a distancia, es necesario añadir permisos en la interfaz gráfica de usuario Windows.
...
5. Haga clic en el usuario de `OVHVeeamEnterprise`{.action} y active todos los permisos.
