...
Vous trouverez la description des classes des stockage [ici](https://docs.ovh.com/ca/fr/storage/s3/choosing-a-suitable-storage-class/).
...
Les classes de stockages objet S3 offrent un  large support des API S3. L'ensemble des API compatibles sont décrites [ici](https://docs.ovh.com/ca/fr/storage/s3/choosing-a-suitable-storage-class/). 
...
La liste des endpoints est disponible [ici](https://docs.ovh.com/ca/fr/storage/s3/location/).
...
OVHcloud s’engage à assurer les niveaux de Service relatifs à la disponibilité du Service tels que décrits dans les T&C consultables [ici](https://docs.ovh.com/ca/fr/storage/s3/choosing-a-suitable-storage-class/).
