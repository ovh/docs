...
- a [Dedicated Server](https://www.ovhcloud.com/en/bare-metal/), [VPS](https://www.ovhcloud.com/en/vps/) or [Public Cloud Instance](https://www.ovhcloud.com/en/public-cloud/) with a Windows distribution.
...
- (Windows Server 2012) Click the "power shell" icon at the bottom of the screen in the taskbar.
- (Windows Server 2016) Click on the menu "Start", then on the "power shell" icon.
- (Windows Server 2019) Click on the menu "Start", then on the "power shell" icon.
...
[NAS - Frequently Asked Questions](https://docs.ovh.com/us/en/storage/faq-nas/)
