...
- [Configure user](https://docs.ovh.com/ca/en/public-cloud/set-openstack-environment-variables/)
- [Add storage space](https://docs.ovh.com/ca/en/storage/create_an_object_container/)
