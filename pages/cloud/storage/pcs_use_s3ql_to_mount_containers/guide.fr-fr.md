...
- [Avoir charger les variables d’environnement OpenStack](https://docs.ovh.com/fr/public-cloud/charger-les-variables-denvironnement-openstack/)
...
Les paramètres OS_PROJECT_ID, OS_USERNAME and OS_PASSWORD peut être trouvé dans votre fichier OpenRC.
