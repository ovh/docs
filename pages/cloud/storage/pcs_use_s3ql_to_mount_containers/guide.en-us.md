...
- [Configure user access to Horizon](../platform/public-cloud/create_and_delete_a_user/guide.en-us.md){.ref}
- [Add storage space](../platform/public-cloud/add_storage_space/guide.en-us.md){.ref}
