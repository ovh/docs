...
- [Configure user access to Horizon](../platform/public-cloud/create_and_delete_a_user/guide.en-ie.md){.ref}
- [Add storage space](../pcs_create_an_object_container/guide.en-ie.md){.ref}
