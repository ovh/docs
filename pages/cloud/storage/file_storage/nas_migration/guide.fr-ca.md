...
- Avoir monté votre NAS-HA au préalable en suivant le guide pour [monter votre NAS-HA via un partage NFS](/pages/cloud/storage/file_storage/nas_nfs){.external}.
