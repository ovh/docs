...
- Aver configurato il tuo NAS-HA seguendo la guida per [montare il tuo NAS-HA tramite una condivisione NFS](https://docs.ovh.com/it/storage/file-storage/nas/nfs/){.external}.
