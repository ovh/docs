...
- You need to have mounted your HA-NAS beforehand by following the guide to [mount your HA-NAS via an NFS](https://docs.ovh.com/asia/en/storage/file-storage/nas/nfs/){.external} share.
