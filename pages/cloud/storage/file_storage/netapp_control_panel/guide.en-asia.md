...
Enterprise File Storage services can be managed [via the OVHcloud API](https://docs.ovh.com/asia/en/storage/file-storage/netapp/quick-start/) or in the OVHcloud Control Panel.
...
> [!primary]
> Please visit the [concepts page](https://docs.ovh.com/asia/en/storage/file-storage/netapp/concepts/) for detailed information on the technical properties of Enterprise File Storage.
>
...
[API Quickstart](https://docs.ovh.com/asia/en/storage/file-storage/netapp/quick-start/)

[Managing volumes via API](https://docs.ovh.com/asia/en/storage/file-storage/netapp/volumes/)

[Managing volume ACLs via API](https://docs.ovh.com/asia/en/storage/file-storage/netapp/volume-acl/)

[Managing volume snapshots via API](https://docs.ovh.com/asia/en/storage/file-storage/netapp/volume-snapshots/)
