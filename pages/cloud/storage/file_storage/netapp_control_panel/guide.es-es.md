...
Los servicios Enterprise File Storage pueden administrarse [a través de la API de OVHcloud](/pages/cloud/storage/file_storage/netapp_quick_start) o desde el área de cliente de OVHcloud.
...
> [!primary]
> Para más información sobre las propiedades técnicas de la solución Enterprise File Storage, consulte la página [Concepts](/pages/cloud/storage/file_storage/netapp_concepts).
>
...
[Enterprise File Storage - Gestión de volúmenes](/pages/cloud/storage/file_storage/netapp_volumes)

[Enterprise File Storage - Gestión de ACL de volumen](/pages/cloud/storage/file_storage/netapp_volume_acl)

[Enterprise File Storage - Gestión de snapshots de volúmenes](/pages/cloud/storage/file_storage/netapp_volume_snapshots)
