...
- [A partition created on the service with the NFS protcol enabled](https://docs.ovh.com/gb/en/storage/file-storage/nas/get-started/#partition)
- [An ACL entry for the server's IP address](https://docs.ovh.com/gb/en/storage/file-storage/nas/get-started/#addaccess)
