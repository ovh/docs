...
- An [OpenStack user](https://docs.ovh.com/sg/en/public-cloud/creation-and-deletion-of-openstack-user/){.external}
...
>  
> See: [Linking a container to a domain name](https://docs.ovh.com/sg/en/storage/pcs/link-domain/)
>
