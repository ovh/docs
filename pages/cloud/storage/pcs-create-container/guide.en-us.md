...
- An [OpenStack user](https://docs.ovh.com/us/en/public-cloud/creation-and-deletion-of-openstack-user/){.external}
...
>  
> See: [Linking a container to a domain name](https://docs.ovh.com/us/en/storage/pcs/link-domain/)
>
