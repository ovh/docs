...
You can manage your HA-NAS service via the [OVHcloud API](https://docs.ovh.com/ca/en/storage/nas/nas-quickapi/) or in your OVHcloud Control Panel.

**This guide explains how to manage HA-NAS partitions and snapshots in the OVHcloud Control Panel.**

## Requirements

- An [OVHcloud HA-NAS solution](https://www.ovh.com/ca/en/nas/)
...
Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca), go to the `Bare Metal Cloud`{.action} section and 
...
[Managing partitions via API](https://docs.ovh.com/ca/en/storage/nas/nas-partitions-api/)

[Managing partition ACLs via API](https://docs.ovh.com/ca/en/storage/nas/nas-manage-acls/)
