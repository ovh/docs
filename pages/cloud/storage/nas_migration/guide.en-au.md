...
- You need to have mounted your NAS beforehand by following the guide to [mount your NAS via an NFS](https://docs.ovh.com/au/en/storage/nas-nfs/){.external} share.
