---
title: Utilisez High Performance avec Veeam
slug: s3/veeam
...
- Ouvrez la vue **Infrastructure de sauvegarde**. Dans le volet d'inventaire, sélectionnez le nœud **Dépôts de sauvegarde** et cliquez sur **Ajouter un dépôt** sur le ruban. Dans la boîte de dialogue **Add Backup Repository**, sélectionnez Object Storage > `S3 Compatible`{.action}.

- Ouvrez la vue **Infrastructure de sauvegarde**. Dans le panneau d'inventaire, cliquez avec le bouton droit de la souris sur le nœud **Dépôts de sauvegarde** et sélectionnez **Ajouter un dépôt de sauvegarde**. Dans la boîte de dialogue **Add Backup Repository**, sélectionnez Object Storage > `S3 Compatible`{.action}.
...
- Dans la liste déroulante **Credentials**, sélectionnez l
es informations d'identification de l'utilisateur pour accéder à votre stockage d'objets compatibles S3.

Si vous avez déjà un enregistrement d'informations d'identification qui a été configuré à l'avance, sélectionnez-le dans la liste déroulante. Sinon, cliquez sur Ajouter et fournissez vos clés d'accès et secrètes. Vous pouvez également cliquer sur le lien Gérer les comptes cloud pour ajouter, modifier ou supprimer un enregistrement d'informations d'identification.
...
Vous pouvez sélectionner tout serveur Microsoft Windows ou Linux ajouté à votre infrastructure de sauvegarde et disposant d'une connexion Internet. Par défaut, le rôle d'un serveur passerelle est attribué à la machine où Veeam Backup & Replication est installé.
...
1. Dans la liste déroulante **Bucket**, sélectionnez un bucket.  
Assurez-vous que le bucket dans lequel vous souhaitez stocker vos données de sauvegarde a été créé à l'avance.
...
Pour sélectionner un dossier, cliquez sur **Parcourir** et sélectionnez un dossier existant ou créez-en un nouveau en cliquant sur **Nouveau dossier**.
