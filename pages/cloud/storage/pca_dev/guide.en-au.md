...
[OVH Public Cloud Archive](https://www.ovhcloud.com/en-au/public-cloud/cloud-archive/){.external} is an extremely low-cost storage solution destined for long-term data archiving.
...
Storage](https://www.ovhcloud.com/en-au/public-cloud/object-storage/){.external} instead.
...
See greater details about this [request](https://docs.ovh.com/au/en/storage/pca/api/).
...
See further explanations about this [request](https://docs.ovh.com/au/en/storage/pca/api/).
