...
In an infrastructure, the HA-NAS is a storage space to which you can attach several [dedicated servers](hhttps://www.ovh.lt/dedikuoti_serveriai/){.external}, [Private Cloud](https://www.ovh.lt/private-cloud/){.external} or [Public Cloud instances](https://www.ovh.lt/public-cloud/instances/){.external}.
