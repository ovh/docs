...
Yes, you can manage it from your [OVH Control Panel](https://ca.ovh.com/auth/) by going to the `Cloud`{.action} section, then `Platforms and services`{.action}.
...
You can also create manual snapshots at any time, save them without any time limit, or delete them. This feature is available in your [OVH Control Panel](https://ca.ovh.com/auth/) or via the[API](https://api.ovh.com/):
