...
> [!primary]
> For more details on the differences between levels L2 and L3, see our [FAQ](/pl/ovhcloud-connect/occdedicated-faq/#how-do-i-choose-between-a-layer-2-or-layer-3-cross-connection-for-the-osi-model).
>
