...
Visit [**this page**](https://www.ovh.com/sg/solutions/ovhcloud-connect/){.external} and log in using your OVHcloud credentials to order **each connection**. The following features will be offered:
...
- The OVHcloud Connect PoP:
    + OVHcloud Connect points of presence are listed [**here**](https://www.ovh.com/sg/solutions/ovhcloud-connect/){.external}, and updated regularly.
