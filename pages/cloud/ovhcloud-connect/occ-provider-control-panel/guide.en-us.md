...
Next, check the activation status of your solution in the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager). To do this, click `Bare Metal Cloud`{.action} in the top navigation bar, then select `Network`{.action} from the left-hand menu. Open `OVHcloud Connect`{.action} and click on your solution. Your solution's status should have changed to “Active”.

### Step 2: Associating a vRack

Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager), click `Bare Metal Cloud`{.action} in the top navigation bar, then select `Network`{.action} from the left-hand menu. Open `OVHcloud Connect`{.action} and click on your solution.
