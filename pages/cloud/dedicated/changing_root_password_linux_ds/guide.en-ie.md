...
After putting your server into [rescue mode](https://docs.ovh.com/ie/en/dedicated/rescue_mode/){.external}, you will need to identify the system partition. You can do this with the following command:
