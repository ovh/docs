...
- You will need a [dedicated server](https://www.ovh.lt/dedikuoti_serveriai/){.external} with Windows installed.
- You need to have a Windows SPLA licence, or have [ordered one](https://www.ovh.lt/dedikuoti_serveriai/windows-2014-licenciju-ikainiai.xml){.external}.
