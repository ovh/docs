...
- a dedicated server in the [Infrastructure range](https://www.ovhcloud.com/en/bare-metal/infra/) with the [SGX](https://www.ovhcloud.com/en/bare-metal/intel-software-guard-extensions/) option in your OVHcloud account
- access to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we) / to the [OVHcloud API](https://ca.api.ovh.com/console/)
