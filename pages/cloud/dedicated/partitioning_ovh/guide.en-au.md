...
- [software RAID](https://docs.ovh.com/au/en/dedicated/raid-soft/) (SR),
...
>
> - lv: means that LVM layers will be added on top of the [software RAID](https://docs.ovh.com/au/en/dedicated/raid-soft/) device (or the physical partition if RAID level is 0)
...
[Configuring Software RAID](https://docs.ovh.com/au/en/dedicated/raid-soft/)

[Managing Hardware RAID](https://docs.ovh.com/au/en/dedicated/raid-hard/)
