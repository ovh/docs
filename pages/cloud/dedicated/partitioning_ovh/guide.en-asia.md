...
With [OVHcloud Dedicated Servers](https://www.ovhcloud.com/asia/bare-metal/), you can configure Partitions, [software RAID](https://docs.ovh.com/asia/en/dedicated/raid-soft/), LVM, ZFS, etc. during [OS installation](https://docs.ovh.com/asia/en/dedicated/getting-started-dedicated-server/) from the [OVHcloud API](https://ca.api.ovh.com/) as well as the [OVHcloud Control Panel](https://ca.ovh.com/manager/#/dedicated/configuration). In this article, we will focus on the [OVHcloud API](https://ca.api.ovh.com/). This will give us more details about the engine that is running in the background in order to create the partitioning on the dedicated server from the input data passed on to the OVHcloud API.
...
* A [dedicated server](https://www.ovhcloud.com/asia/bare-metal/) **ready to be installed/re-installed** in your OVHcloud account.
...
- [software RAID](https://docs.ovh.com/asia/en/dedicated/raid-soft/) (SR),
...
>
> - lv: means that LVM layers will be added on top of the [software RAID](https://docs.ovh.com/asia/en/dedicated/raid-soft/) device (or the physical partition if RAID level is 0)
...
[Configuring Software RAID](https://docs.ovh.com/asia/en/dedicated/raid-soft/)

[Managing Hardware RAID](https://docs.ovh.com/asia/en/dedicated/raid-hard/)
