...
- [software RAID](https://docs.ovh.com/de/dedicated/soft-raid/) (SR),
...
>
> - lv: means that LVM layers will be added on top of the [software RAID](https://docs.ovh.com/de/dedicated/soft-raid/) device (or the physical partition if RAID level is 0)
...
[Configuring Software RAID](https://docs.ovh.com/de/dedicated/soft-raid/)
