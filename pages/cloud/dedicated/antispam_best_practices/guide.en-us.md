...
Log in to the [OVHcloud API interface](https://ca.api.ovh.com/) according to the [relevant guide](https://docs.ovh.com/us/en/api/first-steps-with-ovh-api/) and follow the steps below.
