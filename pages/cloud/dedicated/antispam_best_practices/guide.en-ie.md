...
Log in to the [OVHcloud API interface](https://api.ovh.com/) according to the [relevant guide](https://docs.ovh.com/ie/en/api/first-steps-with-ovh-api/) and follow the steps below.
