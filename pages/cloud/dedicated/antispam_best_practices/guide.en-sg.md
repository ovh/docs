...
Log in to the [OVHcloud API interface](https://ca.api.ovh.com/console/) according to the [relevant guide](https://docs.ovh.com/sg/en/api/first-steps-with-ovh-api/) and follow the steps below.
