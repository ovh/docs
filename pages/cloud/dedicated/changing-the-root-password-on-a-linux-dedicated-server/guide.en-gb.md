...
* You need to have root access to your server (in SSH)
* You need to have access to your [OVH control panel](https://www.ovh.com/auth/?action=gotomanager){.external}.
