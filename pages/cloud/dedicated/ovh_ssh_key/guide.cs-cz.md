---
deprecated: true
title: Instalace SSH klíče OVHcloud
slug: ovh-ssh-key
excerpt: Instalace klíče SSH OVHcloud je zapotřebí v případech, kdy je na serveru či instanci zákazníka vyžadována intervence ze strany administrátora OVHcloud
...
V některých situacích může být na Vaší dedikované infrastruktuře vyžadován zásah ze strany administrátora OVHcloud. 

**V této příručce se dozvíte, jak na instalaci a následnou deaktivaci SSH klíče OVHcloud.**
...
- Váš server je hostován v některém z evropských datacenter OVHcloud:
...
- Váš server je hostován v kanadském datacentru OVHcloud:
