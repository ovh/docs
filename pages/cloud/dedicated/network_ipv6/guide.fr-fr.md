...
- Avoir des connaissances de base en [SSH](http://en.wikipedia.org/wiki/Secure_Shell) et en réseau.
...
Retrouvez plus d'informations dans [ce guide](../getting-started-dedicated-server/#logging-on-to-your-server)
