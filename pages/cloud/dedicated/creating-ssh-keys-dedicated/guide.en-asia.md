...
We recommend reading the [SSH introduction guide](/pages/cloud/dedicated/ssh_introduction) as well.
...
You can learn more about SSH connections in the ["Getting started" guides](#getstarted) and in our [SSH introduction](/pages/cloud/dedicated/ssh_introduction).

### Adding SSH keys to your server <a name="addserverkey"></a>

[Connect](/pages/cloud/dedicated/ssh_introduction) to your server and make sure you are in your user's `$HOME` directory. Create the folder `.ssh` (if it does not exist):
...
> [!primary]
>
> All keys saved in the `Dedicated` section are available to preinstall on a dedicated server or a VPS. Regarding SSH keys for Public Cloud services, please refer to [this guide](/pages/platform/public-cloud/public-cloud-first-steps).
>
