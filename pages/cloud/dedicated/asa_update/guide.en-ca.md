...
To do this, go to your [OVH Control Panel](https://ca.ovh.com/auth/?action=gotomanager){.external}, and open the `Dedicated`{.action} section. Then select your dedicated server, and `Cisco ASA Firewall`{.action}. Next, click `Disable the Cisco ASA firewall`{.action}, on the right-hand side.
...
As per the first step, go to your [OVH Control Panel](https://ca.ovh.com/auth/?action=gotomanager){.external}, and open the `Dedicated`{.action} section. Select your dedicated server, then `Cisco ASA Firewall`{.action}. Next, click `Enable the Cisco ASA firewall`{.action}, on the right-hand side.
...
As per the first step, go to your [OVH Control Panel](https://ca.ovh.com/auth/?action=gotomanager){.external}, and open the `Dedicated`{.action} section. Then select your dedicated server, and `Cisco ASA Firewall`{.action}. Next, click `Enable the Cisco ASA firewall`{.action}, on the right-hand side.
