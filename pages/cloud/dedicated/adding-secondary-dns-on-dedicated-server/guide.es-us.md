...
Inicie sesión en el [área de cliente de OVHcloud](https://ca.ovh.com/auth/?action=gotomanager), acceda a la sección `Bare Metal Cloud`{.action} y seleccione el servidor en la columna izquierda, en los `servidores dedicados`{.action}.
