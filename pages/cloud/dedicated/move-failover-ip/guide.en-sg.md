...
- A [failover IP address](https://www.ovhcloud.com/en-sg/bare-metal/ip/)
...
> See [this guide](https://docs.ovh.com/sg/en/dedicated/network-support-virtual-mac/) for details.
>
...
Log in to the [OVHcloud Control](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg), click on the `Bare Metal Cloud`{.action} menu, then click on the `IP`{.action} section at the bottom of the column on the left of the page.
