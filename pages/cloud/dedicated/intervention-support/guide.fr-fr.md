...
1\. Redémarrez le serveur en [mode rescue](/pages/cloud/dedicated/rescue_mode).
...
1\. Redémarrez le serveur en [mode rescue](/pages/cloud/dedicated/rescue_mode) et repérez la partition `/` :
...
1\. Redémarrez le serveur en [mode rescue](/pages/cloud/dedicated/rescue_mode) et utilisez la commande `chroot` :
...
1\. Redémarrez le serveur en [mode rescue](/pages/cloud/dedicated/rescue_mode) afin de monter la partition `/` :
...
1\. Connectez-vous en tant qu'administrateur à partir de l'interface [IPMI/KVM](/pages/cloud/dedicated/using_ipmi_on_dedicated_servers).
...
1\. Redémarrez le serveur en [mode rescue](/pages/cloud/dedicated/rescue_mode), montez la partition `/` et utilisez ensuite la commande `chroot` :
