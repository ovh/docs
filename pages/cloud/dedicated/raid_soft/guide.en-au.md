...
* a [dedicated server](https://www.ovh.com.au/dedicated-servers/){.external} with a software RAID configuration
...
* [Hot Swap – Hardware RAID](https://docs.ovh.com/au/en/dedicated/hotswap-raid-hard/){.external}
* [Hot Swap – Software RAID](https://docs.ovh.com/au/en/dedicated/hotswap-raid-soft/){.external}
