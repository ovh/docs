...
>
> The migration of a failover IP between two accounts of different branches is only possible from a SYS account to OVHcloud. It is not possible to migrate an IP from an OVHcloud account to So you Start.
>
...
To do this, please refer to our dedicated guide: [Move a failover IP](https://docs.ovh.com/ca/en/dedicated/ip-fo-move/).
