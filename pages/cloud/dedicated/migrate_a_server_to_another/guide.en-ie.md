...
- The easiest way is to use a suitable software such as [SFTP](https://docs.ovh.com/ie/en/dedicated/store-retrieve-data-via-sftp/).
- The other option is to [synchronise the two servers with each other](https://docs.ovh.com/ie/en/dedicated/copy-data-server-rsync/).
...
See our guide on [using Backup Storage on a dedicated server](https://docs.ovh.com/ie/en/dedicated/services-backup-storage/){.external} for more information.
...
For more information, please read our documentation on [domains and Dns](https://docs.ovh.com/ie/en/domains/).

## Go further

If you would like assistance migrating your server, please refer to our [support offers](https://www.ovhcloud.com/en-ie/support-levels/) or contact [OVHcloud partners](https://partner.ovhcloud.com/en-ie/directory/).
