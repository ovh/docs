...
- The easiest way is to use a suitable software such as [SFTP](https://docs.ovh.com/asia/en/dedicated/store-retrieve-data-via-sftp/).
- The other option is to [synchronise the two servers with each other](https://docs.ovh.com/asia/en/dedicated/copy-data-server-rsync/).
...
See our guide on [using Backup Storage on a dedicated server](https://docs.ovh.com/asia/en/dedicated/using-backup-storage/){.external} for more information.
...
If the reputation of your IP addresses is important, we strongly recommend using [failover IPs](https://www.ovhcloud.com/asia/bare-metal/ip/), as they can be kept if you migrate.

Once you have these IPs, you simply need to move them to the new server.
To do this, please refer to our dedicated guide: [Moving a failover IP](https://docs.ovh.com/asia/en/dedicated/ip-fo-move/).
...
For more information, please read our documentation on [domains and Dns](https://docs.ovh.com/asia/en/domains/).

## Go further

If you would like assistance migrating your server, please refer to our [support offers](https://www.ovhcloud.com/asia/support-levels/) or contact [OVHcloud partners](https://partner.ovhcloud.com/asia/).
