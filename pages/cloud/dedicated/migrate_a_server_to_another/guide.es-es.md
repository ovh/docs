...
Para más información, consulte nuestra guía sobre [utilizar Backup Storage en un servidor dedicado](https://docs.ovh.com/es/dedicated/servicio-backup-storage/){.external}.

### Migración de una dirección IP failover (disponible únicamente en OVHcloud y So you Start)

> [!warning]
>
> La dirección IP principal de un servidor no puede migrarse y se perderá en el proceso.
>
> La migración de una dirección IP failover entre dos cuentas de diferentes sucursales sólo es posible desde una cuenta So you start a una cuenta OVHcloud. No es posible migrar una dirección IP failover de una cuenta de OVHcloud a So you Start.
>
...
Si desea obtener ayuda para migrar su servidor, póngase en contacto con los [partners de OVHcloud](https://partner.ovhcloud.com/es-es/).
