...
Ajoutez l'adresse IP et le masque de sous-réseau correspondant à votre IP fail-over et cliquez sur `Add`{.action}
...
> [!warning]
>
> Cette étape peut provoquer une perte de connexion. Si cela se produit, connectez-vous en utilisant l'[IPMI](../use-ipmi-serveurs-dédiés) et modifiez de nouveau la configuration. Vous constaterez alors que votre passerelle par défaut est revenue à l'état vide. Rajoutez la gateway 100.64.0.1.
>
