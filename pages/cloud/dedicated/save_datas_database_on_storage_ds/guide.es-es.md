...
- Un [servidor de almacenamiento](https://www.ovhcloud.com/es-es/bare-metal/storage/){.external} de OVH.
...
Los [servidores de almacenamiento](https://www.ovhcloud.com/es-es/bare-metal/storage/){.external} de OVH incluyen varios discos duros en su configuración de hardware. Para este tutorial, vamos a utilizar un servidor con RAID por software (o softRAID) y cuatro discos con una capacidad de 6 TB cada uno.
...
Conéctese al [área de cliente de OVH](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es){.external} e instale el servidor.
