...
- an [OVHcloud Storage Server](https://www.ovh.com/asia/dedicated_servers/storage/){.external}
- a production infrastructure ([VPS](https://www.ovh.com/asia/vps/){.external}, [Dedicated Servers](https://www.ovh.com/asia/dedicated_servers/){.external}, [Public Cloud](https://www.ovh.com/asia/public-cloud/instances/){.external}, etc.)
...
OVHcloud offers a range of [Storage Servers](https://www.ovh.com/asia/dedicated_servers/storage/){.external} with hardware configurations that contain several hard disks. In our example, we are using a software RAID (or softRAID) with four disks, which each have 6 TB capacity.
