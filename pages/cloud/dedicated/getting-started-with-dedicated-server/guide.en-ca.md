...
* A [dedicated server](https://www.ovh.com/ca/en/dedicated-servers/){.external} in your [OVH Control Panel](https://ca.ovh.com/auth/?action=gotomanager){.external} with root to via SSH (Linux)
* A [dedicated server](https://www.ovh.com/ca/en/dedicated-servers/){.external} in your [OVH Control Panel](https://ca.ovh.com/auth/?action=gotomanager){.external} with administrative access via remote desktop (Windows).
