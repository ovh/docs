...
- For a [dedicated server](https://docs.ovh.com/ie/en/dedicated/getting-started-dedicated-server/)
- For a [dedicated server of the **Eco** product line](https://docs.ovh.com/ie/en/dedicated/getting-started-dedicated-server-eco/)
- For a [VPS](https://docs.ovh.com/ie/en/vps/getting-started-vps/)
...
[Dedicated server rescue mode](https://docs.ovh.com/ie/en/dedicated/rescue_mode/)
