...
Para más información sobre la gestión de su servidor dedicado desde el área de cliente de OVHcloud, consulte [esta guía](https://docs.ovh.com/us/es/dedicated/primeros-pasos-servidor-dedicado/).
...
- **Seguridad**: desde esta sección podrá administrar los parámetros de seguridad de su cuenta. Para más información, consulte [esta guía](https://docs.ovh.com/us/es/customer/todo-sobre-el-id-de-cliente/).
...
- **Gestión de los usuarios**: esta sección le permite gestionar sus usuarios. Para más información, consulte [esta guía](https://docs.ovh.com/us/es/customer/gestion-de-usuarios/).
- **Mis facturas**: desde esta sección podrá consultar sus facturas, seguir los pagos realizados con su forma de pago por defecto y consultar sus activos. Más información sobre [esta guía](https://docs.ovh.com/us/es/billing/gestionar-facturas-ovh/).
- **Mis servicios**: desde esta sección podrá ver todos sus servicios, contratos y llaves SSH.
- **Formas de pago**: en esta sección, tiene acceso a su forma de pago actual, a su cuenta de prepago y a sus códigos promocionales de OVHcloud. También incluye la opción de añadir o eliminar una forma de pago. Para más información sobre la gestión de sus formas de pago, consulte [esta guía](https://docs.ovh.com/us/es/billing/gestionar-formas-de-pago/).
- **Mis pedidos**: consulte sus pedidos desde esta página. Más información sobre [esta guía](https://docs.ovh.com/us/es/billing/gestionar-los-pedidos-en-ovh/).
...
[¿Cuáles son las direcciones IP del monitoring de OVHcloud?](https://docs.ovh.com/us/es/dedicated/monitoring-ip-ovh/).
