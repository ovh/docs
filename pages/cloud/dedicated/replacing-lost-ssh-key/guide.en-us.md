...
Switch the boot mode back to "normal" and restart the server in your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we). Refer to the [rescue mode guide](/pages/cloud/dedicated/rescue_mode) if necessary.
