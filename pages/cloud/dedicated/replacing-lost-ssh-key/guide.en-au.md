...
If you are [using SSH keys](https://docs.ovh.com/au/en/dedicated/creating-ssh-keys-dedicated/) to connect to your dedicated server, losing your private SSH key could mean losing access to your server altogether.

However, you can still connect to your server via the OVHcloud [rescue mode](https://docs.ovh.com/au/en/dedicated/ovh-rescue/), which allows you to log in with a provisional password and modify your files.
...
Log in to your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au) and navigate to the `SSH keys`{.action} section. Use our [SSH key guide](https://docs.ovh.com/au/en/dedicated/creating-ssh-keys-dedicated/#cpsshkey) if necessary.
...
Create a new SSH key pair on your device, as described in the first part of the [SSH key guide](https://docs.ovh.com/au/en/dedicated/creating-ssh-keys-dedicated/).

### Step 3: Access your server in rescue mode and replace the key

Follow the steps in the [rescue mode guide](https://docs.ovh.com/au/en/dedicated/ovh-rescue/) to connect to your server and mount your partitions.
...
Switch the boot mode back to "normal" and restart the server in your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au). Refer to the [rescue mode guide](https://docs.ovh.com/au/en/dedicated/ovh-rescue/) if necessary.

You have now access to the server with your new SSH key pair.

## Go further

[Changing the root password on a dedicated server](https://docs.ovh.com/au/en/dedicated/root-password/)
