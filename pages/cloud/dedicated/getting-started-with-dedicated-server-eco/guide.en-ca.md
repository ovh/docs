...
- A [dedicated server](https://www.ovhcloud.com/en-ca/bare-metal/) of the ranges Kimsufi, So You Start or Rise in your OVHcloud account
...
> [!primary]
>
> Please note that [additional IP addresses](https://www.ovhcloud.com/en-ca/bare-metal/ip/) are not compatible with the **Kimsufi** range.
>
