...
**This guide will show you how to configure private networking between a [Public Cloud instance](https://docs.ovh.com/ca/en/public-cloud/public-cloud-first-steps/#create-instance/) and a [Dedicated Server](https://www.ovhcloud.com/en-ca/bare-metal/).**
...
You can attach an existing instance to a private network. For more information, please refer to [this section](https://docs.ovh.com/ca/en/public-cloud/public-cloud-vrack/#cases-of-an-already-existing-instance) of the corresponding guide.
...
Next, configure the network interfaces on your new [Public Cloud instance](https://www.ovh.com/ca/en/public-cloud/instances/) and [Dedicated Server](https://www.ovhcloud.com/en-ca/bare-metal/) using this guide: [Configuring the vRack on your Dedicated Servers](https://docs.ovh.com/ca/en/dedicated/configuring-vrack-on-dedicated-servers/).
