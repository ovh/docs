...
<ol start="2">
  <li>By <a href="https://docs.ovh.com/us/en/public-cloud/public-cloud-vrack/#instructions_1">creating or adding an existing vRack service</a> in the Public Cloud section.</li>
</ol>
...
You can attach an existing instance to a private network. For more information, please refer to [this section](https://docs.ovh.com/us/en/public-cloud/public-cloud-vrack/#cases-of-an-already-existing-instance) of the corresponding guide.
...
Next, configure the network interfaces on your new [Public Cloud instance](https://docs.ovh.com/us/en/public-cloud/public-cloud-first-steps/#create-instance) and [Dedicated Server](https://www.ovhcloud.com/en/bare-metal/) using this guide: [Configuring the vRack on your Dedicated Servers](https://docs.ovh.com/us/en/dedicated/configuring-vrack-on-dedicated-servers/).
