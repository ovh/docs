...
<ol start="2">
  <li>By [creating or adding an existing vRack service](https://docs.ovh.com/gb/en/public-cloud/public-cloud-vrack/#instructions_1) in the `Public Cloud`{.action} section.
</ol>
