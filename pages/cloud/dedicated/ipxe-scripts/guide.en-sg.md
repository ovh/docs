...
In the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg), it is possible to specify a boot mode among a predefined list: mainly disk or rescue.<br>
...
You can now switch back to disk or rescue boot from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg) (see our guide on [Activating and using rescue mode](/pages/cloud/dedicated/rescue_mode)), or the [OVHcloud API](https://ca.api.ovh.com/).
