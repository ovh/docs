...
In the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au), it is possible to specify a boot mode among a predefined list: primary disk or rescue.<br>
...
- A [dedicated server](https://www.ovhcloud.com/en-au/bare-metal/) **ready to be booted/rebooted** in your OVHcloud account.
...
You can now switch back to disk or rescue boot from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au) (see our guide on [Activating and using rescue mode](/pages/cloud/dedicated/rescue_mode)), or the [OVHcloud API](https://ca.api.ovh.com/).
