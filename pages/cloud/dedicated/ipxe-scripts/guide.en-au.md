...
In the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au), it is possible to specify a boot mode among a predefined list: mainly disk or rescue.<br>
