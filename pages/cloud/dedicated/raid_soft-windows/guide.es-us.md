...
En este ejemplo, el `Disk 1` es un disco sustitutivo que se ha instalado para sustituir el `Disk M0` defectuoso que había sido [físicamente retirado](https://docs.ovh.com/us/es/dedicated/sustitucion-disco/) anteriormente.
