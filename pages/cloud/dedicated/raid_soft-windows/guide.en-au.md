...
- A Windows [dedicated server](https://www.ovhcloud.com/en-au/bare-metal/) with a software mirror
...
In this example, `Disk 1` is a replacement drive that has been installed in order to replace the defective `Disk M0` which had been [physically removed](https://docs.ovh.com/au/en/dedicated/disk-replacement/) previously.
