...
Get a private infrastructure without having to change the default configuration for your [OVHcloud dedicated servers](https://www.ovhcloud.com/en-ie/bare-metal/).
...
With [OVHcloud dedicated servers](https://www.ovhcloud.com/en-ie/bare-metal/), you can configure/declare your own networks.<br>
...
We will present the case of [dedicated server(s)](https://www.ovhcloud.com/en-ie/bare-metal/) configured in **OLA** mode, i.e. with **only** private networks.
...
- At least one [dedicated server](https://www.ovhcloud.com/en-ie/bare-metal/) with an operating system **already installed**.
...
- You must have all of the network interfaces for this server in **private** mode, which implies that you have already configured [our OLA feature](/pages/cloud/dedicated/pxe-with-full-private-dedicatedpages/cloud/dedicated/ola-enable-manager/).<br>

>
> To check that your machine is eligible for our procedure, log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie) and click on the `Bare Metal Cloud`{.action} tab.
>
