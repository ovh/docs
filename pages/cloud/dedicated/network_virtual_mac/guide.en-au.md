...
- A [dedicated server](https://www.ovhcloud.com/en-au/bare-metal/) that supports [virtual MACs](/pages/cloud/dedicated/network_support_virtual_mac)
...
- Your server must support virtual MACs. To determine this, consult [this guide](/pages/cloud/dedicated/network_support_virtual_mac).
