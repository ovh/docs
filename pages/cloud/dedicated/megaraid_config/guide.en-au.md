...
- a [dedicated server](https://www.ovh.com.au/dedicated_servers/){.external} with hardware RAID
...
In the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au){.external}, click on the `Bare Metal Cloud`{.action} menu and select your server.
...
Click the `Restart`{.action} button in the [Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au){.external}.
