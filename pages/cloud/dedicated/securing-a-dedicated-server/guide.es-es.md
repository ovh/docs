...
Le recomendamos que cree y adapte las reglas del firewall en función de su uso. Para más información sobre la configuración de iptables, consulte [nuestra guía](https://docs.ovh.com/es/dedicated/firewall-iptables/) y la documentación oficial de su distribución Linux.
