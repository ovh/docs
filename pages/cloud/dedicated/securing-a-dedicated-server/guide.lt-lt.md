...
We also have a guide to configuring the Network Firewall: <https://docs.ovh.com/lt/dedicated/firewall-network/>.
...
For more information on our backup storage solutions, please see our [backup storage guide](https://docs.ovh.com/lt/dedicated/services-backup-storage/){.external}.
