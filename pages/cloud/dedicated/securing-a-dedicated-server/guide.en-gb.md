...
>
> If you are configuring your first OVHcloud dedicated server, we recommend to consult our guide on [getting started with a dedicated server](https://docs.ovh.com/gb/en/dedicated/getting-started-dedicated-server/) before continuing.
>
...
It is strongly recommended that you modify the password of the root user as to not leave it at default value on a new system. Please refer to the information in [this guide](https://docs.ovh.com/gb/en/dedicated/root-password/) for details.
...
You can learn more about iptables in our [Firewall guide](https://docs.ovh.com/gb/en/dedicated/firewall-iptables/).
...
Please refer to the [Network Firewall guide](https://docs.ovh.com/gb/en/dedicated/firewall-network/) if you would like to activate it.
