...
It is recommended that you create and adjust the rules on this firewall to fit your needs. For more detailed information on how to configure the iptables, please refer to [our guide](https://docs.ovh.com/asia/en/dedicated/firewall-iptables/) and the official documentation of your Linux distribution.
