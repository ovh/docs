...
The standard [vRack configuration](https://docs.ovh.com/ca/en/dedicated/configuring-vrack-on-dedicated-servers/){.external} enables you to create only one vLAN. This means that you can only use each IP address once. However, with the vRack version 2.0 configuration, you can create up to 4,000 vLANs within a single vRack. This means that you can use each IP address up to 4,000 times.
...
* You must have completed the [vRack configuration guide](https://docs.ovh.com/ca/en/dedicated/configuring-vrack-on-dedicated-servers/){.external}.
