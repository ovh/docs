...
[Créer plusieurs réseaux locaux virtuels dans un vRack](https://docs.ovh.com/fr/dedicated/creer-vlans-vrack/){.external}

[Configurer un vRack entre une instance Public Cloud et un serveur dédié](https://docs.ovh.com/fr/configurer-vrack-entre-pci-serveur-dedie/){.external}
