...
As well as private IP addressing, the [vRack](https://www.ovh.lt/sprendimai/vrack/){.external} also allows you to route public IP traffic through your server's [vRack](https://www.ovh.lt/sprendimai/vrack/){.external} port using a public IP address block.
...
* a [vRack compatible server](https://www.ovh.lt/dedikuoti_serveriai/){.external}
* a [vRack](https://www.ovh.lt/sprendimai/vrack/){.external} service activated in your account
...
[Creating multiple vLANs in a vRack](https://docs.ovh.com/lt/dedicated/multiple-vlans/){.external}

[Configuring the vRack between the Public Cloud and a Dedicated Server](https://docs.ovh.com/lt/dedicated/vrack-pci-ds/){.external}
