...
- You must have a dedicated server ([Dedicated server](https://www.ovh.com/sg/dedicated-servers/){.external},[VPS](https://www.ovh.com/sg/vps/){.external} or [instance Cloud Public](https://www.ovh.com/sg/public-cloud/instances/){.external}).
- You must have one or more [failover IPs](https://www.ovh.com/sg/dedicated-servers/ip_failover.xml){.external}.
