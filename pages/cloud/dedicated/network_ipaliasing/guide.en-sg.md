...
IP aliasing is a special network configuration for your OVHcloud Dedicated Server, which allows you to associate multiple IP addresses with a single network interface.
