...
- You must have a dedicated server ([Dedicated server](https://www.ovh.com/ca/en/dedicated-servers/){.external},[VPS](https://www.ovh.com/ca/en/vps/){.external} or [instance Cloud Public](https://www.ovh.com/ca/en/public-cloud/instances/){.external}).
- You must have one or more [failover IPs](https://www.ovh.com/ca/en/dedicated-servers/ip_failover.xml){.external}.
