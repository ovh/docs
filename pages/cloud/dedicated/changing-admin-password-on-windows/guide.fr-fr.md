...
Commencez par remplacer le netboot par **Booter sur le disque dur** dans l'[espace client OVHcloud](https://www.ovh.com/auth/?action=gotomanager) (voir [Etape 1](./#etape-1-redemarrer-le-serveur-en-mode-rescue_1)). 
...
Dans l'[espace client OVHcloud](https://www.ovh.com/auth/?action=gotomanager), accédez à l'onglet `IPMI`{.action} pour ouvrir une session KVM.
