...
Log into your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we). Switch to the `Bare Metal Cloud`{.action} section and select the server from **Dedicated Servers** in the left-hand sidebar. On the `Backup storage`{.action} tab, click the `Enable backup storage`{.action} button.
...
Log into your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we). Switch to the `Bare Metal Cloud`{.action} section and select the server from **Dedicated Servers** in the left-hand sidebar. On the `Backup storage`{.action} tab, click on the button `Add an access`{.action}.
...
Log into your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we). Switch to the `Bare Metal Cloud`{.action} section and select the server from **Dedicated Servers** in the left-hand sidebar. On the `Backup storage`{.action} tab, click on the button `Forgotten your password?`{.action}.
...
Log into your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we). Switch to the `Bare Metal Cloud`{.action} section and select the server from **Dedicated Servers** in the left-hand sidebar. On the `Backup storage`{.action} tab, click on the button `Delete backup storage`{.action}.
...
Log into your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we). Switch to the `Bare Metal Cloud`{.action} section and select the server from **Dedicated Servers** in the left-hand sidebar. On the `Backup storage`{.action} tab, click on the button `Order disk space`{.action}.
