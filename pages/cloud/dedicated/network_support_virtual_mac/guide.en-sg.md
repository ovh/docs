...
> [!primary]
> If you are not familiar with using the OVHcloud API, please refer to our guide on [Getting started with the OVHcloud API](https://docs.ovh.com/sg/en/api/first-steps-with-ovh-api/) .
...
[First Steps with the OVHcloud API](https://docs.ovh.com/sg/en/api/first-steps-with-ovh-api/)
