...
> [!primary]
> Si vous n'êtes pas familier avec l'utilisation de l'API OVHcloud, consultez notre guide « [Premiers pas avec les API OVHcloud](https://docs.ovh.com/ca/fr/api/api-premiers-pas/)».
...
[Premiers pas avec les API OVHcloud](https://docs.ovh.com/ca/fr/api/api-premiers-pas/)
