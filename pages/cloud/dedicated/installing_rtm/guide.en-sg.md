...
> [!primary]
>
> Some firewall restrictions could prevent your infrastructure from being monitored, even though you have added the RTM. Don’t forget to give OVH monitoring IP addresses access to your server. You can find more details [here](https://docs.ovh.com/sg/en/dedicated/monitoring-ip-ovh/){.external}.
> 
...
[IP addresses for OVH monitoring](https://docs.ovh.com/sg/en/dedicated/monitoring-ip-ovh/){.external}
