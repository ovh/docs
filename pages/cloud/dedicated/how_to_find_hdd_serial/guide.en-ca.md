...
For an in-depth look of these commands and how to test your hard disks, refer to [this guide (LSI raid controller)](https://docs.ovh.com/ca/en/dedicated/raid-hard/){.external}.
...
You can refer to [this guide (LSI raid controller)](https://docs.ovh.com/ca/en/dedicated/raid-hard/){.external} to find which hard drive relates to a designated sg device.
