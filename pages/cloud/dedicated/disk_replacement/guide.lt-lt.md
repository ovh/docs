...
- You must be connected via SSH to your [OVH Dedicated Server](https://www.ovh.lt/dedikuoti_serveriai/){.external}, with *root access* (Linux).
...
If you have an NVMe disk, you will need to put the server into [rescue mode](https://docs.ovh.com/lt/dedicated/ovh-rescue/){.external}, on which the **nvme-cli** tool is installed by default.
...
> [!primary]
>
> This replacement type is only possible for [FS-MAX](https://www.ovh.lt/dedikuoti_serveriai/fs/1801fs05.xml){.external} and [Big-HG](https://www.ovh.lt/dedikuoti_serveriai/hg/1801bhg01.xml){.external} servers that have a RAID card.
> 
