...
Dans le cas d'un disque NVMe, il sera nécessaire de placer le serveur en mode [« Rescue-pro »](../ovh-rescue/){.external} sur lequel l'outil **nvme-cli** est installé par défaut.
