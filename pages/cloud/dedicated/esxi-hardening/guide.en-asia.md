...
>
> To do this, you will need to [reboot](https://docs.ovh.com/asia/en/dedicated/getting-started-dedicated-server/#restarting-your-dedicated-server) your ESXi server via the OVHcloud Control Panel.
> 
