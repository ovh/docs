...
>
> You can find more information on this attack in [an additional FAQ](https://docs.ovh.com/sg/en/dedicated/esxi-faq/).
>
...
- An offer compatible with our [Network Firewall](https://docs.ovh.com/sg/en/dedicated/firewall-network/) feature, if you would like to use it for filtering
...
>
> To do this, you will need to [reboot](https://docs.ovh.com/sg/en/dedicated/getting-started-dedicated-server/#restarting-your-dedicated-server_1) your ESXi server via the OVHcloud Control Panel.
> 
...
You can enable and use our [Network Firewall](https://docs.ovh.com/sg/en/dedicated/firewall-network/) filtering solution.
