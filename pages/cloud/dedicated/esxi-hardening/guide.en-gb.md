...
>
> To do this, you will need to [reboot](https://docs.ovh.com/gb/en/dedicated/getting-started-dedicated-server/#restarting-your-dedicated-server) your ESXi server via the OVHcloud Control Panel.
> 
...
You can enable and use our [Network Firewall](https://docs.ovh.com/gb/en/dedicated/firewall-network/) filtering solution.
