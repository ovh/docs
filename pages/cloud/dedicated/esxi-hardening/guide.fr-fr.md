...
>
> Pour cela, il vous sera nécessaire de [redémarrer](/pages/cloud/dedicated/getting-started-with-dedicated-server#redemarrage-de-votre-serveur-dedie_1) votre serveur ESXi à travers l'espace client OVHcloud.
> 
