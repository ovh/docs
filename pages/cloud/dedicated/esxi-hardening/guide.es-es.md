...
>
> Para ello, deberá [reiniciar](https://docs.ovh.com/es/dedicated/primeros-pasos-servidor-dedicado/#reinicio-del-servidor-dedicado) el servidor ESXi desde el área de cliente de OVHcloud.
> 
...
Le ofrecemos activar y utilizar nuestra solución de filtrado [Network Firewall](https://docs.ovh.com/es/dedicated/firewall-de-red/).
