...
Connectez-vous à[ l’espace client OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr){.external} et accédez à la section `Bare Metal Cloud`{.action}, accédez à la section `Bare Metal Cloud`{.action} et cliquer sur `IP`{.action}.
