...
> [!primary]
>
> You can read more information on our Anti-DDoS solution here: <https://www.ovh.com/world/anti-ddos/>.
> 
...
- You must have an OVHcloud service with a Network Firewall ([Dedicated Server](https://www.ovh.com/world/dedicated-servers/){.external}, [VPS](https://www.ovh.com/world/vps/){.external}, [Public Cloud instance](https://www.ovh.com/world/public-cloud/instances/){.external}, [Hosted Private Cloud](https://www.ovh.com/world/private-cloud/){.external},  [Additional IP](https://www.ovhcloud.com/en/bare-metal/ip/){.external}, etc.)
- You must have access to your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we){.external}
...
> For more information, please refer to the following guides: [Configure the firewall on Windows](https://docs.ovh.com/us/en/dedicated/firewall-windows/) and [Configuring the firewall on Linux with iptables](https://docs.ovh.com/us/en/dedicated/firewall-iptables/).
>
