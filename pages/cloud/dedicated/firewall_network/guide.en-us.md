...
> For more information, please refer to the following guides: [Configuring the firewall on Windows](https://docs.ovh.com/us/en/dedicated/firewall-windows/) and [Configuring the firewall on Linux with iptables](https://docs.ovh.com/us/en/dedicated/firewall-iptables/).
>
