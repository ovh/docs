...
> [!primary]
>
> You can read more information on our Anti-DDoS solution here: <https://www.ovhcloud.com/en-ca/security/anti-ddos/>.
> 
...
- An OVHcloud service with a Network Firewall ([Dedicated Server](https://www.ovhcloud.com/en-ca/bare-metal/){.external}, [VPS](https://www.ovhcloud.com/en-ca/vps/){.external}, [Public Cloud instance](https://www.ovhcloud.com/en-ca/public-cloud/){.external}, [Hosted Private Cloud](https://www.ovhcloud.com/en-ca/enterprise/products/hosted-private-cloud/){.external}, [Additional IP](https://www.ovhcloud.com/en-ca/network/additional-ip/){.external}, etc.)
...
> For more information, please refer to the following guides: [Configuring the firewall on Windows](https://docs.ovh.com/ca/en/dedicated/firewall-windows/) and [Configuring the firewall on Linux with iptables](https://docs.ovh.com/ca/en/dedicated/firewall-iptables/).
>
