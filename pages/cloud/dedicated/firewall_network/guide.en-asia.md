...
- You must have an OVHcloud service with a Network Firewall ([Dedicated Server](https://www.ovh.com/asia/dedicated-servers/){.external}, [VPS](https://www.ovh.com/asia/vps/){.external}, [Public Cloud instance](https://www.ovh.com/asia/public-cloud/instances/){.external}, [Private Cloud](https://www.ovh.com/asia/private-cloud/){.external},  [Failover IP](https://www.ovh.com/asia/dedicated-servers/ip_failover.xml){.external}, etc.)
