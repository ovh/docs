...
- You must have an OVH service with a Firewall Network ([Dedicated Server](https://www.ovh.com/asia/dedicated-servers/){.external}, [VPS](https://www.ovh.com/asia/vps/){.external}, [Public Cloud instance](https://www.ovh.com/asia/public-cloud/instances/){.external}, [Private Cloud](https://www.ovh.com/asia/private-cloud/){.external},  [Failover IP](https://www.ovh.com/asia/dedicated-servers/ip_failover.xml){.external}, etc.)
