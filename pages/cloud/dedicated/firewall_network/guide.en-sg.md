...
> [!warning]
> Please note that the OVHcloud Firewall Network cannot be used to open ports on a server. To open ports on a server, you must go through the firewall of the operating system installed on the server. 
