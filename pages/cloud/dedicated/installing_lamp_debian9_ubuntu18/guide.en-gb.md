...
- a server or a virtual machine with a Linux distribution (a [VPS](https://www.ovh.co.uk/vps/){.external}, a [Dedicated Server](https://www.ovhcloud.com/en-gb/bare-metal/){.external} or [OVH Public Cloud instance](https://www.ovhcloud.com/en-gb/public-cloud/){.external})
...
> 
> We have published this guide to assist you as much as we can with common tasks. However, we recommend contacting a [specialist service provider](https://partner.ovhcloud.com/en-gb/directory/) if you experience any difficulties or have any doubts about managing, using and securing a server. You can find more information in the “Go further” section of this guide.
>
