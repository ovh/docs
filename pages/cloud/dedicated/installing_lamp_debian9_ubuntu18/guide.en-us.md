...
- a server or a virtual machine with a Linux distribution (a [VPS](https://www.ovhcloud.com/en/vps/){.external}, a [Dedicated Server](https://www.ovhcloud.com/en/bare-metal/){.external} or [OVHcloud Public Cloud instance](https://www.ovhcloud.com/en/public-cloud/){.external})
...
> 
> We have published this guide to assist you as much as we can with common tasks. However, we recommend contacting a [specialist service provider](https://partner.ovhcloud.com/en/directory/) if you experience any difficulties or have any doubts about managing, using and securing a server. You can find more information in the “Go further” section of this guide.
>
