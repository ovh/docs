...
- a server or a virtual machine with a Linux distribution (a [VPS](https://www.ovh.com.au/vps/){.external}, a [Dedicated Server](https://www.ovh.com.au/dedicated-servers/all_servers.xml){.external} or [OVHcloud Public Cloud instance](https://www.ovh.com.au/public-cloud/instances/prices/){.external})
