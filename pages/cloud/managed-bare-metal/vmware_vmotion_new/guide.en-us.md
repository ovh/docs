...
The option "Change storage only" allows to migrate the VM to another datastore. It is explained in [this guide](/pages/cloud/managed-bare-metal/vmware_storage_vmotion).
