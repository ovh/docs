...
routes:
    canonical: 'https://docs.ovh.com/es/private-cloud/asociar-direccion-correo-electronico-a-usuario-vsphere/'
...
Conéctese al [área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager) y acceda a la sección `Servidores`. En la barra de servicios de la izquierda, haga clic en `Managed Bare Metal` y seleccione la infraestructura correspondiente.
