...
Conéctese al [área de cliente de OVHcloud](https://ca.ovh.com/auth/?action=gotomanager) y acceda a la sección `Servidores`. En la barra de servicios de la izquierda, haga clic en `Managed Bare Metal` y seleccione la infraestructura correspondiente.
