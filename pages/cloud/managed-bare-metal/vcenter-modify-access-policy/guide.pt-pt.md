...
Aceda à sua [Área de Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager), vá à secção `Bare Metal Cloud`{.action} e selecione o seu serviço em `Managed Bare Metal`{.action} no menu à esquerda.
