...
Connectez-vous à votre [espace client OVHcloud](https://www.ovh.com/auth/?action=gotomanager), dirigez-vous dans la section`Bare Metal Cloud`{.action}, puis sélectionnez votre service sous `Managed Bare Metal`{.action} dans la barre de navigation de gauche.
