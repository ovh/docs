...
routes:
    canonical: 'https://docs.ovh.com/au/en/private-cloud/applying-ovh-template/'
...
- [active Windows licences](../control-panel-ovhcloud/#windows-licence-tab) (activate via the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au){.external}, in the `Windows licence`{.action} tab for the datacentre)
