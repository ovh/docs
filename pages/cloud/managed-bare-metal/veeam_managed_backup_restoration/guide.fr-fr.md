...
routes:
    canonical: 'https://docs.ovh.com/fr/private-cloud/veeam-backup-restoration/'
...
- [Veeam Managed Backup activé](../veeam-backup-as-a-service) sur votre offre Managed Bare Metal
