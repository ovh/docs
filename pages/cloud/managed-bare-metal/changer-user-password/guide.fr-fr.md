...
routes:
    canonical: 'https://docs.ovh.com/fr/private-cloud/changement-du-mot-de-passe-utilisateur/'
...
- Disposer d'un compte utilisateur créé depuis l'espace client OVHcloud.

## En pratique

### Modifier le mot de passe

Connectez-vous à votre [espace client OVHcloud](https://www.ovh.com/auth/?action=gotomanager){.external}, accédez à la section `Bare Metal Cloud`{.action} (1), cliquez sur `Managed Bare Metal`{.action} (2) et sélectionnez votre serveur dans la liste (3). Cliquez alors sur l'onglet `Utilisateurs`{.action} (4).
