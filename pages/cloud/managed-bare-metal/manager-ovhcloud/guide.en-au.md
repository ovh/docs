...
routes:
    canonical: 'https://docs.ovh.com/au/en/private-cloud/control-panel-ovh-private-cloud/'
...
You can find more information on the [pricing page](https://www.ovhcloud.com/en-au/managed-bare-metal/images-licenses/).
