...
Quando [a política de acesso ao vCenter é limitada](/pages/cloud/managed-bare-metal/vcenter-modify-access-policy), é necessário adicionar os IP que serão autorizados a ligar-se ao serviço.
