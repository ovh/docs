...
routes:
    canonical: 'https://docs.ovh.com/us/es/private-cloud/conexion_en_sftp/'
...
- Haber creado una cuenta de usuario desde el [área de cliente de OVHcloud](https://ca.ovh.com/auth/?action=gotomanager){.external}.
