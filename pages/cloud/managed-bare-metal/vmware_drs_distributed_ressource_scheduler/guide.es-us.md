...
La cuarta regla, «máquinas virtuales a máquinas virtuales», viene explicada en nuestra guía sobre la [funcionalidad HA](/pages/cloud/managed-bare-metal/vmware_ha_high_availability).
