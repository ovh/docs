...
Die vierte Regel, “Virtuelle Maschinen zu virtuelle Maschinen”, wird in unserer Anleitung zur [HA-Funktion](/pages/cloud/managed-bare-metal/vmware_ha_high_availability) erklärt (Englisch).
