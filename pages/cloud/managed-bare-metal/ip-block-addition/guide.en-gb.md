...
slug: add-ip-block
routes:
    canonical: 'https://docs.ovh.com/gb/en/private-cloud/add-ip-block/'
...
> [!primary]
>
> Please feel free to refer to our guide on the [OVHcloud Network plugin](../plugin-ovhcloud-network/){.external-link} to find out which IPs are reserved for your block, as well as how they are used.
>
...
You can track the movement of your IP block via the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager){.external} in the `Bare Metal Cloud`{.action} section, then `Managed Bare Metal`{.action}. Click on your Managed Bare Metal service, then on the `Operations`{.action} tab.
