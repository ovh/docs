...
routes:
    canonical: 'https://docs.ovh.com/es/private-cloud/anadir-bloque-ip/'
...
Podrá seguir la migración del bloque de IP desde su [área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager) en el menú `Bare Metal Cloud`{.action} > `Managed Bare Metal`{.action}. Haga clic en su servicio y, a continuación, en la pestaña `Operaciones`{.action}.
