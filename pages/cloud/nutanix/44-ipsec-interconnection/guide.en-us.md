...
- Being familiar with uses for an IPsec VPN using the [Nutanix Disaster Recovery Plan guide](https://docs.ovh.com/us/en/nutanix/disaster-recovery-plan-overview/)
...
Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we), select your Nutanix cluster, and find the information in the `FOIP` field.
...
[Asynchronous or *NearSync* replication through Prism Element](https://docs.ovh.com/us/en/nutanix/prism-element-nutanix-replication/)
