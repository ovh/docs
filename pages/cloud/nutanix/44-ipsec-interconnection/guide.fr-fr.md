...
Saisissez le mot de passe deux fois dans `Password` pour le confirmez. Faite défiler la barre de défilement jusqu'en bas de la fenêtre.
...
* **Réseau privé France** : 192.168.0.0/24
