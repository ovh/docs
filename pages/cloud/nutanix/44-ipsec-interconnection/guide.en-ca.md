...
- Being familiar with uses for an IPsec VPN using the [Nutanix Disaster Recovery Plan guide](https://docs.ovh.com/ca/en/nutanix/disaster-recovery-plan-overview/)
...
Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca), select your Nutanix cluster, and find the information in the `FOIP` field.
...
[Disaster Recovery Plan on Nutanix](https://docs.ovh.com/ca/en/nutanix/disaster-recovery-plan-overview/)
