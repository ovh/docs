...
- Being familiar with uses for an IPsec VPN using the [Nutanix Disaster Recovery Plan guide](https://docs.ovh.com/es/nutanix/disaster-recovery-plan-overview/)
...
Using [this documentation](https://docs.ovh.com/es/nutanix/image-import/), add the **pfSense ISO** image to your Nutanix cluster.
...
You can use [our guide on virtual machine management](https://docs.ovh.com/es/nutanix/virtual-machine-management/) to create this virtual machine.
