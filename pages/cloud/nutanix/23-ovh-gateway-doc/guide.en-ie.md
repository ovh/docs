...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie)  and access your [vRack](https://www.ovh.ie/solutions/vrack/){.external} management. Check the failover IP address used by the Nutanix cluster.
