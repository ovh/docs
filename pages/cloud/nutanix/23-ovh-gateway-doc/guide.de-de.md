...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de) and open the management section of your [vRack](https://www.ovh.de/loesungen/vrack/){.external}. Verify the Additional IP address used by the Nutanix Cluster.
...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de)  and access your [vRack](https://www.ovh.de/loesungen/vrack/){.external} management. Check the Additional IP address used by the Nutanix cluster.
...
When using the [vRack](https://www.ovh.de/loesungen/vrack/){.external}, the first, penultimate, and last addresses in a given IP block are always reserved for the network address, network gateway, and network broadcast respectively. This means that the first usable address is the second address in the block, as shown below:
