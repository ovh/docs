...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl) and open the management section of your [vRack](https://www.ovh.pl/rozwiazania/vrack/){.external}. Verify the failover IP address used by the Nutanix Cluster.
...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl)  and access your [vRack](https://www.ovh.pl/rozwiazania/vrack/){.external} management. Check the failover IP address used by the Nutanix cluster.
