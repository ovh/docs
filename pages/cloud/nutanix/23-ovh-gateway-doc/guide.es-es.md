...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es)  and access your [vRack](https://www.ovh.es/soluciones/vrack/){.external} management. Check the failover IP address used by the Nutanix cluster.
