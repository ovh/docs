...
- **Veeam Backup & Replication** installed on a virtual machine in your Nutanix cluster via this procedure: [Setting up Veeam Backup & Replication](https://docs.ovh.com/de/storage/veeam-backup-replication/).
...
[OVHcloud storage solutions](https://docs.ovh.com/de/storage/)
