...
- [vRack](https://www.ovh.ie/solutions/vrack/)
- [Load Balancer](https://www.ovh.ie/solutions/load-balancer/)
...
You can replace this virtual machine with another network operating system by following this guide [Replace OVHgateway](https://docs.ovh.com/ie/en/nutanix/software-gateway-replacement/).
