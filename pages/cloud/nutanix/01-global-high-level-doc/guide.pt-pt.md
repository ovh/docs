---
title: Documentação geral sobre Nutanix on OVHcloud (EN)
...
- [vRack](https://www.ovh.pt/solucoes/vrack/)
- [Load Balancer](https://www.ovh.pt/solucoes/load-balancer/)
...
To replace this virtual machine with another network operating system, please read this guide: [Replace OVHgateway](https://docs.ovh.com/pt/nutanix/software-gateway-replacement/).
