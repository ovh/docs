---
title: Documentação geral sobre Nutanix (EN)
...
You can replace this virtual machine with another network operating system by following this guide [Replace OVHgateway](https://docs.ovh.com/pt/nutanix/software-gateway-replacement/).
