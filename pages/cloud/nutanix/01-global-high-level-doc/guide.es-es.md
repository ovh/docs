...
- [vRack](https://www.ovh.es/soluciones/vrack/)
- [Load Balancer](https://www.ovh.es/soluciones/load-balancer/)
...
You can replace this virtual machine with another network operating system by following this guide [Replace OVHgateway](https://docs.ovh.com/es/nutanix/software-gateway-replacement/).
