...
- [vRack](https://www.ovh.pl/rozwiazania/vrack/)
- [Load Balancer](https://www.ovh.pl/rozwiazania/load-balancer/)
...
You can replace this virtual machine with another network operating system by following this guide [Replace OVHgateway](https://docs.ovh.com/pl/nutanix/software-gateway-replacement/).
