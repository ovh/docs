...
You can replace this virtual machine with another network operating system by following this guide [Replace OVHgateway](https://docs.ovh.com/ca/en/nutanix/software-gateway-replacement/).
