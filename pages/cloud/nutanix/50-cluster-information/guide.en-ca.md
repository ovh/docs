...
> [!primary]
> Use the [Plik tool](https://ca.plik.ovh/#/) to upload your report and send it to us as a download link. You can find more information on using the Plik tool in [this guide](https://docs.ovh.com/ca/en/customer/plik/).
>
...
> [!primary]
> Use the [Plik tool](https://ca.plik.ovh/#/) tool to upload your .zip files and send them to us as download links. You can find more information on using the Plik tool in [this guide](https://docs.ovh.com/ca/en/customer/plik/).
>
