...
If you need help setting up an IPsec VPN, please refer to our guide on [interconnecting two Nutanix clusters through an IPsec VPN](https://docs.ovh.com/de/nutanix/ipsec-interconnection/).

Connect via **Prism Element** to the cluster in France from **Prism Central**, as shown in this documentation: [Nutanix Hyperconvergence](https://docs.ovh.com/de/nutanix/nutanix-hci/).
...
[Disaster Recovery Plan in Nutanix](https://docs.ovh.com/de/nutanix/disaster-recovery-plan-overview/)

[IPsec interconnection between two sites](https://docs.ovh.com/de/nutanix/ipsec-interconnection/)
