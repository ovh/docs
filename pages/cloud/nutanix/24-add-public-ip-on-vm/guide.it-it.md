...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it) and add a failover IP address to your [vRack](https://www.ovh.it/soluzioni/vrack/){.external}.
