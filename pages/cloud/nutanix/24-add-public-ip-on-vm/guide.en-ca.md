...
Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca) and add a failover IP address to your [vRack](https://www.ovh.com/ca/en/solutions/vrack/){.external}.
