...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pt/&ovhSubsidiary=pt) and add a failover IP address to your [vRack](https://www.ovh.pt/solucoes/vrack/){.external}.
