...
Vous pouvez vous aider de ce guide pour gérer vos licences : [Gestion des licences dans votre cluster Nutanix on OVHcloud BYOL][Gestion des licences dans votre cluster Nutanix on OVHcloud BYOL Offer](/pages/cloud/nutanix/12-activate-licenses-on-byol).<br>
