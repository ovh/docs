...
[Using the OVHcloud API](https://docs.ovh.com/de/api/).

[Manage licences in your Nutanix cluster on OVHcloud BYOL Offer](https://docs.ovh.com/de/nutanix/activate-licence-on-nutanix-byol/).
