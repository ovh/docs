...
Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg) and open the management section of your [vRack](https://www.ovh.com/sg/solutions/vrack/){.external}. Verify the failover IP address used by the Nutanix Cluster.
