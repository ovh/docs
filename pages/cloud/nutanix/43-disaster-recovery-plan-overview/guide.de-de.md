...
An example of an IPsec interconnection in this guide: [IPsec interconnection between two sites](https://docs.ovh.com/de/nutanix/ipsec-interconnection/)
...
Details of these solutions can be found in our documentation on [asynchronous or NearSync replication through Prism Element](https://docs.ovh.com/de/nutanix/prism-element-nutanix-replication/)
