...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie) and add a failover IP address to your [vRack](https://www.ovh.ie/solutions/vrack/){.external}.
