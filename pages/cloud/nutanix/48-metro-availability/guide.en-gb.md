...
- [advanced tools](https://docs.ovh.com/gb/en/nutanix/advanced-tools/)
...
Use this guide to connect your clusters: [Interconnect clusters through the vRack](https://docs.ovh.com/gb/en/nutanix/nutanix-vrack-interconnection/). To connect the three clusters, use the instructions provided in the guide:
...
Use this guide to create VLANs on your Nutanix clusters: [isolate production management machines](https://docs.ovh.com/gb/en/nutanix/nutanix-isolate-management-machines/).
...
[Interconnect clusters through the vRack](https://docs.ovh.com/gb/en/nutanix/nutanix-vrack-interconnection/)

[Disaster Recovery Plan for Nutanix](https://docs.ovh.com/gb/en/nutanix/disaster-recovery-plan-overview/)
...
[Advanced replication with Leap](https://docs.ovh.com/gb/en/nutanix/leap-replication/)
