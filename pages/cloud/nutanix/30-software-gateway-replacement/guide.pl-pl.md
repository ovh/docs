...
Use the [Isolating management machines from production](https://docs.ovh.com/pl/nutanix/nutanix-isolate-management-machines/) guide to create a new VLAN on your Nutanix cluster with these settings:
