...
- An interconnection between two clusters, for example using these technologies:
    - via an IPsec VPN as detailed in the guide [Interconnecting IPsec between two sites](https://docs.ovh.com/ie/en/nutanix/ipsec-interconnection/)
    - or via a [vRack](https://www.ovh.ie/solutions/vrack/) connection.
...
Using **Prism Central**, connect to **Prism Element** on the cluster in France. You can use the [Nutanix Hyperconvergence guide](https://docs.ovh.com/ie/en/nutanix/nutanix-hci/) for more information.
...
[IPsec interconnect between two sites](https://docs.ovh.com/ie/en/nutanix/ipsec-interconnection/)

[OVHcloud vRack](https://www.ovh.ie/solutions/vrack/)
