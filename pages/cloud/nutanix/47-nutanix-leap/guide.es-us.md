...
- An interconnection between two clusters, for example using these technologies:
    - via an IPsec VPN as detailed in the guide [Interconnecting IPsec between two sites](https://docs.ovh.com/us/es/nutanix/ipsec-interconnection/)
...
Using **Prism Central**, connect to **Prism Element** on the cluster in France. You can use the [Nutanix Hyperconvergence guide](https://docs.ovh.com/us/es/nutanix/nutanix-hci/) for more information.
...
[IPsec interconnect between two sites](https://docs.ovh.com/us/es/nutanix/ipsec-interconnection/)
