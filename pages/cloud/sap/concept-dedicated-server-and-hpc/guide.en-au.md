...
Instead of using OVHcloud Connect, a point-to-point VPN can also be deployed with NSX Edge. To learn how to configure an NSX Edge Gateway VPN with OVHcloud, please refer to [our documentation](https://docs.ovh.com/au/en/private-cloud/nsx-edge-gateway-vpn-configuration/).

A prerequisite for updating your servers and for SAP Support access is to configure an Additional IP. A public IP subnet will be used as outbound link on your NSX Edge. Find more information in the [Additional IP documentation](https://docs.ovh.com/au/en/publiccloud/network-services/buy-additional-ip/).

### SAP HANA database

The SAP HANA database is hosted on a dedicated server of the SAP HANA on Bare Metal server range (references HGR-SAP-1/2/3). To know how to deploy a SAP HANA database on an OVHcloud dedicated server, please refer to [our documentation](https://docs.ovh.com/au/en/sap/sap-installation-sap-hana-sles/).
...
To learn how to install a Veeam Enterprise Plus server in your VMware on OVHcloud solution, please refer to the [OVHcloud documentation](https://docs.ovh.com/au/en/storage/backup/veeam/veeam-backup-replication/).
...
To know how to enable this feature, please refer to the [OVHcloud documentation](https://docs.ovh.com/au/en/private-cloud/zerto-virtual-replication-vmware-vsphere-drp/).
...
- [Setting up Zerto Virtual Replication between two OVHcloud datacenters](https://docs.ovh.com/au/en/private-cloud/zerto-virtual-replication-vmware-vsphere-drp/)
- [Setting up Veeam Backup & Replication](https://docs.ovh.com/au/en/storage/backup/veeam/veeam-backup-replication/)
