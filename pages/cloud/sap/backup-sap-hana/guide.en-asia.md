...
For our backup needs, we will use the [OVHcloud Veeam Enterprise product](https://www.ovhcloud.com/asia/storage-solutions/veeam-enterprise/).

You can find the OVHcloud installation guide [here](https://docs.ovh.com/asia/en/storage/veeam-backup-replication/)
...
Therefore, we will use the [OVHcloud Object Storage product](https://www.ovhcloud.com/asia/public-cloud/object-storage/) to extend our previously created Scale-Out Backup Repository
...
<ol start="1">
  <li>Log in to the <a class="external-link" href="https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia" rel="nofollow">OVHcloud Control Panel</a>, go to the <code class="action">Public Cloud</code> section, select your project then click <code class="action">Object Storage</code> and finally click on <code class="action">Create an object container</code>.</li>
</ol>
