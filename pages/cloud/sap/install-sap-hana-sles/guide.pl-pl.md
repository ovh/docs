...
You can set a hostname which will be displayed with the command `hostname`. You have also the possibility to [add your SSH key](https://docs.ovh.com/pl/dedicated/pierwsze-kroki-z-serwerem-dedykowanym/#dodanie-klucza-ssh-opcjonalnie).
...
Once the SLES 15 for SAP installation is done, you can [connect to your dedicated server](https://docs.ovh.com/pl/dedicated/pierwsze-kroki-z-serwerem-dedykowanym/#polaczenie-z-serwerem_1).
