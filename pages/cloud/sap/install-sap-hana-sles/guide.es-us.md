...
You can set a hostname which will be displayed with the command `hostname`. You have also the possibility to [add your SSH key](https://docs.ovh.com/us/es/dedicated/primeros-pasos-servidor-dedicado/#anadir-una-llave-ssh-opcional).
...
Once the SLES 15 for SAP installation is done, you can [connect to your dedicated server](https://docs.ovh.com/us/es/dedicated/primeros-pasos-servidor-dedicado/#conexion-al-servidor_1).
...
[How to Configure Your NIC for OVHcloud Link Aggregation in SLES 15](https://docs.ovh.com/us/es/dedicated/ola-sles15/)
