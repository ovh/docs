...
Une fois l'installation de l'image SLES 15 for SAP réalisée, vous pouvez [vous connecter à votre serveur dédié](/pages/cloud/dedicated/getting-started-with-dedicated-server#connexion-a-votre-serveur_1).
