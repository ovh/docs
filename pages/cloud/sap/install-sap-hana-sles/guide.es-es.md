...
updated: 2023-03-20
routes:
    canonical: 'https://docs.ovh.com/gb/en/sap/sap-installation-sap-hana-sles/'
---
...
You can set a hostname which will be displayed with the command `hostname`. You have also the possibility to [add your SSH key](https://docs.ovh.com/es/dedicated/primeros-pasos-servidor-dedicado/#anadir-una-llave-ssh-opcional).
...
[How to Configure Your NIC for OVHcloud Link Aggregation in SLES 15](https://docs.ovh.com/es/dedicated/ola-sles15/)
