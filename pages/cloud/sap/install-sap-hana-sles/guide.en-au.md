...
You can set a hostname which will be displayed with the command `hostname`. You have also the possibility to [add your SSH key](https://docs.ovh.com/au/en/dedicated/getting-started-dedicated-server/#adding-an-ssh-key-optional).
...
Once the SLES 15 for SAP installation is done, you can [connect to your dedicated server](https://docs.ovh.com/au/en/dedicated/getting-started-dedicated-server/#logging-on-to-your-server_1).
