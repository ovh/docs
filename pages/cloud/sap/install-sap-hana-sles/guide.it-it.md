...
Once the SLES 15 for SAP installation is done, you can [connect to your dedicated server](https://docs.ovh.com/it/dedicated/iniziare-a-utilizzare-server-dedicato/#connessione-al-tuo-server).
