...
Once the SLES 15 for SAP installation is done, you can [connect to your dedicated server](https://docs.ovh.com/us/en/dedicated/getting-started-dedicated-server/#logging-on-to-your-server).
