...
You can set a hostname which will be displayed with the command `hostname`. You have also the possibility to [add your SSH key](https://docs.ovh.com/pt/dedicated/primeiros-passos-servidor-dedicado/#adicionar-uma-chave-ssh-facultativo).
...
Once the SLES 15 for SAP installation is done, you can [connect to your dedicated server](https://docs.ovh.com/pt/dedicated/primeiros-passos-servidor-dedicado/#ligacao-ao-seu-servidor_1).
...
[How to Configure Your NIC for OVHcloud Link Aggregation in SLES 15](https://docs.ovh.com/pt/dedicated/ola-sles15/)
