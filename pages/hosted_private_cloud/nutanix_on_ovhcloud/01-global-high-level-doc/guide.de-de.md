...
- [Dedicated server](/links/websitebare-metal/)
- [vRack](/links/websitenetwork/vrack/)
- [Load Balancer](/links/websitenetwork/load-balancer/)
- [Additional IP](/links/websitebare-metal/ip/)
...
This machine is only for you to download your first sources (Windows ISO, appliances, etc.). You will need to replace this virtual machine with another operating system. See this guide for more information: [Replace OVHgateway](/pages/hosted_private_cloud/nutanix_on_ovhcloud/30-software-gateway-replacement).
