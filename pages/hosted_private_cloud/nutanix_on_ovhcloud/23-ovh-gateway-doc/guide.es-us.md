...
Log in to the [OVHcloud Control Panel](/links/manager) and open the management section of your [vRack](https://www.ovhcloud.com/es/network/vrack/){.external}. Verify the Additional IP address used by the Nutanix Cluster.
