...
Connectez-vous à l'[espace client OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) et accédez à la gestion de votre [vRack](/links/websitenetwork/vrack/){.external}. Vérifiez l'adresse Additional IP utilisée par le cluster Nutanix.
