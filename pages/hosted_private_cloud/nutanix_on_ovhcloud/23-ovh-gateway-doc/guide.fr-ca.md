...
Connectez-vous à l'[espace client OVHcloud](/links/manager) et accédez à la gestion de votre [vRack](https://www.ovhcloud.com/fr-ca/network/vrack/){.external}. Vérifiez l'adresse Additional IP utilisée par le cluster Nutanix.
