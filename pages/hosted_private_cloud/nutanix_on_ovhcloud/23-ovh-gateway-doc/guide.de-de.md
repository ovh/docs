...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de) and open the management section of your [vRack](/links/websitenetwork/vrack/){.external}. Verify the Additional IP address used by the Nutanix Cluster.
