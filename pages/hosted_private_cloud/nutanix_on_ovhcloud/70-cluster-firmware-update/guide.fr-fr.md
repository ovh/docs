...
> [!warning]
> Avant d'entamer toute action, créez un ticket de demande d'assistance depuis votre [espace client OVHcloud](/links/manager) pour demander une mise à jour du firmware et communiquer aux équipes d'assistance OVHcloud les éléments techniques concernant votre cluster.
...
Dans l'espace client OVHcloud, après avoir sélectionné votre cluster, notez les nœuds listés.
