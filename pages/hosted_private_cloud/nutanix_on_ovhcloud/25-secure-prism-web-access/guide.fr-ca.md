...
Une fois votre service livré, Prism Central est accessible sur l'Internet public. Vous pouvez en restreindre l'accès à une ou plusieurs adresses IP via le [Load Balancer OVHcloud](https://www.ovh.com/ca/fr/solutions/load-balancer/).
...
Ouvrez la page de configuration du Nutanix Cluster vRack.
