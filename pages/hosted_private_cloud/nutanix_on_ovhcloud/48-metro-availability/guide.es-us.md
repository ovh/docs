...
routes:
    canonical: '/pages/hosted_private_cloud/nutanix_on_ovhcloud/48-metro-availability'
updated: 2023-08-08
---
...
- [advanced tools](/pages/hosted_private_cloud/nutanix_on_ovhcloud/09-advanced-tools)
...
Use this guide to connect your clusters: [Interconnect clusters through the vRack](/pages/hosted_private_cloud/nutanix_on_ovhcloud/45-vrack-interconnection). To connect the three clusters, use the instructions provided in the guide:
...
Use this guide to create VLANs on your Nutanix clusters: [isolate production management machines](/pages/hosted_private_cloud/nutanix_on_ovhcloud/27-isolate-management-vm).
...
[Interconnect clusters through the vRack](/pages/hosted_private_cloud/nutanix_on_ovhcloud/45-vrack-interconnection)

[Disaster Recovery Plan for Nutanix](/pages/hosted_private_cloud/nutanix_on_ovhcloud/43-disaster-recovery-plan-overview)
