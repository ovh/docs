---
title: Configura il Load Balancer NSX-v Edge (EN)
routes:
    canonical: '/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/nsx_configurer_le_load_balancer_edge_gateway'
