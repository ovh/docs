...
2. Importez le certificat `.pfx` dans le Windows Certificate Store de Veeam.
3. Cochez l'option permettant de rendre le certificat exportable lors de l'importation.
