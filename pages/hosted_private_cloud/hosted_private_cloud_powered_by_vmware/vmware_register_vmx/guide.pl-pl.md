...
- Posiadanie kontaktu administracyjnego infrastruktury [Hosted Private Cloud](/links/websiteenterprise/products/hosted-private-cloud/), aby otrzymać dane do logowania.
...
W [interfejsie vSphere](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vsphere_interface_connexion) umieść widok `Storage`{.action}.
...
Sprawdź parametry swoich wirtualnych maszyn (nazwa, [portgroup](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/creation_vlan), itp..) klikając prawym przyciskiem myszy na każdym z nich, a następnie wybierając `Edit Settings`{.action}.
