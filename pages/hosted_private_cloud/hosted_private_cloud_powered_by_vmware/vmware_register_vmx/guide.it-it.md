...
Nella tua [interfaccia vSphere](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vsphere_interface_connexion), posizionati nella vista `Storage`{.action}.
...
Verifica le impostazioni delle tue VM (nome, [portgroup](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/creation_vlan), ecc...) cliccando con il tasto destro su ciascuna di esse e selezionando `Edit Settings`{.action}.
