...
Zaloguj się do [Panelu klienta OVHcloud](/links/manager), przejdź do sekcji `Serwer`{.action} (1), kliknij `Hosted Private Cloud`{.action} (2) i wybierz serwer z listy (3). Teraz kliknij zakładkę [Użytkownicy](/links/manager) (4).
