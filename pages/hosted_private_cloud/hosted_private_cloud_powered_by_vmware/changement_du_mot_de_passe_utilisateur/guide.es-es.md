...
Conéctese al [área de cliente de OVHcloud](/links/manager), acceda al menú `Servidores`{.action} y, en la sección `Hosted Private Cloud`{.action}, seleccione su servidor en la lista. A continuación, haga clic en la pestaña `Usuarios` (4).
