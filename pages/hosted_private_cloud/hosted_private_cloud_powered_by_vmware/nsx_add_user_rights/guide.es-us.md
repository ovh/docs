...
- You have a [Hosted Private Cloud](https://www.ovhcloud.com/es/hosted-private-cloud/vmware/) service with the option **"Network Security Virtualization"** or **"Software-Defined Datacenter"**.
