...
- Avoir souscrit une offre [Hosted Private Cloud](/links/websitehosted-private-cloud/vmware/) avec les options **"Network Security Virtualization"** ou **"Software-Defined Datacenter"** 
