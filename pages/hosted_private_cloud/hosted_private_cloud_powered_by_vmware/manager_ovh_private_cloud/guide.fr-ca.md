...
Une fois dans la partie `Hosted Private Cloud`{.action} puis `Private Cloud`{.action} de votre [espace client OVHcloud](/links/manager){.external}, vous aurez accès à un aperçu général de votre Private Cloud :
