...
> [!primary]
> 
> Ceny obrazów systemów oferowanych przez OVH znajdziesz na [stronie WWW](/links/hosted-private-cloud/vmware-images-licenses).
>

## Wymagania początkowe

- Dostęp do klienta sieciowego lub do grubego klienta w zależności od używanej wersji
- [Aktywowanie licencji Windows](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/manager_ovh_private_cloud#licencje-windows) w [Panelu klienta OVH](/links/manager) (zakładka `Licencje Windows`{.action} w odpowiednim centrum danych) 
