---
title: Jak zmienić funkcję HA dla NSX-v Edge (EN)
routes:
    canonical: '/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/nsx_edge_enable_disable_after_update'
updated: 2022-09-14
---
...
You can ensure the username has access to NSX via the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl). This will be the same username and password used for your web-client login.
