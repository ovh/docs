...
Welcome to the complete guide on migrating to VMware Cloud Director within the vSphere managed on OVHcloud ecosystem.
...
Before you can migrate to VCD, you will need to follow some steps and prerequisites. Indeed, many vSphere managed on OVHcloud notions and use cases are not available with VCD and must be taken into account.
...
1. Does my vSphere managed on OVHcloud infrastructure use multi-vDC?
