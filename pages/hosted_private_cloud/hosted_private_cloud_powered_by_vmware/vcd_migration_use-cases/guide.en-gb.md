...
| **Step 10** | ?        | ❌           | **Zerto**                                               | **No Zerto.**                                                                                                            | - Errors with Zerto use cases, if you use Zerto, you cannot be migrated to VCD for now.                                                                                                                                                                                                         | [Setting up Zerto Virtual Replication between two OVHcloud data centres](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/zerto_virtual_replication_as_a_service). |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               
| **Step 11** | ?        | ❎           | **Hosts / Zpool**                                       | **Release resources (hosts + Zpool) freespare and hourly before migration. <br/> Or convert it in monthly resources.** |                                                                                                                                                                                                                                                                                                 | [Hosted Private Cloud billing information](/pages/account_and_service_management/managing_billing_payments_and_services/facturation_private_cloud).                                 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               
