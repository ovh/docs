...
|     **Étape 2**     |             |            🚫**VMware vSphere FT**             | Désactiver la tolérance aux pannes (FT) des VMs.                                                                                                                     |                                                                                                                                                                                                                                                                  | [Tolerance aux pannes VMware](/pages/bare_metal_cloud/managed_bare_metal/vmware_fault_tolerance)                                                                                                       |
...
|     **Étape 8**     |      ❌      | 📜**Si certifié PCI-DSS, HDS ou qualifié SNC** |                                                                                                                                                                      | - Ne peut pas être migré si vos charges de travail sont certifié PCI-DSS, HDS, SecNumCloud (options de sécurité) à ce jour.                                                                                                                                      | [Enterprise > Compliance and certification](/links/compliance-and-certification)                                                                                                                       |
