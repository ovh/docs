...
**PCC/VCD:**
- [x] Obtenir json du service PCC (voir 3ReturnComputesubscribed).
- [x] Créer un client.
- [x] Sélectionnez l'instance correcte en fonction de l'emplacement pcc (pcczone) retourné dans le json.
- [x] Sélectionner le pVDC correspondant à l'offre donnée en paramètres.
- [x] Traduire les ressources de calcul PCC en ressources VCD et approvisionner ces ressources en VDC d'organisation.
- [x] Après l'initialisation du client, les étapes suivantes de préconfiguration du réseau sont déclenchées.

**Côté VCD seulement:**
- [x] Vhosts.
- [x] Stockages.
- [x] Frais complémentaires (Org vDC + Org).

**Réseau:**
- [x] Bridge to map vlan 1xxx to VCD instance vRACK with vlan id 1xxx..
...
|----------------------|---------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------|--------|----------|--------------|
| Durant la migration  | CARP (avertissement) to be coded                                                      | - Detection + VCD implementation side.                                                                                                                                                                                                      | ?     | Non    | Oui      |              |
| Durant la migration  | 	Scale0 on PCC (NSX-T 4.0.1) → (coche)                                                | 	- Ignore this profile and remove them.                                                                                                                                                                                                     | ?     | Non    | Oui      |              |
| Durant la migration  | 	Edge, Backup infra, zerto infra, private GW... (OVH vms) Virtual Machines → (coche)  | 	- Do not migrate.                                                                                                                                                                                                                          | ?     | Non    | Oui      |              |
...
| Pre-check            | FT (coche)                                                                            | - Detection + error + E-Mail or detection + E-Mail + Disable FT on PCC side + Migration                                                                                                                                                     |       |        |          |              |
...
| Pre-check            | 	Check special devices (CD...) → (coche)                                              | - Public documentation <br/> Notify customer + E-Mail.                                                                                                                                                                                      |       |        |          |              |
...
| Pre-check            | 	Encrypted VM disks (erreur)	                                                         | - Public documentation, detection and block.                                                                                                                                                                                                |       |        |          |              |
| Pre-check            | 	Zerto (erreur) → list block (avertissement)                                          | 	- 8 PCCs (avertissement) public documentation.                                                                                                                                                                                             |       |        |          |              |
| Pre-check            | 	Backup (coche)	                                                                      | - Detection + migration du scenario.                                                                                                                                                                                                        |       |        |          |              |
