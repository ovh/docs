...
| **Étape 11** | ?           | ❎                 | **Hosts / Zpool**                           | **Libérez des ressources (hôtes + Zpool) gratuitement et toutes les heures avant la migration. <br/> Ou convertissez-le en ressources mensuelles.**                                                         | [Informations de facturation du Hosted Private Cloud](/pages/account_and_service_management/manage_billing_payment_and_services/facturation_private_cloud).                          |
