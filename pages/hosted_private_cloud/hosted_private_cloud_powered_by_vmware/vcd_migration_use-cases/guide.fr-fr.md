...
> [!primary]
>
> VCD on OVHcloud est actuellement en phase alpha. Ce guide peut donc évoluer et être mis à jour à l'avenir avec les avancées de nos équipes n charge de ce produit.
>
...
>
> Vous devrez faire la demande de migration par le biais d'un [ticket au support](https://help.ovhcloud.com/csm?id=csm_get_help), ce qui vous permettra d'avoir toutes les informations et de signer les T&C.
>
...
| **Post actions** | **Cas d'usage**                                             | **Objectif**                                                                                                                                                           | **Aides et références**                                                                                                                                                                                                                                                                                                           |
|:----------------:|:------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| 🥉 `Gold Repository`   | `Premium`    | - **High Performance Object Storage** avec copie de sauvegarde hors site et 14 points d’immuabilité (100 To). |
