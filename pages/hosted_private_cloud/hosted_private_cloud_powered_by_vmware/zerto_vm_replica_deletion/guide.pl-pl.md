...
- Posiadanie kontaktu administracyjnego infrastruktury [Hosted Private Cloud](/links/websiteenterprise/products/hosted-private-cloud/), aby otrzymywać dane do logowania.
