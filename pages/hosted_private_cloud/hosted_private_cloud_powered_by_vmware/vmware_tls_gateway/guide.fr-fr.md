...
| Options / Offers / Features                                           | Dependency                                                                           |   Available zones   |  Type  | Certification  |                                      Pack Basic                                       |                                                 Pack Advanced Security                                                 | WAF | Comments                                                                                                                                                                                                                                                                                                                                         |
|:----------------------------------------------------------------------|:-------------------------------------------------------------------------------------|:-------------------:|:------:|:--------------:|:-------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------:|----|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Default options                                                       |                                                                                      |         All         |  Pack  |                | - SFTP<br/>- Access Network<br/>- HIDS<br/>- Grsec Kernel<br/>- Log Insight Forwarder | - Pack Basic<br/>- 2FA<br/>- Log Insight Forwarder<br/>- TLS 1.2<br/>- Timeout on session<br/>- NIDS<br/>- Token validation |    |                                                                                                                                                                                                                                                                                                                                                  |
...
| NIDS                                                                  |                                                                                      |         All         | Option |       ❌        |                                           ✅                                           |                                                           ✅                                                            |    | - Will configure a nids software on components with a dedicated access.                                                                                                                                                                                                                                                                          |
| HIDS                                                                  |                                                                                      |         All         | Option |       ❌        |                                           ✅                                           |                                                           ✅                                                            |    | - Will configure a hids software on pcc's components.                                                                                                                                                                                                                                                                                            |
...
| SPLA (licences windows)                                               |                                                                                      |         All         | Option |       ❌        |                                           ✅                                           |                                                           ✅                                                            |    | - [How to manage Windows licenses for virtual machines on your Hosted Private Cloud infrastructure](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/spla_license_management).                                                                                                                                                 |
| Log Forwarder                                                         | - vRealize Log Insight Log Forwarder (vrli Forwarder)                                |         All         | Option |       ❌        |                                           ✅                                           |                                                           ✅                                                            |    | - Deploy logs components to forward all VMware logs of a PCC. 2 features Log forwarder and Log to customer.<br/>- [Logs Data Platform - Collect VMware on OVHcloud logs](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vmware_ldp).                                                                                         |
| TLS 1.2 (vSphere v7)                                                  | - VMware vSphere v7                                                                  |         All         | Option |       ❌        |                                           ❌                                           |                                                           ✅                                                            |    | - Force tls 1.2 on all PCC components.                                                                                                                                                                                                                                                                                                           |
| TLS 1.3 (vSphere v8)                                                  | - VMware vSphere v8                                                                  |         All         | Option |       ❌        |                                           ❌                                           |                                                           ✅                                                            |    | - Force tls 1.3 on all PCC components.                                                                                                                                                                                                                                                                                                           |
...
| Log to Customer (coming soon)                                         | - vRealize Log Insight Log Forwarder (vrli Forwarder)                                |         All         | Option |       ❌        |                                           ❌                                           |                                                           ✅                                                            |    |                                                                                                                                                                                                                                                                                                                                                  |
|                                                                       |                                                                                      |                     |        |                |                                                                                       |                                                                                                                        |    |                                                                                                                                                                                                                                                                                                                                                  |
| Beta SecNumCloud                                                      | - Pack Basic + Pack Security Advanced<br/>- Logstash                                 |                     |  Pack  |       ❌        |                                           ✅                                           |                                                           ✅                                                            |  ❌  |                                                                                                                                                                                                                                                                                                                                                  |
| SecNumCloud                                                           | - Pack Basic + Pack Security Advanced<br/>- WAF<br/>- Logstash<br/>- Log to Customer |    `sbg2a`<br/>`rbx1a`     |  Pack  |       ✅        |                                           ✅                                           |                                                           ✅                                                            | ✅  |                                                                                                                                                                                                                                                                                                                                                  |
| SecNumCloud - PCIDSS                                                  | - Pack Basic + Pack Security Advanced<br/>- WAF<br/>- Logstash<br/>- Log to Customer |         All         |  Pack  |       ✅        |                                           ✅                                           |                                                           ✅                                                            |  ✅  |                                                                                                                                                                                                                                                                                                                                                  |
| SecNumCloud - HDS                                                     | - Pack Basic + Pack Security Advanced<br/>- WAF<br/>- Logstash<br/>- Log to Customer |         All         |  Pack  |       ✅        |                                           ✅                                           |                                                           ✅                                                            | ✅   |                                                                                                                                                                                                                                                                                                                                                  |
