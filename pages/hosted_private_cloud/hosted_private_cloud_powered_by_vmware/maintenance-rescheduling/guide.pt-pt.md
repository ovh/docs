...
> [!success]
> Os e-mails enviados pela OVHcloud também estão acessíveis a partir do seu [Área de Cliente OVHcloud](/links/manager).<br>
...
Aceda à [Área de Cliente OVHcloud](/links/manager) com uma conta de administrador.
...
Ligue-se à [interface de administração dos seus serviços através da API](/links/api). Pode consultar o nosso manual "[Primeiros passos com as API OVHcloud](/pages/manage_and_operate/api/first-steps)".
