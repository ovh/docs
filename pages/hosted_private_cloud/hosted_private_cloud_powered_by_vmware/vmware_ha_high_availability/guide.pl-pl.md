...
- Posiadanie usługi [Hosted Private Cloud](/links/websiteenterprise/products/hosted-private-cloud/){.external}
...
Wyłączenie tej funkcji jest konieczne na przykład do przeprowadzenia aktualizacji przy użyciu narzędzia [Update Manager](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vmware_update_manager). W tym konkretnym przypadku host jest izolowany.
...
Monitoring maszyn wirtualnych jest dostępny po zainstalowaniu narzędzia [VMware tools](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vmware_tools_install).
