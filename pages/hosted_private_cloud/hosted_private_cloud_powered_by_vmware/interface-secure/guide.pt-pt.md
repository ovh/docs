...
- Dispor de uma infraestrutura com a opção **advanced security** (incluída nas ofertas [PCI-DSS](/links/websiteenterprise/products/hosted-private-cloud/safety-compliance/sddc/) e [HDS](/links/websiteenterprise/certification-conformity/hds/)). Este direito permite a validação.
