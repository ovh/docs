...
Questa operazione, chiamata **vMotion**, è descritta in [questa guida](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vmware_vmotion_new).
...
Durante questa operazione è anche possibile modificare la politica di storage e, ad esempio, applicare le regole esistenti per uno [storage vSAN](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vmware_vsan) o l’opzione [VMencryption](/pages/hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vm_encrypt).
