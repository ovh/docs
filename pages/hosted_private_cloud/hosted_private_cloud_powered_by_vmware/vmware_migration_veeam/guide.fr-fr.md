...
1. Cliquez sur [ce lien](/links/control-panel/privatecloud-vmware-vsphere) pour accéder à la section `VMware vSphere`{.action}, puis ouvrez le Secure SSL Gateway.
2. Ajoutez les adresses IP autorisées.
