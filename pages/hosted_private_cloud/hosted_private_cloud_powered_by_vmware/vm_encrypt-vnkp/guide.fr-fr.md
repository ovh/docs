...
Cliquez sur [ce lien](/links/control-panel/privatecloud-vmware-vsphere) pour accéder à la section `VMware vSphere`{.action}, puis sélectionnez votre service. Allez dans `Utilisateurs`{.action} et cliquez sur le bouton `...`{.action}.
