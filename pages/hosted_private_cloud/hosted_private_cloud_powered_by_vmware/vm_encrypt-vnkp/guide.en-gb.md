...
Click [this link](/links/control-panel/privatecloud-vmware-vsphere) to access the `VMware vSphere`{.action} section, then select your service. Go to `Users`{.action} and click the `...`{.action}
