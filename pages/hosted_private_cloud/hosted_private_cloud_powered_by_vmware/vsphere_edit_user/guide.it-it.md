...
Accedi allo [Spazio Cliente](/links/manager) e, nella sezione `Hosted Private Cloud`, clicca su `Private Cloud` nella colonna a sinistra e seleziona il servizio in questione.
