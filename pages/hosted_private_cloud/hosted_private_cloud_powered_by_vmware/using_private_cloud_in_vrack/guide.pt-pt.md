...
- Ter contacto com o administrador da infraestrutura [Hosted Private Cloud](/links/websiteenterprise/products/hosted-private-cloud/), para receber dados de acesso.
...
Aquando da entrega do seu serviço [Hosted Private Cloud](/links/websiteenterprise/products/hosted-private-cloud/), a parte *datacenter* já está dentro de um vRack. Para aceder à secção vRack, aceda à secção `Bare Metal Cloud`{.action, clique em `Network`{.action}, e em `vRack`{.action}. Selecione o seu vRack na lista para visualizar o conteúdo.
