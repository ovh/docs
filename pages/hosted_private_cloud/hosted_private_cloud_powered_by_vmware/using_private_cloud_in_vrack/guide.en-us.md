...
After your [Hosted Private Cloud infrastructure](https://www.ovhcloud.com/en/enterprise/products/hosted-private-cloud/) is delivered, it will be displayed in the `vRack`{.action} section. Select your vRack from the list and the "datacenter" will be automatically included into a vRack.
