...
- Tener un servicio [vRack](/links/network/vrack) en su cuenta o contratar uno si es necesario.
...
- Tener un usuario activo con acceso a vSphere (creado en el [área de cliente de OVHcloud](/links/manager))
...
Al entregar el servicio [Hosted Private Cloud](https://www.ovhcloud.com/es/enterprise/products/hosted-private-cloud/), la parte *datacenter* ya está dentro de un vRack. Seleccione su vRack de la lista para ver el contenido.
