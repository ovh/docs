...
To create a storage policy, you need to access your PCC vSphere. If you have followed the previous steps, you should already have access after adding your OVHcloud KMS in [step 4](#add-okms).
