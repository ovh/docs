...
- Ter contacto com o administrador da infraestrutura [Hosted Private Cloud](/links/websiteenterprise/products/hosted-private-cloud/), a fim de receber dados de acesso.
...
- Ativar a opção [Veeam Backup Managed](/links/websiteenterprise/products/hosted-private-cloud/veeam-backup-managed/){.external}.
