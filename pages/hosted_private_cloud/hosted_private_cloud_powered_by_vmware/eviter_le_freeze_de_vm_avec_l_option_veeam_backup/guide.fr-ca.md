...
- Être contact administrateur de l'infrastructure [Hosted Private Cloud](/links/websiteenterprise/products/hosted-private-cloud/), afin de recevoir des identifiants de connexion.
...
- Activer l'option [Veeam Backup Managed](/links/websiteenterprise/products/hosted-private-cloud/veeam-backup-managed/){.external}.
