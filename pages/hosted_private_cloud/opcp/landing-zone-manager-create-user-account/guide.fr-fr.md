---
title: "Landing Zone Manager - Créer et utiliser un compte utilisateur"
...
Le Landing Zone Manager propose une gestion de comptes en self-service qui permet aux administrateurs de provisionner de nouveaux utilisateurs et de leur donner accès à la plateforme. Chaque compte utilisateur créé dans le Landing Zone Manager s'appuie sur un realm dédié dans l'instance Keycloak sous-jacente.
...
### Étape 1 : Accéder à la section de gestion des comptes utilisateur
...
> [!primary]
>
> L'adresse email fournie est utilisée comme identifiant de connexion du nouveau compte utilisateur. Assurez-vous qu'elle est correcte avant de valider, car les utilisateurs s'authentifieront avec cette valeur.
>
...
- **Mot de passe** : le mot de passe par défaut de première connexion défini lors du déploiement de OPCP et du Cloud Store.
