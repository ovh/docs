...
You can set a hostname which will be displayed with the command `hostname`. You have also the possibility to [add your SSH key](/pages/cloud/dedicated/getting-started-with-dedicated-server#dodanie-klucza-ssh-opcjonalnie).
...
Once the SLES 15 for SAP installation is done, you can [connect to your dedicated server](/pages/cloud/dedicated/getting-started-with-dedicated-server#polaczenie-z-serwerem).
