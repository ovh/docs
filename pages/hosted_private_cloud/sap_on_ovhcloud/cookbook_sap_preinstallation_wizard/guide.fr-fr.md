...
L'assistant de pré-installation SAP proposé d'OVHcloud facilite le déploiement d'un système SAP sur votre service VMware on OVHcloud déjà configuré dans votre compte client. Il vous permet de mettre en place des environnements SAP NetWeaver 7.50 ou S/4HANA, que ce soit en configuration ABAP ou Java, et selon des schémas standard, distribué ou hautement disponible.

Ce guide vous accompagne tout au long du processus, vous demandant les détails nécessaires pour configurer vos machines virtuelles et effectuer la pré-installation du système SAP.

> [!primary]
>
> Il est important de noter que le terme « pré-installation » désigne ici l'installation de la stack technique uniquement. Cela inclut la base de données SAP HANA ainsi que la stack technique SAP NetWeaver 7.50 ou S/4HANA. Après cette phase de pré-installation, il vous faudra installer le module SAP spécifique à vos besoins et finaliser les configurations dans le cadre d'une post-installation.
...
![start-wizard](images/start-wizard.png){.thumbnail}
...
![step-4](images/step-4.png){.thumbnail}
...
![step-5](images/step-5.png){.thumbnail}
...
> [!tabs]
> Paramètres réseaux
>> ![step-6_1](images/step-6_1.png){.thumbnail}
> SAP HANA
>> ![step-6_2](images/step-6_2.png){.thumbnail}
> Serveurs d'application SAP
>> ![step-6_3](images/step-6_3.png){.thumbnail}
...
![step-7](images/step-7.png){.thumbnail}
...
![step-8](images/step-8.png){.thumbnail}
...
>
> Si une erreur interne survient et que le statut de la tâche n'a pas correctement été mis à jour, veuillez supprimer la tâche en question via notre API [/dedicatedCloud/{serviceName}/sap/{taskId}](/links/api). Cette action permettra de supprimer la tâche en erreur bloquant les nouvelles installations. Veuillez également supprimer les machines virtuelles qui ont été créées par la tâche d'installation en erreur.
