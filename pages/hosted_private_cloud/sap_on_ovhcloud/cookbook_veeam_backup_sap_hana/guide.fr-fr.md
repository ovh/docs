...
[Veeam Enterprise Plus avec OVHcloud](/links/websitestorage-solutions/veeam-enterprise/) vous permet d’utiliser Veeam Backup and Replication 12 au sein de votre infrastructure OVHcloud en bénéficiant d'un niveau de licence Veeam Enterprise Plus.
...
Pour découvrir les étapes de création d'un bucket Object Storage, veuillez prendre connaissance des étapes détaillées dans [notre guide](/pages/storage_and_backup/object_storage/s3_getting_started_with_object_storage).
