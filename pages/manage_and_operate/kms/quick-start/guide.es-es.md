...
- **Enlace directo:** [Key Management Service](/links/control-panel/security-kms)
- **Ruta de navegación:** `Identidad, seguridad y operaciones`{.action} > `Key Management Service`{.action} > Seleccione su dominio OKMS.
