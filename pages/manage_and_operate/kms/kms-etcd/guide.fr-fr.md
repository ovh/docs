...
| `--kmip-addr`   | Adresse du serveur KMIP. Disponible dans le dashboard de votre domaine [Key Management Service](/links/control-panel/security-kms). (par exemple : `eu-west-rbx.okms.ovh.net:5696`). | `""` (obligatoire)               |
