...
You will also need the `region` and the `okms-id` of the OKMS domain you want to use. This ID and this region can be found in the [Key Management Service](/links/control-panel/security-kms) dashboard or via the [OVHcloud CLI](https://github.com/ovh/ovhcloud-cli):
