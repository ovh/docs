...
Pour ce faire, cliquez sur le lien suivant : [https://auth.ca.ovhcloud.com/api/createToken](https://auth.ca.ovhcloud.com/api/createToken).
...
>>
>> Rendez-vous sur la page [Clés API](/links/control-panel/iam-api-keys).
>>
