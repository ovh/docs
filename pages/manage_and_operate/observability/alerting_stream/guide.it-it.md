...
- [Quick start of Logs Data Platform](/pages/manage_and_operate/observability/getting_started_quick_start).
- [Logstash collector on Logs Data Platform](/pages/manage_and_operate/observability/ingestion_logstash_dedicated_input).
- [The Filebeat tutorial](/pages/manage_and_operate/observability/ingestion_filebeat).
...
The configuration is inspired by the one you can find in [this tutorial](/pages/manage_and_operate/observability/ingestion_apache).
