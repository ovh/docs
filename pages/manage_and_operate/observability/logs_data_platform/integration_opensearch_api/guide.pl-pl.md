...
- **Link bezpośredni:** [Logs Data Platform](/links/control-panel/logs-data-platform)
- **Ścieżka nawigacji:** `Tożsamość, bezpieczeństwo i operacje`{.action} > `Logs Data Platform`{.action} > Wybierz odpowiednią platformę.
