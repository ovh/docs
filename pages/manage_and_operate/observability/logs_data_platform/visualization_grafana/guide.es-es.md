...
- **Enlace directo:** [Logs Data Platform](/links/control-panel/logs-data-platform)
- **Ruta de navegación:** `Identidad, seguridad y operaciones`{.action} > `Logs Data Platform`{.action} > Seleccione la plataforma correspondiente.
