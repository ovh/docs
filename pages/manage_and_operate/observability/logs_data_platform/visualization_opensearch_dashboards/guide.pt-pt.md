...
- **Ligação direta:** [Logs Data Platform](/links/control-panel/logs-data-platform)
- **Caminho de navegação:** `Identidade, Segurança e Operações`{.action} > `Logs Data Platform`{.action} > Selecione a plataforma em questão.
