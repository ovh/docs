...
With the [Cold Storage feature](/pages/manage_and_operate/observability/archive_cold_storage) you can generate daily archives for your log streams.
...
- A stream with cold storage enabled. You can follow this [Cold Storage tutorial](/pages/manage_and_operate/observability/archive_cold_storage) to set it up.
...
- Ensure the `Enable long-term storage` option is checked. You can refer to the [Cold Storage feature](/pages/manage_and_operate/observability/archive_cold_storage) documentation to know about each of its fields.
...
Once your encrypted archives are available, you can retrieve them [following this tutorial](/pages/manage_and_operate/observability/archive_cold_storage#retrieving-the-archives).
