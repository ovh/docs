...
If you only have [indices](/pages/manage_and_operate/observability/opensearch_index), you can use them directly in the ElastAlert configuration.
...
- `<password>` is the associated password. You can use [tokens](/pages/manage_and_operate/observability/security_tokens) in place of the username/password couple for your credentials.
...
To test your alert you can use the following curl command sending logs to our [OpenSearch endpoint](/pages/manage_and_operate/observability/ingestion_opensearch_api_mutualized_input):
