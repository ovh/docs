...
The best feature is to mix criteria, based on what is important to you. For example, `facility:auth AND level:6`.  Why not [create an alert](/pages/manage_and_operate/observability/alerting_stream) on this condition?
