...
3. Edit your LDP access tokens (more on this functionality [here](/pages/manage_and_operate/observability/security_tokens)).
...
- **Manage alerts** allows you to define your alert conditions on the logs routed to the stream. [More about](/pages/manage_and_operate/observability/alerting_stream)
- **Archives** allows you to download the cold stored archives. [More about](/pages/manage_and_operate/observability/archive_cold_storage)
...
- [Send correctly formatted logs](/pages/manage_and_operate/observability/getting_started_field_naming_convention) to use custom types as number, boolean and other stuffs
- [Configure your syslog-ng](/pages/manage_and_operate/observability/ingestion_syslog_ng) to send your Linux logs to Logs Data Platform.
...
- [Using OpenSearch Dashboards and aliases to unleash the power of OpenSearch](/pages/manage_and_operate/observability/visualization_opensearch_dashboards)
