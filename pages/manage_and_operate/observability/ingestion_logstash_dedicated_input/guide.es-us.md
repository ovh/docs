...
If you are new to Logs Data Platform, completion of the [Quick Start Tutorial](/pages/manage_and_operate/observability/getting_started_quick_start) is highly recommended.
...
- [Logstash + Groks + Filebeat = Awesome](/pages/manage_and_operate/observability/ingestion_filebeat)
