...
- [Starting with Logs Data Platform.](/pages/manage_and_operate/observability/getting_started_quick_start)
- [How to setup a Logstash input?](/pages/manage_and_operate/observability/ingestion_logstash_dedicated_input)
- [Using Filebeat with Logs Data Platform.](/pages/manage_and_operate/observability/ingestion_filebeat)
...
We cover Filebeat in depth in [another tutorial](/pages/manage_and_operate/observability/ingestion_filebeat){.external}. Here is a minimal **filebeat.yml** configuration file.
