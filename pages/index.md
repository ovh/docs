...
+ Hosted Private Cloud
    + [VMware on OVHcloud](products/hosted-private-cloud-hosted-private-cloud-powered-by-vmware)
        ...
        + [Access and Security](hosted-private-cloud-hosted-private-cloud-powered-by-vmware-access-security)
            ...
            + [IAM - How to activate IAM in Vsphere](hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vmware_iam_activation)
            + [IAM - How to use and create Vsphere IAM role](hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vmware_iam_role)
            + [IAM - How to link an IAM policy to a Vsphere role](hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vmware_iam_role_policy)
            + [IAM - How to link an OVHcloud identity user to a global policy](hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vmware_iam_user_policy)
