...
+ Bare Metal Cloud
    + [Dedicated Servers](products/bare-metal-cloud-dedicated-servers)
        ...
        + [Server management](bare-metal-cloud-dedicated-servers-managing-servers)
            ...
            + [How to reset the Windows Administrator password when using Rescue-Customer-Windows](bare_metal_cloud/dedicated_servers/rcw-changing-admin-password-on-windows)
