...
+ Hosted Private Cloud
    + [VMware on OVHcloud](products/hosted-private-cloud-hosted-private-cloud-powered-by-vmware)
        ...
        + [Access and Security](hosted-private-cloud-hosted-private-cloud-powered-by-vmware-access-security)
            ...
            + [IAM - How to use default Vsphere role with IAM](hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vmware_iam_role)
            + [IAM - How to link a policy to an IAM role](hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vmware_iam_role_policy)
            + [IAM - How to link a Vsphere role to an OVHcloud identity user](hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vmware_iam_user_policy)
