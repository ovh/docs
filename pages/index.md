...
+ Bare Metal Cloud
    + [Dedicated Servers](products/bare-metal-cloud-dedicated-servers) 
        ...
        + [Security](bare-metal-cloud-dedicated-servers-security)
            + [Hardening](bare-metal-cloud-dedicated-servers-security-hardening)
                ...
                + [Anti-Hack information - Dedicated Server and VPS](bare_metal_cloud/dedicated_servers/anti-hack-dedicated-vps)   
    ...
    + [Virtual Private Servers](products/bare-metal-cloud-virtual-private-servers)
        ...
        + [Troubleshooting](bare-metal-cloud-virtual-private-servers-troubleshooting)
            ...
            + [How to enable Windows boot logs](bare_metal_cloud/virtual_private_servers/windows-boot-logs)
...
+ Hosted Private Cloud
    + [Public VCF as-a-Service](products/hosted-private-cloud-public-VCF)
        ...
        + [Configuration](hosted-private-cloud-public-VCF-configuration)
            ...
            + [Public VCF as-a-Service - User roles](hosted_private_cloud/hosted_private_cloud_powered_by_vmware/vcd_user_role)
    ...
    + [On-Prem Cloud Platform](products/hosted-private-cloud-hosted-private-cloud-opcp)
        + [Getting started](hosted-private-cloud-hosted-private-cloud-opcp-getting-started)
            ...
            + [OPCP - How to use Terraform](hosted_private_cloud/opcp/how-to-use-terraform)
        ...
        + [Security](hosted-private-cloud-hosted-private-cloud-opcp-security)
            + [OPCP - IAM rights management](hosted_private_cloud/opcp/iam-rights-management)
...
+ Public Cloud
    + [Public Cloud - General Information](products/public-cloud-cross-functional)
        ...
        + [Additional resources](public-cloud-cross-functional-additional-resources)
            ...
            + [Understanding Metrics in Public Cloud](public_cloud/public_cloud_cross_functional/metrics_informations)
        ...
        + [Object Storage](products/public-cloud-storage-object-storage)
            + [S3 compatible](products/public-cloud-storage-object-storage-s3)
                ...
                + [Tutorials](products/public-cloud-storage-object-storage-s3-tutorials)
                    ...
                    + [Object Storage - Lifecycle and replication use cases](storage_and_backup/object_storage/s3_use_cases_lifecycle_replication)
    ...
    + [Public Cloud Databases](products/public-cloud-databases)
        + [PostgreSQL](products/public-cloud-databases-postgresql)
            ...
            + [Configuration](public-cloud-databases-postgresql-configuration)
                ...
                + [Detect and terminate long-running queries of Public Cloud Databases for PostgreSQL](public_cloud/public_cloud_databases/postgresql_11_terminate_queries)
                ...
                + [Set up logs forwarding for Public Cloud Databases](public_cloud/public_cloud_databases/databases_16_logs_to_customer)
                + [Set up the Kubernetes operator for Public Cloud Databases](public_cloud/public_cloud_databases/databases_12_operator)
                + [Set up service integration for Public Cloud Databases](public_cloud/public_cloud_databases/databases_07_cross_service_integration)
                + [Fetch service metrics with Prometheus for Public Cloud Databases](public_cloud/public_cloud_databases/databases_17_metrics_via_prometheus)
            ...
            + [Tutorials](public-cloud-databases-postgresql-tutorials)
                ...
                + [Migrate an on-premises database to Public Cloud Databases for PostgreSQL](public_cloud/public_cloud_databases/postgresql_tuto_03_migrate_ecdb)
            + [Security](public-cloud-databases-postgresql-security)
                + [Security Overview for Public Cloud Databases](public_cloud/public_cloud_databases/information_01_security_overview)
        ...
        + [MySQL](products/public-cloud-databases-mysql)
            + [Key concepts](public-cloud-databases-mysql-key-concepts)
                ...
                + [FAQ for Public Cloud databases](public_cloud/public_cloud_databases/information_04_faq)
                + [Capabilities and Limitations of Public Cloud Databases](public_cloud/public_cloud_databases/information_05_capabilities)
                + [Capabilities and Limitations of Public Cloud Databases for MySQL](public_cloud/public_cloud_databases/mysql_01_capabilities)
                + [Comparison of Public Cloud Databases Deployment Modes - Understanding 3-AZ / 1-AZ](public_cloud/public_cloud_databases/databases_18_regions_comparison)
                + [Automated Backups for Public Cloud Databases](public_cloud/public_cloud_databases/databases_05_automated_backups)
            + [Getting started](public-cloud-databases-mysql-getting-started)
                + [Getting started with Public Cloud Databases](public_cloud/public_cloud_databases/databases_01_order_control_panel)
                + [Configure incoming connections of a Public Cloud Databases for MySQL service](public_cloud/public_cloud_databases/mysql_07_prepare_for_incoming_connections)
                + [Connect using the CLI for Public Cloud Databases for MySQL](public_cloud/public_cloud_databases/mysql_03_connect_cli)
                + [Connect using PHP for Public Cloud Databases for MySQL](public_cloud/public_cloud_databases/mysql_04_connect_php)
                + [Connect using Python for Public Cloud Databases for MySQL](public_cloud/public_cloud_databases/mysql_05_connect_python)
                + [Connect using Workbench for Public Cloud Databases for MySQL](public_cloud/public_cloud_databases/mysql_06_connect_workbench)
        ...
        + [MongoDB](products/public-cloud-databases-mongodb)
            + [Key concepts](public-cloud-databases-mongodb-key-concepts)
                ...
                + [Operational Best Practices with Public Cloud Databases for MongoDB](public_cloud/public_cloud_databases/mongodb_21_operational_best_practices)
                + [Lifecycle policy for Public Cloud Databases](public_cloud/public_cloud_databases/information_02_lifecycle_policy)
                + [FAQ for Public Cloud databases](public_cloud/public_cloud_databases/information_04_faq)
                + [Capabilities and Limitations of Public Cloud Databases](public_cloud/public_cloud_databases/information_05_capabilities)
                + [Capabilities and Limitations of Public Cloud Databases for MongoDB](public_cloud/public_cloud_databases/mongodb_01_concept_capabilities)
                + [Comparison of Public Cloud Databases Deployment Modes - Understanding 3-AZ / 1-AZ](public_cloud/public_cloud_databases/databases_18_regions_comparison)
                + [Automated Backups for Public Cloud Databases](public_cloud/public_cloud_databases/databases_05_automated_backups)
            ...
            + [Getting started](public-cloud-databases-mongodb-getting-started)
                ...
                + [Getting started with Public Cloud Databases](public_cloud/public_cloud_databases/databases_01_order_control_panel)
                + [Deploy with Terraform for Public Cloud for MongoDB](public_cloud/public_cloud_databases/mongodb_14_deploy_with_terraform)
                + [Configure incoming connections of a Public Cloud Databases for MongoDB service](public_cloud/public_cloud_databases/mongodb_02_manage_control_panel)
                + [Connect using the CLI for Public Cloud Databases for MongoDB](public_cloud/public_cloud_databases/mongodb_03_connect_cli)
                ...
                + [Cluster monitoring for Public Cloud Databases for MongoDB](public_cloud/public_cloud_databases/mongodb_15_monitoring)
            + [Configuration](public-cloud-databases-mongodb-configuration)
                + [Maintenance operations for Public Cloud Databases](public_cloud/public_cloud_databases/databases_15_maintenances)
                + [Configure the private network for Public Cloud Databases](public_cloud/public_cloud_databases/databases_08_vrack)
                + [Configure the advanced parameters for Public Cloud Databases](public_cloud/public_cloud_databases/databases_03_advanced_configuration)
                + [Restore a backup of Public Cloud Databases](public_cloud/public_cloud_databases/databases_06_restore_backup)
                + [Backup and restore a service with the CLI for Public Cloud Databases for MongoDB](public_cloud/public_cloud_databases/mongodb_06_howto_backup_restore)
                + [Resize the storage of Public Cloud Databases](public_cloud/public_cloud_databases/databases_11_resize_your_cluster_storage)
                + [Update the flavor of Public Cloud Databases](public_cloud/public_cloud_databases/databases_13_update_your_cluster_flavor)
                + [Update the plan of Public Cloud Databases](public_cloud/public_cloud_databases/databases_14_upgrade_your_cluster_plan)
                + [Set up logs forwarding for Public Cloud Databases](public_cloud/public_cloud_databases/databases_16_logs_to_customer)
            ...
            + [Additional resources](public-cloud-databases-mongodb-additional-resources)
                ...
                + [Configure an Analytics node for Public Databases for MongoDB](public_cloud/public_cloud_databases/mongodb_08_analytics)
                + [Setup a Kafka integration for Public Cloud for MongoDB](public_cloud/public_cloud_databases/mongodb_23_kafka_connector)
                + [Understand readPreference and writeConcern of Public Cloud Databases for MongoDB](public_cloud/public_cloud_databases/mongodb_24_read_preference_and_write_concern)
                + [Benchmark Public Cloud Databases for MongoDB](public_cloud/public_cloud_databases/mongodb_22_benchmark)
        + [Valkey](products/public-cloud-databases-valkey)
            + [Key concepts](public-cloud-databases-valkey-key-concepts)
                + [Lifecycle policy for Public Cloud Databases](public_cloud/public_cloud_databases/information_02_lifecycle_policy)
                + [FAQ for Public Cloud databases](public_cloud/public_cloud_databases/information_04_faq)
                + [Capabilities and Limitations of Public Cloud Databases](public_cloud/public_cloud_databases/information_05_capabilities)
                + [Capabilities and Limitations of Public Cloud Databases for Valkey](public_cloud/public_cloud_databases/redis_01_capabilities)
                + [Comparison of Public Cloud Databases Deployment Modes - Understanding 3-AZ / 1-AZ](public_cloud/public_cloud_databases/databases_18_regions_comparison)
                + [Automated Backups for Public Cloud Databases](public_cloud/public_cloud_databases/databases_05_automated_backups)
            + [Getting started](public-cloud-databases-valkey-getting-started)
                ...
                + [Connect using the CLI for Public Cloud Databases for Valkey](public_cloud/public_cloud_databases/redis_03_connect_cli)
                + [Connect using PHP for Public Cloud Databases for Valkey](public_cloud/public_cloud_databases/redis_04_connect_php)
                + [Connect using Python for Public Cloud Databases for Valkey](public_cloud/public_cloud_databases/redis_05_connect_python)
                + [Connect using RedisInsight for Public Cloud Databases for Valkey](public_cloud/public_cloud_databases/redis_06_connect_redisinsight)
            + [Configuration](public-cloud-databases-valkey-configuration)
                ...
                + [Update the flavor of Public Cloud Databases](public_cloud/public_cloud_databases/databases_13_update_your_cluster_flavor)
                + [Update the plan of Public Cloud Databases](public_cloud/public_cloud_databases/databases_14_upgrade_your_cluster_plan)
                + [Manage ACLs via API for Public Cloud Databases for Valkey](public_cloud/public_cloud_databases/redis_07_update_acls)
                + [Set up logs forwarding for Public Cloud Databases](public_cloud/public_cloud_databases/databases_16_logs_to_customer)
                + [Set up the Kubernetes operator for Public Cloud Databases](public_cloud/public_cloud_databases/databases_12_operator)
                + [Set up service integration for Public Cloud Databases](public_cloud/public_cloud_databases/databases_07_cross_service_integration)
                + [Fetch service metrics with Prometheus for Public Cloud Databases](public_cloud/public_cloud_databases/databases_17_metrics_via_prometheus)
            ...
            + [Tutorials](public-cloud-databases-valkey-tutorials)
                + [Boost your WordPress CMS with caching with Public Cloud Databases for Valkey](public_cloud/public_cloud_databases/redis_tuto_01_wordpress)
        ...
        + [Common](public-cloud-databases-common)
            + [Key concepts](public-cloud-databases-common-key-concepts)
                ...
                + [Comparison of Public Cloud Databases Deployment Modes - Understanding 3-AZ / 1-AZ](public_cloud/public_cloud_databases/databases_18_regions_comparison)
                + [Automated Backups for Public Cloud Databases](public_cloud/public_cloud_databases/databases_05_automated_backups)
                + [Understanding Public Cloud Databases pricing](public_cloud/public_cloud_databases/databases_21_billing)
    ...
    + [Analytics](products/public-cloud-data-analytics)
        ...
        + [Kafka](products/public-cloud-data-analytics-kafka)
            + [Key concepts](public-cloud-data-analytics-kafka-key-concepts)
                ...
                + [Capabilities and Limitations of Analytics](public_cloud/data_analytics/analytics/information_03_capabilities)
                + [Capabilities and Limitations of Analytics with Kafka](public_cloud/public_cloud_databases/kafka_01_capabilities)
                + [Capabilities and Limitations of Analytics with Kafka Connect](public_cloud/public_cloud_databases/kafkaconnect_01_capabilities)
            ...
            + [Getting started](public-cloud-data-analytics-kafka-getting-started)
                ...
                + [Create a cluster with Analytics with Kafka](public_cloud/data_analytics/analytics/kafka_create_cluster)
                + [Configure incoming connections of an Analytics for Kafka service](public_cloud/data_analytics/analytics/kafka_incoming_connections)
                + [Connect using the CLI for Analytics with Kafka](public_cloud/data_analytics/analytics/kafka_connect_cluster_cli)
                + [Create topics for Analytics with Kafka](public_cloud/data_analytics/analytics/kafka_create_topics)
                + [Use Access Control Lists (ACLs) for Analytics with Kafka](public_cloud/data_analytics/analytics/kafka_configure_acl)
                + [Enable schema registry for Analytics with Kafka](public_cloud/data_analytics/analytics/kafka_enable_schema_registry)
            + [Configuration](public-cloud-data-analytics-kafka-configuration)
                + [Maintenance operations for Analytics](public_cloud/data_analytics/analytics/information_04_maintenances)
                + [Configure the advanced parameters for Analytics](public_cloud/data_analytics/analytics/analytics_advanced_parameters)
                + [Advanced parameters for Analytics with Kafka](public_cloud/public_cloud_databases/kafka_03_advanced_parameters_references)
                + [Advanced parameters for Analytics with Kafka Connect](public_cloud/public_cloud_databases/kafkaconnect_02_advanced_parameters_references)
                + [Restore a backup of Analytics](public_cloud/data_analytics/analytics/analytics_restore_backup)
                + [Resize the storage of Analytics](public_cloud/data_analytics/analytics/analytics_resize_cluster_storage)
                + [Update the flavor of Analytics](public_cloud/data_analytics/analytics/analytics_update_cluster_flavor)
                + [Update the plan of Analytics](public_cloud/data_analytics/analytics/analytics_update_cluster_plan)
                + [Set up logs forwarding for Analytics](public_cloud/data_analytics/analytics/analytics_logs_to_customer)
                + [Set up the Kubernetes operator for Analytics](public_cloud/data_analytics/analytics/analytics_kubernetes_operator)
                + [Fetch service metrics with Prometheus for Analytics](public_cloud/data_analytics/analytics/analytics_metrics_via_prometheus)
            + [Migration](public-cloud-data-analytics-kafka-migration)
                + [Reversibility Policy for the Managed Message Broker product](account_and_service_management/reversibility/14-reversibility-mdb)
            + [Tutorials](public-cloud-data-analytics-kafka-tutorials)
                + [Create publisher and consumer applications with Analytics with Kafka](public_cloud/public_cloud_databases/kafka_04_dev_python_basics)
            + [Security](public-cloud-data-analytics-kafka-security)
                + [Security overview for Analytics](public_cloud/data_analytics/analytics/information_01_security_overview)
                + [Responsibility model for Analytics](public_cloud/data_analytics/analytics/information_06_shared_responsibility)
            + [Troubleshooting](public-cloud-data-analytics-kafka-troubleshooting)
                + [Troubleshoot your Analytics](public_cloud/data_analytics/analytics/analytics_troubleshooting)
                + [Handle 'Disk Full' situations for Analytics](public_cloud/data_analytics/analytics/analytics_full_disk_handling)
        ...
        + [Common](public-cloud-data-analytics-common)
            + [Key concepts](public-cloud-data-analytics-common-key-concepts)
                ...
                + [Comparison of Analytics Engines Deployment Modes - Understanding 3-AZ / 1-AZ](public_cloud/data_analytics/analytics/analytics_regions_comparison)
                + [Automated Backups for Analytics](public_cloud/data_analytics/analytics/information_05_automated_backups)
                + [Understanding Analytics pricing](public_cloud/data_analytics/analytics/information_07_billing)
    ...
    + [AI & Machine Learning](products/public-cloud-ai-and-machine-learning)
        + [General information](public-cloud-ai-and-machine-learning-general-information)
            ...
            + [Reversibility Policy for the Managed Containers product](account_and_service_management/reversibility/21-ai-managed-containers-reversibility)
            + [FAQ - AI Tools](public_cloud/ai_machine_learning/gi_04_training_FAQ)
        + [Command Line Interface](public-cloud-ai-and-machine-learning-command-line-interface)
            ...
            + [CLI - Cheat Sheet](public_cloud/ai_machine_learning/gi_05_ovhai_cheatsheet)
        ...
        + [AI Notebooks](products/public-cloud-ai-and-machine-learning-ai-notebooks)
            ...
            + [Configuration](public-cloud-ai-and-machine-learning-ai-notebooks-configuration)
                ...
                + [AI Notebooks - Reversibility Policy for the Notebook Interface product](account_and_service_management/reversibility/20-ai-notebook-reversibility)
...
+ Web Cloud
    ...
    + [Video Center](web-cloud-video-center)
        + [Getting started](web-cloud-video-center-getting-started)
            + [Video Center - Manage your videos online](web_cloud/video_center/video-center-manage-videos)
...
+ Network
    ...
    + [OVHcloud Connect](products/network-ovhcloud-connect)
        + [Key Concepts](network-ovhcloud-connect-concepts)
            + [Introduction to OVHcloud Connect](network/ovhcloud_connect/ovhcloud-connect-what-is)
            + [OVHcloud Connect - Glossary](network/ovhcloud_connect/ovhcloud-connect-glossary)
            + [OVHcloud Connect - Providers](network/ovhcloud_connect/ovhcloud-connect-providers)
            + [OVHcloud Connect - PoPs and Regions](network/ovhcloud_connect/ovhcloud-connect-pop-locations-regions)
            + [Multi-AZ architectures for OVHcloud Connect](network/ovhcloud_connect/ovhcloud-connect-multi-az)
            + [OVHcloud Connect - SLAs](network/ovhcloud_connect/ovhcloud-connect-slas)
            + [OVHcloud Connect - Prerequisites & Limitations](network/ovhcloud_connect/ovhcloud-connect-prerequisites-limitations)
        + [Getting started](network-ovhcloud-connect-getting-started)
            + [Quick Start: Direct Connection to OVHcloud](network/ovhcloud_connect/ovhcloud-connect-quick-start-direct)
            + [Quick Start: Connection to OVHcloud with a Provider](network/ovhcloud_connect/ovhcloud-connect-quick-start-provider)
        + [Configuration](network-ovhcloud-connect-configuration)
            + [Order OVHcloud Connect Direct](network/ovhcloud_connect/ovhcloud-connect-order-direct)
            + [Order OVHcloud Connect Provider](network/ovhcloud_connect/ovhcloud-connect-order-provider)
            + [Cancel OVHcloud Connect Direct](network/ovhcloud_connect/ovhcloud-connect-cancel-direct)
            + [Cancel OVHcloud Connect Provider](network/ovhcloud_connect/ovhcloud-connect-cancel-provider)
            + [Associate an OVHcloud Connect to Your vRack](network/ovhcloud_connect/ovhcloud-connect-associate-vrack)
            + [Set up the vRack network for OVHcloud Connect](network/ovhcloud_connect/ovhcloud-connect-vrack-network-setup)
            + [Configure OVHcloud Connect L3 with BGP](network/ovhcloud_connect/ovhcloud-connect-l3-bgp)
            + [Configure OVHcloud Connect L3 with static routes](network/ovhcloud_connect/ovhcloud-connect-l3-static)
            + [Monitor Your OVHcloud Connect](network/ovhcloud_connect/ovhcloud-connect-monitor)
            + [Order or cancel a Cross Connect with an LOA](network/ovhcloud_connect/ovhcloud-connect-cross-connect-loa)
            + [Set up logs forwarding for OVHcloud Connect](network/ovhcloud_connect/ovhcloud-connect-log-forwarding)
            + [Automate OVHcloud Connect with API, CLI, and Terraform](network/ovhcloud_connect/ovhcloud-connect-automation)
        + [Tutorials](network-ovhcloud-connect-tutorials)
            + [Set up a simple OVHcloud Connect architecture](network/ovhcloud_connect/ovhcloud-connect-simple-architecture)
            + [Set up a resilient OVHcloud Connect architecture](network/ovhcloud_connect/ovhcloud-connect-resilient-architecture)
        + [Troubleshooting](network-ovhcloud-connect-troubleshooting)
            + [Troubleshoot OVHcloud Connect](network/ovhcloud_connect/ovhcloud-connect-troubleshooting)
            + [Declare and Follow Up Upon an Incident](network/ovhcloud_connect/ovhcloud-connect-incident-followup)
        + [Additional resources](network-ovhcloud-connect-technical-resources)
            + [OVHcloud Connect - Frequently Asked Questions (FAQ)](network/ovhcloud_connect/ovhcloud-connect-faq)
    ...
    + [Observability](products/manage-operate-observability)
        + [Logs Data Platform](products/observability-logs-data-platform)
            ...
            + [OVHcloud Service Logs](observability-logs-data-platform-services-logs)
                ...
                + [OVHcloud Connect Logs Forwarding](network/ovhcloud_connect/ovhcloud-connect-log-forwarding)
