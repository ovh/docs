    ...
    + [Public Cloud Databases](products/public-cloud-databases)
        + [PostgreSQL](products/public-cloud-databases-postgresql)
            ...
            + [Configuration](public-cloud-databases-postgresql-configuration)
                ...
                + [Setup the Kubernetes operator for Public Cloud Databases](public_cloud/public_cloud_databases/databases_12_operator)
                + [Setup service integration for Public Cloud Databases](public_cloud/public_cloud_databases/databases_07_cross_service_integration)
