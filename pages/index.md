...
+ Account and service management
    + [Account Information](account-and-service-management-account-information)
        ...
        + [Security and conformity](account-and-service-management-account-information-security-and-conformity)
            ...
            + [Hosted Private Cloud powered by VMware - Security Specifications](account_and_service_management/account_information/security-specification-privatecloud-VMware)
            + [SecNumCloud-qualified Hosted Private Cloud powered by VMware - Security Specifications](account_and_service_management/account_information/security-specification-privatecloud-SNC)
    ...
    + [Responsibility sharing](account-and-service-management-responsibility-sharing)
        ...
        + [SecNumcloud-qualified Hosted Private Cloud powered by VMware - Shared Responsibility](hosted_private_cloud/hosted_private_cloud_powered_by_vmware/SNC-responsibility-sharing)
...
+ Hosted Private Cloud
    + [Hosted Private Cloud powered by VMware](hosted-private-cloud-hosted-private-cloud-powered-by-vmware)
        + [Getting started](hosted-private-cloud-hosted-private-cloud-powered-by-vmware-getting-started)
            ...
            + [Responsibility sharing for the SecNumcloud-qualified Hosted Private Cloud powered by VMware service](hosted_private_cloud/hosted_private_cloud_powered_by_vmware/SNC-responsibility-sharing)
    ...
    + [SAP on OVHcloud](hosted-private-cloud-sap-ovhcloud)
        + [Concepts](hosted-private-cloud-sap-ovhcloud-concepts)
            + [SAP HANA on Bare Metal and SAP Application Servers on VMware on OVHcloud](cloud/sap/concept_dedicated_server_and_hpc)
            + [SAP infrastructure with VMware on OVHcloud solution](cloud/sap/concept_vmware_for_sap)`
        + [Getting started](hosted-private-cloud-sap-ovhcloud-getting-started)
            + [Install SAP HANA on Bare Metal with SLES 15 for SAP](cloud/sap/cookbook_install_sles_sap_hana_dedicated_server/)`
        + [Advanced usage](hosted-private-cloud-sap-ovhcloud-advanced-usage)
            + [Deploy virtual machines of SAP Application Server on VMware on OVHcloud solution with Terraform](cloud/sap/cookbook_terraform_sap_application_server)
            + [Deploy virtual machines of SAP HANA database on VMware on OVHcloud solution with Terraform](cloud/sap/cookbook_terraform_sap_hana_database)
            + [Deploy an SAP system infrastructure on VMware on OVHcloud solution with Terraform](cloud/sap/cookbook_terraform_sap_system)
            + [Deploy an SAProuter with NSX](cloud/sap/cookbook_vmware_saprouter)
            + [Deploy a virtual machine with SAP HANA and OVHcloud Backint Agent pre_installed](cloud/sap/cookbook_sap_hana_template_vmware)
            + [Deploy a SAP HANA cluster with SLES on VMware on OVHcloud](cloud/sap/cookbook_configure_sap_hana_cluster)
        + [Backups](hosted-private-cloud-sap-ovhcloud-backups)
            + [Install and use OVHcloud Backint Agent for SAP HANA](cloud/sap/cookbook_install_ovhcloud_backint_agent)
            + [Use OVHcloud Backint Agent with several S3 Object Storage buckets](cloud/sap/cookbook_configure_ovhcloud_backint_agent_several_buckets)
            + [Backup SAP HANA with Veeam Backup and Replication](cloud/sap/cookbook_veeam_backup_sap_hana)
+ Public Cloud
