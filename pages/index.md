    ...
    + [Analytics](products/public-cloud-data-analytics)
        ...
        + [Kafka](products/public-cloud-data-analytics-kafka)
            + [Guides](public-cloud-data-analytics-kafka-guides)
                + [Kafka - Capabilities and Limitations](public_cloud/data_analytics/analytics/kafka_01_capabilities)
                + [Kafka - Getting started](public_cloud/data_analytics/analytics/kafka_02_getting_started)
                + [Kafka - Advanced parameters references](public_cloud/data_analytics/analytics/kafka_03_advanced_parameters_references)
                + [Kafka - Python 101](public_cloud/data_analytics/analytics/kafka_04_dev_python_basics)
        + [Kafka Connect](products/public-cloud-data-analytics-kafka-connect)
            + [Guides](public-cloud-data-analytics-kafka-connect-guides)
                + [Kafka Connect - Capabilities and Limitations](public_cloud/data_analytics/analytics/kafkaconnect_01_capabilities)
                + [Kafka Connect - Advanced parameters references](public_cloud/data_analytics/analytics/kafkaconnect_02_advanced_parameters_references)
        + [Kafka MirrorMaker](products/public-cloud-data-analytics-kafka-mirrormaker)
            + [Guides](public-cloud-data-analytics-kafka-mirrormaker-guides)
                + [Kafka MirrorMaker - Capabilities and Limitations](public_cloud/data_analytics/analytics/mirrormaker_01_capabilities)
        + [OpenSearch](products/public-cloud-data-analytics-opensearch)
            + [Guides](public-cloud-data-analytics-opensearch-guides)
                + [OpenSearch - Capabilities and Limitations](public_cloud/data_analytics/analytics/opensearch_01_capabilities)
                + [OpenSearch - Getting started](public_cloud/data_analytics/analytics/opensearch_02_getting_Started)
                + [OpenSearch - Monitor your infra (with Logstash or Fluent Bit)](public_cloud/data_analytics/analytics/opensearch_200_elk_like)
                + [OpenSearch - Advanced parameters references](public_cloud/data_analytics/analytics/opensearch_03_advanced_parameters_references)
        + [Dashboards](products/public-cloud-data-analytics-grafana)
            + [Guides](public-cloud-data-analytics-grafana-guides)
                + [Dashboards - Capabilities and Limitations](public_cloud/data_analytics/analytics/grafana_01_capabilities)
                + [Dashboards - Configure your Dashboards instance to accept incoming connections](public_cloud/data_analytics/analytics/grafana_02_prepare_for_incoming_connections)
                + [Dashboards - Advanced parameters references](public_cloud/data_analytics/analytics/grafana_03_advanced_parameters_references)
            + [Tutorials](public-cloud-data-analytics-grafana-tutorials)
                + [Dashboards - Tutorial - Expose your Grafana in your private network via a reverse proxy NGINX](public_cloud/data_analytics/analytics/grafana_tuto_01_reverse_proxy)
                + [Dashboards - Tutorial - How to use the Dashboards API](public_cloud/data_analytics/analytics/grafana_tuto_02_using_api) 
