...
+ Bare Metal Cloud
    + [Dedicated Servers](products/bare-metal-cloud-dedicated-servers)
        ...
        + [Server Backup and Restore](bare-metal-cloud-dedicated-servers-backup-restore)
            ...
            + [Backing up a Bare Metal Server with Veeam Enterprise](bare_metal_cloud/dedicated_servers/veeam-enterprise-server-backup-realisation)
            + [Backing Up a Bare Metal Server Using Veeam Agent for Windows](bare_metal_cloud/dedicated_servers/veeam-enterprise-server-backup-windows-agent)
...
+ Public Cloud
    ...
    + [Data Platform](products/public-cloud-data-platform)
        ...
        + [Build your AI model from scratch](public-cloud-data-platform-build-an-ai-model-from-scratch)
            + [0 - Introduction](public_cloud/data_platform/tuto_02_build_an_ai_model_from_scratch_intro)
            + [1 - Prepare your dataset](public_cloud/data_platform/tuto_02_build_an_ai_model_from_scratch_step1)
            + [2 - Choose a training procedure](public_cloud/data_platform/tuto_02_build_an_ai_model_from_scratch_step2)
            + [3 - Fine-tune hyper-parameters](public_cloud/data_platform/tuto_02_build_an_ai_model_from_scratch_step3)
            + [4 - Select the best model](public_cloud/data_platform/tuto_02_build_an_ai_model_from_scratch_step4)
            + [5 - Setup deployment options](public_cloud/data_platform/tuto_02_build_an_ai_model_from_scratch_step5)
        + [Build your analytics app from scratch](public-cloud-data-platform-build-a-first-app-from-scratch)
            + [0 - Introduction](public_cloud/data_platform/tuto_01_build_a_first_app_from_scratch_intro)
            + [1 - Connect sources](public_cloud/data_platform/tuto_01_build_a_first_app_from_scratch_step1)
            + [2 - Organize data](public_cloud/data_platform/tuto_01_build_a_first_app_from_scratch_step2)
            + [3 - Prepare data](public_cloud/data_platform/tuto_01_build_a_first_app_from_scratch_step3)
            + [4 - Create queries](public_cloud/data_platform/tuto_01_build_a_first_app_from_scratch_step4)
            + [5 - Expose through API](public_cloud/data_platform/tuto_01_build_a_first_app_from_scratch_step5)
            + [6 - Visualize data](public_cloud/data_platform/tuto_01_build_a_first_app_from_scratch_step6)
+ Web Cloud
