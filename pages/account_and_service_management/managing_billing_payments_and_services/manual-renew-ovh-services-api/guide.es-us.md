...
Para utilizar la [función de renovación de la API](https://ca.api.ovh.com/console/#/service/{serviceId}/renew#GET), necesitará el **serviceId**. Puede obtener este dato con la función **serviceInfos**, como en el siguiente ejemplo:
