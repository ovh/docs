...
Se não registou nenhum [método de pagamento](/pages/account_and_service_management/managing_billing_payments_and_services/manage-payment-methods), receberá uma fatura por e-mail. Bastará, então, pagá-la online.
...
Se não pretender prolongar um destes serviços, basta [rescindir o serviço na Área de Cliente](/pages/account_and_service_management/managing_billing_payments_and_services/how_to_cancel_services).
...
> [!warning]
>
> Para mais informações sobre a rescisão dos serviços OVHcloud, siga as [instruções deste manual](/pages/account_and_service_management/managing_billing_payments_and_services/how_to_cancel_services).
>
