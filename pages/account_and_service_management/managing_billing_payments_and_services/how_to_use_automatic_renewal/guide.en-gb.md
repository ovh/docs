...
**Find out how to manage your services and their renewal via the OVHcloud Control Panel.**
...
- Being the [billing contact](/pages/account_and_service_management/account_information/managing_contacts#definition) of your OVHcloud services
- A valid payment method in your OVHcloud account. Read our guide [Managing your payment methods](/pages/account_and_service_management/managing_billing_payments_and_services/manage-payment-methods).
...
> **Automatic renewal**
>>
>> By default, when you subscribe your services, they are set to **automatic renewal**. This mode allows you to ensure that your services are systematically renewed when the subscription expires.
...
>> If you have not registered a [payment method](/pages/account_and_service_management/managing_billing_payments_and_services/manage-payment-methods), you will be sent an invoice via email. You will then need to pay it online.
>>
...
>>
>> **Warning**, the absence of a payment method in your account does not trigger an automatic cancelation of your services. To cancel services, please read our guide on [Canceling OVHcloud services](/pages/account_and_service_management/managing_billing_payments_and_services/how_to_cancel_services) .
>>
> **Manual renewal**
>>
...
>>
>> - if you are not sure whether you want to keep the service after its expiry date.
>> - if you do not want your bills to be debited automatically from your payment method.
>>
...
The **My services** page contains a table for managing your OVHcloud services. You can find their names, the type of service, service availability (`Active` by default), its status (renewal type, action to be taken, etc.), the next renewal or cancelation date of effect, and a `...`{.action} button dedicated to the possible actions for each service.
...
>>
>> For more information on canceling OVHcloud services, follow the instructions in our guide **[How to cancel your OVHcloud services ](/pages/account_and_service_management/managing_billing_payments_and_services/how_to_cancel_services)**.
>>
> **Renew service**
>>
...
> [!faq]
>
> I am asked to enter a NIC handle and password when I want to anticipate payment for my service. What is the NIC?
>> The NIC (or NIC-handle) is your OVHcloud customer ID, which is in the form of **xx11111-ovh**. The password requested is the password for accessing your OVHcloud account. If you have forgotten it, set up a new password it by following [these instructions](/pages/account_and_service_management/account_information/manage-ovh-password).
> Where can I find my OVHcloud NIC handle?
...
>> Once a service has been renewed, this renewal cannot be canceled. You can still choose another renewal type or cancel the service, but these 2 options will only be taken into account at the end of the current subscription, i.e. after the 12 months.
...
>> To protect yourself from unavailability of access for all your critical services, we recommend prioritizing automatic renewal and [check regularly that your payment methods are up to date](/pages/account_and_service_management/managing_billing_payments_and_services/manage-payment-methods).
