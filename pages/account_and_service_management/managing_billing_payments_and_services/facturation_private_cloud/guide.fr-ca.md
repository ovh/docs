...
Si vous conservez un hôte de la gamme Premier en facturation horaire tout un mois, le prix horaire de la ressource, tel qu’indiqué sur [cette page](/links/websiteenterprise/products/hosted-private-cloud/hosts/), sera appliqué. Le coût horaire n’est plus capé au prix mensuel.
...
La facturation se base sur le tableau des tarifs disponible sur [cette page](/links/websiteenterprise/products/hosted-private-cloud/images-licenses/).
