...
Si vous conservez un hôte de la gamme Premier en facturation horaire tout un mois, le prix horaire de la ressource, tel qu’indiqué sur [cette page](https://www.ovhcloud.com/fr-ca/enterprise/products/hosted-private-cloud/hosts/), sera appliqué. Le coût horaire n’est plus capé au prix mensuel.
