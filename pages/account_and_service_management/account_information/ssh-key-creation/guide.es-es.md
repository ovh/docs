...
*¹ La autenticación por clave SSH es un método de autenticación que utiliza claves criptográficas para verificar la identidad de un usuario o servicio. Esto proporciona una capa adicional de seguridad para proteger tus servicios en la nube.<!-- CP-STEPS-END:confirm-ssh-key -->
