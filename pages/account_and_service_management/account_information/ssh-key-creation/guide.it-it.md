...
<a name="ssh">[1]</a> *SSH (Secure Shell)*: un protocollo di rete crittografato che consente l'accesso remoto a sistemi informatici in modo sicuro.<!-- CP-STEPS-END:confirm-ssh-key -->
