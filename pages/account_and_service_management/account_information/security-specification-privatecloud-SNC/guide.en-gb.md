...
| **Componentt** | **SLA** | **Calculation method** | **Compensation** |
| --- | --- | --- | --- |
...
SLA for options like Veeam Managed Backups could be different, you can refer to Special Terms and Conditions of the option for more details. 
