...
- [Activer la méthode de double authentification par SMS](/pages/account_and_service_management/account_information/enable-2fa-with-sms).
- [Activer la méthode de double authentification par application mobile](/pages/account_and_service_management/account_information/enable-2fa-with-mobile-app).
- [Activer la méthode de double authentification par clé de sécurité](/pages/account_and_service_management/account_information/enable-2fa-with-security-key).
