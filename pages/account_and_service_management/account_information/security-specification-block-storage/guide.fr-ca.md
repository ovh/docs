...
| --- | --- | --- |
| Espace client | Logs sur toutes les interactions réalisées via des appels API, lancés par les contacts administrateur, technique ou de facturation, sur les services auxquels ils ont accès. |- </links/apiconsole/#/me> (voir `/me/api/logs`)<br>- [Liste des appels API lancés avec votre compte](/links/apiconsole/#/me/api/logs/self~GET)<br>- [Liste des appels API lancés sur des services auxquels vous avez accès](/links/apiconsole/#/me/api/logs/services~GET)<br>- [Obtenir vos logs d'audit](/links/apiconsole/#/me/logs/audit~GET) |
