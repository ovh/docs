...
To avoid waiting on the phone, please create a support request via the [OVHcloud Help Center](https://help.ovhcloud.com/csm?id=csm_cases_requests). Click on the button `Create a ticket`{.action}.

You can also refer to our documentation (FAQs, guides, diagnostic tools, etc.) in the [Help Center](https://help.ovhcloud.com/csm/asia-documentation?id=kb_home).
...
Create a support request in the [OVHcloud Help Center](https://help.ovhcloud.com/csm?id=csm_cases_requests) and attach your files.
