...
This guide explains how to connect your Enterprise File Storage service to a [vRack private network](https://www.ovhcloud.com/es-es/network/vrack/) using vRack Services and vRack Service Endpoint technology.
