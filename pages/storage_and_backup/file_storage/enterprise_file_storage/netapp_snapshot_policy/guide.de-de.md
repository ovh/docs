...
- **Direkter Link:** [Enterprise File Storage](/links/control-panel/storage-enterprise-file-storage)
- **Navigationspfad:** `Bare Metal Cloud`{.action} > `Enterprise File Storage`{.action}
