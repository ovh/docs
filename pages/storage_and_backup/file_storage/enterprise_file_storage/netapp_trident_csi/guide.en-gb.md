...
The installation uses Helm with specific images hosted on Docker Hub.
These images include a driver added by OVHcloud to control OVHcloud Enterprise File Storage resources.
