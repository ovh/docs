...
- Avoir monté votre NAS-HA au préalable en suivant le guide pour [monter votre NAS-HA via un partage NFS](/pages/storage_and_backup/file_storage/ha_nas/nas_nfs).
