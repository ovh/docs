...
- Haber montado previamente un NAS-HA siguiendo la guía para [montar un NAS-HA utilizando un NFS](/pages/storage_and_backup/file_storage/ha_nas/nas_nfs) compartido.
