...
/// details | Peut-on gérer le NAS-HA via un espace de configuration ?
...
/// details | Quel SLA est fourni avec NAS-HA ?
...
/// details | Quels protocoles de transfert de fichiers sont actuellement supportés sur la solution NAS-HA ?

NAS-HA supporte le transfert de fichiers via NFS (NFSv3, NFSv4.1, NFNSv4.2) ainsi que CIFS (SMB).

///

/// details | Depuis quels services OVHcloud puis-je pousser des données ?
...
/// details | Comment gère-t-on les accès au NAS-HA ?
...
/// details | NAS-HA est-il éligible à l’offre vRack ?
...
/// details | Quelles sont les capacités de stockage disponibles ?
...
/// details | Les ressources de mon NAS-HA me sont-elles dédiées ?
...
/// details | Quel est le nombre de partitions maximum par service ?
...
/// details | Le taux de transfert et de disponibilité est-il garanti ?
...
/// details | Le NAS-HA peut-il être connecté à plusieurs serveurs en même temps ?

Oui. Il est possible de faire interagir simultanément votre NAS avec plusieurs services OVHcloud.

///

/// details | Peut-on installer un système d’exploitation sur un NAS-HA ?

Non, il n'est pas possible d'installer un OS sur les offres NAS-HA.

///

/// details | L'espace alloué est-il partitionnable ?
...
/// details | Comment faire pour changer de capacité de stockage sur mon NAS-HA ?
...
/// details | Que sont les snapshots ?
...
/// details | Quelle politique de sauvegarde est associée à NAS-HA ?
...
/// details | Quelle est la fréquence des snapshots ? <a name="frequency"></a>
...
Vous pouvez aussi, à tout moment, créer des snapshots manuels, les conserver sans limitation de durée ou les supprimer. Cette fonctionnalité est disponible au sein de votre [espace client OVHcloud](/links/manager) ou via l'appel [API](/links/api) suivant :
...
/// details | Comment fonctionne le système de gestion des snapshots ?
...
/// details | Peut-on supprimer un snapshot ?
...
/// details | Les snapshots sont-ils compris dans la capacité d’un service ?
...
/// details | Où sont stockés les snapshots ?
...
/// details | Où puis-je récupérer mes snapshots ?
...
/// details | Combien de politiques de snapshots puis-je créer par volume ?
...
/// details | Quel type de tarification est lié au service ?

NAS-HA est un service facturé mensuellement au volume (de 3 à 144 To par paliers).

///

/// details | Pour quelle durée puis-je souscrire à un NAS-HA ?
