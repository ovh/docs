...
/// details | O que é a solução NAS-HA OVHcloud?
...
/// details | O que posso fazer com o NAS-HA?
...
/// details | É possível obter o NAS-HA através da área de gestão do serviço?
...
/// details | Qual é o SLA fornecido com o NAS-HA?
...
/// details | Que protocolos de transferência de ficheiros são atualmente suportados na solução NAS-HA?

O NAS-HA suporta a transferência de ficheiros através do NFS (NFSv3, NFSv4.1, NFNSv4.2) e do CIFS (SMB).

///

/// details | A partir de que serviços OVHcloud posso cultivar dados?
...
/// details | Como gerir os acessos ao NAS-HA?
...
/// details | O serviço NAS-HA é compatível com outros servidores fora da OVHcloud?

Não, o NAS-HA só pode ser acedido através da rede OVHcloud.

///

/// details | O NAS-HA é elegível para a oferta vRack?
...
/// details | Quais as opções em termos de espaço de armazenamento?
...
/// details | Os recursos NAS-HA são dedicados?
...
/// details | Quantos serviços NAS-HA posso criar a partir da minha conta de cliente?

Não há limite de número de serviços por conta de cliente.

///

/// details | Qual é o número máximo de partições por serviço?
...
/// details | A taxa de transferência e a disponibilidade são garantidas?
...
/// details | Qual é a política de backup associada ao NAS-HA?
...
/// details | Qual é a frequência das snapshots? <a name="frequency"></a>
...
Também pode criar Snapshots manuais a qualquer momento. Esta funcionalidade está disponível no seio do seu [Espaço Cliente OVHcloud](/links/manager) ou através da [API](/links/api) seguinte:
...
/// details | Como funciona a gestão das Snapshots?
...
/// details | Posso eliminar uma Snapshot?
...
/// details | As snapshots estão incluídas na capacidade de um serviço?
...
/// details | Onde estão armazenadas as snapshots?
...
/// details | Como aceder às Snapshots?
...
/// details | Quantas políticas de snapshots posso criar por volume?
...
/// details | Que tipo de preços está associado ao serviço?

NAS-HA é um serviço faturado mensalmente ao volume (de 3 a 144 TB por patamares).

///

/// details | Quais são os períodos de subscrição do NAS-HA?
