...
/// details | Was ist die HA-NAS Lösung von OVHcloud?
...
/// details | Was kann ich mit HA-NAS tun?
...
/// details | Kann das HA-NAS über eine Verwaltungsoberfläche genutzt werden?
...
/// details | Welche Dateiübertragungsprotokolle werden derzeit auf der HA-NAS unterstützt?

HA-NAS unterstützt den Transfer von Dateien über NFS (NFSv3) und CIFS (SMB).

///

/// details | Aus welchen OVHcloud Diensten kann ich Daten übertragen?
...
/// details | Wie werden HA-NAS-Zugänge verwaltet?
...
/// details | Ist HA-NAS mit anderen Servern außerhalb von OVHcloud kompatibel?

Nein, der Zugriff auf Ihr HA-NAS ist nur über das OVHcloud Netzwerk möglich.

///

/// details | Ist HA-NAS für die Nutzung mit vRack geeignet?
...
/// details | Sind die Ressourcen meines HA-NAS dediziert?
...
/// details | Wie viele HA-NAS Dienstleistungen kann ich über meine Kundenkennung erstellen?

Es gibt keine Begrenzung der Anzahl der Dienstleistungen pro Kunden-Account.

///

/// details | Wie viele Partitionen können maximal pro Dienstleistung erstellt werden?
...
/// details | Ist die Transfer- und Verfügbarkeitsrate garantiert?
...
/// details | Kann ein HA-NAS an mehrere Server gleichzeitig angeschlossen werden?

Ja. Ihr HA-NAS kann gleichzeitig mit mehreren OVHcloud-Diensten interagieren.

///

/// details | Kann ich ein Betriebssystem auf einem HA-NAS installieren?

Nein, es ist nicht möglich, ein Betriebssystem auf den HA-NAS Diensten zu installieren.

///

/// details | Ist der zugewiesene Speicherplatz partitionierbar?
...
/// details | Wie ändere ich die Speicherkapazität meines NAS-HA?
...
/// details | Welche Backup-Policy ist mit HA-NAS verbunden?
...
/// details | Wie oft werden Snapshots erstellt? <a name="frequency"></a>
...
Sie können auch jederzeit manuelle Snapshots erstellen, zeitlich unbegrenzt speichern oder löschen. Diese Funktion ist in Ihrem [OVHcloud Kundencenter](/links/manager) oder über folgenden [API-Aufruf](/links/api) verfügbar:
...
/// details | Wie funktioniert das Snapshot-Management-System?
...
/// details | Kann ein Snapshot gelöscht werden?
...
/// details | Sind Snapshots in der Kapazität eines Dienstes enthalten?
...
/// details | Wie viele Snapshots kann ich maximal erstellen?
...
/// details | Wo werden die Snapshots gespeichert?
...
/// details | Wo kann ich meine Snapshots einsehen?
...
/// details | Wie viele Snapshot-Richtlinien kann ich pro Volume erstellen?
...
/// details | Welche Art von Abrechnung wird auf den Dienst angewendet?

HA-NAS ist ein Dienst, der monatlich nach Volumen abgerechnet wird (in Schritten von 3 bis 144 TB).

///

/// details | Für wie lange kann ich einen HA-NAS abonnieren?
