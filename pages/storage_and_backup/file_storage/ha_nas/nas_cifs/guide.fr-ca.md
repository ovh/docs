...
- Un [serveur dédié](/links/websitebare-metal/) **ou** un [VPS](/links/websitevps/) **ou** une [instance Public Cloud](/links/websitepublic-cloud/) avec une distribution Windows.
