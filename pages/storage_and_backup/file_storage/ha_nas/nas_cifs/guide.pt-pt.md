...
- Um [servidor dedicado](/links/websitebare-metal/) **ou** um [VPS]/links/websitevps/) **ou** uma [instância Public Cloud](/links/websitepublic-cloud/) com uma distribuição Windows.
...
Se precisar de formação ou de assistência técnica para implementar as nossas soluções, contacte o seu representante comercial ou clique em [esta ligação](/links/websiteprofessional-services/) para obter um orçamento e solicitar uma análise personalizada do seu projecto aos nossos especialistas da equipa de Serviços Profissionais.
