...
- Un [servidor dedicado](/links/websitebare-metal/) **o** un [VPS](/links/websitevps/) **o** una [instancia de Public Cloud](/links/websitepublic-cloud/) con una distribución Windows.
