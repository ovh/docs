...
To find your Vaults, log in to the [OVHcloud Control Panel](/links/manager), go to `Bare Metal Cloud`{.action} and then `Backup Agent`{.action}. Click on the `Vaults`{.action} tab.
