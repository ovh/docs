...
Aby znaleźć swoje Vault, zaloguj się do [Panelu klienta OVHcloud](/links/manager), przejdź do `Bare Metal Cloud`{.action}, a następnie do `Backup Agent`{.action}. Kliknij kartę `Vaults`{.action}.
