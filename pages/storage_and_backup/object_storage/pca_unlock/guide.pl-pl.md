...
Kliknij sekcję `Cloud Archive`{.action} w menu po lewej stronie.
...
Twój plik będzie dostępny do pobrania po tym czasie. Pobieranie można wówczas rozpocząć bezpośrednio przez przeglądarkę lub przez [klienta Swift/SFTP/SCP](/pages/storage_and_backup/object_storage/pca_sftp).
