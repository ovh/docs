...
Si vous ne connaissez plus votre mot de passe d'utilisateur OpenStack, vous pouvez le modifier en suivant [ce guide](/pages/public_cloud/public_cloud_cross_functional/create_and_delete_a_user).
