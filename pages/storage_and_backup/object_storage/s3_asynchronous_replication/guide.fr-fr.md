...
_<sup>1</sup>: Pour répliquer des objest qui ont été téléversés avant la création de la configuration de réplication, utilisez Batch Replication. Pour en savoir plus sur la configuration de Batch Replication, consultez [Réplication des objets existants](#bacthReplication)._
