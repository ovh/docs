...
>> 
>> The tab displays the following informations for each job :
>> - ID: a unique ID that identifies a job
>> - Creation date: the job creation timestamp in MM/dd/aaaa HH:mm format
...
>> - Completed: the number of objectss that have been replicated
