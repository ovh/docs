...
- **Exact replica creation and Replicate data within the same region**

![Schema 1](images/1.png)

- **Replicate data to a different region and Replicate data to two different regions**
...
If you need training or technical assistance to implement our solutions, contact your sales representative or click on [this link](https://www.ovhcloud.com/en-gb/support-levels/professional-services/) to get a quote and ask our Professional Services experts for a custom analysis of your project.
