...
| Attribute                                            | Required | Description 
| ---------------------------------------------------- | -------- | ------------
| Transitions                                          | yes*     | An array of lifecycle operations that automatically copy all selected objects (current versions only, if versioning is enabled) from their current storage tier to a most-effective storage tier. |
