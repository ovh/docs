...
/// details | Abandonner les téléversements multi-parties incomplets
...
/// details | Vider un bucket non-versionné
...
/// details | Vider un bucket versionné.
...
| Attribut                                             | Requis   | Description 
| ---------------------------------------------------- | -------- | ------------
| Transitions                                          | oui*     | Un tableau d'opérations lifecycle qui copient automatiquement tous les objets sélectionnés (seulement les versions courantes s'il s'agit d'un bucket versionné) de leur niveau de stockage actuel vers le niveau de stockage le plus efficace. |
