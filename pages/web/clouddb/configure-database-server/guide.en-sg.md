...
- A [Web Cloud Databases instance](https://www.ovh.co.uk/cloud/cloud-databases/) (included in a [Performance web hosting plan](https://www.ovhcloud.com/en-sg/web-hosting/)).
...
To log in via **SFTP**, you can do so via the FileZilla software, using [this guide](https://docs.ovh.com/sg/en/hosting/web_hosting_filezilla_user_guide/).
