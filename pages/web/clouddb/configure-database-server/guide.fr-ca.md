...
Pour vous y connecter en **SFTP**, vous pouvez le faire via le logiciel Filezilla en vous aidant du guide: [« Utilisation du logiciel FileZilla avec votre hébergement »](https://docs.ovh.com/ca/fr/mutualise-guide-utilisation-filezilla/).
...
[Liste des adresses IP des clusters et hebergements web](https://docs.ovh.com/ca/fr/liste-des-adresses-ip-des-clusters-et-hebergements-web/)
