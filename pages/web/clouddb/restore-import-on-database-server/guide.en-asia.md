...
- A [Web Cloud Databases instance](https://www.ovh.co.uk/cloud/cloud-databases/) (included in a [Performance web hosting plan](https://www.ovhcloud.com/asia/web-hosting/)) in your OVHcloud account
...
To import your database directly from phpMyAdmin, you will need to log in to the interface first. To do this, you can refer to the [section in this guide](https://docs.ovh.com/asia/en/clouddb/connecting-to-database-on-database-server/#logging-in-to-a-mysql-or-mariadb-database).
...
This action is only possible via [SSH](https://docs.ovh.com/asia/en/hosting/web_hosting_ssh_on_web_hosting_packages/) from an OVHcloud Web Hosting plan.
...
This action is only possible via [SSH](https://docs.ovh.com/asia/en/hosting/web_hosting_ssh_on_web_hosting_packages/) from an OVHcloud Web Hosting plan, in stable or higher versions.
