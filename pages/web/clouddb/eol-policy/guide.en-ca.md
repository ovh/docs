...
- One of the included databases with a [Web Hosting plan](https://www.ovhcloud.com/en-ca/web-hosting/).
- A [Web Cloud Databases instance](https://www.ovh.co.uk/cloud/cloud-databases/){.external} (included in a [Performance Web Hosting](https://www.ovhcloud.com/en-ca/web-hosting/) offer).
- A [Start SQL](https://www.ovhcloud.com/en-ca/web-hosting/options/start-sql/) database pack.
...
- Web Cloud Databases Web Hosting services (also known as Private SQL services), dedicated DBMS instances that can be reached via the Web Hosting network ([see announcements](https://docs.ovh.com/ca/en/hosting/sql_eos_eol/)).
- SharedSQL Web Hosting services, MySQL databases that can be reached through the Web Hosting network ([see announcements](https://docs.ovh.com/ca/en/hosting/sql_eos_eol/)).
