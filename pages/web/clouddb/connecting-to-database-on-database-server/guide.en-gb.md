...
> [!warning]
>
> If you use a `Cloud DB`/`Private SQL` offer, do not forget to authorise your IP using the guide on [Configuring your database server](https://docs.ovh.com/gb/en/clouddb/configure-optimise-database-server/).
>
