...
- You need to have read the [Web Cloud Databases startup guide](https://docs.ovh.com/gb/en/clouddb/getting-started-with-clouddb/).
...
Please also read our guide on [getting started with the Web Cloud Databases service](https://docs.ovh.com/gb/en/clouddb/getting-started-with-clouddb/).
