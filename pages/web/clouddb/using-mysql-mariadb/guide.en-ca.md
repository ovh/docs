...
- A [Web Cloud Databases instance](https://www.ovh.co.uk/cloud/cloud-databases/){.external} (included in a [performance web hosting plan](https://www.ovhcloud.com/en-ca/web-hosting/)).
- Access to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca){.external}.
- You need to have read the [Web Cloud Databases startup guide](https://docs.ovh.com/ca/en/clouddb/getting-started-with-clouddb/).
...
All this information is available in the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca).

Please also read our guide on [getting started with the Web Cloud Databases service](https://docs.ovh.com/ca/en/clouddb/getting-started-with-clouddb/).
