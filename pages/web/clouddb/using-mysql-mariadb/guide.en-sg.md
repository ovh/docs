...
- A [Web Cloud Databases instance](https://www.ovh.co.uk/cloud/cloud-databases/){.external} (included in a [performance web hosting plan](https://www.ovhcloud.com/en-sg/web-hosting/)).
...
- You need to have read the [Web Cloud Databases startup guide](https://docs.ovh.com/sg/en/clouddb/getting-started-with-clouddb/).
...
Please also read our guide on [getting started with the Web Cloud Databases service](https://docs.ovh.com/sg/en/clouddb/getting-started-with-clouddb/).
