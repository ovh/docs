...
- Avoir consulté le [guide de démarrage de Web Cloud Databases](https://docs.ovh.com/ca/fr/debuter-avec-clouddb/)
...
Toutes ces informations sont disponibles dans votre [espace client OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc){.external}.

Un guide est également disponible : [Premiers pas avec le service Web Cloud Databases](https://docs.ovh.com/ca/fr/debuter-avec-clouddb/)
