...
- Tener un [dominio .uk](https://www.ovh.es/dominios/) registrado con OVHcloud.
...
Conéctese al [Panel de configuración de OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es) y seleccione `Web Cloud`{.action} en la columna izquierda. Haga clic en `Dominios`{.action} en la columna de la izquierda y seleccione el dominio correspondiente.
