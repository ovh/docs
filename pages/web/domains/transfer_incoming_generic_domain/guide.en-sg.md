...
> [!warning]
>
> Be careful, if the domain is already registered with OVHcloud, you don't actually need to make an incoming transfer but [a change of "administrator", "technical" and/or "billing" contacts](https://docs.ovh.com/sg/en/customer/managing-contacts/) for your domain name.
>
> In fact, real domain name transfers are only carried out between registrars such as OVHcloud.
>
> If the ownership of the domain needs to be changed as well, don't forget to do this **before** changing the contacts of your domain using our [changing domain name owner](https://docs.ovh.com/sg/en/domains/how-to-change-domain-name-holder/) documentation.
>
