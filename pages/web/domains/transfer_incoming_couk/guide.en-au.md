...
> [!warning]
>
> Be careful, if the domain is already registered with OVHcloud, you don't actually need to make an incoming transfer but [a change of "administrator", "technical" and/or "billing" contacts](https://docs.ovh.com/au/en/customer/managing-contacts/) for your domain name.
>
> In fact, real domain name transfers are only carried out between registrars such as OVHcloud.
>
> If the ownership of the domain needs to be changed as well, don't forget to do this **before** changing the contacts of your domain using our [changing domain name owner](https://docs.ovh.com/au/en/domains/how-to-change-domain-name-holder/) documentation.
>
...
>
> This guide is designed to assist you in common tasks as much as possible. Nevertheless, we recommend that you contact a [specialist service provider](https://partner.ovhcloud.com/en-au/directory/) and/or discuss the issue with our community on if you face difficulties or doubts. You can find more information in the [Go further](#gofurther) section of this guide.
>
...
Your domain will then be available in your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au) within a few hours.
