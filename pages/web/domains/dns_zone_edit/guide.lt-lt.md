...
[Adding an SPF record to your domain name’s configuration](https://docs.ovh.com/lt/domains/svetainiu_talpinimas_spf_laukas/){.external}.

[Protect your data from DNS cache poisoning with DNSSEC](https://www.ovh.lt/domenai/paslauga_dnssec.xml){.external}.
