...
- Disponer de los permisos [necesarios para gestionar](/pages/account/customer/managing_contacts){.external} el dominio desde el [área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es){.external}.
