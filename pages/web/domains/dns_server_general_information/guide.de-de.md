...
- Sie verfügen über die [entsprechenden Berechtigungen](/pages/account/customer/managing_contacts){.external} für die Verwaltung der Domain über Ihr [OVHcloud Kundencenter](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de).
