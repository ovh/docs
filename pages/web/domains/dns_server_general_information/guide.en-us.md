...
First, log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we), click `Domains`{.action}, then choose the domain name concerned. Go to the `DNS servers`{.action} tab.
