...
- [Add an OVHcloud](#spfrecordovhcloud) **SPF record and use the OVHcloud** configuration: for users who only have OVHcloud email offers on their domain name (excluding [Private Exchange](https://www.ovhcloud.com/en-gb/emails/hosted-exchange/){.external} and Exchange Provider).
...
- MX Plan alone or included in an OVHcloud web [hosting plan](https://www.ovhcloud.com/en-gb/web-hosting/){.external}.
