...
>
> If your domain name is registered with OVH, you can check if it is using the OVH configuration in your [Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie){.external}. Select the domain and go to the `DNS servers`{.action} tab.
>
...
- MX Plan (as a standalone, or part of our [OVH Web Hosting solution](https://www.ovh.lt/svetainiu-talpinimas/){.external});
- [Email Pro](https://www.ovh.lt/El_pastas/email-pro/){.external};
- [Hosted Exchange](https://www.ovh.lt/El_pastas/hosted-exchange/){.external}.
...
[General information on DNS servers](https://docs.ovh.com/lt/domains/svetainiu_talpinimas_bendra_informacija_apie_dns_serverius/){.external}.
