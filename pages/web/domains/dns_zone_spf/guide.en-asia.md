...
>
> - Outgoing Mail Server **A** is listed in the SPF record, so the email will be sent normally in the recipient's inbox.
> - Outgoing Mail Server **B** is not listed in the SPF record, so the email sent from this server will be marked as suspicious in the inbox. This can result in `[SPAM]` being mentioned in the subject of the email, being placed in a `Junk` mail folder, or being deleted directly, depending on the rules of the incoming server.
>
...
- You must have access to manage the domain name from your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia){.external}.
...
>
> If your domain name is registered with OVHcloud, you can check if it is using the OVHcloud configuration in your [Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia). Click on the `DNS servers`{.action} tab of your domain name.
>
...
Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia) and switch to `Web Cloud`{.action} in the top navigation bar. In the `Domains`{.action} section, select the domain name concerned. Click on the `DNS zone`{.action} tab.
...
- [Add an OVHcloud](#spfrecordovhcloud) **SPF record and use the OVHcloud** configuration: for users who only have OVHcloud email offers on their domain name (excluding [Private Exchange](https://www.ovhcloud.com/asia/emails/hosted-exchange/){.external} and Exchange Provider).
...
- MX Plan alone or included in an OVHcloud web [hosting plan](https://www.ovhcloud.com/asia/web-hosting/){.external}.
- [Hosted Exchange](https://www.ovhcloud.com/asia/emails/hosted-exchange/).
...
- MX Plan alone or included in an OVHcloud web [hosting plan](https://www.ovhcloud.com/en-gb/web-hosting/).
