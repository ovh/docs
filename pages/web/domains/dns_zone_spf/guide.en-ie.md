...
- access to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie) with the necessary permissions to manage the domain's DNS
...
- MX Plan standalone or included in an OVHcloud [Web Hosting plan](https://www.ovhcloud.com/en-ie/web-hosting/){.external};
- [Email Pro](https://www.ovhcloud.com/en-ie/emails/email-pro/){.external};
- [Hosted Exchange](https://www.ovhcloud.com/en-ie/emails/hosted-exchange/){.external}.
...
This configuration does not apply to Provider Exchange or [Private Exchange solutions](https://www.ovhcloud.com/en-ie/emails/hosted-exchange/){.external}.
...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie) and switch to `Web Cloud`{.action} in the top navigation bar. In the `Domains`{.action} section on the left-hand side, select the domain name concerned. Click on the `DNS zone`{.action} tab.
