...
- MX Plan (as a standalone, or part of our [OVH Web Hosting solution](https://www.ovh.ie/web-hosting/){.external});
...
[General information on DNS servers](https://docs.ovh.com/ie/en/domains/web_hosting_general_information_about_dns_servers/){.external}.
