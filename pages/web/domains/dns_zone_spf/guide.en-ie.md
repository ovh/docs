...
- MX Plan standalone or included in an OVHcloud [Web Hosting plan](https://www.ovh.ie/web-hosting/){.external};
- [Email Pro](https://www.ovh.ie/emails/email-pro/){.external};
- [Hosted Exchange](https://www.ovh.ie/emails/hosted-exchange/){.external}.
...
This configuration does not apply to Provider Exchange or [Private Exchange solutions](https://www.ovh.ie/emails/hosted-exchange/){.external}.
