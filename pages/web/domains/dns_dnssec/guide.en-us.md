...
To start with, log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we){.external}, and go to the "Web" section. Click `Web hosting`{.action}, then choose the domain name concerned from the list.
