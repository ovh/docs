...
This route will add the new name servers on the domain name and trigger a `DomainDnsUpdate` synchronisation task on the registry side. You will be able to track this task via the [dedicated APIs](/pages/web/domains/api_domain_intro-tasks/#view-pending-tasks).
...
You will be able to track this task via the [dedicated APIs](/pages/web/domains/api_domain_intro-tasks/#view-pending-tasks).
...
You will be able to track this task via the [dedicated APIs](/pages/web/domains/api_domain_intro-tasks/#view-pending-tasks), and you will not have to re-declare the name server on the domain name.
