...
It works in the same way as any other OVHcloud service. More details explaining the workflow, as well as how to do this, can be found on [this page](https://docs.ovh.com/pt/customer/gestao_dos_contactos/).
