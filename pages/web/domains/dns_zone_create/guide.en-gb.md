...
|No|Select this option if you are planning to use OVHcloud services like a [Web Hosting plan](https://www.ovhcloud.com/en-gb/web-hosting/){.external}, since the zone has already been pre-configured.|
