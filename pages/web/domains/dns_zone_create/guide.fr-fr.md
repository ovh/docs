...
Pour démarrer cette manipulation, connectez-vous à votre [espace client OVH](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr){.external}, cliquez sur `Commander`{.action} dans la barre de services à gauche, puis sur `Zone DNS`{.action}.
...
|Non|Sélectionnez ce choix si vous prévoyez d'utiliser des services OVH comme un [hébergement web](https://www.ovhcloud.com/fr/web-hosting/){.external}, la zone étant préconfigurée à cet effet.|
