...
|No|Select this option if you are planning to use OVH services like a [Web Hosting plan](https://www.ovhcloud.com/en-ie/web-hosting/){.external}, since the zone has already been pre-configured.|
