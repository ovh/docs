...
>
> - Verify that you are up to date with [payments](https://docs.ovh.com/gb/en/billing/manage-ovh-bills/#pay-bills) and domain name [renewals](https://docs.ovh.com/gb/en/billing/how-to-use-automatic-renewal-at-ovh/#renewal-management).
...
In the `Domain names`{.action} section, select the domain name concerned, then click the `DNS servers`{.action} tab. In this tab, [edit your DNS servers](https://docs.ovh.com/gb/en/domains/web_hosting_general_information_about_dns_servers/). 
...
[Transferring a domain name to another registrar](https://docs.ovh.com/gb/en/domains/outgoing-transfer-of-generic-or-geographical-domain-name/)
