...
In your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia), go to the `Web Cloud`{.action} section, then `Domain names`{.action}. Click on `Ongoing operations`{.action} above the list of domain names.
...
>
> - Verify that you are up to date with [payments](https://docs.ovh.com/asia/en/billing/manage-ovh-bills/#pay-bills) and domain name [renewals](https://docs.ovh.com/asia/en/billing/how-to-use-automatic-renewal-at-ovh/#renewal-management).
...
In the `Domain names`{.action} section, select the domain name concerned, then click the `DNS servers`{.action} tab. In this tab, [edit your DNS servers](https://docs.ovh.com/asia/en/domains/web_hosting_general_information_about_dns_servers/). 
...
[Transferring a domain name to another registrar](https://docs.ovh.com/asia/en/domains/outgoing-transfer-of-generic-or-geographical-domain-name/)

[Editing the DNS servers for an OVHcloud domain name](https://docs.ovh.com/asia/en/domains/web_hosting_general_information_about_dns_servers/)
