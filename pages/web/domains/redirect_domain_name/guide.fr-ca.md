...
> Pour créer ce type de redirection, vous devrez obligatoirement passer par [une réécriture d'URL](https://docs.ovh.com/ca/fr/hosting/htaccess-reecriture-url-mod-rewrite/) via un fichier « .htaccess » par exemple.
>
...
>
> Pour plus d'informations sur les entrées DNS, consultez notre documentation sur les [enregistrements DNS](https://docs.ovh.com/ca/fr/domains/editer-ma-zone-dns/).
>
...
[Bloquer l’accès à mon site pour certaines adresses IP via un fichier « .htaccess » ](https://docs.ovh.com/ca/fr/hosting/mutualise-htaccess-comment-bloquer-certaines-ip-au-niveau-de-mon-site/).
...
[Comment éditer ma zone DNS ?](https://docs.ovh.com/ca/fr/domains/editer-ma-zone-dns/)
