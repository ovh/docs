...
Once you have logged in to your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca){.external}, click your domain name in the `Domains`{.action} section. Then click the `Redirection`{.action} tab in the page that opens.
