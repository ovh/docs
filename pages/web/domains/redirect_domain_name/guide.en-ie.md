...
You can also do this if your domain name uses OVH configuration, by modifying it within the Control Panel (see [How to edit my DNS zone](../web_hosting_how_to_edit_my_dns_zone/){.external}).
