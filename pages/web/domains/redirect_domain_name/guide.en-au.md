...
> To create this type of redirection, you will have to apply [a URL rewrite](https://docs.ovh.com/au/en/hosting/htaccess_url_rewriting_using_mod_rewrite/), for example by editing a ".htaccess" file. 
>
...
>
> For more information on DNS records, see our [DNS records](https://docs.ovh.com/au/en/domains/web_hosting_how_to_edit_my_dns_zone/).
>
...
[Protecting your website’s administration interface with a .htaccess file](https://docs.ovh.com/au/en/hosting/how_to_password_protect_a_directory_on_your_website/).

[URL rewriting using mod_rewrite](https://docs.ovh.com/au/en/hosting/htaccess_url_rewriting_using_mod_rewrite/).

[Using .htaccess for advanced purposes](https://docs.ovh.com/au/en/hosting/what_else_can_you_do_with_the_htaccess_file/).
