...
With your website’s domain name, you can configure its DNS zone. To do this, log into the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg){.external} and select the `Domains` section, then click on your domain name and the `DNS zone`{.action} tab. 
