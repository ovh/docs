...
A continuación se indica la configuración MX de OVH que deberá utilizar para su MX Plan (solo o incluido en un [plan de hosting de OVH](https://www.ovh.es/hosting/){.external}), [Email Pro](https://www.ovh.es/emails/email-pro/){.external} o [Exchange](https://www.ovh.es/emails/){.external}. Le recordamos que nuestros servidores de correo disponen de antispam y antivirus.
