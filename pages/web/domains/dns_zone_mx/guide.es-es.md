...
excerpt: 'Cómo añadir un registro MX a la configuración de un dominio en OVH'
...
**Esta guía explica cómo añadir un registro MX a la configuración de un dominio en OVH.**
...
Los registros MX permiten asociar un dominio al servidor de un proveedor de correo, como OVH. Cuando una persona envía un mensaje de correo electrónico, el servidor que realiza el envío sabe a qué servidor debe dirigirlo gracias al registro MX.
...
### 2. Conocer la configuración MX de OVH

A continuación se indica la configuración MX de OVH que deberá utilizar para su MX Plan (solo o incluido en un [plan de hosting de OVH](https://www.ovhcloud.com/es-es/web-hosting/){.external}), [Email Pro](https://www.ovhcloud.com/es-es/emails/email-pro/){.external} o [Exchange](https://www.ovhcloud.com/es-es/emails/){.external}. Le recordamos que nuestros servidores de correo disponen de antispam y antivirus.
...
- **Si tiene contratada una solución de correo de OVH**, consulte la información del paso [2. Conocer la configuración MX de OVH](https://docs.ovh.com/es/domains/anadir-registro-mx-configuracion-dominio/#2-conocer-la-configuracion-mx-de-ovh){.external}.
