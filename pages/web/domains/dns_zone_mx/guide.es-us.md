...
- **Si tiene contratada una solución de correo de OVHcloud**, consulte la información del paso [2. Conocer la configuración MX de OVHcloud](/pages/web/domains/dns_zone_mx#2-conocer-la-configuracion-mx-de-ovhcloud){.external}.
