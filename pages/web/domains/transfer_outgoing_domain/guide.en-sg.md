...
> [!warning]
>
> Be careful, if the domain is already registered with OVHcloud, you don't actually need to make an outgoing transfer but [a change of "administrator", "technical" and/or "billing" contacts](https://docs.ovh.com/sg/en/customer/managing-contacts/) for your domain name.
>
...
[Transferring a .uk domain name to another registrar](https://docs.ovh.com/sg/en/domains/outgoing_couk_domain_name_transfer/)
