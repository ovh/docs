...
> [!warning]
>
> Warning, if the domain is already registered with OVHcloud, you do not need to make an outgoing transfer but [a change of "administrator", "technical" and/or "billing" contacts](https://docs.ovh.com/sg/en/customer/managing-contacts/) for your domain name.
>
