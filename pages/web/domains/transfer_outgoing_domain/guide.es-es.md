...
Conéctese al [área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager) y seleccione `Web Cloud`{.action} en la barra de navegación superior. En la columna izquierda, haga clic en `Dominios`{.action} y seleccione el dominio correspondiente.
