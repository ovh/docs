...
Se desejar associar o seu endereço de e-mail a um software de correio eletrónico ou a um dispositivo, como um smartphone ou tablet, [consulte os nossos manuais de configuração](/pt/emails-pro/). Se pretender obter mais informações sobre os elementos necessários para configurar a sua conta E-mail Pro, consulte as configurações que deverá utilizar:
...
[Utilizar o Outlook Web App com uma conta de e-mail](/pages/web/microsoft-collaborative-solutions/owa_user_guide)

[Criar regras inbox no OWA](/pages/web/microsoft-collaborative-solutions/creating-inbox-rules-in-owa)
