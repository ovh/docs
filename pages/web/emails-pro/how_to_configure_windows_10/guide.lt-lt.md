...
OVH also offers a web application that includes various [collaborative features](https://www.ovh.lt/El_pastas/email-pro/){.external}. You can access this application at <https://mail.ovh.net/lt/>. Log in using your email credentials.
