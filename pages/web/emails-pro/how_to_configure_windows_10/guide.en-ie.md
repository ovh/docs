...
- You must have an [Email Pro](https://www.ovh.ie/emails/email-pro/){.external} account.
...
[Configuring an email address included in an MX Plan package or web hosting plan in the Mail application for Windows 10](https://docs.ovh.com/ie/en/emails/mail-configuration-windows-10/){.external}

[Configuring your Exchange account in the Mail app for Windows 10](https://docs.ovh.com/ie/en/microsoft-collaborative-solutions/mail-configuration-windows-10/){.external}
