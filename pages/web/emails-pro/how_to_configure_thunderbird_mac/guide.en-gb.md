...
**Find out how to configure your Email Pro  address on Thunderbird on macOS.**
...
| | |
|---|---|
|![Thunderbird](images/thunderbird-mac-emailpro01.png){.thumbnail}|In the window that appears, enter the following 3 information: <br>- Your display name<br>- Email <br>- Password|
|Then click `Configure manually...`{.action} to enter the **INCOMING** server settings: <br>- **IMAP protocol** <br>- Server **pro?.mail.ovh.net** (replace “**?**” with your server number)<br>- Port **993** <br>- SSL **SSL/TLS** <br>- Authentication **Normal password** <br>- Identifying **your full email address**|![Thunderbird](images/thunderbird-mac-emailpro02.png){.thumbnail}|
