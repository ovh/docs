...
Seguite la nostra guida [Gestire lo spazio di storage di un account email](https://docs.ovh.com/it/emails/manage-email-quota/){.external} nella sezione "Hosted email - MX Plan".