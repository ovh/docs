...
OVH propose également une application web disposant de [fonctions collaboratives](https://www.ovh.com/fr/emails/){.external} accessible à l’adresse [https://pro1.mail.ovh.net](https://pro1.mail.ovh.net){.external}. Vous pouvez vous y connecter grâce aux identifiants de votre adresse e-mail.
