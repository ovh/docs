...
> To identify these security vulnerabilities, analyse the [web logs](/pages/web/hosting/logs_and_statistics) of your web hosting plan, or contact a [specialised provider](https://partner.ovhcloud.com/en-sg/directory/) to perform a security audit on your websites.
>
