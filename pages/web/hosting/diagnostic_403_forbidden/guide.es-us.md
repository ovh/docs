...
> Para identificar estos fallos de seguridad, puede analizar los ["logs web"](/pages/web/hosting/logs_and_statistics#logs) de su alojamiento o recurrir a un [proveedor especializado](https://partner.ovhcloud.com/es/) para realizar una auditoría de seguridad de sus soluciones.
>
