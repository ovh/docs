...
You can use it to put files or your website online by [connecting to your web hosting plan’s FTP space](/pages/web/hosting/ftp_connection).
...
Go to the Web Cloud section of your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc){.external}, then click on `Hosting plans`{.action}. Select the name of the web hosting plan and click on the `FTP - SSH`{.action} tab.
...
> [!success]
> A guide is available for [changing the FTP](/pages/web/hosting/ftp_change_password) password on shared hosting plans.
...
>
> You must then [secure your solutions](/pages/web/hosting/diagnostic_403_forbidden) while correcting the security vulnerabilities mentioned in the block notification received via email.
>
...
Consult our documentation for [resolving recurring errors when using FTP](/pages/web/hosting/ftp_recurring_ftp_problems) software.

Generally, find all our [of our guides related to shared](https://docs.ovh.com/ca/en/hosting/).
