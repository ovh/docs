...
Consult our documentation for [resolving recurring errors when using FTP](https://docs.ovh.com/ie/en/hosting/recurring_ftp_problems/) software.

Generally, find all our [of our guides related to shared](https://docs.ovh.com/ie/en/hosting/).
