...
> [!success]
> A guide is available for [changing the FTP password](/pages/web/hosting/ftp_change_password) on shared hosting plans.
...
>
> You must then [secure your services](/pages/web/hosting/diagnostic_403_forbidden) while correcting the security vulnerabilities mentioned in the block notification received via email.
>
