...
>
> To edit (or create) these directories, log in to your hosting plan’s FTP space. If you need help with this, please refer to our guide on [Logging in to your Web Hosting plan’s storage space](https://docs.ovh.com/au/en/hosting/log-in-to-storage-ftp-web-hosting/).
>
...
In the event of an error, you can always log in to [the FTP space](https://docs.ovh.com/au/en/hosting/log-in-to-storage-ftp-web-hosting/) of your hosting to correct mistakes.
...
- [Protect your website’s administration interface via ".htaccess"](https://docs.ovh.com/au/en/hosting/how_to_password_protect_a_directory_on_your_website/).
- [Rewrite your URLs using mod_rewrite](https://docs.ovh.com/au/en/hosting/htaccess_url_rewriting_using_mod_rewrite/)
- [Perform other operations with the ".htaccess" file](https://docs.ovh.com/au/en/hosting/what_else_can_you_do_with_the_htaccess_file/)
