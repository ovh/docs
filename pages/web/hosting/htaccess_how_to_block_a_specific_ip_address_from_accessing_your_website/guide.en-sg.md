...
You can create multiple « .htaccess » files in [the FTP space](https://docs.ovh.com/sg/en/hosting/log-in-to-storage-ftp-web-hosting/) of your hosting but **only one** per directory or subdirectory to avoid conflicts between different .htaccess files.
...
- You must have [OVHcloud shared hosting](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg)
...
>
> To edit (or create) these directories, log in to your hosting plan’s FTP space. If you need help with this, please refer to our guide on [Accessing my storage space](https://docs.ovh.com/sg/en/hosting/log-in-to-storage-ftp-web-hosting/).
>
...
In the event of an error, you can always log in to [the FTP space](https://docs.ovh.com/sg/en/hosting/log-in-to-storage-ftp-web-hosting/) of your hosting to correct the situation.
...
- [Protect your website’s administration interface via « .htaccess »](https://docs.ovh.com/sg/en/hosting/how_to_password_protect_a_directory_on_your_website/).
