...
>
> To edit (or create) these directories, log in to your hosting plan’s FTP space. If you need help with this, please refer to our guide on [Logging in to your Web Hosting plan’s storage space](https://docs.ovh.com/us/en/hosting/log-in-to-storage-ftp-web-hosting/).
>
...
In the event of an error, you can always log in to [the FTP space](https://docs.ovh.com/us/en/hosting/log-in-to-storage-ftp-web-hosting/) of your hosting to correct mistakes.
