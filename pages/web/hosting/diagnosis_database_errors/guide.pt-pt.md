...
- [Otimize a sua base de dados](/pages/web/clouddb/configure-database-server#otimizar-as-bases-de-dados_1) e depois repita as operações de exportação/importação.
