...
- Utilizar uno de nuestros productos de bases de datos [Web Cloud](https://www.ovhcloud.com/es/web-hosting/options/start-sql/) o [SQL Privado](../primeros-pasos-con-sql-privado/).
...
- Contrate, si es necesario, una [base de datos](https://www.ovhcloud.com/es/web-hosting/options/start-sql/) de mayor tamaño y lance su [creación](../crear-base-de-datos/).
