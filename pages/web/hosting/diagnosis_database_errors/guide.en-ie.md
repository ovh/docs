...
- an OVHcloud database service: [Web Cloud](https://www.ovhcloud.com/en-ie/web-hosting/options/start-sql/) or [Private SQL](../getting-started-with-private-sql/)
...
- Order a larger [database service](https://www.ovhcloud.com/en-ie/web-hosting/options/start-sql/) if necessary, then [create the new database](../creating-database/);
