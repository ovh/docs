...
In this situation, you will need to [optimise your databases](https://docs.ovh.com/asia/en/hosting/configure-optimise-database-server/#managing-your-databases) in order to reduce the number of active connections.
