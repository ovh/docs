...
- Utilizar uno de nuestros productos de bases de datos [Web Cloud](https://www.ovhcloud.com/es-es/web-hosting/options/start-sql/) o [SQL Privado](https://docs.ovh.com/es/hosting/primeros-pasos-con-sql-privado/).
...
> [!primary]
>
> Si dispone de un alojamiento **Performance**, también puede [activar gratis un servidor SQL Privado](https://docs.ovh.com/es/hosting/primeros-pasos-con-sql-privado/#activacion-de-su-servidor-sql-privado-incluido-con-su-plan-de-hosting).
>
...
Este número es de **200** para las bases de servidores [SQL Privado](https://docs.ovh.com/es/hosting/primeros-pasos-con-sql-privado/). (Puede cambiar este parámetro en la sección `Configuración`{.action} del servidor de la base de datos).
...
>
> Si desea conectarse a una base de datos en un servidor [SQL Privado](https://docs.ovh.com/es/hosting/primeros-pasos-con-sql-privado/), el nombre del servidor a introducir se inscribe en la pestaña `Información general`{.action}, parte `Datos de conexión`{.action}, `SQL`{.action} y en el `Nombre del host`{.action}.
>

## Más información <a name="gofurther"></a>

[Primeros pasos con el servicio SQL Privado](https://docs.ovh.com/es/hosting/primeros-pasos-con-sql-privado/)
