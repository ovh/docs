...
>
> We recommend that you contact the publisher of the [CMS](/pages/web/hosting/cms_install_1_click_modules) concerned or a [specialised service provider](https://partner.ovhcloud.com/en-ca/directory/) if necessary. We will not be able to assist you with this.
>
...
- Order a larger [database service](https://www.ovh.com/ca/en/web-hosting/sql-options.xml) if necessary, then [create the new database](/pages/web/hosting/sql_create_database);
...
In this situation, [check the credentials entered](https://docs.ovh.com/ca/en/hosting/connecting-to-database-on-database-server/#instructions) and change your [database password](/pages/web/hosting/sql_change_password) if necessary.
