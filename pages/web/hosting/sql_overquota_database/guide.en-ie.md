...
Retrieve the password for accessing your database directly from your website’s configuration file. Perform this action using the **step 1** in our guide to [changing a database password](/pages/web/hosting/sql_change_password).
...
- [First steps with Web Cloud Databasess](/pages/web/clouddb/starting_with_clouddb)
- [Import your old database into your Web Cloud Databasess solution](/pages/web/clouddb/restore-import-on-database-server)
