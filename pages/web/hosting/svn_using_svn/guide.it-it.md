...
Segui la guida [Creare chiavi SSH](/pages/platform/public-cloud/public-cloud-first-steps#step-1-crea-chiavi-ssh/). Non è necessario seguire lo step [Importa la tua chiave SSH nello Spazio Cliente OVHcloud](/pages/platform/public-cloud/public-cloud-first-steps#step-1-crea-chiavi-ssh/#importa-la-chiave-ssh-nello-spazio-cliente_1) in questa guida.
