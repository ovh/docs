...
- a  [web hosting plan](https://www.ovh.com/ca/en/web-hosting/) that allows an SSH connection (**from the Pro plan onwards**)
...
Please follow our guide on [Creating SSH keys](https://docs.ovh.com/ca/en/public-cloud/create-ssh-keys/). You don't need to follow the [Importing your SSH key in the OVHcloud Control Panel](https://docs.ovh.com/ca/en/public-cloud/create-ssh-keys/#importing-your-ssh-key-into-the-ovhcloud-control-panel_1) step in this guide.
