...
Zapoznaj się z przewodnikiem [Tworzenie kluczy SSH](/pages/platform/public-cloud/public-cloud-first-steps#krok-1-utworzenie-kluczy-ssh/). Nie musisz postępować zgodnie z instrukcjami etapu [Zaimportuj klucz SSH do Panelu klienta OVHcloud](/pages/platform/public-cloud/public-cloud-first-steps#krok-1-utworzenie-kluczy-ssh/#importowanie-klucza-ssh-do-panelu-klienta-ovhcloud_1) w tym przewodniku.
