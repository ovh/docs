...
Your domain name is connected via the `Multisite`{.action} section of your hosting to a directory (a `Root folder`) on your [FTP](https://docs.ovh.com/sg/en/hosting/log-in-to-storage-ftp-web-hosting/) server.
