...
- a database created as part of an [OVHcloud Web Hosting plan](https://www.ovh.com.au/web-hosting/){.external}
...
- **Carry out the backup from an SSH command line.** This method involves using the SSH protocol to log in to your storage space, then using commands to interact with it. More advanced knowledge and a specific [OVHcloud Web Hosting plan](https://www.ovh.com.au/web-hosting/){.external} are required to use this method.
