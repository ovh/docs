...
- You must have an [OVH web hosting plan](https://www.ovh.lt/svetainiu-talpinimas/).
...
OVH offers a selection of 4 CMSs as 1-click modules. By using this solution, you will need to choose from this list. If you have already chosen a CMS from the list, you can start following the steps in this tutorial. If have not yet chosen which CMS to use, this [CMS comparison page](https://www.ovh.lt/svetainiu-talpinimas/website/tvs-palyginimas/) can help you decide which one would best suit your project.

If you would like to install a CMS that isn’t offered as an OVH 1-click module, you can install it manually on your web hosting plan, provided that the CMS is compatible with your plan (see our web hosting plans [here](https://www.ovh.lt/svetainiu-talpinimas/).
...
See our [CloudDB solutions](https://www.ovh.lt/cloud/cloud-databases/){.external}
