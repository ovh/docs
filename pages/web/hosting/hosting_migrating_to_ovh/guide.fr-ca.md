...
Si vous avez opté pour une solution « Exchange », consultez notre documentation sur le sujet pour créer vos adresses e-mail : <https://docs.ovh.com/fr/microsoft-collaborative-solutions/premiere-configuration-exchange/>
