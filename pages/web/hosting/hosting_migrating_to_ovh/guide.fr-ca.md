...
Si vous avez opté pour une solution « Exchange », consultez notre documentation sur le sujet pour créer vos adresses e-mail : </pages/web/microsoft-collaborative-solutions/exchange_starting_hosted>
...
Une fois la migration terminée, connectez-vous à votre adresse e-mail OVHcloud à l'aide du [webmail OVHcloud](https://www.ovhcloud.com/fr-ca/mail/) pour vérifier que tous vos e-mails sont bien présents dans le nouveau compte.
...
- Retrouvez l'ensemble des paramètres de configuration dans notre guide « [Généralités sur les e-mails MX Plan](/pages/web/emails/email_generalities#2-utiliser-lappareil-de-votre-choix) ». Vous y trouverez également les liens vers les guides de configuration personnalisés pour les principaux logiciels de messagerie.
