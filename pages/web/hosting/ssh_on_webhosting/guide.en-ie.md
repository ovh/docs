...
- The SSH option, available on: Hosting plans starting with [Professional hosting](https://www.ovh.ie/web-hosting/).
- An SSH client.
...
[PuTTy](https://docs.ovh.com/ie/en/hosting/web_hosting_using_putty_on_windows/).
