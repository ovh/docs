...
- an [OVHcloud Web Hosting plan](https://www.ovh.ie/web-hosting/){.external}
...
With an OVHcloud Web Hosting plan, you can choose from a range of [SSL certificate solutions](https://www.ovh.ie/ssl/){.external}:
