...
- an [OVHcloud Web Hosting plan](https://www.ovh.com.au/web-hosting/){.external}
- at least one [domain name](https://www.ovh.com.au/domains/){.external}
...
With an OVHcloud Web Hosting plan, you can choose from a range of [SSL certificate solutions](https://www.ovh.com.au/web-hosting/shared-ssl.xml){.external}:

- a free Let's Encrypt SSL certificate ([included with compatible Web Hosting plans](https://www.ovh.com.au/web-hosting/shared-ssl.xml){.external})
- a paid SSL certificate ([available as an option with compatible Web Hosting plans](https://www.ovh.com.au/web-hosting/shared-ssl.xml){.external})
