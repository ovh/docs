...
- at least one [domain name](https://www.ovh.com/ca/en/domains/){.external}
...
With an OVHcloud Web Hosting plan, you can choose from a range of [SSL certificate solutions](https://www.ovh.com/ca/en/web-hosting/shared-ssl.xml){.external}:

- a free Let's Encrypt SSL certificate ([included with compatible Web Hosting plans](https://www.ovh.com/ca/en/web-hosting/shared-ssl.xml){.external})
- a paid SSL certificate ([available as an option with compatible Web Hosting plans](https://www.ovh.com/ca/en/web-hosting/shared-ssl.xml){.external})
