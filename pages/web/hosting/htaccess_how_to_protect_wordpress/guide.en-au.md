...
- Have a [web hosting](https://www.ovhcloud.com/en-au/web-hosting/) with WordPress installed.
- Be able to use an FTP client like [FileZilla](https://filezilla-project.org/). You can refer to our guide “[Use FileZilla to retrieve and store your data](https://docs.ovh.com/au/en/dedicated/store-retrieve-data-via-sftp/#using-filezilla-to-retrieve-and-upload-your-data)”.
...
For more information on this subject, please refer to our guide on [“IP access restriction via .htaccess file”](https://docs.ovh.com/au/en/hosting/htaccess_how_to_block_a_specific_ip_address_from_accessing_your_website/).
