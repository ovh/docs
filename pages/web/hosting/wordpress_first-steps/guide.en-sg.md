...
- [WordPress installed](https://docs.ovh.com/sg/en/hosting/web_hosting_web_hosting_modules/) on your web hosting plan
...
If one is not already installed, [add an SSL certificate](https://docs.ovh.com/sg/en/hosting/activate-https-website-ssl/#step-1-activate-the-ssl-certificate-on-the-web-hosting-plan) for the domain name associated with your website before you continue.
