...
- [WordPress installed](https://docs.ovh.com/ca/en/hosting/web_hosting_web_hosting_modules/) on your web hosting plan
- Access to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca){.external}

## Instructions

If one is not already installed, [add an SSL certificate](https://docs.ovh.com/ca/en/hosting/activate-https-website-ssl/#step-1-activate-the-ssl-certificate-on-the-web-hosting-plan) for the domain name associated with your website before you continue.
