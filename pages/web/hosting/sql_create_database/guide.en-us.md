...
First of all, log in to your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we){.external}, click `Web Hosting`{.action}, then choose the web hosting plan concerned. Next, go to the `Databases`{.action} tab.
