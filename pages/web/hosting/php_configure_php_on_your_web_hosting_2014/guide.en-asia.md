...
- Have an [OVHcloud web hosting plan](https://www.ovhcloud.com/asia/web-hosting/){.external}, with the exception of a Cloud Web hosting plan.
- Have access to your Web Hosting plan from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia), or you must know the information required to connect to the [FTP storage space](https://docs.ovh.com/asia/en/hosting/log-in-to-storage-ftp-web-hosting/). 
...
- **via the OVHcloud Control Panel**: log in to [the OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia){.external}, go to the `Web Cloud`{.action} section, click on `Web Hosting`{.action} then select the Web Hosting plan concerned. In the `General information`{.action} tab, locate the version below *Global PHP version*. 
...
- **via a script**: Create a **.php** script containing only the code `<?php phpinfo(); ?>`. Then put it online on your [FTP storage space](https://docs.ovh.com/asia/en/hosting/log-in-to-storage-ftp-web-hosting/), then call it by accessing its full address/URL.
...
- **via a configuration assistant in your control panel**: Once you have logged in to your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia), you can choose the new PHP version you want from other settings. Please refer to the instructions set out in our guide [“Modifying the configuration of a Web Hosting plan”](https://docs.ovh.com/asia/en/hosting/modify_your_web_hosting_systems_runtime_environment/){.external} to do this using this method.

- **By manually editing a file in your storage space**: this solution is more technical, and you will need to be logged in to your [FTP storage](https://docs.ovh.com/asia/en/hosting/log-in-to-storage-ftp-web-hosting/), where you will need to edit the .ovhconfig file. Please refer to the instructions set out in our guide [“Configuring the .ovhconfig file of your Web Hosting plan”](https://docs.ovh.com/asia/en/hosting/configuring-file-ovhconfig/){.external} to do this.
...
> To do this, you will need to use the `.ovhconfig` file, which you can do by referring to our guide [“Configuring the .ovhconfig file of my Web Hosting plan”](https://docs.ovh.com/asia/en/hosting/configuring-file-ovhconfig/){.external}.
>

Some PHP versions only work with certain runtime environments. The following are the PHP versions available on OVHcloud web hosting plans and compatible [runtime environments](https://docs.ovh.com/asia/en/hosting/modify_your_web_hosting_systems_runtime_environment/):
...
[Modifying the configuration of a Web Hosting plan](https://docs.ovh.com/asia/en/hosting/modify_your_web_hosting_systems_runtime_environment/){.external}

[Configuring the .ovhconfig file of your Web Hosting plan](https://docs.ovh.com/asia/en/hosting/configuring-file-ovhconfig/){.external}

[Log in to your Web Hosting plan’s storage space](https://docs.ovh.com/asia/en/hosting/log-in-to-storage-ftp-web-hosting/){.external}
