...
excerpt: 'Find out how to change the PHP version on an OVHcloudcloud Web Hosting plan'
...
There are many different types of website published online. With an [OVHcloudcloud Web Hosting plan](https://www.ovhcloud.com/en-ca/web-hosting/){.external}, you can host whatever kind of website you want, provided it is compatible with [our infrastructures’ configuration](https://webhosting-infos.hosting.ovh.net){.external}. As a result, you may find that you want to modify the PHP version used by your Web Hosting plan.

**Find out how to change the PHP version on an OVHcloudcloud Web Hosting plan.**

## Requirements

- a compatible [OVHcloudcloud Web Hosting plan](https://www.ovhcloud.com/en-ca/web-hosting/){.external} (excluding Cloud Web)
- the ability to manage the Web Hosting plan from the [OVHcloudcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca), or access to the information you need to connect to the storage space 

## Instructions

There are now several versions of PHP programming language. As usual, version developments include different patches, and also add or remove features. OVHcloudcloud offers the very latest PHP versions, a list of which can be found here: <https://www.ovhcloud.com/en-ca/web-hosting/php.xml>. 
...
Although OVHcloudcloud manages setup for the latest PHP versions on its servers, as a webmaster, you are responsible for ensuring that your website is up-to-date and compatible with the latest PHP versions. There are two ways of doing this, depending on the type of website you are using.
...
- If necessary, update your CMS and check that the new version is compatible with your OVHcloudcloud Web Hosting plan.
...
- If necessary, update your website’s code and check that it remains compatible with your OVHcloudcloud Web Hosting plan.

If you need to see which PHP version is currently used by your OVHcloudcloud Web Hosting plan, there are two ways of doing so: 

|Method|Description|
|---|---|
|Via the OVHcloudcloud Control Panel|Log in to the [OVHcloudcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca), click `Web hosting`{.action}, then choose the Web Hosting plan concerned. In the `General information`{.action} tab, note down the version listed below **Global PHP version**. If a blue circle appears instead, please wait a few moments for the version to load.|
...
- **Through a configuration wizard in the OVHcloudcloud Control Panel.** This solution is less technical, and you will need to be logged in to the OVHcloudcloud Control Panel, where you can choose the new PHP version along with other settings. Please refer to the instructions set out in this guide if you would like to use this method: [Modifying the configuration of a Web Hosting plan](../modify_your_web_hosting_systems_runtime_environment/).
