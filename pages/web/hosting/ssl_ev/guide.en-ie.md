...
- Acces into your [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie).
- Order or have a [OVHcloud shared hosting](https://www.ovhcloud.com/en-ie/web-hosting/) on which no SSL certificate is already installed.
- Order or have a [domain name](https://www.ovhcloud.com/en-ie/domains/) and have exclusive rights to use it. The domain name must not already be linked to an SSL certificate.
...
> 
> This guide is designed to help you with common tasks. Nevertheless, we recommend contacting a [specialist provider](https://partner.ovhcloud.com/en-ie/) if you encounter any difficulties. We will not be able to provide you with assistance **for all verification steps directly performed with the Sectigo certification authority**. You can find more information in the [Go further](#go-further) section of this guide.
>
...
Read our guide on how to [manage an SSL certificate on your Web Hosting plan](https://docs.ovh.com/ie/en/hosting/ssl-certificates-on-web-hosting-plans/) and select the **EV SSL Certificate** once you have reached the order tunnel.
...
If you have not yet ordered your domain name and associated hosting package, go to our [OVHcloud homepage](https://www.ovhcloud.com/en-ie/), enter a domain name in the **search form** and click `Search`{.action} to start your order.
...
You will only need to [activate HTTPS on your website](https://docs.ovh.com/ie/en/hosting/activate-https-website-ssl/) to fully use your EV SSL certificate.
...
[Activate HTTPS on your website](https://docs.ovh.com/ie/en/hosting/activate-https-website-ssl/)
