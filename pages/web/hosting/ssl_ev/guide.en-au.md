...
- Acces into your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au).
- Order or have a [OVHcloud shared hosting](https://www.ovhcloud.com/en-au/web-hosting/) on which no SSL certificate is already installed.
- Order or have a [domain name](https://www.ovhcloud.com/en-au/domains/) and have exclusive rights to use it. The domain name must not already be linked to an SSL certificate.
...
Read our guide on how to [manage an SSL certificate on your Web Hosting plan](https://docs.ovh.com/au/en/hosting/ssl-certificates-on-web-hosting-plans/) and select the **EV SSL Certificate** once you have reached the order tunnel.
...
If you have not yet ordered your domain name and associated hosting package, go to our [OVHcloud homepage](https://www.ovhcloud.com/en-au/), enter a domain name in the **search form** and click `Search`{.action} to start your order.
