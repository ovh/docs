...
Cyberduck is an application for Mac users. If you have a machine that uses Windows, use [FileZilla](https://docs.ovh.com/us/en/hosting/web_hosting_filezilla_user_guide/) instead.
