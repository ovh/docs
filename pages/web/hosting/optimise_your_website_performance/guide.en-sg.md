...
- a [domain name](https://www.ovh.com/sg/domains/) that can be used to access your website
...
We provide recommendations on what web hosting offer to use for the above listed CMS on [the product page](https://www.ovh.com/sg/web-hosting/){.external}.

You can find more informations regarding which plan to choose from on [this page](https://www.ovh.com/sg/web-hosting/what_web_hosting_choice.xml){.external}.
...
You can find out how to update PHP in [this guide](../how_to_configure_php_on_your_ovh_web_hosting_package_2014/).

To switch to use PHP-FPM in the _stable_ version or to get details on more advanced options of your webhosting, please consult [this guide](../modify_your_web_hosting_systems_runtime_environment/).
...
To ensure that your hosting offer is adapted to the needs of your CMS, you can find a comparison of our services on [the product page](https://www.ovh.com/sg/web-hosting/).
...
**How to access the database via phpMyAdmin:** To access your database via phpMyAdmin, here is the procedure to follow via the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg){.external}:
...
A comparison of our offers can be found [on the product page](https://www.ovh.com/sg/web-hosting/sql-options.xml).
