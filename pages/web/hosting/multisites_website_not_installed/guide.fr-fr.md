...
|Le domaine ou le sous-domaine lié à votre site n'apparaît pas dans le tableau.|Vous n'avez pas encore ajouté votre site dans l'onglet `multisite`{.action} de votre hébergement web. Pour effectuer cette manipulation, consultez notre documentation [Partager son hébergement entre plusieurs sites](../multisites-configurer-un-multisite-sur-mon-hebergement-web/#etape-2-ajouter-un-domaine-ou-un-sous-domaine).![hosting-general-informations](images/hosting-general-informations.png)|
