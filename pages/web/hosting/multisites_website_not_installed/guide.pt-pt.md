...
excerpt: Saiba como identificar e resolver a página de erro "Site não instalado"
...
|Este aviso aparece no separador Zona `DNS`{.action}: ![aviso_zonedns_pas_sur_srv_Dns](images/avertissement_zonedns_pas_sur_srv_dns.png){.thumbnail}|Assim, deverá alterar os servidores DNS do seu domínio de acordo com este [guia](../../domains/partilhado_generalidades_sobre_os_servidores_dns/).|
