...
- On Web Hosting plans (shared databases), there is a limit of 30 concurrent connections per database (200 with the included Private SQL database). Plese refer to the [product page](https://www.ovhcloud.com/en-sg/web-hosting/) to verify the available options of our Web Hosting plans.
...
Find out more on our [website](https://www.ovhcloud.com/en-sg/web-hosting/options/start-sql/) and in [our guide](../getting-started-with-private-sql/).
...
- We recommend to consult [our website](https://www.ovhcloud.com/en-sg/web-hosting/uc-programming-language/) to make sure the Web Hosting plan you would like to order will be appropriate for your hosting requirements.
...
- You will be able to change the PHP version for your Web Hosting, either in the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg) ("**Configuration**") or by editing the .ovhconfig file. Mixed configurations are also possible with the latter. Detailed instructions are available in our guides:
