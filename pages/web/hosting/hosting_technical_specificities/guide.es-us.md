...
- Para conectarse por **SFTP**, se necesita un [**Hosting Profesional**](https://www.ovh.com/world/es/hosting/) o superior. Puede actualizar su servicio directamente en [el área de cliente de OVHcloud](https://ca.ovh.com/auth/?action=gotomanager) ("Información general", "Plan", "Cambiar el plan").
...
- Podrá modificar la versión PHP de su alojamiento web, o bien en [el área de cliente de OVHcloud](https://ca.ovh.com/auth/?action=gotomanager) ("**Configuración**"), o bien modificando el archivo .ovhconfig. También se pueden llevar a cabo configuraciones mixtas en estas últimas. Tiene a su disposición instrucciones detalladas en nuestras guías:
