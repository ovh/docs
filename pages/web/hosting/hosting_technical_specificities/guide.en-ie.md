...
- On Web Hosting plans (shared databases), there is a limit of 30 concurrent connections per database (200 with the included CloudDB database). Plese refer to the [product page](https://www.ovhcloud.com/en-ie/web-hosting/) to verify the available options of our Web Hosting plans.
