...
- In order to connect via **SFTP**, a [**Professional plan**](https://www.ovh.ie/web-hosting/) or better is required. You can upgrade your plan directly in your [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager) ("General information", "Plan", "Change offer").
...
- On Web Hosting plans (shared databases), there is a limit of 30 concurrent connections per database (200 with the included Private SQL database). Plese refer to the [product page](https://www.ovh.ie/web-hosting/) to verify the available options of our Web Hosting plans.
...
Find out more on our [website](https://www.ovh.ie/web-hosting/sql-options.xml) and in [our guide](../getting-started-with-private-sql/).
...
- We recommend to consult [our website](https://www.ovh.ie/web-hosting/php.xml) to make sure the Web Hosting plan you would like to order will be appropriate for your hosting requirements.
