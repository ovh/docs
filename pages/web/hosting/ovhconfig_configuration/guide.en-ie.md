...
For numerous reasons, you may need to modify the configuration of your [Web Hosting plan](https://www.ovh.ie/web-hosting/){.external}. For this reason, OVH has implemented a file that allows you to change certain settings: the **.ovhconfig** file.
...
|app.engine.version|Allows you to define the PHP version used by the hosting plan from [the ones proposed by OVH](https://www.ovh.ie/web-hosting/php.xml){.external}. Enter the version of your choice.|
|http.firewall|Allows you to enable or disable the  [firewall supplied with all OVH Web Hosting plans](https://www.ovh.ie/web-hosting/mod_security.xml){.external}. Enter “security” to enable it or “none” to disable it.|
