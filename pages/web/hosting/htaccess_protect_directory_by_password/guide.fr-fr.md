...
excerpt: "Decouvrez comment protéger un répertoire ou  l'accès à l'administration de votre site web avec des fichiers .htaccess et .htpasswd"
...
Ce tutoriel explique comment mettre en place une authentification d'accès par « utilisateur/mot de passe » pour accéder via un navigateur Internet à tout ou partie de votre site web. 
...
- « **.htpasswd** » : En complément du présent tutoriel, vous pouvez consulter la [documentation officielle Apache](https://httpd.apache.org/docs/2.4/fr/programs/htpasswd.html) relative à ce fichier.
...
>
> Pour toutes questions relatives à la création, l'utilisation ou la programmation de votre site web, OVHcloud sera pas en mesure de vous apporter une assistance sur ces sujets.
>
...
- Création des fichiers « crypt.php », « .htaccess » et « .htpasswd »
- Génération des mots de passe chiffrés avec le fichier « crypt.php »
- Définition des utilisateurs et des mots de passe chiffrés avec le fichier « .htpasswd »
- Configuration des règles dans le fichier « .htaccess »
...
> 
> Si non, nous vous conseillons de d'abord d'optimiser votre site web afin de le rendre compatible avant de mettre en place ce qui va suivre. Cela réduira encore plus les risques de piratage de vos données au travers de failles de sécurités.
>

### Etape 1 : Créer les fichiers « crypt.php », « .htaccess » et « .htpasswd »

Connectez-vous à [l'espace de stockage FTP](/pages/web/hosting/ftp_connection/) de votre hébergement. Ouvrez le [« dossier racine »](/pages/web/hosting/multisites_configure_multisite/) vers lequel pointe votre nom de domaine.

Créez un fichier « crypt.php » dans ce « dossier racine ».

![root_folder](images/root_folder.png){.thumbnail}

Ouvrez ou créez le dossier destiné à contenir la partie « admin » de votre site web. Créez dans ce répertoire un fichier « .htpasswd » et un fichier « .htaccess ».
...
- les fichiers « .htaccess » et « .htpasswd » sont invisible pour les internautes qui visitent votre site Web ;
...
Remontez dans le « dossier racine » où vous avez créé le le fichier « crypt.php ». Cliquez sur `Editer`{.action} puis placez les lignes suivantes :
...
Exemple où le script PHP va chiffrer 3 mots de passe d'un seul coup :
...
> [!warning]
>
> Pour des raisons de sécurité, l'utilisation du SSH est recommandée. Toutefois, si vous disposez d'une offre [Kimsufi Web](https://www.kimsufi.com/fr/hosting.xml) ou [Perso](https://www.ovhcloud.com/fr/web-hosting/personal-offer/), vous pouvez aussi exécuter le fichier « crypt.php » via votre navigateur Web.
>
> Pour cela, saisissez l'URL suivante : `https://domain.tld/crypt.php` en modifiant `domain.tld` par votre propre nom de domaine.
>

Récupérez les mots de passe chiffrés (Ne copiez pas le « &#60;br /> » si vous exécutez la commande « php crypt.php » en SSH) :
