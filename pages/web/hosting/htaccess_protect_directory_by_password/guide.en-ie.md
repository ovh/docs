...
If you have a [Professional](https://www.ovh.ie/web-hosting/web-hosting-pro.xml) or [Performance](https://www.ovh.ie/web-hosting/performance-web-hosting.xml) Web Hosting plan, log in to your hosting via [SSH](../web_hosting_ssh_on_web_hosting_packages/). Run the following command:
...
> [!warning]
>
> For security reasons, using SSH in this case is recommended. However, if you have a [Personal](https://www.ovh.ie/web-hosting/web-hosting-personal.xml) offer and you do not want to upgrade it to a [Professional](https://www.ovh.ie/web-hosting/web-hosting-pro.xml) or [Performance](https://www.ovh.ie/web-hosting/performance-web-hosting.xml) one, you can also run the "crypter.php" file with your web browser (by simply opening the URL, for example: https://your-domain-name.ovh/crypter.php).
>
