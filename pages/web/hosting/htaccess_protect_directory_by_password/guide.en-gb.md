...
If you have a [Professional](https://www.ovhcloud.com/en-gb/web-hosting/professional-offer/) or [Performance](https://www.ovhcloud.com/en-gb/web-hosting/performance-offer/) Web Hosting plan, log in to your hosting via [SSH](/pages/web/hosting/ssh_on_webhosting). Run the following command:
...
[All about the .htaccess file](/gb/en/hosting/all_about_the_htaccess_file/)
