...
If you have a [Professional](https://www.ovhcloud.com/asia/web-hosting/professional-offer/) or [Performance](https://www.ovhcloud.com/asia/web-hosting/performance-offer/) Web Hosting plan, log in to your hosting via [SSH](/pages/web/hosting/ssh_on_webhosting). Run the following command:
