...
If you have a [Pro](https://www.ovhcloud.com/en-au/web-hosting/professional-offer/) or [Performance](https://www.ovhcloud.com/en-au/web-hosting/performance-offer/) hosting plan, then log in with [SSH](/pages/web/hosting/ssh_on_webhosting) to your web hosting. Go to the **root folder** where your script “crypt.php” is located.
