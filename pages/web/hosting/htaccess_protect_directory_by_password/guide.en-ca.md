...
If you have a [Professional](https://www.ovhcloud.com/en-ca/web-hosting/professional-offer/) or [Performance](https://www.ovhcloud.com/en-ca/web-hosting/performance-offer/) Web Hosting plan, log in to your hosting via [SSH](/pages/web/hosting/ssh_on_webhosting). Run the following command:
