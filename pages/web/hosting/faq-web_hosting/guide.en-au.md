...
**Tips and tricks**: To help you configure your hosting, please check the `Getting started` section [here](https://docs.ovh.com/au/en/hosting/get_started_with_a_web_hosting_package/).
...
Once you have made your choice, follow the instructions in our guide [Changing your web hosting plan offer](https://docs.ovh.com/au/en/hosting/how_to_change_web_hosting_offer/).
...
To do this, log in to your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au). Go to the `Web Cloud`{.action} section, then to the web hosting plan concerned on the left-hand side, in the `Hosting`{.action} tab. 
