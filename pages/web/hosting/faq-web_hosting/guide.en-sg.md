...
**Tips and tricks**: To help you configure your hosting, please check the `Getting started` section [here](https://docs.ovh.com/sg/en/hosting/get_started_with_a_web_hosting_package/).
...
- If the elements are not identical and the servers listed in the `DNS server`{.action} tab do not appear in [this list](https://docs.ovh.com/sg/en/hosting/list-of-ip-addresses-of-web-hosting-clusters/), contact your webmaster or search for a [specialist service provider](https://partner.ovhcloud.com/en-sg/directory/) via the [OVHcloud partners](https://partner.ovhcloud.com/en-sg/directory/) page.
