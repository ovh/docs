...
- a database created as part of an [OVHcloud Web Hosting plan](https://www.ovh.com/sg/web-hosting/)
...
- **Carry out the import from an SSH command line**: this method involves using the SSH protocol to log in to your storage space, then using commands to interact with the storage space. More advanced knowledge and a specific [OVHcloud Hosting Plan](https://www.ovh.com/sg/web-hosting/) are required to use this type of access.
