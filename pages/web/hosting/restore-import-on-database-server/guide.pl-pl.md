...
**Ostatnia aktualizacja z dnia 11-06-2020**
...
> [!warning]
>
> Przywrócenie usługi wiąże się z zastąpieniem zawartości bazy danych po przywróceniu jej zawartości.
> Jeśli nie jesteś pewien, co robisz, zalecamy wykonanie wcześniej kopii zapasowej.
> 
...
Operacja ta jest możliwa tylko przez [SSH](../hosting_www_ssh_na_hostingu/) z poziomu hostingu OVHcloud.
...
Operacja ta jest możliwa wyłącznie przez [SSH](../hosting_www_ssh_na_hostingu/) z poziomu hostingu OVHcloud w wersji stabilnej lub wyższej.
