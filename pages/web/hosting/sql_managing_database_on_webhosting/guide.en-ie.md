...
OVH's shared web hosting packages include SQL databases by default. The number and size of the database depends on the package that you have ordered. You can find more [details here](https://www.ovhcloud.com/en-ie/web-hosting/){.external}.
...
### Creating a database
Log in to the [OVH Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie){.external} with your ID (nic-handle, for example " **xx999-ovh** ") - and password.
...
There is a guide available: [here](https://docs.ovh.com/ie/en/hosting/web_hosting_guide_to_importing_a_mysql_database/){.external}