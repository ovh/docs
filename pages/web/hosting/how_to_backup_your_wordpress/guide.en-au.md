...
- An [OVHcloud web hosting plan](https://www.ovhcloud.com/en-au/web-hosting/) with [WordPress installed](https://docs.ovh.com/au/en/hosting/web_hosting_web_hosting_modules/)
...
Retrieving your data is done via an FTP client like FileZilla. See our tutorial "[Using FileZilla with your OVHcloud hosting](https://docs.ovh.com/au/en/hosting/web_hosting_filezilla_user_guide/)" for more information.
...
- [More information on backups for your web hosting plan](https://docs.ovh.com/au/en/hosting/technical-specifications-web-hosting/#automatic-backup-information_1)
