...
- A [web hosting plan](https://www.ovhcloud.com/en-ca/web-hosting/) and WordPress installed
...
Recovery is done via an FTP client like FileZilla. See our guide "[Using FileZilla with your OVHcloud hosting](https://docs.ovh.com/ca/en/hosting/web_hosting_filezilla_user_guide/)" for more information.
