...
With the [Professional](https://www.ovhcloud.com/en-au/web-hosting/professional-offer/) and [Performance](https://www.ovhcloud.com/en-au/web-hosting/performance-offer/) offers, you can create up to three additional 1-click modules. 
...
If your current password to access your CMS admin interface is rejected, please read the “Change your module password” paragraph in our documentation on [managing your 1-click module](https://docs.ovh.com/au/en/hosting/1-click-module-management/).
