...
- a compatible [OVHcloud Web Hosting plan](https://www.ovh.com.au/web-hosting/)
...
> [!primary]
>
> View our comparison of different [hosting plans](https://www.ovh.com.au/web-hosting/).
>
...
With the [Professional](https://www.ovh.com.au/web-hosting/web-hosting-pro.xml) and [Performance](https://www.ovh.com.au/web-hosting/performance-web-hosting.xml) offers, you can create up to three additional 1-click modules. **Performance** hosting plans also allow you to enable a [private SQL server](https://www.ovh.com.au/web-hosting/sql-options.xml) for free.
...
> [!primary]
>
> Check our various [database offers](https://www.ovh.com.au/web-hosting/sql-options.xml).
>
