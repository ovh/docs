...
Active un [certificado SSL](https://www.ovh.com/world/es/hosting/ssl_compartido.xml) en su alojamiento siguiendo las instrucciones de este [guía](../gestionar-un-certificado-ssl-en-un-alojamiento-web/).
