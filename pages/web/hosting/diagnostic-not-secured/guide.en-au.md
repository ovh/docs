...
You now need to check that the IP address listed in the [DNS zone](/pages/web/domains/dns_zone_edit) corresponds to the one of your [Web Cloud hosting plan](https://www.ovhcloud.com/en-au/web-hosting/).
