...
You now need to check that the IP address listed in the [DNS zone](/pages/web/domains/dns_zone_edit) corresponds to the one of your [OVHcloud Web Hosting plan](https://www.ovhcloud.com/en-gb/web-hosting/).
...
Activate an [SSL certificate](https://www.ovhcloud.com/en-gb/web-hosting/options/ssl/) on your Web Hosting plan by following the instructions in this [guide](/pages/web/hosting/ssl_on_webhosting).
