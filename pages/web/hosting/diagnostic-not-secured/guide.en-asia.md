...
2. create, activate or renew a [SSL certificate](/asia/en/web/hosting/ssl-certificates-on-web-hosting-plans/) for your domain name on the concerned hosting plan.
