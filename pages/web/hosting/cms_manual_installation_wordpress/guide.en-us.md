...
You can find the free download link and a tutorial on how to use it in our documentation on [using Filezilla with your OVHcloud hosting plan](https://docs.ovh.com/us/en/hosting/web_hosting_filezilla_user_guide/).
...
If you have a CloudDB offer in MySQL or MariaDB and you want to use it to manually install your WordPress, please refer to our documentation on [creating a database on a CloudDB](https://docs.ovh.com/us/en/clouddb/create-databases-and-users/#creating-a-database).
