...
*Si vous souhaitez installer Wordpress de manière automatique depuis votre espace client, vous pouvez vous aider du guide suivant :* [Installer son site avec les modules en 1 clic](../modules-en-1-clic/){.ref}
...
- Voici un lien vers un [forum d'entraide](http://www.wordpress-fr.net/support/){.external} dédié à ce CMS.
...
*Vous pouvez consulter le guide concernant la modification de la version PHP sur l'offre mutualisée :* [Changer la version de PHP de son hébergement web](../configurer-le-php-sur-son-hebergement-web-mutu-2014/){.ref}
