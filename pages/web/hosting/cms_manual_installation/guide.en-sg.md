...
> [!success]
>
> To install your CMS **automatically** from your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg), please refer to our documentation on [installing a 1-click module](https://docs.ovh.com/sg/en/hosting/web_hosting_web_hosting_modules/).
>
...
Please refer to our documentation, which describes [how to add a multisite on your web hosting plan](https://docs.ovh.com/sg/en/hosting/multisites-configuring-multiple-websites/), in order to define the root directory to use with your CMS.
...
If you are not already using an FTP client, you can use Filezilla. You can find the free download link and a tutorial on how to use it in our documentation on [using FileZilla with your OVHcloud hosting plan](https://docs.ovh.com/sg/en/hosting/web_hosting_filezilla_user_guide/).

#### 1.4 Prepare a database <a name="step1-4"></a>

CMSs need a database to work. Our [Web Hosting](https://www.ovhcloud.com/en-sg/web-hosting/) solutions  include these, with the exception of [the free Start 10M hosting plan](https://www.ovhcloud.com/en-sg/domains/free-web-hosting/).

Use our documentation to [create a database from your web hosting plan](https://docs.ovh.com/sg/en/hosting/creating-database/).

If you have a Cloud Databases web hosting plan in MySQL or MariaDB and you would like to use it to manually install your CMS, please refer to our guide on [creating a database on a Cloud Databases web service](https://docs.ovh.com/sg/en/clouddb/create-databases-and-users/#creating-a-database).
...
> - To connect to a database on a Web Cloud Databases solution, see [this guide](https://docs.ovh.com/sg/en/clouddb/connecting-to-database-on-database-server/).
>
...
>
> Then configure the PHP version on your web hosting plan by referring to our guide on [Changing a Web Hosting plan’s PHP version](https://docs.ovh.com/sg/en/hosting/how_to_configure_php_on_your_ovh_web_hosting_package_2014/).
>
...
To log in to your hosting plan via SSH, please refer to our guide on [Accessing a web hosting plan via SSH](https://docs.ovh.com/sg/en/hosting/web_hosting_ssh_on_web_hosting_packages/).
...
- [Finalise a WordPress installation](https://docs.ovh.com/sg/en/hosting/cms_manually_install_wordpress/)
- [Finalise a Joomla! installation](https://docs.ovh.com/sg/en/hosting/cms_manually_install_joomla/)
- [Finalise a Drupal installation](https://docs.ovh.com/sg/en/hosting/cms_manually_install_drupal/)
- [Finalise a PrestaShop installation](https://docs.ovh.com/sg/en/hosting/cms_manually_install_prestashop/)

## Go further <a name="go-further"></a>

[Migrating your website and emails to OVHcloud](https://docs.ovh.com/sg/en/hosting/migrating-website-to-ovh/)

[Publishing a website on your Web Hosting space](https://docs.ovh.com/sg/en/hosting/web_hosting_how_to_get_my_website_online/)
