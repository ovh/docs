...
Esta etapa só se aplica se tiver selecionado "Adicionar um domínio registado na OVHcloud". Para os domínios externos, consulte o [passo 2.2: adicionar um domínio externo](#add-external-domain){.external}.
