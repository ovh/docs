...
Um Ihren Kunden-Account zu schützen, aktivieren Sie die [Zwei-Faktor-Authentifizierung](/pages/account/customer/secure-ovhcloud-account-with-2fa) und folgen Sie den Anweisungen in dieser [Anleitung](/pages/account/customer/all_about_username).
...
Loggen Sie sich hierzu in Ihrem [FTP-Speicherplatz](/pages/web/hosting/ftp_connection) ein. Es erfordert technische Kenntnisse, um kompromittierte Dateien auf Ihrem Hosting zu erkennen. Sollten Sie Schwierigkeiten haben, diese Überprüfung durchzuführen, wenden Sie sich an unsere [Partner](https://partner.ovhcloud.com/de/directory/).
