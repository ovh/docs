...
Per rendere sicuro il tuo account cliente, [attiva la doppia autenticazione](../../customer/proteggi_il_tuo_account_con_2FA/) e segui le istruzioni di questa [guida](/pages/account/customer/all_about_username).
...
Per prima cosa, effettua un backup dei dati che compongono il tuo sito web connettendosi al tuo [spazio FTP](../accedere-spazio-storage-ftp-hosting-web/) e al tuo [server database](/pages/web/hosting/sql_database_export). Importa sul tuo dispositivo o su un supporto esterno, come un server NAS o una chiave USB.
...
Per effettuare questa operazione, accedi al tuo [spazio FTP](../accedere-spazio-storage-ftp-hosting-web/). E richiede competenze tecniche per riconoscere eventuali file malevoli sul tuo hosting. In caso di difficoltà nell'effettuare questa verifica, contatta i nostri [partner](https://partner.ovhcloud.com/it/directory/).
