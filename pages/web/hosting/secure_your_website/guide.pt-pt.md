...
Para proteger a sua conta de cliente, [ative a dupla autenticação](../../customer/proteger-a-sua-conta-com-uma-2FA/) e siga as instruções deste [guia](/pages/account/customer/all_about_username).
