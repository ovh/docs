...
> [!primary]
>
> This guide mainly applies to emails sent from scripts located on your [OVHcloud web hosting](https://www.ovhcloud.com/en-gb/web-hosting/) using PHP's "mail()" function.
>
> If you would like to manage the email addresses included in your MX Plan package or in your [OVHcloud web hosting plan](https://www.ovhcloud.com/en-gb/web-hosting/){.external} package, please refer to our [MX Plan](https://docs.ovh.com/gb/en/emails/) documentation.
>
...
- Have an [OVHcloud web hosting](https://www.ovhcloud.com/en-gb/web-hosting/){.external} solution.
- Log in to your [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/&ovhSubsidiary=GB){.external}.

## In practice

You can monitor and manage automated emails from your OVHcloud Web Hosting plan in your [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/&ovhSubsidiary=GB){.external}. Once you have logged in, go to the `Web cloud`{.action} section, click on `Hosting plan`{.action}, then select the relevant hosting plan from the list. Then click on the `More`{.action} tab, then `Email scripts`{.action}.

![hosting](images/monitoring-automatic-emails-step1.png){.thumbnail}

The page that opens will enable you to monitor and manage automated emails sent from your [OVHcloud web hosting](https://www.ovhcloud.com/en-gb/web-hosting/).
...
- You have yourself disabled the feature from your [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/&ovhSubsidiary=GB).
...
> 
> We will provide you with the next section to help you with common tasks. Nevertheless, we recommend contacting a [specialist provider](https://partner.ovhcloud.com/en-gb/) if you encounter any difficulties. We will not be able to assist you. You can find more information in the ["Go further"](#go-further) section of this guide.
>
...
[Fix the 403 Forbidden page that appears on your website](https://docs.ovh.com/gb/en/hosting/diagnostic-403-forbidden/)
