...
>
> If you would like to manage the email addresses included in your MX Plan package or in your [OVHcloud web hosting plan](https://www.ovhcloud.com/en-ie/web-hosting/){.external} package, please refer to our [MX Plan documentation](https://docs.ovh.com/ie/en/emails/).
>
...
- An [OVHcloud web hosting](https://www.ovhcloud.com/en-ie/web-hosting/){.external} solution.
...
The page that opens will enable you to monitor and manage automated emails sent from your [OVHcloud web hosting](https://www.ovhcloud.com/en-ie/web-hosting/).
