...
>
> Are you looking to manage email addresses included in your MX Plan solution, or in your [OVHcloud Web Hosting plan](https://www.ovh.com/world/web-hosting/){.external}? Go to the `Emails`{.action} section of your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager){.external}.
>
