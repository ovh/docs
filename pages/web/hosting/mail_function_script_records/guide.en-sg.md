...
> [!primary]
>
> This guide mainly applies to emails sent from scripts located on your [OVHcloud web hosting](https://www.ovhcloud.com/en-sg/web-hosting/) using PHP's "mail()" function.
>
> If you would like to manage the email addresses included in your MX Plan package or in your [OVHcloud web hosting plan](https://www.ovhcloud.com/en-sg/web-hosting/){.external} package, please refer to our [MX Plan](https://docs.ovh.com/sg/en/emails/) documentation.
>
...
- Have an [OVHcloud web hosting](https://www.ovhcloud.com/en-sg/web-hosting/){.external} solution.
...
You can monitor and manage automated emails from your OVHcloud Web Hosting plan in your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg){.external}. Once you have logged in, go to the `Web cloud`{.action} section, click on `Hosting plan`{.action}, then select the relevant hosting plan from the list. Then click on the `More`{.action} tab, then `Email scripts`{.action}.

![hosting](images/monitoring-automatic-emails-step1.png){.thumbnail}

The page that opens will enable you to monitor and manage automated emails sent from your [OVHcloud web hosting](https://www.ovhcloud.com/en-sg/web-hosting/).
...
- You have yourself disabled the feature from your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg).
...
- Analyse [your hosting logs](https://docs.ovh.com/sg/en/hosting/shared_view_my_websites_logs_and_statistics/) to identify security vulnerabilities and infected files.
...
> 
> We will provide you with the next section to help you with common tasks. Nevertheless, we recommend contacting a [specialist provider](https://partner.ovhcloud.com/en-sg/) if you encounter any difficulties. We will not be able to assist you. You can find more information in the ["Go further"](#go-further) section of this guide.
>
...
> [!warning]
> 
> Emails sent with a script that uses an SMTP configuration cannot be managed and tracked from your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg).
> 
...
[View your hosting logs](https://docs.ovh.com/sg/en/hosting/shared_view_my_websites_logs_and_statistics/)

[Fix the 403 Forbidden page that appears on your website](https://docs.ovh.com/sg/en/hosting/diagnostic-403-forbidden/)
