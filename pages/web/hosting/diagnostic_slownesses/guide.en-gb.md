...
If you are using a database of a **CloudDB** solution, please refer to our guide on [CloudDB databases](https://docs.ovh.com/gb/en/clouddb/connecting-to-database-on-database-server/).
