...
If you are using a database of a **Web Cloud Databases** solution, please refer to our guide on [Web Cloud Databases databases](/pages/web/clouddb/connecting-to-database-on-database-server).
