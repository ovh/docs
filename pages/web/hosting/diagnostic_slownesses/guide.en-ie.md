...
If you are using a database for a **CloudDB** solution, please refer to our guide on [connecting to your database via a Cloud DB solution](https://docs.ovh.com/fr/clouddb/connexion-base-de-donnees-serveur-bdd/).
