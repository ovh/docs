...
Para que su navegador encuentre la dirección IPv6 con su nombre de dominio, modifique la zona DNS activa de su dominio. Utilice nuestra guía "[Editar una zona DNS de OVHcloud](/pages/web/domains/dns_zone_edit#editar-la-zona-dns-de-ovhcloud-de-un-dominio_1)" para crear un registro DNS de tipo **AAAA**.
...
[Editar una zona DNS de OVHcloud](/pages/web/domains/dns_zone_edit#editar-la-zona-dns-de-ovhcloud-de-un-dominio_1)
