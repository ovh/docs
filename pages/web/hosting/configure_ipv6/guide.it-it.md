...
Per consentire al browser di trovare l'indirizzo IPv6 con il tuo dominio, modifica la zona DNS attiva del tuo dominio. Per creare un record DNS di tipo **AAAA**, consulta la guida "[Modificare una zona DNS OVHcloud](/pages/web/domains/dns_zone_edit#modifica-la-zona-dns-ovhcloud-del-dominio_1)".
...
[Modifica una zona DNS OVHcloud](/pages/web/domains/dns_zone_edit#modifica-la-zona-dns-ovhcloud-del-dominio_1)
