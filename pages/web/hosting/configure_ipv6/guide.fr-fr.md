...
Pour en savoir plus, n'hésitez pas à cosulter l'article de [wikipédia](https://fr.wikipedia.org/wiki/IPv6) sur le protocole IPv6.
...
**Ce guide vous indique comment vérifier si votre site est compatible en IPv6 et commet le configurer pour qu'il le soit.**
...
Pour tester si votre site web est compatible avec IPv6, vous pouvez utiliser le site [ipv6-test.com](https://ipv6-test.com/validate.php). Ce dernier vous indiquera si votre site répond sur ce nouveau protocole IP. Si ça n'est pas le cas, poursuivez ce guide pour le rendre compatible.

### Étape 1 : Récupérer l'adresse IPv6 de votre hébergement web

Connectez-vous à votre [espace client OVHcloud](https://www.ovh.com/auth/?action=gotomanager){.external}, cliquez sur `Hébergements`{.action} dans la barre de services à gauche, puis choisissez l'hébergement.

Dans la rubrique `Informations générales`, dans le cadre **IPv6**, copier l'entrée et passez à l'étape suivante.
