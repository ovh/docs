...
To verify these details, you can use a [SSH connection](/pages/web/hosting/ssh_on_webhosting). (SSH is only available with the [Professional Hosting and Performance Hosting](https://www.ovhcloud.com/en-sg/web-hosting/).)
