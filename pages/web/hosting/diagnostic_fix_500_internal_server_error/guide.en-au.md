...
To verify these details, you can use a [SSH connection](../web_hosting_ssh_on_web_hosting_packages/). (SSH is only available with the [Professional Hosting and Performance Hosting](https://www.ovhcloud.com/en-au/web-hosting/).)
