...
- a [Web Cloud hosting plan](https://www.ovhcloud.com/en-ie/web-hosting/) that allows you to install a 1-click module (only the free [Start10M plan](https://docs.ovh.com/ie/en/hosting/activate-start10m/) does not provide this feature)
...
> [!warning]
>
> Backing up your data is an essential part of the [securing of your websites](https://docs.ovh.com/ie/en/hosting/secure-website/). We recommend you to download regularly your data backup on a local device, such as an USB key or external hard drive, following the instructions in this [guide](https://docs.ovh.com/gb/en/hosting/export-a-website/).
>
