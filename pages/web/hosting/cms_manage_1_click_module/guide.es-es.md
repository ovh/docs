...
Si dispone de una sola base de datos en esta parte del área de cliente y no dispone de soluciones [SQL Privado](https://www.ovhcloud.com/es-es/web-hosting/options/private-sql/), puede considerar que se trata de la de su sitio web.
