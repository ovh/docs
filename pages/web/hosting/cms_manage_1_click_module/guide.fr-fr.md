...
> [!primary]
>
> Si votre site ne s'affiche pas correctement suite à cette manipulation, consultez les guides OVHCLOUD liés aux hébergements mutualisés dans la section [Diagnostic](../).
>
...
Recherchez tout d'abord l'e-mail reçu lors de la création de votre module depuis votre [espace client OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr) : cliquez sur votre nom en haut à droite de l'écran puis, dans le menu qui apparaît, cliquez sur vos initiales (Bouton `Gérer mon compte`{.action}) puis sur l'onglet `Emails reçus`{.action}).
...
> [!warning]
>
> Après avoir reçu ce message, le lien de réinitialisation restera valide pendant 48 heures. 
>
> Après avoir cliqué sur le lien en lui-même, vous pourrez l'utiliser pendant 30 minutes.
>

Vous pouvez également modifier ce mot de passe en vous rendant directement sur la page de connexion à l'espace administrateur de votre site Web :
...
Cliquez sur le point d'interrogation à côté du champ `Mot de passe`{.action} :

![admin_joomla1](images/admin_joomla1.png){.thumbnail}

Indiquez l'adresse e-mail de votre compte administrateur sur Joomla (par défaut, celle de votre compte OVHcloud) et cliquez sur `Envoyer`{.action} :
...
Cliquez sur `Réinitialiser votre mot de passe`{.action} :

![admin_drupal1](images/admin_drupal1.png){.thumbnail}

Indiquez le nom d'utilisateur ou l'adresse e-mail de votre compte administrateur sur Drupal (par défaut, celle de votre compte OVHcloud) et cliquez sur `Envoyer nouveau mot de passe par courriel`{.action}
...
#### Étape 1 : identifier la base de données lié à votre module <a name=" "></a>
