...
- Avoir créé un module en 1 clic sur votre hébergement (Si vous n'avez pas encore effectué cette installation, suivez les instructions de ce [guide](../modules-en-1-clic/)).
...
> [!primary]
>
> Si votre site ne s'affiche pas correctement suite à cette manipulation, consultez les guides OVHCLOUD de la section [Diagnostic](../) liée aux hébergements mutualisés.
>
...
Cliquez ensuite sur le bouton `...`{.action} à droite de la ligne concernant votre module puis sur `Modifier le mot de passe`{.action}. Cliquez sur `Valider`{.action}. Vous recevrez sous quelques minutes un lien de réinitialisation de votre mot de passe par e-mail.

> [!warning]
>
> Après avoir cliqué sur ce lien, il restera valide pendant 30 minutes. Pendant 48 heures sinon, après avoir reçu l'e-mail de réinitialisation de votre mot de passe.
>
...
Connectez-vous ensuite à [l'espace FTP de votre hébergement](../connexion-espace-stockage-ftp-hebergement-web/). Ouvrez le `Dossier racine` et retrouvez le fichier de configuration de votre module en fonction du CMS utilisé :

- Pour WORDPRESS : **« wp-config.php »** (le nom de la base de votre module apparaît sous la mention **« DB_NAME »**).
- Pour JOOMLA : **« configuration.php »** (le nom de la base de votre module apparaît sous la mention **« public $db »**).
- Pour DRUPAL : **« settings.php »** (Pour le retrouver, rendez-vous dans le dossier « sites » puis « default ». Le nom de la base de votre module apparaît sous la mention **« 'database' »**).
