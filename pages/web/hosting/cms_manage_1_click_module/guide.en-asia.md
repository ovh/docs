...
Then log on to the [FTP space](/pages/web/hosting/ftp_connection) of your web hosting. Open the `Root folder` found earlier in the `Multisite`{.action} tab and browse in to the configuration file of your website:
