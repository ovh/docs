...
> Check the [IP address list for Web Hosting clusters](https://docs.ovh.com/au/en/hosting/list-of-ip-addresses-of-web-hosting-clusters/) to find the specific IP address for your cluster’s CDN.
...
> [!warning]
>
> Some options are locked on the Basic solution and require you to sign up to [CDN Security](https://www.ovhcloud.com/en-au/web-hosting/options/cdn/) or [CDN Advanced](https://www.ovhcloud.com/en-au/web-hosting/options/cdn/).
...
> [!warning]
>
> To have a higher quota of rules and more settings available than creating cache rules, you can choose the [Advanced CDN option](https://www.ovhcloud.com/en-au/web-hosting/options/cdn/).
...
> [!primary]
> The options explained below require a subscription to [CDN Security](https://www.ovhcloud.com/en-au/web-hosting/options/cdn/) or [CDN Advanced](https://www.ovhcloud.com/en-au/web-hosting/options/cdn/).
...
> [!warning]
>
> For the installation of an [OVHcloud 1-click module](https://docs.ovh.com/au/en/hosting/web_hosting_web_hosting_modules/), the WAF must be disabled in order to prevent the installation of the module from being blocked.
...
> [!primary]
>
> The options presented below require a subscription to [CDN Advanced](https://www.ovhcloud.com/en-au/web-hosting/options/cdn/).
