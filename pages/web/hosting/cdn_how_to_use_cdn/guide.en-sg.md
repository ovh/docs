...
> [!primary]
> The options presented below require a subscription to [CDN Security](https://www.ovhcloud.com/en-sg/web-hosting/options/cdn/) or [CDN Advanced](https://www.ovhcloud.com/en-sg/web-hosting/options/cdn/).
