...
> Check the [IP address list for Web Hosting clusters](https://docs.ovh.com/ie/en/hosting/list-of-ip-addresses-of-web-hosting-clusters/) to find the specific IP address for your cluster’s CDN.
...
> [!warning]
>
> For the installation of an [OVHcloud 1-click module](https://docs.ovh.com/ca/en/hosting/web_hosting_web_hosting_modules/), the WAF must be disabled in order to prevent the installation of the module from being blocked.
