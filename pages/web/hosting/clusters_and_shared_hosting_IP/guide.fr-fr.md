...
Si vous avez le  **CDN Business**  activé sur votre hébergement, vous devez utiliser cette adresse IP :
...
Si vous avez le  **CDN Basic**  activé sur votre hébergement, vous devez utiliser cette adresse IP :
