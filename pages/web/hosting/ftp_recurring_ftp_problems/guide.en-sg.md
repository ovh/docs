...
> [!primary]
>
> For any other error messages, see the `Troubleshooting` section of our [Web Hosting guides](/sg/en/hosting/).
>
...
If you have a [Pro](https://www.ovhcloud.com/en-sg/web-hosting/professional-offer/) or [Performance](https://www.ovhcloud.com/en-sg/web-hosting/performance-offer/) Web Hosting plan, use the [SSH protocol](/pages/web/hosting/ssh_on_webhosting) to import files on to your file storage space.
