...
> [!primary]
>
> For any other error messages, see the `Troubleshooting` section of our [Web Hosting guides](/ie/en/hosting/).
>
...
If you have a [Pro](https://www.ovhcloud.com/en-ie/web-hosting/professional-offer/) or [Performance](https://www.ovhcloud.com/en-ie/web-hosting/performance-offer/) Web Hosting plan, use the [SSH protocol](/pages/web/hosting/ssh_on_webhosting) to import files on to your file storage space.
