...
>
> If the `Global PHP version`{.action} option does not appear in your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca), check that a "**.ovhconfig**" file does exist in the FTP root of your OVHcloud shared hosting plan by referring to our guide on [configuring the ".ovhconfig" file](https://docs.ovh.com/ca/en/hosting/configuring-file-ovhconfig/).
>
