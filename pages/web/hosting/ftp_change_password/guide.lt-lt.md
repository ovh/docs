...
There are two ways you can modify an FTP user's password, depending on which [OVH Web Hosting plan](https://www.ovh.lt/svetainiu-talpinimas/){.external} you are using:
...
There are several ways of doing this, depending on which [OVH Web Hosting plan](https://www.ovh.lt/svetainiu-talpinimas/){.external} you are using:
...
[FileZilla user guide](https://docs.ovh.com/lt/hosting/svetainiu_talpinimas_filezilla_naudojimas/){.external}.

[SSH on web hosting packages](https://docs.ovh.com/lt/hosting/svetainiu_talpinimas_ssh_prieiga/){.external}.
