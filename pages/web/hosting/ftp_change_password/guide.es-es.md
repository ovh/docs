...
Conéctese al [área de cliente de OVH](https://www.ovh.com/auth/?action=gotomanager){.external}, haga clic en `Alojamientos`{.action} en la columna izquierda y seleccione el alojamiento correspondiente. A continuación, abra la pestaña `FTP-SSH`{.action}.
...
En función de su [plan de hosting de OVH](https://www.ovh.es/hosting/){.external}, podrá cambiar la contraseña de un usuario FTP de una de las siguientes formas:
...
En función del [plan de hosting de OVH](https://www.ovh.es/hosting/){.external} del que disponga, podrá acceder de diversas formas:
