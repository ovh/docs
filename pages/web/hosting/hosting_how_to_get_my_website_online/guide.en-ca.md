...
If you already have a database and wish to use it (from an [OVHcloud web hosting plan](https://www.ovhcloud.com/en-ca/web-hosting/) or a [Private SQL](https://www.ovhcloud.com/en-ca/web-hosting/options/start-sql/){.external} or [Cloud DB solution](https://www.ovh.co.uk/cloud/cloud-databases/){.external}), you will need your username and password, the name of the database and the address of the server. You can now go on to the next step.
...
[Modifying an FTP user password](https://docs.ovh.com/ca/en/hosting/modify-ftp-user-password/)
