...
If you already have a database and wish to use it (from an [OVHcloud web hosting plan](https://www.ovhcloud.com/asia/web-hosting/) or a [Private SQL](https://www.ovhcloud.com/asia/web-hosting/options/start-sql/){.external} or [Cloud DB solution](https://www.ovh.co.uk/cloud/cloud-databases/){.external}), you will need your username and password, the name of the database and the address of the server. You can now go on to the next step.
...
[Setting up your website with 1-click modules](https://docs.ovh.com/asia/en/hosting/web_hosting_web_hosting_modules/)

[Modifying an FTP user password](https://docs.ovh.com/asia/en/hosting/modify-ftp-user-password/)
