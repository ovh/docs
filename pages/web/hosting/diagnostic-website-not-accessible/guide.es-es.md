...
Para comprobar la validez de sus [servidores DNS](/pages/web/domains/dns_server_general_information), haga clic en [área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es) y seleccione el dominio del `Dominios`{.action}.
