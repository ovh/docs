...
A continuación, cópiela en la [zona DNS](/pages/web/domains/dns_zone_edit#editar-la-zona-dns-de-ovhcloud-de-su-dominio_1) de su dominio modificando o creando uno o más registros de tipo `A`.
