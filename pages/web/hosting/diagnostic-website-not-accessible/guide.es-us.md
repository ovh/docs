...
Si su sitio web está alojado en uno de nuestros [planes de hosting Cloud](https://www.ovhcloud.com/es/web-hosting/), abra la pestaña `Alojamientos`{.action} a la izquierda de su pantalla y seleccione el alojamiento correspondiente.
