...
De seguida, aceda à [Zona DNS](/pages/web/domains/dns_zone_edit#editar-a-zona-dns-da-ovhcloud-do-seu-dominio_1) do seu domínio alterando ou criando uma ou mais entradas de tipo `A`.
