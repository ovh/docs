...
Pour vérifier la validité de vos [serveurs DNS](/pages/web/domains/dns_server_general_information), dans votre [espace client OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc) cliquez sur `Noms de domaine`{.action}, puis sur le domaine de votre site.
