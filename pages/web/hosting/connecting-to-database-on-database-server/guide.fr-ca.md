...
- Disposer d'une [offre d'hébergement SQL Privé](https://www.ovhcloud.com/fr-ca/web-hosting/options/start-sql/){.external}.
...
> [!primary]
>
> Il est à noter que les offres [SQL Privé](https://www.ovhcloud.com/fr-ca/web-hosting/options/start-sql/){.external} ne donnent pas accès au Host mais aux bases de données hébergées sur celui-ci. 
