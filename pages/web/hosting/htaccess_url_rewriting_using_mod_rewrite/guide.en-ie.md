...
To edit (or create) directories, log in to your hosting plan’s FTP space. If you need help with this, please refer to our guide on [Accessing my storage space](https://docs.ovh.com/ie/en/hosting/log-in-to-storage-ftp-web-hosting/).
...
Please refer to our guide on [configuring a multisite on a shared hosting plan](https://docs.ovh.com/ie/en/hosting/multisites-configuring-multiple-websites/) if you would like more information on this subject.
...
[Block access to my website for certain IP addresses via a .htaccess file](https://docs.ovh.com/ie/en/hosting/htaccess_how_to_block_a_specific_ip_address_from_accessing_your_website/)
