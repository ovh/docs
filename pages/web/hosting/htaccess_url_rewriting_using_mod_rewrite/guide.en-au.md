...
To edit (or create) directories, log in to your hosting plan’s FTP space. If you need help with this, please refer to our guide on [Accessing your Web Hosting plan’s storage space](/pages/web/hosting/ftp_connection).
...
Please refer to our guide on [Hosting multiple websites on your Web Hosting plan](/pages/web/hosting/multisites_configure_multisite) if you would like more information on this subject.
...
If you do not have an SSL certificate, please refer to our guide on [Managing an SSL certificate on an OVHcloud shared hosting plan](/pages/web/hosting/ssl_on_webhosting).
...
[Protect your website's administration interface with a .htaccess file](/pages/web/hosting/htaccess_protect_directory_by_password)
