...
- You must have a Private SQL instance (included in [web hosting plans](https://www.ovhcloud.com/en-ca/web-hosting/){.external}, or available to order as an [SQL option](https://www.ovhcloud.com/en-ca/web-hosting/options/start-sql/){.external}).
- You must have a [web hosting plan](https://www.ovhcloud.com/en-ca/web-hosting/){.external} hosted in the same datacentre as your Private SQL instance (you can view this information in your OVHcloud Control Panel).
...
If your hosting plan includes the Private SQL option, go to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca){.external}. In the `Web Cloud`{.action} section, click `Web Hosting`{.action} in the left-hand column.
...
In the services bar on the left-hand side of your [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca){.external}, go to the `Databases`{.action} section, then to the SQL instance concerned. Click on the `General information`{.action} tab.
