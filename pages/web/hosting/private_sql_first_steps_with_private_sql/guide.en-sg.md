...
- You must have a Private SQL instance (included in [web hosting plans](https://www.ovhcloud.com/en-sg/web-hosting/){.external}, or available to order as an [SQL option](https://www.ovhcloud.com/en-sg/web-hosting/options/start-sql/){.external}).
- You must have a [web hosting plan](https://www.ovhcloud.com/en-sg/web-hosting/){.external} hosted in the same datacentre as your Private SQL instance (you can view this information in your OVHcloud Control Panel).
