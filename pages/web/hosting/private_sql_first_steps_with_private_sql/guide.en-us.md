...
- You must have a Private SQL instance (included in [web hosting plans](https://www.ovh.com/world/web-hosting/){.external}, or available to order as an [SQL option](https://www.ovh.com/world/web-hosting/sql-options.xml){.external}).
- You must have a [web hosting plan](https://www.ovh.com/world/web-hosting/){.external} hosted in the same datacentre as your Private SQL instance (you can view this information in your OVHcloud Control Panel).
