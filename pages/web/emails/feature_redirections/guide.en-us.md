...
- A preconfigured OVHcloud email solution, such as [**Hosted Exchange**](https://www.ovhcloud.com/en/emails/hosted-exchange/) or **MX Plan** (available with a [web hosting plan](https://www.ovhcloud.com/en/web-hosting/), a [free Start 10M hosting plan](https://www.ovhcloud.com/en/domains/free-web-hosting/), or ordered separately)
