...
- An MX Plan solution, available as part of our [Web Hosting plans](https://www.ovh.com.au/web-hosting/)
...
Go to the webmail platform [here](https://www.ovh.com.au/mail){.external}. Enter the **email address** and **password** to log in.
![emails](images/webmail.png){.thumbnail}

#### Step 1: Access the section for managing redirections.

Once you have logged in via the [webmail platform](https://www.ovh.com.au/mail){.external}, click on the cogwheel icon in the top right-hand corner, then `Options`{.action}.
