...
Renseignez le mot de passe défini dans votre [Manager](https://www.ovh.com/auth/?action=gotomanager){.external} pour le compte mutualisé OVH.
...
Mot de passe : *le mot de passe défini dans votre* [Manager](https://www.ovh.com/auth/?action=gotomanager){.external} *pour le compte mutualisé OVH.*
...
Mot de passe SMTP : *le mot de passe défini dans votre* [Manager](https://www.ovh.com/auth/?action=gotomanager){.external} *pour le compte mutualisé OVH.*
