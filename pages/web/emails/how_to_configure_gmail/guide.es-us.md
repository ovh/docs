...
Haga clic en el icono con forma de rueda dentada y seleccione `ver todos los parámetros`{.action}. A continuación, haga clic en `Cuentas e importación`{.action}. 
