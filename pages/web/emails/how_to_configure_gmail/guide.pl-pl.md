...
Po zalogowaniu do interfejsu kliknij ikonę koła zębatego, a następnie `wyświetl wszystkie parametry`{.action}. Na stronie, która się wyświetli, kliknij zakładkę `Konta i import`{.action}. 
