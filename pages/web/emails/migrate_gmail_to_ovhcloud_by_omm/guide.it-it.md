...
In questo caso, accedi alla casella di posta in arrivo del tuo account Gmail e controlla se hai ricevuto l’email con oggetto: **“Avviso di sicurezza”** Si tratta di una misura di sicurezza adottata da Gmail. Per risolvere questa situazione, consulta la guida:  [Consentire alle applicazioni meno sicure di accedere al tuo account Gmail](/pages/web/emails/migrate_gmail_to_ovhcloud_by_omm/security_gmail){.external}
...
[Consentire alle applicazioni meno sicure di accedere al tuo account Gmail](/pages/web/emails/migrate_gmail_to_ovhcloud_by_omm/security_gmail){.external}.
