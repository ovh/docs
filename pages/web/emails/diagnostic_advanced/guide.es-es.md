...
Puede consultar las distintas tareas en curso en <http://travaux.ovh.net/>este momento.
...
|554|Transacción fallida, "Aquí no hay servicios SMTP")|En general, se trata de un problema de lista negra. Compruebe si su dirección IP del servidor de correo no es blacklistada ([SpamHaus](https://www.spamhaus.org/lookup/){.external})|
