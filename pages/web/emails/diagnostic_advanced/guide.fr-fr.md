...
|550 5.7.26|This message does not have authentication information or fails to 550-5.7.26 pass authentication checks| l'e-mail a été rejeté car le service e-mail n'a pas de SPF ou de DKIM configuré sur son nom de domaine.<br><br> Il est conseillé de mettre en place un enregistrement SPF en priorité, celui-ci est compatible avec l'ensemble des offres e-mail. Pour cela appuyez-vous du guide [Configurer un enregistrement SPF sur son nom de domaine](/pages/web/domains/dns_zone_spf).<br><br> Si votre offre e-mail dispose de l'option DKIM, vous pouvez la mettre en place à l'aide de notre guide [Configurer un enregistrement DKIM](/pages/web/domains/dns_zone_dkim)|
