...
|449|Errore di routing|Questo errore è restituito esclusivamente dai server di posta Microsoft Exchange. Microsoft consiglia di effettuare una diagnostica utilizzando il tool [WinRoute](https://support.microsoft.com/it-it/kb/281382)|
