...
[La migrazione automatica](/pages/web/microsoft-collaborative-solutions/migration_omm){.external} di un indirizzo email è possibile tramite il nostro tool [OVH Mail Migrator](https://omm.ovh.net/){.external}. Inoltre, è possibile migrare manualmente il tuo indirizzo email tramite client di posta.
...
> [!primary]
> Per prima cosa, verifica che la migrazione automatica sia possibile utilizzando il nostro tool [OVH Mail Migrator](https://omm.ovh.net/){.external}. Per effettuare questa operazione, consulta la guida [Migrare account email via OVH Mail Migrator](/pages/web/microsoft-collaborative-solutions/migration_omm){.external}.
...
[Migrare un account email con OVH Mail Migrator](/pages/web/microsoft-collaborative-solutions/migration_omm){.external}
