...
You can [migrate an email address automatically](/pages/web/microsoft-collaborative-solutions/migration_omm){.external} via our [OVH Mail Migrator](https://omm.ovh.net/){.external} tool. You can also manually migrate your email address using an email client.
