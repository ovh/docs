...
routes:
    canonical: 'https://docs.ovh.com/asia/en/emails/configure-email-for-thunderbird-windows/'
...
- an MX Plan email address (included in the MX Plan solution and in [OVHcloud Web Hosting plans](https://www.ovh.com/asia/web-hosting/){.external})
