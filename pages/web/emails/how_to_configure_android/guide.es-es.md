...
OVH ofrece una aplicación web con la que podrá acceder a su cuenta de correo electrónico desde el navegador, disponible en la dirección <https://mail.ovh.net/es/>. Puede conectarse con el nombre de usuario y la contraseña de su dirección de correo electrónico.
