...
OVH also offers a web application that you can use to consult your email from a web browser. You can access this application at <https://mail.ovh.net/lt/>. Just log in using your email login details.
