...
If you don't see this column, spam filters can only be created by setting up inbox rules on your email account via [webmail](/pages/web/emails/creating-inbox-rules-in-owa-mx-plan) for detailed instructions.
