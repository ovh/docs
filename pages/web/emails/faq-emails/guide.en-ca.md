...
You can configure your email account to use an email client like Outlook, Thunderbird, Mac Mail, etc. To do this, we have created guides to help you set up your email address. You can find them on [this page](/ca/en/emails/). 
...
If you don't see this column, spam filters can only be created by setting up inbox rules on your email account via [webmail](https://www.ovh.com/ca/en/mail/). Please refer to [this guide](/pages/web/microsoft-collaborative-solutions/creating-inbox-rules-in-owa) for detailed instructions.
