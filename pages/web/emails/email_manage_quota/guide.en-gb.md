...
- a pre-configured OVHcloud email solution (**MX Plan**, available as part of our web[ hosting ](https://www.ovhcloud.com/fr/web-hosting/)plans, included in a free[ Start10M ](https://www.ovhcloud.com/fr/domains/free-web-hosting/)hosting package or ordered separately as a standalone solution, such as [**Hosted Exchange**](https://www.ovhcloud.com/fr/emails/hosted-exchange/) or [**Email Pro**](https://www.ovhcloud.com/fr/emails/email-pro/))
- access to the OVHcloud Control [Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr){.external}, and `Web Cloud`{.action} section
...
> **Special cases**
>
> - Regarding the free Start 10M hosting solution, you will need to activate it beforehand in order to create an email address. You can do this from your OVHcloud Control [Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr){.external} by going to the domain name concerned.
> - For web [hosting plans](https://www.ovhcloud.com/fr/web-hosting/){.external}, you will need to activate your MX Plan package before continuing to read this guide. To do this, please refer to our guide on [Activating the email addresses included in your web](https://docs.ovh.com/fr/hosting/activer-email-hebergement-web/) hosting plan.
...
In the OVHcloud Control [Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr){.external}, go to the `Web Cloud`{.action} section, then follow the instructions for your solution:
...
To log in to webmail, go to the page <https://www.ovhcloud.com/fr/mail/>and enter the login information for your email account. Then select the webmail address for your solution below:
...
When your email account is full, you can always send emails on your side. However, these emails cannot be stored in your `outbox`.
...
> **Emails (MXplan)**
>>
>> The capacity of an MXplan account can range from 2.5 MB to 5 GB. If it is full and its capacity is less than 5GB, you can change its capacity via the>
...
> **Email Pro**
>> 
>> The Email Pro offer has a unique capacity of 10 GB. If you need more storage, you will need to upgrade to a plan that offers more space. To do this, read >
>>
> **Exchange**
>>
...
>> In the `Email`{.action} accounts tab for your platform, click the button to the right of the account you want to modify, then click <i class="icons-ellipsis icons-border-rounded icons-masterbrand-blue"></i>Increase capacity to 300 GB` `{.action}. Select the billing method that best suits you, then click `Confirm`{.action}.<br><br>
...
>> In the Email` `{.action}accounts tab on your Exchange platform, click the button to the right <i class="icons-ellipsis icons-border-rounded icons-masterbrand-blue"></i>of the account you want to modify, then click `Increase capacity to 300 GB`{.action}.<br><br>
>> ![email](images/email-quota-more02.png){.thumbnail}<br>
>>

## Go further

[Migrate an MX Plan email address to an Email Pro or Exchange account](https://docs.ovh.com/fr/microsoft-collaborative-solutions/migration-adresse-e-mail-mutualisee-vers-exchange/)

[Manually migrate your email address](https://docs.ovh.com/fr/emails/migrer-ses-adresses-email-manuellement/)

[Migrate your email addresses from one OVHcloud email platform to another](https://docs.ovh.com/fr/microsoft-collaborative-solutions/migration-email-platform/)
