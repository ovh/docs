...
- Dostęp do [Panelu klienta OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr){.external}, sekcja `Web Cloud`{.action}.
...
>
> - Jeśli chodzi o bezpłatny hosting Start 10M, konieczne jest wcześniejsze aktywowanie go przed utworzeniem konta e-mail. Operację tę możesz przeprowadzić w Panelu [klienta OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr){.external}, przechodząc do odpowiedniej domeny.
> - Zanim przejdziesz do niniejszego przewodnika, należy aktywować Twój [pakiet MX Plan zawarty w ofercie](https://www.ovhcloud.com/fr/web-hosting/){.external} hostingu. W tym celu zapoznaj się z naszym przewodnikiem "[Aktywuj konta e-mail zawarte w Twoim hostingu](https://docs.ovh.com/fr/hosting/activer-email-hebergement-web/)".
...
W [Panelu klienta OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr){.external} przejdź do sekcji `Web Cloud`{.action} i postępuj zgodnie z instrukcjami zawartymi w Twojej ofercie:
...
Aby zalogować się do interfejsu Webmail, przejdź do strony <https://www.ovhcloud.com/fr/mail/>i wprowadź dane do logowania do konta e-mail. Wybierz poniżej interfejs webmail dla swojej usługi:
...
- `2`{.action} **Elementy wysłane (czują wiadomości)**: po wysłaniu wiadomości e-mail zostanie ona wysłana do odbiorcy. Jest on również przechowywany na koncie e-mail w "przesłanych elementach". Zalecamy regularne czyszczenie tego katalogu lub archiwizację jego zawartości lokalnie na komputerze lub na zdalnej przestrzeni dyskowej typu "cloud".
...
> **E-maile (MXplan)**
>>
>> Konto MXplan może mieć rozmiar od 2,5 MB do 5 GB. Jeśli pojemność jest wysycona i jest mniejsza niż 5 GB, możesz zmienić jej pojemność poprzez>
>> W zakładce `Konta e-mail`{.action} kliknij przycisk po prawej stronie konta, które chcesz zmienić, po czym kliknij <i class="icons-ellipsis icons-border-rounded icons-masterbrand-blue"></i>Zmień` `{.action}.
...
> **Email Pro**
>> 
>> Oferta Email Pro posiada unikalną pojemność 10 GB. Jeśli potrzebujesz większej przestrzeni dyskowej, zmień ofertę proponującą więcej przestrzeni dyskowej. W tym celu przeczytaj sekcję >
>>
> **Exchange**
>>
...
>> W zakładce `Konta e-mail`{.action} Twojej platformy kliknij przycisk po prawej stronie konta, które chcesz zmienić, po czym kliknij <i class="icons-ellipsis icons-border-rounded icons-masterbrand-blue"></i>Zwiększ pojemność do 300 GB` `{.action}. Wybierz odpowiedni dla Ciebie sposób płatności i kliknij na `Zatwierdź`{.action}.<br><br>
...
> **E-maile (MXplan)**
>>
>> Konfiguracja konta MXplan w systemie **Windows**:<br><br>
>> - >
>> - ><br>
>> Konfiguracja konta MXplan na **macOS**:<br><br>
>> - >
>> - >
>> - >
>>
> **E-mail Pro**
>>
>> Konfiguracja konta E-mail Pro w systemie **Windows**:<br><br>
>> - >
>> - >
>> - ><br>
>> Konfiguracja konta E-mail Pro na **macOS**:<br><br>
>> - >
>> - >
>> - >
>>
> **Exchange**
>>
>> Konfiguracja konta Exchange w systemie **Windows**:<br><br>
>> - >
>> - >
>> - ><br>
...
>> W zakładce `Konta e-mail`{.action} w Twojej usłudze Exchange kliknij przycisk po prawej stronie konta, który chcesz zmienić, a następnie kliknij <i class="icons-ellipsis icons-border-rounded icons-masterbrand-blue"></i>Zwiększ pojemność do 300 GB` `{.action}.<br><br>
>> ![email](images/email-quota-more02.png){.thumbnail}<br>
>>

## Sprawdź również

[Przeniesienie konta e-mail MX Plan na konto E-mail Pro lub Exchange](https://docs.ovh.com/fr/microsoft-collaborative-solutions/migration-adresse-e-mail-mutualisee-vers-exchange/)

[Ręczna migracja Twojego konta e-mail](https://docs.ovh.com/fr/emails/migrer-ses-adresses-email-manuellement/)

[Przeniesienie kont e-mail z jednej platformy e-mail OVHcloud na inną](https://docs.ovh.com/fr/microsoft-collaborative-solutions/migration-email-platform/)
