...
>> - [Outlook](/pages/web/microsoft-collaborative-solutions/how_to_configure_outlook_2016-mac/)<br>
...
> **E-mails (MXplan)**
>>
>> Se a capacidade da sua conta de e-mail já está a um máximo de 5GB, pode optar por uma migração para uma oferta [**Email Pro** de 10GB](https://www.ovhcloud.com/pt/emails/email-pro/) ou [**Hosted Exchange** de 50GB](https://www.ovhcloud.com/pt/emails/hosted-exchange/). Para isso, sugerimos que encomende a oferta mais adequada e siga a documentação "[Migrar um endereço de e-mail MX Plan para uma conta E-mail Pro ou Exchange](/pages/web/microsoft-collaborative-solutions/migration_control_panel)". 
>>
> **Email Pro**
>>
>> A oferta Email Pro dispõe de uma capacidade única de 10GB. Pode optar por uma migração para uma oferta [**Hosted Exchange** de 50GB](https://www.ovhcloud.com/pt/emails/hosted-exchange/). Para isso, sugerimos que encomende a oferta mais adequada e siga o nosso manual "[Migrar os endereços de e-mail de uma plataforma de e-mail da OVHcloud para outra](/pages/web/microsoft-collaborative-solutions/migration_platform)".
>>
> **Exchange**
>>
...
[Migrar um endereço de e-mail MX Plan para uma conta E-mail Pro ou Exchange](/pages/web/microsoft-collaborative-solutions/migration_control_panel)

[Migrar manualmente o seu endereço de e-mail](/pages/web/emails/manual_email_migration)

[Migrar os endereços de e-mail de uma plataforma de e-mail OVHcloud para outra](/pages/web/microsoft-collaborative-solutions/migration_platform)
