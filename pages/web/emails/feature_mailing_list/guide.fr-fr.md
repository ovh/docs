...
Afin de créer votre mailing list, rendez-vous dans votre [Espace client OVHcloud](http://www.ovh.com/manager/web){.external}  et sélectionnez l'onglet `Web Cloud`{.action} en haut.
