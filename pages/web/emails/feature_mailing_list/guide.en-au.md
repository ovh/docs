...
- an MX Plan 100 minimum or [Web Hosting plan](https://www.ovhcloud.com/en-au/web-hosting/){.external} eligible for mailing lists
...
To create a mailing list, go to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au){.external} and click on the `Web Cloud`{.action} tab at the top.
