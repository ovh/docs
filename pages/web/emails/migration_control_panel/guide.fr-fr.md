...
> Si vos e-mails sont uniquement enregistrés en local (configuration en POP ou archivage en local), vous pouvez effectuer un [export depuis votre logiciel de messagerie](/pages/web/emails/manual_email_migration), puis [importer votre fichier PST via OMM](/pages/web/emails/migration_omm#realiser-une-migration-par-fichier) ou [importer directement depuis votre logiciel de messagerie](/pages/web/emails/manual_email_migration).
