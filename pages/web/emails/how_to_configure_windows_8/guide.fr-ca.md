...
### Comptes
Cliquez ensuite sur l'icône "Comptes" afin d'ajouter votre nouveau compte e-mail mutualisé OVHcloud.
...
"Adresse de messagerie" : L'adresse e-mail mutualisé OVHcloud en entier.

"Mot de passe" : Le mot de passe défini dans [l'espace client](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc){.external} pour ce compte e-mail.
