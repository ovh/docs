...
- You must have an MX Plan email address (included in the MX Plan solution and in OVHcloud web [hosting plans](https://www.ovhcloud.com/en-gb/web-hosting/){.external}).
...
| | |
|---|---|
|![mailmac](images/mail-mac-mxplan01.png){.thumbnail}|Select `Add Other Account...`{.action} , then click `Mail account`{.action} .|
