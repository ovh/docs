...
As contas de e-mail incluídas no seu [Alojamento Web OVHcloud](https://www.ovh.pt/alojamento-partilhado/) permitem-lhe enviar e receber e-mails a partir do dispositivo e do cliente à sua escolha.
...
<br>A nossa página de ligação ao [webmail](https://www.ovh.pt/mail/) é o ponto de acesso único à interface OWA respetiva para todas as contas de e-mail ativas no MX Plan, [Email Pro](https://www.ovh.pt/emails/email-pro/) e [Hosted Exchange](https://www.ovh.pt/emails/hosted-exchange/).
