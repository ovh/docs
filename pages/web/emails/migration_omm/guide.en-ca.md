...
- An email service with OVHcloud: [Exchange](https://www.ovhcloud.com/en-ca/emails/){.external}, [Email Pro](https://www.ovhcloud.com/en-ca/emails/email-pro/){.external} or MX Plan (via the MX Plan or included in an [OVHcloud Web Hosting](https://www.ovhcloud.com/en-ca/web-hosting/){.external})
