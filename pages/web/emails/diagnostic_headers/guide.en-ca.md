...
- The `Received-SPF` field displays the result of the [SPF](https://docs.ovh.com/ca/en/domains/web_hosting_the_spf_record/) check performed on the sender's domain name. You can use the `client-ip` argument to find the IP address of the server that sent the email. 
<pre class="console"><code>
...
[Email FAQ](https://docs.ovh.com/ca/en/emails/emails-faq/)
