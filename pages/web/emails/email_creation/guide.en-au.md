...
> [!primary]
>
> For [web hosting plans](https://www.ovhcloud.com/en-au/web-hosting/){.external}, you will need to activate your MX Plan package before reading this guide. To do this, please refer to our guide on how to [Activate the email addresses included in your Web Hosting plan](https://docs.ovh.com/au/en/hosting/activate-email-web-hosting/).
