...
>**Special cases**
>
> - For web [hosting plans](https://www.ovhcloud.com/en-ie/web-hosting/){.external}, you will need to activate your MX Plan package before reading this guide. If you have not already done so, you will need to do so. To do this, please refer to our guide [Activate the email addresses included in your Web Hosting plan](https://docs.ovh.com/ie/en/hosting/activate-email-web-hosting/).
