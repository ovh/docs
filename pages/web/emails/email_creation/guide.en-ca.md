...
Depending on the date your service was activated and whether [it was recently migrated](https://www.ovhcloud.com/en-ca/web-hosting/mxplan-migration/){.external}, you are using either the legacy version or the new version of the MX Plan solution. Before you proceed with this guide, you need to check which version you are using. 

To do this, log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca){.external}, and open the `Web Cloud`{.action} section. Click on `Emails`{.action}.
...
> **Windows**
>>
>> - [Mail on Windows 10](https://docs.ovh.com/ca/en/emails/mail-configuration-windows-10/)
>> - [Outlook](https://docs.ovh.com/ca/en/emails/configuration-outlook-2016/)
>> - [Thunderbird](https://docs.ovh.com/ca/en/emails/configure-email-for-thunderbird-windows/)
>>
> **Apple**
>>
>> - [macOS email](https://docs.ovh.com/ca/en/emails/guide-configuring-mail-on-macos/)
>> - [Mail for iPhone or iPad](https://docs.ovh.com/ca/en/emails/email_hosting_iphone_ios_91_configuration/)
>> - [Outlook Mac OS](https://docs.ovh.com/ca/en/emails/configuration-outlook-2016-mac/)
>> - [Thunderbird](https://docs.ovh.com/ca/en/emails/configure-email-for-thunderbird-mac/)
>>
> **Android**
>>
>> - [Android](https://docs.ovh.com/ca/en/emails/configuration-android/)
>>
> **Other**
>>
>> - [Gmail interface](https://docs.ovh.com/ca/en/emails/gmail-configuration/)
>>
