...
- Ter acesso às informações de acesso ao endereço de e-mail MX Plan que pretende consultar. Para mais informações, consulte o nosso guia [Primeiros passos com a oferta MX Plan](/pages/web/emails/email_generalities).
...
> [!warning]
> 
> Se for redirecionado para uma interface **O**utlook **W**eb **A**ccess (OWA), isto significa que está na última versão da oferta MX Plan. Para mais informações sobre a sua oferta MX Plan, consulte a nossa página [Primeiros passos com a oferta MX Plan](/pages/web/emails/email_generalities).
>
> Para se familiarizar com a interface **OWA**, consulte o nosso guia [Consultar a sua conta de e-mail a partir da interface OWA](/pages/web/microsoft-collaborative-solutions/owa_user_guide).
...
[Alterar a palavra-passe de um endereço de e-mail MX Plan](/pages/web/emails/email_change_password)

[Criar filtros para os seus endereços de e-mail](/pages/web/emails/feature_filters)

[Utilizar os reencaminhamentos de e-mail](/pages/web/emails/feature_redirections)
