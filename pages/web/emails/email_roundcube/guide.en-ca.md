...
- An OVHcloud **MX Plan** email solution, included in our [web hosting plans](https://www.ovhcloud.com/en-ca/web-hosting/), included in a free [Start10M](https://www.ovhcloud.com/en-ca/domains/free-web-hosting/) hosting plan, or ordered separately as a standalone solution.
- Access to the MX Plan email account you would like to use; for more information, please refer to our guide [Getting started with an MX Plan](https://docs.ovh.com/ca/en/emails/web_hosting_an_overview_of_ovh_email/).

## Instructions

### Logging in to RoundCube

Go to the page <https://www.ovh.com/ca/en/mail/>. Enter your email address and password, then click `Login` {.action}. 
...
>
> To familiarise yourself with the **OWA** interface, please refer to our guide on [Using an email account in the OWA interface](https://docs.ovh.com/ca/en/microsoft-collaborative-solutions/exchange_2016_outlook_web_app_user_guide/).
...
[Changing your password for an MX Plan email address](https://docs.ovh.com/ca/en/emails/changing-email-address-password/)

[Creating filters for your email addresses](https://docs.ovh.com/ca/en/emails/email-hosting-configuring-filters/)

[Using email redirections](https://docs.ovh.com/ca/en/emails/email-redirection-guide/)
