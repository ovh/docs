...
- an OVHcloud email solution already set up (**MX Plan**, available as part of our [Web Hosting plans](https://www.ovh.com/world/web-hosting/), or [**Hosted Exchange**](https://www.ovhcloud.com/en-ca/emails/hosted-exchange/)
