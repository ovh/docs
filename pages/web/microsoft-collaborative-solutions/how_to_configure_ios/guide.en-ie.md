...
routes:
    canonical: 'https://docs.ovh.com/ie/en/emails/email_hosting_iphone_ios_91_configuration/'
...
OVHcloud also offers a web application that includes [Exchange collaborative features](https://www.ovh.ie/emails/){.external}, accessible via <https://www.ovh.ie/mail/>. You can log in using your email credentials.
