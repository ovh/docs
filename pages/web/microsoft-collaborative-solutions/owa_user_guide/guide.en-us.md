...
- an OVHcloud email solution already set up (**MX Plan**, available as part of our [Web Hosting plans]({ovh_www}/web-hosting), or ordered separately as a standalone solution; [**Hosted Exchange**]({ovh_www}/emails/hosted-exchange))
