...
Log in to your Exchange account via the [OVHcloud webmail]({ovh_www}/mail). Click on the gear symbol on the top right to unfold the "Options" menu and select `Automatic replies`{.action}.
