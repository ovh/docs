...
- Tener una [solución Exchange de OVHcloud](https://www.ovh.com/world/es/emails/hosted-exchange/) ya configurada.
...
|Nombre del recurso|Nombre completo que aparece en el [área de cliente de OVHcloud](https://ca.ovh.com/auth/?action=gotomanager) y en [el webmail OVHcloud](https://www.ovh.com/world/es/mail/) (OWA).|
