...
- You must have an email service with OVHcloud, such as [Exchange](https://www.ovhcloud.com/en-ca/emails/hosted-exchange/){.external}.
...
[Migrating a Gmail account to an OVHcloud email account via the OVH Mail Migrator](https://docs.ovh.com/ca/en/emails/migrate-gmail-via-ovh-mail-migrator/)
