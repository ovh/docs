...
OVH also offers a web application that includes various [collaborative features](https://www.ovh.lt/El_pastas/){.external}. You can access this application at <https://www.ovh.lt/mail/>. Log in using your email credentials.
