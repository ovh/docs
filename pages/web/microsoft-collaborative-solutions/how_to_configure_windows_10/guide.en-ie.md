...
OVH also offers a web application that includes various [collaborative features](https://www.ovhcloud.com/en-ie/emails/){.external}. You can access this application at <https://www.ovh.ie/mail/>. Log in using your email credentials.
