...
- You need to have a subscription to a [Hosted Exchange](https://www.ovh.lt/El_pastas/){.external} solution.
...
To find out more, please refer to this guide on [Adding a domain name to an Exchange service](https://docs.ovh.com/lt/microsoft-collaborative-solutions/adding-domain-exchange/){.external}.
...
For assistance with these features, please refer to our documentation in this portal: [https://docs.ovh.com/lt/microsoft-collaborative-solutions/](https://docs.ovh.com/lt/microsoft-collaborative-solutions/){.external}.
