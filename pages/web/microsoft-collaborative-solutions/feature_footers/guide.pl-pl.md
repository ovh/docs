...
- W interfejsie OWA nie jest wskazane, czy stopka jest aktywna w danej domenie i **nie ma synchronizacji**. Jeśli użytkownicy dodadzą [własne podpisy](/pages/web/microsoft-collaborative-solutions/owa_user_guide#dodawanie-podpisu/), e-maile będą zawierać zarówno ich indywidualną stopkę, jak i ogólną stopkę domeny.
...
[Korzystanie z interfejsu Outlook Web App wraz z kontem e-mail](/pages/web/microsoft-collaborative-solutions/owa_user_guide)
