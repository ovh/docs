...
- OWA no indica si una firma está habilitada en este dominio y **no se sincroniza**. Cuando los usuarios agregan sus [propias firmas](/es/microsoft-collaborative-solutions/exchange_2016_guia_de_uso_de_outlook_web_app/#anadir-una-firma), los correos electrónicos incluyen tanto el pie del mensaje individual como el de todo el dominio.
...
[Usar Outlook Web App con una cuenta de correo](/es/microsoft-collaborative-solutions/exchange_2016_guia_de_uso_de_outlook_web_app)
