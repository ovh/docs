...
routes:
    canonical: 'https://https://docs.ovh.com/ca/en/emails/configure-email-for-thunderbird-windows/'
...
- an [OVHcloud Exchange account](https://www.ovh.com/ca/en/emails/hosted-exchange/)
