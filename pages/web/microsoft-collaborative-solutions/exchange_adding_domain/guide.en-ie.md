...
- You must be able to modify your domain name’s configuration ([DNS zone](https://docs.ovh.com/ie/en/domains/web_hosting_how_to_edit_my_dns_zone/)).
...
> [!warning]
>
> All of the addresses created on your email service can view all of the addresses for this service in the directory, including those that have different domain names. To stop different domain names from being displayed this way, you will need to order a new [Exchange or Email Pro](https://www.ovhcloud.com/en-ie/emails/)solution for the domain name(s) concerned.
>
...
Once you have finished configuring your accounts, you can now start using them. To do this, OVHcloud offers **webmail**, accessible via <https://www.ovhcloud.com/en-ie/mail/>. To optimise the way you use your email address on software, ensure that it is compatible with the service. 
...
You can purchase Outlook licences in the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie), and Office 365 licences on the following page: <https://www.ovhcloud.com/en-ie/collaborative-tools/microsoft-365/]>. We recommend using one of these solutions if you would like to use the Outlook email client, or other software from the Microsoft Office suite.
...
[Creating a CNAME record to add an associated domain](https://docs.ovh.com/ie/en/microsoft-collaborative-solutions/exchange_20132016_how_to_add_a_cname_record/)
