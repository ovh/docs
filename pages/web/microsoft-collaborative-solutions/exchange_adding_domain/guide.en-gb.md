...
- You must have an [Exchange solution](https://www.ovhcloud.com/en-gb/emails/){.external}.
...
> [!warning]
>
> In the directory, all of the addresses created on your Exchange service can view all other addresses associated with it, including those that have different domain names. To stop different domain names from being displayed this way, you will need to order a new [Exchange solution](https://www.ovhcloud.com/en-gb/emails/){.external} for the domain name(s) concerned.
>
