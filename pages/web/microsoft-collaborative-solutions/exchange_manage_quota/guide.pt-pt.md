...
Siga o nosso guia [Gerir o espaço de armazenamento de uma conta de e-mail](https://docs.ovh.com/pt/emails/manage-email-quota/){.externa} na secção "Hosted email - MX Plan".