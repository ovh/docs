...
Follow our guide [Managing the storage space for an email account](https://docs.ovh.com/ca/en/emails/manage-email-quota/){.external} in the "Hosted email - MX Plan" section.