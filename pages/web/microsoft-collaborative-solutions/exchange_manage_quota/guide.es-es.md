...
Siga nuestra guía [Gestionar el espacio de almacenamiento de una cuenta de correo](https://docs.ovh.com/es/emails/manage-email-quota/){.external} en la sección "Correo electrónico".