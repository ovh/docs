...
OVH also offers a web application that has [collaborative features](https://www.ovh.lt/El_pastas/){.external}, accessible via <https://mail.ovh.net/lt/>. You can log in using your email credentials.
