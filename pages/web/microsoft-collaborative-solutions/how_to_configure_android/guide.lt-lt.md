...
OVH also offers a web application that has [collaborative features](https://www.ovh.lt/El_pastas/){.external}, accessible via <https://www.ovh.lt/mail/>. You can log in using your email credentials.
...
[Configuring an Email Pro account on Android via the Gmail app](https://docs.ovh.com/lt/emails-pro/configuration-android/){.external}.
