...
OVH also offers a web application that has [collaborative features](https://www.ovhcloud.com/en-gb/emails/){.external}, accessible via [https://www.ovh.co.uk/mail/](https://www.ovh.co.uk/mail/){.external}. You can log in using your email credentials.
