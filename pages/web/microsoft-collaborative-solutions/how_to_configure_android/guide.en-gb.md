...
OVH also offers a web application that has [collaborative features](https://www.ovh.co.uk/emails/){.external}, accessible via [https://mail.ovh.net/en/](https://mail.ovh.net/en/){.external}. You can log in using your email credentials.
