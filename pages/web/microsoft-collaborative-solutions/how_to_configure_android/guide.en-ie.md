...
[Configuring an email address included in an MX Plan or web hosting plan on Android, via the Gmail app](/pages/web/emails/how_to_configure_android){.external}.
