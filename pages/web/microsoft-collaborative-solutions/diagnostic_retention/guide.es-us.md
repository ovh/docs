...
- Disponer de una solución de correo de OVHcloud:
    - **MX Plan** ([solo la nueva versión](https://docs.ovh.com/us/es/emails/primeros-pasos-correo-compartido/)) incluido entre nuestros [planes de hosting](https://www.ovhcloud.com/es/web-hosting/)
