...
- An OVHcloud email solution:
    - **MX Plan** ([new version only](https://docs.ovh.com/ca/en/emails/web_hosting_an_overview_of_ovh_email/)), available as part of our [web hosting plans](https://www.ovhcloud.com/en-ca/web-hosting/)
