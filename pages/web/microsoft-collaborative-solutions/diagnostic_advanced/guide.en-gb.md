...
Please follow the instructions in [this guide](/gb/en/microsoft-collaborative-solutions/blocked-for-spam/) to enable our security teams to re-enable the account.
...
This can be caused by entering an incorrect account password. First verify via a [webmail login](/gb/en/microsoft-collaborative-solutions/exchange_2016_outlook_web_app_user_guide/) that the password is correct, then restart the diagnostics.
