...
Please follow the instructions in [this guide](/ca/en/microsoft-collaborative-solutions/blocked-for-spam/) to enable our security teams to re-enable the account.
...
You can find more information about this topic in the [security policy guide](/ca/en/microsoft-collaborative-solutions/manage-security-policy-password/).

### Webmail authentication has failed <a name="password"></a>

This can be caused by entering an incorrect account password. First verify via a [webmail login](/ca/en/microsoft-collaborative-solutions/exchange_2016_outlook_web_app_user_guide/) that the password is correct, then restart the diagnostics.
