...
Veuillez consulter notre guide [Que faire en cas de compte bloqué pour spam ?](/ca/fr/microsoft-collaborative-solutions/bloque-pour-spam/) pour permettre à nos équipes de sécurité de réactiver le compte.
...
Pour plus d'informations sur cette fonctionnalité, consultez notre [guide sur la politique de sécurité](/ca/fr/microsoft-collaborative-solutions/gerer-politique-de-securite-mot-de-passe/).

### L'authentification au webmail a échoué <a name="password"></a>

Cela peut être dû à la saisie d'un mot de passe de compte incorrect. Vérifiez d'abord que le mot de passe est correct, en vous connectant au [webmail](/ca/fr/microsoft-collaborative-solutions/exchange-2016-guide-utilisation-outlook-web-app/), puis redémarrez le diagnostic.
