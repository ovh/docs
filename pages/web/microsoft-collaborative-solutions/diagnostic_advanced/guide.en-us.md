...
Please follow the instructions in [this guide](/pages/web/microsoft-collaborative-solutions/locked_for_spam) to enable our security teams to re-enable the account.
...
You can find more information about this topic in the [security policy guide](/pages/web/microsoft-collaborative-solutions/exchange_security_policy).

### Webmail authentication has failed <a name="password"></a>

This can be caused by entering an incorrect account password. First verify via a [webmail login](/pages/web/microsoft-collaborative-solutions/owa_user_guide) that the password is correct, then restart the diagnostics.
