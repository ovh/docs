...
Consulta la nostra guida [Cosa fare in caso di account bloccato per Spam?](/pages/web/microsoft-collaborative-solutions/locked_for_spam) per consentire ai nostri team di sicurezza di riattivare l'account.
...
Per maggiori informazioni su questa funzionalità, consulta la nostra [guida sulla politica di sicurezza](/pages/web/microsoft-collaborative-solutions/exchange_security_policy).

### L'autenticazione alla Webmail è fallita <a name="password"></a>

Questa operazione può essere dovuta all'inserimento di una password dell'account non corretta. Verifica che la password sia corretta, accedendo alla [Webmail](/pages/web/microsoft-collaborative-solutions/owa_user_guide) e riavvia la diagnostica.
