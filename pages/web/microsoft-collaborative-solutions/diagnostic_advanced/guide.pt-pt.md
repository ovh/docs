...
Consulte o nosso guia [O que fazer em caso de conta bloqueada por spam?](/pages/web/microsoft-collaborative-solutions/locked_for_spam) para permitir às nossas equipas de segurança reativar a conta.
...
Para mais informações sobre esta funcionalidade, consulte o nosso [guia sobre a política de segurança](/pages/web/microsoft-collaborative-solutions/exchange_security_policy).

### A autenticação ao webmail falhou <a name="password"></a>

Isto pode dever-se à introdução de uma palavra-passe de conta incorreta. Verifique primeiro que a palavra-passe está correta, ligando-se ao [webmail](/pages/web/microsoft-collaborative-solutions/owa_user_guide) e reinicie o diagnóstico.
