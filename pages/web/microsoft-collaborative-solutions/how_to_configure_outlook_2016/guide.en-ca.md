...
- You must have an [Exchange](https://www.ovh.com/ca/en/emails/hosted-exchange/){.external} account.
...
> [!primary]
>
> Are you using Outlook 2016 for Mac? Read our guide: [Configuring your Exchange account in Outlook 2016 for Mac](https://docs.ovh.com/ca/en/microsoft-collaborative-solutions/exchange-configuration-outlook-2016-mac/){.external}.
>
...
>
> We recommend that you check the domain name configuration for your Exchange service in your [OVH Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca){.external}, in the`Associated domains`{.action} tab, then the Diagnostic column of the table.
>
...
OVH offers a web application that includes various collaborative features, You can access this application at <https://ex.mail.ovh.ca/>.
