...
You can find the DNS zone configuration details for your email service on our [Add an MX record to your domain name’s configuration](https://docs.ovh.com/ca/en/domains/web_hosting_configuring_mx_with_the_ovh_dns_zone/) page.
...
To find out more, please refer to this guide on [Adding a domain name to an Exchange service](https://docs.ovh.com/ca/en/microsoft-collaborative-solutions/adding-domain-exchange/).
...
To subscribe, go to our page on [Getting an Outlook licence for Exchange](https://docs.ovh.com/ca/en/microsoft-collaborative-solutions/exchange-outlook-licence/). 

You can also get Office 365 licences at [https://www.ovhcloud.com/en-ca/collaborative-tools/microsoft-365/](https://www.ovhcloud.com/en-ca/collaborative-tools/microsoft-365/). We recommend using one of these solutions if you would like to use the Outlook email client, or other software from the Microsoft Office suite.
...
For assistance with these features, please refer to our documentation in this portal: [https://docs.ovh.com/ca/en/microsoft-collaborative-solutions/](https://docs.ovh.com/ca/en/microsoft-collaborative-solutions/).

## Go further

[Creating contact groups](https://docs.ovh.com/ca/en/microsoft-collaborative-solutions/exchange_20132016_how_to_use_the_groups_feature_mailing_lists/)

[Creating and using a shared account](https://docs.ovh.com/ca/en/microsoft-collaborative-solutions/exchange-using-share-accounts/)

[Using resource accounts](https://docs.ovh.com/ca/en/microsoft-collaborative-solutions/exchange_20132016_how_to_use_resource_accounts/)

[Delegating permissions on an email account](https://docs.ovh.com/ca/en/microsoft-collaborative-solutions/exchange_2013_how_to_grant_full_access_permissions_for_an_account/)

[Sharing folders in OWA](https://docs.ovh.com/ca/en/microsoft-collaborative-solutions/exchange_2016_how_to_share_a_folder_via_owa/)
