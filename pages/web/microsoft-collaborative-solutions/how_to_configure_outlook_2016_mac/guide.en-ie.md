...
OVH offers a web application that includes various [collaborative features](https://www.ovhcloud.com/en-ie/emails/){.external}, which can be accessed at <https://www.ovhcloud.com/en-ie/mail/>. You can log in using your email credentials.
