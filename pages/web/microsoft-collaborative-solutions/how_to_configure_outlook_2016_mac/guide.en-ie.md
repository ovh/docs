...
OVH offers a web application that includes various [collaborative features](https://www.ovh.ie/emails/){.external}, which can be accessed at <https://mail.ovh.net/ie/>. You can log in using your email credentials.
