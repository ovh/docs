...
OVH offers a web application that includes various [collaborative features](https://www.ovh.lt/El_pastas/){.external}, which can be accessed at <https://mail.ovh.net/lt/>. You can log in using your email credentials.
