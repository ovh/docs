...
OVH offers a web application that includes various collaborative features, which can be accessed at <https://www.ovhcloud.com/en/mail/>. You can log in using your email credentials.
