...
* Describe your desired future URL structure in [.platform/routes.yaml](/ie/en/web-paas/(configuration-routes)
* Understand [what DNS records you will need](/ie/en/web-paas/(domains-steps/dns), and whether your DNS provider can support them
* Optional: [use a CDN](/ie/en/web-paas/(domains-cdn)
* Update your [DNS](/ie/en/web-paas/(domains-steps/dns)

In this short section we will give you a simple, typical example. See the [Step by step guide](/ie/en/web-paas/(domains-steps) for more complex cases.
