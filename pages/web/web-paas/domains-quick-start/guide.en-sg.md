...
* Describe your desired future URL structure in [.platform/routes.yaml](/sg/en/web-paas/(configuration-routes)
* Understand [what DNS records you will need](/sg/en/web-paas/(domains-steps/dns), and whether your DNS provider can support them
* Optional: [use a CDN](/sg/en/web-paas/(domains-cdn)
* Update your [DNS](/sg/en/web-paas/(domains-steps/dns)

In this short section we will give you a simple, typical example. See the [Step by step guide](/sg/en/web-paas/(domains-steps) for more complex cases.
