...
* Describe your desired future URL structure in [.platform/routes.yaml](/au/en/web-paas/(configuration-routes)
* Understand [what DNS records you will need](/au/en/web-paas/(domains-steps/dns), and whether your DNS provider can support them
* Optional: [use a CDN](/au/en/web-paas/(domains-cdn)
* Update your [DNS](/au/en/web-paas/(domains-steps/dns)

In this short section we will give you a simple, typical example. See the [Step by step guide](/au/en/web-paas/(domains-steps) for more complex cases.
