...
You control your application and the way it will be built and deployed on $partner_full via a single configuration file, `.platform.app.yaml`, located at the root of your application folder inside your Git repository.
