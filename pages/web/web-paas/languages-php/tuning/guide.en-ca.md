...
See the [router cache](../../configuration-routes/cache) documentation
and the [cookie entry](../../configuration-routes/cache#cookies).
...
See the [`web.locations`](../../configuration-app/app-reference#locations) documentation for more details.
...
If using PHP 7.4 or later, see the [PHP Preload instructions](../#opcache-preloading)
...
but Web PaaS recommends enabling [Blackfire.io](../../integrations-observability/blackfire)
