...
This large block details all information about all services in the environment.  That includes the resulting configuration objects derived from [`routes.yaml`](/pages/web/web-paas/configuration-routes), [`services.yaml`](/pages/web/web-paas/configuration-services), and [`.platform.app.yaml`](/pages/web/web-paas/configuration-app).
