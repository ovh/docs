...
If you need to add additional configuration that is specific to Web PaaS, such as connecting to additional services like [Redis](/pages/web/web-paas/frameworks-drupal7/redis) or [Solr](/pages/web/web-paas/frameworks-drupal7/apachesolr-module), those changes should go in the `settings.platformsh.php` file.
