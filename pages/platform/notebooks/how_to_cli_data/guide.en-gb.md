...
You can read the \[Getting Started\]\[OVH Getting Started CLI\] page to know how to find this URL.

You should get a page like this, showing your dataset in the file explorer:

![image](images/jupyterlab_with_dataset.png)
...
As long as your notebook is in the `STOPPING` state, this means that the upload is still in progress. Once it's state
is `STOPPED`, then it means all the data were uploaded to your object storage.
...
When loading large files from the object storage, this can take some time to download from your object
...
Cached volumes will be deleted at least 72 hours after the last notebook using it will be stopped.
