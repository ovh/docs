...
If you are new to Logs Data Platform, completion of the [Quick Start Tutorial](../quick_start/guide.fr-fr.md){.ref} is highly recommended.
...
- Finally, select the number of instances you would need to handle your load. We recommend to have at least two instances to ensure the high availabilty of your Logstash. However some uses cases need you to limit the number of instance at 1 (like the [Twitter use case](../twitter/guide.fr-fr.md){.ref}).
