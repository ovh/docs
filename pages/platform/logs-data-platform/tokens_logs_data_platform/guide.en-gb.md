...
So you can pop up a [Kibana](../using_kibana_with_logs/guide.en-gb.md){.external} or a [Grafana](../using_grafana_with_logs/guide.en-gb.md){.ref} or even [a terminal Dashboard for Graylog](https://github.com/Graylog2/cli-dashboard){.external}.
