...
As implied in the title, you will need a stream. If you don't know what a stream is or if you don't have any, you can follow this [quick start tutorial](/pages/platform/logs-data-platform/getting_started_quick_start){.ref}. You must edit the stream configuration to activate the cold storage. Click on the Edit button in the menu to go to the stream configuration page.
...
- The content of your archives : GELF, one special field [X-OVH-TO-FREEZE](/pages/platform/logs-data-platform/getting_started_field_naming_convention){.ref}, or both (you will get two separate archive in this case)
