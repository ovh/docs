...
We cover Filebeat in depth in [another tutorial](https://docs.ovh.com/es/logs-data-platform/filebeat-logs/){.external}. Here is a minimal **filebeat.yml** configuration file.
