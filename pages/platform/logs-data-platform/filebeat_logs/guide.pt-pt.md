...
routes:
    canonical: '/pages/platform/logs-data-platform/filebeat_logs'
updated: 2022-06-13
---
...
This configuration deactivates the template configuration (unneeded for our endpoint). You need to provide your credentials **<username>** and **<password>** of your account. Like all Logs Data Platform APIs you can also use [tokens](/pages/platform/logs-data-platform/tokens_logs_data_platform){.ref}. Don't change **ldp-logs** since it is our special destination index.
...
- Learn how to configure Filebeat and Logstash to add your own extra filters: [All you have to know about the Logstash Collector on Logs Data Platform!](/pages/platform/logs-data-platform/logstash_input){.ref}

## Going further

- Getting Started: [Quick Start](/pages/platform/logs-data-platform/quick_start){.ref}
- Documentation: [Guides](/pt/logs-data-platform/){.ref}
