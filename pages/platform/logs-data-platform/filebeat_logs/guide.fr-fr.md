...
3. Attach your Graylog stream to logstash by using the list. Please refer to [this guide first](../quick_start/guide.fr-fr.md){.ref} if you need to create a new one.
