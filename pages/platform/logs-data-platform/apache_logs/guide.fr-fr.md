...
> [Shipping logs to Logs Data platform with Filebeat](https://docs.ovh.com/fr/logs-data-platform/filebeat-logs/){.external}
> 
...
To keep thing brief, this extract has only the parts relevant to the access log file. [The syslog-ng tutorial](https://docs.ovh.com/fr/logs-data-platform/how-to-log-your-linux/){.external} covers the configuration for any syslog file (like the error log file). This configuration is only valid for syslog-ng 3.0+.


### Apache logs format

If you want to use your own log format and include some useful information here is a cheat sheet for you (Note that the labels follows [the field naming conventions](https://docs.ovh.com/fr/logs-data-platform/field-naming-conventions/){.external}).
