...
You can also use a special field [X-OVH-TO-FREEZE](../field_naming_conventions/guide.fr-fr.md){.ref} on your logs to craft an additional archive with only the content of this specific field at each line (along with the usual gelf archive). This file can be used for example to restore a common human readable log file.
