...
- The content of your archives : GELF, one special field [X-OVH-TO-FREEZE](../field_naming_conventions/guide.fr-fr.md){.ref}, or both (you will get two separate archive in this case)
