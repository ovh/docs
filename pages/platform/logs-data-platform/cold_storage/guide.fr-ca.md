...
- The storage backend for your logs (on [OVH Object Storage](https://www.ovhcloud.com/fr-ca/public-cloud/object-storage/){.external} or [OVH Public Archive](https://www.ovhcloud.com/fr-ca/public-cloud/cloud-archive/){.external}).
