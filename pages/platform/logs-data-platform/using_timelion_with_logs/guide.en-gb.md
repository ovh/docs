...
In order to use Timelion, your Kibana access has to be already configured. If you don't have it already, you can visit [this Kibana tutorial](https://docs.ovh.com/gb/en/logs-data-platform/using-kibana-with-logs/){.external}. If you're ready, let's get started!
