...
- [Logstash collector on Logs Data Platform](../logstash_input/){.ref}.
- [The Filebeat tutorial](../filebeat_logs/){.ref}.
...
For this tutorial, we will configure the 3 alerts that we can use for a website. These 3 alerts can help you to react immediately in the case of a failure, detect unexpected problems or verify that all your websites are working correctly. But before going into the alerting feature itself, we need to configure our Apache Logging format to include all the information we need. We will also use [Filebeat](../filebeat_logs/){.ref} to send our logs to Logs Data Platform.
...
The configuration is inspired by the one you can find in [this tutorial](../apache_logs/){.ref}.
