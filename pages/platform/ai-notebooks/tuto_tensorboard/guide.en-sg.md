...
If you want to launch it from the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg), just create a new notebook and select **TensorFlow** docker image.
...
If you want to launch TensorBoard in a job, please refer to this [documentation](https://docs.ovh.com/sg/en/ai-training/tuto-tensorboard-inside-job).
