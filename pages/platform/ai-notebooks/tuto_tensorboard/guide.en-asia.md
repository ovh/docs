...
If you want to launch it from the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia), just create a new notebook and select **TensorFlow** docker image.
...
If you want to launch TensorBoard in a job, please refer to this [documentation](https://docs.ovh.com/asia/en/ai-training/tuto-tensorboard-inside-job).
