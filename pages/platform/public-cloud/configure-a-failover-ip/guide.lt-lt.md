...
In order to do this you can either buy or [import a failover IP address](https://docs.ovh.com/lt/public-cloud/ip_failover_importavimas/){.external} for your [Public Cloud instances](https://www.ovh.lt/public-cloud/instances/){.external}.
...
[Import a failover IP](https://docs.ovh.com/lt/public-cloud/ip_failover_importavimas/){.external}
