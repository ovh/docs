...
Abra una [conexión SSH a su instancia](https://docs.ovh.com/es/public-cloud/public-cloud-primeros-pasos/#connect-to-instance) y utilice el siguiente comando para mostrar los discos asociados.
