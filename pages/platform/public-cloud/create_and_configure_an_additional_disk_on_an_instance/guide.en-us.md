...
Establish an [SSH connection to your instance](https://docs.ovh.com/us/en/public-cloud/public-cloud-first-steps/#connect-to-instance), then use the command below to list the attached disks.
