...
You now need to [create a new OpenStack user](../creation-and-deletion-of-openstack-user/), then [generate the OpenRC file](../set-openstack-environment-variables/#step-1-retrieve-the-variables) containing all of the credentials you want to export as environment variables.
