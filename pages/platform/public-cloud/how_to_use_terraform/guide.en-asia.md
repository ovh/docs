...
If you log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia) or [the Horizon interface](https://horizon.cloud.ovh.net/auth/login/), you will find an instance named "terraform_instance".
