...
>
If the domain is managed by OVHcloud as its registrar and it uses OVHcloud DNS servers, you can refer to [our DNS zone guide](https://docs.ovh.com/ie/en/domains/web_hosting_how_to_edit_my_dns_zone/).
>
