...
* [Guide for creating Object Storage on the Public Cloud platform](https://docs.ovh.com/ca/en/storage/object-storage/pcs/create-container/)
* [Guide for creating and configuring an addition disk on a Public Cloud Instance](https://docs.ovh.com/ca/en/public-cloud/configure-an-additional-volume/)


## Requirements

- A [Public Cloud Instance](https://www.ovhcloud.com/en-ca/public-cloud/prices/){.external} in the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca){.external} with Ubuntu 18.04 installed
