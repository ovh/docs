...
- A [Public Cloud Instance](https://www.ovh.co.uk/public-cloud/instances/prices/){.external} in the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager){.external} with Ubuntu 18.04 installed
