...
- Infrastructure utilisée : B2-15 [Instance Public Cloud](https://www.ovhcloud.com/fr/public-cloud/){.external}
...
- Avoir une [instance de Public Cloud](https://www.ovhcloud.com/fr/public-cloud/){.external} dans [l’espace client d’OVH](https://www.ovh.com/auth/?action=gotomanager){.external} avec Ubuntu 18.04 installé
- Accès root SSH sur l'Instance
- [ Stockage d'objets](https://www.ovhcloud.com/fr/public-cloud/object-storage/){.external} dans le même datacenter que votre Public Cloud Instance (facultatif)
- [Disque supplémentaire de haute performance](https://www.ovhcloud.com/fr/public-cloud/object-storage/){.external} dans le même datacenter que votre instance de Public Cloud (en option)
...
En savoir plus sur [l’Object Storage d’OVH](https://www.ovhcloud.com/fr/public-cloud/storage/object-storage/){.external}.
...
En savoir plus sur [les disques supplémentaires du Public Cloud](https://www.ovhcloud.com/fr/public-cloud/object-storage/){.external}.
