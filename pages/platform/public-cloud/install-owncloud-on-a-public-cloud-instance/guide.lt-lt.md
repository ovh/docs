...
- A [Public Cloud Instance](https://www.ovh.lt/public-cloud/instances/kaines/){.external} in the [OVH Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.ie/&ovhSubsidiary=ie){.external} with Ubuntu 18.04 installed
