...
- A [Public Cloud Instance](https://www.ovhcloud.com/en/public-cloud/){.external} in the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager){.external} with Ubuntu 18.04 installed
