...
* [Guide for creating Object Storage on the Public Cloud platform](https://docs.ovh.com/us/en/storage/object-storage/pcs/create-container/)
* [Guide for creating and configuring an addition disk on a Public Cloud Instance](https://docs.ovh.com/us/en/public-cloud/configure-an-additional-volume/)
...
Read out guide to using Object Storage for ownCloud: [Object Storage for ownCloud](https://docs.ovh.com/us/en/storage/configure_owncloud_with_object_storage/){.external}.
