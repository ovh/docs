...
Log into to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we){.external}. Once you're logged in, click on the `Cloud`{.action} menu.
