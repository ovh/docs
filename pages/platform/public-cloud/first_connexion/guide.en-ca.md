...
* an [OVHcloud Public Cloud instance](https://www.ovhcloud.com/en-ca/public-cloud/){.external} created in your account
...
Once you have created your instance, you will need to finalise something called *sysprep*. To do this, log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca){.external} and launch the VNC console:
