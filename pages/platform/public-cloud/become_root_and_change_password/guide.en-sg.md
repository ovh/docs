...
- A [Public Cloud instance](https://docs.ovh.com/sg/en/public-cloud/public-cloud-first-steps/#create-instance) in your OVHcloud account
...
First, establish an [SSH connection](https://docs.ovh.com/sg/en/public-cloud/public-cloud-first-steps/#step-4-connecting-to-your-instance) to your server with your default user.
