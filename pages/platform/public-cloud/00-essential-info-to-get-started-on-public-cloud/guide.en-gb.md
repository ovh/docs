...
|[Configuring a failover IP](https://docs.ovh.com/gb/en/public-cloud/configure_a_failover_ip/)|Failover IPs can allow you to switch traffic from one instance to another. This guide will explain how to configure this.|
