...
- [Open an OVHcloud account](https://docs.ovh.com/us/en/customer/create-ovhcloud-account/)
- [Create your first Public Cloud project](https://docs.ovh.com/us/en/public-cloud/create_a_public_cloud_project/)
- [Familiarise yourself with the Public Cloud interface](https://docs.ovh.com/us/en/public-cloud/public-cloud-interface/)
- [Create your first instance](https://docs.ovh.com/us/en/public-cloud/public-cloud-first-steps/)
- [Manage quotas](https://docs.ovh.com/us/en/public-cloud/increase-public-cloud-quota/)
...
To get started, you will first need an OVHcloud [customer account](https://docs.ovh.com/us/en/customer/create-ovhcloud-account/).

You will then need to [create a Public Cloud project](https://docs.ovh.com/us/en/public-cloud/create_a_public_cloud_project/). A project is an environment that you will dedicate to a context.
...
<br>These quotas are allocated by region (in the OpenStack sense). As a result, you may reach the maximum possible resources for your project, and you may need to [increase these quotas](https://docs.ovh.com/us/en/public-cloud/increase-public-cloud-quota/).
...
- If you would like to use the OpenStack or S3 APIs, or the Horizon interface, you will need to [create users](https://docs.ovh.com/us/en/public-cloud/creation-and-deletion-of-openstack-user/) to do this. Users may have limited permissions to secure the action perimeters.
- If you do not need access to the APIs or Horizon, you can [link another OVHcloud](https://docs.ovh.com/us/en/public-cloud/delegate-projects/) customer account as an add-on to your project.
...
|---|---|
|[FAQ](https://docs.ovh.com/us/en/public-cloud/public-cloud-faq/)|Frequently asked questions about Public Cloud.|
|[Glossary](https://docs.ovh.com/us/en/public-cloud/introduction-to-instances-and-other-cloud-based-terms/)|The concepts and definitions you will need to move forward.|
...
|[Image Changelog](https://docs.ovh.com/us/en/public-cloud/pci-vps-image-changelog/)|Changes to publicly available system images.|

Here are some guides to help you with the first steps:

|Documentation|Details|
|---|---|
|[Create your first instance](https://docs.ovh.com/us/en/public-cloud/public-cloud-first-steps/)|First practical guide to starting a cloud server from the OVHcloud Control Panel.|
...
|[Configuring a failover IP](https://docs.ovh.com/us/en/public-cloud/configure_a_failover_ip/)|Failover IPs can allow you to switch traffic from one instance to another. This guide will explain how to configure this.|
