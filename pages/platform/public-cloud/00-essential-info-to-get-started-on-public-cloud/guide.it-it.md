...
- [Apri un account OVHcloud](/pages/account/customer/ovhcloud-account-creation)
...
- [Crea la tua prima istanza](/pages/platform/public-cloud/public-cloud-first-steps)
- [Gestisci le quote](/pages/platform/public-cloud/increasing_public_cloud_quota)
...
Per iniziare, ti serve un [account cliente OVHcloud](/pages/account/customer/ovhcloud-account-creation).

A questo punto [crei un progetto Public Cloud](/pages/platform/public-cloud/create_a_public_cloud_project). Un progetto è un ambiente che voi dedicherete a un contesto.
...
Una volta registrato il metodo di pagamento, verrà utilizzato per addebitare l'importo calcolato per la tua [fatturazione alla fine del mese](/pages/platform/public-cloud/analyze_billing). Questo calcolo è effettuato in base al tempo di utilizzo di ogni risorsa, in funzione del prezzo delle risorse.
...
<br>Tali quote sono assegnate per localizzazione (regione in senso OpenStack). È quindi possibile che tu raggiunga il massimo delle risorse possibili sul tuo progetto e che sia necessario [aumentare queste quote](/pages/platform/public-cloud/increasing_public_cloud_quota).
...
- Per utilizzare le API OpenStack o S3 o l'interfaccia Horizon, è necessario [creare degli utenti](/pages/platform/public-cloud/create_and_delete_a_user). Gli utenti possono avere diritti limitati per proteggere i perimetri di azione.
- Se non hai bisogno di accedere alle API o a Horizon, puoi [associare al tuo progetto un altro account cliente OVHcloud](/pages/platform/public-cloud/delegate_projects).
...
|---|---|
|[FAQ](/pages/platform/public-cloud/faq_pci)|Le domande più frequenti su Public Cloud|
|[Lessico](/pages/platform/public-cloud/introduction_about_instances)|I concetti e le definizioni di cui avete bisogno per progredire.|
...
|[Changelog delle immagini](/pages/platform/public-cloud/image_changelog)|Modifiche alle immagini di sistema disponibili al pubblico.|

Nella pratica, ecco alcune guide che ti aiuteranno ad avviare:

|Documentazione|Descrizione|
|---|---|
|[Crea la tua prima istanza](/pages/platform/public-cloud/public-cloud-first-steps)|La prima guida pratica per avviare un server Cloud dallo Spazio Cliente OVHcloud.|
|[Utilizzo di una chiave SSH](/pages/platform/public-cloud/public-cloud-first-steps#step-2-salva-le-chiavi-pubbliche-nello-spazio-cliente-ovhcloud_1/)| Per connetterti a un'istanza Linux, dovrai connetterti in SSH tramite questa guida.|
|[Configura la rete privata](/pages/platform/network-services/getting-started-07-creating-vrack)|In OVHcloud le reti private sono basate sulla tecnologia vRack. Questa guida ti mostra come eseguire questa operazione.|
|[Associa un disco aggiuntivo a un'istanza](/pages/platform/public-cloud/create_and_configure_an_additional_disk_on_an_instance)|Questa guida ti mostra come aggiungere spazio di storage supplementare alla tua prima istanza.|
|[Accedere all’interfaccia Horizon](/pages/platform/public-cloud/introducing_horizon)|L'interfaccia Horizon di OpenStack permette alcune azioni avanzate: ecco come connettersi.|
|[Crea un cluster Kubernetes](/pages/platform/kubernetes-k8s/creating-a-cluster) (EN)|Questa guida ti mostra come creare il tuo primo cluster Kubernetes.|
|[Configura un Additional IP](/pages/platform/network-services/getting-started-04-configure-additional-ip-to-instance)|Gli Additional IP ti permettono di trasferire il traffico da un'istanza all'altra, questa guida ti mostra come configurarlo.|
|[Installazione della CLI OpenStack](/pages/platform/public-cloud/prepare_the_environment_for_using_the_openstack_api)|OpenStack può essere utilizzato anche da riga di comando, come installare gli strumenti.|
