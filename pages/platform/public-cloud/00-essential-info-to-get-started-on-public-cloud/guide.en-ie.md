...
|[Accessing the Horizon interface](https://docs.ovh.com/ie/en/public-cloud/configure_user_access_to_horizon/)|The Horizon interface of OpenStack allows some advanced actions, here is how to connect to it.|
...
|[Configuring a failover IP](https://docs.ovh.com/ie/en/public-cloud/configure_a_failover_ip/)|Failover IPs can allow you to switch traffic from one instance to another. This guide will explain how to configure this.|
