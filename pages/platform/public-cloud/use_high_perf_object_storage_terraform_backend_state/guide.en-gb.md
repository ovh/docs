...
First, you need to have a High Performance Object Storage container. If you don't already had one, you can follow the [Creating a High Performance Object Storage container](../../storage/s3/create-container/) tutorial.

For this guide, our Object Storage container is named `terraform-state`, its solution is `High Performance` and its region is `GRA`.
