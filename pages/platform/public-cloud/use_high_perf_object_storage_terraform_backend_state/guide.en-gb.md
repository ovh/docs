...
This section was to test **UAT for GitHub and ServiceNow**. Test done [here](https://jira.ovhcloud.tools/browse/SNF-2005).
...
First, you need to have a High Performance Object Storage container. If you don't already have one, you can follow the [Creating a High Performance Object Storage container](https://docs.ovh.com/gb/en/storage/object-storage/s3/getting-started-with-object-storage/) tutorial.
