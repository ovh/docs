...
First, you need to have a High Performance Object Storage container. If you don't already have one, you can follow the [Creating a High Performance Object Storage container](https://docs.ovh.com/asia/en/storage/object-storage/s3/getting-started-with-object-storage/) tutorial.
