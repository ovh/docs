...
Una volta effettuato l'associazione, puoi seguire gli step successivi [con Linux](../crea_e_configura_un_disco_aggiuntivo_sulla_tua_istanza/#da-linux) o [Windows](/pages/platform/public-cloud/create_and_configure_an_additional_disk_on_an_instance#da-windows).
