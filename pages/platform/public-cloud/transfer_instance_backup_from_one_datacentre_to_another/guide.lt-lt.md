...
* [Transfer a volume backup from one datacentre to another](https://docs.ovh.com/lt/public-cloud/transfer_volume_backup_from_one_datacentre_to_another/){.external}