...
* Avoir [une IP Fail Over](https://www.ovh.com/ca/fr/serveurs_dedies/ip_failover.xml){.external} liée à un [serveur dédié OVHcloud](https://www.ovh.com/ca/fr/serveurs_dedies/){.external}.
