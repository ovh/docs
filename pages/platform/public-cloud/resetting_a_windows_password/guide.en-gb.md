...
Connect to the instance via VNC in the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager) with the login details you have received by email.
