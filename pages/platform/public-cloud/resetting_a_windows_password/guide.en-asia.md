...
routes:
    canonical: 'https://docs.ovh.com/asia/en/vps/resetting-a-windows-password-vps'
...
Connect to the instance via VNC in the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia) with the login details you have received by email.
