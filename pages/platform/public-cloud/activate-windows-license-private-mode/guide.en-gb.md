...
We recommend that you read our guide on [Accessing the Horizon](https://docs.ovh.com/gb/en/public-cloud/horizon/) interface to familiarise yourself with Horizon.
...
Log in to the [Horizon](https://horizon.cloud.ovh.net/auth/login/) interface using the method listed in the [first part of this guide](https://docs.ovh.com/gb/en/publiccloud/network-services/public-cloud-vrack/#horizon).
...
[Find out how to change the activation key of your Windows Server](https://docs.ovh.com/gb/en/dedicated/windows-key/).
