...
We recommend that you read our guide on [Accessing the Horizon interface](https://docs.ovh.com/asia/en/public-cloud/horizon/) to familiarise yourself with Horizon.
...
Log in to the [Horizon](https://horizon.cloud.ovh.net/auth/login/) interface using the method listed in the [first part of this guide](https://docs.ovh.com/asia/en/publiccloud/network-services/public-cloud-vrack/#horizon).
...
[Find out how to change the activation key of your Windows Server](https://docs.ovh.com/asia/en/dedicated/windows-key/).
