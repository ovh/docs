...
Log in to the [Horizon](https://horizon.cloud.ovh.net/auth/login/) interface using the method listed in the [first part of this guide](https://docs.ovh.com/us/en/publiccloud/network-services/public-cloud-vrack/#horizon).
...
- [Preparing an environment for using the OpenStack API](https://docs.ovh.com/us/en/public-cloud/prepare_the_environment_for_using_the_openstack_api/). 
...
[Find out how to change the activation key of your Windows Server](https://docs.ovh.com/us/en/dedicated/windows-key/).
