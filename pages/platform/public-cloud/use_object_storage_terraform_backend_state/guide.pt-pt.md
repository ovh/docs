...
First, you need to have an Object Storage container. If you don't already had one, you can follow the [Creating an Object Storage container](https://docs.ovh.com/pt/storage/object-storage/pcs/create-container/) tutorial.
