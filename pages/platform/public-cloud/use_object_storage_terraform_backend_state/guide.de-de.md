---
title: 'OVHcloud Object Storage als Terraform Backend für Terraform State verwenden (EN)'
...
First, you need to have an Object Storage container. If you don't already had one, you can follow the [Creating an Object Storage container](https://docs.ovh.com/de/storage/object-storage/pcs/create-container/) tutorial.
...
Log in to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de), go to the Public Cloud section and select the Public Cloud project concerned.
