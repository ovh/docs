...
You can use the OVHcloud [Public Cloud](https://www.ovhcloud.com/en-au/public-cloud/) to create instances (i.e. virtual servers) quickly and easily, in just a few clicks.
