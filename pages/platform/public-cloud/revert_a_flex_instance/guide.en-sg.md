...
- [Access to the Horizon interface](https://docs.ovh.com/sg/en/public-cloud/horizon/)
...
Alternatively, you can [edit the configuration of the instance](https://docs.ovh.com/sg/en/public-cloud/get-started-with-a-public-cloud-instance/#edit-the-configuration-of-an-instance) in the OVHcloud Control Panel.
