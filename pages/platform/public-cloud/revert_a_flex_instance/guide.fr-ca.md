---
title : Basculer une instance flex à une instance classique
...
- [Créer un accès à l'interface Horizon](https://docs.ovh.com/ca/fr/public-cloud/creer-un-acces-a-horizon/)
...
Ensuite, cliquez sur le menu `Compute`{.action} à gauche et cliquez sur `Instances`{.action}. Sélectionnez `Resize instance`{.action} dans la liste déroulante de l'instance correspondante.
