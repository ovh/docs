...
- Avoir créé un utilisateur OpenStack. Consultez [le guide qui y est dédié](/pages/platform/public-cloud/create_and_delete_a_user)
- Avoir préparé l'environnement pour utiliser OpenStack. Consultez pour cela le guide suivant : [Préparer l’environnement pour utiliser l’API OpenStack](/pages/platform/public-cloud/prepare_the_environment_for_using_the_openstack_api)
...
Comme indiqué dans [ce guide](/pages/platform/public-cloud/create_and_delete_a_user), le mot de passe n'est visible qu'une seule fois, à sa création.
