...
Please read our guide on [Creating and connecting to your first Public Cloud instance](https://docs.ovh.com/ca/en/public-cloud/public-cloud-first-steps/).
...
Please read our guide on [Replacing your lost SSH key pair](https://docs.ovh.com/ca/en/public-cloud/replacing_your_lost_ssh_key_pair/).
...
Please read our guide on [Backing up an instance](https://docs.ovh.com/ca/en/public-cloud/back-up-instance/).
...
Please read our guide on [Creating and deleting an OpenStack user](https://docs.ovh.com/ca/en/public-cloud/creation-and-deletion-of-openstack-user/).
...
To switch from one billing method to another, please refer to our guide on [Switching from hourly to monthly billing](https://docs.ovh.com/ca/en/public-cloud/change-public-cloud-billing-rate/).
...
Please refer to our guide on [Configuring a security group](https://docs.ovh.com/ca/en/public-cloud/configure-security-group-horizon/) .
...
Please read our guide on [Configuring vRack for Public Cloud](https://docs.ovh.com/ca/en/publiccloud/network-services/public-cloud-vrack/).
...
Please refer to our guide on [Managing firewall rules and port security on networks using OpenStack CLI](https://docs.ovh.com/ca/en/public-cloud/firewall_security_pci/).
...
For more information, please refer to this guide: [Buying an Additional IP](https://docs.ovh.com/ca/en/publiccloud/network-services/buy-additional-ip/).
...
Anyway, if you want to mitigate this inside your instance as well, you should hard reboot your instance, either doing it from the [OVHcloud Control Panel](https://docs.ovh.com/ca/en/public-cloud/get-started-with-a-public-cloud-instance/#restarting-the-instance), or with a command like this:
