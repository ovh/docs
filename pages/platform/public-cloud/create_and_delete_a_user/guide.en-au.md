...
With the OpenStack user created, you can use its credentials to log into the [Horizon interface](https://docs.ovh.com/au/en/public-cloud/horizon/) by clicking on the link `Horizon`{.action} in the left-hand menu.

### Deleting an OpenStack user

You can remove an OpenStack user in the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au). Click on `Users & Roles`{.action} the left-hand menu under "Project management". 
...
[Introducing Horizon](https://docs.ovh.com/au/en/public-cloud/horizon/)
