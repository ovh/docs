...
First you need to create an OpenStack user account. Log in to your OVHcloud Control Panel and open your `Public Cloud`{.action} project.
...
Be sure to save your password now as this is the only time you will be able to recover it. However, if you lose it you can always create a new one by clicking on `...`{.action} and selecting `Generate a password`{.action}.
