...
Une fois l'utilisateur OpenStack créé, vous pourrez utiliser ses identifiants pour vous connecter à [l'interface Horizon](https://docs.ovh.com/ca/fr/public-cloud/presentation-dhorizon/) en cliquant sur le lien `Horizon`{.action} dans le menu de gauche.
...
[Présentation de Horizon](https://docs.ovh.com/ca/fr/public-cloud/presentation-dhorizon/)
