...
With the OpenStack user created, you can use its credentials to log into the [Horizon interface](https://docs.ovh.com/gb/en/public-cloud/horizon/) by clicking on the link `Horizon`{.action} in the left-hand menu.
...
[Introducing Horizon](https://docs.ovh.com/gb/en/public-cloud/horizon/)
