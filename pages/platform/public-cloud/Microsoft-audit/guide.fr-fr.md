...
Dans le cadre de [l'audit Microsoft](files/Microsoft-audit.pdf), mené par le cabinet de consulting Ernst & Young, OVHcloud vous a adressé [un e-mail](files/OVH-email.pdf) afin de solliciter votre contribution pour déclarer vos utilisations.
...
* Option 3 : [Effectuer et envoyer les copies d'écran et éléments nécessaires à OVHcloud](./#option-3-effectuer-et-envoyer-les-copies-d-ecran-et-elements-necessaires-a-ovhcloud)
...
13. Envoyez-nous ce fichier chiffré ainsi que [le mandat suivant complété et signé par vos soins](files/autorisation.docx), avant le 26 mai 2020, à l'adresse suivante : auditmicrosoft@ovhcloud.com
