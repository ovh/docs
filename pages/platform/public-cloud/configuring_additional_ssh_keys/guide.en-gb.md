...
First, follow our guide to [Creating SSH keys](../create-ssh-keys/).
...
[Creating SSH keys](../create-ssh-keys/)

[Using an SSH key in the Public Cloud interface](../use-of-an-ssh-key-in-the-public-cloud-interface)
