...
First, follow our guide to [Create your first SSH keys](https://docs.ovh.com/ca/en/public-cloud/create-ssh-keys/){.external}.
...
[Create SSH keys](https://docs.ovh.com/ca/en/public-cloud/create-ssh-keys/){.external}

[Replacing your lost SSH key pair](https://docs.ovh.com/ca/en/public-cloud/replacing_your_lost_ssh_key_pair/){.external}
