...
- a [Public Cloud instance](https://docs.ovh.com/us/en/public-cloud/public-cloud-first-steps/) in your OVHcloud Control Panel.

## Instructions

Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we), go to the `Public Cloud`{.action} section, and select the Public Cloud project of your choice.<br>
...
[Configuring a failover IP](https://docs.ovh.com/us/en/public-cloud/configure_a_failover_ip/)
