...
* A [Public Cloud Instance](https://www.ovhcloud.com/asia/public-cloud/){.external} in your your OVHcloud account
* An [additional disk](https://www.ovhcloud.com/asia/public-cloud/block-storage/){.external} attached to your instance
...
In order to deploy a public cloud instance, log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia){.external} and open your `Public Cloud`{.action} project.
