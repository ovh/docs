...
* A [Public Cloud Instance](https://www.ovhcloud.com/en-au/public-cloud/){.external} in your your OVHcloud account
* An [additional disk](https://www.ovhcloud.com/en-au/public-cloud/block-storage/){.external} attached to your instance
