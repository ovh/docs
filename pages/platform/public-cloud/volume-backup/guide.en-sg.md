...
- A [Block Storage volume](https://docs.ovh.com/sg/en/public-cloud/create_and_configure_an_additional_disk_on_an_instance/) created in your [Public Cloud project](https://www.ovhcloud.com/en-sg/public-cloud/)
...
You can find further information in [this guide](https://docs.ovh.com/sg/en/public-cloud/create-volume-from-backup/).
