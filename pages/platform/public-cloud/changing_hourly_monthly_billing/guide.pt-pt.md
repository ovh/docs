...
Aceda à[interface API OVHcloud](https://ca.api.ovh.com/console/) conforme o [guia apropriado](https://docs.ovh.com/gb/en/api/first-steps-with-ovh-api/) (EN) e siga os passos abaixo.
