...
Conéctese a la [interfaz API OVHcloud](https://ca.api.ovh.com/console/) según la [guía adecuada](https://docs.ovh.com/gb/en/api/first-steps-with-ovh-api/) (EN) y siga los pasos que se indican a continuación.
