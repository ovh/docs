...
Conéctese a la [interfaz API OVHcloud](https://ca.api.ovh.com/) según la [guía adecuada](/pages/account/api/first-steps) y siga los pasos que se indican a continuación.
