...
- You need to have created a Public Cloud instance in your [OVHcloud Control Panel](../public-cloud-first-steps/) or through the [Horizon interface](https://docs.ovh.com/asia/en/public-cloud/create-an-instance-in-horizon/)
- [An SSH key](https://docs.ovh.com/asia/en/public-cloud/public-cloud-first-steps/#step-1-creating-ssh-keys)
...
This option allows you to create an instance. Please refer to [this guide](https://docs.ovh.com/asia/en/public-cloud/create-an-instance-in-horizon/) for more information.
...
**Create snapshot**: This option allows you to create a snapshot of your instance. Consult [this guide](https://docs.ovh.com/asia/en/public-cloud/manage-snapshots-of-instances-in-horizon/) for more information.
...
- Attach Interface: This option allows you to add one or more private interfaces to your instance via the VLAN. For more information, refer to [this section](https://docs.ovh.com/asia/en/public-cloud/public-cloud-vrack/#adding-a-private-interface) of the corresponding guide.
- Detach Interface: This option allows you to delete an interface linked to an instance. For more information, refer to [this section](https://docs.ovh.com/asia/en/public-cloud/public-cloud-vrack/#removing-a-private-interface) of the corresponding guide.
- Edit Instance: This option allows you to change the instance name and [security groups](https://docs.ovh.com/asia/en/public-cloud/configure-security-group-horizon/).
...
To find out how to suspend or pause an instance, please refer to [this guide](https://docs.ovh.com/asia/en/public-cloud/shelve-or-pause-an-instance/).
...
> Consult [this guide](https://docs.ovh.com/asia/en/public-cloud/become_the_root_user_and_select_a_password/) for more information.
