...
**Create snapshot**: This option allows you to create a snapshot of your instance. Consult [this guide](https://docs.ovh.com/gb/en/public-cloud/manage-snapshots-of-instances-in-horizon/) for more information.
...
To find out how to shelve or pause an instance, please refer to [this guide](https://docs.ovh.com/gb/en/public-cloud/shelve-or-pause-an-instance/).
