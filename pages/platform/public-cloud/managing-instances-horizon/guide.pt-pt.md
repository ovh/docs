...
- Ter criado uma instância Public Cloud a partir da [Área de Cliente OVHcloud](../public-cloud-primeiros-passos/) ou através da [interface Horizon](/pages/platform/public-cloud/create_instance_in_horizon).
