...
- [Preparar o ambiente para utilizar a API OpenStack](../preparar_o_ambiente_para_utilizar_a_api_openstack/) instalando pithon-cinderclient e python-novaclient
