...
Find out how to use backups to clone or restore instances in [this guide](https://docs.ovh.com/au/en/public-cloud/create-restore-virtual-server-from-backup/).

## Go further

[Using instance backups to create or restore an instance](https://docs.ovh.com/au/en/public-cloud/create-restore-virtual-server-from-backup/)
