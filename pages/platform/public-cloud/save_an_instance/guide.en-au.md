...
You can create a backup of your instance at any time via the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au){.external}. You can then use this backup to restore your instance to an old configuration, or recreate it.
...
Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au){.external}, and select the Public Cloud tab from the `Instances`{.action} section.
