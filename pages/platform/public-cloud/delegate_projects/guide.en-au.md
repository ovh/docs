...
You can click on the `Edit`{.action} buttons to change the current contacts. This will open the **Contact management** section of your Control Panel. Follow the instructions in our guide [Managing contacts for your services](https://docs.ovh.com/au/en/customer/managing-contacts/) to complete this process.
...
[Getting started with a Public Cloud Instance](https://docs.ovh.com/au/en/public-cloud/public-cloud-first-steps/)
...
[Access and Security in Horizon](https://docs.ovh.com/au/en/public-cloud/access_and_security_in_horizon/)
