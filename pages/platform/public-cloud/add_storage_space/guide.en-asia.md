...
[OVH Public Cloud Storage](https://www.ovhcloud.com/asia/public-cloud/storage/){.external} offers an unlimited storage solution with simple billing that can be adapted to suit your needs.
...
**This guide will show you how to add external storage space to your [Public Cloud Instance](https://www.ovhcloud.com/asia/public-cloud/){.external}.**
...
First, log in to the [OVH Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia){.external} and click on `Cloud`{.action}.
...
> [!primary]
>
This step is optional. You can find out more about this feature on our [Cloud Archive](https://www.ovhcloud.com/asia/public-cloud/cloud-archive/){.external} page.
>
