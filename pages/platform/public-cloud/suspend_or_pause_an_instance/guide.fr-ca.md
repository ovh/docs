...
- Être connecté à l’[espace client OVHcloud](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc){.external} ou à l’interface [Horizon.](https://docs.ovh.com/ca/fr/public-cloud/horizon/)
