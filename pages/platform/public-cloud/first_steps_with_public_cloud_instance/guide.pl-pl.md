...
Działanie to spowoduje zawieszenie instancji. Więcej informacji znajdziesz w przewodniku "[Wstrzymanie lub uśpienie instancji](/pages/platform/public-cloud/suspend_or_pause_an_instance#zatrzymaj-suspend-instancje_1)".
