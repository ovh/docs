...
Cette action aura pour effet de suspendre l'instance. Référez-vous à notre guide « [Suspendre ou mettre en pause une instance](/pages/platform/public-cloud/suspend_or_pause_an_instance#arreter-suspend-une-instance_1) » pour plus d'informations.
