...
- Être connecté à l'interface Horizon. Le guide « [Accéder à l’interface Horizon](../creer-un-acces-a-horizon/) » peut vous y aider.
...
Si ces règles vous conviennent, poursuivez vers l'étape 3 « [configurer un groupe de sécurité sur son instance](../configurer-un-groupe-de-securite/#etape-3-configurer-un-groupe-de-securite-sur-son-instance) » de cette documentation.
