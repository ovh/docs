...
- Access to the [Horizon interface](https://docs.ovh.com/au/en/public-cloud/configure_user_access_to_horizon/)

## Instructions

### Step 1: creating a security group

Access the [Horizon interface](https://docs.ovh.com/au/en/public-cloud/configure_user_access_to_horizon/). Then choose the region in which you want to create a security group, via the button in the top left-hand corner.
