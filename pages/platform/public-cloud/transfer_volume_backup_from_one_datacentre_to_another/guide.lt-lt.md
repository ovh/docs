...
* [Prepare the environment to use the OpenStack API](https://docs.ovh.com/gb/en/public-cloud/prepare-environment-for-using-openstack-api/){.external}
...
* [Transfer an instance backup from one datacentre to another](https://docs.ovh.com/lt/public-cloud/instance_atsargines_kopijos_perkelimas_is_vieno_duomenu_centro_i_kita/){.external}