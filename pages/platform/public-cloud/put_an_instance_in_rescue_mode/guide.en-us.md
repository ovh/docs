...
> [!alert]
>
> To date, rescue mode for Metal instances cannot be accessed via the OVHcloud Control Panel. For more information, please refer to our guide on [rescue mode for Metal instances](https://docs.ovh.com/us/en/public-cloud/metal-instance-rescue-mode/).
