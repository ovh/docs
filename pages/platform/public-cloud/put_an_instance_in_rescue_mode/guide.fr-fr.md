...
> [!alert]
>
> A ce jour, le mode rescue pour les instances Metal n'est pas accessible via l'espace client OVHcloud. Pour plus d'informations, consultez notre guide dédié au [mode rescue pour les instances Metal](https://docs.ovh.com/fr/public-cloud/metal-instance-rescue-mode/).
