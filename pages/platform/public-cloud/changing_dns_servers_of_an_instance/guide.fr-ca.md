...
- Connectez-vous sur l'instance en SSH. Vous pouvez consulter le guide [Se connecter à une instance Public Cloud](../premiere-connexion/){.external}.
- Passez root. Vous pouvez consulter le guide [Passer root et définir un mot de passe](../passer-root-et-definir-un-mot-de-passe/){.external}.
...
- Connectez-vous via le bureau à distance ou la console VNC. Vous pouvez consulter le guide [Se connecter à une instance Public Cloud](../premiere-connexion/){.external}.
...
[Se connecter à une instance Public Cloud](../premiere-connexion/){.external}.

[Passer root et définir un mot de passe](../passer-root-et-definir-un-mot-de-passe/){.external}.

[Modifier le hostname d’une instance Public Cloud](../modifier-le-hostname-dune-instance/){.external}.
