...
|---|---|
|**Horizon**|This is the [graphical interface](https://docs.ovh.com/au/en/public-cloud/horizon/) usually available on OpenStack. It is not altered, which allows users who are used to this interface to easily navigate it.|
...
|**SSH Keys**|A tool that allows you to [manage your SSH keys](https://docs.ovh.com/au/en/public-cloud/public-cloud-first-steps/#step-1-creating-ssh-keys) in a centralised way.|
