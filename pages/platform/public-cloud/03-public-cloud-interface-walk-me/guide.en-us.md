...
|---|---|
|**Horizon**|This is the [graphical interface](https://docs.ovh.com/us/en/public-cloud/horizon/) usually available on OpenStack. It is not altered, which allows users who are used to this interface to find their reflexes.|
