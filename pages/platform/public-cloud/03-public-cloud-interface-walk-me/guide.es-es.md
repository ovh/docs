...
- Haber creado su [primer proyecto de Public Cloud](https://docs.ovh.com/es/public-cloud/create_a_public_cloud_project/).
...
|**Project settings**|Esta última herramienta le permite configurar los parámetros generales del proyecto como su nombre, su configuración como "proyecto por defecto de la cuenta", la compatibilidad HDS o incluso [eliminar su proyecto de Public Cloud.](https://docs.ovh.com/es/public-cloud/delete_a_project/)|
