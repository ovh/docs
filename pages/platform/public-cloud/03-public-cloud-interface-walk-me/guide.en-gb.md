...
|---|---|
|**Horizon**|This is the [graphical interface](https://docs.ovh.com/gb/en/public-cloud/horizon/) usually available on OpenStack. It is not altered, which allows users who are used to this interface to find their reflexes.|
...
|**Credit and Vouchers**|This menu allows you to view voucher usage, add a voucher, or [add credit](https://docs.ovh.com/gb/en/public-cloud/add-cloud-credit/) directly to your Public Cloud project.|
...
|**Project settings**|With this tool, you can configure the project’s general settings, such as its name, its configuration as a "default project for the account", HDS compatibility, or to [delete your Public Cloud project](https://docs.ovh.com/gb/en/public-cloud/delete_a_project/).|
