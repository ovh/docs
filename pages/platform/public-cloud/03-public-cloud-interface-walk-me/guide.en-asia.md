...
|**Credit and Vouchers**|This menu allows you to view voucher usage, add a voucher, or [add credit](https://docs.ovh.com/asia/en/public-cloud/add-cloud-credit/) directly to your Public Cloud project.|
|**Contacts and Rights**|In this menu, you can add users (OVHcloud account) in read-only and read-write mode.|
|**Project settings**|With this tool, you can configure the project’s general settings, such as its name, its configuration as a "default project for the account", HDS compatibility, or to [delete your Public Cloud project](https://docs.ovh.com/asia/en/public-cloud/delete_a_project/).|
