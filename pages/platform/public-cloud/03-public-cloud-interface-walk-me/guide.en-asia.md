...
- You need to have created your [first Public Cloud project](https://docs.ovh.com/asia/en/public-cloud/create_a_public_cloud_project/).
...
|**Credit and Vouchers**|This menu allows you to view the consumption of a voucher, add a voucher, or [add credit](https://docs.ovh.com/asia/en/public-cloud/add-cloud-credit/) directly to your Public Cloud project.|
|**Contacts and Rights**|In this menu, you can add users (OVHcloud account) in read-only and read-write mode.|
|**Project settings**|With this tool, you can configure the project’s general settings, such as its name, its configuration as a "default project for the account", HDS compatibility, or [delete your Public Cloud project](https://docs.ovh.com/asia/en/public-cloud/delete_a_project/).|

## Go further

[Creating and connecting to your first Public Cloud instance](https://docs.ovh.com/asia/en/public-cloud/public-cloud-first-steps/)
