...
- Access to your instance via SSH in [rescue mode](https://docs.ovh.com/asia/en/public-cloud/put_an_instance_in_rescue_mode/) 
- Create an SSH key
...
[Become root and select a password](../become_the_root_user_and_select_a_password/){.external}
