...
El [área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es) es una interfaz completa y únicamente visual, lo que la convierte en una interfaz ideal si solo tiene una VLAN para gestionar. No podrá personalizar el rango de IP privadas, que estará únicamente en 10.x.x.16.
...
Consulte la guía [Primeros pasos con las API de OVHcloud](../../api/first-steps-with-ovh-api/) para familiarizarse con el uso de las APIv6 de OVHcloud.
...
Para activar y gestionar un vRack desde la APIv6 de OVHcloud, haga clic [aquí](../public-cloud/public-cloud-vrack-apiv6/#step-1-activating-and-managing-a-vrack) para consultar la guía específica sobre este método.
...
Para crear una VLAN desde las APIv6 de OVHcloud, haga clic [aquí](../public-cloud-vrack-apiv6/#step-3-creating-a-vlan-in-the-vrack_1) para consultar la guía específica.
...
Haga clic [aquí](../public-cloud-vrack-apiv6/#step-4-integrating-an-instance-into-the-vrack_1) para consultar la guía específica sobre este método.
...
Haga clic [aquí](../public-cloud-vrack-apiv6/#in-case-of-an-existing-instance_1) para consultar la guía específica sobre este método.
...
[Configuración del vRack Public Cloud desde las APIv6 de OVHcloud](https://docs.ovh.com/gb/en/public-cloud/public-cloud-vrack-apiv6/)
