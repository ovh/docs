...
- um [utilizador OpenStack](../criar-e-eliminar-um-utilizador-openstack/#criar-um-utilizador-openstack_1) (opcional)
...
Consulte o guia [Primeiros passos com as API OVHcloud](https://docs.ovh.com/gb/en/api/first-steps-with-ovh-api/) (EN), para se familiarizar com a utilização das APIv6 OVHcloud.
...
Para ativar e gerir um vRack a partir das APIv6 OVHcloud, clique [aqui](https://docs.ovh.com/gb/en/public-cloud/public-cloud-vrack-apiv6/#step-1-activating-and-managing-a-vrack) (EN), para consultar o guia específico deste método.
...
Caso seja necessário fazer comunicar servidores dedicados OVHcloud com VLAN taggado, consulte o seguinte guia: [Criar várias VLAN no vRack](../../dedicated/criar-vlan-vrack/).
...
Para criar uma VLAN a partir da APIv6 OVHcloud, clique [aqui](https://docs.ovh.com/gb/en/public-cloud/public-cloud-vrack-apiv6/#step-3-creating-a-vlan-in-the-vrack_1) (EN), para consultar o guia específico deste método.
...
Clique [aqui](https://docs.ovh.com/gb/en/public-cloud/public-cloud-vrack-apiv6/#step-4-integrating-an-instance-into-the-vrack_1) (EN), para consultar o guia específico deste método.
...
Tenha em atenção as seguintes informações, como indicado no [guia de utilização da API Nova](../dar_os_primeiros_passos_com_a_api_nova/):
...
Clique [aqui](https://docs.ovh.com/gb/en/public-cloud/public-cloud-vrack-apiv6/#in-case-of-an-existing-instance_1) (EN), para consultar o guia específico deste método.
