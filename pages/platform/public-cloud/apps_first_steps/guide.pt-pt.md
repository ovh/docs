...
Na Área [de Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager), nas API OVHcloud ou na API OpenStack Horizon, instale a aplicação à sua escolha na sua instância Public Cloud.
