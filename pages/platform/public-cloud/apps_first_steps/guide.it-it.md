...
Dallo [Spazio Cliente OVHcloud](https://www.ovh.com/auth/?action=gotomanager), le API OVHcloud o l'API OpenStack Horizon, installa l'applicazione scelta sulla tua istanza Public Cloud.
