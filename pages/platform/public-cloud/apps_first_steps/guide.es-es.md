...
Desde [el área de cliente de OVHcloud](https://www.ovh.com/auth/?action=gotomanager), las API de OVHcloud o la API de OpenStack Horizon podrá instalar en su instancia de Public Cloud la aplicación que desee.
