...
This documentation will only apply to [VPS](https://www.ovhcloud.com/en-ca/vps/compare/) and [Public Cloud instances](https://www.ovhcloud.com/en-ca/public-cloud/compute/).
