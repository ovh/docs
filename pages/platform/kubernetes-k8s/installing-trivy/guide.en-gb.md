...
TODO: xxx
[Trivy](https://github.com/derailed/popeye) is a tool that scans Kubernetes clusters and reports potential issues with deployed resources and configurations. 
TODO: aqua...

TODO: xxx
![Trivy](images/popeye.png)
...
You can [install Trivy](https://aquasecurity.github.io/trivy/v0.28.1/getting-started/installation/#homebrew) on your computer from the binaries, the source, HomeBrew and even use it directly from a Docker image.
