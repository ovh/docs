...
If you are using the [OVHcloud Domain name product](https://www.ovhcloud.com/fr-ca/domains/), you can follow this documentation to configure your DNS record to link it to the public IPv4 address associated to your LoadBalancer: [Editing an OVHcloud DNS zone](https://docs.ovh.com/ca/fr/domains/web_hosting_how_to_edit_my_dns_zone/).
