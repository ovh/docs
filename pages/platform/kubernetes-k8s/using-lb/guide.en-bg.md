...
![ClusterIp and kubectl proxy](./images/using-lb-ClusterIp.jpg)
...
![NodePort](./images/using-lb-NodePort.jpg)
...
![LoadBalancer](./images/using-lb-LoadBalancer.jpg)
...
<pre style="background-color: #300A24;"><code>$ kubectl get services
...
<pre style="background-color: #300A24;"><code>$ kubectl get service hello-world 
NAME          TYPE           CLUSTER-IP    EXTERNAL-IP                        PORT(S)        AGE
...
![Testing your service](./images/using-lb-01.png)
...
<pre style="background-color: #300A24;"><code>$ kubectl delete service hello-world
...
<pre style="background-color: #300A24;"><code>$ kubectl delete deploy hello-world-deployment
...
<pre style="background-color: #300A24;"><code>$ kubectl -n=default get pods
No resources found
</code></pre>
