...
To use this kubeconfig file and access to your cluster, you can follow our [configuring kubectl](https://docs.ovh.com/us/en/kubernetes/configuring-kubectl/) tutorial, or symply add the `--kubeconfig` flag in your `kubectl` commands.
