---
title: How to use a custom gateway on an OVHcloud Managed Kubernetes cluster
...
First, create in your environment/local machine a `utils` folder and then download this script into it:

- [ovhAPI.sh](https://raw.githubusercontent.com/ovh/docs/vrack-k8s-custom-gateway/pages/platform/kubernetes-k8s/vrack-k8s-custom-gateway/utils/ovhAPI.sh)

And then add execution right:
