...
- The [OpenStack API CLI](https://docs.ovh.com/fr/public-cloud/preparer-lenvironnement-pour-utiliser-lapi-openstack/) installed.
- Be familiar with the [OVHcloud API](https://docs.ovh.com/fr/api/first-steps-with-ovh-api/).
...
> Important: Assuming that your PCI project is added to your [vRack](https://docs.ovh.com/fr/public-cloud/public-cloud-vrack/).
...
To use this kubeconfig file and access to your cluster, you can follow our [configuring kubectl](https://docs.ovh.com/fr/kubernetes/configuring-kubectl/) tutorial, or simply add the `--kubeconfig` flag in your `kubectl` commands.
