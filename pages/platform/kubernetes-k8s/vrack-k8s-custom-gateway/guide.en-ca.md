...
- The [OpenStack API CLI](https://docs.ovh.com/ca/en/public-cloud/prepare_the_environment_for_using_the_openstack_api/) installed.
- Be familiar with the [OVHcloud API](https://docs.ovh.com/ca/en/api/first-steps-with-ovh-api/).
...
> Important: Assuming that your PCI project is added to your [vRack](https://docs.ovh.com/ca/en/public-cloud/public-cloud-vrack/).
...
To use this kubeconfig file and access to your cluster, you can follow our [configuring kubectl](https://docs.ovh.com/ca/en/kubernetes/configuring-kubectl/) tutorial, or simply add the `--kubeconfig` flag in your `kubectl` commands.
