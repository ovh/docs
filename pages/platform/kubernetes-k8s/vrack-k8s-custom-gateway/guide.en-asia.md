...
To use this kubeconfig file and access to your cluster, you can follow our [configuring kubectl](https://docs.ovh.com/asia/en/kubernetes/configuring-kubectl/) tutorial, or symply add the `--kubeconfig` flag in your `kubectl` commands.
