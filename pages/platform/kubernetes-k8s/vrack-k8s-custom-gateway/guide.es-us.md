...
- The [OpenStack API CLI](https://docs.ovh.com/us/es/public-cloud/preparar_el_entorno_para_utilizar_la_api_de_openstack/) installed.
- Be familiar with the [OVHcloud API](https://docs.ovh.com/us/es/api/first-steps-with-ovh-api/).
...
> Important: Assuming that your PCI project is added to your [vRack](https://docs.ovh.com/us/es/public-cloud/public-cloud-vrack/).
...
To use this kubeconfig file and access to your cluster, you can follow our [configuring kubectl](https://docs.ovh.com/us/es/kubernetes/configuring-kubectl/) tutorial, or simply add the `--kubeconfig` flag in your `kubectl` commands.
