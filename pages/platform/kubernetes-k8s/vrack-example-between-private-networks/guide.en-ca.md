...
> [!warning]
> This guide assumes you are familiar with the [OVHcloud API](https://ca.api.ovh.com/). If you have never used it, you can find the basics here: [First steps with the OVHcloud API](https://docs.ovh.com/ca/en/api/first-steps-with-ovh-api/).
>
