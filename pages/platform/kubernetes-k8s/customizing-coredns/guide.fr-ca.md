...
routes:
    canonical: '/pages/platform/kubernetes-k8s/customizing-coredns'
updated: 2022-10-11
---
...
To learn more about how to use your Kubernetes cluster the practical way, we invite you to read our [tutorials](/ca/fr/kubernetes/).
