...
Next, create an Access Key and Secret Key to access the S3 Object Storage Container using the [Getting Started with the Swift S3 API](https://docs.ovh.com/ca/fr/storage/getting_started_with_the_swift_S3_API/) tutorial.
