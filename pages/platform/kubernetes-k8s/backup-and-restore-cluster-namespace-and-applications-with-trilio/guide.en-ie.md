...
- To create Target for the `OVHcloud Object Storage using High Performance`, use [this link](https://docs.ovh.com/ie/en/storage/s3/getting-started-with-s3/)
...
> [!primary]
>
> If you have created a container with High Performance then follow the [Getting started with S3 High Performance](https://docs.ovh.com/ie/en/storage/s3/getting-started-with-s3/#using-the-aws-cli) documentation.
