...
Next, create an Access Key and Secret Key to access the S3 Object Storage Container using the [Getting Started with the Swift S3 API](https://docs.ovh.com/fr/storage/object-storage/pcs/getting-started-with-the-swift-s3-api/) tutorial.
