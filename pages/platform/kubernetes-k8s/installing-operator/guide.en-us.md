...
Then, build the image and push it on your favorite registry (for instance the [Managed Private Registry](https://docs.ovh.com/us/en/private-registry/) by OVHcloud):
```bash
