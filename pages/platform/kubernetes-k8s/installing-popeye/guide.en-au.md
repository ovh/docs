...
First, you need to have an Object Storage container, if you don't already had one, you can follow the [Creating an Object Storage container](https://docs.ovh.com/au/en/storage/object-storage/pcs/create-container/) guide.
...
Log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au), go to the Public Cloud section and select the Public Cloud project concerned.
