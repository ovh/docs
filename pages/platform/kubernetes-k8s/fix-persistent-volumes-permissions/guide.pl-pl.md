...
excerpt: ''
routes:
    canonical: '/pages/platform/kubernetes-k8s/fix-persistent-volumes-permissions'
updated: 2021-12-17
---
...
To learn more about using your Kubernetes cluster the practical way, we invite you to look at our [OVHcloud Managed Kubernetes documentation](/pl/kubernetes/).
