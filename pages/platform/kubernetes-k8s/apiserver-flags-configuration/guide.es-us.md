...
routes:
    canonical: '/pages/platform/kubernetes-k8s/apiserver-flags-configuration'
updated: 2023-02-14
---
...
To learn more about how to use your Kubernetes cluster the practical way, we invite you to look at our [tutorials](/us/es/kubernetes/).
