...
This tutorial assumes that you already have a working OVH Managed Kubernetes cluster, and some basic knowledge of how to operate it.
...
If you get an `Error: no available release name found` message when installing the `stable/redis` chart, please try the following steps:
