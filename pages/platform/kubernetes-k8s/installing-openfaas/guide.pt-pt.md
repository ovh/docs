...
If you need a private registry, you can use our [OVHcloud Managed Private Registry](/pt/private-registry). For this tutorial we are choosing to deploy our image on the official Docker registry.
