...
routes:
    canonical: '/pages/platform/kubernetes-k8s/installing-openfaas'
updated: 2020-05-12
---
...
If you need a private registry, you can use our [OVHcloud Managed Private Registry](/pl/private-registry). For this tutorial we are choosing to deploy our image on the official Docker registry.
