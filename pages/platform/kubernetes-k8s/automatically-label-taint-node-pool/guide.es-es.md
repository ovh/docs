...
You can follow the Kubernetes cluster creation step by step guide if you want to create it through the [Control Panel](../label-nodeaffinity-node-pools/#cluster-creation) or through [Terraform](https://docs.ovh.com/es/kubernetes/creating-a-cluster-through-terraform/).
...
In order to retrieve this necessary information, please follow our [First steps with the OVHcloud APIs](https://docs.ovh.com/es/api/first-steps-with-ovh-api/) tutorial.
