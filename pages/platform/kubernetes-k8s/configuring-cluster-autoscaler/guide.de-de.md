...
When the autoscaler is enabled on a node pool, it uses a [default configuration](https://docs.ovh.com/de/kubernetes/configuring-cluster-autoscaler/#cluster-autoscaler-configuration).
