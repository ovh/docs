...
Now, go to the `OVHcloud Control Panel`, click on [Public Cloud](https://www.ovhcloud.com/en-us/public-cloud/) and then click on `Managed Kubernetes Service` section. 
