...
Now, go to the `OVHcloud Control Panel`, click on [Public Cloud](https://www.ovhcloud.com/en-au/public-cloud/) and then click on `Managed Kubernetes Service` section. 
...
[Increasing Public Cloud quotas](https://docs.ovh.com/au/en/public-cloud/increase-public-cloud-quota/){.external}.
