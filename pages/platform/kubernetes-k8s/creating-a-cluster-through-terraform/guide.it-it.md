...
In order to retrieve this necessary information, please follow [First steps with the OVHcloud APIs](https://docs.ovh.com/it/api/first-steps-with-ovh-api/) tutorial.
...
[Increasing Public Cloud quotas](https://docs.ovh.com/it/public-cloud/aumenta_la_quota_del_tuo_public_cloud/){.external}.
