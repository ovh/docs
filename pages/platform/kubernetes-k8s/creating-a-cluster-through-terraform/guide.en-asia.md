...
Now, go in the `OVHcloud Control Panel`, click on [Public Cloud](https://www.ovhcloud.com/en-gb/public-cloud/) and then click on `Managed Kubernetes Service` section. 
...
[increase Public Cloud quota](https://docs.ovh.com/asia/en/public-cloud/increase-public-cloud-quota/){.external}.
