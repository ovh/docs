...
-   installing the [OVHcloud AI CLI](https://docs.ovh.com/it/publiccloud/ai/cli/install-client)
...
- Check how to run Tensorflow code with GPUs [here](https://docs.ovh.com/it/publiccloud/ai/training/tensorflow-gpu-examples/).
