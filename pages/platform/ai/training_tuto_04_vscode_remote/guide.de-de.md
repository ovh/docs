...
-   installing the [OVHcloud AI CLI](https://docs.ovh.com/de/publiccloud/ai/cli/install-client)
...
- Check how to run Tensorflow code with GPUs [here](https://docs.ovh.com/de/publiccloud/ai/training/tensorflow-gpu-examples/).
