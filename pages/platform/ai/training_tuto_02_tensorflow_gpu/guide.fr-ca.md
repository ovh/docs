...
If you want to launch it from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc), just follow this [guide](https://docs.ovh.com/ca/fr/publiccloud/ai/training/start-use-notebooks) and select the `Tensorflow 2` docker image.
