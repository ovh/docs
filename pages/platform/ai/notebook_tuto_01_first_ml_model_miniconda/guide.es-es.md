...
- If you want to learn more about the field of **Computer vision** and **Image Classification**, check out this [notebook](https://docs.ovh.com/es/publiccloud/ai/notebooks/tuto-transfer-learning-resnet/).
