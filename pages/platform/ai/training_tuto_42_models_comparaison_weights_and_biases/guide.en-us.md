...
> [!primary]
>
> Here we will use the [ovhai CLI](https://docs.ovh.com/us/en/publiccloud/ai/cli/run-job-cli/). If you wish to do this from the control panel, refer to this [documentation](https://docs.ovh.com/us/en/publiccloud/ai/training/submit-job/).
>
...
To build an app to classify audios, refer to this [tutorial](https://docs.ovh.com/us/en/publiccloud/ai/training/tuto-streamlit-sounds-classification/).
