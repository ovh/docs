...
> [!primary]
>
> Here we will use the [ovhai CLI](https://docs.ovh.com/ie/en/publiccloud/ai/cli/run-job-cli/). If you wish to do this from the control panel, refer to this [documentation](https://docs.ovh.com/ie/en/publiccloud/ai/training/submit-job/).
>
