...
You can also easily access to your [Object Storage](https://docs.ovh.com/asia/en/storage/object-storage/).
...
To know how to manage your users and token, please read the following guide: [Manage AI users and roles](https://docs.ovh.com/asia/en/publiccloud/ai/users/).
