...
You can also easily access to your [Object Storage](https://docs.ovh.com/gb/en/storage/).
...
To know how to manage your users and token, please read the following guide: [Manage AI users and roles](https://docs.ovh.com/gb/en/publiccloud/ai/users/).
