...
This guide shows how to share [**notebooks**](https://docs.ovh.com/sg/en/publiccloud/ai/notebooks/definition/) with other people through the **ovhai** CLI.

## Requirements

-   a working `ovhai` CLI ([how to install ovhai CLI](https://docs.ovh.com/sg/en/publiccloud/ai/training/install-client/))
