...
If you want to launch it from the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de), just follow this [guide](https://docs.ovh.com/de/publiccloud/ai/training/start-use-notebooks) and select the `Tensorflow 2` docker image.
...
- You can compare AI models based on resource consumption, accuracy and training time. Refer to this [tutorial](https://docs.ovh.com/de/publiccloud/ai/training/tuto-models-comparaison-weights-and-biases/).
