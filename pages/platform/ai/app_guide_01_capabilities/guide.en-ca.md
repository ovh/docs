...
AI Apps is compliant with the OVHcloud AI CLI. Discover how to [install the OVHcloud AI CLI](https://docs.ovh.com/ca/en/publiccloud/ai/cli/install-client/){.external}.
