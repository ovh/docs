---
title: AI Deploy - Tutoriel - Déployer une application Gradio pour la reconnaissance de croquis (EN)
...
> [!primary]
>
> Here you will use your trained model, then save it in an Object Storage container. Click [here](https://docs.ovh.com/ca/fr/ai-training/data-cli/) to learn more about Object Storage.
>
...
- You can imagine deploying an AI model with an other tool: **Flask**. Refer to this [tutorial](https://docs.ovh.com/ca/fr/publiccloud/ai/deploy/tuto-flask-hugging-face-sentiment-analysis/).
