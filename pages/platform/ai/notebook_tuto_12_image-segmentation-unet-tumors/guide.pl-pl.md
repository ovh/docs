...
You can launch the notebook from the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.pl/&ovhSubsidiary=pl) or via the ovhai [CLI](https://docs.ovh.com/pl/publiccloud/ai/cli/getting-started-cli/).
...
*If you do not have our CLI yet, follow [this guide](https://docs.ovh.com/pl/publiccloud/ai/cli/install-client/) to install it.*
