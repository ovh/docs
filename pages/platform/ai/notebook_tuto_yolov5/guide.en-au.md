...
If you want to launch it from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au), just follow this [guide](https://docs.ovh.com/au/en/publiccloud/ai/notebooks/definition/).
...
If you want to launch it with the CLI, choose the [volumes](https://docs.ovh.com/au/en/publiccloud/ai/cli/access-object-storage-data/) you want to attach and the number of GPUs (`<nb-gpus>`) to use on your notebook and use the following command:
...
Do you want to observe the evolution of your metrics during the training of your model? Click [here](https://docs.ovh.com/au/en/publiccloud/ai/notebooks/tuto-weights-and-biases/)!

Do you want to use your YOLOv5 model in an app? [Here it is](https://docs.ovh.com/au/en/publiccloud/ai/training/web-service-yolov5/).
