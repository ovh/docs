...
- To go further with **Flask**, imagine creating an app to deploy an Object Detection model. Refer to this [tutorial](https://docs.ovh.com/us/en/publiccloud/ai/deploy/web-service-yolov5/).
- **Flask** allows you to do sentiment classification on texts using Hugging Face models. [Here it is](https://docs.ovh.com/us/en/publiccloud/ai/deploy/tuto-flask-hugging-face-sentiment-analysis/).
