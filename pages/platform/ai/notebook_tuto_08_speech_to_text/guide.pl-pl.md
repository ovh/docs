...
- With NLP, you can do **sentiment analysis**. For more information, click [here](https://docs.ovh.com/pl/publiccloud/ai/notebooks/tuto-hugging-face-sentiment-analysis/).
