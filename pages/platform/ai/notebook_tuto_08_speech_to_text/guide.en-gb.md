...
- With NLP, you can do **sentiment analysis**. For more information, click [here](https://docs.ovh.com/gb/en/publiccloud/ai/notebooks/tuto-hugging-face-sentiment-analysis/).
