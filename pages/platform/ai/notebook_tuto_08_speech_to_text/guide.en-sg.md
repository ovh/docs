...
- With NLP, you can do **sentiment analysis**. For more information, click [here](https://docs.ovh.com/sg/en/publiccloud/ai/notebooks/tuto-hugging-face-sentiment-analysis/).
