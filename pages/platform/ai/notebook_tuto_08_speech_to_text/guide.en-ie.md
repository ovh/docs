...
- With NLP, you can do **sentiment analysis**. For more information, click [here](https://docs.ovh.com/ie/en/publiccloud/ai/notebooks/tuto-hugging-face-sentiment-analysis/).
