...
> > See this [OVHcloud documentation](/pages/platform/ai/gi_02_concepts_data) on data for more information.
> >
...
> > While AI Notebooks does not offer this possibility, it is possible with AI Training & AI Deploy Your image needs to be either on the shared registry, a private managed registry, DockerHub, or GitHub packages. You will find more information [here](/pages/platform/ai/gi_07_manage_registry).
> >
...
> > Essential information about building a custom Docker image can be found [here](/pages/platform/ai/training_tuto_02_build_custom_image). Advanced information can be found [here](https://docs.docker.com/engine/reference/builder/).
> >  
> 
...
> > All steps for starting and working on AI Notebooks are described [here](/pages/platform/ai/training_guide_06_howto_notebooks).
> >
...
> > You will have to pay for the resources you use. Check [this documentation](/pages/platform/ai/notebook_guide_billing_concept) for detailed examples.
> >
> For more information about AI Notebooks, please check the [Troubleshooting documentation](/pages/platform/ai/notebook_guide_troubleshooting).
> >
> **Specific to AI Training**
> >
> How to start an AI Training job?
> > All steps for starting and working on AI Training are described [here](/pages/platform/ai/training_guide_02_howto_submit_job).
> >
...
> >
> >  The price will depend on the compute resources you use (CPUs and GPUs) and their running time. Pricing examples can be found [here](/pages/platform/ai/training_guide_08_billing_concept).
> >
> For more information about AI Training, please check the [Troubleshooting documentation](/pages/platform/ai/training_guide_07_troubleshooting).
> >
> **Specific to AI Deploy**
> >
> How to start an AI Deploy app?
> > All steps for starting and working on AI Deploy are described [here](/pages/platform/ai/deploy_guide_02_getting_started).
> >
> Is it possible to update the image used by my app?
> > To make your app use the updated version of a Docker image, follow [this guide](/pages/platform/ai/deploy_guide_08_update_custom_docker_image).
> >
> How is the product billed? 
> > AI Deploy apps are a pay-per-use solution. You only pay for the resources consumption, also known as available replicas, during a period of time (during the RUNNING and SCALING phases of your apps). We do not provide a pay-per-call pricing so far. Pricing examples can be found [here](/pages/platform/ai/deploy_guide_06_billing_concept).
> >
...
> >
> For more information about AI Deploy, please check the [Troubleshooting documentation](/pages/platform/ai/deploy_guide_07_troubleshooting).
> >
