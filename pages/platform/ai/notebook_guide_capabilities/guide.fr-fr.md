...
The maximum amount of CPU/GPU, memory per CPU/GPU and local storage is available through our [OVHcloud website](https://www.ovhcloud.com/fr/public-cloud/prices/), Control Panel and the `ovhai` CLI.
...
- **NVIDIA V100S** ([pricing available here](https://www.ovhcloud.com/fr/public-cloud/prices/)).
