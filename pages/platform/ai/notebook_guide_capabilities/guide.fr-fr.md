...
AI Notebooks is compliant with the OVHcloud AI CLI. Discover how to [install the OVHcloud AI CLI](https://docs.ovh.com/fr/publiccloud/ai/cli/install-client/).
...
The maximum amount of CPU/GPU, memory per CPU/GPU and local storage is available through our [OVHcloud website](https://www.ovhcloud.com/fr/public-cloud/prices/#ai-&-machine-learning), Control Panel and the `ovhai` CLI.
...
Browse the full [AI Notebooks documentation](https://docs.ovh.com/fr/publiccloud/ai/) to further understand the main concepts and get started.
