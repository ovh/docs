...
AI Notebooks is compliant with the OVHcloud AI CLI. Discover how to [install the OVHcloud AI CLI](https://docs.ovh.com/gb/en/publiccloud/ai/cli/install-client/).
...
Browse the full [AI Notebooks documentation](https://docs.ovh.com/gb/en/publiccloud/ai/) to further understand the main concepts and get started.
