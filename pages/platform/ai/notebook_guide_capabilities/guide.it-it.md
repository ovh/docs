...
AI Notebooks is compliant with the OVHcloud AI CLI. Discover how to [install the OVHcloud AI CLI](https://docs.ovh.com/it/publiccloud/ai/cli/install-client/).
...
The maximum amount of CPU/GPU, memory per CPU/GPU and local storage is available through our [OVHcloud website](https://www.ovhcloud.com/it/public-cloud/prices/#ai-&-machine-learning), Control Panel and the `ovhai` CLI.
...
##### **Available hardware for notebooks**
...
> [!primary]
> **Local storage** is limited and not the recommended way to handle data, see the [OVHcloud documentation on data](https://docs.ovh.com/it/publiccloud/ai/data) for more information.
>
...
Browse the full [AI Notebooks documentation](https://docs.ovh.com/it/publiccloud/ai/) to further understand the main concepts and get started.
