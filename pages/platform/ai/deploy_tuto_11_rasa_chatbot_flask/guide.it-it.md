...
If you want to know more about data storage concept, read this guide: [Create an object container](https://docs.ovh.com/it/storage/object-storage/pcs/create-container/).
