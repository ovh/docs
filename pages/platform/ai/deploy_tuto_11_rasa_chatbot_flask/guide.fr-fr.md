...
In a previous tutorial, we created and trained a Rasa Chatbot with AI Notebooks: [How to create and train a chatbot on OVHcloud](https://docs.ovh.com/fr/publiccloud/ai/notebooks/create-rasa-chatbot).
...
[How to create and train a rasa chatbot](https://docs.ovh.com/fr/publiccloud/ai/notebooks/create-rasa-chatbot)
