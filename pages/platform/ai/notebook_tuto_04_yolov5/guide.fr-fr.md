---
title: AI Notebooks - Tutoriel - Entraîner YOLOv5 sur un jeu de données personnalisé (EN)
...
If you want to run it with the CLI, just follow this [guide](https://docs.ovh.com/fr/publiccloud/ai/cli/access-object-storage-data). You have to choose the region, the name of your container and the path where your data is located and use the following command:
...
You need to attach a volume if your data is in your OVHcloud object storage and you want to use it during your experiment, or if you need to save the results of your work in the object storage. For more information on data, volumes and permissions, see [our guide on data](https://docs.ovh.com/fr/publiccloud/ai/cli/access-object-storage-data/).

If you want to launch it from the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/fr/&ovhSubsidiary=fr), just follow this [guide](https://docs.ovh.com/fr/publiccloud/ai/notebooks/definition/).
...
If you want to launch it with the CLI, choose the [volumes](https://docs.ovh.com/fr/publiccloud/ai/cli/access-object-storage-data/) you want to attach and the number of GPUs (`<nb-gpus>`) to use on your notebook and use the following command:
...
- Do you want to observe the evolution of your metrics during the training of your model? Click [here](https://docs.ovh.com/fr/publiccloud/ai/notebooks/tuto-weights-and-biases/)!
- Do you want to use your YOLOv5 model in an app? [Here it is](https://docs.ovh.com/fr/publiccloud/ai/deploy/web-service-yolov5/).
