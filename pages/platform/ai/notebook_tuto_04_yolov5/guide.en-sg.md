...
- Do you want to observe the evolution of your metrics during the training of your model? Click [here](https://docs.ovh.com/sg/en/publiccloud/ai/notebooks/tuto-weights-and-biases/)!
- Do you want to use your YOLOv5 model in an app? [Here it is](https://docs.ovh.com/sg/en/publiccloud/ai/deploy/web-service-yolov5/).
