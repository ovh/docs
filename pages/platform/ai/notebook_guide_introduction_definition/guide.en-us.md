...
by reading the [Getting Started](https://docs.ovh.com/us/en/publiccloud/ai/cli/getting-started-cli/) page.

Notebooks also provide an easy way to access data from your Object Storage, you can read more about it [here](https://docs.ovh.com/us/en/publiccloud/ai/notebooks/tuto-access-object-storage-data/).
