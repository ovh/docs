...
- a Public Cloud user with `administrator` or `AI Training admin` role, see [here](https://docs.ovh.com/it/publiccloud/ai/users/) for more information
...
If you have not already created a Public Cloud user account, follow this [guide](https://docs.ovh.com/it/publiccloud/ai/users/) and then log in with your Public Cloud user account.
