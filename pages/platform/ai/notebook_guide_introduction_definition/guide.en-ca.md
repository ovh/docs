...
Notebooks also provide an easy way to access data from your Object Storage, you can read more about it [here](https://docs.ovh.com/ca/en/publiccloud/ai/notebooks/tuto-access-object-storage-data/).
