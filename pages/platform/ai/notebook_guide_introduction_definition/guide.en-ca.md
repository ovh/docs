...
If you have not already created a Public Cloud user account, follow this [guide](https://docs.ovh.com/ca/en/publiccloud/ai/users/) and then login with your Public Cloud user account.
