---
title: "AI Notebooks - Tutoriel - Analyse des sentiments sur les Tweets à l'aide de Hugging Face (EN)"
...
- You can also deploy a **Flask** app to classify text sentiments with **Hugging Face** models. Check this [documentation](https://docs.ovh.com/fr/publiccloud/ai/deploy/tuto-flask-hugging-face-sentiment-analysis/).
