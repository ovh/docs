...
- You can also deploy a **Flask** app to classify text sentiments with **Hugging Face** models. Check this [documentation](https://docs.ovh.com/pl/publiccloud/ai/deploy/tuto-flask-hugging-face-sentiment-analysis/).
