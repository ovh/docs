...
> [!primary]
>
> Here we will use the [ovhai CLI](https://docs.ovh.com/ca/fr/publiccloud/ai/cli/run-job-cli/). If you wish to do this from the OVHcloud Control Panel, refer to this [documentation](https://docs.ovh.com/ca/fr/publiccloud/ai/training/submit-job/).
>
...
> [!primary]
>
> To find out more about how jobs work and their status, check this [documentation](https://docs.ovh.com/ca/fr/publiccloud/ai/training/jobs/).
>
...
- To build an app to classify audios, refer to this [tutorial](https://docs.ovh.com/ca/fr/publiccloud/ai/deploy/tuto-streamlit-sounds-classification/).
- Do you want to know how to build and use custom Docker image with AI Training? [Here it is](https://docs.ovh.com/ca/fr/publiccloud/ai/training/build-use-custom-image/).
