...
- an [Object Storage Container](https://docs.ovh.com/es/storage/object-storage/pcs/create-container/) in your OVHcloud account
...
To follow all the steps in detail, please refer to this [documentation](https://docs.ovh.com/es/publiccloud/ai/users/).

As an alternative, you can generate an authorized token directly via our [CLI](https://docs.ovh.com/es/publiccloud/ai/cli/app-token-cli/).
...
If you want to find this information, check the [documentation](https://docs.ovh.com/es/publiccloud/ai/cli/install-client/#instructions).
...
Please note that each AI Notebook is limited to a maximum amount of CPUs and GPUs. You can refer to the AI Notebooks [Capabilities and Limitations](https://docs.ovh.com/es/publiccloud/ai/notebooks/capabilities/) guide.
...
If you want to build and use a custom Docker image, you can do it with AI Training by following this [tutorial](https://docs.ovh.com/es/publiccloud/ai/training/build-use-custom-image/).
