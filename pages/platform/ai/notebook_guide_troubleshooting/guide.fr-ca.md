...
- an [Object Storage Container](https://docs.ovh.com/ca/fr/storage/object-storage/pcs/create-container/) in your OVHcloud account
...
To follow all the steps in detail, please refer to this [documentation](https://docs.ovh.com/ca/fr/publiccloud/ai/users/).

As an alternative, you can generate an authorized token directly via our [CLI](https://docs.ovh.com/ca/fr/publiccloud/ai/cli/app-token-cli/).
...
If you want to find this information, check the [documentation](https://docs.ovh.com/ca/fr/publiccloud/ai/cli/install-client/#instructions).
...
Please note that each AI Notebook is limited to a maximum amount of CPUs and GPUs. You can refer to the AI Notebooks [Capabilities and Limitations](https://docs.ovh.com/ca/fr/publiccloud/ai/notebooks/capabilities/) guide.
