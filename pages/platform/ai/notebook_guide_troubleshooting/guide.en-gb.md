...
AI Notebooks does not allow the use of `apt-get install`, you are not root. You can install your various packages using the commands:
...
> [!primary]
>
> When you write data inside an attached volume, we wait for the AI Notebook stop to synchronize back your data.
>

If you are unable to see your data synchronized, please ensure the following:
...
To install the CLI for OVHcloud AI Tools, you can check this and follow the different steps.

For informations, two regions are available: `bhs` and `gra`.
...
Now all you have to do is adding it to your `PATH`:
...
If you want to find this information, check the [documentation](https://docs.ovh.com/gb/en/publiccloud/ai/cli/install-client/#instructions).
...
## I may have reached the resources limits

Each AI Notebooks comes with a monitoring dashboard, allowing you to closely watch your compute, storage and network consumptions.
...
Please note that each AI Notebook is limited to a maximum amount of CPU and GPUs. You can refer to AI Notebooks [Capabilities and Limitations](https://docs.ovh.com/gb/en/publiccloud/ai/notebooks/capabilities/) guide.

## I am experiencing slowness

Slowness can be experienced in two major cases: you are running intensive task taking all you resources or it's an issue on OVHcloud side.

For the first case, you may refer to the question *"I may have reach the resources limits"*.
...
OVHcloud AI Notebooks comes with preinstalled AI environment, such as TensorFlow, PyTorch or HuggingFace, and useful packages.
...
- Check if you have access to the data of the volume you are trying to connect to your notebook: If you try to connect a volume (from PCS) and you do not have access rights, your notebook will be in failed status.

To debug yourself, run the following command in the CLI:
...
While we are doing our best to avoid this situation, like any products in the world outages can happen.

Please open a ticket to our support.

If you notebook is shut down unexpectedly it may be due to an issue in our backend. Usually, your remote data is safe and will be synchronized in Public Cloud Object Storage.
