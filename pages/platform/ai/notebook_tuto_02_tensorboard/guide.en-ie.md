...
- Another way to track your training with an AI notebook is to use **Weights & Biases**. Follow this [tutorial](https://docs.ovh.com/ie/en/publiccloud/ai/notebooks/tuto-weights-and-biases/).
