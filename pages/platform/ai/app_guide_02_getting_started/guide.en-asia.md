...
> [!primary]
>
> OVHcloud provides multiple datacenters. You can find the capabilities for AI Apps in the guide [AI Apps capabilities](https://docs.ovh.com/asia/en/publiccloud/ai/apps/capabilities/).
>
...
That's it! To go further, you can imagine deploying an AI model thanks to AI Apps. Refer to this [tutorial](https://docs.ovh.com/asia/en/publiccloud/ai/apps/tuto-gradio-sketch-recognition/).
