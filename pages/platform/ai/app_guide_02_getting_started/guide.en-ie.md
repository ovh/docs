...
> [!primary]
>
> OVHcloud provides multiple datacenters. You can find the capabilities for AI Apps in the guide [AI Apps capabilities](https://docs.ovh.com/ie/en/publiccloud/ai/deploy/capabilities/).
>
...
That's it! To go further, you can imagine to deploy an AI model thanks to AI Apps. Refer to this [tutorial](https://docs.ovh.com/ie/en/publiccloud/ai/deploy/tuto-gradio-sketch-recognition/).
