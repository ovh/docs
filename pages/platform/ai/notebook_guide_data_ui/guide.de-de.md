...
This guide shows how to access Object Storage data from your [**notebooks**](https://docs.ovh.com/de/publiccloud/ai/notebooks/definition/) via the OVHcloud Control Panel.

## Requirements

- a [Public Cloud project](https://www.ovhcloud.com/de/public-cloud/) in your OVHcloud account
- access to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.de/&ovhSubsidiary=de)
- a Public Cloud user with `Administrator` or `AI Training operator` role, see [here](https://docs.ovh.com/de/publiccloud/ai/users/) for more information
...
If you want to know more about the different storage solutions, refer to this [page](https://docs.ovh.com/de/storage/).
...
For the *first 4 steps* of the notebook creation, please refer to this [tutorial](https://docs.ovh.com/de/publiccloud/ai/notebooks/definition/).
...
You can read the [Getting started](https://docs.ovh.com/de/publiccloud/ai/notebooks/definition/) page to know how to find this URL.
