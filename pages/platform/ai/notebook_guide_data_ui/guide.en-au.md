...
- a [Public Cloud project](https://www.ovhcloud.com/au/public-cloud/) in your OVHcloud account
...
For the *first 4 steps* of the notebook creation, please refer to this [tutorial](https://docs.ovh.com/au/en/publiccloud/ai/cli/getting-started-cli/).
