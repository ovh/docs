...
If you prefer using your own private Docker registry instead of the shared one, feel free to use it. Just don't forget to [add your registry in your AI Tools project](https://docs.ovh.com/asia/en/publiccloud/ai/training/add-private-registry) before using it.
...
- Discover some AI Deploy apps we built with API or Web frontend via our [Apps portfolio](https://docs.ovh.com/asia/en/publiccloud/ai/deploy/apps-portfolio/).
