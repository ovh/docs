...
- You can use the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we), see [create data container](https://docs.ovh.com/us/en/storage/object-storage/pcs/create-container/).
