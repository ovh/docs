...
- You can use the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.co.uk/&ovhSubsidiary=GB), see [create data container](/pages/cloud/storage/object_storage/pcs_create_container).
