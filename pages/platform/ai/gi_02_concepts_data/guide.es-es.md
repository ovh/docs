...
- You can upload and download data from your local environment using the CLI, see [how to install `ovhai` CLI](https://docs.ovh.com/es/publiccloud/ai/cli/install-client). Next, find out how to [manage your data with the CLI](https://docs.ovh.com/es/publiccloud/ai/cli/data-cli/).
- You can use the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es), see [create data container](https://docs.ovh.com/es/storage/object-storage/pcs/create-container/).
...
- You can check how to [use your data in an AI Notebook](https://docs.ovh.com/es/publiccloud/ai/cli/access-object-storage-data/).

- You can check how to [launch an AI Training job with attached volumes](https://docs.ovh.com/es/publiccloud/ai/cli/run-job-cli/).
