...
- You can use the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au), see [create data container](https://docs.ovh.com/au/en/storage/pcs/create-container/).
