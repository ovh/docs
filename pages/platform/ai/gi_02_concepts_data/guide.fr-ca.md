...
- You can use the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc), see [create data container](https://docs.ovh.com/ca/fr/storage/pcs/create-container/).
