...
- You can upload and download data from your local environment using the CLI, see [how to install `ovhai` CLI](https://docs.ovh.com/ca/fr/publiccloud/ai/cli/install-client). Next, find out how to [manage your data with the CLI](https://docs.ovh.com/ca/fr/publiccloud/ai/cli/data-cli/).
- You can use the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc), see [create data container](https://docs.ovh.com/ca/fr/storage/object-storage/pcs/create-container/).
...
- You can check the [OVHcloud documentation on how to create a data container](https://docs.ovh.com/ca/fr/storage/object-storage/pcs/create-container/).

- You can check how to [use your data in an AI Notebook](https://docs.ovh.com/ca/fr/publiccloud/ai/cli/access-object-storage-data/).

- You can check how to [launch an AI Training job with attached volumes](https://docs.ovh.com/ca/fr/publiccloud/ai/cli/run-job-cli/).
