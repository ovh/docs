...
- You can use the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca), see [create data container](/pages/cloud/storage/object_storage/pcs_create_container).
