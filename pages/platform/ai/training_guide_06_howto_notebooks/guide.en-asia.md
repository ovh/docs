...
Follow the same steps as a classic job submission described [here](https://docs.ovh.com/asia/en/publiccloud/ai/training/submit-job) until you reach the [Step 5 - Providing a Docker image](https://docs.ovh.com/asia/en/publiccloud/ai/training/submit-job/#step-5-providing-a-docker-image).
...
Continue to follow the same steps as a classic job submission described [here](https://docs.ovh.com/asia/en/publiccloud/ai/training/submit-job) until you reach the [Step 10 - Consulting your job](https://docs.ovh.com/asia/en/publiccloud/ai/training/submit-job/#step-10-consulting-your-job).
...
> [!primary]
> If you have never created a user for AI Training yet you can follow the instruction [here](https://docs.ovh.com/asia/en/publiccloud/ai/users)
