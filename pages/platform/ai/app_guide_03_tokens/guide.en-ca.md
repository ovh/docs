...
Additional information about the use of a token to manage an AI Training resource can be found [here](https://docs.ovh.com/ca/en/publiccloud/ai/training/app-token-cli/#use-the-app-token).
