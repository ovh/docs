...
Additional information about the use of a token to manage an AI Training resource can be found [here](https://docs.ovh.com/au/en/publiccloud/ai/cli/app-token-cli/#use-the-app-token).
