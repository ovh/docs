...
AI Training is compliant with the OVHcloud AI CLI. Discover how to [install the OVHcloud AI CLI](https://docs.ovh.com/asia/en/publiccloud/ai/cli/install-client/).
...
Learn how to build and use your custom Docker image in this [tutorial](https://docs.ovh.com/asia/en/publiccloud/ai/training/build-use-custom-image/).
...
Browse the full [AI Training documentation](https://docs.ovh.com/asia/en/publiccloud/ai/) to further understand the main concepts and get started.
