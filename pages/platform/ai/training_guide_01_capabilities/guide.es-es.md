...
AI Training is compliant with the OVHcloud AI CLI. Discover how to [install the OVHcloud AI CLI](https://docs.ovh.com/es/publiccloud/ai/cli/install-client/).
...
Browse the full [AI Training documentation](https://docs.ovh.com/es/publiccloud/ai/) to further understand the main concepts and get started.
