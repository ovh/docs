...
- A [user for AI Training](https://docs.ovh.com/pl/publiccloud/ai/users/);
...
If you want to run it with the CLI, just follow [this guide](https://docs.ovh.com/pl/publiccloud/ai/cli/access-object-storage-data/). You have to choose the region, the name of your container and the path where your data is located and use the following command:
...
> [!primary]
>
> Here we will use the [ovhai CLI](https://docs.ovh.com/pl/publiccloud/ai/cli/run-job-cli/). If you wish to do this from the OVHcloud Control Panel, refer to this [documentation](https://docs.ovh.com/pl/publiccloud/ai/training/submit-job/).
>
...
> [!primary]
>
> To find out more about how jobs work and their status, check this [documentation](https://docs.ovh.com/pl/publiccloud/ai/training/jobs/).
>
...
- To build an app to classify audios, refer to this [tutorial](https://docs.ovh.com/pl/publiccloud/ai/deploy/tuto-streamlit-sounds-classification/).
- Do you want to know how to build and use custom Docker image with AI Training? [Here it is](https://docs.ovh.com/pl/publiccloud/ai/training/build-use-custom-image/).
