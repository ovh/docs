---
title: AI Training - Tutorial - Deploy a simple app with Flask
slug: training/tuto-build-use-flask-image
excerpt: How to build and use a custom Docker image containing a Flask application
section: AI Training tutorials
order: 11
---

**Last updated 1st of March, 2022.**
...
> [!warning]
>
> The shared registry of AI Training should only be used for testing purposes. Please consider attaching your own docker registry. More information about this can be found [here](https://docs.ovh.com/asia/en/publiccloud/ai/training/add-private-registry/).
>
