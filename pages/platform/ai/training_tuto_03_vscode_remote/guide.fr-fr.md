---
title: AI Training - Tutoriel - Se connecter à distance via VSCode (EN)
...
-   installing the [OVHcloud AI CLI](https://docs.ovh.com/fr/publiccloud/ai/cli/install-client)
