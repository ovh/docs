...
If you want to launch it from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au), just follow this [guide](https://docs.ovh.com/au/en/publiccloud/ai/training/start-use-notebooks) and select the docker image of your choice.
