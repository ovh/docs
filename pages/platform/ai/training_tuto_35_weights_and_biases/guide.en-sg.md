...
If you want to launch it from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg), just follow this [guide](https://docs.ovh.com/sg/en/publiccloud/ai/training/start-use-notebooks) and select the docker image of your choice.
