...
-   a working `ovhai` CLI ([how to install ovhai CLI](https://docs.ovh.com/ca/en/publiccloud/ai/training/install-client/))
...
Learn how to access your object storage data from your notebooks [here](https://docs.ovh.com/ca/en/publiccloud/ai/notebooks/tuto-access-object-storage-data/).
