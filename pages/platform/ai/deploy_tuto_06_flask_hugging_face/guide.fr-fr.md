---
title: "AI Deploy - Tutoriel - Déployer une application pour l'analyse des sentiments avec des modèles Hugging Face à l'aide de Flask (EN)"
...
- You can also imagine deploying an Object Detection model with **Flask** in this [tutorial](https://docs.ovh.com/fr/publiccloud/ai/deploy/web-service-yolov5/).
- Discover an other tool to deploy easily AI models: **Gradio**. Refer to this [documentation](https://docs.ovh.com/fr/publiccloud/ai/deploy/tuto-gradio-sketch-recognition/).
