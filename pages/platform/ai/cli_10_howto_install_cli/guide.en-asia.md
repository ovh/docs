...
-   **AI Training activated** for your account, see [how to submit a job Step 2](https://docs.ovh.com/asia/en/publiccloud/ai/training/submit-job)
-   a user for AI Training, see [how to create a user](https://docs.ovh.com/asia/en/publiccloud/ai/create-user)
...
The documentation of the CLI is available at [CLI documentation](https://docs.ovh.com/asia/en/publiccloud/ai/cli/overview-cli).
