...
-   **AI Training activated** for your account, see [how to submit a job Step 2](https://docs.ovh.com/es/publiccloud/ai/training/submit-job)
-   a user for AI Tools, see [how to create a user](https://docs.ovh.com/es/publiccloud/ai/users)
...
The documentation of the CLI is available at [CLI documentation](https://docs.ovh.com/es/publiccloud/ai/cli/overview-cli).
