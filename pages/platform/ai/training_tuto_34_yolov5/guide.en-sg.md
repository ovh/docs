...
If you want to run it with the CLI, just follow this [guide](https://docs.ovh.com/sg/en/publiccloud/ai/cli/data-cli). You have to choose the region, the name of your container and the path where your data is located and use the following command:
...
If you want to launch it from the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/sg/&ovhSubsidiary=sg), just follow this [guide](https://docs.ovh.com/sg/en/publiccloud/ai/training/start-use-notebooks).
...
If you want to launch it with the CLI, choose the [volume](https://docs.ovh.com/sg/en/publiccloud/ai/cli/run-job-cli/) you want to attach and the number of GPUs (`<nb-gpus>`) to use on your job and use the following command:
