...
- Two [Object Storage containers](https://docs.ovh.com/fr/storage/object-storage/pcs/create-container/) to store the data and the model
- Your own dataset
