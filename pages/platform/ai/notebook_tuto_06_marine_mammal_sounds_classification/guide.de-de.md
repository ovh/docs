...
- Two [Object Storage containers](https://docs.ovh.com/de/storage/object-storage/pcs/create-container/) to store the data and the model
- Your own dataset
...
If you want to launch it with the CLI, choose the [volume](https://docs.ovh.com/de/publiccloud/ai/cli/access-object-storage-data/) you want to attach and the number of GPUs (`<nb-gpus>`) to use on your notebook and use the following command:
