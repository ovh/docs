...
- Two [Object Storage containers](https://docs.ovh.com/ca/fr/storage/object-storage/pcs/create-container/) to store the data and the model
- Your own dataset
...
You need to attach a volume if your data is in your OVHcloud Object Storage and you want to use it during your experiment. For more information on data, volumes and permissions, see [our guide on data](https://docs.ovh.com/ca/fr/publiccloud/ai/cli/access-object-storage-data/).
...
If you want to launch it with the CLI, choose the [volume](https://docs.ovh.com/ca/fr/publiccloud/ai/cli/access-object-storage-data/) you want to attach and the number of GPUs (`<nb-gpus>`) to use on your notebook and use the following command:
