...
updated: 2023-04-17
routes:
    canonical: 'https://docs.ovh.com/pl/publiccloud/ai/deploy/tuto-streamlit-image-segmentation-unet-brain-tumors/'
---
...
You can upload your data to the cloud either by using the [OVHcloud Control Panel (UI)](https://www.ovh.com/manager/#/public-cloud/) or with the [OVHcloud AI CLI](https://docs.ovh.com/pl/publiccloud/ai/cli/install-client/).
