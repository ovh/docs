...
- [The OVHcloud AI CLI](https://docs.ovh.com/au/en/publiccloud/ai/cli/install-client/) installed on your local computer
...
You can upload your data to the cloud either by using the [OVHcloud Control Panel (UI)](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com.au/&ovhSubsidiary=au) or with the [OVHcloud AI CLI](https://docs.ovh.com/au/en/publiccloud/ai/cli/install-client/).
...
Then, select the `Object Storage`{.action} section (in the Storage category) and [create a new object container](https://docs.ovh.com/au/en/storage/object-storage/pcs/create-container/) by clicking `Storage`{.action} > `Object Storage`{.action} > `Create an object container`{.action}.
...
- Do you want to use Streamlit to create an audio classification app? [Learn how to do it](https://docs.ovh.com/au/en/publiccloud/ai/deploy/tuto-streamlit-sounds-classification/).
- Learn how to create & deploy a Speech-to-Text app [here](https://docs.ovh.com/au/en/publiccloud/ai/deploy/tuto-streamlit-speech-to-text-app/).
