...
updated: 2023-04-17
routes:
    canonical: 'https://docs.ovh.com/fr/publiccloud/ai/deploy/tuto-streamlit-image-segmentation-unet-brain-tumors/'
---
...
- [The OVHcloud AI CLI](https://docs.ovh.com/fr/publiccloud/ai/cli/install-client/) installed on your local computer
...
You can upload your data to the cloud either by using the [OVHcloud Control Panel (UI)](https://www.ovh.com/manager/#/public-cloud/) or with the [OVHcloud AI CLI](https://docs.ovh.com/fr/publiccloud/ai/cli/install-client/).
...
Then, select the Object Storage section (in the Storage category) and [create a new object container](https://docs.ovh.com/fr/storage/object-storage/pcs/create-container/) by clicking `Storage` > `Object Storage` > `Create an object container`.
...
- Do you want to use Streamlit to create a audio classification app? [Here it is](https://docs.ovh.com/fr/publiccloud/ai/deploy/tuto-streamlit-sounds-classification/).
- Learn how to create & deploy a Speech-to-Text app [here](https://docs.ovh.com/fr/publiccloud/ai/deploy/tuto-streamlit-speech-to-text-app/).
