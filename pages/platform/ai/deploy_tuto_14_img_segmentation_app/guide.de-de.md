...
updated: 2023-04-17
routes:
    canonical: 'https://docs.ovh.com/de/publiccloud/ai/deploy/tuto-streamlit-yolov7-sign-language/'
---
...
- [The OVHcloud AI CLI](https://docs.ovh.com/de/publiccloud/ai/cli/install-client/) installed on your local computer
...
You can upload your data to the cloud either by using the [OVHcloud Control Panel (UI)](https://www.ovh.com/manager/#/public-cloud/) or with the [OVHcloud AI CLI](https://docs.ovh.com/de/publiccloud/ai/cli/install-client/).
...
Then, select the Object Storage section (in the Storage category) and [create a new object container](https://docs.ovh.com/de/storage/object-storage/pcs/create-container/) by clicking `Storage` > `Object Storage` > `Create an object container`.
...
> [!warning]
> **Warning**
> The shared registry of AI Deploy should only be used for testing purpose. Please consider attaching your own Docker registry. More information about this can be found [here](https://docs.ovh.com/de/publiccloud/ai/training/add-private-registry).
...
- Learn how to create & deploy a Speech-to-Text app [here](https://docs.ovh.com/de/publiccloud/ai/deploy/tuto-streamlit-speech-to-text-app/).
