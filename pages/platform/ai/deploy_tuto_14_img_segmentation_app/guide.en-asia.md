...
- An access to the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia)
...
You can upload your data to the cloud either by using the [OVHcloud Control Panel (UI)](https://www.ovh.com/manager/#/public-cloud/) or with the [OVHcloud AI CLI](https://docs.ovh.com/asia/en/publiccloud/ai/cli/install-client/).
...
> [!warning]
> **Warning**
> The shared registry of AI Deploy should only be used for testing purpose. Please consider attaching your own Docker registry. More information about this can be found [here](https://docs.ovh.com/asia/en/publiccloud/ai/training/add-private-registry).
...
- Do you want to use Streamlit to create a audio classification app? [Here it is](https://docs.ovh.com/asia/en/publiccloud/ai/deploy/tuto-streamlit-sounds-classification/).
