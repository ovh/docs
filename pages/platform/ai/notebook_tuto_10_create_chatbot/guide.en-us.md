...
- A [user for AI Notebooks](https://docs.ovh.com/us/en/publiccloud/ai/users/)
...
Here is the reference to install the CLI: [CLI Installation](https://docs.ovh.com/us/en/publiccloud/ai/cli/install-client/).
...
[How to deploy a chatbot](https://docs.ovh.com/us/en/publiccloud/ai/deploy/rasa-chatbot)
