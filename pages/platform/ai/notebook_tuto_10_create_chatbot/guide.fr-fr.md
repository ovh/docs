...
- The ovhai CLI interface installed on your system (more information [here](https://docs.ovh.com/fr/publiccloud/ai/cli/install-client/))
- A [user for AI Notebooks](https://docs.ovh.com/fr/publiccloud/ai/users/)
...
Here is the reference to install the CLI: [CLI Installation](https://docs.ovh.com/fr/publiccloud/ai/cli/install-client/).

The token is now created. Don't forget to save the token to use it later.

Now, if you already have trained some Rasa models with AI Training by following [our tutorial](https://docs.ovh.com/fr/publiccloud/ai/training/tuto-train-rasa-chatbot/), you already have created a container with your trained models. You can skip the next part and go directly [here](#visualstudiocode).
...
If you want to know more about data storage concept, read this guide: [Create an object container](https://docs.ovh.com/fr/storage/object-storage/pcs/create-container/). 
...
[How to deploy a chatbot](https://docs.ovh.com/fr/publiccloud/ai/deploy/deploy-rasa-chatbot)

If you want to train a Rasa chatbot with the tool AI Training, please refer to this tutorial:

[How to train a chatbot with docker and AI Training](https://docs.ovh.com/fr/publiccloud/ai/training/tuto-train-rasa-chatbot/)
