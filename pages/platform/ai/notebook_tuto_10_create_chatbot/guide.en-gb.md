...
Now, if you already have trained some Rasa models with AI Training by following [our tutorial](https://docs.ovh.com/gb/en/publiccloud/ai/training/train-rasa-chatbot/), you already have created a container with your trained models. You can skip the next part and go directly [here](#Create-and-train-a-chatbot-with-a-visual-studio-code-notebook).
