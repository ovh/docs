...
- A [user for AI Notebooks](https://docs.ovh.com/it/publiccloud/ai/users/)
...
Here is the reference to install the CLI: [CLI Installation](https://docs.ovh.com/it/publiccloud/ai/cli/install-client/).

The token is now created. Don't forget to save the token to use it later.

Now, if you already have trained some Rasa models with AI Training by following [our tutorial](https://docs.ovh.com/it/publiccloud/ai/training/train-rasa-chatbot/), you already have created a container with your trained models. You can skip the next part and go directly [here](#visualstudiocode).
...
[How to train a chatbot with docker and AI Training](https://docs.ovh.com/it/publiccloud/ai/training/train-rasa-chatbot/)
