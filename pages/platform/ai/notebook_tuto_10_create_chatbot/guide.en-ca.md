...
- A [user for AI Notebooks](https://docs.ovh.com/ca/en/publiccloud/ai/users/)
...
Here is the reference to install the CLI: [CLI Installation](https://docs.ovh.com/ca/en/publiccloud/ai/cli/install-client/).
...
[How to deploy a chatbot](https://docs.ovh.com/ca/en/publiccloud/ai/deploy/deploy-rasa-chatbot)
