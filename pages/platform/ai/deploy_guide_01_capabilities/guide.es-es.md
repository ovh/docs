...
AI Deploy offers the possibility to choose between two [scaling strategies](https://docs.ovh.com/es/publiccloud/ai/deploy/apps-deployments/): **static** or **automatic**.
...
AI Deploy authorizes the deployment of your own Docker images or applications from the [OVHcloud portfolio](https://docs.ovh.com/es/publiccloud/ai/deploy/apps-portfolio/).
...
You are also able to check it from the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.es/&ovhSubsidiary=es) in your app information by clicking on the button `Access dashboards`.
...
AI Deploy is compliant with the OVHcloud AI CLI. Discover how to [install the OVHcloud AI CLI](https://docs.ovh.com/es/publiccloud/ai/cli/install-client/){.external}.

## Go further

Browse the full [AI Deploy documentation](https://docs.ovh.com/es/publiccloud/ai/) to further understand the main concepts and get started.
