...
You can see more details on the prices of the AI tools in the [documentation](https://www.ovhcloud.com/en-sg/public-cloud/prices/#ai-&-machine-learning).
...
To know how to manage your users and token, please read the guide Manage [AI users and roles](https://docs.ovh.com/sg/en/publiccloud/ai/users/).
