...
If you want to launch it with the CLI, choose the [volume](https://docs.ovh.com/us/en/publiccloud/ai/cli/access-object-storage-data/) you want to attach and the number of GPUs (`<nb-gpus>`) to use on your notebook and use the following command:
