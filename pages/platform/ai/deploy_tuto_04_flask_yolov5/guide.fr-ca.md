...
- You can imagine deploying a **Flask** app in order to classify the feelings in a text. Refer to this [tutorial](https://docs.ovh.com/ca/fr/publiccloud/ai/deploy/tuto-flask-hugging-face-sentiment-analysis/).
