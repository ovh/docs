...
Then, select the Object Storage section (in the Storage category) and [create a new object container](https://docs.ovh.com/ca/en/storage/object-storage/pcs/create-container/) by clicking `Storage` > `Object Storage` > `Create an object container`.
...
- If you are interested in **deploying your model** in a Python app, discover AI Deploy by following this [tutorial](https://docs.ovh.com/ca/en/publiccloud/ai/deploy/build-use-streamlit-image/).
- If you want learn about Docker, check out this [tutorial](https://docs.ovh.com/ca/en/publiccloud/ai/training/build-use-custom-image/).
