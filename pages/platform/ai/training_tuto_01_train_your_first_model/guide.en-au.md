...
Then, select the Object Storage section (in the Storage category) and [create a new object container](https://docs.ovh.com/au/en/storage/pcs/create-container/) by clicking `Storage` > `Object Storage` > `Create an object container`.
