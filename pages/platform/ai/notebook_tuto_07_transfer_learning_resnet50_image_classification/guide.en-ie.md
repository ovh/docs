...
- If you want to deploy a Gradio app for **Image classification** or **Sketch recognition**, check out this [documentation](https://docs.ovh.com/ie/en/publiccloud/ai/apps/tuto-gradio-sketch-recognition/).
