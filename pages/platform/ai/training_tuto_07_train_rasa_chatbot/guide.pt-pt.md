...
Deployment will be performed in the second part of the tutorial which you can find here: [How to deploy a chatbot](https://docs.ovh.com/pt/publiccloud/ai/deploy/rasa-chatbot).
...
[How to deploy a chatbot](https://docs.ovh.com/pt/publiccloud/ai/deploy/rasa-chatbot)
