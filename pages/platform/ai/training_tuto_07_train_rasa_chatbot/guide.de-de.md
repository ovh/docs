...
Deployment will be performed in the second part of the tutorial which you can find here: [How to deploy a chatbot](https://docs.ovh.com/de/publiccloud/ai/deploy/rasa-chatbot).
If you want to access the code, you can find it [here](https://github.com/ovh/ai-training-examples/jobs/rasa-chatbot).
If you want to create a Rasa chatbot with a notebook, please follow this tutorial: [Create and train a Rasa chatbot](https://docs.ovh.com/de/publiccloud/ai/notebooks/create-rasa-chatbot).
...
For more explanation about the CLI command for AI Training, please read this guide: [CLI Reference](https://docs.ovh.com/de/publiccloud/ai/cli/overview-cli/).
...
More explanations are here: [CLI Reference](https://docs.ovh.com/de/publiccloud/ai/cli/overview-cli/).
...
[How to deploy a chatbot](https://docs.ovh.com/de/publiccloud/ai/deploy/rasa-chatbot)
