...
Deployment will be performed in the second part of the tutorial which you can find here: [How to deploy a chatbot](https://docs.ovh.com/sg/en/publiccloud/ai/deploy/deploy-rasa-chatbot).
