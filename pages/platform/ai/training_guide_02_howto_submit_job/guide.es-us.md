...
-   optionally container objects to attach data to the **job** at step 6, see our [create data container](https://docs.ovh.com/us/es/storage/pcs/create-container/) guide.
