...
During its lifetime, the [AI Training job](https://docs.ovh.com/us/es/publiccloud/ai/training/jobs/) will go through the following statuses:

- `QUEUED`: The job run request is about to be processed.
- `INITIALIZING`: The job instance is created and the data is synchronized from the Object Storage. To know more about the data synchronisation check out the [Data How it works](https://docs.ovh.com/us/es/publiccloud/ai/data/#how-it-works) section.
...
- `FINALIZING`: The job instance is deleted and the data is synchronized back to the Object Storage. To know more about the data synchronisation check out the [Data How it works](https://docs.ovh.com/us/es/publiccloud/ai/data/#how-it-works) section.
