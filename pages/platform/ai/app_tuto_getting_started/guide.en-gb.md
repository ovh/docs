...
Click on the button `Deploy an AI App`{.action} and accept terms and conditions if any.
...
> [!primary]
>
> If you want to deploy your own container, you need to comply with a few rules like adding a specific user. Follow our guide [Build and use custom images](https://docs.ovh.com/gb/en/ai-training/build-use-custom-image/).
>
...
AI Apps can be your own Docker container or applications proposed by OVHcloud's ecosystem.
...
In this example, we added the label **owner=bastien** and two labels where automatically added by OVHcloud.
...
That's it! To go further, you can imagine a script who gather latest Facebook or Twitter message and analyze their sentiment over time. 
