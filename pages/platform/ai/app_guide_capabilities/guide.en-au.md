...
AI Apps is compliant with the OVHcloud AI CLI. Discover how to [install the OVHcloud AI CLI](https://docs.ovh.com/au/en/ai-training/install-client/){.external}.

## Going further

Browse the full [AI Apps documentation](https://docs.ovh.com/au/en/publiccloud/ai/) to further understand the main concepts and get started.
