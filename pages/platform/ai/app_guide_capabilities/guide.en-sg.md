...
AI Apps is compliant with the OVHcloud AI CLI. Discover how to [install the OVHcloud AI CLI](https://docs.ovh.com/sg/en/ai-training/install-client/){.external}.

## Going further

Browse the full [AI Apps documentation](https://docs.ovh.com/sg/en/ai/){.external} to further understand the main concepts and get started.
