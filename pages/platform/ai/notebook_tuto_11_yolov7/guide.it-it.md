...
If you want to run it with the CLI, just follow this [guide](https://docs.ovh.com/it/publiccloud/ai/cli/access-object-storage-data). You have to choose the region, the name of your container and the path where your data is located and use the following commands.
...
If you want to launch it with the CLI, choose the [volumes](https://docs.ovh.com/it/publiccloud/ai/cli/access-object-storage-data/) you want to attach and the number of GPUs (`<nb-gpus>`) to use on your notebook and use the following command:
...
- Do you want to observe the evolution of your metrics during the training of your model? Click [here](https://docs.ovh.com/it/publiccloud/ai/notebooks/tuto-weights-and-biases/)!
- Do you want to use your YOLOv7 model in an app? [Here it is](https://docs.ovh.com/it/publiccloud/ai/deploy/tuto-streamlit-yolov7-sign-language/).
