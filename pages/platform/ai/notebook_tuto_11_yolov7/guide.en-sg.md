...
If you want to run it with the CLI, just follow this [guide](https://docs.ovh.com/sg/en/publiccloud/ai/cli/access-object-storage-data). You have to choose the region, the name of your container and the path where your data is located and use the following commands.
...
- Do you want to use your YOLOv7 model in an app? [Here it is](https://docs.ovh.com/sg/en/publiccloud/ai/deploy/tuto-streamlit-yolov7-sign-language/).
