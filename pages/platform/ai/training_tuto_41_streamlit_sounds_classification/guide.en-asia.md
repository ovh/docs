...
> [!warning]
>
> The shared registry of AI Training should only be used for testing purpose. Please consider attaching your own Docker registry. More information about this can be found [here](https://docs.ovh.com/asia/en/publiccloud/ai/training/add-private-registry/).
>
...
```console
ovhai job run --default-http-port 8501 \
      --cpu 1 \
...
The second volume contains the sound files that you will upload directly from the Streamlit app. By running the job, this Object Container is empty. It will fill up as the sound files are uploaded.
