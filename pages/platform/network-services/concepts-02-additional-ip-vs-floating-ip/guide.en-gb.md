...
More information about configuring Additional IP addresses is available in [this guide](https://docs.ovh.com/gb/en/publiccloud/network-services/configure-additional-ip/).
...
More information about configuring Floating IP is available on the [Public Cloud Networking Concepts page](https://docs.ovh.com/gb/en/publiccloud/network-services/networking-concepts/).
