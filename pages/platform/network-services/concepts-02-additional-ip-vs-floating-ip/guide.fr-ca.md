...
Retrouvez plus d'informations sur la configuration d'adresses Additional IP dans [ce guide](https://docs.ovh.com/ca/fr/public-cloud/configurer_une_ip_failover/).
...
Pour plus d'informations sur la configuration des Floating IP, consultez la page [Concepts - Réseau Public Cloud](https://docs.ovh.com/ca/fr/publiccloud/network-services/networking-concepts/).
