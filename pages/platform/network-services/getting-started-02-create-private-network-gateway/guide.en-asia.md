...
This can be created via the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/asia/&ovhSubsidiary=asia), the [OpenStack API](https://docs.ovh.com/asia/en/public-cloud/prepare_the_environment_for_using_the_openstack_api/) or the [OVHcloud API](https://ca.api.ovh.com/console/).
...
>>
>> Please note that you need to have activated the vRack before proceeding, if you do not have a vRack, please consult [this section](https://docs.ovh.com/asia/en/publiccloud/network-services/public-cloud-vrack/#activation) of the relevant guide.
>> 
...
- [Preparing an environment to use the OpenStack API](https://docs.ovh.com/asia/en/public-cloud/prepare_the_environment_for_using_the_openstack_api/)
