...
This can be created via the [OVHcloud Control Panel](https://www.ovh.com/auth/?action=gotomanager&from=https://www.ovh.it/&ovhSubsidiary=it), the [OpenStack API](https://docs.ovh.com/it/public-cloud/prepara_il_tuo_ambiente_di_sviluppo_per_utilizzare_lapi_openstack/) or the [OVHcloud API](https://eu.api.ovh.com/console/).
...
>>
>> Please note that you need to have activated the vRack before proceeding, if you do not have a vRack, please consult [this section](https://docs.ovh.com/it/publiccloud/network-services/public-cloud-vrack/#activation) of the relevant guide.
>> 
...
- [Preparing an environment to use the OpenStack API](https://docs.ovh.com/it/public-cloud/prepara_il_tuo_ambiente_di_sviluppo_per_utilizzare_lapi_openstack/)
