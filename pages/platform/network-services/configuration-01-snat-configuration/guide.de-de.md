...
- A [Public Cloud Floating IP](https://docs.ovh.com/de/publiccloud/network-services/attaching-pci-floating-ip-to-instance/)
...
This scenario is covered by the guide [Attaching a Floating IP to an instance](https://docs.ovh.com/de/publiccloud/network-services/attaching-pci-floating-ip-to-instance/).
...
Create a VM with a Floating IP as explained in [this guide](https://docs.ovh.com/de/publiccloud/network-services/attaching-pci-floating-ip-to-instance/).
