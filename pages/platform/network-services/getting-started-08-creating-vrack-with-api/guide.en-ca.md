...
- Consulting the guide [Configuring the vRack on Public Cloud](https://docs.ovh.com/ca/en/publiccloud/network-services/public-cloud-vrack/) (to understand the different methods to manage the vRack with the Public Cloud)
...
Log in to the OVHcloud APIv6 interface according to the relevant guide ([First steps with the OVHcloud API](https://docs.ovh.com/ca/en/api/first-steps-with-ovh-api/)) and follow these steps:
...
Log in to the OVHcloud APIv6 interface according to the relevant guide ([First steps with the OVHcloud API](https://docs.ovh.com/ca/en/api/first-steps-with-ovh-api/)).
...
[Configuring vRack for Public Cloud](https://docs.ovh.com/ca/en/publiccloud/network-services/public-cloud-vrack/)

[First steps with the OVHcloud API](https://docs.ovh.com/ca/en/api/first-steps-with-ovh-api/)
