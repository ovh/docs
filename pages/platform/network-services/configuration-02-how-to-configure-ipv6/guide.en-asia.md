...
> [!primary]
> 
> Floating IP and Gateway currently do not support IPv6. You can only use IPv6 with instances in [Public Mode](https://docs.ovh.com/asia/en/publiccloud/network-services/networking-concepts/#publicmode).
>
...
Firstly, [put your instance into rescue-pro mode](https://docs.ovh.com/asia/en/public-cloud/put_an_instance_in_rescue_mode/).
