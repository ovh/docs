...
Para crear una red privada desde las APIv6 de OVHcloud, haga clic [aquí](/pages/platform/network-services/getting-started-08-creating-vrack-with-api#step-3-creating-a-vlan-in-the-vrack_1) (EN), para consultar la guía específica.
...
Haga clic [aquí](/pages/platform/network-services/getting-started-08-creating-vrack-with-api#step-4-integrating-an-instance-into-the-vrack_1) (EN), para consultar la guía específica sobre este método.
...
Haga clic [aquí](/pages/platform/network-services/getting-started-08-creating-vrack-with-api#in-case-of-an-existing-instance_1) (EN), para consultar la guía específica sobre este método.
