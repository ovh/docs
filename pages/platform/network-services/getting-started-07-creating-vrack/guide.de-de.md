...
Um ein vRack mit der OVHcloud APIv6 zu aktivieren und zu verwalten, lesen Sie [diesen Abschnitt](/pages/platform/network-services/getting-started-07-creating-vrack-apiv6/#step-1-activating-and-managing-a-vrack) (EN) der entsprechenden Anleitung.
...
Um ein privates Netzwerk mit der OVHCloud APIv6 zu erstellen, folgen Sie [diesem Abschnitt](/pages/platform/network-services/getting-started-07-creating-vrack-apiv6/#step-3-creating-a-vlan-in-the-vrack_1) der entsprechenden Anleitung (EN).
...
Bitte folgen Sie [diesem Abschnitt](/pages/platform/network-services/getting-started-07-creating-vrack-apiv6/#step-4-integrating-an-instance-into-the-vrack_1) (EN) der entsprechenden Anleitung.
...
Lesen Sie [diesen Abschnitt](/pages/platform/network-services/getting-started-07-creating-vrack-apiv6/#in-case-of-an-existing-instance_1) (EN) der entsprechenden Anleitung.
...
[Konfiguration von vRack für Public Cloud mit OVHcloud APIv6](/pages/platform/network-services/getting-started-07-creating-vrack-apiv6/) (EN)
