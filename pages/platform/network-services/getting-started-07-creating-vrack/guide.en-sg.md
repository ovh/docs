...
- An [OpenStack user](https://docs.ovh.com/sg/en/public-cloud/creation-and-deletion-of-openstack-user/) (optional)
...
Please refer to [this guide](https://docs.ovh.com/sg/en/public-cloud/horizon/) to familiarise yourself with Horizon.
...
Please refer to [this guide](https://docs.ovh.com/sg/en/api/first-steps-with-ovh-api/) to get started with the OVHcloud APIv6.
...
For that you need to cherry-pick the correct terraform provider & resource. Find more information in our guide on [using Terraform with OVHcloud](https://docs.ovh.com/sg/en/api/terraform-at-ovhcloud/).
...
To activate and manage a vRack using the OVHcloud APIv6, please refer to [this section](https://docs.ovh.com/sg/en/publiccloud/network-services/public-cloud-vrack-apiv6/#step-1-activating-and-managing-a-vrack) of the corresponding guide.
...
>
> To learn more about this topic, please refer to the guide [Creating multiple vLANs in a vRack](https://docs.ovh.com/sg/en/dedicated/multiple-vlans/)
...
In case you need to be able to communicate with dedicated servers in this VLAN, please consult the guide [Creating multiple vLANs in a vRack](https://docs.ovh.com/sg/en/dedicated/multiple-vlans/).
...
To create a private network using the OVHcloud APIv6, please refer to [this section](https://docs.ovh.com/sg/en/publiccloud/network-services/public-cloud-vrack-apiv6/#step-3-creating-a-vlan-in-the-vrack_1) of the corresponding guide.
...
Please refer to [this section](https://docs.ovh.com/sg/en/publiccloud/network-services/public-cloud-vrack-apiv6/#step-4-integrating-an-instance-into-the-vrack_1) of the corresponding guide.
...
Also, note the information explicated in [this guide](https://docs.ovh.com/sg/en/public-cloud/starting-with-nova-api/):
...
Please refer to [this section](https://docs.ovh.com/sg/en/publiccloud/network-services/public-cloud-vrack-apiv6/#in-case-of-an-existing-instance_1) of the corresponding guide.
...
[Configuring vRack for Public Cloud using OVHcloud APIv6](https://docs.ovh.com/sg/en/publiccloud/network-services/public-cloud-vrack-apiv6/)

[Creating multiple vLANs in a vRack](https://docs.ovh.com/sg/en/dedicated/multiple-vlans/)
