...
Consulte la guía [Crear una instancia desde el área de cliente](https://docs.ovh.com/us/es/public-cloud/public-cloud-primeros-pasos/#create-instance). Al crear una instancia, podrá especificar, en el paso 4, una red privada en la que integrar su instancia. Seleccione el vRack anteriormente creado en el menú desplegable que aparece.
