...
For that you need to cherry-pick the correct terraform provider & resource. Find more information in our guide on [how to use Terraform](https://docs.ovh.com/ie/en/public-cloud/how-to-use-terraform/).
