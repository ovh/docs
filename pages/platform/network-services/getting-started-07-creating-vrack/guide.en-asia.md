...
- An [OpenStack user](https://docs.ovh.com/asia/en/public-cloud/creation-and-deletion-of-openstack-user/) (optional)
...
Please refer to [this guide](https://docs.ovh.com/asia/en/public-cloud/horizon/) to familiarise yourself with Horizon.
...
Please refer to [this guide](https://docs.ovh.com/asia/en/api/first-steps-with-ovh-api/) to get started with the OVHcloud APIv6.
...
- [Preparing an environment for using the OpenStack API](https://docs.ovh.com/asia/en/public-cloud/prepare_the_environment_for_using_the_openstack_api/)
...
In case you need to be able to communicate with dedicated servers in this VLAN, please consult the guide [Creating multiple vLANs in a vRack](https://docs.ovh.com/asia/en/dedicated/multiple-vlans/).
...
To create a private network using the OVHcloud APIv6, please refer to [this section](https://docs.ovh.com/asia/en/publiccloud/network-services/public-cloud-vrack-apiv6/#step-3-creating-a-vlan-in-the-vrack) of the corresponding guide.
...
If you need assistance, follow this guide first: [Creating an instance in the OVHcloud Control Panel](https://docs.ovh.com/asia/en/public-cloud/public-cloud-first-steps/#create-instance). When creating an instance, you can choose, in Step 5, a network mode, followed by a private network to integrate your instance into. 
...
Please refer to [this section](https://docs.ovh.com/asia/en/publiccloud/network-services/public-cloud-vrack-apiv6/#step-4-integrating-an-instance-into-the-vrack) of the corresponding guide.
...
Also, note the information explicated in [this guide](https://docs.ovh.com/asia/en/public-cloud/starting-with-nova-api/):
...
Please refer to [this section](https://docs.ovh.com/asia/en/publiccloud/network-services/public-cloud-vrack-apiv6/#in-case-of-an-existing-instance) of the corresponding guide.
...
[Configuring vRack for Public Cloud using OVHcloud APIv6](https://docs.ovh.com/asia/en/publiccloud/network-services/public-cloud-vrack-apiv6/)

[Creating multiple vLANs in a vRack](https://docs.ovh.com/asia/en/dedicated/multiple-vlans/)
