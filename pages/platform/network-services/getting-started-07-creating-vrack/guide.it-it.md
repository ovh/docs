...
Per creare una VLAN dalle APIv6 OVHcloud, clicca [qui](/pages/platform/network-services/getting-started-08-creating-vrack-with-api#step-3-creating-a-vlan-in-the-vrack_1) (EN), per consultare la guida specifica a questo metodo.
...
Clicca [qui](/pages/platform/network-services/getting-started-08-creating-vrack-with-api#step-4-integrating-an-instance-into-the-vrack_1) (EN), per consultare la guida specifica a questo metodo.
...
Clicca [qui](/pages/platform/network-services/getting-started-08-creating-vrack-with-api#in-case-of-an-existing-instance_1) (EN), per consultare la guida specifica a questo metodo.
...
[Configurazione della vRack Public Cloud da APIv6 OVHcloud](/pages/platform/network-services/getting-started-08-creating-vrack-with-api) (EN)
