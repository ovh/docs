...
Pour créer un réseau privé depuis les APIv6 OVHcloud, cliquez [ici](/pages/platform/network-services/getting-started-08-creating-vrack-with-api#etape-3-creer-un-vlan-dans-le-vrack_1) pour consulter le guide spécifique à cette méthode.
...
Cliquez [ici](/pages/platform/network-services/getting-started-08-creating-vrack-with-api#etape-4-integrer-une-instance-dans-le-vrack_1) pour consulter le guide spécifique à cette méthode.
...
Cliquez [ici](/pages/platform/network-services/getting-started-08-creating-vrack-with-api#cas-dune-instance-deja-existante_1) pour consulter le guide spécifique à cette méthode.
...
[Configuration du vRack Public Cloud depuis les APIv6 OVHcloud](/pages/platform/network-services/getting-started-08-creating-vrack-with-api)
