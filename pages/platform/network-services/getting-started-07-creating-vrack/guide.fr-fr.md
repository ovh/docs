...
Consultez le guide [Créer une instance depuis l’espace client](https://docs.ovh.com/fr/public-cloud/premiers-pas-instance-public-cloud/#create-instance). Lors de la création d'une instance, vous pourrez spécifier, durant l'étape 4, un réseau privé dans lequel intégrer votre instance. Choisissez alors, dans le menu déroulant présenté, votre vRack précédemment créé.
