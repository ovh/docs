...
In the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca), select your project from the `Public Cloud`{.action} section. Open `Public IPs`{.action} under "**Network**" in the left-hand menu.
...
The next step will be the IP configuration in your OS; please refer to our [guide](https://docs.ovh.com/ca/en/publiccloud/network-services/configure-additional-ip/).
