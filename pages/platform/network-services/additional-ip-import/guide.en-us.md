...
In the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/world/&ovhSubsidiary=we), select your project from the `Public Cloud`{.action} section. Open `Public IPs`{.action} under "**Network**" in the left-hand menu.
