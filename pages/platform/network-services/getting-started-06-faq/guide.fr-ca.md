...
Cette fonctionnalité est issue du composant Octavia Load Balancer de la version Yoga, qui n'est actuellement pas disponible. Nous travaillons à un upgrade de Octavia et Barbican de Victoria à Yoga. Une fois cette opération effectuée, nous vous communiquerons cette mise à jour sur [cette page](https://www.ovhcloud.com/fr/public-cloud/regions-availability/).
