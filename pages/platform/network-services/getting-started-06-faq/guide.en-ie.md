...
This feature comes from the Octavia Load Balancer component in the Yoga release which is not currently available. We are working on upgrading Octavia and Barbican from Victoria to Yoga. Once this is done, we will share this update on [this page](https://www.ovhcloud.com/en-ie/public-cloud/regions-availability/).
