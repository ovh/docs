...
- Avoir un [réseau privé](https://docs.ovh.com/fr/public-cloud/public-cloud-vrack/) configuré dans votre projet
...
Vous pouvez en savoir plus sur notre page [Concepts](https://docs.ovh.com/fr/publiccloud/network-services/additional-ip-vs-floating-ip/).
