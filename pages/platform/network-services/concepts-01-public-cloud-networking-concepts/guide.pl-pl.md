...
Read more about it on our [Load Balancer guide page](https://docs.ovh.com/pl/publiccloud/network-services/getting-started-with-load-balancer-public-cloud/).
...
Find out more about Additional IP and Floating IP on the dedicated [Concepts page](https://docs.ovh.com/pl/publiccloud/network-services/additional-ip-vs-floating-ip/).
