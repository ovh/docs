...
Public Cloud private networks are being created on top of a [vRack](https://www.ovh.co.uk/solutions/vrack/) - an OVHcloud service providing a global private network that can be assigned to a Public Cloud project.
...
Read more about it on our [Load Balancer guide page](https://docs.ovh.com/gb/en/publiccloud/network-services/getting-started-with-load-balancer-public-cloud/).
...
Find out more about Additional IP and Floating IP on the dedicated [Concepts page](https://docs.ovh.com/gb/en/publiccloud/network-services/additional-ip-vs-floating-ip/).
