...
First, log in to the [OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca) and open your `Public Cloud`{.action} project. Then, select Additional IP in the **Network** section.
...
[Configure an Additional IP](https://docs.ovh.com/ca/en/publiccloud/network-services/configure-additional-ip/)
