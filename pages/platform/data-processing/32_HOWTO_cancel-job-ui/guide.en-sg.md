...
In this guide, we are assuming that you're using the [OVHcloud Manager](https://www.ovh.com/manager/cloud/){.external} to use Data Processing platform and you have already submitted a job.  
