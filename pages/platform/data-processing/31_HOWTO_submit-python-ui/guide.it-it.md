...
Please see [Creating Storage Containers in Customer Panel](https://docs.ovh.com/it/storage/object-storage/pcs/create-container/){.external} or [Create an object container in Horizon](https://docs.ovh.com/it/storage/object-storage/pcs/create-container/#horizon) for more details.
