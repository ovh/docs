...
In this guide, we are assuming that you're using the [OVHcloud Manager](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/fr/&ovhSubsidiary=qc){.external} to use the Data Processing platform.
...
Please see [Creating Storage Containers in Customer Panel](https://docs.ovh.com/ca/fr/storage/object-storage/pcs/create-container/){.external} or [Create an object container in Horizon](https://docs.ovh.com/ca/fr/storage/object-storage/pcs/create-container/#horizon) for more details.
