...
Please see [Creating Storage Containers in Customer Panel](https://docs.ovh.com/ca/fr/storage/object-storage/pcs/create-container/){.external} or [Create an object container in Horizon](../../storage/create_an_object_container/){.external} for more details.
