...
The wordcount.txt file should be uploaded in the container you're using when submitting a job. Please refer to this documentation that explains how to create a Swift container [Getting started with the Swift API](https://docs.ovh.com/pl/storage/object-storage/pcs/getting-started-with-the-swift-api/).
...
(See [How to create EC2 credentials](https://docs.ovh.com/pl/storage/object-storage/pcs/getting-started-with-the-swift-s3-api/){.external} for more details)
