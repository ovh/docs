...
There is three may ways to download your logs from your object storage:
- with the OVHcloud Manager
...
- Login to the [OVHcloud Manager](https://ca.ovh.com/auth/?action=gotomanager&from=https://www.ovh.com/ca/en/&ovhSubsidiary=ca){.external} and select `Public Cloud`{.action}.
- Select the project in which you submitted your job. 
...
![get Openstack's RC file](images/users-logs.png){.thumbnail}
