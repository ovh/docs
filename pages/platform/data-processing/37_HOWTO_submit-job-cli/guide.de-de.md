...
Please see [Creating Storage Containers in Customer Panel](https://docs.ovh.com/de/storage/object-storage/pcs/create-container/){.external} or [Create an object container in Horizon](https://docs.ovh.com/de/storage/object-storage/pcs/create-container/){.external} for more details.

You can also manage your Object storage through command line with the [Openstack Swift API](https://docs.ovh.com/de/storage/object-storage/pcs/getting-started-with-the-swift-api/){.external} 
