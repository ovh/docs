...
Please see [Creating Storage Containers in the OVHcloud Control Panel](https://docs.ovh.com/de/storage/object-storage/pcs/create-container/#controlpanel) or [Create an object container in Horizon](https://docs.ovh.com/de/storage/object-storage/pcs/create-container/#horizon) for more details.
