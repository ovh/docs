...
- An OVHcloud account
- A cloud project in your OVHcloud account (see [How to create a cloud project](https://docs.ovh.com/fr/public-cloud/create_a_public_cloud_project/) for details.)
