...
- Access to the [OVHcloud API](https://api.ovh.com/). You can find more information [here](/pages/account/api/first-steps). Make sure your application token can access the **/cloud** POST and GET requests and the **/me** GET request. 
