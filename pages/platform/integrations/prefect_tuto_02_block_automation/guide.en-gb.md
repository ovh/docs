...
- First configuration for Prefect and OVHcloud. See our guide [Getting started](/pages/platform/integrations/prefect_guide_01_getting_started) for more information
- An email address
...
Click on the "Add +" button and fill in the block with a name and the desired email address where you will receive a notification. You can enter multiple email addresses. Once your block is created, let's see what an automation is and why it will be useful to send our email. 
...
In the last step, you have to fill in the details of your automations like the name and the description. Choose a name and a description as you wish.
