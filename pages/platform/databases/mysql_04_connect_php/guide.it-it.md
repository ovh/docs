...
- [Configure your MySQL instance](https://docs.ovh.com/it/databases/mysql/configure-mysql-instance/) to accept incoming connections
...
One of the easiest, yet powerful, is to use a Command Line Interface (CLI), as shown in our guide : [Connect to MySQL with CLI](https://docs.ovh.com/it/publiccloud/databases/mysql/connect-cli/).
