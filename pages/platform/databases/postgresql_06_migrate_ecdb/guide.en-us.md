---
title: How to migrate from Enterprise Cloud Database to Public Cloud Databases
excerpt: Learn how to migrate a PostgreSQL Enterprise Cloud Database instance to Public Cloud Databases for PostgreSQL
...
**This guide details a procedure to migrate a PostgreSQL instance running on OVHcloud Enterprise Cloud Database (soon to be EOL) to OVHcloud Public Cloud Databases for PostgreSQL.**
