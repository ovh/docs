...
- OVHcloud Control Panel will also show an EOL notification for affected services.
...
Public Cloud Databases offers database forking (a copy) as an efficient tool to verify the version upgrade so that you can safely test compatibility without committing your production services to a one-way upgrade.
