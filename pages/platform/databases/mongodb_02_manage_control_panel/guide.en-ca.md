...
- a MongoDB database service in your OVHcloud account (find the details in [this guide](https://docs.ovh.com/ca/en/publiccloud/databases/mongodb/getting-started/))
...
The button `Create a database`{.action} starts the process of ordering a [new database service](https://docs.ovh.com/ca/en/publiccloud/databases/mongodb/getting-started/).
