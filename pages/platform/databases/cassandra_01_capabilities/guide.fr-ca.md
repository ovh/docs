...
You can customize your Cassandra further through the use of advanced parameters. See the [Advanced parameters references documentation](https://docs.ovh.com/ca/fr/publiccloud/databases/cassandra/advanced-parameters-references/) for more information about which ones are supported.
