...
You can increased the storage of your cluster up to the maximum allowed for a given reference. Please refer to the [Resize your cluster storage guide](https://docs.ovh.com/us/en/publiccloud/databases/resize-cluster-storage/) for more information.
...
You can customize your Cassandra further through the use of advanced parameters. See the [Advanced parameters references documentation](https://docs.ovh.com/us/en/publiccloud/databases/cassandra/advanced-parameters-references/) for more information about which ones are supported.
