...
You can further customise your Cassandra by using advanced parameters. See the [Advanced parameters references documentation](https://docs.ovh.com/ca/en/publiccloud/databases/cassandra/advanced-parameters-references/) for more information on the supported parameters.
