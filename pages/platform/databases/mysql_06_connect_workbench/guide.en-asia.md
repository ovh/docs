...
One of the easiest, yet powerful, is to use a Command Line Interface (CLI), as shown in our guide : [Connect to MySQL with CLI](https://docs.ovh.com/asia/en/publiccloud/databases/mysql/connect-cli/) or by using programming languages, such as [PHP](https://docs.ovh.com/asia/en/publiccloud/databases/mysql/connect-php/) or [Python](https://docs.ovh.com/asia/en/publiccloud/databases/mysql/connect-python/).
...
In the **Setup New Connection** dialog box, fill the `Parameters`{.action} tab form with the previous collected informations

![](images/mysql_06_connect_workbench-2022021011165750.png)

Store password for connection in keychain
...
Congratulation, in the `Schemas`{.action} tab, you will see yours databases
