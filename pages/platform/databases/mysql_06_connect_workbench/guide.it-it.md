...
One of the easiest, yet powerful, is to use a Command Line Interface (CLI), as shown in our guide: [Connect to MySQL with CLI](https://docs.ovh.com/it/publiccloud/databases/mysql/connect-cli/) or by using programming languages, such as [PHP](https://docs.ovh.com/it/publiccloud/databases/mysql/connect-php/) or [Python](https://docs.ovh.com/it/publiccloud/databases/mysql/connect-python/).
