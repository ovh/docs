...
- access to the [OVHcloud API](https://api.ovh.com/){.external} (create your credentials by consulting [this guide](https://docs.ovh.com/it/api/first-steps-with-ovh-api/))
