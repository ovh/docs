...
- A Grafana database running on your OVHcloud Public Cloud project (see [this guide](https://docs.ovh.com/pl/publiccloud/databases/getting-started/) to create a managed Grafana)
...
> [!warning]
> 
> Don't forget to set the `Authorised IP addresses` in the Grafana configuration. See our guide on [Configuring your Grafana instance to accept incoming connections](https://docs.ovh.com/pl/publiccloud/databases/grafana/configure-grafana-instance/) for more details.
