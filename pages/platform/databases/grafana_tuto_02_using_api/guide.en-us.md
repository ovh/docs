...
> [!warning]
> 
> Don't forget to set the `Authorised IP addresses` in the Grafana configuration. See [Configure your Grafana instance to accept incoming connections documentation](https://docs.ovh.com/us/en/publiccloud/databases/grafana/configure-grafana-instance/) guide for more details.
