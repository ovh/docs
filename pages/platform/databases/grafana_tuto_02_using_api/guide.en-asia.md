...
- A Grafana database running on your OVHcloud Public Cloud project (see [this guide](https://docs.ovh.com/asia/en/publiccloud/databases/getting-started/) to create a managed Grafana)
