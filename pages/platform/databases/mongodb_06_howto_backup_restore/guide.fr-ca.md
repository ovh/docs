...
- A MongoDB database running on your OVHcloud Public Cloud Databases ([this guide](https://docs.ovh.com/ca/fr/publiccloud/databases/getting-started/) can help you to meet this requirement)
