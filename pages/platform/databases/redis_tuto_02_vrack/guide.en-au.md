...
If you want to test the access from an existing instance, read this tutorial to connect it to the vRack: [Configuring vRack for Public Cloud](https://docs.ovh.com/au/en/public-cloud/public-cloud-vrack/#cases-of-an-already-existing-instance_2).
