...
- An [Activated Vrack](https://docs.ovh.com/us/es/public-cloud/public-cloud-vrack/).
...
According the [Redis capabilities page](https://docs.ovh.com/us/es/publiccloud/databases/redis/capabilities/#plans), the use of private networks with databases is allowed for **Business** and **Enterprise** plans.
...
If you want to test the access from an existing instance, read this tutorial to connect it to the vRack: [Configuring vRack for Public Cloud](https://docs.ovh.com/us/es/public-cloud/public-cloud-vrack/#cases-of-an-already-existing-instance_2).
