...
According the [Redis capabilities page](https://docs.ovh.com/ie/en/publiccloud/databases/redis/capabilities/#plans), the use of private networks with databases is allowed for **business** or **enterprise** plans. 
...
We assume that you have a parameted SSH key on your project. For more details, read the [Creating and connecting to your first Public Cloud instance](https://docs.ovh.com/ie/en/public-cloud/public-cloud-first-steps/) page.
