...
You can learn more about how backups works on the [Automated backups guide](https://docs.ovh.com/pt/publiccloud/databases/backups/).
...
If your service supports point in time recovery (see [Automated Backup guide](https://docs.ovh.com/pt/publiccloud/databases/backups/) for more details), you will also be offered the option to restore from a specific date and time.
