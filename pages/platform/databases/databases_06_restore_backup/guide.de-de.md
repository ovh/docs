...
If your service supports point in time recovery (see the [Automated Backup guide](/pages/platform/databases/databases_05_automated_backups) for more details), you will also be offered the option to restore from a specific date and time.
