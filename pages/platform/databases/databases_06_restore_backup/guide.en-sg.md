...
If your service supports point in time recovery (see [Automated Backup guide](https://docs.ovh.com/sg/en/publiccloud/databases/backups/) for more details), you will also be offered the option to restore from a specific date and time.
