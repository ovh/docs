...
Following the related documentation on how to [authorise the suitable IP addresses](https://docs.ovh.com/us/en/publiccloud/databases/mongodb/managing-service/#configuring-authorised-ips), add your IPs to the authorised list.
