...
> [!primary]
>
> Learn more about vRack [here](https://docs.ovh.com/pt/public-cloud/public-cloud-vrack/)
>

### Step 2 - Creating a Public Cloud Database connected to the private network


Follow this [guide](https://docs.ovh.com/pt/publiccloud/databases/getting-started/) to create a new Public Cloud Database.
...
Follow the *Configure your \<database> instance to accept incoming connections* guide of your selected database type available [here](https://docs.ovh.com/pt/publiccloud/databases/) to configure your service after installation.
...
Follow this [guide](https://docs.ovh.com/pt/public-cloud/public-cloud-first-steps/#step-3-creating-an-instance) to create a new Public Cloud Instance
...
> [!primary]
>
>If you want to test the access from an existing instance, read this tutorial to connect it to the vRack: [Configuring vRack for Public Cloud](https://docs.ovh.com/pt/public-cloud/public-cloud-vrack/#in-case-of-an-existing-instance_2).
>
