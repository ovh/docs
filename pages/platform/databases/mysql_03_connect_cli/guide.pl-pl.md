...
- [Configure your MySQL instance](https://docs.ovh.com/pl/databases/mysql/configure-mysql-instance/) to accept incoming connections
...
[MySQL capabilities](https://docs.ovh.com/pl/publiccloud/databases/mysql/capabilities/)
