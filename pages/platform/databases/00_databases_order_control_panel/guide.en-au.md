...
Please visit the [MongoDB capabilities page](https://docs.ovh.com/au/en/publiccloud/databases/mongodb/capabilities/) for detailed information on each plan's properties.
...
Please visit the [MongoDB capabilities page](https://docs.ovh.com/au/en/publiccloud/databases/mongodb/capabilities/) for detailed information on the hardware resources and other properties of the database installation.
...
The final section will display a summary of your order as well as the API equivalent for creating this database instance, for use with the [OVHcloud API](https://docs.ovh.com/au/en/api/first-steps-with-ovh-api/).
