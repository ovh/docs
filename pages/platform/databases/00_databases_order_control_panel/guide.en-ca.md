...
The final section will display a summary of your order as well as the API equivalent for creating this database instance, for use with the [OVHcloud API](https://docs.ovh.com/ca/en/api/first-steps-with-ovh-api/).
