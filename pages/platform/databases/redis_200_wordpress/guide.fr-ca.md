...
>
>If you encounter any difficulties performing these actions, please contact a specialised service provider and/or discuss the issue with [our community](https://community.ovh.com/). OVHcloud cannot provide you with technical support in this regard.
>
...
[Redis capabilities](https://docs.ovh.com/ca/fr/publiccloud/databases/redis/capabilities/)

[How to connect to Redis with CLI](https://docs.ovh.com/ca/fr/publiccloud/databases/redis/connect-cli/)

[How to connect to Redis with PHP](https://docs.ovh.com/ca/fr/publiccloud/databases/redis/connect-php/)
