...
you can increase the storage of your cluster up to the maximum allowed for a given reference. Please refer to the [Resize your cluster storage guide](https://docs.ovh.com/fr/publiccloud/databases/resize-cluster-storage/) for more information.
...
You can further customise your MySQL by using advanced parameters. See the [Advanced parameters references documentation](https://docs.ovh.com/fr/publiccloud/databases/mysql/advanced-parameters-references/) for more information on the supported parameters.
