...
Please refer to this [guide](https://docs.ovh.com/ca/en/publiccloud/databases/postgresql/connect-cli/) to find out how to connect to your database using `psql`.
