...
- [Configure your Redis instance](https://docs.ovh.com/us/en/publiccloud/databases/redis/configure-redis-instance/) to accept incoming connections
...
One of the easiest, yet powerful, is to use a Command Line Interface (CLI), as shown in our guide : [Connect to Redis with CLI](https://docs.ovh.com/us/en/publiccloud/databases/redis/connect-cli).
...
[Redis capabilities](https://docs.ovh.com/us/en/publiccloud/databases/redis/capabilities/)
