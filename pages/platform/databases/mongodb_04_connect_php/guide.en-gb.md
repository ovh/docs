...
Please follow official [MongoDB documentation for PHP drivers](https://docs.mongodb.com/drivers/php/){.external} to get the laatest informations.
...
A bit of information to know :
 ...
 - Will connect to the hostname or the replica set (name is **replicaset**)
 - to the "admin" database directly
 - on the default MongoDB port (27017)
 - All of that securely, with TLS activated
  
We will now follow official MongoDB documentation to perform our first connection with PHP.
...
In your PHP environment, let's try a connection. To be sure that we are indeed connected, we will dump all the MongoDB instance information.
 ...
 As shown in the code, we use the  **MongoDB\Driver\Manager**. Official Use official PHP documentation for exhaustive documentation : <https://www.php.net/manual/en/set.mongodb.php>.
