...
- A database running on your OVHcloud Public Cloud Databases ([this guide](https://docs.ovh.com/pl/databases/getting-started/) can help you to meet this requirement)
