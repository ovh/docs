...
Please refer to the [DBMS lifecycle policy guide](https://help.ovhcloud.com/csm/es-es-public-cloud-databases-lifecycle-policy?id=kb_article_view&sysparm_article=KB0048889) for recommendations on version upgrades and end of life announcements of major versions. Additionally, MongoDB recommends always installing and using the latest stable version of MongoDB. See [MongoDB Versioning](https://docs.mongodb.com/manual/reference/versioning/){.external} for more information.
