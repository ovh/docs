...
- A database running on your OVHcloud Public Cloud Databases ([this guide](https://docs.ovh.com/ca/en/databases/getting-started/) can help you to meet this requirement)
...
*Follow this [guide](https://docs.ovh.com/ca/en/publiccloud/databases/postgresql/connect-pgadmin/) to learn more about pgAdmin*
