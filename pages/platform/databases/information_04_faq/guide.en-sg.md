...
Please read our [Getting started with Public Cloud Databases documentation](https://docs.ovh.com/sg/en/publiccloud/databases/getting-started/).
...
Backups are performed differently according to the DBMS. See [Automated backups](https://docs.ovh.com/sg/en/publiccloud/databases/backups/) for more details.
...
Please read our [Getting started guide](https://docs.ovh.com/sg/en/publiccloud/databases/getting-started/) to get a step by step documentation.
