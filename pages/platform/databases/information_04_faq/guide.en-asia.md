...
Backups are performed differently according to the DBMS. See [Automated backups](https://docs.ovh.com/en/asia/publiccloud/databases/backups/) for more details.
