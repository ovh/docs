...
One of the easiest, yet powerful, is to use a Command Line Interface (CLI), as shown in our guide : [Connect to PostegreSQL with CLI](https://docs.ovh.com/ie/en/publiccloud/databases/postgresql/connect-cli).
