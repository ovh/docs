...
[Redis capabilities](https://docs.ovh.com/sg/en/publiccloud/databases/redis/capabilities/)

[How to connect to Redis with CLI](https://docs.ovh.com/sg/en/publiccloud/databases/redis/connect-cli/)

[How to connect to Redis with PHP](https://docs.ovh.com/sg/en/publiccloud/databases/redis/connect-php/)
