...
[OVHcloud documentation on managed Public Cloud Databases](https://docs.ovh.com/es/publiccloud/databases/)

[Redis capabilities](https://docs.ovh.com/es/publiccloud/databases/redis/capabilities/)

[How to connect to Redis with CLI](https://docs.ovh.com/es/publiccloud/databases/redis/connect-cli/)

[How to connect to Redis with PHP](https://docs.ovh.com/es/publiccloud/databases/redis/connect-php/)
