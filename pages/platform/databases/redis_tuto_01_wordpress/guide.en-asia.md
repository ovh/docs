...
[How to connect to Redis with CLI](https://docs.ovh.com/asia/en/publiccloud/databases/redis/connect-cli/)

[How to connect to Redis with PHP](https://docs.ovh.com/asia/en/publiccloud/databases/redis/connect-php/)
