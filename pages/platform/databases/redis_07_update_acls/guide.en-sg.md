...
As explained on this page: [Redis Capabilities, Users & roles](https://docs.ovh.com/sg/en/publiccloud/databases/redis/capabilities/#users-and-roles), the users' ACLs can not be updated via the OVHcloud Control Panel.

You must therefore use the [OVHcloud API](https://docs.ovh.com/sg/en/api/first-steps-with-ovh-api/).
