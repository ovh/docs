...
As explained on this page: [Redis Capabilities, Users & roles](https://docs.ovh.com/it/publiccloud/databases/redis/capabilities/#users-and-roles), the users' ACLs can not be updated via the OVHcloud Control Panel.

You must therefore use the [OVHcloud API](https://docs.ovh.com/it/api/first-steps-with-ovh-api/).
