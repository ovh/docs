...
- Access to the [OVHcloud API](https://ca.api.ovh.com/console/) (create your credentials by consulting [this guide](https://docs.ovh.com/ca/en/api/first-steps-with-ovh-api/))
