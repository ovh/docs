...
- Access to the [OVHcloud API](https://api.ovh.com/console/) (create your credentials by consulting [this guide](https://docs.ovh.com/fr/api/first-steps-with-ovh-api/))
