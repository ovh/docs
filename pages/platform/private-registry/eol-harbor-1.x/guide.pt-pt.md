...
First, follow the guide [Creating a private registry](https://docs.ovh.com/pt/private-registry/creating-a-private-registry/) to create a new private registry named `my-new-registry` for example, with the latest version of Harbor.
...
To have an overview of OVHcloud Managed Private Registry service, you can consult the [OVHcloud Managed Private Registry site](https://docs.ovh.com/pt/private-registry/).
