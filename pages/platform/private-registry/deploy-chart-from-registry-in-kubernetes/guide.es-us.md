...
routes:
    canonical: '/pages/platform/private-registry/deploy-chart-from-registry-in-kubernetes'
updated: 2022-04-14
---
...
To have an overview of the OVHcloud Managed Private Registry service, you can go to the [OVHcloud Managed Private Registry site](/us/es/private-registry/).
