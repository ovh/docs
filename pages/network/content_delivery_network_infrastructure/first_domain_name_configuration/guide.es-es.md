...
Para ello, en el [área de cliente de OVH](/links/manager) acceda a la sección `Dedicado`{.action}. En la columna izquierda, haga clic en `NAS y CDN`{.action} y seleccione el servicio CDN correspondiente.
