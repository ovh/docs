...
Es posible adquirir tráfico adicional directamente desde el [área de cliente de OVH](/links/manager).

![Adquirir tráfico](images/add_quota.png){.thumbnail}

Puede consultar el precio de los paquetes de tráfico disponibles en la página de la solución [CDN de OVH](/links/network/cdn-infrastructure).
