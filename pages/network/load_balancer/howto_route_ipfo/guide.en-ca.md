...
For more information on Additional IPs, you can consult our [webpage](/links/websitebare-metal/ip/){.external}.
...
- an [Additional IP](/links/websitebare-metal/ip/){.external}
