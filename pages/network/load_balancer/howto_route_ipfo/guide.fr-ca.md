...
Pour plus d'informations sur l'Additional IP nous vous recommandons la lecture du [document de présentation](/links/websitebare-metal/ip/){.external}.
...
- Disposer d'une [Additional IP](/links/websitebare-metal/ip/){.external}.
