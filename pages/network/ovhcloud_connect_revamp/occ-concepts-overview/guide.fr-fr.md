...
OVHcloud Connect est un service de connectivité réseau qui permet de relier votre infrastructure (datacenter, site d’entreprise ou fournisseur de colocation) directement au réseau d’OVHcloud via une connexion privée dédiée, sans passer par Internet.
