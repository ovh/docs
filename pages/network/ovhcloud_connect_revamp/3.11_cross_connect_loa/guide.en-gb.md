...
Before removing the physical cable, cancel the OVHcloud Connect service (see [Cancel Direct](3.3_cancel_direct.md) or [Cancel Provider](3.4_cancel_provider.md)).
